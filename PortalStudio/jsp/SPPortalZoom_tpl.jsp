<%/*Type:Pagelet*/%>
<%/*Template*/%>
<%/*Def:type||pagelet||id||pagelet||name||SPPortalZoom_tpl||template||0||width||100%||height|| ||css|| ||css_class|| ||color|| ||align||left||security||none||on_security_failure||login||offline||false||shared_manifest|| ||manifest||Custom manifest||description|| ||sp_theme||false||cache_time|| ||roles|| |||type||column||id||header||name||header||width|| ||color|| ||align||left||valign||top||css_class|| ||height||0px||padding|| ||collapsable||false|||type||column||id||col1||name||column1||width||200px||color|| ||align||left||valign||top||css_class|| ||height|| ||padding|| ||collapsable||true close|||type||column||id||col2||name||column2||width||95%||color|| ||align||left||valign||top||css_class|| ||height|| ||padding|| ||collapsable||false|||type||column||id||col3||name||column3||width||0px||color|| ||align||left||valign||top||css_class|| ||height|| ||padding|| ||collapsable||false|||type||column||id||footer||name||footer||width|| ||color|| ||align||left||valign||top||css_class|| ||height||0px||padding|| ||collapsable||false|||type||zone||id||ZoomParameters0||name||ZoomParameters||titled||false||title|| ||open||false||in_iframe||false||iframe_height|| ||container||col1||position||0||margin_bottom||10px||draggable||false||css_class|| |||type||zone||id||ZoomGrid1||name||ZoomGrid||titled||false||title|| ||open||false||in_iframe||false||iframe_height|| ||container||col2||position||0||margin_bottom||10px||draggable||false||css_class|| |||*/%>
<%/*Template_type:0*/%>
<%/*Encoding:UTF-8*/%>
<%/*Description: */%>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=PageletId%>','SPPortalZoom_tpl','pageletObj','<%=SPParentObjId%>');
/*JS_MARKER_END*/
</script>
...
<%}%>
ZtVWeb.addPagelet('<%=PageletId%>',<%=PageletId%>,'SPPortalZoom_tpl','<%=includerPageletId%>');
