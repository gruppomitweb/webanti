...
/* exported RaphaelAdapter */
function RaphaelAdapter() {
	var _canvas,pellicola,
	_nomeId;
	...
	this.createCanvas = function(nomeId) {
      ...
      // creo una pellicola per quando faccio mouseOut sulle informazioni
        pellicola=this.createRect(-1,-1,100000,100000,0,'#345678')
        pellicola.attr({fill: "#345678", "fill-opacity": 0, "stroke-width": 0});
      }
		}
	}
    ...
    else 	_canvas.setSize(larghezza+500, altezza+500);
	}

  this.getPellicola=function(){
    return pellicola;
  }
