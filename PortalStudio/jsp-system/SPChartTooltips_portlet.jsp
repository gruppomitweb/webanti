...
%>
window.SPChartTooltips_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.SPChartTooltips_container .labelTP{  white-space: nowrap;
  overflow: visible !important;
  font-family: Open Sans, sans-serif;
  color: #0D0F12;
  text-decoration: none;
...
.SPChartTooltips_container {
  background-color:#FAFAFA;
}
.SPChartTooltips_portlet{
  position:relative;
  min-width:250px;
  height:100px;
}
.SPChartTooltips_portlet[Data-page="1"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet[Data-page="2"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet[Data-page="3"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet[Data-page="4"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet[Data-page="5"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet[Data-page="6"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet[Data-page="7"]{
  height:100px;
  width:100%;
}
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelcategory_ctrl {
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labellat_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelclass_catkey_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labeltarget2_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labellng_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelserie_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelclass_x_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluehie_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelclass_y_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluedep2_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelclass_cls_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelseriexyz_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelclass_z_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .arrowRight_ctrl {
  box-sizing:border-box;
  z-index:13;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelkeyxyz_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluez_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluex_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluey_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelmultikeyxyz_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelrangexyz_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelname_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelnamesub_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluegeo_1_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelseriegeo_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvalue_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluegeo_2_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelrange_ctrl {
  box-sizing:border-box;
  z-index:3;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelmultikey_ctrl {
  box-sizing:border-box;
  z-index:3;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelrangegeo_ctrl {
  box-sizing:border-box;
  z-index:3;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelmultikeygeo_ctrl {
  box-sizing:border-box;
  z-index:3;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelkey_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .icon_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .iconxyz_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .icongeo_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelsource_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labeltarget_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelvaluedep_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .arrowLeft_ctrl {
  box-sizing:border-box;
  z-index:13;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelsource2_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelcategoryhie_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labelclass_cat_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.SPChartTooltips_portlet > .SPChartTooltips_page > .labeldesc_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"SPChartTooltips","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp-system/SPChartTooltips_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','SPChartTooltips','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
...
<div id='<%=idPortlet%>_container' class='SPChartTooltips_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='SPChartTooltips_portlet portlet'Data-page='1' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('SPChartTooltips','<%=idPortlet%>',false,'');
</script><%}}%>
<div id='<%=idPortlet%>_page_1' class='SPChartTooltips_page' style='display:block'>
...
<span id='<%=idPortlet%>_labelmultikey'  formid='<%=idPortlet%>' ps-name='labelmultikey'    class='labelTP labelmultikey_ctrl'><div id='<%=idPortlet%>_labelmultikeytbl' style='width:100%;'></div></span>
...
<div id='<%=idPortlet%>_page_2' class='SPChartTooltips_page' style='display:none'>
...
<div id='<%=idPortlet%>_page_3' class='SPChartTooltips_page' style='display:none'>
...
<div id='<%=idPortlet%>_page_4' class='SPChartTooltips_page' style='display:none'>
...
<div id='<%=idPortlet%>_page_5' class='SPChartTooltips_page' style='display:none'>
...
<div id='<%=idPortlet%>_page_6' class='SPChartTooltips_page' style='display:none'>
...
<div id='<%=idPortlet%>_page_7' class='SPChartTooltips_page' style='display:none'>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','SPChartTooltips');
<%!
...
final boolean isMainTabsForAltUI = com__zucchetti__sitepainter__altinterface__url != null && com__zucchetti__sitepainter__altinterface__url.contains("/SPChartTooltips_portlet.jsp");
%>
...
ZtVWeb.newForm(this,'<%=idPortlet%>','SPChartTooltips',["250","250","250","250","250","250","250"],["100"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','','true',{},false,false,7,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"250","h":"100","title":"category","layer":"false","npage":"1"},{"layout_steps_values":{},"w":"250","h":"100","title":"xyz","layer":"false","npage":"2"},{"layout_steps_values":{},"w":"250","h":"100","title":"geo","layer":"false","npage":"3"},{"layout_steps_values":{},"w":"250","h":"100","title":"hie","layer":"false","npage":"4"},{"layout_steps_values":{},"w":"250","h":"100","title":"dep","layer":"false","npage":"5"},{"layout_steps_values":{},"w":"250","h":"100","title":"classif","layer":"false","npage":"6"},{"layout_steps_values":{},"w":"250","h":"100","title":"marker","layer":"false","npage":"7"}]);
this.labelcategory=new ZtVWeb._LC(this,{"align":"","anchor":"top-left-bottom","assoc_input":"","calculate":"","class_Css":"labelTP","create_undercond":"","ctrlid":"<%=idPortlet%>_labelcategory","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":false,"field":"","font":"","font_color":"","font_size":"","font_weight":"","fontpct":"","h":15,"heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layer":false,"layout_steps_values":{},"n_col":1,"name":"labelcategory","nowrap":"false","page":1,"picture":"","sanitize":"","sanitize_tags":"","server_side":"","shrinkable":"","spuid":"","tabindex":"","target":"","template":"","text":"<%=JSPLib.ToJSValue(labelcategory,false,true)%>","type":"Label","w":218,"x":5,"y":5,"zindex":"1"});
...
this.labelvalue=new ZtVWeb._LC(this,{"align":"left","anchor":"top-left-bottom","assoc_input":"","calculate":"","class_Css":"labelTP","create_undercond":"","ctrlid":"<%=idPortlet%>_labelvalue","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":false,"field":"","font":"","font_color":"","font_size":"","font_weight":"","fontpct":"","h":15,"heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layer":false,"layout_steps_values":{},"n_col":1,"name":"labelvalue","nowrap":"false","page":1,"picture":"","sanitize":"","sanitize_tags":"","server_side":"","shrinkable":"","spuid":"","tabindex":"","target":"","template":"","text":"<%=JSPLib.ToJSValue(labelvalue,false,true)%>","type":"Label","w":65,"x":160,"y":35,"zindex":"2"});
...
this.labelrange=new ZtVWeb._LC(this,{"align":"","anchor":"top-left-bottom","assoc_input":"","calculate":"","class_Css":"labelTP","create_undercond":"","ctrlid":"<%=idPortlet%>_labelrange","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":false,"field":"","font":"","font_color":"","font_size":"","font_weight":"","fontpct":"","h":15,"heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layer":false,"layout_steps_values":{},"n_col":1,"name":"labelrange","nowrap":"false","page":1,"picture":"","sanitize":"","sanitize_tags":"","server_side":"","shrinkable":"","spuid":"","tabindex":"","target":"","template":"","text":"<%=JSPLib.ToJSValue(labelrange,false,true)%>","type":"Label","w":220,"x":5,"y":50,"zindex":"3"});
this.labelmultikey=new ZtVWeb._LC(this,{"align":"","anchor":"top-left-bottom","assoc_input":"","calculate":"","class_Css":"labelTP","create_undercond":"","ctrlid":"<%=idPortlet%>_labelmultikey","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":false,"field":"","font":"","font_color":"","font_size":"","font_weight":"","fontpct":"","h":15,"heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layer":false,"layout_steps_values":{},"n_col":1,"name":"labelmultikey","nowrap":"false","page":1,"picture":"","sanitize":"","sanitize_tags":"","server_side":"","shrinkable":"","spuid":"","tabindex":"","target":"","template":"","text":"<%=JSPLib.ToJSValue(labelmultikey,false,true)%>","type":"Label","w":220,"x":5,"y":65,"zindex":"3"});
...
<%if(request.getAttribute("SPChartTooltips_firstinclusion")==null){%>
<script src='<%=JSPLib.getJSPSelfPath(request)%>?SpStaticCode=<%=m_cJSPUID%>'></script>
<%request.setAttribute("SPChartTooltips_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.SPChartTooltips_Static.call(window.<%=idPortlet%>);
...
ZtVWeb.addPortletObj('<%=idPortlet%>','SPChartTooltips',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'SPChartTooltips');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("SPChartTooltips");
}%>
<%! public String getJSPUID() { return "3849405944"; } %>