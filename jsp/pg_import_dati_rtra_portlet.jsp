...
%>
window.pg_import_dati_rtra_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_import_dati_rtra_container {
  height:100%;
  overflow:auto;
}
.pg_import_dati_rtra_title_container {
  margin: auto;
}
.pg_import_dati_rtra_portlet{
  position:relative;
  margin: auto;
  width:100%;
  min-width:851px;
...
.pg_import_dati_rtra_portlet[Data-page="1"]{
  height:100%;
  width:100%;
}
.pg_import_dati_rtra_portlet > .nomefile_ctrl {
...
.pg_import_dati_rtra_portlet > .nomefile_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:Verdana;
...
.pg_import_dati_rtra_portlet > .PortletLogs_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .label1_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .image5_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .rDest_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .listaFile_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .Label18_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .cTipo_ctrl {
  box-sizing:border-box;
  z-index:8;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .cErrAUI_ctrl {
  box-sizing:border-box;
  z-index:8;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .cImpAna_ctrl {
  box-sizing:border-box;
  z-index:8;
  position:absolute;
  display:inline-block;
...
.pg_import_dati_rtra_portlet > .cGData_ctrl {
  box-sizing:border-box;
  z-index:8;
  position:absolute;
  display:inline-block;
...
void PrintWireFrame(String containerId, java.io.Writer out) throws java.lang.Throwable {
 String def="[{\"h\":\"430\",\"layout_steps_values\":{},\"pages_names\":\"\",\"steps\":\"\",\"title\":\"default\",\"type\":\"Form\",\"v_line\":\"851\",\"w\":\"100%\",\"wizard\":\"\"},{\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"nomefile\",\"page\":\"1\",\"type\":\"Textbox\",\"w\":\"750\",\"x\":\"64\",\"y\":\"11\",\"zindex\":\"1\"},{\"anchor\":\"top-left(%)-right(%)-bottom\",\"h\":\"90\",\"layout_steps_values\":{},\"name\":\"PortletLogs\",\"page\":\"1\",\"type\":\"Portlet\",\"w\":\"850\",\"x\":\"0\",\"y\":\"340\",\"zindex\":\"6\"},{\"align\":\"right\",\"anchor\":\"\",\"h\":\"19\",\"layout_steps_values\":{},\"n_col\":\"1\",\"name\":\"label1\",\"page\":\"1\",\"type\":\"Label\",\"value\":\"NomeFile:\",\"w\":\"51\",\"x\":\"8\",\"y\":\"14\",\"zindex\":\"1\"},{\"h\":\"20\",\"name\":\"RTUpload\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"86\",\"x\":\"88\",\"y\":\"-63\"},{\"h\":\"20\",\"name\":\"RTSalva\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"77\",\"x\":\"1\",\"y\":\"-63\"},{\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"image5\",\"page\":\"1\",\"type\":\"Image\",\"w\":\"20\",\"x\":\"820\",\"y\":\"9\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"23\",\"layout_steps_values\":{},\"name\":\"rDest\",\"page\":\"1\",\"type\":\"Radio\",\"w\":\"188\",\"x\":\"146\",\"y\":\"44\",\"zindex\":\"2\"},{\"anchor\":\"\",\"h\":\"202\",\"layout_steps_values\":{},\"name\":\"listaFile\",\"page\":\"1\",\"type\":\"Portlet\",\"w\":\"850\",\"x\":\"0\",\"y\":\"136\",\"zindex\":\"6\"},{\"align\":\"right\",\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"n_col\":\"1\",\"name\":\"Label18\",\"page\":\"1\",\"type\":\"Label\",\"value\":\"Destinazione Dati:\",\"w\":\"129\",\"x\":\"15\",\"y\":\"46\",\"zindex\":\"7\"},{\"h\":\"30\",\"name\":\"Event_filename\",\"page\":\"1\",\"type\":\"EventReceiver\",\"w\":\"111\",\"x\":\"179\",\"y\":\"-70\"},{\"h\":\"20\",\"name\":\"dir\",\"page\":\"1\",\"type\":\"Variable\",\"w\":\"42\",\"x\":\"297\",\"y\":\"-59\"},{\"h\":\"20\",\"name\":\"RTSaveFile\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"120\",\"x\":\"502\",\"y\":\"-63\"},{\"h\":\"20\",\"name\":\"RTDownload\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"120\",\"x\":\"729\",\"y\":\"-63\"},{\"anchor\":\"\",\"h\":\"20\",\"label_text\":\"Esegui solo controlli tipo G\",\"layout_steps_values\":{},\"name\":\"cTipo\",\"page\":\"1\",\"type\":\"Checkbox\",\"w\":\"216\",\"x\":\"17\",\"y\":\"74\",\"zindex\":\"8\"},{\"anchor\":\"\",\"h\":\"20\",\"label_text\":\"Genera solo file errori AUI\",\"layout_steps_values\":{},\"name\":\"cErrAUI\",\"page\":\"1\",\"type\":\"Checkbox\",\"w\":\"216\",\"x\":\"255\",\"y\":\"74\",\"zindex\":\"8\"},{\"anchor\":\"\",\"h\":\"20\",\"label_text\":\"Importa solo dati Anagrafici\",\"layout_steps_values\":{},\"name\":\"cImpAna\",\"page\":\"1\",\"type\":\"Checkbox\",\"w\":\"216\",\"x\":\"493\",\"y\":\"74\",\"zindex\":\"8\"},{\"anchor\":\"\",\"h\":\"20\",\"label_text\":\"Non eseguire controllo data su controlli di tipo G\",\"layout_steps_values\":{},\"name\":\"cGData\",\"page\":\"1\",\"type\":\"Checkbox\",\"w\":\"454\",\"x\":\"17\",\"y\":\"103\",\"zindex\":\"8\"}]";
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_import_dati_rtra","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_import_dati_rtra_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_import_dati_rtra','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%String nomefile= "";
if(request.getAttribute("pg_import_dati_rtra_firstinclusion")==null){
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_import_dati_rtra_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_import_dati_rtra_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_import_dati_rtra_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_import_dati_rtra','<%=idPortlet%>',false,'');
</script><%}}%>
...
<div id='<%=idPortlet%>_cTipo_div' style=''><input id='<%=idPortlet%>_cTipo' name='cTipo' class='slider checkbox' style='vertical-align:middle' type='checkbox' /><label for='<%=idPortlet%>_cTipo' class='label' style:'vertical-align:middle;'><%=JSPLib.ToHTML("Esegui solo controlli tipo G")%></label></div>
<div id='<%=idPortlet%>_cErrAUI_div' style=''><input id='<%=idPortlet%>_cErrAUI' name='cErrAUI' class='slider checkbox' style='vertical-align:middle' type='checkbox' /><label for='<%=idPortlet%>_cErrAUI' class='label' style:'vertical-align:middle;'><%=JSPLib.ToHTML("Genera solo file errori AUI")%></label></div>
...
<div id='<%=idPortlet%>_cGData_div' style=''><input id='<%=idPortlet%>_cGData' name='cGData' class='slider checkbox' style='vertical-align:middle' type='checkbox' /><label for='<%=idPortlet%>_cGData' class='label' style:'vertical-align:middle;'><%=JSPLib.ToHTML("Non eseguire controllo data su controlli di tipo G")%></label></div>
</div>
</div>
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_import_dati_rtra');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_import_dati_rtra',["851"],["430"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','<%=m_cTITLEUID%>','',{},false,true,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"851","h":"430","title":"","layer":""}]);
...
this.PortletLogs_ctrl=new ZtVWeb.PortletCtrl(this,{"anchor":"top-left(%)-right(%)-bottom","ctrlid":"<%=idPortlet%>_PortletLogs","h":90,"hide":"false","layer":false,"layout_steps_values":{},"name":"PortletLogs","page":1,"portlet_id":"<%=idPortlet%>_13wmc2x","spuid":"","type":"Portlet","w":850,"x":0,"y":340,"zindex":"6"});
} else {
...
this.listaFile_ctrl=new ZtVWeb.PortletCtrl(this,{"anchor":"top-left(%)-right(%)","ctrlid":"<%=idPortlet%>_listaFile","h":202,"hide":"false","layer":false,"layout_steps_values":{},"name":"listaFile","page":1,"portlet_id":"<%=idPortlet%>_1esm17j","spuid":"","type":"Portlet","w":850,"x":0,"y":136,"zindex":"6"});
} else {
...
this.RTSaveFile=new ZtVWeb.SPLinkerCtrl(this,{"action":"function","allowedEntities":"<%=JSPLib.encrypt("arfn_upload_file_doc",request,"xxxx")%>","anchor":"","async":false,"check_exp":"","ctrlid":"<%=idPortlet%>_RTSaveFile","decrypted_parms":"","entity_type":"routine","force_msg_id":false,"h":20,"hide":"false","layer":false,"layout_steps_values":{},"m_cAltInterface":"","name":"RTSaveFile","offline":false,"page":1,"parms":"pNomeFile=nomefile,pDirDest=appo,pFileTmp=S","popup":"false","popup_height":"","popup_maximized":"false","popup_scroll":"false","popup_style":"by skin","popup_width":"","progressbar":false,"refresh":"","servlet":"arfn_upload_file_doc","target":"","type":"SPLinker","w":120,"x":502,"y":-63});
this.RTSaveFile.m_cID='<%=JSPLib.cmdHash("routine,arfn_upload_file_doc",request.getSession())%>';
this.RTDownload=new ZtVWeb.SPLinkerCtrl(this,{"action":"","allowedEntities":"<%=JSPLib.encrypt("../jsp/pg_scarti_import_portlet.jsp",request,"xxxx")%>","anchor":"","async":false,"check_exp":"","ctrlid":"<%=idPortlet%>_RTDownload","decrypted_parms":"","entity_type":"","force_msg_id":false,"h":20,"hide":"false","layer":false,"layout_steps_values":{},"m_cAltInterface":"","name":"RTDownload","offline":false,"page":1,"parms":"","popup":"true","popup_height":"","popup_maximized":"false","popup_scroll":"false","popup_style":"by skin","popup_width":"","progressbar":false,"refresh":"","servlet":"..\u002fjsp\u002fpg_scarti_import_portlet.jsp","target":"","type":"SPLinker","w":120,"x":729,"y":-63});
this.RTDownload.m_cID='<%=JSPLib.cmdHash("entity,../jsp/pg_scarti_import_portlet.jsp",request.getSession())%>';
this.cTipo=new ZtVWeb.CheckboxCtrl(this,{"anchor":"top-left(%)-right(%)","calculate":"","checked_value":"G","create_undercond":"","css_class":"label","css_class_input":"slider checkbox","ctrlid":"<%=idPortlet%>_cTipo","decrypt":false,"edit_undercond":"","encrypt":false,"field":"","h":20,"hide":"false","hide_undercond":"","init":"","init_par":"I","label_text":"Esegui solo controlli tipo G","layer":false,"layout_steps_values":{},"name":"cTipo","page":1,"reactive":false,"server_side":"","spuid":"","style_type":"slider","tabindex":"","type":"Checkbox","typevar":"character","unchecked_value":"I","w":216,"x":17,"y":74,"zindex":"8"});
this.cTipo.Value('<%=cTipo%>');
this.cErrAUI=new ZtVWeb.CheckboxCtrl(this,{"anchor":"top-left(%)-right(%)","calculate":"","checked_value":"S","create_undercond":"","css_class":"label","css_class_input":"slider checkbox","ctrlid":"<%=idPortlet%>_cErrAUI","decrypt":false,"edit_undercond":"","encrypt":false,"field":"","h":20,"hide":"false","hide_undercond":"","init":"","init_par":"N","label_text":"Genera solo file errori AUI","layer":false,"layout_steps_values":{},"name":"cErrAUI","page":1,"reactive":false,"server_side":"","spuid":"","style_type":"slider","tabindex":"","type":"Checkbox","typevar":"character","unchecked_value":"N","w":216,"x":255,"y":74,"zindex":"8"});
this.cErrAUI.Value('<%=cErrAUI%>');
this.cImpAna=new ZtVWeb.CheckboxCtrl(this,{"anchor":"top-left(%)-right(%)","calculate":"","checked_value":"S","create_undercond":"","css_class":"label","css_class_input":"slider checkbox","ctrlid":"<%=idPortlet%>_cImpAna","decrypt":false,"edit_undercond":"","encrypt":false,"field":"","h":20,"hide":"false","hide_undercond":"","init":"","init_par":"N","label_text":"Importa solo dati Anagrafici","layer":false,"layout_steps_values":{},"name":"cImpAna","page":1,"reactive":false,"server_side":"","spuid":"","style_type":"slider","tabindex":"","type":"Checkbox","typevar":"character","unchecked_value":"N","w":216,"x":493,"y":74,"zindex":"8"});
this.cImpAna.Value('<%=cImpAna%>');
this.cGData=new ZtVWeb.CheckboxCtrl(this,{"anchor":"top-left(%)-right(%)","calculate":"","checked_value":"S","create_undercond":"","css_class":"label","css_class_input":"slider checkbox","ctrlid":"<%=idPortlet%>_cGData","decrypt":false,"edit_undercond":"","encrypt":false,"field":"","h":20,"hide":"false","hide_undercond":"","init":"","init_par":"N","label_text":"Non eseguire controllo data su controlli di tipo G","layer":false,"layout_steps_values":{},"name":"cGData","page":1,"reactive":false,"server_side":"","spuid":"","style_type":"slider","tabindex":"","type":"Checkbox","typevar":"character","unchecked_value":"N","w":454,"x":17,"y":103,"zindex":"8"});
this.cGData.Value('<%=cGData%>');
<%if(!Library.Empty(PageletId) ){%>
...
<%request.setAttribute("pg_import_dati_rtra_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_import_dati_rtra_Static.call(window.<%=idPortlet%>);
...
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_import_dati_rtra',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_import_dati_rtra');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_import_dati_rtra");
}%>
<%! public String getJSPUID() { return "1381254894"; } %>