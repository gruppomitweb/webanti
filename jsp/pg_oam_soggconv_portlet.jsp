...
%>
window.pg_oam_soggconv_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_oam_soggconv_container {
  height:100%;
  overflow:auto;
}
.pg_oam_soggconv_title_container {
  margin: auto;
}
.pg_oam_soggconv_portlet{
  position:relative;
  margin: auto;
  width:100%;
  min-width:800px;
...
.pg_oam_soggconv_portlet[Data-page="1"]{
  height:100%;
  width:100%;
}
.pg_oam_soggconv_portlet > .PortletLogs_ctrl {
...
.pg_oam_soggconv_portlet > .anno_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_oam_soggconv_portlet > .anno_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:Verdana;
...
.pg_oam_soggconv_portlet > .lblAnno_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_oam_soggconv_portlet > .semestre_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_oam_soggconv_portlet > .lblMese_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_oam_soggconv_portlet > .iPrint_ctrl {
  box-sizing:border-box;
  z-index:9;
  position:absolute;
  display:inline-block;
...
.pg_oam_soggconv_portlet > .chkPrimo_ctrl {
  box-sizing:border-box;
  z-index:10;
  position:absolute;
  display:inline-block;
...
void PrintWireFrame(String containerId, java.io.Writer out) throws java.lang.Throwable {
 String def="[{\"h\":\"275\",\"layout_steps_values\":{},\"pages_names\":\"\",\"steps\":\"\",\"title\":\"default\",\"type\":\"Form\",\"v_line\":\"800\",\"w\":\"100%\",\"wizard\":\"\"},{\"h\":\"20\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"119\",\"x\":\"820\",\"y\":\"23\"},{\"anchor\":\"top-left(%)-right(%)-bottom\",\"h\":\"80\",\"layout_steps_values\":{},\"page\":\"1\",\"type\":\"Portlet\",\"w\":\"800\",\"x\":\"0\",\"y\":\"195\",\"zindex\":\"3\"},{\"anchor\":\"top-left\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"anno\",\"page\":\"1\",\"type\":\"Textbox\",\"w\":\"53\",\"x\":\"164\",\"y\":\"15\",\"zindex\":\"1\"},{\"align\":\"right\",\"anchor\":\"top-left\",\"h\":\"19\",\"layout_steps_values\":{},\"n_col\":\"1\",\"name\":\"lblAnno\",\"page\":\"1\",\"type\":\"Label\",\"value\":\"Anno di riferimento:\",\"w\":\"155\",\"x\":\"7\",\"y\":\"16\",\"zindex\":\"1\"},{\"anchor\":\"top-left\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"semestre\",\"page\":\"1\",\"textlist\":\"I Semestre,II Semestre\",\"type\":\"Combobox\",\"w\":\"212\",\"x\":\"309\",\"y\":\"15\",\"zindex\":\"1\"},{\"align\":\"right\",\"anchor\":\"top-left\",\"h\":\"19\",\"layout_steps_values\":{},\"n_col\":\"1\",\"name\":\"lblMese\",\"page\":\"1\",\"type\":\"Label\",\"value\":\"Semestre:\",\"w\":\"82\",\"x\":\"224\",\"y\":\"16\",\"zindex\":\"1\"},{\"anchor\":\"top-left-right\",\"h\":\"150\",\"layout_steps_values\":{},\"name\":\"iPrint\",\"page\":\"1\",\"type\":\"Iframe\",\"w\":\"800\",\"x\":\"0\",\"y\":\"43\",\"zindex\":\"9\"},{\"h\":\"20\",\"name\":\"RTDown\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"119\",\"x\":\"820\",\"y\":\"-31\"},{\"h\":\"20\",\"name\":\"filename\",\"page\":\"1\",\"type\":\"Variable\",\"w\":\"120\",\"x\":\"823\",\"y\":\"76\"},{\"h\":\"20\",\"name\":\"RTDownload\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"116\",\"x\":\"821\",\"y\":\"-6\"},{\"anchor\":\"top-left\",\"h\":\"20\",\"label_text\":\"Effettua come primo invio\",\"layout_steps_values\":{},\"name\":\"chkPrimo\",\"page\":\"1\",\"type\":\"Checkbox\",\"w\":\"206\",\"x\":\"571\",\"y\":\"15\",\"zindex\":\"10\"}]";
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_oam_soggconv","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_oam_soggconv_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_oam_soggconv','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%double anno= 0;
if(request.getAttribute("pg_oam_soggconv_firstinclusion")==null){
 if (Library.IsMobile(request)) {%><link rel='prefetch' as='script' id='controls.js' href='../<%=SPPrxycizer.proxycizedPath("controls.js") %>'>
<link rel='prefetch' as='script' id='calculator.mobile.js' href='../<%=SPPrxycizer.proxycizedPath(sp.getSkin()+"/calculator.mobile.js") %>'>
<% } %><%}
String lblAnno= "Anno di riferimento:";
double semestre= 0;
String lblMese= "Semestre:";
String filename= "";
String chkPrimo="N";
try{
if(!included){%>
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_oam_soggconv_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_oam_soggconv_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_oam_soggconv_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_oam_soggconv','<%=idPortlet%>',false,'');
</script><%}}%>
...
<select id='<%=idPortlet%>_semestre' name='semestre' class='combobox' style=''></select>
<span id='<%=idPortlet%>_lblMese'  formid='<%=idPortlet%>' ps-name='lblMese'    class='label lblMese_ctrl'><div id='<%=idPortlet%>_lblMesetbl' style='width:100%;'><%=JSPLib.ToHTML("Semestre:")%></div></span>
<div id='<%=idPortlet%>_iPrint_DIV'>&nbsp;</div>
<div id='<%=idPortlet%>_chkPrimo_div' style=''><input id='<%=idPortlet%>_chkPrimo' name='chkPrimo' class='checkbox' style='vertical-align:middle' type='checkbox' /><label for='<%=idPortlet%>_chkPrimo' class='label' style:'vertical-align:middle;'><%=JSPLib.ToHTML("Effettua come primo invio")%></label></div>
</div>
</div>
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_oam_soggconv');
<%!
...
out.write("ZtVWeb.AddTranslation("+JSPLib.ToJSValue("Crea il file dei Soggetti Convenzionati",true)+","+JSPLib.ToJSValue(sp.translate("Crea il file dei Soggetti Convenzionati"),true)+");\n");
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_oam_soggconv',["800"],["275"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','<%=m_cTITLEUID%>','',{},false,true,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"800","h":"275","title":"","layer":""}]);
this.RTExec=new ZtVWeb.SPLinkerCtrl(this,{"action":"function","allowedEntities":"<%=JSPLib.encrypt("arfn_oam_soggconv_xml",request,"xxxx")%>","anchor":"","async":true,"check_exp":"","ctrlid":"<%=idPortlet%>_RTExec","decrypted_parms":"","entity_type":"routine","force_msg_id":false,"h":20,"hide":"false","layer":false,"layout_steps_values":{},"m_cAltInterface":"","name":"RTExec","offline":false,"page":1,"parms":"pAnno=anno,pSem=semestre,pPrimo=chkPrimo","popup":"false","popup_height":"","popup_maximized":"false","popup_scroll":"false","popup_style":"by skin","popup_width":"","progressbar":false,"refresh":"","servlet":"arfn_oam_soggconv_xml","target":"","type":"SPLinker","w":119,"x":820,"y":23});
this.RTExec.m_cID='<%=JSPLib.cmdHash("routine,arfn_oam_soggconv_xml",request.getSession())%>';
...
this.semestre=new ZtVWeb.ComboboxCtrl(this,{"anchor":"top-left","calculate":"","class_Css":"combobox","create_undercond":"","ctrlid":"<%=idPortlet%>_semestre","dataobj_value":"","decrypt":false,"disabled":false,"edit_undercond":"","empty_value":false,"encrypt":false,"field":"","font":"","font_size":"","h":20,"help_tips":"","hide":"false","hide_undercond":"","init":"","init_par":"<%=semestre%>","isdatap":false,"layer":false,"layout_steps_values":{},"name":"semestre","page":1,"picture":"","reactive":false,"server_side":"","spuid":"","tabindex":"","textlist":"I Semestre,II Semestre","type":"Combobox","typevar":"numeric","valuelist":"1,2","visible":true,"w":212,"x":309,"y":15,"zindex":"1"});
...
this.iPrint=new ZtVWeb.IframeCtrl(this,{"anchor":"top-left-right","auto_resize":"false","border":"","ctrlid":"<%=idPortlet%>_iPrint","default_portlet":"","h":150,"hide":"false","layer":false,"layout_steps_values":{},"name":"iPrint","name_iframe":"iPrint","page":1,"spuid":"","type":"Iframe","w":800,"x":0,"y":43,"zindex":"9"});
...
this.chkPrimo=new ZtVWeb.CheckboxCtrl(this,{"anchor":"top-left","calculate":"","checked_value":"S","create_undercond":"","css_class":"label","css_class_input":"checkbox","ctrlid":"<%=idPortlet%>_chkPrimo","decrypt":false,"edit_undercond":"","encrypt":false,"field":"","h":20,"hide":"false","hide_undercond":"","init":"","init_par":"N","label_text":"Effettua come primo invio","layer":false,"layout_steps_values":{},"name":"chkPrimo","page":1,"reactive":false,"server_side":"","spuid":"","style_type":"","tabindex":"","type":"Checkbox","typevar":"character","unchecked_value":"N","w":206,"x":571,"y":15,"zindex":"10"});
this.chkPrimo.Value('<%=chkPrimo%>');
<%if(!Library.Empty(PageletId) ){%>
...
<%request.setAttribute("pg_oam_soggconv_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_oam_soggconv_Static.call(window.<%=idPortlet%>);
window.<%=idPortlet%>.semestre.FillData();
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_oam_soggconv',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_oam_soggconv');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_oam_soggconv");
}%>
<%! public String getJSPUID() { return "1551914065"; } %>