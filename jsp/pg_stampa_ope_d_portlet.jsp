...
%>
window.pg_stampa_ope_d_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_stampa_ope_d_container {
}
.pg_stampa_ope_d_title_container {
  margin: auto;
}
.pg_stampa_ope_d_portlet{
  position:relative;
  margin: auto;
  width:100%;
max-width:1024px;
...
.pg_stampa_ope_d_portlet[Data-page="1"]{
  height:620px;
  width:100%;
}
.pg_stampa_ope_d_portlet > .Textbox_dadata_reg_ctrl {
...
.pg_stampa_ope_d_portlet > .Textbox_dadata_reg_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .Textbox_adata_reg_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Textbox_adata_reg_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .Calendario_dadata_reg_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Calendario_adata_reg_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .dacodcli_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .dacodcli_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .LinkZoom10_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .daragsoc_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .daragsoc_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .a_codcli_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .a_codcli_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .LinkZoom12_ctrl {
  box-sizing:border-box;
  z-index:8;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .a_ragsoc_ctrl {
  box-sizing:border-box;
  z-index:9;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .a_ragsoc_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .dacoddest_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .dacoddest_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .LinkZoom10_Copy_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .daragdest_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .daragdest_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .a_coddest_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .a_coddest_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .LinkZoom12_Copy_ctrl {
  box-sizing:border-box;
  z-index:8;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .a_ragdest_ctrl {
  box-sizing:border-box;
  z-index:9;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .a_ragdest_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stampa_ope_d_portlet > .prnAnalitica_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Label14_Copy_Copy_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Label14_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Label_data_reg_ctrl {
  box-sizing:border-box;
  z-index:23;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Box_data_reg_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Box_data_reg_ctrl > .box_content {
  height:100%;
}
.pg_stampa_ope_d_portlet > .Box_data_reg_ctrl {
  min-height:111px;
...
.pg_stampa_ope_d_portlet > .Label14_Copy_Copy_Copy_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .btnExit_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Ope_Print_ctrl {
  box-sizing:border-box;
  z-index:26;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .flgtit_ctrl {
  box-sizing:border-box;
  z-index:27;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .ShowMsg_ctrl {
  box-sizing:border-box;
  z-index:28;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .ShowLog_ctrl {
  box-sizing:border-box;
  z-index:28;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .prnSintetica_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stampa_ope_d_portlet > .Label14_Copy_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_stampa_ope_d","UTF-8")) {return; }
 %><%if(!sp.isLogged()){%>
<script>
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_stampa_ope_d_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_stampa_ope_d','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%java.sql.Date Textbox_dadata_reg= JSPLib.NullDate();
if(request.getAttribute("pg_stampa_ope_d_firstinclusion")==null){
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_stampa_ope_d_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_stampa_ope_d_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_stampa_ope_d_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_stampa_ope_d','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_stampa_ope_d');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_stampa_ope_d',["900"],["620"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','<%=m_cTITLEUID%>','',{},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"900","h":"620","title":"Stampa con Dettaglio","layer":"false","npage":"1"}]);
...
<%request.setAttribute("pg_stampa_ope_d_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_stampa_ope_d_Static.call(window.<%=idPortlet%>);
...
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_stampa_ope_d',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_stampa_ope_d');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%! public String getJSPUID() { return "298373247"; } %>