...
%>
window.pg_rapporti_702_202501_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_rapporti_702_202501_container {
}
.pg_rapporti_702_202501_portlet{
  position:relative;
  width:951px;
  min-width:951px;
  height:700px;
}
.pg_rapporti_702_202501_portlet[Data-page="1"]{
  height:700px;
  width:951px;
}
.pg_rapporti_702_202501_portlet > .Grid0_ctrl {
...
.pg_rapporti_702_202501_portlet > .label2_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .label2_Copy_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .label2_Copy_Copy_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .label7_Copy_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .button12_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .Conferma_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .passwd_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_rapporti_702_202501_portlet > .passwd_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:verdana;
...
.pg_rapporti_702_202501_portlet > .Portlet13_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
void PrintWireFrame(String containerId, java.io.Writer out) throws java.lang.Throwable {
 String def="[{\"h\":\"700\",\"pages_names\":\"Abbina Rapporti 6.02 con Rapporti 2.02\\u002f5.01\",\"title\":\"\",\"type\":\"Form\",\"v_line\":\"\",\"w\":\"951\"},{\"anchor\":\"\",\"h\":\"422\",\"page\":\"1\",\"type\":\"Grid\",\"w\":\"951\",\"x\":\"0\",\"y\":\"246\"},{\"page\":\"1\",\"type\":\"SQLDataobj\",\"x\":\"3\",\"y\":\"93\"},{\"anchor\":\"\",\"h\":\"20\",\"page\":\"1\",\"type\":\"Label\",\"w\":\"469\",\"x\":\"482\",\"y\":\"226\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"20\",\"page\":\"1\",\"type\":\"Label\",\"w\":\"464\",\"x\":\"18\",\"y\":\"226\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"25\",\"page\":\"1\",\"type\":\"Label\",\"w\":\"953\",\"x\":\"-1\",\"y\":\"-1\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"19\",\"page\":\"1\",\"type\":\"Label\",\"w\":\"73\",\"x\":\"-1\",\"y\":\"49\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"20\",\"page\":\"1\",\"type\":\"Button\",\"w\":\"65\",\"x\":\"214\",\"y\":\"45\"},{\"anchor\":\"\",\"h\":\"20\",\"page\":\"1\",\"type\":\"Button\",\"w\":\"75\",\"x\":\"870\",\"y\":\"45\"},{\"anchor\":\"\",\"h\":\"20\",\"page\":\"1\",\"type\":\"Textbox\",\"w\":\"130\",\"x\":\"74\",\"y\":\"45\",\"zindex\":\"1\"},{\"h\":\"30\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"30\",\"x\":\"908\",\"y\":\"186\"},{\"anchor\":\"\",\"h\":\"128\",\"page\":\"1\",\"type\":\"Portlet\",\"w\":\"810\",\"x\":\"70\",\"y\":\"88\"},{\"h\":\"30\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"30\",\"x\":\"906\",\"y\":\"137\"},{\"h\":\"20\",\"page\":\"1\",\"type\":\"Variable\",\"w\":\"130\",\"x\":\"3\",\"y\":\"678\"}]";
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_rapporti_702_202501","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_rapporti_702_202501_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_rapporti_702_202501','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%if(request.getAttribute("pg_rapporti_702_202501_firstinclusion")==null){
...
<%String label2= "Deleghe 2.02 / 5.01";
String label2_Copy= "Deleghe 7.02";
String label2_Copy_Copy= "Abbina Deleghe 7.02 con Deleghe 2.02/5.01";
...
<div id='<%=idPortlet%>_container' class='pg_rapporti_702_202501_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_rapporti_702_202501_portlet undefined' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_rapporti_702_202501','<%=idPortlet%>',false,' ');
</script><%}}%>
...
<%}%>
<span id='<%=idPortlet%>_label2'  formid='<%=idPortlet%>' ps-name='label2'    class='label label2_ctrl'><div id='<%=idPortlet%>_label2tbl' style='width:100%;'><%=JSPLib.ToHTML("Deleghe 2.02 / 5.01")%></div></span>
<span id='<%=idPortlet%>_label2_Copy'  formid='<%=idPortlet%>' ps-name='label2_Copy'    class='label label2_Copy_ctrl'><div id='<%=idPortlet%>_label2_Copytbl' style='width:100%;'><%=JSPLib.ToHTML("Deleghe 7.02")%></div></span>
<span id='<%=idPortlet%>_label2_Copy_Copy'  formid='<%=idPortlet%>' ps-name='label2_Copy_Copy'    class='label label2_Copy_Copy_ctrl'><div id='<%=idPortlet%>_label2_Copy_Copytbl' style='width:100%;'><%=JSPLib.ToHTML("Abbina Deleghe 7.02 con Deleghe 2.02/5.01")%></div></span>
...
<span class='textbox-container'id='<%=idPortlet%>_passwd_wrp'><input id='<%=idPortlet%>_passwd' name='passwd' type='password' class='textbox' formid='<%=idPortlet%>' autocomplete='off' ps-name='passwd' /></span>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_rapporti_702_202501');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_rapporti_702_202501',["951"],["700"],'undefined',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', '','','false',{},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"951","h":"700","title":"Abbina Rapporti 6.02 con Rapporti 2.02\u002f5.01","layer":"false","npage":"1"}]);
...
<%request.setAttribute("pg_rapporti_702_202501_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_rapporti_702_202501_Static.call(window.<%=idPortlet%>);
window.<%=idPortlet%>.Query1.firstQuery('true');
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_rapporti_702_202501',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_rapporti_702_202501');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_rapporti_702_202501");
}%>
<%! public String getJSPUID() { return "1562277763"; } %>