...
%>
window.pg_stplegami_sint_prv_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_stplegami_sint_prv_container {
}
.pg_stplegami_sint_prv_title_container {
  margin: auto;
}
.pg_stplegami_sint_prv_portlet{
  position:relative;
  margin: auto;
  width:100%;
max-width:1024px;
...
.pg_stplegami_sint_prv_portlet[Data-page="1"]{
  height:530px;
  width:100%;
}
.pg_stplegami_sint_prv_portlet > .Textbox_dadata_fin_ctrl {
...
.pg_stplegami_sint_prv_portlet > .Textbox_dadata_fin_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .Calendario_dadata_fin_ctrl {
  box-sizing:border-box;
  z-index:19;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_adata_fin_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_adata_fin_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .Box_data_informazione_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Box_data_informazione_ctrl > .box_content {
  height:100%;
}
.pg_stplegami_sint_prv_portlet > .Box_data_informazione_ctrl {
  min-height:111px;
...
.pg_stplegami_sint_prv_portlet > .Calendario_adata_fin_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Label_data_ope_Copy_ctrl {
  box-sizing:border-box;
  z-index:22;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_dadata_ini_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_dadata_ini_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .Calendario_dadata_ini_ctrl {
  box-sizing:border-box;
  z-index:19;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_adata_ini_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_adata_ini_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .Calendario_adata_ini_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Label_data_ope_ctrl {
  box-sizing:border-box;
  z-index:22;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Ope_Print_ctrl {
  box-sizing:border-box;
  z-index:26;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_daCodCli_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_daCodCli_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .LinkZoom_daCodCli_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_daragsoc_ctrl {
  box-sizing:border-box;
  z-index:3;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_daragsoc_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .Textbox_aCodCli_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_aCodCli_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .LinkZoom_aCodCli_ctrl {
  box-sizing:border-box;
  z-index:5;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_aragsoc_ctrl {
  box-sizing:border-box;
  z-index:6;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Textbox_aragsoc_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_stplegami_sint_prv_portlet > .Box_data_informazione_Copy_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.pg_stplegami_sint_prv_portlet > .Box_data_informazione_Copy_ctrl > .box_content {
  height:100%;
}
.pg_stplegami_sint_prv_portlet > .Box_data_informazione_Copy_ctrl {
  min-height:111px;
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_stplegami_sint_prv","UTF-8")) {return; }
 %><%if(!sp.isLogged()){%>
<script>
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_stplegami_sint_prv_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_stplegami_sint_prv','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%java.sql.Date Textbox_dadata_fin= JSPLib.NullDate();
if(request.getAttribute("pg_stplegami_sint_prv_firstinclusion")==null){
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_stplegami_sint_prv_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_stplegami_sint_prv_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_stplegami_sint_prv_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_stplegami_sint_prv','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_stplegami_sint_prv');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_stplegami_sint_prv',["700"],["530"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','<%=m_cTITLEUID%>','',{},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"700","h":"530","title":"Stampa Elenco Legami (Provvisorio)","layer":"false","npage":"1"}]);
...
<%request.setAttribute("pg_stplegami_sint_prv_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_stplegami_sint_prv_Static.call(window.<%=idPortlet%>);
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_stplegami_sint_prv',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_stplegami_sint_prv');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_stplegami_sint_prv");
}%>
...
<%! public String getJSPUID() { return "2655332779"; } %>