...
%>
window.pg_import_Static=function(){
...
.pg_import_portlet[Data-page="1"]{
  height:380px;
  width:100%;
}
.pg_import_portlet > .nomefile_ctrl {
...
.pg_import_portlet > .nomefile_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:Verdana;
...
.pg_import_portlet > .Label18_Copy_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .rTipoForm_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .btnExit_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .Label18_Copy_Copy_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .PAGMEZ_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  width:100%;
...
.pg_import_portlet > .Label18_Copy_Copy_Copy_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .btnStep_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .Label18_ctrl {
  box-sizing:border-box;
  z-index:7;
  position:absolute;
  display:inline-block;
...
.pg_import_portlet > .rTipoFile_ctrl {
  box-sizing:border-box;
  z-index:2;
  position:absolute;
  display:inline-block;
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_import","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_import_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_import','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%String nomefile= "";
if(request.getAttribute("pg_import_firstinclusion")==null){
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_import_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_import_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_import_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_import','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_import');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_import',["851"],["380"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','<%=m_cTITLEUID%>','',{},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"851","h":"380","title":"","layer":"false","npage":"1"}]);
...
this.pMsg_ctrl=new ZtVWeb.PortletCtrl(this,{"anchor":"top-left(%)-right(%)","ctrlid":"<%=idPortlet%>_pMsg","h":67,"hide":"false","layer":false,"layout_steps_values":{},"name":"pMsg","page":1,"portlet_id":"<%=idPortlet%>_216gh","spuid":"","type":"Portlet","w":851,"x":0,"y":302,"zindex":"3"});
} else {
document.getElementById('<%=idPortlet%>_pMsg').style.display='none';
}
this.btnStep=new ZtVWeb._IC(this,{"alt":"","anchor":"top-right","boundedPosition":"right","class_Css":"image btnStep_ctrl","create_undercond":"","ctrlid":"<%=idPortlet%>_btnStep","edit_undercond":"","field":"","font_color":"","font_color_hover":"","font_image":"&#xe91c;","font_image_hover":"&#xe91d;","font_name":"ZucchettiDevelopement","font_path":"","font_size":"","h":30,"help_tips":"<%=JSPLib.ToJSValue("Esegui l'import dei dati",false,true)%>","hide":"false","hide_undercond":"Eq(this.errimp.Value(),1)","href":"","img_type":"font icon","keepProportions":"bounded","layer":false,"layout_steps_values":{},"name":"btnStep","page":1,"path_type":"","server_side":"","spuid":"","src":"&#xe91c;","srchover":"&#xe91d;","tabindex":"","target":"","type":"Image","type_submit":"false","w":30,"x":737,"y":119,"zindex":"1"});
 ZtVWeb.RequireFont("ZucchettiDevelopement","");
...
<%request.setAttribute("pg_import_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_import_Static.call(window.<%=idPortlet%>);
...
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_import',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_import');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_import");
}%>
<%! public String getJSPUID() { return "1879362227"; } %>