...
%>
window.pg_list_file_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_list_file_container {
}
.pg_list_file_title_container {
  margin: auto;
}
.pg_list_file_portlet{
  position:relative;
  margin: auto;
  width:756px;
  min-width:756px;
...
.pg_list_file_portlet[Data-page="1"]{
  height:472px;
  width:756px;
}
.pg_list_file_portlet > .ListaFile_ctrl {
...
void PrintWireFrame(String containerId, java.io.Writer out) throws java.lang.Throwable {
 String def="[{\"h\":\"472\",\"layout_steps_values\":{},\"pages_names\":\"\",\"steps\":\"\",\"title\":\"default\",\"type\":\"Form\",\"v_line\":\"\",\"w\":\"756\",\"wizard\":\"\"},{\"h\":\"20\",\"page\":\"1\",\"type\":\"SQLDataobj\",\"w\":\"120\",\"x\":\"100\",\"y\":\"-59\"},{\"anchor\":\"top-left-right\",\"checkbox\":\"false\",\"colProperties\":[{\"title\":\"Nome file prodotti\"},{\"title\":\"Seq.\"}],\"h\":\"416\",\"layout_steps_values\":{},\"page\":\"1\",\"rows\":\"15\",\"type\":\"Grid\",\"w\":\"754\",\"x\":\"0\",\"y\":\"0\",\"zindex\":\"\"}]";
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_list_file","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_list_file_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_list_file','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%if(request.getAttribute("pg_list_file_firstinclusion")==null){
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_list_file_title_container' style='width:756px'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_list_file_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_list_file_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_list_file','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_list_file');
<%!
...
<%request.setAttribute("pg_list_file_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_list_file_Static.call(window.<%=idPortlet%>);
window.<%=idPortlet%>.SQLListImp.firstQuery('true');
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_list_file',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_list_file');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_list_file");
}%>
<%! public String getJSPUID() { return "805896325"; } %>