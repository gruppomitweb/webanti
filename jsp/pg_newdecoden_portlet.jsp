...
%>
window.pg_newdecoden_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_newdecoden_container {
}
.pg_newdecoden_title_container {
  margin: auto;
}
.pg_newdecoden_portlet{
  position:relative;
  margin: auto;
  width:851px;
  min-width:851px;
...
.pg_newdecoden_portlet[Data-page="1"]{
  height:73px;
  width:851px;
}
.pg_newdecoden_portlet > .account_ctrl {
...
.pg_newdecoden_portlet > .account_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:Verdana;
...
.pg_newdecoden_portlet > .btnSave_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_newdecoden_portlet > .label1_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_newdecoden_portlet > .coduif_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_newdecoden_portlet > .coduif_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:Verdana;
...
.pg_newdecoden_portlet > .LinkZoom3_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_newdecoden_portlet > .label4_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_newdecoden_portlet > .desuif_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_newdecoden_portlet > .desuif_ctrl > input{
  vertical-align:top;
  box-sizing:border-box;
  z-index:1;
  font-family:Verdana;
...
.pg_newdecoden_portlet > .btnExit_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
void PrintWireFrame(String containerId, java.io.Writer out) throws java.lang.Throwable {
 String def="[{\"h\":\"73\",\"layout_steps_values\":{},\"pages_names\":\"\",\"steps\":\"\",\"title\":\"\",\"type\":\"Form\",\"v_line\":\"\",\"w\":\"851\",\"wizard\":\"\"},{\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"account\",\"page\":\"1\",\"type\":\"Textbox\",\"w\":\"750\",\"x\":\"90\",\"y\":\"11\",\"zindex\":\"1\"},{\"anchor\":\"top-left-right\",\"h\":\"30\",\"layout_steps_values\":{},\"name\":\"btnSave\",\"page\":\"1\",\"type\":\"Image\",\"w\":\"30\",\"x\":\"766\",\"y\":\"37\",\"zindex\":\"1\"},{\"align\":\"right\",\"anchor\":\"\",\"h\":\"19\",\"layout_steps_values\":{},\"n_col\":\"1\",\"name\":\"label1\",\"page\":\"1\",\"type\":\"Label\",\"value\":\"Località:\",\"w\":\"69\",\"x\":\"17\",\"y\":\"14\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"coduif\",\"page\":\"1\",\"type\":\"Textbox\",\"w\":\"41\",\"x\":\"90\",\"y\":\"42\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"LinkZoom3\",\"page\":\"1\",\"type\":\"LinkZoom\",\"w\":\"20\",\"x\":\"132\",\"y\":\"42\",\"zindex\":\"\"},{\"align\":\"right\",\"anchor\":\"\",\"h\":\"19\",\"layout_steps_values\":{},\"n_col\":\"1\",\"name\":\"label4\",\"page\":\"1\",\"type\":\"Label\",\"value\":\"Codice AGE:\",\"w\":\"69\",\"x\":\"17\",\"y\":\"45\",\"zindex\":\"1\"},{\"anchor\":\"\",\"h\":\"20\",\"layout_steps_values\":{},\"name\":\"desuif\",\"page\":\"1\",\"type\":\"Textbox\",\"w\":\"554\",\"x\":\"163\",\"y\":\"42\",\"zindex\":\"1\"},{\"h\":\"30\",\"name\":\"RTSalva\",\"page\":\"1\",\"type\":\"SPLinker\",\"w\":\"30\",\"x\":\"3\",\"y\":\"-33\"},{\"anchor\":\"top-right\",\"h\":\"30\",\"layout_steps_values\":{},\"name\":\"btnExit\",\"page\":\"1\",\"type\":\"Image\",\"w\":\"30\",\"x\":\"807\",\"y\":\"37\",\"zindex\":\"1\"}]";
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_newdecoden","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_newdecoden_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_newdecoden','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%String account= "";
if(request.getAttribute("pg_newdecoden_firstinclusion")==null){
...
<div id='<%=idPortlet%>_container' class='pg_newdecoden_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_newdecoden_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_newdecoden','<%=idPortlet%>',false,'');
</script><%}}%>
...
<span class='textbox-container'id='<%=idPortlet%>_coduif_wrp'><input id='<%=idPortlet%>_coduif' name='coduif' type='text' maxlength='4' class='textbox' formid='<%=idPortlet%>' ps-name='coduif' /></span>
...
<span id='<%=idPortlet%>_label4'  formid='<%=idPortlet%>' ps-name='label4'    class='label label4_ctrl'><div id='<%=idPortlet%>_label4tbl' style='width:100%;'><%=JSPLib.ToHTML("Codice AGE:")%></div></span>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_newdecoden');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_newdecoden',["851"],["73"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', '','','',{},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"851","h":"73","title":"","layer":"false","npage":"1"}]);
...
this.coduif=new ZtVWeb._TC(this,{"anchor":"top-left","calculate":"","create_undercond":"","ctrlid":"<%=idPortlet%>_coduif","decrypt":false,"edit_undercond":"","encrypt":false,"field":"","fixed":"false","floating_placeholder":false,"h":20,"help_tips":"","hide":"false","hide_undercond":"","init":"","init_par":"","layer":false,"layout_steps_values":{},"maxlength":"4","name":"coduif","page":1,"picker":"","picture":"","reactive":false,"readonly":"false","server_side":"","type":"Textbox","typehtml5":"","typevar":"character","value":"<%=JSPLib.ToJSValue(coduif,false,true)%>","w":41,"x":90,"y":42,"zerofilling":false,"zindex":"1","zoom":""});
this.LinkZoom3=new ZtVWeb.LinkZoomCtrl(this,{"advanced_suggester":"","advanced_suggester_height":"","advanced_suggester_modal":false,"advanced_suggester_width":"","anchor":"top-left","class_Css":"","configname":"","ctrlid":"<%=idPortlet%>_LinkZoom3","defaultsfunction":"","defaultsfunction_zoom":false,"entityName":"\u002fjsp\u002fpg_newdecoden_portlet.jsp","fillemptykeys":false,"fixedvars":"","h":20,"hide":"false","image":"","intovars":"coduif,desuif","intovarsType":"C,C","keyfixedfilters":"","layer":false,"layout_steps_values":{},"link_id_hash":"<%=JSPLib.cmdHash("/jsp/pg_newdecoden_portlet.jspLinkZoom3",request.getSession())%>","linkedField":"coduif","linkedUsing":"","looselylinked":false,"n_criteria":"2","name":"LinkZoom3","offline":false,"openZoomOnMultipleRecord":true,"page":1,"path_type":"","queryparms":"","readfields":"SIGLA,DESCRI","row_suggest":"10","searchingfunction":"","sendkeystozoomonzoom":false,"servlet":"","spztl":"<%=JSPLib.cmdHash("link,tbluonas,default",request.getSession())%>","suggest":false,"table":"tbluonas","type":"LinkZoom","w":20,"x":132,"y":42,"zindex":"","zoomtitle":"<%=JSPLib.ToJSValue(sp.translate(""),false,true)%>"});
...
<%request.setAttribute("pg_newdecoden_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_newdecoden_Static.call(window.<%=idPortlet%>);
window.<%=idPortlet%>.btnSave.dispatchEvent('OnLoad');
window.<%=idPortlet%>.btnExit.dispatchEvent('OnLoad');
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_newdecoden',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_newdecoden');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
if (Library.eq(p_cControlName,"LinkZoom3")) {
  ...
  result.m_PrgZoom = "";
  result.m_rdField = new String[]{"SIGLA", "DESCRI"};
...
<%! public String getJSPUID() { return "3792114890"; } %>