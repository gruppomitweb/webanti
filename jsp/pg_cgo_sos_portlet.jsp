...
%>
window.pg_cgo_sos_Static=function(){
...
this.Query1.addDataConsumer(this.w_numsos,<%=JSPLib.ToJSValue("SOSCODICE",true)%>);
...
response.setHeader("Cache-Control","public");
%>
.pg_cgo_sos_container {
}
.pg_cgo_sos_title_container {
  margin: auto;
}
.pg_cgo_sos_portlet{
  position:relative;
...
.pg_cgo_sos_portlet[Data-page="1"]{
  height:680px;
  width:100%;
}
.pg_cgo_sos_portlet[Data-step="320"] {
  height:680px;
  width:100%;
}
.pg_cgo_sos_portlet[Data-step="480"] {
  height:680px;
  width:100%;
}
.pg_cgo_sos_portlet[Data-step="768"] {
  height:680px;
  width:100%;
}
.pg_cgo_sos_portlet[Data-step="320"] > .Grid0_ctrl {
...
.pg_cgo_sos_portlet[Data-step="480"] > .Grid0_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_cgo_sos_portlet[Data-step="768"] > .Grid0_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_cgo_sos_portlet[Data-step="320"] > .btnExit_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_cgo_sos_portlet[Data-step="480"] > .btnExit_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_cgo_sos_portlet[Data-step="768"] > .btnExit_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.pg_cgo_sos_portlet > .btnExit_ctrl {
...
.pg_cgo_sos_portlet[Data-step="1024"] > .btnExit_ctrl {
  line-height:30px;
  font-size:30px;
}
.pg_cgo_sos_portlet[Data-step="320"] > .btnExit_ctrl {
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_cgo_sos","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_cgo_sos_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_cgo_sos','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%if(request.getAttribute("pg_cgo_sos_firstinclusion")==null){
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_cgo_sos_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_cgo_sos_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_cgo_sos_portlet undefined' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_cgo_sos','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_cgo_sos');
<%!
...
this.Query1=new ZtVWeb._SQP(this,{"allowedcmds":"","anchor":"","appendingData":false,"async":false,"auto_exec":"true","cmd":"qbe_cgo_sos","cmdHash":"<%=JSPLib.cmdHash("qbe_cgo_sos",request.getSession())%>","count":"true","ctrlid":"<%=idPortlet%>_Query1","decrypted_parms":"","encrypted_fields":"","fieldstype":"true","h":20,"hide":"false","init_time":0,"layer":false,"layout_steps_values":{},"localDBName":"","long_query":false,"name":"Query1","nrows":"20","page":1,"parms":"","parms_source":"","type":"SQLDataobj","w":120,"x":816,"y":16});
this.SOSView=new ZtVWeb.SPLinkerCtrl(this,{"action":"view","allowedEntities":"","anchor":"","async":false,"check_exp":"","ctrlid":"<%=idPortlet%>_SOSView","decrypted_parms":"","entity_type":"master","force_msg_id":false,"h":30,"hide":"false","layer":false,"layout_steps_values":{},"m_cAltInterface":"","name":"SOSView","offline":false,"page":1,"parms":"SOSCODICE=w_numsos","popup":"true","popup_height":"1024","popup_maximized":"false","popup_scroll":"false","popup_style":"layer","popup_width":"800","progressbar":false,"refresh":"false","servlet":"armt_cgo_sos","target":"","type":"SPLinker","w":89,"x":966,"y":-61});
this.SOSView.m_cID='<%=JSPLib.cmdHash("entity,armt_cgo_sos",request.getSession())%>';
this.Uscita=new ZtVWeb.SPLinkerCtrl(this,{"action":"","allowedEntities":"","anchor":"","async":false,"check_exp":"","ctrlid":"<%=idPortlet%>_Uscita","decrypted_parms":"","entity_type":"page","force_msg_id":false,"h":30,"hide":"false","layer":false,"layout_steps_values":{},"m_cAltInterface":"","name":"Uscita","offline":false,"page":1,"parms":"","popup":"false","popup_height":"","popup_maximized":"false","popup_scroll":"false","popup_style":"by skin","popup_width":"","progressbar":false,"refresh":"","servlet":"start_page_logo_portlet.jsp","target":"","type":"SPLinker","w":115,"x":970,"y":-21});
this.Uscita.m_cID='<%=JSPLib.cmdHash("entity,start_page_logo_portlet.jsp",request.getSession())%>';
this.RTStampa=new ZtVWeb.SPLinkerCtrl(this,{"action":"start","allowedEntities":"","anchor":"","async":false,"check_exp":"","ctrlid":"<%=idPortlet%>_RTStampa","decrypted_parms":"","entity_type":"routine","force_msg_id":false,"h":20,"hide":"false","layer":false,"layout_steps_values":{},"m_cAltInterface":"","name":"RTStampa","offline":false,"page":1,"parms":"pSOS=w_numsos","popup":"false","popup_height":"","popup_maximized":"false","popup_scroll":"false","popup_style":"by skin","popup_width":"","progressbar":false,"refresh":"","servlet":"arrt_cgo_modulo_sos","target":"","type":"SPLinker","w":120,"x":807,"y":-57});
this.RTStampa.m_cID='<%=JSPLib.cmdHash("routine,arrt_cgo_modulo_sos",request.getSession())%>';
this.w_numsos=new ZtVWeb._VC(this,'w_numsos',null,'numeric',<%=w_numsos%>,false,false);
<%if(!Library.Empty(PageletId) ){%>
...
<%request.setAttribute("pg_cgo_sos_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_cgo_sos_Static.call(window.<%=idPortlet%>);
window.<%=idPortlet%>.btnExit.dispatchEvent('OnLoad');
window.<%=idPortlet%>.Query1.firstQuery('true');
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_cgo_sos',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_cgo_sos');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_cgo_sos");
}%>
<%! public String getJSPUID() { return "1468669031"; } %>