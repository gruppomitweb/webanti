...
%>
window.pg_upload_doc_Static=function(){
...
response.setHeader("Cache-Control","public");
%>
.pg_upload_doc_container {
}
.pg_upload_doc_title_container {
  margin: auto;
}
.pg_upload_doc_portlet{
  position:relative;
  margin: auto;
  width:100%;
  min-width:250px;
...
.pg_upload_doc_portlet[Data-page="1"]{
  height:150px;
  width:100%;
}
.pg_upload_doc_portlet > .SpUpload0_ctrl {
...
void PrintWireFrame(String containerId, java.io.Writer out) throws java.lang.Throwable {
 String def="[{\"h\":\"150\",\"layout_steps_values\":{},\"pages_names\":\"\",\"steps\":\"\",\"title\":\"default\",\"type\":\"Form\",\"v_line\":\"250\",\"w\":\"100%\",\"wizard\":\"\"},{\"anchor\":\"top-center\",\"h\":\"150\",\"layout_steps_values\":{},\"page\":\"1\",\"type\":\"SpUpload\",\"w\":\"248\",\"x\":\"1\",\"y\":\"0\",\"zindex\":\"1\"},{\"h\":\"20\",\"page\":\"1\",\"type\":\"Variable\",\"w\":\"120\",\"x\":\"4\",\"y\":\"211\"},{\"h\":\"20\",\"page\":\"1\",\"type\":\"Variable\",\"w\":\"120\",\"x\":\"129\",\"y\":\"210\"}]";
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"pg_upload_doc","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/pg_upload_doc_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','pg_upload_doc','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
<%if(request.getAttribute("pg_upload_doc_firstinclusion")==null){%>
...
<div id='<%=idPortlet%>_<%=m_cTITLEUID%>_title_container' class='pg_upload_doc_title_container' style='width:100%'>
<%out.flush(); 
 if(!Library.includeResource(request,response,"/"+sp.getSkin()+"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 if(!Library.includeResource(request,response,"/jsp-decorators/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",true)) 
 Library.includeResource(request,response,"/jsp/custom_toolbar_portlet.jsp?ForcedPortletUID="+idPortlet+"_"+m_cTITLEUID+"",false);%>
</div>
<div id='<%=idPortlet%>_container' class='pg_upload_doc_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='pg_upload_doc_portlet portlet' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('pg_upload_doc','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','pg_upload_doc');
<%!
...
ZtVWeb.newForm(this,'<%=idPortlet%>','pg_upload_doc',["250"],["150"],'portlet',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'', 'adaptive','<%=m_cTITLEUID%>','',{},true,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{},"w":"250","h":"150","title":"","layer":"false","npage":"1"}]);
this.SpUpload0=new ZtVWeb.SpUploadCtrl(this,{"allow_live_abort":"","allow_multiple_files":"","anchor":"top-center","ctrlid":"<%=idPortlet%>_SpUpload0","custom_file_prefix":"","extallowed":"","file_prefix":"none","h":150,"hide":"false","layer":false,"layout_steps_values":{},"manual_upload":"","my_max_file_size":"300","name":"SpUpload0","page":1,"show_selected_files":"","show_selected_files_name":"","spuid":"","style_mode":"mixed","submiturl":"","type":"SpUpload","uploaddir":"Tmp\u002f","w":248,"x":1,"y":0,"zindex":"1"});
...
<%request.setAttribute("pg_upload_doc_firstinclusion",idPortlet);
}%>
<script>
/*JS_MARKER_START*/
window.pg_upload_doc_Static.call(window.<%=idPortlet%>);
ZtVWeb.addPortletObj('<%=idPortlet%>','pg_upload_doc',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'pg_upload_doc');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("pg_upload_doc");
}%>
<%! public String getJSPUID() { return "3255464961"; } %>