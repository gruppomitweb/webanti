...
<script>
/*JS_MARKER_START*/
var m_cSPParentObjId =   ZtVWeb.POM.addObj('<%=PageletId%>','SPPortalZoom_sx_tpl','pageletObj', '<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
...
%>
<div class="type_20 pagelet_container defaultMainContent" id="<%=PageletId%>_container"><%
String ID_SEP;
...
<%}%>
ZtVWeb.addPagelet('<%=PageletId%>',<%=PageletId%>,'SPPortalZoom_sx_tpl','<%=JSPLib.ToJSValue(includerPageletId,false,true)%>');
