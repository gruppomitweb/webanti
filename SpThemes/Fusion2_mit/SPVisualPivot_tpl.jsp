...
<script>
/*JS_MARKER_START*/
var m_cSPParentObjId =   ZtVWeb.POM.addObj('<%=PageletId%>','SPVisualPivot_tpl','pageletObj', '<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
...
<%}%>
ZtVWeb.addPagelet('<%=PageletId%>',<%=PageletId%>,'SPVisualPivot_tpl','<%=JSPLib.ToJSValue(includerPageletId,false,true)%>');
