...
ZtVWeb.newForm(this,'<%=idPortlet%>','default_zoom_title',["900"],["62"],'ZoomTitle',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'600,900', '','','',{"600":{"h":"62","w":"100%"},"900":{"h":"62","w":"100%"}},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{"600":{"w":"100%","h":"62"},"900":{"w":"100%","h":"62"}},"w":"900","h":"62","title":"","layer":""}]);
...
<%! public String getJSPUID() { return "1485689497"; } %>