<%/*Encoding:UTF-8*/%>
<%/*Type:Portlet*/%>
<%//Def:[{"actioncode":"var _this = this;\nfunction clock() {\n\t\u002f\u002f creiamo l'oggetto data\n  var data = new Date();\n  \u002f\u002f recuperiamo l'ora corrente\n  var ora = data.getHours();\n  \u002f\u002f recuperiamo i minuti attuali\n  var min = data.getMinutes();\n  \u002f\u002f recuperiamo i secondi attuali\n  var sec = data.getSeconds();\n  \u002f\u002f formattiamo i minuti\n  if (min \u003c 10) {\n    min = \"0\" + min;\n  }\n  if (sec \u003c 10) {\n    sec = \"0\" + sec;\n  }\n  \u002f\u002f prepariamo l'output\n  var output = ora + \":\" + min+\":\"+sec;\n  \u002f\u002f scriviamo l'ora nell'elemento\n  this.lblClock.Value(output);\n  \u002f\u002f richiamiamo la funione tra un secondo\n  setTimeout( function() {_this.clock()},1000 );\n}\nfunction diary(){\n  \u002f\u002f creiamo l'oggetto data\n  var data = new Date();\n  var dayname = ['Domenica','Lunedì','Martedì','Mercoledì','Giovedì','Venerdì','Sabato'][data.getDay()];\n  var day = data.getDate();\n  var month = ['Gennaio' , 'Febbraio','Marzo','Aprile','Maggio','Giugno','Luglio','Agosto','Settembre','Ottobre','Novembre','Dicembre'][data.getMonth()];\n  var year = data.getFullYear();\n  \n  var output = dayname + \" \" + day +\" \"+ month + \" \"+year ;\n  this.lblDay.Value(output);\n}\nfunction this_Loaded(){\n\tthis.clock();   \n  this.diary();\n}","adaptive":"","bg_image":"","bg_image_position":"","bg_image_repeat":"","bg_image_size":"","cache_in_post":"false","cache_time":"","color":"","container_bg_color":"","container_bg_image":"","container_bg_pos":"","css":"","css_class":"","css_code":"[]","description":"Calendario sidebar","fixed_top":"","form_action":"","form_enctype":"default","form_target":"","form_type":"false","h":"100","hsl":"","included_font":"[]","included_font_offline":"","included_font_online":"","language":"true","layout_step":"","layout_steps_values":"{}","lock_items":"","manifest":"Custom manifest","max_w":"","min_w":"","my_library":"","offline":"false","on_security_failure":"empty","pages_names":"","portlet_position":"","positioning":"absolute","roles":"","security":"pagelet","server_cache_time":"","shared_manifest":"false","sp_theme":"true","sp_uid":"false","steps":"","tag":"","title":"","title_url":"","type":"Form","v_line":"230","version":"37","w":"100%","wizard":""},{"anchor":"top-left-right","bg_color":"","border_color":"","border_weight":"","class_Css":"bg_class","create_undercond":"","h":"101","hide":"false","hide_undercond":"","layout_steps_values":"{}","name":"bg","page":"1","sequence":"7","shrinkable":"","stretch":"false","type":"Box","w":"230","wireframe_props":"","x":"0","y":"0","zindex":"0"},{"align":"center","anchor":"top-left-right","assoc_input":"","bg_color":"transparent","calculate":"","class_Css":"label","create_undercond":"","dataobj":"","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":"false","field":"","font":"","font_color":"#fff","font_size":"","font_weight":"","fontpct":"120","h":"25","heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layout_steps_values":"{}","n_col":"1","name":"lblDay","nowrap":"false","page":"1","picture":"","sequence":"11","server_side":"","shrinkable":"","tabindex":"","target":"","type":"Label","value":"Lunedì 12 Settembre 2015","w":"224","wireframe_props":"align,value,n_col","x":"2","y":"24","zindex":"1"},{"align":"center","anchor":"top-left-right","assoc_input":"","bg_color":"transparent","calculate":"","class_Css":"label","create_undercond":"","dataobj":"","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":"false","field":"","font":"","font_color":"#fff","font_size":"","font_weight":"","fontpct":"","h":"25","heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layout_steps_values":"{}","n_col":"1","name":"lblClock","nowrap":"false","page":"1","picture":"","sequence":"11","server_side":"","shrinkable":"","tabindex":"","target":"","type":"Label","value":"12:30:45","w":"224","wireframe_props":"align,value,n_col","x":"2","y":"53","zindex":"1"}]%>
...
.start_page_calendar_portlet > .bg_ctrl {
...
.start_page_calendar_portlet > .bg_ctrl > .box_content {
  height:100%;
}
.start_page_calendar_portlet > .bg_ctrl {
  min-height:101px;
}
.start_page_calendar_portlet > .lblDay_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.start_page_calendar_portlet > .lblDay_ctrl > div{
  font-size:120%;
}
.start_page_calendar_portlet > .lblClock_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
<%if(request.getAttribute("start_page_calendar_firstinclusion")==null){%>
...
<%! public String getJSPUID() { return "3926651018"; } %>