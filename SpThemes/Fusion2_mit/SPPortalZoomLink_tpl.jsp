<%/*Type:PageletEditor*/%>
<%//Def:[{"id":"pagelet","name":"pagelet","type":"pagelet","template":"7","cols_n":"20","rows_n":"3","width":"960px","height":"100%","css":"","css_Class":"","color":"","security":"none","on_security_failure":"login","roles":"","cache_time":"0","sp_theme":"true","offline":"false","shared_manifest":"false","manifest":"Custom manifest","action_code":"","description":"","steps":"","layout_step":"","is960":"false","steppable_prop":[],"stretch":"false","css_class":"","codemanifest":"","css_code":"[]"},{"id":"item_static_0","type":"static","name":"zoom_title","src":"default_zoom_title_portlet.jsp","parameters":" ","titled":"false","title":"","open":"true","in_iframe":"false","iframe_height":"","condition":"","row":"0","col":"0","height":"1","width":"20","prefx":"0","suffx":"0","inserted":"true","behavior":"show","layout_steps_values":{},"steppable_prop":["row","col","width","height","behavior","popupItems","prefx","suffx","renderWidth"],"popupItems":[],"stretch":"false","caption":"","draggable":"false","toremove":"","hidden":"false","curTab":"generic","renderWidth":"20"},{"id":"item_resources_2","type":"resource","name":"ZoomGrid","titled":"false","title":"","open":"true","in_iframe":"false","iframe_height":"","container":"","row":"1","col":"0","height":"1","width":"20","prefx":"0","suffx":"0","inserted":"true","behavior":"show","layout_steps_values":{},"steppable_prop":["row","col","width","height","behavior","popupItems","prefx","suffx","renderWidth"],"popupItems":[],"stretch":"true","draggable":"false","hidden":"false","curTab":"generic","condition":"","css_Class":""}]%>
<%/*Encoding:UTF-8*/%>
<%/*Description:*/%>
...
<script>
/*JS_MARKER_START*/
var m_cSPParentObjId =   ZtVWeb.POM.addObj('<%=PageletId%>','SPPortalZoomLink_tpl','pageletObj', '<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
...
CONTAINER_SUFFIX="container";
CONTENT_SUFFIX="content";
uid= PageletId + ID_SEP +"item_resources_2";
container_id= uid + ID_SEP + CONTAINER_SUFFIX;
content_id= uid + ID_SEP + CONTENT_SUFFIX;
title_value= "";
url= "";
...
<% if(ZoomGrid_box!=null){%>
	this.ZoomGrid= new ZtVWeb.ResourceCtrl(this,{"behavior":"show","id":"item_resources_2","layout_steps_values":{},"name":"ZoomGrid","open":true,"popupItems":[],"renderWidth":20,"row":1,"strechStructure":"{\"table\":\"_area_0\", \"row\": \"_area_4\", \"cell\": \"_area_3\"}","stretch":true,"type":"resource","width":20});
<%}%>
...
<%}%>
ZtVWeb.addPagelet('<%=PageletId%>',<%=PageletId%>,'SPPortalZoomLink_tpl','<%=JSPLib.ToJSValue(includerPageletId,false,true)%>');
