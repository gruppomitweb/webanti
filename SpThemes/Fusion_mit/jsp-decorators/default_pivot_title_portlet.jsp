...
%>
.default_pivot_title_container {
}
.default_pivot_title_portlet{
  position:relative;
  width:100%;
  min-width:600px;
  height:62px;
}
.default_pivot_title_portlet[Data-page="1"]{
  height:62px;
  width:100%;
}
.default_pivot_title_portlet[Data-step="600"] {
  height:62px;
  width:100%;
}
.default_pivot_title_portlet[Data-step="900"] {
  height:62px;
  width:100%;
}
.default_pivot_title_portlet[Data-step="600"] > .caption_label_ctrl {
...
.default_pivot_title_portlet[Data-step="900"] > .caption_label_ctrl {
  box-sizing:border-box;
  z-index:3;
  position:absolute;
  display:inline-block;
...
.default_pivot_title_portlet > .caption_label_ctrl {
  overflow:hidden;
  text-align:left;
  background-color:transparent;
}
.default_pivot_title_portlet[Data-step="600"] > .caption_label_ctrl > div{
  -webkit-column-count:1;
  -moz-column-count:1;
  column-count:1;
}
.default_pivot_title_portlet[Data-step="900"] > .caption_label_ctrl > div{
  text-align:left;
  -webkit-column-count:1;
  -moz-column-count:1;
  column-count:1;
}
.default_pivot_title_portlet[Data-step="600"] > .toolbar_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.default_pivot_title_portlet[Data-step="900"] > .toolbar_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.default_pivot_title_portlet[Data-step="600"] > .loadFontIcon_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.default_pivot_title_portlet[Data-step="900"] > .loadFontIcon_ctrl {
  box-sizing:border-box;
  z-index:4;
  position:absolute;
  display:inline-block;
...
.default_pivot_title_portlet > .loadFontIcon_ctrl {
  display:none;
...
.default_pivot_title_portlet[Data-step="600"] > .Tabs_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
.default_pivot_title_portlet[Data-step="900"] > .Tabs_ctrl {
  box-sizing:border-box;
  z-index:1;
  position:absolute;
  display:inline-block;
...
<%}else{
if (JSPLib.checkApplication(request, response, out, sp, 37,"default_pivot_title","UTF-8")) {return; }
...
if(!included){%>
<head>
<base href=<%=JSPLib.ToHTMLValue( JSPLib.SPWebRootURL(request)+"/jsp/default_pivot_title_portlet.jsp"+(!Library.Empty(request.getQueryString())?"?"+request.getQueryString():"") )%>/>
...
.default_pivot_title_portlet > .Tabs_ctrl {
  display:none;
}
...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=idPortlet%>','default_pivot_title','portletObj','<%=JSPLib.ToJSValue(SPParentObjId,false,true)%>');
/*JS_MARKER_END*/
</script>
...
<div id='<%=idPortlet%>_container' class='default_pivot_title_container'>
<div id='<%=idPortlet%>' portlet_id='<%=idPortlet%>' align='left' class='default_pivot_title_portlet ZoomTitle' style='opacity:0.001'>
<%if(sp.isLogged()){
 if(sp.isInGroup(1) && sp.getGlobal("g_EditPortlet",false)==true){%>
<script>
ZtVWeb.AddPortletToEdit('default_pivot_title','<%=idPortlet%>',false,'');
</script><%}}%>
...
<script>
/*JS_MARKER_START*/
ZtVWeb.addPortlet('<%=idPortlet%>','default_pivot_title');
<%!
...
out.write("ZtVWeb.AddTranslation("+JSPLib.ToJSValue("MSG_XLSX_PIVOT",true)+","+JSPLib.ToJSValue(sp.translate("MSG_XLSX_PIVOT"),true)+");\n");
out.write("ZtVWeb.AddTranslation("+JSPLib.ToJSValue("MSG_XLSX_TABLE",true)+","+JSPLib.ToJSValue(sp.translate("MSG_XLSX_TABLE"),true)+");\n");
out.write("ZtVWeb.AddTranslation("+JSPLib.ToJSValue("PIVOT_HIDE_FIELDS",true)+","+JSPLib.ToJSValue(sp.translate("PIVOT_HIDE_FIELDS"),true)+");\n");
out.write("ZtVWeb.AddTranslation("+JSPLib.ToJSValue("PIVOT_SAVE_CONFIG",true)+","+JSPLib.ToJSValue(sp.translate("PIVOT_SAVE_CONFIG"),true)+");\n");
out.write("ZtVWeb.AddTranslation("+JSPLib.ToJSValue("PIVOT_SHOW_FIELDS",true)+","+JSPLib.ToJSValue(sp.translate("PIVOT_SHOW_FIELDS"),true)+");\n");
}/**/%>
window.<%=idPortlet%>=new function(){
var m_cSPPageletId = '<%=JSPLib.ToJSValue(PageletId,false,true)%>';
var m_cSPPortletTitleId = '<%=JSPLib.ToJSValue(SPPortletTitleId,false,true)%>';
ZtVWeb.newForm(this,'<%=idPortlet%>','default_pivot_title',["900"],["62"],'ZoomTitle',<%=sp.isOfflineInstallation()%>,false,m_cSPPageletId,'600,900', '','','',{"600":{"h":"62","w":"100%"},"900":{"h":"62","w":"100%"}},false,false,1,m_cSPPortletTitleId, 'NORMAL',[{"layout_steps_values":{"600":{"w":"100%","h":"62"},"900":{"w":"100%","h":"62"}},"w":"900","h":"62","title":"","layer":""}]);
this.caption_label=new ZtVWeb._LC(this,{"align":"left","anchor":"top-left-right(%)","assoc_input":"","calculate":"","class_Css":"TitleLabel","create_undercond":"","ctrlid":"<%=idPortlet%>_caption_label","draggable":"","draggable_name":"","droppable":"","droppable_name":"","edit_undercond":"","enable_HTML":true,"field":"","font":"","font_color":"","font_size":"","font_weight":"","fontpct":"","h":30,"heading":"","help_tips":"","hide":"false","hide_undercond":"","href":"","init":"","layer":false,"layout_steps_values":{"600":{"align":"","anchor":"top-left-right","fontpct":"","h":30,"hide":"","n_col":"1","w":"276","x":20,"y":15},"900":{"align":"left","anchor":"top-left-right(%)","fontpct":"","h":30,"hide":"false","n_col":"1","w":483,"x":20,"y":15}},"n_col":1,"name":"caption_label","nowrap":"false","page":1,"picture":"","sanitize":"xssPrevent","sanitize_tags":"","server_side":"","shrinkable":"","spuid":"","tabindex":"","target":"","template":"","text":"<%=JSPLib.ToJSValue(sp.translate(caption_label),false,true)%>","type":"Label","w":483,"x":20,"y":15,"zindex":"3"});
...
<%request.setAttribute("default_pivot_title_firstinclusion",idPortlet);%>
<script>
/*JS_MARKER_START*/
window.default_pivot_title_Static=function(){
if(typeof SubmitListenerForm !='undefined')this.SubmitListenerForm=SubmitListenerForm;
if(typeof SetSaveConfig !='undefined')this.SetSaveConfig=SetSaveConfig;
...
if(typeof updateShowHideFieldsButton !='undefined')this.updateShowHideFieldsButton=updateShowHideFieldsButton;
<%if(!Library.Empty(PageletId) ){%>
...
<script>
/*JS_MARKER_START*/
window.default_pivot_title_Static.call(window.<%=idPortlet%>);
window.<%=idPortlet%>.loadFontIcon.dispatchEvent('OnLoad');
ZtVWeb.addPortletObj('<%=idPortlet%>','default_pivot_title',<%=idPortlet%>);
ZtVWeb.portletLoaded(<%=idPortlet%>,'default_pivot_title');
/*JS_MARKER_END*/
</script>
<%if(!included){%>
</body>
...
<%}
sp.endPage("default_pivot_title");
}%>
<%! public String getJSPUID() { return "300454441"; } %>