...
/*JS_MARKER_START*/
<%=tabs_js%>=new Z.Tabs({container:'<%=JSPLib.ToJSValue(tabs_div)%>',useseparator:SPTheme['colTabUseSeparator'],expandcollapse:(typeof(SPTheme['formTabCanCollapse'])!='undefined'?SPTheme['formTabCanCollapse']:true),wizard: false,tabstrip_class: ''});<%=tabs_js%>.tabList=new Array();
/*JS_MARKER_END*/
</script><div id=<%=JSPLib.ToHTMLValue(content_id)%> class='' style='height:calc(100% - <%=Library.GetStyleVariable(sp.getSkin(), "formTabH", "", 0)%>px)'><%
{int i=0;
