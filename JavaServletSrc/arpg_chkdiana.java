...
public class arpg_chkdiana extends SPDialogServlet implements SPInvokable {
  public static String m_cEntityUid = "!*GIAAZQWPXE*!";
  ...
  public String getEntityTitle() {
    return "Preparazione file per Check Scarico OffLine (Dal 01/06/2010 al 31/12/2013)";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "arpg_chkdiana";
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,arpg_chkdianaBO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"1049831526",p_Context.Translate("La data di inizio periodo devere essere compresa tra il 01/06/2010 e il 31/12/2013")},
    ...
    {"11003358743",p_Context.Translate("Preparazione file per Check Scarico OffLine (Dal 01/06/2010 al 31/12/2013)")},
    ...
    {"1462449345",p_Context.Translate("La data di fine periodo deve essere maggiore di quella di inizio e compresa tra il 01/06/2010 e il 31/12/2013")},
  ...
  void WriteStyles(arpg_chkdianaBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='SPPrxy/"+m_cEntityUid+"/arpg_chkdiana.css'>" +
      "");
    }
  ...
  void WriteMainForm(arpg_chkdianaBO BO,ServletStatus status) {
    status.out.println(
  ...
  com.zucchetti.sitepainter.Library.IncludedPortletUtils.Vars GetPortlet_DYMVKIQWCA_Vars(arpg_chkdianaBO BO,ServletStatus status) {
  ...
  // GetPortlet_Log_Vars
  com.zucchetti.sitepainter.Library.IncludedPortletUtils.Vars GetPortlet_KQMKKBMXYE_Vars(arpg_chkdianaBO BO,ServletStatus status) {
    com.zucchetti.sitepainter.Library.IncludedPortletUtils.Vars inclusionVars;
    inclusionVars = com.zucchetti.sitepainter.Library.IncludedPortletUtils.buildVars();
    return inclusionVars;
  }
  void WriteControls(arpg_chkdianaBO BO,ServletStatus status) {
    WriteControls_p1(BO,status);
    PrintNotifyContent(status,getNotifyItems());
  }
  void WriteControls_p1(arpg_chkdianaBO BO,ServletStatus status) {
    status.themeWriter.Header_BeginHtml(658);
    WriteControls_1_h_0(BO,status);
  }
  void WriteControls_1_h_0(arpg_chkdianaBO BO,ServletStatus status) {
  ...
  static void PrintState(arpg_chkdianaBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(arpg_chkdianaBL BO,ServletStatus status) {
  }
  static void PrintStateWorkVars(arpg_chkdianaBL BO,ServletStatus status) {
  ...
  void WriteMainFormVarScript(arpg_chkdianaBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"arpg_chkdiana"),"C",0,0)+ ";");
    ...
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"arpg_chkdiana","");
  ...
  void WriteMainFormScript(arpg_chkdianaBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
  ...
  arpg_chkdianaBO getBO(ServletStatus status) {
    arpg_chkdianaBO BO = new arpg_chkdianaBO(status.context);
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(arpg_chkdianaBO BO) {
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,arpg_chkdianaBO BO) {
    super.NotifyEvent(p_cEvent,status,BO);
    CPLib.NotifyEvent(p_cEvent,BO,BO.m_Ctx,BO.specificEventsHandlers,BO.allEventsHandlers);
  }
  void Start(ServletStatus status,arpg_chkdianaBO BO) {
    BO.SetFromContext(status.m_cWv);
    BO.Calculate();
  }
  void Save(ServletStatus status,arpg_chkdianaBO BO) {
    boolean l_bResult;
    BO.SetFromContext(status.m_cWv);
    l_bResult = BO.Save();
    if (l_bResult) {
  ...
  void Discard(ServletStatus status,arpg_chkdianaBO BO) {
    status.m_bExit = true;
  }
  void CreatePortlet(ServletStatus status,arpg_chkdianaBO BO) {
    ...
    item.put("altInterfaceFor","arpg_chkdiana");
    items.put(item);
    String s;
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"19\",\"name\":\"tipoarch\",\"orientation\":\"horizontal\",\"page\":\"1\",\"spuid\":\"YJWPZAWNZJ\",\"tabindex\":\"15\",\"textlist\":\"Definitivi (A.U.I.),Provvisori\",\"type\":\"Radio\",\"valuelist\":\""+"'"+"D"+"'"+","+"'"+"P"+"'"+"\",\"w\":\"193\",\"x\":\"128\",\"y\":\"224\",\"zone\":\"VFFMUWZZJS_9\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"name\":\"flgrae\",\"page\":\"1\",\"spuid\":\"QNMKJLGOKW\",\"tabindex\":\"16\",\"textlist\":\"Utilizza codifica RAE,Utilizza codifica ATECO\",\"type\":\"Combobox\",\"valuelist\":\""+"'"+"R"+"'"+","+"'"+"A"+"'"+"\",\"w\":\"240\",\"x\":\"528\",\"y\":\"219\",\"zone\":\"VFFMUWZZJS_8\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgope\",\"page\":\"1\",\"spuid\":\"ACJYNBGGGK\",\"tabindex\":\"17\",\"type\":\"Checkbox\",\"w\":\"96\",\"x\":\"128\",\"y\":\"251\",\"zone\":\"VFFMUWZZJS_10\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgfrz\",\"page\":\"1\",\"spuid\":\"UGLRKSBAIN\",\"tabindex\":\"18\",\"type\":\"Checkbox\",\"w\":\"96\",\"x\":\"208\",\"y\":\"252\",\"zone\":\"VFFMUWZZJS_10\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgrap\",\"page\":\"1\",\"spuid\":\"QXOCQTKHHM\",\"tabindex\":\"19\",\"type\":\"Checkbox\",\"w\":\"288\",\"x\":\"128\",\"y\":\"282\",\"zone\":\"VFFMUWZZJS_11\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"name\":\"tiprap\",\"page\":\"1\",\"spuid\":\"YKZIVVFLHM\",\"tabindex\":\"20\",\"textlist\":\"Rapporti attivi nel periodo,Rapporti attivi nel periodo escludendo le chiusure successive,Solo informazioni nel periodo\",\"type\":\"Combobox\",\"valuelist\":\""+"'"+"1"+"'"+","+"'"+"2"+"'"+","+"'"+"3"+"'"+"\",\"w\":\"320\",\"x\":\"448\",\"y\":\"282\",\"zone\":\"VFFMUWZZJS_11\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgint\",\"page\":\"1\",\"spuid\":\"BHRJFGYNWO\",\"tabindex\":\"21\",\"type\":\"Checkbox\",\"w\":\"248\",\"x\":\"128\",\"y\":\"315\",\"zone\":\"VFFMUWZZJS_12\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgdel\",\"page\":\"1\",\"spuid\":\"VIRLZRRHIQ\",\"tabindex\":\"22\",\"type\":\"Checkbox\",\"w\":\"248\",\"x\":\"448\",\"y\":\"315\",\"zone\":\"VFFMUWZZJS_12\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgchk\",\"page\":\"1\",\"spuid\":\"LJVZZPXJUZ\",\"tabindex\":\"23\",\"type\":\"Checkbox\",\"w\":\"184\",\"x\":\"128\",\"y\":\"342\",\"zone\":\"VFFMUWZZJS_13\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgsto\",\"page\":\"1\",\"spuid\":\"DRCOVPYYCV\",\"tabindex\":\"24\",\"type\":\"Checkbox\",\"w\":\"205\",\"x\":\"448\",\"y\":\"342\",\"zone\":\"VFFMUWZZJS_13\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"32\",\"href\":\"javascript:href_MAYNQUHJSS()\",\"name\":\"images_elaborazione_gif\",\"page\":\"1\",\"spuid\":\"MAYNQUHJSS\",\"src\":\"images\\/elaborazione.gif\",\"tabindex\":\"25\",\"type\":\"Image\",\"w\":\"42\",\"x\":\"384\",\"y\":\"378\",\"zone\":\"VFFMUWZZJS_14\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Premere il bottone per prelevare il file generato\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"32\",\"href\":\"javascript:href_LCFKHGNSPV()\",\"name\":\"images_view_gif\",\"page\":\"1\",\"spuid\":\"LCFKHGNSPV\",\"src\":\"images\\/view.gif\",\"tabindex\":\"26\",\"type\":\"Image\",\"w\":\"42\",\"x\":\"336\",\"y\":\"378\",\"zone\":\"VFFMUWZZJS_14\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Chiudi la procedura senza elaborare i dati\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"32\",\"href\":\"javascript:href_NACPPABTRW()\",\"name\":\"images_exit_gif\",\"page\":\"1\",\"spuid\":\"NACPPABTRW\",\"src\":\"images\\/exit.gif\",\"tabindex\":\"27\",\"type\":\"Image\",\"w\":\"42\",\"x\":\"432\",\"y\":\"378\",\"zone\":\"VFFMUWZZJS_14\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_type\":\"\",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"1\",\"name\":\"Box_IQCSEEHKKR\",\"page\":\"1\",\"shrinkable\":\"true\",\"spuid\":\"IQCSEEHKKR\",\"tabindex\":\"28\",\"type\":\"Box\",\"w\":\"775\",\"x\":\"8\",\"y\":\"68\",\"zone\":\"VFFMUWZZJS_15\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"left\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"PERIODO_DA_ESAMINARE\",\"page\":\"1\",\"spuid\":\"IWHDABKYSG_DIV\",\"tabindex\":\"29\",\"type\":\"Label\",\"value\":\"PERIODO DA ESAMINARE\",\"w\":\"137\",\"x\":\"16\",\"y\":\"75\",\"zone\":\"VFFMUWZZJS_16\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Tipologia_Archivi_\",\"page\":\"1\",\"spuid\":\"USJHXUDNOM_DIV\",\"tabindex\":\"32\",\"type\":\"Label\",\"value\":\"Tipologia Archivi:\",\"w\":\"81\",\"x\":\"46\",\"y\":\"224\",\"zone\":\"VFFMUWZZJS_9\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Tipologia_Dati_\",\"page\":\"1\",\"spuid\":\"MBIRXQHNIJ_DIV\",\"tabindex\":\"36\",\"type\":\"Label\",\"value\":\"Tipologia Dati:\",\"w\":\"81\",\"x\":\"46\",\"y\":\"256\",\"zone\":\"VFFMUWZZJS_10\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"\",\"h\":\"91\",\"name\":\"Portlet_DYMVKIQWCA\",\"page\":\"1\",\"src\":\"\\/jsp\\/showmsg_portlet.jsp?ForcedPortletUID=___com__zucchetti__sitepainter__altinterface__m_cEntityUid____DYMVKIQWCA\",\"type\":\"Portlet\",\"w\":\"760\",\"x\":\"16\",\"y\":\"563\",\"zone\":\"VFFMUWZZJS_18\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"\",\"h\":\"147\",\"name\":\"Portlet_KQMKKBMXYE\",\"page\":\"1\",\"src\":\"\\/jsp\\/showlog_portlet.jsp?ForcedPortletUID=___com__zucchetti__sitepainter__altinterface__m_cEntityUid____KQMKKBMXYE\",\"type\":\"Portlet\",\"w\":\"760\",\"x\":\"16\",\"y\":\"413\",\"zone\":\"VFFMUWZZJS_17\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    SPLib.SetMimeType(status.response,"application/json");
    items.write(status.out);
  }
  void Next(ServletStatus status,arpg_chkdianaBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow+entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void Previous(ServletStatus status,arpg_chkdianaBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow-entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void WriteFormPage(arpg_chkdianaBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='arpg_chkdiana?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+m_cEntityUid+"/arpg_chkdiana_proc.js'>" +
     "</script>" +
    "");
    IncludeJS(status);
  ...
  void RaiseLoadedEntity(arpg_chkdianaBO BO,ServletStatus status) {
    RaiseEventLoadedEntity(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cClientMode,"C",0,0)+"})","C",0,0));
  }
  void RaiseSavedEntity(arpg_chkdianaBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(arpg_chkdianaBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(arpg_chkdianaBO BO,ServletStatus status) {
  ...
  void WriteExitPage(arpg_chkdianaBO BO,ServletStatus status,Forward f) {
    WriteExitPage(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cMode,"C",0,0)+"})","C",0,0), f);
  }
  void WriteExitPage(arpg_chkdianaBO BO,ServletStatus status) {
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      arrt_chkdiana.GetCallableNames(callable);
    } else {
  ...
  public String GetCheckVars(ServletStatus status,arpg_chkdianaBO BO) {
    return "NO_VALUE";
  }
  public boolean CheckVars(ServletStatus status,arpg_chkdianaBO BO) {
    boolean result = true;
    return result;
  }
}
