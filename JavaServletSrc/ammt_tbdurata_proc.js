...
function Help() {
windowOpenForeground('../doc/ammt_tbdurata_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'tbdurata'+'\\'+CPLib.ToCPStr(w_CODICE);
}
...
p_d.setValue('ammt_tbdurata',m_cSelectedPage);
