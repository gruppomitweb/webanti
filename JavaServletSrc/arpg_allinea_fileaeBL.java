...
public class arpg_allinea_fileaeBL extends arpg_allinea_fileaeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_allinea_fileae";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'errchk':errchk,'xdesval':xdesval,'impzip':impzip,'dadata':dadata,'a_data':a_data}";
  public static final String i_ItemSequence = "dadata,a_data";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"dadata","Da Data Operazione","D","8","0","variabile","nokey","false","false"},new String[]{"a_data","Da Data Operazione","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_allinea_fileaeBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_fileae","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
