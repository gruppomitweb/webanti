...
public class arpg_kersonboBL extends arpg_kersonboWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public java.sql.Date c_datamodi;
    public String c_OLDCONNES;
  ...
  public static final String i_EntityName = "arpg_kersonbo";
  ...
  public arpg_kersonboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_kersonbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_datamodi=c_datamodi;
    m_oTrs.get(m_nCurrentRow).c_OLDCONNES=c_OLDCONNES;
  ...
  public void TrsToWork() {
    c_datamodi= m_oTrs.get(m_nCurrentRow).c_datamodi;
    c_OLDCONNES= m_oTrs.get(m_nCurrentRow).c_OLDCONNES;
