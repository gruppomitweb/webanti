...
if(c=Ctrl('UYVYTEMEXX')) c.value = WtH(w_daRapporto,'C',25,0,'')
if(c=Ctrl('CJWUHWULAR')) c.value = WtH(w_aRapporto,'C',25,0,'')
...
var h;
SetDisplay(Ctrl('UYVYTEMEXX'),Eq(w_tipopdf,'PDFA1B') || IsHiddenByStateDriver('daRapporto'));
SetDisplay(Ctrl('UYVYTEMEXX_ZOOM'),Eq(w_tipopdf,'PDFA1B'));
SetDisplay(Ctrl('CJWUHWULAR'),Eq(w_tipopdf,'PDFA1B') || IsHiddenByStateDriver('aRapporto'));
...
SetDisplay(Ctrl('DPKVLWHCIG'),Eq(w_tipopdf,'PDFA1B') || IsHiddenByStateDriver('DaDatOpe'));
SetDisplay(Ctrl('DPKVLWHCIG_ZOOM'),Eq(w_tipopdf,'PDFA1B'));
SetDisplay(Ctrl('MTJDZQTEIR'),Eq(w_tipopdf,'PDFA1B') || IsHiddenByStateDriver('ADatOpe'));
SetDisplay(Ctrl('MTJDZQTEIR_ZOOM'),Eq(w_tipopdf,'PDFA1B'));
SetDisplay(Ctrl('HPGJXQIVYG'),Eq(w_tipopdf,'PDFA1B'));
SetDisplay(Ctrl('BGHAITOPMU'),Eq(w_tipopdf,'PDFA1B'));
...
SetDisplay(Ctrl('AZGUIQSSRM'),true);
HideUI();
}
HideUI.lblids["ADatOpe"]=['BGHAITOPMU'];
HideUI.lblids["ADatReg"]=['FWWBDIWISI'];
HideUI.lblids["DaDatOpe"]=['PCILMATBXL','JGQCNSZOCQ','HPGJXQIVYG','ZWZOQIGZCX','BGOVXFIBXQ'];
HideUI.lblids["DaDatReg"]=['IVTUBJDSFA'];
HideUI.lblids["aCodDip"]=['PCILMATBXL','JGQCNSZOCQ','HPGJXQIVYG','ZWZOQIGZCX','BGOVXFIBXQ'];
HideUI.lblids["aRapporto"]=['PCILMATBXL','JGQCNSZOCQ','HPGJXQIVYG','ZWZOQIGZCX','BGOVXFIBXQ'];
HideUI.lblids["daCodDip"]=['PCILMATBXL','JGQCNSZOCQ','HPGJXQIVYG','ZWZOQIGZCX','BGOVXFIBXQ'];
HideUI.lblids["daRapporto"]=['PCILMATBXL','JGQCNSZOCQ','HPGJXQIVYG','ZWZOQIGZCX','BGOVXFIBXQ'];
...
e=(Ne(e,null)?e:window.event);
return Set_daRapporto(HtW(Ctrl('UYVYTEMEXX').value,'C'),null,e);
}
...
e=(Ne(e,null)?e:window.event);
return Set_aRapporto(HtW(Ctrl('CJWUHWULAR').value,'C'),null,e);
}
...
function href_AZGUIQSSRM() {
var l_oWv = InitWvApplet();
l_oWv.setValue('pAUI',AsAppletValue('D'));
l_oWv.setValue('pPDF',AsAppletValue(w_tipopdf));
l_oWv.setValue('m_cParameterSequence',AsAppletValue('pAUI,pPDF'));
SetLocationHref(null,'arrt_stp_stdtec_rap_new'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
_ResetTracker();
...
w_Messaggi.raiseEvent('arpg_stp_stdtec_rap_new_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_stp_stdtec_rap_new_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stp_stdtec_rap_new_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_stdtec_rap_new',m_cSelectedPage);
...
w_RAGSOC1=l_Appl.GetStringValue('DESCRAP',70,0);
} else {
...
w_RAGSOC2=l_Appl.GetStringValue('DESCRAP',70,0);
} else {
...
_FillChildren.n=[];
FillWv.n=["tipopdf","daRapporto","aRapporto","RAGSOC1","RAGSOC2","DESCRIZ1","DESCRIZ2","daCodDip","aCodDip","DaDatOpe","ADatOpe","ADatReg","DaDatReg"];
...
_Obli('daRapporto',0,'UYVYTEMEXX',false)
_Obli('aRapporto',0,'CJWUHWULAR',false)
