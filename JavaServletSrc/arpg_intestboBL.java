...
public class arpg_intestboBL extends arpg_intestboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_intestbo";
  ...
  public arpg_intestboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_intestbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
