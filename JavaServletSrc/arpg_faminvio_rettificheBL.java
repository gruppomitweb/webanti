...
public class arpg_faminvio_rettificheBL extends arpg_faminvio_rettificheWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_faminvio_rettifiche";
  ...
  public static final String i_StateStructure = "{'flgagg':flgagg,'anno':anno,'mese':mese,'flgdett':flgdett}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gDescAzi':gDescAzi,'flgagg':flgagg,'flgdel':flgdel,'anno':anno,'mese':mese,'dadata':dadata,'a_data':a_data,'flgstp':flgstp,'gFlgWU':gFlgWU,'flgdett':flgdett,'flgnew':flgnew}";
  public static final String i_ItemSequence = "flgagg,anno,mese,flgdett";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"flgagg","","C","1","0","variabile","nokey","false","false"},new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","true"},new String[]{"flgdett","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_faminvio_rettificheBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_faminvio_rettifiche","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
