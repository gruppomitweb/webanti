...
public class arpg_genera_opexBL extends arpg_genera_opexWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_genera_opex";
  ...
  public arpg_genera_opexBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_genera_opex","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
