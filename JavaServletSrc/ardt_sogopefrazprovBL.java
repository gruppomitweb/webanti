...
public class ardt_sogopefrazprovBL extends ardt_sogopefrazprovWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_sogopefrazprov";
  ...
  public CPPhTableWrInfo m_oWrInfo_xogopefbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xogopefbo;
  ...
  public static String[] m_EntityTables = {"xogopefbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("ardt_sogopefrazprov",true,true)+"}"+FoundlingChildrenList("ardt_sogopefrazprov",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescriz':xdescriz,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("ardt_sogopefrazprov",true,true)+"}"+FoundlingChildrenList("ardt_sogopefrazprov",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG LEGAME CPROWNUM"+FoundlingChildrenList("ardt_sogopefrazprov",false,true)+"]"+FoundlingChildrenList("ardt_sogopefrazprov",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_sogopefrazprov"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key2","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"},new String[]{"CPROWNUM","Numero Progressivo","N","4","0","campo","key1","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_sogopefrazprovBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xogopefbo = p_ContextObject.GetPhName("xogopefbo",p_ContextObject.GetCompany(),false);
    m_cServer_xogopefbo = p_ContextObject.GetServer("xogopefbo");
    m_oWrInfo_xogopefbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xogopefbo",p_ContextObject.GetCompany());
    m_cVirtName_xogopefbo = CPSql.ManipulateTablePhName("xogopefbo",m_cServer_xogopefbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_sogopefrazprov",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_sogopefrazprov","xogopefbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_sogopefrazprov",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_sogopefrazprov",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_sogopefrazprov",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_sogopefrazprov",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_sogopefrazprov"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_sogopefrazprov\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xogopefbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xogopefbo"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
