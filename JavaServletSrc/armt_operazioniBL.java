...
public class armt_operazioniBL extends armt_operazioniWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_operazioni";
  ...
  public String m_cVirtName_operazbo;
  ...
  public armt_operazioniBL (CPContext p_ContextObject) {
    ...
    m_cPhName_operazbo = p_ContextObject.GetPhName("operazbo",p_ContextObject.GetCompany(),false);
    m_cServer_operazbo = p_ContextObject.GetServer("operazbo");
    m_oWrInfo_operazbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"operazbo",p_ContextObject.GetCompany());
    m_cVirtName_operazbo = CPSql.ManipulateTablePhName("operazbo",m_cServer_operazbo);
    ...
    ardt_sogope = new ardt_sogopeBO(p_ContextObject);
    ardt_clientiope = new ardt_clientiopeBO(p_ContextObject);
    ardt_mlientiope = new ardt_mlientiopeBO(p_ContextObject);
    ardt_mogopebo = new ardt_mogopeboBO(p_ContextObject);
    ardt_beneficope = new ardt_beneficopeBO(p_ContextObject);
    ardt_meneficope = new ardt_meneficopeBO(p_ContextObject);
    ardt_terzistiope = new ardt_terzistiopeBO(p_ContextObject);
    ardt_merzistiope = new ardt_merzistiopeBO(p_ContextObject);
    ardt_rapcoll = new ardt_rapcollBO(p_ContextObject);
    ardt_docopebo = new ardt_docopeboBO(p_ContextObject);
    armt_operazbo_agg = new armt_operazbo_aggBO(p_ContextObject);
    ardt_ope_contante = new ardt_ope_contanteBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_operazioni",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_sogope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_sogope);
    l_bResult = l_bResult || ardt_clientiope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_clientiope);
    l_bResult = l_bResult || ardt_mlientiope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_mlientiope);
    l_bResult = l_bResult || ardt_mogopebo.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_mogopebo);
    l_bResult = l_bResult || ardt_beneficope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_beneficope);
    l_bResult = l_bResult || ardt_meneficope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_meneficope);
    l_bResult = l_bResult || ardt_terzistiope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_terzistiope);
    l_bResult = l_bResult || ardt_merzistiope.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_merzistiope);
    l_bResult = l_bResult || ardt_rapcoll.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_rapcoll);
    l_bResult = l_bResult || ardt_docopebo.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_docopebo);
    l_bResult = l_bResult || armt_operazbo_agg.IsUpdated() || CPLib.IsUpdated(m_cWv_armt_operazbo_agg);
    l_bResult = l_bResult || ardt_ope_contante.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_ope_contante);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    o_RAGIO = w_RAGIO;
    o_TIPO = w_TIPO;
    ardt_sogope.SaveDependsOn();
    ardt_clientiope.SaveDependsOn();
    ardt_mlientiope.SaveDependsOn();
    ardt_mogopebo.SaveDependsOn();
    ardt_beneficope.SaveDependsOn();
    ardt_meneficope.SaveDependsOn();
    ardt_terzistiope.SaveDependsOn();
    ardt_merzistiope.SaveDependsOn();
    ardt_rapcoll.SaveDependsOn();
    ardt_docopebo.SaveDependsOn();
    armt_operazbo_agg.SaveDependsOn();
    ardt_ope_contante.SaveDependsOn();
  }
  ...
  public boolean Calculate() {
    ...
    UpdateAutonumber();
    CopyWorkVar(this,armt_operazbo_agg,new String[]{"SEGNO"},new String[]{"SEGNO"},true);
  ...
  void Calculation_ISMPZVVNVG() {
    w_TIPOLEG = arfn_read_tipolegR.Make(m_Ctx,this).Run(w_IDBASE,"OD");
  }
  ...
  void Calculation_DIWSVSDVMG() {
    if (w_CALCOLI) {
      arrt_li_operazboR l_oRoutine_arrt_li_operazbo;
      l_oRoutine_arrt_li_operazbo = arrt_li_operazboR.Make(m_Ctx,this);
      l_oRoutine_arrt_li_operazbo.pObj = this;
      l_oRoutine_arrt_li_operazbo.Run();
    }
  }
  ...
  void Calculation_KGBNFVNJHO() {
    ...
    l_oRoutine_arrt_writelog.pTabella = "OPERAZBO";
    l_oRoutine_arrt_writelog.pChiave = w_IDBASE;
    l_oRoutine_arrt_writelog.Run();
  }
  void Calculation_RMCHLJQOEX() {
    arrt_copiaoperazioneR l_oRoutine_arrt_copiaoperazione;
    l_oRoutine_arrt_copiaoperazione = arrt_copiaoperazioneR.Make(m_Ctx,this);
    l_oRoutine_arrt_copiaoperazione.Run();
  }
  ...
  void Calculation_BVXCMRSYKS() {
    arrt_deloperazioneR l_oRoutine_arrt_deloperazione;
    l_oRoutine_arrt_deloperazione = arrt_deloperazioneR.Make(m_Ctx,this);
    l_oRoutine_arrt_deloperazione.Run();
  }
  void Calculation_OEZVQSLBRM() {
    ...
    l_oRoutine_arrt_updel_opextrbo.pTipo = "O";
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_operazioni","operazbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_ardt_sogope = CPLib.GetProperty(p,"m_cWv_ardt_sogope",m_cWv_ardt_sogope,0);
      m_cWv_ardt_clientiope = CPLib.GetProperty(p,"m_cWv_ardt_clientiope",m_cWv_ardt_clientiope,0);
      m_cWv_ardt_mlientiope = CPLib.GetProperty(p,"m_cWv_ardt_mlientiope",m_cWv_ardt_mlientiope,0);
      m_cWv_ardt_mogopebo = CPLib.GetProperty(p,"m_cWv_ardt_mogopebo",m_cWv_ardt_mogopebo,0);
      m_cWv_ardt_beneficope = CPLib.GetProperty(p,"m_cWv_ardt_beneficope",m_cWv_ardt_beneficope,0);
      m_cWv_ardt_meneficope = CPLib.GetProperty(p,"m_cWv_ardt_meneficope",m_cWv_ardt_meneficope,0);
      m_cWv_ardt_terzistiope = CPLib.GetProperty(p,"m_cWv_ardt_terzistiope",m_cWv_ardt_terzistiope,0);
      m_cWv_ardt_merzistiope = CPLib.GetProperty(p,"m_cWv_ardt_merzistiope",m_cWv_ardt_merzistiope,0);
      m_cWv_ardt_rapcoll = CPLib.GetProperty(p,"m_cWv_ardt_rapcoll",m_cWv_ardt_rapcoll,0);
      m_cWv_ardt_docopebo = CPLib.GetProperty(p,"m_cWv_ardt_docopebo",m_cWv_ardt_docopebo,0);
      m_cWv_armt_operazbo_agg = CPLib.GetProperty(p,"m_cWv_armt_operazbo_agg",m_cWv_armt_operazbo_agg,0);
      m_cWv_ardt_ope_contante = CPLib.GetProperty(p,"m_cWv_ardt_ope_contante",m_cWv_ardt_ope_contante,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("sogopebo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("sogopebo",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("sogopebo\u0000false\u0000false\u00001\u00000\u0000ardt_sogope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("clientiope");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("clientiope",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("clientiope\u0000false\u0000false\u00001\u00000\u0000ardt_clientiope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("mlientiope");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("mlientiope",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("mlientiope\u0000false\u0000false\u00001\u00000\u0000ardt_mlientiope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("mogopebo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("mogopebo",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("mogopebo\u0000false\u0000false\u00001\u00000\u0000ardt_mogopebo\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("beneficope");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("beneficope",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("beneficope\u0000false\u0000false\u00001\u00000\u0000ardt_beneficope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("meneficope");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("meneficope",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("meneficope\u0000false\u0000false\u00001\u00000\u0000ardt_meneficope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("terzistiope");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("terzistiope",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("terzistiope\u0000false\u0000false\u00001\u00000\u0000ardt_terzistiope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("merzistiope");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("merzistiope",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("merzistiope\u0000false\u0000false\u00001\u00000\u0000ardt_merzistiope\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("rapcoll");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("rapcoll",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("rapcoll\u0000false\u0000false\u00001\u00000\u0000ardt_rapcoll\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("operazbo_agg");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("operazbo_agg",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("operazbo_agg\u0000false\u0000false\u00001\u00000\u0000armt_operazbo_agg\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("ope_contante");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("ope_contante",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("ope_contante\u0000false\u0000false\u00001\u00000\u0000ardt_ope_contante\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_operazioni",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_operazioni",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_sogope = new ardt_sogopeBO(m_Ctx);
    ardt_clientiope = new ardt_clientiopeBO(m_Ctx);
    ardt_mlientiope = new ardt_mlientiopeBO(m_Ctx);
    ardt_mogopebo = new ardt_mogopeboBO(m_Ctx);
    ardt_beneficope = new ardt_beneficopeBO(m_Ctx);
    ardt_meneficope = new ardt_meneficopeBO(m_Ctx);
    ardt_terzistiope = new ardt_terzistiopeBO(m_Ctx);
    ardt_merzistiope = new ardt_merzistiopeBO(m_Ctx);
    ardt_rapcoll = new ardt_rapcollBO(m_Ctx);
    ardt_docopebo = new ardt_docopeboBO(m_Ctx);
    armt_operazbo_agg = new armt_operazbo_aggBO(m_Ctx);
    ardt_ope_contante = new ardt_ope_contanteBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_operazioni",m_Ctx);
  ...
  public boolean Check() {
    ...
    if (l_bResult && (( ! (ardt_sogope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_sogope)) || ( ! (ardt_sogope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_sogope)))) {
      ardt_sogope.SetFromContext(m_cWv_ardt_sogope);
      m_cWv_ardt_sogope = "_not_empty_";
    }
    if (l_bResult && (ardt_sogope.m_bLoaded || ardt_sogope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_sogope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_sogope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_clientiope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_clientiope)) || ( ! (ardt_clientiope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_clientiope)))) {
      ardt_clientiope.SetFromContext(m_cWv_ardt_clientiope);
      m_cWv_ardt_clientiope = "_not_empty_";
    }
    if (l_bResult && (ardt_clientiope.m_bLoaded || ardt_clientiope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_clientiope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_clientiope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_mlientiope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_mlientiope)) || ( ! (ardt_mlientiope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_mlientiope)))) {
      ardt_mlientiope.SetFromContext(m_cWv_ardt_mlientiope);
      m_cWv_ardt_mlientiope = "_not_empty_";
    }
    if (l_bResult && (ardt_mlientiope.m_bLoaded || ardt_mlientiope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_mlientiope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_mlientiope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_mogopebo.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_mogopebo)) || ( ! (ardt_mogopebo.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_mogopebo)))) {
      ardt_mogopebo.SetFromContext(m_cWv_ardt_mogopebo);
      m_cWv_ardt_mogopebo = "_not_empty_";
    }
    if (l_bResult && (ardt_mogopebo.m_bLoaded || ardt_mogopebo.m_bUpdated)) {
      l_bResult = l_bResult && ardt_mogopebo.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_mogopebo.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_beneficope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_beneficope)) || ( ! (ardt_beneficope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_beneficope)))) {
      ardt_beneficope.SetFromContext(m_cWv_ardt_beneficope);
      m_cWv_ardt_beneficope = "_not_empty_";
    }
    if (l_bResult && (ardt_beneficope.m_bLoaded || ardt_beneficope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_beneficope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_beneficope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_meneficope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_meneficope)) || ( ! (ardt_meneficope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_meneficope)))) {
      ardt_meneficope.SetFromContext(m_cWv_ardt_meneficope);
      m_cWv_ardt_meneficope = "_not_empty_";
    }
    if (l_bResult && (ardt_meneficope.m_bLoaded || ardt_meneficope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_meneficope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_meneficope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_terzistiope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_terzistiope)) || ( ! (ardt_terzistiope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_terzistiope)))) {
      ardt_terzistiope.SetFromContext(m_cWv_ardt_terzistiope);
      m_cWv_ardt_terzistiope = "_not_empty_";
    }
    if (l_bResult && (ardt_terzistiope.m_bLoaded || ardt_terzistiope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_terzistiope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_terzistiope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_merzistiope.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_merzistiope)) || ( ! (ardt_merzistiope.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_merzistiope)))) {
      ardt_merzistiope.SetFromContext(m_cWv_ardt_merzistiope);
      m_cWv_ardt_merzistiope = "_not_empty_";
    }
    if (l_bResult && (ardt_merzistiope.m_bLoaded || ardt_merzistiope.m_bUpdated)) {
      l_bResult = l_bResult && ardt_merzistiope.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_merzistiope.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_rapcoll.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_rapcoll)) || ( ! (ardt_rapcoll.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_rapcoll)))) {
      ardt_rapcoll.SetFromContext(m_cWv_ardt_rapcoll);
      m_cWv_ardt_rapcoll = "_not_empty_";
    }
    if (l_bResult && (ardt_rapcoll.m_bLoaded || ardt_rapcoll.m_bUpdated)) {
      l_bResult = l_bResult && ardt_rapcoll.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
    ...
    if (l_bResult && (( ! (armt_operazbo_agg.m_bLoaded) && CPLib.IsLoaded(m_cWv_armt_operazbo_agg)) || ( ! (armt_operazbo_agg.m_bUpdated) && CPLib.IsUpdated(m_cWv_armt_operazbo_agg)))) {
      armt_operazbo_agg.SetFromContext(m_cWv_armt_operazbo_agg);
      m_cWv_armt_operazbo_agg = "_not_empty_";
    }
    if (l_bResult && (armt_operazbo_agg.m_bLoaded || armt_operazbo_agg.m_bUpdated)) {
      l_bResult = l_bResult && armt_operazbo_agg.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = armt_operazbo_agg.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_ope_contante.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_ope_contante)) || ( ! (ardt_ope_contante.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_ope_contante)))) {
      ardt_ope_contante.SetFromContext(m_cWv_ardt_ope_contante);
      m_cWv_ardt_ope_contante = "_not_empty_";
    }
    if (l_bResult && (ardt_ope_contante.m_bLoaded || ardt_ope_contante.m_bUpdated)) {
      l_bResult = l_bResult && ardt_ope_contante.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_operazioni"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_operazioni\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public boolean CanEdit(String p_cState) {
    ...
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile modifcare un'operazione già cancellata o copia di modifica";
    }
  ...
  public boolean CanDelete() {
    ...
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile cancellare un'operazione già cancellata o copia di modifica";
    }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"POPERAZ1"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_operazbo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_NUMPROG = m_Ctx.AskTableProg(w_NUMPROG,11,op_NUMPROG,"POPERAZ2"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_operazbo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PRGIMPOPE = m_Ctx.AskTableProg(w_PRGIMPOPE,15,op_PRGIMPOPE,"PRGIMPOPE"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_operazbo);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (ardt_sogope.IsUpdated()) {
        m_cWv_ardt_sogope = ardt_sogope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_sogope",m_cWv_ardt_sogope,0);
    }
    if (p_bGetChildren) {
      if (ardt_clientiope.IsUpdated()) {
        m_cWv_ardt_clientiope = ardt_clientiope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_clientiope",m_cWv_ardt_clientiope,0);
    }
    if (p_bGetChildren) {
      if (ardt_mlientiope.IsUpdated()) {
        m_cWv_ardt_mlientiope = ardt_mlientiope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_mlientiope",m_cWv_ardt_mlientiope,0);
    }
    if (p_bGetChildren) {
      if (ardt_mogopebo.IsUpdated()) {
        m_cWv_ardt_mogopebo = ardt_mogopebo.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_mogopebo",m_cWv_ardt_mogopebo,0);
    }
    if (p_bGetChildren) {
      if (ardt_beneficope.IsUpdated()) {
        m_cWv_ardt_beneficope = ardt_beneficope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_beneficope",m_cWv_ardt_beneficope,0);
    }
    if (p_bGetChildren) {
      if (ardt_meneficope.IsUpdated()) {
        m_cWv_ardt_meneficope = ardt_meneficope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_meneficope",m_cWv_ardt_meneficope,0);
    }
    if (p_bGetChildren) {
      if (ardt_terzistiope.IsUpdated()) {
        m_cWv_ardt_terzistiope = ardt_terzistiope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_terzistiope",m_cWv_ardt_terzistiope,0);
    }
    if (p_bGetChildren) {
      if (ardt_merzistiope.IsUpdated()) {
        m_cWv_ardt_merzistiope = ardt_merzistiope.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_merzistiope",m_cWv_ardt_merzistiope,0);
    }
    if (p_bGetChildren) {
      if (ardt_rapcoll.IsUpdated()) {
        m_cWv_ardt_rapcoll = ardt_rapcoll.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_rapcoll",m_cWv_ardt_rapcoll,0);
    }
    if (p_bGetChildren) {
    ...
    if (p_bGetChildren) {
      if (armt_operazbo_agg.IsUpdated()) {
        m_cWv_armt_operazbo_agg = armt_operazbo_agg.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_armt_operazbo_agg",m_cWv_armt_operazbo_agg,0);
    }
    if (p_bGetChildren) {
      if (ardt_ope_contante.IsUpdated()) {
        m_cWv_ardt_ope_contante = ardt_ope_contante.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_ope_contante",m_cWv_ardt_ope_contante,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "operazbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public boolean ChildExists_ardt_sogope() {
    if (ardt_sogope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_sogope) || CPLib.IsLoaded(m_cWv_ardt_sogope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_sogope.m_bLoaded)) {
      ardt_sogope.Blank();
      ardt_sogope.w_IDFILEBO = w_IDBASE;
      ardt_sogope.Load();
    }
    return ardt_sogope.m_bLoaded;
  }
  public void CtxLoad_ardt_sogope() {
    if ( ! (ardt_sogope.m_lCtxLoaded)) {
      ardt_sogope.Blank();
    }
    ardt_sogope.m_lCtxLoaded = true;
    if ( ! (ardt_sogope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_sogope) || CPLib.IsLoaded(m_cWv_ardt_sogope)) {
        ardt_sogope.SetFromContext(m_cWv_ardt_sogope);
        m_cWv_ardt_sogope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_sogope.m_bLoaded)) {
          ardt_sogope.Blank();
          ardt_sogope.w_IDFILEBO = w_IDBASE;
          ardt_sogope.Load();
          if ( ! (ardt_sogope.m_bLoaded)) {
            ardt_sogope.Initialize();
            ardt_sogope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_clientiope() {
    if (ardt_clientiope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_clientiope) || CPLib.IsLoaded(m_cWv_ardt_clientiope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_clientiope.m_bLoaded)) {
      ardt_clientiope.Blank();
      ardt_clientiope.w_IDFILEBO = w_IDBASE;
      ardt_clientiope.Load();
    }
    return ardt_clientiope.m_bLoaded;
  }
  public void CtxLoad_ardt_clientiope() {
    if ( ! (ardt_clientiope.m_lCtxLoaded)) {
      ardt_clientiope.Blank();
    }
    ardt_clientiope.m_lCtxLoaded = true;
    if ( ! (ardt_clientiope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_clientiope) || CPLib.IsLoaded(m_cWv_ardt_clientiope)) {
        ardt_clientiope.SetFromContext(m_cWv_ardt_clientiope);
        m_cWv_ardt_clientiope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_clientiope.m_bLoaded)) {
          ardt_clientiope.Blank();
          ardt_clientiope.w_IDFILEBO = w_IDBASE;
          ardt_clientiope.Load();
          if ( ! (ardt_clientiope.m_bLoaded)) {
            ardt_clientiope.Initialize();
            ardt_clientiope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_mlientiope() {
    if (ardt_mlientiope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_mlientiope) || CPLib.IsLoaded(m_cWv_ardt_mlientiope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_mlientiope.m_bLoaded)) {
      ardt_mlientiope.Blank();
      ardt_mlientiope.w_IDFILEBO = w_IDBASE;
      ardt_mlientiope.Load();
    }
    return ardt_mlientiope.m_bLoaded;
  }
  public void CtxLoad_ardt_mlientiope() {
    if ( ! (ardt_mlientiope.m_lCtxLoaded)) {
      ardt_mlientiope.Blank();
    }
    ardt_mlientiope.m_lCtxLoaded = true;
    if ( ! (ardt_mlientiope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_mlientiope) || CPLib.IsLoaded(m_cWv_ardt_mlientiope)) {
        ardt_mlientiope.SetFromContext(m_cWv_ardt_mlientiope);
        m_cWv_ardt_mlientiope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_mlientiope.m_bLoaded)) {
          ardt_mlientiope.Blank();
          ardt_mlientiope.w_IDFILEBO = w_IDBASE;
          ardt_mlientiope.Load();
          if ( ! (ardt_mlientiope.m_bLoaded)) {
            ardt_mlientiope.Initialize();
            ardt_mlientiope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_mogopebo() {
    if (ardt_mogopebo.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_mogopebo) || CPLib.IsLoaded(m_cWv_ardt_mogopebo))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_mogopebo.m_bLoaded)) {
      ardt_mogopebo.Blank();
      ardt_mogopebo.w_IDFILEBO = w_IDBASE;
      ardt_mogopebo.Load();
    }
    return ardt_mogopebo.m_bLoaded;
  }
  public void CtxLoad_ardt_mogopebo() {
    if ( ! (ardt_mogopebo.m_lCtxLoaded)) {
      ardt_mogopebo.Blank();
    }
    ardt_mogopebo.m_lCtxLoaded = true;
    if ( ! (ardt_mogopebo.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_mogopebo) || CPLib.IsLoaded(m_cWv_ardt_mogopebo)) {
        ardt_mogopebo.SetFromContext(m_cWv_ardt_mogopebo);
        m_cWv_ardt_mogopebo = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_mogopebo.m_bLoaded)) {
          ardt_mogopebo.Blank();
          ardt_mogopebo.w_IDFILEBO = w_IDBASE;
          ardt_mogopebo.Load();
          if ( ! (ardt_mogopebo.m_bLoaded)) {
            ardt_mogopebo.Initialize();
            ardt_mogopebo.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_beneficope() {
    if (ardt_beneficope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_beneficope) || CPLib.IsLoaded(m_cWv_ardt_beneficope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_beneficope.m_bLoaded)) {
      ardt_beneficope.Blank();
      ardt_beneficope.w_IDFILEBO = w_IDBASE;
      ardt_beneficope.Load();
    }
    return ardt_beneficope.m_bLoaded;
  }
  public void CtxLoad_ardt_beneficope() {
    if ( ! (ardt_beneficope.m_lCtxLoaded)) {
      ardt_beneficope.Blank();
    }
    ardt_beneficope.m_lCtxLoaded = true;
    if ( ! (ardt_beneficope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_beneficope) || CPLib.IsLoaded(m_cWv_ardt_beneficope)) {
        ardt_beneficope.SetFromContext(m_cWv_ardt_beneficope);
        m_cWv_ardt_beneficope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_beneficope.m_bLoaded)) {
          ardt_beneficope.Blank();
          ardt_beneficope.w_IDFILEBO = w_IDBASE;
          ardt_beneficope.Load();
          if ( ! (ardt_beneficope.m_bLoaded)) {
            ardt_beneficope.Initialize();
            ardt_beneficope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_meneficope() {
    if (ardt_meneficope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_meneficope) || CPLib.IsLoaded(m_cWv_ardt_meneficope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_meneficope.m_bLoaded)) {
      ardt_meneficope.Blank();
      ardt_meneficope.w_IDFILEBO = w_IDBASE;
      ardt_meneficope.Load();
    }
    return ardt_meneficope.m_bLoaded;
  }
  public void CtxLoad_ardt_meneficope() {
    if ( ! (ardt_meneficope.m_lCtxLoaded)) {
      ardt_meneficope.Blank();
    }
    ardt_meneficope.m_lCtxLoaded = true;
    if ( ! (ardt_meneficope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_meneficope) || CPLib.IsLoaded(m_cWv_ardt_meneficope)) {
        ardt_meneficope.SetFromContext(m_cWv_ardt_meneficope);
        m_cWv_ardt_meneficope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_meneficope.m_bLoaded)) {
          ardt_meneficope.Blank();
          ardt_meneficope.w_IDFILEBO = w_IDBASE;
          ardt_meneficope.Load();
          if ( ! (ardt_meneficope.m_bLoaded)) {
            ardt_meneficope.Initialize();
            ardt_meneficope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_terzistiope() {
    if (ardt_terzistiope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_terzistiope) || CPLib.IsLoaded(m_cWv_ardt_terzistiope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_terzistiope.m_bLoaded)) {
      ardt_terzistiope.Blank();
      ardt_terzistiope.w_IDFILEBO = w_IDBASE;
      ardt_terzistiope.Load();
    }
    return ardt_terzistiope.m_bLoaded;
  }
  public void CtxLoad_ardt_terzistiope() {
    if ( ! (ardt_terzistiope.m_lCtxLoaded)) {
      ardt_terzistiope.Blank();
    }
    ardt_terzistiope.m_lCtxLoaded = true;
    if ( ! (ardt_terzistiope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_terzistiope) || CPLib.IsLoaded(m_cWv_ardt_terzistiope)) {
        ardt_terzistiope.SetFromContext(m_cWv_ardt_terzistiope);
        m_cWv_ardt_terzistiope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_terzistiope.m_bLoaded)) {
          ardt_terzistiope.Blank();
          ardt_terzistiope.w_IDFILEBO = w_IDBASE;
          ardt_terzistiope.Load();
          if ( ! (ardt_terzistiope.m_bLoaded)) {
            ardt_terzistiope.Initialize();
            ardt_terzistiope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_merzistiope() {
    if (ardt_merzistiope.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_merzistiope) || CPLib.IsLoaded(m_cWv_ardt_merzistiope))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_merzistiope.m_bLoaded)) {
      ardt_merzistiope.Blank();
      ardt_merzistiope.w_IDFILEBO = w_IDBASE;
      ardt_merzistiope.Load();
    }
    return ardt_merzistiope.m_bLoaded;
  }
  public void CtxLoad_ardt_merzistiope() {
    if ( ! (ardt_merzistiope.m_lCtxLoaded)) {
      ardt_merzistiope.Blank();
    }
    ardt_merzistiope.m_lCtxLoaded = true;
    if ( ! (ardt_merzistiope.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_merzistiope) || CPLib.IsLoaded(m_cWv_ardt_merzistiope)) {
        ardt_merzistiope.SetFromContext(m_cWv_ardt_merzistiope);
        m_cWv_ardt_merzistiope = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_merzistiope.m_bLoaded)) {
          ardt_merzistiope.Blank();
          ardt_merzistiope.w_IDFILEBO = w_IDBASE;
          ardt_merzistiope.Load();
          if ( ! (ardt_merzistiope.m_bLoaded)) {
            ardt_merzistiope.Initialize();
            ardt_merzistiope.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_rapcoll() {
    if (ardt_rapcoll.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_rapcoll) || CPLib.IsLoaded(m_cWv_ardt_rapcoll))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_rapcoll.m_bLoaded)) {
      ardt_rapcoll.Blank();
      ardt_rapcoll.w_IDFILEBO = w_IDBASE;
      ardt_rapcoll.Load();
    }
    return ardt_rapcoll.m_bLoaded;
  }
  public void CtxLoad_ardt_rapcoll() {
    if ( ! (ardt_rapcoll.m_lCtxLoaded)) {
      ardt_rapcoll.Blank();
    }
    ardt_rapcoll.m_lCtxLoaded = true;
    if ( ! (ardt_rapcoll.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_rapcoll) || CPLib.IsLoaded(m_cWv_ardt_rapcoll)) {
        ardt_rapcoll.SetFromContext(m_cWv_ardt_rapcoll);
        m_cWv_ardt_rapcoll = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_rapcoll.m_bLoaded)) {
          ardt_rapcoll.Blank();
          ardt_rapcoll.w_IDFILEBO = w_IDBASE;
          ardt_rapcoll.Load();
          if ( ! (ardt_rapcoll.m_bLoaded)) {
            ardt_rapcoll.Initialize();
            ardt_rapcoll.SetUpdated();
          }
        }
      }
    }
  ...
  public boolean ChildExists_armt_operazbo_agg() {
    if (armt_operazbo_agg.IsUpdated() || (CPLib.IsUpdated(m_cWv_armt_operazbo_agg) || CPLib.IsLoaded(m_cWv_armt_operazbo_agg))) {
      return true;
    } else if (m_bLoaded &&  ! (armt_operazbo_agg.m_bLoaded)) {
      armt_operazbo_agg.Blank();
      armt_operazbo_agg.w_IDBASE = w_IDBASE;
      armt_operazbo_agg.Load();
    }
    return armt_operazbo_agg.m_bLoaded;
  }
  public void CtxLoad_armt_operazbo_agg() {
    if ( ! (armt_operazbo_agg.m_lCtxLoaded)) {
      armt_operazbo_agg.Blank();
    }
    armt_operazbo_agg.m_lCtxLoaded = true;
    if ( ! (armt_operazbo_agg.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_armt_operazbo_agg) || CPLib.IsLoaded(m_cWv_armt_operazbo_agg)) {
        armt_operazbo_agg.SetFromContext(m_cWv_armt_operazbo_agg);
        m_cWv_armt_operazbo_agg = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (armt_operazbo_agg.m_bLoaded)) {
          armt_operazbo_agg.Blank();
          armt_operazbo_agg.w_IDBASE = w_IDBASE;
          armt_operazbo_agg.Load();
          if ( ! (armt_operazbo_agg.m_bLoaded)) {
            armt_operazbo_agg.Initialize();
            armt_operazbo_agg.SetUpdated();
          }
          CopyWorkVar(this,armt_operazbo_agg,new String[]{"SEGNO"},new String[]{"SEGNO"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,armt_operazbo_agg,new String[]{"SEGNO"},new String[]{"SEGNO"},true);
        }
      }
  ...
  public boolean ChildExists_ardt_ope_contante() {
    if (ardt_ope_contante.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_ope_contante) || CPLib.IsLoaded(m_cWv_ardt_ope_contante))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_ope_contante.m_bLoaded)) {
      ardt_ope_contante.Blank();
      ardt_ope_contante.w_IDOPE = w_IDBASE;
      ardt_ope_contante.Load();
    }
    return ardt_ope_contante.m_bLoaded;
  }
  public void CtxLoad_ardt_ope_contante() {
    if ( ! (ardt_ope_contante.m_lCtxLoaded)) {
      ardt_ope_contante.Blank();
    }
    ardt_ope_contante.m_lCtxLoaded = true;
    if ( ! (ardt_ope_contante.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_ope_contante) || CPLib.IsLoaded(m_cWv_ardt_ope_contante)) {
        ardt_ope_contante.SetFromContext(m_cWv_ardt_ope_contante);
        m_cWv_ardt_ope_contante = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_ope_contante.m_bLoaded)) {
          ardt_ope_contante.Blank();
          ardt_ope_contante.w_IDOPE = w_IDBASE;
          ardt_ope_contante.Load();
          if ( ! (ardt_ope_contante.m_bLoaded)) {
            ardt_ope_contante.Initialize();
            ardt_ope_contante.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_sogope")) {
      CtxLoad_ardt_sogope();
      return ardt_sogope;
    }
    if (CPLib.eq(p_cName,"ardt_clientiope")) {
      CtxLoad_ardt_clientiope();
      return ardt_clientiope;
    }
    if (CPLib.eq(p_cName,"ardt_mlientiope")) {
      CtxLoad_ardt_mlientiope();
      return ardt_mlientiope;
    }
    if (CPLib.eq(p_cName,"ardt_mogopebo")) {
      CtxLoad_ardt_mogopebo();
      return ardt_mogopebo;
    }
    if (CPLib.eq(p_cName,"ardt_beneficope")) {
      CtxLoad_ardt_beneficope();
      return ardt_beneficope;
    }
    if (CPLib.eq(p_cName,"ardt_meneficope")) {
      CtxLoad_ardt_meneficope();
      return ardt_meneficope;
    }
    if (CPLib.eq(p_cName,"ardt_terzistiope")) {
      CtxLoad_ardt_terzistiope();
      return ardt_terzistiope;
    }
    if (CPLib.eq(p_cName,"ardt_merzistiope")) {
      CtxLoad_ardt_merzistiope();
      return ardt_merzistiope;
    }
    if (CPLib.eq(p_cName,"ardt_rapcoll")) {
      CtxLoad_ardt_rapcoll();
      return ardt_rapcoll;
    }
    ...
    if (CPLib.eq(p_cName,"armt_operazbo_agg")) {
      CtxLoad_armt_operazbo_agg();
      return armt_operazbo_agg;
    }
    if (CPLib.eq(p_cName,"ardt_ope_contante")) {
      CtxLoad_ardt_ope_contante();
      return ardt_ope_contante;
    }
