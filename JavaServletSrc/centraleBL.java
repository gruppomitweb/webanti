...
public class centraleBL extends centraleWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "centrale";
  ...
  public centraleBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("centrale","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
