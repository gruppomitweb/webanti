...
public class ardt_docopeboBL extends ardt_docopeboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_docopebo";
  ...
  public CPPhTableWrInfo m_oWrInfo_docopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_docopebo;
  ...
  public static String[] m_EntityTables = {"docopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'NUMPROG':NUMPROG,'m_Detail':{'CONNESCLI':CONNESCLI,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'AUTRILASC':AUTRILASC,'DATAVALI':DATAVALI,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PAESE':PAESE"+FoundlingChildrenList("ardt_docopebo",true,true)+"}"+FoundlingChildrenList("ardt_docopebo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'NUMPROG':NUMPROG,'m_Detail':{'CONNESCLI':CONNESCLI,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'AUTRILASC':AUTRILASC,'xRagSocDoc':xRagSocDoc,'DATAVALI':DATAVALI,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PAESE':PAESE,'dessta':dessta"+FoundlingChildrenList("ardt_docopebo",true,true)+"}"+FoundlingChildrenList("ardt_docopebo",true,false)+"}";
  public static final String i_ItemSequence = "NUMPROG,m_Detail[ CONNESCLI TIPODOC NUMDOCUM DATARILASC AUTRILASC DATAVALI DOMICILIO DESCCIT PROVINCIA CAP PAESE"+FoundlingChildrenList("ardt_docopebo",false,true)+"]"+FoundlingChildrenList("ardt_docopebo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_docopebo"),new String[][]{new String[]{"NUMPROG","Codice Operazione","C","11","0","campo","key1","false","false"},new String[]{"CONNESCLI","Codice Operatore","C","16","0","campo","key1","true","false"},new String[]{"TIPODOC","Tipo Documento","C","2","0","campo","nokey","true","false"},new String[]{"NUMDOCUM","Numero Doc.","C","15","0","campo","nokey","true","false"},new String[]{"DATARILASC","Data Rilascio Doc.","D","8","0","campo","nokey","true","false"},new String[]{"AUTRILASC","Autorità di rilascio","C","30","0","campo","nokey","true","false"},new String[]{"DATAVALI","Data Fine Validità","D","8","0","campo","nokey","true","false"},new String[]{"DOMICILIO","Indirizzo","C","35","0","campo","nokey","true","false"},new String[]{"DESCCIT","Città","C","30","0","campo","nokey","true","false"},new String[]{"PROVINCIA","Provincia","C","2","0","campo","nokey","true","false"},new String[]{"CAP","CAP","C","9","0","campo","nokey","true","false"},new String[]{"PAESE","Stato","C","3","0","campo","nokey","true","false"}});
  ...
  public ardt_docopeboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_docopebo = p_ContextObject.GetPhName("docopebo",p_ContextObject.GetCompany(),false);
    m_cServer_docopebo = p_ContextObject.GetServer("docopebo");
    m_oWrInfo_docopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"docopebo",p_ContextObject.GetCompany());
    m_cVirtName_docopebo = CPSql.ManipulateTablePhName("docopebo",m_cServer_docopebo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_docopebo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_docopebo","docopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_docopebo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_docopebo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_docopebo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_docopebo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_docopebo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_docopebo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "docopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("NUMPROG","C",11,0));
  }
  public String RowPrimaryKey() {
    return "docopebo"+"\\"+CPLib.ToCPStr(w_CONNESCLI);
  }
