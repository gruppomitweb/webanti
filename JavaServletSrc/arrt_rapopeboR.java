...
// * --- Fine Area Manuale
public class arrt_rapopeboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_rapopeboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_rapopebo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(w_tipooper,"S")) {
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_rapopebo",18,"0000000C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  public static arrt_rapopeboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_rapopeboR(p_Ctx, p_Caller);
  }
  public void Blank() {
