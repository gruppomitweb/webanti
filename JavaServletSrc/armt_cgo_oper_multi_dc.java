...
public class armt_cgo_oper_multi_dc extends SPServlet implements SPInvokable {
  public static String m_cEntityUid = "!*fd54f616*!";
  static public class ServletStatus extends SPMasterServletStatus {
    ServletStatus() {
      m_cAllVirtNames = "cgo_operazioni_dl_multi_dc";
    }
    public String w_SNAINUMOPE;
    public void BuildLastWhereFromPK() {
      if (CPLib.Empty(m_cLastWhere)) {
        m_cLastWhere = m_cLastWhere+CPLib.BuildLastWhereFromPK(w_SNAINUMOPE,context,"cgo_operazioni_dl_multi_dc","SNAINUMOPE","C",15,0,( ! (CPLib.Empty(m_cLastWhere))?" and ":""));
      }
    }
    void FillParameters() {
  ...
  public void doProcess(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
    ...
    armt_cgo_oper_multi_dcBO BO;
    BO = getBO(status);
    BO.m_bSkipCheckOTPSecurity = false;
    status.m_cVirtName = BO.m_cVirtName_cgo_operazioni_dl_multi_dc;
  ...
  public String getEntityTitle() {
    return "Multiple da completare (CGO)";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "armt_cgo_oper_multi_dc";
    l_eg.userName = getEntityTitle();
    l_eg.m_nEntityWidth = 1021;
    l_eg.m_nEntityHeight = 1053;
    l_eg.isPublic = false;
    l_eg.canAccess = true;
    l_eg.canInsert = true;
    l_eg.canChange = true;
    l_eg.canDelete = true;
    l_eg.m_cStates = "[]";
    l_eg.zoomableTables = new String[]{"cgo_operazioni_dl_multi_dc","cgo_tbtipgio","cgo_vltplat","tbcauana","tbcitta","tbstati","cgo_tipdoc","cgo_autorita","tbtipreg","personbo","intermbo","anadip","operazbo","tbcausin","tbtipatt"};
    l_eg.zoneItems = new ZoneItem[]{new ZoneItem("page_1","Dati Operazione","page"),new ZoneItem("page_2","Documenti","page"),new ZoneItem("Base","Dati Base","horizontal_section"),new ZoneItem("Operazione","Dati Operazione","horizontal_section"),new ZoneItem("Soggetto","Dati Soggetto","collapsible"),new ZoneItem("Documenti","Documenti","horizontal_section")};
    ...
    l_eg.items = new SPItem[]{
                   ...
                   new SPItem("DESCCIT2","C",40,0, "edit","Città Domicilio"),
                   ...
                   new SPItem("DATAVALI","D",8,0, "edit","Data Fine Validità"),
                   new SPItem("RDCODAUT","C",2,0, "edit","Autorità Rilascio"),
                   new SPItem("RDLOCAUT","C",20,0, "edit","Luogo Autorità Rilascio"),
                   ...
                   new SPItem("MIDBIGLIETTO1","M",10,0, "edit",""),
                   new SPItem("MIDBIGLIETTO2","M",10,0, "edit",""),
                   new SPItem("MIDBIGLIETTO3","M",10,0, "edit",""),
                   new SPItem("MIDBIGLIETTO4","M",10,0, "edit",""),
                   ...
                   new SPItem("xIMPMINTOT","N",12,2, "hide","Importo Minimo Totale Multiple"),
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,armt_cgo_oper_multi_dcBO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"10560887444",p_Context.Translate("Multiple da completare (CGO)")},
    ...
    {"10845724022",p_Context.Translate("La data del ticket non può essere maggiore della data odierna!")},
    ...
    {"12120646188",p_Context.Translate("\"9,999,999,999.99\"")},
    ...
    {"1314928579",p_Context.Translate("L'importo non può superare la differenza tra importo totale e importo contanti")},
    ...
    {"1518802369",p_Context.Translate("Attenzione! Data di rilascio superiore alla data fine validità.Verificare il corretto inserimento delle date.")},
  ...
  void WriteStyles(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='../armt_cgo_oper_multi_dc.css?"+m_cEntityUid+"'>" +
      "");
    }
  ...
  void WriteMainForm(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println("Z.Tabs.Get('tabs').InitSelect('armt_cgo_oper_multi_dc',false);");
    status.out.println(
     "</script>" +
    "");
    PrintPwdOTPDiv(status,"armt_cgo_oper_multi_dc",BO.m_bLoaded,(BO.m_bLoaded?false:false),(BO.m_bLoaded?false:false));
    status.out.println(
     "</div>" +
    "");
  }
  // GetPortlet_Documenti_Vars
  com.zucchetti.sitepainter.Library.IncludedPortletUtils.Vars GetPortlet_KUBMCPCHPZ_Vars(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    ...
    com.zucchetti.sitepainter.Library.IncludedPortletUtils.addAttribute(inclusionVars,"aOrigine","M");
  ...
  void WriteControls(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    WriteControls_p1(BO,status);
    WriteControls_p2(BO,status);
    PrintNotifyContent(status,getNotifyItems());
    WriteExtendedTabs(BO.m_MNTs,BO.extendedFields,status,3);
  }
  void WriteControls_p1(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_1' class='PageContainer' style='position:relative;height:1053px;width:1021px;display:none'>" +
    "");
  ...
  void WriteControls_p2(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_2' class='PageContainer' style='position:relative;height:497px;width:1021px;display:none'>" +
    "");
  ...
  void WriteControls_p1_b0(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b1(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println(
     "<div id='CCUOYXMBZC' class='SectionBody' style='position:relative;height:93px;display:block'>" +
    "");
    ...
    if (status.includeZoneAltInterface("Base")) {
      ...
      if (status.HasZoneAltInterface("Base@BEGIN") || status.HasZoneAltInterface("Base@END")) {
        status.out.println(
         "<div id='CCUOYXMBZC_boxContent' style='position:relative;height:93px;display:block'>" +
        "");
      }
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      ...
      status.m_nTabIndex = status.m_nTabIndex+(1);
      status.out.println(
       "<input name='CAIDBIGLIETTO' id='BMTLGIUQTH' type='text' class='Field' value="+SPLib.ToHTMLValue(BO.w_CAIDBIGLIETTO,"C",30,0,"!", status.m_oRegSettings)+" tabindex='"+(CPLib.eq(status.m_cClientMode,"query")?""+status.m_nTabIndex+"":"-1")+"' curTabIndex='"+status.m_nTabIndex+"' maxlength='30' size='30' fieldtype='C'>" +
      "");
      status.out.println(
      ...
      "");
      status.out.println(
       "<span class='SPLabel' id='DJRHGZHJSR_DIV' style='display:none'>" +
      ...
      "");
      status.out.println(
       "<span class='SPLabel' id='RKDCRUGGJP_DIV'>" +
       "<label id='RKDCRUGGJP' for='BMTLGIUQTH'>" +
  ...
  void WriteControls_p1_b1_CloseBand(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    ...
    if (status.HasZoneAnyAltInterface("Base")) {
      ...
      status.out.println("Ctrl('CCUOYXMBZC').setAttribute('band_height',93);");
    }
  ...
  void WriteControls_p1_b2(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b3(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println(
     "<div id='YORQOIOBQN' class='SectionBody' style='position:relative;display:block'>" +
    "");
    ...
    if (status.includeZoneAltInterface("Operazione")) {
      ...
      if (status.HasZoneAltInterface("Operazione@BEGIN") || status.HasZoneAltInterface("Operazione@END")) {
        status.out.println(
         "<div id='YORQOIOBQN_boxContent' style='position:relative;display:block'>" +
        "");
      }
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['YORQOIOBQN']=['band_1_102','band_1_200','band_1_428'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("Operazione@BEGIN") || status.HasZoneAltInterface("Operazione@END")) {
  ...
  void WriteControls_p1_b3_CloseBand(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b3_b0(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_1_102' style='position:relative;height:98px;display:block' page='1'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
     "<input name='DATAOPE' id='YLIKFVPZJA' type='text' class='"+status.ObligatoryClass("Field Disabled")+"' value="+SPLib.ToHTMLValue(BO.w_DATAOPE,"D",8,0,SPLib.GetUserDatePicture(status.context.GetLanguage(),"DD-MM-YYYY"), status.m_oRegSettings)+" tabindex='-1' readonly maxlength='10' size='8' fieldtype='D'>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
    ...
    "");
    status.out.println(
     "<select name='CACODICE' id='WJQFIEBCQV' class='"+status.ObligatoryClass("Combobox Disabled")+"' disabled>" +
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<select name='CAFLGOPE' id='YJDISDDJUY' class='Combobox' tabindex='"+(CPLib.eq(status.m_cClientMode,"query")?""+status.m_nTabIndex+"":"-1")+"' curTabIndex='"+status.m_nTabIndex+"'>" +
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<select name='SEGNO' id='QNNLSEAZHF' class='Combobox' tabindex='"+(CPLib.eq(status.m_cClientMode,"query")?""+status.m_nTabIndex+"":"-1")+"' curTabIndex='"+status.m_nTabIndex+"'>" +
     "<option value="+SPLib.ToHTMLValue("","C",0,0)+">" +
     "</option>" +
    ...
    "");
    status.out.println(
     "<span class='SPLabel' id='RRAEQSPNFR_DIV'>" +
     "<label id='RRAEQSPNFR' for='QNNLSEAZHF'>" +
  ...
  void WriteControls_p1_b3_b1(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_1_200' style='position:relative;display:block' page='1'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_cgo_oper_multi_dc' id='AAHJPBZVGL' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<textarea name='MIDBIGLIETTO1' id='PLOWDDMVBX' class='Memo "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"Disabled":"")+"' tabindex='"+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"-1":""+status.m_nTabIndex+"")+"' curTabIndex='"+status.m_nTabIndex+"' "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"readonly":"")+" cols='20' rows='2' style='display:none'>" +
     "</textarea>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<textarea name='MIDBIGLIETTO2' id='SARDBHIRVW' class='Memo "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"Disabled":"")+"' tabindex='"+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"-1":""+status.m_nTabIndex+"")+"' curTabIndex='"+status.m_nTabIndex+"' "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"readonly":"")+" cols='20' rows='2' style='display:none'>" +
     "</textarea>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<textarea name='MIDBIGLIETTO3' id='ASCWWTJMOW' class='Memo "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"Disabled":"")+"' tabindex='"+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"-1":""+status.m_nTabIndex+"")+"' curTabIndex='"+status.m_nTabIndex+"' "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"readonly":"")+" cols='20' rows='2' style='display:none'>" +
     "</textarea>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<textarea name='MIDBIGLIETTO4' id='VHQLLRDGQY' class='Memo "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"Disabled":"")+"' tabindex='"+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"-1":""+status.m_nTabIndex+"")+"' curTabIndex='"+status.m_nTabIndex+"' "+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"readonly":"")+" cols='20' rows='2' style='display:none'>" +
     "</textarea>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_1_200']=['AAHJPBZVGL'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p1_b3_b2(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_1_428' style='position:relative;height:137px;display:block' page='1'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    ...
    "");
    status.out.println(
     "<span class='SPLabel' id='HMWSYZMWAI_DIV'>" +
     "<label id='HMWSYZMWAI' for='RUNOCZKNEF'>" +
     ""+SPLib.ToHTMLRepresentation(status.context.Translate("WALLET:"))+"" +
     "</label>" +
     "</span>" +
    "");
  ...
  void WriteControls_p1_b4(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    if (status.IsHiddenZoneAltInterface("shadowBand_BEFORE_AQSQVBKXAL")) {
      return;
    }
    status.out.println(
     "<div id='shadowBand_BEFORE_AQSQVBKXAL' style='position:relative;height:3px;display:block' page='1'>" +
    "");
  ...
  void WriteControls_p1_b5(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println(
     "<div id='AQSQVBKXAL' class='CollapsibleBody' style='position:relative;height:420px;display:block'>" +
    "");
    ...
    if (status.includeZoneAltInterface("Soggetto")) {
      ...
      if (status.HasZoneAltInterface("Soggetto@BEGIN") || status.HasZoneAltInterface("Soggetto@END")) {
        status.out.println(
         "<div id='AQSQVBKXAL_boxContent' style='position:relative;height:420px;display:block'>" +
        "");
      }
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      ...
      status.m_nTabIndex = status.m_nTabIndex+(1);
      status.out.println(
       "<input name='NUMTEL' id='TPAKMNVWJA' type='text' class='Field' value="+SPLib.ToHTMLValue(BO.w_NUMTEL,"C",20,0,"", status.m_oRegSettings)+" tabindex='"+status.m_nTabIndex+"' curTabIndex='"+status.m_nTabIndex+"' maxlength='20' size='20' fieldtype='C'>" +
      "");
      status.m_nTabIndex = status.m_nTabIndex+(1);
      status.out.println(
  ...
  void WriteControls_p1_b5_1(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
    ...
    "");
    status.out.println(
     "<span class='SPLabel' id='IGQWCVLGRC_DIV'>" +
     "<label id='IGQWCVLGRC' for='TPAKMNVWJA'>" +
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<input name='PROFESSIONE' id='NTWMYVQDWZ' type='text' class='"+status.ObligatoryClass("Field",BO.NTWMYVQDWZ_isObligatory())+"' value="+SPLib.ToHTMLValue(BO.w_PROFESSIONE,"C",40,0,"", status.m_oRegSettings)+" tabindex='"+status.m_nTabIndex+"' curTabIndex='"+status.m_nTabIndex+"' maxlength='40' size='40' fieldtype='C' style='display:none'>" +
    "");
    status.out.println(
     "<span class='SPLabel' id='FLTWHVLGEG_DIV' style='display:none'>" +
     "<label id='FLTWHVLGEG' for='NTWMYVQDWZ'>" +
  ...
  void WriteControls_p1_b5_CloseBand(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    ...
    if (status.HasZoneAnyAltInterface("Soggetto")) {
      ...
      status.out.println("Ctrl('AQSQVBKXAL').setAttribute('band_height',420);");
    }
  ...
  void WriteControls_p1_b6(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b0(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b1(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (CPLib.eq(status.GetBoxHeaderInclude(),"")) {
      ...
      SPLib.Include(servletContext,status,status.GetBoxHeaderInclude()+"?ForcedPortletUID=XWJLXLYKJC_HEADER&m_cBoxId=XWJLXLYKJC&m_cInitialState=open&m_cTheme="+status.m_cTheme+"&m_nTabIndex="+status.m_nTabIndex+"&m_cCaption="+com.zucchetti.sitepainter.Library.URLencode(status.context.Translate("Documenti"))+"");
    }
    status.out.println(
  ...
  void WriteControls_p2_b1_CloseBand(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b2(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  static void PrintState(armt_cgo_oper_multi_dcBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(armt_cgo_oper_multi_dcBL BO,ServletStatus status) {
    PrintMNTState(status,BO,BO.m_MNTs);
    if (BO.ardt_cgo_oper_multi_dc.IsUpdated()) {
      BO.m_cWv_ardt_cgo_oper_multi_dc = BO.ardt_cgo_oper_multi_dc.GetContext();
    }
  }
  static void PrintStateWorkVars(armt_cgo_oper_multi_dcBL BO,ServletStatus status) {
    ...
    status.out.print(","+SPLib.ToJSValue(BO.w_xIMPMINTOT,"N",12,2));
    ...
    if (CPLib.eq(BO.m_cWv_ardt_cgo_oper_multi_dc,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_cgo_oper_multi_dc");
    } else if (CPLib.eq(BO.m_cWv_ardt_cgo_oper_multi_dc,"_not_empty_")) {
      BO.m_cWv_ardt_cgo_oper_multi_dc = BO.ardt_cgo_oper_multi_dc.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_cgo_oper_multi_dc,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_cgo_oper_multi_dc,"C",0,0));
    }
  ...
  void WriteMainFormVarScript(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    if ( ! (SPLib.IsMobile(status.request))) {
      status.out.println("var m_nPreferredHeight = " + SPLib.ToJSValue(1053,"N",0,0)+ ";");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"armt_cgo_oper_multi_dc"),"C",0,0)+ ";");
    ...
    status.out.println("var m_cProgNameAlter = " + SPLib.ToJSValue("armt_cgo_oper_multi_dc","C",0,0)+ ";");
    // hide e disable di pagine ed item
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"armt_cgo_oper_multi_dc",BO.GetCurrentState());
    ...
    status.out.println("// * --- armt_cgo_oper_multi_dc");
  ...
  void WriteMainFormScript(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    if (CPLib.eq(status.m_cClientMode,"edit") || CPLib.eq(status.m_cClientMode,"new")) {
      ...
      if (CPLib.eq(status.m_cClientMode,"view")) {
        ...
        status.out.println("if(c=Ctrl('QNNLSEAZHF')) SetDisabled(c,true);");
        ...
        status.out.println("if(c=Ctrl('RUNOCZKNEF')) SetDisabled(c,true);");
        ...
        status.out.println("if(c=Ctrl('TPAKMNVWJA')) SetDisabled(c,true);");
        ...
        status.out.println("if(c=Ctrl('PLOWDDMVBX')) SetDisabled(c,true);");
        status.out.println("if(c=Ctrl('SARDBHIRVW')) SetDisabled(c,true);");
        status.out.println("if(c=Ctrl('ASCWWTJMOW')) SetDisabled(c,true);");
        status.out.println("if(c=Ctrl('VHQLLRDGQY')) SetDisabled(c,true);");
        ...
        status.out.println("if(c=Ctrl('NTWMYVQDWZ')) SetDisabled(c,true);");
    ...
    status.out.println("if (Eq(name,'ardt_cgo_oper_multi_dc')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_cgo_oper_multi_dc")+"';");
    ...
    if (CPLib.ne(status.m_cClientMode,"query")) {
      ...
      if (CPLib.eq(status.m_cClientMode,"new")) {
        ...
        status.out.println("AutonumberApplet().SetETName('cgo_operazioni_dl_multi_dc');");
    ...
    status.out.println("  arrt_cgo_read_codfisc_multi_dc([['pObj',this],['pTipo','I']])");
    status.out.println("  Calculate()");
    status.out.println("}");
    status.out.println("");
    status.out.println("function DatiCN() {");
    status.out.println("  arrt_cgo_read_codfisc_multi_dc([['pObj',this],['pTipo','E']])");
    status.out.println("  Calculate()");
    status.out.println("}");
    status.out.println("// * --- Fine Area Manuale");
    status.out.println(
  ...
  armt_cgo_oper_multi_dcBO getBO(ServletStatus status) {
    armt_cgo_oper_multi_dcBO BO = new armt_cgo_oper_multi_dcBO(status.context);
    // gli op_ possono essere utilizzati dalla servlet anche prima di essere inizializzati
    BO.op_SNAINUMOPE = BO.w_SNAINUMOPE;
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(armt_cgo_oper_multi_dcBO BO) {
    XDCHolder xdc = CPLib.GetXDCHolder(SPLib.GetClassesPath(),new SPXDCReaderFactory(BO.m_Ctx.GetInstance()),BO.m_Ctx.GetInstance());
    XDCTable t = xdc.GetXDCTable("cgo_operazioni_dl_multi_dc",true);
    BO.extendedFields = CPExtenderLib.GetExtendedItemsFromTable(t);
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
  ...
  void Calculation_OATZTIMJMD(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
  ...
  void Calculation_GCDVVJTTDD(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    arrt_cgo_delete_docR l_oRoutine_arrt_cgo_delete_doc;
    l_oRoutine_arrt_cgo_delete_doc = arrt_cgo_delete_docR.Make(status.context,BO);
    l_oRoutine_arrt_cgo_delete_doc.pIDDOC = BO.w_IDDOCALL;
    l_oRoutine_arrt_cgo_delete_doc.pSaved = BO.w_saveddoc;
  ...
  void Calculation_BVTIXLYUGT(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    BO.w_PEP = "N";
  }
  void Calculation_LAEGOZNRMQ(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    BO.w_IDDOCALL = (CPLib.Empty(BO.w_IDDOCALL)?LibreriaMit.nextUID():BO.w_IDDOCALL);
  }
  void WriteTableCombo(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    String l_cTmp;
    CPResultSet l_rsLoad=null;
    l_cTmp = "[";
    if (l_rsLoad!=null)
      l_rsLoad.Close();
    l_rsLoad = BO.m_Sql.Query(BO.m_cServer_cgo_tbtipgio,CPSql.BuildSQLPhrase("CODTPGIO,DESTPGIO",BO.m_cPhName_cgo_tbtipgio,"FLGMLGIO="+CPLib.ToSQL("S","C",1,0)+" AND FLGATTIVO="+CPLib.ToSQL("S","C",1,0)+"",""));
    try {
  ...
  CPResultSet QueryKeyCursor(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    String l_cServer = BO.m_cServer_cgo_operazioni_dl_multi_dc;
    String l_cPhName = BO.m_cPhName_cgo_operazioni_dl_multi_dc;
    ...
    if ( ! (CPLib.Empty(status.m_cLastWhere))) {
      ...
      String l_cQueryFilter = armt_cgo_oper_multi_dcBL.QueryFilter(status.context);
      ...
      if (l_rsKeys!=null)
        l_rsKeys.Close();
      l_rsKeys = status.context.GetSql().Query(l_cServer,CPSql.BuildSQLPhrase(" "+BO.m_cVirtName_cgo_operazioni_dl_multi_dc+".SNAINUMOPE",CPLib.GetTablesWithAliases(l_cPhName,status.m_cAllVirtNames,status.context),l_cLastWhere,status.m_cLastOrderBy));
    } else {
  ...
  CPResultSet QueryKeyCursor(SPMasterServletStatus status) {
    String l_cServer = status.context.GetServer("cgo_operazioni_dl_multi_dc");
    String l_cPhName = CPSql.ManipulateTablePhName("cgo_operazioni_dl_multi_dc",l_cServer);
    // Creazione del cursore delle chiavi. Costruisce la frase SQL nella tabella
    // associata alla maschera selezionando solo i campi della chiave di ricerca che
    // soddisfa la clausola di "where" passata come parametro. Riceve altresì come
    // parametro la clausola di "order by".
  ...
  void Query(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    if ( ! (CPLib.Empty(status.m_cLastWhere))) {
      ...
      if (l_rsCount!=null)
        l_rsCount.Close();
      l_rsCount = BO.m_Sql.Query(BO.m_cServer_cgo_operazioni_dl_multi_dc,CPSql.BuildSQLPhrase(" count(*) as reccount",CPLib.GetTablesWithAliases(BO.m_cPhName_cgo_operazioni_dl_multi_dc,status.m_cAllVirtNames,BO.m_Ctx),l_cLastWhere,""));
      try {
  ...
  void View(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
  ...
  void Edit(ServletStatus status,armt_cgo_oper_multi_dcBO BO,SPParameterSource source) {
  ...
  void New(ServletStatus status,armt_cgo_oper_multi_dcBO BO,SPParameterSource source) {
    BO.Initialize();
    if (BO.CanAdd()) {
  ...
  void Write(ServletStatus status,armt_cgo_oper_multi_dcBO BO,SPParameterSource source) {
  ...
  void LoadCurrentRecord(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
  ...
  void EditLoad(ServletStatus status,armt_cgo_oper_multi_dcBO BO,SPParameterSource source) {
    Edit(status,BO,source);
    if ( ! (BO.m_bLoaded)) {
      status.m_cErrMsg = "";
      status.m_bError = false;
  ...
  void Delete(ServletStatus status,armt_cgo_oper_multi_dcBO BO,SPParameterSource source) {
    boolean l_bResult = false;
    String l_cTrsMsgErr = "";
    boolean l_bTrsOk = true;
  ...
  void DeleteMessage(ServletStatus status,armt_cgo_oper_multi_dcBO BO,SPParameterSource source) {
    BO.Load(status.w_SNAINUMOPE);
    status.m_cBOWarnMessageDeleted = status.context.Translate("MSG_PROCEED_WITH_DELETE");
    status.m_bExit = true;
    status.m_cClientMode = "bringback";
  }
  void Save(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    boolean l_bResult = false;
    String l_cTrsMsgErr = "";
    boolean l_bTrsOk = true;
    String l_cTransMsgErr = "";
  ...
  void Discard(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    BO.SetFromContext(status.m_cWv,status.m_Parameters);
  ...
  void CreatePortlet(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    ...
    item.put("altInterfaceFor","armt_cgo_oper_multi_dc");
    items.put(item);
    String s;
    org.json.JSONObject ctrl = null;
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Base\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Dati Base\",\"h\":93,\"name\":\"Base\",\"page\":1,\"shrinkable\":true,\"spuid\":\"CCUOYXMBZC\",\"stretch\":true,\"tabindex\":1,\"title_caption\":\"Dati Base\",\"titled\":true,\"type\":\"Box\",\"w\":1008,\"x\":8,\"y\":8,\"zone\":\"pag1_1\",\"zonepath\":\"[1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Intermediario\",\"disabled\":\"true\",\"h\":20,\"maxlength\":11,\"name\":\"gIntemediario\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"GXLWKNXGMM\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":72,\"x\":136,\"y\":22,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"N\\u00B0 Operazione\",\"h\":20,\"maxlength\":15,\"name\":\"SNAINUMOPE\",\"page\":1,\"spuid\":\"XFUOZLSACP\",\"tabindex\":3,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":114,\"x\":136,\"y\":48,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_GZVEXPFQCZ\",\"page\":1,\"spuid\":\"GZVEXPFQCZ\",\"tabindex\":93,\"type\":\"Label\",\"value\":\"N\\u00B0 Operazione:\",\"w\":117,\"x\":16,\"y\":52,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_LOEAMXUYLA\",\"page\":1,\"spuid\":\"LOEAMXUYLA\",\"tabindex\":110,\"type\":\"Label\",\"value\":\"Intermediario:\",\"w\":117,\"x\":17,\"y\":26,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Codice
,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_RKDCRUGGJP\",\"page\":1,\"spuid\":\"RKDCRUGGJP\",\"tabindex\":208,\"type\":\"Label\",\"value\":\"ID BIGLIETTO:\",\"w\":152,\"x\":352,\"y\":52,\"zone\":\"pag1_1_2\",\"zonepath\":\"[1,1,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Operazione\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Dati Operazione\",\"h\":463,\"name\":\"Operazione\",\"page\":1,\"shrinkable\":true,\"spuid\":\"YORQOIOBQN\",\"stretch\":true,\"tabindex\":14,\"title_caption\":\"Dati Operazione\",\"titled\":true,\"type\":\"Box\",\"w\":1008,\"x\":8,\"y\":102,\"zone\":\"pag1_2\",\"zonepath\":\"[1,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data Operazione\",\"disabled\":\"true\",\"h\":20,\"maxlength\":10,\"name\":\"DATAOPE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"YLIKFVPZJA\",\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":88,\"x\":136,\"y\":109,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_HVHVAYPDJE\",\"page\":1,\"spuid\":\"HVHVAYPDJE\",\"tabindex\":108,\"type\":\"Label\",\"value\":\"Data di pagamento:\",\"w\":117,\"x\":16,\"y\":113,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data registrazione\",\"disabled\":\"true\",\"h\":20,\"maxlength\":10,\"name\":\"DATAREG\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"OEIKQOZMYJ\",\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":80,\"x\":928,\"y\":109,\"zone\":\"pag1_2_2\",\"zonepath\":\"[1,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IKBMEWKQJW\",\"page\":1,\"spuid\":\"IKBMEWKQJW\",\"tabindex\":114,\"type\":\"Label\",\"value\":\"Data registrazione:\",\"w\":134,\"x\":792,\"y\":113,\"zone\":\"pag1_2_2\",\"zonepath\":\"[1,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Contanti (S\\/N)\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"FLAGCONT\",\"page\":1,\"spuid\":\"PURPSXEVAI\",\"tabindex\":28,\"textlist\":\"No,Si\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"0"+"'"+","+"'"+"1"+"'"+"\",\"w\":104,\"x\":136,\"y\":137,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Flag Wallet\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"FLAGWALLET\",\"page\":1,\"spuid\":\"DWJVPXTRND\",\"tabindex\":29,\"textlist\":\"No,Si\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"0"+"'"+","+"'"+"1"+"'"+"\",\"w\":104,\"x\":352,\"y\":136,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_GVTXMEILAZ\",\"page\":1,\"spuid\":\"GVTXMEILAZ\",\"tabindex\":113,\"type\":\"Label\",\"value\":\"Contanti:\",\"w\":117,\"x\":16,\"y\":141,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_AYZLWZINKY\",\"page\":1,\"spuid\":\"AYZLWZINKY\",\"tabindex\":205,\"type\":\"Label\",\"value\":\"Wallet:\",\"w\":80,\"x\":269,\"y\":140,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Causale\",\"disabled\":\"true\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":6,\"name\":\"CACODICE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"WJQFIEBCQV\",\"textlist\":\"Emissione Biglietti,Pagamento Biglietti\",\"type\":\"Combobox\",\"typevar\":\"numeric\",\"valuelist\":\"1,3\",\"w\":392,\"x\":136,\"y\":165,\"zone\":\"pag1_2_4\",\"zonepath\":\"[1,2,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Tipo Registrazione\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"CAFLGOPE\",\"page\":1,\"spuid\":\"YJDISDDJUY\",\"tabindex\":33,\"textlist\":\"Giocata,Versamento,Vincita,Prelievo\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"G"+"'"+","+"'"+"R"+"'"+","+"'"+"V"+"'"+","+"'"+"P"+"'"+"\",\"w\":122,\"x\":539,\"y\":165,\"zone\":\"pag1_2_4\",\"zonepath\":\"[1,2,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Segno\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"SEGNO\",\"page\":1,\"spuid\":\"QNNLSEAZHF\",\"tabindex\":34,\"textlist\":\"Avere,Dare\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+
\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":272,\"x\":144,\"y\":528,\"zone\":\"pag1_2_9\",\"zonepath\":\"[1,2,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Soggetto\",\"box_type\":\"collapsible\",\"collapsible\":true,\"comment\":\"Dati Soggetto\",\"h\":420,\"name\":\"Soggetto\",\"page\":1,\"shrinkable\":true,\"spuid\":\"AQSQVBKXAL\",\"tabindex\":15,\"title_caption\":\"Dati Soggetto\",\"titled\":true,\"type\":\"Box\",\"w\":1008,\"x\":8,\"y\":568,\"zone\":\"pag1_3\",\"zonepath\":\"[1,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"checked_value\":\"1\",\"comment\":\"Codice Fiscale Estero\",\"h\":21,\"label_text\":\"Soggetto Residente All"+"'"+"Estero\",\"maxlength\":2,\"name\":\"CFESTERO\",\"page\":1,\"spuid\":\"CZTHKEDVCO\",\"tabindex\":51,\"type\":\"Checkbox\",\"typevar\":\"numeric\",\"unchecked_value\":\"0\",\"w\":256,\"x\":136,\"y\":574,\"zone\":\"pag1_3_1\",\"zonepath\":\"[1,3,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"checked_value\":\""+"'"+"S"+"'"+"\",\"comment\":\"Persona Politicamente Esposta\",\"h\":21,\"label_text\":\"Persona Esposta Politicamente\",\"maxlength\":1,\"name\":\"PEP\",\"page\":1,\"spuid\":\"XFKXBQYUIU\",\"tabindex\":52,\"type\":\"Checkbox\",\"typevar\":\"character\",\"unchecked_value\":\""+"'"+"N"+"'"+"\",\"w\":208,\"x\":408,\"y\":574,\"zone\":\"pag1_3_1\",\"zonepath\":\"[1,3,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"check\",\"comment\":\"Codice Fiscale\",\"h\":20,\"maxlength\":16,\"name\":\"CODFISC\",\"page\":1,\"spuid\":\"OJJHIUDPFY\",\"tabindex\":53,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":128,\"x\":136,\"y\":606,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Cognome\",\"h\":20,\"maxlength\":26,\"name\":\"COGNOME\",\"page\":1,\"spuid\":\"TWTTDWKCRG\",\"tabindex\":54,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":176,\"x\":392,\"y\":606,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Nome\",\"h\":20,\"maxlength\":25,\"name\":\"NOME\",\"page\":1,\"spuid\":\"WWGIVGNUDW\",\"tabindex\":55,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":168,\"x\":616,\"y\":606,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Recupera dati anagrafici da codice fiscale\",\"h\":20,\"keep_proportions\":\"bounded\",\"name\":\"image_DERAHXASAL\",\"page\":1,\"spuid\":\"DERAHXASAL\",\"src\":\"..\\/images\\/search4.gif\",\"tabindex\":142,\"type\":\"Image\",\"w\":21,\"x\":268,\"y\":606,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_WZDAFMDKJE\",\"page\":1,\"spuid\":\"WZDAFMDKJE\",\"tabindex\":147,\"type\":\"Label\",\"value\":\"Codice Fiscale:\",\"w\":117,\"x\":16,\"y\":610,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_TVSLWOCERI\",\"page\":1,\"spuid\":\"TVSLWOCERI\",\"tabindex\":159,\"type\":\"Label\",\"value\":\"Cognome:\",\"w\":93,\"x\":296,\"y\":610,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KUPYKSUBXV\",\"page\":1,\"spuid\":\"KUPYKSUBXV\",\"tabindex\":160,\"type\":\"Label\",\"value\":\"Nome:\",\"w\":47,\"x\":568,\"y\":610,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Luogo di Nascita\",\"h\":20,\"maxlength\":30,\"name\":\"NASCOMUN\",\"page\":1,\"picker\":true,\"spuid\":\"NEUBQNUEOJ\",\"tabindex\":56,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":222,\"x\":136,\"y\":631,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Prov.\",\"h\":20,\"maxlength\":2,\"name\":\"TIPINTER\",\"page\":1,\"spuid\":\"KPSCOABZLB\",\"tabindex\":57,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":32,\"x\":440,\"y\":631,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Sesso\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"SESSO\",\"page\":1,\"spuid\":\"QPALJZMFCL\",\"tabindex\":58,\"textlist\":\"Maschile,Femminile\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"1"+"'"+","+"'"+"2"+"'"+"\",\"w\":88,\"x\":560,\"y\":631,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_WVJSUIKYEY\",\"page\":1,\"spuid\":\"WVJSUIKYEY\",\"tabindex\":144,\"type\":\"Label\",\"value\":\"Citt\\u00E0 di Nascita:\",\"w\":117,\"x\":16,\"y\":635,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KRSCDPQZTQ\",\"page\":1,\"spuid\":\"KRSCDPQZTQ\",\"tabindex\":153,\"type\":\"Label\",\"value\":\"Sesso:\",\"w\":78,\"x\":480,\"y\":635,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IVAWYVSUQI\",\"page\":1,\"spuid\":\"IVAWYVSUQI\",\"tabindex\":155,\"type\":\"Label\",\"value\":\"Prov.:\",\"w\":62,\"x\":376,\"y\":635,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Stato di nascita\",\"h\":20,\"maxlength\":30,\"name\":\"NASSTATO\",\"page\":1,\"picker\":true,\"spuid\":\"HODZKKOSYW\",\"tabindex\":59,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":222,\"x\":136,\"y\":656,\"zone\":\"pag1_3_4\",\"zonepath\":\"[1,3,4]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_ZBRDCBHLZC\",\"page\":1,\"spuid\":\"ZBRDCBHLZC\",\"tabindex\":158,\"type\":\"Label\",\"value\":\"Stato di Nascita:\",\"w\":117,\"x\":16,\"y\":661,\"zone\":\"pag1_3_4\",\"zonepath\":\"[1,3,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data Nascita\",\"h\":20,\"maxlength\":10,\"name\":\"DATANASC\",\"page\":1,\"picker\":true,\"spuid\":\"XMGRWGFSFV\",\"tabindex\":60,\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":86,\"x\":560,\"y\":657,\"zone\":\"pag1_3_5\",\"zonepath\":\"[1,3,5]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_HZYTDOZFPI\",\"page\":1,\"spuid\":\"HZYTDOZFPI\",\"tabindex\":146,\"type\":\"Label\",\"value\":\"Data Nascita:\",\"w\":93,\"x\":464,\"y\":661,\"zone\":\"pag1_3_5\",\"zonepath\":\"[1,3,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Recupera dati anagrafici da codice fiscale\",\"h\":20,\"keep_proportions\":\"bounded\",\"name\":\"image_RQVPEKINIU\",\"page\":1,\"spuid\":\"RQVPEKINIU\",\"src\":\"..\\/images\\/search4.gif\",\"tabindex\":161,\"type\":\"Image\",\"w\":21,\"x\":672,\"y\":657,\"zone\":\"pag1_3_5\",\"zonepath\":\"[1,3,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Stato\",\"h\":20,\"maxlength\":3,\"name\":\"PAESE\",\"page\":1,\"picker\":true,\"spuid\":\"YVIKEGPYPM\",\"tabindex\":61,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":40,\"x\":136,\"y\":681,\"zone\":\"pag1_3_6\",\"zonepath\":\"[1,3,6]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_RZBLEGCFJJ\",\"page\":1,\"spuid\":\"RZBLEGCFJJ\",\"tabindex\":150,\"type\":\"Label\",\"value\":\"Stato Residenza:\",\"w\":117,\"x\":16,\"y\":685,\"zone\":\"pag1_3_6\",\"zonepath\":\"[1,3,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label
\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Luogo Autorit\\u00E0 Rilascio\",\"h\":20,\"maxlength\":20,\"name\":\"RDLOCAUT\",\"page\":1,\"spuid\":\"MPRHMTBSXX\",\"tabindex\":80,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":152,\"x\":560,\"y\":907,\"zone\":\"pag1_3_18\",\"zonepath\":\"[1,3,18]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_LSLCBQSYUK\",\"page\":1,\"spuid\":\"LSLCBQSYUK\",\"tabindex\":171,\"type\":\"Label\",\"value\":\"Luogo Autorit\\u00E0 Rilascio:\",\"w\":174,\"x\":384,\"y\":911,\"zone\":\"pag1_3_18\",\"zonepath\":\"[1,3,18]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Descrizione PEP\",\"h\":20,\"maxlength\":80,\"name\":\"PEPDESCRI\",\"page\":1,\"spuid\":\"DAEHHCRYAM\",\"tabindex\":81,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":648,\"x\":136,\"y\":932,\"zone\":\"pag1_3_19\",\"zonepath\":\"[1,3,19]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_ELBFOCJOYH\",\"page\":1,\"spuid\":\"ELBFOCJOYH\",\"tabindex\":186,\"type\":\"Label\",\"value\":\"Descrizione PEP:\",\"w\":117,\"x\":16,\"y\":936,\"zone\":\"pag1_3_19\",\"zonepath\":\"[1,3,19]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Ricerca su Soggetti Segnalati (Black List Interna)\",\"h\":24,\"keep_proportions\":\"bounded\",\"name\":\"image_BYFMKHYARA\",\"page\":1,\"spuid\":\"BYFMKHYARA\",\"src\":\"..\\/{\\\"Char\\\":\\\"60124\\\",\\\"Color\\\":\\\"#000000\\\",\\\"FontName\\\":\\\"ZucchettiDevelopement\\\",\\\"FontWeight\\\":\\\"\\\",\\\"Size\\\":\\\"25\\\"}\",\"tabindex\":200,\"type\":\"Image\",\"w\":32,\"x\":16,\"y\":576,\"zone\":\"pag1_3_20\",\"zonepath\":\"[1,3,20]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Professione\",\"h\":20,\"maxlength\":40,\"name\":\"PROFESSIONE\",\"page\":1,\"spuid\":\"NTWMYVQDWZ\",\"tabindex\":202,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":252,\"x\":136,\"y\":957,\"zone\":\"pag1_3_21\",\"zonepath\":\"[1,3,21]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_FLTWHVLGEG\",\"page\":1,\"spuid\":\"FLTWHVLGEG\",\"tabindex\":203,\"type\":\"Label\",\"value\":\"Professione:\",\"w\":120,\"x\":16,\"y\":961,\"zone\":\"pag1_3_21\",\"zonepath\":\"[1,3,21]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Documenti\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Documenti\",\"h\":464,\"name\":\"Documenti\",\"page\":2,\"shrinkable\":true,\"spuid\":\"XWJLXLYKJC\",\"stretch\":true,\"tabindex\":1,\"title_caption\":\"Documenti\",\"titled\":true,\"type\":\"Box\",\"w\":1008,\"x\":8,\"y\":8,\"zone\":\"pag2_1\",\"zonepath\":\"[2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
  ...
  void WriteFormPage(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='armt_cgo_oper_multi_dc?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    if (CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")) {
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_cgo_oper_multi_dc_query.js'>" +
       "</script>" +
      "");
    } else if (CPLib.eq(status.m_cClientMode,"new") || CPLib.eq(status.m_cClientMode,"edit")) {
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_cgo_oper_multi_dc_edit.js'>" +
       "</script>" +
      "");
    }
    if (CPLib.eq(status.m_cClientMode,"painter")) {
      ...
      status.out.println("op_SNAINUMOPE=a[1];");
      status.out.println("w_TIPOGIOCO=a[2];");
      status.out.println("w_VLTPLAT=a[3];");
      status.out.println("w_CGOTIPOPE=a[4];");
      status.out.println("w_CAIDBIGLIETTO=a[5];");
      status.out.println("w_DATAOPE=a[6];");
      status.out.println("w_FLAGCONT=a[7];");
      status.out.println("w_FLAGWALLET=a[8];");
      status.out.println("w_CACODICE=a[9];");
      status.out.println("w_CODANA=a[10];");
      status.out.println("w_CODVOC=a[11];");
      status.out.println("w_CAFLGOPE=a[12];");
      status.out.println("w_SEGNO=a[13];");
      status.out.println("w_TOTLIRE=a[14];");
      status.out.println("w_TOTCONT=a[15];");
      status.out.println("w_IMPWALLET=a[16];");
      status.out.println("w_CODWALLET=a[17];");
      status.out.println("w_CODTRANSZ=a[18];");
      status.out.println("w_CGOFLGVLT=a[19];");
      status.out.println("w_CGOFLGVNP=a[20];");
      status.out.println("w_CC4CIFRE=a[21];");
      status.out.println("w_CCMESSCA=a[22];");
      status.out.println("w_CCANNSCA=a[23];");
      status.out.println("w_IBAN=a[24];");
      status.out.println("w_ASSEGNO=a[25];");
      status.out.println("w_CCDATSCA=a[26];");
      status.out.println("w_CFESTERO=a[27];");
      status.out.println("w_PEP=a[28];");
      status.out.println("w_CODFISC=a[29];");
      status.out.println("w_COGNOME=a[30];");
      status.out.println("w_NOME=a[31];");
      status.out.println("w_NASCOMUN=a[32];");
      status.out.println("w_TIPINTER=a[33];");
      status.out.println("w_SESSO=a[34];");
      status.out.println("w_NASSTATO=a[35];");
      status.out.println("w_DATANASC=a[36];");
      status.out.println("w_PAESE=a[37];");
      status.out.println("w_DESCCIT=a[38];");
      status.out.println("w_PROVINCIA=a[39];");
      status.out.println("w_CAP=a[40];");
      status.out.println("w_DOMICILIO=a[41];");
      status.out.println("w_NUMTEL=a[42];");
      status.out.println("w_FLGDOM=a[43];");
      status.out.println("w_PAESE2=a[44];");
      status.out.println("w_DESCCIT2=a[45];");
      status.out.println("w_PROVINCIA2=a[46];");
      status.out.println("w_CAP2=a[47];");
      status.out.println("w_DOMICILIO2=a[48];");
      status.out.println("w_TIPODOC=a[49];");
      status.out.println("w_NUMDOCUM=a[50];");
      status.out.println("w_DATARILASC=a[51];");
      status.out.println("w_DATAVALI=a[52];");
      status.out.println("w_RDCODAUT=a[53];");
      status.out.println("w_RDLOCAUT=a[54];");
      status.out.println("w_PEPDESCRI=a[55];");
      status.out.println("w_TIPOPERS=a[56];");
      status.out.println("w_RAGSOC=a[57];");
      status.out.println("w_SOTGRUP=a[58];");
      status.out.println("w_RAMOGRUP=a[59];");
      status.out.println("w_SETTSINT=a[60];");
      status.out.println("w_DATAREG=a[61];");
      status.out.println("w_TIPOOPRAP=a[62];");
      status.out.println("w_VALUTA=a[63];");
      status.out.println("w_CAMBIO=a[64];");
      status.out.println("w_CONNESCLI=a[65];");
      status.out.println("w_CONNESBEN=a[66];");
      status.out.println("w_C_RAG=a[67];");
      status.out.println("w_C_CTA=a[68];");
      status.out.println("w_C_PRV=a[69];");
      status.out.println("w_C_CAP=a[70];");
      status.out.println("w_C_CAB=a[71];");
      status.out.println("w_C_IND=a[72];");
      status.out.println("w_C_STA=a[73];");
      status.out.println("w_CODINTER=a[74];");
      status.out.println("w_CODDIPE=a[75];");
      status.out.println("w_DESCCITDIP=a[76];");
      status.out.println("w_FLAGFRAZ=a[77];");
      status.out.println("w_COLLEG=a[78];");
      status.out.println("w_PROVINCIADIP=a[79];");
      status.out.println("w_CODCABDIP=a[80];");
      status.out.println("w_CODCAB=a[81];");
      status.out.println("w_ATTIV=a[82];");
      status.out.println("w_AUTRILASC=a[83];");
      status.out.println("w_IDDOCALL=a[84];");
      status.out.println("w_FLGDOCALL=a[85];");
      status.out.println("w_PROFESSIONE=a[86];");
      status.out.println("w_MEZPAGAM=a[87];");
      status.out.println("w_gIntemediario=a[88];");
      status.out.println("w_gCodDip=a[89];");
      status.out.println("w_gStpDwn=a[90];");
      status.out.println("w_gVLT=a[91];");
      status.out.println("w_gVNP=a[92];");
      status.out.println("w_gChkDate=a[93];");
      status.out.println("w_gGesDoc=a[94];");
      status.out.println("w_gSeekAos=a[95];");
      status.out.println("w_gDataVaria=a[96];");
      status.out.println("w_gFlgDoc=a[97];");
      status.out.println("w_gTipMul=a[98];");
      status.out.println("w_xARDESCRI=a[99];");
      status.out.println("w_xSOGTPGIO=a[100];");
      status.out.println("w_xDEFTPGIO=a[101];");
      status.out.println("w_xEDTTPGIO=a[102];");
      status.out.println("w_xEDTSPGIO=a[103];");
      status.out.println("w_xDEFSPGIO=a[104];");
      status.out.println("w_xFLGPLGIO=a[105];");
      status.out.println("w_FLGPAGAM=a[106];");
      status.out.println("w_FILTROMP=a[107];");
      status.out.println("w_idcitta=a[108];");
      status.out.println("w_idcitta2=a[109];");
      status.out.println("w_dessta=a[110];");
      status.out.println("w_tipsot=a[111];");
      status.out.println("w_STATOREG=a[112];");
      status.out.println("w_IDBASE=a[113];");
      status.out.println("w_NUMPROG=a[114];");
      status.out.println("w_DESCRI=a[115];");
      status.out.println("w_xDescDipe=a[116];");
      status.out.println("w_datpaseuro=a[117];");
      status.out.println("w_xdes1=a[118];");
      status.out.println("w_desccauana=a[119];");
      status.out.println("w_CITINT=a[120];");
      status.out.println("w_CITDIP=a[121];");
      status.out.println("w_PROVDIP=a[122];");
      status.out.println("w_CABDIP=a[123];");
      status.out.println("w_PROVINT=a[124];");
      status.out.println("w_CABINT=a[125];");
      status.out.println("w_xdesccausin=a[126];");
      status.out.println("w_xdesctipatt=a[127];");
      status.out.println("w_MIDBIGLIETTO=a[128];");
      status.out.println("w_MIDBIGLIETTO1=a[129];");
      status.out.println("w_MIDBIGLIETTO2=a[130];");
      status.out.println("w_MIDBIGLIETTO3=a[131];");
      status.out.println("w_MIDBIGLIETTO4=a[132];");
      status.out.println("w_xVPFLGATT=a[133];");
      status.out.println("w_DOC03=a[134];");
      status.out.println("w_DOC04=a[135];");
      status.out.println("w_edtdoc=a[136];");
      status.out.println("w_saveddoc=a[137];");
      status.out.println("w_dessta2=a[138];");
      status.out.println("w_verifica=a[139];");
      status.out.println("w_xIMPMINTOT=a[140];");
      status.out.println("w_gAzienda=a[141];");
      status.out.println("w_xCGOFLGPROF=a[142];");
      status.out.println("w_ANA_FOUND=a[143];");
      status.out.println("op_codazi=a[144];");
      status.out.println("m_cWv_ardt_cgo_oper_multi_dc=a[145];");
      status.out.println("if (Gt(a.length,146)) {");
      status.out.println("m_cErrorInChild='';");
      status.out.println("}");
      status.out.println("if (Gt(a.length,146)) {");
      status.out.println("o_SNAINUMOPE=w_SNAINUMOPE;");
      ...
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_cgo_oper_multi_dc_proc.js'>" +
       "</script>" +
      "");
    }
    IncludeJS(status);
    ...
    status.themeWriter.WriteBody_Begin(1053,status.m_cBodyAttributes,status.context.Translate("MSG_LOADING")+"...");
    status.out.println(
     "<script>" +
    "");
    if (CPLib.eq(status.m_cClientMode,"edit") || CPLib.eq(status.m_cClientMode,"new")) {
  ...
  void ForwardZoom(String p_cForwardZoomResource,ServletStatus status,SPParameterSource source) {
    ...
    f.SetParameter("Table","cgo_operazioni_dl_multi_dc");
  ...
  void RaiseLoadedEntity(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void RaiseSavedEntity(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
  ...
  void WriteExitPage(armt_cgo_oper_multi_dcBO BO,ServletStatus status,Forward f) {
  ...
  void WriteExitPage(armt_cgo_oper_multi_dcBO BO,ServletStatus status) {
    WriteExitPage(BO,status,Forward.Unforwarded);
  }
  protected void BringBackPage(armt_cgo_oper_multi_dcBO BO,ServletStatus status) throws IOException {
  ...
  void IncludeJS(ServletStatus status) {
    ...
    status.out.println(
     ...
     "</script>" +
    "");
    l_cJsUid = SPPrxycizer.proxycizedPath("arrt_cgo_calc_multiid_dc.js");
    status.out.println(
     "<script src='../"+l_cJsUid+"'>" +
     "</script>" +
    "");
    ...
    status.out.println(
     ...
     "</script>" +
    "");
    l_cJsUid = SPPrxycizer.proxycizedPath("arrt_cgo_read_codfisc_multi_dc.js");
    status.out.println(
     "<script src='../"+l_cJsUid+"'>" +
     "</script>" +
    "");
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+arrt_cgo_setpagatore_m_dc.m_cEntityUid+"/arrt_cgo_setpagatore_m_dc.js'>" +
     "</script>" +
    "");
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      ...
      arrt_cgo_setpagatore_m_dc.GetCallableNames(callable);
      CPLib.AddToSet(callable,"LibreriaMit");
      CPLib.AddToSet(callable,"Utilities");
      CPLib.AddToSet(callable,"arrt_cgo_calc_multiid_dc");
      CPLib.AddToSet(callable,"arrt_cgo_moduli");
      CPLib.AddToSet(callable,"arrt_cgo_read_codfisc_multi_dc");
      CPLib.AddToSet(callable,"ardt_cgo_oper_multi_dc");
    } else {
  ...
  public String GetCheckVars(ServletStatus status,armt_cgo_oper_multi_dcBO BO,String p_cUID) {
  ...
  public boolean CheckVars(ServletStatus status,armt_cgo_oper_multi_dcBO BO) {
    boolean result = true;
