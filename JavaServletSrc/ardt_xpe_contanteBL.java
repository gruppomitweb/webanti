...
public class ardt_xpe_contanteBL extends ardt_xpe_contanteWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xpe_contante";
  ...
  public CPPhTableWrInfo m_oWrInfo_xpe_contante;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xpe_contante;
  ...
  public ardt_xpe_contanteBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xpe_contante = p_ContextObject.GetPhName("xpe_contante",p_ContextObject.GetCompany(),false);
    m_cServer_xpe_contante = p_ContextObject.GetServer("xpe_contante");
    m_oWrInfo_xpe_contante = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xpe_contante",p_ContextObject.GetCompany());
    m_cVirtName_xpe_contante = CPSql.ManipulateTablePhName("xpe_contante",m_cServer_xpe_contante);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xpe_contante",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xpe_contante","xpe_contante",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xpe_contante",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xpe_contante",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xpe_contante",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xpe_contante",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xpe_contante"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xpe_contante\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xpe_contante"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDOPE","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xpe_contante"+"\\"+CPLib.ToCPStr(w_TAGLIO);
  }
