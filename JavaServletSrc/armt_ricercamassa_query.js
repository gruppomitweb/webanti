...
WindowAlert(AlertErrorMessage('11155509822'));
}
}
}
var m_bIsMq = false;
...
m_oFather.DoQueryFromChild('tmp_ricmas1',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
_chNotF(childAlias,'master','armt_ricercamassa');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('tmp_ricmas1',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
