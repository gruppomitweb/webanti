...
public class arpg_pers_rapporti_prvBL extends arpg_pers_rapporti_prvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_pers_rapporti_prv";
  ...
  public static final String i_CompleteStateStructure = "{'CONNES':CONNES}";
  ...
  public arpg_pers_rapporti_prvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_pers_rapporti_prv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
