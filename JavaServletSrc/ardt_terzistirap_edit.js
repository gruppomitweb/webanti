...
if ( ! (m_oFather.SaveContext_ardt_terzistirap())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_terzistirap_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_terzistirap_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_terzistirap();
}
}
SaveContext.child=[];
function BlankRow() {
