...
// * --- Fine Area Manuale
public class arrt_stprappo_stoR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_stprappo_stoR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_stprappo_sto",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(w_tipstp,"N")) {
      ...
      Forward f;
      f=new Forward("Report",false,this,Forward.Start,false);
      f.SetParameter("ReportName","arrp_stprappo_ana_sto");
      f.SetParameter("outputFormat","PDF");
      f.SetParameter("daRappo",w_daRappo);
      f.SetParameter("aRappo",w_aRappo);
      f.SetParameter("m_cParameterSequence","ReportName"+","+"outputFormat"+","+"daRappo"+","+"aRappo");
  ...
  public static arrt_stprappo_stoR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_stprappo_stoR(p_Ctx, p_Caller);
  }
  public void Blank() {
