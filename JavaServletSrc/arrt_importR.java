...
// * --- Fine Area Manuale
public class arrt_importR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_importR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_import",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(_trovato,0)) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import",23,"0000000C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  public static arrt_importR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_importR(p_Ctx, p_Caller);
  }
  public void Blank() {
