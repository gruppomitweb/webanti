...
public class arpg_cgo_operazioni_agenzie_dl_multipliBL extends arpg_cgo_operazioni_agenzie_dl_multipliWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_agenzie_dl_multipli";
  ...
  public static final String i_CompleteStateStructure = "{'gCodDip':gCodDip,'gStpDwn':gStpDwn}";
  ...
  public arpg_cgo_operazioni_agenzie_dl_multipliBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_agenzie_dl_multipli","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
