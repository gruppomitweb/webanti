...
// * --- Fine Area Manuale
public class armt_rapotitBO extends armt_rapotitBL {
  class SqlLoader {
    ...
    public void AddJoinedLink_1_5(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+6,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_5.CODINTER AS CODINTER105";
        m_cSelect = m_cSelect+" ,link_1_5.DATANASC AS DATANASC105";
        m_cSelect = m_cSelect+" ,link_1_5.CODCAB AS CODCAB105";
        m_cSelect = m_cSelect+" ,link_1_5.PROVINCIA AS PROVINCIA105";
        m_cSelect = m_cSelect+" ,link_1_5.DESCCIT AS DESCCIT105";
        m_cSelect = m_cSelect+" ,link_1_5.TIPINTER AS TIPINTER105";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_5","CODINTER","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_5","CODINTER","CODINTER",true);
    ...
    public void AddJoinedLink_1_8(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_8.CODDIP AS CODDIP108";
        m_cSelect = m_cSelect+" ,link_1_8.DESCRIZ AS DESCRIZ108";
        m_cSelect = m_cSelect+" ,link_1_8.DESCCIT AS DESCCIT108";
        m_cSelect = m_cSelect+" ,link_1_8.PROVINCIA AS PROVINCIA108";
        m_cSelect = m_cSelect+" ,link_1_8.CAB AS CAB108";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_8","CODDIPE","CODDIP");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_8","CODDIPE","CODDIP",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_62(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        ...
        m_cSelect = m_cSelect+" ,link_1_62.SESSO AS SESSO162";
    ...
    public void AddJoinedLink_1_66(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_66.CODICE AS CODICE166";
        m_cSelect = m_cSelect+" ,link_1_66.DES1 AS DES1166";
        m_cSelect = m_cSelect+" ,link_1_66.TIPREG AS TIPREG166";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_66","TIPOOPRAP","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_66","TIPOOPRAP","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_69(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_69.RAPPORTO AS RAPPORTO169";
        m_cSelect = m_cSelect+" ,link_1_69.DESCRAP AS DESCRAP169";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_69","RAPPORTO","RAPPORTO");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_69","RAPPORTO","RAPPORTO",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_rapotitBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_rapotit");
    }
  ...
  public boolean CanSave() {
    ...
    if (l_bResult) {
      l_bResult = CanSaveChild(ardt_intestit,m_cWv_ardt_intestit,"m_cWv_ardt_intestit");
      if (l_bResult) {
        l_bResult = CanSaveMNTs(m_MNTs,true) && CanSaveMNTs(m_MNTs,false);
      } else {
        m_cLastMsgError = ardt_intestit.m_cLastMsgError;
      }
    }
    return l_bResult;
  }
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_intestit.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_intestit)) {
            ardt_intestit.SetFromContext(m_cWv_ardt_intestit);
            m_cWv_ardt_intestit = "_not_empty_";
          }
          if (ardt_intestit.IsUpdated()) {
            ardt_intestit.w_CODCLI = w_CONNESCLI;
            if ( ! (ardt_intestit.Save(true))) {
  ...
  public boolean Load(String p_IDBASE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_rapotit,m_cPhName_rapotit,m_cVirtName_rapotit,m_cVirtName_rapotit+".IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDBASE,"C",10,0),m_cServer_rapotit,p_IDBASE),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_1_5(m_cPhName_intermbo,m_cServer_intermbo);
    l_oSqlLoader.AddJoinedLink_1_8(m_cPhName_anadip,m_cServer_anadip);
    l_oSqlLoader.AddJoinedLink_1_62(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_66(m_cPhName_tbtipreg,m_cServer_tbtipreg);
    l_oSqlLoader.AddJoinedLink_1_69(m_cPhName_anarapbo,m_cServer_anarapbo);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_5) {
          w_datpaseuro = l_rsLoad.GetDate("DATANASC105");
          w_CABINT = l_rsLoad.GetString("CODCAB105");
          w_PROVINT = l_rsLoad.GetString("PROVINCIA105");
          w_CITINT = l_rsLoad.GetString("DESCCIT105");
          w_TIPOINTER = l_rsLoad.GetString("TIPINTER105");
        } else {
          Link_WJSVGWKSFC("Load");
        }
        w_CODDIPE = l_rsLoad.GetString("CODDIPE");
        if (l_oSqlLoader.m_bLink_1_8) {
          w_xDescDipe = l_rsLoad.GetString("DESCRIZ108");
          w_CITDIP = l_rsLoad.GetString("DESCCIT108");
          w_PROVDIP = l_rsLoad.GetString("PROVINCIA108");
          w_CABDIP = l_rsLoad.GetString("CAB108");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_62) {
          w_xRagSocCli = l_rsLoad.GetString("RAGSOC162");
          w_SESSO = l_rsLoad.GetString("SESSO162");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_66) {
          w_xDesReg = l_rsLoad.GetString("DES1166");
          w_tipreg = l_rsLoad.GetString("TIPREG166");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_69) {
          w_xdescrap = l_rsLoad.GetString("DESCRAP169");
        } else {
        ...
        m_cWv_ardt_intestit = "";
        ardt_intestit.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"rapotit")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_rapotit);
      l_cSql = "insert into "+m_oWrInfo_rapotit.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_rapotit.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"rapotit")) {
      ...
      l_cSql = l_cSql+m_oWrInfo_rapotit.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"rapotit")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_rapotit,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_rapotit);
      l_cSql = "Update "+m_oWrInfo_rapotit.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_rapotit,w_IDBASE);
      l_cSql = l_cSql+m_oWrInfo_rapotit.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"rapotit")) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          ...
          ardt_intestit.w_CODCLI = w_CONNESCLI;
          ardt_intestit.Delete();
        }
        CPLib.DeleteMNTs(m_Sql,m_MNTs,this);
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_rapotit.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_rapotit,w_IDBASE);
          l_cSql = l_cSql+m_oWrInfo_rapotit.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"rapotit")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_rapotit,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"PRGTITO1","i_codazi,w_IDBASE",m_cServer_rapotit,m_Ctx.GetCompany());
    ...
    m_Sql.NextTableProg(this,"PRGTITO2","i_codazi,w_NUMPROG",m_cServer_rapotit,m_Ctx.GetCompany());
    ...
    op_NUMPROG = w_NUMPROG;
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    m_Sql.NextTableProg(this,"PRGIMPTIT","i_codazi,w_PRGIMPTIT",m_cServer_rapotit,m_Ctx.GetCompany());
    op_PRGIMPTIT = w_PRGIMPTIT;
  }
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_chkdatdoc,arfn_chkdatreg,arrt_ae_agg_aetesta_tit,arrt_crea_idereg,arrt_delrapotit,arrt_edtrapotit,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_chkdatdoc,arfn_chkdatreg,arrt_ae_agg_aetesta_tit,arrt_crea_idereg,arrt_delrapotit,arrt_edtrapotit,arrt_writelog,";
}
