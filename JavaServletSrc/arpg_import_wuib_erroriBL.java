...
public class arpg_import_wuib_erroriBL extends arpg_import_wuib_erroriWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_wuib_errori";
  ...
  public static final String i_StateStructure = "{'tipodest':tipodest}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'tipodest':tipodest,'gAzienda':gAzienda,'gPathApp':gPathApp,'fileerrori':fileerrori,'gBrowser':gBrowser,'gUrlApp':gUrlApp}";
  public static final String i_ItemSequence = "tipodest";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"tipodest","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_import_wuib_erroriBL (CPContext p_ContextObject) {
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getVisible_fileerrori() {
    return true;
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_wuib_errori","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_fileerrori = CPLib.GetProperty(p,"fileerrori",w_fileerrori,0);
