...
m_oFather.i_last_focused_item='child_ardt_garantbo';
...
function Help() {
windowOpenForeground('../doc/ardt_garantbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'garantbo'+'\\'+CPLib.ToCPStr(w_RAPPORTO);
}
...
p_d.setValue('ardt_garantbo',m_cSelectedPage);
