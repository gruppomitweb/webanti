...
// * --- Fine Area Manuale
public class arfn_chksintR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_chksintR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_chksint",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      Cursor_tbsetsin = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select DATAINI,DATAFINE  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"SETSINT="+CPSql.SQLValueAdapter(CPLib.ToSQL(pSet,"?",0,0,m_cServer, m_oParameters),m_cServer,pSet)+" "+")"+(m_Ctx.IsSharedTemp("tbsetsin")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
  ...
  public String RunAsync(String p_pSet) {
    pSet = p_pSet;
  ...
  public boolean Run(String p_pSet) {
    pSet = p_pSet;
    return Run();
  }
  public boolean Run() {
  ...
  public static arfn_chksintR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_chksintR(p_Ctx, p_Caller);
  }
  public static arfn_chksintR Make(CPContext p_Ctx) {
    return new arfn_chksintR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
    pSet = CPLib.Space(3);
    bRitorno = false;
  ...
  // ENTITY_BATCHES: ,arfn_chksint,
  public static final String i_InvokedRoutines = ",arfn_chksint,";
  public static String[] m_cRunParameterNames={"pSet"};
}
