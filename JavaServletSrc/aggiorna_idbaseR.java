...
// * --- Fine Area Manuale
public class aggiorna_idbaseR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public aggiorna_idbaseR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("aggiorna_idbase",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      try {
        ...
        while (CPLib.le(_contacilci,_cicli)) {
          ...
          if (CPLib.ge(_top,_min)) {
            ...
            while ( ! (Cursor_operazbo.Eof())) {
              /* If (operazbo->TIPOOPRAP='11' and operazbo->CODVOC='4M') or (operazbo->TIPOOPRAP='12' and operazbo->CODVOC='3M') or (operazbo->TIPOOPRAP='11' and operazbo->CODVOC='2B') or(operazbo->TIPOOPRAP='12' and operazbo->CODVOC='1B') or(operazbo->STATOREG='1' and Empty(operazbo->DATARETT)) */
              if ((CPLib.eqr(Cursor_operazbo.GetString("TIPOOPRAP"),"11") && CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"4M")) || (CPLib.eqr(Cursor_operazbo.GetString("TIPOOPRAP"),"12") && CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"3M")) || (CPLib.eqr(Cursor_operazbo.GetString("TIPOOPRAP"),"11") && CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"2B")) || (CPLib.eqr(Cursor_operazbo.GetString("TIPOOPRAP"),"12") && CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"1B")) || (CPLib.eqr(Cursor_operazbo.GetString("STATOREG"),"1") && CPLib.Empty(Cursor_operazbo.GetDate("DATARETT")))) {
                ...
                _idbase2 = LibreriaMit.UniqueId();
                /* Case operazbo->CODVOC='3M' */
                if (CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"3M")) {
                  /* _codvoc := '11' */
                  _codvoc = "11";
                  /* Case operazbo->CODVOC='4M' */
                } else if (CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"4M")) {
                  /* _codvoc := '12' */
                  _codvoc = "12";
                  /* Case operazbo->CODVOC='2B' */
                } else if (CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"2B")) {
                  /* _codvoc := '12' */
                  _codvoc = "12";
                  /* Case operazbo->CODVOC='1B' */
                } else if (CPLib.eqr(Cursor_operazbo.GetString("CODVOC"),"1B")) {
                  /* _codvoc := '11' */
                  _codvoc = "11";
                } // End Case
                ...
                m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"0000002D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                while ( ! (Cursor_sogopebo.Eof())) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"0000002F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                while ( ! (Cursor_clientiope.Eof())) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"00000031")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                while ( ! (Cursor_beneficope.Eof())) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"00000033")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                while ( ! (Cursor_terzistiope.Eof())) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"00000035")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"00000036")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                m_cSql = m_cSql+"TIPOOPRAP = "+CPLib.ToSQL(_codvoc,"C",2,0,m_cServer)+", ";
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"00000038")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"TIPOOPRAP = "+CPLib.ToSQL("12","C",2,0,m_cServer)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"CODVOC = "+CPSql.SQLValueAdapter(CPLib.ToSQL("4M","?",0,0,m_cServer),m_cServer,"4M")+"";
        m_cSql = m_cSql+m_oWrInfo.WhereFilter();
        m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        if (CPLib.lt(m_nUpdatedRows,0)) {
          m_Sql.AbortTransaction();
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_idbase",82,"00000039")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"TIPOOPRAP = "+CPLib.ToSQL("11","C",2,0,m_cServer)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"CODVOC = "+CPSql.SQLValueAdapter(CPLib.ToSQL("3M","?",0,0,m_cServer),m_cServer,"3M")+"";
        m_cSql = m_cSql+m_oWrInfo.WhereFilter();
        m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        if (CPLib.lt(m_nUpdatedRows,0)) {
          m_Sql.AbortTransaction();
  ...
  public static aggiorna_idbaseR Make(CPContext p_Ctx, Caller p_Caller) {
    return new aggiorna_idbaseR(p_Ctx, p_Caller);
  }
  public void Blank() {
    nProgImp = 0;
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_operazbo_minmax,
  public static final String m_cVQRList = ",qbe_operazbo_minmax,";
  // ENTITY_BATCHES: ,
