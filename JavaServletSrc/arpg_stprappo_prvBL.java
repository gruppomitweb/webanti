...
public class arpg_stprappo_prvBL extends arpg_stprappo_prvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stprappo_prv";
  ...
  public static final String i_StateStructure = "{'daRappo':daRappo,'aRappo':aRappo,'DaData':DaData,'AData':AData,'coddip':coddip,'detope':detope,'flgtit':flgtit,'flgdel':flgdel}";
  public static final String i_CompleteStateStructure = "{'daRappo':daRappo,'aRappo':aRappo,'DaData':DaData,'AData':AData,'coddip':coddip,'desrap1':desrap1,'desrap2':desrap2,'detope':detope,'c_dadata':c_dadata,'c_adata':c_adata,'flgtit':flgtit,'flgdel':flgdel,'desdip':desdip}";
  public static final String i_ItemSequence = "daRappo,aRappo,DaData,AData,coddip,detope,flgtit,flgdel";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daRappo","","C","25","0","variabile","nokey","false","false"},new String[]{"aRappo","","C","25","0","variabile","nokey","false","false"},new String[]{"DaData","","D","8","0","variabile","nokey","false","false"},new String[]{"AData","","D","8","0","variabile","nokey","false","false"},new String[]{"coddip","Dipendenza / Agenzia","C","6","0","variabile","nokey","false","false"},new String[]{"detope","","C","1","0","variabile","nokey","false","false"},new String[]{"flgtit","","C","1","0","variabile","nokey","false","false"},new String[]{"flgdel","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_stprappo_prvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stprappo_prv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
