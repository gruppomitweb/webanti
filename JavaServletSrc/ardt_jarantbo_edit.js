...
if ( ! (m_oFather.SaveContext_ardt_jarantbo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_jarantbo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_jarantbo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_jarantbo();
}
}
SaveContext.child=[];
function BlankRow() {
