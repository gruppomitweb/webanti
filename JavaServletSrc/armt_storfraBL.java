...
public class armt_storfraBL extends armt_storfraWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_storfra";
  ...
  public CPPhTableWrInfo m_oWrInfo_wraziobo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wraziobo;
  ...
  public static String[] m_EntityTables = {"wraziobo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'DATAOPE':DATAOPE,'DATAREG':DATAREG,'FLAGFRAZ':FLAGFRAZ,'TIPOOPRAP':TIPOOPRAP,'CODANA':CODANA,'CODVOC':CODVOC,'appolire':appolire,'VALUTA':VALUTA,'xTOTLIRE':xTOTLIRE,'FLAGCONT':FLAGCONT,'xTOTCONT':xTOTCONT,'CAMBIO':CAMBIO,'RAPPORTO':RAPPORTO,'CONNESCLI':CONNESCLI,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'PAGASOGOP':PAGASOGOP,'CONNESBEN':CONNESBEN,'CONNALTRO':CONNALTRO,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_PRV':C_PRV,'C_CAP':C_CAP,'C_CAB':C_CAB,'C_IND':C_IND,'C_STA':C_STA,'TIPOINT2':TIPOINT2,'CODINT2':CODINT2,'DESCINTER':DESCINTER,'PAESE':PAESE,'C_RAPPORTO':C_RAPPORTO,'CODCAB2':CODCAB2,'PROV2':PROV2,'DESC2':DESC2,'ZCPARTE':ZCPARTE,'IDBASE':IDBASE,'CODDIPE':CODDIPE,'DATARETT':DATARETT,'ardt_wlientifrz':ardt_wlientifrz,'ardt_storsogfraz':ardt_storsogfraz,'ardt_weneficfrz':ardt_weneficfrz,'ardt_werzistifrz':ardt_werzistifrz,'OPERAG':OPERAG,'NOPROT':NOPROT,'RESPINS':RESPINS,'INFORM':INFORM,'NATURA':NATURA,'SCOPO':SCOPO,'AREAGEO':AREAGEO,'MODSVOL':MODSVOL,'RAGIO':RAGIO,'TIPO':TIPO,'RAREA':RAREA,'RCOMP':RCOMP,'RRAGIO':RRAGIO,'RTIPO':RTIPO,'RFREQ':RFREQ,'RIMP':RIMP,'DURAT':DURAT,'AMMONT':AMMONT,'MITIG':MITIG,'MITGDOC':MITGDOC,'ardt_docfrabo':ardt_docfrabo,'CONNESDOC':CONNESDOC,'MTCN':MTCN"+FoundlingChildrenList("armt_storfra",true)+"}";
  public static final String i_CompleteStateStructure = "{'DATAOPE':DATAOPE,'CDATOPE':CDATOPE,'filtro':filtro,'DATAREG':DATAREG,'FLAGFRAZ':FLAGFRAZ,'COLLEG':COLLEG,'TIPOOPRAP':TIPOOPRAP,'CODANA':CODANA,'CODVOC':CODVOC,'FLAGLIRE':FLAGLIRE,'appolire':appolire,'VALUTA':VALUTA,'xTOTLIRE':xTOTLIRE,'FLAGCONT':FLAGCONT,'xTOTCONT':xTOTCONT,'CAMBIO':CAMBIO,'RAPPORTO':RAPPORTO,'CONNESCLI':CONNESCLI,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'PAGASOGOP':PAGASOGOP,'CONNESBEN':CONNESBEN,'CONNALTRO':CONNALTRO,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_PRV':C_PRV,'C_CAP':C_CAP,'C_CAB':C_CAB,'C_IND':C_IND,'C_STA':C_STA,'TIPOINT2':TIPOINT2,'CODINT2':CODINT2,'DESCINTER':DESCINTER,'PAESE':PAESE,'C_RAPPORTO':C_RAPPORTO,'CODCAB2':CODCAB2,'PROV2':PROV2,'DESC2':DESC2,'ZCPARTE':ZCPARTE,'IDBASE':IDBASE,'NUMPROG':NUMPROG,'CODINTER':CODINTER,'CODDIPE':CODDIPE,'DESCCIT':DESCCIT,'SEGNO':SEGNO,'PROVINCIA':PROVINCIA,'CODCAB':CODCAB,'tipope':tipope,'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'TIPOINF':TIPOINF,'IDEREG':IDEREG,'FLAGRAP':FLAGRAP,'OPRAP':OPRAP,'RAPPORTBEN':RAPPORTBEN,'OPERATORE':OPERATORE,'AUTOM':AUTOM,'gIntemediario':gIntemediario,'xdes1':xdes1,'desccauana':desccauana,'xdesccausin':xdesccausin,'descdiv':descdiv,'xragsocper':xragsocper,'xdescrap':xdescrap,'xragsocct':xragsocct,'xragsocben':xragsocben,'xdestipleg':xdestipleg,'xragint2':xragint2,'xdescpaese2':xdescpaese2,'datpaseuro':datpaseuro,'xDescDipe':xDescDipe,'sEdit':sEdit,'gChkDate':gChkDate,'errmsg':errmsg,'test':test,'FLAGRAP2':FLAGRAP2,'valflg2':valflg2,'gTipInter':gTipInter,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'PRGIMPFRZ':PRGIMPFRZ,'dataoggi':dataoggi,'stringaflagrap2':stringaflagrap2,'gSblocco':gSblocco,'CDATAOPE':CDATAOPE,'gStatus':gStatus,'gDataVaria':gDataVaria,'CITINT':CITINT,'CITDIP':CITDIP,'CONNESDOC':CONNESDOC,'gFlgDoc':gFlgDoc,'xcodfisc':xcodfisc,'dessta':dessta,'xragsocalt':xragsocalt,'xdciticon':xdciticon,'gFlgWU':gFlgWU,'CDATREG':CDATREG,'DATAVALI':DATAVALI,'DATARILASC':DATARILASC,'apporeg':apporeg,'gFlgDTP':gFlgDTP,'ANNOOPE':ANNOOPE,'DATARETT':DATARETT,'STATOREG':STATOREG,'xdescmodsvo':xdescmodsvo,'xdescareag':xdescareag,'xdescplauso':xdescplauso,'xdesctipor':xdesctipor,'xdescopeage':xdescopeage,'xdescfreq':xdescfreq,'xdescammo':xdescammo,'ardt_wlientifrz':ardt_wlientifrz,'ardt_storsogfraz':ardt_storsogfraz,'ardt_weneficfrz':ardt_weneficfrz,'ardt_werzistifrz':ardt_werzistifrz,'OPERAG':OPERAG,'NOPROT':NOPROT,'RESPINS':RESPINS,'INFORM':INFORM,'NATURA':NATURA,'SCOPO':SCOPO,'AREAGEO':AREAGEO,'MODSVOL':MODSVOL,'RAGIO':RAGIO,'TIPO':TIPO,'RAREA':RAREA,'RCOMP':RCOMP,'RRAGIO':RRAGIO,'RTIPO':RTIPO,'RFREQ':RFREQ,'RIMP':RIMP,'DURAT':DURAT,'AMMONT':AMMONT,'IPCOLLEG':IPCOLLEG,'ORACOLLEG':ORACOLLEG,'DUCOLLEG':DUCOLLEG,'MITIG':MITIG,'MITGDOC':MITGDOC,'ardt_docfrabo':ardt_docfrabo,'xRAGSOCDOC':xRAGSOCDOC,'IDFILE':IDFILE,'MTCN':MTCN"+FoundlingChildrenList("armt_storfra",true)+"}";
  public static final String i_ItemSequence = "DATAOPE,DATAREG,FLAGFRAZ,TIPOOPRAP,CODANA,CODVOC,appolire,VALUTA,xTOTLIRE,FLAGCONT,xTOTCONT,CAMBIO,RAPPORTO,CONNESCLI,CONNESOPER,TIPOLEG,PAGASOGOP,CONNESBEN,CONNALTRO,C_RAG,C_CTA,C_PRV,C_CAP,C_CAB,C_IND,C_STA,TIPOINT2,CODINT2,DESCINTER,PAESE,C_RAPPORTO,CODCAB2,PROV2,DESC2,ZCPARTE,IDBASE,CODDIPE,DATARETT,ardt_wlientifrz,ardt_storsogfraz,ardt_weneficfrz,ardt_werzistifrz,OPERAG,NOPROT,RESPINS,INFORM,NATURA,SCOPO,AREAGEO,MODSVOL,RAGIO,TIPO,RAREA,RCOMP,RRAGIO,RTIPO,RFREQ,RIMP,DURAT,AMMONT,MITIG,MITGDOC,ardt_docfrabo,CONNESDOC,MTCN"+FoundlingChildrenList("armt_storfra",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_storfra"),new String[][]{new String[]{"DATAOPE","Data Operazione","D","8","0","campo","key2","false","true"},new String[]{"DATAREG","Data registrazione","D","8","0","campo","nokey","false","true"},new String[]{"FLAGFRAZ","Frazionata (S/N)","C","1","0","campo","nokey","false","false"},new String[]{"TIPOOPRAP","Tipo Operazione Completa","C","2","0","campo","nokey","false","false"},new String[]{"CODANA","Causale Analitica","C","4","0","campo","nokey","false","false"},new String[]{"CODVOC","Causale Sintetica","C","2","0","campo","nokey","false","false"},new String[]{"appolire","","C","1","0","variabile","nokey","false","false"},new String[]{"VALUTA","Divisa","C","3","0","campo","nokey","false","false"},new String[]{"xTOTLIRE","","N","15","2","variabile","nokey","false","true"},new String[]{"FLAGCONT","Contanti (S/N)","C","1","0","campo","nokey","false","false"},new String[]{"xTOTCONT","","N","15","2","variabile","nokey","false","true"},new String[]{"CAMBIO","Cambio","N","9","4","campo","nokey","false","false"},new String[]{"RAPPORTO","Rapporto Collegato","C","25","0","campo","nokey","false","false"},new String[]{"CONNESCLI","Codice Cliente Occasionale","C","16","0","campo","nokey","false","false"},new String[]{"CONNESOPER","Codice Cliente Occasionale","C","16","0","campo","nokey","false","false"},new String[]{"TIPOLEG","Tipo Legame","C","1","0","campo","nokey","false","true"},new String[]{"PAGASOGOP","","C","1","0","campo","nokey","false","false"},new String[]{"CONNESBEN","Codice Cliente Occasionale","C","16","0","campo","nokey","false","false"},new String[]{"CONNALTRO","","C","16","0","campo","nokey","false","false"},new String[]{"C_RAG","","C","70","0","campo","nokey","false","false"},new String[]{"C_CTA","","C","30","0","campo","nokey","false","false"},new String[]{"C_PRV","","C","2","0","campo","nokey","false","false"},new String[]{"C_CAP","","C","5","0","campo","nokey","false","false"},new String[]{"C_CAB","","C","6","0","campo","nokey","false","false"},new String[]{"C_IND","","C","35","0","campo","nokey","false","false"},new String[]{"C_STA","","C","3","0","campo","nokey","false","false"},new String[]{"TIPOINT2","Tipo Intermediario C/Parte","C","2","0","campo","nokey","false","false"},new String[]{"CODINT2","Codice Intermediario C/Parte","C","11","0","campo","nokey","false","false"},new String[]{"DESCINTER","","C","50","0","campo","nokey","false","false"},new String[]{"PAESE","Stato Intermediario C/Parte","C","3","0","campo","nokey","false","false"},new String[]{"C_RAPPORTO","","C","25","0","campo","nokey","false","false"},new String[]{"CODCAB2","CAB Intermediario C/Parte","C","6","0","campo","nokey","false","false"},new String[]{"PROV2","Provincia Intermediario C/Parte","C","2","0","campo","nokey","false","true"},new String[]{"DESC2","Denominazione Intermediario C/Parte","C","30","0","campo","nokey","false","false"},new String[]{"ZCPARTE","","C","69","0","campo","nokey","false","false"},new String[]{"IDBASE","Idbase","C","10","0","campo","key1","false","false"},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"DATARETT","Data Rettifica","D","8","0","campo","nokey","false","false"},new String[]{"ardt_wlientifrz","LinkPC","","","","link_PC","","false",""},new String[]{"ardt_storsogfraz","+ Soggetti Oper. Conto Terzi","","","","link_PC","","false",""},new String[]{"ardt_weneficfrz","LinkPC","","","","link_PC","","false",""},new String[]{"ardt_werzistifrz","LinkPC","","","","link_PC","","false",""},new String[]{"OPERAG","","C","3","0","campo","nokey","false","false"},new String[]{"NOPROT","","N","1","0","campo","nokey","false","false"},new String[]{"RESPINS","","C","30","0","campo","nokey","false","false"},new String[]{"INFORM","","C","30","0","campo","nokey","false","false"},new String[]{"NATURA","","C","50","0","campo","nokey","false","false"},new String[]{"SCOPO","","C","50","0","campo","nokey","false","false"},new String[]{"AREAGEO","","C","5","0","campo","nokey","false","false"},new String[]{"MODSVOL","","C","5","0","campo","nokey","false","false"},new String[]{"RAGIO","","C","5","0","campo","nokey","false","false"},new String[]{"TIPO","","C","3","0","campo","nokey","false","false"},new String[]{"RAREA","","N","3","0","campo","nokey","false","false"},new String[]{"RCOMP","","N","3","0","campo","nokey","false","false"},new String[]{"RRAGIO","","N","3","0","campo","nokey","false","false"},new String[]{"RTIPO","","N","3","0","campo","nokey","false","false"},new String[]{"RFREQ","","N","3","0","campo","nokey","false","false"},new String[]{"RIMP","","N","3","0","campo","nokey","false","false"},new String[]{"DURAT","","C","5","0","campo","nokey","false","false"},new String[]{"AMMONT","","C","5","0","campo","nokey","false","false"},new String[]{"MITIG","Mitigazione (+/-)","N","4","0","campo","nokey","false","false"},new String[]{"MITGDOC","Documentazione Mitigazione","C","100","0","campo","nokey","false","false"},new String[]{"ardt_docfrabo","LinkPC","","","","link_PC","","false",""},new String[]{"CONNESDOC","Storico Documenti","C","50","0","campo","nokey","false","false"},new String[]{"MTCN","MTCN","C","10","0","campo","key11","false","false"}});
  ...
  public armt_storfraBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wraziobo = p_ContextObject.GetPhName("wraziobo",p_ContextObject.GetCompany(),false);
    m_cServer_wraziobo = p_ContextObject.GetServer("wraziobo");
    m_oWrInfo_wraziobo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wraziobo",p_ContextObject.GetCompany());
    m_cVirtName_wraziobo = CPSql.ManipulateTablePhName("wraziobo",m_cServer_wraziobo);
    ...
    ardt_wlientifrz = new ardt_wlientifrzBO(p_ContextObject);
    ardt_storsogfraz = new ardt_storsogfrazBO(p_ContextObject);
    ardt_weneficfrz = new ardt_weneficfrzBO(p_ContextObject);
    ardt_werzistifrz = new ardt_werzistifrzBO(p_ContextObject);
    ardt_docfrabo = new ardt_docfraboBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_storfra",p_ContextObject);
  }
  public void Blank() {
    ...
    w_TIPOINF = "1";
    w_IDEREG = "";
    w_IDEREG = CPLib.DateToChar(w_DATAOPE)+w_NUMPROG+LibreriaMit.StatoReg("FRAZIOBO",w_STATOREG);
    w_OPRAP = "";
    w_OPRAP = "1";
    w_sEdit = 0;
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_wlientifrz.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_wlientifrz);
    l_bResult = l_bResult || ardt_storsogfraz.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_storsogfraz);
    l_bResult = l_bResult || ardt_weneficfrz.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_weneficfrz);
    l_bResult = l_bResult || ardt_werzistifrz.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_werzistifrz);
  ...
  public void SaveDependsOn() {
    ...
    o_CODDIPE = w_CODDIPE;
    ardt_wlientifrz.SaveDependsOn();
    ardt_storsogfraz.SaveDependsOn();
    ardt_weneficfrz.SaveDependsOn();
    ardt_werzistifrz.SaveDependsOn();
  ...
  protected boolean Link_FCUPIYMFZB() {
    return Link_FCUPIYMFZB("Full");
  }
  protected boolean Link_FCUPIYMFZB(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_COLLEG))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_COLLEG,"C",11,0),m_cServer_wraziobo,w_COLLEG);
      if (m_Ctx.IsSharedTemp("wraziobo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_wraziobo,"select NUMPROG from "+m_cPhName_wraziobo+((m_cPhName_wraziobo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"NUMPROG"+l_cCurrentKey+l_cWhere);
      try {
  ...
  void Link_FCUPIYMFZB_blank() {
    w_COLLEG = "";
  }
  protected boolean Link_EZPCGCABUD() {
    return Link_EZPCGCABUD("Full");
  }
  protected boolean Link_EZPCGCABUD(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_EZPCGCABUD_blank() {
    w_CODANA = "";
  }
  protected boolean Link_BHDZAMJILO() {
    return Link_BHDZAMJILO("Full");
  }
  protected boolean Link_BHDZAMJILO(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  protected boolean Link_SDKWKBVOVR() {
    return Link_SDKWKBVOVR("Full");
  }
  protected boolean Link_SDKWKBVOVR(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_SDKWKBVOVR_blank() {
    Link_SDKWKBVOVR_blank("");
  }
  void Link_SDKWKBVOVR_blank(String p_cType) {
    w_C_CAB = "";
    w_C_PRV = "";
    w_C_STA = "";
    w_C_CAP = "";
  }
  protected boolean Link_QASGTWMXYC() {
    return Link_QASGTWMXYC("Full");
  }
  protected boolean Link_QASGTWMXYC(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  protected boolean Link_KZPPWSIAXL() {
    return Link_KZPPWSIAXL("Full");
  }
  protected boolean Link_KZPPWSIAXL(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_KZPPWSIAXL_blank() {
    w_OPERAG = "";
    w_xdescopeage = "";
  }
  protected boolean Link_RTGTOVGSAH() {
    return Link_RTGTOVGSAH("Full");
  }
  protected boolean Link_RTGTOVGSAH(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_RTGTOVGSAH_blank() {
    w_AREAGEO = "";
    w_xdescareag = "";
    w_RAREA = 0;
  }
  protected boolean Link_WZGVCTOIUK() {
    return Link_WZGVCTOIUK("Full");
  }
  protected boolean Link_WZGVCTOIUK(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_WZGVCTOIUK_blank() {
    w_MODSVOL = "";
    w_xdescmodsvo = "";
    w_RCOMP = 0;
  }
  protected boolean Link_MTCGTVJYAU() {
    return Link_MTCGTVJYAU("Full");
  }
  protected boolean Link_MTCGTVJYAU(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_MTCGTVJYAU_blank() {
    w_RAGIO = "";
    w_xdescplauso = "";
    w_RRAGIO = 0;
  }
  protected boolean Link_NQCYKQCVPJ() {
    return Link_NQCYKQCVPJ("Full");
  }
  protected boolean Link_NQCYKQCVPJ(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_NQCYKQCVPJ_blank() {
    w_TIPO = "";
    w_xdesctipor = "";
    w_RTIPO = 0;
  }
  protected boolean Link_RIGLNJERGO() {
    return Link_RIGLNJERGO("Full");
  }
  protected boolean Link_RIGLNJERGO(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Link_RIGLNJERGO_blank() {
    w_DURAT = "";
    w_xdescfreq = "";
    w_RFREQ = 0;
  }
  protected boolean Link_QTLAIWJTIK() {
    return Link_QTLAIWJTIK("Full");
  }
  protected boolean Link_QTLAIWJTIK(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_storfra","wraziobo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_ardt_wlientifrz = CPLib.GetProperty(p,"m_cWv_ardt_wlientifrz",m_cWv_ardt_wlientifrz,0);
      m_cWv_ardt_storsogfraz = CPLib.GetProperty(p,"m_cWv_ardt_storsogfraz",m_cWv_ardt_storsogfraz,0);
      m_cWv_ardt_weneficfrz = CPLib.GetProperty(p,"m_cWv_ardt_weneficfrz",m_cWv_ardt_weneficfrz,0);
      m_cWv_ardt_werzistifrz = CPLib.GetProperty(p,"m_cWv_ardt_werzistifrz",m_cWv_ardt_werzistifrz,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("wlientifrz");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("wlientifrz",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("wlientifrz\u0000false\u0000false\u00001\u00000\u0000ardt_wlientifrz\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("wogopefbo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("wogopefbo",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("wogopefbo\u0000false\u0000false\u00001\u00000\u0000ardt_storsogfraz\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("weneficfrz");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("weneficfrz",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("weneficfrz\u0000false\u0000false\u00001\u00000\u0000ardt_weneficfrz\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("werzistifrz");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("werzistifrz",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("werzistifrz\u0000false\u0000false\u00001\u00000\u0000ardt_werzistifrz\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("wraziobo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("wraziobo",items);
    }
    items.add(map);
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("wraziobo\u0000false\u0000false\u00001\u00000\u0000\u0000false\u0000false\u0000Frazionate\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_storfra",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_storfra",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_wlientifrz = new ardt_wlientifrzBO(m_Ctx);
    ardt_storsogfraz = new ardt_storsogfrazBO(m_Ctx);
    ardt_weneficfrz = new ardt_weneficfrzBO(m_Ctx);
    ardt_werzistifrz = new ardt_werzistifrzBO(m_Ctx);
    ardt_docfrabo = new ardt_docfraboBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_storfra",m_Ctx);
  ...
  public boolean Check() {
    ...
    if (l_bResult && (( ! (ardt_wlientifrz.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_wlientifrz)) || ( ! (ardt_wlientifrz.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_wlientifrz)))) {
      ardt_wlientifrz.SetFromContext(m_cWv_ardt_wlientifrz);
      m_cWv_ardt_wlientifrz = "_not_empty_";
    }
    if (l_bResult && (ardt_wlientifrz.m_bLoaded || ardt_wlientifrz.m_bUpdated)) {
      l_bResult = l_bResult && ardt_wlientifrz.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_wlientifrz.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_storsogfraz.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_storsogfraz)) || ( ! (ardt_storsogfraz.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_storsogfraz)))) {
      ardt_storsogfraz.SetFromContext(m_cWv_ardt_storsogfraz);
      m_cWv_ardt_storsogfraz = "_not_empty_";
    }
    if (l_bResult && (ardt_storsogfraz.m_bLoaded || ardt_storsogfraz.m_bUpdated)) {
      l_bResult = l_bResult && ardt_storsogfraz.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_storsogfraz.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_weneficfrz.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_weneficfrz)) || ( ! (ardt_weneficfrz.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_weneficfrz)))) {
      ardt_weneficfrz.SetFromContext(m_cWv_ardt_weneficfrz);
      m_cWv_ardt_weneficfrz = "_not_empty_";
    }
    if (l_bResult && (ardt_weneficfrz.m_bLoaded || ardt_weneficfrz.m_bUpdated)) {
      l_bResult = l_bResult && ardt_weneficfrz.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_weneficfrz.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_werzistifrz.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_werzistifrz)) || ( ! (ardt_werzistifrz.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_werzistifrz)))) {
      ardt_werzistifrz.SetFromContext(m_cWv_ardt_werzistifrz);
      m_cWv_ardt_werzistifrz = "_not_empty_";
    }
    if (l_bResult && (ardt_werzistifrz.m_bLoaded || ardt_werzistifrz.m_bUpdated)) {
      l_bResult = l_bResult && ardt_werzistifrz.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_storfra"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_storfra\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public boolean CanEdit(String p_cState) {
    ...
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile variare una frazionata nell'archivio storico";
    }
  ...
  public boolean CanDelete() {
    ...
    l_bResult = false;
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile cancellare una frazionata dall'archivio storico";
    }
  ...
  public boolean CanAdd(String p_cState) {
    ...
    l_bResult = false;
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile inserire una frazionata nell'archivio storico";
    }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"PFRAZIO1"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wraziobo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_NUMPROG = m_Ctx.AskTableProg(w_NUMPROG,11,op_NUMPROG,"PFRAZIO2"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wraziobo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PRGIMPFRZ = m_Ctx.AskTableProg(w_PRGIMPFRZ,15,op_PRGIMPFRZ,"PRGIMPFRZ"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wraziobo);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (ardt_wlientifrz.IsUpdated()) {
        m_cWv_ardt_wlientifrz = ardt_wlientifrz.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_wlientifrz",m_cWv_ardt_wlientifrz,0);
    }
    if (p_bGetChildren) {
      if (ardt_storsogfraz.IsUpdated()) {
        m_cWv_ardt_storsogfraz = ardt_storsogfraz.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_storsogfraz",m_cWv_ardt_storsogfraz,0);
    }
    if (p_bGetChildren) {
      if (ardt_weneficfrz.IsUpdated()) {
        m_cWv_ardt_weneficfrz = ardt_weneficfrz.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_weneficfrz",m_cWv_ardt_weneficfrz,0);
    }
    if (p_bGetChildren) {
      if (ardt_werzistifrz.IsUpdated()) {
        m_cWv_ardt_werzistifrz = ardt_werzistifrz.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_werzistifrz",m_cWv_ardt_werzistifrz,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wraziobo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public boolean ChildExists_ardt_wlientifrz() {
    if (ardt_wlientifrz.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_wlientifrz) || CPLib.IsLoaded(m_cWv_ardt_wlientifrz))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_wlientifrz.m_bLoaded)) {
      ardt_wlientifrz.Blank();
      ardt_wlientifrz.w_IDFILEBO = w_IDBASE;
      ardt_wlientifrz.Load();
    }
    return ardt_wlientifrz.m_bLoaded;
  }
  public void CtxLoad_ardt_wlientifrz() {
    if ( ! (ardt_wlientifrz.m_lCtxLoaded)) {
      ardt_wlientifrz.Blank();
    }
    ardt_wlientifrz.m_lCtxLoaded = true;
    if ( ! (ardt_wlientifrz.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_wlientifrz) || CPLib.IsLoaded(m_cWv_ardt_wlientifrz)) {
        ardt_wlientifrz.SetFromContext(m_cWv_ardt_wlientifrz);
        m_cWv_ardt_wlientifrz = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_wlientifrz.m_bLoaded)) {
          ardt_wlientifrz.Blank();
          ardt_wlientifrz.w_IDFILEBO = w_IDBASE;
          ardt_wlientifrz.Load();
          if ( ! (ardt_wlientifrz.m_bLoaded)) {
            ardt_wlientifrz.Initialize();
            ardt_wlientifrz.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_storsogfraz() {
    if (ardt_storsogfraz.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_storsogfraz) || CPLib.IsLoaded(m_cWv_ardt_storsogfraz))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_storsogfraz.m_bLoaded)) {
      ardt_storsogfraz.Blank();
      ardt_storsogfraz.w_IDFILEBO = w_IDBASE;
      ardt_storsogfraz.Load();
    }
    return ardt_storsogfraz.m_bLoaded;
  }
  public void CtxLoad_ardt_storsogfraz() {
    if ( ! (ardt_storsogfraz.m_lCtxLoaded)) {
      ardt_storsogfraz.Blank();
    }
    ardt_storsogfraz.m_lCtxLoaded = true;
    if ( ! (ardt_storsogfraz.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_storsogfraz) || CPLib.IsLoaded(m_cWv_ardt_storsogfraz)) {
        ardt_storsogfraz.SetFromContext(m_cWv_ardt_storsogfraz);
        m_cWv_ardt_storsogfraz = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_storsogfraz.m_bLoaded)) {
          ardt_storsogfraz.Blank();
          ardt_storsogfraz.w_IDFILEBO = w_IDBASE;
          ardt_storsogfraz.Load();
          if ( ! (ardt_storsogfraz.m_bLoaded)) {
            ardt_storsogfraz.Initialize();
            ardt_storsogfraz.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_weneficfrz() {
    if (ardt_weneficfrz.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_weneficfrz) || CPLib.IsLoaded(m_cWv_ardt_weneficfrz))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_weneficfrz.m_bLoaded)) {
      ardt_weneficfrz.Blank();
      ardt_weneficfrz.w_IDFILEBO = w_IDBASE;
      ardt_weneficfrz.Load();
    }
    return ardt_weneficfrz.m_bLoaded;
  }
  public void CtxLoad_ardt_weneficfrz() {
    if ( ! (ardt_weneficfrz.m_lCtxLoaded)) {
      ardt_weneficfrz.Blank();
    }
    ardt_weneficfrz.m_lCtxLoaded = true;
    if ( ! (ardt_weneficfrz.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_weneficfrz) || CPLib.IsLoaded(m_cWv_ardt_weneficfrz)) {
        ardt_weneficfrz.SetFromContext(m_cWv_ardt_weneficfrz);
        m_cWv_ardt_weneficfrz = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_weneficfrz.m_bLoaded)) {
          ardt_weneficfrz.Blank();
          ardt_weneficfrz.w_IDFILEBO = w_IDBASE;
          ardt_weneficfrz.Load();
          if ( ! (ardt_weneficfrz.m_bLoaded)) {
            ardt_weneficfrz.Initialize();
            ardt_weneficfrz.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_werzistifrz() {
    if (ardt_werzistifrz.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_werzistifrz) || CPLib.IsLoaded(m_cWv_ardt_werzistifrz))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_werzistifrz.m_bLoaded)) {
      ardt_werzistifrz.Blank();
      ardt_werzistifrz.w_IDFILEBO = w_IDBASE;
      ardt_werzistifrz.Load();
    }
    return ardt_werzistifrz.m_bLoaded;
  }
  public void CtxLoad_ardt_werzistifrz() {
    if ( ! (ardt_werzistifrz.m_lCtxLoaded)) {
      ardt_werzistifrz.Blank();
    }
    ardt_werzistifrz.m_lCtxLoaded = true;
    if ( ! (ardt_werzistifrz.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_werzistifrz) || CPLib.IsLoaded(m_cWv_ardt_werzistifrz)) {
        ardt_werzistifrz.SetFromContext(m_cWv_ardt_werzistifrz);
        m_cWv_ardt_werzistifrz = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_werzistifrz.m_bLoaded)) {
          ardt_werzistifrz.Blank();
          ardt_werzistifrz.w_IDFILEBO = w_IDBASE;
          ardt_werzistifrz.Load();
          if ( ! (ardt_werzistifrz.m_bLoaded)) {
            ardt_werzistifrz.Initialize();
            ardt_werzistifrz.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_wlientifrz")) {
      CtxLoad_ardt_wlientifrz();
      return ardt_wlientifrz;
    }
    if (CPLib.eq(p_cName,"ardt_storsogfraz")) {
      CtxLoad_ardt_storsogfraz();
      return ardt_storsogfraz;
    }
    if (CPLib.eq(p_cName,"ardt_weneficfrz")) {
      CtxLoad_ardt_weneficfrz();
      return ardt_weneficfrz;
    }
    if (CPLib.eq(p_cName,"ardt_werzistifrz")) {
      CtxLoad_ardt_werzistifrz();
      return ardt_werzistifrz;
    }
