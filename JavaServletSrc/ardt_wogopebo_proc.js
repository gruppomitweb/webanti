...
m_oFather.i_last_focused_item='child_ardt_wogopebo';
...
function Help() {
windowOpenForeground('../doc/ardt_wogopebo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('ardt_wogopebo',m_cSelectedPage);
