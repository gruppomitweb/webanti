...
if ( ! (m_oFather.SaveContext_ardt_docopebo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_docopebo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_docopebo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_docopebo();
}
}
SaveContext.child=[];
function BlankRow() {
