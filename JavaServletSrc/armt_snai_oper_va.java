...
public class armt_snai_oper_va extends SPServlet implements SPInvokable {
  public static String m_cEntityUid = "!*e54d4895*!";
  ...
  public SPEntityGlobals getEntityGlobals() {
    ...
    l_eg.name = "armt_snai_oper_va";
    l_eg.userName = getEntityTitle();
    l_eg.m_nEntityWidth = 1285;
    ...
    l_eg.canDelete = true;
    l_eg.m_cStates = "[]";
    l_eg.zoomableTables = new String[]{"cgo_operazioni_dl","cgo_tbtipgio","tbcitta","tbstati","tbtipatt","tbtipreg","tbcauana","personbo","intermbo","anadip","operazbo","tbcausin","cgo_causali","cgo_tipdoc","cgo_autorita"};
    l_eg.zoneItems = new ZoneItem[]{new ZoneItem("page_1","Dati Base","page"),new ZoneItem("page_2","Documenti","page"),new ZoneItem("page_3","Contatto","page"),new ZoneItem("Base","Dati Base","horizontal_section"),new ZoneItem("Operazione","Dati Operazione","horizontal_section"),new ZoneItem("Soggetto","Dati Soggetto","horizontal_section"),new ZoneItem("box_XWJLXLYKJC","",""),new ZoneItem("box_NYSCBMMEEX","","")};
    ...
    l_eg.items = new SPItem[]{
                   ...
                   new SPItem("CGOFLGVNP","C",1,0, "edit","Pagamento Vincite prenotate"),
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,armt_snai_oper_vaBO BO) {
  ...
  void WriteStyles(armt_snai_oper_vaBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='../armt_snai_oper_va.css?"+m_cEntityUid+"'>" +
      "");
    }
  ...
  void WriteMainForm(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println("Z.Tabs.Get('tabs').InitSelect('armt_snai_oper_va',false);");
    status.out.println(
     "</script>" +
    "");
    PrintPwdOTPDiv(status,"armt_snai_oper_va",BO.m_bLoaded,(BO.m_bLoaded?false:false),(BO.m_bLoaded?false:false));
    status.out.println(
     "</div>" +
    "");
  }
  // GetPortlet_Documenti_Vars
  com.zucchetti.sitepainter.Library.IncludedPortletUtils.Vars GetPortlet_KUBMCPCHPZ_Vars(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_1' class='PageContainer' style='position:relative;height:825px;width:1285px;display:none'>" +
    "");
  ...
  void WriteControls_p2(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_2' class='PageContainer' style='position:relative;height:477px;width:1285px;display:none'>" +
    "");
  ...
  void WriteControls_p3(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_3' class='PageContainer' style='position:relative;height:293px;width:1285px;display:none'>" +
    "");
  ...
  void WriteControls_p1_b0(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b1(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b1_CloseBand(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b2(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b3(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b3_CloseBand(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b4(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b5(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println(
     "<div id='AQSQVBKXAL' class='SectionBody' style='position:relative;height:475px;display:block'>" +
    "");
  ...
  void WriteControls_p1_b5_1(armt_snai_oper_vaBO BO,ServletStatus status) {
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p1_b5_CloseBand(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b6(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b0(armt_snai_oper_vaBO BO,ServletStatus status) {
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b0(armt_snai_oper_vaBO BO,ServletStatus status) {
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  static void PrintState(armt_snai_oper_vaBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(armt_snai_oper_vaBL BO,ServletStatus status) {
    PrintMNTState(status,BO,BO.m_MNTs);
  }
  static void PrintStateWorkVars(armt_snai_oper_vaBL BO,ServletStatus status) {
  ...
  void WriteMainFormVarScript(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    if ( ! (SPLib.IsMobile(status.request))) {
      ...
      status.out.println("var m_nPreferredWidth = " + SPLib.ToJSValue(1285,"N",0,0)+ ";");
    }
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"armt_snai_oper_va"),"C",0,0)+ ";");
    ...
    status.out.println("var m_cProgNameAlter = " + SPLib.ToJSValue("armt_snai_oper_va","C",0,0)+ ";");
    // hide e disable di pagine ed item
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"armt_snai_oper_va",BO.GetCurrentState());
  ...
  void WriteMainFormScript(armt_snai_oper_vaBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    if (CPLib.eq(status.m_cClientMode,"edit") || CPLib.eq(status.m_cClientMode,"new")) {
      ...
      if (CPLib.eq(status.m_cClientMode,"view")) {
        ...
        status.out.println("if(c=Ctrl('UQLWTKHQTJ')) SetDisabled(c,true);");
  ...
  armt_snai_oper_vaBO getBO(ServletStatus status) {
    armt_snai_oper_vaBO BO = new armt_snai_oper_vaBO(status.context);
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(armt_snai_oper_vaBO BO) {
    XDCHolder xdc = CPLib.GetXDCHolder(SPLib.GetClassesPath(),new SPXDCReaderFactory(BO.m_Ctx.GetInstance()),BO.m_Ctx.GetInstance());
    XDCTable t = xdc.GetXDCTable("cgo_operazioni_dl",true);
    BO.extendedFields = CPExtenderLib.GetExtendedItemsFromTable(t);
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,armt_snai_oper_vaBO BO) {
    super.NotifyEvent(p_cEvent,status,BO);
    CPLib.NotifyEvent(p_cEvent,BO,BO.m_Ctx,BO.specificEventsHandlers,BO.allEventsHandlers);
  }
  void WriteTableCombo(ServletStatus status,armt_snai_oper_vaBO BO) {
    String l_cTmp;
    CPResultSet l_rsLoad=null;
    l_cTmp = "[";
    if (l_rsLoad!=null)
  ...
  CPResultSet QueryKeyCursor(armt_snai_oper_vaBO BO,ServletStatus status) {
    ...
    if ( ! (CPLib.Empty(status.m_cLastWhere))) {
      ...
      String l_cQueryFilter = armt_snai_oper_vaBL.QueryFilter(status.context);
  ...
  void Query(ServletStatus status,armt_snai_oper_vaBO BO) {
    if ( ! (CPLib.Empty(status.m_cLastWhere))) {
  ...
  void View(ServletStatus status,armt_snai_oper_vaBO BO) {
  ...
  void Edit(ServletStatus status,armt_snai_oper_vaBO BO,SPParameterSource source) {
  ...
  void New(ServletStatus status,armt_snai_oper_vaBO BO,SPParameterSource source) {
    BO.Initialize();
    if (BO.CanAdd()) {
  ...
  void Write(ServletStatus status,armt_snai_oper_vaBO BO,SPParameterSource source) {
  ...
  void LoadCurrentRecord(ServletStatus status,armt_snai_oper_vaBO BO) {
  ...
  void EditLoad(ServletStatus status,armt_snai_oper_vaBO BO,SPParameterSource source) {
    Edit(status,BO,source);
    if ( ! (BO.m_bLoaded)) {
      status.m_cErrMsg = "";
      status.m_bError = false;
  ...
  void Delete(ServletStatus status,armt_snai_oper_vaBO BO,SPParameterSource source) {
    boolean l_bResult = false;
    String l_cTrsMsgErr = "";
    boolean l_bTrsOk = true;
  ...
  void DeleteMessage(ServletStatus status,armt_snai_oper_vaBO BO,SPParameterSource source) {
    BO.Load(status.w_SNAINUMOPE);
    status.m_cBOWarnMessageDeleted = status.context.Translate("MSG_PROCEED_WITH_DELETE");
    status.m_bExit = true;
    status.m_cClientMode = "bringback";
  }
  void Save(ServletStatus status,armt_snai_oper_vaBO BO) {
    boolean l_bResult = false;
    String l_cTrsMsgErr = "";
    boolean l_bTrsOk = true;
    String l_cTransMsgErr = "";
  ...
  void Discard(ServletStatus status,armt_snai_oper_vaBO BO) {
    BO.SetFromContext(status.m_cWv,status.m_Parameters);
  ...
  void CreatePortlet(ServletStatus status,armt_snai_oper_vaBO BO) {
    ...
    item.put("altInterfaceFor","armt_snai_oper_va");
    items.put(item);
    String s;
    org.json.JSONObject ctrl = null;
    s = "{\"comment\":\"Pagamento Vincite prenotate\",\"h\":19,\"maxlength\":1,\"name\":\"CGOFLGVNP\",\"orientation\":\"horizontal\",\"page\":1,\"spuid\":\"UQLWTKHQTJ\",\"tabindex\":11,\"type\":\"Radio\",\"typevar\":\"character\",\"w\":72,\"x\":1208,\"y\":248,\"zone\":\"pag1_1\",\"zonepath\":\"[1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Base\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Dati Base\",\"h\":91,\"name\":\"Base\",\"page\":1,\"shrinkable\":true,\"spuid\":\"CCUOYXMBZC\",\"stretch\":true,\"tabindex\":1,\"title_caption\":\"Dati Base\",\"titled\":true,\"type\":\"Box\",\"w\":784,\"x\":8,\"y\":8,\"zone\":\"pag1_2\",\"zonepath\":\"[1,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Intermediario\",\"disabled\":\"true\",\"h\":20,\"maxlength\":11,\"name\":\"gIntemediario\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"GXLWKNXGMM\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":72,\"x\":96,\"y\":16,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_LOEAMXUYLA\",\"page\":1,\"spuid\":\"LOEAMXUYLA\",\"tabindex\":89,\"type\":\"Label\",\"value\":\"Intermediario:\",\"w\":78,\"x\":16,\"y\":20,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Codice Dipendenza\",\"disabled\":\"true\",\"h\":21,\"maxlength\":6,\"name\":\"CODDIPE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"AVHTGZTOSZ\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":48,\"x\":224,\"y\":16,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Citt\\u00E0 Dipendenza\",\"disabled\":\"true\",\"h\":21,\"maxlength\":30,\"name\":\"DESCCITDIP\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"RLUMBFHPUD\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":160,\"x\":480,\"y\":16,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_XVRJYSKGWZ\",\"page\":1,\"spuid\":\"XVRJYSKGWZ\",\"tabindex\":98,\"type\":\"Label\",\"value\":\"Dipen.:\",\"w\":40,\"x\":184,\"y\":20,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_CTLYJMTHDV\",\"page\":1,\"spuid\":\"CTLYJMTHDV\",\"tabindex\":99,\"type\":\"Label\",\"value\":\"Citt\\u00E0:\",\"w\":28,\"x\":453,\"y\":20,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_JWSDOSRGAG\",\"page\":1,\"spuid\":\"JWSDOSRGAG\",\"tabindex\":100,\"type\":\"Label\",\"value\":\"Pr.:\",\"w\":24,\"x\":640,\"y\":20,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_ENBRMMDVUP\",\"page\":1,\"spuid\":\"ENBRMMDVUP\",\"tabindex\":101,\"type\":\"Label\",\"value\":\"CAB:\",\"w\":27,\"x\":695,\"y\":20,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":17,\"name\":\"label_BLXOBUQVYE\",\"page\":1,\"spuid\":\"BLXOBUQVYE\",\"tabindex\":102,\"type\":\"Label\",\"w\":175,\"x\":277,\"y\":20,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Provincia Dipendenza\",\"disabled\":\"true\",\"h\":21,\"maxlength\":2,\"name\":\"PROVINCIADIP\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"OJGQABFSYN\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":24,\"x\":664,\"y\":16,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"CAB Dipendenza\",\"disabled\":\"true\",\"h\":21,\"maxlength\":6,\"name\":\"CODCABDIP\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"OZEOCQRSEQ\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":48,\"x\":720,\"y\":16,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"N\\u00B0 Operazione\",\"h\":20,\"maxlength\":15,\"name\":\"SNAINUMOPE\",\"page\":1,\"spuid\":\"XFUOZLSACP\",\"tabindex\":65,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":112,\"x\":136,\"y\":48,\"zone\":\"pag1_2_2\",\"zonepath\":\"[1,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_GZVEXPFQCZ\",\"page\":1,\"spuid\":\"GZVEXPFQCZ\",\"tabindex\":66,\"type\":\"Label\",\"value\":\"N\\u00B0 Operazione:\",\"w\":104,\"x\":29,\"y\":52,\"zone\":\"pag1_2_2\",\"zonepath\":\"[1,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"ID BIGLIETTO\",\"disabled\":\"true\",\"h\":20,\"maxlength\":30,\"name\":\"CAIDBIGLIETTO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"BMTLGIUQTH\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":280,\"x\":504,\"y\":48,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_EZWFUWOKXC\",\"page\":1,\"spuid\":\"EZWFUWOKXC\",\"tabindex\":127,\"type\":\"Label\",\"value\":\"ID BIGLIETTO:\",\"w\":96,\"x\":408,\"y\":52,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Tipo gioco\",\"disabled\":\"true\",\"h\":20,\"maxlength\":3,\"name\":\"TIPOGIOCO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"QZTTRBWAQL\",\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":208,\"x\":136,\"y\":72,\"zone\":\"pag1_2_4\",\"zonepath\":\"[1,2,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_JNQVUOSVPV\",\"page\":1,\"spuid\":\"JNQVUOSVPV\",\"tabindex\":133,\"type\":\"Label\",\"value\":\"Tipo Gioco:\",\"w\":64,\"x\":72,\"y\":76,\"zone\":\"pag1_2_4\",\"zonepath\":\"[1,2,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_DJRHGZHJSR\",\"page\":1,\"spuid\":\"DJRHGZHJSR\",\"tabindex\":146,\"type\":\"Label\",\"value\":\"Tipo Piattaforma:\",\"w\":112,\"x\":392,\"y\":76,\"zone\":\"pag1_2_5\",\"zonepath\":\"[1,2,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Piattaforma VLT\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"VLTPLAT\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"LVYFMQXNZH\",\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":280,\"x\":504,\"y\":72,\"zone\":\"pag1_2_5\",\"zonepath\":\"[1,2,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Operazione\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Dati Operazione\",\"h\":182,\"name\":\"Operazione\",\"page\":1,\"shrinkable\":true,\"spuid\":\"YORQOIOBQN\",\"stretch\":true,\"tabindex\":2,\"title_caption\":\"Dati Operazione\",\"titled\":true,\"type\":\"Box\",\"w\":784,\"x\":8,\"y\":101,\"zone\":\"pag1_3\",\"zonepath\":\"[1,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data registrazione\",\"disabled\":\"true\",\"h\":20,\"maxlength\":10,\"name\":\"DATAREG\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"OEIKQOZMYJ\",\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":80,\"x\":704,\"y\":107,\"zone\":\"pag1_3_1\",\"zonepath\":\"[1,3,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IKBMEWKQJW\",\"page\":1,\"spuid\":\"IKBMEWKQJW\",\"tabindex\":93,\"type\":\"Label\",\"value\":\"Data registrazione:\",\"w\":104,\"x\":600,\"y\":111,\"zone\":\"pag1_3_1\",\"zonepath\":\"[1,3,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data Operazione\",\"h\":20,\"maxlength\":10,\"name\":\"DATAOPE\",\"page\":1,\"spuid\":\"YLIKFVPZJA\",\"tabindex\":67,\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":88,\"x\":136,\"y\":108,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_HVHVAYPDJE\",\"page\":1,\"spuid\":\"HVHVAYPDJE\",\"tabindex\":87,\"type\":\"Label\",\"value\":\"Data di pagamento:\",\"w\":104,\"x\":29,\"y\":112,\"zone\":\"pag1_3_2\",\"zonepath\":\"[1,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Contanti (S\\/N)\",\"disabled\":\"true\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"FLAGCONT\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"PURPSXEVAI\",\"textlist\":\"No,Si\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"0"+"'"+","+"'"+"1"+"'"+"\",\"w\":104,\"x\":136,\"y\":136,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_GVTXMEILAZ\",\"page\":1,\"spuid\":\"GVTXMEILAZ\",\"tabindex\":92,\"type\":\"Label\",\"value\":\"Contanti:\",\"w\":80,\"x\":53,\"y\":140,\"zone\":\"pag1_3_3\",\"zonepath\":\"[1,3,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Tipo Operazione Completa\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"TIPOOPRAP\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"UJRFWINIVQ\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":24,\"x\":392,\"y\":136,\"zone\":\"pag1_3_4\",\"zonepath\":\"[1,3,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KMCNAWQHKV\",\"page\":1,\"spuid\":\"KMCNAWQHKV\",\"tabindex\":94,\"type\":\"Label\",\"value\":\"Tipo Operazione:\",\"w\":104,\"x\":288,\"y\":140,\"zone\":\"pag1_3_4\",\"zonepath\":\"[1,3,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_THOGQCLBJA\",\"page\":1,\"spuid\":\"THOGQCLBJA\",\"tabindex\":103,\"type\":\"Label\",\"w\":361,\"x\":423,\"y\":140,\"zone\":\"pag1_3_4\",\"zonepath\":\"[1,3,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Causale\",\"disabled\":\"true\",\"h\":20,\"maxlength\":6,\"name\":\"CACODICE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"WJQFIEBCQV\",\"type\":\"Combobox\",\"typevar\":\"numeric\",\"w\":312,\"x\":136,\"y\":164,\"zone\":\"pag1_3_5\",\"zonepath\":\"[1,3,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_YFGRJCQGZV\",\"page\":1,\"spuid\":\"YFGRJCQGZV\",\"tabindex\":124,\"type\":\"Label\",\"value\":\"Causale:\",\"w\":42,\"x\":91,\"y\":168,\"zone\":\"pag1_3_5\",\"zonepath\":\"[1,3,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Tipo Registrazione\",\"disabled\":\"true\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"CAFLGOPE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"YJDISDDJUY\",\"textlist\":\"Giocata,Versamento,Vincita,Prelievo\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"G"+"'"+","+"'"+"R"+"'"+","+"'"+"V"+"'"+","+"'"+"P"+"'"+"\",\"w\":112,\"x\":456,\"y\":164,\"zone\":\"pag1_3_5\",\"zonepath\":\"[1,3,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Totale Operazione\",\"disabled\":\"true\",\"h\":20,\"maxlength\":21,\"name\":\"TOTLIRE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"HUAGBHPUNH\",\"type\":\"Textbox\",\"typevar\":\"numeric\",\"w\":120,\"x\":136,\"y\":195,\"zone\":\"pag1_3_6\",\"zonepath\":\"[1,3,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_XLNVLBYVQX\",\"page\":1,\"spuid\":\"XLNVLBYVQX\",\"tabindex\":96,\"type\":\"Label\",\"value\":\"Totale Euro:\",\"w\":95,\"x\":38,\"y\":199,\"zone\":\"pag1_3_6\",\"zonepath\":\"[1,3,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IDTBMNCIOX\",\"page\":1,\"spuid\":\"IDTBMNCIOX\",\"tabindex\":97,\"type\":\"Label\",\"value\":\"di cui contanti:\",\"w\":78,\"x\":280,\"y\":199,\"zone\":\"pag1_3_6\",\"zonepath\":\"[1,3,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"di cui contanti\",\"disabled\":\"true\",\"h\":20,\"maxlength\":21,\"name\":\"TOTCONT\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"HUDOCMLKKT\",\"type\":\"Textbox\",\"typevar\":\"numeric\",\"w\":120,\"x\":360,\"y\":195,\"zone\":\"pag1_3_6\",\"zonepath\":\"[1,3,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Pagamento VLT\",\"disabled\":\"true\",\"h\":19,\"maxlength\":1,\"name\":\"CGOFLGVLT\",\"orientation\":\"horizontal\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"SFKJNKYLJO\",\"type\":\"Radio\",\"typevar\":\"character\",\"w\":288,\"x\":136,\"y\":227,\"zone\":\"pag1_3_7\",\"zonepath\":\"[1,3,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_LKYFODKVBU\",\"page\":1,\"spuid\":\"LKYFODKVBU\",\"tabindex\":129,\"type\":\"Label\",\"value\":\"Pagamento da parte di:\",\"w\":124,\"x\":12,\"y\":231,\"zone\":\"pag1_3_7\",\"zonepath\":\"[1,3,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Mezzo Pagamento\",\"disabled\":\"true\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"MEZPAGAM\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"EOSKLIUGBC\",\"textlist\":\"Altro Mezzo,Bonifico Italia,Bonifico Estero,Bonifico Postale,Assegno Circolare,Assegno Bancario,Carta di Credito,Contante\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"A"+"'"+","+"'"+"I"+"'"+","+"'"+"E"+"'"+","+"'"+"P"+"'"+","+"'"+"C"+"'"+","+"'"+"B"+"'"+","+"'"+"V"+"'"+","+"'"+"S"+"'"+"\",\"w\":224,\"x\":136,\"y\":251,\"zone\":\"pag1_3_8\",\"zonepath\":\"[1,3,8]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_VQCVMXHDPB\",\"page\":1,\"spuid\":\"VQCVMXHDPB\",\"tabindex\":125,\"type\":\"Label\",\"value\":\"Mezzo Pagamento:\",\"w\":120,\"x\":16,\"y\":255,\"zone\":\"pag1_3_8\",\"zonepath\":\"[1,3,8]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Assegno\",\"disabled\":\"true\",\"h\":20,\"maxlength\":25,\"name\":\"ASSEGNO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"KZWBLPQNHU\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":224,\"x\":560,\"y\":251,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"IBAN per Bonifici\",\"disabled\":\"true\",\"h\":20,\"maxlength\":27,\"name\":\"IBAN\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"UTUCDPQJKK\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":224,\"x\":560,\"y\":251,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Ultime Cifre CC\",\"disabled\":\"true\",\"h\":20,\"maxlength\":4,\"name\":\"CC4CIFRE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"FKEAKFSYVU\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":36,\"x\":560,\"y\":251,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Scadenza\",\"disabled\":\"true\",\"h\":20,\"maxlength\":7,\"name\":\"CCDATSCA\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"OXFYJQLTDL\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":64,\"x\":704,\"y\":251,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_PBHNLOUBML\",\"page\":1,\"spuid\":\"PBHNLOUBML\",\"tabindex\":148,\"type\":\"Label\",\"value\":\"IBAN per Bonifici:\",\"w\":144,\"x\":411,\"y\":255,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_BTZLLSBMCC\",\"page\":1,\"spuid\":\"BTZLLSBMCC\",\"tabindex\":149,\"type\":\"Label\",\"value\":\"Numero Assegno:\",\"w\":93,\"x\":464,\"y\":255,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_CQTMIXIELC\",\"page\":1,\"spuid\":\"CQTMIXIELC\",\"tabindex\":150,\"type\":\"Label\",\"value\":\"Ultime Cifre CC:\",\"w\":83,\"x\":472,\"y\":255,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_HKREYYVVOP\",\"page\":1,\"spuid\":\"HKREYYVVOP\",\"tabindex\":151,\"type\":\"Label\",\"value\":\"Scadenza:\",\"w\":55,\"x\":649,\"y\":255,\"zone\":\"pag1_3_9\",\"zonepath\":\"[1,3,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Soggetto\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Dati Soggetto\",\"h\":475,\"name\":\"Soggetto\",\"page\":1,\"shrinkable\":true,\"spuid\":\"AQSQVBKXAL\",\"stretch\":true,\"tabindex\":8,\"title_caption\":\"Dati Soggetto\",\"titled\":true,\"type\":\"Box\",\"w\":784,\"x\":8,\"y\":285,\"zone\":\"pag1_4\",\"zonepath\":\"[1,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"checked_value\":\"1\",\"comment\":\"Codice Fiscale Estero\",\"disabled\":\"true\",\"h\":21,\"label_text\":\"Soggetto Residente All"+"'"+"Estero\",\"maxlength\":2,\"name\":\"CFESTERO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"CZTHKEDVCO\",\"type\":\"Checkbox\",\"typevar\":\"numeric\",\"unchecked_value\":\"0\",\"w\":575,\"x\":136,\"y\":291,\"zone\":\"pag1_4_1\",\"zonepath\":\"[1,4,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Codice Fiscale\",\"disabled\":\"true\",\"h\":20,\"maxlength\":16,\"name\":\"CODFISC\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"OJJHIUDPFY\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":128,\"x\":136,\"y\":323,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Cognome\",\"disabled\":\"true\",\"h\":20,\"maxlength\":26,\"name\":\"COGNOME\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"TWTTDWKCRG\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":176,\"x\":392,\"y\":323,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Nome\",\"disabled\":\"true\",\"h\":20,\"maxlength\":25,\"name\":\"NOME\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"WWGIVGNUDW\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":168,\"x\":616,\"y\":323,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_WZDAFMDKJE\",\"page\":1,\"spuid\":\"WZDAFMDKJE\",\"tabindex\":43,\"type\":\"Label\",\"value\":\"Codice Fiscale:\",\"w\":85,\"x\":48,\"y\":327,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_TVSLWOCERI\",\"page\":1,\"spuid\":\"TVSLWOCERI\",\"tabindex\":56,\"type\":\"Label\",\"value\":\"Cognome:\",\"w\":56,\"x\":333,\"y\":327,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KUPYKSUBXV\",\"page\":1,\"spuid\":\"KUPYKSUBXV\",\"tabindex\":57,\"type\":\"Label\",\"value\":\"Nome:\",\"w\":35,\"x\":580,\"y\":327,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Luogo di Nascita\",\"disabled\":\"true\",\"h\":20,\"maxlength\":30,\"name\":\"NASCOMUN\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"NEUBQNUEOJ\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":222,\"x\":136,\"y\":355,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Prov.\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"TIPINTER\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"KPSCOABZLB\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":32,\"x\":440,\"y\":355,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Sesso\",\"disabled\":\"true\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"SESSO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"QPALJZMFCL\",\"textlist\":\"Maschile,Femminile\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"1"+"'"+","+"'"+"2"+"'"+"\",\"w\":88,\"x\":560,\"y\":355,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_WVJSUIKYEY\",\"page\":1,\"spuid\":\"WVJSUIKYEY\",\"tabindex\":41,\"type\":\"Label\",\"value\":\"Citt\\u00E0 di Nascita:\",\"w\":101,\"x\":32,\"y\":359,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KRSCDPQZTQ\",\"page\":1,\"spuid\":\"KRSCDPQZTQ\",\"tabindex\":48,\"type\":\"Label\",\"value\":\"Sesso:\",\"w\":39,\"x\":519,\"y\":359,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IVAWYVSUQI\",\"page\":1,\"spuid\":\"IVAWYVSUQI\",\"tabindex\":50,\"type\":\"Label\",\"value\":\"Prov.:\",\"w\":32,\"x\":408,\"y\":359,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Stato di nascita\",\"disabled\":\"true\",\"h\":20,\"maxlength\":30,\"name\":\"NASSTATO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"HODZKKOSYW\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":222,\"x\":136,\"y\":387,\"zone\":\"pag1_4_4\",\"zonepath\":\"[1,4,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_ZBRDCBHLZC\",\"page\":1,\"spuid\":\"ZBRDCBHLZC\",\"tabindex\":55,\"type\":\"Label\",\"value\":\"Stato di Nascita:\",\"w\":101,\"x\":32,\"y\":391,\"zone\":\"pag1_4_4\",\"zonepath\":\"[1,4,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data Nascita\",\"disabled\":\"true\",\"h\":20,\"maxlength\":10,\"name\":\"DATANASC\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"XMGRWGFSFV\",\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":86,\"x\":560,\"y\":387,\"zone\":\"pag1_4_5\",\"zonepath\":\"[1,4,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_HZYTDOZFPI\",\"page\":1,\"spuid\":\"HZYTDOZFPI\",\"tabindex\":42,\"type\":\"Label\",\"value\":\"Data Nascita:\",\"w\":74,\"x\":483,\"y\":391,\"zone\":\"pag1_4_5\",\"zonepath\":\"[1,4,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Stato\",\"disabled\":\"true\",\"h\":20,\"maxlength\":3,\"name\":\"PAESE\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"YVIKEGPYPM\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":40,\"x\":136,\"y\":419,\"zone\":\"pag1_4_6\",\"zonepath\":\"[1,4,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_RZBLEGCFJJ\",\"page\":1,\"spuid\":\"RZBLEGCFJJ\",\"tabindex\":45,\"type\":\"Label\",\"value\":\"Stato Residenza:\",\"w\":108,\"x\":24,\"y\":424,\"zone\":\"pag1_4_6\",\"zonepath\":\"[1,4,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_ESVLUSNYWB\",\"page\":1,\"spuid\":\"ESVLUSNYWB\",\"tabindex\":52,\"type\":\"Label\",\"w\":323,\"x\":203,\"y\":424,\"zone\":\"pag1_4_6\",\"zonepath\":\"[1,4,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Citt\\u00E0\",\"disabled\":\"true\",\"h\":20,\"maxlength\":40,\"name\":\"DESCCIT\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"ODAYKSRECA\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":318,\"x\":136,\"y\":451,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Provincia\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"PROVINCIA\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"NOTZPDMYIA\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":24,\"x\":536,\"y\":451,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"CAP\",\"disabled\":\"true\",\"h\":20,\"maxlength\":9,\"name\":\"CAP\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"RDAVOEETJG\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":66,\"x\":608,\"y\":451,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_SBJQIAQUCN\",\"page\":1,\"spuid\":\"SBJQIAQUCN\",\"tabindex\":44,\"type\":\"Label\",\"value\":\"Provincia:\",\"w\":52,\"x\":480,\"y\":455,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_GDOCAGKROT\",\"page\":1,\"spuid\":\"GDOCAGKROT\",\"tabindex\":47,\"type\":\"Label\",\"value\":\"CAP:\",\"w\":30,\"x\":576,\"y\":455,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_XPSQTBKQQZ\",\"page\":1,\"spuid\":\"XPSQTBKQQZ\",\"tabindex\":49,\"type\":\"Label\",\"value\":\"Citt\\u00E0:\",\"w\":70,\"x\":63,\"y\":455,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Indirizzo\",\"disabled\":\"true\",\"h\":20,\"maxlength\":35,\"name\":\"DOMICILIO\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"VYLHWTRQNX\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":222,\"x\":136,\"y\":483,\"zone\":\"pag1_4_8\",\"zonepath\":\"[1,4,8]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_TWTXGZJTAR\",\"page\":1,\"spuid\":\"TWTXGZJTAR\",\"tabindex\":46,\"type\":\"Label\",\"value\":\"Indirizzo:\",\"w\":47,\"x\":86,\"y\":487,\"zone\":\"pag1_4_8\",\"zonepath\":\"[1,4,8]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Numero Telefono\",\"disabled\":\"true\",\"h\":20,\"maxlength\":20,\"name\":\"NUMTEL\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"VFKGHJLVGB\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":132,\"x\":560,\"y\":483,\"zone\":\"pag1_4_9\",\"zonepath\":\"[1,4,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_ZZVYXPTPXC\",\"page\":1,\"spuid\":\"ZZVYXPTPXC\",\"tabindex\":152,\"type\":\"Label\",\"value\":\"Numero Telefono:\",\"w\":94,\"x\":463,\"y\":487,\"zone\":\"pag1_4_9\",\"zonepath\":\"[1,4,9]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Tipo Documento\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"TIPODOC\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"MBGANUUHRA\",\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":246,\"x\":136,\"y\":632,\"zone\":\"pag1_4_10\",\"zonepath\":\"[1,4,10]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KCXIMANXKF\",\"page\":1,\"spuid\":\"KCXIMANXKF\",\"tabindex\":186,\"type\":\"Label\",\"value\":\"Tipo Documento:\",\"w\":89,\"x\":47,\"y\":636,\"zone\":\"pag1_4_10\",\"zonepath\":\"[1,4,10]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Numero Doc.\",\"disabled\":\"true\",\"h\":20,\"maxlength\":15,\"name\":\"NUMDOCUM\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"HVEEMUJUUY\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":128,\"x\":560,\"y\":632,\"zone\":\"pag1_4_11\",\"zonepath\":\"[1,4,11]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_YXFGMWZGNN\",\"page\":1,\"spuid\":\"YXFGMWZGNN\",\"tabindex\":167,\"type\":\"Label\",\"value\":\"Numero Doc.:\",\"w\":69,\"x\":488,\"y\":636,\"zone\":\"pag1_4_11\",\"zonepath\":\"[1,4,11]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Rilascio Doc.\",\"disabled\":\"true\",\"h\":20,\"maxlength\":10,\"name\":\"DATARILASC\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"XHWYGOPPUN\",\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":86,\"x\":136,\"y\":664,\"zone\":\"pag1_4_12\",\"zonepath\":\"[1,4,12]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data Fine Validit\\u00E0\",\"disabled\":\"true\",\"h\":20,\"maxlength\":10,\"name\":\"DATAVALI\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"BNWXBPSIDG\",\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":86,\"x\":344,\"y\":664,\"zone\":\"pag1_4_12\",\"zonepath\":\"[1,4,12]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_ZPQIEJPWJC\",\"page\":1,\"spuid\":\"ZPQIEJPWJC\",\"tabindex\":168,\"type\":\"Label\",\"value\":\"Autorit\\u00E0 di rilascio:\",\"w\":100,\"x\":459,\"y\":668,\"zone\":\"pag1_4_12\",\"zonepath\":\"[1,4,12]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_UYGHJPRVKH\",\"page\":1,\"spuid\":\"UYGHJPRVKH\",\"tabindex\":169,\"type\":\"Label\",\"value\":\"Data Fine Validit\\u00E0:\",\"w\":101,\"x\":240,\"y\":668,\"zone\":\"pag1_4_12\",\"zonepath\":\"[1,4,12]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Autorit\\u00E0 di rilascio\",\"disabled\":\"true\",\"h\":20,\"maxlength\":30,\"name\":\"AUTRILASC\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"TXKHUBKEOP\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":224,\"x\":560,\"y\":664,\"zone\":\"pag1_4_12\",\"zonepath\":\"[1,4,12]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_QUXAELRWLA\",\"page\":1,\"spuid\":\"QUXAELRWLA\",\"tabindex\":187,\"type\":\"Label\",\"value\":\"Rilascio Doc.:\",\"w\":70,\"x\":66,\"y\":668,\"zone\":\"pag1_4_12\",\"zonepath\":\"[1,4,12]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Autorit\\u00E0 Rilascio\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"RDCODAUT\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"YDUQCBNYFV\",\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":176,\"x\":136,\"y\":696,\"zone\":\"pag1_4_13\",\"zonepath\":\"[1,4,13]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_RAVMCVENOT\",\"page\":1,\"spuid\":\"RAVMCVENOT\",\"tabindex\":188,\"type\":\"Label\",\"value\":\"Autorit\\u00E0 Rilascio:\",\"w\":89,\"x\":47,\"y\":700,\"zone\":\"pag1_4_13\",\"zonepath\":\"[1,4,13]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Luogo Autorit\\u00E0 Rilascio\",\"disabled\":\"true\",\"h\":20,\"maxlength\":20,\"name\":\"RDLOCAUT\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"MPRHMTBSXX\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":152,\"x\":560,\"y\":696,\"zone\":\"pag1_4_14\",\"zonepath\":\"[1,4,14]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_LSLCBQSYUK\",\"page\":1,\"spuid\":\"LSLCBQSYUK\",\"tabindex\":171,\"type\":\"Label\",\"value\":\"Luogo Autorit\\u00E0 Rilascio:\",\"w\":124,\"x\":436,\"y\":700,\"zone\":\"pag1_4_14\",\"zonepath\":\"[1,4,14]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Descrizione PEP\",\"disabled\":\"true\",\"h\":20,\"maxlength\":80,\"name\":\"PEPDESCRI\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"DAEHHCRYAM\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":648,\"x\":136,\"y\":728,\"zone\":\"pag1_4_15\",\"zonepath\":\"[1,4,15]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_ELBFOCJOYH\",\"page\":1,\"spuid\":\"ELBFOCJOYH\",\"tabindex\":180,\"type\":\"Label\",\"value\":\"Descrizione PEP:\",\"w\":86,\"x\":50,\"y\":732,\"zone\":\"pag1_4_15\",\"zonepath\":\"[1,4,15]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Stato Domicilio\",\"disabled\":\"true\",\"h\":20,\"maxlength\":3,\"name\":\"PAESE2\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"UOOQYQWWNG\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":40,\"x\":136,\"y\":538,\"zone\":\"pag1_4_16\",\"zonepath\":\"[1,4,16]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_XAZPZOWUXV\",\"page\":1,\"spuid\":\"XAZPZOWUXV\",\"tabindex\":178,\"type\":\"Label\",\"w\":323,\"x\":180,\"y\":542,\"zone\":\"pag1_4_16\",\"zonepath\":\"[1,4,16]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_MCODDONEHP\",\"page\":1,\"spuid\":\"MCODDONEHP\",\"tabindex\":181,\"type\":\"Label\",\"value\":\"Stato Domicilio:\",\"w\":80,\"x\":56,\"y\":542,\"zone\":\"pag1_4_16\",\"zonepath\":\"[1,4,16]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Citt\\u00E0 Domicilio\",\"disabled\":\"true\",\"h\":20,\"maxlength\":40,\"name\":\"DESCCIT2\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"BVEIQEJCLQ\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":318,\"x\":136,\"y\":568,\"zone\":\"pag1_4_17\",\"zonepath\":\"[1,4,17]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Provincia\",\"disabled\":\"true\",\"h\":20,\"maxlength\":2,\"name\":\"PROVINCIA2\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"NKJDWBKDWM\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":24,\"x\":536,\"y\":568,\"zone\":\"pag1_4_17\",\"zonepath\":\"[1,4,17]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"CAP\",\"disabled\":\"true\",\"h\":20,\"maxlength\":9,\"name\":\"CAP2\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"MDTHUZMSSI\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":66,\"x\":608,\"y\":568,\"zone\":\"pag1_4_17\",\"zonepath\":\"[1,4,17]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_BRPGRCAORR\",\"page\":1,\"spuid\":\"BRPGRCAORR\",\"tabindex\":182,\"type\":\"Label\",\"value\":\"Citt\\u00E0 Domicilio:\",\"w\":77,\"x\":59,\"y\":572,\"zone\":\"pag1_4_17\",\"zonepath\":\"[1,4,17]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_INUGZKMMHN\",\"page\":1,\"spuid\":\"INUGZKMMHN\",\"tabindex\":183,\"type\":\"Label\",\"value\":\"Provincia:\",\"w\":51,\"x\":485,\"y\":572,\"zone\":\"pag1_4_17\",\"zonepath\":\"[1,4,17]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_PXQUPKOPNQ\",\"page\":1,\"spuid\":\"PXQUPKOPNQ\",\"tabindex\":184,\"type\":\"Label\",\"value\":\"CAP:\",\"w\":26,\"x\":582,\"y\":572,\"zone\":\"pag1_4_17\",\"zonepath\":\"[1,4,17]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Indirizzo Domicilio\",\"disabled\":\"true\",\"h\":20,\"maxlength\":35,\"name\":\"DOMICILIO2\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"CWOLOHZAQW\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":222,\"x\":136,\"y\":600,\"zone\":\"pag1_4_18\",\"zonepath\":\"[1,4,18]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KBBIQTXMOO\",\"page\":1,\"spuid\":\"KBBIQTXMOO\",\"tabindex\":185,\"type\":\"Label\",\"value\":\"Indirizzo Domicilio:\",\"w\":95,\"x\":41,\"y\":604,\"zone\":\"pag1_4_18\",\"zonepath\":\"[1,4,18]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"checked_value\":\""+"'"+"S"+"'"+"\",\"comment\":\"Domicilio diverso da residenza\",\"disabled\":\"true\",\"h\":21,\"label_text\":\"Domicilio diverso da residenza\",\"maxlength\":1,\"name\":\"FLGDOM\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"ZJPDUNZSZL\",\"type\":\"Checkbox\",\"typevar\":\"character\",\"unchecked_value\":\""+"'"+"N"+"'"+"\",\"w\":360,\"x\":136,\"y\":512,\"zone\":\"pag1_4_19\",\"zonepath\":\"[1,4,19]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
  ...
  void WriteFormPage(armt_snai_oper_vaBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='armt_snai_oper_va?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    if (CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")) {
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_snai_oper_va_query.js'>" +
       "</script>" +
      "");
    } else if (CPLib.eq(status.m_cClientMode,"new") || CPLib.eq(status.m_cClientMode,"edit")) {
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_snai_oper_va_edit.js'>" +
       "</script>" +
      "");
    }
    if (CPLib.eq(status.m_cClientMode,"painter")) {
      ...
      status.out.println("w_xSOGTPGIO=a[84];");
      status.out.println("w_xDEFTPGIO=a[85];");
      status.out.println("w_xEDTTPGIO=a[86];");
      status.out.println("w_xEDTSPGIO=a[87];");
      status.out.println("w_xDEFSPGIO=a[88];");
      status.out.println("w_xARDESCRI=a[89];");
      status.out.println("w_dessta=a[90];");
      status.out.println("w_tipsot=a[91];");
      status.out.println("w_STATOREG=a[92];");
      status.out.println("w_IDBASE=a[93];");
      status.out.println("w_NUMPROG=a[94];");
      status.out.println("w_DESCRI=a[95];");
      status.out.println("w_gSeekAos=a[96];");
      status.out.println("w_gDataVaria=a[97];");
      status.out.println("w_gFlgDoc=a[98];");
      status.out.println("w_gIntemediario=a[99];");
      ...
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_snai_oper_va_proc.js'>" +
       "</script>" +
      "");
    }
    IncludeJS(status);
  ...
  void RaiseLoadedEntity(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void RaiseSavedEntity(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(armt_snai_oper_vaBO BO,ServletStatus status) {
  ...
  void WriteExitPage(armt_snai_oper_vaBO BO,ServletStatus status,Forward f) {
  ...
  void WriteExitPage(armt_snai_oper_vaBO BO,ServletStatus status) {
    WriteExitPage(BO,status,Forward.Unforwarded);
  }
  protected void BringBackPage(armt_snai_oper_vaBO BO,ServletStatus status) throws IOException {
  ...
  public String GetCheckVars(ServletStatus status,armt_snai_oper_vaBO BO,String p_cUID) {
  ...
  public boolean CheckVars(ServletStatus status,armt_snai_oper_vaBO BO) {
    boolean result = true;
