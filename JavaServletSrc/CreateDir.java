...
public class CreateDir extends HttpServlet implements SPInvokable {
  ...
  static Vector<String> Instances;     
	...
	*/
    ...
    System.out.println("Start Creazione Directories ..");
    ...
    try {
          ...
          Class clazz = Class.forName("arrt_creadir_startR");
