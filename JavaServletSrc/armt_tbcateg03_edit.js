...
function Set_C3CODTAB(ctrlValue,kmode,e) {
if (Ne(w_C3CODTAB,ctrlValue)) {
var ctl = _GetCtl(e,'SEJWRQHUSP');
if (_tracker.goon(ctl,ctrlValue)) {
w_C3CODTAB=ctrlValue;
SetModified();
var l_bResult = true;
...
function Set_C3CODICE(ctrlValue,kmode,e) {
if (Ne(w_C3CODICE,ctrlValue)) {
var ctl = _GetCtl(e,'XREVNLNKCY');
if (_tracker.goon(ctl,ctrlValue)) {
w_C3CODICE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
function Set_C3DESCRI(ctrlValue,kmode,e) {
if (Ne(w_C3DESCRI,ctrlValue)) {
var ctl = _GetCtl(e,'RJDJPGMTCC');
if (_tracker.goon(ctl,ctrlValue)) {
w_C3DESCRI=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg03_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg03_dataNotSent',{'action':formaction});
}
}
}
}
...
l_oWv.setValue('C3CODTAB',WtA(w_C3CODTAB,'C'));
l_oWv.setValue('C3CODICE',WtA(w_C3CODICE,'C'));
l_oWv.setValue('C3DESCRI',WtA(w_C3DESCRI,'C'));
...
FillWv.n=["C3CODTAB","C3CODICE","C3DESCRI","IDBASE"];
