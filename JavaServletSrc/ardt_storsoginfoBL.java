...
public class ardt_storsoginfoBL extends ardt_storsoginfoWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_CODSOG;
    public String w_LEGAME;
    public String w_xragsoc;
    public String w_xdescleg;
  ...
  public static final String i_EntityName = "ardt_storsoginfo";
  ...
  public CPPhTableWrInfo m_oWrInfo_woginfo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_woginfo;
  ...
  public static String[] m_EntityTables = {"woginfo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_storsoginfo",true,true)+"}"+FoundlingChildrenList("ardt_storsoginfo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescleg':xdescleg,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_storsoginfo",true,true)+"}"+FoundlingChildrenList("ardt_storsoginfo",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,RAPCOL,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_storsoginfo",false,true)+"]"+FoundlingChildrenList("ardt_storsoginfo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_storsoginfo"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"RAPCOL","","C","25","0","campo","key4","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_storsoginfoBL (CPContext p_ContextObject) {
    ...
    m_cPhName_woginfo = p_ContextObject.GetPhName("woginfo",p_ContextObject.GetCompany(),false);
    m_cServer_woginfo = p_ContextObject.GetServer("woginfo");
    m_oWrInfo_woginfo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"woginfo",p_ContextObject.GetCompany());
    m_cVirtName_woginfo = CPSql.ManipulateTablePhName("woginfo",m_cServer_woginfo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_storsoginfo",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_FVKNSPNHTX() {
    return Link_FVKNSPNHTX("Full");
  }
  protected boolean Link_FVKNSPNHTX(String p_cType) {
  ...
  protected boolean Link_KQROMFNGNZ() {
    return Link_KQROMFNGNZ("Full");
  }
  protected boolean Link_KQROMFNGNZ(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    if ( ! (CPLib.Empty(w_LEGAME))) {
      ...
      try {
        ...
        if (l_bLoaded) {
          ...
          w_xdescleg = l_rsLink.GetString("DESCRIZ");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
  ...
  public boolean Set_RAPCOL(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getVisible_RAPCOL() {
    return true;
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_storsoginfo","woginfo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_RAPCOL;
      p_RAPCOL = CPLib.GetProperties(trs_p.getProperty("RAPCOL"),new Properties());
      Properties p_xragsoc;
      p_xragsoc = CPLib.GetProperties(trs_p.getProperty("xragsoc"),new Properties());
      Properties p_xdescleg;
      p_xdescleg = CPLib.GetProperties(trs_p.getProperty("xdescleg"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_RAPCOL = "";
        w_RAPCOL = CPLib.GetProperty(p_RAPCOL,"",w_RAPCOL,i);
        w_xragsoc = "";
        w_xragsoc = CPLib.GetProperty(p_xragsoc,"",w_xragsoc,i);
        w_xdescleg = "";
        w_xdescleg = CPLib.GetProperty(p_xdescleg,"",w_xdescleg,i);
        w_DOMICILIO = "";
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_CODSOG","w_xragsoc","w_DOMICILIO","w_DESCCIT","w_PROVINCIA","w_CAP"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C\u0000C\u0000C\u0000C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("16\u000070\u000035\u000030\u00002\u00009",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000\u00000\u00000\u00000\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Codice Soggetto\u0000Ragione Sociale\u0000Indirizzo\u0000Città\u0000Provincia\u0000CAP",-1));
    ...
    map.put("property.value",zeroSplit.split("personbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Anagrafica Persone\u0000\u0000\u0000false",-1));
    ...
    map.put("rd_var",new String[]{"w_LEGAME","w_xdescleg"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("tbtipleg\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Tipologie  legami\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
  }
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_storsoginfo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_storsoginfo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_storsoginfo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_storsoginfo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_storsoginfo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_storsoginfo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_RAPCOL;
    p_RAPCOL = new Properties();
    Properties p_xragsoc;
    p_xragsoc = new Properties();
    Properties p_xdescleg;
    p_xdescleg = new Properties();
    Properties p_DOMICILIO;
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_RAPCOL,"",w_RAPCOL,trsrow);
      CPLib.PutProperty(p_xragsoc,"",w_xragsoc,trsrow);
      CPLib.PutProperty(p_xdescleg,"",w_xdescleg,trsrow);
    ...
    trs_p.setProperty("RAPCOL",CPLib.ToProperties(p_RAPCOL));
    trs_p.setProperty("xragsoc",CPLib.ToProperties(p_xragsoc));
    trs_p.setProperty("xdescleg",CPLib.ToProperties(p_xdescleg));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "woginfo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "woginfo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
  ...
  protected void TrsToWork() {
    ...
    w_xdescleg= m_oTrs.get(m_nCurrentRow).w_xdescleg;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_xdescleg=w_xdescleg;
  ...
  public void AddRow() {
    ...
    if ( ! (CPLib.Empty(w_CODSOG))) {
      l_bTmpRes = Link_FVKNSPNHTX();
    }
    if ( ! (CPLib.Empty(w_LEGAME))) {
      l_bTmpRes = Link_KQROMFNGNZ();
    }
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_xdescleg=w_xdescleg;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_xdescleg= m_oDeletedRows.get(l_RowNumberToSet).w_xdescleg;
