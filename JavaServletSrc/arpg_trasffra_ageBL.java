...
public class arpg_trasffra_ageBL extends arpg_trasffra_ageWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasffra_age";
  ...
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe}";
  ...
  public arpg_trasffra_ageBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasffra_age","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
