...
public class arpg_allinea_anagrafiche_noreportBL extends arpg_allinea_anagrafiche_noreportWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_allinea_anagrafiche_noreport";
  ...
  public arpg_allinea_anagrafiche_noreportBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_anagrafiche_noreport","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
