...
function Help() {
windowOpenForeground('../doc/arpg_operazrappo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_operazrappo',m_cSelectedPage);
...
GroupFooter_BeginHtml(document,1,'784464834'+l_nIdx+'','A',true,false)
document.writeln(
 "<div id='DIV_097EDFB0"+l_nIdx+"' style='position:relative;height:2px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
GroupFooter_EndHtml(document,1,'784464834'+l_nIdx+'','A')
} else {
}
l_nIdx=l_nIdx+1;
m_nCurrentRow=l_nIdx;
...
if (Ge(2,l_nDeep)) {
GroupHeader_BeginHtml(document,1,'784464866'+l_nIdx+'','A',true,false)
document.writeln(
 "<div id='DIV_0981E808"+l_nIdx+"' style='position:relative;height:19px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
GroupHeader_EndHtml(document,1,'784464866'+l_nIdx+'','A')
} else {
}
Row_BeginHtml(document,l_nEvenOdd,'784239746'+l_nIdx+'','A',true,-1)
document.writeln(
 "<div id='DIV_098E9530"+l_nIdx+"' style='position:relative;height:20px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
Row_EndHtml(document,l_nEvenOdd,'784239746'+l_nIdx+'','A')
Parms.Idx=l_nIdx;
Parms.Deep=l_nDeep;
Parms.EvenOdd=l_nEvenOdd;
}
