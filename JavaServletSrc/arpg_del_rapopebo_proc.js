...
if (false || WindowConfirm(Translate('10838174534'))) {
SetHypPar('m_cAction',AsAppletValue('start'));
SetHypPar('m_cMode',AsAppletValue('hyperlink'));
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_del_rapopebo']));
SendData('start','arrt_del_rapopebo'+'',HParApplet().asString());
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_del_rapopebo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_del_rapopebo',m_cSelectedPage);
