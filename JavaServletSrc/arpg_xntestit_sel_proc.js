...
function Help() {
windowOpenForeground('../doc/arpg_xntestit_sel_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_xntestit_sel',m_cSelectedPage);
...
GroupFooter_BeginHtml(document,1,'2139631474'+l_nIdx+'','A',true,false)
GroupFooter_EndHtml(document,1,'2139631474'+l_nIdx+'','A')
} else {
}
l_nIdx=l_nIdx+1;
m_nCurrentRow=l_nIdx;
...
if (Ge(2,l_nDeep)) {
GroupHeader_BeginHtml(document,1,'2139631986'+l_nIdx+'','A',true,false)
document.writeln(
 "<div id='DIV_0BAAD6A0"+l_nIdx+"' style='position:relative;height:17px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
GroupHeader_EndHtml(document,1,'2139631986'+l_nIdx+'','A')
} else {
}
Row_BeginHtml(document,l_nEvenOdd,'2136030066'+l_nIdx+'','A',true,-1)
document.writeln(
 "<div id='DIV_0BA80570"+l_nIdx+"' style='position:relative;height:17px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
Row_EndHtml(document,l_nEvenOdd,'2136030066'+l_nIdx+'','A')
Parms.Idx=l_nIdx;
Parms.Deep=l_nDeep;
Parms.EvenOdd=l_nEvenOdd;
}
