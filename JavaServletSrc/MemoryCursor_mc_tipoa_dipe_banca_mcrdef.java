// Definition generated from record definition mc_tipoa_dipe_banca_mcrdef
public class MemoryCursor_mc_tipoa_dipe_banca_mcrdef extends CPMemoryCursor {
  MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef row;
  MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef empty_row;
  public MemoryCursor_mc_tipoa_dipe_banca_mcrdef() {
    empty_row = new MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef();
    row = empty_row;
  }
  public MemoryCursor_mc_tipoa_dipe_banca_mcrdef(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  public void AppendData(java.util.Properties p,CPContext p_Ctx) {
    ...
    java.util.Properties p_TIPO_RAPP;
    p_TIPO_RAPP = new java.util.Properties();
    java.util.Properties p_TIPO_ATT;
    p_TIPO_ATT = new java.util.Properties();
    ...
    while (e.hasMoreElements()) {
      ...
      if ("TIPO_RAPP".equalsIgnoreCase(key)) {
        p_TIPO_RAPP = CPLib.GetProperties(p.getProperty(key));
      }
      if ("TIPO_ATT".equalsIgnoreCase(key)) {
        p_TIPO_ATT = CPLib.GetProperties(p.getProperty(key));
      }
    ...
    for ( i = 1; CPLib.le(i,Rows); i = i + (1)) {
      ...
      row.TIPO_RAPP = CPLib.GetProperty(p_TIPO_RAPP,"","",i);
      row.TIPO_ATT = CPLib.GetProperty(p_TIPO_ATT,"","",i);
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef();
  }
  ...
  public MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_mc_tipoa_dipe_banca_mcrdef();
    }
    this.row.Copy(p_Row);
    return true;
  }
