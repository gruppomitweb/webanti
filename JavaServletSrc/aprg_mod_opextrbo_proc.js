...
FocusFirstComponent.otherwise={"page_1":["MVMKKHKTPS"]};
function Help() {
windowOpenForeground('../doc/aprg_mod_opextrbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('aprg_mod_opextrbo',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["txtnote","nummov","impsaldo","codval","CONNES","dataope","annorif","xdesval"];
...
TransferBetweenWindows(opener,'w_dataope','w_dataope');
}
if (Empty(w_annorif) && Ne(opener.w_annorif,null)) {
TransferBetweenWindows(opener,'w_annorif','w_annorif');
}
}
}
m_bCalculating=true;
