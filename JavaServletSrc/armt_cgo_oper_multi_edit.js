...
function DisplayErrorMessage_ardt_cgo_oper_multi() {
if ( ! (ChildToLoad(FrameRef('ardt_cgo_oper_multi'))) && Ne(typeof(FrameRef('ardt_cgo_oper_multi').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_cgo_oper_multi').DisplayErrorMessage();
}
}
...
l_bEnabled= ! (Eq(w_xFLGPLGIO,'S')) || IsDisabledByStateDriver('VLTPLAT');
SetDisabled('LVYFMQXNZH',l_bEnabled);
l_bEnabled= ! (false) || IsDisabledByStateDriver('CAIDBIGLIETTO');
SetDisabled('BMTLGIUQTH',l_bEnabled);
l_bEnabled= ! (false) || IsDisabledByStateDriver('CAFLGOPE');
SetDisabled('YJDISDDJUY',l_bEnabled);
l_bEnabled= ! (false) || IsDisabledByStateDriver('SEGNO');
SetDisabled('QNNLSEAZHF',l_bEnabled);
...
SetDisabled('TTZZVOAPLN',l_bEnabled);
...
SetObligatory(Ctrl('LVYFMQXNZH'),Eq(w_xFLGPLGIO,'S') || IsObligatoryByStateDriver('VLTPLAT'));
...
SetObligatory(Ctrl('TTZZVOAPLN'),Eq(w_FLAGWALLET,'1') || IsObligatoryByStateDriver('CODWALLET'));
...
SetObligatory(Ctrl('FRTNMCIRCW'),Eq(w_xCGOFLGPROF,'S') || IsObligatoryByStateDriver('PROFESSIONE'));
...
function Set_MIDBIGLIETTO4(ctrlValue,kmode,e) {
if (Ne(w_MIDBIGLIETTO4,ctrlValue)) {
var ctl = _GetCtl(e,'VHQLLRDGQY');
if (_tracker.goon(ctl,ctrlValue)) {
w_MIDBIGLIETTO4=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('VHQLLRDGQY',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
...
function Set_MIDBIGLIETTO3(ctrlValue,kmode,e) {
if (Ne(w_MIDBIGLIETTO3,ctrlValue)) {
var ctl = _GetCtl(e,'ASCWWTJMOW');
if (_tracker.goon(ctl,ctrlValue)) {
w_MIDBIGLIETTO3=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('ASCWWTJMOW',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','M',10,0,'');
...
function Set_MIDBIGLIETTO2(ctrlValue,kmode,e) {
if (Ne(w_MIDBIGLIETTO2,ctrlValue)) {
var ctl = _GetCtl(e,'SARDBHIRVW');
if (_tracker.goon(ctl,ctrlValue)) {
w_MIDBIGLIETTO2=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('SARDBHIRVW',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','M',10,0,'');
...
function Set_VLTPLAT(ctrlValue,kmode,e) {
if (Ne(w_VLTPLAT,ctrlValue)) {
var ctl = _GetCtl(e,'LVYFMQXNZH');
if (_tracker.goon(ctl,ctrlValue)) {
w_VLTPLAT=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('LVYFMQXNZH',0);
if (l_bResult) {
l_bResult=Link_LVYFMQXNZH(kmode);
if ( ! (l_bResult)) {
w_VLTPLAT=HtW('','C');
}
}
...
function Set_MIDBIGLIETTO1(ctrlValue,kmode,e) {
if (Ne(w_MIDBIGLIETTO1,ctrlValue)) {
var ctl = _GetCtl(e,'PLOWDDMVBX');
if (_tracker.goon(ctl,ctrlValue)) {
w_MIDBIGLIETTO1=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('PLOWDDMVBX',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','M',10,0,'');
...
if (l_bResult) {
l_bResult=Le(w_DATAOPE,SystemDate());
if ( ! (l_bResult)) {
m_nLastError=2;
m_cLastWorkVarErrorMsg='829201110';
m_cLastMsgError=AlertErrorMessage('10845724022');
}
if ( ! (l_bResult)) {
w_DATAOPE=HtW('','D');
}
...
var ctl = _GetCtl(e,'FRTNMCIRCW');
if (_tracker.goon(ctl,ctrlValue)) {
w_PROFESSIONE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('FRTNMCIRCW',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
...
var ctl = _GetCtl(e,'YJDISDDJUY');
if (_tracker.goon(ctl,ctrlValue)) {
w_CAFLGOPE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('YJDISDDJUY',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','C',1,0,'');
...
var ctl = _GetCtl(e,'QNNLSEAZHF');
if (_tracker.goon(ctl,ctrlValue)) {
w_SEGNO=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('QNNLSEAZHF',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','C',1,0,'');
...
if (l_bResult) {
l_bResult=Gt(w_TOTLIRE,0) && Ge(w_TOTLIRE,(w_TOTCONT+w_IMPWALLET));
if ( ! (l_bResult)) {
m_nLastError=2;
m_cLastWorkVarErrorMsg='1825772649';
m_cLastMsgError=AlertErrorMessage('11419822357');
}
if ( ! (l_bResult)) {
w_TOTLIRE=HtW('','N');
}
...
var ctl = _GetCtl(e,'TTZZVOAPLN');
if (_tracker.goon(ctl,ctrlValue)) {
w_CODWALLET=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('TTZZVOAPLN',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','C',20,0,'');
...
var ctl = _GetCtl(e,'TPAKMNVWJA');
if (_tracker.goon(ctl,ctrlValue)) {
w_NUMTEL=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('TPAKMNVWJA',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','C',20,0,'');
...
if ( ! (ChildToLoad(FrameRef('ardt_cgo_oper_multi'))) && Ne(typeof(FrameRef('ardt_cgo_oper_multi').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('ardt_cgo_oper_multi'),['CGOTIPOPE','DATOPE_P','SEGNO_P'],['CGOTIPOPE','DATAOPE','SEGNO'],true)
}
if ((Ne(o_TIPOGIOCO,w_TIPOGIOCO)) || (Ne(o_TOTLIRE,w_TOTLIRE))) {
...
function Calculation_QMNVPQPHJO() {
arrt_cgo_setpagatore_m([["pObj",this]])
}
...
function Calculation_CHYPGHRXCN() {
w_CGOFLGVLT=(Ge(w_TOTLIRE,w_xSOGTPGIO)?w_xDEFTPGIO:w_xDEFSPGIO);
}
function Calculation_TDZCBUMNXR() {
w_VLTPLAT=(Eq(w_xFLGPLGIO,'S')?w_VLTPLAT:'');
}
...
function Calculation_DJCGAISFTP() {
w_SEGNO=(Eq(w_CAFLGOPE,'G')?'A':(Eq(w_CAFLGOPE,'V')?'D':''));
}
function Calculation_ZOUJCIPILP() {
...
l_Appl.SetFields('CODTPGIO,SOGTPGIO,DEFTPGIO,EDTTPGIO,EDTSPGIO,DEFSPGIO,FLGPLGIO,FLTIPGIO,IMPMINTOT');
l_Appl.SetTypes('C,N,C,C,C,C,C,C,N');
...
w_CGOTIPOPE=l_Appl.GetStringValue('FLTIPGIO',1,0);
w_xIMPMINTOT=l_Appl.GetDoubleValue('IMPMINTOT',12,2);
...
l_Appl.SetFields('VPCODICE,VPFLGATT');
l_Appl.SetTypes('C,C');
...
w_xVPFLGATT=l_Appl.GetStringValue('VPFLGATT',1,0);
l_Appl.GetLinkHash(m_CheckVars);
} else {
Link_LVYFMQXNZH_Blank();
}
if (Eq(l_nRec,2)) {
var openername = 'linkview_LVYFMQXNZH';
...
if (l_bResult &&  ! (Empty(w_VLTPLAT) && l_bEmp)) {
l_bResult=Eq(w_xVPFLGATT,'S');
if ( ! (l_bResult)) {
Link_LVYFMQXNZH_Blank();
}
}
...
m_cLastMsgError=AlertErrorMessage('441053783');
}
}
}
return l_bResult;
...
var bResult = false;
if (Eq(varName,'LVYFMQXNZH')) {
last_focused_comp=GetLastFocusedElementOfLink('LVYFMQXNZH');
function SetMethod_LVYFMQXNZH() {
Set_VLTPLAT(HtW(value,'C'),0);
}
if (IsDeviceMobile()) {
SetMethod_LVYFMQXNZH();
} else {
setTimeout(SetMethod_LVYFMQXNZH,1);
}
bResult=true;
}
...
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_oper_multi_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_oper_multi_dataNotSent',{'action':formaction});
}
}
}
}
CheckChild.child=[{'prg':"ardt_cgo_oper_multi",'BOScId':function(){ return FrameRef('ardt_cgo_oper_multi')},'repeated':0}];
function Check() {
var l_bResult = true;
...
l_bResult=false;
w_SNAINUMOPE=HtW('','C');
} else if ((Eq(w_xFLGPLGIO,'S')) && (( ! (_ChkObl('LVYFMQXNZH',1))) || ( ! (Empty(w_VLTPLAT)) &&  ! (Eq(w_xVPFLGATT,'S'))))) {
_SignErr('LVYFMQXNZH','441053783');
l_bResult=false;
w_VLTPLAT=HtW('','C');
...
} else if (( ! (_ChkObl('YLIKFVPZJA',1))) || ( ! (Le(w_DATAOPE,SystemDate())))) {
_SignErr('YLIKFVPZJA','10845724022');
l_bResult=false;
w_DATAOPE=HtW('','D');
...
l_bResult=false;
w_CACODICE=HtW('','N');
} else if ((false) && ( ! (_ChkObl('YJDISDDJUY',1)))) {
_SignErr('YJDISDDJUY');
m_cLastWorkVarErrorMsg='995100987';
l_bResult=false;
w_CAFLGOPE=HtW('','C');
} else if ((false) && ( ! (_ChkObl('QNNLSEAZHF',1)))) {
_SignErr('QNNLSEAZHF');
m_cLastWorkVarErrorMsg='7753123';
l_bResult=false;
w_SEGNO=HtW('','C');
} else if ((false) && (( ! (_ChkObl('HUAGBHPUNH',1))) || ( ! (Gt(w_TOTLIRE,0) && Ge(w_TOTLIRE,(w_TOTCONT+w_IMPWALLET)))))) {
_SignErr('HUAGBHPUNH','11419822357');
l_bResult=false;
w_TOTLIRE=HtW('','N');
} else if ((Eq(w_FLAGCONT,'1') &&  ! (Empty(w_DATAOPE))) && (( ! (_ChkObl('HUDOCMLKKT',1))) || ( ! (arfn_chktotalelire_cont(w_DATAOPE,w_datpaseuro,w_TOTCONT,w_TOTLIRE))))) {
...
l_bResult=false;
w_IMPWALLET=HtW('','N');
} else if ((Eq(w_FLAGWALLET,'1') &&  ! (Empty(w_DATAOPE))) && ( ! (_ChkObl('TTZZVOAPLN',1)))) {
_SignErr('TTZZVOAPLN');
...
_SignErr('XMGRWGFSFV','12120646188');
l_bResult=false;
w_DATANASC=HtW('','D');
...
} else if ( ! (_ChkObl('PLOWDDMVBX',1))) {
_SignErr('PLOWDDMVBX');
m_cLastWorkVarErrorMsg='MIDBIGLIETTO1';
l_bResult=false;
w_MIDBIGLIETTO1=HtW('','M');
} else if ( ! (_ChkObl('SARDBHIRVW',1))) {
_SignErr('SARDBHIRVW');
m_cLastWorkVarErrorMsg='MIDBIGLIETTO2';
l_bResult=false;
w_MIDBIGLIETTO2=HtW('','M');
} else if ( ! (_ChkObl('ASCWWTJMOW',1))) {
_SignErr('ASCWWTJMOW');
m_cLastWorkVarErrorMsg='MIDBIGLIETTO3';
l_bResult=false;
w_MIDBIGLIETTO3=HtW('','M');
} else if ( ! (_ChkObl('VHQLLRDGQY',1))) {
_SignErr('VHQLLRDGQY');
m_cLastWorkVarErrorMsg='MIDBIGLIETTO4';
l_bResult=false;
w_MIDBIGLIETTO4=HtW('','M');
...
if (l_bResult) {
  if (w_TOTLIRE < w_xIMPMINTOT) {
      m_cLastMsgError='Importo totale deve essere uguale o superiore a \u20ac '+LRTrim(Str(w_xIMPMINTOT,12,2))
      l_bResult=false
  }
}
...
l_oWv.setValue('gTipMul',WtA(w_gTipMul,'C'));
...
l_oWv.setValue('xIMPMINTOT',WtA(w_xIMPMINTOT,'N'));
...
_FillChildren.n=['ardt_cgo_oper_multi'];
FillWv.n=["SNAINUMOPE","TIPOGIOCO","VLTPLAT","CGOTIPOPE","CAIDBIGLIETTO","DATAOPE","FLAGCONT","FLAGWALLET","CACODICE","CODANA","CODVOC","CAFLGOPE","SEGNO","TOTLIRE","TOTCONT","IMPWALLET","CODWALLET","CODTRANSZ","CGOFLGVLT","CGOFLGVNP","CC4CIFRE","CCMESSCA","CCANNSCA","IBAN","ASSEGNO","CCDATSCA","CFESTERO","PEP","CODFISC","COGNOME","NOME","NASCOMUN","TIPINTER","SESSO","NASSTATO","DATANASC","PAESE","DESCCIT","PROVINCIA","CAP","DOMICILIO","NUMTEL","FLGDOM","PAESE2","DESCCIT2","PROVINCIA2","CAP2","DOMICILIO2","TIPODOC","NUMDOCUM","DATARILASC","DATAVALI","RDCODAUT","RDLOCAUT","PEPDESCRI","TIPOPERS","RAGSOC","SOTGRUP","RAMOGRUP","SETTSINT","DATAREG","TIPOOPRAP","VALUTA","CAMBIO","CONNESCLI","CONNESBEN","C_RAG","C_CTA","C_PRV","C_CAP","C_CAB","C_IND","C_STA","CODINTER","FLAGFRAZ","COLLEG","CODCAB","ATTIV","AUTRILASC","IDDOCALL","FLGDOCALL","PROFESSIONE","MEZPAGAM","CODDIPE","DESCCITDIP","PROVINCIADIP","CODCABDIP","gIntemediario","gCodDip","gStpDwn","gVLT","gVNP","gChkDate","gGesDoc","gSeekAos","gDataVaria","gFlgDoc","gTipMul","xARDESCRI","xSOGTPGIO","xDEFTPGIO","xEDTTPGIO","xEDTSPGIO","xDEFSPGIO","xFLGPLGIO","FLGPAGAM","FILTROMP","idcitta","idcitta2","dessta","tipsot","STATOREG","IDBASE","NUMPROG","DESCRI","xDescDipe","datpaseuro","xdes1","desccauana","CITINT","CITDIP","PROVDIP","CABDIP","PROVINT","CABINT","xdesccausin","xdesctipatt","MIDBIGLIETTO","MIDBIGLIETTO1","MIDBIGLIETTO2","MIDBIGLIETTO3","MIDBIGLIETTO4","xVPFLGATT","DOC03","DOC04","edtdoc","saveddoc","dessta2","xIMPMINTOT","gAzienda","xCGOFLGPROF","TELDIP","CODLOC","ANA_FOUND"];
function SetModified() {
m_bUpdated=true;
}
function SetChildVariables_ardt_cgo_oper_multi() {
if ( ! (ChildToLoad(FrameRef('ardt_cgo_oper_multi'))) && Ne(typeof(FrameRef('ardt_cgo_oper_multi').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('ardt_cgo_oper_multi'),['CGOTIPOPE','DATOPE_P','SEGNO_P'],['CGOTIPOPE','DATAOPE','SEGNO'],false)
}
}
function CtxLoad_ardt_cgo_oper_multi() {
if (ChildToLoad(FrameRef('ardt_cgo_oper_multi'))) {
return [LoadContext(0,'AAHJPBZVGL'),'ardt_cgo_oper_multi'];
}
}
