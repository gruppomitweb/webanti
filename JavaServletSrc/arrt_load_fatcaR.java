...
// * --- Fine Area Manuale
public class arrt_load_fatcaR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_load_fatcaR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_load_fatca",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* _comando Memo */
    /* _where Char(80) */
    /* _comando := 'editload CONNES="'+cConnes+'"'+ NL + "@" + NL + "@SAVE"+ NL + "arrt_void"+NL +"@DISCARD"+ NL + "arrt_void" */
    _comando = "editload CONNES=\""+cConnes+"\""+"\n"+"@"+"\n"+"@SAVE"+"\n"+"arrt_void"+"\n"+"@DISCARD"+"\n"+"arrt_void";
    /* _where := "CONNES='"+cConnes+"'" */
    _where = "CONNES='"+cConnes+"'";
    /* Stop ardt_fatca_ind */
    Forward f;
    f=new Forward("ardt_fatca_ind",false,this,Forward.Start,false);
    f.SetParameter("m_cAction","workflow");
    f.SetParameter("m_cLastWhere",_where);
    f.SetParameter("WorkFlowScript",_comando);
    f.SetParameter("m_cParameterSequence","m_cAction"+","+"m_cLastWhere"+","+"WorkFlowScript");
    f.SetParameter("m_cMode","hyperlink");
    throw f;
  }
  void _init_() {
  }
  public String RunAsync(String p_cConnes) {
    cConnes = p_cConnes;
  ...
  public Forward Run(String p_cConnes) {
    cConnes = p_cConnes;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_load_fatcaR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_load_fatcaR(p_Ctx, p_Caller);
  }
  public void Blank() {
    cConnes = CPLib.Space(25);
    _tipo = CPLib.Space(1);
    _comando = "";
  ...
  public static String[] m_cRunParameterNames={"cConnes"};
}
