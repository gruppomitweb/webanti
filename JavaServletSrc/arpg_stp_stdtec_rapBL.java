...
public class arpg_stp_stdtec_rapBL extends arpg_stp_stdtec_rapWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_rap";
  ...
  public static final String i_CompleteStateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daRapporto':daRapporto,'aRapporto':aRapporto,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2}";
  ...
  public arpg_stp_stdtec_rapBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_rap","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
