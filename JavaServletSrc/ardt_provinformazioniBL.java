...
public class ardt_provinformazioniBL extends ardt_provinformazioniWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_provinformazioni";
  ...
  public CPPhTableWrInfo m_oWrInfo_xntestbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xntestbo;
  ...
  public static String[] m_EntityTables = {"xntestbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_provinformazioni",true,true)+"}"+FoundlingChildrenList("ardt_provinformazioni",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDBASE':IDBASE,'tipreg':tipreg,'appoggio':appoggio,'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'tiporegr':tiporegr,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'TIPOPERS':TIPOPERS,'NUMPROG1':NUMPROG1,'NUMPROG2':NUMPROG2,'xragsoci':xragsoci,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PRGIMPSOG':PRGIMPSOG,'xRagSoc':xRagSoc,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_provinformazioni",true,true)+"}"+FoundlingChildrenList("ardt_provinformazioni",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER DATAINI DATAFINE PROQUOTA"+FoundlingChildrenList("ardt_provinformazioni",false,true)+"]"+FoundlingChildrenList("ardt_provinformazioni",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_provinformazioni"),new String[][]{new String[]{"RAPPORTO","Rapporto (Copia della testata)","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","Intestatario (Non Intermediario)","C","16","0","campo","key2","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","true"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","true"},new String[]{"PROQUOTA","% Pro Quota","N","3","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_provinformazioniBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xntestbo = p_ContextObject.GetPhName("xntestbo",p_ContextObject.GetCompany(),false);
    m_cServer_xntestbo = p_ContextObject.GetServer("xntestbo");
    m_oWrInfo_xntestbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xntestbo",p_ContextObject.GetCompany());
    m_cVirtName_xntestbo = CPSql.ManipulateTablePhName("xntestbo",m_cServer_xntestbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_provinformazioni",p_ContextObject);
  }
  public void Blank() {
    ...
    w_PROQUOTA = 0;
    w_tipreg = 0;
    w_tipreg = Utilities.Make(m_Ctx).GetCallerNumber("tipregn");
    Link_XTDHYWJPZL();
    w_NUMPROG1 = "";
    w_NUMPROG1 = ( ! (CPLib.Empty(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"))) && CPLib.ne(CPLib.At(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"|21|22|23|24|27|33|34|35|43|44|45"),0)?Utilities.Make(m_Ctx).GetCallerString("NUMPROG"):w_NUMPROG1);
    w_NUMPROG2 = "";
    w_NUMPROG2 = ( ! (CPLib.Empty(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"))) && CPLib.ne(CPLib.At(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"|26|36|38|46"),0) && CPLib.Empty(w_NUMPROG2)?Utilities.Make(m_Ctx).GetCallerString("NUMPROG"):w_NUMPROG2);
    w_xRagSoc = "";
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_provinformazioni","xntestbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_provinformazioni",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_provinformazioni",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_provinformazioni",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_provinformazioni",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_provinformazioni"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_provinformazioni\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xntestbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "xntestbo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
