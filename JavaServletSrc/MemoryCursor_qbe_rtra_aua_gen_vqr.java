// Definition generated from query qbe_rtra_aua_gen_vqr
public class MemoryCursor_qbe_rtra_aua_gen_vqr extends CPMemoryCursor {
  MemoryCursorRow_qbe_rtra_aua_gen_vqr row;
  MemoryCursorRow_qbe_rtra_aua_gen_vqr empty_row;
  public MemoryCursor_qbe_rtra_aua_gen_vqr() {
    empty_row = new MemoryCursorRow_qbe_rtra_aua_gen_vqr();
    row = empty_row;
  }
  public MemoryCursor_qbe_rtra_aua_gen_vqr(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_qbe_rtra_aua_gen_vqr)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_qbe_rtra_aua_gen_vqr();
  }
  ...
  public MemoryCursorRow_qbe_rtra_aua_gen_vqr _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_qbe_rtra_aua_gen_vqr _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_qbe_rtra_aua_gen_vqr> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_qbe_rtra_aua_gen_vqr();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    MemoryCursorRow_qbe_rtra_aua_gen_vqr l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_qbe_rtra_aua_gen_vqr p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_qbe_rtra_aua_gen_vqr();
    }
    this.row.Copy(p_Row);
    return true;
  }
