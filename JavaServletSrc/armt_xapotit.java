...
public class armt_xapotit extends SPServlet implements SPInvokable {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"1016682754",p_Context.Translate("E"+"'"+" indicato il sesso, quindi si tratta di persona fisica e non di Società.\"+NL+\"Non esiste Titolare effettivo di persona fisica")},
