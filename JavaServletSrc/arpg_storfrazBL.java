...
public class arpg_storfrazBL extends arpg_storfrazWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_storfraz";
  ...
  public static final String i_CompleteStateStructure = "{'tipoope':tipoope,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'gIntemediario':gIntemediario,'gTipInter':gTipInter,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gDatDel':gDatDel,'gDatTra':gDatTra}";
  ...
  public arpg_storfrazBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_storfraz","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
