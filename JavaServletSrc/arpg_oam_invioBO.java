...
// * --- Fine Area Manuale
public class arpg_oam_invioBO extends arpg_oam_invioBL {
  ...
  public arpg_oam_invioBO (CPContext p_ContextObject) {
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_filesage,arfn_finemese,azzera_messaggi,
  public static final String i_InvokedRoutines = ",arfn_filesage,arfn_finemese,azzera_messaggi,";
}
