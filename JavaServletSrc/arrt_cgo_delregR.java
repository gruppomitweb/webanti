...
// * --- Fine Area Manuale
public class arrt_cgo_delregR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_cgo_delregR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_cgo_delreg",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    m_cSql = CPLib.GetSQLPrefixComment("arrt_cgo_delreg",34,"00000003")+"delete from "+m_oWrInfo.GetTableWriteName();
    m_cSql = m_cSql+" where ";
    ...
    /* Stop arpg_cgo_operazioni_agenzie_dl */
    Forward f;
    f=new Forward("arpg_cgo_operazioni_agenzie_dl",false,this,Forward.Start,false);
  ...
  public static arrt_cgo_delregR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_cgo_delregR(p_Ctx, p_Caller);
  }
  public void Blank() {
