...
public class ardt_wlientiopeBL extends ardt_wlientiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_wlientiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_wlientiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wlientiope;
  ...
  public static String[] m_EntityTables = {"wlientiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_wlientiope",true,true)+"}"+FoundlingChildrenList("ardt_wlientiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_wlientiope",true,true)+"}"+FoundlingChildrenList("ardt_wlientiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_wlientiope",false,true)+"]"+FoundlingChildrenList("ardt_wlientiope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_wlientiope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_wlientiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wlientiope = p_ContextObject.GetPhName("wlientiope",p_ContextObject.GetCompany(),false);
    m_cServer_wlientiope = p_ContextObject.GetServer("wlientiope");
    m_oWrInfo_wlientiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wlientiope",p_ContextObject.GetCompany());
    m_cVirtName_wlientiope = CPSql.ManipulateTablePhName("wlientiope",m_cServer_wlientiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_wlientiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_wlientiope","wlientiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_wlientiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_wlientiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_wlientiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_wlientiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_wlientiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_wlientiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wlientiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "wlientiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
