...
if ( ! (m_oFather.SaveContext_ardt_xarantbo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xarantbo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xarantbo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xarantbo();
}
}
SaveContext.child=[];
function BlankRow() {
