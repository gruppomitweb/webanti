...
SetDisplay(Ctrl('UJDYOPDWZF'),true || IsHiddenByStateDriver('RAPCOL'));
...
m_oFather.i_last_focused_item='child_ardt_ae_soginfo';
...
function Help() {
windowOpenForeground('../doc/ardt_ae_soginfo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'joginfo'+'\\'+CPLib.ToCPStr(w_RAPCOL);
}
...
p_d.setValue('ardt_ae_soginfo',m_cSelectedPage);
