...
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_modopen3']));
SendData('start','arrt_modopen3'+'',HParApplet().asString());
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_modopen3_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_modopen3',m_cSelectedPage);
