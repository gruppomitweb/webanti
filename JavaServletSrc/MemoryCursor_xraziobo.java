// Definition generated from table xraziobo
public class MemoryCursor_xraziobo extends CPMemoryCursor {
  MemoryCursorRow_xraziobo row;
  MemoryCursorRow_xraziobo empty_row;
  public MemoryCursor_xraziobo() {
    empty_row = new MemoryCursorRow_xraziobo();
    row = empty_row;
  }
  public MemoryCursor_xraziobo(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  public void AppendData(java.util.Properties p,CPContext p_Ctx) {
    ...
    java.util.Properties p_VASP;
    p_VASP = new java.util.Properties();
    ...
    while (e.hasMoreElements()) {
      ...
      if ("VASP".equalsIgnoreCase(key)) {
        p_VASP = CPLib.GetProperties(p.getProperty(key));
      }
    }
    for ( i = 1; CPLib.le(i,Rows); i = i + (1)) {
      ...
      row.VASP = CPLib.GetProperty(p_VASP,"","",i);
    }
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_xraziobo)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_xraziobo();
  }
  ...
  public MemoryCursorRow_xraziobo _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_xraziobo _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_xraziobo> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_xraziobo();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_xraziobo p_Row) {
    MemoryCursorRow_xraziobo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_xraziobo p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_xraziobo();
    }
    this.row.Copy(p_Row);
    return true;
  }
