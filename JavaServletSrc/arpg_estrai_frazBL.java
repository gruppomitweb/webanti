...
public class arpg_estrai_frazBL extends arpg_estrai_frazWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_estrai_fraz";
  ...
  public static final String i_StateStructure = "{'dadata':dadata,'adata':adata,'cMTCN':cMTCN,'cCODFISC':cCODFISC,'cDIP':cDIP}";
  public static final String i_CompleteStateStructure = "{'dadata':dadata,'adata':adata,'cdadata':cdadata,'c_adata':c_adata,'cMTCN':cMTCN,'cCODFISC':cCODFISC,'cDIP':cDIP,'xdesdip':xdesdip}";
  public static final String i_ItemSequence = "dadata,adata,cMTCN,cCODFISC,cDIP";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"dadata","","D","8","0","variabile","nokey","false","false"},new String[]{"adata","","D","8","0","variabile","nokey","false","false"},new String[]{"cMTCN","","C","10","0","variabile","nokey","false","false"},new String[]{"cCODFISC","","C","16","0","variabile","nokey","false","false"},new String[]{"cDIP","","C","5","0","variabile","nokey","false","false"}});
  ...
  public arpg_estrai_frazBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_xdesdip = "";
    w_cdadata = "";
    w_cdadata = CPLib.DateToChar(w_dadata);
    w_c_adata = "";
    w_c_adata = CPLib.DateToChar(w_adata);
    Link_FBVBGICYQT();
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  protected boolean Link_FBVBGICYQT(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_cDIP))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_cDIP,"C",5,0),m_cServer_anadip,w_cDIP);
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_estrai_fraz","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var.len",zeroSplit.split("5\u000030",-1));
