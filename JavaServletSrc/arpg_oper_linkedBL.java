...
public class arpg_oper_linkedBL extends arpg_oper_linkedWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_oper_linked";
  ...
  public static final String i_StateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'DaDatReg':DaDatReg,'ADatReg':ADatReg}";
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'c_dadata':c_dadata,'c_adata':c_adata,'daCodCli':daCodCli,'aCodCli':aCodCli,'DaDatReg':DaDatReg,'ADatReg':ADatReg}";
  public static final String i_ItemSequence = "DaDatOpe,ADatOpe,daCodCli,aCodCli,DaDatReg,ADatReg";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"DaDatReg","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatReg","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_oper_linkedBL (CPContext p_ContextObject) {
  ...
  public boolean Set_ADatReg(java.sql.Date p_workVariableValue) {
    ...
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di fine registrazione non deve essere minore di quella di inizio registrazione!";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_ADatReg = CPLib.NullDate();
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_oper_linked","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
