...
_modifyandopen('arrt_stp_contfile_do'+'?m_cAction=start&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes,height=200,width=300',null)
}
...
w_Messaggi.raiseEvent('arpg_stp_contfile_do_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stp_contfile_do_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_contfile_do',m_cSelectedPage);
