...
public class arpg_check_opexBL extends arpg_check_opexWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_check_opex";
  ...
  public arpg_check_opexBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_check_opex","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
