...
// * --- Fine Area Manuale
public class arrt_aelistanomi_doR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_aelistanomi_doR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_aelistanomi_do",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    /* If w_tipostp='D' */
    if (CPLib.eqr(w_tipostp,"D")) {
      /* Case w_iniz = 'I' */
      if (CPLib.eqr(w_iniz,"I")) {
        /* Return  */
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("ReportName","arrp_aelistarapporti_d_1");
        ...
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("ReportName","arrp_aelistarapporti_d_2");
        f.SetParameter("outputFormat","PDF");
        f.SetParameter("rotation","LANDSCAPE");
        ...
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("ReportName","arrp_aelistarapporti_d_3");
        f.SetParameter("outputFormat","PDF");
        f.SetParameter("rotation","LANDSCAPE");
      ...
      if (CPLib.eqr(w_iniz,"I")) {
        ...
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("ReportName","arrp_aelistarapporti_o_1");
        f.SetParameter("outputFormat","PDF");
        f.SetParameter("rotation","LANDSCAPE");
        f.SetParameter("datpris",w_datpris);
        f.SetParameter("datprif",w_datprif);
        ...
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("ReportName","arrp_aelistarapporti_o_2");
        f.SetParameter("outputFormat","PDF");
        f.SetParameter("rotation","LANDSCAPE");
        f.SetParameter("datseci",w_datseci);
        f.SetParameter("datsecf",w_datsecf);
        ...
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("ReportName","arrp_aelistarapporti_o_3");
        f.SetParameter("outputFormat","PDF");
        f.SetParameter("rotation","LANDSCAPE");
        f.SetParameter("dadata",w_dadata);
        f.SetParameter("a_data",w_a_data);
  ...
  public Forward Run() {
    ...
    try {
      ...
      m_Caller.SetString("tipostp","C",1,0,w_tipostp);
  ...
  public static arrt_aelistanomi_doR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_aelistanomi_doR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    w_tipostp = m_Caller.GetString("tipostp","C",1,0);
