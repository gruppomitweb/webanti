...
public class arpg_cgo_operazioni_agenzie_smBL extends arpg_cgo_operazioni_agenzie_smWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public java.sql.Date c_DATAOPE;
    public String c_CACODICE;
    public String c_TRDESREG;
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_agenzie_sm";
  ...
  public static final String i_CompleteStateStructure = "{'tipogioco':tipogioco}";
  ...
  public arpg_cgo_operazioni_agenzie_smBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_agenzie_sm","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_TRDESREG=c_TRDESREG;
  ...
  public void TrsToWork() {
    ...
    c_TRDESREG= m_oTrs.get(m_nCurrentRow).c_TRDESREG;
