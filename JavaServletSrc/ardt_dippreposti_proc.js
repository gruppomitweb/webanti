...
m_oFather.i_last_focused_item='child_ardt_dippreposti';
...
function Help() {
windowOpenForeground('../doc/ardt_dippreposti_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
w_DATAINI=a[6];
w_DATAFINE=a[7];
m_PrimaryKeys=['CPROWNUM','CODDIP'];
}
function i_PrimaryKey() {
return 'dippreposti'+'\\'+CPLib.ToCPStr(w_CODDIP);
}
...
p_d.setValue('ardt_dippreposti',m_cSelectedPage);
