...
public class arpg_import_esito_dettaglio_reportBL extends arpg_import_esito_dettaglio_reportWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_ESITO;
    public String c_NOMREP;
  ...
  public static final String i_EntityName = "arpg_import_esito_dettaglio_report";
  ...
  public arpg_import_esito_dettaglio_reportBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_esito_dettaglio_report","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_ESITO=c_ESITO;
    m_oTrs.get(m_nCurrentRow).c_NOMREP=c_NOMREP;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_ESITO= m_oTrs.get(m_nCurrentRow).c_ESITO;
    c_NOMREP= m_oTrs.get(m_nCurrentRow).c_NOMREP;
