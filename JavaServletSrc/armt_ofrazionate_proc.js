...
SPBOUILib.SetInputValue('NXYGHZZLCG',function(){return WtH(w_DATAREG,'D',8,0,TranslatePicture(GetDatePicture(true,'D'),'D'))},w_DATAREG);
...
SetDisplay('KURTXQHCYE_DIV',IsHiddenByStateDriver('Rettifiche'));
...
SetDisplay('VTDYLKLZYX',Ne(w_STATOREG,'3'));
...
SetDisplay('CHLTBGCVDY',Ne(w_STATOREG,'3'));
...
SetDisplay('OZFWYFQQTV',Ne(w_STATOREG,'3'));
...
SetDisplay('LUESWSIYXN',Ne(w_STATOREG,'3'));
...
HideUI.lblids["DATAREG"]=['KZBMHOFWYD'];
...
if (Ne(_tracker.ctrl,Ctrl('WAAXEDMKXA'))) {
if ( ! (IsMobile() && LibJavascript.HTML5Tests && LibJavascript.HTML5Tests.InputTypes && LibJavascript.HTML5Tests.InputTypes.date)) {
...
function NXYGHZZLCG_Valid(e) {
var dateisok = false;
if (Eq(m_oEnteredInDate,Ctrl('NXYGHZZLCG'))) {
if ( ! (IsMobile() && LibJavascript.HTML5Tests && LibJavascript.HTML5Tests.InputTypes && LibJavascript.HTML5Tests.InputTypes.date)) {
Ctrl('NXYGHZZLCG').value=ApplyPictureToDate(Ctrl('NXYGHZZLCG').value,TranslatePicture(datePattern),'NXYGHZZLCG');
} else if (IsMobile() && LibJavascript.HTML5Tests && LibJavascript.HTML5Tests.InputTypes && LibJavascript.HTML5Tests.InputTypes.date) {
CheckDateValidity(Ctrl('NXYGHZZLCG'));
}
m_oEnteredInDate=null;
dateisok=lastDateIsOk;
if ( ! (dateisok)) {
m_nLastError=-2;
if (IsMobile()) {
m_oEnteredInDate=Ctrl('NXYGHZZLCG');
}
}
}
SetActiveField(Ctrl('NXYGHZZLCG'),false);
if (Eq(m_cFunction,'query')) {
DoQuery('DATAREG','D',w_DATAREG,HtW(Ctrl('NXYGHZZLCG').value,'D'));
} else {
e=(Ne(e,null)?e:window.event);
var l_bSetResult;
l_bSetResult=Set_DATAREG(HtW(Ctrl('NXYGHZZLCG').value,'D'),null,e) && dateisok;
return l_bSetResult;
}
}
function NXYGHZZLCG_OnFocus(e) {
if (Ne(m_cFunction,'query') &&  ! (CheckZone('NXYGHZZLCG'))) {
DisplayErrorMessage();
}
if (Ne(_tracker.ctrl,Ctrl('NXYGHZZLCG'))) {
if ( ! (IsMobile() && LibJavascript.HTML5Tests && LibJavascript.HTML5Tests.InputTypes && LibJavascript.HTML5Tests.InputTypes.date)) {
SPBOUILib.WtH('NXYGHZZLCG',w_DATAREG,'D',8,0,TranslatePicture(GetDatePicture(false,'D'),'D'));
}
}
m_oEnteredInDate=Ctrl('NXYGHZZLCG');
SetActiveField(Ctrl('NXYGHZZLCG'),true);
SetLastFocusedOnParent();
SPSelectCtrl(Ctrl('NXYGHZZLCG'),e);
}
...
_modifyandopen(ToResource('jsp/pg_linkfraz_portlet.jsp'+'?w_CONNES='+URLenc(w_CONNESCLI)+'&ragsoc='+URLenc(w_xragsocper)+'&w_RAPPORTO='+URLenc(w_RAPPORTO)+'&descrap='+URLenc(w_xdescrap)+'&w_IDOPER='+URLenc(w_IDBASE)+'&tipope='+URLenc('2')+'&w_CONNESOPER='+URLenc(w_CONNESOPER)+'&w_CONNESBEN='+URLenc(w_CONNESBEN)+'&ragsocope='+URLenc(w_xragsocct)+'&ragsocben='+URLenc(w_xragsocben)+'&m_cParameterSequence=w_CONNES,ragsoc,w_RAPPORTO,descrap,w_IDOPER,tipope,w_CONNESOPER,w_CONNESBEN,ragsocope,ragsocben')+'&m_cAtExit=close&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes,height=540,width=750',null)
}
...
linkpc_url.u('BOAFVDQFRN',function(){return 'ardt_clientifrz?m_bInnerChild=true'+GetLinkPCKeys('ardt_clientifrz')+'&m_bRowsChild='+EnableChild('ardt_clientifrz')})
linkpc_url.u('VTDYLKLZYX',function(){return 'ardt_mlientifrz?m_bInnerChild=true'+GetLinkPCKeys('ardt_mlientifrz')+'&m_bRowsChild='+EnableChild('ardt_mlientifrz')})
linkpc_url.u('TQDGESLQVD',function(){return 'ardt_sogopefraz?m_bInnerChild=true'+GetLinkPCKeys('ardt_sogopefraz')+'&m_bRowsChild='+EnableChild('ardt_sogopefraz')})
linkpc_url.u('CHLTBGCVDY',function(){return 'ardt_mogopefbo?m_bInnerChild=true'+GetLinkPCKeys('ardt_mogopefbo')+'&m_bRowsChild='+EnableChild('ardt_mogopefbo')})
linkpc_url.u('OZFWYFQQTV',function(){return 'ardt_meneficfrz?m_bInnerChild=true'+GetLinkPCKeys('ardt_meneficfrz')+'&m_bRowsChild='+EnableChild('ardt_meneficfrz')})
linkpc_url.u('OCTDIOXFMI',function(){return 'ardt_beneficfrz?m_bInnerChild=true'+GetLinkPCKeys('ardt_beneficfrz')+'&m_bRowsChild='+EnableChild('ardt_beneficfrz')})
linkpc_url.u('NOKYMTFBFL',function(){return 'ardt_terzistifrz?m_bInnerChild=true'+GetLinkPCKeys('ardt_terzistifrz')+'&m_bRowsChild='+EnableChild('ardt_terzistifrz')})
linkpc_url.u('LUESWSIYXN',function(){return 'ardt_merzistifrz?m_bInnerChild=true'+GetLinkPCKeys('ardt_merzistifrz')+'&m_bRowsChild='+EnableChild('ardt_merzistifrz')})
...
linkpc_url.u('RZOXJTRIYP',function(){return 'armt_fraziobo_agg?m_bInnerChild=true'+GetLinkPCKeys('armt_fraziobo_agg')+'&m_bRowsChild='+EnableChild('armt_fraziobo_agg')})
linkpc_url.u('QMSPZAQYXJ',function(){return 'ardt_frz_contante?m_bInnerChild=true'+GetLinkPCKeys('ardt_frz_contante')+'&m_bRowsChild='+EnableChild('ardt_frz_contante')})
_ResetTracker();
...
function NXYGHZZLCG_wrap_Valid(event) {
return NXYGHZZLCG_Valid(event);
}
SPBOUILib.SetInputExit('NXYGHZZLCG',NXYGHZZLCG_wrap_Valid);
function NXYGHZZLCG_wrap_OnFocus(event) {
return NXYGHZZLCG_OnFocus(event);
}
SPBOUILib.SetInputEnter('NXYGHZZLCG',NXYGHZZLCG_wrap_OnFocus);
function NXYGHZZLCG_wrap_OnKeyPress(event) {
return CheckDateChar(event);
}
SPBOUILib.SetInputKeyPress('NXYGHZZLCG',NXYGHZZLCG_wrap_OnKeyPress);
function NXYGHZZLCG_wrap_OnKeyDown(event) {
return ManageKeys(event,Eq(window.m_cFunction,'query'),false,false,true);
}
SPBOUILib.SetInputKeyDown('NXYGHZZLCG',NXYGHZZLCG_wrap_OnKeyDown);
...
function Help() {
windowOpenForeground('../doc/armt_ofrazionate_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
function SetModified_ardt_clientifrz() {
SetModified();
}
function SetModified_ardt_mlientifrz() {
SetModified();
}
function SetModified_ardt_sogopefraz() {
SetModified();
}
function SetModified_ardt_mogopefbo() {
SetModified();
}
function SetModified_ardt_meneficfrz() {
SetModified();
}
function SetModified_ardt_beneficfrz() {
SetModified();
}
function SetModified_ardt_terzistifrz() {
SetModified();
}
function SetModified_ardt_merzistifrz() {
SetModified();
}
function SetModified_ardt_docfrabo() {
SetModified();
}
function SetModified_armt_fraziobo_agg() {
SetModified();
}
function SetModified_ardt_frz_contante() {
SetModified();
}
...
if (Eq(page,'page_2')) {
if (ChildToLoad('VTDYLKLZYX')) {
LoadContext.lc(1,'VTDYLKLZYX');
} else {
LibJavascript.RefreshChildGrid('VTDYLKLZYX');
}
}
if (Eq(page,'page_2')) {
...
if (Eq(page,'page_2')) {
if (ChildToLoad('CHLTBGCVDY')) {
LoadContext.lc(1,'CHLTBGCVDY');
} else {
LibJavascript.RefreshChildGrid('CHLTBGCVDY');
}
}
if (Eq(page,'page_3')) {
if (ChildToLoad('OZFWYFQQTV')) {
LoadContext.lc(1,'OZFWYFQQTV');
} else {
LibJavascript.RefreshChildGrid('OZFWYFQQTV');
}
}
if (Eq(page,'page_3')) {
...
if (Eq(page,'page_3')) {
if (ChildToLoad('LUESWSIYXN')) {
LoadContext.lc(1,'LUESWSIYXN');
} else {
LibJavascript.RefreshChildGrid('LUESWSIYXN');
}
}
if (Eq(page,'page_5')) {
...
GetLayerID.Layers.push({"id":"KURTXQHCYE","name":"Rettifiche"});
...
m_cWv_ardt_clientifrz=a[165];
m_cWv_ardt_mlientifrz=a[166];
m_cWv_ardt_sogopefraz=a[167];
m_cWv_ardt_mogopefbo=a[168];
m_cWv_ardt_meneficfrz=a[169];
m_cWv_ardt_beneficfrz=a[170];
m_cWv_ardt_terzistifrz=a[171];
m_cWv_ardt_merzistifrz=a[172];
m_cWv_ardt_docfrabo=a[173];
m_cWv_armt_fraziobo_agg=a[174];
m_cWv_ardt_frz_contante=a[175];
if (Gt(a.length,176)) {
m_cErrorInChild='';
}
if (Gt(a.length,176)) {
...
return 'fraziobo'+'\\'+CPLib.ToCPStr(w_IDBASE);
}
GetLinkPCKeys.set_o('ardt_clientifrz',false);
GetLinkPCKeys.set_o('ardt_mlientifrz',false);
GetLinkPCKeys.set_o('ardt_sogopefraz',false);
GetLinkPCKeys.set_o('ardt_mogopefbo',false);
GetLinkPCKeys.set_o('ardt_meneficfrz',false);
GetLinkPCKeys.set_o('ardt_beneficfrz',false);
GetLinkPCKeys.set_o('ardt_terzistifrz',false);
GetLinkPCKeys.set_o('ardt_merzistifrz',false);
GetLinkPCKeys.set_o('ardt_docfrabo',false);
GetLinkPCKeys.set_o('armt_fraziobo_agg',false);
GetLinkPCKeys.set_o('ardt_frz_contante',false);
GetLinkPCKeys.o['ardt_clientifrz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_mlientifrz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_sogopefraz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_mogopefbo']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_meneficfrz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_beneficfrz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_terzistifrz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_merzistifrz']['IDFILEBO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
...
GetLinkPCKeys.o['armt_fraziobo_agg']['IDBASE']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
GetLinkPCKeys.o['ardt_frz_contante']['IDOPE']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_IDBASE,'C');
}
}
resizeChildIframe.children['ardt_clientifrz']=true;
resizeChildIframe.children['ardt_mlientifrz']=true;
resizeChildIframe.children['ardt_sogopefraz']=true;
resizeChildIframe.children['ardt_mogopefbo']=true;
resizeChildIframe.children['ardt_meneficfrz']=true;
resizeChildIframe.children['ardt_beneficfrz']=true;
resizeChildIframe.children['ardt_terzistifrz']=true;
resizeChildIframe.children['ardt_merzistifrz']=true;
resizeChildIframe.children['ardt_docfrabo']=true;
resizeChildIframe.children['armt_fraziobo_agg']=true;
...
LoadContext.f('BOAFVDQFRN',function(){return FrameRef('ardt_clientifrz')},1,'ardt_clientifrz',0,2)
LoadContext.f('VTDYLKLZYX',function(){return FrameRef('ardt_mlientifrz')},1,'ardt_mlientifrz',0,2)
LoadContext.f('TQDGESLQVD',function(){return FrameRef('ardt_sogopefraz')},1,'ardt_sogopefraz',0,2)
LoadContext.f('CHLTBGCVDY',function(){return FrameRef('ardt_mogopefbo')},1,'ardt_mogopefbo',0,2)
LoadContext.f('OZFWYFQQTV',function(){return FrameRef('ardt_meneficfrz')},1,'ardt_meneficfrz',0,3)
LoadContext.f('OCTDIOXFMI',function(){return FrameRef('ardt_beneficfrz')},1,'ardt_beneficfrz',0,3)
LoadContext.f('NOKYMTFBFL',function(){return FrameRef('ardt_terzistifrz')},1,'ardt_terzistifrz',0,3)
LoadContext.f('LUESWSIYXN',function(){return FrameRef('ardt_merzistifrz')},1,'ardt_merzistifrz',0,3)
LoadContext.f('OQWMEPQQNM',function(){return FrameRef('ardt_docfrabo')},1,'ardt_docfrabo',0,5)
LoadContext.f('RZOXJTRIYP',function(){return FrameRef('armt_fraziobo_agg')},1,'armt_fraziobo_agg',0,6)
LoadContext.f('QMSPZAQYXJ',function(){return FrameRef('ardt_frz_contante')},1,'ardt_frz_contante',0,7)
GetSelectedChildPage.child={'ardt_clientifrz': function(){return FrameRef('ardt_clientifrz')}, 'ardt_mlientifrz': function(){return FrameRef('ardt_mlientifrz')}, 'ardt_sogopefraz': function(){return FrameRef('ardt_sogopefraz')}, 'ardt_mogopefbo': function(){return FrameRef('ardt_mogopefbo')}, 'ardt_meneficfrz': function(){return FrameRef('ardt_meneficfrz')}, 'ardt_beneficfrz': function(){return FrameRef('ardt_beneficfrz')}, 'ardt_terzistifrz': function(){return FrameRef('ardt_terzistifrz')}, 'ardt_merzistifrz': function(){return FrameRef('ardt_merzistifrz')}, 'ardt_docfrabo': function(){return FrameRef('ardt_docfrabo')}, 'armt_fraziobo_agg': function(){return FrameRef('armt_fraziobo_agg')}, 'ardt_frz_contante': function(){return FrameRef('ardt_frz_contante')}}
function GetSelectedPage(p_d) {
p_d.setValue('armt_ofrazionate',m_cSelectedPage);
...
_Obli('DATAOPE',2,'WAAXEDMKXA',true,"829201110",null,"12128708791")
...
_Obli('DATAREG',2,'NXYGHZZLCG',true,"1028598955",null,"12128708791")
...
_Obli('PROV2',0,'HWGWORUQJF',true,"11135066302",null,null,function() { return Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') && w_CALCOLI })
_Obli('CONNESDOC',0,'EOXCZYYEBY',false,"711282992")
_Obli('CONNESDOC',0,'NWEMAAVMTA',false,"339694596")
_Obli('DESC2',0,'KDONRVZYMP',true,"10166248752",null,null,function() { return Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') && w_CALCOLI })
...
_Obli('TIPOINT2',0,'OBBUSHLGFO',true,"11628231202",null,null,function() { return Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && w_CALCOLI })
_Obli('CODINT2',0,'OGZBJVOVLN',false,"10455298077")
_Obli('DESCINTER',0,'TYCTKKPTQQ',true,"1663847307",null,null,function() { return Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Empty(w_CODINT2) && Eq(w_gVerSim,'N') && w_CALCOLI })
_Obli('DESCINTER',0,'MXCRVGEBAO',false)
_Obli('PAESE',0,'MUTRCJYNJT',true,"1108605666",'MUTRCJYNJT',null,function() { return Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && w_CALCOLI })
_Obli('C_RAPPORTO',0,'YBNJCVPDUM',false)
_Obli('CODCAB2',0,'CRVLITCYRD',true,"12135010165",'CRVLITCYRD',null,function() { return Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') && w_CALCOLI })
