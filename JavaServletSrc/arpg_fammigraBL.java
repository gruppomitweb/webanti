...
public class arpg_fammigraBL extends arpg_fammigraWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fammigra";
  ...
  public static final String i_StateStructure = "{'nomefile':nomefile,'dadata':dadata,'a_data':a_data,'flgwrt':flgwrt}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'gAzienda':gAzienda,'gDescAzi':gDescAzi,'dadata':dadata,'a_data':a_data,'gFlgIPMT':gFlgIPMT,'flgwrt':flgwrt}";
  public static final String i_ItemSequence = "nomefile,dadata,a_data,flgwrt";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"nomefile","","C","100","0","variabile","nokey","false","false"},new String[]{"dadata","Da data operazione","D","8","0","variabile","nokey","false","false"},new String[]{"a_data","Da data operazione","D","8","0","variabile","nokey","false","false"},new String[]{"flgwrt","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_fammigraBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_gFlgIPMT = m_Ctx.GetGlobalString("gFlgIPMT");
    w_flgwrt = "M";
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  public boolean Set_flgwrt(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fammigra","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_gFlgIPMT = CPLib.GetProperty(p,"gFlgIPMT",w_gFlgIPMT,0);
      w_flgwrt = CPLib.GetProperty(p,"flgwrt",w_flgwrt,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
