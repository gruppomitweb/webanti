...
public class arpg_xperazboBL extends arpg_xperazboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_xperazbo";
  ...
  public arpg_xperazboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_xperazbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
