...
public class arpg_viewinfoprvBL extends arpg_viewinfoprvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_viewinfoprv";
  ...
  public arpg_viewinfoprvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_viewinfoprv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
