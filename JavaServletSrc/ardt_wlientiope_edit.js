...
if ( ! (m_oFather.SaveContext_ardt_wlientiope())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_wlientiope_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_wlientiope_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_wlientiope();
}
}
SaveContext.child=[];
function BlankRow() {
