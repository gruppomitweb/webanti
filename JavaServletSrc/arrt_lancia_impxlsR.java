...
// * --- Fine Area Manuale
public class arrt_lancia_impxlsR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_impxlsR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_impxls",m_Caller);
  ...
  public static arrt_lancia_impxlsR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_impxlsR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
