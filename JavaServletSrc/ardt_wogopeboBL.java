...
public class ardt_wogopeboBL extends ardt_wogopeboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_wogopebo";
  ...
  public CPPhTableWrInfo m_oWrInfo_sogopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_sogopebo;
  ...
  public static String[] m_EntityTables = {"sogopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_wogopebo",true,true)+"}"+FoundlingChildrenList("ardt_wogopebo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescriz':xdescriz"+FoundlingChildrenList("ardt_wogopebo",true,true)+"}"+FoundlingChildrenList("ardt_wogopebo",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_wogopebo",false,true)+"]"+FoundlingChildrenList("ardt_wogopebo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_wogopebo"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_wogopeboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_sogopebo = p_ContextObject.GetPhName("sogopebo",p_ContextObject.GetCompany(),false);
    m_cServer_sogopebo = p_ContextObject.GetServer("sogopebo");
    m_oWrInfo_sogopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"sogopebo",p_ContextObject.GetCompany());
    m_cVirtName_sogopebo = CPSql.ManipulateTablePhName("sogopebo",m_cServer_sogopebo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_wogopebo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_wogopebo","sogopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_wogopebo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_wogopebo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_wogopebo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_wogopebo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_wogopebo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_wogopebo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "sogopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "sogopebo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
