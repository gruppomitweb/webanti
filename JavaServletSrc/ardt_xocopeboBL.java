...
public class ardt_xocopeboBL extends ardt_xocopeboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xocopebo";
  ...
  public CPPhTableWrInfo m_oWrInfo_xocopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xocopebo;
  ...
  public ardt_xocopeboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xocopebo = p_ContextObject.GetPhName("xocopebo",p_ContextObject.GetCompany(),false);
    m_cServer_xocopebo = p_ContextObject.GetServer("xocopebo");
    m_oWrInfo_xocopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xocopebo",p_ContextObject.GetCompany());
    m_cVirtName_xocopebo = CPSql.ManipulateTablePhName("xocopebo",m_cServer_xocopebo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xocopebo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xocopebo","xocopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xocopebo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xocopebo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xocopebo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xocopebo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xocopebo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xocopebo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xocopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("NUMPROG","C",11,0));
  }
  public String RowPrimaryKey() {
    return "xocopebo"+"\\"+CPLib.ToCPStr(w_CONNESCLI);
  }
