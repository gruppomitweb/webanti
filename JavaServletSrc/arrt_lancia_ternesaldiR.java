...
// * --- Fine Area Manuale
public class arrt_lancia_ternesaldiR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_ternesaldiR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_ternesaldi",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_terne_saldi */
    Forward f;
    f=new Forward("arpg_terne_saldi",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_ternesaldiR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_ternesaldiR(p_Ctx, p_Caller);
  }
  public void Blank() {
