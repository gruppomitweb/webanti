...
SetLocationHref(null,'arrt_all_opextrbo'+'?m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
function Help() {
windowOpenForeground('../doc/arpg_all_opextrbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_all_opextrbo',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["DaDatOpe","ADatOpe","c_dadata","c_adata"];
