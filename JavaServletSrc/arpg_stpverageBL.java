...
public class arpg_stpverageBL extends arpg_stpverageWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpverage";
  ...
  public arpg_stpverageBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpverage","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
