...
public class arpg_intestit_selBL extends arpg_intestit_selWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_CODINTER;
    public String c_DESCINTER;
  ...
  public static final String i_EntityName = "arpg_intestit_sel";
  ...
  public arpg_intestit_selBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_intestit_sel","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_DESCINTER=c_DESCINTER;
  ...
  public void TrsToWork() {
    ...
    c_DESCINTER= m_oTrs.get(m_nCurrentRow).c_DESCINTER;
