...
public class ardt_jntestitBL extends ardt_jntestitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_jntestit";
  ...
  public CPPhTableWrInfo m_oWrInfo_jntestit;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_jntestit;
  ...
  public static String[] m_EntityTables = {"jntestit"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CODCLI':CODCLI,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'DESCINTER':DESCINTER,'PRGIMPTITE':PRGIMPTITE,'IDBASE':IDBASE"+FoundlingChildrenList("ardt_jntestit",true,true)+"}"+FoundlingChildrenList("ardt_jntestit",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'tipreg':tipreg,'CODCLI':CODCLI,'gAzienda':gAzienda,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'DESCINTER':DESCINTER,'TIPOPERS':TIPOPERS,'xragsoci':xragsoci,'tiporegr':tiporegr,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PRGIMPTITE':PRGIMPTITE,'STATOREG':STATOREG,'IDEREG':IDEREG,'TIPORAP':TIPORAP,'NUMPROG1':NUMPROG1,'NUMPROG2':NUMPROG2,'IDBASE':IDBASE"+FoundlingChildrenList("ardt_jntestit",true,true)+"}"+FoundlingChildrenList("ardt_jntestit",true,false)+"}";
  public static final String i_ItemSequence = "CODCLI,m_Detail[ CODINTER DATAINI DATAFINE DESCINTER PRGIMPTITE IDBASE"+FoundlingChildrenList("ardt_jntestit",false,true)+"]"+FoundlingChildrenList("ardt_jntestit",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_jntestit"),new String[][]{new String[]{"CODCLI","","C","16","0","campo","key1","false","false"},new String[]{"CODINTER","Intestatario (Non Intermediario)","C","16","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"},new String[]{"DESCINTER","","C","70","0","campo","key2","true","false"},new String[]{"PRGIMPTITE","","N","15","0","campo","key3","true","false"},new String[]{"IDBASE","idbase","C","10","0","campo","nokey","true","false"}});
  ...
  public ardt_jntestitBL (CPContext p_ContextObject) {
    ...
    m_cPhName_jntestit = p_ContextObject.GetPhName("jntestit",p_ContextObject.GetCompany(),false);
    m_cServer_jntestit = p_ContextObject.GetServer("jntestit");
    m_oWrInfo_jntestit = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"jntestit",p_ContextObject.GetCompany());
    m_cVirtName_jntestit = CPSql.ManipulateTablePhName("jntestit",m_cServer_jntestit);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_jntestit",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean getWritable_DATAINI() {
    return CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"50") || CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"52") || CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"58");
  }
  public boolean getWritable_DATAFINE() {
    return CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"51") || CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"53");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_jntestit","jntestit",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_jntestit",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_jntestit",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_jntestit",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_jntestit",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_jntestit"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_jntestit\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "jntestit"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CODCLI","C",16,0));
  }
  public String RowPrimaryKey() {
    return "jntestit"+"\\"+CPLib.ToCPStr(w_CODINTER);
  }
