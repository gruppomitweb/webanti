...
public class ardt_destwarnBL extends ardt_destwarnWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_destwarn";
  ...
  public static final String i_StateStructure = "{'DWCODINT':DWCODINT,'m_Detail':{'DWNOMINATIVO':DWNOMINATIVO,'DWEMAIL':DWEMAIL,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("ardt_destwarn",true,true)+"}"+FoundlingChildrenList("ardt_destwarn",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'DWCODINT':DWCODINT,'m_Detail':{'DWNOMINATIVO':DWNOMINATIVO,'DWEMAIL':DWEMAIL,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("ardt_destwarn",true,true)+"}"+FoundlingChildrenList("ardt_destwarn",true,false)+"}";
  public static final String i_ItemSequence = "DWCODINT,m_Detail[ DWNOMINATIVO DWEMAIL CPROWNUM"+FoundlingChildrenList("ardt_destwarn",false,true)+"]"+FoundlingChildrenList("ardt_destwarn",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_destwarn"),new String[][]{new String[]{"DWCODINT","Codice Intermediario","C","11","0","campo","key1","false","false"},new String[]{"DWNOMINATIVO","Nominativo","C","50","0","campo","nokey","true","false"},new String[]{"DWEMAIL","Email Destinatari","C","50","0","campo","nokey","true","false"},new String[]{"CPROWNUM","","N","3","0","campo","key1","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_destwarnBL (CPContext p_ContextObject) {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_destwarn",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_destwarn","destwarn",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_destwarn",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_destwarn",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_destwarn",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_destwarn",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_destwarn"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_destwarn\\"+p_cState};
    }
    return l_Keys;
  }
