...
m_oFather.i_last_focused_item='child_ardt_docopebo';
...
function Help() {
windowOpenForeground('../doc/ardt_docopebo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'docopebo'+'\\'+CPLib.ToCPStr(w_NUMPROG);
}
...
p_d.setValue('ardt_docopebo',m_cSelectedPage);
