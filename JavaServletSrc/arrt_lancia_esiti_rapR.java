...
// * --- Fine Area Manuale
public class arrt_lancia_esiti_rapR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_esiti_rapR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_esiti_rap",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if ( ! (m_Ctx.IsSharedTemp("tmp_esiti_age"))) {
      m_cServer = m_Ctx.GetServer("tmp_esiti_age");
      m_Sql.SrvQuery(m_cServer,"* ","from "+m_Ctx.PhNameAdapter(m_Sql.ManipulateTablePhName("tmp_esiti_age",m_cServer,"proto")),m_cPhName,"tmp_esiti_age",m_Ctx);
    }
    ...
    /* Stop arpg_esito_rap */
    Forward f;
    f=new Forward("arpg_esito_rap",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_esiti_rapR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_esiti_rapR(p_Ctx, p_Caller);
  }
  public void Blank() {
