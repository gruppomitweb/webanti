...
SPBOUILib.SetInputValue('KMRTAJNGKT',function(){return WtH(w_datamodi,'D',8,0,TranslatePicture(GetDatePicture(true,'D'),'D'))},w_datamodi);
...
var h;
h=Ge(w_gTipInter,'30') && Le(w_gTipInter,'41') || IsHiddenByStateDriver(Z.Tabs.Get('tabs').GetTabstripID('page_3'));
...
Z.Tabs.Get("tabs_2_Altri").Hide('AYKUXGKLPO',IsHiddenByStateDriver('DatiAgg'));
Z.Tabs.Get("tabs_2_Altri").Hide('ZETZWJBOFM',IsHiddenByStateDriver('Dipendenza'));
Z.Tabs.Get("tabs_2_Altri").Hide('XDDGTPJDHN',IsHiddenByStateDriver('SogCollegati'));
...
Z.Tabs.Get("tabs_4_Rischio").Hide('WJVOGIFRCK',IsHiddenByStateDriver('ValRisk'));
Z.Tabs.Get("tabs_4_Rischio").Hide('XTDFJTMZAQ',IsHiddenByStateDriver('MitRisk'));
Z.Tabs.Get("tabs_4_Rischio").Hide('TKKVDEVHBF',IsHiddenByStateDriver('Patrimonio'));
Z.Tabs.Get("tabs_4_Rischio").Hide('STJESIOURE',IsHiddenByStateDriver('Reddito'));
...
HideUI.lblids["datamodi"]=['UCXGHMUVCO'];
...
if (Eq(m_cFunction,'query')) {
DoQuery('CONNES','C',w_CONNES,HtW(Ctrl('YTPWDRMFUS').value,'C'));
} else {
e=(Ne(e,null)?e:window.event);
var l_bSetResult;
...
linkpc_url.u('OIREAEXNKZ',function(){return 'armt_wersonbo_agg?m_bInnerChild=true'+GetLinkPCKeys('armt_wersonbo_agg')+'&m_bRowsChild='+EnableChild('armt_wersonbo_agg')})
...
w_Frazionate_AUI.raiseEvent('armt_wersonbo_'+Strtran(p_cEvent,' ','_'));
}
}
...
FocusFirstComponent.edit={"page_1":["UYWIEUHCAL"],"page_2":["DQZNJUSTLN"],"page_3":["RKHMYOIJDM"],"page_4":["NXVXQSLAGM"]};
FocusFirstComponent.query={"page_1":["UYWIEUHCAL"],"page_2":["DQZNJUSTLN"],"page_3":["RKHMYOIJDM"],"page_4":["NXVXQSLAGM"]};
FocusFirstComponent.otherwise={"page_1":["UYWIEUHCAL"],"page_2":["DQZNJUSTLN"],"page_3":["RKHMYOIJDM"],"page_4":["NXVXQSLAGM"]};
function Help() {
windowOpenForeground('../doc/armt_wersonbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
function SetModified_armt_wersonbo_agg() {
SetModified();
}
...
w_FLGALTO=a[149];;
op_codazi=a[150];
m_cWv_ardt_personbo_dip=a[151];
m_cWv_armt_wersonbo_agg=a[152];
m_cWv_ardt_soggope=a[153];
m_cWv_ardt_fatca_ind=a[154];
m_cWv_ardt_patrimonio=a[155];
m_cWv_ardt_reddito=a[156];
if (Gt(a.length,157)) {
m_cErrorInChild='';
}
if (Gt(a.length,157)) {
...
return 'wersonbo'+'\\'+CPLib.ToCPStr(w_sanumpro);
}
GetLinkPCKeys.set_o('ardt_personbo_dip',false);
GetLinkPCKeys.set_o('armt_wersonbo_agg',false);
...
GetLinkPCKeys.o['armt_wersonbo_agg']['CONNES']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_CONNES,'C');
}
}
...
resizeChildIframe.children['armt_wersonbo_agg']=true;
...
LoadContext.f('BKKASVQSWO',function(){return FrameRef('ardt_personbo_dip')},1,'ardt_personbo_dip',0,2)
LoadContext.f('OIREAEXNKZ',function(){return FrameRef('armt_wersonbo_agg')},1,'armt_wersonbo_agg',0,2)
LoadContext.f('RYYOFFRITV',function(){return FrameRef('ardt_soggope')},1,'ardt_soggope',0,2)
LoadContext.f('FBAHOFZNEF',function(){return FrameRef('ardt_fatca_ind')},1,'ardt_fatca_ind',0,3)
LoadContext.f('FFIYUAKUTX',function(){return FrameRef('ardt_patrimonio')},1,'ardt_patrimonio',0,4)
LoadContext.f('COWMRLCMMU',function(){return FrameRef('ardt_reddito')},1,'ardt_reddito',0,4)
GetSelectedChildPage.child={'ardt_personbo_dip': function(){return FrameRef('ardt_personbo_dip')}, 'armt_wersonbo_agg': function(){return FrameRef('armt_wersonbo_agg')}, 'ardt_soggope': function(){return FrameRef('ardt_soggope')}, 'ardt_fatca_ind': function(){return FrameRef('ardt_fatca_ind')}, 'ardt_patrimonio': function(){return FrameRef('ardt_patrimonio')}, 'ardt_reddito': function(){return FrameRef('ardt_reddito')}}
function GetSelectedPage(p_d) {
p_d.setValue('armt_wersonbo',m_cSelectedPage);
