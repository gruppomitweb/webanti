...
m_oFather.i_last_focused_item='child_ardt_xeneficope';
...
function Help() {
windowOpenForeground('../doc/ardt_xeneficope_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'xeneficope'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_xeneficope',m_cSelectedPage);
...
_Obli('C_RAG',0,'GAEWMPRBSY',false,"10662833211")
