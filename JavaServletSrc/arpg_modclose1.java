...
public class arpg_modclose1 extends SPDialogServlet implements SPInvokable {
  public static String m_cEntityUid = "!*XPFPMOBLHP*!";
  ...
  public String getEntityTitle() {
    return "Aggiorna la data di chiusura del rapporto";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "arpg_modclose1";
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,arpg_modclose1BO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    l_translations=new String[][]{{"11262499997",p_Context.Translate("Aggiorna la data di chiusura del rapporto")},
    {"382511098",p_Context.Translate("Esegui aggiornamento dati")}};
    return l_translations;
  }
  void WriteStyles(arpg_modclose1BO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='SPPrxy/"+m_cEntityUid+"/arpg_modclose1.css'>" +
      "");
    }
  ...
  void WriteMainForm(arpg_modclose1BO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls(arpg_modclose1BO BO,ServletStatus status) {
    WriteControls_p1(BO,status);
    PrintNotifyContent(status,getNotifyItems());
  }
  void WriteControls_p1(arpg_modclose1BO BO,ServletStatus status) {
    status.themeWriter.Header_BeginHtml(70);
    WriteControls_1_h_0(BO,status);
  }
  void WriteControls_1_h_0(arpg_modclose1BO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println(
     ...
     "<label id='NRLLUEOMLT'>" +
     ""+SPLib.ToHTMLRepresentation(status.context.Translate("Data Precedente:"))+"" +
     "</label>" +
     "</span>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<a href='javascript:href_MDWFLPZWFN()' tabindex='-1' id='MDWFLPZWFN_HREF'>" +
  ...
  static void PrintState(arpg_modclose1BL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(arpg_modclose1BL BO,ServletStatus status) {
  }
  static void PrintStateWorkVars(arpg_modclose1BL BO,ServletStatus status) {
  ...
  void WriteMainFormVarScript(arpg_modclose1BO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"arpg_modclose1"),"C",0,0)+ ";");
    ...
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"arpg_modclose1","");
    ...
    status.out.println("// * --- arpg_modclose1");
  ...
  void WriteMainFormScript(arpg_modclose1BO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
  ...
  arpg_modclose1BO getBO(ServletStatus status) {
    arpg_modclose1BO BO = new arpg_modclose1BO(status.context);
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(arpg_modclose1BO BO) {
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,arpg_modclose1BO BO) {
    super.NotifyEvent(p_cEvent,status,BO);
    CPLib.NotifyEvent(p_cEvent,BO,BO.m_Ctx,BO.specificEventsHandlers,BO.allEventsHandlers);
  }
  void Start(ServletStatus status,arpg_modclose1BO BO) {
    BO.SetFromContext(status.m_cWv);
    BO.Calculate();
  }
  void Save(ServletStatus status,arpg_modclose1BO BO) {
    boolean l_bResult;
    BO.SetFromContext(status.m_cWv);
    l_bResult = BO.Save();
    if (l_bResult) {
  ...
  void Discard(ServletStatus status,arpg_modclose1BO BO) {
    status.m_bExit = true;
  }
  void CreatePortlet(ServletStatus status,arpg_modclose1BO BO) {
    ...
    item.put("altInterfaceFor","arpg_modclose1");
    items.put(item);
    String s;
    org.json.JSONObject ctrl = null;
    s = "{\"bg_color\":\"transparent\",\"box_type\":\"\",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"63\",\"name\":\"Box_ODCPZZXLHY\",\"page\":\"1\",\"shrinkable\":\"true\",\"spuid\":\"ODCPZZXLHY\",\"tabindex\":\"1\",\"type\":\"Box\",\"w\":\"664\",\"x\":\"8\",\"y\":\"7\",\"zone\":\"pag1_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Data_Rettifica_\",\"page\":\"1\",\"spuid\":\"XQSJGZVMDV_DIV\",\"tabindex\":\"2\",\"type\":\"Label\",\"value\":\"Data Rettifica:\",\"w\":\"81\",\"x\":\"51\",\"y\":\"18\",\"zone\":\"ODCPZZXLHY_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"datarett\",\"page\":\"1\",\"spuid\":\"JIYGZCDTPQ\",\"tabindex\":\"3\",\"type\":\"Textbox\",\"w\":\"78\",\"x\":\"136\",\"y\":\"14\",\"zone\":\"ODCPZZXLHY_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"olddata\",\"page\":\"1\",\"spuid\":\"QLKRKJTVJT\",\"tabindex\":\"4\",\"type\":\"Textbox\",\"w\":\"80\",\"x\":\"352\",\"y\":\"42\",\"zone\":\"ODCPZZXLHY_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Nuova_Chiusura_\",\"page\":\"1\",\"spuid\":\"OLVLBDQTYW_DIV\",\"tabindex\":\"5\",\"type\":\"Label\",\"value\":\"Nuova Chiusura:\",\"w\":\"90\",\"x\":\"42\",\"y\":\"46\",\"zone\":\"ODCPZZXLHY_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"newdate\",\"page\":\"1\",\"spuid\":\"WYJHXYCTSP\",\"tabindex\":\"6\",\"type\":\"Textbox\",\"w\":\"78\",\"x\":\"136\",\"y\":\"42\",\"zone\":\"ODCPZZXLHY_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Data_Precedente_\",\"page\":\"1\",\"spuid\":\"NRLLUEOMLT_DIV\",\"tabindex\":\"7\",\"type\":\"Label\",\"value\":\"Data Precedente:\",\"w\":\"98\",\"x\":\"250\",\"y\":\"46\",\"zone\":\"ODCPZZXLHY_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"31\",\"href\":\"javascript:href_YBBLCLWLHJ()\",\"name\":\"images_exit_gif\",\"page\":\"1\",\"spuid\":\"YBBLCLWLHJ\",\"src\":\"images\\/exit.gif\",\"tabindex\":\"8\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"625\",\"y\":\"34\",\"zone\":\"ODCPZZXLHY_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Esegui aggiornamento dati\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"31\",\"href\":\"javascript:href_MDWFLPZWFN()\",\"name\":\"images_elaborazione_gif\",\"page\":\"1\",\"spuid\":\"MDWFLPZWFN\",\"src\":\"images\\/elaborazione.gif\",\"tabindex\":\"9\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"577\",\"y\":\"34\",\"zone\":\"ODCPZZXLHY_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{}";
    ctrl = new org.json.JSONObject(s);
  ...
  void Next(ServletStatus status,arpg_modclose1BO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow+entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void Previous(ServletStatus status,arpg_modclose1BO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow-entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void WriteFormPage(arpg_modclose1BO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='arpg_modclose1?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+m_cEntityUid+"/arpg_modclose1_proc.js'>" +
     "</script>" +
    "");
    IncludeJS(status);
  ...
  void RaiseLoadedEntity(arpg_modclose1BO BO,ServletStatus status) {
    RaiseEventLoadedEntity(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cClientMode,"C",0,0)+"})","C",0,0));
  }
  void RaiseSavedEntity(arpg_modclose1BO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(arpg_modclose1BO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(arpg_modclose1BO BO,ServletStatus status) {
  ...
  void WriteExitPage(arpg_modclose1BO BO,ServletStatus status,Forward f) {
    WriteExitPage(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cMode,"C",0,0)+"})","C",0,0), f);
  }
  void WriteExitPage(arpg_modclose1BO BO,ServletStatus status) {
    WriteExitPage(BO,status,Forward.Unforwarded);
  }
  void IncludeJS(ServletStatus status) {
    String l_cJsUid;
    status.out.println(
     "<script src='SPPrxy/"+arrt_modclose1.m_cEntityUid+"/arrt_modclose1.js'>" +
     "</script>" +
    "");
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      arrt_modclose1.GetCallableNames(callable);
    } else {
  ...
  public String GetCheckVars(ServletStatus status,arpg_modclose1BO BO) {
    return "NO_VALUE";
  }
  public boolean CheckVars(ServletStatus status,arpg_modclose1BO BO) {
    boolean result = true;
    return result;
  }
}
