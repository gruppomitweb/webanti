...
if ( ! (m_oFather.SaveContext_ardt_meneficope())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_meneficope_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_meneficope_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_meneficope();
}
}
SaveContext.child=[];
function BlankRow() {
