...
// * --- Fine Area Manuale
public class armt_cgo_anadip_errBO extends armt_cgo_anadip_errBL {
  class SqlLoader {
    double m_nColumns = 0;
    CPSql m_Sql;
    String m_cServer;
  ...
  // * --- Fine Area Manuale
  public armt_cgo_anadip_errBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_cgo_anadip_err");
    }
  ...
  public static String[] m_cLoadParameterNames = {"PRGDIP"};
  public static String[] m_cDeleteParameterNames = m_cLoadParameterNames;
  public boolean Load(String p_PRGDIP) {
    CPResultSet l_rsLoad=null;
    SqlLoader l_oSqlLoader;
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_cgo_anadip_err,m_cPhName_cgo_anadip_err,m_cVirtName_cgo_anadip_err,m_cVirtName_cgo_anadip_err+".PRGDIP="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_PRGDIP,"C",15,0),m_cServer_cgo_anadip_err,p_PRGDIP),"");
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_cgo_anadip_err);
      l_cSql = "insert into "+m_oWrInfo_cgo_anadip_err.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+"PRGDIP,";
      l_cSql = l_cSql+"CODICEAAMS,";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsNameToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_cgo_anadip_err.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_anadip_err")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQLNull(w_DESCCIT,"C",30,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_DOMICILIO,"C",40,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_TELEFONO,"C",15,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_TXTERR,"M",10,0,m_cServer_cgo_anadip_err,m_oParameters)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_FLGFULL,"C",1,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_PRGDIP,"C",15,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_CODICEAAMS,"C",12,0)+", ";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsValueToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_cgo_anadip_err.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_anadip_err")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_cgo_anadip_err,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_cgo_anadip_err);
      l_cSql = "Update "+m_oWrInfo_cgo_anadip_err.GetTableWriteName()+" set";
      l_cSql = l_cSql+" CODDIP = "+CPLib.ToSQL(w_CODDIP,"C",6,0);
      l_cSql = l_cSql+", DESCRIZ = "+CPLib.ToSQL(w_DESCRIZ,"C",30,0);
      l_cSql = l_cSql+", DESCCIT = "+CPLib.ToSQLNull(w_DESCCIT,"C",30,0);
      ...
      l_cSql = l_cSql+", DOMICILIO = "+CPLib.ToSQL(w_DOMICILIO,"C",40,0);
      l_cSql = l_cSql+", TELEFONO = "+CPLib.ToSQL(w_TELEFONO,"C",15,0);
      l_cSql = l_cSql+", TXTERR = "+CPLib.ToSQL(w_TXTERR,"M",10,0,m_cServer_cgo_anadip_err,m_oParameters);
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"PRGDIP="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_PRGDIP,"C",15,0),m_cServer_cgo_anadip_err,w_PRGDIP);
      l_cSql = l_cSql+m_oWrInfo_cgo_anadip_err.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_anadip_err")) {
  ...
  public boolean Delete(String p_PRGDIP) {
    String l_cSql;
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_cgo_anadip_err.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"PRGDIP="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_PRGDIP,"C",15,0),m_cServer_cgo_anadip_err,w_PRGDIP);
          l_cSql = l_cSql+m_oWrInfo_cgo_anadip_err.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_anadip_err")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_cgo_anadip_err,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  public boolean Delete() {
    return Delete(w_PRGDIP);
  }
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    CPLib.SPLinkProperties result = CPLib.GetSPLinkerProperties();
    if (CPLib.eq(p_cID,"QGLRMYVVYR")) {
      ...
      result.m_PrgZoom = "";
      result.m_rdField = new String[]{"CITTA" , "CAB" , "PROV"};
      result.m_rdTypes = new String[]{"C" , "C" , "C"};
      result.m_kField = new String[]{};
      result.m_kTypes = new String[]{};
      result.AppendFieldsHash("QGLRMYVVYR",CPLib.GetLinkedFieldProps("CITTA","DESCCIT","C",30,0));
    }
    return result;
  }
  // * --- Area Manuale = BO - Methods
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arrt_save_cgo_anadip_err,
  public static final String i_InvokedRoutines = ",arrt_save_cgo_anadip_err,";
}
