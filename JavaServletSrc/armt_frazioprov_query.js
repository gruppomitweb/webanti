...
m_oFather.DoQueryFromChild('xraziobo',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
function DoQueryFrom_xlientifrz(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xogopefbo(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xeneficfrz(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xerzistifrz(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_docfrabo(firstAlias) {
return m_cVirtName+".NUMPROG = "+firstAlias+".NUMPROG ";
}
function DoQueryFrom_xraziobo_agg(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDBASE ";
}
function DoQueryFrom_xrz_contante(firstAlias) {
...
_chNotF(childAlias,'master','armt_frazioprov');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('xraziobo',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
