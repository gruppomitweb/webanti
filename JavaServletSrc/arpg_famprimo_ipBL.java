...
public class arpg_famprimo_ipBL extends arpg_famprimo_ipWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_famprimo_ip";
  ...
  public static final String i_StateStructure = "{'mese':mese,'flgstp':flgstp}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gDescAzi':gDescAzi,'anno':anno,'mese':mese,'dadata':dadata,'a_data':a_data,'flgnuovi':flgnuovi,'flgstp':flgstp}";
  public static final String i_ItemSequence = "mese,flgstp";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"mese","","C","2","0","variabile","nokey","false","true"},new String[]{"flgstp","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_famprimo_ipBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_famprimo_ip","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
