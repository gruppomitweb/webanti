...
public class arpg_stp_contfile_doBL extends arpg_stp_contfile_doWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_contfile_do";
  ...
  public arpg_stp_contfile_doBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_contfile_do","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
