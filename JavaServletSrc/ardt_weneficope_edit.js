...
if ( ! (m_oFather.SaveContext_ardt_weneficope())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_weneficope_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_weneficope_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_weneficope();
}
}
SaveContext.child=[];
function BlankRow() {
