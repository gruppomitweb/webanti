...
public class arpg_list_dprocsBL extends arpg_list_dprocsWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public double c_DPRPROGRE;
    public String c_DPRTXTMSG;
    public double c_DPRNUMRIG;
    public String c_DPRESITO;
  ...
  public static final String i_EntityName = "arpg_list_dprocs";
  ...
  public static final String i_CompleteStateStructure = "{'tipo':tipo,'codice':codice}";
  ...
  public arpg_list_dprocsBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_list_dprocs","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_DPRPROGRE=c_DPRPROGRE;
    m_oTrs.get(m_nCurrentRow).c_DPRTXTMSG=c_DPRTXTMSG;
    m_oTrs.get(m_nCurrentRow).c_DPRNUMRIG=c_DPRNUMRIG;
    m_oTrs.get(m_nCurrentRow).c_DPRESITO=c_DPRESITO;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_DPRPROGRE= m_oTrs.get(m_nCurrentRow).c_DPRPROGRE;
    c_DPRTXTMSG= m_oTrs.get(m_nCurrentRow).c_DPRTXTMSG;
    c_DPRNUMRIG= m_oTrs.get(m_nCurrentRow).c_DPRNUMRIG;
    c_DPRESITO= m_oTrs.get(m_nCurrentRow).c_DPRESITO;
