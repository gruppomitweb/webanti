...
public class ardt_cgo_oper_multiBL extends ardt_cgo_oper_multiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_cgo_oper_multi";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_operazioni_dl_multi_dt;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_operazioni_dl_multi_dt;
  ...
  public static String[] m_EntityTables = {"cgo_operazioni_dl_multi_dt"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'SNAINUMOPE':SNAINUMOPE,'snainumope_sel':snainumope_sel,'s_snainumope_sel':s_snainumope_sel,'m_Detail':{'DATOPE':DATOPE,'TIPOGIOCO':TIPOGIOCO,'CAIDBIGLIETTO':CAIDBIGLIETTO,'TOTLIRE':TOTLIRE,'FLGFULL':FLGFULL,'CPROWNUM':CPROWNUM,'NUMOPEDL':NUMOPEDL,'ROWNUMDL':ROWNUMDL"+FoundlingChildrenList("ardt_cgo_oper_multi",true,true)+"}"+FoundlingChildrenList("ardt_cgo_oper_multi",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'SNAINUMOPE':SNAINUMOPE,'CGOTIPOPE':CGOTIPOPE,'dc':dc,'SEGNO_P':SEGNO_P,'DATOPE_P':DATOPE_P,'snainumope_sel':snainumope_sel,'s_snainumope_sel':s_snainumope_sel,'m_Detail':{'DATOPE':DATOPE,'TIPOGIOCO':TIPOGIOCO,'CAIDBIGLIETTO':CAIDBIGLIETTO,'TOTLIRE':TOTLIRE,'FLGFULL':FLGFULL,'CPROWNUM':CPROWNUM,'NUMOPEDL':NUMOPEDL,'ROWNUMDL':ROWNUMDL,'CACODICE':CACODICE,'CODLOB':CODLOB,'CATIPGIO':CATIPGIO,'CATIPCON':CATIPCON,'impmin':impmin"+FoundlingChildrenList("ardt_cgo_oper_multi",true,true)+"},'TOTALE':TOTALE"+FoundlingChildrenList("ardt_cgo_oper_multi",true,false)+"}";
  public static final String i_ItemSequence = "SNAINUMOPE,snainumope_sel,s_snainumope_sel,m_Detail[ DATOPE TIPOGIOCO CAIDBIGLIETTO TOTLIRE FLGFULL CPROWNUM NUMOPEDL ROWNUMDL"+FoundlingChildrenList("ardt_cgo_oper_multi",false,true)+"]"+FoundlingChildrenList("ardt_cgo_oper_multi",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_cgo_oper_multi"),new String[][]{new String[]{"SNAINUMOPE","N° Operazione","C","15","0","campo","key1","false","false"},new String[]{"snainumope_sel","","C","15","0","variabile","nokey","false","false"},new String[]{"s_snainumope_sel","","C","15","0","variabile","nokey","false","false"},new String[]{"DATOPE","Data Operazione","D","8","0","campo","nokey","true","false"},new String[]{"TIPOGIOCO","Tipo gioco","C","3","0","campo","nokey","true","false"},new String[]{"CAIDBIGLIETTO","ID BIGLIETTO","C","30","0","campo","nokey","true","false"},new String[]{"TOTLIRE","Importo","N","15","2","campo","nokey","true","false"},new String[]{"FLGFULL","Operazione completa","C","1","0","campo","nokey","true","false"},new String[]{"CPROWNUM","N° Riga ","N","4","0","campo","key1","true","false"},new String[]{"NUMOPEDL","Operazione Associata","C","15","0","campo","nokey","true","false"},new String[]{"ROWNUMDL","Numero Riga Selezionata","N","4","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_cgo_oper_multiBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_operazioni_dl_multi_dt = p_ContextObject.GetPhName("cgo_operazioni_dl_multi_dt",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_operazioni_dl_multi_dt = p_ContextObject.GetServer("cgo_operazioni_dl_multi_dt");
    m_oWrInfo_cgo_operazioni_dl_multi_dt = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_operazioni_dl_multi_dt",p_ContextObject.GetCompany());
    m_cVirtName_cgo_operazioni_dl_multi_dt = CPSql.ManipulateTablePhName("cgo_operazioni_dl_multi_dt",m_cServer_cgo_operazioni_dl_multi_dt);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_oper_multi",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Set_s_snainumope_sel(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_s_snainumope_sel = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean getVisible_s_snainumope_sel() {
    return true;
  }
  ...
  public boolean getVisible_TOTALE() {
    return true;
  }
  ...
  public boolean Calculate() {
    ...
    m_bCalculating = true;
    w_SEGNO_P = Utilities.Make(m_Ctx).GetCallerString("SEGNO");
    if (CPLib.ne(o_snainumope_sel,w_snainumope_sel)) {
      Calculation_VSGHQTSIYR();
    }
    if (CPLib.ne(o_s_snainumope_sel,w_s_snainumope_sel)) {
  ...
  void Calculation_VSGHQTSIYR() {
    if ( ! (CPLib.Empty(w_snainumope_sel))) {
      arrt_aggiornamento_multiple_dcR l_oRoutine_arrt_aggiornamento_multiple_dc;
      l_oRoutine_arrt_aggiornamento_multiple_dc = arrt_aggiornamento_multiple_dcR.Make(m_Ctx,this);
      l_oRoutine_arrt_aggiornamento_multiple_dc.pObj = this;
      l_oRoutine_arrt_aggiornamento_multiple_dc.azione = "I";
      l_oRoutine_arrt_aggiornamento_multiple_dc.CAIDBIGLIETTO = "";
      l_oRoutine_arrt_aggiornamento_multiple_dc.Run();
    }
  }
  void Calculation_EAMJXOSRVO() {
    if ( ! (CPLib.Empty(w_s_snainumope_sel))) {
      arrt_aggiornamento_multiple_dcR l_oRoutine_arrt_aggiornamento_multiple_dc;
      l_oRoutine_arrt_aggiornamento_multiple_dc = arrt_aggiornamento_multiple_dcR.Make(m_Ctx,this);
      l_oRoutine_arrt_aggiornamento_multiple_dc.pObj = this;
      l_oRoutine_arrt_aggiornamento_multiple_dc.azione = "J";
      l_oRoutine_arrt_aggiornamento_multiple_dc.CAIDBIGLIETTO = "";
      l_oRoutine_arrt_aggiornamento_multiple_dc.Run();
    }
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_cgo_oper_multi","cgo_operazioni_dl_multi_dt",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_s_snainumope_sel = CPLib.GetProperty(p,"s_snainumope_sel",w_s_snainumope_sel,0);
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"s_snainumope_sel")) {
      SetUpdated();
      return;
    }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_cgo_oper_multi",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_cgo_oper_multi",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_cgo_oper_multi",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_oper_multi",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_cgo_oper_multi"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_cgo_oper_multi\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"s_snainumope_sel",w_s_snainumope_sel,0);
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_operazioni_dl_multi_dt"+"\\"+CPLib.ToCPStr(p_Caller.GetString("SNAINUMOPE","C",15,0));
  }
  public String RowPrimaryKey() {
    return "cgo_operazioni_dl_multi_dt"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
