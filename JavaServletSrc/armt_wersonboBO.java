...
// * --- Fine Area Manuale
public class armt_wersonboBO extends armt_wersonboBL {
  class SqlLoader {
    public boolean m_bLink_1_30 = false;
    public boolean m_bLink_1_35 = false;
    public boolean m_bLink_1_44 = false;
    public boolean m_bLink_1_45 = false;
    public boolean m_bLink_2_7 = false;
    public boolean m_bLink_2_17 = false;
    public boolean m_bLink_3_4 = false;
    public boolean m_bLink_3_12 = false;
    public boolean m_bLink_3_13 = false;
    public boolean m_bLink_3_14 = false;
    public boolean m_bLink_4_5 = false;
    ...
    public void AddJoinedLink_1_30(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_30.IDBASE AS IDBASE130";
        m_cSelect = m_cSelect+" ,link_1_30.DESCRI AS DESCRI130";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_30","IDNASSTATO","IDBASE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_30","IDNASSTATO","IDBASE",true);
    ...
    public void AddJoinedLink_1_35(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_35.TIPDOC AS TIPDOC135";
        m_cSelect = m_cSelect+" ,link_1_35.DESCRI AS DESCRI135";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_35","TIPODOC","TIPDOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_35","TIPODOC","TIPDOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_44(String rightTable,String rightServer) {
      // questo link aggiunge 4 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+4,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_44.SOTGRU AS SOTGRU144";
        m_cSelect = m_cSelect+" ,link_1_44.DESCRI AS DESCRI144";
        m_cSelect = m_cSelect+" ,link_1_44.TIPOSOT AS TIPOSOT144";
        m_cSelect = m_cSelect+" ,link_1_44.DATAFINE AS DATAFINE144";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_44","SOTGRUP","SOTGRU");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_44","SOTGRUP","SOTGRU",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_2_7(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_2_7.CODINTER AS CODINTER207";
        m_cSelect = m_cSelect+" ,link_2_7.RAGSOC AS RAGSOC207";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_2_7","BANCABEN","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_2_7","BANCABEN","CODINTER",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_2_17(String rightTable,String rightServer) {
      // questo link aggiunge 3 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_2_17.CONNES AS CONNES217";
        m_cSelect = m_cSelect+" ,link_2_17.RAGSOC AS RAGSOC217";
        m_cSelect = m_cSelect+" ,link_2_17.IDBASE AS IDBASE217";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_2_17","CODLEGRAP","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_2_17","CODLEGRAP","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_3_4(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_3_4.CODSTA AS CODSTA304";
        m_cSelect = m_cSelect+" ,link_3_4.DESCRI AS DESCRI304";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_3_4","FATCA","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_3_4","FATCA","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_3_12(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_3_12.CODSTA AS CODSTA312";
        m_cSelect = m_cSelect+" ,link_3_12.DESCRI AS DESCRI312";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_3_12","CITTADIN1","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_3_12","CITTADIN1","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_3_13(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_3_13.CODSTA AS CODSTA313";
        m_cSelect = m_cSelect+" ,link_3_13.DESCRI AS DESCRI313";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_3_13","CITTADIN2","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_3_13","CITTADIN2","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_3_14(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_3_14.CODSTA AS CODSTA314";
        m_cSelect = m_cSelect+" ,link_3_14.DESCRI AS DESCRI314";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_3_14","RESFISC","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_3_14","RESFISC","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_4_5(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_4_5.CODICE AS CODICE405";
        m_cSelect = m_cSelect+" ,link_4_5.DESCRI AS DESCRI405";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_4_5","AREAGEO","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_4_5","AREAGEO","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_4_8(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_4_8.CODSPE AS CODSPE408";
        m_cSelect = m_cSelect+" ,link_4_8.DESCRI AS DESCRI408";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_4_8","PKTBSPECIE","CODSPE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_4_8","PKTBSPECIE","CODSPE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_4_14(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_4_14","COMPORT","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_4_14","COMPORT","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_wersonboBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_wersonbo");
    }
  ...
  public boolean CanSave() {
    ...
    if (l_bResult) {
      ...
      if (l_bResult) {
        l_bResult = CanSaveChild(armt_wersonbo_agg,m_cWv_armt_wersonbo_agg,"m_cWv_armt_wersonbo_agg");
        if (l_bResult) {
          ...
          m_cLastMsgError = armt_wersonbo_agg.m_cLastMsgError;
        }
      } else {
  ...
  public boolean Save(boolean p_bAlreadyAccepted) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (armt_wersonbo_agg.IsUpdated()) && CPLib.IsUpdated(m_cWv_armt_wersonbo_agg)) {
            armt_wersonbo_agg.SetFromContext(m_cWv_armt_wersonbo_agg);
            m_cWv_armt_wersonbo_agg = "_not_empty_";
          }
          if (armt_wersonbo_agg.IsUpdated()) {
            armt_wersonbo_agg.w_CONNES = w_CONNES;
            if ( ! (armt_wersonbo_agg.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
  ...
  public static String[] m_cLoadParameterNames = {"sanumpro"};
  public static String[] m_cDeleteParameterNames = m_cLoadParameterNames;
  public boolean Load(String p_sanumpro) {
    CPResultSet l_rsLoad=null;
    SqlLoader l_oSqlLoader;
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_wersonbo,m_cPhName_wersonbo,m_cVirtName_wersonbo,m_cVirtName_wersonbo+".sanumpro="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_sanumpro,"C",15,0),m_cServer_wersonbo,p_sanumpro),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_1_30(m_cPhName_tbstatna,m_cServer_tbstatna);
    l_oSqlLoader.AddJoinedLink_1_35(m_cPhName_tbtipdoc,m_cServer_tbtipdoc);
    l_oSqlLoader.AddJoinedLink_1_44(m_cPhName_tbstgru,m_cServer_tbstgru);
    l_oSqlLoader.AddJoinedLink_1_45(m_cPhName_tbramgru,m_cServer_tbramgru);
    l_oSqlLoader.AddJoinedLink_2_7(m_cPhName_inter2bo,m_cServer_inter2bo);
    l_oSqlLoader.AddJoinedLink_2_17(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_3_4(m_cPhName_tbstati,m_cServer_tbstati);
    l_oSqlLoader.AddJoinedLink_3_12(m_cPhName_tbstati,m_cServer_tbstati);
    l_oSqlLoader.AddJoinedLink_3_13(m_cPhName_tbstati,m_cServer_tbstati);
    l_oSqlLoader.AddJoinedLink_3_14(m_cPhName_tbstati,m_cServer_tbstati);
    l_oSqlLoader.AddJoinedLink_4_5(m_cPhName_tbareegeog,m_cServer_tbareegeog);
    l_oSqlLoader.AddJoinedLink_4_8(m_cPhName_tbspecie,m_cServer_tbspecie);
    l_oSqlLoader.AddJoinedLink_4_14(m_cPhName_tbcondotta,m_cServer_tbcondotta);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_30) {
          w_xstatonas = l_rsLoad.GetString("DESCRI130");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_35) {
          w_DESCRI = l_rsLoad.GetString("DESCRI135");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_44) {
          w_DESCSGRU = l_rsLoad.GetString("DESCRI144");
          w_tipsot = l_rsLoad.GetString("TIPOSOT144");
          w_finesae = l_rsLoad.GetDate("DATAFINE144");
        } else {
        ...
        w_sanumpro = l_rsLoad.GetString("sanumpro");
        w_datamodi = l_rsLoad.GetDate("datamodi");
        w_BANCABEN = l_rsLoad.GetString("BANCABEN");
        if (l_oSqlLoader.m_bLink_2_7) {
          w_ragbanben = l_rsLoad.GetString("RAGSOC207");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_2_17) {
          w_xRAGLEGRAP = l_rsLoad.GetString("RAGSOC217");
          w_xIDLEGRAP = l_rsLoad.GetString("IDBASE217");
        } else {
          Link_CKHRNQSKKQ("Load");
        }
        w_FATCA = l_rsLoad.GetString("FATCA");
        if (l_oSqlLoader.m_bLink_3_4) {
          w_xdesfatca = l_rsLoad.GetString("DESCRI304");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_3_12) {
          w_xDesCit1 = l_rsLoad.GetString("DESCRI312");
        } else {
          Link_CJBEXKJOQO("Load");
        }
        w_CITTADIN2 = l_rsLoad.GetString("CITTADIN2");
        if (l_oSqlLoader.m_bLink_3_13) {
          w_xDesCit2 = l_rsLoad.GetString("DESCRI313");
        } else {
          Link_UNRQNVVFTK("Load");
        }
        w_RESFISC = l_rsLoad.GetString("RESFISC");
        if (l_oSqlLoader.m_bLink_3_14) {
          w_xResFis = l_rsLoad.GetString("DESCRI314");
        } else {
          Link_OSLBLDODHQ("Load");
        }
        w_AREAGEO = l_rsLoad.GetString("AREAGEO");
        if (l_oSqlLoader.m_bLink_4_5) {
          w_xdescareag = l_rsLoad.GetString("DESCRI405");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_4_8) {
          w_xdescnatgiu = l_rsLoad.GetString("DESCRI408");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_4_14) {
          w_xdesccomp = l_rsLoad.GetString("DESCRI414");
        } else {
        ...
        m_cWv_armt_wersonbo_agg = "";
        armt_wersonbo_agg.m_lCtxLoaded = false;
        m_cWv_ardt_soggope = "";
        ...
        if (CPLib.HasTableCPCCCHK(m_Ctx,"wersonbo")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_wersonbo);
      l_cSql = "insert into "+m_oWrInfo_wersonbo.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_wersonbo.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wersonbo")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_sanumpro,"C",15,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_NOTERIS,"M",10,0,m_cServer_wersonbo,m_oParameters)+", ";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsValueToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_wersonbo.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wersonbo")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_wersonbo,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_wersonbo);
      l_cSql = "Update "+m_oWrInfo_wersonbo.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+", NOTERIS = "+CPLib.ToSQL(w_NOTERIS,"M",10,0,m_cServer_wersonbo,m_oParameters);
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wersonbo")) {
        l_cSql = l_cSql+", CPCCCHK ="+CPLib.ToSQL(l_cCPCCCHK,"C",10,0);
      }
      l_cSql = l_cSql+SPExtenderLib.UpdateExtendedFieldsNameValueToSQL(extendedFields);
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"sanumpro="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_sanumpro,"C",15,0),m_cServer_wersonbo,w_sanumpro);
      l_cSql = l_cSql+m_oWrInfo_wersonbo.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wersonbo")) {
  ...
  public boolean Delete(String p_sanumpro) {
    String l_cSql;
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_wersonbo.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"sanumpro="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_sanumpro,"C",15,0),m_cServer_wersonbo,w_sanumpro);
          l_cSql = l_cSql+m_oWrInfo_wersonbo.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"wersonbo")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_wersonbo,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"PRGIMPOCLI","i_codazi,w_PROGIMPORT",m_cServer_wersonbo,m_Ctx.GetCompany());
    op_PROGIMPORT = w_PROGIMPORT;
  }
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    ...
    if (CPLib.eq(p_cID,"LDTVEYLAXJ")) {
      ...
      result.m_PrgZoom = "";
      result.m_rdField = new String[]{"CODINTER" , "ITFLGPEP"};
      ...
      result.m_dynamicprgzoom = false;
      result.m_SearchingFunction = "";
      result.m_PrgZoom = "armt_personbo";
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_chk_tiporapporto,arfn_chkateco,arfn_chkcodfis,arfn_chksint,
  public static final String i_InvokedRoutines = ",arfn_chk_tiporapporto,arfn_chkateco,arfn_chkcodfis,arfn_chksint,";
}
