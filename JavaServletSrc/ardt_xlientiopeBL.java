...
public class ardt_xlientiopeBL extends ardt_xlientiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xlientiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_xlientiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xlientiope;
  ...
  public static String[] m_EntityTables = {"xlientiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'PROQUOTA':PROQUOTA,'IMPSARA':IMPSARA"+FoundlingChildrenList("ardt_xlientiope",true,true)+"}"+FoundlingChildrenList("ardt_xlientiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'xragsoc':xragsoc,'PROQUOTA':PROQUOTA,'IMPSARA':IMPSARA,'IDBASE':IDBASE,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_xlientiope",true,true)+"}"+FoundlingChildrenList("ardt_xlientiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG PROQUOTA IMPSARA"+FoundlingChildrenList("ardt_xlientiope",false,true)+"]"+FoundlingChildrenList("ardt_xlientiope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_xlientiope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"PROQUOTA","Pro Quota","N","3","0","campo","nokey","true","false"},new String[]{"IMPSARA","Importo per Sara","N","19","2","campo","nokey","true","false"}});
  ...
  public ardt_xlientiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xlientiope = p_ContextObject.GetPhName("xlientiope",p_ContextObject.GetCompany(),false);
    m_cServer_xlientiope = p_ContextObject.GetServer("xlientiope");
    m_oWrInfo_xlientiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xlientiope",p_ContextObject.GetCompany());
    m_cVirtName_xlientiope = CPSql.ManipulateTablePhName("xlientiope",m_cServer_xlientiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xlientiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xlientiope","xlientiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_IMPSARA;
      p_IMPSARA = CPLib.GetProperties(trs_p.getProperty("IMPSARA"),new Properties());
      Properties p_IDBASE;
      ...
      Properties p_opk_CODSOG;
      p_opk_CODSOG = CPLib.GetProperties(trs_p.getProperty("opk_CODSOG"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_IMPSARA = 0;
        w_IMPSARA = CPLib.GetProperty(p_IMPSARA,"",w_IMPSARA,i);
        w_IDBASE = "";
        ...
        opk_CODSOG = CPLib.GetProperty(p_opk_CODSOG,"","",i);
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xlientiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xlientiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xlientiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xlientiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xlientiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xlientiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_IMPSARA,"",w_IMPSARA,trsrow);
      ...
      CPLib.PutProperty(p_opk_CODSOG,"",opk_CODSOG,trsrow);
    ...
    trs_p.setProperty("IMPSARA",CPLib.ToProperties(p_IMPSARA));
    ...
    trs_p.setProperty("opk_CODSOG",CPLib.ToProperties(p_opk_CODSOG));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xlientiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xlientiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
  ...
  protected void TrsToWork() {
    ...
    w_IMPSARA= m_oTrs.get(m_nCurrentRow).w_IMPSARA;
    ...
    opk_CODSOG= m_oTrs.get(m_nCurrentRow).opk_CODSOG;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_IMPSARA=w_IMPSARA;
    ...
    m_oTrs.get(m_nCurrentRow).opk_CODSOG=opk_CODSOG;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_IMPSARA=w_IMPSARA;
    ...
    m_oDeletedRows.get(l_nRows).opk_CODSOG=opk_CODSOG;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_IMPSARA= m_oDeletedRows.get(l_RowNumberToSet).w_IMPSARA;
    ...
    opk_CODSOG= m_oDeletedRows.get(l_RowNumberToSet).opk_CODSOG;
