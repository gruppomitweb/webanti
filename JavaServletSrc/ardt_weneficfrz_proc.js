...
m_oFather.i_last_focused_item='child_ardt_weneficfrz';
...
function Help() {
windowOpenForeground('../doc/ardt_weneficfrz_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'weneficfrz'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_weneficfrz',m_cSelectedPage);
