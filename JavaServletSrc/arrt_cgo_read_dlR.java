...
// * --- Fine Area Manuale
public class arrt_cgo_read_dlR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_cgo_read_dlR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_cgo_read_dl",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* In base al codice fiscale del cliente legge i dati anagrafici (tranne documento ?) */
  ...
  public String RunAsync(armt_snai_operBO p_pObj) {
    pObj = p_pObj;
  ...
  public Forward Run(armt_snai_operBO p_pObj) {
    pObj = p_pObj;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_cgo_read_dlR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_cgo_read_dlR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
  }
