...
public class arpg_trasffra_wuBL extends arpg_trasffra_wuWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasffra_wu";
  ...
  public arpg_trasffra_wuBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasffra_wu","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
