...
public class ardt_sogopeprovBL extends ardt_sogopeprovWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_sogopeprov";
  ...
  public CPPhTableWrInfo m_oWrInfo_xogopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xogopebo;
  ...
  public static String[] m_EntityTables = {"xogopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_sogopeprov",true,true)+"}"+FoundlingChildrenList("ardt_sogopeprov",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'xragsoc':xragsoc,'LEGAME':LEGAME,'xdescriz':xdescriz"+FoundlingChildrenList("ardt_sogopeprov",true,true)+"}"+FoundlingChildrenList("ardt_sogopeprov",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_sogopeprov",false,true)+"]"+FoundlingChildrenList("ardt_sogopeprov",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_sogopeprov"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key2","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_sogopeprovBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xogopebo = p_ContextObject.GetPhName("xogopebo",p_ContextObject.GetCompany(),false);
    m_cServer_xogopebo = p_ContextObject.GetServer("xogopebo");
    m_oWrInfo_xogopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xogopebo",p_ContextObject.GetCompany());
    m_cVirtName_xogopebo = CPSql.ManipulateTablePhName("xogopebo",m_cServer_xogopebo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_sogopeprov",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_sogopeprov","xogopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_sogopeprov",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_sogopeprov",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_sogopeprov",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_sogopeprov",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_sogopeprov"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_sogopeprov\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xogopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xogopebo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
