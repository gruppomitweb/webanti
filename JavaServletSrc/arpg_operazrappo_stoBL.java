...
public class arpg_operazrappo_stoBL extends arpg_operazrappo_stoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_operazrappo_sto";
  ...
  public arpg_operazrappo_stoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_operazrappo_sto","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
