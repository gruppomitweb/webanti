...
HideUI.lblids["DATARETT"]=['MBOMUTRIJO'];
...
var old_c;
if (Ne(typeof(w_Titolari),'undefined')) {
w_Titolari.raiseEvent('armt_titolabo_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/armt_titolabo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('armt_titolabo',m_cSelectedPage);
...
_Obli('TIPOOPRAP',0,'SWRTSKXMDH',true,"684190680",'SWRTSKXMDH',"11525797640")
