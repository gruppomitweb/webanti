...
var tmp_ZVNCMVSNJW = ToHTag(AsControlValue(w_xDESATECO));
if (Ne(e_ZVNCMVSNJW,tmp_ZVNCMVSNJW)) {
SPBOUILib.SetLabelValue('ZVNCMVSNJW','innerHTML',tmp_ZVNCMVSNJW);
e_ZVNCMVSNJW=tmp_ZVNCMVSNJW;
}
...
m_oFather.i_last_focused_item='child_ardt_xrz_contante';
...
function Help() {
windowOpenForeground('../doc/ardt_xrz_contante_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'xrz_contante'+'\\'+CPLib.ToCPStr(w_IDOPE);
}
...
p_d.setValue('ardt_xrz_contante',m_cSelectedPage);
