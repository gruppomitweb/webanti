...
if ( ! (m_oFather.SaveContext_ardt_xeneficfrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xeneficfrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xeneficfrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xeneficfrz();
}
}
SaveContext.child=[];
function BlankRow() {
