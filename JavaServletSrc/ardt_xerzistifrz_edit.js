...
if ( ! (m_oFather.SaveContext_ardt_xerzistifrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xerzistifrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xerzistifrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xerzistifrz();
}
}
SaveContext.child=[];
function BlankRow() {
