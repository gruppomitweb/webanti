...
public class armt_cgo_oper_multiBL extends armt_cgo_oper_multiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_cgo_oper_multi";
  ...
  public armt_cgo_oper_multiBL (CPContext p_ContextObject) {
    ...
    ardt_cgo_oper_multi = new ardt_cgo_oper_multiBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_cgo_oper_multi",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_cgo_oper_multi.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    o_CODDIPE = w_CODDIPE;
    ardt_cgo_oper_multi.SaveDependsOn();
  }
  ...
  public boolean TTZZVOAPLN_isObligatory() {
    // Condizione di obbligatorietà
    return CPLib.eq(w_FLAGWALLET,"1");
  }
  ...
  public boolean FRTNMCIRCW_isObligatory() {
    // Condizione di obbligatorietà
  ...
  public boolean Calculate() {
    ...
    if (CPLib.ne(o_TOTLIRE,w_TOTLIRE) || CPLib.ne(o_TOTCONT,w_TOTCONT) || CPLib.ne(o_IMPWALLET,w_IMPWALLET)) {
      Calculation_ZOUJCIPILP();
    }
    // * --- Area Manuale = BO - Calculate
    // * --- Fine Area Manuale
    // Aggiorna l'autonumber se cambia la parte fissa
    UpdateAutonumber();
    CopyWorkVar(this,ardt_cgo_oper_multi,new String[]{"CGOTIPOPE","DATOPE_P","SEGNO_P"},new String[]{"CGOTIPOPE","DATAOPE","SEGNO"},true);
  ...
  void Calculation_QMNVPQPHJO() {
    arrt_cgo_setpagatore_mR l_oRoutine_arrt_cgo_setpagatore_m;
    l_oRoutine_arrt_cgo_setpagatore_m = arrt_cgo_setpagatore_mR.Make(m_Ctx,this);
    l_oRoutine_arrt_cgo_setpagatore_m.pObj = this;
    l_oRoutine_arrt_cgo_setpagatore_m.Run();
  }
  ...
  void Calculation_KGBNFVNJHO() {
    ...
    l_oRoutine_arrt_cgo_save_multi_dl.w_SNAINUMOPE = w_SNAINUMOPE;
    l_oRoutine_arrt_cgo_save_multi_dl._gAzienda = w_gAzienda;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_cgo_oper_multi","cgo_operazioni_dl_multi",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_ardt_cgo_oper_multi = CPLib.GetProperty(p,"m_cWv_ardt_cgo_oper_multi",m_cWv_ardt_cgo_oper_multi,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("cgo_operazioni_dl_multi_dt");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("cgo_operazioni_dl_multi_dt",items);
    }
    items.add(map);
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("cgo_operazioni_dl_multi_dt\u0000false\u0000false\u00001\u00000\u0000ardt_cgo_oper_multi\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_cgo_oper_multi",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_cgo_oper_multi",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_cgo_oper_multi = new ardt_cgo_oper_multiBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_cgo_oper_multi",m_Ctx);
  ...
  public boolean Check() {
    ...
    } else if ((CPLib.eq(w_FLAGWALLET,"1") &&  ! (CPLib.Empty(w_DATAOPE))) && (CPLib.Empty(w_CODWALLET) && TTZZVOAPLN_isObligatory())) {
    ...
    } else if (CPLib.Empty(w_PROFESSIONE) && FRTNMCIRCW_isObligatory()) {
    ...
    if (l_bResult && (( ! (ardt_cgo_oper_multi.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_cgo_oper_multi)) || ( ! (ardt_cgo_oper_multi.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi)))) {
      ardt_cgo_oper_multi.SetFromContext(m_cWv_ardt_cgo_oper_multi);
      m_cWv_ardt_cgo_oper_multi = "_not_empty_";
    }
    if (l_bResult && (ardt_cgo_oper_multi.m_bLoaded || ardt_cgo_oper_multi.m_bUpdated)) {
      l_bResult = l_bResult && ardt_cgo_oper_multi.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_cgo_oper_multi.m_cLastMsgError;
      }
    }
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_cgo_oper_multi"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_cgo_oper_multi\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (ardt_cgo_oper_multi.IsUpdated()) {
        m_cWv_ardt_cgo_oper_multi = ardt_cgo_oper_multi.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_cgo_oper_multi",m_cWv_ardt_cgo_oper_multi,0);
    }
    if (p_bGetChildren) {
  ...
  public boolean ChildExists_ardt_cgo_oper_multi() {
    if (ardt_cgo_oper_multi.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi) || CPLib.IsLoaded(m_cWv_ardt_cgo_oper_multi))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_cgo_oper_multi.m_bLoaded)) {
      ardt_cgo_oper_multi.Blank();
      ardt_cgo_oper_multi.w_SNAINUMOPE = w_SNAINUMOPE;
      ardt_cgo_oper_multi.Load();
    }
    return ardt_cgo_oper_multi.m_bLoaded;
  }
  public void CtxLoad_ardt_cgo_oper_multi() {
    if ( ! (ardt_cgo_oper_multi.m_lCtxLoaded)) {
      ardt_cgo_oper_multi.Blank();
    }
    ardt_cgo_oper_multi.m_lCtxLoaded = true;
    if ( ! (ardt_cgo_oper_multi.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi) || CPLib.IsLoaded(m_cWv_ardt_cgo_oper_multi)) {
        ardt_cgo_oper_multi.SetFromContext(m_cWv_ardt_cgo_oper_multi);
        m_cWv_ardt_cgo_oper_multi = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_cgo_oper_multi.m_bLoaded)) {
          ardt_cgo_oper_multi.Blank();
          ardt_cgo_oper_multi.w_SNAINUMOPE = w_SNAINUMOPE;
          ardt_cgo_oper_multi.Load();
          if ( ! (ardt_cgo_oper_multi.m_bLoaded)) {
            ardt_cgo_oper_multi.Initialize();
            ardt_cgo_oper_multi.SetUpdated();
          }
          CopyWorkVar(this,ardt_cgo_oper_multi,new String[]{"CGOTIPOPE","DATOPE_P","SEGNO_P"},new String[]{"CGOTIPOPE","DATAOPE","SEGNO"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_cgo_oper_multi,new String[]{"CGOTIPOPE","DATOPE_P","SEGNO_P"},new String[]{"CGOTIPOPE","DATAOPE","SEGNO"},true);
        }
      }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_cgo_oper_multi")) {
      CtxLoad_ardt_cgo_oper_multi();
      return ardt_cgo_oper_multi;
    }
