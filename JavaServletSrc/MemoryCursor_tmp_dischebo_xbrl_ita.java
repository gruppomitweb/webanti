// Definition generated from table tmp_dischebo_xbrl_ita
public class MemoryCursor_tmp_dischebo_xbrl_ita extends CPMemoryCursor {
  MemoryCursorRow_tmp_dischebo_xbrl_ita row;
  MemoryCursorRow_tmp_dischebo_xbrl_ita empty_row;
  public MemoryCursor_tmp_dischebo_xbrl_ita() {
    empty_row = new MemoryCursorRow_tmp_dischebo_xbrl_ita();
    row = empty_row;
  }
  public MemoryCursor_tmp_dischebo_xbrl_ita(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_tmp_dischebo_xbrl_ita)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_tmp_dischebo_xbrl_ita();
  }
  ...
  public MemoryCursorRow_tmp_dischebo_xbrl_ita _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_tmp_dischebo_xbrl_ita _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_tmp_dischebo_xbrl_ita> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_tmp_dischebo_xbrl_ita();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    MemoryCursorRow_tmp_dischebo_xbrl_ita l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_tmp_dischebo_xbrl_ita p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_tmp_dischebo_xbrl_ita();
    }
    this.row.Copy(p_Row);
    return true;
  }
