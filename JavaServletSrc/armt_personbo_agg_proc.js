...
m_oFather.i_last_focused_item='child_armt_personbo_agg';
...
function Help() {
windowOpenForeground('../doc/armt_personbo_agg_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'personbo_agg'+'\\'+CPLib.ToCPStr(w_CONNES);
}
function CheckZone(me) {
if (IsWndAccessible(window['m_oFather'])) {
return m_oFather.CheckZone('child_armt_personbo_agg');
}
return true;
}
GetSelectedChildPage.child={}
function GetSelectedPage(p_d) {
p_d.setValue('armt_personbo_agg',m_cSelectedPage);
