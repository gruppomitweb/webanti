...
// * --- Fine Area Manuale
public class arrt_cgo_punteggio_adv_dlR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_cgo_punteggio_adv_dlR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_cgo_punteggio_adv_dl",m_Caller);
    Blank();
  }
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_cgo_punteggio_adv_dl";
  ...
  void Page_1() throws Exception {
    /* pObj Object(armt_cgo_qadv_operazioni_dlBL) // Numero Domanda */
    /* _completa Char(1) */
  ...
  public String RunAsync(armt_cgo_qadv_operazioni_dlBL p_pObj) {
    pObj = p_pObj;
  ...
  public Forward Run(armt_cgo_qadv_operazioni_dlBL p_pObj) {
    pObj = p_pObj;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_cgo_punteggio_adv_dlR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_cgo_punteggio_adv_dlR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
