...
// * --- Fine Area Manuale
public class arrt_lancia_import_rtraR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_rtraR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_rtra",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_import_rtra";
  ...
  void Page_1() throws Exception {
    ...
    /* Stop ../jsp/pg_import_dati_rtra_portlet.jsp */
    Forward f;
    f=new Forward("../jsp/pg_import_dati_rtra_portlet.jsp",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_import_rtraR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_rtraR(p_Ctx, p_Caller);
  }
  public void Blank() {
