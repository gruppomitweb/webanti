...
public class arpg_stpinforma_prvBL extends arpg_stpinforma_prvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpinforma_prv";
  ...
  public arpg_stpinforma_prvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpinforma_prv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
