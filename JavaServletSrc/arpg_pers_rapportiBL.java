...
public class arpg_pers_rapportiBL extends arpg_pers_rapportiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_pers_rapporti";
  ...
  public arpg_pers_rapportiBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_pers_rapporti","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
