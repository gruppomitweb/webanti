...
public class arpg_genera_rettificheBL extends arpg_genera_rettificheWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_genera_rettifiche";
  ...
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_genera_rettificheBL (CPContext p_ContextObject) {
  ...
  public boolean Calculate() {
    ...
    l_bResult = true;
    m_bCalculating = true;
    if (CPLib.ne(o_mese,w_mese) || CPLib.ne(o_anno,w_anno)) {
      w_DaDatOpe = ( ! (CPLib.Empty(w_anno)) &&  ! (CPLib.Empty(w_mese))?CPLib.CharToDate(CPLib.Str(w_anno,4,0)+w_mese+"01"):CPLib.NullDate());
    }
    if (CPLib.ne(o_mese,w_mese) || CPLib.ne(o_anno,w_anno)) {
      w_ADatOpe = arfn_finemeseR.Make(m_Ctx,this).Run(w_DaDatOpe);
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_genera_rettifiche","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
