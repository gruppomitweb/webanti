...
public class arpg_scaricodati_negaglobBL extends arpg_scaricodati_negaglobWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_scaricodati_negaglob";
  ...
  public static final String i_StateStructure = "{'anno':anno,'mese':mese,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'dadata':dadata,'a_data':a_data,'anno':anno,'mese':mese,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO}";
  public static final String i_ItemSequence = "anno,mese,CFINVIO,CAFINVIO,FILEINVIO,DATAINVIO";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","true"},new String[]{"CFINVIO","Codice Fiscale Organo Invio File","C","16","0","variabile","nokey","false","false"},new String[]{"CAFINVIO","Codice CAF Organo Invio","C","5","0","variabile","nokey","false","false"},new String[]{"FILEINVIO","Tipo Preparazione FIle","C","1","0","variabile","nokey","false","false"},new String[]{"DATAINVIO","Data Impegno Organo Invio","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_scaricodati_negaglobBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_scaricodati_negaglob","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
