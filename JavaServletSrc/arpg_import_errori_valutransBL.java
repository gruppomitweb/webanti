...
public class arpg_import_errori_valutransBL extends arpg_import_errori_valutransWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_errori_valutrans";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'tipodest':tipodest,'impzip':impzip,'gAzienda':gAzienda,'gPathApp':gPathApp}";
  public static final String i_ItemSequence = "tipodest";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"tipodest","Destinazione","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_import_errori_valutransBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_errori_valutrans","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
