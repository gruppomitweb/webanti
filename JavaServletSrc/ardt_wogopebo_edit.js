...
if ( ! (m_oFather.SaveContext_ardt_wogopebo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_wogopebo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_wogopebo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_wogopebo();
}
}
SaveContext.child=[];
function BlankRow() {
