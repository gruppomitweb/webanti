...
// * --- Fine Area Manuale
public class armt_wu_chkerrBO extends armt_wu_chkerrBL {
  class SqlLoader {
    ...
    public void AddJoinedLink_1_78(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_78.MACODICE AS MACODICE178";
        m_cSelect = m_cSelect+" ,link_1_78.MADESCRI AS MADESCRI178";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_78","WUCODMAGE","MACODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_78","WUCODMAGE","MACODICE",true);
    ...
    public void AddJoinedLink_1_82(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_82.CODDIP AS CODDIP182";
        m_cSelect = m_cSelect+" ,link_1_82.DESCCIT AS DESCCIT182";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_82","WUCODDIP","CODDIP");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_82","WUCODDIP","CODDIP",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_wu_chkerrBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_wu_chkerr");
    }
  ...
  public boolean Load(double p_WUCODICE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_wuchkimp,m_cPhName_wuchkimp,m_cVirtName_wuchkimp,m_cVirtName_wuchkimp+".WUCODICE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_WUCODICE,"N",10,0),m_cServer_wuchkimp,p_WUCODICE),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_1_78(m_cPhName_tbmacage,m_cServer_tbmacage);
    l_oSqlLoader.AddJoinedLink_1_82(m_cPhName_anadip,m_cServer_anadip);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        w_WUDATOPE = l_rsLoad.GetString("WUDATOPE");
        ...
        w_WUBSTACLI = l_rsLoad.GetString("WUBSTACLI");
        ...
        w_WURDOCCLI = l_rsLoad.GetString("WURDOCCLI");
        w_WUSDOCCLI = l_rsLoad.GetString("WUSDOCCLI");
        ...
        if (l_oSqlLoader.m_bLink_1_78) {
          w_xMADESCRI = l_rsLoad.GetString("MADESCRI178");
        } else {
          Link_FHWIGGJJLC("Load");
        }
        w_WUCODDIP = l_rsLoad.GetString("WUCODDIP");
        if (l_oSqlLoader.m_bLink_1_82) {
          w_xDESDIP = l_rsLoad.GetString("DESCCIT182");
        } else {
        ...
        if (CPLib.HasTableCPCCCHK(m_Ctx,"wuchkimp")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_wuchkimp);
      l_cSql = "insert into "+m_oWrInfo_wuchkimp.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_wuchkimp.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wuchkimp")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_WUDATOPE,"C",10,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_WUNTDOCCLI,"C",1,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_WUBSTACLI,"C",40,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_WURDOCCLI,"C",10,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_WUSDOCCLI,"C",10,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_WUSEXCLI,"C",1,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_WUTDOCCLI,"C",1,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_WUNOTE,"M",10,0,m_cServer_wuchkimp,m_oParameters)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQLNull(w_WUNSTACLI,"C",30,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_WUNSEXCLI,"C",1,0)+", ";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsValueToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_wuchkimp.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wuchkimp")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_wuchkimp,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_wuchkimp);
      l_cSql = "Update "+m_oWrInfo_wuchkimp.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+", WUDATOPE = "+CPLib.ToSQL(w_WUDATOPE,"C",10,0);
      ...
      l_cSql = l_cSql+", WUNTDOCCLI = "+CPLib.ToSQL(w_WUNTDOCCLI,"C",1,0);
      ...
      l_cSql = l_cSql+", WUBSTACLI = "+CPLib.ToSQL(w_WUBSTACLI,"C",40,0);
      ...
      l_cSql = l_cSql+", WURDOCCLI = "+CPLib.ToSQL(w_WURDOCCLI,"C",10,0);
      l_cSql = l_cSql+", WUSDOCCLI = "+CPLib.ToSQL(w_WUSDOCCLI,"C",10,0);
      l_cSql = l_cSql+", WUSEXCLI = "+CPLib.ToSQL(w_WUSEXCLI,"C",1,0);
      l_cSql = l_cSql+", WUTDOCCLI = "+CPLib.ToSQL(w_WUTDOCCLI,"C",1,0);
      ...
      l_cSql = l_cSql+", WUNOTE = "+CPLib.ToSQL(w_WUNOTE,"M",10,0,m_cServer_wuchkimp,m_oParameters);
      ...
      l_cSql = l_cSql+", WUNSTACLI = "+CPLib.ToSQLNull(w_WUNSTACLI,"C",30,0);
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"WUCODICE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_WUCODICE,"N",10,0),m_cServer_wuchkimp,w_WUCODICE);
      l_cSql = l_cSql+m_oWrInfo_wuchkimp.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wuchkimp")) {
  ...
  public boolean Delete(double p_WUCODICE) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_wuchkimp.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"WUCODICE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_WUCODICE,"N",10,0),m_cServer_wuchkimp,w_WUCODICE);
          l_cSql = l_cSql+m_oWrInfo_wuchkimp.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"wuchkimp")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_wuchkimp,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    ...
    if (CPLib.eq(p_cID,"RPXEDSQTUE")) {
      ...
      result.m_kField = new String[]{};
      result.m_kTypes = new String[]{};
      result.AppendFieldsHash("WVLDFVKALY",CPLib.GetLinkedFieldProps("DESCRI","WUNSTACLI","C",30,0));
    }
    return result;
  }
