...
public class ardt_terzistirapBL extends ardt_terzistirapWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_terzistirap";
  ...
  public CPPhTableWrInfo m_oWrInfo_terzistirap;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_terzistirap;
  ...
  public static String[] m_EntityTables = {"terzistirap"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_terzistirap",true,true)+"}"+FoundlingChildrenList("ardt_terzistirap",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_terzistirap",true,true)+"}"+FoundlingChildrenList("ardt_terzistirap",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_terzistirap",false,true)+"]"+FoundlingChildrenList("ardt_terzistirap",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_terzistirap"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_terzistirapBL (CPContext p_ContextObject) {
    ...
    m_cPhName_terzistirap = p_ContextObject.GetPhName("terzistirap",p_ContextObject.GetCompany(),false);
    m_cServer_terzistirap = p_ContextObject.GetServer("terzistirap");
    m_oWrInfo_terzistirap = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"terzistirap",p_ContextObject.GetCompany());
    m_cVirtName_terzistirap = CPSql.ManipulateTablePhName("terzistirap",m_cServer_terzistirap);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_terzistirap",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_terzistirap","terzistirap",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_terzistirap",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_terzistirap",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_terzistirap",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_terzistirap",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_terzistirap"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_terzistirap\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "terzistirap"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "terzistirap"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
