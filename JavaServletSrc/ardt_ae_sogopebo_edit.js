...
if ( ! (m_oFather.SaveContext_ardt_ae_sogopebo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_ae_sogopebo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_ae_sogopebo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_ae_sogopebo();
}
}
SaveContext.child=[];
function BlankRow() {
