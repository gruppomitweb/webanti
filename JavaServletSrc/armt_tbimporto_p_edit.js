...
if ( ! (m_oFather.SaveContext_armt_tbimporto_p())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_tbimporto_p_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tbimporto_p_dataNotSent',{'action':formaction});
}
}
}
}
...
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_tbimporto_p();
}
}
