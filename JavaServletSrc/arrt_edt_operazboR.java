...
// * --- Fine Area Manuale
public class arrt_edt_operazboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_edt_operazboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_edt_operazbo",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("armt_operazioni",false,this,Forward.EditStatus,false);
  ...
  public static arrt_edt_operazboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_edt_operazboR(p_Ctx, p_Caller);
  }
  public void Blank() {
