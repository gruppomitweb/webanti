...
public class arpg_stp_contfileBL extends arpg_stp_contfileWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_contfile";
  ...
  public CPPhTableWrInfo m_oWrInfo_aefiles_glob;
  ...
  public arpg_stp_contfileBL (CPContext p_ContextObject) {
    ...
    m_oWrInfo_aefiles_glob = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"aefiles_glob",p_ContextObject.GetCompany());
  }
  public void Blank() {
  ...
  protected boolean Link_UCCWMDWDFX(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_nomefile))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_nomefile,"C",20,0),m_cServer_aefiles_glob,w_nomefile);
      if (m_Ctx.IsSharedTemp("aefiles_glob")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_aefiles_glob,"select nomefile,idfile,descfile from "+m_cPhName_aefiles_glob+((m_cPhName_aefiles_glob).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"nomefile"+l_cCurrentKey+l_cWhere);
      try {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_contfile","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("aefiles_glob");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("aefiles_glob",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("aefiles_glob\u0000false\u0000true\u00001\u00000\u0000\u0000true\u0000false\u0000File Generati\u0000\u0000\u0000false",-1));
