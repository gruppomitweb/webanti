...
import jxl.*;
// * --- Fine Area Manuale
public class aggiorna_titolari2R implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public aggiorna_titolari2R (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("aggiorna_titolari2",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    double nTry0000001Fstatus;
    nTry0000001Fstatus = m_Sql.GetTransactionStatus();
    String cTry0000001Fmsg;
    cTry0000001Fmsg = m_Sql.TransactionErrorMessage();
    try {
      //base
      Workbook workbook = Workbook.getWorkbook(new File(CPLib.LRTrim(gPathApp)+"/appo/Migrazione.xls"));
      ...
      while (CPLib.lt(_i,_conta)) {
        ...
        while (CPLib.lt(_y,_righe)) {
          ...
          column06 = a06.getContents();
          /* _dataope := CharToDate(LRTrim(column04)) */
          _dataope = CPLib.CharToDate(CPLib.LRTrim(column04));
          ...
          m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000034")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.LRTrim(column02),"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000035")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(CPLib.Left(column02,25)),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("2","?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("0","?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+m_oWrInfo.InsertValues();
      ...
      if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry0000001Fstatus,0)) {
        m_Sql.SetTransactionStatus(nTry0000001Fstatus,cTry0000001Fmsg);
      }
    }
  }
  void Page_2() throws Exception {
    ...
    try {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_rapotit.GetString("CONNESOPER")))) && CPLib.le(Cursor_rapotit.GetDate("DATAOPE"),CPLib.CharToDate("20131231"))) {
          ...
          if (CPLib.eqr(Cursor_rapotit.GetString("STATOREG"),"3")) {
            ...
            if (CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"50") || CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"52")) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000040")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"mntestit",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000041")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          if (CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"50") || CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"52")) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000044")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestit",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000045")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(Cursor_rapotit.GetDate("DATAOPE"),"D",8,0)+", ";
            m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(Cursor_rapotit.GetString("NUMPROG"),"C",11,0,m_cServer)+", ";
      ...
      while ( ! (Cursor_wuib1.Eof())) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000050")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000051")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_intestit.Eof())) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000054")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_intestbo.Eof())) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"00000057")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_anarapbo.Eof())) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari2",99,"0000005A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  public static aggiorna_titolari2R Make(CPContext p_Ctx, Caller p_Caller) {
    return new aggiorna_titolari2R(p_Ctx, p_Caller);
  }
  public void Blank() {
    nProg = 0;
