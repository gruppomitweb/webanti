...
if ( ! (m_oFather.SaveContext_ardt_xrz_contante())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xrz_contante_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xrz_contante_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xrz_contante();
}
}
SaveContext.child=[];
function BlankRow() {
