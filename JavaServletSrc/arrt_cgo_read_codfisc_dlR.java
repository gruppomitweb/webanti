...
// * --- Fine Area Manuale
public class arrt_cgo_read_codfisc_dlR implements CallerWithObjs {
  ...
  public armt_cgo_operBO pObj;
  public String pTipo;
  public String _lastope;
  public String cDoc;
  // * --- Area Manuale = BO - Properties
  // * --- Fine Area Manuale
  public arrt_cgo_read_codfisc_dlR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_cgo_read_codfisc_dl",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_cgo_read_codfisc_dl";
  ...
  public String RunAsync(armt_cgo_operBO p_pObj,String p_pTipo) {
    pObj = p_pObj;
    pTipo = p_pTipo;
  ...
  public Forward Run(armt_cgo_operBO p_pObj,String p_pTipo) {
    pObj = p_pObj;
    pTipo = p_pTipo;
    return Run();
  }
  ...
  public static arrt_cgo_read_codfisc_dlR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_cgo_read_codfisc_dlR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
    pTipo = CPLib.Space(1);
