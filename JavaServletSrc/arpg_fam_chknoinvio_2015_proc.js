...
SetLocationHref(null,'arrt_fam_chknoinvio_2015'+'?m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
w_Messaggi.raiseEvent('arpg_fam_chknoinvio_2015_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_fam_chknoinvio_2015_'+Strtran(p_cEvent,' ','_'));
}
}
...
FocusFirstComponent.otherwise={"page_1":["RSFTNWRBDD"]};
function Help() {
windowOpenForeground('../doc/arpg_fam_chknoinvio_2015_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_fam_chknoinvio_2015',m_cSelectedPage);
