...
function Set_C1CODTAB(ctrlValue,kmode,e) {
if (Ne(w_C1CODTAB,ctrlValue)) {
var ctl = _GetCtl(e,'SEJWRQHUSP');
if (_tracker.goon(ctl,ctrlValue)) {
w_C1CODTAB=ctrlValue;
SetModified();
var l_bResult = true;
...
function Set_C1CODICE(ctrlValue,kmode,e) {
if (Ne(w_C1CODICE,ctrlValue)) {
var ctl = _GetCtl(e,'XREVNLNKCY');
if (_tracker.goon(ctl,ctrlValue)) {
w_C1CODICE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
function Set_C1DESCRI(ctrlValue,kmode,e) {
if (Ne(w_C1DESCRI,ctrlValue)) {
var ctl = _GetCtl(e,'RJDJPGMTCC');
if (_tracker.goon(ctl,ctrlValue)) {
w_C1DESCRI=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg01_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg01_dataNotSent',{'action':formaction});
}
}
}
}
...
l_oWv.setValue('C1CODTAB',WtA(w_C1CODTAB,'C'));
l_oWv.setValue('C1CODICE',WtA(w_C1CODICE,'C'));
l_oWv.setValue('C1DESCRI',WtA(w_C1DESCRI,'C'));
...
FillWv.n=["C1CODTAB","C1CODICE","C1DESCRI","IDBASE"];
