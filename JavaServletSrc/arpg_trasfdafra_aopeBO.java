...
// * --- Fine Area Manuale
public class arpg_trasfdafra_aopeBO extends arpg_trasfdafra_aopeBL {
  ...
  public arpg_trasfdafra_aopeBO (CPContext p_ContextObject) {
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_dateminus,azzera_messaggi,
  public static final String i_InvokedRoutines = ",arfn_dateminus,azzera_messaggi,";
}
