...
public class armt_informazioniBL extends armt_informazioniWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_informazioni";
  ...
  public CPPhTableWrInfo m_oWrInfo_rapopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_rapopebo;
  ...
  public static String[] m_EntityTables = {"rapopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'ardt_informazioni':ardt_informazioni,'ardt_delegabo':ardt_delegabo,'CODDIPE':CODDIPE,'RAPPORTO':RAPPORTO,'DATAOPE':DATAOPE,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'IDBASE':IDBASE,'DATARETT':DATARETT,'STATOREG':STATOREG,'closeall':closeall,'ardt_soginfo':ardt_soginfo,'ardt_fiduciabo':ardt_fiduciabo,'ardt_terzistirap':ardt_terzistirap,'FLAGTIT':FLAGTIT"+FoundlingChildrenList("armt_informazioni",true)+"}";
  public static final String i_CompleteStateStructure = "{'ardt_informazioni':ardt_informazioni,'ardt_delegabo':ardt_delegabo,'gIntemediario':gIntemediario,'gSblocco':gSblocco,'gFlgDTP':gFlgDTP,'gChkDate':gChkDate,'gStatus':gStatus,'gDataVaria':gDataVaria,'gCodDip':gCodDip,'filtro':filtro,'dataoggi':dataoggi,'tipreg':tipreg,'tipregn':tipregn,'CDATOPE':CDATOPE,'CDATREG':CDATREG,'sEdit':sEdit,'CODINTER':CODINTER,'CODDIPE':CODDIPE,'RAPPORTO':RAPPORTO,'DATAOPE':DATAOPE,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'IDBASE':IDBASE,'TIPOINTER':TIPOINTER,'TIPOINF':TIPOINF,'IDEREG':IDEREG,'FLAGRAP':FLAGRAP,'OPRAP':OPRAP,'OPERATORE':OPERATORE,'AUTOM':AUTOM,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CODCAB':CODCAB,'NUMPROG':NUMPROG,'xdescrap':xdescrap,'xDescDipe':xDescDipe,'datpaseuro':datpaseuro,'xDesReg':xDesReg,'xRagSoc':xRagSoc,'errmsg':errmsg,'Aggiorna':Aggiorna,'FLAGRAP2':FLAGRAP2,'lancio':lancio,'FLAGLIRE':FLAGLIRE,'VALUTA':VALUTA,'PRGIMPINF':PRGIMPINF,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'OPERAZMOD':OPERAZMOD,'IDBASE2':IDBASE2,'inutile':inutile,'DATARETT':DATARETT,'STATOREG':STATOREG,'prova':prova,'closeall':closeall,'ardt_soginfo':ardt_soginfo,'ardt_fiduciabo':ardt_fiduciabo,'ardt_terzistirap':ardt_terzistirap,'FLAGTIT':FLAGTIT"+FoundlingChildrenList("armt_informazioni",true)+"}";
  public static final String i_ItemSequence = "ardt_informazioni,ardt_delegabo,CODDIPE,RAPPORTO,DATAOPE,DATAREG,TIPOOPRAP,CONNESOPER,TIPOLEG,IDBASE,DATARETT,STATOREG,closeall,ardt_soginfo,ardt_fiduciabo,ardt_terzistirap,FLAGTIT"+FoundlingChildrenList("armt_informazioni",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_informazioni"),new String[][]{new String[]{"ardt_informazioni","Informazioni","","","","link_PC","","false",""},new String[]{"ardt_delegabo","Deleghe","","","","link_PC","","false",""},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"RAPPORTO","","C","25","0","campo","key3","false","false"},new String[]{"DATAOPE","Data Operazione","D","8","0","campo","key7","false","true"},new String[]{"DATAREG","Data registrazione","D","8","0","campo","key4","false","true"},new String[]{"TIPOOPRAP","Tipo Informazione","C","2","0","campo","key5","false","true"},new String[]{"CONNESOPER","Soggetto Operante Conto Terzi","C","16","0","campo","key6","false","false"},new String[]{"TIPOLEG","Tipo Legame Sogg.","C","1","0","campo","nokey","false","false"},new String[]{"IDBASE","idbase","C","10","0","campo","key1","false","false"},new String[]{"DATARETT","Data Rettifica","D","8","0","campo","nokey","false","false"},new String[]{"STATOREG","Stato","C","1","0","campo","nokey","false","false"},new String[]{"closeall","","C","1","0","variabile","nokey","false","false"},new String[]{"ardt_soginfo","Soggetti Agenti per Conto Inform.","","","","link_PC","","false",""},new String[]{"ardt_fiduciabo","Soggetti conto informazioni","","","","link_PC","","false",""},new String[]{"ardt_terzistirap","LinkPC","","","","link_PC","","false",""},new String[]{"FLAGTIT","Flag Somma Titolari","N","1","0","campo","nokey","false","false"}});
  ...
  public armt_informazioniBL (CPContext p_ContextObject) {
    ...
    m_cPhName_rapopebo = p_ContextObject.GetPhName("rapopebo",p_ContextObject.GetCompany(),false);
    m_cServer_rapopebo = p_ContextObject.GetServer("rapopebo");
    m_oWrInfo_rapopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"rapopebo",p_ContextObject.GetCompany());
    m_cVirtName_rapopebo = CPSql.ManipulateTablePhName("rapopebo",m_cServer_rapopebo);
    ...
    ardt_informazioni = new ardt_informazioniBO(p_ContextObject);
    ardt_delegabo = new ardt_delegaboBO(p_ContextObject);
    ardt_soginfo = new ardt_soginfoBO(p_ContextObject);
    ardt_fiduciabo = new ardt_fiduciaboBO(p_ContextObject);
    ardt_terzistirap = new ardt_terzistirapBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_informazioni",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_informazioni.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_informazioni);
    l_bResult = l_bResult || ardt_delegabo.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_delegabo);
    l_bResult = l_bResult || ardt_soginfo.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_soginfo);
    l_bResult = l_bResult || ardt_fiduciabo.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_fiduciabo);
    l_bResult = l_bResult || ardt_terzistirap.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_terzistirap);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    o_FLAGRAP = w_FLAGRAP;
    ardt_informazioni.SaveDependsOn();
    ardt_delegabo.SaveDependsOn();
    ardt_soginfo.SaveDependsOn();
    ardt_fiduciabo.SaveDependsOn();
    ardt_terzistirap.SaveDependsOn();
  }
  ...
  protected boolean Link_UMFEJVRUFZ(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_RAPPORTO))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_anarapbo,"select RAPPORTO,DESCRAP,FLAGLIRE,VALUTA,TIPORAP from "+m_cPhName_anarapbo+((m_cPhName_anarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"RAPPORTO"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            ...
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_anarapbo,"select RAPPORTO,DESCRAP,FLAGLIRE,VALUTA,TIPORAP from "+m_cPhName_anarapbo+((m_cPhName_anarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
  ...
  public boolean Set_closeall(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_closeall = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean getVisible_closeall() {
    return true;
  }
  ...
  public boolean Calculate() {
    ...
    UpdateAutonumber();
    CopyWorkVar(this,ardt_informazioni,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},true);
    CopyWorkVar(this,ardt_delegabo,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},true);
  ...
  void Calculation_EIXZSXFKBS() {
    arrt_copiainformazioneR l_oRoutine_arrt_copiainformazione;
    l_oRoutine_arrt_copiainformazione = arrt_copiainformazioneR.Make(m_Ctx,this);
    l_oRoutine_arrt_copiainformazione.pTipo = "I";
    l_oRoutine_arrt_copiainformazione.Run();
  }
  void Calculation_OEZVQSLBRM() {
    ...
    l_oRoutine_arrt_writelog.pTabella = "RAPOPEBO";
    l_oRoutine_arrt_writelog.pChiave = w_IDBASE;
    l_oRoutine_arrt_writelog.Run();
    arrt_delinformazioneR l_oRoutine_arrt_delinformazione;
    l_oRoutine_arrt_delinformazione = arrt_delinformazioneR.Make(m_Ctx,this);
    l_oRoutine_arrt_delinformazione.Run();
    ...
    l_oRoutine_arrt_ae_agg_aetesta.w_TIPOOPRAP = w_TIPOOPRAP;
    l_oRoutine_arrt_ae_agg_aetesta.w_NUMPROG = w_NUMPROG;
    l_oRoutine_arrt_ae_agg_aetesta.w_DATAOPE = w_DATAOPE;
  ...
  void Calculation_KGBNFVNJHO() {
    ...
    l_oRoutine_arrt_ae_agg_aetesta.w_NUMPROG = w_NUMPROG;
    l_oRoutine_arrt_ae_agg_aetesta.w_DATAOPE = w_DATAOPE;
    l_oRoutine_arrt_ae_agg_aetesta.w_closeall = w_closeall;
    l_oRoutine_arrt_ae_agg_aetesta.Run();
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_informazioni","rapopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_closeall = CPLib.GetProperty(p,"closeall",w_closeall,0);
      m_cWv_ardt_informazioni = CPLib.GetProperty(p,"m_cWv_ardt_informazioni",m_cWv_ardt_informazioni,0);
      m_cWv_ardt_delegabo = CPLib.GetProperty(p,"m_cWv_ardt_delegabo",m_cWv_ardt_delegabo,0);
      m_cWv_ardt_soginfo = CPLib.GetProperty(p,"m_cWv_ardt_soginfo",m_cWv_ardt_soginfo,0);
      m_cWv_ardt_fiduciabo = CPLib.GetProperty(p,"m_cWv_ardt_fiduciabo",m_cWv_ardt_fiduciabo,0);
      m_cWv_ardt_terzistirap = CPLib.GetProperty(p,"m_cWv_ardt_terzistirap",m_cWv_ardt_terzistirap,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("intestbo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("intestbo",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("intestbo\u0000false\u0000false\u00001\u00000\u0000ardt_informazioni\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("soginfo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("soginfo",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("soginfo\u0000false\u0000false\u00001\u00000\u0000ardt_soginfo\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("fiduciabo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("fiduciabo",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("fiduciabo\u0000false\u0000false\u00001\u00000\u0000ardt_fiduciabo\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("terzistirap");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("terzistirap",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("terzistirap\u0000false\u0000false\u00001\u00000\u0000ardt_terzistirap\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("key3\u0000nokey\u0000nokey\u0000nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE\u0000FALSE\u0000FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("\u0000\u0000\u0000\u0000",-1));
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("anarapbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Rapporti in essere\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_informazioni",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_informazioni",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_informazioni = new ardt_informazioniBO(m_Ctx);
    ardt_delegabo = new ardt_delegaboBO(m_Ctx);
    ardt_soginfo = new ardt_soginfoBO(m_Ctx);
    ardt_fiduciabo = new ardt_fiduciaboBO(m_Ctx);
    ardt_terzistirap = new ardt_terzistirapBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_informazioni",m_Ctx);
  ...
  public boolean Check() {
    ...
    if (l_bResult && (( ! (ardt_informazioni.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_informazioni)) || ( ! (ardt_informazioni.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_informazioni)))) {
      ardt_informazioni.SetFromContext(m_cWv_ardt_informazioni);
      m_cWv_ardt_informazioni = "_not_empty_";
    }
    if (l_bResult && (ardt_informazioni.m_bLoaded || ardt_informazioni.m_bUpdated)) {
      l_bResult = l_bResult && ardt_informazioni.Check();
    ...
    if (l_bResult && (( ! (ardt_soginfo.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_soginfo)) || ( ! (ardt_soginfo.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_soginfo)))) {
      ardt_soginfo.SetFromContext(m_cWv_ardt_soginfo);
      m_cWv_ardt_soginfo = "_not_empty_";
    }
    if (l_bResult && (ardt_soginfo.m_bLoaded || ardt_soginfo.m_bUpdated)) {
      l_bResult = l_bResult && ardt_soginfo.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_soginfo.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_fiduciabo.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_fiduciabo)) || ( ! (ardt_fiduciabo.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_fiduciabo)))) {
      ardt_fiduciabo.SetFromContext(m_cWv_ardt_fiduciabo);
      m_cWv_ardt_fiduciabo = "_not_empty_";
    }
    if (l_bResult && (ardt_fiduciabo.m_bLoaded || ardt_fiduciabo.m_bUpdated)) {
      l_bResult = l_bResult && ardt_fiduciabo.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_fiduciabo.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_terzistirap.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_terzistirap)) || ( ! (ardt_terzistirap.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_terzistirap)))) {
      ardt_terzistirap.SetFromContext(m_cWv_ardt_terzistirap);
      m_cWv_ardt_terzistirap = "_not_empty_";
    }
    if (l_bResult && (ardt_terzistirap.m_bLoaded || ardt_terzistirap.m_bUpdated)) {
      l_bResult = l_bResult && ardt_terzistirap.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_informazioni"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_informazioni\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public boolean CanEdit(String p_cState) {
    ...
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile modificare un'operazione già cancellata o copia di modifica";
    }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"PRGINFO1"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_rapopebo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_NUMPROG = m_Ctx.AskTableProg(w_NUMPROG,11,op_NUMPROG,"PRGINFO2"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_rapopebo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PRGIMPINF = m_Ctx.AskTableProg(w_PRGIMPINF,15,op_PRGIMPINF,"PRGIMPINF"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_rapopebo);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"closeall",w_closeall,0);
    if (p_bGetChildren) {
      if (ardt_informazioni.IsUpdated()) {
        m_cWv_ardt_informazioni = ardt_informazioni.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_informazioni",m_cWv_ardt_informazioni,0);
    }
    if (p_bGetChildren) {
    ...
    if (p_bGetChildren) {
      if (ardt_soginfo.IsUpdated()) {
        m_cWv_ardt_soginfo = ardt_soginfo.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_soginfo",m_cWv_ardt_soginfo,0);
    }
    if (p_bGetChildren) {
      if (ardt_fiduciabo.IsUpdated()) {
        m_cWv_ardt_fiduciabo = ardt_fiduciabo.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_fiduciabo",m_cWv_ardt_fiduciabo,0);
    }
    if (p_bGetChildren) {
      if (ardt_terzistirap.IsUpdated()) {
        m_cWv_ardt_terzistirap = ardt_terzistirap.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_terzistirap",m_cWv_ardt_terzistirap,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "rapopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public boolean ChildExists_ardt_informazioni() {
    if (ardt_informazioni.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_informazioni) || CPLib.IsLoaded(m_cWv_ardt_informazioni))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_informazioni.m_bLoaded)) {
      ardt_informazioni.Blank();
      ardt_informazioni.w_RAPPORTO = w_RAPPORTO;
      ardt_informazioni.Load();
    }
    return ardt_informazioni.m_bLoaded;
  }
  public void CtxLoad_ardt_informazioni() {
    if ( ! (ardt_informazioni.m_lCtxLoaded)) {
      ardt_informazioni.Blank();
    }
    ardt_informazioni.m_lCtxLoaded = true;
    if ( ! (ardt_informazioni.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_informazioni) || CPLib.IsLoaded(m_cWv_ardt_informazioni)) {
        ardt_informazioni.SetFromContext(m_cWv_ardt_informazioni);
        m_cWv_ardt_informazioni = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_informazioni.m_bLoaded)) {
          ardt_informazioni.Blank();
          ardt_informazioni.w_RAPPORTO = w_RAPPORTO;
          ardt_informazioni.Load();
          if ( ! (ardt_informazioni.m_bLoaded)) {
            ardt_informazioni.Initialize();
            ardt_informazioni.SetUpdated();
          }
          CopyWorkVar(this,ardt_informazioni,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_informazioni,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},true);
        }
      }
    ...
    if ( ! (ardt_delegabo.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_delegabo) || CPLib.IsLoaded(m_cWv_ardt_delegabo)) {
        ...
        if (m_bLoaded &&  ! (ardt_delegabo.m_bLoaded)) {
          ...
          CopyWorkVar(this,ardt_delegabo,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_delegabo,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},true);
        }
      }
  ...
  public boolean ChildExists_ardt_soginfo() {
    if (ardt_soginfo.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_soginfo) || CPLib.IsLoaded(m_cWv_ardt_soginfo))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_soginfo.m_bLoaded)) {
      ardt_soginfo.Blank();
      ardt_soginfo.w_RAPCOL = w_RAPPORTO;
      ardt_soginfo.Load();
    }
    return ardt_soginfo.m_bLoaded;
  }
  public void CtxLoad_ardt_soginfo() {
    if ( ! (ardt_soginfo.m_lCtxLoaded)) {
      ardt_soginfo.Blank();
    }
    ardt_soginfo.m_lCtxLoaded = true;
    if ( ! (ardt_soginfo.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_soginfo) || CPLib.IsLoaded(m_cWv_ardt_soginfo)) {
        ardt_soginfo.SetFromContext(m_cWv_ardt_soginfo);
        m_cWv_ardt_soginfo = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_soginfo.m_bLoaded)) {
          ardt_soginfo.Blank();
          ardt_soginfo.w_RAPCOL = w_RAPPORTO;
          ardt_soginfo.Load();
          if ( ! (ardt_soginfo.m_bLoaded)) {
            ardt_soginfo.Initialize();
            ardt_soginfo.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_fiduciabo() {
    if (ardt_fiduciabo.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_fiduciabo) || CPLib.IsLoaded(m_cWv_ardt_fiduciabo))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_fiduciabo.m_bLoaded)) {
      ardt_fiduciabo.Blank();
      ardt_fiduciabo.w_RAPCOL = w_RAPPORTO;
      ardt_fiduciabo.Load();
    }
    return ardt_fiduciabo.m_bLoaded;
  }
  public void CtxLoad_ardt_fiduciabo() {
    if ( ! (ardt_fiduciabo.m_lCtxLoaded)) {
      ardt_fiduciabo.Blank();
    }
    ardt_fiduciabo.m_lCtxLoaded = true;
    if ( ! (ardt_fiduciabo.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_fiduciabo) || CPLib.IsLoaded(m_cWv_ardt_fiduciabo)) {
        ardt_fiduciabo.SetFromContext(m_cWv_ardt_fiduciabo);
        m_cWv_ardt_fiduciabo = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_fiduciabo.m_bLoaded)) {
          ardt_fiduciabo.Blank();
          ardt_fiduciabo.w_RAPCOL = w_RAPPORTO;
          ardt_fiduciabo.Load();
          if ( ! (ardt_fiduciabo.m_bLoaded)) {
            ardt_fiduciabo.Initialize();
            ardt_fiduciabo.SetUpdated();
          }
        }
      }
    }
  }
  public boolean ChildExists_ardt_terzistirap() {
    if (ardt_terzistirap.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_terzistirap) || CPLib.IsLoaded(m_cWv_ardt_terzistirap))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_terzistirap.m_bLoaded)) {
      ardt_terzistirap.Blank();
      ardt_terzistirap.w_IDFILEBO = w_IDBASE;
      ardt_terzistirap.Load();
    }
    return ardt_terzistirap.m_bLoaded;
  }
  public void CtxLoad_ardt_terzistirap() {
    if ( ! (ardt_terzistirap.m_lCtxLoaded)) {
      ardt_terzistirap.Blank();
    }
    ardt_terzistirap.m_lCtxLoaded = true;
    if ( ! (ardt_terzistirap.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_terzistirap) || CPLib.IsLoaded(m_cWv_ardt_terzistirap)) {
        ardt_terzistirap.SetFromContext(m_cWv_ardt_terzistirap);
        m_cWv_ardt_terzistirap = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_terzistirap.m_bLoaded)) {
          ardt_terzistirap.Blank();
          ardt_terzistirap.w_IDFILEBO = w_IDBASE;
          ardt_terzistirap.Load();
          if ( ! (ardt_terzistirap.m_bLoaded)) {
            ardt_terzistirap.Initialize();
            ardt_terzistirap.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_informazioni")) {
      CtxLoad_ardt_informazioni();
      return ardt_informazioni;
    }
    if (CPLib.eq(p_cName,"ardt_delegabo")) {
      CtxLoad_ardt_delegabo();
      return ardt_delegabo;
    }
    if (CPLib.eq(p_cName,"ardt_soginfo")) {
      CtxLoad_ardt_soginfo();
      return ardt_soginfo;
    }
    if (CPLib.eq(p_cName,"ardt_fiduciabo")) {
      CtxLoad_ardt_fiduciabo();
      return ardt_fiduciabo;
    }
    if (CPLib.eq(p_cName,"ardt_terzistirap")) {
      CtxLoad_ardt_terzistirap();
      return ardt_terzistirap;
    }
