...
// * --- Fine Area Manuale
public class arrt_imp_dati_wubs_erroriR implements CallerWithObjs {
  ...
  public int riga;
  // * --- Fine Area Manuale
  public arrt_imp_dati_wubs_erroriR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_imp_dati_wubs_errori",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_imp_dati_wubs_errori";
    ...
    if (CPLib.eqr("cell40",p_cVarName)) {
      return cell40;
    }
    if (CPLib.eqr("cell41",p_cVarName)) {
      return cell41;
    }
    ...
    try {
      ...
      try {
        ...
        while ( ! (Cursor_tmp_list_imprich.Eof())) {
          ...
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000009D")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
  ...
  void Page_2() throws Exception {
    ...
    try {
      ...
      // Legge le righe del foglio
        for (int riga = 1 ; riga < sheet.getRows() ; riga++) {
          ...
          if (row.length > 0 && CPLib.LRTrim(row[0].getContents()) != "" ) {
            ...
            cell40=row[39].getContents();
            cell41=row[40].getContents();
            righe++;
      /* If cell39='I' */
      if (CPLib.eqr(cell39,"I")) {
        ...
        /* _causin := '' */
        _causin = "";
        /* gMsgProc := gMsgProc + 'Elaboro operazione N. '+LRTrim(cell06)+" del Customer ID "+LRTrim(cell04) + NL */
        gMsgProc = gMsgProc+"Elaboro operazione N. "+CPLib.LRTrim(cell06)+" del Customer ID "+CPLib.LRTrim(cell04)+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgImp := 'Elaboro operazione N. '+LRTrim(cell06)+" del Customer ID "+LRTrim(cell04) // Messaggio Import */
        gMsgImp = "Elaboro operazione N. "+CPLib.LRTrim(cell06)+" del Customer ID "+CPLib.LRTrim(cell04);
        m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
        ...
        if (CPLib.ge(nVal,_limitesoglia)) {
          ...
          if (CPLib.eqr(CPLib.LRTrim(cell08),"EUR")) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbvalute into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on anarapbo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(cell18)))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbstati into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
              ...
              while ( ! (Cursor_delegabo.Eof())) {
                ...
                if (CPLib.Empty(Cursor_delegabo.GetDate("DATAFINE"))) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on personbo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
          ...
          if (((CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"false") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"falso") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"0")) && CPLib.eqr(CPLib.Left(cell06,3),"TCP"))) {
            ...
            if (CPLib.eqr(CPLib.Upper(CPLib.Left(CPLib.LRTrim(cell23),3)),"086")) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on inter2bo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on operazbo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(_numprog)) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on fraziobo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
          ...
          if (CPLib.Empty(_numprog)) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xperazbo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
          ...
          if (CPLib.Empty(_numprog)) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xraziobo into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
          ...
          /* If (nVal / 100) > _sogliamax and LRTrim(cell40) ='N' */
          if (CPLib.gt((nVal/100),_sogliamax) && CPLib.eqr(CPLib.LRTrim(cell40),"N")) {
          ...
          if (CPLib.Empty(_errore)) {
            ...
            if (CPLib.lt(nVal,_limitesoglia)) {
              /* Exec "Scrive Frazionate" Page 4:WriteFrazionate */
              WriteFrazionate();
            } else { // Else
              /* Exec "Scrive Operazioni" Page 5:WriteOperazioni */
              WriteOperazioni();
            } // End If
          } else { // Else
        ...
        if ( ! (CPLib.Empty(_numprog))) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001A1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          if ( ! (CPLib.Empty(_numprog))) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001A4")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"DATARETT = "+CPLib.ToSQL(CPLib.Date(),"D",8,0)+", ";
            m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("2","C",1,0,m_cServer)+", ";
            ...
            if ( ! (CPLib.Empty(_numprog))) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001A7")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"NUMPROG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_numprog,"?",0,0,m_cServer),m_cServer,_numprog)+"";
              m_cSql = m_cSql+m_oWrInfo.WhereFilter();
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
              ...
              if ( ! (CPLib.Empty(_numprog))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001AA")+"delete from "+m_oWrInfo.GetTableWriteName();
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"NUMPROG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_numprog,"?",0,0,m_cServer),m_cServer,_numprog)+"";
                m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
  ...
  void Page_3() throws Exception {
    ...
    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001E2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
    m_cSql = m_cSql+GetFieldsName_000001E2(m_Ctx,m_oWrInfo);
  ...
  void WriteFrazionate() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001E8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(_rappd,"D")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001EC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001ED")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_xntestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001F1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientifrz",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001F2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000001F2(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
        ...
        if ((CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"false") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"falso") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"0")) && CPLib.ne(CPLib.Upper(CPLib.Left(cell06,3)),"TCP")) {
            ...
            while ( ! (Cursor_intestbo.Eof())) {
              ...
              while ( ! (Cursor_personbo.Eof())) {
                ...
                if (CPLib.eqr(nIntest,1)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001FA")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000001FB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_000001FB(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            while ( ! (Cursor_xntestbo.Eof())) {
              ...
              while ( ! (Cursor_personbo.Eof())) {
                ...
                if (CPLib.eqr(nIntest,1)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000200")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xeneficfrz",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000201")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(CPLib.Upper(CPLib.Left(CPLib.LRTrim(cell18),3)),"086")) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_imp_dati_wubs_errori returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000020D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        if (CPLib.eqr(CPLib.LRTrim(cell01),"554")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000213")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(_rappd,"D")) {
            ...
            while ( ! (Cursor_intestbo.Eof())) {
              ...
              if (CPLib.eqr(nIntest,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000217")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientifrz",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000218")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_xntestbo.Eof())) {
              ...
              if (CPLib.eqr(nIntest,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000021C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientifrz",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000021D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000223")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000223(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Year(CPLib.CharToDate(xData)),"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(nChVal,"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        ...
        while ( ! (Cursor_intestbo.Eof())) {
          ...
          if (CPLib.eqr(nIntest,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000226")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000227")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if ((CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"false") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"falso") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"0")) && CPLib.ne(CPLib.Upper(CPLib.Left(cell06,3)),"TCP")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            while ( ! (Cursor_personbo.Eof())) {
              ...
              if (CPLib.eqr(nIntest,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000022E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000022F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000023B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(_crag,"C",70,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(_csta,"C",3,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(cell17),30),"C",30,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_PRV = "+CPLib.ToSQL(_cprov,"C",2,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.LRTrim(cell01),"554")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000241")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000244")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000245")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void WriteOperazioni() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000024C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(_rappd,"D")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000250")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000251")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_xntestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000255")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientiope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000256")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if ((CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"false") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"falso") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"0")) && CPLib.ne(CPLib.Upper(CPLib.Left(cell06,3)),"TCP")) {
            ...
            while ( ! (Cursor_intestbo.Eof())) {
              ...
              while ( ! (Cursor_personbo.Eof())) {
                ...
                if (CPLib.eqr(nIntest,1)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000025E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000025F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_xntestbo.Eof())) {
              ...
              while ( ! (Cursor_personbo.Eof())) {
                ...
                if (CPLib.eqr(nIntest,1)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000264")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xeneficope",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000265")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000271")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(_crag,"C",70,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(_csta,"C",3,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(cell17),30),"C",30,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_PRV = "+CPLib.ToSQL(_cprov,"C",2,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.LRTrim(cell01),"554")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000277")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(_rappd,"D")) {
            ...
            while ( ! (Cursor_intestbo.Eof())) {
              ...
              if (CPLib.eqr(nIntest,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000027B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientiope",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000027C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_xntestbo.Eof())) {
              ...
              if (CPLib.eqr(nIntest,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000280")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientiope",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000281")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000287")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000287(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Year(CPLib.CharToDate(xData)),"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(nChVal,"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        ...
        while ( ! (Cursor_intestbo.Eof())) {
          ...
          if (CPLib.eqr(nIntest,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000028A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000028B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if ((CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"false") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"falso") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(cell07)),"0")) && CPLib.ne(CPLib.Upper(CPLib.Left(cell06,3)),"TCP")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            while ( ! (Cursor_personbo.Eof())) {
              ...
              if (CPLib.eqr(nIntest,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000292")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"00000293")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000293(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"0000029F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(_crag,"C",70,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(_csta,"C",3,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(cell17),30),"C",30,0,m_cServer)+", ";
          m_cSql = m_cSql+"C_PRV = "+CPLib.ToSQL(_cprov,"C",2,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.LRTrim(cell01),"554")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000002A5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000002A8")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_dati_wubs_errori",865,"000002A9")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  public static arrt_imp_dati_wubs_erroriR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_imp_dati_wubs_erroriR(p_Ctx, p_Caller);
  }
  public static arrt_imp_dati_wubs_erroriR Make(CPContext p_Ctx) {
    return new arrt_imp_dati_wubs_erroriR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
    ...
    cell40 = CPLib.Space(0);
    cell41 = CPLib.Space(0);
  ...
  // ENTITY_BATCHES: ,arfn_chksogg,arfn_fdatetime,arrt_imp_dati_wubs_errori,
  public static final String i_InvokedRoutines = ",arfn_chksogg,arfn_fdatetime,arrt_imp_dati_wubs_errori,";
  public static String[] m_cRunParameterNames={"w_tipodest"};
  protected static String GetFieldsName_000001E2(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000001F2(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000001FB(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000223(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"ANNOOPE,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
  ...
  protected static String GetFieldsName_00000287(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"ANNOOPE,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
  ...
  protected static String GetFieldsName_00000293(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
