...
public class arpg_stprappo_sint_aeBL extends arpg_stprappo_sint_aeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stprappo_sint_ae";
  ...
  public arpg_stprappo_sint_aeBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_UYVYTEMEXX(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_daRappo))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daRappo,"C",25,0),m_cServer_jnarapbo,w_daRappo);
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daRappo,"C",50,0),m_cServer_jnarapbo,w_daRappo);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_jnarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_jnarapbo+((m_cPhName_jnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
  ...
  protected boolean Link_CJWUHWULAR(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_aRappo))) {
      ...
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aRappo,"C",25,0),m_cServer_jnarapbo,w_aRappo);
      if (m_Ctx.IsSharedTemp("jnarapbo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aRappo,"C",50,0),m_cServer_jnarapbo,w_aRappo);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_jnarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_jnarapbo+((m_cPhName_jnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stprappo_sint_ae","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.value",zeroSplit.split("jnarapbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Rapporti Continuativi AE\u0000\u0000\u0000false",-1));
