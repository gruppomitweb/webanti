...
l_oWv.setValue('ReportName',AsAppletValue('arrp_chkopx_anno'));
l_oWv.setValue('rotation',AsAppletValue('PORTRAIT'));
...
w_Messaggi.raiseEvent('arpg_chkope_anno_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_chkope_anno_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_chkope_anno',m_cSelectedPage);
