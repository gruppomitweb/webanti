...
if ( ! (m_oFather.SaveContext_ardt_wlientifrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_wlientifrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_wlientifrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_wlientifrz();
}
}
SaveContext.child=[];
function BlankRow() {
