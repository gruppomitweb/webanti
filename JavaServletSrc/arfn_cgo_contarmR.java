...
// * --- Fine Area Manuale
public class arfn_cgo_contarmR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_cgo_contarmR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_cgo_contarm",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      Cursor_cgo_operazioni_storico_multi = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select CPROWNUM  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(pOpe,"?",0,0,m_cServer, m_oParameters),m_cServer,pOpe)+" "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_storico_multi")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
  ...
  public String RunAsync(String p_pOpe) {
    pOpe = p_pOpe;
  ...
  public double Run(String p_pOpe) {
    pOpe = p_pOpe;
    return Run();
  }
  public double Run() {
  ...
  public static arfn_cgo_contarmR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_cgo_contarmR(p_Ctx, p_Caller);
  }
  public static arfn_cgo_contarmR Make(CPContext p_Ctx) {
    return new arfn_cgo_contarmR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
    pOpe = CPLib.Space(15);
    nRitorno = 0;
  ...
  // ENTITY_BATCHES: ,arfn_cgo_contarm,
  public static final String i_InvokedRoutines = ",arfn_cgo_contarm,";
  public static String[] m_cRunParameterNames={"pOpe"};
}
