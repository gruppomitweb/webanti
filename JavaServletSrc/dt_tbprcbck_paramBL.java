...
public class dt_tbprcbck_paramBL extends dt_tbprcbck_paramWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_PPDESCRI;
    public String w_PPTIPPAR;
    public String w_PPVALPAR;
  ...
  public static final String i_EntityName = "dt_tbprcbck_param";
  ...
  public CPPhTableWrInfo m_oWrInfo_tbprcbck_param;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_tbprcbck_param;
  ...
  public static String[] m_EntityTables = {"tbprcbck_param"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'PPCODICE':PPCODICE,'m_Detail':{'PPDESCRI':PPDESCRI,'PPTIPPAR':PPTIPPAR,'PPVALPAR':PPVALPAR,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("dt_tbprcbck_param",true,true)+"}"+FoundlingChildrenList("dt_tbprcbck_param",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'PPCODICE':PPCODICE,'m_Detail':{'PPDESCRI':PPDESCRI,'PPTIPPAR':PPTIPPAR,'PPVALPAR':PPVALPAR,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("dt_tbprcbck_param",true,true)+"}"+FoundlingChildrenList("dt_tbprcbck_param",true,false)+"}";
  public static final String i_ItemSequence = "PPCODICE,m_Detail[ PPDESCRI PPTIPPAR PPVALPAR CPROWNUM"+FoundlingChildrenList("dt_tbprcbck_param",false,true)+"]"+FoundlingChildrenList("dt_tbprcbck_param",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("dt_tbprcbck_param"),new String[][]{new String[]{"PPCODICE","","N","10","0","campo","key1","false","false"},new String[]{"PPDESCRI","Descrizione","C","50","0","campo","nokey","true","false"},new String[]{"PPTIPPAR","Tipo (Stringa,Double,Int)","C","1","0","campo","nokey","true","false"},new String[]{"PPVALPAR","Valore","C","20","0","campo","nokey","true","false"},new String[]{"CPROWNUM","","N","3","0","campo","key1","true","false"}});
  ...
  public int m_nCPRowNum;
  public dt_tbprcbck_paramBL (CPContext p_ContextObject) {
    ...
    m_cPhName_tbprcbck_param = p_ContextObject.GetPhName("tbprcbck_param",p_ContextObject.GetCompany(),false);
    m_cServer_tbprcbck_param = p_ContextObject.GetServer("tbprcbck_param");
    m_oWrInfo_tbprcbck_param = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"tbprcbck_param",p_ContextObject.GetCompany());
    m_cVirtName_tbprcbck_param = CPSql.ManipulateTablePhName("tbprcbck_param",m_cServer_tbprcbck_param);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("dt_tbprcbck_param",p_ContextObject);
  }
  public void Blank() {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_PPCODICE(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_PPCODICE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_PPDESCRI(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_PPDESCRI = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_PPTIPPAR(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_PPTIPPAR = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_PPVALPAR(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_PPVALPAR = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"PPCODICE"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("dt_tbprcbck_param","tbprcbck_param",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_PPDESCRI;
      p_PPDESCRI = CPLib.GetProperties(trs_p.getProperty("PPDESCRI"),new Properties());
      Properties p_PPTIPPAR;
      p_PPTIPPAR = CPLib.GetProperties(trs_p.getProperty("PPTIPPAR"),new Properties());
      Properties p_PPVALPAR;
      p_PPVALPAR = CPLib.GetProperties(trs_p.getProperty("PPVALPAR"),new Properties());
      ...
      w_PPCODICE = CPLib.GetProperty(p,"PPCODICE",w_PPCODICE,0);
      ...
      while (CPLib.le(i,rows)) {
        w_PPDESCRI = "";
        w_PPDESCRI = CPLib.GetProperty(p_PPDESCRI,"",w_PPDESCRI,i);
        w_PPTIPPAR = "";
        w_PPTIPPAR = CPLib.GetProperty(p_PPTIPPAR,"",w_PPTIPPAR,i);
        w_PPVALPAR = "";
        w_PPVALPAR = CPLib.GetProperty(p_PPVALPAR,"",w_PPVALPAR,i);
        w_CPROWNUM = 0;
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"PPCODICE")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"PPDESCRI")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"PPTIPPAR")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"PPVALPAR")) {
      SetUpdatedRow();
      return;
    }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("dt_tbprcbck_param",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("dt_tbprcbck_param",child);
    ...
    for(String child : CPLib.LoadableMNTs("dt_tbprcbck_param",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("dt_tbprcbck_param",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"dt_tbprcbck_param"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"dt_tbprcbck_param\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_PPDESCRI;
    p_PPDESCRI = new Properties();
    Properties p_PPTIPPAR;
    p_PPTIPPAR = new Properties();
    Properties p_PPVALPAR;
    p_PPVALPAR = new Properties();
    Properties p_CPROWNUM;
    ...
    CPLib.PutProperty(p,"PPCODICE",w_PPCODICE,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_PPDESCRI,"",w_PPDESCRI,trsrow);
      CPLib.PutProperty(p_PPTIPPAR,"",w_PPTIPPAR,trsrow);
      CPLib.PutProperty(p_PPVALPAR,"",w_PPVALPAR,trsrow);
    ...
    trs_p.setProperty("PPDESCRI",CPLib.ToProperties(p_PPDESCRI));
    trs_p.setProperty("PPTIPPAR",CPLib.ToProperties(p_PPTIPPAR));
    trs_p.setProperty("PPVALPAR",CPLib.ToProperties(p_PPVALPAR));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "tbprcbck_param"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("PPCODICE","N",10,0));
  }
  public String RowPrimaryKey() {
    return "tbprcbck_param"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
  ...
  protected void TrsToWork() {
    w_PPDESCRI= m_oTrs.get(m_nCurrentRow).w_PPDESCRI;
    w_PPTIPPAR= m_oTrs.get(m_nCurrentRow).w_PPTIPPAR;
    w_PPVALPAR= m_oTrs.get(m_nCurrentRow).w_PPVALPAR;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_PPDESCRI=w_PPDESCRI;
    m_oTrs.get(m_nCurrentRow).w_PPTIPPAR=w_PPTIPPAR;
    m_oTrs.get(m_nCurrentRow).w_PPVALPAR=w_PPVALPAR;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_PPDESCRI=w_PPDESCRI;
    m_oDeletedRows.get(l_nRows).w_PPTIPPAR=w_PPTIPPAR;
    m_oDeletedRows.get(l_nRows).w_PPVALPAR=w_PPVALPAR;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_PPDESCRI= m_oDeletedRows.get(l_RowNumberToSet).w_PPDESCRI;
    w_PPTIPPAR= m_oDeletedRows.get(l_RowNumberToSet).w_PPTIPPAR;
    w_PPVALPAR= m_oDeletedRows.get(l_RowNumberToSet).w_PPVALPAR;
