...
public class armt_ofrazionate extends SPServlet implements SPInvokable {
  public static String m_cEntityUid = "!*9462ddc4*!";
  static public class ServletStatus extends SPMasterServletStatus {
    ServletStatus() {
      m_cAllVirtNames = "fraziobo";
    }
    public String w_IDBASE;
    public void BuildLastWhereFromPK() {
      if (CPLib.Empty(m_cLastWhere)) {
        m_cLastWhere = m_cLastWhere+CPLib.BuildLastWhereFromPK(w_IDBASE,context,"fraziobo","IDBASE","C",10,0,( ! (CPLib.Empty(m_cLastWhere))?" and ":""));
      }
    }
    void FillParameters() {
  ...
  public void doProcess(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
    ...
    armt_ofrazionateBO BO;
    BO = getBO(status);
    BO.m_bSkipCheckOTPSecurity = false;
    status.m_cVirtName = BO.m_cVirtName_fraziobo;
  ...
  public String getEntityTitle() {
    return "Frazionate (A.U.I.)";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "armt_ofrazionate";
    l_eg.userName = getEntityTitle();
    l_eg.m_nEntityWidth = 1293;
    l_eg.m_nEntityHeight = 835;
    l_eg.isPublic = false;
    l_eg.canAccess = true;
    l_eg.canInsert = true;
    l_eg.canChange = true;
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,armt_ofrazionateBO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"11004525328",p_Context.Translate("Impossibile cancellare un'operazione frazionata già cancellata o copia di modifica")},
    ...
    {"11115366573",p_Context.Translate("Frazionate (A.U.I.)")},
    ...
    {"453648321",p_Context.Translate("Impossibile modificare un'operazione frazionata già cancellata o copia di modifica")},
  ...
  void WriteStyles(armt_ofrazionateBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='../armt_ofrazionate.css?"+m_cEntityUid+"'>" +
      "");
    }
  ...
  void WriteMainForm(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println("Z.Tabs.Get('tabs').InitSelect('armt_ofrazionate',false);");
    status.out.println(
     "</script>" +
    "");
    PrintPwdOTPDiv(status,"armt_ofrazionate",BO.m_bLoaded,(BO.m_bLoaded?false:false),(BO.m_bLoaded?false:false));
    status.out.println(
     "</div>" +
    "");
  }
  void WriteControls(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_1' class='PageContainer' style='position:relative;height:835px;width:1293px;display:none'>" +
    "");
  ...
  void WriteControls_p2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='page_3' class='PageContainer' style='position:relative;height:1105px;width:1293px;display:none'>" +
    "");
  ...
  void WriteControls_p4(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p5(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p7(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b2_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b3(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b4(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b4_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b5(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b6(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b6_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b7(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b8(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b8_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b9(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b10(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p1_b10_1(armt_ofrazionateBO BO,ServletStatus status) {
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p1_b10_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b11(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p1_b12(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div name='Rettifiche' id='KURTXQHCYE_DIV' class='BoxContainer SPSection_expanded SectionContainerWithTitle'>" +
    "");
    if (CPLib.eq(status.GetBoxHeaderInclude(),"")) {
      status.out.println(
    ...
    status.out.println(
     "<div id='KURTXQHCYE' class='SectionBody' style='position:relative;height:31px;display:block'>" +
    "");
    status.includeZoneAltInterface("Rettifiche@BEGIN");
    if (status.includeZoneAltInterface("Rettifiche")) {
      WriteControls_p1_b12_CloseBand(BO,status);
    } else {
      if (status.HasZoneAltInterface("Rettifiche@BEGIN") || status.HasZoneAltInterface("Rettifiche@END")) {
        status.out.println(
         "<div id='KURTXQHCYE_boxContent' style='position:relative;height:31px;display:block'>" +
        "");
      }
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
  ...
  void WriteControls_p1_b12_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
    status.includeZoneAltInterface("Rettifiche@END");
    status.out.println(
     "</div>" +
    "");
    status.out.println(
    ...
    status.out.println(
     "<script>" +
    "");
    if (status.HasZoneAnyAltInterface("Rettifiche")) {
      status.out.println("Ctrl('KURTXQHCYE').style.height='auto';");
    } else {
      status.out.println("Ctrl('KURTXQHCYE').setAttribute('band_height',31);");
    }
  ...
  void WriteControls_p1_b13(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p2_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b2(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("AltriIntestatari")) {
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['BDZUATYPMW']=['band_2_46','KYBHVGCEJO','band_2_270','XVSFEWJZNA','band_2_488'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriIntestatari@BEGIN") || status.HasZoneAltInterface("AltriIntestatari@END")) {
  ...
  void WriteControls_p2_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p2_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("Intestatari Operazioni diverso da statoreg 3")) {
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['KYBHVGCEJO']=['band_2_51','band_2_57','band_2_262'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("Intestatari Operazioni diverso da statoreg 3@BEGIN") || status.HasZoneAltInterface("Intestatari Operazioni diverso da statoreg 3@END")) {
  ...
  void WriteControls_p2_b3_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b3_b1_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_51' style='position:relative;height:6px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b3_b1_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_clientifrz' id='BOAFVDQFRN' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
  ...
  void WriteControls_p2_b3_b1_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_262' style='position:relative;height:8px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_270' style='position:relative;height:2px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b3_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("Intestatari Operazioni uguale a statoreg 3")) {
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['XVSFEWJZNA']=['band_2_272','band_2_277','band_2_482'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("Intestatari Operazioni uguale a statoreg 3@BEGIN") || status.HasZoneAltInterface("Intestatari Operazioni uguale a statoreg 3@END")) {
  ...
  void WriteControls_p2_b3_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b3_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_272' style='position:relative;height:5px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b3_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_277' style='position:relative;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_mlientifrz' id='VTDYLKLZYX' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_2_277']=['VTDYLKLZYX'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p2_b3_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_482' style='position:relative;height:6px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b3_b4(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_488' style='position:relative;height:7px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b4(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b5(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("AltriEsecutori")) {
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['ZYUUSRMPQG']=['band_2_497','XJNRVUSEVC','band_2_667','UZFRPBBNAH','band_2_837'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriEsecutori@BEGIN") || status.HasZoneAltInterface("AltriEsecutori@END")) {
  ...
  void WriteControls_p2_b5_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b5_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_497' style='position:relative;height:4px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b5_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("Soggetti Agenti per Conto Oper. diverso da statoreg 3")) {
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['XJNRVUSEVC']=['band_2_501','band_2_506','band_2_661'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("Soggetti Agenti per Conto Oper. diverso da statoreg 3@BEGIN") || status.HasZoneAltInterface("Soggetti Agenti per Conto Oper. diverso da statoreg 3@END")) {
  ...
  void WriteControls_p2_b5_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b5_b1_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_501' style='position:relative;height:5px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b5_b1_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_506' style='position:relative;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_sogopefraz' id='TQDGESLQVD' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_2_506']=['TQDGESLQVD'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p2_b5_b1_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_661' style='position:relative;height:6px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b5_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_667' style='position:relative;height:2px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b5_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("Soggetti Agenti per Conto Oper. uguale a statoreg 3")) {
      ...
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['UZFRPBBNAH']=['band_2_669','band_2_675','band_2_830'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("Soggetti Agenti per Conto Oper. uguale a statoreg 3@BEGIN") || status.HasZoneAltInterface("Soggetti Agenti per Conto Oper. uguale a statoreg 3@END")) {
  ...
  void WriteControls_p2_b5_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p2_b5_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_669' style='position:relative;height:6px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b5_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_675' style='position:relative;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_mogopefbo' id='CHLTBGCVDY' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_2_675']=['CHLTBGCVDY'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p2_b5_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_830' style='position:relative;height:7px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b5_b4(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_2_837' style='position:relative;height:9px;display:block' page='2'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p2_b6(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p3_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b2(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("AltreControparti")) {
      ...
      WriteControls_p3_b3_b3(BO,status);
      WriteControls_p3_b3_b4(BO,status);
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['GTSBULOFTD']=['band_3_46','DOUBCEKLZK','band_3_300','HTFNVDSDLI','band_3_552'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltreControparti@BEGIN") || status.HasZoneAltInterface("AltreControparti@END")) {
  ...
  void WriteControls_p3_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_46' style='position:relative;height:4px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("AltriSogTerzi diverso da statoreg 3")) {
      WriteControls_p3_b3_b1_CloseBand(BO,status);
    } else {
      ...
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      WriteControls_p3_b3_b1_b0(BO,status);
      WriteControls_p3_b3_b1_b1(BO,status);
      WriteControls_p3_b3_b1_b2(BO,status);
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['DOUBCEKLZK']=['band_3_50','band_3_55','band_3_294'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriSogTerzi diverso da statoreg 3@BEGIN") || status.HasZoneAltInterface("AltriSogTerzi diverso da statoreg 3@END")) {
  ...
  void WriteControls_p3_b3_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b3_b1_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_50' style='position:relative;height:5px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b3_b1_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_beneficfrz' id='OCTDIOXFMI' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
  ...
  void WriteControls_p3_b3_b1_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_294' style='position:relative;height:6px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_300' style='position:relative;height:1px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b3_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("AltriSogTerzi uguale da statoreg 3")) {
      WriteControls_p3_b3_b3_CloseBand(BO,status);
    } else {
      ...
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      WriteControls_p3_b3_b3_b0(BO,status);
      WriteControls_p3_b3_b3_b1(BO,status);
      WriteControls_p3_b3_b3_b2(BO,status);
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['HTFNVDSDLI']=['band_3_301','band_3_305','band_3_544'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriSogTerzi uguale da statoreg 3@BEGIN") || status.HasZoneAltInterface("AltriSogTerzi uguale da statoreg 3@END")) {
  ...
  void WriteControls_p3_b3_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b3_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_301' style='position:relative;height:4px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b3_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_305' style='position:relative;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_meneficfrz' id='OZFWYFQQTV' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_3_305']=['OZFWYFQQTV'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p3_b3_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_544' style='position:relative;height:8px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b3_b4(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_552' style='position:relative;height:3px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b4(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b5(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("AltriSoggTerzi")) {
      ...
      WriteControls_p3_b5_b3(BO,status);
      WriteControls_p3_b5_b4(BO,status);
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['BHLGNNSXQY']=['band_3_556','QNQPIPOVDE','band_3_795','WNXNBDZSBN','band_3_1034'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriSoggTerzi@BEGIN") || status.HasZoneAltInterface("AltriSoggTerzi@END")) {
  ...
  void WriteControls_p3_b5_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p3_b5_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_556' style='position:relative;height:4px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b5_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.includeZoneAltInterface("AltriSogTerzi diverso da statoreg 3@BEGIN");
    if (status.includeZoneAltInterface("AltriSogTerzi diverso da statoreg 3")) {
      WriteControls_p3_b5_b1_CloseBand(BO,status);
    } else {
      if (status.HasZoneAltInterface("AltriSogTerzi diverso da statoreg 3@BEGIN") || status.HasZoneAltInterface("AltriSogTerzi diverso da statoreg 3@END")) {
        status.out.println(
      ...
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      WriteControls_p3_b5_b1_b0(BO,status);
      WriteControls_p3_b5_b1_b1(BO,status);
      WriteControls_p3_b5_b1_b2(BO,status);
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['QNQPIPOVDE']=['band_3_560','band_3_564','band_3_790'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriSogTerzi diverso da statoreg 3@BEGIN") || status.HasZoneAltInterface("AltriSogTerzi diverso da statoreg 3@END")) {
  ...
  void WriteControls_p3_b5_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
    status.includeZoneAltInterface("AltriSogTerzi diverso da statoreg 3@END");
    status.out.println(
     "</div>" +
    "");
  ...
  void WriteControls_p3_b5_b1_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_560' style='position:relative;height:4px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b5_b1_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_564' style='position:relative;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_terzistifrz' id='NOKYMTFBFL' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_3_564']=['NOKYMTFBFL'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p3_b5_b1_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_790' style='position:relative;height:5px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b5_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_795' style='position:relative;height:1px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b5_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.includeZoneAltInterface("AltriSogTerzi uguale da statoreg 3@BEGIN");
    if (status.includeZoneAltInterface("AltriSogTerzi uguale da statoreg 3")) {
      WriteControls_p3_b5_b3_CloseBand(BO,status);
    } else {
      if (status.HasZoneAltInterface("AltriSogTerzi uguale da statoreg 3@BEGIN") || status.HasZoneAltInterface("AltriSogTerzi uguale da statoreg 3@END")) {
        status.out.println(
      ...
      CPResultSet l_rsLoad=null;
      VQRHolder l_VQRHolder=null;
      WriteControls_p3_b5_b3_b0(BO,status);
      WriteControls_p3_b5_b3_b1(BO,status);
      WriteControls_p3_b5_b3_b2(BO,status);
      status.out.println(
       "<script>" +
      "");
      status.out.println("ToggleCollapsibleBox.subBands['WNXNBDZSBN']=['band_3_796','band_3_802','band_3_1028'];");
      status.out.println(
       "</script>" +
      "");
      if (status.HasZoneAltInterface("AltriSogTerzi uguale da statoreg 3@BEGIN") || status.HasZoneAltInterface("AltriSogTerzi uguale da statoreg 3@END")) {
  ...
  void WriteControls_p3_b5_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
    status.includeZoneAltInterface("AltriSogTerzi uguale da statoreg 3@END");
    status.out.println(
     "</div>" +
    "");
  ...
  void WriteControls_p3_b5_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_796' style='position:relative;height:6px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b5_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_802' style='position:relative;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='ardt_merzistifrz' id='LUESWSIYXN' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
    ...
    status.out.println(
     "<script>" +
    "");
    status.out.println("ToggleCollapsibleBox.children['band_3_802']=['LUESWSIYXN'];");
    status.out.println(
     "</script>" +
    "");
  }
  void WriteControls_p3_b5_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_1028' style='position:relative;height:6px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b5_b4(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<div id='band_3_1034' style='position:relative;height:6px;display:block' page='3'>" +
    "");
    CPResultSet l_rsLoad=null;
    VQRHolder l_VQRHolder=null;
    status.out.println(
  ...
  void WriteControls_p3_b6(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b2(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b4(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b5(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b5_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b6(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b7(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b7_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b8(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b9(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b9_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b10(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b11(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b11_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b12(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b13(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p4_b13_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p4_b14(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p5_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p5_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p5_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p5_b2(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p5_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p5_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p5_b3_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p5_b3_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p5_b3_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p5_b4(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b2(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b3(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6_b3_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b4(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b5(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6_b5_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b6(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b7(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6_b7_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p6_b7_b0(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6_b7_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
     "<iframe name='armt_fraziobo_agg' id='RZOXJTRIYP' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
     "</iframe>" +
    "");
    status.out.println(
     "</div>" +
  ...
  void WriteControls_p6_b7_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p6_b8(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p7_b0(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p7_b1(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls_p7_b1_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p7_b2(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
    ...
    if (status.includeZoneAltInterface("Contante")) {
      ...
      status.m_nTabIndex = status.m_nTabIndex+(1);
      status.out.println(
       "<iframe name='ardt_frz_contante' id='QMSPZAQYXJ' frameborder='0' allowtransparency='true' toResize='no' tabindex='"+status.m_nTabIndex+"' src='javascript:[].join()'>" +
       "</iframe>" +
      "");
      if (status.HasZoneAltInterface("Contante@BEGIN") || status.HasZoneAltInterface("Contante@END")) {
        status.out.println(
  ...
  void WriteControls_p7_b2_CloseBand(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteControls_p7_b3(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  static void PrintState(armt_ofrazionateBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(armt_ofrazionateBL BO,ServletStatus status) {
    PrintMNTState(status,BO,BO.m_MNTs);
    if (BO.ardt_clientifrz.IsUpdated()) {
      BO.m_cWv_ardt_clientifrz = BO.ardt_clientifrz.GetContext();
    }
    if (BO.ardt_mlientifrz.IsUpdated()) {
      BO.m_cWv_ardt_mlientifrz = BO.ardt_mlientifrz.GetContext();
    }
    if (BO.ardt_sogopefraz.IsUpdated()) {
      BO.m_cWv_ardt_sogopefraz = BO.ardt_sogopefraz.GetContext();
    }
    if (BO.ardt_mogopefbo.IsUpdated()) {
      BO.m_cWv_ardt_mogopefbo = BO.ardt_mogopefbo.GetContext();
    }
    if (BO.ardt_meneficfrz.IsUpdated()) {
      BO.m_cWv_ardt_meneficfrz = BO.ardt_meneficfrz.GetContext();
    }
    if (BO.ardt_beneficfrz.IsUpdated()) {
      BO.m_cWv_ardt_beneficfrz = BO.ardt_beneficfrz.GetContext();
    }
    if (BO.ardt_terzistifrz.IsUpdated()) {
      BO.m_cWv_ardt_terzistifrz = BO.ardt_terzistifrz.GetContext();
    }
    if (BO.ardt_merzistifrz.IsUpdated()) {
      BO.m_cWv_ardt_merzistifrz = BO.ardt_merzistifrz.GetContext();
    }
    if (BO.ardt_docfrabo.IsUpdated()) {
      BO.m_cWv_ardt_docfrabo = BO.ardt_docfrabo.GetContext();
    }
    if (BO.armt_fraziobo_agg.IsUpdated()) {
      BO.m_cWv_armt_fraziobo_agg = BO.armt_fraziobo_agg.GetContext();
    }
    if (BO.ardt_frz_contante.IsUpdated()) {
      BO.m_cWv_ardt_frz_contante = BO.ardt_frz_contante.GetContext();
    }
  }
  static void PrintStateWorkVars(armt_ofrazionateBL BO,ServletStatus status) {
    ...
    if (CPLib.eq(BO.m_cWv_ardt_clientifrz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_clientifrz");
    } else if (CPLib.eq(BO.m_cWv_ardt_clientifrz,"_not_empty_")) {
      BO.m_cWv_ardt_clientifrz = BO.ardt_clientifrz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_clientifrz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_clientifrz,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_mlientifrz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_mlientifrz");
    } else if (CPLib.eq(BO.m_cWv_ardt_mlientifrz,"_not_empty_")) {
      BO.m_cWv_ardt_mlientifrz = BO.ardt_mlientifrz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_mlientifrz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_mlientifrz,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_sogopefraz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_sogopefraz");
    } else if (CPLib.eq(BO.m_cWv_ardt_sogopefraz,"_not_empty_")) {
      BO.m_cWv_ardt_sogopefraz = BO.ardt_sogopefraz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_sogopefraz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_sogopefraz,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_mogopefbo,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_mogopefbo");
    } else if (CPLib.eq(BO.m_cWv_ardt_mogopefbo,"_not_empty_")) {
      BO.m_cWv_ardt_mogopefbo = BO.ardt_mogopefbo.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_mogopefbo,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_mogopefbo,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_meneficfrz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_meneficfrz");
    } else if (CPLib.eq(BO.m_cWv_ardt_meneficfrz,"_not_empty_")) {
      BO.m_cWv_ardt_meneficfrz = BO.ardt_meneficfrz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_meneficfrz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_meneficfrz,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_beneficfrz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_beneficfrz");
    } else if (CPLib.eq(BO.m_cWv_ardt_beneficfrz,"_not_empty_")) {
      BO.m_cWv_ardt_beneficfrz = BO.ardt_beneficfrz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_beneficfrz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_beneficfrz,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_terzistifrz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_terzistifrz");
    } else if (CPLib.eq(BO.m_cWv_ardt_terzistifrz,"_not_empty_")) {
      BO.m_cWv_ardt_terzistifrz = BO.ardt_terzistifrz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_terzistifrz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_terzistifrz,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_merzistifrz,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_merzistifrz");
    } else if (CPLib.eq(BO.m_cWv_ardt_merzistifrz,"_not_empty_")) {
      BO.m_cWv_ardt_merzistifrz = BO.ardt_merzistifrz.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_merzistifrz,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_merzistifrz,"C",0,0));
    }
    ...
    if (CPLib.eq(BO.m_cWv_armt_fraziobo_agg,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_armt_fraziobo_agg");
    } else if (CPLib.eq(BO.m_cWv_armt_fraziobo_agg,"_not_empty_")) {
      BO.m_cWv_armt_fraziobo_agg = BO.armt_fraziobo_agg.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_armt_fraziobo_agg,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_armt_fraziobo_agg,"C",0,0));
    }
    if (CPLib.eq(BO.m_cWv_ardt_frz_contante,"_not_empty_") && status.m_bBrowserUpdate) {
      status.out.print(","+"m_cWv_ardt_frz_contante");
    } else if (CPLib.eq(BO.m_cWv_ardt_frz_contante,"_not_empty_")) {
      BO.m_cWv_ardt_frz_contante = BO.ardt_frz_contante.GetContext();
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_frz_contante,"C",0,0));
    } else {
      status.out.print(","+SPLib.ToJSValue(BO.m_cWv_ardt_frz_contante,"C",0,0));
    }
  ...
  void WriteMainFormVarScript(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    if ( ! (SPLib.IsMobile(status.request))) {
      status.out.println("var m_nPreferredHeight = " + SPLib.ToJSValue(835,"N",0,0)+ ";");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"armt_ofrazionate"),"C",0,0)+ ";");
    ...
    status.out.println("var m_cProgNameAlter = " + SPLib.ToJSValue("armt_ofrazionate","C",0,0)+ ";");
    // hide e disable di pagine ed item
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"armt_ofrazionate",BO.GetCurrentState());
    ...
    if (CPLib.eq(status.GetZoneAltInterface("Rettifiche"),"")) {
      status.quoteAndAppend("Rettifiche","hide","box");
    }
  ...
  void WriteMainFormScript(armt_ofrazionateBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    if ( ! (CPLib.Empty(status.m_cAltInterface))) {
      ...
      status.out.println("}");
      status.out.println("if (Ctrl('VTDYLKLZYX')) {");
      status.out.println("ChangeIframeSrcWithoutPushingHistory('VTDYLKLZYX',linkpc_url('VTDYLKLZYX'));");
      status.out.println("}");
      ...
      status.out.println("}");
      status.out.println("if (Ctrl('CHLTBGCVDY')) {");
      status.out.println("ChangeIframeSrcWithoutPushingHistory('CHLTBGCVDY',linkpc_url('CHLTBGCVDY'));");
      status.out.println("}");
      status.out.println("if (Ctrl('OZFWYFQQTV')) {");
      status.out.println("ChangeIframeSrcWithoutPushingHistory('OZFWYFQQTV',linkpc_url('OZFWYFQQTV'));");
      status.out.println("}");
      ...
      status.out.println("}");
      status.out.println("if (Ctrl('LUESWSIYXN')) {");
      status.out.println("ChangeIframeSrcWithoutPushingHistory('LUESWSIYXN',linkpc_url('LUESWSIYXN'));");
      status.out.println("}");
    ...
    status.out.println("if (Eq(name,'ardt_clientifrz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_clientifrz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_mlientifrz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_mlientifrz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_sogopefraz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_sogopefraz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_mogopefbo')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_mogopefbo")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_meneficfrz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_meneficfrz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_beneficfrz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_beneficfrz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_terzistifrz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_terzistifrz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_merzistifrz')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_merzistifrz")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    ...
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'armt_fraziobo_agg')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"armt_fraziobo_agg")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    status.out.println("if (Eq(name,'ardt_frz_contante')) {");
    status.out.println("l_cRes='"+SPLib.GetSelectedPage(status.m_cSelectedPage,"ardt_frz_contante")+"';");
    status.out.println("return l_cRes;");
    status.out.println("}");
    ...
    if (CPLib.ne(status.m_cClientMode,"query")) {
      ...
      if (CPLib.eq(status.m_cClientMode,"new")) {
        ...
        status.out.println("AutonumberApplet().SetETName('fraziobo');");
  ...
  armt_ofrazionateBO getBO(ServletStatus status) {
    armt_ofrazionateBO BO = new armt_ofrazionateBO(status.context);
  ...
  void LoadExtensions(armt_ofrazionateBO BO) {
    XDCHolder xdc = CPLib.GetXDCHolder(SPLib.GetClassesPath(),new SPXDCReaderFactory(BO.m_Ctx.GetInstance()),BO.m_Ctx.GetInstance());
    XDCTable t = xdc.GetXDCTable("fraziobo",true);
    BO.extendedFields = CPExtenderLib.GetExtendedItemsFromTable(t);
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,armt_ofrazionateBO BO) {
  ...
  void Calculation_NAKGPBRIRV(ServletStatus status,armt_ofrazionateBO BO) {
  ...
  void Calculation_VWASRYIQTS(ServletStatus status,armt_ofrazionateBO BO) {
  ...
  void WriteTableCombo(ServletStatus status,armt_ofrazionateBO BO) {
    String l_cTmp;
    CPResultSet l_rsLoad=null;
    l_cTmp = "[";
    if (l_rsLoad!=null)
  ...
  CPResultSet QueryKeyCursor(armt_ofrazionateBO BO,ServletStatus status) {
    String l_cServer = BO.m_cServer_fraziobo;
    String l_cPhName = BO.m_cPhName_fraziobo;
    ...
    if ( ! (CPLib.Empty(status.m_cLastWhere))) {
      ...
      String l_cQueryFilter = armt_ofrazionateBL.QueryFilter(status.context);
      ...
      if (l_rsKeys!=null)
        l_rsKeys.Close();
      l_rsKeys = status.context.GetSql().Query(l_cServer,CPSql.BuildSQLPhrase(" "+BO.m_cVirtName_fraziobo+".IDBASE",CPLib.GetTablesWithAliases(l_cPhName,status.m_cAllVirtNames,status.context),l_cLastWhere,status.m_cLastOrderBy));
    } else {
  ...
  CPResultSet QueryKeyCursor(SPMasterServletStatus status) {
    String l_cServer = status.context.GetServer("fraziobo");
    String l_cPhName = CPSql.ManipulateTablePhName("fraziobo",l_cServer);
    // Creazione del cursore delle chiavi. Costruisce la frase SQL nella tabella
    // associata alla maschera selezionando solo i campi della chiave di ricerca che
    // soddisfa la clausola di "where" passata come parametro. Riceve altresì come
    // parametro la clausola di "order by".
  ...
  void Query(ServletStatus status,armt_ofrazionateBO BO) {
    if ( ! (CPLib.Empty(status.m_cLastWhere))) {
      ...
      if (l_rsCount!=null)
        l_rsCount.Close();
      l_rsCount = BO.m_Sql.Query(BO.m_cServer_fraziobo,CPSql.BuildSQLPhrase(" count(*) as reccount",CPLib.GetTablesWithAliases(BO.m_cPhName_fraziobo,status.m_cAllVirtNames,BO.m_Ctx),l_cLastWhere,""));
      try {
  ...
  void View(ServletStatus status,armt_ofrazionateBO BO) {
  ...
  void Edit(ServletStatus status,armt_ofrazionateBO BO,SPParameterSource source) {
  ...
  void New(ServletStatus status,armt_ofrazionateBO BO,SPParameterSource source) {
    BO.Initialize();
    if (BO.CanAdd()) {
  ...
  void Write(ServletStatus status,armt_ofrazionateBO BO,SPParameterSource source) {
  ...
  void LoadCurrentRecord(ServletStatus status,armt_ofrazionateBO BO) {
  ...
  void EditLoad(ServletStatus status,armt_ofrazionateBO BO,SPParameterSource source) {
    Edit(status,BO,source);
    if ( ! (BO.m_bLoaded)) {
      status.m_cErrMsg = "";
      status.m_bError = false;
  ...
  void Delete(ServletStatus status,armt_ofrazionateBO BO,SPParameterSource source) {
    boolean l_bResult = false;
    String l_cTrsMsgErr = "";
    boolean l_bTrsOk = true;
  ...
  void DeleteMessage(ServletStatus status,armt_ofrazionateBO BO,SPParameterSource source) {
    BO.Load(status.w_IDBASE);
    status.m_cBOWarnMessageDeleted = status.context.Translate("MSG_PROCEED_WITH_DELETE");
    status.m_bExit = true;
    status.m_cClientMode = "bringback";
  }
  void Save(ServletStatus status,armt_ofrazionateBO BO) {
    boolean l_bResult = false;
    String l_cTrsMsgErr = "";
    boolean l_bTrsOk = true;
    String l_cTransMsgErr = "";
  ...
  void Discard(ServletStatus status,armt_ofrazionateBO BO) {
    BO.SetFromContext(status.m_cWv,status.m_Parameters);
  ...
  void CreatePortlet(ServletStatus status,armt_ofrazionateBO BO) {
    ...
    item.put("altInterfaceFor","armt_ofrazionate");
    items.put(item);
    String s;
    org.json.JSONObject ctrl = null;
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Intermediario\",\"box_type\":\"auto_horizontal_section\",\"collapsible\":true,\"comment\":\"Intermediario\",\"h\":45,\"name\":\"Intermediario\",\"page\":1,\"shrinkable\":true,\"spuid\":\"QOEQGFTIYF\",\"stretch\":true,\"tabindex\":187,\"title_caption\":\"Intermediario\",\"type\":\"Box\",\"w\":1016,\"x\":0,\"y\":0,\"zone\":\"pag1_1\",\"zonepath\":\"[1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_HBLSDWZPZJ\",\"page\":1,\"spuid\":\"HBLSDWZPZJ\",\"tabindex\":26,\"type\":\"Label\",\"value\":\"A01B. Intermediario:\",\"w\":122,\"x\":14,\"y\":13,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_HZDQOFEXPB\",\"page\":1,\"spuid\":\"HZDQOFEXPB\",\"tabindex\":28,\"type\":\"Label\",\"value\":\"A11. Dipendenza:\",\"w\":93,\"x\":246,\"y\":13,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Codice Dipendenza\",\"h\":21,\"maxlength\":6,\"name\":\"CODDIPE\",\"page\":1,\"picker\":true,\"spuid\":\"SDNFDOJDLP\",\"tabindex\":30,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":56,\"x\":344,\"y\":9,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_OIZHYHOJII\",\"page\":1,\"spuid\":\"OIZHYHOJII\",\"tabindex\":31,\"type\":\"Label\",\"value\":\"A12B. Citt\\u00E0:\",\"w\":62,\"x\":445,\"y\":13,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_IZRUENEKXU\",\"page\":1,\"spuid\":\"IZRUENEKXU\",\"tabindex\":33,\"type\":\"Label\",\"value\":\"A12C. Prov.:\",\"w\":66,\"x\":680,\"y\":13,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":17,\"name\":\"label_VPEIKRTWFC\",\"page\":1,\"spuid\":\"VPEIKRTWFC\",\"tabindex\":35,\"type\":\"Label\",\"value\":\"A12A. CAB:\",\"w\":64,\"x\":789,\"y\":13,\"zone\":\"pag1_1_1\",\"zonepath\":\"[1,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"check\",\"comment\":\"Data Operazione\",\"h\":20,\"maxlength\":10,\"name\":\"DATAOPE\",\"page\":1,\"picker\":true,\"spuid\":\"WAAXEDMKXA\",\"tabindex\":37,\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":80,\"x\":130,\"y\":58,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_RUVVREGNGP\",\"page\":1,\"spuid\":\"RUVVREGNGP\",\"tabindex\":111,\"type\":\"Label\",\"value\":\"A03. Numero Progressivo:\",\"w\":138,\"x\":259,\"y\":62,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_NRJTHQEJCT\",\"page\":1,\"spuid\":\"NRJTHQEJCT\",\"tabindex\":112,\"type\":\"Label\",\"value\":\"A21. Data Operazione:\",\"w\":122,\"x\":5,\"y\":62,\"zone\":\"pag1_2_1\",\"zonepath\":\"[1,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"check\",\"comment\":\"Data registrazione\",\"h\":20,\"maxlength\":10,\"name\":\"DATAREG\",\"page\":1,\"spuid\":\"NXYGHZZLCG\",\"tabindex\":42,\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":72,\"x\":820,\"y\":58,\"zone\":\"pag1_2_2\",\"zonepath\":\"[1,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KZBMHOFWYD\",\"page\":1,\"spuid\":\"KZBMHOFWYD\",\"tabindex\":122,\"type\":\"Label\",\"value\":\"A51. Data registrazione:\",\"w\":136,\"x\":680,\"y\":62,\"zone\":\"pag1_2_2\",\"zonepath\":\"[1,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Frazionata (S\\/N)\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"FLAGFRAZ\",\"page\":1,\"spuid\":\"QSRYXQJCBZ\",\"tabindex\":44,\"textlist\":\"Normale,Fraz. Trasferita,Multipla\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"0"+"'"+","+"'"+"1"+"'"+","+"'"+"2"+"'"+"\",\"w\":128,\"x\":130,\"y\":85,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Collegamento Operazione Multiple\",\"disabled\":\"true\",\"h\":20,\"maxlength\":12,\"name\":\"COLLEG\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"FCUPIYMFZB\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":96,\"x\":368,\"y\":85,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_RLUNSWADHC\",\"page\":1,\"spuid\":\"RLUNSWADHC\",\"tabindex\":139,\"type\":\"Label\",\"value\":\"A22. Tipo:\",\"w\":122,\"x\":5,\"y\":89,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_CNKLWUVOXA\",\"page\":1,\"spuid\":\"CNKLWUVOXA\",\"tabindex\":140,\"type\":\"Label\",\"value\":\"A53. Collegata a:\",\"w\":104,\"x\":262,\"y\":89,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Premere il bottone per collegare le operazioni\",\"h\":20,\"keep_proportions\":\"bounded\",\"name\":\"image_RHYSMJSILT\",\"page\":1,\"spuid\":\"RHYSMJSILT\",\"src\":\"..\\/images\\/070.gif\",\"tabindex\":188,\"type\":\"Image\",\"w\":19,\"x\":464,\"y\":85,\"zone\":\"pag1_2_3\",\"zonepath\":\"[1,2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Tipo Operazione Completa\",\"h\":20,\"maxlength\":2,\"name\":\"TIPOOPRAP\",\"page\":1,\"spuid\":\"XVLCUXTZXI\",\"tabindex\":46,\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":296,\"x\":653,\"y\":85,\"zone\":\"pag1_2_4\",\"zonepath\":\"[1,2,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_KJZKHGDTBV\",\"page\":1,\"spuid\":\"KJZKHGDTBV\",\"tabindex\":123,\"type\":\"Label\",\"value\":\"A52. Tipo Operazione:\",\"w\":118,\"x\":533,\"y\":89,\"zone\":\"pag1_2_4\",\"zonepath\":\"[1,2,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"
\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_EXIXNLTCBE\",\"page\":1,\"spuid\":\"EXIXNLTCBE\",\"tabindex\":120,\"type\":\"Label\",\"value\":\"A41. Rapporto Collegato:\",\"w\":216,\"x\":8,\"y\":273,\"zone\":\"pag1_4_1\",\"zonepath\":\"[1,4,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_UWUWSYENHG\",\"page\":1,\"spuid\":\"UWUWSYENHG\",\"tabindex\":135,\"type\":\"Label\",\"w\":432,\"x\":412,\"y\":273,\"zone\":\"pag1_4_1\",\"zonepath\":\"[1,4,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Codice Cliente Occasionale\",\"h\":20,\"maxlength\":16,\"name\":\"CONNESCLI\",\"page\":1,\"picker\":true,\"spuid\":\"QBLXDBODXR\",\"tabindex\":62,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":108,\"x\":228,\"y\":296,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"% Pro Quota\",\"h\":20,\"maxlength\":4,\"name\":\"PROQUOTA\",\"page\":1,\"spuid\":\"ADUIDSWRJW\",\"tabindex\":63,\"type\":\"Textbox\",\"typevar\":\"numeric\",\"w\":30,\"x\":859,\"y\":296,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_NUEFWOMRRX\",\"page\":1,\"spuid\":\"NUEFWOMRRX\",\"tabindex\":130,\"type\":\"Label\",\"value\":\"C11. Intest. \\/ Cliente Occ.:\",\"w\":216,\"x\":8,\"y\":300,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_PXKFPRTVXX\",\"page\":1,\"spuid\":\"PXKFPRTVXX\",\"tabindex\":134,\"type\":\"Label\",\"w\":412,\"x\":364,\"y\":300,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_CMPDPVIXKY\",\"page\":1,\"spuid\":\"CMPDPVIXKY\",\"tabindex\":180,\"type\":\"Label\",\"value\":\"% Pro Quota:\",\"w\":73,\"x\":783,\"y\":300,\"zone\":\"pag1_4_2\",\"zonepath\":\"[1,4,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Codice Cliente Occasionale\",\"h\":20,\"maxlength\":16,\"name\":\"CONNESOPER\",\"page\":1,\"picker\":true,\"spuid\":\"TCOTJNZLGM\",\"tabindex\":64,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":108,\"x\":228,\"y\":323,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IINONMZPLB\",\"page\":1,\"spuid\":\"IINONMZPLB\",\"tabindex\":131,\"type\":\"Label\",\"w\":216,\"x\":8,\"y\":327,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_QGPWBVUZYW\",\"page\":1,\"spuid\":\"QGPWBVUZYW\",\"tabindex\":136,\"type\":\"Label\",\"w\":480,\"x\":364,\"y\":327,\"zone\":\"pag1_4_3\",\"zonepath\":\"[1,4,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Tipo Legame\",\"h\":20,\"maxlength\":1,\"name\":\"TIPOLEG\",\"page\":1,\"spuid\":\"WBHSORBZAV\",\"tabindex\":65,\"type\":\"Combobox\",\"typevar\":\"character\",\"w\":360,\"x\":228,\"y\":350,\"zone\":\"pag1_4_4\",\"zonepath\":\"[1,4,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"checked_value\":\""+"'"+"S"+"'"+"\",\"h\":21,\"label_text\":\"Soggetto operante utilizza mezzi propri\",\"maxlength\":1,\"name\":\"PAGASOGOP\",\"page\":1,\"spuid\":\"TMYVGJFCXV\",\"tabindex\":66,\"type\":\"Checkbox\",\"typevar\":\"character\",\"unchecked_value\":\""+"'"+"N"+"'"+"\",\"w\":237,\"x\":648,\"y\":350,\"zone\":\"pag1_4_4\",\"zonepath\":\"[1,4,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_VECGHPFLII\",\"page\":1,\"spuid\":\"VECGHPFLII\",\"tabindex\":121,\"type\":\"Label\",\"value\":\"A43. Tipo Legame:\",\"w\":216,\"x\":8,\"y\":354,\"zone\":\"pag1_4_4\",\"zonepath\":\"[1,4,4]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"Codice Cliente Occasionale\",\"h\":20,\"maxlength\":16,\"name\":\"CONNESBEN\",\"page\":1,\"picker\":true,\"spuid\":\"ULVCBLFVEU\",\"tabindex\":67,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":108,\"x\":228,\"y\":377,\"zone\":\"pag1_4_5\",\"zonepath\":\"[1,4,5]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_LZDWHHTSGR\",\"page\":1,\"spuid\":\"LZDWHHTSGR\",\"tabindex\":132,\"type\":\"Label\",\"value\":\"C31. Controparte Bonifico:\",\"w\":216,\"x\":8,\"y\":381,\"zone\":\"pag1_4_5\",\"zonepath\":\"[1,4,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_USZXRLYSFT\",\"page\":1,\"spuid\":\"USZXRLYSFT\",\"tabindex\":137,\"type\":\"Label\",\"w\":480,\"x\":364,\"y\":381,\"zone\":\"pag1_4_5\",\"zonepath\":\"[1,4,5]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"h\":20,\"maxlength\":16,\"name\":\"CONNALTRO\",\"page\":1,\"picker\":true,\"spuid\":\"TRNDHQYOXC\",\"tabindex\":68,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":108,\"x\":228,\"y\":404,\"zone\":\"pag1_4_6\",\"zonepath\":\"[1,4,6]\",\"zoom\":\"stdz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_CKBXAAYFYL\",\"page\":1,\"spuid\":\"CKBXAAYFYL\",\"tabindex\":142,\"type\":\"Label\",\"w\":216,\"x\":8,\"y\":408,\"zone\":\"pag1_4_6\",\"zonepath\":\"[1,4,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":16,\"name\":\"label_RDOJHWCSNP\",\"page\":1,\"spuid\":\"RDOJHWCSNP\",\"tabindex\":143,\"type\":\"Label\",\"w\":480,\"x\":364,\"y\":408,\"zone\":\"pag1_4_6\",\"zonepath\":\"[1,4,6]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":20,\"name\":\"button_XPWBHUQUGP\",\"page\":1,\"picker\":true,\"spuid\":\"XPWBHUQUGP\",\"tabindex\":69,\"type\":\"Button\",\"value\":\"Collega\",\"w\":72,\"x\":925,\"y\":405,\"zone\":\"pag1_4_7\",\"zonepath\":\"[1,4,7]\",\"zoom\":\"usrz\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"F11. Denominazione Controparte\",\"h\":20,\"maxlength\":70,\"name\":\"C_RAG\",\"page\":1,\"spuid\":\"AWPNTOJIRR\",\"tabindex\":70,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":432,\"x\":160,\"y\":440,\"zone\":\"pag1_5_1\",\"zonepath\":\"[1,5,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_PFEQRACAUA\",\"page\":1,\"spuid\":\"PFEQRACAUA\",\"tabindex\":170,\"type\":\"Label\",\"value\":\"F11. Denominazione:\",\"w\":149,\"x\":8,\"y\":444,\"zone\":\"pag1_5_1\",\"zonepath\":\"[1,5,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Ricerca su Soggetti Segnalati\",\"h\":24,\"keep_proportions\":\"bounded\",\"name\":\"image_FRGXYSRNBR\",\"page\":1,\"spuid\":\"FRGXYSRNBR\",\"src\":\"..\\/{\\\"Char\\\":\\\"60124\\\",\\\"Color\\\":\\\"#000000\\\",\\\"FontName\\\":\\\"ZucchettiDevelopement\\\",\\\"FontWeight\\\":\\\"\\\",\\\"Size\\\":\\\"25\\\"}\",\"tabindex\":71,\"type\":\"Image\",\"w\":32,\"x\":968,\"y\":437,\"zone\":\"pag1_5_2\",\"zonepath\":\"[1,5,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"check\":\"file\",\"comment\":\"F14B. Comune Controparte\",\"h\":20,\"maxlength\":30,\"name\":\"C_CTA\",\"page\":1,\"picker\":true,\"spuid\":\"ODAYKSRECA\",\"tabindex\":72,\"type\":\"Textbox\",\"typevar\":\"character\",\"w\
",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Dati Rettifiche (A54)\",\"h\":31,\"name\":\"Rettifiche\",\"page\":1,\"shrinkable\":true,\"spuid\":\"KURTXQHCYE\",\"stretch\":true,\"tabindex\":25,\"title_caption\":\"Dati Rettifiche (A54)\",\"titled\":true,\"type\":\"Box\",\"w\":1016,\"x\":0,\"y\":696,\"zone\":\"pag1_7\",\"zonepath\":\"[1,7]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Stato\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":1,\"name\":\"STATOREG\",\"page\":1,\"spuid\":\"OJXGBVSJHY\",\"tabindex\":87,\"textlist\":\"0 - Registrazione in essere mai modificata,1 - Registrazione in essere sostitutiva di precedente registrazione,2 - Registrazione annullata (cancellata per rettifica),3 - Registrazione annullata (sostituita per rettifica)\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"0"+"'"+","+"'"+"1"+"'"+","+"'"+"2"+"'"+","+"'"+"3"+"'"+"\",\"w\":352,\"x\":160,\"y\":703,\"zone\":\"pag1_7_1\",\"zonepath\":\"[1,7,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Data Rettifica\",\"h\":20,\"maxlength\":10,\"name\":\"DATARETT\",\"page\":1,\"spuid\":\"VYBZEWHKFF\",\"tabindex\":88,\"type\":\"Textbox\",\"typevar\":\"date\",\"w\":80,\"x\":608,\"y\":703,\"zone\":\"pag1_7_1\",\"zonepath\":\"[1,7,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_PXIMPOLVHG\",\"page\":1,\"spuid\":\"PXIMPOLVHG\",\"tabindex\":177,\"type\":\"Label\",\"value\":\"A54B:\",\"w\":77,\"x\":528,\"y\":707,\"zone\":\"pag1_7_1\",\"zonepath\":\"[1,7,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_MBISTIEAGL\",\"page\":1,\"spuid\":\"MBISTIEAGL\",\"tabindex\":178,\"type\":\"Label\",\"value\":\"A54A. Stato Registrazione:\",\"w\":154,\"x\":4,\"y\":707,\"zone\":\"pag1_7_1\",\"zonepath\":\"[1,7,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Operazione Modificata\",\"disabled\":\"true\",\"h\":20,\"maxlength\":20,\"name\":\"OPERAZMOD\",\"page\":1,\"readonly\":\"true\",\"spuid\":\"NSRIXGWOLV\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":132,\"x\":865,\"y\":703,\"zone\":\"pag1_7_2\",\"zonepath\":\"[1,7,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_AGZEQLWBPS\",\"page\":1,\"spuid\":\"AGZEQLWBPS\",\"tabindex\":179,\"type\":\"Label\",\"value\":\"A54C:\",\"w\":40,\"x\":822,\"y\":707,\"zone\":\"pag1_7_2\",\"zonepath\":\"[1,7,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"AltriIntestatari\",\"box_type\":\"collapsible\",\"collapsible\":true,\"comment\":\"Altri Intestatari\",\"h\":449,\"name\":\"AltriIntestatari\",\"page\":2,\"shrinkable\":true,\"spuid\":\"BDZUATYPMW\",\"tabindex\":7,\"title_caption\":\"Altri Intestatari\",\"titled\":true,\"type\":\"Box\",\"w\":1016,\"x\":0,\"y\":46,\"zone\":\"pag2_2\",\"zonepath\":\"[2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Intestatari Operazioni diverso da statoreg 3\",\"box_type\":\"auto_horizontal_section\",\"collapsible\":true,\"h\":219,\"name\":\"Intestatari Operazioni diverso da statoreg 3\",\"page\":2,\"shrinkable\":true,\"spuid\":\"KYBHVGCEJO\",\"stretch\":true,\"tabindex\":8,\"type\":\"Box\",\"w\":1000,\"x\":7,\"y\":51,\"zone\":\"pag2_2_1\",\"zonepath\":\"[2,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"autoexpand\":true,\"h\":205,\"name\":\"ardt_clientifrz\",\"page\":2,\"spuid\":\"BOAFVDQFRN\",\"tabindex\":9,\"type\":\"Iframe\",\"w\":677,\"x\":120,\"y\":57,\"zone\":\"pag2_2_1_1\",\"zonepath\":\"[2,2,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Intestatari Operazioni uguale a statoreg 3\",\"box_type\":\"auto_horizontal_section\",\"collapsible\":true,\"h\":216,\"name\":\"Intestatari Operazioni uguale a statoreg 3\",\"page\":2,\"shrinkable\":true,\"spuid\":\"XVSFEWJZNA\",\"stretch\":true,\"tabindex\":10,\"type\":\"Box\",\"w\":1000,\"x\":8,\"y\":272,\"zone\":\"pag2_2_2\",\"zonepath\":\"[2,2,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"autoexpand\":true,\"h\":205,\"name\":\"ardt_mlientifrz\",\"page\":2,\"spuid\":\"VTDYLKLZYX\",\"tabindex\":11,\"type\":\"Iframe\",\"w\":677,\"x\":120,\"y\":277,\"zone\":\"pag2_2_2_1\",\"zonepath\":\"[2,2,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"AltriEsecutori\",\"box_type\":\"collapsible\",\"collapsible\":true,\"comment\":\"iif(w_DATAOPE < CharToDate("+"'"+"20140101"+"'"+"),"+"'"+"Altri Soggetti Operanti Conto Terzi"+"'"+","+"'"+"Altri Esecutori"+"'"+")\",\"h\":349,\"name\":\"AltriEsecutori\",\"page\":2,\"shrinkable\":true,\"spuid\":\"ZYUUSRMPQG\",\"tabindex\":12,\"titled\":true,\"type\":\"Box\",\"w\":1017,\"x\":0,\"y\":497,\"zone\":\"pag2_3\",\"zonepath\":\"[2,3]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Soggetti Agenti per Conto Oper. diverso da statoreg 3\",\"box_type\":\"auto_horizontal_section\",\"collapsible\":true,\"h\":166,\"name\":\"Soggetti Agenti per Conto Oper. diverso da statoreg 3\",\"page\":2,\"shrinkable\":true,\"spuid\":\"XJNRVUSEVC\",\"stretch\":true,\"tabindex\":13,\"type\":\"Box\",\"w\":1000,\"x\":8,\"y\":501,\"zone\":\"pag2_3_1\",\"zonepath\":\"[2,3,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"autoexpand\":true,\"h\":155,\"name\":\"ardt_sogopefraz\",\"page\":2,\"spuid\":\"TQDGESLQVD\",\"tabindex\":14,\"type\":\"Iframe\",\"w\":681,\"x\":120,\"y\":506,\"zone\":\"pag2_3_1_1\",\"zonepath\":\"[2,3,1,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"Soggetti Agenti per Conto Oper. uguale a statoreg 3\",\"box_type\":\"auto_horizontal_section\",\"collapsible\":true,\"h\":168,\"name\":\"Soggetti Agenti per Conto Oper. uguale a statoreg 3\",\"page\":2,\"shrinkable\":true,\"spuid\":\"UZFRPBBNAH\",\"stretch\":true,\"tabindex\":15,\"type\":\"Box\",\"w\":1000,\"x\":9,\"y\":669,\"zone\":\"pag2_3_2\",\"zonepath\":\"[2,3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"autoexpand\":true,\"h\":155,\"name\":\"ardt_mogopefbo\",\"page\":2,\"spuid\":\"CHLTBGCVDY\",\"tabindex\":16,\"type\":\"Iframe\",\"w\":681,\"x\":120,\"y\":675,\"zone\":\"pag2_3_2_1\",\"zonepath\":\"[2,3,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"AltreControparti\",\"box_type\":\"horizontal_section\",\"collapsible\":true,\"comment\":\"Controparti\",\"h\":509,\"name\":\"AltreControparti\",\"page\":3,\"shrinkable\":true,\"spuid\":\"GTSBULOFTD\",\"stretch\":true,\"tabindex\":7,\"title_caption\":\"Controparti\",\"titled\":true,\"type\":\"Box\",\"w\":1016,\"x\":0,\"y\":46,\"zone\":\"pag3_2\",\"zonepath\":\"[3,2]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"bg_color\":\"transparent\",\"box_name\":\"AltriSogTerzi diverso da statoreg 3\",\"box_type\":\"auto_horizontal_section\",\"collapsible\":true,\"h\":250,\"name\":\"AltriSogTerzi diverso da statoreg 3\",\"page\":3,\"shrinkable\":true,\"spuid\":\"DOUBCEKLZK\",\"stretch\":true,\"tabindex\":8,\"type\":\"Box\",\"w\":1000,\"x\":8,\"y\":50,\"zone\":\"pag3_2_1\",\"zonepath\":\"[3,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"autoexpand\":true,\"h\
\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Punto Contante\",\"disabled\":\"true\",\"h\":20,\"maxlength\":80,\"name\":\"DESPUNTO\",\"page\":4,\"readonly\":\"true\",\"spuid\":\"DVZEGUGHBR\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":492,\"x\":152,\"y\":355,\"zone\":\"pag4_6_1\",\"zonepath\":\"[4,6,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_GWFAZWBZWG\",\"page\":4,\"spuid\":\"GWFAZWBZWG\",\"tabindex\":53,\"type\":\"Label\",\"value\":\"Codice Cliente Contante:\",\"w\":132,\"x\":580,\"y\":332,\"zone\":\"pag4_6_1\",\"zonepath\":\"[4,6,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Codice Cliente Contante\",\"disabled\":\"true\",\"h\":20,\"maxlength\":20,\"name\":\"CODCLICON\",\"page\":4,\"readonly\":\"true\",\"spuid\":\"IDIFNZYSLH\",\"type\":\"Textbox\",\"typevar\":\"character\",\"w\":152,\"x\":712,\"y\":328,\"zone\":\"pag4_6_1\",\"zonepath\":\"[4,6,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"Tipo attivit\\u00E0\",\"disabled\":\"true\",\"empty_value\":\"false\",\"h\":20,\"maxlength\":3,\"name\":\"TIPATT\",\"page\":4,\"readonly\":\"true\",\"spuid\":\"SOMEUVNZHG\",\"textlist\":\"Ritiro,Sovvenzione\",\"type\":\"Combobox\",\"typevar\":\"character\",\"valuelist\":\""+"'"+"RIT"+"'"+","+"'"+"SOV"+"'"+"\",\"w\":184,\"x\":152,\"y\":328,\"zone\":\"pag4_6_1\",\"zonepath\":\"[4,6,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_TZYCGKLUVR\",\"page\":4,\"spuid\":\"TZYCGKLUVR\",\"tabindex\":56,\"type\":\"Label\",\"value\":\"Tipo attivit\\u00E0:\",\"w\":104,\"x\":48,\"y\":332,\"zone\":\"pag4_6_1\",\"zonepath\":\"[4,6,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"h\":16,\"name\":\"label_IXLIPJPKPM\",\"page\":4,\"spuid\":\"IXLIPJPKPM\",\"tabindex\":57,\"type\":\"Label\",\"value\":\"Punto Contante:\",\"w\":88,\"x\":64,\"y\":359,\"zone\":\"pag4_6_1\",\"zonepath\":\"[4,6,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"autoexpand\":true,\"h\":316,\"name\":\"armt_fraziobo_agg\",\"page\":6,\"spuid\":\"RZOXJTRIYP\",\"tabindex\":15,\"type\":\"Iframe\",\"w\":821,\"x\":88,\"y\":288,\"zone\":\"pag6_4_1\",\"zonepath\":\"[6,4,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"h\":702,\"name\":\"ardt_frz_contante\",\"page\":7,\"spuid\":\"QMSPZAQYXJ\",\"tabindex\":1,\"type\":\"Iframe\",\"w\":749,\"x\":144,\"y\":54,\"zone\":\"pag7_2_1\",\"zonepath\":\"[7,2,1]\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
  ...
  void WriteFormPage(armt_ofrazionateBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='armt_ofrazionate?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    if (CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")) {
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_ofrazionate_query.js'>" +
       "</script>" +
      "");
    } else if (CPLib.eq(status.m_cClientMode,"new") || CPLib.eq(status.m_cClientMode,"edit")) {
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_ofrazionate_edit.js'>" +
       "</script>" +
      "");
    }
    if (CPLib.eq(status.m_cClientMode,"painter")) {
      ...
      status.out.println("w_STATOREG=a[52];");
      status.out.println("w_DATARETT=a[53];");
      status.out.println("w_OPERAZMOD=a[54];");
      status.out.println("w_TIPOINF=a[55];");
      status.out.println("w_SEGNO=a[56];");
      status.out.println("w_IDFILE=a[57];");
      status.out.println("w_MTCN=a[58];");
      status.out.println("w_TOTLIRE=a[59];");
      status.out.println("w_TOTCONT=a[60];");
      status.out.println("w_IDEREG=a[61];");
      status.out.println("w_FLAGRAP=a[62];");
      status.out.println("w_OPRAP=a[63];");
      status.out.println("w_RAPPORTBEN=a[64];");
      status.out.println("w_OPERATORE=a[65];");
      status.out.println("w_AUTOM=a[66];");
      status.out.println("w_FLAGRAP2=a[67];");
      status.out.println("w_PRGIMPFRZ=a[68];");
      status.out.println("op_PRGIMPFRZ=a[69];");
      status.out.println("w_IDBASE2=a[70];");
      status.out.println("w_NOPROT=a[71];");
      status.out.println("w_OPERAG=a[72];");
      status.out.println("w_RESPINS=a[73];");
      status.out.println("w_INFORM=a[74];");
      status.out.println("w_NATURA=a[75];");
      status.out.println("w_SCOPO=a[76];");
      status.out.println("w_SV58550=a[77];");
      status.out.println("w_SV58550MA=a[78];");
      status.out.println("w_DURAT=a[79];");
      status.out.println("w_AMMONT=a[80];");
      status.out.println("w_AREAGEO=a[81];");
      status.out.println("w_MODSVOL=a[82];");
      status.out.println("w_RAGIO=a[83];");
      status.out.println("w_TIPO=a[84];");
      status.out.println("w_DUCOLLEG=a[85];");
      status.out.println("w_ORACOLLEG=a[86];");
      status.out.println("w_IPCOLLEG=a[87];");
      status.out.println("w_MEZPAG=a[88];");
      status.out.println("w_PRESTAZ=a[89];");
      status.out.println("w_NOSARA=a[90];");
      status.out.println("w_RFREQ=a[91];");
      status.out.println("w_RIMP=a[92];");
      status.out.println("w_RAREA=a[93];");
      status.out.println("w_RCOMP=a[94];");
      status.out.println("w_RRAGIO=a[95];");
      status.out.println("w_RTIPO=a[96];");
      status.out.println("w_RISGLOB=a[97];");
      status.out.println("w_MITIG=a[98];");
      status.out.println("w_MITIGDOC=a[99];");
      status.out.println("w_DESPUNTO=a[100];");
      status.out.println("w_CODCLICON=a[101];");
      status.out.println("w_TIPATT=a[102];");
      status.out.println("w_VASP=a[103];");
      status.out.println("w_RIFIMP=a[104];");
      status.out.println("w_xRAGSOCDOC=a[105];");
      ...
      status.out.println("w_gDataVaria=a[112];");
      status.out.println("w_gFlgDoc=a[113];");
      ...
      status.out.println("w_appolire=a[125];");
      status.out.println("w_xTOTLIRE=a[126];");
      status.out.println("w_xTOTCONT=a[127];");
      ...
      status.out.println("w_CABINT=a[135];");
      status.out.println("w_xragsocper=a[136];");
      status.out.println("w_desccauana=a[137];");
      status.out.println("w_xragsocben=a[138];");
      status.out.println("w_xdesccausin=a[139];");
      status.out.println("w_xdescpaese2=a[140];");
      status.out.println("w_xdescrap=a[141];");
      status.out.println("w_xdes1=a[142];");
      status.out.println("w_xcodfisc=a[143];");
      status.out.println("w_xdciticon=a[144];");
      status.out.println("w_dessta=a[145];");
      status.out.println("w_xragsocalt=a[146];");
      status.out.println("w_xFLGITAEST=a[147];");
      status.out.println("w_CITINT=a[148];");
      status.out.println("w_CITDIP=a[149];;");
      status.out.println("w_PROVDIP=a[150];");
      status.out.println("w_CABDIP=a[151];");
      status.out.println("w_PROVINT=a[152];");
      status.out.println("w_DATAVALI=a[153];");
      status.out.println("w_DATARILASC=a[154];");
      status.out.println("w_xdescopeage=a[155];");
      status.out.println("w_xdescfreq=a[156];");
      status.out.println("w_xdescammo=a[157];");
      status.out.println("w_xdescareag=a[158];");
      status.out.println("w_xdescmodsvo=a[159];");
      status.out.println("w_xdescplauso=a[160];");
      status.out.println("w_xdesctipor=a[161];");
      status.out.println("w_CALCOLI=a[162];");
      status.out.println("w_COMPLETA=a[163];");
      status.out.println("op_codazi=a[164];");
      ...
      status.out.println("m_cWv_ardt_clientifrz=a[165];");
      status.out.println("m_cWv_ardt_mlientifrz=a[166];");
      status.out.println("m_cWv_ardt_sogopefraz=a[167];");
      status.out.println("m_cWv_ardt_mogopefbo=a[168];");
      status.out.println("m_cWv_ardt_meneficfrz=a[169];");
      status.out.println("m_cWv_ardt_beneficfrz=a[170];");
      status.out.println("m_cWv_ardt_terzistifrz=a[171];");
      status.out.println("m_cWv_ardt_merzistifrz=a[172];");
      status.out.println("m_cWv_ardt_docfrabo=a[173];");
      status.out.println("m_cWv_armt_fraziobo_agg=a[174];");
      status.out.println("m_cWv_ardt_frz_contante=a[175];");
      status.out.println("if (Gt(a.length,176)) {");
      ...
      status.out.println(
       "<script src='SPPrxy/"+m_cEntityUid+"/armt_ofrazionate_proc.js'>" +
       "</script>" +
      "");
    }
    IncludeJS(status);
    ...
    status.themeWriter.WriteBody_Begin(835,status.m_cBodyAttributes,status.context.Translate("MSG_LOADING")+"...");
    status.out.println(
     "<script>" +
    "");
    if (CPLib.eq(status.m_cClientMode,"edit") || CPLib.eq(status.m_cClientMode,"new")) {
  ...
  void RaiseLoadedEntity(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void RaiseSavedEntity(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(armt_ofrazionateBO BO,ServletStatus status) {
  ...
  void WriteExitPage(armt_ofrazionateBO BO,ServletStatus status,Forward f) {
  ...
  void WriteExitPage(armt_ofrazionateBO BO,ServletStatus status) {
    WriteExitPage(BO,status,Forward.Unforwarded);
  }
  protected void BringBackPage(armt_ofrazionateBO BO,ServletStatus status) throws IOException {
  ...
  void IncludeJS(ServletStatus status) {
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+arrt_li_fraziobo.m_cEntityUid+"/arrt_li_fraziobo.js'>" +
     "</script>" +
    "");
    status.out.println(
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      ...
      arrt_li_fraziobo.GetCallableNames(callable);
      ...
      CPLib.AddToSet(callable,"ardt_clientifrz");
      CPLib.AddToSet(callable,"ardt_mlientifrz");
      CPLib.AddToSet(callable,"ardt_sogopefraz");
      CPLib.AddToSet(callable,"ardt_mogopefbo");
      CPLib.AddToSet(callable,"ardt_meneficfrz");
      CPLib.AddToSet(callable,"ardt_beneficfrz");
      CPLib.AddToSet(callable,"ardt_terzistifrz");
      CPLib.AddToSet(callable,"ardt_merzistifrz");
      CPLib.AddToSet(callable,"ardt_docfrabo");
      CPLib.AddToSet(callable,"armt_fraziobo_agg");
      CPLib.AddToSet(callable,"ardt_frz_contante");
    } else {
  ...
  public String GetCheckVars(ServletStatus status,armt_ofrazionateBO BO,String p_cUID) {
  ...
  public boolean CheckVars(ServletStatus status,armt_ofrazionateBO BO) {
    boolean result = true;
