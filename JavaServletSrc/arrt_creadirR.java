...
// * --- Fine Area Manuale
public class arrt_creadirR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_creadirR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_creadir",m_Caller);
  ...
  public static arrt_creadirR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_creadirR(p_Ctx, p_Caller);
  }
  public void Blank() {
