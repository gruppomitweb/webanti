...
public class arpg_viewinfoBL extends arpg_viewinfoWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_NUMPROG;
    public java.sql.Date c_DATAOPE;
    public java.sql.Date c_DATAREG;
    public String c_TIPOOPRAP;
    public String c_DES1;
    public String c_IDBASE;
    public String c_RAPPORTO;
    public String c_STATOREG;
    public String c_STATO;
  ...
  public static final String i_EntityName = "arpg_viewinfo";
  ...
  public static final String i_StateStructure = "{'rapporto':rapporto}";
  public static final String i_CompleteStateStructure = "{'rapporto':rapporto}";
  public static final String i_ItemSequence = "rapporto";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"rapporto","","C","25","0","variabile","nokey","false","false"}});
  ...
  public arpg_viewinfoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_viewinfo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_DATAREG=c_DATAREG;
    m_oTrs.get(m_nCurrentRow).c_TIPOOPRAP=c_TIPOOPRAP;
    m_oTrs.get(m_nCurrentRow).c_DES1=c_DES1;
    m_oTrs.get(m_nCurrentRow).c_IDBASE=c_IDBASE;
    m_oTrs.get(m_nCurrentRow).c_RAPPORTO=c_RAPPORTO;
    m_oTrs.get(m_nCurrentRow).c_STATOREG=c_STATOREG;
    m_oTrs.get(m_nCurrentRow).c_STATO=c_STATO;
  ...
  public void TrsToWork() {
    ...
    c_DATAREG= m_oTrs.get(m_nCurrentRow).c_DATAREG;
    c_TIPOOPRAP= m_oTrs.get(m_nCurrentRow).c_TIPOOPRAP;
    c_DES1= m_oTrs.get(m_nCurrentRow).c_DES1;
    c_IDBASE= m_oTrs.get(m_nCurrentRow).c_IDBASE;
    c_RAPPORTO= m_oTrs.get(m_nCurrentRow).c_RAPPORTO;
    c_STATOREG= m_oTrs.get(m_nCurrentRow).c_STATOREG;
    c_STATO= m_oTrs.get(m_nCurrentRow).c_STATO;
