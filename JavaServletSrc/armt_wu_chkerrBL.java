...
public class armt_wu_chkerrBL extends armt_wu_chkerrWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_wu_chkerr";
  ...
  public CPPhTableWrInfo m_oWrInfo_wuchkimp;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wuchkimp;
  ...
  public static String[] m_EntityTables = {"wuchkimp"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'WUTIPOPE':WUTIPOPE,'WUCODICE':WUCODICE,'WUNDATOPE':WUNDATOPE,'WUNCAPCLI':WUNCAPCLI,'WUNDATNAS':WUNDATNAS,'WUNRDOCCLI':WUNRDOCCLI,'WUNSDOCCLI':WUNSDOCCLI,'WUNTDOCCLI':WUNTDOCCLI,'WUNSTADES':WUNSTADES,'WUNCODDIP':WUNCODDIP,'WUNCITCLI':WUNCITCLI,'WUNBSTACLI':WUNBSTACLI,'WUNBCITCLI':WUNBCITCLI,'WUFLGALL':WUFLGALL,'WUNCODFIS':WUNCODFIS,'WUNOTE':WUNOTE,'WUFLGFRC':WUFLGFRC,'WUNSTACLI':WUNSTACLI,'WUNSEXCLI':WUNSEXCLI"+FoundlingChildrenList("armt_wu_chkerr",true)+"}";
  public static final String i_CompleteStateStructure = "{'WUNOMEFILE':WUNOMEFILE,'WURIFMTCN':WURIFMTCN,'WUTIPOPE':WUTIPOPE,'WUCODDIP':WUCODDIP,'WUDATOPE':WUDATOPE,'WUIMPORTO':WUIMPORTO,'WUSTADES':WUSTADES,'WUTIPERR':WUTIPERR,'WUCODICE':WUCODICE,'WUNDATOPE':WUNDATOPE,'WUNCAPCLI':WUNCAPCLI,'WUNDATNAS':WUNDATNAS,'WUNRDOCCLI':WUNRDOCCLI,'WUNSDOCCLI':WUNSDOCCLI,'WUNTDOCCLI':WUNTDOCCLI,'WUNSTADES':WUNSTADES,'WUNCODDIP':WUNCODDIP,'WUNCITCLI':WUNCITCLI,'WUNBSTACLI':WUNBSTACLI,'WUNBCITCLI':WUNBCITCLI,'WUNOMCLI':WUNOMCLI,'WUCOGCLI':WUCOGCLI,'WUCITCLI':WUCITCLI,'WUCAPCLI':WUCAPCLI,'WUINDCLI':WUINDCLI,'WUNOMCON':WUNOMCON,'WUCOGCON':WUCOGCON,'WUBCITCLI':WUBCITCLI,'WUBSTACLI':WUBSTACLI,'WUDATNAS':WUDATNAS,'WUCODFIS':WUCODFIS,'WUNDOCCLI':WUNDOCCLI,'WUADOCRIL':WUADOCRIL,'WURDOCCLI':WURDOCCLI,'WUSDOCCLI':WUSDOCCLI,'WUSEXCLI':WUSEXCLI,'WUTDOCCLI':WUTDOCCLI,'WUFLGALL':WUFLGALL,'WUNCODFIS':WUNCODFIS,'WUCODMAGE':WUCODMAGE,'xMADESCRI':xMADESCRI,'xDESDIP':xDESDIP,'WUNOTE':WUNOTE,'WUFLGFRC':WUFLGFRC,'WUORIGCF':WUORIGCF,'WUSTACLI':WUSTACLI,'WUNSTACLI':WUNSTACLI,'WUNSEXCLI':WUNSEXCLI"+FoundlingChildrenList("armt_wu_chkerr",true)+"}";
  public static final String i_ItemSequence = "WUTIPOPE,WUCODICE,WUNDATOPE,WUNCAPCLI,WUNDATNAS,WUNRDOCCLI,WUNSDOCCLI,WUNTDOCCLI,WUNSTADES,WUNCODDIP,WUNCITCLI,WUNBSTACLI,WUNBCITCLI,WUFLGALL,WUNCODFIS,WUNOTE,WUFLGFRC,WUNSTACLI,WUNSEXCLI"+FoundlingChildrenList("armt_wu_chkerr",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_wu_chkerr"),new String[][]{new String[]{"WUTIPOPE","Send o Payment","C","1","0","campo","nokey","false","false"},new String[]{"WUCODICE","Progressivo","N","10","0","campo","key1","false","false"},new String[]{"WUNDATOPE","Nuova Data Operazione","D","8","0","campo","nokey","false","false"},new String[]{"WUNCAPCLI","Nuovo CAP Cliente","C","5","0","campo","nokey","false","false"},new String[]{"WUNDATNAS","Nuova Data Nascita Cliente","D","8","0","campo","nokey","false","false"},new String[]{"WUNRDOCCLI","Nuova Data Rilascio Documento","D","8","0","campo","nokey","false","false"},new String[]{"WUNSDOCCLI","Nuova Data Scadenza Documento","D","8","0","campo","nokey","false","false"},new String[]{"WUNTDOCCLI","Tipo Documento","C","1","0","campo","nokey","false","false"},new String[]{"WUNSTADES","Nuovo Stato Destinazione WU","C","3","0","campo","nokey","false","false"},new String[]{"WUNCODDIP","Nuovo Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"WUNCITCLI","Città Cliente","C","40","0","campo","nokey","false","false"},new String[]{"WUNBSTACLI","Nuovo Stato Nascita Cliente","C","40","0","campo","nokey","false","false"},new String[]{"WUNBCITCLI","Nuova Città Nascita Cliente","C","40","0","campo","nokey","false","false"},new String[]{"WUFLGALL","Completata","C","1","0","campo","nokey","false","false"},new String[]{"WUNCODFIS","Codice Fiscale","C","16","0","campo","nokey","false","false"},new String[]{"WUNOTE","Elenco Errori","M","10","0","campo","nokey","false","false"},new String[]{"WUFLGFRC","Forza caricamento movimento","C","1","0","campo","nokey","false","false"},new String[]{"WUNSTACLI","Nuovo Stato Residenza Cliente","C","30","0","campo","nokey","false","false"},new String[]{"WUNSEXCLI","Nuovo Sesso Cliente","C","1","0","campo","nokey","false","false"}});
  ...
  public armt_wu_chkerrBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wuchkimp = p_ContextObject.GetPhName("wuchkimp",p_ContextObject.GetCompany(),false);
    m_cServer_wuchkimp = p_ContextObject.GetServer("wuchkimp");
    m_oWrInfo_wuchkimp = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wuchkimp",p_ContextObject.GetCompany());
    m_cVirtName_wuchkimp = CPSql.ManipulateTablePhName("wuchkimp",m_cServer_wuchkimp);
    ...
    m_MNTs = CPLib.MNTChilds("armt_wu_chkerr",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_WVLDFVKALY(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_WUNSTACLI))) {
      ...
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_WUNSTACLI,"C",30,0),m_cServer_tbstati,w_WUNSTACLI);
      if (m_Ctx.IsSharedTemp("tbstati")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_wu_chkerr","wuchkimp",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_wu_chkerr",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_wu_chkerr",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_wu_chkerr",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_wu_chkerr"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_wu_chkerr\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wuchkimp"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("WUCODICE","N",10,0));
  }
