...
HideUI.lblids["CODSOG"]=['BWVJMZXBAZ'];
HideUI.lblids["LEGAME"]=['YNZSSJFJCM'];
...
m_oFather.i_last_focused_item='child_ardt_mogopebo';
...
function Help() {
windowOpenForeground('../doc/ardt_mogopebo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'mogopebo'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_mogopebo',m_cSelectedPage);
