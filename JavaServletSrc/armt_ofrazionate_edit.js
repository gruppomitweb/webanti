...
function DisplayErrorMessage_ardt_clientifrz() {
if ( ! (ChildToLoad(FrameRef('ardt_clientifrz'))) && Ne(typeof(FrameRef('ardt_clientifrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_clientifrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_mlientifrz() {
if ( ! (ChildToLoad(FrameRef('ardt_mlientifrz'))) && Ne(typeof(FrameRef('ardt_mlientifrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_mlientifrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_sogopefraz() {
if ( ! (ChildToLoad(FrameRef('ardt_sogopefraz'))) && Ne(typeof(FrameRef('ardt_sogopefraz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_sogopefraz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_mogopefbo() {
if ( ! (ChildToLoad(FrameRef('ardt_mogopefbo'))) && Ne(typeof(FrameRef('ardt_mogopefbo').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_mogopefbo').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_meneficfrz() {
if ( ! (ChildToLoad(FrameRef('ardt_meneficfrz'))) && Ne(typeof(FrameRef('ardt_meneficfrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_meneficfrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_beneficfrz() {
if ( ! (ChildToLoad(FrameRef('ardt_beneficfrz'))) && Ne(typeof(FrameRef('ardt_beneficfrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_beneficfrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_terzistifrz() {
if ( ! (ChildToLoad(FrameRef('ardt_terzistifrz'))) && Ne(typeof(FrameRef('ardt_terzistifrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_terzistifrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_merzistifrz() {
if ( ! (ChildToLoad(FrameRef('ardt_merzistifrz'))) && Ne(typeof(FrameRef('ardt_merzistifrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_merzistifrz').DisplayErrorMessage();
}
}
...
function DisplayErrorMessage_armt_fraziobo_agg() {
if ( ! (ChildToLoad(FrameRef('armt_fraziobo_agg'))) && Ne(typeof(FrameRef('armt_fraziobo_agg').DisplayErrorMessage),'undefined')) {
FrameRef('armt_fraziobo_agg').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_frz_contante() {
if ( ! (ChildToLoad(FrameRef('ardt_frz_contante'))) && Ne(typeof(FrameRef('ardt_frz_contante').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_frz_contante').DisplayErrorMessage();
}
}
...
if (IsDisabledByStateDriver('Soggetti')) {
...
if (IsDisabledByStateDriver('AltreControparti')) {
...
if (IsDisabledByStateDriver('AltriSoggTerzi')) {
...
if (IsDisabledByStateDriver('Aggiuntivi')) {
DisableInputsInContainer(Ctrl('RNCPQBELNU'),true);
}
if (IsDisabledByStateDriver('SV')) {
DisableInputsInContainer(Ctrl('MOGXTATYIF'),true);
}
...
DisableInputsInContainer(Ctrl('GNPYRENPRZ'),true);
}
if (IsDisabledByStateDriver('Intermediario7')) {
DisableInputsInContainer(Ctrl('ZKIEGJMZVC'),true);
}
if (IsDisabledByStateDriver('Contante')) {
DisableInputsInContainer(Ctrl('HFENTZBUDL'),true);
}
...
SetObligatory(Ctrl('KUMAEYPETV'),Eq(w_FLAGCONT,'1') || IsObligatoryByStateDriver('xTOTCONT'));
SetObligatory(Ctrl('WBHSORBZAV'), ! (Empty(w_CONNESOPER)) || IsObligatoryByStateDriver('TIPOLEG'));
...
SetObligatory(Ctrl('OBBUSHLGFO'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && w_CALCOLI || IsObligatoryByStateDriver('TIPOINT2'));
SetObligatory(Ctrl('TYCTKKPTQQ'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Empty(w_CODINT2) && Eq(w_gVerSim,'N') && w_CALCOLI || IsObligatoryByStateDriver('DESCINTER'));
SetObligatory(Ctrl('MUTRCJYNJT'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && w_CALCOLI || IsObligatoryByStateDriver('PAESE'));
SetObligatory(Ctrl('CRVLITCYRD'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') && w_CALCOLI || IsObligatoryByStateDriver('CODCAB2'));
SetObligatory(Ctrl('KDONRVZYMP'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') && w_CALCOLI || IsObligatoryByStateDriver('DESC2'));
SetObligatory(Ctrl('HWGWORUQJF'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') && w_CALCOLI || IsObligatoryByStateDriver('PROV2'));
}
...
var c;
if(c=Ctrl('SDNFDOJDLP')) c.title=Strtran(AlertErrorMessage('11446531735',w_xDescDipe),'\\n',"\n");
...
if ( ! (ChildToLoad(FrameRef('armt_fraziobo_agg'))) && Ne(typeof(FrameRef('armt_fraziobo_agg').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('armt_fraziobo_agg'),['SEGNO'],['SEGNO'],true)
}
...
l_bResult=(w_COMPLETA?arfn_chksogg(w_CONNESCLI,'7'):true);
if ( ! (l_bResult)) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_ofrazionate_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_ofrazionate_dataNotSent',{'action':formaction});
}
}
}
}
CheckChild.child=[{'prg':"ardt_clientifrz",'BOScId':function(){ return FrameRef('ardt_clientifrz')},'repeated':0},{'prg':"ardt_mlientifrz",'BOScId':function(){ return FrameRef('ardt_mlientifrz')},'repeated':0},{'prg':"ardt_sogopefraz",'BOScId':function(){ return FrameRef('ardt_sogopefraz')},'repeated':0},{'prg':"ardt_mogopefbo",'BOScId':function(){ return FrameRef('ardt_mogopefbo')},'repeated':0},{'prg':"ardt_meneficfrz",'BOScId':function(){ return FrameRef('ardt_meneficfrz')},'repeated':0},{'prg':"ardt_beneficfrz",'BOScId':function(){ return FrameRef('ardt_beneficfrz')},'repeated':0},{'prg':"ardt_terzistifrz",'BOScId':function(){ return FrameRef('ardt_terzistifrz')},'repeated':0},{'prg':"ardt_merzistifrz",'BOScId':function(){ return FrameRef('ardt_merzistifrz')},'repeated':0},{'prg':"ardt_docfrabo",'BOScId':function(){ return FrameRef('ardt_docfrabo')},'repeated':0},{'prg':"armt_fraziobo_agg",'BOScId':function(){ return FrameRef('armt_fraziobo_agg')},'repeated':0},{'prg':"ardt_frz_contante",'BOScId':function(){ return FrameRef('ardt_frz_contante')},'repeated':0}];
function Check() {
var l_bResult = true;
var l_bChildCheck = true;
ResetErrorVars();
m_nLastError=0;
if ( ! (_ChkObl('NJDOYSOENB',1))) {
_SignErr('NJDOYSOENB');
...
l_bResult=false;
w_CODDIPE=HtW('','C');
} else if (( ! (_ChkObl('WAAXEDMKXA',1))) || ( ! ((w_COMPLETA?Ge(w_DATAREG,w_DATAOPE):true)))) {
_SignErr('WAAXEDMKXA','12128708791');
l_bResult=false;
w_DATAOPE=HtW('','D');
} else if ((Ne(w_gChkDate,'U') && Ne(w_gChkDate,'B') && Eq(w_gFlgDTP,0)) && (( ! (_ChkObl('NXYGHZZLCG',1))) || ( ! ((w_COMPLETA?Ge(w_DATAREG,w_DATAOPE):true))))) {
...
l_bResult=false;
w_FLAGCONT=HtW('','C');
} else if ((Eq(w_FLAGCONT,'1')) && ( ! (_ChkObl('KUMAEYPETV',1)))) {
_SignErr('KUMAEYPETV');
...
_SignErr('TYCTKKPTQQ');
m_cLastWorkVarErrorMsg='1663847307';
l_bResult=false;
w_DESCINTER=HtW('','C');
...
_FillChildren.n=['ardt_clientifrz','ardt_mlientifrz','ardt_sogopefraz','ardt_mogopefbo','ardt_meneficfrz','ardt_beneficfrz','ardt_terzistifrz','ardt_merzistifrz','ardt_docfrabo','armt_fraziobo_agg','ardt_frz_contante'];
FillWv.n=["CONNESDOC","IDBASE","CODINTER","CODDIPE","DESCCIT","PROVINCIA","CODCAB","DATAOPE","NUMPROG","CDATOPE","CDATAOPE","ANNOOPE","DATAREG","CDATREG","FLAGFRAZ","COLLEG","TIPOOPRAP","idcauana","CODANA","CODVOC","FLAGLIRE","VALUTA","FLAGCONT","CAMBIO","IMPIN","IMPOUT","RAPPORTO","CONNESCLI","PROQUOTA","CONNESOPER","TIPOLEG","PAGASOGOP","CONNESBEN","CONNALTRO","C_RAG","C_CTA","C_PRV","C_CAP","C_CAB","C_IND","C_STA","TIPOINT2","CODINT2","DESCINTER","PAESE","C_RAPPORTO","CODCAB2","DESC2","PROV2","ZCPARTE","STATOREG","DATARETT","OPERAZMOD","TIPOINF","SEGNO","IDFILE","MTCN","TOTLIRE","TOTCONT","IDEREG","FLAGRAP","OPRAP","RAPPORTBEN","OPERATORE","AUTOM","FLAGRAP2","PRGIMPFRZ","IDBASE2","NOPROT","OPERAG","RESPINS","INFORM","NATURA","SCOPO","SV58550","SV58550MA","DURAT","AMMONT","AREAGEO","MODSVOL","RAGIO","TIPO","DUCOLLEG","ORACOLLEG","IPCOLLEG","MEZPAG","PRESTAZ","NOSARA","RFREQ","RIMP","RAREA","RCOMP","RRAGIO","RTIPO","RISGLOB","MITIG","MITIGDOC","DESPUNTO","CODCLICON","TIPATT","VASP","RIFIMP","xRAGSOCDOC","gIntemediario","gChkDate","gTipInter","gSblocco","gFlgWU","gStatus","gDataVaria","gFlgDoc","gFlgDTP","gSeekAos","gVerSim","dataoggi","filtro","sEdit","test","datpaseuro","tipope","stringaflagrap2","apporeg","appolire","xTOTLIRE","xTOTCONT","xdestipleg","xragsocct","xDescDipe","descdiv","valflg2","xragint2","errmsg","CABINT","xragsocper","desccauana","xragsocben","xdesccausin","xdescpaese2","xdescrap","xdes1","xcodfisc","xdciticon","dessta","xragsocalt","xFLGITAEST","CITINT","CITDIP","PROVDIP","CABDIP","PROVINT","DATAVALI","DATARILASC","xdescopeage","xdescfreq","xdescammo","xdescareag","xdescmodsvo","xdescplauso","xdesctipor","CALCOLI","COMPLETA"];
function SetModified() {
m_bUpdated=true;
}
function SetChildVariables_ardt_clientifrz() {
}
function CtxLoad_ardt_clientifrz() {
if (ChildToLoad(FrameRef('ardt_clientifrz'))) {
return [LoadContext(0,'BOAFVDQFRN'),'ardt_clientifrz'];
}
}
function SetChildVariables_ardt_mlientifrz() {
}
function CtxLoad_ardt_mlientifrz() {
if (ChildToLoad(FrameRef('ardt_mlientifrz'))) {
return [LoadContext(0,'VTDYLKLZYX'),'ardt_mlientifrz'];
}
}
function SetChildVariables_ardt_sogopefraz() {
}
function CtxLoad_ardt_sogopefraz() {
if (ChildToLoad(FrameRef('ardt_sogopefraz'))) {
return [LoadContext(0,'TQDGESLQVD'),'ardt_sogopefraz'];
}
}
function SetChildVariables_ardt_mogopefbo() {
}
function CtxLoad_ardt_mogopefbo() {
if (ChildToLoad(FrameRef('ardt_mogopefbo'))) {
return [LoadContext(0,'CHLTBGCVDY'),'ardt_mogopefbo'];
}
}
function SetChildVariables_ardt_meneficfrz() {
}
function CtxLoad_ardt_meneficfrz() {
if (ChildToLoad(FrameRef('ardt_meneficfrz'))) {
return [LoadContext(0,'OZFWYFQQTV'),'ardt_meneficfrz'];
}
}
function SetChildVariables_ardt_beneficfrz() {
}
function CtxLoad_ardt_beneficfrz() {
if (ChildToLoad(FrameRef('ardt_beneficfrz'))) {
return [LoadContext(0,'OCTDIOXFMI'),'ardt_beneficfrz'];
}
}
function SetChildVariables_ardt_terzistifrz() {
}
function CtxLoad_ardt_terzistifrz() {
if (ChildToLoad(FrameRef('ardt_terzistifrz'))) {
return [LoadContext(0,'NOKYMTFBFL'),'ardt_terzistifrz'];
}
}
function SetChildVariables_ardt_merzistifrz() {
}
function CtxLoad_ardt_merzistifrz() {
if (ChildToLoad(FrameRef('ardt_merzistifrz'))) {
return [LoadContext(0,'LUESWSIYXN'),'ardt_merzistifrz'];
}
}
...
function SetChildVariables_armt_fraziobo_agg() {
if ( ! (ChildToLoad(FrameRef('armt_fraziobo_agg'))) && Ne(typeof(FrameRef('armt_fraziobo_agg').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('armt_fraziobo_agg'),['SEGNO'],['SEGNO'],false)
}
}
function CtxLoad_armt_fraziobo_agg() {
if (ChildToLoad(FrameRef('armt_fraziobo_agg'))) {
return [LoadContext(0,'RZOXJTRIYP'),'armt_fraziobo_agg'];
}
}
function SetChildVariables_ardt_frz_contante() {
}
function CtxLoad_ardt_frz_contante() {
if (ChildToLoad(FrameRef('ardt_frz_contante'))) {
return [LoadContext(0,'QMSPZAQYXJ'),'ardt_frz_contante'];
}
}
