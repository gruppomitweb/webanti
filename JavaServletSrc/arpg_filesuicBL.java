...
public class arpg_filesuicBL extends arpg_filesuicWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_idfile;
  ...
  public static final String i_EntityName = "arpg_filesuic";
  ...
  public arpg_filesuicBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_filesuic","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_idfile=c_idfile;
  ...
  public void TrsToWork() {
    c_idfile= m_oTrs.get(m_nCurrentRow).c_idfile;
