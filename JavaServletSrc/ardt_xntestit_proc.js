...
if (Ne(typeof(Calculation_TDLAKFIXPS),'undefined')) {
old_c=m_bCalculating;
m_bCalculating=true;
...
m_oFather.i_last_focused_item='child_ardt_xntestit';
...
function Help() {
windowOpenForeground('../doc/ardt_xntestit_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'xntestit'+'\\'+CPLib.ToCPStr(w_CODCLI);
}
...
p_d.setValue('ardt_xntestit',m_cSelectedPage);
