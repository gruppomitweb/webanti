...
public class ardt_xiduciaboBL extends ardt_xiduciaboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xiduciabo";
  ...
  public CPPhTableWrInfo m_oWrInfo_xiduciabo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xiduciabo;
  ...
  public static String[] m_EntityTables = {"xiduciabo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_xiduciabo",true,true)+"}"+FoundlingChildrenList("ardt_xiduciabo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'NUMCOL':NUMCOL,'m_Detail':{'CODSOG':CODSOG,'TIPOFILE':TIPOFILE,'LEGAME':LEGAME,'UCODE':UCODE,'IDBASE':IDBASE,'xragsoc':xragsoc,'PROVINCIA':PROVINCIA,'CAP':CAP,'DESCCIT':DESCCIT,'DOMICILIO':DOMICILIO"+FoundlingChildrenList("ardt_xiduciabo",true,true)+"},'NUMIMP':NUMIMP"+FoundlingChildrenList("ardt_xiduciabo",true,false)+"}";
  public static final String i_ItemSequence = "RAPCOL,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_xiduciabo",false,true)+"]"+FoundlingChildrenList("ardt_xiduciabo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_xiduciabo"),new String[][]{new String[]{"RAPCOL","Codice rapporto Collegato","C","25","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_xiduciaboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xiduciabo = p_ContextObject.GetPhName("xiduciabo",p_ContextObject.GetCompany(),false);
    m_cServer_xiduciabo = p_ContextObject.GetServer("xiduciabo");
    m_oWrInfo_xiduciabo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xiduciabo",p_ContextObject.GetCompany());
    m_cVirtName_xiduciabo = CPSql.ManipulateTablePhName("xiduciabo",m_cServer_xiduciabo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xiduciabo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xiduciabo","xiduciabo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xiduciabo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xiduciabo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xiduciabo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xiduciabo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xiduciabo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xiduciabo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xiduciabo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPCOL","C",25,0));
  }
  public String RowPrimaryKey() {
    return "xiduciabo"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
