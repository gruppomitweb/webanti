...
// * --- Fine Area Manuale
public class arrt_start_imp_masscfR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_start_imp_masscfR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_start_imp_masscf",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_import_masscf */
    Forward f;
    f=new Forward("arpg_import_masscf",false,this,Forward.Start,false);
  ...
  public static arrt_start_imp_masscfR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_start_imp_masscfR(p_Ctx, p_Caller);
  }
  public void Blank() {
