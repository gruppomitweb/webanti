...
// * --- Fine Area Manuale
public class arrt_lancia_import_wu_erroriR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_wu_erroriR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_wu_errori",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_import_wu_errori";
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_import_wu_errori */
    Forward f;
    f=new Forward("arpg_import_wu_errori",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_import_wu_erroriR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_wu_erroriR(p_Ctx, p_Caller);
  }
  public void Blank() {
