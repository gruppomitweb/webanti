...
public class aosdt_ind_mitBL extends aosdt_ind_mitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "aosdt_ind_mit";
  ...
  public CPPhTableWrInfo m_oWrInfo_ind_mit;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_ind_mit;
  ...
  public static String[] m_EntityTables = {"ind_mit"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDMOD':IDMOD,'m_Detail':{'IDIND':IDIND,'PROGIND':PROGIND,'DESCRI':DESCRI,'aosdt_sub_ind_mit':aosdt_sub_ind_mit,'DESCRI_layer':DESCRI_layer"+FoundlingChildrenList("aosdt_ind_mit",true,true)+"}"+FoundlingChildrenList("aosdt_ind_mit",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDMOD':IDMOD,'m_Detail':{'IDIND':IDIND,'PROGIND':PROGIND,'DESCRI':DESCRI,'aosdt_sub_ind_mit':aosdt_sub_ind_mit,'DESCRI_layer':DESCRI_layer"+FoundlingChildrenList("aosdt_ind_mit",true,true)+"}"+FoundlingChildrenList("aosdt_ind_mit",true,false)+"}";
  public static final String i_ItemSequence = "IDMOD,m_Detail[ IDIND PROGIND DESCRI aosdt_sub_ind_mit DESCRI_layer"+FoundlingChildrenList("aosdt_ind_mit",false,true)+"]"+FoundlingChildrenList("aosdt_ind_mit",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("aosdt_ind_mit"),new String[][]{new String[]{"IDMOD","ID del modello","C","10","0","campo","key1","false","false"},new String[]{"IDIND","ID del indicatore","C","10","0","campo","key1","true","false"},new String[]{"PROGIND","Progressivo indicatore","C","10","0","campo","key2","true","false"},new String[]{"DESCRI","Descrizione del indicatore","M","10","0","campo","nokey","true","false"},new String[]{"aosdt_sub_ind_mit","Sub Indicatori anomalia mit","","","","link_PC","","true",""},new String[]{"DESCRI_layer","Descrizione","M","10","0","variabile","nokey","true","false"}});
  ...
  public aosdt_ind_mitBL (CPContext p_ContextObject) {
    ...
    m_cPhName_ind_mit = p_ContextObject.GetPhName("ind_mit",p_ContextObject.GetCompany(),false);
    m_cServer_ind_mit = p_ContextObject.GetServer("ind_mit");
    m_oWrInfo_ind_mit = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"ind_mit",p_ContextObject.GetCompany());
    m_cVirtName_ind_mit = CPSql.ManipulateTablePhName("ind_mit",m_cServer_ind_mit);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    aosdt_sub_ind_mit = new aosdt_sub_ind_mitBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("aosdt_ind_mit",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || aosdt_sub_ind_mit.IsUpdated() || CPLib.IsUpdated(m_cWv_aosdt_sub_ind_mit);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    aosdt_sub_ind_mit.SaveDependsOn();
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("aosdt_ind_mit","ind_mit",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_m_cWv_aosdt_sub_ind_mit;
      p_m_cWv_aosdt_sub_ind_mit = CPLib.GetProperties(trs_p.getProperty("m_cWv_aosdt_sub_ind_mit"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        aosdt_sub_ind_mit = new aosdt_sub_ind_mitBO(m_Ctx);
        m_cWv_aosdt_sub_ind_mit = "";
        m_cWv_aosdt_sub_ind_mit = CPLib.GetProperty(p_m_cWv_aosdt_sub_ind_mit,"",m_cWv_aosdt_sub_ind_mit,i);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("sub_ind_mit");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("sub_ind_mit",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("sub_ind_mit\u0000false\u0000false\u00001\u00000\u0000aosdt_sub_ind_mit\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("aosdt_ind_mit",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("aosdt_ind_mit",child);
    ...
    for(String child : CPLib.LoadableMNTs("aosdt_ind_mit",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    aosdt_sub_ind_mit = new aosdt_sub_ind_mitBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("aosdt_ind_mit",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"aosdt_ind_mit"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"aosdt_ind_mit\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_m_cWv_aosdt_sub_ind_mit;
    p_m_cWv_aosdt_sub_ind_mit = new Properties();
    Properties p_opk_IDIND;
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      if (p_bGetChildren) {
        if (aosdt_sub_ind_mit.IsUpdated()) {
          m_cWv_aosdt_sub_ind_mit = aosdt_sub_ind_mit.GetContext();
        }
        CPLib.PutProperty(p_m_cWv_aosdt_sub_ind_mit,"",m_cWv_aosdt_sub_ind_mit,trsrow);
      }
    ...
    trs_p.setProperty("m_cWv_aosdt_sub_ind_mit",CPLib.ToProperties(p_m_cWv_aosdt_sub_ind_mit));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "ind_mit"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDMOD","C",10,0));
  }
  public String RowPrimaryKey() {
    return "ind_mit"+"\\"+CPLib.ToCPStr(w_IDIND);
  }
  ...
  public boolean ChildExists_aosdt_sub_ind_mit() {
    if (aosdt_sub_ind_mit.IsUpdated() || (CPLib.IsUpdated(m_cWv_aosdt_sub_ind_mit) || CPLib.IsLoaded(m_cWv_aosdt_sub_ind_mit))) {
      return true;
    } else if (m_bLoaded &&  ! (aosdt_sub_ind_mit.m_bLoaded)) {
      aosdt_sub_ind_mit.Blank();
      aosdt_sub_ind_mit.w_IDMOD = w_IDMOD;
      aosdt_sub_ind_mit.w_IDIND = w_IDIND;
      if (CPLib.ne(RowStatus(),"A")) {
        aosdt_sub_ind_mit.Load();
      }
    }
    return aosdt_sub_ind_mit.m_bLoaded;
  }
  public void CtxLoad_aosdt_sub_ind_mit() {
    if ( ! (aosdt_sub_ind_mit.m_lCtxLoaded)) {
      aosdt_sub_ind_mit.Blank();
    }
    aosdt_sub_ind_mit.m_lCtxLoaded = true;
    if ( ! (aosdt_sub_ind_mit.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_aosdt_sub_ind_mit) || CPLib.IsLoaded(m_cWv_aosdt_sub_ind_mit)) {
        aosdt_sub_ind_mit.SetFromContext(m_cWv_aosdt_sub_ind_mit);
        m_cWv_aosdt_sub_ind_mit = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (aosdt_sub_ind_mit.m_bLoaded)) {
          aosdt_sub_ind_mit.Blank();
          aosdt_sub_ind_mit.w_IDMOD = w_IDMOD;
          aosdt_sub_ind_mit.w_IDIND = w_IDIND;
          if (CPLib.ne(RowStatus(),"A")) {
          ...
          if ( ! (aosdt_sub_ind_mit.m_bLoaded)) {
            aosdt_sub_ind_mit.Initialize();
            aosdt_sub_ind_mit.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"aosdt_sub_ind_mit")) {
      CtxLoad_aosdt_sub_ind_mit();
      return aosdt_sub_ind_mit;
    }
  ...
  protected void TrsToWork() {
    ...
    m_cWv_aosdt_sub_ind_mit= m_oTrs.get(m_nCurrentRow).m_cWv_aosdt_sub_ind_mit;
    aosdt_sub_ind_mit= m_oTrs.get(m_nCurrentRow).aosdt_sub_ind_mit;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).m_cWv_aosdt_sub_ind_mit=m_cWv_aosdt_sub_ind_mit;
    m_oTrs.get(m_nCurrentRow).aosdt_sub_ind_mit=aosdt_sub_ind_mit;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).m_cWv_aosdt_sub_ind_mit=m_cWv_aosdt_sub_ind_mit;
    m_oDeletedRows.get(l_nRows).aosdt_sub_ind_mit=aosdt_sub_ind_mit;
  ...
  boolean CanSaveConditionallyRow(boolean p_bSaveWork) {
    ...
    if (CPLib.ge(m_nCurrentRow,Rows())) {
      ...
      if (l_bResult && (( ! (aosdt_sub_ind_mit.m_bLoaded) && CPLib.IsLoaded(m_cWv_aosdt_sub_ind_mit)) || ( ! (aosdt_sub_ind_mit.m_bUpdated) && CPLib.IsUpdated(m_cWv_aosdt_sub_ind_mit)))) {
        aosdt_sub_ind_mit.SetFromContext(m_cWv_aosdt_sub_ind_mit);
        m_cWv_aosdt_sub_ind_mit = "_not_empty_";
      }
      if (l_bResult && (aosdt_sub_ind_mit.m_bLoaded || aosdt_sub_ind_mit.m_bUpdated)) {
        l_bResult = l_bResult && aosdt_sub_ind_mit.Check();
        l_bNoCheck = l_bResult;
        if ( ! (l_bNoCheck)) {
          m_cLastMsgError = aosdt_sub_ind_mit.m_cLastMsgError;
        }
      }
      if ( ! (l_bNoCheck)) {
        m_nLastError = 2;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    m_cWv_aosdt_sub_ind_mit= m_oDeletedRows.get(l_RowNumberToSet).m_cWv_aosdt_sub_ind_mit;
    aosdt_sub_ind_mit= m_oDeletedRows.get(l_RowNumberToSet).aosdt_sub_ind_mit;
