...
public class arpg_ope_modopen2BL extends arpg_ope_modopen2WV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_ope_modopen2";
  ...
  public static final String i_StateStructure = "{'datarett':datarett}";
  public static final String i_CompleteStateStructure = "{'datarett':datarett,'oldprog':oldprog,'oldidbase':oldidbase,'oldrappo':oldrappo,'oldrnumrig':oldrnumrig,'oldfile':oldfile}";
  public static final String i_ItemSequence = "datarett";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"datarett","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_ope_modopen2BL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_ope_modopen2","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
