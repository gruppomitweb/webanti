// Definition generated from table wersonbo
public class MemoryCursor_wersonbo extends CPMemoryCursor {
  MemoryCursorRow_wersonbo row;
  MemoryCursorRow_wersonbo empty_row;
  public MemoryCursor_wersonbo() {
    empty_row = new MemoryCursorRow_wersonbo();
    row = empty_row;
  }
  public MemoryCursor_wersonbo(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  public void AppendData(java.util.Properties p,CPContext p_Ctx) {
    ...
    java.util.Properties p_sanumpro;
    p_sanumpro = new java.util.Properties();
    ...
    while (e.hasMoreElements()) {
      ...
      if ("sanumpro".equalsIgnoreCase(key)) {
        p_sanumpro = CPLib.GetProperties(p.getProperty(key));
      }
    ...
    for ( i = 1; CPLib.le(i,Rows); i = i + (1)) {
      ...
      row.sanumpro = CPLib.GetProperty(p_sanumpro,"","",i);
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_wersonbo)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_wersonbo();
  }
  ...
  public MemoryCursorRow_wersonbo _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_wersonbo _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_wersonbo> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_wersonbo();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_wersonbo p_Row) {
    MemoryCursorRow_wersonbo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_wersonbo p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_wersonbo();
    }
    this.row.Copy(p_Row);
    return true;
  }
