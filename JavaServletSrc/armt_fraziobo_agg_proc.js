...
m_oFather.i_last_focused_item='child_armt_fraziobo_agg';
...
function Help() {
windowOpenForeground('../doc/armt_fraziobo_agg_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'fraziobo_agg'+'\\'+CPLib.ToCPStr(w_IDBASE);
}
function CheckZone(me) {
if (IsWndAccessible(window['m_oFather'])) {
return m_oFather.CheckZone('child_armt_fraziobo_agg');
}
return true;
}
GetSelectedChildPage.child={}
function GetSelectedPage(p_d) {
p_d.setValue('armt_fraziobo_agg',m_cSelectedPage);
