...
// * --- Fine Area Manuale
public class arrt_cgo_read_codfisc_multiR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_cgo_read_codfisc_multiR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_cgo_read_codfisc_multi",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_cgo_read_codfisc_multi";
  ...
  public String RunAsync(armt_cgo_oper_multiBO p_pObj,String p_pTipo) {
    pObj = p_pObj;
    pTipo = p_pTipo;
  ...
  public Forward Run(armt_cgo_oper_multiBO p_pObj,String p_pTipo) {
    pObj = p_pObj;
    pTipo = p_pTipo;
    return Run();
  }
  ...
  public static arrt_cgo_read_codfisc_multiR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_cgo_read_codfisc_multiR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
    pTipo = CPLib.Space(1);
