...
// * --- Fine Area Manuale
public class arrt_wuaccchkimpR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_wuaccchkimpR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_wuaccchkimp",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("_mtcnold",p_cVarName)) {
      return _mtcnold;
    }
  ...
  public java.sql.Date GetDate(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("_olddatreg",p_cVarName)) {
      return _olddatreg;
    }
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000000B2")+"delete from "+m_oWrInfo.GetTableWriteName();
      m_cSql = m_cSql+" where ";
      m_cSql = m_cSql+"WUCODMAGE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_codmage,"?",0,0,m_cServer),m_cServer,w_codmage)+"";
      ...
      /* Exec "Estrae i file dallo zip" Page 5:Page_5 */
      Page_5();
      ...
      while ( ! (Cursor_tmp_list_imprich.Eof())) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000000BE")+"delete from "+m_oWrInfo.GetTableWriteName();
        m_cSql = m_cSql+" where ";
      ...
      try {
        ...
        while ( ! (FileLibMit.Eof(fhand))) {
          ...
          if (CPLib.eqr(CPLib.Left(riga,1),"S") || CPLib.eqr(CPLib.Left(riga,1),"P")) {
                ...
                if (CPLib.eqr(_i,1)) {
                  ...
                  while (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
                    ...
                    if (CPLib.eqr(_npos,1)) {
                      ...
                      /* _coddip := Substr(LRTrim(_riga1_2),4,6) */
                      _coddip = CPLib.Substr(CPLib.LRTrim(_riga1_2),4,6);
                      /* Case _npos = 3 */
                  ...
                  while (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
                    ...
                    if (CPLib.eqr(_npos,1)) {
                      ...
                      if ( ! (Read_Cursor.Eof())) {
                        ...
                        Read_Cursor.Next();
                        if ( ! (Read_Cursor.Eof())) {
                          Error l_oErrorFault = new Error("Read on wucodes into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
            ...
            /* Exec "Controlla Esistenza MTCN" Page 6:Page_6 */
            Page_6();
            if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
              throw new RoutineException();
            }
            /* If Empty(LRTrim(_mtcnold)) */
            if (CPLib.Empty(CPLib.LRTrim(_mtcnold))) {
              /* conta := conta + 1 */
              conta = CPLib.Round(conta+1,0);
              /* Exec "Controllo dati di base" Page 8:Page_8 */
              Page_8();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              if (CPLib.eqr(_esito,0)) {
                ...
                if (CPLib.eqr(CPLib.Substr(_codfis,12,1),"Z")) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on personbo into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_connes))) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000257")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on kersonbo into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_condoc))) {
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000260")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"kersonbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000266")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  if (CPLib.eqr(w_opextc,"S")) {
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000026E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000026F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  if (CPLib.eqr(_aggcli,1)) {
                    ...
                    while ( ! (Cursor_personbo.Eof())) {
                      ...
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000282")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000288")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Left(_cab,6),"C",6,0,m_cServer)+", ";
                    m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(_cognome)+" "+CPLib.LRTrim(_nome),70),"C",70,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DOMICILIO = "+CPLib.ToSQL(CPLib.Left(_via,35),"C",35,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(_codfis,"C",16,0,m_cServer)+", ";
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_condoc))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"kersonbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000291")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    if (CPLib.eqr(_aggcli,1)) {
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"kersonbo",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000298")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                      m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Left(_cab,6),"C",6,0,m_cServer)+", ";
                      m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(_cognome)+" "+CPLib.LRTrim(_nome),70),"C",70,0,m_cServer)+", ";
                      m_cSql = m_cSql+"DOMICILIO = "+CPLib.ToSQL(CPLib.Left(_via,35),"C",35,0,m_cServer)+", ";
                      m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(_codfis,"C",16,0,m_cServer)+", ";
                  ...
                  if (CPLib.eqr(w_opextc,"S")) {
                    ...
                    if (CPLib.Empty(CPLib.LRTrim(_prog))) {
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"aeoprig",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002A5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"opextrbo",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002A6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      m_cSql = m_cSql+GetFieldsName_000002A6(m_Ctx,m_oWrInfo);
                      m_cSql = m_cSql+") values (";
                      m_cSql = m_cSql+""+CPLib.ToSQL(_connes,"?",0,0,m_cServer)+", ";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Str(CPLib.Year(_datope),4,0),"?",0,0,m_cServer)+", ";
                      m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                ...
                /* Trova data di registrazione in base a nome file */
                /* Exec "Trova data registrazione in base a file" Page 7:Page_7 */
                Page_7();
                if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                  throw new RoutineException();
                }
                ...
                if (CPLib.eqr(w_destfin,"O")) {
                  ...
                  if (CPLib.eqr(w_tipodest,"P")) {
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002C6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_cSql = m_cSql+""+CPLib.ToSQL(_codfis,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_olddatreg,"?",0,0)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002CC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002D6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002DC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  if (CPLib.eqr(w_tipodest,"P")) {
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002E8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000002E8(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(_cognomecp)+" "+CPLib.LRTrim(_nomecp),70),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_uifdest,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002EE")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002F8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"000002FE")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000002FE(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg2,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(_connes,16),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(_doctype,2),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_esito,1)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wuchkimp",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000309")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000309(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000030C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000030D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              /* Exec "Controlla i dati delle persone" Page 3:Page_3 */
              Page_3();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
    ...
    try {
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        if (CPLib.eqr(_rap,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000032B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_0000032B(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(w_codmage,"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000032D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_0000032D(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(_codrap,"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000032E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000332")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000334")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_00000334(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
        ...
        if (CPLib.eqr(_rap,0)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wurapporti",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000338")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000033A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"knarapbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000033B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_0000033B(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(_codrap,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(_cognome)+" "+CPLib.LRTrim(_nome),"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"0000033F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000341")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      while ( ! (Cursor_xapopebo.Eof())) {
        ...
        if (CPLib.gt(Cursor_xapopebo.GetDate("DATAOPE"),_datope)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapopebo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000344")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000345")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_rapopebo.Eof())) {
        ...
        if (CPLib.gt(Cursor_rapopebo.GetDate("DATAOPE"),_datope)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapopebo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000348")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"DATAOPE = "+CPLib.ToSQL(_datope,"D",8,0)+", ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000349")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(_datope,"D",8,0)+", ";
  ...
  void Page_5() throws Exception {
    /* Estrae i file dal file zip */
    /* czipfile := w_nomefile */
    czipfile = w_nomefile;
    /* gMsgProc := gMsgProc + 'Ora Inizio Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' + czipfile + NL // Messaggio */
    ...
    while (CPLib.lt(contanome,conteggio)) {
      ...
      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_list_imprich",m_Ctx.GetCompany());
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_wuaccchkimp",695,"00000354")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_6() throws Exception {
    ...
    try {
      ...
      if (Read_Cursor!=null)
        Read_Cursor.Close();
      Read_Cursor = m_Sql.Query(m_cServer,"select "+CPLib.GetMultilanguageField("MTCN",m_Ctx,m_cServer)+" from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+m_cSql);
      if ( ! (Read_Cursor.Eof())) {
        _mtcnold = Read_Cursor.GetString("MTCN");
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on operazbo into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
          CPStdCounter.Error(l_oErrorFault);
        }
        Read_Cursor.Close();
      } else {
      ...
      if (CPLib.Empty(CPLib.LRTrim(_mtcnold))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on fraziobo into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
      ...
      if (CPLib.Empty(CPLib.LRTrim(_mtcnold))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on xperazbo into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
      ...
      if (CPLib.Empty(CPLib.LRTrim(_mtcnold))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on xraziobo into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
  ...
  void Page_7() throws Exception {
    ...
    try {
      /* _olddatreg := NullDate() */
      _olddatreg = CPLib.NullDate();
      // * --- Select from operazbo
      m_cServer = m_Ctx.GetServer("operazbo");
      m_cPhName = m_Ctx.GetPhName("operazbo");
      if (Cursor_operazbo!=null)
        Cursor_operazbo.Close();
      Cursor_operazbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select DATAREG  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDFILE="+CPSql.SQLValueAdapter(CPLib.ToSQL(_idfile,"?",0,0,m_cServer, m_oParameters),m_cServer,_idfile)+" "+")"+(m_Ctx.IsSharedTemp("operazbo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
      while ( ! (Cursor_operazbo.Eof())) {
        /* _olddatreg := operazbo->DATAREG */
        _olddatreg = Cursor_operazbo.GetDate("DATAREG");
      ...
      // * --- End Select
      /* If Empty(_olddatreg) */
      if (CPLib.Empty(_olddatreg)) {
        // * --- Select from fraziobo
        m_cServer = m_Ctx.GetServer("fraziobo");
        m_cPhName = m_Ctx.GetPhName("fraziobo");
        if (Cursor_fraziobo!=null)
          Cursor_fraziobo.Close();
        Cursor_fraziobo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select DATAREG  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDFILE="+CPSql.SQLValueAdapter(CPLib.ToSQL(_idfile,"?",0,0,m_cServer, m_oParameters),m_cServer,_idfile)+" "+")"+(m_Ctx.IsSharedTemp("fraziobo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
        while ( ! (Cursor_fraziobo.Eof())) {
          /* _olddatreg := fraziobo->DATAREG */
          _olddatreg = Cursor_fraziobo.GetDate("DATAREG");
      ...
      if (CPLib.Empty(_olddatreg)) {
        ...
        Cursor_xperazbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select DATAREG  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDFILE="+CPSql.SQLValueAdapter(CPLib.ToSQL(_idfile,"?",0,0,m_cServer, m_oParameters),m_cServer,_idfile)+" "+")"+(m_Ctx.IsSharedTemp("xperazbo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
        while ( ! (Cursor_xperazbo.Eof())) {
          /* _olddatreg := xperazbo->DATAREG */
          _olddatreg = Cursor_xperazbo.GetDate("DATAREG");
      ...
      if (CPLib.Empty(_olddatreg)) {
        ...
        Cursor_xraziobo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select DATAREG  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDFILE="+CPSql.SQLValueAdapter(CPLib.ToSQL(_idfile,"?",0,0,m_cServer, m_oParameters),m_cServer,_idfile)+" "+")"+(m_Ctx.IsSharedTemp("xraziobo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
        while ( ! (Cursor_xraziobo.Eof())) {
          /* _olddatreg := xraziobo->DATAREG */
          _olddatreg = Cursor_xraziobo.GetDate("DATAREG");
  ...
  void Page_8() throws Exception {
    ...
    try {
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on anadip into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
          CPStdCounter.Error(l_oErrorFault);
        }
        Read_Cursor.Close();
      } else {
      ...
      if (CPLib.Empty(CPLib.LRTrim(_codfis)) || CPLib.ne(CPLib.Len(CPLib.LRTrim(_codfis)),16)) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on mtstati into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(_codstanas))) {
          ...
          if (CPLib.eqr(CPLib.Substr(_codfis,12,1),"Z")) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbstati into routine arrt_wuaccchkimp returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
  ...
  public static arrt_wuaccchkimpR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_wuaccchkimpR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  protected static String GetFieldsName_000002A6(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000002E8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"C_RAG,";
    p_cSql = p_cSql+"C_STA,";
    p_cSql = p_cSql+"CAMBIO,";
  ...
  protected static String GetFieldsName_000002FE(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"CONNESCLI,";
    p_cSql = p_cSql+"TIPODOC,";
  ...
  protected static String GetFieldsName_00000309(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0000032B(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0000032D(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_00000334(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0000033B(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
