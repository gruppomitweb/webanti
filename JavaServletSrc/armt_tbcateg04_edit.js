...
function Set_C4CODTAB(ctrlValue,kmode,e) {
if (Ne(w_C4CODTAB,ctrlValue)) {
var ctl = _GetCtl(e,'SEJWRQHUSP');
if (_tracker.goon(ctl,ctrlValue)) {
w_C4CODTAB=ctrlValue;
SetModified();
var l_bResult = true;
...
function Set_C4CODICE(ctrlValue,kmode,e) {
if (Ne(w_C4CODICE,ctrlValue)) {
var ctl = _GetCtl(e,'XREVNLNKCY');
if (_tracker.goon(ctl,ctrlValue)) {
w_C4CODICE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
function Set_C4DESCRI(ctrlValue,kmode,e) {
if (Ne(w_C4DESCRI,ctrlValue)) {
var ctl = _GetCtl(e,'RJDJPGMTCC');
if (_tracker.goon(ctl,ctrlValue)) {
w_C4DESCRI=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg04_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg04_dataNotSent',{'action':formaction});
}
}
}
}
...
l_oWv.setValue('C4CODTAB',WtA(w_C4CODTAB,'C'));
l_oWv.setValue('C4CODICE',WtA(w_C4CODICE,'C'));
l_oWv.setValue('C4DESCRI',WtA(w_C4DESCRI,'C'));
...
FillWv.n=["C4CODTAB","C4CODICE","C4DESCRI","IDBASE"];
