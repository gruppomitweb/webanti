...
public class ardt_soggopeBL extends ardt_soggopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_soggope";
  ...
  public CPPhTableWrInfo m_oWrInfo_soggope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_soggope;
  ...
  public static String[] m_EntityTables = {"soggope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'COLLEG':COLLEG,'m_Detail':{'CODINTER':CODINTER,'IDBASE':IDBASE,'PRIMO':PRIMO,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'TIPOLEG':TIPOLEG,'RUOLO':RUOLO"+FoundlingChildrenList("ardt_soggope",true,true)+"}"+FoundlingChildrenList("ardt_soggope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'COLLEG':COLLEG,'m_Detail':{'CODINTER':CODINTER,'IDBASE':IDBASE,'PRIMO':PRIMO,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'TIPOLEG':TIPOLEG,'RUOLO':RUOLO,'xRAGSOC':xRAGSOC"+FoundlingChildrenList("ardt_soggope",true,true)+"}"+FoundlingChildrenList("ardt_soggope",true,false)+"}";
  public static final String i_ItemSequence = "COLLEG,m_Detail[ CODINTER IDBASE PRIMO DATAINI DATAFINE TIPOLEG RUOLO"+FoundlingChildrenList("ardt_soggope",false,true)+"]"+FoundlingChildrenList("ardt_soggope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_soggope"),new String[][]{new String[]{"COLLEG","Codice Soggetto","C","16","0","campo","key1","false","false"},new String[]{"CODINTER","Codice Soggetto Collegato","C","16","0","campo","key1","true","false"},new String[]{"IDBASE","ID Riga","C","10","0","campo","key1","true","false"},new String[]{"PRIMO","Primo Soggetto","N","1","0","campo","nokey","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"},new String[]{"TIPOLEG","Tipo Legame","C","1","0","campo","nokey","true","false"},new String[]{"RUOLO","Ruolo","C","1","0","campo","nokey","true","false"}});
  public static final String i_TrsKeys = ",CODINTER,IDBASE";
  ...
  public ardt_soggopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_soggope = p_ContextObject.GetPhName("soggope",p_ContextObject.GetCompany(),false);
    m_cServer_soggope = p_ContextObject.GetServer("soggope");
    m_oWrInfo_soggope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"soggope",p_ContextObject.GetCompany());
    m_cVirtName_soggope = CPSql.ManipulateTablePhName("soggope",m_cServer_soggope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_soggope",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_NMXBOMFUCN() {
    return Link_NMXBOMFUCN("Full");
  }
  protected boolean Link_NMXBOMFUCN(String p_cType) {
  ...
  public boolean Set_PRIMO(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_PRIMO = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_RUOLO(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_RUOLO = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_soggope","soggope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_PRIMO;
      p_PRIMO = CPLib.GetProperties(trs_p.getProperty("PRIMO"),new Properties());
      ...
      Properties p_TIPOLEG;
      p_TIPOLEG = CPLib.GetProperties(trs_p.getProperty("TIPOLEG"),new Properties());
      Properties p_RUOLO;
      p_RUOLO = CPLib.GetProperties(trs_p.getProperty("RUOLO"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_PRIMO = 0;
        w_PRIMO = CPLib.GetProperty(p_PRIMO,"",w_PRIMO,i);
        w_DATAINI = CPLib.NullDate();
        w_DATAINI = CPLib.GetProperty(p_DATAINI,"",w_DATAINI,i);
        w_DATAFINE = CPLib.NullDate();
        w_DATAFINE = CPLib.GetProperty(p_DATAFINE,"",w_DATAFINE,i);
        w_TIPOLEG = "";
        w_TIPOLEG = CPLib.GetProperty(p_TIPOLEG,"",w_TIPOLEG,i);
        w_RUOLO = "";
        w_RUOLO = CPLib.GetProperty(p_RUOLO,"",w_RUOLO,i);
        w_xRAGSOC = "";
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"TIPOLEG")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"RUOLO")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var.comment",zeroSplit.split("Codice Soggetto Collegato\u0000Ragione Sociale",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_soggope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_soggope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_soggope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_soggope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_soggope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_soggope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_PRIMO;
    p_PRIMO = new Properties();
    Properties p_DATAINI;
    p_DATAINI = new Properties();
    Properties p_DATAFINE;
    p_DATAFINE = new Properties();
    Properties p_TIPOLEG;
    p_TIPOLEG = new Properties();
    Properties p_RUOLO;
    p_RUOLO = new Properties();
    Properties p_xRAGSOC;
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_PRIMO,"",w_PRIMO,trsrow);
      CPLib.PutProperty(p_DATAINI,"",w_DATAINI,trsrow);
      CPLib.PutProperty(p_DATAFINE,"",w_DATAFINE,trsrow);
      CPLib.PutProperty(p_TIPOLEG,"",w_TIPOLEG,trsrow);
      CPLib.PutProperty(p_RUOLO,"",w_RUOLO,trsrow);
    ...
    trs_p.setProperty("PRIMO",CPLib.ToProperties(p_PRIMO));
    trs_p.setProperty("DATAINI",CPLib.ToProperties(p_DATAINI));
    trs_p.setProperty("DATAFINE",CPLib.ToProperties(p_DATAFINE));
    trs_p.setProperty("TIPOLEG",CPLib.ToProperties(p_TIPOLEG));
    trs_p.setProperty("RUOLO",CPLib.ToProperties(p_RUOLO));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "soggope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("COLLEG","C",16,0));
  }
  public String RowPrimaryKey() {
    return "soggope"+"\\"+CPLib.ToCPStr(w_CODINTER)+"\\"+CPLib.ToCPStr(w_IDBASE);
  }
  ...
  protected void TrsToWork() {
    ...
    w_PRIMO= m_oTrs.get(m_nCurrentRow).w_PRIMO;
    w_DATAINI= m_oTrs.get(m_nCurrentRow).w_DATAINI;
    w_DATAFINE= m_oTrs.get(m_nCurrentRow).w_DATAFINE;
    w_TIPOLEG= m_oTrs.get(m_nCurrentRow).w_TIPOLEG;
    w_RUOLO= m_oTrs.get(m_nCurrentRow).w_RUOLO;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_PRIMO=w_PRIMO;
    m_oTrs.get(m_nCurrentRow).w_DATAINI=w_DATAINI;
    m_oTrs.get(m_nCurrentRow).w_DATAFINE=w_DATAFINE;
    m_oTrs.get(m_nCurrentRow).w_TIPOLEG=w_TIPOLEG;
    m_oTrs.get(m_nCurrentRow).w_RUOLO=w_RUOLO;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_PRIMO=w_PRIMO;
    m_oDeletedRows.get(l_nRows).w_DATAINI=w_DATAINI;
    m_oDeletedRows.get(l_nRows).w_DATAFINE=w_DATAFINE;
    m_oDeletedRows.get(l_nRows).w_TIPOLEG=w_TIPOLEG;
    m_oDeletedRows.get(l_nRows).w_RUOLO=w_RUOLO;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_PRIMO= m_oDeletedRows.get(l_RowNumberToSet).w_PRIMO;
    w_DATAINI= m_oDeletedRows.get(l_RowNumberToSet).w_DATAINI;
    w_DATAFINE= m_oDeletedRows.get(l_RowNumberToSet).w_DATAFINE;
    w_TIPOLEG= m_oDeletedRows.get(l_RowNumberToSet).w_TIPOLEG;
    w_RUOLO= m_oDeletedRows.get(l_RowNumberToSet).w_RUOLO;
