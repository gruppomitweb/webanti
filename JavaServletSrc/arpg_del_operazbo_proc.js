...
if (false || WindowConfirm(Translate('1934966978'))) {
...
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_del_operazbo']));
SendData('start','arrt_del_operazbo'+'',HParApplet().asString());
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_del_operazbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_del_operazbo',m_cSelectedPage);
