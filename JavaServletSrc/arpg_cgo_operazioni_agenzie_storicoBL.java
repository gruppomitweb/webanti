...
public class arpg_cgo_operazioni_agenzie_storicoBL extends arpg_cgo_operazioni_agenzie_storicoWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    ...
    public java.sql.Date c_CGODATDIPCOM;
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_agenzie_storico";
  ...
  public static final String i_StateStructure = "{'DaData':DaData,'A_Data':A_Data,'DaDataOpe':DaDataOpe,'A_DataOpe':A_DataOpe}";
  public static final String i_CompleteStateStructure = "{'DaData':DaData,'A_Data':A_Data,'DaDataOpe':DaDataOpe,'A_DataOpe':A_DataOpe}";
  public static final String i_ItemSequence = "DaData,A_Data,DaDataOpe,A_DataOpe";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaData","Da Data Completamento","D","8","0","variabile","nokey","false","false"},new String[]{"A_Data","A Data Completamento","D","8","0","variabile","nokey","false","false"},new String[]{"DaDataOpe","Da Data Operazione","D","8","0","variabile","nokey","false","false"},new String[]{"A_DataOpe","A Data Operazione","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_cgo_operazioni_agenzie_storicoBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_DaDataOpe = CPLib.NullDate();
    w_A_DataOpe = CPLib.NullDate();
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  public boolean Set_DaDataOpe(java.sql.Date p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_DaDataOpe = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_A_DataOpe(java.sql.Date p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_A_DataOpe = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_agenzie_storico","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_DaDataOpe = CPLib.GetProperty(p,"DaDataOpe",w_DaDataOpe,0);
      w_A_DataOpe = CPLib.GetProperty(p,"A_DataOpe",w_A_DataOpe,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_CGODATDIPCOM=c_CGODATDIPCOM;
  ...
  public void TrsToWork() {
    ...
    c_CGODATDIPCOM= m_oTrs.get(m_nCurrentRow).c_CGODATDIPCOM;
