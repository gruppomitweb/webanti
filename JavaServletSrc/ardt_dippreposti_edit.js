...
if ( ! (m_oFather.SaveContext_ardt_dippreposti())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_dippreposti_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_dippreposti_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_dippreposti();
}
}
SaveContext.child=[];
function BlankRow() {
