...
// * --- Fine Area Manuale
public class arrt_lancia_nuovainfR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_nuovainfR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_nuovainf",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* w_rapporto Char(25) // Messaggio */
    /* Lancia la pagina */
    /* Stop armt_ae_rapopebo */
    Forward f;
    f=new Forward("armt_ae_rapopebo",false,this,Forward.NewStatus,false);
    f.SetParameter("RAPPORTO",w_rapporto);
    f.SetParameter("m_cParameterSequence","RAPPORTO");
  ...
  public static arrt_lancia_nuovainfR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_nuovainfR(p_Ctx, p_Caller);
  }
  public void Blank() {
