...
if ( ! (m_oFather.SaveContext_ardt_weneficfrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_weneficfrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_weneficfrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_weneficfrz();
}
}
SaveContext.child=[];
function BlankRow() {
