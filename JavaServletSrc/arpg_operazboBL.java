...
public class arpg_operazboBL extends arpg_operazboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_operazbo";
  ...
  public arpg_operazboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_operazbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
