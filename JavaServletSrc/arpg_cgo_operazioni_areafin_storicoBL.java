...
public class arpg_cgo_operazioni_areafin_storicoBL extends arpg_cgo_operazioni_areafin_storicoWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    ...
    public java.sql.Date c_CGODATFINCOM;
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_areafin_storico";
  ...
  public static final String i_StateStructure = "{'DaData':DaData,'A_Data':A_Data}";
  public static final String i_CompleteStateStructure = "{'DaData':DaData,'A_Data':A_Data,'gDescAzi':gDescAzi}";
  public static final String i_ItemSequence = "DaData,A_Data";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaData","Da Data Registrazione","D","8","0","variabile","nokey","false","false"},new String[]{"A_Data","A Data Registrazione","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_cgo_operazioni_areafin_storicoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_areafin_storico","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_CGODATFINCOM=c_CGODATFINCOM;
  ...
  public void TrsToWork() {
    ...
    c_CGODATFINCOM= m_oTrs.get(m_nCurrentRow).c_CGODATFINCOM;
