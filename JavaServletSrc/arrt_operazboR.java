...
// * --- Fine Area Manuale
public class arrt_operazboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_operazboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_operazbo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(w_tipooper,"S")) {
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_operazbo",14,"0000000C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  public static arrt_operazboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_operazboR(p_Ctx, p_Caller);
  }
  public void Blank() {
