...
public class ardt_dipprepostiBL extends ardt_dipprepostiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_dippreposti";
  ...
  public CPPhTableWrInfo m_oWrInfo_dippreposti;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_dippreposti;
  ...
  public static String[] m_EntityTables = {"dippreposti"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CODDIP':CODDIP,'m_Detail':{'COGNOME':COGNOME,'NOME':NOME,'CODFISC':CODFISC,'CPROWNUM':CPROWNUM,'DATAINI':DATAINI,'DATAFINE':DATAFINE"+FoundlingChildrenList("ardt_dippreposti",true,true)+"}"+FoundlingChildrenList("ardt_dippreposti",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'CODDIP':CODDIP,'m_Detail':{'COGNOME':COGNOME,'NOME':NOME,'CODFISC':CODFISC,'IDBASE':IDBASE,'CPROWNUM':CPROWNUM,'DATAINI':DATAINI,'DATAFINE':DATAFINE"+FoundlingChildrenList("ardt_dippreposti",true,true)+"}"+FoundlingChildrenList("ardt_dippreposti",true,false)+"}";
  public static final String i_ItemSequence = "CODDIP,m_Detail[ COGNOME NOME CODFISC CPROWNUM DATAINI DATAFINE"+FoundlingChildrenList("ardt_dippreposti",false,true)+"]"+FoundlingChildrenList("ardt_dippreposti",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_dippreposti"),new String[][]{new String[]{"CODDIP","Codice Dipendenza","C","6","0","campo","key1","false","false"},new String[]{"COGNOME","Cognome","C","50","0","campo","nokey","true","false"},new String[]{"NOME","Nome","C","50","0","campo","nokey","true","false"},new String[]{"CODFISC","Codice Fiscale","C","16","0","campo","nokey","true","false"},new String[]{"CPROWNUM","","N","3","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_dipprepostiBL (CPContext p_ContextObject) {
    ...
    m_cPhName_dippreposti = p_ContextObject.GetPhName("dippreposti",p_ContextObject.GetCompany(),false);
    m_cServer_dippreposti = p_ContextObject.GetServer("dippreposti");
    m_oWrInfo_dippreposti = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"dippreposti",p_ContextObject.GetCompany());
    m_cVirtName_dippreposti = CPSql.ManipulateTablePhName("dippreposti",m_cServer_dippreposti);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_dippreposti",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_dippreposti","dippreposti",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_dippreposti",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_dippreposti",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_dippreposti",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_dippreposti",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_dippreposti"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_dippreposti\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "dippreposti"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CODDIP","C",6,0));
  }
  public String RowPrimaryKey() {
    return "dippreposti"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
