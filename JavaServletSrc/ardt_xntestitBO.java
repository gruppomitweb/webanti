...
// * --- Fine Area Manuale
public class ardt_xntestitBO extends ardt_xntestitBL {
  class SqlDetailLoader {
    ...
    public void AddJoinedLink_2_1(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+6,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_2_1","CODINTER","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_2_1","CODINTER","CONNES",true);
  ...
  // * --- Fine Area Manuale
  public ardt_xntestitBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"ardt_xntestit");
    }
  ...
  public static String[] m_cLoadParameterNames = {"CODCLI"};
  public static String[] m_cDeleteParameterNames = m_cLoadParameterNames;
  public boolean Load(String p_CODCLI) {
    CPResultSet l_rsLoadBody=null;
    SqlDetailLoader l_oSqlDetailLoader;
    l_oSqlDetailLoader = new SqlDetailLoader(m_Sql,m_cServer_xntestit,m_cPhName_xntestit,m_cVirtName_xntestit,m_cVirtName_xntestit+".CODCLI="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_CODCLI,"C",16,0),m_cServer_xntestit,p_CODCLI),"");
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        w_CODCLI = l_rsLoadBody.GetString("CODCLI");
        ...
        if (CPLib.HasTableCPCCCHK(m_Ctx,"xntestit")) {
        ...
        while ( ! (l_rsLoadBody.Eof())) {
          ...
          if (l_oSqlDetailLoader.m_bLink_2_1) {
            w_xragsoci = l_rsLoadBody.GetString("RAGSOC201");
          ...
          w_PRGIMPTITE = l_rsLoadBody.GetDouble("PRGIMPTITE");
  ...
  public boolean Delete(String p_CODCLI) {
    String l_cSql;
    int l_nRow;
  ...
  void DeleteDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      ...
      if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
        l_cSql = "Delete from "+m_oWrInfo_xntestit.GetTableWriteName()+" where ";
        l_cSql = l_cSql+"CODINTER="+CPLib.ToSQL(opk_CODINTER,"C",16,0)+" AND CODCLI="+CPLib.ToSQL(w_CODCLI,"C",16,0);
        l_cSql = l_cSql+m_oWrInfo_xntestit.WhereFilter();
        if (CPLib.HasTableCPCCCHK(m_Ctx,"xntestit")) {
          l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldRowCPCCCHK,"C",10,0);
        }
        l_nUpdatedRows = m_Sql.Update(m_cServer_xntestit,l_cSql);
  ...
  public boolean Delete() {
    return Delete(w_CODCLI);
  }
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    CPLib.SPLinkProperties result = CPLib.GetSPLinkerProperties();
    if (CPLib.eq(p_cID,"XTDHYWJPZL")) {
      ...
      result.AppendFieldsHash("XTDHYWJPZL",CPLib.GetLinkedFieldProps("CONNES","CODINTER","C",16,0));
    }
    return result;
  }
  void InsertDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xntestit);
      l_cSql = "insert into "+m_oWrInfo_xntestit.GetTableWriteName()+" (";
      l_cSql = l_cSql+"CODCLI,";
      l_cSql = l_cSql+"CODINTER,";
      l_cSql = l_cSql+"DATAINI,";
      l_cSql = l_cSql+"DATAFINE,";
      l_cSql = l_cSql+"TIPOPERS,";
      l_cSql = l_cSql+"PRGIMPTITE,";
      ...
      l_cSql = l_cSql+m_oWrInfo_xntestit.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xntestit")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_CODCLI,"C",16,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQLNull(w_CODINTER,"C",16,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_PRGIMPTITE,"N",15,0)+", ";
      ...
      l_cSql = l_cSql+m_oWrInfo_xntestit.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xntestit")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_xntestit,l_cSql,m_oParameters);
      if (CPLib.ne(l_nUpdatedRows,1)) {
        m_Sql.AbortTransaction();
      } else {
  ...
  void UpdateDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xntestit);
      l_cSql = "Update "+m_oWrInfo_xntestit.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+", PRGIMPTITE = "+CPLib.ToSQL(w_PRGIMPTITE,"N",15,0);
