...
public class arpg_all_opextrboBL extends arpg_all_opextrboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_all_opextrbo";
  ...
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'c_dadata':c_dadata,'c_adata':c_adata}";
  ...
  public arpg_all_opextrboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_all_opextrbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
