...
// * --- Fine Area Manuale
public class arrt_crea_tmp_list_imprichR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_crea_tmp_list_imprichR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_crea_tmp_list_imprich",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_crea_tmp_list_imprich";
  ...
  public static arrt_crea_tmp_list_imprichR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_crea_tmp_list_imprichR(p_Ctx, p_Caller);
  }
  public static arrt_crea_tmp_list_imprichR Make(CPContext p_Ctx) {
    return new arrt_crea_tmp_list_imprichR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
  }
  ...
  // ENTITY_BATCHES: ,arrt_crea_tmp_list_imprich,
  public static final String i_InvokedRoutines = ",arrt_crea_tmp_list_imprich,";
