...
public class arpg_wu_stp_rapportiBL extends arpg_wu_stp_rapportiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_wu_stp_rapporti";
  ...
  public static final String i_StateStructure = "{'WUCODMAGE':WUCODMAGE,'codrap':codrap}";
  public static final String i_CompleteStateStructure = "{'WUCODMAGE':WUCODMAGE,'xMADESCRI':xMADESCRI,'codrap':codrap,'xDESCRAP':xDESCRAP,'gDescAzi':gDescAzi}";
  public static final String i_ItemSequence = "WUCODMAGE,codrap";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"WUCODMAGE","MacroAgente","C","5","0","variabile","nokey","false","false"},new String[]{"codrap","Rapporto","C","16","0","variabile","nokey","false","false"}});
  ...
  public arpg_wu_stp_rapportiBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_CAPXTPHATP() {
    return Link_CAPXTPHATP("Full");
  }
  protected boolean Link_CAPXTPHATP(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    // Dichiarazione del cursore locale del link
    CPResultSet l_rsLink=null;
    if ( ! (CPLib.Empty(w_codrap))) {
      String l_OldValue = w_codrap;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_codrap,"C",16,0),m_cServer_anarapbo,w_codrap);
      ...
      try {
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                      relativi campi e/o variabili.
                                    */
          w_codrap = l_rsLink.GetString("RAPPORTO");
        ...
        if ( ! (l_bResult)) {
          ...
          m_cLastMsgError = "";
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","codrap");
          }
          m_cLastWorkVarError = "codrap";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  public boolean Set_codrap(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_codrap = p_workVariableValue;
    l_bResult = Link_CAPXTPHATP();
    // La variabile che indica il tipo di errore viene eventualmente impostata
    // dalla funzione di link: infatti il suo valore di ritorno non e'
    // sufficiente per determinare il tipo di errore che puo' essere di valore
    // non trovato nella tabella collegata o di check non valido.
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_wu_stp_rapporti","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_codrap = CPLib.GetProperty(p,"codrap",w_codrap,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_codrap","w_xDESCRAP"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    ...
    map.put("rd_var.obj",zeroSplit.split("variabile\u0000variabile",-1));
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("anarapbo\u0000false\u0000false\u00001\u00000\u0000armt_anarap\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
  }
