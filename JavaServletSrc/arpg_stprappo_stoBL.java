...
public class arpg_stprappo_stoBL extends arpg_stprappo_stoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stprappo_sto";
  ...
  public static final String i_StateStructure = "{'daRappo':daRappo,'aRappo':aRappo,'tipstp':tipstp}";
  public static final String i_CompleteStateStructure = "{'daRappo':daRappo,'aRappo':aRappo,'tipstp':tipstp,'desrap1':desrap1,'desrap2':desrap2}";
  public static final String i_ItemSequence = "daRappo,aRappo,tipstp";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daRappo","","C","16","0","variabile","nokey","false","false"},new String[]{"aRappo","","C","16","0","variabile","nokey","false","false"},new String[]{"tipstp","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_stprappo_stoBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_UYVYTEMEXX(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_daRappo))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daRappo,"C",16,0),m_cServer_wnarapbo,w_daRappo);
      if (m_Ctx.IsSharedTemp("wnarapbo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_wnarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_wnarapbo+((m_cPhName_wnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"RAPPORTO"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daRappo,"C",50,0),m_cServer_wnarapbo,w_daRappo);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_wnarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_wnarapbo+((m_cPhName_wnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
  ...
  protected boolean Link_CJWUHWULAR(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_aRappo))) {
      ...
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aRappo,"C",16,0),m_cServer_wnarapbo,w_aRappo);
      if (m_Ctx.IsSharedTemp("wnarapbo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aRappo,"C",50,0),m_cServer_wnarapbo,w_aRappo);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_wnarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_wnarapbo+((m_cPhName_wnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stprappo_sto","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var.len",zeroSplit.split("16\u000050",-1));
    ...
    map.put("property.value",zeroSplit.split("wnarapbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Storico Rapporti Continuativi\u0000\u0000\u0000false",-1));
