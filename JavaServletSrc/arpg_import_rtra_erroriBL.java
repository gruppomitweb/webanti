...
public class arpg_import_rtra_erroriBL extends arpg_import_rtra_erroriWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_rtra_errori";
  ...
  public static final String i_StateStructure = "{'tipodest':tipodest,'destfin':destfin}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'tipodest':tipodest,'impzip':impzip,'errchk':errchk,'gFlgCMod':gFlgCMod,'destfin':destfin,'gAzienda':gAzienda,'gPathApp':gPathApp,'fscarti':fscarti}";
  public static final String i_ItemSequence = "tipodest,destfin";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"tipodest","","C","1","0","variabile","nokey","false","false"},new String[]{"destfin","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_import_rtra_erroriBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_rtra_errori","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
