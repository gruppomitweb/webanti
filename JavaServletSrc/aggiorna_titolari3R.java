...
import jxl.*;
// * --- Fine Area Manuale
public class aggiorna_titolari3R implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public aggiorna_titolari3R (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("aggiorna_titolari3",m_Caller);
    ...
    try {
      ...
      while (CPLib.lt(_i,_conta)) {
        ...
        while (CPLib.lt(_y,_righe)) {
          ...
          m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000002F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"SPLITCODE = "+CPLib.ToSQL(CPLib.LRTrim(column03),"C",15,0,m_cServer)+", ";
          m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"anarapbo",false,true);
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(column02),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(column02))+"";
  ...
  void Page_2() throws Exception {
    ...
    try {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_rapotit.GetString("CONNESOPER")))) && CPLib.le(Cursor_rapotit.GetDate("DATAOPE"),CPLib.CharToDate("20131231"))) {
          ...
          if (CPLib.eqr(Cursor_rapotit.GetString("STATOREG"),"3")) {
            ...
            if (CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"50") || CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"52")) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000003A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"mntestit",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000003B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          if (CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"50") || CPLib.eqr(Cursor_rapotit.GetString("TIPOOPRAP"),"52")) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000003E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestit",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000003F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(Cursor_rapotit.GetDate("DATAOPE"),"D",8,0)+", ";
            m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(Cursor_rapotit.GetString("NUMPROG"),"C",11,0,m_cServer)+", ";
      ...
      while ( ! (Cursor_wuib1.Eof())) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000004A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000004B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_intestit.Eof())) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"0000004E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_intestbo.Eof())) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"00000051")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      while ( ! (Cursor_anarapbo.Eof())) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anarapbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("aggiorna_titolari3",98,"00000054")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  public static aggiorna_titolari3R Make(CPContext p_Ctx, Caller p_Caller) {
    return new aggiorna_titolari3R(p_Ctx, p_Caller);
  }
  public void Blank() {
    nProg = 0;
