...
public class armt_wersonboBL extends armt_wersonboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_wersonbo";
  ...
  public CPPhTableWrInfo m_oWrInfo_wersonbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wersonbo;
  ...
  public armt_wersonboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wersonbo = p_ContextObject.GetPhName("wersonbo",p_ContextObject.GetCompany(),false);
    m_cServer_wersonbo = p_ContextObject.GetServer("wersonbo");
    m_oWrInfo_wersonbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wersonbo",p_ContextObject.GetCompany());
    m_cVirtName_wersonbo = CPSql.ManipulateTablePhName("wersonbo",m_cServer_wersonbo);
    ...
    armt_wersonbo_agg = new armt_wersonbo_aggBO(p_ContextObject);
    ...
    m_MNTs = CPLib.MNTChilds("armt_wersonbo",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || armt_wersonbo_agg.IsUpdated() || CPLib.IsUpdated(m_cWv_armt_wersonbo_agg);
  ...
  public void SaveDependsOn() {
    ...
    armt_wersonbo_agg.SaveDependsOn();
  ...
  protected boolean Link_LDTVEYLAXJ(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_gIntemediario))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_intermbo,"select CODINTER,ITFLGPEP from "+m_cPhName_intermbo+((m_cPhName_intermbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODINTER"+l_cCurrentKey+l_cWhere);
      try {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_wersonbo","wersonbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_armt_wersonbo_agg = CPLib.GetProperty(p,"m_cWv_armt_wersonbo_agg",m_cWv_armt_wersonbo_agg,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_field",new String[]{"CODINTER","ITFLGPEP"});
    map.put("rd_var",new String[]{"w_gIntemediario","w_xITFLGPEP"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("11\u00001",-1));
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("wersonbo_agg");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("wersonbo_agg",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_var.obj",new String[]{});
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("wersonbo_agg\u0000false\u0000false\u00001\u00000\u0000armt_wersonbo_agg\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("rd_var.obj",zeroSplit.split("campo\u0000variabile\u0000variabile",-1));
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("personbo\u0000false\u0000false\u00003\u00000\u0000armt_personbo\u0000false\u0000false\u0000Elenco Soggetti\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("tbstati");
    if (CPLib.IsNull(items)) {
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_wersonbo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_wersonbo",child);
  ...
  public void Initialize() {
    ...
    armt_wersonbo_agg = new armt_wersonbo_aggBO(m_Ctx);
    ...
    m_MNTs = CPLib.MNTChilds("armt_wersonbo",m_Ctx);
  ...
  public boolean Check() {
    ...
    if (l_bResult && (( ! (armt_wersonbo_agg.m_bLoaded) && CPLib.IsLoaded(m_cWv_armt_wersonbo_agg)) || ( ! (armt_wersonbo_agg.m_bUpdated) && CPLib.IsUpdated(m_cWv_armt_wersonbo_agg)))) {
      armt_wersonbo_agg.SetFromContext(m_cWv_armt_wersonbo_agg);
      m_cWv_armt_wersonbo_agg = "_not_empty_";
    }
    if (l_bResult && (armt_wersonbo_agg.m_bLoaded || armt_wersonbo_agg.m_bUpdated)) {
      l_bResult = l_bResult && armt_wersonbo_agg.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_wersonbo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_wersonbo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public boolean CanEdit(String p_cState) {
    ...
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Imposibile modificare soggetti nell'archivio storico";
    }
  ...
  public boolean CanDelete() {
    ...
    l_bResult = false;
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Imposibile cancellare soggetti nell'archivio storico";
    }
  ...
  public boolean CanAdd(String p_cState) {
    ...
    l_bResult = false;
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Imposibile aggiungere nuovi soggetti nell'archivio storico";
    }
  ...
  void InitAutonumber() {
    ...
    w_PROGIMPORT = m_Ctx.AskTableProg(w_PROGIMPORT,15,op_PROGIMPORT,"PRGIMPOCLI"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wersonbo);
    op_codazi = m_Ctx.GetCompany();
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (armt_wersonbo_agg.IsUpdated()) {
        m_cWv_armt_wersonbo_agg = armt_wersonbo_agg.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_armt_wersonbo_agg",m_cWv_armt_wersonbo_agg,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wersonbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("sanumpro","C",15,0));
  }
  ...
  public boolean ChildExists_armt_wersonbo_agg() {
    if (armt_wersonbo_agg.IsUpdated() || (CPLib.IsUpdated(m_cWv_armt_wersonbo_agg) || CPLib.IsLoaded(m_cWv_armt_wersonbo_agg))) {
      return true;
    } else if (m_bLoaded &&  ! (armt_wersonbo_agg.m_bLoaded)) {
      armt_wersonbo_agg.Blank();
      armt_wersonbo_agg.w_CONNES = w_CONNES;
      armt_wersonbo_agg.Load();
    }
    return armt_wersonbo_agg.m_bLoaded;
  }
  public void CtxLoad_armt_wersonbo_agg() {
    if ( ! (armt_wersonbo_agg.m_lCtxLoaded)) {
      armt_wersonbo_agg.Blank();
    }
    armt_wersonbo_agg.m_lCtxLoaded = true;
    if ( ! (armt_wersonbo_agg.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_armt_wersonbo_agg) || CPLib.IsLoaded(m_cWv_armt_wersonbo_agg)) {
        armt_wersonbo_agg.SetFromContext(m_cWv_armt_wersonbo_agg);
        m_cWv_armt_wersonbo_agg = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (armt_wersonbo_agg.m_bLoaded)) {
          armt_wersonbo_agg.Blank();
          armt_wersonbo_agg.w_CONNES = w_CONNES;
          armt_wersonbo_agg.Load();
          if ( ! (armt_wersonbo_agg.m_bLoaded)) {
            armt_wersonbo_agg.Initialize();
            armt_wersonbo_agg.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"armt_wersonbo_agg")) {
      CtxLoad_armt_wersonbo_agg();
      return armt_wersonbo_agg;
    }
