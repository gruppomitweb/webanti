...
public class arpg_calcsaldi_opex_wuBL extends arpg_calcsaldi_opex_wuWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_calcsaldi_opex_wu";
  ...
  public static final String i_StateStructure = "{'annorif':annorif,'valuta':valuta,'flgmod':flgmod,'flgazz':flgazz,'ndgcli':ndgcli,'flgmopx':flgmopx,'mese':mese}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gTipInter':gTipInter,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gFlgWU':gFlgWU,'annorif':annorif,'valuta':valuta,'xdesval':xdesval,'flgmod':flgmod,'flgazz':flgazz,'ndgcli':ndgcli,'xragsoc':xragsoc,'flgmopx':flgmopx,'mese':mese}";
  public static final String i_ItemSequence = "annorif,valuta,flgmod,flgazz,ndgcli,flgmopx,mese";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"annorif","Anno di riferimento","N","4","0","variabile","nokey","false","true"},new String[]{"valuta","Valuta Prevalente","C","3","0","variabile","nokey","false","false"},new String[]{"flgmod","","C","1","0","variabile","nokey","false","false"},new String[]{"flgazz","","C","1","0","variabile","nokey","false","false"},new String[]{"ndgcli","Calcola Saldi solo per NDG","C","16","0","variabile","nokey","false","false"},new String[]{"flgmopx","","C","1","0","variabile","nokey","false","false"},new String[]{"mese","Opex Inviate nel mese di","N","2","0","variabile","nokey","false","false"}});
  ...
  public arpg_calcsaldi_opex_wuBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_SZZYVNKOQS() {
    return Link_SZZYVNKOQS("Full");
  }
  protected boolean Link_SZZYVNKOQS(String p_cType) {
  ...
  void Link_SZZYVNKOQS_blank() {
    w_valuta = "";
    w_xdesval = "";
  }
  protected boolean Link_UNGKYHCDIF() {
    return Link_UNGKYHCDIF("Full");
  }
  protected boolean Link_UNGKYHCDIF(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    if ( ! (CPLib.Empty(w_ndgcli))) {
      String l_OldValue = w_ndgcli;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_ndgcli,"C",16,0),m_cServer_personbo,w_ndgcli);
      ...
      try {
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                      relativi campi e/o variabili.
                                    */
          w_ndgcli = l_rsLink.GetString("CONNES");
        ...
        if ( ! (l_bResult)) {
          ...
          m_cLastMsgError = "";
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","ndgcli");
          }
          m_cLastWorkVarError = "ndgcli";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  public boolean Set_annorif(double p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.ge(w_annorif,2011) && CPLib.le(w_annorif,CPLib.Year(CPLib.Date()));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "L'anno deve essere superiore o uguale al 2011 e inferiore all'anno corrente";
    }
    if ( ! (l_bResult)) {
  ...
  public boolean Set_flgmod(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_flgmod = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_flgazz(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_flgazz = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_ndgcli(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_ndgcli = p_workVariableValue;
    l_bResult = Link_UNGKYHCDIF();
    // La variabile che indica il tipo di errore viene eventualmente impostata
    // dalla funzione di link: infatti il suo valore di ritorno non e'
    // sufficiente per determinare il tipo di errore che puo' essere di valore
    // non trovato nella tabella collegata o di check non valido.
  ...
  public boolean Set_flgmopx(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_flgmopx = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_mese(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getVisible_flgmopx() {
    return CPLib.Empty(w_ndgcli);
  }
  public boolean getVisible_mese() {
    return CPLib.ne(w_flgmod,"C");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_calcsaldi_opex_wu","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_flgmod = CPLib.GetProperty(p,"flgmod",w_flgmod,0);
      w_flgazz = CPLib.GetProperty(p,"flgazz",w_flgazz,0);
      w_ndgcli = CPLib.GetProperty(p,"ndgcli",w_ndgcli,0);
      w_xragsoc = CPLib.GetProperty(p,"xragsoc",w_xragsoc,0);
      w_flgmopx = CPLib.GetProperty(p,"flgmopx",w_flgmopx,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.value",zeroSplit.split("tbvalute\u0000false\u0000false\u00001\u00000\u0000armt_divise\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    ...
    map.put("rd_var",new String[]{"w_ndgcli","w_xragsoc"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    ...
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Calcola Saldi solo per NDG\u0000Ragione Sociale",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    ...
    map.put("rd_var.obj",zeroSplit.split("variabile\u0000variabile",-1));
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("personbo\u0000false\u0000false\u00001\u00000\u0000armt_personbo\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
  }
