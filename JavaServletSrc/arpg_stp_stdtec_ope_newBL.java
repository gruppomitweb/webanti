...
public class arpg_stp_stdtec_ope_newBL extends arpg_stp_stdtec_ope_newWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_ope_new";
  ...
  public arpg_stp_stdtec_ope_newBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_ope_new","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
