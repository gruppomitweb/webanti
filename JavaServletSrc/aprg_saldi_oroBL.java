...
public class aprg_saldi_oroBL extends aprg_saldi_oroWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "aprg_saldi_oro";
  ...
  public static final String i_StateStructure = "{'annoope':annoope,'CONNES':CONNES,'imppagato':imppagato,'impricevuto':impricevuto,'numope':numope}";
  public static final String i_CompleteStateStructure = "{'annoope':annoope,'CONNES':CONNES,'risultato':risultato,'imppagato':imppagato,'impricevuto':impricevuto,'numope':numope}";
  public static final String i_ItemSequence = "annoope,CONNES,imppagato,impricevuto,numope";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"annoope","Anno","N","4","0","variabile","nokey","false","false"},new String[]{"CONNES","","C","16","0","variabile","nokey","false","false"},new String[]{"imppagato","Importo Pagato da cliente per acquisto oro","N","15","0","variabile","nokey","false","false"},new String[]{"impricevuto","Importo Consegnato al Cliente per vendita oro","N","15","0","variabile","nokey","false","false"},new String[]{"numope","Numero Operazioni di Acquisto/Vendita","N","6","0","variabile","nokey","false","false"}});
  ...
  public aprg_saldi_oroBL (CPContext p_ContextObject) {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_annoope(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public boolean Set_imppagato(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_imppagato = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_impricevuto(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_impricevuto = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_numope(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("aprg_saldi_oro","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_imppagato = CPLib.GetProperty(p,"imppagato",w_imppagato,0);
      w_impricevuto = CPLib.GetProperty(p,"impricevuto",w_impricevuto,0);
      w_numope = CPLib.GetProperty(p,"numope",w_numope,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
