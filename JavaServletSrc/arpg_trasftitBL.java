...
public class arpg_trasftitBL extends arpg_trasftitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasftit";
  ...
  public arpg_trasftitBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasftit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
