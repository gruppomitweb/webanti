...
// * --- Fine Area Manuale
public class arrt_del_operazboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_del_operazboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_del_operazbo",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("armt_operazioni",false,this,Forward.Delete,false);
  ...
  public static arrt_del_operazboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_del_operazboR(p_Ctx, p_Caller);
  }
  public void Blank() {
