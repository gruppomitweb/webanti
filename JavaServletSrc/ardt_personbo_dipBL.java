...
public class ardt_personbo_dipBL extends ardt_personbo_dipWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_CODDIPE;
    public String w_xDESCRIZ;
    public String opk_CODDIPE;
  ...
  public static final String i_EntityName = "ardt_personbo_dip";
  ...
  public CPPhTableWrInfo m_oWrInfo_personbo_dip;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_personbo_dip;
  ...
  public static String[] m_EntityTables = {"personbo_dip"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CONNES':CONNES,'m_Detail':{'CODDIPE':CODDIPE"+FoundlingChildrenList("ardt_personbo_dip",true,true)+"}"+FoundlingChildrenList("ardt_personbo_dip",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'CONNES':CONNES,'m_Detail':{'CODDIPE':CODDIPE,'xDESCRIZ':xDESCRIZ"+FoundlingChildrenList("ardt_personbo_dip",true,true)+"}"+FoundlingChildrenList("ardt_personbo_dip",true,false)+"}";
  public static final String i_ItemSequence = "CONNES,m_Detail[ CODDIPE"+FoundlingChildrenList("ardt_personbo_dip",false,true)+"]"+FoundlingChildrenList("ardt_personbo_dip",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_personbo_dip"),new String[][]{new String[]{"CONNES","NDG","C","16","0","campo","key1","false","false"},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",CODDIPE";
  ...
  public ardt_personbo_dipBL (CPContext p_ContextObject) {
    ...
    m_cPhName_personbo_dip = p_ContextObject.GetPhName("personbo_dip",p_ContextObject.GetCompany(),false);
    m_cServer_personbo_dip = p_ContextObject.GetServer("personbo_dip");
    m_oWrInfo_personbo_dip = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"personbo_dip",p_ContextObject.GetCompany());
    m_cVirtName_personbo_dip = CPSql.ManipulateTablePhName("personbo_dip",m_cServer_personbo_dip);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_personbo_dip",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_JSWFSTAHBP() {
    return Link_JSWFSTAHBP("Full");
  }
  protected boolean Link_JSWFSTAHBP(String p_cType) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_personbo_dip","personbo_dip",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_CODDIPE;
      p_CODDIPE = CPLib.GetProperties(trs_p.getProperty("CODDIPE"),new Properties());
      Properties p_xDESCRIZ;
      p_xDESCRIZ = CPLib.GetProperties(trs_p.getProperty("xDESCRIZ"),new Properties());
      Properties p_opk_CODDIPE;
      p_opk_CODDIPE = CPLib.GetProperties(trs_p.getProperty("opk_CODDIPE"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        w_CODDIPE = "";
        w_CODDIPE = CPLib.GetProperty(p_CODDIPE,"",w_CODDIPE,i);
        w_xDESCRIZ = "";
        w_xDESCRIZ = CPLib.GetProperty(p_xDESCRIZ,"",w_xDESCRIZ,i);
        opk_CODDIPE = CPLib.GetProperty(p_opk_CODDIPE,"","",i);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_CODDIPE","w_xDESCRIZ"});
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_personbo_dip",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_personbo_dip",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_personbo_dip",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_personbo_dip",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_personbo_dip"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_personbo_dip\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_CODDIPE;
    p_CODDIPE = new Properties();
    Properties p_xDESCRIZ;
    p_xDESCRIZ = new Properties();
    Properties p_opk_CODDIPE;
    p_opk_CODDIPE = new Properties();
    Properties p_m_nRowStatus;
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_CODDIPE,"",w_CODDIPE,trsrow);
      CPLib.PutProperty(p_xDESCRIZ,"",w_xDESCRIZ,trsrow);
      CPLib.PutProperty(p_opk_CODDIPE,"",opk_CODDIPE,trsrow);
    ...
    trs_p.setProperty("CODDIPE",CPLib.ToProperties(p_CODDIPE));
    trs_p.setProperty("xDESCRIZ",CPLib.ToProperties(p_xDESCRIZ));
    trs_p.setProperty("opk_CODDIPE",CPLib.ToProperties(p_opk_CODDIPE));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "personbo_dip"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CONNES","C",16,0));
  }
  public String RowPrimaryKey() {
    return "personbo_dip"+"\\"+CPLib.ToCPStr(w_CODDIPE);
  }
  ...
  protected void TrsToWork() {
    w_CODDIPE= m_oTrs.get(m_nCurrentRow).w_CODDIPE;
    w_xDESCRIZ= m_oTrs.get(m_nCurrentRow).w_xDESCRIZ;
    opk_CODDIPE= m_oTrs.get(m_nCurrentRow).opk_CODDIPE;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_CODDIPE=w_CODDIPE;
    m_oTrs.get(m_nCurrentRow).w_xDESCRIZ=w_xDESCRIZ;
    m_oTrs.get(m_nCurrentRow).opk_CODDIPE=opk_CODDIPE;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_CODDIPE=w_CODDIPE;
    m_oDeletedRows.get(l_nRows).w_xDESCRIZ=w_xDESCRIZ;
    m_oDeletedRows.get(l_nRows).opk_CODDIPE=opk_CODDIPE;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_CODDIPE= m_oDeletedRows.get(l_RowNumberToSet).w_CODDIPE;
    w_xDESCRIZ= m_oDeletedRows.get(l_RowNumberToSet).w_xDESCRIZ;
    opk_CODDIPE= m_oDeletedRows.get(l_RowNumberToSet).opk_CODDIPE;
