...
public class arpg_annulla_soggettiBL extends arpg_annulla_soggettiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_annulla_soggetti";
  ...
  public static final String i_CompleteStateStructure = "{'gAzienda':gAzienda}";
  ...
  public arpg_annulla_soggettiBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_annulla_soggetti","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
