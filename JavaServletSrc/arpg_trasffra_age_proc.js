...
l_oWv.setValue('m_cParameterSequence',AsAppletValue('w_DaDatOpe,w_ADatOpe'));
if (false || WindowConfirm(Translate('522312053'))) {
SetLocationHref(null,'arrt_trasffra_age'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
}
...
w_Messaggi.raiseEvent('arpg_trasffra_age_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_trasffra_age_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_trasffra_age_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_trasffra_age',m_cSelectedPage);
