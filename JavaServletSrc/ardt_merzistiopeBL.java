...
public class ardt_merzistiopeBL extends ardt_merzistiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_merzistiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_merzistiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_merzistiope;
  ...
  public static String[] m_EntityTables = {"merzistiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_merzistiope",true,true)+"}"+FoundlingChildrenList("ardt_merzistiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_merzistiope",true,true)+"}"+FoundlingChildrenList("ardt_merzistiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_merzistiope",false,true)+"]"+FoundlingChildrenList("ardt_merzistiope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_merzistiope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_merzistiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_merzistiope = p_ContextObject.GetPhName("merzistiope",p_ContextObject.GetCompany(),false);
    m_cServer_merzistiope = p_ContextObject.GetServer("merzistiope");
    m_oWrInfo_merzistiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"merzistiope",p_ContextObject.GetCompany());
    m_cVirtName_merzistiope = CPSql.ManipulateTablePhName("merzistiope",m_cServer_merzistiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_merzistiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_merzistiope","merzistiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_merzistiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_merzistiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_merzistiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_merzistiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_merzistiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_merzistiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "merzistiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "merzistiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
