...
// * --- Fine Area Manuale
public class ardt_weneficopeBO extends ardt_weneficopeBL {
  ...
  // * --- Fine Area Manuale
  public ardt_weneficopeBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"ardt_weneficope");
    }
  ...
  public boolean Load(String p_IDFILEBO) {
    ...
    String l_cOrderBy;
    l_cOrderBy = m_cVirtName_weneficope+".CPRowNum";
    SqlDetailLoader l_oSqlDetailLoader;
    l_oSqlDetailLoader = new SqlDetailLoader(m_Sql,m_cServer_weneficope,m_cPhName_weneficope,m_cVirtName_weneficope,m_cVirtName_weneficope+".IDFILEBO="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDFILEBO,"C",10,0),m_cServer_weneficope,p_IDFILEBO),l_cOrderBy);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (CPLib.HasTableCPCCCHK(m_Ctx,"weneficope")) {
  ...
  void DeleteDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      ...
      if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
        l_cSql = "Delete from "+m_oWrInfo_weneficope.GetTableWriteName()+" where ";
        ...
        l_cSql = l_cSql+m_oWrInfo_weneficope.WhereFilter();
        if (CPLib.HasTableCPCCCHK(m_Ctx,"weneficope")) {
          l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldRowCPCCCHK,"C",10,0);
        }
        l_nUpdatedRows = m_Sql.Update(m_cServer_weneficope,l_cSql);
  ...
  void InsertDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_weneficope);
      l_cSql = "insert into "+m_oWrInfo_weneficope.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_weneficope.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"weneficope")) {
      ...
      l_cSql = l_cSql+m_oWrInfo_weneficope.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"weneficope")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_weneficope,l_cSql,m_oParameters);
      if (CPLib.ne(l_nUpdatedRows,1)) {
        m_Sql.AbortTransaction();
      } else {
  ...
  void UpdateDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_weneficope);
      l_cSql = "Update "+m_oWrInfo_weneficope.GetTableWriteName()+" set";
