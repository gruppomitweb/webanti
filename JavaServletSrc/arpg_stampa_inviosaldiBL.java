...
public class arpg_stampa_inviosaldiBL extends arpg_stampa_inviosaldiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stampa_inviosaldi";
  ...
  public static final String i_CompleteStateStructure = "{'anno':anno,'dadata':dadata,'a_data':a_data,'gDescAzi':gDescAzi}";
  ...
  public arpg_stampa_inviosaldiBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stampa_inviosaldi","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
