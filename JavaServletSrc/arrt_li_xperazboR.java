...
// * --- Fine Area Manuale
public class arrt_li_xperazboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_li_xperazboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_li_xperazbo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* pObj Object(armt_oprovvisorieBL) */
      /* Variabili locali */
      /* conta Numeric(2, 0) */
      /* _tiporap Char(1) */
      /* Carica il contesto del figlio */
      /* pObj.CtxLoad_ardt_xlientiope() */
      pObj.CtxLoad_ardt_xlientiope();
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on knarapbo into routine arrt_li_xperazbo returns two or more records. This item should return only a record.");
      ...
      if (CPLib.eqr(_tiporap,"D")) {
        ...
        while ( ! (Cursor_intestbo.Eof())) {
          ...
          if (CPLib.eqr(conta,0)) {
            ...
            /* pObj.ardt_xlientiope.AddRow() */
            pObj.ardt_xlientiope.AddRow();
            /* pObj.ardt_xlientiope.Set_CODSOG(intestbo->CODINTER) */
            pObj.ardt_xlientiope.Set_CODSOG(Cursor_intestbo.GetString("CODINTER"));
            /* pObj.ardt_xlientiope.Set_PROQUOTA(intestbo->PROQUOTA) */
            pObj.ardt_xlientiope.Set_PROQUOTA(Cursor_intestbo.GetDouble("PROQUOTA"));
            /* pObj.ardt_xlientiope.SaveRow() */
            pObj.ardt_xlientiope.SaveRow();
            /* pObj.ardt_xlientiope.SetUpdated() */
            pObj.ardt_xlientiope.SetUpdated();
          } // End If
        ...
        while ( ! (Cursor_xntestbo.Eof())) {
          ...
          if (CPLib.eqr(conta,0)) {
            ...
            /* pObj.ardt_xlientiope.AddRow() */
            pObj.ardt_xlientiope.AddRow();
            /* pObj.ardt_xlientiope.Set_CODSOG(xntestbo->CODINTER) */
            pObj.ardt_xlientiope.Set_CODSOG(Cursor_xntestbo.GetString("CODINTER"));
            /* pObj.ardt_xlientiope.Set_PROQUOTA(xntestbo->PROQUOTA) */
            pObj.ardt_xlientiope.Set_PROQUOTA(Cursor_xntestbo.GetDouble("PROQUOTA"));
            /* pObj.ardt_xlientiope.SaveRow() */
            pObj.ardt_xlientiope.SaveRow();
            /* pObj.ardt_xlientiope.SetUpdated() */
            pObj.ardt_xlientiope.SetUpdated();
  ...
  public String RunAsync(armt_oprovvisorieBL p_pObj) {
    pObj = p_pObj;
  ...
  public Forward Run(armt_oprovvisorieBL p_pObj) {
    pObj = p_pObj;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_li_xperazboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_li_xperazboR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
    conta = 0;
