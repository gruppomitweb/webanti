...
public class arpg_xapotitBL extends arpg_xapotitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_xapotit";
  ...
  public arpg_xapotitBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_xapotit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
