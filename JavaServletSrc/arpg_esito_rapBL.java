...
public class arpg_esito_rapBL extends arpg_esito_rapWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_esito_rap";
  ...
  public static final String i_StateStructure = "{'tipoelab':tipoelab,'tipodoc':tipodoc}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'gDescAzi':gDescAzi,'tipoelab':tipoelab,'tipodoc':tipodoc,'impzip':impzip}";
  public static final String i_ItemSequence = "tipoelab,tipodoc";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"tipoelab","Modalità Elaborazione","C","1","0","variabile","nokey","false","false"},new String[]{"tipodoc","","C","10","0","variabile","nokey","false","false"}});
  ...
  public arpg_esito_rapBL (CPContext p_ContextObject) {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_tipoelab(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_tipoelab = p_workVariableValue;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_esito_rap","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_tipoelab = CPLib.GetProperty(p,"tipoelab",w_tipoelab,0);
