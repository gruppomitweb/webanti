...
public class arpg_trasffra_wu extends SPDialogServlet implements SPInvokable {
  public static String m_cEntityUid = "!*PBUGFCFTGM*!";
  ...
  public String getEntityTitle() {
    return "Trasferimento Frazionate Provvisorie";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "arpg_trasffra_wu";
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,arpg_trasffra_wuBO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"10593635871",p_Context.Translate("Trasferimento Frazionate Provvisorie")},
  ...
  void WriteStyles(arpg_trasffra_wuBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='SPPrxy/"+m_cEntityUid+"/arpg_trasffra_wu.css'>" +
      "");
    }
  ...
  void WriteMainForm(arpg_trasffra_wuBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls(arpg_trasffra_wuBO BO,ServletStatus status) {
    WriteControls_p1(BO,status);
    PrintNotifyContent(status,getNotifyItems());
  }
  void WriteControls_p1(arpg_trasffra_wuBO BO,ServletStatus status) {
    status.themeWriter.Header_BeginHtml(153);
    WriteControls_1_h_0(BO,status);
  }
  void WriteControls_1_h_0(arpg_trasffra_wuBO BO,ServletStatus status) {
    status.out.println(
  ...
  static void PrintState(arpg_trasffra_wuBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(arpg_trasffra_wuBL BO,ServletStatus status) {
  }
  static void PrintStateWorkVars(arpg_trasffra_wuBL BO,ServletStatus status) {
  ...
  void WriteMainFormVarScript(arpg_trasffra_wuBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"arpg_trasffra_wu"),"C",0,0)+ ";");
    ...
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"arpg_trasffra_wu","");
  ...
  void WriteMainFormScript(arpg_trasffra_wuBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    WriteTrs(status,BO);
  ...
  arpg_trasffra_wuBO getBO(ServletStatus status) {
    arpg_trasffra_wuBO BO = new arpg_trasffra_wuBO(status.context);
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(arpg_trasffra_wuBO BO) {
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,arpg_trasffra_wuBO BO) {
    super.NotifyEvent(p_cEvent,status,BO);
    CPLib.NotifyEvent(p_cEvent,BO,BO.m_Ctx,BO.specificEventsHandlers,BO.allEventsHandlers);
  }
  void Start(ServletStatus status,arpg_trasffra_wuBO BO) {
    BO.SetFromContext(status.m_cWv);
    BO.Calculate();
  }
  void Save(ServletStatus status,arpg_trasffra_wuBO BO) {
    boolean l_bResult;
    BO.SetFromContext(status.m_cWv);
  ...
  void Discard(ServletStatus status,arpg_trasffra_wuBO BO) {
    status.m_bExit = true;
  }
  void CreatePortlet(ServletStatus status,arpg_trasffra_wuBO BO) {
    ...
    item.put("altInterfaceFor","arpg_trasffra_wu");
    items.put(item);
    String s;
    org.json.JSONObject ctrl = null;
    s = "{\"bg_color\":\"transparent\",\"box_type\":\"\",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"153\",\"name\":\"Box_XLVFHSOSYH\",\"page\":\"1\",\"shrinkable\":\"true\",\"spuid\":\"XLVFHSOSYH\",\"tabindex\":\"1\",\"type\":\"Box\",\"w\":\"800\",\"x\":\"0\",\"y\":\"0\",\"zone\":\"pag1_6\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Da_Data_Frazionata_\",\"page\":\"1\",\"spuid\":\"HPGJXQIVYG_DIV\",\"tabindex\":\"2\",\"type\":\"Label\",\"value\":\"Da Data Frazionata:\",\"w\":\"132\",\"x\":\"8\",\"y\":\"16\",\"zone\":\"XLVFHSOSYH_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"A_Data_Frazionata_\",\"page\":\"1\",\"spuid\":\"BGHAITOPMU_DIV\",\"tabindex\":\"4\",\"type\":\"Label\",\"value\":\"A Data Frazionata:\",\"w\":\"132\",\"x\":\"216\",\"y\":\"16\",\"zone\":\"XLVFHSOSYH_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"ADatOpe\",\"page\":\"1\",\"spuid\":\"MTJDZQTEIR\",\"tabindex\":\"5\",\"type\":\"Textbox\",\"w\":\"72\",\"x\":\"352\",\"y\":\"12\",\"zone\":\"XLVFHSOSYH_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Esecuzione trasferimento dati da provvisorie a definitive\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"30\",\"href\":\"javascript:href_FLFHSXPWZI()\",\"name\":\"images_elaborazione_gif\",\"page\":\"1\",\"spuid\":\"FLFHSXPWZI\",\"src\":\"images\\/elaborazione.gif\",\"tabindex\":\"18\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"704\",\"y\":\"9\",\"zone\":\"XLVFHSOSYH_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Visualizza registrazioni comprese nel periodo\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"30\",\"href\":\"javascript:href_VRHQBWKFPP()\",\"name\":\"images_search_gif\",\"page\":\"1\",\"spuid\":\"VRHQBWKFPP\",\"src\":\"images\\/search.gif\",\"tabindex\":\"19\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"656\",\"y\":\"9\",\"zone\":\"XLVFHSOSYH_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Conferma i record selezionati\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"30\",\"href\":\"javascript:href_HDSXZTLKVK()\",\"name\":\"images_save_gif\",\"page\":\"1\",\"spuid\":\"HDSXZTLKVK\",\"src\":\"images\\/save.gif\",\"tabindex\":\"20\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"608\",\"y\":\"9\",\"zone\":\"XLVFHSOSYH_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Deseleziona tutti i rapporti\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"30\",\"href\":\"javascript:href_ZWTNEMXOFQ()\",\"name\":\"images_dese_all_gif\",\"page\":\"1\",\"spuid\":\"ZWTNEMXOFQ\",\"src\":\"images\\/dese_all.gif\",\"tabindex\":\"21\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"560\",\"y\":\"9\",\"zone\":\"XLVFHSOSYH_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Seleziona tutti i rapporti\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"30\",\"href\":\"javascript:href_FCATLNLMSB()\",\"name\":\"images_sel_all_gif\",\"page\":\"1\",\"spuid\":\"FCATLNLMSB\",\"src\":\"images\\/sel_all.gif\",\"tabindex\":\"22\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"512\",\"y\":\"9\",\"zone\":\"XLVFHSOSYH_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"30\",\"href\":\"javascript:href_PTXYMSWBZO()\",\"name\":\"images_exit_gif\",\"page\":\"1\",\"spuid\":\"PTXYMSWBZO\",\"src\":\"images\\/exit.gif\",\"tabindex\":\"24\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"752\",\"y\":\"9\",\"zone\":\"XLVFHSOSYH_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{}";
    ctrl = new org.json.JSONObject(s);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"left\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"103\",\"href\":\" \",\"name\":\"__iframe_width__755__height__150__id___messaggi__src__arpg_msg_import__frameborder__1___border__1__align__TOP__marginwidth__1__marginheight__1____iframe__\",\"page\":\"1\",\"spuid\":\"SSRCOAMDBL_DIV\",\"tabindex\":\"28\",\"type\":\"Label\",\"value\":\"\\\"<iframe width="+"'"+"755"+"'"+" height="+"'"+"150"+"'"+" id ="+"'"+"messaggi"+"'"+" src="+"'"+"arpg_msg_import"+"'"+" frameborder="+"'"+"1"+"'"+"  border="+"'"+"1"+"'"+" align="+"'"+"TOP"+"'"+" marginwidth="+"'"+"1"+"'"+" marginheight="+"'"+"1"+"'"+"><\\/iframe>\\\"\",\"w\":\"784\",\"x\":\"8\",\"y\":\"45\",\"zone\":\"XLVFHSOSYH_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    SPLib.SetMimeType(status.response,"application/json");
    items.write(status.out);
  }
  void WriteBody(ServletStatus status,arpg_trasffra_wuBO BO) {
  ...
  void WriteTrs(ServletStatus status,arpg_trasffra_wuBO BO) {
  ...
  void AddTrsQueryRow(ServletStatus status,int p_nCnt,arpg_trasffra_wuBO BO) {
    String l_cTrsQ;
  ...
  void Next(ServletStatus status,arpg_trasffra_wuBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow+entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void Previous(ServletStatus status,arpg_trasffra_wuBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow-entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void WriteFormPage(arpg_trasffra_wuBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='arpg_trasffra_wu?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+m_cEntityUid+"/arpg_trasffra_wu_proc.js'>" +
     "</script>" +
    "");
    IncludeJS(status);
  ...
  void RaiseLoadedEntity(arpg_trasffra_wuBO BO,ServletStatus status) {
    RaiseEventLoadedEntity(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cClientMode,"C",0,0)+"})","C",0,0));
  }
  void RaiseSavedEntity(arpg_trasffra_wuBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(arpg_trasffra_wuBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(arpg_trasffra_wuBO BO,ServletStatus status) {
  ...
  void WriteExitPage(arpg_trasffra_wuBO BO,ServletStatus status,Forward f) {
    WriteExitPage(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cMode,"C",0,0)+"})","C",0,0), f);
  }
  void WriteExitPage(arpg_trasffra_wuBO BO,ServletStatus status) {
  ...
  void IncludeJS(ServletStatus status) {
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+arrt_trasffra_sel.m_cEntityUid+"/arrt_trasffra_sel.js'>" +
     "</script>" +
    "");
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      ...
      arrt_trasffra_sel.GetCallableNames(callable);
      arrt_trasffra.GetCallableNames(callable);
    } else {
  ...
  public String GetCheckVars(ServletStatus status,arpg_trasffra_wuBO BO) {
    return "NO_VALUE";
  }
  public boolean CheckVars(ServletStatus status,arpg_trasffra_wuBO BO) {
    boolean result = true;
    return result;
  }
}
