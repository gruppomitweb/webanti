...
// * --- Fine Area Manuale
public class arrt_importsfR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_importsfR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_importsf",m_Caller);
    Blank();
  }
  ...
  public static arrt_importsfR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_importsfR(p_Ctx, p_Caller);
  }
  public void Blank() {
