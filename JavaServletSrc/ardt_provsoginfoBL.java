...
public class ardt_provsoginfoBL extends ardt_provsoginfoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_provsoginfo";
  ...
  public CPPhTableWrInfo m_oWrInfo_xoginfo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xoginfo;
  ...
  public static String[] m_EntityTables = {"xoginfo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_provsoginfo",true,true)+"}"+FoundlingChildrenList("ardt_provsoginfo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescleg':xdescleg,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_provsoginfo",true,true)+"}"+FoundlingChildrenList("ardt_provsoginfo",true,false)+"}";
  public static final String i_ItemSequence = "RAPCOL,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_provsoginfo",false,true)+"]"+FoundlingChildrenList("ardt_provsoginfo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_provsoginfo"),new String[][]{new String[]{"RAPCOL","","C","25","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_provsoginfoBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xoginfo = p_ContextObject.GetPhName("xoginfo",p_ContextObject.GetCompany(),false);
    m_cServer_xoginfo = p_ContextObject.GetServer("xoginfo");
    m_oWrInfo_xoginfo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xoginfo",p_ContextObject.GetCompany());
    m_cVirtName_xoginfo = CPSql.ManipulateTablePhName("xoginfo",m_cServer_xoginfo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_provsoginfo",p_ContextObject);
  }
  public void Blank() {
    ...
    w_CAP = "";
    w_IDFILEBO = "";
    w_IDFILEBO = LibreriaMit.UniqueId();
    Link_FVKNSPNHTX();
    Link_KQROMFNGNZ();
  ...
  public boolean getVisible_LEGAME() {
    return arfn_view_soctR.Make(m_Ctx,this).Run(Utilities.Make(m_Ctx).GetCallerDate("DATAOPE"),Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"T");
  }
  public boolean getVisible_xdescleg() {
    return arfn_view_soctR.Make(m_Ctx,this).Run(Utilities.Make(m_Ctx).GetCallerDate("DATAOPE"),Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"T");
  }
  ...
  public final static String[] m_KeyColumns = {"RAPCOL"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_provsoginfo","xoginfo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_RAPCOL = CPLib.GetProperty(p,"RAPCOL",w_RAPCOL,0);
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_provsoginfo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_provsoginfo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_provsoginfo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_provsoginfo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_provsoginfo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_provsoginfo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"RAPCOL",w_RAPCOL,0);
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xoginfo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPCOL","C",25,0));
  }
  public String RowPrimaryKey() {
    return "xoginfo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
