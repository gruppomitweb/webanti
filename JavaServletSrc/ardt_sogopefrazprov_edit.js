...
if ( ! (m_oFather.SaveContext_ardt_sogopefrazprov())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_sogopefrazprov_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_sogopefrazprov_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_sogopefrazprov();
}
}
SaveContext.child=[];
function BlankRow() {
