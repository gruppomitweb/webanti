...
public class arpg_trasfdafra_aopeBL extends arpg_trasfdafra_aopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasfdafra_aope";
  ...
  public static final String i_StateStructure = "{'ADatOpe':ADatOpe,'flgdel':flgdel}";
  public static final String i_CompleteStateStructure = "{'numgio':numgio,'ADatOpe':ADatOpe,'msgtxt':msgtxt,'valelab':valelab,'flgdel':flgdel,'DaDatOpe':DaDatOpe,'gIntemediario':gIntemediario,'xLIMITE20':xLIMITE20}";
  public static final String i_ItemSequence = "ADatOpe,flgdel";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"flgdel","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_trasfdafra_aopeBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_DaDatOpe = ( ! (CPLib.Empty(w_ADatOpe))?arfn_dateminusR.Make(m_Ctx,this).Run(w_ADatOpe,w_numgio-1):CPLib.NullDate());
    Link_BAUGPXCQMW();
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasfdafra_aope","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
