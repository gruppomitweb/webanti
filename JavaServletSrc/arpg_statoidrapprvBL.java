...
public class arpg_statoidrapprvBL extends arpg_statoidrapprvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_statoidrapprv";
  ...
  public arpg_statoidrapprvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_statoidrapprv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
