...
public class ardt_clientiopeBL extends ardt_clientiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_clientiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_clientiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_clientiope;
  ...
  public static String[] m_EntityTables = {"clientiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'PROQUOTA':PROQUOTA,'IMPSARA':IMPSARA"+FoundlingChildrenList("ardt_clientiope",true,true)+"}"+FoundlingChildrenList("ardt_clientiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PROQUOTA':PROQUOTA,'IMPSARA':IMPSARA"+FoundlingChildrenList("ardt_clientiope",true,true)+"}"+FoundlingChildrenList("ardt_clientiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG PROQUOTA IMPSARA"+FoundlingChildrenList("ardt_clientiope",false,true)+"]"+FoundlingChildrenList("ardt_clientiope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_clientiope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"PROQUOTA","Pro Quota","N","3","0","campo","nokey","true","false"},new String[]{"IMPSARA","Importo per Sara","N","19","2","campo","nokey","true","false"}});
  ...
  public ardt_clientiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_clientiope = p_ContextObject.GetPhName("clientiope",p_ContextObject.GetCompany(),false);
    m_cServer_clientiope = p_ContextObject.GetServer("clientiope");
    m_oWrInfo_clientiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"clientiope",p_ContextObject.GetCompany());
    m_cVirtName_clientiope = CPSql.ManipulateTablePhName("clientiope",m_cServer_clientiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_clientiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_clientiope","clientiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_clientiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_clientiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_clientiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_clientiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_clientiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_clientiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "clientiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "clientiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
