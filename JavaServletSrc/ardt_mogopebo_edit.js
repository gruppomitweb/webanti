...
if ( ! (m_oFather.SaveContext_ardt_mogopebo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_mogopebo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_mogopebo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_mogopebo();
}
}
SaveContext.child=[];
function BlankRow() {
