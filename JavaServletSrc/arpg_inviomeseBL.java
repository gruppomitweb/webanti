...
public class arpg_inviomeseBL extends arpg_inviomeseWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_inviomese";
  ...
  public static final String i_StateStructure = "{'a_datag':a_datag,'flgglob':flgglob,'iniz':iniz,'seco':seco,'dadata':dadata,'a_data':a_data}";
  public static final String i_CompleteStateStructure = "{'dadatag':dadatag,'a_datag':a_datag,'flgglob':flgglob,'iniz':iniz,'seco':seco,'dadata':dadata,'a_data':a_data,'datpri':datpri,'datseci':datseci,'datsecf':datsecf,'datprf':datprf,'bloccaedit':bloccaedit,'_errore':_errore}";
  public static final String i_ItemSequence = "a_datag,flgglob,iniz,seco,dadata,a_data";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"a_datag","","D","8","0","variabile","nokey","false","false"},new String[]{"flgglob","","C","1","0","variabile","nokey","false","false"},new String[]{"iniz","","C","1","0","variabile","nokey","false","false"},new String[]{"seco","","C","1","0","variabile","nokey","false","false"},new String[]{"dadata","","D","8","0","variabile","nokey","false","false"},new String[]{"a_data","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_inviomeseBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_inviomese","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
