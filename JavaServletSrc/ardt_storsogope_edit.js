...
if ( ! (m_oFather.SaveContext_ardt_storsogope())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_storsogope_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_storsogope_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_storsogope();
}
}
SaveContext.child=[];
function BlankRow() {
