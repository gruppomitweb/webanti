...
public class ardt_meneficopeBL extends ardt_meneficopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_meneficope";
  ...
  public CPPhTableWrInfo m_oWrInfo_meneficope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_meneficope;
  ...
  public static String[] m_EntityTables = {"meneficope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_CAB':C_CAB,'C_PRV':C_PRV,'C_IND':C_IND,'C_STA':C_STA,'C_CAP':C_CAP"+FoundlingChildrenList("ardt_meneficope",true,true)+"}"+FoundlingChildrenList("ardt_meneficope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_CAB':C_CAB,'C_PRV':C_PRV,'C_IND':C_IND,'C_STA':C_STA,'xdessta':xdessta,'C_CAP':C_CAP"+FoundlingChildrenList("ardt_meneficope",true,true)+"}"+FoundlingChildrenList("ardt_meneficope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG C_RAG C_CTA C_CAB C_PRV C_IND C_STA C_CAP"+FoundlingChildrenList("ardt_meneficope",false,true)+"]"+FoundlingChildrenList("ardt_meneficope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_meneficope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"C_RAG","","C","70","0","campo","key3","true","false"},new String[]{"C_CTA","","C","30","0","campo","nokey","true","false"},new String[]{"C_CAB","","C","6","0","campo","nokey","true","false"},new String[]{"C_PRV","","C","2","0","campo","nokey","true","false"},new String[]{"C_IND","","C","35","0","campo","nokey","true","false"},new String[]{"C_STA","","C","3","0","campo","nokey","true","false"},new String[]{"C_CAP","","C","5","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_meneficopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_meneficope = p_ContextObject.GetPhName("meneficope",p_ContextObject.GetCompany(),false);
    m_cServer_meneficope = p_ContextObject.GetServer("meneficope");
    m_oWrInfo_meneficope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"meneficope",p_ContextObject.GetCompany());
    m_cVirtName_meneficope = CPSql.ManipulateTablePhName("meneficope",m_cServer_meneficope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_meneficope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_meneficope","meneficope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_meneficope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_meneficope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_meneficope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_meneficope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_meneficope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_meneficope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "meneficope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "meneficope"+"\\"+CPLib.ToCPStr(w_CODSOG)+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
