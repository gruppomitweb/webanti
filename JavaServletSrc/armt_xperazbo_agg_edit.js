...
if ( ! (m_oFather.SaveContext_armt_xperazbo_agg())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_xperazbo_agg_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_xperazbo_agg_dataNotSent',{'action':formaction});
}
}
}
}
...
_FillChildren.n=[];
FillWv.n=["IDBASE","CATEG01","CATEG02","CATEG03","CATEG04","CATEG05","FLAGFRAUD","SV58724","SV58726SCA","SV58726SA","SV58726PISP","CATEGORIA","C_COGNOME","C_NOME","SOSPAGAM","SEGNO","xC1DESCRI","xC2DESCRI","xC3DESCRI","xC4DESCRI","xC5DESCRI"];
function SetModified() {
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_xperazbo_agg();
}
}
