...
public class ardt_patrimonioBL extends ardt_patrimonioWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_patrimonio";
  ...
  public String m_cPhName_patrimonio;
  public String m_cServer_patrimonio;
  public CPPhTableWrInfo m_oWrInfo_patrimonio;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_patrimonio;
  // Variabile che memorizza lo stato subito dopo una Load o una Save
  public String m_cPreviousState;
  public String m_cPhName_tbfascepr;
  public String m_cServer_tbfascepr;
  public CPPhTableWrInfo m_oWrInfo_tbfascepr;
  ...
  public static String[] m_EntityTables = {"patrimonio"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CONNES':CONNES,'m_Detail':{'CODICE':CODICE,'IMPEFF':IMPEFF,'RISCHIO':RISCHIO,'ANNO':ANNO"+FoundlingChildrenList("ardt_patrimonio",true,true)+"}"+FoundlingChildrenList("ardt_patrimonio",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'CONNES':CONNES,'m_Detail':{'CODICE':CODICE,'IMPEFF':IMPEFF,'RISCHIO':RISCHIO,'ANNO':ANNO,'xDESCRI':xDESCRI,'IDBASE':IDBASE"+FoundlingChildrenList("ardt_patrimonio",true,true)+"}"+FoundlingChildrenList("ardt_patrimonio",true,false)+"}";
  public static final String i_ItemSequence = "CONNES,m_Detail[ CODICE IMPEFF RISCHIO ANNO"+FoundlingChildrenList("ardt_patrimonio",false,true)+"]"+FoundlingChildrenList("ardt_patrimonio",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_patrimonio"),new String[][]{new String[]{"CONNES","NDG","C","16","0","campo","key1","false","false"},new String[]{"CODICE","Codice","C","10","0","campo","nokey","true","false"},new String[]{"IMPEFF","Importo","N","19","2","campo","nokey","true","false"},new String[]{"RISCHIO","Rischio","N","3","0","campo","nokey","true","false"},new String[]{"ANNO","Anno Riferimento","N","4","0","campo","key1","true","false"}});
  ...
  public ardt_patrimonioBL (CPContext p_ContextObject) {
    ...
    m_cPhName_patrimonio = p_ContextObject.GetPhName("patrimonio",p_ContextObject.GetCompany(),false);
    m_cServer_patrimonio = p_ContextObject.GetServer("patrimonio");
    m_oWrInfo_patrimonio = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"patrimonio",p_ContextObject.GetCompany());
    m_cVirtName_patrimonio = CPSql.ManipulateTablePhName("patrimonio",m_cServer_patrimonio);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    m_cPhName_tbfascepr = p_ContextObject.GetPhName("tbfascepr");
    m_cServer_tbfascepr = p_ContextObject.GetServer("tbfascepr");
    m_oWrInfo_tbfascepr = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"tbfascepr",p_ContextObject.GetCompany());
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_patrimonio",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_MDAZAECEFB() {
    return Link_MDAZAECEFB("Full");
  }
  protected boolean Link_MDAZAECEFB(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_CODICE))) {
      String l_OldValue = w_CODICE;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CODICE,"C",10,0),m_cServer_tbfascepr,w_CODICE);
      if (m_Ctx.IsSharedTemp("tbfascepr")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_tbfascepr,"select CODICE,DESCRI,RISCHIO from "+m_cPhName_tbfascepr+((m_cPhName_tbfascepr).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODICE"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CODICE,"C",150,0),m_cServer_tbfascepr,w_CODICE);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_tbfascepr,"select CODICE,DESCRI,RISCHIO from "+m_cPhName_tbfascepr+((m_cPhName_tbfascepr).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRI"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                    ...
                                    */
          w_CODICE = l_rsLink.GetString("CODICE");
          w_xDESCRI = l_rsLink.GetString("DESCRI");
          w_RISCHIO = l_rsLink.GetDouble("RISCHIO");
          l_rsLink.Next();
        ...
        if ( ! (l_bResult)) {
          ...
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","CODICE");
          }
          m_cLastWorkVarError = "CODICE";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  public boolean Set_IMPEFF(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IMPEFF = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_RISCHIO(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_RISCHIO = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_patrimonio","patrimonio",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_CODICE;
      p_CODICE = CPLib.GetProperties(trs_p.getProperty("CODICE"),new Properties());
      Properties p_IMPEFF;
      p_IMPEFF = CPLib.GetProperties(trs_p.getProperty("IMPEFF"),new Properties());
      Properties p_RISCHIO;
      p_RISCHIO = CPLib.GetProperties(trs_p.getProperty("RISCHIO"),new Properties());
      Properties p_ANNO;
      ...
      while (CPLib.le(i,rows)) {
        w_CODICE = "";
        w_CODICE = CPLib.GetProperty(p_CODICE,"",w_CODICE,i);
        w_IMPEFF = 0;
        w_IMPEFF = CPLib.GetProperty(p_IMPEFF,"",w_IMPEFF,i);
        w_RISCHIO = 0;
        w_RISCHIO = CPLib.GetProperty(p_RISCHIO,"",w_RISCHIO,i);
        w_ANNO = 0;
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"CODICE")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"IMPEFF")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"RISCHIO")) {
      SetUpdatedRow();
      return;
    }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("tbfascepr");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("tbfascepr",items);
    }
    items.add(map);
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODICE","DESCRI","RISCHIO"});
    map.put("rd_var",new String[]{"w_CODICE","w_xDESCRI","w_RISCHIO"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C\u0000N",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("10\u0000150\u00003",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Codice\u0000Descrizione\u0000Rischio",-1));
    ...
    map.put("property.value",zeroSplit.split("tbfascepr\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Fasce Reddito/Patrimonio\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_patrimonio",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_patrimonio",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_patrimonio",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_patrimonio",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_patrimonio"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_patrimonio\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_CODICE;
    p_CODICE = new Properties();
    Properties p_IMPEFF;
    p_IMPEFF = new Properties();
    Properties p_RISCHIO;
    p_RISCHIO = new Properties();
    Properties p_ANNO;
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_CODICE,"",w_CODICE,trsrow);
      CPLib.PutProperty(p_IMPEFF,"",w_IMPEFF,trsrow);
      CPLib.PutProperty(p_RISCHIO,"",w_RISCHIO,trsrow);
    ...
    trs_p.setProperty("CODICE",CPLib.ToProperties(p_CODICE));
    trs_p.setProperty("IMPEFF",CPLib.ToProperties(p_IMPEFF));
    trs_p.setProperty("RISCHIO",CPLib.ToProperties(p_RISCHIO));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "patrimonio"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CONNES","C",16,0));
  }
  public String RowPrimaryKey() {
    return "patrimonio"+"\\"+CPLib.ToCPStr(w_ANNO);
  }
  ...
  protected void TrsToWork() {
    w_CODICE= m_oTrs.get(m_nCurrentRow).w_CODICE;
    w_IMPEFF= m_oTrs.get(m_nCurrentRow).w_IMPEFF;
    w_RISCHIO= m_oTrs.get(m_nCurrentRow).w_RISCHIO;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_CODICE=w_CODICE;
    m_oTrs.get(m_nCurrentRow).w_IMPEFF=w_IMPEFF;
    m_oTrs.get(m_nCurrentRow).w_RISCHIO=w_RISCHIO;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_CODICE=w_CODICE;
    m_oDeletedRows.get(l_nRows).w_IMPEFF=w_IMPEFF;
    m_oDeletedRows.get(l_nRows).w_RISCHIO=w_RISCHIO;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_CODICE= m_oDeletedRows.get(l_RowNumberToSet).w_CODICE;
    w_IMPEFF= m_oDeletedRows.get(l_RowNumberToSet).w_IMPEFF;
    w_RISCHIO= m_oDeletedRows.get(l_RowNumberToSet).w_RISCHIO;
