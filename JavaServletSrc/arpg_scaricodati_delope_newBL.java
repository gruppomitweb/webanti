...
public class arpg_scaricodati_delope_newBL extends arpg_scaricodati_delope_newWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_scaricodati_delope_new";
  ...
  public static final String i_StateStructure = "{'anno':anno,'mese':mese,'darett':darett,'a_rett':a_rett,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO,'mespre':mespre}";
  public static final String i_CompleteStateStructure = "{'anno':anno,'mese':mese,'darett':darett,'a_rett':a_rett,'dadata':dadata,'a_data':a_data,'gIntemediario':gIntemediario,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO,'sogest':sogest,'gDescAzi':gDescAzi,'mespre':mespre}";
  public static final String i_ItemSequence = "anno,mese,darett,a_rett,CFINVIO,CAFINVIO,FILEINVIO,DATAINVIO,mespre";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","true"},new String[]{"darett","","D","8","0","variabile","nokey","false","false"},new String[]{"a_rett","","D","8","0","variabile","nokey","false","false"},new String[]{"CFINVIO","Codice Fiscale Organo Invio File","C","16","0","variabile","nokey","false","false"},new String[]{"CAFINVIO","Codice CAF Organo Invio","C","5","0","variabile","nokey","false","false"},new String[]{"FILEINVIO","Tipo Preparazione FIle","C","1","0","variabile","nokey","false","false"},new String[]{"DATAINVIO","Data Impegno Organo Invio","D","8","0","variabile","nokey","false","false"},new String[]{"mespre","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_scaricodati_delope_newBL (CPContext p_ContextObject) {
  ...
  public boolean Set_anno(double p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.ge(w_anno,2008);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "L'utilizzo di questa maschera consente date dal 2008 in avanti";
    }
    if ( ! (l_bResult)) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_scaricodati_delope_new","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
