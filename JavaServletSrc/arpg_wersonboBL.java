...
public class arpg_wersonboBL extends arpg_wersonboWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_sanumpro;
  ...
  public static final String i_EntityName = "arpg_wersonbo";
  ...
  public arpg_wersonboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_wersonbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_sanumpro=c_sanumpro;
  ...
  public void TrsToWork() {
    c_sanumpro= m_oTrs.get(m_nCurrentRow).c_sanumpro;
