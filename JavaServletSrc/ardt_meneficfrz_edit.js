...
if ( ! (m_oFather.SaveContext_ardt_meneficfrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_meneficfrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_meneficfrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_meneficfrz();
}
}
SaveContext.child=[];
function BlankRow() {
