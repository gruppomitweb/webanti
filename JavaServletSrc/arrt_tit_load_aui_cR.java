...
// * --- Fine Area Manuale
public class arrt_tit_load_aui_cR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_tit_load_aui_cR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_tit_load_aui_c",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Stop armt_titolabo */
    Forward f;
    f=new Forward("armt_titolabo",false,this,Forward.Autozoom,false);
  ...
  public static arrt_tit_load_aui_cR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_tit_load_aui_cR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
