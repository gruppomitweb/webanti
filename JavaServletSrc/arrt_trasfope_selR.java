...
// * --- Fine Area Manuale
public class arrt_trasfope_selR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_trasfope_selR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_trasfope_sel",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    _h00000011.Set("dadata",w_dadata);
    _h00000011.Set("a_data",w_a_data);
    _h00000011.Set("DaDatReg",w_DaDatReg);
    _h00000011.Set("ADatReg",w_ADatReg);
    m_cPhName = m_Ctx.CreateTmpPhName("tmp_trasfope");
    new VQRHolder("qbe_trasfope",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000011,true).CreateServerQuery(m_Ctx, "tmp_trasfope",false);
    m_cPhName_tmp_trasfope = m_cPhName;
    /* Stop arpg_trasfope */
    Forward f;
  ...
  public static arrt_trasfope_selR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_trasfope_selR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_trasfope,
  public static final String m_cVQRList = ",qbe_trasfope,";
  // ENTITY_BATCHES: ,
