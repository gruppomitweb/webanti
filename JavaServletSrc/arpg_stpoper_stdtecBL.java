...
public class arpg_stpoper_stdtecBL extends arpg_stpoper_stdtecWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpoper_stdtec";
  ...
  public static final String i_CompleteStateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2}";
  ...
  public arpg_stpoper_stdtecBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpoper_stdtec","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
