...
if ( ! (m_oFather.SaveContext_ardt_werzistiope())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_werzistiope_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_werzistiope_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_werzistiope();
}
}
SaveContext.child=[];
function BlankRow() {
