...
// * --- Fine Area Manuale
public class arrt_lancia_impxls_aeR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_impxls_aeR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_impxls_ae",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("arpg_imp_amexxls",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_impxls_aeR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_impxls_aeR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
