// Definition generated from table tmp_import_rtra
public class MemoryCursor_tmp_import_rtra extends CPMemoryCursor {
  MemoryCursorRow_tmp_import_rtra row;
  MemoryCursorRow_tmp_import_rtra empty_row;
  public MemoryCursor_tmp_import_rtra() {
    empty_row = new MemoryCursorRow_tmp_import_rtra();
    row = empty_row;
  }
  public MemoryCursor_tmp_import_rtra(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  public void AppendData(java.util.Properties p,CPContext p_Ctx) {
    ...
    java.util.Properties p_CLIDESCCIT;
    p_CLIDESCCIT = new java.util.Properties();
    java.util.Properties p_CLIPROVINCIA;
    p_CLIPROVINCIA = new java.util.Properties();
    java.util.Properties p_CLIPAESE;
    p_CLIPAESE = new java.util.Properties();
    java.util.Properties p_CLICAP;
    p_CLICAP = new java.util.Properties();
    ...
    while (e.hasMoreElements()) {
      ...
      if ("CLIDESCCIT".equalsIgnoreCase(key)) {
        p_CLIDESCCIT = CPLib.GetProperties(p.getProperty(key));
      }
      if ("CLIPROVINCIA".equalsIgnoreCase(key)) {
        p_CLIPROVINCIA = CPLib.GetProperties(p.getProperty(key));
      }
      if ("CLIPAESE".equalsIgnoreCase(key)) {
        p_CLIPAESE = CPLib.GetProperties(p.getProperty(key));
      }
      if ("CLICAP".equalsIgnoreCase(key)) {
        p_CLICAP = CPLib.GetProperties(p.getProperty(key));
      }
    ...
    for ( i = 1; CPLib.le(i,Rows); i = i + (1)) {
      ...
      row.CLIDESCCIT = CPLib.GetProperty(p_CLIDESCCIT,"","",i);
      row.CLIPROVINCIA = CPLib.GetProperty(p_CLIPROVINCIA,"","",i);
      row.CLIPAESE = CPLib.GetProperty(p_CLIPAESE,"","",i);
      row.CLICAP = CPLib.GetProperty(p_CLICAP,"","",i);
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_tmp_import_rtra)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_tmp_import_rtra();
  }
  ...
  public MemoryCursorRow_tmp_import_rtra _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_tmp_import_rtra _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_tmp_import_rtra> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_tmp_import_rtra();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_tmp_import_rtra p_Row) {
    MemoryCursorRow_tmp_import_rtra l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_tmp_import_rtra p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_tmp_import_rtra();
    }
    this.row.Copy(p_Row);
    return true;
  }
