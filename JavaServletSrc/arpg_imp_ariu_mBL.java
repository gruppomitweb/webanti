...
public class arpg_imp_ariu_mBL extends arpg_imp_ariu_mWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_imp_ariu_m";
  ...
  public static final String i_CompleteStateStructure = "{'gFlgWU':gFlgWU}";
  ...
  public arpg_imp_ariu_mBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_imp_ariu_m","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
