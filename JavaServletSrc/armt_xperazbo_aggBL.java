...
public class armt_xperazbo_aggBL extends armt_xperazbo_aggWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_xperazbo_agg";
  ...
  public CPPhTableWrInfo m_oWrInfo_xperazbo_agg;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xperazbo_agg;
  ...
  public armt_xperazbo_aggBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xperazbo_agg = p_ContextObject.GetPhName("xperazbo_agg",p_ContextObject.GetCompany(),false);
    m_cServer_xperazbo_agg = p_ContextObject.GetServer("xperazbo_agg");
    m_oWrInfo_xperazbo_agg = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xperazbo_agg",p_ContextObject.GetCompany());
    m_cVirtName_xperazbo_agg = CPSql.ManipulateTablePhName("xperazbo_agg",m_cServer_xperazbo_agg);
    ...
    m_MNTs = CPLib.MNTChilds("armt_xperazbo_agg",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_xperazbo_agg","xperazbo_agg",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_xperazbo_agg",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_xperazbo_agg",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_xperazbo_agg",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_xperazbo_agg"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_xperazbo_agg\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xperazbo_agg"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
