...
public class ardt_soginfoBL extends ardt_soginfoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_soginfo";
  ...
  public CPPhTableWrInfo m_oWrInfo_soginfo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_soginfo;
  ...
  public static String[] m_EntityTables = {"soginfo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_soginfo",true,true)+"}"+FoundlingChildrenList("ardt_soginfo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescleg':xdescleg,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_soginfo",true,true)+"}"+FoundlingChildrenList("ardt_soginfo",true,false)+"}";
  public static final String i_ItemSequence = "RAPCOL,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_soginfo",false,true)+"]"+FoundlingChildrenList("ardt_soginfo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_soginfo"),new String[][]{new String[]{"RAPCOL","","C","25","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_soginfoBL (CPContext p_ContextObject) {
    ...
    m_cPhName_soginfo = p_ContextObject.GetPhName("soginfo",p_ContextObject.GetCompany(),false);
    m_cServer_soginfo = p_ContextObject.GetServer("soginfo");
    m_oWrInfo_soginfo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"soginfo",p_ContextObject.GetCompany());
    m_cVirtName_soginfo = CPSql.ManipulateTablePhName("soginfo",m_cServer_soginfo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_soginfo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_soginfo","soginfo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_soginfo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_soginfo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_soginfo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_soginfo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_soginfo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_soginfo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "soginfo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPCOL","C",25,0));
  }
  public String RowPrimaryKey() {
    return "soginfo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
