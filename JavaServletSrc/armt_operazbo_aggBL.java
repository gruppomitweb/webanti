...
public class armt_operazbo_aggBL extends armt_operazbo_aggWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_operazbo_agg";
  ...
  public CPPhTableWrInfo m_oWrInfo_operazbo_agg;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_operazbo_agg;
  ...
  public armt_operazbo_aggBL (CPContext p_ContextObject) {
    ...
    m_cPhName_operazbo_agg = p_ContextObject.GetPhName("operazbo_agg",p_ContextObject.GetCompany(),false);
    m_cServer_operazbo_agg = p_ContextObject.GetServer("operazbo_agg");
    m_oWrInfo_operazbo_agg = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"operazbo_agg",p_ContextObject.GetCompany());
    m_cVirtName_operazbo_agg = CPSql.ManipulateTablePhName("operazbo_agg",m_cServer_operazbo_agg);
    ...
    m_MNTs = CPLib.MNTChilds("armt_operazbo_agg",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_operazbo_agg","operazbo_agg",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var.key_num",zeroSplit.split("key5\u0000nokey",-1));
    ...
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("key7\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("\u0000",-1));
    ...
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Categoria 4\u0000Descrizione",-1));
    map.put("rd_kvar.comment",new String[]{});
    ...
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Categoria 5\u0000Descrizione",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("key9\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("\u0000",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_operazbo_agg",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_operazbo_agg",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_operazbo_agg",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_operazbo_agg"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_operazbo_agg\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "operazbo_agg"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
