...
public class ardt_delegaboBL extends ardt_delegaboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_delegabo";
  ...
  public CPPhTableWrInfo m_oWrInfo_delegabo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_delegabo;
  ...
  public static String[] m_EntityTables = {"delegabo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'NOAGE':NOAGE"+FoundlingChildrenList("ardt_delegabo",true,true)+"}"+FoundlingChildrenList("ardt_delegabo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'NUMPROG':NUMPROG,'m_Detail':{'CODINTER':CODINTER,'xragsoci':xragsoci,'DESCINTER':DESCINTER,'DATAINI':DATAINI,'TIPORAP':TIPORAP,'TIPOPERS':TIPOPERS,'STATOREG':STATOREG,'OPERAZMOD':OPERAZMOD,'DATARETT':DATARETT,'IDEREG':IDEREG,'COLLEGAMEN':COLLEGAMEN,'DATAFINE':DATAFINE,'IDBASE':IDBASE,'UCODE':UCODE,'tiporegr':tiporegr,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'NUMPROG1':NUMPROG1,'NUMPROG2':NUMPROG2,'xRagSoc':xRagSoc,'NOAGE':NOAGE"+FoundlingChildrenList("ardt_delegabo",true,true)+"}"+FoundlingChildrenList("ardt_delegabo",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER DATAINI DATAFINE NOAGE"+FoundlingChildrenList("ardt_delegabo",false,true)+"]"+FoundlingChildrenList("ardt_delegabo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_delegabo"),new String[][]{new String[]{"RAPPORTO","Rapporto (Copia della testata)","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","","C","16","0","campo","nokey","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","true"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","true"},new String[]{"NOAGE","","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_delegaboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_delegabo = p_ContextObject.GetPhName("delegabo",p_ContextObject.GetCompany(),false);
    m_cServer_delegabo = p_ContextObject.GetServer("delegabo");
    m_oWrInfo_delegabo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"delegabo",p_ContextObject.GetCompany());
    m_cVirtName_delegabo = CPSql.ManipulateTablePhName("delegabo",m_cServer_delegabo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_delegabo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_delegabo","delegabo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_CODINTER","w_DESCINTER","w_DOMICILIO","w_DESCCIT","w_PROVINCIA","w_CAP","w_xragsoci"});
    ...
    map.put("rd_var.comment",zeroSplit.split("\u0000\u0000Indirizzo\u0000Città\u0000Provincia\u0000CAP\u0000Ragione Sociale",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("TRUE\u0000TRUE\u0000TRUE\u0000TRUE\u0000TRUE\u0000TRUE\u0000TRUE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("\u0000\u0000\u0000\u0000\u0000\u0000",-1));
    map.put("rd_kvar.frm_obbl",new String[]{});
    map.put("rd_var.obj",zeroSplit.split("campo\u0000campo\u0000variabile\u0000variabile\u0000variabile\u0000variabile\u0000variabile",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_delegabo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_delegabo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_delegabo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_delegabo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_delegabo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_delegabo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "delegabo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "delegabo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
