...
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_edt_rapotit']));
SendData('start','arrt_edt_rapotit'+'',HParApplet().asString());
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_edt_rapotit_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_edt_rapotit',m_cSelectedPage);
