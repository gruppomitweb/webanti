...
public class armt_wu_chkerr_sfBL extends armt_wu_chkerr_sfWV implements CPLib.QueryFilterFromProject {
  ...
  public static final String i_EntityName = "armt_wu_chkerr_sf";
  ...
  public CPPhTableWrInfo m_oWrInfo_wuchkimp_sf;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wuchkimp_sf;
  ...
  public static String[] m_EntityTables = {"wuchkimp_sf"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'WUTIPOPE':WUTIPOPE,'WUCODICE':WUCODICE,'WUNDATOPE':WUNDATOPE,'WUNCAPCLI':WUNCAPCLI,'WUNDATNAS':WUNDATNAS,'WUNRDOCCLI':WUNRDOCCLI,'WUNSDOCCLI':WUNSDOCCLI,'WUNTDOCCLI':WUNTDOCCLI,'WUNSTADES':WUNSTADES,'WUNCODDIP':WUNCODDIP,'WUNCITCLI':WUNCITCLI,'WUNBSTACLI':WUNBSTACLI,'WUNBCITCLI':WUNBCITCLI,'WUFLGALL':WUFLGALL,'WUNCODFIS':WUNCODFIS,'WUNOTE':WUNOTE,'WUFLGFRC':WUFLGFRC,'WUNSTACLI':WUNSTACLI,'WUOPETYPE':WUOPETYPE,'WUCODCLC':WUCODCLC,'WUNSEXCLI':WUNSEXCLI"+FoundlingChildrenList("armt_wu_chkerr_sf",true)+"}";
  public static final String i_CompleteStateStructure = "{'WUNOMEFILE':WUNOMEFILE,'WURIFMTCN':WURIFMTCN,'WUTIPOPE':WUTIPOPE,'WUCODDIP':WUCODDIP,'WUDATOPE':WUDATOPE,'WUIMPORTO':WUIMPORTO,'WUSTADES':WUSTADES,'WUTIPERR':WUTIPERR,'WUCODICE':WUCODICE,'WUNDATOPE':WUNDATOPE,'WUNCAPCLI':WUNCAPCLI,'WUNDATNAS':WUNDATNAS,'WUNRDOCCLI':WUNRDOCCLI,'WUNSDOCCLI':WUNSDOCCLI,'WUNTDOCCLI':WUNTDOCCLI,'WUNSTADES':WUNSTADES,'WUNCODDIP':WUNCODDIP,'WUNCITCLI':WUNCITCLI,'WUNBSTACLI':WUNBSTACLI,'WUNBCITCLI':WUNBCITCLI,'WUNOMCLI':WUNOMCLI,'WUCOGCLI':WUCOGCLI,'WUCITCLI':WUCITCLI,'WUCAPCLI':WUCAPCLI,'WUINDCLI':WUINDCLI,'WUNOMCON':WUNOMCON,'WUCOGCON':WUCOGCON,'WUBCITCLI':WUBCITCLI,'WUDATNAS':WUDATNAS,'WUCODFIS':WUCODFIS,'WUNDOCCLI':WUNDOCCLI,'WUADOCRIL':WUADOCRIL,'WURDOCCLI':WURDOCCLI,'WUSDOCCLI':WUSDOCCLI,'WUSEXCLI':WUSEXCLI,'WUTDOCCLI':WUTDOCCLI,'WUFLGALL':WUFLGALL,'WUNCODFIS':WUNCODFIS,'WUCODMAGE':WUCODMAGE,'xMADESCRI':xMADESCRI,'xDESDIP':xDESDIP,'WUNOTE':WUNOTE,'WUFLGFRC':WUFLGFRC,'WUORIGCF':WUORIGCF,'WUSTACLI':WUSTACLI,'WUNSTACLI':WUNSTACLI,'WUCONTANTI':WUCONTANTI,'WUOPETYPE':WUOPETYPE,'WUCODCLC':WUCODCLC,'WUNSEXCLI':WUNSEXCLI"+FoundlingChildrenList("armt_wu_chkerr_sf",true)+"}";
  public static final String i_ItemSequence = "WUTIPOPE,WUCODICE,WUNDATOPE,WUNCAPCLI,WUNDATNAS,WUNRDOCCLI,WUNSDOCCLI,WUNTDOCCLI,WUNSTADES,WUNCODDIP,WUNCITCLI,WUNBSTACLI,WUNBCITCLI,WUFLGALL,WUNCODFIS,WUNOTE,WUFLGFRC,WUNSTACLI,WUOPETYPE,WUCODCLC,WUNSEXCLI"+FoundlingChildrenList("armt_wu_chkerr_sf",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_wu_chkerr_sf"),new String[][]{new String[]{"WUTIPOPE","Send o Payment","C","1","0","campo","nokey","false","false"},new String[]{"WUCODICE","Progressivo","N","10","0","campo","key1","false","false"},new String[]{"WUNDATOPE","Nuova Data Operazione","D","8","0","campo","nokey","false","false"},new String[]{"WUNCAPCLI","Nuovo CAP Cliente","C","5","0","campo","nokey","false","false"},new String[]{"WUNDATNAS","Nuova Data Nascita Cliente","D","8","0","campo","nokey","false","false"},new String[]{"WUNRDOCCLI","Nuova Data Rilascio Documento","D","8","0","campo","nokey","false","false"},new String[]{"WUNSDOCCLI","Nuova Data Scadenza Documento","D","8","0","campo","nokey","false","false"},new String[]{"WUNTDOCCLI","Tipo Documento","C","2","0","campo","nokey","false","false"},new String[]{"WUNSTADES","Nuovo Stato Destinazione WU","C","3","0","campo","nokey","false","false"},new String[]{"WUNCODDIP","Nuovo Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"WUNCITCLI","Città Cliente","C","40","0","campo","nokey","false","false"},new String[]{"WUNBSTACLI","Nuovo Stato Nascita Cliente","C","40","0","campo","nokey","false","false"},new String[]{"WUNBCITCLI","Nuova Città Nascita Cliente","C","40","0","campo","nokey","false","false"},new String[]{"WUFLGALL","Completata","C","1","0","campo","nokey","false","false"},new String[]{"WUNCODFIS","Codice Fiscale","C","16","0","campo","nokey","false","false"},new String[]{"WUNOTE","Elenco Errori","M","10","0","campo","nokey","false","false"},new String[]{"WUFLGFRC","Forza caricamento movimento","C","1","0","campo","nokey","false","false"},new String[]{"WUNSTACLI","Nuovo Stato Residenza Cliente","C","50","0","campo","nokey","false","false"},new String[]{"WUOPETYPE","I - M- D","C","1","0","campo","nokey","false","false"},new String[]{"WUCODCLC","Codice Fiscale Ricalcolato","N","1","0","campo","nokey","false","false"},new String[]{"WUNSEXCLI","Nuovo Sesso Cliente","C","1","0","campo","nokey","false","false"}});
  ...
  public armt_wu_chkerr_sfBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wuchkimp_sf = p_ContextObject.GetPhName("wuchkimp_sf",p_ContextObject.GetCompany(),false);
    m_cServer_wuchkimp_sf = p_ContextObject.GetServer("wuchkimp_sf");
    m_oWrInfo_wuchkimp_sf = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wuchkimp_sf",p_ContextObject.GetCompany());
    m_cVirtName_wuchkimp_sf = CPSql.ManipulateTablePhName("wuchkimp_sf",m_cServer_wuchkimp_sf);
    ...
    m_MNTs = CPLib.MNTChilds("armt_wu_chkerr_sf",p_ContextObject);
  }
  public void Blank() {
    ...
    w_WUTIPOPE = "";
    w_WUCODDIP = "";
    w_WUDATOPE = CPLib.NullDate();
    w_WUIMPORTO = 0;
    w_WUSTADES = "";
    w_WUTIPERR = "";
    w_WUCODICE = 0;
    w_WUNDATOPE = CPLib.NullDate();
    w_WUNCAPCLI = "";
    ...
    w_WUNDOCCLI = "";
    w_WUADOCRIL = "";
    w_WURDOCCLI = CPLib.NullDate();
    w_WUSDOCCLI = CPLib.NullDate();
    w_WUSEXCLI = "";
    w_WUTDOCCLI = "";
    w_WUNCODFIS = "";
    w_WUCODMAGE = "";
  ...
  protected boolean Link_HHRNUENTOX() {
    return Link_HHRNUENTOX("Full");
  }
  protected boolean Link_HHRNUENTOX(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    // Dichiarazione del cursore locale del link
    CPResultSet l_rsLink=null;
    if ( ! (CPLib.Empty(w_WUCODDIP))) {
      String l_OldValue = w_WUCODDIP;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_WUCODDIP,"C",6,0),m_cServer_anadip,w_WUCODDIP);
      if (m_Ctx.IsSharedTemp("anadip")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_anadip,"select CODDIP,DESCCIT from "+m_cPhName_anadip+((m_cPhName_anadip).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODDIP"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                      relativi campi e/o variabili.
                                    */
          w_WUCODDIP = l_rsLink.GetString("CODDIP");
          w_xDESDIP = l_rsLink.GetString("DESCCIT");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
        ...
        if ( ! (l_bResult)) {
          ...
          m_cLastMsgError = "";
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","WUCODDIP");
          }
          m_cLastWorkVarError = "WUCODDIP";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  void Link_HHRNUENTOX_blank() {
    w_WUCODDIP = "";
    w_xDESDIP = "";
  }
  protected boolean Link_WVLDFVKALY() {
    return Link_WVLDFVKALY("Full");
  }
  protected boolean Link_WVLDFVKALY(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    // Dichiarazione del cursore locale del link
    CPResultSet l_rsLink=null;
    if ( ! (CPLib.Empty(w_WUNSTACLI))) {
      String l_OldValue = w_WUNSTACLI;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_WUNSTACLI,"C",50,0),m_cServer_tbstati,w_WUNSTACLI);
      if (m_Ctx.IsSharedTemp("tbstati")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
      ...
      try {
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                      relativi campi e/o variabili.
                                    */
          w_WUNSTACLI = l_rsLink.GetString("DESCRI");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
        ...
        if ( ! (l_bResult)) {
          ...
          m_cLastMsgError = "";
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","WUNSTACLI");
          }
          m_cLastWorkVarError = "WUNSTACLI";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_WUTIPOPE(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_WUTIPOPE = p_workVariableValue;
  ...
  public boolean Set_WUNDATOPE(java.sql.Date p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_WUNDATOPE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_WUNSTADES(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_WUNSTADES = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_WUNSTACLI(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_WUNSTACLI = p_workVariableValue;
    l_bResult = Link_WVLDFVKALY();
    // La variabile che indica il tipo di errore viene eventualmente impostata
    // dalla funzione di link: infatti il suo valore di ritorno non e'
    // sufficiente per determinare il tipo di errore che puo' essere di valore
    // non trovato nella tabella collegata o di check non valido.
  ...
  public boolean Set_WUOPETYPE(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_WUOPETYPE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_WUCODCLC(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_WUCODCLC = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Calculate() {
    ...
    if (CPLib.ne(o_WUCODDIP,w_WUCODDIP)) {
      l_bTmpRes = Link_HHRNUENTOX();
    }
  ...
  void Calculation_JZLZQNXXZW() {
    arrt_start_wusf_okR l_oRoutine_arrt_start_wusf_ok;
    l_oRoutine_arrt_start_wusf_ok = arrt_start_wusf_okR.Make(m_Ctx,this);
    l_oRoutine_arrt_start_wusf_ok.Run();
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ProjectAndApplicationQueryFilter("armt_wu_chkerr_sf","wuchkimp_sf",m_KeyColumns,"WUFLGALL='N'",m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_WURIFMTCN = CPLib.GetProperty(p,"WURIFMTCN",w_WURIFMTCN,0);
      w_WUTIPOPE = CPLib.GetProperty(p,"WUTIPOPE",w_WUTIPOPE,0);
      w_WUCODDIP = CPLib.GetProperty(p,"WUCODDIP",w_WUCODDIP,0);
      w_WUDATOPE = CPLib.GetProperty(p,"WUDATOPE",w_WUDATOPE,0);
      w_WUIMPORTO = CPLib.GetProperty(p,"WUIMPORTO",w_WUIMPORTO,0);
      w_WUSTADES = CPLib.GetProperty(p,"WUSTADES",w_WUSTADES,0);
      w_WUTIPERR = CPLib.GetProperty(p,"WUTIPERR",w_WUTIPERR,0);
      w_WUCODICE = CPLib.GetProperty(p,"WUCODICE",w_WUCODICE,0);
      w_WUNDATOPE = CPLib.GetProperty(p,"WUNDATOPE",w_WUNDATOPE,0);
      ...
      w_WUNSTADES = CPLib.GetProperty(p,"WUNSTADES",w_WUNSTADES,0);
      ...
      w_WUNOMCON = CPLib.GetProperty(p,"WUNOMCON",w_WUNOMCON,0);
      w_WUCOGCON = CPLib.GetProperty(p,"WUCOGCON",w_WUCOGCON,0);
      ...
      w_WUORIGCF = CPLib.GetProperty(p,"WUORIGCF",w_WUORIGCF,0);
      w_WUSTACLI = CPLib.GetProperty(p,"WUSTACLI",w_WUSTACLI,0);
      w_WUNSTACLI = CPLib.GetProperty(p,"WUNSTACLI",w_WUNSTACLI,0);
      w_WUCONTANTI = CPLib.GetProperty(p,"WUCONTANTI",w_WUCONTANTI,0);
      w_WUOPETYPE = CPLib.GetProperty(p,"WUOPETYPE",w_WUOPETYPE,0);
      w_WUCODCLC = CPLib.GetProperty(p,"WUCODCLC",w_WUCODCLC,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODDIP","DESCCIT"});
    map.put("rd_var",new String[]{"w_WUCODDIP","w_xDESDIP"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    ...
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"DESCRI"});
    map.put("rd_var",new String[]{"w_WUNSTACLI"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C",-1));
    ...
    map.put("rd_var.dec",zeroSplit.split("0",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Nuovo Stato Residenza Cliente",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_wu_chkerr_sf",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_wu_chkerr_sf",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_wu_chkerr_sf",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_wu_chkerr_sf"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_wu_chkerr_sf\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"WURIFMTCN",w_WURIFMTCN,0);
    CPLib.PutProperty(p,"WUTIPOPE",w_WUTIPOPE,0);
    CPLib.PutProperty(p,"WUCODDIP",w_WUCODDIP,0);
    CPLib.PutProperty(p,"WUDATOPE",w_WUDATOPE,0);
    CPLib.PutProperty(p,"WUIMPORTO",w_WUIMPORTO,0);
    CPLib.PutProperty(p,"WUSTADES",w_WUSTADES,0);
    CPLib.PutProperty(p,"WUTIPERR",w_WUTIPERR,0);
    CPLib.PutProperty(p,"WUCODICE",w_WUCODICE,0);
    CPLib.PutProperty(p,"WUNDATOPE",w_WUNDATOPE,0);
    ...
    CPLib.PutProperty(p,"WUNSTADES",w_WUNSTADES,0);
    ...
    CPLib.PutProperty(p,"WUNOMCON",w_WUNOMCON,0);
    CPLib.PutProperty(p,"WUCOGCON",w_WUCOGCON,0);
    ...
    CPLib.PutProperty(p,"WUORIGCF",w_WUORIGCF,0);
    CPLib.PutProperty(p,"WUSTACLI",w_WUSTACLI,0);
    CPLib.PutProperty(p,"WUNSTACLI",w_WUNSTACLI,0);
    CPLib.PutProperty(p,"WUCONTANTI",w_WUCONTANTI,0);
    CPLib.PutProperty(p,"WUOPETYPE",w_WUOPETYPE,0);
    CPLib.PutProperty(p,"WUCODCLC",w_WUCODCLC,0);
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wuchkimp_sf"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("WUCODICE","N",10,0));
  }
