...
public class arpg_cgo_operazioni_agenzieBL extends arpg_cgo_operazioni_agenzieWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_agenzie";
  ...
  public arpg_cgo_operazioni_agenzieBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_agenzie","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
