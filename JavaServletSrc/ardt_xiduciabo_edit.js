...
if ( ! (m_oFather.SaveContext_ardt_xiduciabo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xiduciabo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xiduciabo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xiduciabo();
}
}
SaveContext.child=[];
function BlankRow() {
