...
public class arpg_import_wu_erroriBL extends arpg_import_wu_erroriWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_wu_errori";
  ...
  public arpg_import_wu_erroriBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_wu_errori","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
