...
public class arpg_pers_rapporti_provBL extends arpg_pers_rapporti_provWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_pers_rapporti_prov";
  ...
  public arpg_pers_rapporti_provBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_pers_rapporti_prov","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
