...
public class arpg_allinea_operazmodBL extends arpg_allinea_operazmodWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_allinea_operazmod";
  ...
  public arpg_allinea_operazmodBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_operazmod","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
