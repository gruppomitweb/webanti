...
public class ardt_xlientifrzBL extends ardt_xlientifrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xlientifrz";
  ...
  public CPPhTableWrInfo m_oWrInfo_xlientifrz;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xlientifrz;
  ...
  public static String[] m_EntityTables = {"xlientifrz"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_xlientifrz",true,true)+"}"+FoundlingChildrenList("ardt_xlientifrz",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'PROQUOTA':PROQUOTA,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'CAP':CAP,'PROVINCIA':PROVINCIA"+FoundlingChildrenList("ardt_xlientifrz",true,true)+"}"+FoundlingChildrenList("ardt_xlientifrz",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG PROQUOTA"+FoundlingChildrenList("ardt_xlientifrz",false,true)+"]"+FoundlingChildrenList("ardt_xlientifrz",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_xlientifrz"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"PROQUOTA","Pro Quota","N","3","0","campo","nokey","true","false"}});
  ...
  public ardt_xlientifrzBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xlientifrz = p_ContextObject.GetPhName("xlientifrz",p_ContextObject.GetCompany(),false);
    m_cServer_xlientifrz = p_ContextObject.GetServer("xlientifrz");
    m_oWrInfo_xlientifrz = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xlientifrz",p_ContextObject.GetCompany());
    m_cVirtName_xlientifrz = CPSql.ManipulateTablePhName("xlientifrz",m_cServer_xlientifrz);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xlientifrz",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xlientifrz","xlientifrz",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xlientifrz",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xlientifrz",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xlientifrz",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xlientifrz",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xlientifrz"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xlientifrz\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xlientifrz"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xlientifrz"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
