...
SetLocationHref(null,'arrt_import_valutrans'+'?m_cAction=start&m_cAtExit=close&m_cMode=hyperlink','elaborazione')
}
...
function Help() {
windowOpenForeground('../doc/arpg_import_valutrans_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_import_valutrans',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["gIntemediario","gTipInter","gUrlApp","gAzienda","gFlgWU","xdesval","xragsoc"];
