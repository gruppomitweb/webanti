...
// * --- Fine Area Manuale
public class arrt_voidR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_voidR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_void",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    if ( ! (CPLib.IsNull(m_Info))) {
      m_Info.log(CPLib.FormatMsg(m_Ctx,"VOID"));
    }
  }
  void _init_() {
  }
  ...
  public static arrt_voidR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_voidR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
