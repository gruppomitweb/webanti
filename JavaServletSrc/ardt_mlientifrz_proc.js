...
m_oFather.i_last_focused_item='child_ardt_mlientifrz';
...
function Help() {
windowOpenForeground('../doc/ardt_mlientifrz_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'mlientifrz'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_mlientifrz',m_cSelectedPage);
