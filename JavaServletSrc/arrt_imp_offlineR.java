...
// * --- Fine Area Manuale
public class arrt_imp_offlineR implements CallerWithObjs {
  ...
  public MemoryCursor_mctesto_mcrdef mcOperazioni;
  public MemoryCursor_mctesto_mcrdef mcInformazioni;
  public MemoryCursor_mctesto_mcrdef mcTitolari;
  public String _opepost;
  public String _infpost;
  public String _titpost;
  public String xTitolare;
  public String cInfTit;
  public String _fileinput;
  public String charset;
  public String xATECO;
  public MemoryCursor_tipo6 mcTipo6;
  public String _tipo6b;
  public java.sql.Date xDatReg;
  ...
  // * --- Fine Area Manuale
  public arrt_imp_offlineR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_imp_offline",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("_opepost",p_cVarName)) {
      return _opepost;
    }
    if (CPLib.eqr("_infpost",p_cVarName)) {
      return _infpost;
    }
    if (CPLib.eqr("_titpost",p_cVarName)) {
      return _titpost;
    }
    ...
    if (CPLib.eqr("xATECO",p_cVarName)) {
      return xATECO;
    }
    if (CPLib.eqr("_tipo6b",p_cVarName)) {
      return _tipo6b;
    }
  ...
  public java.sql.Date GetDate(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("xDatReg",p_cVarName)) {
      return xDatReg;
    }
  ...
  public CPMemoryCursor GetMemoryCursor(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("mcInformazioni",p_cVarName)) {
      return mcInformazioni;
    }
    if (CPLib.eqr("mcTitolari",p_cVarName)) {
      return mcTitolari;
    }
  ...
  public void SetMemoryCursor(String p_cVarName,String p_cType,int len,int dec,CPMemoryCursor value) {
    if (CPLib.eqr("mcOperazioni",p_cVarName)) {
      mcOperazioni = (MemoryCursor_mctesto_mcrdef)value;
      return;
    }
    if (CPLib.eqr("mcInformazioni",p_cVarName)) {
      mcInformazioni = (MemoryCursor_mctesto_mcrdef)value;
      return;
    }
    if (CPLib.eqr("mcTitolari",p_cVarName)) {
      mcTitolari = (MemoryCursor_mctesto_mcrdef)value;
      return;
    }
    if (CPLib.eqr("mcTipo6",p_cVarName)) {
  ...
  void Page_1() throws Exception {
    ...
    try {
      /* w_nomefile Char(100) // Nome file di import */
      /* w_tipodest Char(1) // Destinazione (Definitivo/Provvisorio) */
      /* w_azzera Char(1) // Azzera archivi esistenti */
      /* w_tipoimp Char(1) // Tipo Import */
      /* w_flgrae Char(1) // RAE o ATECO */
      ...
      /* _dataope Date */
      /* _prvnas Char(2) */
      /* mcOperazioni MemoryCursor(mcTesto.MCRDef) */
      /* mcInformazioni MemoryCursor(mcTesto.MCRDef) */
      /* mcTitolari MemoryCursor(mcTesto.MCRDef) */
      /* _opepost Char(1) */
      /* _infpost Char(1) */
      /* _titpost Char(1) */
      /* xTitolare Char(16) */
      ...
      /* _fileinput Char(0) */
      /* charset Char(0) */
      /* objCharset Object(CharsetMit) // ritorno del Charset */
      ...
      try {
        ...
        if (CPLib.eqr(w_azzera,"S")) {
          ...
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000066")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000067")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000068")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000069")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000006A")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000006B")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000006C")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000006D")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000006E")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000006F")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000070")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000071")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000072")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000073")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000074")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000075")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000076")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000077")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000078")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          if (CPLib.lt(m_nUpdatedRows,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000079")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
        ...
        /* gMsgProc := gMsgProc + 'Ora Inizio Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' + w_nomefile + NL */
        gMsgProc = gMsgProc+"Ora Inizio Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        ...
        /* _fileinput := LRTrim(gPathApp)+'/appo/'+LRTrim(gAzienda)+"/"+LRTrim(fileelab) */
        _fileinput = CPLib.LRTrim(gPathApp)+"/appo/"+CPLib.LRTrim(gAzienda)+"/"+CPLib.LRTrim(fileelab);
        /* objCharset := new CharsetMit() // ritorno del Charset */
        objCharset = new CharsetMit();
        /* charset := objCharset.detectCharsetString(_fileinput) */
        charset = objCharset.detectCharsetString(_fileinput);
        /* fhand := FileLibrary.OpenRead('appo/'+LRTrim(gAzienda)+"/"+LRTrim(fileelab),charset) */
        fhand = FileLibrary.OpenRead("appo/"+CPLib.LRTrim(gAzienda)+"/"+CPLib.LRTrim(fileelab),charset);
        ...
        if (CPLib.eqr(w_tipoimp,"M") || CPLib.eqr(w_tipoimp,"R")) {
          ...
          while ( ! (FileLibrary.Eof(fhand))) {
            ...
            if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
              ...
              /* gMsgImp := 'Sono stati elaborati '+LRTrim(Str(conta,10,0))+' record del file '+w_nomefile // Messaggio Import */
              gMsgImp = "Sono stati elaborati "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" record del file "+w_nomefile;
          ...
          if (CPLib.eqr(w_tipoimp,"M")) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A1")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            ...
            while ( ! (Cursor_tmp_rapopebo_ol.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A3")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A4")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_rapopebo_ol.GetString("RAPPORTO"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_rapopebo_ol.GetString("RAPPORTO"))+"";
              m_cSql = m_cSql+m_oWrInfo.WhereFilter();
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A5")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_rapopebo_ol.GetString("RAPPORTO"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_rapopebo_ol.GetString("RAPPORTO"))+"";
              m_cSql = m_cSql+m_oWrInfo.WhereFilter();
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A6")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A7")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            while ( ! (Cursor_tmp_rapopebo_ol.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000A9")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000AA")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            while ( ! (Cursor_tmp_rapopebo_ol.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000AC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(Cursor_tmp_rapopebo_ol.GetDate("DATAOPE"),"D",8,0)+", ";
              m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(CPLib.NullDate(),"D",8,0)+", ";
              m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(Cursor_tmp_rapopebo_ol.GetString("NUMPROG"),"C",11,0,m_cServer)+", ";
              m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL("","C",11,0,m_cServer)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000AD")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_cPhName = m_Ctx.GetPhName("xnarapbo");
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xnarapbo",m_Ctx.GetCompany());
            m_nUpdatedRows=m_Sql.InsertIntoSQL(CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000AE"),m_cServer,m_oWrInfo,"* ","from "+m_cPhName_tmp_anarapbo+"","xnarapbo",m_Ctx,CPLib.HasTableCPCCCHK(m_Ctx,"xnarapbo"));
            if (CPLib.lt(m_nUpdatedRows,0)) {
              m_Sql.AbortTransaction();
            }
            m_Sql.CompleteTransaction();
            ...
            m_cPhName = m_Ctx.GetPhName("xapopebo");
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapopebo",m_Ctx.GetCompany());
            m_nUpdatedRows=m_Sql.InsertIntoSQL(CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000AF"),m_cServer,m_oWrInfo,"* ","from "+m_cPhName_tmp_rapopebo_ol+"","xapopebo",m_Ctx,CPLib.HasTableCPCCCHK(m_Ctx,"xapopebo"));
            if (CPLib.lt(m_nUpdatedRows,0)) {
              m_Sql.AbortTransaction();
            }
            m_Sql.CompleteTransaction();
            ...
            m_cPhName = m_Ctx.GetPhName("xntestbo");
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
            m_nUpdatedRows=m_Sql.InsertIntoSQL(CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000B0"),m_cServer,m_oWrInfo,"* ","from "+m_cPhName_tmp_intestbo_ol+"","xntestbo",m_Ctx,CPLib.HasTableCPCCCHK(m_Ctx,"xntestbo"));
            if (CPLib.lt(m_nUpdatedRows,0)) {
              m_Sql.AbortTransaction();
            }
            m_Sql.CompleteTransaction();
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000B1")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"TIPOOPRAP = "+CPSql.SQLValueAdapter(CPLib.ToSQL("36","?",0,0,m_cServer),m_cServer,"36")+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000B2")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"TIPOOPRAP = "+CPSql.SQLValueAdapter(CPLib.ToSQL("46","?",0,0,m_cServer),m_cServer,"46")+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            ...
            while ( ! (Cursor_tmp_operazbo_ol.Eof())) {
              ...
              if (CPLib.eqr(w_tipodest,"P")) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000B5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000000B6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
              ...
              if (CPLib.eqr(xTipo,"1")) {
                ...
                if (CPLib.ne(w_soloanag,"S")) {
                  ...
                  /* Case xOpe='1' and False */
                  if (CPLib.eqr(xOpe,"1") && false) {
                ...
                /* If _opepost='N' or _infpost='N' or _titpost='N' */
                if (CPLib.eqr(_opepost,"N") || CPLib.eqr(_infpost,"N") || CPLib.eqr(_titpost,"N")) {
                  /* Case xOpe='1' and False */
                  if (CPLib.eqr(xOpe,"1") && false) {
                    /* If xTipo='5' */
                    if (CPLib.eqr(xTipo,"5")) {
                  ...
                  /* If _opepost='S' */
                  if (CPLib.eqr(_opepost,"S")) {
                    /* mcOperazioni.AppendBlank() */
                    mcOperazioni.AppendBlank();
                    /* mcOperazioni.testo := riga */
                    mcOperazioni.row.testo = riga;
                    /* mcOperazioni.SaveRow() */
                    mcOperazioni.SaveRow();
                  } // End If
                  /* If _infpost='S' */
                  if (CPLib.eqr(_infpost,"S")) {
                    /* mcInformazioni.AppendBlank() */
                    mcInformazioni.AppendBlank();
                    /* mcInformazioni.testo := riga */
                    mcInformazioni.row.testo = riga;
                    /* mcInformazioni.SaveRow() */
                    mcInformazioni.SaveRow();
                  } // End If
                  /* If _titpost='S' */
                  if (CPLib.eqr(_titpost,"S")) {
                    /* mcTitolari.AppendBlank() */
                    mcTitolari.AppendBlank();
                    /* mcTitolari.testo := riga */
                    mcTitolari.row.testo = riga;
                    /* mcTitolari.SaveRow() */
                    mcTitolari.SaveRow();
                  } // End If
                } // End If
          ...
          if (CPLib.gt(mcOperazioni.RecCount(),0)) {
            for (MemoryCursorRow_mctesto_mcrdef rwOperazioni : mcOperazioni._iterable_()) {
              /* riga := rwOperazioni.testo */
              riga = rwOperazioni.testo;
              /* xTipo := Substr(riga,14,1) */
              xTipo = CPLib.Substr(riga,14,1);
              /* If xTipo='1' */
          ...
          /* If mcInformazioni.RecCount() > 0 */
          if (CPLib.gt(mcInformazioni.RecCount(),0)) {
            for (MemoryCursorRow_mctesto_mcrdef rwInformazioni : mcInformazioni._iterable_()) {
              /* riga := rwInformazioni.testo */
              riga = rwInformazioni.testo;
              /* xTipo := Substr(riga,14,1) */
              xTipo = CPLib.Substr(riga,14,1);
              /* If xTipo='1' */
          ...
          /* If mcTitolari.RecCount() > 0 */
          if (CPLib.gt(mcTitolari.RecCount(),0)) {
            for (MemoryCursorRow_mctesto_mcrdef rwTitolari : mcTitolari._iterable_()) {
              /* riga := rwTitolari.testo */
              riga = rwTitolari.testo;
              /* xTipo := Substr(riga,14,1) */
              xTipo = CPLib.Substr(riga,14,1);
              /* If xTipo='1' */
        ...
        /* Messaggi finali */
        /* gMsgProc := gMsgProc + 'Soggetti Inseriti/Aggiornati: '+LRTrim(Str(cNumPer,10,0)) + ' dal file '+w_nomefile+NL */
        gMsgProc = gMsgProc+"Soggetti Inseriti/Aggiornati: "+CPLib.LRTrim(CPLib.Str(cNumPer,10,0))+" dal file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgProc := gMsgProc + 'Rapporti Inseriti: '+LRTrim(Str(cNumRap,10,0)) + ' dal file '+w_nomefile+NL */
        gMsgProc = gMsgProc+"Rapporti Inseriti: "+CPLib.LRTrim(CPLib.Str(cNumRap,10,0))+" dal file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgProc := gMsgProc + 'Informazioni Inserite: '+LRTrim(Str(cNumInf,10,0)) + ' dal file '+w_nomefile+NL */
        gMsgProc = gMsgProc+"Informazioni Inserite: "+CPLib.LRTrim(CPLib.Str(cNumInf,10,0))+" dal file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgProc := gMsgProc + 'Operazioni Inserite: '+LRTrim(Str(cNumOpe,10,0)) + ' dal file '+w_nomefile+NL */
        gMsgProc = gMsgProc+"Operazioni Inserite: "+CPLib.LRTrim(CPLib.Str(cNumOpe,10,0))+" dal file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgProc := gMsgProc + 'Titolari Inseriti: '+LRTrim(Str(cNumTit,10,0)) + ' dal file '+w_nomefile+NL */
        gMsgProc = gMsgProc+"Titolari Inseriti: "+CPLib.LRTrim(CPLib.Str(cNumTit,10,0))+" dal file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgProc := gMsgProc + 'Ora Fine Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' +w_nomefile + NL */
        gMsgProc = gMsgProc+"Ora Fine Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+w_nomefile+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      ...
      FileLibrary.Close(fhand);
      /* FileLibrary.DeleteFile('appo/'+LRTrim(gAzienda)+"/"+w_nomefile) */
      FileLibrary.DeleteFile("appo/"+CPLib.LRTrim(gAzienda)+"/"+w_nomefile);
    } finally {
      try {
        if (Cursor_tmp_rapopebo_ol!=null)
          Cursor_tmp_rapopebo_ol.Close();
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on anadip into routine arrt_imp_offline returns two or more records. This item should return only a record.");
          ...
          if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000011E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000011F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on tbcauana into routine arrt_imp_offline returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000121")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.lt(m_nUpdatedRows,1)) {
          // No rows inserted
          /* gMsgProc := gMsgProc +"Rilevati errori nel file "+w_nomefile+" per l'operazione in data "+Substr(riga,79,8)+" con importo "+Str((Val(Substr(riga,282,15)))/100,14,2)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
          gMsgProc = gMsgProc+"Rilevati errori nel file "+w_nomefile+" per l'operazione in data "+CPLib.Substr(riga,79,8)+" con importo "+CPLib.Str((CPLib.Val(CPLib.Substr(riga,282,15)))/100,14,2)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
          m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        ...
        /* If Substr(riga,248,1)='0' or (At(Substr(riga,248,1),'|3|2') >0 and LRTrim(Substr(riga,257,20))='') */
        if (CPLib.eqr(CPLib.Substr(riga,248,1),"0") || (CPLib.gt(CPLib.At(CPLib.Substr(riga,248,1),"|3|2"),0) && CPLib.eqr(CPLib.LRTrim(CPLib.Substr(riga,257,20)),""))) {
          ...
          m_cPhName = m_Ctx.GetPhName("operazbo");
          m_cSql = "";
          m_cSql = m_cSql+"IDEREG="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Substr(riga,257,20),"C",20,0,m_cServer),m_cServer,CPLib.Substr(riga,257,20));
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on operazbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
        ...
        /* If not(Empty(cOpeProg2)) */
        if ( ! (CPLib.Empty(cOpeProg2))) {
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000133")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000134")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"DESCCIT = "+CPLib.ToSQL(CPLib.Substr(riga,47,30),"C",60,0,m_cServer)+", ";
              m_cSql = m_cSql+"CAB = "+CPLib.ToSQL(CPLib.Substr(riga,41,6),"C",6,0,m_cServer)+", ";
              m_cSql = m_cSql+"PROVINCIA = "+CPLib.ToSQL(CPLib.Substr(riga,77,2),"C",2,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"anadip",false,true);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000135")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000014C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on xnarapbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xAppRap))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xnarapbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000153")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on knarapbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xRapportox))) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000157")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapopebo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000158")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.lt(m_nUpdatedRows,1)) {
          // No rows inserted
          /* gMsgProc := gMsgProc +"Rilevati errori nel file "+w_nomefile+" per l'informazione in data "+Substr(riga,79,8)+" relativa al rapporto: "+xRapporto+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
          gMsgProc = gMsgProc+"Rilevati errori nel file "+w_nomefile+" per l'informazione in data "+CPLib.Substr(riga,79,8)+" relativa al rapporto: "+xRapporto+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
          m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
          // Azzera messaggio errore
          m_cLastMsgError = "";
        } else if (CPLib.ne(m_cLastMsgError,"")) {
        ...
        if (CPLib.eqr(xTipoInf,"A") || CPLib.eqr(xTipoInf,"C")) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on xntestbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
            ...
            Cursor_xntestbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select CPROWNUM  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xRapporto),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.LRTrim(xRapporto))+" "+")"+(m_Ctx.IsSharedTemp("xntestbo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+"CPROWNUM ",m_cServer,m_Ctx,true));
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000166")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000166(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            ...
            if (CPLib.lt(m_nUpdatedRows,1)) {
              // No rows inserted
              /* gMsgProc := gMsgProc +"Rilevati errori nel file "+w_nomefile+" per la registrazione dell'intestatario dell'informazione in data "+Substr(riga,79,8)+" relativa al rapporto: "+ xRapporto +" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
              gMsgProc = gMsgProc+"Rilevati errori nel file "+w_nomefile+" per la registrazione dell'intestatario dell'informazione in data "+CPLib.Substr(riga,79,8)+" relativa al rapporto: "+xRapporto+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
              m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
              // Azzera messaggio errore
              m_cLastMsgError = "";
            } else if (CPLib.ne(m_cLastMsgError,"")) {
          ...
          if (CPLib.eqr(xTipoInf,"A")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000016A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000016B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        if (CPLib.ne(xTipoInf,"X")) {
          ...
          if (CPLib.eqr(CPLib.Substr(riga,248,1),"0") || (CPLib.gt(CPLib.At(CPLib.Substr(riga,248,1),"|3|2"),0) && CPLib.eqr(CPLib.LRTrim(CPLib.Substr(riga,257,20)),""))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on rapopebo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
          ...
          /* If not(Empty(cInfProg2)) */
          if ( ! (CPLib.Empty(cInfProg2))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000017F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on anarapbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xAppRap))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anarapbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000186")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.Empty(CPLib.LRTrim(xRapportox))) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"knarapbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000018A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapopebo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000018B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.ne(cDelega,"S")) {
              ...
              if (CPLib.eqr(xTipoInf,"A") || CPLib.eqr(xTipoInf,"C")) {
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on intestbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
                ...
                if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000198")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_00000198(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(xMaxRow+1,"?",0,0)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
                ...
                if (CPLib.eqr(xTipoInf,"A")) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000019C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"TIPOPERS = "+CPLib.ToSQL("P","C",1,0,m_cServer)+", ";
                  m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,79,8)),"D",8,0)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000019D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,79,8)),"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfProg2,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestbo",false,true);
                  m_cSql = m_cSql+" where ";
  ...
  void Page_4() throws Exception {
    ...
    try {
      ...
      /* xConnes := LRTrim(Substr(riga,35,16)) */
      xConnes = CPLib.LRTrim(CPLib.Substr(riga,35,16));
      ...
      if (CPLib.Empty(CPLib.LRTrim(xCF)) && CPLib.Empty(CPLib.LRTrim(xConnes))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on personbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
      ...
      if ( ! (CPLib.Empty(xCF))) {
        ...
        if (CPLib.eqr(CPLib.Substr(xCF,12,1),"Z") && CPLib.eqr(CPLib.Len(CPLib.LRTrim(xCF)),16)) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_imp_offline returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
      ...
      if (CPLib.eqr(w_flgrae,"R")) {
        ...
        /* xRam := '' */
        xRam = "";
        /* xATECO := iif(Substr(riga,259,3)='000','',Substr(riga,259,3)) */
        xATECO = (CPLib.eqr(CPLib.Substr(riga,259,3),"000")?"":CPLib.Substr(riga,259,3));
      } // End If
      ...
      if (CPLib.eqr(xNewSog,"S")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001D1")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_000001D1(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xConnes),"?",0,0,m_cServer)+", ";
        ...
        m_cSql = m_cSql+""+CPLib.ToSQL(xATECO,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+m_oWrInfo.InsertValues();
        ...
        if (CPLib.Empty(CPLib.LRTrim(cProgSto))) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001D8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001D9")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        m_cSql = m_cSql+"ATTIV = "+CPLib.ToSQL(xATECO,"C",10,0,m_cServer)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"personbo",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"CONNES = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xConnes),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(xConnes))+"";
        m_cSql = m_cSql+m_oWrInfo.WhereFilter();
        m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        if (CPLib.lt(m_nUpdatedRows,0)) {
          m_Sql.AbortTransaction();
      ...
      if (CPLib.ne(w_soloanag,"S")) {
        ...
        if (CPLib.eqr(xTipo,"2") || CPLib.eqr(xTipo,"3") || CPLib.eqr(xTipo,"7")) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001DD")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001DE")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001E0")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001E1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESOPER = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
          ...
          if (CPLib.Empty(CPLib.LRTrim(xConnes)) && CPLib.Empty(CPLib.LRTrim(cConnes))) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001E4")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001E5")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Substr(riga,130,30),"C",30,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001E7")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001E8")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Substr(riga,130,30),"C",30,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001EA")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000001EB")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNALTRO = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
  ...
  void Page_5() throws Exception {
    ...
    try {
      ...
      m_cPhName = m_Ctx.GetPhName("personbo");
      m_cSql = "";
      m_cSql = m_cSql+"CONNES="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xConnes),"C",16,0,m_cServer),m_cServer,CPLib.LRTrim(xConnes));
      if (m_Ctx.IsSharedTemp("personbo")) {
        m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (Read_Cursor!=null)
      ...
      if (CPLib.Empty(CPLib.LRTrim(cConnes))) {
        /* xNewSog := 'S' */
        xNewSog = "S";
        /* cConnes := LRTrim(Substr(riga,35,16)) */
        cConnes = CPLib.LRTrim(CPLib.Substr(riga,35,16));
      } // End If
      /* xCF := Substr(riga,202,16) */
      xCF = CPLib.Substr(riga,202,16);
      ...
      if (CPLib.eqr(xNewSog,"S")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000020E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.Empty(CPLib.LRTrim(cProgSto))) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000215")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000216")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(xCF,"C",16,0,m_cServer)+", ";
        m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
        m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
        m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
      ...
      if (CPLib.ne(w_soloanag,"S")) {
        ...
        if (CPLib.eqr(xTipo,"2") || CPLib.eqr(xTipo,"3") || CPLib.eqr(xTipo,"7")) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            SPBridge.HMCaller _h0000021B;
            _h0000021B = new SPBridge.HMCaller();
            _h0000021B.Set("m_cVQRList",m_cVQRList);
            _h0000021B.Set("xRapporto",xRapporto);
            if (Cursor_qbe_offline_max_int!=null)
              Cursor_qbe_offline_max_int.Close();
            Cursor_qbe_offline_max_int = new VQRHolder("qbe_offline_max_int",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000021B,true).GetResultSet(m_Ctx);
            ...
            if (CPLib.gt(cMaxRow,0)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000021E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xnarapbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000021F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              if (CPLib.Empty(CPLib.LRTrim(xIDBx))) {
                ...
                if (Cursor_xntestbo!=null)
                  Cursor_xntestbo.Close();
                Cursor_xntestbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xRapporto),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.LRTrim(xRapporto))+"  and  CPROWNUM=1 "+")"+(m_Ctx.IsSharedTemp("xntestbo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
                while ( ! (Cursor_xntestbo.Eof())) {
                  // * --- Insert into xntestbo from values
                  m_Sql.RequireTransaction();
                  m_cServer = m_Ctx.GetServer("xntestbo");
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000227")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            _h00000229.Set("xRapporto",xRapporto);
            if (Cursor_qbe_offline_max_int_d!=null)
              Cursor_qbe_offline_max_int_d.Close();
            Cursor_qbe_offline_max_int_d = new VQRHolder("qbe_offline_max_int_d",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000229,true).GetResultSet(m_Ctx);
            ...
            if (CPLib.gt(cMaxRow,0)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000022C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anarapbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000022D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"DESCRAP = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(cRagSoc),50),"C",50,0,m_cServer)+", ";
              ...
              if (CPLib.Empty(CPLib.LRTrim(xIDBx))) {
                ...
                if (Cursor_intestbo!=null)
                  Cursor_intestbo.Close();
                Cursor_intestbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xRapporto),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.LRTrim(xRapporto))+"  and  CPROWNUM=1 "+")"+(m_Ctx.IsSharedTemp("intestbo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
                while ( ! (Cursor_intestbo.Eof())) {
                  // * --- Insert into intestbo from values
                  m_Sql.RequireTransaction();
                  m_cServer = m_Ctx.GetServer("intestbo");
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000235")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(Cursor_intestbo.GetString("RAPPORTO")),"?",0,0,m_cServer)+", ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"knarapbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000236")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"DESCRAP = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(cRagSoc),50),"C",50,0,m_cServer)+", ";
          ...
          /* Case xTipo='4' or xTipo='5' or xTipo='8' */
        } else if (CPLib.eqr(xTipo,"4") || CPLib.eqr(xTipo,"5") || CPLib.eqr(xTipo,"8")) {
          /* If w_tipodest='P' */
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapopebo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000238")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            if (CPLib.eqr(cDelega,"S")) {
              ...
              Cursor_xelegabo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select CPROWNUM  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xRapporto),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.LRTrim(xRapporto))+"  and  CODINTER="+CPSql.SQLValueAdapter(CPLib.ToSQL(cConnes,"?",0,0,m_cServer, m_oParameters),m_cServer,cConnes)+" "+")"+(m_Ctx.IsSharedTemp("xelegabo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
              ...
              if (CPLib.eqr(cMaxRow,0)) {
                ...
                Cursor_delegabo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select "+CPLib.ToSQL(Cursor_xelegabo.GetDouble("CPROWNUM"),"?",0,0)+"  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+""+CPLib.ToSQL(Cursor_xelegabo.GetString("RAPPORTO"),"?",0,0)+"="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xRapporto),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.LRTrim(xRapporto))+" "+")"+(m_Ctx.IsSharedTemp("delegabo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+""+CPLib.ToSQL(Cursor_xelegabo.GetDouble("CPROWNUM"),"?",0,0)+" ",m_cServer,m_Ctx,true));
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xelegabo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000241")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.eqr(xTipoInf,"A")) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xelegabo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000243")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xelegabo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000244")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapopebo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000245")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            if (CPLib.eqr(cDelega,"S")) {
              ...
              if (Cursor_delegabo!=null)
                Cursor_delegabo.Close();
              Cursor_delegabo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select CPROWNUM  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xRapporto),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.LRTrim(xRapporto))+"  and  CODINTER="+CPSql.SQLValueAdapter(CPLib.ToSQL(cConnes,"?",0,0,m_cServer, m_oParameters),m_cServer,cConnes)+" "+")"+(m_Ctx.IsSharedTemp("delegabo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+"CPROWNUM ",m_cServer,m_Ctx,true));
              while ( ! (Cursor_delegabo.Eof())) {
              ...
              if (CPLib.eqr(cMaxRow,0)) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"delegabo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000024E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.eqr(xTipoInf,"A")) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"delegabo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000250")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfProg2,"C",11,0,m_cServer)+", ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"delegabo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000251")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfProg2,"C",11,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"delegabo",false,true);
                m_cSql = m_cSql+" where ";
          ...
          /* If w_tipodest='P' */
          if (CPLib.eqr(w_tipodest,"P")) {
            // * --- Merge into xiduciabo from values
            m_Sql.RequireTransaction();
            ...
            m_cQuery = "select ";
            m_cQuery =  m_cQuery+""+CPLib.ToSQL(xRapporto,"?",0,0)+" as RAPCOL";
            m_cQuery =  m_cQuery+", "+CPLib.ToSQL(cConnes,"?",0,0)+" as CODSOG";
            if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle)) {
              m_cQuery = m_cQuery+" from dual";
            }
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cWhere = "xiduciabo.RAPCOL = cptmp_1xab23.RAPCOL";
            m_cWhere = m_cWhere+" and "+"xiduciabo.CODSOG = cptmp_1xab23.CODSOG";
            ...
            if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000253")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" xiduciabo USING ";
              m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
              m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
              m_cSql = m_cSql+"CODSOG = "+CPLib.ToSQL(cConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"RAPCOL = "+CPLib.ToSQL(xRapporto,"C",25,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xiduciabo",true,true);
              ...
              m_cSql = m_cSql+""+CPLib.ToSQL(xRapporto,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+m_oWrInfo.InsertValues();
              m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"xiduciabo",true);
              m_cSql = m_cSql+")";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000253")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CODSOG = "+CPLib.ToSQL(cConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"RAPCOL = "+CPLib.ToSQL(xRapporto,"C",25,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xiduciabo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"RAPCOL = "+CPSql.SQLValueAdapter(CPLib.ToSQL(xRapporto,"?",0,0,m_cServer),m_cServer,xRapporto)+"";
              m_cSql = m_cSql+" and CODSOG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cConnes,"?",0,0,m_cServer),m_cServer,cConnes)+"";
              m_cSql = m_cSql+m_oWrInfo.WhereFilter();
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
              if (CPLib.eqr(m_nUpdatedRows,0)) {
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000253")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000253(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cWhere = "fiduciabo.RAPCOL = cptmp_1xab23.RAPCOL";
            m_cWhere = m_cWhere+" and "+"fiduciabo.CODSOG = cptmp_1xab23.CODSOG";
            m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
            if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000254")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" fiduciabo USING ";
              m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
              m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
              m_cSql = m_cSql+"CODSOG = "+CPLib.ToSQL(cConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"RAPCOL = "+CPLib.ToSQL(xRapporto,"C",25,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000254")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CODSOG = "+CPLib.ToSQL(cConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"RAPCOL = "+CPLib.ToSQL(xRapporto,"C",25,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(m_nUpdatedRows,0)) {
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000254")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000254(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(xTipoInf,"P")) {
        ...
        while ( ! (Cursor_personbo.Eof())) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000259")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(xTipoInf,"D")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000026C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(xCF,"C",16,0,m_cServer)+", ";
        m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
        m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
        m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
  ...
  void Page_6() throws Exception {
    ...
    /* Case At(Substr(riga,234,2),'|26|28|36|38|46|51|53') > 0 */
    if (CPLib.gt(CPLib.At(CPLib.Substr(riga,234,2),"|26|28|36|38|46|51|53"),0)) {
      /* xTipoInf := 'C' */
      xTipoInf = "C";
      /* Case At(Substr(riga,234,2),'|21|22|23|25|33|34|35|37|43|44|45|50|52|58') > 0 */
    } else if (CPLib.gt(CPLib.At(CPLib.Substr(riga,234,2),"|21|22|23|25|33|34|35|37|43|44|45|50|52|58"),0)) {
      /* xTipoInf := 'A' */
      xTipoInf = "A";
      /* Case At(Substr(riga,234,2),'|31|54') > 0 */
    } else if (CPLib.gt(CPLib.At(CPLib.Substr(riga,234,2),"|31|54"),0)) {
      /* xTipoInf := 'P' */
      xTipoInf = "P";
      /* Case At(Substr(riga,234,2),'|32|55') > 0 */
    } else if (CPLib.gt(CPLib.At(CPLib.Substr(riga,234,2),"|32|55"),0)) {
      /* xTipoInf := 'D' */
      xTipoInf = "D";
    } else { // Otherwise
      /* xTipoInf := 'X' */
    ...
    try {
      ...
      if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000281")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_00000281(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(xDIP,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(xDIP,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+m_oWrInfo.InsertValues();
      ...
      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_operazbo_ol",m_Ctx.GetCompany());
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000283")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
    ...
    try {
      ...
      if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000294")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000295")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      m_cSql = m_cSql+GetFieldsName_00000295(m_Ctx,m_oWrInfo);
      m_cSql = m_cSql+") values (";
      m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
      m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,79,8)),"?",0,0)+", ";
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on tmp_anarapbo into routine arrt_imp_offline returns two or more records. This item should return only a record.");
          CPStdCounter.Error(l_oErrorFault);
        }
        Read_Cursor.Close();
      } else {
      ...
      if (CPLib.Empty(CPLib.LRTrim(xAppRap))) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_anarapbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000029E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(xTipoInf,"A") || CPLib.eqr(xTipoInf,"C")) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on tmp_intestbo_ol into routine arrt_imp_offline returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002A7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(xTipoInf,"A")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002AB")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"TIPOPERS = "+CPLib.ToSQL("P","C",1,0,m_cServer)+", ";
          m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,79,8)),"D",8,0)+", ";
          m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_intestbo_ol",false,true);
          m_cSql = m_cSql+" where ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002AC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,79,8)),"D",8,0)+", ";
          m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfProg2,"C",11,0,m_cServer)+", ";
          m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_intestbo_ol",false,true);
          m_cSql = m_cSql+" where ";
  ...
  void Page_9() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(xNewSog,"S")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002CF")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(xTipo,"2") || CPLib.eqr(xTipo,"3")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_operazbo_ol",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002D1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_operazbo_ol",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002D2")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CONNESOPER = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_operazbo_ol",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_operazbo_ol",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002D3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_operazbo_ol",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
  ...
  void Page_10() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(xNewSog,"S")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002F7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_000002F7(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(xConnes,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xCF,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,51,70),"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(xTipo,"2") || CPLib.eqr(xTipo,"3")) {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xIDBx))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002FE")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_anarapbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000002FF")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"DESCRAP = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(cRagSoc),50),"C",50,0,m_cServer)+", ";
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDBx))) {
            ...
            while ( ! (Cursor_tmp_intestbo_ol.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_intestbo_ol",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000307")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapopebo_ol",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000308")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CONNESOPER = "+CPLib.ToSQL(cConnes,"C",16,0,m_cServer)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_rapopebo_ol",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer),m_cServer,cInfProg1)+"";
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000031D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapotit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000031E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_0000031E(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,79,8)),"?",0,0)+", ";
        ...
        if (CPLib.ne(xTipoInf,"X")) {
          ...
          if (CPLib.eqr(CPLib.Substr(riga,248,1),"0") || (CPLib.gt(CPLib.At(CPLib.Substr(riga,248,1),"|3|2"),0) && CPLib.eqr(CPLib.LRTrim(CPLib.Substr(riga,257,20)),""))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on rapotit into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
          ...
          if ( ! (CPLib.Empty(cInfProg2))) {
            ...
            /* xDatOpe := CharToDate(Substr(riga,79,8)) */
            xDatOpe = CPLib.CharToDate(CPLib.Substr(riga,79,8));
            /* xDatReg := CharToDate(Substr(riga,226,8)) */
            xDatReg = CPLib.CharToDate(CPLib.Substr(riga,226,8));
            /* streg := iif(Substr(riga,248,1)='2','2',iif(Substr(riga,248,1)='0','S','A')) */
            streg = (CPLib.eqr(CPLib.Substr(riga,248,1),"2")?"2":(CPLib.eqr(CPLib.Substr(riga,248,1),"0")?"S":"A"));
            /* cIdCau := '' */
            cIdCau = "";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(xDIP)))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000336")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000336(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(xDIP,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(xDIP,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+m_oWrInfo.InsertValues();
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapotit",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000337")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_12() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(xNewSog,"S")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000360")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.Empty(CPLib.LRTrim(cProgSto))) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000367")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000367(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(cProgSto,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(xConnes,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"?",0,0,m_cServer)+", ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000368")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(xCF,"C",16,0,m_cServer)+", ";
        m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
        m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
        m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
      ...
      if (CPLib.ne(w_soloanag,"S")) {
        /* Case xTipo='7' */
        if (CPLib.eqr(xTipo,"7")) {
          /* xTitolare := LRTrim(cConnes) */
          xTitolare = CPLib.LRTrim(cConnes);
          /* If w_tipodest='P' */
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapotit",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000036D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(cConnes,"C",16,0,m_cServer)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapotit",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000036E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(CPLib.LRTrim(cConnes),"C",16,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(_tipo6b,"S")) {
            for (MemoryCursorRow_tipo6 rwTipo6 : mcTipo6._iterable_()) {
              ...
              if (CPLib.eqr(w_tipodest,"P")) {
                ...
                if (m_Ctx.IsSharedTemp("xntestit")) {
                  m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                }
                if (Read_Cursor!=null)
                  Read_Cursor.Close();
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on xntestit into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
                ...
                /* If xTipoInf='A' */
                if (CPLib.eqr(xTipoInf,"A")) {
                  // * --- Merge into xntestit from values
                  m_Sql.RequireTransaction();
                  m_cServer = m_Ctx.GetServer("xntestit");
                  m_cPhName = m_Ctx.GetPhName("xntestit");
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cWhere = "xntestit.CODCLI = cptmp_1xab23.CODCLI";
                  m_cWhere = m_cWhere+" and "+"xntestit.CODINTER = cptmp_1xab23.CODINTER";
                  m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                  if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000376")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" xntestit USING ";
                    m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                    m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                    m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xntestit",true,true);
                    m_cSql = m_cSql+" WHEN NOT MATCHED THEN INSERT (";
                    ...
                    m_cSql = m_cSql+""+CPLib.ToSQL(xDatOpe,"?",0,0)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cInfTit,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL("0","?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp2,"?",0,0)+", ";
                    m_cSql = m_cSql+m_oWrInfo.InsertValues();
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000376")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                    ...
                    if (CPLib.eqr(m_nUpdatedRows,0)) {
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000376")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      m_cSql = m_cSql+GetFieldsName_00000376(m_Ctx,m_oWrInfo);
                      m_cSql = m_cSql+") values (";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                      m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                  ...
                  m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                  if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000377")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" xntestit USING ";
                    m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                    m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                    m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xntestit",true,true);
                    m_cSql = m_cSql+" WHEN NOT MATCHED THEN INSERT (";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000377")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xntestit",false,true);
                    ...
                    if (CPLib.eqr(m_nUpdatedRows,0)) {
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000377")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      m_cSql = m_cSql+GetFieldsName_00000377(m_Ctx,m_oWrInfo);
                      m_cSql = m_cSql+") values (";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(rwTipo6.C41),"?",0,0,m_cServer)+", ";
                      m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on intestit into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
                ...
                if (CPLib.eqr(xTipoInf,"A")) {
                  ...
                  m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                  if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000037C")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" intestit USING ";
                    m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                    m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                    m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000037C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                    ...
                    if (CPLib.eqr(m_nUpdatedRows,0)) {
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000037C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      m_cSql = m_cSql+GetFieldsName_0000037C(m_Ctx,m_oWrInfo);
                      m_cSql = m_cSql+") values (";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(rwTipo6.C41),"?",0,0,m_cServer)+", ";
                  ...
                  m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                  if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000037D")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" intestit USING ";
                    m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                    m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                    m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    ...
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",true,true);
                    m_cSql = m_cSql+" WHEN NOT MATCHED THEN INSERT (";
                    m_cSql = m_cSql+GetFieldsName_0000037D(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(rwTipo6.C41),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000037D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                    m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",false,true);
                    ...
                    if (CPLib.eqr(m_nUpdatedRows,0)) {
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000037D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      m_cSql = m_cSql+GetFieldsName_0000037D(m_Ctx,m_oWrInfo);
                      m_cSql = m_cSql+") values (";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(rwTipo6.C41),"?",0,0,m_cServer)+", ";
          ...
          /* If Empty(xTitolare) */
          if (CPLib.Empty(xTitolare)) {
            /* _tipo6b := 'S' */
            _tipo6b = "S";
            /* mcTipo6.AppendBlank() */
            mcTipo6.AppendBlank();
            /* mcTipo6.A01A := Substr(riga,1,2) */
            mcTipo6.row.A01A = CPLib.Substr(riga,1,2);
            /* mcTipo6.A01B := Substr(riga,3,11) */
            mcTipo6.row.A01B = CPLib.Substr(riga,3,11);
            /* mcTipo6.A02 := Substr(riga,14,1) */
            mcTipo6.row.A02 = CPLib.Substr(riga,14,1);
            /* mcTipo6.A03 := Substr(riga,15,20) */
            mcTipo6.row.A03 = CPLib.Substr(riga,15,20);
            /* mcTipo6.C41 := Substr(riga,35,16) */
            mcTipo6.row.C41 = CPLib.Substr(riga,35,16);
            /* mcTipo6.G11 := Substr(riga,51,70) */
            mcTipo6.row.G11 = CPLib.Substr(riga,51,70);
            /* mcTipo6.G13 := Substr(riga,121,3) */
            mcTipo6.row.G13 = CPLib.Substr(riga,121,3);
            /* mcTipo6.G14A := Substr(riga,124,6) */
            mcTipo6.row.G14A = CPLib.Substr(riga,124,6);
            /* mcTipo6.G14B := Substr(riga,130,30) */
            mcTipo6.row.G14B = CPLib.Substr(riga,130,30);
            /* mcTipo6.G14C := Substr(riga,160,2) */
            mcTipo6.row.G14C = CPLib.Substr(riga,160,2);
            /* mcTipo6.G15 := Substr(riga,162,35) */
            mcTipo6.row.G15 = CPLib.Substr(riga,162,35);
            /* mcTipo6.G16 := Substr(riga,197,5) */
            mcTipo6.row.G16 = CPLib.Substr(riga,197,5);
            /* mcTipo6.G17 := Substr(riga,202,16) */
            mcTipo6.row.G17 = CPLib.Substr(riga,202,16);
            /* mcTipo6.G18 := CharToDate(Substr(riga,218,8)) */
            mcTipo6.row.G18 = CPLib.CharToDate(CPLib.Substr(riga,218,8));
            /* mcTipo6.G19 := Substr(riga,226,30) */
            mcTipo6.row.G19 = CPLib.Substr(riga,226,30);
            /* mcTipo6.G41 := Substr(riga,291,2) */
            mcTipo6.row.G41 = CPLib.Substr(riga,291,2);
            /* mcTipo6.G42 := Substr(riga,293,15) */
            mcTipo6.row.G42 = CPLib.Substr(riga,293,15);
            /* mcTipo6.G43 := CharToDate(Substr(riga,308,8)) */
            mcTipo6.row.G43 = CPLib.CharToDate(CPLib.Substr(riga,308,8));
            /* mcTipo6.G44 := Substr(riga,316,30) */
            mcTipo6.row.G44 = CPLib.Substr(riga,316,30);
            /* mcTipo6.G45 := Substr(riga,346,1) */
            mcTipo6.row.G45 = CPLib.Substr(riga,346,1);
            /* mcTipo6.SaveRow() */
            mcTipo6.SaveRow();
          } else { // Else
            /* If w_tipodest='P' */
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              if (Read_Cursor!=null)
                Read_Cursor.Close();
              Read_Cursor = m_Sql.Query(m_cServer,"select "+CPLib.GetMultilanguageField("IDBASE",m_Ctx,m_cServer)+","+CPLib.GetMultilanguageField("PRGIMPTITE",m_Ctx,m_cServer)+" from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+m_cSql);
              if ( ! (Read_Cursor.Eof())) {
                xIDBx = Read_Cursor.GetString("IDBASE");
                nProgImp2 = CPLib.Round(Read_Cursor.GetDouble("PRGIMPTITE"),0);
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on xntestit into routine arrt_imp_offline returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
              ...
              if (CPLib.eqr(xTipoInf,"A")) {
                ...
                m_cQuery = "select ";
                m_cQuery =  m_cQuery+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0)+" as CODCLI";
                m_cQuery =  m_cQuery+", "+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0)+" as CODINTER";
                if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle)) {
                  m_cQuery = m_cQuery+" from dual";
                }
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                ...
                m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000039B")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" xntestit USING ";
                  m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                  m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                  m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                  m_cSql = m_cSql+"PRGIMPTITE = "+CPLib.ToSQL(nProgImp2,"N",15,0)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xntestit",true,true);
                  m_cSql = m_cSql+" WHEN NOT MATCHED THEN INSERT (";
                  m_cSql = m_cSql+GetFieldsName_0000039B(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(xDatOpe,"?",0,0)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cInfTit,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("0","?",0,0,m_cServer)+", ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000039B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                  m_cSql = m_cSql+"PRGIMPTITE = "+CPLib.ToSQL(nProgImp2,"N",15,0)+", ";
                  ...
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"CODCLI = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(xTitolare))+"";
                  m_cSql = m_cSql+" and CODINTER = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(cConnes))+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                  if (CPLib.eqr(m_nUpdatedRows,0)) {
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000039B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_0000039B(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
                ...
                m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000039C")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" xntestit USING ";
                  m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                  m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                  m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000039C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xntestit",false,true);
                  ...
                  if (CPLib.eqr(m_nUpdatedRows,0)) {
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000039C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_0000039C(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = "";
              m_cSql = m_cSql+"CODCLI="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xTitolare),"C",16,0,m_cServer),m_cServer,CPLib.LRTrim(xTitolare));
              m_cSql = m_cSql+" and CODINTER="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(cConnes),"C",16,0,m_cServer),m_cServer,CPLib.LRTrim(cConnes));
              if (m_Ctx.IsSharedTemp("intestit")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
              if (Read_Cursor!=null)
              ...
              if (CPLib.eqr(xTipoInf,"A")) {
                ...
                m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A1")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" intestit USING ";
                  m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                  m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                  m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"DATAINI = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG1 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",false,true);
                  ...
                  if (CPLib.eqr(m_nUpdatedRows,0)) {
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A1")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000003A1(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
                ...
                m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
                if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A2")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" intestit USING ";
                  m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
                  m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
                  m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A2")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(xDatOpe,"D",8,0)+", ";
                  m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfTit,"C",11,0,m_cServer)+", ";
                  m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",false,true);
                  ...
                  if (CPLib.eqr(m_nUpdatedRows,0)) {
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000003A2(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(xTipoInf,"P")) {
        ...
        while ( ! (Cursor_personbo.Eof())) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003A7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("SOSPMAF"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("idcitta"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(xDatReg,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetDate("DATAVALI"),"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("NASSTATO"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("DOCFILE"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("NOME"),"?",0,0,m_cServer)+", ";
        ...
        Cursor_personbo.Close();
        // * --- End Select
        /* If xTipo='6' and not(Empty(xTitolare)) */
        if (CPLib.eqr(xTipo,"6") &&  ! (CPLib.Empty(xTitolare))) {
          // * --- Read from intestit
          m_cServer = m_Ctx.GetServer("intestit");
          m_cPhName = m_Ctx.GetPhName("intestit");
          m_cSql = "";
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDBx))) {
            ...
            m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
            if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003AC")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" intestit USING ";
              m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
              m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",true,true);
              m_cSql = m_cSql+" WHEN NOT MATCHED THEN INSERT (";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003AC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"CODCLI = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(xTitolare))+"";
              m_cSql = m_cSql+" and CODINTER = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(cConnes))+"";
              ...
              if (CPLib.eqr(m_nUpdatedRows,0)) {
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003AC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_000003AC(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(xTipoInf,"D")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003BF")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(xCF,"C",16,0,m_cServer)+", ";
        m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
        m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
        m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(xTipo,"6") &&  ! (CPLib.Empty(xTitolare))) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDBx))) {
            ...
            m_cWhere = m_cWhere+m_oWrInfo.WhereFilter(2);
            if (CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nOracle) || CPLib.eqr(m_Sql.GetDataBaseType(m_cServer),CPSql.m_nSQLServer)) {
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003C4")+"MERGE INTO "+m_oWrInfo.GetTableWriteName()+" intestit USING ";
              m_cSql = m_cSql+" ("+m_cQuery+") cptmp_1xab23 ON ("+m_cWhere+")";
              m_cSql = m_cSql+" WHEN MATCHED THEN UPDATE SET ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",true,true);
              m_cSql = m_cSql+" WHEN NOT MATCHED THEN INSERT (";
              m_cSql = m_cSql+GetFieldsName_000003C4(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003C4")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestit",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"CODCLI = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(xTitolare))+"";
              m_cSql = m_cSql+" and CODINTER = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer),m_cServer,CPLib.LRTrim(cConnes))+"";
              ...
              if (CPLib.eqr(m_nUpdatedRows,0)) {
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003C4")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_000003C4(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(xTitolare),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(cConnes),"?",0,0,m_cServer)+", ";
  ...
  void Page_13() throws Exception {
    ...
    m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
    /* gMsgImp := 'Inizio estrazione del file '+ LRTrim(w_nomefile) // Messaggio Import */
    gMsgImp = "Inizio estrazione del file "+CPLib.LRTrim(w_nomefile);
    m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
    /* cpercorsozip := LRTrim(gPathApp)+"/appo/"+LRTrim(gAzienda)+"/"+LRTrim(w_nomefile) */
    cpercorsozip = CPLib.LRTrim(gPathApp)+"/appo/"+CPLib.LRTrim(gAzienda)+"/"+CPLib.LRTrim(w_nomefile);
    ...
    /* fileelab := lista[0] */
    fileelab = lista[0];
    /* FileLibrary.DeleteFile('./appo/'+LRTrim(w_nomefile)) */
    FileLibrary.DeleteFile("./appo/"+CPLib.LRTrim(w_nomefile));
    /* gMsgImp := 'Fine estrazione del file '+ LRTrim(w_nomefile) // Messaggio Import */
    gMsgImp = "Fine estrazione del file "+CPLib.LRTrim(w_nomefile);
    m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
    ...
    try {
      ...
      if ( ! (CPLib.Empty(CPLib.LRTrim(xConnes)))) {
        ...
        if (CPLib.eqr(xNewSog,"S")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003F1")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000003F1(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(xConnes,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(xCF,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,51,70),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.Empty(CPLib.LRTrim(cProgSto))) {
            ...
            while ( ! (Cursor_personbo.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003F8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000003F8(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cProgSto,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xConnes,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"?",0,0,m_cServer)+", ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003F9")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(xCF,"C",16,0,m_cServer)+", ";
          m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
          m_cSql = m_cSql+"CODCAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
          m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
      ...
      if (CPLib.ne(w_soloanag,"S")) {
        ...
        if (CPLib.eqr(xTipo,"2") || CPLib.eqr(xTipo,"3") || CPLib.eqr(xTipo,"7")) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003FD")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"000003FE")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000400")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESOPER = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000401")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNESOPER = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
          ...
          if (CPLib.Empty(CPLib.LRTrim(xConnes))) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000404")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Substr(riga,130,30),"C",30,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000405")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Substr(riga,130,30),"C",30,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(CPLib.Substr(riga,124,6),"C",6,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000407")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Substr(riga,130,30),"C",30,0,m_cServer)+", ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"00000408")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESBEN = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(CPLib.Substr(riga,51,70),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(CPLib.Substr(riga,121,3),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(CPLib.Substr(riga,130,30),"C",30,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000040A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNALTRO = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_imp_offline",649,"0000040B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CONNALTRO = "+CPLib.ToSQL(xConnes,"C",16,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
  ...
  public String RunAsync(String p_w_nomefile,String p_w_tipodest,String p_w_azzera,String p_w_tipoimp,String p_w_flgrae,String p_w_soloanag) {
    w_nomefile = p_w_nomefile;
    w_tipodest = p_w_tipodest;
    w_azzera = p_w_azzera;
    w_tipoimp = p_w_tipoimp;
    w_flgrae = p_w_flgrae;
  ...
  public Forward Run(String p_w_nomefile,String p_w_tipodest,String p_w_azzera,String p_w_tipoimp,String p_w_flgrae,String p_w_soloanag) {
    w_nomefile = p_w_nomefile;
    w_tipodest = p_w_tipodest;
    w_azzera = p_w_azzera;
    w_tipoimp = p_w_tipoimp;
  ...
  public static arrt_imp_offlineR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_imp_offlineR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    mcOperazioni = new MemoryCursor_mctesto_mcrdef();
    mcInformazioni = new MemoryCursor_mctesto_mcrdef();
    mcTitolari = new MemoryCursor_mctesto_mcrdef();
    _opepost = CPLib.Space(1);
    _infpost = CPLib.Space(1);
    _titpost = CPLib.Space(1);
    xTitolare = CPLib.Space(16);
    cInfTit = CPLib.Space(11);
    _fileinput = CPLib.Space(0);
    charset = CPLib.Space(0);
    xATECO = CPLib.Space(10);
    mcTipo6 = new MemoryCursor_tipo6();
    _tipo6b = CPLib.Space(1);
    xDatReg = CPLib.NullDate();
  ...
  public static String[] m_cRunParameterNames={"w_nomefile","w_tipodest","w_azzera","w_tipoimp","w_flgrae","w_soloanag"};
  ...
  protected static String GetFieldsName_00000166(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000198(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"NUMPROG1,";
  ...
  protected static String GetFieldsName_00000253(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    ...
    p_cSql = p_cSql+p_oWrInfo.InsertFields();
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"xiduciabo",true);
    return p_cSql;
  }
  ...
  protected static String GetFieldsName_00000281(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CODDIP,";
    p_cSql = p_cSql+"DESCRIZ,";
    p_cSql = p_cSql+p_oWrInfo.InsertFields();
  ...
  protected static String GetFieldsName_00000295(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"DATAOPE,";
  ...
  protected static String GetFieldsName_000002F7(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODFISC,";
    p_cSql = p_cSql+"RAGSOC,";
  ...
  protected static String GetFieldsName_0000031E(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"DATAOPE,";
  ...
  protected static String GetFieldsName_00000336(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CODDIP,";
    p_cSql = p_cSql+"DESCRIZ,";
    p_cSql = p_cSql+p_oWrInfo.InsertFields();
  ...
  protected static String GetFieldsName_00000367(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"sanumpro,";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODCAB,";
  ...
  protected static String GetFieldsName_0000037D(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CODCLI,";
    p_cSql = p_cSql+"CODINTER,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0000039B(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CODCLI,";
    p_cSql = p_cSql+"CODINTER,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000003C4(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CODCLI,";
    p_cSql = p_cSql+"CODINTER,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000003F1(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODFISC,";
    p_cSql = p_cSql+"RAGSOC,";
  ...
  protected static String GetFieldsName_000003F8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"sanumpro,";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODCAB,";
