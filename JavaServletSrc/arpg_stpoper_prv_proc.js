...
SetLocationHref(null,'arrt_stpoper_prv'+'?m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
function Help() {
windowOpenForeground('../doc/arpg_stpoper_prv_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stpoper_prv',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["daCodDip","aCodDip","DaDatOpe","ADatOpe","daCodCli","aCodCli","Tipop","tipstp","RAGSOC1","RAGSOC2","c_dadata","c_adata","OrderBy","DESCRIZ1","DESCRIZ2"];
