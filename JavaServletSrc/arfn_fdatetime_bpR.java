...
// * --- Fine Area Manuale
public class arfn_fdatetime_bpR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_fdatetime_bpR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_fdatetime_bp",m_Caller);
    Blank();
  }
  ...
  public static arfn_fdatetime_bpR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_fdatetime_bpR(p_Ctx, p_Caller);
  }
  public static arfn_fdatetime_bpR Make(CPContext p_Ctx) {
    return new arfn_fdatetime_bpR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
  ...
  // ENTITY_BATCHES: ,arfn_fdatetime_bp,
  public static final String i_InvokedRoutines = ",arfn_fdatetime_bp,";
