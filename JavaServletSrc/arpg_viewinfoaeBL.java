...
public class arpg_viewinfoaeBL extends arpg_viewinfoaeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_viewinfoae";
  ...
  public arpg_viewinfoaeBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_viewinfoae","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
