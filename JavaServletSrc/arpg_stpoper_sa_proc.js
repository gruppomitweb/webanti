...
SetLocationHref(null,'arrt_stpoper_sa'+'?m_cAction=start&m_cMode=hyperlink','elaborazione')
}
function href_WBCVTRNSQS() {
...
function Help() {
windowOpenForeground('../doc/arpg_stpoper_sa_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stpoper_sa',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["DaDatOpe","ADatOpe","RAGSOC1","RAGSOC2","c_dadata","c_adata","daCodCli","aCodCli","OrderBy"];
