...
public class arpg_chkdiana_newBL extends arpg_chkdiana_newWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_chkdiana_new";
  ...
  public static final String i_StateStructure = "{'codinter':codinter,'tipinter':tipinter,'codage':codage,'codcli':codcli,'ragben':ragben,'DaData':DaData,'AData':AData,'tipoarch':tipoarch,'flgope':flgope,'flgfrz':flgfrz,'flgrap':flgrap,'tiprap':tiprap,'flgint':flgint,'flgdel':flgdel,'flgchk':flgchk,'flgsto':flgsto}";
  ...
  public static final String i_ItemSequence = "codinter,tipinter,codage,codcli,ragben,DaData,AData,tipoarch,flgope,flgfrz,flgrap,tiprap,flgint,flgdel,flgchk,flgsto";
  ...
  public arpg_chkdiana_newBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    Link_LMCBBKUTJY();
    Link_VEYKPVUMPQ();
    w_DaData = CPLib.CharToDate("20140101");
    w_tipoarch = "D";
    w_flgrae = "";
    w_flgrae = "A";
    w_flgope = "S";
  ...
  public boolean Set_DaData(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.ge(w_DaData,CPLib.CharToDate("20140101"));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di inizio periodo non deve essere inferiore al 01/01/2014";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
  ...
  public boolean Set_AData(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.ge(w_AData,w_DaData) && CPLib.ge(w_AData,CPLib.CharToDate("20140101"));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di fine periodo deve essere maggiore di quella di inizio e non inferiore al 01/01/2014";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_AData = CPLib.NullDate();
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_chkdiana_new","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
