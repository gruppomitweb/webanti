...
public class arpg_cgo_operazioni_agenzie_dlBL extends arpg_cgo_operazioni_agenzie_dlWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_agenzie_dl";
  ...
  public static final String i_CompleteStateStructure = "{'dataoggi':dataoggi,'gCodDip':gCodDip,'gStpDwn':gStpDwn}";
  ...
  public arpg_cgo_operazioni_agenzie_dlBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_agenzie_dl","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
