...
_modifyandopen('armt_ae_rapopebo'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=edit&m_cAtExit=close&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes',null)
}
...
l_oWv.setValue('IDBASE',AsAppletValue(c_IDBASE));
l_oWv.setValue('m_cParameterSequence',AsAppletValue('IDBASE'));
_modifyandopen('armt_ae_rapopebo'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=delete&m_cAtExit=close&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes',null)
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_viewinfoae_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_viewinfoae',m_cSelectedPage);
...
GroupFooter_BeginHtml(document,1,'474739646'+l_nIdx+'','A',true,false)
GroupFooter_EndHtml(document,1,'474739646'+l_nIdx+'','A')
} else {
}
l_nIdx=l_nIdx+1;
m_nCurrentRow=l_nIdx;
...
if (Ge(2,l_nDeep)) {
GroupHeader_BeginHtml(document,1,'474739648'+l_nIdx+'','A',true,false)
document.writeln(
 "<div id='DIV_0B9EFB50"+l_nIdx+"' style='position:relative;height:17px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
GroupHeader_EndHtml(document,1,'474739648'+l_nIdx+'','A')
} else {
}
Row_BeginHtml(document,l_nEvenOdd,'474725578'+l_nIdx+'','A',true,-1)
document.writeln(
 "<div id='DIV_0BB12850"+l_nIdx+"' style='position:relative;height:19px'>" +
"")
document.writeln(
 "<a href='javascript:href_XZUXXWWVEZ("+l_nIdx+")' id='XZUXXWWVEZ_"+l_nIdx+"_HREF'>" +
 "<img id='XZUXXWWVEZ_"+l_nIdx+"' class='XZUXXWWVEZ' src="+"'"+ToResource('images/edit.gif')+"'"+" alt='' onload=SetSectionsHeight('DIV_0BB12850',"+l_nIdx+")>" +
 "</a>" +
"")
document.writeln(
 "<a href='javascript:href_AWKKPZGIBE("+l_nIdx+")' id='AWKKPZGIBE_"+l_nIdx+"_HREF'>" +
 "<img id='AWKKPZGIBE_"+l_nIdx+"' class='AWKKPZGIBE' src="+"'"+ToResource('images/remove.gif')+"'"+" alt='' onload=SetSectionsHeight('DIV_0BB12850',"+l_nIdx+")>" +
 "</a>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
Row_EndHtml(document,l_nEvenOdd,'474725578'+l_nIdx+'','A')
Parms.Idx=l_nIdx;
Parms.Deep=l_nDeep;
Parms.EvenOdd=l_nEvenOdd;
}
