...
public class arpg_cgo_rapporti_errBL extends arpg_cgo_rapporti_errWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_PRGRAP;
    public String c_RAPPORTO;
    public String c_DESCRAP;
    public java.sql.Date c_DATAOPE;
    public String c_CODINTEST;
    public String c_TIPOMOV;
  ...
  public static final String i_EntityName = "arpg_cgo_rapporti_err";
  ...
  public arpg_cgo_rapporti_errBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_rapporti_err","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_PRGRAP=c_PRGRAP;
    ...
    m_oTrs.get(m_nCurrentRow).c_CODINTEST=c_CODINTEST;
    m_oTrs.get(m_nCurrentRow).c_TIPOMOV=c_TIPOMOV;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_PRGRAP= m_oTrs.get(m_nCurrentRow).c_PRGRAP;
    ...
    c_CODINTEST= m_oTrs.get(m_nCurrentRow).c_CODINTEST;
    c_TIPOMOV= m_oTrs.get(m_nCurrentRow).c_TIPOMOV;
