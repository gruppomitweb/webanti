// Definition generated from table intestit
public class MemoryCursor_intestit extends CPMemoryCursor {
  MemoryCursorRow_intestit row;
  MemoryCursorRow_intestit empty_row;
  public MemoryCursor_intestit() {
    empty_row = new MemoryCursorRow_intestit();
    row = empty_row;
  }
  public MemoryCursor_intestit(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  public void AppendData(java.util.Properties p,CPContext p_Ctx) {
    ...
    java.util.Properties p_PRGIMPTITE;
    p_PRGIMPTITE = new java.util.Properties();
    ...
    while (e.hasMoreElements()) {
      ...
      if ("PRGIMPTITE".equalsIgnoreCase(key)) {
        p_PRGIMPTITE = CPLib.GetProperties(p.getProperty(key));
      }
    ...
    for ( i = 1; CPLib.le(i,Rows); i = i + (1)) {
      ...
      row.PRGIMPTITE = CPLib.GetProperty(p_PRGIMPTITE,"",0,i);
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_intestit)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_intestit();
  }
  ...
  public MemoryCursorRow_intestit _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_intestit _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_intestit> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_intestit();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_intestit p_Row) {
    MemoryCursorRow_intestit l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_intestit p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_intestit();
    }
    this.row.Copy(p_Row);
    return true;
  }
