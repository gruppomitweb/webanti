...
// * --- Fine Area Manuale
public class arrt_delret_aerigheR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_delret_aerigheR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_delret_aerighe",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_delret_aerighe",6,"00000008")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_delret_aerighe",6,"00000009")+"delete from "+m_oWrInfo.GetTableWriteName();
      m_cSql = m_cSql+" where ";
      m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"?",0,0,m_cServer),m_cServer,w_IDBASE)+"";
      m_cSql = m_cSql+" and RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_RAPPORTO,"?",0,0,m_cServer),m_cServer,w_RAPPORTO)+"";
      m_cSql = m_cSql+m_oWrInfo.WhereFilter();
      ...
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_delret_aerighe",6,"0000000A")+"delete from "+m_oWrInfo.GetTableWriteName();
      m_cSql = m_cSql+" where ";
      m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"?",0,0,m_cServer),m_cServer,w_IDBASE)+"";
      m_cSql = m_cSql+" and RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_RAPPORTO,"?",0,0,m_cServer),m_cServer,w_RAPPORTO)+"";
      m_cSql = m_cSql+m_oWrInfo.WhereFilter();
  ...
  public static arrt_delret_aerigheR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_delret_aerigheR(p_Ctx, p_Caller);
  }
  public void Blank() {
