...
if ( ! (m_oFather.SaveContext_ardt_werzistifrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_werzistifrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_werzistifrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_werzistifrz();
}
}
SaveContext.child=[];
function BlankRow() {
