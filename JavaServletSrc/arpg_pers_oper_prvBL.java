...
public class arpg_pers_oper_prvBL extends arpg_pers_oper_prvWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public java.sql.Date c_DATAOPE;
    public String c_NUMPROG;
    public java.sql.Date c_DATAREG;
    public String c_CODANA;
    public String c_CODVOC;
  ...
  public static final String i_EntityName = "arpg_pers_oper_prv";
  ...
  public arpg_pers_oper_prvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_pers_oper_prv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_CODANA=c_CODANA;
    m_oTrs.get(m_nCurrentRow).c_CODVOC=c_CODVOC;
  ...
  public void TrsToWork() {
    ...
    c_CODANA= m_oTrs.get(m_nCurrentRow).c_CODANA;
    c_CODVOC= m_oTrs.get(m_nCurrentRow).c_CODVOC;
