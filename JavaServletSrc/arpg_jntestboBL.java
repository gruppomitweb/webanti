...
public class arpg_jntestboBL extends arpg_jntestboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_jntestbo";
  ...
  public arpg_jntestboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_jntestbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
