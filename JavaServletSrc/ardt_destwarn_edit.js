...
if ( ! (m_oFather.SaveContext_ardt_destwarn())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_destwarn_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_destwarn_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_destwarn();
}
}
SaveContext.child=[];
function BlankRow() {
