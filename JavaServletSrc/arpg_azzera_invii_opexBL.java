...
public class arpg_azzera_invii_opexBL extends arpg_azzera_invii_opexWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_azzera_invii_opex";
  ...
  public static final String i_StateStructure = "{'anno':anno,'mese':mese}";
  public static final String i_CompleteStateStructure = "{'anno':anno,'mese':mese,'dadata':dadata,'a_data':a_data}";
  public static final String i_ItemSequence = "anno,mese";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","true"}});
  ...
  public arpg_azzera_invii_opexBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_azzera_invii_opex","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
