...
if(c=Ctrl('UIMDWYEZSX')) selectCombo(c,w_SEGNO,'C')
SPBOUILib.SetInputValue('EWZFJXYEWM',function(){return WtH(w_PROFESSIONE,'C',40,0,'')},w_PROFESSIONE);
if (m_bExtended) {
SetExtensions();
}
...
var h;
h=Ne(w_TIPOGIOCO,'V') || IsHiddenByStateDriver(Z.Tabs.Get('tabs').GetTabstripID('page_3'));
...
SetDisplay('RWCKHDGZVX_DIV',IsHiddenByStateDriver('Multiple'));
SetDisplay(Ctrl('EWZFJXYEWM'),Eq(w_xCGOFLGPROF,'N') || IsHiddenByStateDriver('PROFESSIONE'));
SetDisplay(Ctrl('EXZMNOSILZ'),Eq(w_xCGOFLGPROF,'N'));
...
HideUI.lblids["PROFESSIONE"]=['EXZMNOSILZ'];
...
HideUI.lblids["TIPINTER"]=['KUMAOEWIHF'];
...
var cond;
cond=Gt(arfn_cgo_contarm(w_SNAINUMOPE),0);
if (Ne(o_RWCKHDGZVX_expand,cond)) {
ExpandCollapsibleBox('RWCKHDGZVX',cond);
o_RWCKHDGZVX_expand=cond;
}
cond=Eq(arfn_cgo_contarm(w_SNAINUMOPE),0);
if (Ne(o_RWCKHDGZVX_collapse,cond)) {
CollapseCollapsibleBox('RWCKHDGZVX',cond);
o_RWCKHDGZVX_collapse=cond;
}
}
...
linkpc_url.u('CJPXRAUTXZ',function(){return 'ardt_cgo_oper_storico_multi?m_bInnerChild=true'+GetLinkPCKeys('ardt_cgo_oper_storico_multi')+'&m_bRowsChild='+EnableChild('ardt_cgo_oper_storico_multi')})
linkpc_url.u('FGDNXNYKKB',function(){return 'armt_cgo_qadv_operazioni_storico?m_bInnerChild=true'+GetLinkPCKeys('armt_cgo_qadv_operazioni_storico')+'&m_bRowsChild='+EnableChild('armt_cgo_qadv_operazioni_storico')})
_ResetTracker();
...
w_PrtDocAll.raiseEvent('armt_snai_oper_storico_'+Strtran(p_cEvent,' ','_'));
}
}
...
FocusFirstComponent.edit={"page_1":["HUDOCMLKKT","BELMGUMGMW","TRGEEVWGRS","YYELCZIDWS","SFKJNKYLJO","EOSKLIUGBC","FKEAKFSYVU","MFCMVHMGSB","YZHCHEDWZM","UTUCDPQJKK","KZWBLPQNHU","CZTHKEDVCO"]};
FocusFirstComponent.query={"page_1":["HUAGBHPUNH","HUDOCMLKKT","BELMGUMGMW","TRGEEVWGRS","YYELCZIDWS","SFKJNKYLJO","EOSKLIUGBC","FKEAKFSYVU","MFCMVHMGSB","YZHCHEDWZM","UTUCDPQJKK","KZWBLPQNHU","CZTHKEDVCO"]};
FocusFirstComponent.otherwise={"page_1":["HUDOCMLKKT","BELMGUMGMW","TRGEEVWGRS","YYELCZIDWS","SFKJNKYLJO","EOSKLIUGBC","FKEAKFSYVU","MFCMVHMGSB","YZHCHEDWZM","UTUCDPQJKK","KZWBLPQNHU","CZTHKEDVCO"]};
function Help() {
windowOpenForeground('../doc/armt_snai_oper_storico_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
function SetModified_armt_cgo_qadv_operazioni_storico() {
SetModified();
}
function LoadChildrenInPage(page,lazy) {
if (Eq(page,'page_1')) {
if (ChildToLoad('CJPXRAUTXZ')) {
if (Eq(lazy,null) || LibJavascript.UserCanSee('CJPXRAUTXZ')) {
LoadContext.lc(1,'CJPXRAUTXZ');
}
} else {
LibJavascript.RefreshChildGrid('CJPXRAUTXZ');
}
}
if (Eq(page,'page_3')) {
if (ChildToLoad('FGDNXNYKKB')) {
LoadContext.lc(1,'FGDNXNYKKB');
} else {
LibJavascript.RefreshChildGrid('FGDNXNYKKB');
}
}
}
...
GetLayerID.Layers.push({"id":"RWCKHDGZVX","name":"Multiple"});
...
w_verifica=a[124];
w_gStpDwn=a[125];
w_MIDBIGLIETTO=a[126];
w_MIDBIGLIETTO1=a[127];
w_MIDBIGLIETTO2=a[128];
w_MIDBIGLIETTO3=a[129];
w_MIDBIGLIETTO4=a[130];
w_TELDIP=a[131];
w_CODLOC=a[132];
w_xFLGPLGIO=a[133];
w_xVPFLGATT=a[134];
...
w_dessta2=a[142];
w_xCGOFLGPROF=a[143];
o_RWCKHDGZVX_expand=null;
o_RWCKHDGZVX_collapse=null;
m_cWv_ardt_cgo_oper_storico_multi=a[144];
m_cWv_armt_cgo_qadv_operazioni_storico=a[145];
if (Gt(a.length,146)) {
m_cErrorInChild='';
}
if (Gt(a.length,146)) {
...
return 'cgo_operazioni_storico'+'\\'+CPLib.ToCPStr(w_SNAINUMOPE);
}
GetLinkPCKeys.set_o('ardt_cgo_oper_storico_multi',false);
GetLinkPCKeys.set_o('armt_cgo_qadv_operazioni_storico',false);
GetLinkPCKeys.o['ardt_cgo_oper_storico_multi']['SNAINUMOPE']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_SNAINUMOPE,'C');
}
}
GetLinkPCKeys.o['armt_cgo_qadv_operazioni_storico']['SNAINUMOPE']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_SNAINUMOPE,'C');
}
}
...
LoadContext.f('CJPXRAUTXZ',function(){return FrameRef('ardt_cgo_oper_storico_multi')},1,'ardt_cgo_oper_storico_multi',0,1)
LoadContext.f('FGDNXNYKKB',function(){return FrameRef('armt_cgo_qadv_operazioni_storico')},1,'armt_cgo_qadv_operazioni_storico',1,3)
GetSelectedChildPage.child={'ardt_cgo_oper_storico_multi': function(){return FrameRef('ardt_cgo_oper_storico_multi')}, 'armt_cgo_qadv_operazioni_storico': function(){return FrameRef('armt_cgo_qadv_operazioni_storico')}}
function GetSelectedPage(p_d) {
p_d.setValue('armt_snai_oper_storico',m_cSelectedPage);
...
_Obli('TOTLIRE',1,'HUAGBHPUNH',false,"1825772649")
