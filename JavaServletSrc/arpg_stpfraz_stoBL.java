...
public class arpg_stpfraz_stoBL extends arpg_stpfraz_stoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpfraz_sto";
  ...
  public static final String i_StateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'tipstp':tipstp}";
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'tipstp':tipstp,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'cdadata':cdadata,'c_adata':c_adata}";
  public static final String i_ItemSequence = "DaDatOpe,ADatOpe,daCodCli,aCodCli,tipstp";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"tipstp","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_stpfraz_stoBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_tipstp = "S";
    w_cdadata = "";
    w_cdadata = (CPLib.Empty(w_DaDatOpe)?"":CPLib.DateToChar(w_DaDatOpe));
    w_c_adata = "";
    w_c_adata = (CPLib.Empty(w_DaDatOpe)?"":CPLib.DateToChar(w_ADatOpe));
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpfraz_sto","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
