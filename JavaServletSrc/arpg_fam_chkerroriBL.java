...
public class arpg_fam_chkerroriBL extends arpg_fam_chkerroriWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fam_chkerrori";
  ...
  public arpg_fam_chkerroriBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fam_chkerrori","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
