...
public class ardt_intestitBL extends ardt_intestitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_intestit";
  ...
  public CPPhTableWrInfo m_oWrInfo_intestit;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_intestit;
  ...
  public static String[] m_EntityTables = {"intestit"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CODCLI':CODCLI,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'PRGIMPTITE':PRGIMPTITE,'DESCINTER':DESCINTER,'IDBASE':IDBASE"+FoundlingChildrenList("ardt_intestit",true,true)+"}"+FoundlingChildrenList("ardt_intestit",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'tipreg':tipreg,'CODCLI':CODCLI,'gAzienda':gAzienda,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'TIPOPERS':TIPOPERS,'xragsoci':xragsoci,'tiporegr':tiporegr,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PRGIMPTITE':PRGIMPTITE,'STATOREG':STATOREG,'IDEREG':IDEREG,'TIPORAP':TIPORAP,'NUMPROG2':NUMPROG2,'NUMPROG1':NUMPROG1,'DESCINTER':DESCINTER,'IDBASE':IDBASE,'NOAGE':NOAGE"+FoundlingChildrenList("ardt_intestit",true,true)+"},'tipooprap':tipooprap"+FoundlingChildrenList("ardt_intestit",true,false)+"}";
  public static final String i_ItemSequence = "CODCLI,m_Detail[ CODINTER DATAINI DATAFINE PRGIMPTITE DESCINTER IDBASE"+FoundlingChildrenList("ardt_intestit",false,true)+"]"+FoundlingChildrenList("ardt_intestit",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_intestit"),new String[][]{new String[]{"CODCLI","","C","16","0","campo","key1","false","false"},new String[]{"CODINTER","Intestatario (Non Intermediario)","C","16","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"},new String[]{"PRGIMPTITE","","N","10","0","campo","nokey","true","false"},new String[]{"DESCINTER","","C","70","0","campo","key2","true","false"},new String[]{"IDBASE","idbase","C","10","0","campo","nokey","true","false"}});
  ...
  public ardt_intestitBL (CPContext p_ContextObject) {
    ...
    m_cPhName_intestit = p_ContextObject.GetPhName("intestit",p_ContextObject.GetCompany(),false);
    m_cServer_intestit = p_ContextObject.GetServer("intestit");
    m_oWrInfo_intestit = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"intestit",p_ContextObject.GetCompany());
    m_cVirtName_intestit = CPSql.ManipulateTablePhName("intestit",m_cServer_intestit);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_intestit",p_ContextObject);
  }
  public void Blank() {
  ...
  void Calculation_XSORDCKKLR() {
    w_DATAINI = (CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"50")?Utilities.Make(m_Ctx).GetCallerDate("DATAOPE"):w_DATAINI);
    w_DATAFINE = (CPLib.eq(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"51")?Utilities.Make(m_Ctx).GetCallerDate("DATAOPE"):w_DATAFINE);
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_intestit","intestit",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_intestit",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_intestit",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_intestit",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_intestit",m_Ctx);
  ...
  public boolean Check() {
    ...
    ResetErrorMessage();
    l_bResult = true;
    if ( ! (CPLib.Empty(w_IDBASE)) &&  ! (CPLib.Empty(w_CODINTER))) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_intestit"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_intestit\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "intestit"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CODCLI","C",16,0));
  }
  public String RowPrimaryKey() {
    return "intestit"+"\\"+CPLib.ToCPStr(w_CODINTER);
  }
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_IDBASE)) &&  ! (CPLib.Empty(w_CODINTER));
  }
  void SetModified() {
