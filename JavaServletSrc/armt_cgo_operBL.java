...
public class armt_cgo_operBL extends armt_cgo_operWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_cgo_oper";
  ...
  public static final String i_StateStructure = "{'TIPOGIOCO':TIPOGIOCO,'VLTPLAT':VLTPLAT,'CAIDBIGLIETTO':CAIDBIGLIETTO,'DATAOPE':DATAOPE,'FLAGCONT':FLAGCONT,'FLAGWALLET':FLAGWALLET,'CAFLGOPE':CAFLGOPE,'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'IMPWALLET':IMPWALLET,'CODWALLET':CODWALLET,'CODTRANSZ':CODTRANSZ,'FILTROMP':FILTROMP,'FLGPAGAM':FLGPAGAM,'MEZPAGAM':MEZPAGAM,'CC4CIFRE':CC4CIFRE,'CCMESSCA':CCMESSCA,'CCANNSCA':CCANNSCA,'ASSEGNO':ASSEGNO,'IBAN':IBAN,'CFESTERO':CFESTERO,'PEP':PEP,'CODFISC':CODFISC,'COGNOME':COGNOME,'NOME':NOME,'NASCOMUN':NASCOMUN,'TIPINTER':TIPINTER,'SESSO':SESSO,'NASSTATO':NASSTATO,'DATANASC':DATANASC,'PAESE':PAESE,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'DOMICILIO':DOMICILIO,'NUMTEL':NUMTEL,'SNAINUMOPE':SNAINUMOPE,'CONNESCLI':CONNESCLI,'FLGDOCALL':FLGDOCALL,'DOC03':DOC03,'DOC04':DOC04,'saveddoc':saveddoc,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'DATAVALI':DATAVALI,'RDCODAUT':RDCODAUT,'RDLOCAUT':RDLOCAUT,'PEPDESCRI':PEPDESCRI,'PAESE2':PAESE2,'DESCCIT2':DESCCIT2,'PROVINCIA2':PROVINCIA2,'CAP2':CAP2,'DOMICILIO2':DOMICILIO2,'FLGDOM':FLGDOM,'FLGQADVFULL':FLGQADVFULL,'PROFESSIONE':PROFESSIONE,'CODDIPE':CODDIPE,'ANA_FOUND':ANA_FOUND,'armt_cgo_qadv_operazioni_dl':armt_cgo_qadv_operazioni_dl"+FoundlingChildrenList("armt_cgo_oper",true)+"}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'TIPOGIOCO':TIPOGIOCO,'xSOGTPGIO':xSOGTPGIO,'xDEFTPGIO':xDEFTPGIO,'xEDTTPGIO':xEDTTPGIO,'xEDTSPGIO':xEDTSPGIO,'xDEFSPGIO':xDEFSPGIO,'xFLGPLGIO':xFLGPLGIO,'CGOTIPOPE':CGOTIPOPE,'VLTPLAT':VLTPLAT,'CAIDBIGLIETTO':CAIDBIGLIETTO,'DATAOPE':DATAOPE,'FLAGCONT':FLAGCONT,'FLAGWALLET':FLAGWALLET,'CAFLGOPE':CAFLGOPE,'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'IMPWALLET':IMPWALLET,'CODWALLET':CODWALLET,'CODTRANSZ':CODTRANSZ,'FILTROMP':FILTROMP,'CGOFLGVLT':CGOFLGVLT,'FLGPAGAM':FLGPAGAM,'CGOFLGVNP':CGOFLGVNP,'MEZPAGAM':MEZPAGAM,'CC4CIFRE':CC4CIFRE,'CCMESSCA':CCMESSCA,'CCANNSCA':CCANNSCA,'ASSEGNO':ASSEGNO,'IBAN':IBAN,'CCDATSCA':CCDATSCA,'CFESTERO':CFESTERO,'PEP':PEP,'CODFISC':CODFISC,'COGNOME':COGNOME,'NOME':NOME,'NASCOMUN':NASCOMUN,'TIPINTER':TIPINTER,'SESSO':SESSO,'NASSTATO':NASSTATO,'DATANASC':DATANASC,'PAESE':PAESE,'DESCCIT':DESCCIT,'idcitta':idcitta,'PROVINCIA':PROVINCIA,'CAP':CAP,'DOMICILIO':DOMICILIO,'NUMTEL':NUMTEL,'xARDESCRI':xARDESCRI,'ATTIV':ATTIV,'TIPOPERS':TIPOPERS,'RAGSOC':RAGSOC,'SOTGRUP':SOTGRUP,'RAMOGRUP':RAMOGRUP,'SETTSINT':SETTSINT,'dessta':dessta,'tipsot':tipsot,'STATOREG':STATOREG,'IDBASE':IDBASE,'NUMPROG':NUMPROG,'DESCRI':DESCRI,'gSeekAos':gSeekAos,'gDataVaria':gDataVaria,'gFlgDoc':gFlgDoc,'SNAINUMOPE':SNAINUMOPE,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'CODANA':CODANA,'CODVOC':CODVOC,'VALUTA':VALUTA,'CAMBIO':CAMBIO,'CONNESCLI':CONNESCLI,'CONNESBEN':CONNESBEN,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_PRV':C_PRV,'C_CAP':C_CAP,'C_CAB':C_CAB,'C_IND':C_IND,'C_STA':C_STA,'CODINTER':CODINTER,'gCodDip':gCodDip,'SEGNO':SEGNO,'FLAGFRAZ':FLAGFRAZ,'COLLEG':COLLEG,'xDescDipe':xDescDipe,'datpaseuro':datpaseuro,'xdes1':xdes1,'desccauana':desccauana,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'xdesccausin':xdesccausin,'gChkDate':gChkDate,'xdesctipatt':xdesctipatt,'gVLT':gVLT,'gVNP':gVNP,'gStpDwn':gStpDwn,'CACODICE':CACODICE,'CODCAB':CODCAB,'MIDBIGLIETTO':MIDBIGLIETTO,'MIDBIGLIETTO1':MIDBIGLIETTO1,'MIDBIGLIETTO4':MIDBIGLIETTO4,'MIDBIGLIETTO2':MIDBIGLIETTO2,'MIDBIGLIETTO3':MIDBIGLIETTO3,'gPathApp':gPathApp,'IDDOCALL':IDDOCALL,'FLGDOCALL':FLGDOCALL,'xVPFLGATT':xVPFLGATT,'DOC03':DOC03,'DOC04':DOC04,'gGesDoc':gGesDoc,'edtdoc':edtdoc,'saveddoc':saveddoc,'xIMPMINGIO':xIMPMINGIO,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'DATAVALI':DATAVALI,'RDCODAUT':RDCODAUT,'RDLOCAUT':RDLOCAUT,'AUTRILASC':AUTRILASC,'PEPDESCRI':PEPDESCRI,'PAESE2':PAESE2,'DESCCIT2':DESCCIT2,'idcitta2':idcitta2,'PROVINCIA2':PROVINCIA2,'CAP2':CAP2,'DOMICILIO2':DOMICILIO2,'FLGDOM':FLGDOM,'dessta2':dessta2,'gTipMul':gTipMul,'FLGQADVFULL':FLGQADVFULL,'gQADV':gQADV,'xCGOFLGPROF':xCGOFLGPROF,'PROFESSIONE':PROFESSIONE,'CODDIPE':CODDIPE,'DESCCITDIP':DESCCITDIP,'PROVINCIADIP':PROVINCIADIP,'CODCABDIP':CODCABDIP,'TELDIP':TELDIP,'CODLOC':CODLOC,'dirupl':dirupl,'ANA_FOUND':ANA_FOUND,'armt_cgo_qadv_operazioni_dl':armt_cgo_qadv_operazioni_dl"+FoundlingChildrenList("armt_cgo_oper",true)+"}";
  public static final String i_ItemSequence = "TIPOGIOCO,VLTPLAT,CAIDBIGLIETTO,DATAOPE,FLAGCONT,FLAGWALLET,CAFLGOPE,TOTLIRE,TOTCONT,IMPWALLET,CODWALLET,CODTRANSZ,FILTROMP,FLGPAGAM,MEZPAGAM,CC4CIFRE,CCMESSCA,CCANNSCA,ASSEGNO,IBAN,CFESTERO,PEP,CODFISC,COGNOME,NOME,NASCOMUN,TIPINTER,SESSO,NASSTATO,DATANASC,PAESE,DESCCIT,PROVINCIA,CAP,DOMICILIO,NUMTEL,SNAINUMOPE,CONNESCLI,FLGDOCALL,DOC03,DOC04,saveddoc,TIPODOC,NUMDOCUM,DATARILASC,DATAVALI,RDCODAUT,RDLOCAUT,PEPDESCRI,PAESE2,DESCCIT2,PROVINCIA2,CAP2,DOMICILIO2,FLGDOM,FLGQADVFULL,PROFESSIONE,CODDIPE,ANA_FOUND,armt_cgo_qadv_operazioni_dl"+FoundlingChildrenList("armt_cgo_oper",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_cgo_oper"),new String[][]{new String[]{"TIPOGIOCO","Tipo gioco","C","3","0","campo","nokey","false","true"},new String[]{"VLTPLAT","Piattaforma VLT","C","2","0","campo","nokey","false","true"},new String[]{"CAIDBIGLIETTO","ID BIGLIETTO","C","30","0","campo","nokey","false","true"},new String[]{"DATAOPE","Data Operazione","D","8","0","campo","key2","false","true"},new String[]{"FLAGCONT","Contanti (S/N)","C","1","0","campo","nokey","false","true"},new String[]{"FLAGWALLET","Flag Wallet","C","1","0","campo","nokey","false","true"},new String[]{"CAFLGOPE","Tipo Registrazione","C","1","0","campo","nokey","false","true"},new String[]{"TOTLIRE","Totale Operazione","N","15","2","campo","nokey","false","true"},new String[]{"TOTCONT","di cui contanti","N","15","2","campo","nokey","false","true"},new String[]{"IMPWALLET","IMporto","N","12","2","campo","nokey","false","true"},new String[]{"CODWALLET","WALLET","C","20","0","campo","nokey","false","true"},new String[]{"CODTRANSZ","Transazione ID Wallet","C","50","0","campo","nokey","false","true"},new String[]{"FILTROMP","","C","50","0","variabile","nokey","false","false"},new String[]{"FLGPAGAM","","C","1","0","variabile","nokey","false","false"},new String[]{"MEZPAGAM","Mezzo Pagamento","C","1","0","campo","nokey","false","true"},new String[]{"CC4CIFRE","Ultime Cifre CC ()","C","4","0","campo","nokey","false","true"},new String[]{"CCMESSCA","Mese Scadenza","N","2","0","campo","nokey","false","true"},new String[]{"CCANNSCA","Carta Di Credito Scadenza","N","4","0","campo","nokey","false","true"},new String[]{"ASSEGNO","Assegno","C","25","0","campo","nokey","false","true"},new String[]{"IBAN","IBAN per Bonifici","C","40","0","campo","nokey","false","true"},new String[]{"CFESTERO","Codice Fiscale Estero","N","1","0","campo","nokey","false","false"},new String[]{"PEP","Persona Politicamente Esposta","C","1","0","campo","nokey","false","true"},new String[]{"CODFISC","Codice Fiscale","C","16","0","campo","nokey","false","true"},new String[]{"COGNOME","Cognome","C","26","0","campo","nokey","false","true"},new String[]{"NOME","Nome","C","25","0","campo","nokey","false","true"},new String[]{"NASCOMUN","Luogo di Nascita","C","30","0","campo","nokey","false","true"},new String[]{"TIPINTER","Prov.","C","2","0","campo","nokey","false","true"},new String[]{"SESSO","Sesso","C","1","0","campo","nokey","false","true"},new String[]{"NASSTATO","Stato di nascita","C","30","0","campo","nokey","false","true"},new String[]{"DATANASC","Data Nascita","D","8","0","campo","nokey","false","true"},new String[]{"PAESE","Stato Residenza","C","3","0","campo","nokey","false","true"},new String[]{"DESCCIT","Città","C","40","0","campo","nokey","false","true"},new String[]{"PROVINCIA","Provincia","C","2","0","campo","nokey","false","true"},new String[]{"CAP","CAP","C","9","0","campo","nokey","false","true"},new String[]{"DOMICILIO","Indirizzo","C","35","0","campo","nokey","false","true"},new String[]{"NUMTEL","Numero Telefono","C","20","0","campo","nokey","false","false"},new String[]{"SNAINUMOPE","N° Operazione","C","15","0","campo","key1","false","false"},new String[]{"CONNESCLI","Codice Cliente Occasionale","C","16","0","campo","nokey","false","false"},new String[]{"FLGDOCALL","Flag Documentazione Completa","C","1","0","campo","nokey","false","false"},new String[]{"DOC03","","C","80","0","variabile","nokey","false","false"},new String[]{"DOC04","","C","80","0","variabile","nokey","false","false"},new String[]{"saveddoc","","C","1","0","variabile","nokey","false","false"},new String[]{"TIPODOC","Tipo Documento","C","2","0","campo","nokey","false","true"},new String[]{"NUMDOCUM","Numero Doc.","C","15","0","campo","nokey","false","true"},new String[]{"DATARILASC","Rilascio Doc.","D","8","0","campo","nokey","false","true"},new String[]{"DATAVALI","Data Fine Validità","D","8","0","campo","nokey","false","true"},new String[]{"RDCODAUT","Autorità Rilascio","C","2","0","campo","nokey","false","true"},new String[]{"RDLOCAUT","Luogo Autorità Rilascio","C","20","0","campo","nokey","false","true"},new String[]{"PEPDESCRI","Descrizione PEP","C","80","0","campo","nokey","false","true"},new String[]{"PAESE2","Stato Domicilio","C","3","0","campo","nokey","false","true"},new String[]{"DESCCIT2","Città Domicilio","C","40","0","campo","nokey","false","true"},new String[]{"PROVINCIA2","Provincia","C","2","0","campo","nokey","false","true"},new String[]{"CAP2","CAP","C","9","0","campo","nokey","false","true"},new String[]{"DOMICILIO2","Indirizzo Domicilio","C","35","0","campo","nokey","false","true"},new String[]{"FLGDOM","Domicilio diverso da residenza","C","1","0","campo","nokey","false","false"},new String[]{"FLGQADVFULL","","C","1","0","variabile","nokey","false","false"},new String[]{"PROFESSIONE","Professione","C","40","0","campo","nokey","false","true"},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"ANA_FOUND","","C","1","0","variabile","nokey","false","false"},new String[]{"armt_cgo_qadv_operazioni_dl","LinkPC","","","","link_PC","","false",""}});
  ...
  public armt_cgo_operBL (CPContext p_ContextObject) {
    ...
    armt_cgo_qadv_operazioni_dl = new armt_cgo_qadv_operazioni_dlBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_cgo_oper",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || armt_cgo_qadv_operazioni_dl.IsUpdated() || CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_dl);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    o_CODDIPE = w_CODDIPE;
    armt_cgo_qadv_operazioni_dl.SaveDependsOn();
  }
  ...
  protected boolean Link_QZTTRBWAQL(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_TIPOGIOCO))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_cgo_tbtipgio,"select CODTPGIO,SOGTPGIO,DEFTPGIO,EDTTPGIO,EDTSPGIO,DEFSPGIO,FLGPLGIO,FLTIPGIO,IMPMINGIO from "+m_cPhName_cgo_tbtipgio+((m_cPhName_cgo_tbtipgio).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODTPGIO"+l_cCurrentKey+l_cWhere);
      try {
        ...
        if (l_bLoaded) {
          ...
          w_xIMPMINGIO = l_rsLink.GetDouble("IMPMINGIO");
          l_rsLink.Next();
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if (l_bResult) {
            l_bResult = CPLib.ne(w_TIPOGIOCO,w_gTipMul);
            if ( ! (l_bResult)) {
              // Se il check è fallito vengono caricati i valori di blank nelle variabili
              m_nLastError = 3;
              m_cLastMsgError = "Non è utilizzabile il tipo gioco valido per le operazioni multiple";
  ...
  public boolean Set_CAIDBIGLIETTO(String p_workVariableValue) {
    ...
    // Se il campo è vuoto, demando la segnalazione dell'obbligatorietà alla Check() del business object
    // 
    l_bResult = (CPLib.eq(w_TIPOGIOCO,"V")?true:arfn_cgo_chkidbR.Make(m_Ctx,this).Run(w_CAIDBIGLIETTO));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
  ...
  public boolean Set_DATAOPE(java.sql.Date p_workVariableValue) {
    ...
    // Se il campo è vuoto, demando la segnalazione dell'obbligatorietà alla Check() del business object
    // 
    l_bResult = CPLib.le(w_DATAOPE,CPLib.Date());
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data del ticket non può essere maggiore della data odierna!";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_DATAOPE = CPLib.NullDate();
  ...
  public boolean TRGEEVWGRS_isObligatory() {
    // Condizione di obbligatorietà
    return CPLib.eq(w_FLAGWALLET,"1");
  }
  ...
  public boolean PAQVIKBAGR_isObligatory() {
    // Condizione di obbligatorietà
  ...
  public boolean Calculate() {
    ...
    if (CPLib.ne(o_CAFLGOPE,w_CAFLGOPE)) {
  ...
  void Calculation_KGBNFVNJHO() {
    ...
    l_oRoutine_arrt_cgo_qadv_mail.pORIGINE = "A";
  ...
  void Calculation_CHYPGHRXCN() {
    if (false) {
      arrt_cgo_setpagatoreR l_oRoutine_arrt_cgo_setpagatore;
      l_oRoutine_arrt_cgo_setpagatore = arrt_cgo_setpagatoreR.Make(m_Ctx,this);
      l_oRoutine_arrt_cgo_setpagatore.pObj = this;
      l_oRoutine_arrt_cgo_setpagatore.Run();
    }
  }
  ...
  boolean Check_GAUOPXUMYI(boolean p_bForce) {
    boolean l_bResult = true;
    if (p_bForce || CPLib.ne(o_CAIDBIGLIETTO,w_CAIDBIGLIETTO) || CPLib.ne(o_TIPOGIOCO,w_TIPOGIOCO)) {
      l_bResult = (CPLib.eq(w_TIPOGIOCO,"V")?true:arfn_cgo_chkidbR.Make(m_Ctx,this).Run(w_CAIDBIGLIETTO));
      if ( ! (l_bResult)) {
        m_cLastMsgError = CPLib.Strtran("%ERRORMESSAGE%","%ERRORMESSAGE%",m_cLastMsgError);
      }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_cgo_oper","cgo_operazioni_dl",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_xIMPMINGIO = CPLib.GetProperty(p,"xIMPMINGIO",w_xIMPMINGIO,0);
      ...
      w_dirupl = CPLib.GetProperty(p,"dirupl",w_dirupl,0);
      w_ANA_FOUND = CPLib.GetProperty(p,"ANA_FOUND",w_ANA_FOUND,0);
      m_cWv_armt_cgo_qadv_operazioni_dl = CPLib.GetProperty(p,"m_cWv_armt_cgo_qadv_operazioni_dl",m_cWv_armt_cgo_qadv_operazioni_dl,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("\u0000w_FLGDOM='S'\u0000w_PAESE2='086' and w_FLGDOM='S'",-1));
    map.put("rd_kvar.frm_obbl",new String[]{});
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("cgo_qadv_operazioni_dl");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("cgo_qadv_operazioni_dl",items);
    }
    items.add(map);
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("cgo_qadv_operazioni_dl\u0000false\u0000false\u00001\u00000\u0000armt_cgo_qadv_operazioni_dl\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODTPGIO","SOGTPGIO","DEFTPGIO","EDTTPGIO","EDTSPGIO","DEFSPGIO","FLGPLGIO","FLTIPGIO","IMPMINGIO"});
    map.put("rd_var",new String[]{"w_TIPOGIOCO","w_xSOGTPGIO","w_xDEFTPGIO","w_xEDTTPGIO","w_xEDTSPGIO","w_xDEFSPGIO","w_xFLGPLGIO","w_CGOTIPOPE","w_xIMPMINGIO"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000N\u0000C\u0000C\u0000C\u0000C\u0000C\u0000C\u0000N",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("3\u000012\u00001\u00001\u00001\u00001\u00001\u00001\u000010",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00002\u00000\u00000\u00000\u00000\u00000\u00000\u00002",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Tipo gioco\u0000Soglia pagamento Agenzia\u0000Default (A=Agenzia , S=SNAI)\u0000Abilita modifica Scelta\u0000Abilita Modifica Sotto Soglia\u0000Default Sotto Soglia\u0000Abilita Selezione Piattaforma\u0000Tipo Gioco\u0000Importo minimo autovalidazione multiple",-1));
    map.put("rd_kvar.comment",new String[]{});
    ...
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Stato Residenza\u0000Descrizione",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    ...
    map.put("rd_kvar.comment",zeroSplit.split("Stato Residenza",-1));
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_cgo_oper",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_cgo_oper",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    armt_cgo_qadv_operazioni_dl = new armt_cgo_qadv_operazioni_dlBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_cgo_oper",m_Ctx);
  ...
  public boolean Check() {
    ...
    ResetErrorMessage();
    if ((CPLib.Empty(w_TIPOGIOCO)) || ( ! (CPLib.Empty(w_TIPOGIOCO)) &&  ! (CPLib.ne(w_TIPOGIOCO,w_gTipMul)))) {
      l_bNoObligatory =  ! (CPLib.Empty(w_TIPOGIOCO));
      String obblMsgError = m_Ctx.Translate("Tipo gioco")+" : ";
      if ( ! (l_bNoObligatory)) {
        m_cLastMsgError = obblMsgError+m_Ctx.Translate("Non è utilizzabile il tipo gioco valido per le operazioni multiple");
      } else {
        m_cLastMsgError = m_Ctx.Translate("Non è utilizzabile il tipo gioco valido per le operazioni multiple");
        l_bNoCheck = false;
      }
      l_bResult = false;
      w_TIPOGIOCO = "";
    ...
    } else if ((CPLib.eq(w_xFLGPLGIO,"S")) && ((CPLib.Empty(w_VLTPLAT) && LVYFMQXNZH_isObligatory()) || ( ! (CPLib.Empty(w_VLTPLAT)) &&  ! (CPLib.eq(w_xVPFLGATT,"S"))))) {
    ...
    } else if ((CPLib.Empty(w_CAIDBIGLIETTO)) || ( ! ((CPLib.eq(w_TIPOGIOCO,"V")?true:arfn_cgo_chkidbR.Make(m_Ctx,this).Run(w_CAIDBIGLIETTO))))) {
      l_bNoObligatory =  ! (CPLib.Empty(w_CAIDBIGLIETTO));
      String obblMsgError = m_Ctx.Translate("ID BIGLIETTO")+" : ";
      if ( ! (l_bNoObligatory)) {
        m_cLastMsgError = CPLib.Strtran("%ERRORMESSAGE%","%ERRORMESSAGE%",m_cLastMsgError);
        if (CPLib.eq(m_cLastMsgError,"")) {
    ...
    } else if ((CPLib.Empty(w_DATAOPE)) || ( ! (CPLib.le(w_DATAOPE,CPLib.Date())))) {
      ...
      if ( ! (l_bNoObligatory)) {
        ...
        m_cLastMsgError = m_Ctx.Translate("La data del ticket non può essere maggiore della data odierna!");
        l_bNoCheck = false;
      }
      l_bResult = false;
      w_DATAOPE = CPLib.NullDate();
    ...
    } else if (CPLib.Empty(w_CAFLGOPE)) {
      l_bNoObligatory =  ! (CPLib.Empty(w_CAFLGOPE));
      String obblMsgError = m_Ctx.Translate("Tipo Registrazione")+" : ";
      m_cLastMsgError = obblMsgError+m_Ctx.Translate("MSG_OBBLI_FIELD");
      l_bResult = false;
      w_CAFLGOPE = "";
      if (CPLib.eq(m_cLastWorkVarError,"")) {
        m_cLastWorkVarError = "CAFLGOPE";
      }
    } else if ((CPLib.Empty(w_TOTLIRE)) || ( ! (CPLib.gt(w_TOTLIRE,0) && CPLib.ge(w_TOTLIRE,(w_TOTCONT+w_IMPWALLET))))) {
    ...
    } else if ((CPLib.eq(w_FLAGWALLET,"1") &&  ! (CPLib.Empty(w_DATAOPE))) && (CPLib.Empty(w_CODWALLET) && TRGEEVWGRS_isObligatory())) {
    ...
    } else if (CPLib.Empty(w_CGOFLGVLT)) {
      ...
      String obblMsgError = m_Ctx.Translate("Stato Residenza")+" : ";
      if ( ! (l_bNoObligatory)) {
        m_cLastMsgError = obblMsgError+m_Ctx.Translate("MSG_OBBLI_FIELD");
      } else {
        m_cLastMsgError = m_Ctx.Translate("Stato Residenza")+" : ";
        m_cLastMsgError = m_cLastMsgError+m_Ctx.Translate("MSG_VALUE_NOT_ALLOWED");
        l_bNoCheck = false;
      }
      l_bResult = false;
    ...
    } else if (CPLib.Empty(w_PROFESSIONE) && PAQVIKBAGR_isObligatory()) {
    ...
    if (l_bResult && (( ! (armt_cgo_qadv_operazioni_dl.m_bLoaded) && CPLib.IsLoaded(m_cWv_armt_cgo_qadv_operazioni_dl)) || ( ! (armt_cgo_qadv_operazioni_dl.m_bUpdated) && CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_dl)))) {
    ...
    if (l_bResult && (armt_cgo_qadv_operazioni_dl.m_bLoaded || armt_cgo_qadv_operazioni_dl.m_bUpdated)) {
      l_bResult = l_bResult && armt_cgo_qadv_operazioni_dl.Check();
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_cgo_oper"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_cgo_oper\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  void InitAutonumber() {
    ...
    w_SNAINUMOPE = m_Ctx.AskTableProg(w_SNAINUMOPE,15,op_SNAINUMOPE,"PRGNUMOPE"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_cgo_operazioni_dl);
    op_codazi = m_Ctx.GetCompany();
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"gPathApp",w_gPathApp,0);
    ...
    CPLib.PutProperty(p,"xIMPMINGIO",w_xIMPMINGIO,0);
    ...
    CPLib.PutProperty(p,"dirupl",w_dirupl,0);
    CPLib.PutProperty(p,"ANA_FOUND",w_ANA_FOUND,0);
    if (p_bGetChildren) {
      if (armt_cgo_qadv_operazioni_dl.IsUpdated()) {
        m_cWv_armt_cgo_qadv_operazioni_dl = armt_cgo_qadv_operazioni_dl.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_armt_cgo_qadv_operazioni_dl",m_cWv_armt_cgo_qadv_operazioni_dl,0);
    }
    if (p_bGetChildren) {
  ...
  public boolean ChildExists_armt_cgo_qadv_operazioni_dl() {
    if (armt_cgo_qadv_operazioni_dl.IsUpdated() || (CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_dl) || CPLib.IsLoaded(m_cWv_armt_cgo_qadv_operazioni_dl))) {
      return true;
    } else if (m_bLoaded &&  ! (armt_cgo_qadv_operazioni_dl.m_bLoaded)) {
      armt_cgo_qadv_operazioni_dl.Blank();
      armt_cgo_qadv_operazioni_dl.w_SNAINUMOPE = w_SNAINUMOPE;
      armt_cgo_qadv_operazioni_dl.Load();
    }
    return armt_cgo_qadv_operazioni_dl.m_bLoaded;
  }
  public void CtxLoad_armt_cgo_qadv_operazioni_dl() {
    if ( ! (armt_cgo_qadv_operazioni_dl.m_lCtxLoaded)) {
      armt_cgo_qadv_operazioni_dl.Blank();
    }
    armt_cgo_qadv_operazioni_dl.m_lCtxLoaded = true;
    if ( ! (armt_cgo_qadv_operazioni_dl.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_dl) || CPLib.IsLoaded(m_cWv_armt_cgo_qadv_operazioni_dl)) {
        armt_cgo_qadv_operazioni_dl.SetFromContext(m_cWv_armt_cgo_qadv_operazioni_dl);
        m_cWv_armt_cgo_qadv_operazioni_dl = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (armt_cgo_qadv_operazioni_dl.m_bLoaded)) {
          armt_cgo_qadv_operazioni_dl.Blank();
          armt_cgo_qadv_operazioni_dl.w_SNAINUMOPE = w_SNAINUMOPE;
          armt_cgo_qadv_operazioni_dl.Load();
          if ( ! (armt_cgo_qadv_operazioni_dl.m_bLoaded)) {
            armt_cgo_qadv_operazioni_dl.Initialize();
            armt_cgo_qadv_operazioni_dl.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"armt_cgo_qadv_operazioni_dl")) {
      CtxLoad_armt_cgo_qadv_operazioni_dl();
      return armt_cgo_qadv_operazioni_dl;
    }
