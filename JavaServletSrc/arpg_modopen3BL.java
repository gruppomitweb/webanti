...
public class arpg_modopen3BL extends arpg_modopen3WV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_modopen3";
  ...
  public arpg_modopen3BL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_modopen3","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
