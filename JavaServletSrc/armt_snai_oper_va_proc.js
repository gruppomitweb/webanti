...
if(c=Ctrl('UQLWTKHQTJ')) selectRadio(c,w_CGOFLGVNP,'C')
...
function UQLWTKHQTJ_Valid(e) {
if (Eq(m_cFunction,'query')) {
DoQuery('CGOFLGVNP','C',w_CGOFLGVNP,HtW(getRadioValue(Ctrl('UQLWTKHQTJ')),'C'));
} else {
e=(Ne(e,null)?e:window.event);
var l_bSetResult;
l_bSetResult=Set_CGOFLGVNP(HtW(getRadioValue(Ctrl('UQLWTKHQTJ')),'C'),null,e);
return l_bSetResult;
}
}
...
function UQLWTKHQTJ_wrap_Valid(event) {
return UQLWTKHQTJ_Valid(event);
}
SPBOUILib.SetRadioClick('UQLWTKHQTJ',UQLWTKHQTJ_wrap_Valid);
...
w_PrtDocAll.raiseEvent('armt_snai_oper_va_'+Strtran(p_cEvent,' ','_'));
}
}
...
FocusFirstComponent.edit={"page_1":["UQLWTKHQTJ"]};
FocusFirstComponent.query={"page_1":["UQLWTKHQTJ"],"page_3":["MVSSLZXHUW"]};
FocusFirstComponent.otherwise={"page_1":["UQLWTKHQTJ"]};
function Help() {
windowOpenForeground('../doc/armt_snai_oper_va_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('armt_snai_oper_va',m_cSelectedPage);
...
_Obli('CGOFLGVNP',0,'UQLWTKHQTJ',false,"448095445")
