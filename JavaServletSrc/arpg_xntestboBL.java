...
public class arpg_xntestboBL extends arpg_xntestboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_xntestbo";
  ...
  public arpg_xntestboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_xntestbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
