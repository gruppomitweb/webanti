...
// * --- Fine Area Manuale
public class armt_snai_oper_storicoBO extends armt_snai_oper_storicoBL {
  class SqlLoader {
    public boolean m_bLink_1_4 = false;
    public boolean m_bLink_1_38 = false;
    public boolean m_bLink_1_48 = false;
    public boolean m_bLink_1_82 = false;
    public boolean m_bLink_1_99 = false;
    public boolean m_bLink_1_101 = false;
    public boolean m_bLink_1_129 = false;
    public boolean m_bLink_1_187 = false;
    public boolean m_bLink_1_191 = false;
    public boolean m_bLink_1_199 = false;
    double m_nColumns = 0;
    CPSql m_Sql;
    String m_cServer;
    String m_cMainTable;
    ...
    public void AddJoinedLink_1_82(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_82.CODICE AS CODICE182";
        m_cSelect = m_cSelect+" ,link_1_82.DES1 AS DES1182";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_82","TIPOOPRAP","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_82","TIPOOPRAP","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_99(String rightTable,String rightServer) {
      // questo link aggiunge 6 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+6,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_99.CODINTER AS CODINTER199";
        m_cSelect = m_cSelect+" ,link_1_99.DATANASC AS DATANASC199";
        m_cSelect = m_cSelect+" ,link_1_99.CODCAB AS CODCAB199";
        m_cSelect = m_cSelect+" ,link_1_99.PROVINCIA AS PROVINCIA199";
        m_cSelect = m_cSelect+" ,link_1_99.DESCCIT AS DESCCIT199";
        m_cSelect = m_cSelect+" ,link_1_99.CGOFLGPROF AS CGOFLGPROF199";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_99","CODINTER","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_99","CODINTER","CODINTER",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_101(String rightTable,String rightServer) {
      // questo link aggiunge 7 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+7,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_101.CODDIP AS CODDIP201";
        m_cSelect = m_cSelect+" ,link_1_101.DESCRIZ AS DESCRIZ201";
        m_cSelect = m_cSelect+" ,link_1_101.DESCCIT AS DESCCIT201";
        m_cSelect = m_cSelect+" ,link_1_101.PROVINCIA AS PROVINCIA201";
        m_cSelect = m_cSelect+" ,link_1_101.CAB AS CAB201";
        m_cSelect = m_cSelect+" ,link_1_101.TELEFONO AS TELEFONO201";
        m_cSelect = m_cSelect+" ,link_1_101.CODLOC AS CODLOC201";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_101","CODDIPE","CODDIP");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_101","CODDIPE","CODDIP",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_129(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_129.CODVOC AS CODVOC229";
        m_cSelect = m_cSelect+" ,link_1_129.DESCRIZ AS DESCRIZ229";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_129","CODVOC","CODVOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_129","CODVOC","CODVOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_187(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_187.TIPDOC AS TIPDOC287";
        m_cSelect = m_cSelect+" ,link_1_187.DESCRI AS DESCRI287";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_187","TIPODOC","TIPDOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_187","TIPODOC","TIPDOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_191(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_191.ARCODICE AS ARCODICE291";
        m_cSelect = m_cSelect+" ,link_1_191.ARDESCRI AS ARDESCRI291";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_191","RDCODAUT","ARCODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_191","RDCODAUT","ARCODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_199(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_199.CODSTA AS CODSTA299";
        m_cSelect = m_cSelect+" ,link_1_199.DESCRI AS DESCRI299";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_199","PAESE2","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_199","PAESE2","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_snai_oper_storicoBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_snai_oper_storico");
    }
  ...
  public boolean CanSave() {
    ...
    if (l_bResult) {
      ...
      if (l_bResult) {
        l_bResult = CanSaveChild(armt_cgo_qadv_operazioni_storico,m_cWv_armt_cgo_qadv_operazioni_storico,"m_cWv_armt_cgo_qadv_operazioni_storico");
        if (l_bResult) {
  ...
  public boolean Save(boolean p_bAlreadyAccepted) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (armt_cgo_qadv_operazioni_storico.IsUpdated()) && CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_storico)) {
          ...
          if (armt_cgo_qadv_operazioni_storico.IsUpdated()) {
            ...
            if ( ! (armt_cgo_qadv_operazioni_storico.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
  ...
  public boolean Load(String p_SNAINUMOPE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_cgo_operazioni_storico,m_cPhName_cgo_operazioni_storico,m_cVirtName_cgo_operazioni_storico,m_cVirtName_cgo_operazioni_storico+".SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_SNAINUMOPE,"C",15,0),m_cServer_cgo_operazioni_storico,p_SNAINUMOPE),"");
    ...
    l_oSqlLoader.AddJoinedLink_1_82(m_cPhName_tbtipreg,m_cServer_tbtipreg);
    l_oSqlLoader.AddJoinedLink_1_99(m_cPhName_intermbo,m_cServer_intermbo);
    l_oSqlLoader.AddJoinedLink_1_101(m_cPhName_anadip,m_cServer_anadip);
    l_oSqlLoader.AddJoinedLink_1_129(m_cPhName_tbcausin,m_cServer_tbcausin);
    l_oSqlLoader.AddJoinedLink_1_187(m_cPhName_cgo_tipdoc,m_cServer_cgo_tipdoc);
    l_oSqlLoader.AddJoinedLink_1_191(m_cPhName_cgo_autorita,m_cServer_cgo_autorita);
    l_oSqlLoader.AddJoinedLink_1_199(m_cPhName_tbstati,m_cServer_tbstati);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_82) {
          w_xdes1 = l_rsLoad.GetString("DES1182");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_99) {
          w_datpaseuro = l_rsLoad.GetDate("DATANASC199");
          w_CABINT = l_rsLoad.GetString("CODCAB199");
          w_PROVINT = l_rsLoad.GetString("PROVINCIA199");
          w_CITINT = l_rsLoad.GetString("DESCCIT199");
          w_xCGOFLGPROF = l_rsLoad.GetString("CGOFLGPROF199");
        } else {
          Link_WJSVGWKSFC("Load");
        }
        w_CODDIPE = l_rsLoad.GetString("CODDIPE");
        if (l_oSqlLoader.m_bLink_1_101) {
          w_xDescDipe = l_rsLoad.GetString("DESCRIZ201");
          w_CITDIP = l_rsLoad.GetString("DESCCIT201");
          w_PROVDIP = l_rsLoad.GetString("PROVINCIA201");
          w_CABDIP = l_rsLoad.GetString("CAB201");
          w_TELDIP = l_rsLoad.GetString("TELEFONO201");
          w_CODLOC = l_rsLoad.GetString("CODLOC201");
        } else {
        ...
        w_CODVOC = l_rsLoad.GetString("CODVOC");
        if (l_oSqlLoader.m_bLink_1_129) {
          w_xdesccausin = l_rsLoad.GetString("DESCRIZ229");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_187) {
          w_DESCRI = l_rsLoad.GetString("DESCRI287");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_191) {
          w_xARDESCRI = l_rsLoad.GetString("ARDESCRI291");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_199) {
          w_dessta2 = l_rsLoad.GetString("DESCRI299");
        } else {
        ...
        w_FLGSBLOCCO = l_rsLoad.GetString("FLGSBLOCCO");
        ...
        armt_cgo_qadv_operazioni_storico.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_operazioni_storico")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_cgo_operazioni_storico);
      l_cSql = "insert into "+m_oWrInfo_cgo_operazioni_storico.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+"FLGSBLOCCO,";
      l_cSql = l_cSql+"SEGNO,";
      l_cSql = l_cSql+"PROFESSIONE,";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsNameToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_cgo_operazioni_storico.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_operazioni_storico")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_FLGSBLOCCO,"C",1,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_SEGNO,"C",1,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_PROFESSIONE,"C",40,0)+", ";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsValueToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_cgo_operazioni_storico.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_operazioni_storico")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_cgo_operazioni_storico,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_cgo_operazioni_storico);
      l_cSql = "Update "+m_oWrInfo_cgo_operazioni_storico.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+", FLGSBLOCCO = "+CPLib.ToSQL(w_FLGSBLOCCO,"C",1,0);
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_SNAINUMOPE,"C",15,0),m_cServer_cgo_operazioni_storico,w_SNAINUMOPE);
      l_cSql = l_cSql+m_oWrInfo_cgo_operazioni_storico.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_operazioni_storico")) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          armt_cgo_qadv_operazioni_storico.w_SNAINUMOPE = w_SNAINUMOPE;
          armt_cgo_qadv_operazioni_storico.Delete();
        }
        CPLib.DeleteMNTs(m_Sql,m_MNTs,this);
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_cgo_operazioni_storico.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_SNAINUMOPE,"C",15,0),m_cServer_cgo_operazioni_storico,w_SNAINUMOPE);
          l_cSql = l_cSql+m_oWrInfo_cgo_operazioni_storico.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_operazioni_storico")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_cgo_operazioni_storico,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    ...
    if (CPLib.eq(p_cID,"QZTTRBWAQL")) {
    ...
    } else if (CPLib.eq(p_cID,"PSLKLXOQMT")) {
      result.m_TableName = "tbcitta";
      result.n_KMode = 1;
      result.m_FillEmpty = false;
      result.m_LooselyLinked = false;
      ...
      result.m_kField = new String[]{};
      result.m_kTypes = new String[]{};
      result.AppendFieldsHash("PSLKLXOQMT",CPLib.GetLinkedFieldProps("IDBASE","idcitta2","C",10,0));
    }
    return result;
  }
  // * --- Area Manuale = BO - Methods
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_agechar,arfn_cgo_chkcap,arfn_cgo_chkcc,arfn_cgo_chkdata,arfn_cgo_chkdocs,arfn_cgo_contarm,arfn_chk_docaut,arfn_chkcodfis,arfn_chkiban,arfn_chktotalelire_cont,arfn_form_cf,arfn_maggiorenne,arrt_cgo_confirm_doc,arrt_cgo_delete_doc,arrt_cgo_read_flgope,arrt_cgo_setpagatore_c,arrt_cgo_update_po,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_agechar,arfn_cgo_chkcap,arfn_cgo_chkcc,arfn_cgo_chkdata,arfn_cgo_chkdocs,arfn_cgo_contarm,arfn_chk_docaut,arfn_chkcodfis,arfn_chkiban,arfn_chktotalelire_cont,arfn_form_cf,arfn_maggiorenne,arrt_cgo_confirm_doc,arrt_cgo_delete_doc,arrt_cgo_read_flgope,arrt_cgo_setpagatore_c,arrt_cgo_update_po,arrt_writelog,";
}
