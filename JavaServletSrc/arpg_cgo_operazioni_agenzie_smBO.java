...
// * --- Fine Area Manuale
public class arpg_cgo_operazioni_agenzie_smBO extends arpg_cgo_operazioni_agenzie_smBL {
  ...
  public arpg_cgo_operazioni_agenzie_smBO (CPContext p_ContextObject) {
    ...
    if (m_bQuery) {
      while ( ! (l_bEof) &&  ! (m_bExitRow)) {
        ...
        if ( ! (l_bEof) &&  ! (m_bExitRow)) {
          ...
          c_CACODICE = rs.GetString("CACODICE");
          c_TRDESREG = rs.GetString("TRDESREG");
