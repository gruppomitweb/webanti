...
public class ardt_xerzistiopeBL extends ardt_xerzistiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xerzistiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_xerzistiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xerzistiope;
  ...
  public static String[] m_EntityTables = {"xerzistiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_xerzistiope",true,true)+"}"+FoundlingChildrenList("ardt_xerzistiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_xerzistiope",true,true)+"}"+FoundlingChildrenList("ardt_xerzistiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_xerzistiope",false,true)+"]"+FoundlingChildrenList("ardt_xerzistiope",false,false)+"";
  ...
  public ardt_xerzistiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xerzistiope = p_ContextObject.GetPhName("xerzistiope",p_ContextObject.GetCompany(),false);
    m_cServer_xerzistiope = p_ContextObject.GetServer("xerzistiope");
    m_oWrInfo_xerzistiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xerzistiope",p_ContextObject.GetCompany());
    m_cVirtName_xerzistiope = CPSql.ManipulateTablePhName("xerzistiope",m_cServer_xerzistiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xerzistiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xerzistiope","xerzistiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xerzistiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xerzistiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xerzistiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xerzistiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xerzistiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xerzistiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xerzistiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xerzistiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
