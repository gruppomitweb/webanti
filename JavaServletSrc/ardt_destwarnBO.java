...
// * --- Fine Area Manuale
public class ardt_destwarnBO extends ardt_destwarnBL {
  ...
  // * --- Fine Area Manuale
  public ardt_destwarnBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"ardt_destwarn");
    }
