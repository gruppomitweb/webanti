...
// * --- Fine Area Manuale
public class arrt_copiaoperazioneR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_copiaoperazioneR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_copiaoperazione",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* w_FLAGRAP2 Char(1) // Stato Registrazione */
      ...
      while ( ! (Cursor_operazbo.Eof())) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arrt_copiaoperazione",62,"0000001A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        Cursor_sogopebo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDFILEBO="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"?",0,0,m_cServer, m_oParameters),m_cServer,w_IDBASE)+" "+")"+(m_Ctx.IsSharedTemp("sogopebo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
        while ( ! (Cursor_sogopebo.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_copiaoperazione",62,"0000001C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        Cursor_clientiope = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDFILEBO="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"?",0,0,m_cServer, m_oParameters),m_cServer,w_IDBASE)+" "+")"+(m_Ctx.IsSharedTemp("clientiope")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
        while ( ! (Cursor_clientiope.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_copiaoperazione",62,"0000001E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        while ( ! (Cursor_beneficope.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_copiaoperazione",62,"00000020")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        while ( ! (Cursor_terzistiope.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_copiaoperazione",62,"00000022")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        Cursor_operazbo_agg = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"?",0,0,m_cServer, m_oParameters),m_cServer,w_IDBASE)+" "+")"+(m_Ctx.IsSharedTemp("operazbo_agg")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
        while ( ! (Cursor_operazbo_agg.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_copiaoperazione",62,"00000024")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        Cursor_operazbo_agg.Close();
        // * --- End Select
        /* w_OPERAZMOD := operazbo->IDEREG // Operazione Modificata */
        w_OPERAZMOD = Cursor_operazbo.GetString("IDEREG");
        ...
        /* w_IDEREG := 'O'+Right(w_NUMPROG,9)+w_IDBASE2 // Stato Registrazione */
        w_IDEREG = "O"+CPLib.Right(w_NUMPROG,9)+w_IDBASE2;
        /* w_DATARETT := Date() */
  ...
  public static arrt_copiaoperazioneR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_copiaoperazioneR(p_Ctx, p_Caller);
  }
  public void Blank() {
