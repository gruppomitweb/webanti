...
// * --- Fine Area Manuale
public class armt_cgo_oper_multiBO extends armt_cgo_oper_multiBL {
  class SqlLoader {
    ...
    public boolean m_bLink_1_134 = false;
    public boolean m_bLink_1_173 = false;
    ...
    public void AddJoinedLink_1_134(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_134.CODVOC AS CODVOC234";
        m_cSelect = m_cSelect+" ,link_1_134.DESCRIZ AS DESCRIZ234";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_134","CODVOC","CODVOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_134","CODVOC","CODVOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_173(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_173.CODICE AS CODICE273";
        m_cSelect = m_cSelect+" ,link_1_173.DESCRI AS DESCRI273";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_173","ATTIV","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_173","ATTIV","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_cgo_oper_multiBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_cgo_oper_multi");
    }
  ...
  public boolean CanSave() {
    ...
    if (l_bResult) {
      l_bResult = CanSaveChild(ardt_cgo_oper_multi,m_cWv_ardt_cgo_oper_multi,"m_cWv_ardt_cgo_oper_multi");
      if (l_bResult) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_cgo_oper_multi.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi)) {
          ...
          if (ardt_cgo_oper_multi.IsUpdated()) {
            ...
            if ( ! (ardt_cgo_oper_multi.Save(true))) {
  ...
  public boolean Load(String p_SNAINUMOPE) {
    ...
    l_oSqlLoader.AddJoinedLink_1_134(m_cPhName_tbcausin,m_cServer_tbcausin);
    l_oSqlLoader.AddJoinedLink_1_173(m_cPhName_tbtipatt,m_cServer_tbtipatt);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        w_CODVOC = l_rsLoad.GetString("CODVOC");
        if (l_oSqlLoader.m_bLink_1_134) {
          w_xdesccausin = l_rsLoad.GetString("DESCRIZ234");
        } else {
          Link_LKEDJRUQJU("Load");
        }
        w_CODCAB = l_rsLoad.GetString("CODCAB");
        w_ATTIV = l_rsLoad.GetString("ATTIV");
        if (l_oSqlLoader.m_bLink_1_173) {
          w_xdesctipatt = l_rsLoad.GetString("DESCRI273");
        } else {
        ...
        ardt_cgo_oper_multi.m_lCtxLoaded = false;
  ...
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    ...
    if (CPLib.eq(p_cID,"QZTTRBWAQL")) {
      ...
      result.AppendFieldsHash("QZTTRBWAQL",CPLib.GetLinkedFieldProps("CODTPGIO","TIPOGIOCO","C",3,0),CPLib.GetLinkedFieldProps("SOGTPGIO","xSOGTPGIO","N",12,2),CPLib.GetLinkedFieldProps("DEFTPGIO","xDEFTPGIO","C",1,0),CPLib.GetLinkedFieldProps("EDTTPGIO","xEDTTPGIO","C",1,0),CPLib.GetLinkedFieldProps("EDTSPGIO","xEDTSPGIO","C",1,0),CPLib.GetLinkedFieldProps("DEFSPGIO","xDEFSPGIO","C",1,0),CPLib.GetLinkedFieldProps("FLGPLGIO","xFLGPLGIO","C",1,0),CPLib.GetLinkedFieldProps("FLTIPGIO","CGOTIPOPE","C",1,0),CPLib.GetLinkedFieldProps("IMPMINTOT","xIMPMINTOT","N",12,2));
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_agechar,arfn_cgo_chkcap,arfn_cgo_chkcc,arfn_cgo_chkdata,arfn_cgo_chkdocs,arfn_chk_docaut,arfn_chkcodfis,arfn_chkiban,arfn_chktotalelire_cont,arfn_form_cf,arrt_cgo_confirm_doc,arrt_cgo_read_flgope,arrt_cgo_save_multi_dl,arrt_cgo_setpagatore_m,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_agechar,arfn_cgo_chkcap,arfn_cgo_chkcc,arfn_cgo_chkdata,arfn_cgo_chkdocs,arfn_chk_docaut,arfn_chkcodfis,arfn_chkiban,arfn_chktotalelire_cont,arfn_form_cf,arrt_cgo_confirm_doc,arrt_cgo_read_flgope,arrt_cgo_save_multi_dl,arrt_cgo_setpagatore_m,arrt_writelog,";
}
