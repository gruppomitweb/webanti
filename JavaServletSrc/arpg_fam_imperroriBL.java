...
public class arpg_fam_imperroriBL extends arpg_fam_imperroriWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fam_imperrori";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile}";
  ...
  public arpg_fam_imperroriBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fam_imperrori","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
