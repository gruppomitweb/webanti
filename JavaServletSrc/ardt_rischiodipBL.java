...
public class ardt_rischiodipBL extends ardt_rischiodipWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_rischiodip";
  ...
  public String m_cPhName_rischiodip;
  public String m_cServer_rischiodip;
  public CPPhTableWrInfo m_oWrInfo_rischiodip;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_rischiodip;
  ...
  public static String[] m_EntityTables = {"rischiodip"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CODDIP':CODDIP,'m_Detail':{'TIPOANALISI':TIPOANALISI,'DATAINI':DATAINI,'DATFIN':DATFIN,'RISGLOB':RISGLOB"+FoundlingChildrenList("ardt_rischiodip",true,true)+"}"+FoundlingChildrenList("ardt_rischiodip",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'CODDIP':CODDIP,'m_Detail':{'TIPOANALISI':TIPOANALISI,'DATAINI':DATAINI,'DATFIN':DATFIN,'RISGLOB':RISGLOB"+FoundlingChildrenList("ardt_rischiodip",true,true)+"}"+FoundlingChildrenList("ardt_rischiodip",true,false)+"}";
  public static final String i_ItemSequence = "CODDIP,m_Detail[ TIPOANALISI DATAINI DATFIN RISGLOB"+FoundlingChildrenList("ardt_rischiodip",false,true)+"]"+FoundlingChildrenList("ardt_rischiodip",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_rischiodip"),new String[][]{new String[]{"CODDIP","Codice Dipendenza","C","6","0","campo","key1","false","false"},new String[]{"TIPOANALISI","Annuale, Semestrale, ecc.","C","1","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio Analisi","D","8","0","campo","key1","true","false"},new String[]{"DATFIN","Data Fine Analisi","D","8","0","campo","nokey","true","false"},new String[]{"RISGLOB","Rischio","C","1","0","campo","nokey","true","false"}});
  public static final String i_TrsKeys = ",TIPOANALISI,DATAINI";
  ...
  public ardt_rischiodipBL (CPContext p_ContextObject) {
    ...
    m_cPhName_rischiodip = p_ContextObject.GetPhName("rischiodip",p_ContextObject.GetCompany(),false);
    m_cServer_rischiodip = p_ContextObject.GetServer("rischiodip");
    m_oWrInfo_rischiodip = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"rischiodip",p_ContextObject.GetCompany());
    m_cVirtName_rischiodip = CPSql.ManipulateTablePhName("rischiodip",m_cServer_rischiodip);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_rischiodip",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Set_TIPOANALISI(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_TIPOANALISI = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_DATFIN(java.sql.Date p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DATFIN = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_rischiodip","rischiodip",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_TIPOANALISI;
      p_TIPOANALISI = CPLib.GetProperties(trs_p.getProperty("TIPOANALISI"),new Properties());
      Properties p_DATAINI;
      p_DATAINI = CPLib.GetProperties(trs_p.getProperty("DATAINI"),new Properties());
      Properties p_DATFIN;
      p_DATFIN = CPLib.GetProperties(trs_p.getProperty("DATFIN"),new Properties());
      Properties p_RISGLOB;
      p_RISGLOB = CPLib.GetProperties(trs_p.getProperty("RISGLOB"),new Properties());
      Properties p_opk_TIPOANALISI;
      p_opk_TIPOANALISI = CPLib.GetProperties(trs_p.getProperty("opk_TIPOANALISI"),new Properties());
      Properties p_opk_DATAINI;
      p_opk_DATAINI = CPLib.GetProperties(trs_p.getProperty("opk_DATAINI"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        w_TIPOANALISI = "";
        w_TIPOANALISI = CPLib.GetProperty(p_TIPOANALISI,"",w_TIPOANALISI,i);
        w_DATAINI = CPLib.NullDate();
        w_DATAINI = CPLib.GetProperty(p_DATAINI,"",w_DATAINI,i);
        w_DATFIN = CPLib.NullDate();
        w_DATFIN = CPLib.GetProperty(p_DATFIN,"",w_DATFIN,i);
        w_RISGLOB = "";
        w_RISGLOB = CPLib.GetProperty(p_RISGLOB,"",w_RISGLOB,i);
        opk_TIPOANALISI = CPLib.GetProperty(p_opk_TIPOANALISI,"","",i);
        opk_DATAINI = CPLib.GetProperty(p_opk_DATAINI,"",CPLib.NullDate(),i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"CODDIP")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"TIPOANALISI")) {
      SetUpdatedRow();
      return;
    }
    ...
    if (CPLib.eq(p_cName,"DATFIN")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"RISGLOB")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_rischiodip",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_rischiodip",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_rischiodip",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_rischiodip",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_rischiodip"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_rischiodip\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_TIPOANALISI;
    p_TIPOANALISI = new Properties();
    Properties p_DATAINI;
    p_DATAINI = new Properties();
    Properties p_DATFIN;
    p_DATFIN = new Properties();
    Properties p_RISGLOB;
    p_RISGLOB = new Properties();
    Properties p_opk_TIPOANALISI;
    p_opk_TIPOANALISI = new Properties();
    Properties p_opk_DATAINI;
    p_opk_DATAINI = new Properties();
    Properties p_m_nRowStatus;
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_TIPOANALISI,"",w_TIPOANALISI,trsrow);
      CPLib.PutProperty(p_DATAINI,"",w_DATAINI,trsrow);
      CPLib.PutProperty(p_DATFIN,"",w_DATFIN,trsrow);
      CPLib.PutProperty(p_RISGLOB,"",w_RISGLOB,trsrow);
      CPLib.PutProperty(p_opk_TIPOANALISI,"",opk_TIPOANALISI,trsrow);
      CPLib.PutProperty(p_opk_DATAINI,"",opk_DATAINI,trsrow);
    ...
    trs_p.setProperty("TIPOANALISI",CPLib.ToProperties(p_TIPOANALISI));
    trs_p.setProperty("DATAINI",CPLib.ToProperties(p_DATAINI));
    trs_p.setProperty("DATFIN",CPLib.ToProperties(p_DATFIN));
    trs_p.setProperty("RISGLOB",CPLib.ToProperties(p_RISGLOB));
    trs_p.setProperty("opk_TIPOANALISI",CPLib.ToProperties(p_opk_TIPOANALISI));
    trs_p.setProperty("opk_DATAINI",CPLib.ToProperties(p_opk_DATAINI));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "rischiodip"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CODDIP","C",6,0));
  }
  public String RowPrimaryKey() {
    return "rischiodip"+"\\"+CPLib.ToCPStr(w_TIPOANALISI)+"\\"+CPLib.ToCPStr(w_DATAINI);
  }
  ...
  protected void TrsToWork() {
    w_TIPOANALISI= m_oTrs.get(m_nCurrentRow).w_TIPOANALISI;
    w_DATAINI= m_oTrs.get(m_nCurrentRow).w_DATAINI;
    w_DATFIN= m_oTrs.get(m_nCurrentRow).w_DATFIN;
    w_RISGLOB= m_oTrs.get(m_nCurrentRow).w_RISGLOB;
    opk_TIPOANALISI= m_oTrs.get(m_nCurrentRow).opk_TIPOANALISI;
    opk_DATAINI= m_oTrs.get(m_nCurrentRow).opk_DATAINI;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_TIPOANALISI=w_TIPOANALISI;
    m_oTrs.get(m_nCurrentRow).w_DATAINI=w_DATAINI;
    m_oTrs.get(m_nCurrentRow).w_DATFIN=w_DATFIN;
    m_oTrs.get(m_nCurrentRow).w_RISGLOB=w_RISGLOB;
    m_oTrs.get(m_nCurrentRow).opk_TIPOANALISI=opk_TIPOANALISI;
    m_oTrs.get(m_nCurrentRow).opk_DATAINI=opk_DATAINI;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_TIPOANALISI=w_TIPOANALISI;
    m_oDeletedRows.get(l_nRows).w_DATAINI=w_DATAINI;
    m_oDeletedRows.get(l_nRows).w_DATFIN=w_DATFIN;
    m_oDeletedRows.get(l_nRows).w_RISGLOB=w_RISGLOB;
    m_oDeletedRows.get(l_nRows).opk_TIPOANALISI=opk_TIPOANALISI;
    m_oDeletedRows.get(l_nRows).opk_DATAINI=opk_DATAINI;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_TIPOANALISI));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_TIPOANALISI= m_oDeletedRows.get(l_RowNumberToSet).w_TIPOANALISI;
    w_DATAINI= m_oDeletedRows.get(l_RowNumberToSet).w_DATAINI;
    w_DATFIN= m_oDeletedRows.get(l_RowNumberToSet).w_DATFIN;
    w_RISGLOB= m_oDeletedRows.get(l_RowNumberToSet).w_RISGLOB;
    opk_TIPOANALISI= m_oDeletedRows.get(l_RowNumberToSet).opk_TIPOANALISI;
    opk_DATAINI= m_oDeletedRows.get(l_RowNumberToSet).opk_DATAINI;
