...
public class arpg_cgo_soggetti_errBL extends arpg_cgo_soggetti_errWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_PRGSOG;
    public String c_CONNES;
    public String c_COGNOME;
    public String c_NOME;
    public java.sql.Date c_DATANASC;
    public String c_NASCOMUN;
    public String c_TXTERR;
  ...
  public static final String i_EntityName = "arpg_cgo_soggetti_err";
  ...
  public arpg_cgo_soggetti_errBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_soggetti_err","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_PRGSOG=c_PRGSOG;
    ...
    m_oTrs.get(m_nCurrentRow).c_DATANASC=c_DATANASC;
    m_oTrs.get(m_nCurrentRow).c_NASCOMUN=c_NASCOMUN;
    m_oTrs.get(m_nCurrentRow).c_TXTERR=c_TXTERR;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_PRGSOG= m_oTrs.get(m_nCurrentRow).c_PRGSOG;
    ...
    c_DATANASC= m_oTrs.get(m_nCurrentRow).c_DATANASC;
    c_NASCOMUN= m_oTrs.get(m_nCurrentRow).c_NASCOMUN;
    c_TXTERR= m_oTrs.get(m_nCurrentRow).c_TXTERR;
