...
public class arpg_list_procsBL extends arpg_list_procsWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_PR_TIPO;
    public String c_PRCODICE;
    public String c_PRDESCRI;
    public java.sql.Timestamp c_PRDOSTART;
    public java.sql.Timestamp c_PRDOSTOP;
    public String c_PRESITO;
  ...
  public static final String i_EntityName = "arpg_list_procs";
  ...
  public arpg_list_procsBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_list_procs","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_PR_TIPO=c_PR_TIPO;
    m_oTrs.get(m_nCurrentRow).c_PRCODICE=c_PRCODICE;
    m_oTrs.get(m_nCurrentRow).c_PRDESCRI=c_PRDESCRI;
    m_oTrs.get(m_nCurrentRow).c_PRDOSTART=c_PRDOSTART;
    m_oTrs.get(m_nCurrentRow).c_PRDOSTOP=c_PRDOSTOP;
    m_oTrs.get(m_nCurrentRow).c_PRESITO=c_PRESITO;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_PR_TIPO= m_oTrs.get(m_nCurrentRow).c_PR_TIPO;
    c_PRCODICE= m_oTrs.get(m_nCurrentRow).c_PRCODICE;
    c_PRDESCRI= m_oTrs.get(m_nCurrentRow).c_PRDESCRI;
    c_PRDOSTART= m_oTrs.get(m_nCurrentRow).c_PRDOSTART;
    c_PRDOSTOP= m_oTrs.get(m_nCurrentRow).c_PRDOSTOP;
    c_PRESITO= m_oTrs.get(m_nCurrentRow).c_PRESITO;
