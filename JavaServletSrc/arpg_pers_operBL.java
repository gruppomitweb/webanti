...
public class arpg_pers_operBL extends arpg_pers_operWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_pers_oper";
  ...
  public arpg_pers_operBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_pers_oper","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
