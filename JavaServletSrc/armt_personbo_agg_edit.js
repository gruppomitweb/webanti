...
if ( ! (m_oFather.SaveContext_armt_personbo_agg())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_personbo_agg_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_personbo_agg_dataNotSent',{'action':formaction});
}
}
}
}
...
_FillChildren.n=[];
FillWv.n=["CONNES","EMAIL","FLGEMAIL","TELEFONO","FLGVALIDO","FLGANAVAL","CLOCCUPA","NAZIONE","CLPRVDOM","REGRES","FLGBL","CATEG01","CATEG02","CATEG03","CATEG04","CATEG05","FLGPREGIUD","FLGTRUST","FLGRISCHIO","FLGFALSADIC","FLGEQUIFIN","FLGRICINF","CATEGORIA","NUMCEL","PEC","REFERENTE","CONALTO","APPALTO","gTipInter","xDesNaz","xC1DESCRI","xC2DESCRI","xC3DESCRI","xC4DESCRI","xC5DESCRI"];
function SetModified() {
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_personbo_agg();
}
}
