...
public class arpg_frazioboBL extends arpg_frazioboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fraziobo";
  ...
  public arpg_frazioboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fraziobo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
