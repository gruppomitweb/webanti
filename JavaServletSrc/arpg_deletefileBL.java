...
public class arpg_deletefileBL extends arpg_deletefileWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_deletefile";
  ...
  public arpg_deletefileBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_deletefile","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
