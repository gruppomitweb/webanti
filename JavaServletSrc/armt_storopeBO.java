...
// * --- Fine Area Manuale
public class armt_storopeBO extends armt_storopeBL {
  class SqlLoader {
    ...
    public void AddJoinedLink_1_23(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_23.RAPPORTO AS RAPPORTO123";
        m_cSelect = m_cSelect+" ,link_1_23.DESCRAP AS DESCRAP123";
        m_cSelect = m_cSelect+" ,link_1_23.TIPORAP AS TIPORAP123";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_23","RAPPORTO","RAPPORTO");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_23","RAPPORTO","RAPPORTO",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_24(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        ...
        m_cSelect = m_cSelect+" ,link_1_24.CODFISC AS CODFISC124";
        m_cSelect = m_cSelect+" ,link_1_24.DATAVALI AS DATAVALI124";
        m_cSelect = m_cSelect+" ,link_1_24.DATARILASC AS DATARILASC124";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_24","CONNESCLI","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_24","CONNESCLI","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_25(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_25","CONNESOPER","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_25","CONNESOPER","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_28(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_28","CONNESBEN","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_28","CONNESBEN","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_29(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_29","CONNALTRO","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_29","CONNALTRO","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_36(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_36.CODSTA AS CODSTA136";
        m_cSelect = m_cSelect+" ,link_1_36.DESCRI AS DESCRI136";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_36","C_STA","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_36","C_STA","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_40(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_40.CODSTA AS CODSTA140";
        m_cSelect = m_cSelect+" ,link_1_40.DESCRI AS DESCRI140";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_40","PAESE","CODSTA");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_40","PAESE","CODSTA",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_50(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_50.CODINTER AS CODINTER150";
        m_cSelect = m_cSelect+" ,link_1_50.DATANASC AS DATANASC150";
        m_cSelect = m_cSelect+" ,link_1_50.CODCAB AS CODCAB150";
        m_cSelect = m_cSelect+" ,link_1_50.PROVINCIA AS PROVINCIA150";
        m_cSelect = m_cSelect+" ,link_1_50.DESCCIT AS DESCCIT150";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_50","CODINTER","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_50","CODINTER","CODINTER",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_52(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_52.CODDIP AS CODDIP152";
        m_cSelect = m_cSelect+" ,link_1_52.DESCRIZ AS DESCRIZ152";
        m_cSelect = m_cSelect+" ,link_1_52.DESCCIT AS DESCCIT152";
        m_cSelect = m_cSelect+" ,link_1_52.PROVINCIA AS PROVINCIA152";
        m_cSelect = m_cSelect+" ,link_1_52.CAB AS CAB152";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_52","CODDIPE","CODDIP");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_52","CODDIPE","CODDIP",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_167(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_167.CODVOC AS CODVOC267";
        m_cSelect = m_cSelect+" ,link_1_167.DESCRIZ AS DESCRIZ267";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_167","CODVOC","CODVOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_167","CODVOC","CODVOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_storopeBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_storope");
    }
  ...
  public boolean CanSave() {
    ...
    l_bResult = true;
    if (l_bResult) {
      l_bResult = CanSaveChild(ardt_storsogope,m_cWv_ardt_storsogope,"m_cWv_ardt_storsogope");
      if (l_bResult) {
        l_bResult = CanSaveChild(ardt_wlientiope,m_cWv_ardt_wlientiope,"m_cWv_ardt_wlientiope");
        if (l_bResult) {
          l_bResult = CanSaveChild(ardt_weneficope,m_cWv_ardt_weneficope,"m_cWv_ardt_weneficope");
          if (l_bResult) {
            l_bResult = CanSaveChild(ardt_werzistiope,m_cWv_ardt_werzistiope,"m_cWv_ardt_werzistiope");
            if (l_bResult) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_storsogope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_storsogope)) {
          ...
          if (ardt_storsogope.IsUpdated()) {
            ...
            if ( ! (ardt_storsogope.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_wlientiope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_wlientiope)) {
          ...
          if (ardt_wlientiope.IsUpdated()) {
            ...
            if ( ! (ardt_wlientiope.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_weneficope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_weneficope)) {
          ...
          if (ardt_weneficope.IsUpdated()) {
            ...
            if ( ! (ardt_weneficope.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_werzistiope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_werzistiope)) {
  ...
  public boolean Load(String p_IDBASE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_wperazbo,m_cPhName_wperazbo,m_cVirtName_wperazbo,m_cVirtName_wperazbo+".IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDBASE,"C",10,0),m_cServer_wperazbo,p_IDBASE),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_1_18(m_cPhName_tbvalute,m_cServer_tbvalute);
    l_oSqlLoader.AddJoinedLink_1_23(m_cPhName_anarapbo,m_cServer_anarapbo);
    ...
    l_oSqlLoader.AddJoinedLink_1_36(m_cPhName_tbstati,m_cServer_tbstati);
    l_oSqlLoader.AddJoinedLink_1_40(m_cPhName_tbstati,m_cServer_tbstati);
    l_oSqlLoader.AddJoinedLink_1_50(m_cPhName_intermbo,m_cServer_intermbo);
    l_oSqlLoader.AddJoinedLink_1_52(m_cPhName_anadip,m_cServer_anadip);
    ...
    l_oSqlLoader.AddJoinedLink_1_167(m_cPhName_tbcausin,m_cServer_tbcausin);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_23) {
          w_xdescrap = l_rsLoad.GetString("DESCRAP123");
          w_FLAGRAP = l_rsLoad.GetString("TIPORAP123");
        } else {
          Link_RZIQZFKPUE("Load");
        }
        w_CONNESCLI = l_rsLoad.GetString("CONNESCLI");
        if (l_oSqlLoader.m_bLink_1_24) {
          w_xragsocper = l_rsLoad.GetString("RAGSOC124");
          w_xcodfisc = l_rsLoad.GetString("CODFISC124");
          w_DATAVALI = l_rsLoad.GetDate("DATAVALI124");
          w_DATARILASC = l_rsLoad.GetDate("DATARILASC124");
        } else {
          Link_QBLXDBODXR("Load");
        }
        w_CONNESOPER = l_rsLoad.GetString("CONNESOPER");
        if (l_oSqlLoader.m_bLink_1_25) {
          w_xragsocct = l_rsLoad.GetString("RAGSOC125");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_36) {
          w_dessta = l_rsLoad.GetString("DESCRI136");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_40) {
          w_xdescpaese2 = l_rsLoad.GetString("DESCRI140");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_50) {
          w_datpaseuro = l_rsLoad.GetDate("DATANASC150");
          w_CABINT = l_rsLoad.GetString("CODCAB150");
          w_PROVINT = l_rsLoad.GetString("PROVINCIA150");
          w_CITINT = l_rsLoad.GetString("DESCCIT150");
        } else {
          Link_WJSVGWKSFC("Load");
        }
        w_CODDIPE = l_rsLoad.GetString("CODDIPE");
        if (l_oSqlLoader.m_bLink_1_52) {
          w_xDescDipe = l_rsLoad.GetString("DESCRIZ152");
          w_CITDIP = l_rsLoad.GetString("DESCCIT152");
          w_PROVDIP = l_rsLoad.GetString("PROVINCIA152");
          w_CABDIP = l_rsLoad.GetString("CAB152");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_167) {
          w_xdesccausin = l_rsLoad.GetString("DESCRIZ267");
        } else {
        ...
        ardt_storsogope.m_lCtxLoaded = false;
        m_cWv_ardt_wlientiope = "";
        ardt_wlientiope.m_lCtxLoaded = false;
        m_cWv_ardt_weneficope = "";
        ardt_weneficope.m_lCtxLoaded = false;
        m_cWv_ardt_werzistiope = "";
        ardt_werzistiope.m_lCtxLoaded = false;
        m_cWv_ardt_docopebo = "";
        ardt_docopebo.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"wperazbo")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_wperazbo);
      l_cSql = "insert into "+m_oWrInfo_wperazbo.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_wperazbo.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wperazbo")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_COLLEG,"C",11,0)+", ";
      ...
      l_cSql = l_cSql+m_oWrInfo_wperazbo.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wperazbo")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_wperazbo,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_wperazbo);
      l_cSql = "Update "+m_oWrInfo_wperazbo.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+", COLLEG = "+CPLib.ToSQL(w_COLLEG,"C",11,0);
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_wperazbo,w_IDBASE);
      l_cSql = l_cSql+m_oWrInfo_wperazbo.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"wperazbo")) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          ...
          ardt_storsogope.w_IDFILEBO = w_IDBASE;
          ardt_storsogope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_wlientiope.w_IDFILEBO = w_IDBASE;
          ardt_wlientiope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_weneficope.w_IDFILEBO = w_IDBASE;
          ardt_weneficope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_werzistiope.w_IDFILEBO = w_IDBASE;
          ardt_werzistiope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_docopebo.w_NUMPROG = w_NUMPROG;
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_wperazbo.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_wperazbo,w_IDBASE);
          l_cSql = l_cSql+m_oWrInfo_wperazbo.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"wperazbo")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_wperazbo,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"POPERAZ1","i_codazi,w_IDBASE",m_cServer_wperazbo,m_Ctx.GetCompany());
    ...
    m_Sql.NextTableProg(this,"POPERAZ2","i_codazi,w_NUMPROG",m_cServer_wperazbo,m_Ctx.GetCompany());
    ...
    op_NUMPROG = w_NUMPROG;
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    m_Sql.NextTableProg(this,"PRGIMPOPE","i_codazi,w_PRGIMPOPE",m_cServer_wperazbo,m_Ctx.GetCompany());
    op_PRGIMPOPE = w_PRGIMPOPE;
  }
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    CPLib.SPLinkProperties result = CPLib.GetSPLinkerProperties();
    if (CPLib.eq(p_cID,"SQVJLYRFKQ")) {
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_calcflaglire,arfn_chkdatdoc,arfn_chktotalelire,arfn_chktotalelire_cont,arrt_aggstatoreg,arrt_val_benefic,
  public static final String i_InvokedRoutines = ",arfn_calcflaglire,arfn_chkdatdoc,arfn_chktotalelire,arfn_chktotalelire_cont,arrt_aggstatoreg,arrt_val_benefic,";
}
