...
public class arpg_statoidrapBL extends arpg_statoidrapWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_statoidrap";
  ...
  public arpg_statoidrapBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_statoidrap","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
