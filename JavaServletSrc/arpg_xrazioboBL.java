...
public class arpg_xrazioboBL extends arpg_xrazioboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_xraziobo";
  ...
  public arpg_xrazioboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_xraziobo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
