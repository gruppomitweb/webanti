...
// * --- Fine Area Manuale
public class arrt_loadinfo_aeR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_loadinfo_aeR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_loadinfo_ae",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* pObj Object(armt_ae_rapopeboBO) */
    /* Carica il contesto del figlio */
    /* pObj.CtxLoad_ardt_ae_intestbo() */
    pObj.CtxLoad_ardt_ae_intestbo();
    /* Tenta di lanciare la funzione di caricamento */
    /* pObj.ardt_ae_intestbo.Load(pObj.w_RAPPORTO) */
    pObj.ardt_ae_intestbo.Load(pObj.w_RAPPORTO);
  }
  void _init_() {
  }
  public String RunAsync(armt_ae_rapopeboBO p_pObj) {
    pObj = p_pObj;
  ...
  public Forward Run(armt_ae_rapopeboBO p_pObj) {
    pObj = p_pObj;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_loadinfo_aeR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_loadinfo_aeR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
  }
