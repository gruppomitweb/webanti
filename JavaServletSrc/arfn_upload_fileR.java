...
// * --- Fine Area Manuale
public class arfn_upload_fileR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_upload_fileR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_upload_file",m_Caller);
        ...
        if (FileLibMit.ExistFile(gPathApp+"/"+CPLib.LRTrim(pDirDest)+"/"+CPLib.LRTrim(gAzienda)+"/"+CPLib.LRTrim(pNomeFile))) {
          ...
          if (FileLibMit.DeleteFile("/WEB-INF/Tmp/"+CPLib.LRTrim(pNomeFile))) {
            ...
            if (CPLib.eqr(pFileTmp,"S")) {
              ...
              m_cSql = CPLib.GetSQLPrefixComment("arfn_upload_file",5,"00000010")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  public static arfn_upload_fileR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_upload_fileR(p_Ctx, p_Caller);
  }
  public static arfn_upload_fileR Make(CPContext p_Ctx) {
    return new arfn_upload_fileR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
  ...
  // ENTITY_BATCHES: ,arfn_upload_file,
  public static final String i_InvokedRoutines = ",arfn_upload_file,";
