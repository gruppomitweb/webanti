...
// * --- Fine Area Manuale
public class arrt_lancia_utf8R implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_utf8R (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_utf8",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("arpg_import_utf8",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_utf8R Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_utf8R(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
