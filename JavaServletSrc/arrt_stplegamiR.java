...
// * --- Fine Area Manuale
public class arrt_stplegamiR implements CallerWithObjs {
  ...
  public DateTime dt;
  // * --- Fine Area Manuale
  public arrt_stplegamiR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_stplegami",m_Caller);
  ...
  void Page_1() throws Exception {
    CPResultSet Cursor_qbe_allrapotit=null;
    ...
    try {
      ...
      if (CPLib.eqr(w_tipo,"T")) {
        ...
        _h00000042.Set("DaData",w_DaData);
        _h00000042.Set("AData",w_AData);
        _h00000042.Set("daSocieta",w_daSocieta);
        _h00000042.Set("aSocieta",w_aSocieta);
        _h00000042.Set("attiva",w_attiva);
        _h00000042.Set("mod_attiva",w_mod_attiva);
        _h00000042.Set("cancellata",w_cancellata);
        _h00000042.Set("mod_copia",w_mod_copia);
        m_nUpdatedRows=m_Sql.InsertIntoVQR(CPLib.GetSQLPrefixComment("arrt_stplegami",110,"00000042"),m_oWrInfo,"qbe_allrapotit",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000042,m_Ctx);
        ...
        // * --- Select from qbe_allrapotit
        if (Cursor_qbe_allrapotit!=null)
          Cursor_qbe_allrapotit.Close();
        Cursor_qbe_allrapotit = new VQRHolder("qbe_allrapotit",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_allrapotit.Eof())) {
          /* If Empty(qbe_allrapotit->DATAFINE) */
          if (CPLib.Empty(Cursor_qbe_allrapotit.GetDate("DATAFINE"))) {
            // * --- Insert into tmp_stplegami from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("tmp_stplegami");
            m_cPhName = m_Ctx.GetPhName("tmp_stplegami");
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stplegami",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stplegami",110,"00000045")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000045(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetDate("DATAOPE"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("CONNESCLI"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("RAGSOC"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("COLLEG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetDate("DATAREG"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("STATOREG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("IDEREG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("TIPOLEG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("DESCRIZ"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("TIPOOPRAP"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("DES1"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("DESCINTER"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("RAGTIT"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetDate("DATAINI"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetDate("DATAFINE"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("NUMPROG1"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allrapotit.GetString("NUMPROG2"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+m_oWrInfo.InsertValues();
            m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"tmp_stplegami",true);
            m_cSql = m_cSql+")";
          ...
          Cursor_qbe_allrapotit.Next();
        }
        m_cConnectivityError = Cursor_qbe_allrapotit.ErrorMessage();
        Cursor_qbe_allrapotit.Close();
        // * --- End Select
        /* Case w_tipo='C' */
        ...
        Cursor_qbe_allrapotit = new VQRHolder("qbe_allrapotit",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_allrapotit.Eof())) {
          /* If not(Empty(qbe_allrapotit->DATAFINE)) */
          if ( ! (CPLib.Empty(Cursor_qbe_allrapotit.GetDate("DATAFINE")))) {
            // * --- Insert into tmp_stplegami from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("tmp_stplegami");
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stplegami",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stplegami",110,"00000048")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(w_detana,"S")) {
        ...
        f.SetParameter("w_attiva",w_attiva);
        f.SetParameter("w_mod_attiva",w_mod_attiva);
        f.SetParameter("w_cancellata",w_cancellata);
        f.SetParameter("w_mod_copia",w_mod_copia);
        f.SetParameter("w_DescAzi",gDescAzi);
        f.SetParameter("_tiporep","D");
        f.SetParameter("ReportName","arrp_stplegami2.vrp");
        f.SetParameter("m_cParameterSequence","w_daSocieta"+","+"w_aSocieta"+","+"w_dadata"+","+"w_adata"+","+"w_attiva"+","+"w_mod_attiva"+","+"w_cancellata"+","+"w_mod_copia"+","+"w_DescAzi"+","+"_tiporep"+","+"ReportName");
  ...
  public String RunAsync(String p_w_daSocieta,String p_w_aSocieta,java.sql.Date p_w_DaData,java.sql.Date p_w_AData,String p_w_attiva,String p_w_cancellata,String p_w_detana,String p_w_mod_attiva,String p_w_mod_copia,String p_w_tipo) {
    w_daSocieta = p_w_daSocieta;
    w_aSocieta = p_w_aSocieta;
    w_DaData = p_w_DaData;
    w_AData = p_w_AData;
    w_attiva = p_w_attiva;
    w_cancellata = p_w_cancellata;
    w_detana = p_w_detana;
    w_mod_attiva = p_w_mod_attiva;
    w_mod_copia = p_w_mod_copia;
    w_tipo = p_w_tipo;
  ...
  public Forward Run(String p_w_daSocieta,String p_w_aSocieta,java.sql.Date p_w_DaData,java.sql.Date p_w_AData,String p_w_attiva,String p_w_cancellata,String p_w_detana,String p_w_mod_attiva,String p_w_mod_copia,String p_w_tipo) {
    w_daSocieta = p_w_daSocieta;
    w_aSocieta = p_w_aSocieta;
    w_DaData = p_w_DaData;
    w_AData = p_w_AData;
  ...
  public static arrt_stplegamiR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_stplegamiR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    w_attiva = CPLib.Space(1);
    w_cancellata = CPLib.Space(1);
    w_detana = CPLib.Space(1);
    w_mod_attiva = CPLib.Space(1);
    w_mod_copia = CPLib.Space(1);
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_allrapotit,qbe_allrapotit,qbe_allrapotit,
  public static final String m_cVQRList = ",qbe_allrapotit,qbe_allrapotit,qbe_allrapotit,";
  // ENTITY_BATCHES: ,
  public static final String i_InvokedRoutines = ",";
  public static String[] m_cRunParameterNames={"w_daSocieta","w_aSocieta","w_DaData","w_AData","w_attiva","w_cancellata","w_detana","w_mod_attiva","w_mod_copia","w_tipo"};
  protected static String GetFieldsName_00000045(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    ...
    p_cSql = p_cSql+"RAGTIT,";
    p_cSql = p_cSql+"DATAINI,";
    p_cSql = p_cSql+"DATAFINE,";
    p_cSql = p_cSql+"NUMPROG1,";
    p_cSql = p_cSql+"NUMPROG2,";
    p_cSql = p_cSql+p_oWrInfo.InsertFields();
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"tmp_stplegami",true);
    return p_cSql;
  }
