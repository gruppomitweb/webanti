...
public class arpg_trasfinfoBL extends arpg_trasfinfoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasfinfo";
  ...
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'cdadata':cdadata,'c_adata':c_adata,'DaDatReg':DaDatReg,'ADatReg':ADatReg,'gFlgDTP':gFlgDTP}";
  ...
  public arpg_trasfinfoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasfinfo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
