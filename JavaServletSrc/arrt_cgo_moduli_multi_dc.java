...
public class arrt_cgo_moduli_multi_dc extends SPRoutineServlet implements SPInvokable {
  public static String m_cEntityUid = "!*9e0a7f31*!";
  ...
  public SPEntityGlobals getEntityGlobals() {
    ...
    l_eg.name = "arrt_cgo_moduli_multi_dc";
  ...
  private void ExecuteRoutine(ServletStatus status) throws IOException {
    arrt_cgo_moduli_multi_dcR Rcalled;
    Rcalled = new arrt_cgo_moduli_multi_dcR(status.context,status);
  ...
  CallerWithObjs NewRoutine(SPServletStatus status,Caller dataFromClient) {
    return new arrt_cgo_moduli_multi_dcR(status.context,dataFromClient);
  }
  protected void BringBackPage(ServletStatus status,arrt_cgo_moduli_multi_dcR Rcalled) throws IOException {
    String l_cErrMsg;
    String msg;
    ...
    if ( ! (CPLib.Empty(status.m_cFaultTrace))) {
      status.out.println("Fault:["+SPLib.ToJSValue(status.context.Translate("MSG_ROUTINE_FAULTED","arrt_cgo_moduli_multi_dc"),"C",0,0)+","+SPLib.ToJSValue(status.m_cFaultTrace,"C",0,0)+"]");
