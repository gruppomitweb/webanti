...
function Help() {
windowOpenForeground('../doc/arpg_imp_offline_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_imp_offline',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["nomefile","tipodest","errchk","azzera","tipoimp","gAzienda","flgrae"];
