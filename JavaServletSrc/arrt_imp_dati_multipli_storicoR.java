...
// * --- arrt_imp_dati_multipli_storico
import java.io.File; 
import java.lang.Double;
import jxl.*;
// * --- Fine Area Manuale
public class arrt_imp_dati_multipli_storicoR implements CallerWithObjs {
  ...
  public int _conta;
  // * --- Fine Area Manuale
  public arrt_imp_dati_multipli_storicoR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_imp_dati_multipli_storico",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_imp_dati_multipli_storico";
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* Exec "Estrai file da zip" Page 20:Page_20 */
      Page_20();
      // Begin Transaction
      ...
      double nTry062DD9B0status;
      nTry062DD9B0status = m_Sql.GetTransactionStatus();
      String cTry062DD9B0msg;
      cTry062DD9B0msg = m_Sql.TransactionErrorMessage();
      try {
        ...
        while ( ! (Cursor_tmp_list_imprich.Eof())) {
          ...
          if (CPLib.eqr(_esito,0)) {
            ...
            if (CPLib.ne(CPLib.At("archpers.txt",CPLib.Lower(nomefileimport)),0)) {
              ...
              /* Case At('titola.txt',Lower(nomefileimport)) <> 0 */
            } else if (CPLib.ne(CPLib.At("titola.txt",CPLib.Lower(nomefileimport)),0)) {
              /* Exec "Titolari Effettivi" Page 11:Page_11 */
              Page_11();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              /* Case At('titocont.txt',Lower(nomefileimport)) <> 0 */
            } else if (CPLib.ne(CPLib.At("titocont.txt",CPLib.Lower(nomefileimport)),0)) {
              /* Exec "Altri Intestatari Operazioni" Page 19:Page_19 */
              Page_19();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Intestatari" Page 15:Page_15 */
              Page_15();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Rapporti Agenzia Entrate" Page 7:Page_7 */
              Page_7();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Informazioni Agenzia Entrate" Page 8:Page_8 */
              Page_8();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Operazioni Agenzia Entrate" Page 9:Page_9 */
              Page_9();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Procuratori/delegati su rapporto" Page 13:Page_13 */
              Page_13();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Procuratori/delegati su rapporto Agenzia Entrate" Page 16:Page_16 */
              Page_16();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Soggetti operanti" Page 14:Page_14 */
              Page_14();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Soggetti operanti Agenzia Entrate" Page 17:Page_17 */
              Page_17();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Intestatari Agenzia Entrate" Page 18:Page_18 */
              Page_18();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Altre Controparti Operazioni" Page 22:Page_22 */
              Page_22();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Altre Terze Parti Operazioni" Page 23:Page_23 */
              Page_23();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              /* Case At('saldopex.txt',Lower(nomefileimport)) <> 0 */
            } else if (CPLib.ne(CPLib.At("saldopex.txt",CPLib.Lower(nomefileimport)),0)) {
              /* Exec "Saldi Operazioni Extraconto" Page 25:Page_25 */
              Page_25();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              /* Case At('saldrapp.txt',Lower(nomefileimport)) <> 0 */
            } else if (CPLib.ne(CPLib.At("saldrapp.txt",CPLib.Lower(nomefileimport)),0)) {
              /* Exec "Saldi Rapporti Continuativi" Page 26:Page_26 */
              Page_26();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Operazioni extraconto" Page 12:Page_12 */
              Page_12();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry062DD9B0status,0)) {
          m_Sql.SetTransactionStatus(nTry062DD9B0status,cTry062DD9B0msg);
        }
      }
    } finally {
      try {
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
          ...
          /* xCF := Upper(Substr(riga,487,16)) */
          xCF = CPLib.Upper(CPLib.Substr(riga,487,16));
          ...
          if (CPLib.Empty(CPLib.LRTrim(xCodCab))) {
            /* xCitta := Upper(Substr(riga,230,30)) */
            xCitta = CPLib.Upper(CPLib.Substr(riga,230,30));
            // * --- Read from tbcitta
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,448,2))))) {
            ...
            if (CPLib.eqr(CPLib.LRTrim(CPLib.Substr(riga,448,2)),"EE")) {
              ...
              m_cSql = "";
              m_cSql = m_cSql+"DESCRI="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,136,30)),"C",40,0,m_cServer),m_cServer,CPLib.Upper(CPLib.Substr(riga,136,30)));
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on tbstati into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              if (CPLib.Empty(cSNAS)) {
                /* cSNAS := Upper(Substr(riga,136,30)) */
                cSNAS = CPLib.Upper(CPLib.Substr(riga,136,30));
              } // End If
              /* cCNAS := '' */
              cCNAS = "";
              /* cPNAS := 'EE' */
              ...
              m_cPhName = m_Ctx.GetPhName("tbcitta");
              m_cSql = "";
              m_cSql = m_cSql+"CITTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,136,30)),"C",40,0,m_cServer),m_cServer,CPLib.Upper(CPLib.Substr(riga,136,30)));
              if (m_Ctx.IsSharedTemp("tbcitta")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
              if (Read_Cursor!=null)
              ...
              if (CPLib.Empty(cCNAS)) {
                /* cCNAS := Upper(Substr(riga,136,30)) */
                cCNAS = CPLib.Upper(CPLib.Substr(riga,136,30));
              } // End If
              /* cSNAS := '' */
              cSNAS = "";
            } // End If
          ...
          if ( ! (CPLib.Empty(xConnes))) {
            ...
            if (CPLib.ne(CPLib.LRTrim(xRiga1),CPLib.LRTrim(xRiga2))) {
              ...
              while ( ! (Cursor_personbo.Eof())) {
                ...
                m_cSql = m_cSql+GetFieldsName_05FBC050(m_Ctx);
              ...
              m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,7,70)),"C",70,0,m_cServer)+", ";
              m_cSql = m_cSql+"DOMICILIO = "+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,77,35)),"C",35,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+"AUTRILASC = "+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,200,30)),"C",30,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+"COGNOME = "+CPLib.ToSQL(CPLib.Upper(xCognome),"C",26,0,m_cServer)+", ";
              m_cSql = m_cSql+"NOME = "+CPLib.ToSQL(CPLib.Upper(xNome),"C",25,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+"RAGSOCOLD = "+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,7,70)),"C",70,0,m_cServer)+", ";
              ...
              /* Exec "Verifica Modifiche su Anagrafiche per Anagrafe tributaria" Page 24:Page_24 */
              Page_24();
              /* cNumMod := cNumMod + 1 */
            ...
            m_cSql = m_cSql+GetFieldsName_05E2FF88(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(cCli1,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(xCodCab,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,7,70)),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,77,35)),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,177,15)),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,196,4)+CPLib.Substr(riga,194,2)+CPLib.Substr(riga,192,2)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(CPLib.Substr(riga,200,30)),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(xCognome),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(xNome),"?",0,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xnarapbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
              ...
              m_cSql = m_cSql+GetFieldsName_0643E5F0(m_Ctx);
              m_cSql = m_cSql+") values (";
              ...
              if (CPLib.lt(m_nUpdatedRows,1)) {
                // No rows inserted
                /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per il rapporto: "+Left(riga,25)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
                gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per il rapporto: "+CPLib.Left(riga,25)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
                m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
                m_cLastMsgError = "";
                /* _esito := 1 */
                _esito = CPLib.Round(1,0);
              ...
              m_cSql = m_cSql+GetFieldsName_05CFA220(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on anarapbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              m_cSql = m_cSql+GetFieldsName_0421DEC0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,76,1),"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"knarapbo")+" (";
              m_cSql = m_cSql+GetFieldsName_0619B928(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,115,6))))) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,121,30))+CPLib.LRTrim(CPLib.Substr(riga,153,6))+CPLib.LRTrim(CPLib.Substr(riga,151,2)))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on anadip into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on personbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          /* _datareg := iif(Empty(LRTrim(Substr(riga,36,8))) or _flgdataim=1,Date(),CharToDate(Right(Substr(riga,36,8),4)+Substr(Substr(riga,36,8),3,2)+Left(Substr(riga,36,8),2))) */
          _datareg = (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,36,8))) || CPLib.eqr(_flgdataim,1)?CPLib.Date():CPLib.CharToDate(CPLib.Right(CPLib.Substr(riga,36,8),4)+CPLib.Substr(CPLib.Substr(riga,36,8),3,2)+CPLib.Left(CPLib.Substr(riga,36,8),2)));
          /* If w_tipodest = 'P' */
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,159,10))),0)) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on xapopebo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
            ...
            m_cSql = m_cSql+GetFieldsName_06238820(m_Ctx);
            m_cSql = m_cSql+") values (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Substr(riga,36,8),4)+CPLib.Substr(CPLib.Substr(riga,36,8),3,2)+CPLib.Left(CPLib.Substr(riga,36,8),2),"?",0,0,m_cServer)+", ";
            if (m_Ctx.IsSharedTemp("xapopebo")) {
              m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
            }
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              if (CPLib.eqr(CPLib.Substr(riga,44,2),"23")) {
                ...
                m_cSql = m_cSql+GetFieldsName_06152A08(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"xntestbo")+" (";
                m_cSql = m_cSql+GetFieldsName_062EDC28(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2)),"?",0,0)+", ";
            ...
            if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,159,10))),0)) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on rapopebo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
            ...
            m_cSql = m_cSql+GetFieldsName_07C5A3B0(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              m_cSql = m_cSql+GetFieldsName_0417AC60(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2)),"?",0,0)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          /* Verifico la presenza dell'_unicode per evitare duplicazioni di informazioni diverse con lo stesso _unicode */
          /* _datareg := iif(Empty(LRTrim(Substr(riga,147,8))) or _flgdataim=1,Date(),CharToDate(Right(Substr(riga,147,8),4)+Substr(Substr(riga,147,8),3,2)+Left(Substr(riga,147,8),2))) */
          _datareg = (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,147,8))) || CPLib.eqr(_flgdataim,1)?CPLib.Date():CPLib.CharToDate(CPLib.Right(CPLib.Substr(riga,147,8),4)+CPLib.Substr(CPLib.Substr(riga,147,8),3,2)+CPLib.Left(CPLib.Substr(riga,147,8),2)));
          /* _unicode := '' */
          _unicode = "";
          ...
          if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,318,10))),0)) {
            ...
            if (CPLib.eqr(CPLib.Left(_ucode,1),"I")) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on operazbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if (CPLib.eqr(_newop,1)) {
            ...
            /* cFlagFraz := iif(Empty(Substr(riga,301,1)),'0',iif(Substr(riga,301,1)='S','1',iif(Substr(riga,301,1)='N','1',Substr(riga,301,1)))) */
            cFlagFraz = (CPLib.Empty(CPLib.Substr(riga,301,1))?"0":(CPLib.eqr(CPLib.Substr(riga,301,1),"S")?"1":(CPLib.eqr(CPLib.Substr(riga,301,1),"N")?"1":CPLib.Substr(riga,301,1))));
            /* cIdCau := '' */
            cIdCau = "";
            // * --- Read from tbcauana
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbcauana into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_cSql = m_cSql+GetFieldsName_074C7FE0(m_Ctx);
              m_cSql = m_cSql+") values (";
              ...
              m_cSql = m_cSql+GetFieldsName_0642F638(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.ne(xRiga1,xRiga2)) {
              ...
              while ( ! (Cursor_operazbo.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"operazbo")+" (";
                m_cSql = m_cSql+GetFieldsName_079B95D0(m_Ctx);
                m_cSql = m_cSql+") values (";
                ...
                while ( ! (Cursor_sogopebo.Eof())) {
                  ...
                  m_cSql = m_cSql+GetFieldsName_06DE5A78(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cNewProg,"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"operazbo")+" (";
              m_cSql = m_cSql+GetFieldsName_079C2C48(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
      ...
      /* FileLibrary.DeleteFile('./appo/'+nomefileimport) */
      FileLibrary.DeleteFile("./appo/"+nomefileimport);
      /* gMsgProc := gMsgProc + 'Operazioni Inserite: '+LRTrim(Str(cNumNew,10,0)) + ' - Operazioni Aggiornate: '+LRTrim(Str(cNumMod,10,0)) +' - Operazioni Invariate: '+LRTrim(Str(cNumInv,10,0)) + NL */
      gMsgProc = gMsgProc+"Operazioni Inserite: "+CPLib.LRTrim(CPLib.Str(cNumNew,10,0))+" - Operazioni Aggiornate: "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+" - Operazioni Invariate: "+CPLib.LRTrim(CPLib.Str(cNumInv,10,0))+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* gMsgProc := gMsgProc + 'Ora Fine Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' +nomefileimport + NL */
      gMsgProc = gMsgProc+"Ora Fine Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
          ...
          if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,318,10))),0)) {
            ...
            if (CPLib.eqr(CPLib.Left(_ucode,1),"I")) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on fraziobo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if (CPLib.eqr(_newop,1)) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_cSql = m_cSql+GetFieldsName_06EF0F68(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_06F17B38(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.ne(xRiga1,xRiga2)) {
              ...
              while ( ! (Cursor_fraziobo.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"fraziobo")+" (";
                m_cSql = m_cSql+GetFieldsName_07247C98(m_Ctx);
                m_cSql = m_cSql+") values (";
                ...
                while ( ! (Cursor_sogopefbo.Eof())) {
                  ...
                  m_cSql = m_cSql+GetFieldsName_06D8C3E8(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cNewProg,"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"fraziobo")+" (";
              m_cSql = m_cSql+GetFieldsName_06D475C8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on jnarapbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
          ...
          m_cSql = m_cSql+GetFieldsName_05EC01B0(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
  ...
  void Page_8() throws Exception {
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        m_cSql = m_cSql+GetFieldsName_062E5F48(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(_intercab,"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(cNumMod,0)) {
          ...
          m_cSql = m_cSql+GetFieldsName_061922F8(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2)),"?",0,0)+", ";
  ...
  void Page_9() throws Exception {
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        m_cSql = m_cSql+GetFieldsName_0778FAC8(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,10,4),"?",0,0,m_cServer)+", ";
  ...
  void Page_10() throws Exception {
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        /* gMsgImp := 'Caricamento dipendenza con codice '+xDIP // Messaggio Import */
        gMsgImp = "Caricamento dipendenza con codice "+xDIP;
        m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
        /* If Empty(LRTrim(xCodCab)) */
        if (CPLib.Empty(CPLib.LRTrim(xCodCab))) {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
          ...
          m_cSql = m_cSql+GetFieldsName_07747818(m_Ctx);
          m_cSql = m_cSql+") values (";
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if ( ! (CPLib.Empty(CPLib.Substr(riga,159,10)))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xapotit into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(_unicode)) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on rapotit into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_cSql = m_cSql+GetFieldsName_05ED0D80(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_intercab,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,115,6),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_06156C68(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_intercab,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,115,6),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(_tdest,"P")) {
              ...
              while ( ! (Cursor_xapotit.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"xapotit")+" (";
                m_cSql = m_cSql+GetFieldsName_06431A38(m_Ctx);
                m_cSql = m_cSql+") values (";
              ...
              while ( ! (Cursor_rapotit.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"rapotit")+" (";
                m_cSql = m_cSql+GetFieldsName_061A5030(m_Ctx);
                m_cSql = m_cSql+") values (";
  ...
  void Page_12() throws Exception {
    ...
    try {
      ...
      /* While not(FileLibrary.Eof(fhand)) */
      while ( ! (FileLibrary.Eof(fhand))) {
        /* gMsgImp := 'Sono stati elaborati '+LRTrim(Str(conta,10,0))+' record dei saldi opex del file '+nomefileimport // Messaggio Import */
        gMsgImp = "Sono stati elaborati "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" record dei saldi opex del file "+nomefileimport;
        m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
        /* riga := FileLibrary.ReadLine(fhand) */
        riga = FileLibrary.ReadLine(fhand);
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on opextrbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
          ...
          m_cSql = m_cSql+GetFieldsName_07762010(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cCli1,"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.lt(m_nUpdatedRows,1)) {
            // No rows inserted
            /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+Substr(riga,1,16)+" per l'operazione extraconto in data: "+Substr(riga,21,8)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
            gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+CPLib.Substr(riga,1,16)+" per l'operazione extraconto in data: "+CPLib.Substr(riga,21,8)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
            m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
            m_cLastMsgError = "";
            /* _esito := 1 */
            _esito = CPLib.Round(1,0);
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on xelegabo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(cMaxRow,0)) {
            ...
            Cursor_xelegabo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.Left(riga,25))+" "+")"+(m_Ctx.IsSharedTemp("xelegabo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+"CPROWNUM ",m_cServer,m_Ctx,true));
            ...
            m_cSql = m_cSql+GetFieldsName_0792A410(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.lt(m_nUpdatedRows,1)) {
              // No rows inserted
              /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+Substr(riga,26,16)+" per il rapporto: "+Substr(riga,1,25)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
              gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+CPLib.Substr(riga,26,16)+" per il rapporto: "+CPLib.Substr(riga,1,25)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
              m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
              m_cLastMsgError = "";
              /* _esito := 1 */
              _esito = CPLib.Round(1,0);
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on delegabo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(cMaxRow,0)) {
            ...
            Cursor_delegabo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.Left(riga,25))+" "+")"+(m_Ctx.IsSharedTemp("delegabo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+"CPROWNUM ",m_cServer,m_Ctx,true));
            ...
            m_cSql = m_cSql+GetFieldsName_079ACA78(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,16),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xperazbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on xraziobo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
                ...
                m_cSql = m_cSql+GetFieldsName_0797C9D0(m_Ctx);
                m_cSql = m_cSql+") values (";
                ...
                if (CPLib.lt(m_nUpdatedRows,1)) {
                  // No rows inserted
                  /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per il soggetto operante con codice fiscale: "+Substr(riga,21,16)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
                  gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per il soggetto operante con codice fiscale: "+CPLib.Substr(riga,21,16)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
                  m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
                  m_cLastMsgError = "";
                  /* _esito := 1 */
                  _esito = CPLib.Round(1,0);
            ...
            if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
              ...
              m_cSql = m_cSql+GetFieldsName_078E6778(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
            ...
            m_cSql = m_cSql+GetFieldsName_078EA6C0(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"sogopefbo")+" (";
                m_cSql = m_cSql+GetFieldsName_077047F0(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
            ...
            m_cSql = m_cSql+GetFieldsName_07995CD8(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          if ( ! (Cursor_xntestbo.Eof())) {
            ...
            // No rows selected
            /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per la registrazione dell'intestatario con codice fiscale "+Substr(riga,26,16)+" relativa al rapporto: "+Substr(riga,1,25)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+ NL */
            gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per la registrazione dell'intestatario con codice fiscale "+CPLib.Substr(riga,26,16)+" relativa al rapporto: "+CPLib.Substr(riga,1,25)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annulata automaticamente."+"\n";
            m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
            m_cLastMsgError = "";
            /* _esito := 1 */
            _esito = CPLib.Round(1,0);
          ...
          if (CPLib.eqr(cNumMod,0)) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"xntestbo")+" (";
            m_cSql = m_cSql+GetFieldsName_0725B168(m_Ctx);
            m_cSql = m_cSql+") values (";
          ...
          if (CPLib.eqr(cNumMod,0)) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"intestbo")+" (";
            m_cSql = m_cSql+GetFieldsName_07715690(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(ciidbase,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cidataini,"?",0,0)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on jelegabo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.eqr(cMaxRow,0)) {
          ...
          Cursor_jelegabo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer, m_oParameters),m_cServer,CPLib.Left(riga,25))+" "+")"+(m_Ctx.IsSharedTemp("jelegabo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+"CPROWNUM ",m_cServer,m_Ctx,true));
          while ( ! (Cursor_jelegabo.Eof())) {
            /* cMaxRow := jelegabo->CPROWNUM */
            cMaxRow = CPLib.Round(Cursor_jelegabo.GetDouble("CPROWNUM"),0);
          ...
          m_cSql = m_cSql+GetFieldsName_076EF9D0(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,16),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on japopebo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on jperazbo into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
            ...
            m_cSql = m_cSql+GetFieldsName_07725AB8(m_Ctx);
            m_cSql = m_cSql+") values (";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.eqr(cNumMod,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.InsertIntoStatement(m_Ctx,"jntestbo")+" (";
          m_cSql = m_cSql+GetFieldsName_07980B58(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(ciidbase,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cidataini,"?",0,0)+", ";
        ...
        if (CPLib.eqr(CPLib.Substr(riga,48,1),"F")) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_065410F8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_05FA2940(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_05B35528(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_05DEA6C8(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      while (CPLib.lt(contanome,conteggio)) {
        ...
        if (CPLib.ne(CPLib.At("archdip.txt",CPLib.Lower(buffernomefile)),0)) {
          ...
          /* Case At('saldopex.txt',Lower(buffernomefile)) <> 0 or At('saldopex.xls',Lower(buffernomefile)) <> 0 */
        } else if (CPLib.ne(CPLib.At("saldopex.txt",CPLib.Lower(buffernomefile)),0) || CPLib.ne(CPLib.At("saldopex.xls",CPLib.Lower(buffernomefile)),0)) {
          /* _priorita := 22 */
          _priorita = CPLib.Round(22,0);
          /* Case At('saldrapp.txt',Lower(buffernomefile)) <> 0 or At('saldrapp.xls',Lower(buffernomefile)) <> 0 */
        } else if (CPLib.ne(CPLib.At("saldrapp.txt",CPLib.Lower(buffernomefile)),0) || CPLib.ne(CPLib.At("saldrapp.xls",CPLib.Lower(buffernomefile)),0)) {
          /* _priorita := 23 */
        ...
        m_cSql = m_cSql+GetFieldsName_05DE8088(m_Ctx);
        m_cSql = m_cSql+") values (";
  ...
  void Page_21() throws Exception {
    ...
    if (CPLib.eqr(LibreriaMit.Occurs(xRagSoc,"?"),0)) {
      ...
      _ii = CPLib.Round(1,0);
      /* While _ii<=NSpazzi */
      while (CPLib.le(_ii,NSpazzi)) {
        /* xNome := Left(xRagSoc,At(' ',xRagSoc,_ii)-1) */
        xNome = CPLib.Left(xRagSoc,CPLib.At(" ",xRagSoc,_ii)-1);
        /* xCognome := Substr(xRagSoc,At(' ',xRagSoc,_ii)+1) */
        xCognome = CPLib.Substr(xRagSoc,CPLib.At(" ",xRagSoc,_ii)+1);
        /* If arfn_verifica_cf_nome_cognome(Substr(riga,487,16),xNome,xCognome) */
        if (arfn_verifica_cf_nome_cognomeR.Make(m_Ctx,this).Run(CPLib.Substr(riga,487,16),xNome,xCognome)) {
          /* xRagSoc := Left(xRagSoc,At(' ',xRagSoc,_ii)-1)+'?'+Substr(xRagSoc,At(' ',xRagSoc,_ii)+1) */
          xRagSoc = CPLib.Left(xRagSoc,CPLib.At(" ",xRagSoc,_ii)-1)+"?"+CPLib.Substr(xRagSoc,CPLib.At(" ",xRagSoc,_ii)+1);
          /* Allineamento := 'KO' */
          Allineamento = "KO";
          // Exit Loop
          if (true) {
    ...
    if (CPLib.eqr(LibreriaMit.Occurs(xRagSoc,"?"),0)) {
      ...
      /* While _ii<=NSpazzi */
      while (CPLib.le(_ii,NSpazzi)) {
        /* xNome := Substr(xRagSoc,At(' ',xRagSoc,_ii)+1) */
        xNome = CPLib.Substr(xRagSoc,CPLib.At(" ",xRagSoc,_ii)+1);
        /* xCognome := Left(xRagSoc,At(' ',xRagSoc,_ii)-1) */
        xCognome = CPLib.Left(xRagSoc,CPLib.At(" ",xRagSoc,_ii)-1);
        /* If arfn_verifica_cf_nome_cognome(Substr(riga,487,16),xNome,xCognome) */
        if (arfn_verifica_cf_nome_cognomeR.Make(m_Ctx,this).Run(CPLib.Substr(riga,487,16),xNome,xCognome)) {
          /* xRagSoc := Left(xRagSoc,At(' ',xRagSoc,_ii)-1)+'?'+Substr(xRagSoc,At(' ',xRagSoc,_ii)+1) */
          xRagSoc = CPLib.Left(xRagSoc,CPLib.At(" ",xRagSoc,_ii)-1)+"?"+CPLib.Substr(xRagSoc,CPLib.At(" ",xRagSoc,_ii)+1);
          ...
          if (CPLib.eqr(CPLib.Substr(riga,48,1),"F")) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
                ...
                m_cSql = m_cSql+GetFieldsName_041754A0(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_06243440(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
                ...
                m_cSql = m_cSql+GetFieldsName_061AC068(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_0628D7F0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.Substr(riga,48,1),"F")) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_06233FD8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_05D94A28(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_06197488(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_05F99478(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      if (CPLib.eqr(chkat,1)) {
        ...
        while ( ! (Cursor_aerighe.Eof())) {
          ...
          m_cSql = m_cSql+GetFieldsName_04189078(m_Ctx);
          m_cSql = m_cSql+") values (";
        ...
        while ( ! (Cursor_aerighe.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_newrapp")+" (";
          m_cSql = m_cSql+GetFieldsName_062EB090(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("S","?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetDouble("CPROWNUM"),"?",0,0)+", ";
  ...
  void Page_25() throws Exception {
    ...
    try {
      ...
      gMsgProc = gMsgProc+"Ora Inizio Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* If Lower(LRTrim(nomefileimport))='saldopex.txt' */
      if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"saldopex.txt")) {
        /* fhand := FileLibrary.OpenRead('./appo/'+nomefileimport) */
        fhand = FileLibrary.OpenRead("./appo/"+nomefileimport);
        /* While not(FileLibrary.Eof(fhand)) */
        while ( ! (FileLibrary.Eof(fhand))) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"opextrbo")+" (";
            m_cSql = m_cSql+GetFieldsName_06FC37E8(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(cCli1,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,17,4),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(xIDB,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,21,17)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,38,6)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,44,3)))?"242":CPLib.Substr(riga,44,3)),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
            if (m_Ctx.IsSharedTemp("opextrbo")) {
              m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
            }
            ...
            if (CPLib.lt(m_nUpdatedRows,1)) {
              // No rows inserted
              /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+Substr(riga,1,16)+" per l'operazione extraconto in data: "+Substr(riga,21,8)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annullata automaticamente."+ NL */
              gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+CPLib.Substr(riga,1,16)+" per l'operazione extraconto in data: "+CPLib.Substr(riga,21,8)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annullata automaticamente."+"\n";
              m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
              m_cLastMsgError = "";
              /* _esito := 1 */
              _esito = CPLib.Round(1,0);
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = "Update "+m_cPhName+" set ";
            m_cSql = m_cSql+"SALDO = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,21,17)),"N",17,0)+", ";
            m_cSql = m_cSql+"QUANTITA = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,38,6)),"N",6,0)+", ";
            m_cSql = m_cSql+"VALUTA = "+CPLib.ToSQL((CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,44,3)))?"242":CPLib.Substr(riga,44,3)),"C",3,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"opextrbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"COLLEG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(riga,16),"?",0,0,m_cServer),m_cServer,CPLib.Left(riga,16))+"";
            m_cSql = m_cSql+" and ANNO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Substr(riga,17,4),"?",0,0,m_cServer),m_cServer,CPLib.Substr(riga,17,4))+"";
            if (m_Ctx.IsSharedTemp("opextrbo")) {
              m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
            }
        ...
        while (CPLib.lt(_i,_conta)) {
          ...
          while (CPLib.lt(_y,_righe)) {
            ...
            column06 = a06.getContents();
            /* If not(Empty(LRTrim(column06))) */
            if ( ! (CPLib.Empty(CPLib.LRTrim(column06)))) {
              ...
              m_cPhName = m_Ctx.GetPhName("opextrbo");
              m_cSql = "";
              m_cSql = m_cSql+"COLLEG="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column01),16),"C",16,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column01),16));
              m_cSql = m_cSql+" and ANNO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column02),4),"C",4,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column02),4));
              if (m_Ctx.IsSharedTemp("opextrbo")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
              if (Read_Cursor!=null)
              ...
              if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"opextrbo")+" (";
                m_cSql = m_cSql+GetFieldsName_07043898(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column01),16),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column02),4),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(xIDB,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column03)),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column04)),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.Empty(CPLib.LRTrim(column05))?"242":CPLib.Left(CPLib.LRTrim(column05),3)),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
                if (m_Ctx.IsSharedTemp("opextrbo")) {
                  m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
                }
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = "Update "+m_cPhName+" set ";
                m_cSql = m_cSql+"SALDO = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column03)),"N",17,0)+", ";
                m_cSql = m_cSql+"QUANTITA = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column04)),"N",6,0)+", ";
                m_cSql = m_cSql+"VALUTA = "+CPLib.ToSQL((CPLib.Empty(CPLib.LRTrim(column05))?"242":CPLib.Left(CPLib.LRTrim(column05),3)),"C",3,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"opextrbo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"COLLEG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column01),16),"?",0,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column01),16))+"";
                m_cSql = m_cSql+" and ANNO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column02),4),"?",0,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column02),4))+"";
                if (m_Ctx.IsSharedTemp("opextrbo")) {
                  m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                }
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
      ...
      /* gMsgProc := gMsgProc + 'Saldi operazioni extraconto Inseriti: '+LRTrim(Str(cNumNew,10,0))  +  NL */
      gMsgProc = gMsgProc+"Saldi operazioni extraconto Inseriti: "+CPLib.LRTrim(CPLib.Str(cNumNew,10,0))+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* gMsgProc := gMsgProc + 'Saldi operazioni extraconto Aggiornati: '+LRTrim(Str(cNumMod,10,0)) + NL */
      gMsgProc = gMsgProc+"Saldi operazioni extraconto Aggiornati: "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* gMsgProc := gMsgProc + 'Ora Fine Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' +nomefileimport + NL */
      gMsgProc = gMsgProc+"Ora Fine Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
  ...
  void Page_26() throws Exception {
    ...
    try {
      ...
      gMsgProc = gMsgProc+"Ora Inizio Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* If Lower(LRTrim(nomefileimport))='saldrapp.txt' */
      if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"saldrapp.txt")) {
        /* fhand := FileLibrary.OpenRead('./appo/'+nomefileimport) */
        fhand = FileLibrary.OpenRead("./appo/"+nomefileimport);
        /* While not(FileLibrary.Eof(fhand)) */
        while ( ! (FileLibrary.Eof(fhand))) {
          /* riga := FileLibrary.ReadLine(fhand) */
          riga = FileLibrary.ReadLine(fhand);
          /* xRapporto := Substr(riga,1,25) */
          xRapporto = CPLib.Substr(riga,1,25);
          /* xIDB := '' */
          xIDB = "";
          // * --- Read from aeannora
          ...
          m_cSql = m_cSql+" and ANNO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Substr(riga,26,4),"C",4,0,m_cServer),m_cServer,CPLib.Substr(riga,26,4));
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on aeannora into routine arrt_imp_dati_multipli_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
            /* xIDB := LibreriaMit.UniqueId() */
            xIDB = LibreriaMit.UniqueId();
            /* nProgImp := Utilities.GetAutonumber("PROGSAR\'"+LRTrim(gAzienda)+"'",0,10) */
            nProgImp = CPLib.Round(Utilities.Make(m_Ctx,m_Caller).GetAutonumber("PROGSAR\\'"+CPLib.LRTrim(gAzienda)+"'",0,10),0);
            // * --- Insert into aeannora from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("aeannora");
            m_cPhName = m_Ctx.GetPhName("aeannora");
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aeannora")+" (";
            m_cSql = m_cSql+GetFieldsName_06FA0E60(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(xRapporto,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,4),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(xIDB,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,30,17)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,47,17)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,64,17)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,81,17)),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,98,6)),"?",0,0)+", ";
            if (m_Ctx.IsSharedTemp("aeannora")) {
              m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
            }
            ...
            if (CPLib.lt(m_nUpdatedRows,1)) {
              // No rows inserted
              /* gMsgProc := gMsgProc +"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+Substr(riga,1,16)+" per il rapporto in data: "+Substr(riga,21,8)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annullata automaticamente."+ NL */
              gMsgProc = gMsgProc+"Rilevati errori nel file "+nomefileimport+" per il soggetto con codice fiscale: "+CPLib.Substr(riga,1,16)+" per il rapporto in data: "+CPLib.Substr(riga,21,8)+" Ricreare il file e rieseguire l'import dei dati. L'attuale procedura di importazione verrà annullata automaticamente."+"\n";
              m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
              m_cLastMsgError = "";
              /* _esito := 1 */
              _esito = CPLib.Round(1,0);
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = "Update "+m_cPhName+" set ";
            m_cSql = m_cSql+"IMPORTO1 = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,30,17)),"N",17,0)+", ";
            m_cSql = m_cSql+"IMPORTO2 = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,47,17)),"N",17,0)+", ";
            m_cSql = m_cSql+"IMPORTO3 = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,64,17)),"N",17,0)+", ";
            m_cSql = m_cSql+"IMPORTO4 = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,81,17)),"N",17,0)+", ";
            m_cSql = m_cSql+"IMPORTO5 = "+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,98,6)),"N",6,0)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"aeannora",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer),m_cServer,CPLib.Left(riga,25))+"";
            m_cSql = m_cSql+" and ANNO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Substr(riga,26,4),"?",0,0,m_cServer),m_cServer,CPLib.Substr(riga,26,4))+"";
            if (m_Ctx.IsSharedTemp("aeannora")) {
              m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
            }
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = "Update "+m_cPhName+" set ";
          m_cSql = m_cSql+"VALUTA = "+CPLib.ToSQL((CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,104,3)))?"242":CPLib.Substr(riga,104,3)),"C",3,0,m_cServer)+", ";
          m_cSql = m_cSql+"CAB = "+CPLib.ToSQL(CPLib.Substr(riga,107,5),"C",5,0,m_cServer)+", ";
          ...
          /* gMsgImp := 'Sono stati elaborati '+LRTrim(Str(conta,10,0))+' record dei saldi rapporti del file '+nomefileimport // Messaggio Import */
          gMsgImp = "Sono stati elaborati "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" record dei saldi rapporti del file "+nomefileimport;
          m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
          /* conta := conta + 1 */
          conta = CPLib.Round(conta+1,0);
        } // End While
        ...
        while (CPLib.lt(_i,_conta)) {
          ...
          while (CPLib.lt(_y,_righe)) {
            ...
            column10 = a10.getContents();
            /* If not(Empty(LRTrim(column10))) */
            if ( ! (CPLib.Empty(CPLib.LRTrim(column10)))) {
              /* gMsgImp := 'Elaborazione Foglio N.'+LRTrim(Str(_i+1,2,0))+' - Riga N. '+LRTrim(Str(_y+1,7,0))+' - Rapporto N. : '+LRTrim(column01) // Messaggio Import */
              gMsgImp = "Elaborazione Foglio N."+CPLib.LRTrim(CPLib.Str(_i+1,2,0))+" - Riga N. "+CPLib.LRTrim(CPLib.Str(_y+1,7,0))+" - Rapporto N. : "+CPLib.LRTrim(column01);
              m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
              /* xRapporto := column01 */
              ...
              m_cPhName = m_Ctx.GetPhName("aeannora");
              m_cSql = "";
              m_cSql = m_cSql+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column01),25),"C",25,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column01),25));
              m_cSql = m_cSql+" and ANNO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column02),4),"C",4,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column02),4));
              if (m_Ctx.IsSharedTemp("aeannora")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
              ...
              if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aeannora")+" (";
                m_cSql = m_cSql+GetFieldsName_0704CF10(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column01),25),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column02),4),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(xIDB,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column03)),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column04)),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column05)),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column06)),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column07)),"?",0,0)+", ";
                if (m_Ctx.IsSharedTemp("aeannora")) {
                  m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
                }
                m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"aeannora",true);
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = "Update "+m_cPhName+" set ";
                m_cSql = m_cSql+"IMPORTO1 = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column03)),"N",17,0)+", ";
                m_cSql = m_cSql+"IMPORTO2 = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column04)),"N",17,0)+", ";
                m_cSql = m_cSql+"IMPORTO3 = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column05)),"N",17,0)+", ";
                m_cSql = m_cSql+"IMPORTO4 = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column06)),"N",17,0)+", ";
                m_cSql = m_cSql+"IMPORTO5 = "+CPLib.ToSQL(CPLib.Val(CPLib.LRTrim(column07)),"N",6,0)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"aeannora",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column01),25),"?",0,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column01),25))+"";
                m_cSql = m_cSql+" and ANNO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column02),4),"?",0,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(column02),4))+"";
                if (m_Ctx.IsSharedTemp("aeannora")) {
                  m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                }
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = "Update "+m_cPhName+" set ";
              m_cSql = m_cSql+"VALUTA = "+CPLib.ToSQL((CPLib.Empty(CPLib.LRTrim(column08))?"242":CPLib.Left(CPLib.LRTrim(column08),3)),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"CAB = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(column09),5),"C",5,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"aetesta",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(xRapporto,"?",0,0,m_cServer),m_cServer,xRapporto)+"";
              if (m_Ctx.IsSharedTemp("aetesta")) {
      ...
      /* gMsgProc := gMsgProc + 'Saldi Rapporti Creati: '+LRTrim(Str(cNumNew,10,0)) + NL */
      gMsgProc = gMsgProc+"Saldi Rapporti Creati: "+CPLib.LRTrim(CPLib.Str(cNumNew,10,0))+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* gMsgProc := gMsgProc + 'Saldi Rapporti Aggiornati: '+LRTrim(Str(cNumMod,10,0)) + NL */
      gMsgProc = gMsgProc+"Saldi Rapporti Aggiornati: "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* gMsgProc := gMsgProc + 'Ora Fine Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' +nomefileimport + NL */
      gMsgProc = gMsgProc+"Ora Fine Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
  ...
  public static arrt_imp_dati_multipli_storicoR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_imp_dati_multipli_storicoR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // ENTITY_BATCHES: ,arfn_calcolasett,arfn_conv_stato_uic,arfn_fdatetime,arfn_verifica_cf_nome_cognome,
  public static final String i_InvokedRoutines = ",arfn_calcolasett,arfn_conv_stato_uic,arfn_fdatetime,arfn_verifica_cf_nome_cognome,";
  public static String[] m_cRunParameterNames={};
  protected static String GetFieldsName_05FBC050(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_05E2FF88(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"RAGSOC,";
  ...
  protected static String GetFieldsName_0643E5F0(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_05CFA220(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_0421DEC0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_0619B928(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_06238820(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_06152A08(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_062EDC28(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
  ...
  protected static String GetFieldsName_07C5A3B0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_0417AC60(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_074C7FE0(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0642F638(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_079B95D0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"AUTOM,";
    p_cSql = p_cSql+"CAMBIO,";
  ...
  protected static String GetFieldsName_06DE5A78(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_079C2C48(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_06EF0F68(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_06F17B38(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_07247C98(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"AUTOM,";
  ...
  protected static String GetFieldsName_06D8C3E8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_06D475C8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_05EC01B0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_062E5F48(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_061922F8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_0778FAC8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CODANA,";
  ...
  protected static String GetFieldsName_07747818(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_05ED0D80(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_06156C68(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_06431A38(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_061A5030(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_07762010(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0792A410(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODINTER,";
  ...
  protected static String GetFieldsName_079ACA78(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODINTER,";
  ...
  protected static String GetFieldsName_0797C9D0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_078E6778(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_078EA6C0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_077047F0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_07995CD8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_0725B168(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_07715690(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_076EF9D0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODINTER,";
  ...
  protected static String GetFieldsName_07725AB8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_07980B58(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_065410F8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05FA2940(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05B35528(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05DEA6C8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05DE8088(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_041754A0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06243440(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_061AC068(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0628D7F0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06233FD8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05D94A28(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06197488(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05F99478(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_04189078(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"TIPO,";
  ...
  protected static String GetFieldsName_062EB090(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"TIPO,";
    p_cSql = p_cSql+"NUMRIG,";
  ...
  protected static String GetFieldsName_06FC37E8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_07043898(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06FA0E60(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
    ...
    if (p_Ctx.IsSharedTemp("aeannora")) {
      p_cSql = p_cSql+"context_id,";
    }
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"aeannora",true);
    return p_cSql;
  }
  protected static String GetFieldsName_0704CF10(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
