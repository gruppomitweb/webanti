...
public class arpg_operazrappoBL extends arpg_operazrappoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_operazrappo";
  ...
  public arpg_operazrappoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_operazrappo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
