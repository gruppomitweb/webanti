...
m_oFather.i_last_focused_item='child_ardt_ae_intestbo';
...
function Help() {
windowOpenForeground('../doc/ardt_ae_intestbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'jntestbo'+'\\'+CPLib.ToCPStr(w_RAPPORTO);
}
...
p_d.setValue('ardt_ae_intestbo',m_cSelectedPage);
