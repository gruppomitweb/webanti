...
public class aosdt_sub_ind_mitBL extends aosdt_sub_ind_mitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "aosdt_sub_ind_mit";
  ...
  public CPPhTableWrInfo m_oWrInfo_sub_ind_mit;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_sub_ind_mit;
  ...
  public static String[] m_EntityTables = {"sub_ind_mit"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDMOD':IDMOD,'IDIND':IDIND,'m_Detail':{'IDSUBIND':IDSUBIND,'PROGSUBIND':PROGSUBIND,'DESCRI':DESCRI,'DESCRI_layer':DESCRI_layer"+FoundlingChildrenList("aosdt_sub_ind_mit",true,true)+"}"+FoundlingChildrenList("aosdt_sub_ind_mit",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDMOD':IDMOD,'IDIND':IDIND,'m_Detail':{'IDSUBIND':IDSUBIND,'PROGSUBIND':PROGSUBIND,'DESCRI':DESCRI,'DESCRI_layer':DESCRI_layer"+FoundlingChildrenList("aosdt_sub_ind_mit",true,true)+"}"+FoundlingChildrenList("aosdt_sub_ind_mit",true,false)+"}";
  public static final String i_ItemSequence = "IDMOD,IDIND,m_Detail[ IDSUBIND PROGSUBIND DESCRI DESCRI_layer"+FoundlingChildrenList("aosdt_sub_ind_mit",false,true)+"]"+FoundlingChildrenList("aosdt_sub_ind_mit",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("aosdt_sub_ind_mit"),new String[][]{new String[]{"IDMOD","ID del modello","C","10","0","campo","key1","false","false"},new String[]{"IDIND","ID del indicatore","C","10","0","campo","key1","false","false"},new String[]{"IDSUBIND","ID del subindicatore","C","10","0","campo","key1","true","false"},new String[]{"PROGSUBIND","Progressivo subindicatore","C","10","0","campo","key2","true","false"},new String[]{"DESCRI","Descrizione del subindicatore","M","10","0","campo","nokey","true","false"},new String[]{"DESCRI_layer","Descrizione","M","10","0","variabile","nokey","true","false"}});
  ...
  public aosdt_sub_ind_mitBL (CPContext p_ContextObject) {
    ...
    m_cPhName_sub_ind_mit = p_ContextObject.GetPhName("sub_ind_mit",p_ContextObject.GetCompany(),false);
    m_cServer_sub_ind_mit = p_ContextObject.GetServer("sub_ind_mit");
    m_oWrInfo_sub_ind_mit = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"sub_ind_mit",p_ContextObject.GetCompany());
    m_cVirtName_sub_ind_mit = CPSql.ManipulateTablePhName("sub_ind_mit",m_cServer_sub_ind_mit);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("aosdt_sub_ind_mit",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("aosdt_sub_ind_mit","sub_ind_mit",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("aosdt_sub_ind_mit",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("aosdt_sub_ind_mit",child);
    ...
    for(String child : CPLib.LoadableMNTs("aosdt_sub_ind_mit",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("aosdt_sub_ind_mit",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"aosdt_sub_ind_mit"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"aosdt_sub_ind_mit\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "sub_ind_mit"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDMOD","C",10,0))+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDIND","C",10,0));
  }
  public String RowPrimaryKey() {
    return "sub_ind_mit"+"\\"+CPLib.ToCPStr(w_IDSUBIND);
  }
