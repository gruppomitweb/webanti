...
// * --- Fine Area Manuale
public class arrt_lancia_import_fileaeR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_fileaeR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_fileae",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_import_fileae";
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      while ( ! (Cursor_intermbo.Eof())) {
        /* _tipo := intermbo->FLGIMPAGE // Tipo Import */
        _tipo = Cursor_intermbo.GetString("FLGIMPAGE");
      ...
      // * --- End Select
      /* Case _tipo='1' */
      if (CPLib.eqr(_tipo,"1")) {
        /* Return  */
        Forward f;
        f=new Forward("arpg_import_fileae",false,this,Forward.Start,false);
        f.SetParameter("m_cParameterSequence", "");
        f.SetParameter("m_cMode","hyperlink");
        throw f;
        /* Case _tipo='2' */
      } else if (CPLib.eqr(_tipo,"2")) {
        /* Return  */
        Forward f;
        f=new Forward("arpg_import_fileae_vg",false,this,Forward.Start,false);
        f.SetParameter("m_cParameterSequence", "");
        f.SetParameter("m_cMode","hyperlink");
        throw f;
      } else { // Otherwise
        /* Alert Msg "Necessario impostare il tipo di import nei dati intermediario" */
        // no alert sever-side
      } // End Case
    } finally {
      try {
  ...
  public static arrt_lancia_import_fileaeR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_fileaeR(p_Ctx, p_Caller);
  }
  public void Blank() {
    _tipo = CPLib.Space(1);
  }
