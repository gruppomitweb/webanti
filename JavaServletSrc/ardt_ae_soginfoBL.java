...
public class ardt_ae_soginfoBL extends ardt_ae_soginfoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_ae_soginfo";
  ...
  public CPPhTableWrInfo m_oWrInfo_joginfo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_joginfo;
  ...
  public static String[] m_EntityTables = {"joginfo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_ae_soginfo",true,true)+"}"+FoundlingChildrenList("ardt_ae_soginfo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescleg':xdescleg,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_ae_soginfo",true,true)+"}"+FoundlingChildrenList("ardt_ae_soginfo",true,false)+"}";
  public static final String i_ItemSequence = "RAPCOL,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_ae_soginfo",false,true)+"]"+FoundlingChildrenList("ardt_ae_soginfo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_ae_soginfo"),new String[][]{new String[]{"RAPCOL","","C","25","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_ae_soginfoBL (CPContext p_ContextObject) {
    ...
    m_cPhName_joginfo = p_ContextObject.GetPhName("joginfo",p_ContextObject.GetCompany(),false);
    m_cServer_joginfo = p_ContextObject.GetServer("joginfo");
    m_oWrInfo_joginfo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"joginfo",p_ContextObject.GetCompany());
    m_cVirtName_joginfo = CPSql.ManipulateTablePhName("joginfo",m_cServer_joginfo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_soginfo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_ae_soginfo","joginfo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_ae_soginfo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_ae_soginfo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_ae_soginfo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_soginfo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_ae_soginfo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_ae_soginfo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "joginfo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPCOL","C",25,0));
  }
  public String RowPrimaryKey() {
    return "joginfo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
