...
var c;
var c;
var tmp_FGMOCXNBFY = ToHTag(AsControlValue('<iframe width=\'655\' height=\'170\' id =\'elaborazione\' id=\'elaborazione\' frameborder=\'1\'  border=\'1\' align=\'TOP\' marginwidth=\'1\' marginheight=\'1\'></iframe>'));
...
var tmp_SSRCOAMDBL = ToHTag(AsControlValue('<iframe width=\'755\' height=\'155\' id =\'messaggi\' src=\'arpg_msg_import\' frameborder=\'1\'  border=\'1\' align=\'TOP\' marginwidth=\'1\' marginheight=\'1\'></iframe>'));
...
if (Eq(w_bloccaedit,'N')) {
Elabora()
}
}
function PSAHIDGTWE_Click() {
if (Ne(w_iniz,'S') && Eq(w_bloccaedit,'N')) {
Elabora3()
}
}
...
var action = (Eq(Left('arpg_filesage'+''+'?',17),'arpg_scaricodati?')?'query':'start');
SetHypPar('m_cAction',AsAppletValue(action));
SetHypPar('m_cMode',AsAppletValue('hyperlink'));
SendData(action,'arpg_filesage'+'',HParApplet().asString());
}
_ResetTracker();
...
FocusFirstComponent.otherwise={"page_1":["LPTSLAVIAK","KHPXTNGSFO","FSXHJAAZGG","CLVVMIYSQG","NMNMXABGKO","PSAHIDGTWE","ALQVOOWZEV","HVQERBROTD","CFLYSPTTDU","DIUBYKKRGY"]};
function Help() {
windowOpenForeground('../doc/arpg_scaricodati_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_scaricodati',m_cSelectedPage);
...
if (l_bResult) {
l_bResult=Gt(w_a_rett,w_darett) && Eq(w_bloccaedit,'N');
if ( ! (l_bResult)) {
m_nLastError=2;
...
l_bResult=false;
w_darett=HtW('','D');
} else if (( ! (_ChkObl('DIUBYKKRGY',1))) || ( ! (Gt(w_a_rett,w_darett) && Eq(w_bloccaedit,'N')))) {
...
_FillChildren.n=[];
FillWv.n=["iniz","seco","dadata","a_data","datpri","datseci","datsecf","darett","a_rett","files","bloccaedit"];
