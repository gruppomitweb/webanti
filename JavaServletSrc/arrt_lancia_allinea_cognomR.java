...
// * --- Fine Area Manuale
public class arrt_lancia_allinea_cognomR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_allinea_cognomR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_allinea_cognom",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_allinea_cognom";
  ...
  public static arrt_lancia_allinea_cognomR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_allinea_cognomR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
