...
public class arpg_fam_stpperiodoBL extends arpg_fam_stpperiodoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fam_stpperiodo";
  ...
  public static final String i_StateStructure = "{'dainviare':dainviare,'anno':anno,'mese':mese,'flgdett':flgdett}";
  public static final String i_CompleteStateStructure = "{'cdadata':cdadata,'c_adata':c_adata,'dainviare':dainviare,'anno':anno,'mese':mese,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'flgdett':flgdett}";
  public static final String i_ItemSequence = "dainviare,anno,mese,flgdett";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"dainviare","","N","1","0","variabile","nokey","false","false"},new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","true"},new String[]{"flgdett","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_fam_stpperiodoBL (CPContext p_ContextObject) {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_dainviare(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_dainviare = p_workVariableValue;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fam_stpperiodo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_dainviare = CPLib.GetProperty(p,"dainviare",w_dainviare,0);
