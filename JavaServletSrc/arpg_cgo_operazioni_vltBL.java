...
public class arpg_cgo_operazioni_vltBL extends arpg_cgo_operazioni_vltWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_cgo_operazioni_vlt";
  ...
  public static final String i_StateStructure = "{'agenzia':agenzia}";
  public static final String i_CompleteStateStructure = "{'agenzia':agenzia,'xagenzia':xagenzia,'xdesage':xdesage,'coddip':coddip}";
  public static final String i_ItemSequence = "agenzia";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"agenzia","Agenzia","C","6","0","variabile","nokey","false","false"}});
  ...
  public arpg_cgo_operazioni_vltBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_HZHPBOOXGE(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_agenzia))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_anadip,"select CODDIP,DESCRIZ,IDBASE from "+m_cPhName_anadip+((m_cPhName_anadip).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODDIP"+l_cCurrentKey+l_cWhere);
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            ...
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_anadip,"select CODDIP,DESCRIZ,IDBASE from "+m_cPhName_anadip+((m_cPhName_anadip).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRIZ"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_operazioni_vlt","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_field",new String[]{"CODDIP","DESCRIZ","IDBASE"});
    map.put("rd_var",new String[]{"w_agenzia","w_xdesage","w_xagenzia"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("6\u000030\u000010",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Agenzia\u0000Descrizione\u0000",-1));
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_DESCRIZ=c_DESCRIZ;
  ...
  public void TrsToWork() {
    ...
    c_DESCRIZ= m_oTrs.get(m_nCurrentRow).c_DESCRIZ;
