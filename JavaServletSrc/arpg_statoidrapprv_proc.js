...
function Help() {
windowOpenForeground('../doc/arpg_statoidrapprv_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_statoidrapprv',m_cSelectedPage);
...
GroupFooter_BeginHtml(document,1,'93478583'+l_nIdx+'','A',true,false)
GroupFooter_EndHtml(document,1,'93478583'+l_nIdx+'','A')
} else {
}
l_nIdx=l_nIdx+1;
m_nCurrentRow=l_nIdx;
...
if (Ge(2,l_nDeep)) {
GroupHeader_BeginHtml(document,1,'93486775'+l_nIdx+'','A',true,false)
document.writeln(
 "<div id='DIV_09E73D90"+l_nIdx+"' style='position:relative;height:20px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
GroupHeader_EndHtml(document,1,'93486775'+l_nIdx+'','A')
} else {
}
Row_BeginHtml(document,l_nEvenOdd,'35856055'+l_nIdx+'','A',true,-1)
document.writeln(
 "<div id='DIV_0A0D3E28"+l_nIdx+"' style='position:relative;height:20px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
Row_EndHtml(document,l_nEvenOdd,'35856055'+l_nIdx+'','A')
Parms.Idx=l_nIdx;
Parms.Deep=l_nDeep;
Parms.EvenOdd=l_nEvenOdd;
}
