...
// * --- Fine Area Manuale
public class arfn_verifica_cf_nome_cognomeR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_verifica_cf_nome_cognomeR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_verifica_cf_nome_cognome",m_Caller);
    Blank();
  }
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arfn_verifica_cf_nome_cognome";
  ...
  public boolean Run(String p_CF,String p_NOME,String p_COGNOME) {
    CF = p_CF;
    NOME = p_NOME;
    COGNOME = p_COGNOME;
    return Run();
  ...
  public static arfn_verifica_cf_nome_cognomeR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_verifica_cf_nome_cognomeR(p_Ctx, p_Caller);
  }
  public static arfn_verifica_cf_nome_cognomeR Make(CPContext p_Ctx) {
    return new arfn_verifica_cf_nome_cognomeR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
    CF = CPLib.Space(16);
    NOME = CPLib.Space(25);
