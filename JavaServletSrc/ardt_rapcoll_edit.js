...
if ( ! (m_oFather.SaveContext_ardt_rapcoll())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_rapcoll_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_rapcoll_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_rapcoll();
}
}
SaveContext.child=[];
function BlankRow() {
