...
// * --- Fine Area Manuale
public class armt_xapotitBO extends armt_xapotitBL {
  class SqlLoader {
    public boolean m_bLink_1_2 = false;
    ...
    public void AddJoinedLink_1_2(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+6,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_2.CODINTER AS CODINTER102";
        m_cSelect = m_cSelect+" ,link_1_2.DATANASC AS DATANASC102";
        m_cSelect = m_cSelect+" ,link_1_2.CODCAB AS CODCAB102";
        m_cSelect = m_cSelect+" ,link_1_2.PROVINCIA AS PROVINCIA102";
        m_cSelect = m_cSelect+" ,link_1_2.DESCCIT AS DESCCIT102";
        m_cSelect = m_cSelect+" ,link_1_2.TIPINTER AS TIPINTER102";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_2","CODINTER","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_2","CODINTER","CODINTER",true);
    ...
    public void AddJoinedLink_1_7(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_7.CODDIP AS CODDIP107";
        m_cSelect = m_cSelect+" ,link_1_7.DESCRIZ AS DESCRIZ107";
        m_cSelect = m_cSelect+" ,link_1_7.DESCCIT AS DESCCIT107";
        m_cSelect = m_cSelect+" ,link_1_7.PROVINCIA AS PROVINCIA107";
        m_cSelect = m_cSelect+" ,link_1_7.CAB AS CAB107";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_7","CODDIPE","CODDIP");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_7","CODDIPE","CODDIP",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_8(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        ...
        m_cSelect = m_cSelect+" ,link_1_8.SESSO AS SESSO108";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_8","CONNESCLI","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_8","CONNESCLI","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_12(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_12.CODICE AS CODICE112";
        m_cSelect = m_cSelect+" ,link_1_12.DES1 AS DES1112";
        m_cSelect = m_cSelect+" ,link_1_12.TIPREG AS TIPREG112";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_12","TIPOOPRAP","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_12","TIPOOPRAP","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_xapotitBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_xapotit");
    }
  ...
  public boolean CanSave() {
    ...
    l_bResult = true;
    if (l_bResult) {
      l_bResult = CanSaveChild(ardt_xntestit,m_cWv_ardt_xntestit,"m_cWv_ardt_xntestit");
      if (l_bResult) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_xntestit.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xntestit)) {
  ...
  public boolean Load(String p_IDBASE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_xapotit,m_cPhName_xapotit,m_cVirtName_xapotit,m_cVirtName_xapotit+".IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDBASE,"C",10,0),m_cServer_xapotit,p_IDBASE),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_1_2(m_cPhName_intermbo,m_cServer_intermbo);
    l_oSqlLoader.AddJoinedLink_1_7(m_cPhName_anadip,m_cServer_anadip);
    l_oSqlLoader.AddJoinedLink_1_8(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_12(m_cPhName_tbtipreg,m_cServer_tbtipreg);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_2) {
          w_datpaseuro = l_rsLoad.GetDate("DATANASC102");
          w_CABINT = l_rsLoad.GetString("CODCAB102");
          w_PROVINT = l_rsLoad.GetString("PROVINCIA102");
          w_CITINT = l_rsLoad.GetString("DESCCIT102");
          w_TIPOINTER = l_rsLoad.GetString("TIPINTER102");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_7) {
          w_xDescDipe = l_rsLoad.GetString("DESCRIZ107");
          w_CITDIP = l_rsLoad.GetString("DESCCIT107");
          w_PROVDIP = l_rsLoad.GetString("PROVINCIA107");
          w_CABDIP = l_rsLoad.GetString("CAB107");
        } else {
          Link_AVHTGZTOSZ("Load");
        }
        w_CONNESCLI = l_rsLoad.GetString("CONNESCLI");
        if (l_oSqlLoader.m_bLink_1_8) {
          w_xRagSocCli = l_rsLoad.GetString("RAGSOC108");
          w_SESSO = l_rsLoad.GetString("SESSO108");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_12) {
          w_xDesReg = l_rsLoad.GetString("DES1112");
          w_tipreg = l_rsLoad.GetString("TIPREG112");
        } else {
        ...
        m_cWv_ardt_xntestit = "";
        ardt_xntestit.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"xapotit")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xapotit);
      l_cSql = "insert into "+m_oWrInfo_xapotit.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_xapotit.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xapotit")) {
      ...
      l_cSql = l_cSql+m_oWrInfo_xapotit.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xapotit")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_xapotit,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xapotit);
      l_cSql = "Update "+m_oWrInfo_xapotit.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_xapotit,w_IDBASE);
      l_cSql = l_cSql+m_oWrInfo_xapotit.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xapotit")) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          ...
          ardt_xntestit.w_CODCLI = w_CONNESCLI;
          ardt_xntestit.Delete();
        }
        CPLib.DeleteMNTs(m_Sql,m_MNTs,this);
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_xapotit.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_xapotit,w_IDBASE);
          l_cSql = l_cSql+m_oWrInfo_xapotit.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"xapotit")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_xapotit,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"PRGPTIT1","i_codazi,w_IDBASE",m_cServer_xapotit,m_Ctx.GetCompany());
    ...
    m_Sql.NextTableProg(this,"PRGPTIT2","i_codazi,w_NUMPROG",m_cServer_xapotit,m_Ctx.GetCompany());
    ...
    op_NUMPROG = w_NUMPROG;
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    m_Sql.NextTableProg(this,"PRGIMPTIT","i_codazi,w_PRGIMPTIT",m_cServer_xapotit,m_Ctx.GetCompany());
    op_PRGIMPTIT = w_PRGIMPTIT;
  }
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_chkdatdoc,arrt_crea_idereg,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_chkdatdoc,arrt_crea_idereg,arrt_writelog,";
}
