...
m_oFather.i_last_focused_item='child_ardt_xiduciabo';
...
function Help() {
windowOpenForeground('../doc/ardt_xiduciabo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'xiduciabo'+'\\'+CPLib.ToCPStr(w_RAPCOL);
}
...
p_d.setValue('ardt_xiduciabo',m_cSelectedPage);
