...
_modifyandopen('arrt_aelistanomi'+'?m_cAction=start&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes',null)
}
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_aelistanomi_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_aelistanomi',m_cSelectedPage);
...
w_datpris=CharToDate('20061231');
w_datseci=CharToDate('20070101');
w_datsecf=CharToDate('20070430');
...
_FillChildren.n=[];
FillWv.n=["iniz","dadata","a_data","datpris","datseci","datsecf","datprif"];
