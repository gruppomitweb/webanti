...
// * --- Fine Area Manuale
public class ardt_soggopeBO extends ardt_soggopeBL {
  ...
  // * --- Fine Area Manuale
  public ardt_soggopeBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"ardt_soggope");
    }
  ...
  public static String[] m_cLoadParameterNames = {"COLLEG"};
  public static String[] m_cDeleteParameterNames = m_cLoadParameterNames;
  public boolean Load(String p_COLLEG) {
    CPResultSet l_rsLoadBody=null;
    SqlDetailLoader l_oSqlDetailLoader;
    l_oSqlDetailLoader = new SqlDetailLoader(m_Sql,m_cServer_soggope,m_cPhName_soggope,m_cVirtName_soggope,m_cVirtName_soggope+".COLLEG="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_COLLEG,"C",16,0),m_cServer_soggope,p_COLLEG),"");
      ...
      if (m_bLoaded) {
        ...
        while ( ! (l_rsLoadBody.Eof())) {
          ...
          if (l_oSqlDetailLoader.m_bLink_2_1) {
            ...
            Link_NMXBOMFUCN("Load");
          }
          w_IDBASE = l_rsLoadBody.GetString("IDBASE");
          w_PRIMO = l_rsLoadBody.GetDouble("PRIMO");
          w_DATAINI = l_rsLoadBody.GetDate("DATAINI");
          w_DATAFINE = l_rsLoadBody.GetDate("DATAFINE");
          w_TIPOLEG = l_rsLoadBody.GetString("TIPOLEG");
          w_RUOLO = l_rsLoadBody.GetString("RUOLO");
  ...
  public boolean Delete(String p_COLLEG) {
    String l_cSql;
    int l_nRow;
  ...
  void DeleteDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      ...
      if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
        l_cSql = "Delete from "+m_oWrInfo_soggope.GetTableWriteName()+" where ";
        l_cSql = l_cSql+"COLLEG="+CPLib.ToSQL(w_COLLEG,"C",16,0)+" AND CODINTER="+CPLib.ToSQL(opk_CODINTER,"C",16,0)+" AND IDBASE="+CPLib.ToSQL(opk_IDBASE,"C",10,0);
        l_cSql = l_cSql+m_oWrInfo_soggope.WhereFilter();
        if (CPLib.HasTableCPCCCHK(m_Ctx,"soggope")) {
          l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldRowCPCCCHK,"C",10,0);
        }
        l_nUpdatedRows = m_Sql.Update(m_cServer_soggope,l_cSql);
  ...
  public boolean Delete() {
    return Delete(w_COLLEG);
  }
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    CPLib.SPLinkProperties result = CPLib.GetSPLinkerProperties();
    if (CPLib.eq(p_cID,"NMXBOMFUCN")) {
      ...
      result.AppendFieldsHash("NMXBOMFUCN",CPLib.GetLinkedFieldProps("CONNES","CODINTER","C",16,0));
    }
    return result;
  }
  void InsertDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_soggope);
      l_cSql = "insert into "+m_oWrInfo_soggope.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_soggope.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"soggope")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_PRIMO,"N",1,0)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_RUOLO,"C",1,0)+", ";
      l_cSql = l_cSql+SPExtenderLib.InsertExtendedFieldsValueToSQL(extendedFields);
      l_cSql = l_cSql+m_oWrInfo_soggope.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"soggope")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_soggope,l_cSql,m_oParameters);
      if (CPLib.ne(l_nUpdatedRows,1)) {
        m_Sql.AbortTransaction();
      } else {
  ...
  void UpdateDetailRow() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_soggope);
      l_cSql = "Update "+m_oWrInfo_soggope.GetTableWriteName()+" set";
      l_cSql = l_cSql+" PRIMO = "+CPLib.ToSQL(w_PRIMO,"N",1,0);
      ...
      l_cSql = l_cSql+", RUOLO = "+CPLib.ToSQL(w_RUOLO,"C",1,0);
      if (CPLib.HasTableCPCCCHK(m_Ctx,"soggope")) {
