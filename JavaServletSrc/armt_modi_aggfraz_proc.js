...
function Help() {
windowOpenForeground('../doc/armt_modi_aggfraz_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('armt_modi_aggfraz',m_cSelectedPage);
