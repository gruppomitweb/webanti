...
m_oFather.i_last_focused_item='child_ardt_frz_contante';
...
function Help() {
windowOpenForeground('../doc/ardt_frz_contante_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'frz_contante'+'\\'+CPLib.ToCPStr(w_IDOPE);
}
...
p_d.setValue('ardt_frz_contante',m_cSelectedPage);
