...
// * --- Fine Area Manuale
public class armt_oprovvisorieBO extends armt_oprovvisorieBL {
  class SqlLoader {
    ...
    public boolean m_bLink_5_2 = false;
    ...
    public void AddJoinedLink_1_67(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_67","CONNESOPER","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_67","CONNESOPER","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_70(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_70.CONNES AS CONNES170";
        m_cSelect = m_cSelect+" ,link_1_70.RAGSOC AS RAGSOC170";
        m_cSelect = m_cSelect+" ,link_1_70.CONTO AS CONTO170";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_70","CONNESBEN","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_70","CONNESBEN","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_71(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_71.CONNES AS CONNES171";
        m_cSelect = m_cSelect+" ,link_1_71.RAGSOC AS RAGSOC171";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_71","CONNALTRO","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_71","CONNALTRO","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_5_2(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_5_2.CONNES AS CONNES502";
        m_cSelect = m_cSelect+" ,link_5_2.RAGSOC AS RAGSOC502";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_5_2","CONNESDOC","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_5_2","CONNESDOC","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_oprovvisorieBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_oprovvisorie");
    }
  ...
  public boolean CanSave() {
    ...
    boolean l_bResult;
    l_bResult = true;
    l_bResult =  ! (CPLib.Empty(w_CONNESCLI));
    ...
    if (l_bResult) {
      ...
      if (l_bResult) {
        l_bResult = CanSaveChild(ardt_xlientiope,m_cWv_ardt_xlientiope,"m_cWv_ardt_xlientiope");
        if (l_bResult) {
          l_bResult = CanSaveChild(ardt_xeneficope,m_cWv_ardt_xeneficope,"m_cWv_ardt_xeneficope");
          if (l_bResult) {
            l_bResult = CanSaveChild(ardt_xerzistiope,m_cWv_ardt_xerzistiope,"m_cWv_ardt_xerzistiope");
            if (l_bResult) {
              l_bResult = CanSaveChild(ardt_xapcoll,m_cWv_ardt_xapcoll,"m_cWv_ardt_xapcoll");
              if (l_bResult) {
                l_bResult = CanSaveChild(ardt_docopebo,m_cWv_ardt_docopebo,"m_cWv_ardt_docopebo");
                if (l_bResult) {
                  l_bResult = CanSaveChild(armt_xperazbo_agg,m_cWv_armt_xperazbo_agg,"m_cWv_armt_xperazbo_agg");
                  if (l_bResult) {
                    l_bResult = CanSaveChild(ardt_xpe_contante,m_cWv_ardt_xpe_contante,"m_cWv_ardt_xpe_contante");
                    if (l_bResult) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (l_bResult && CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          ...
          if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
            if ( ! (ardt_xlientiope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xlientiope)) {
            ...
            if (ardt_xlientiope.IsUpdated()) {
              ...
              if ( ! (ardt_xlientiope.Save(true))) {
                m_Sql.AbortTransaction();
              }
            }
          }
          if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
            if ( ! (ardt_xeneficope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xeneficope)) {
            ...
            if (ardt_xeneficope.IsUpdated()) {
              ...
              if ( ! (ardt_xeneficope.Save(true))) {
                m_Sql.AbortTransaction();
              }
            }
          }
          if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
            if ( ! (ardt_xerzistiope.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xerzistiope)) {
            ...
            if (ardt_xerzistiope.IsUpdated()) {
              ...
              if ( ! (ardt_xerzistiope.Save(true))) {
                m_Sql.AbortTransaction();
              }
            }
          }
          if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
            if ( ! (ardt_xapcoll.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xapcoll)) {
          ...
          if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
            if ( ! (armt_xperazbo_agg.IsUpdated()) && CPLib.IsUpdated(m_cWv_armt_xperazbo_agg)) {
            ...
            if (armt_xperazbo_agg.IsUpdated()) {
              ...
              if ( ! (armt_xperazbo_agg.Save(true))) {
                m_Sql.AbortTransaction();
              }
            }
          }
          if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
            if ( ! (ardt_xpe_contante.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xpe_contante)) {
            ...
            if (ardt_xpe_contante.IsUpdated()) {
              ...
              if ( ! (ardt_xpe_contante.Save(true))) {
                m_Sql.AbortTransaction();
              }
            }
          }
  ...
  public boolean Load(String p_IDBASE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_xperazbo,m_cPhName_xperazbo,m_cVirtName_xperazbo,m_cVirtName_xperazbo+".IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDBASE,"C",10,0),m_cServer_xperazbo,p_IDBASE),"");
    ...
    l_oSqlLoader.AddJoinedLink_1_70(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_71(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_4_16(m_cPhName_tbtipope,m_cServer_tbtipope);
    l_oSqlLoader.AddJoinedLink_5_2(m_cPhName_kersonbo,m_cServer_kersonbo);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_67) {
          w_xragsocct = l_rsLoad.GetString("RAGSOC167");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_70) {
          w_xragsocben = l_rsLoad.GetString("RAGSOC170");
          w_C_RAPPORTO = l_rsLoad.GetString("CONTO170");
        } else {
          Link_ULVCBLFVEU("Load");
        }
        w_CONNALTRO = l_rsLoad.GetString("CONNALTRO");
        if (l_oSqlLoader.m_bLink_1_71) {
          w_xragsocalt = l_rsLoad.GetString("RAGSOC171");
        } else {
        ...
        w_CONNESDOC = l_rsLoad.GetString("CONNESDOC");
        if (l_oSqlLoader.m_bLink_5_2) {
          w_xRAGSOCDOC = l_rsLoad.GetString("RAGSOC502");
        } else {
        ...
        ardt_xlientiope.m_lCtxLoaded = false;
        m_cWv_ardt_xeneficope = "";
        ardt_xeneficope.m_lCtxLoaded = false;
        m_cWv_ardt_xerzistiope = "";
        ardt_xerzistiope.m_lCtxLoaded = false;
        m_cWv_ardt_xapcoll = "";
        ardt_xapcoll.m_lCtxLoaded = false;
        m_cWv_ardt_docopebo = "";
        ardt_docopebo.m_lCtxLoaded = false;
        m_cWv_armt_xperazbo_agg = "";
        armt_xperazbo_agg.m_lCtxLoaded = false;
        m_cWv_ardt_xpe_contante = "";
        ardt_xpe_contante.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"xperazbo")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xperazbo);
      l_cSql = "insert into "+m_oWrInfo_xperazbo.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_xperazbo.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xperazbo")) {
      ...
      l_cSql = l_cSql+m_oWrInfo_xperazbo.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xperazbo")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_xperazbo,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xperazbo);
      l_cSql = "Update "+m_oWrInfo_xperazbo.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_xperazbo,w_IDBASE);
      l_cSql = l_cSql+m_oWrInfo_xperazbo.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xperazbo")) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          ...
          ardt_xlientiope.w_IDFILEBO = w_IDBASE;
          ardt_xlientiope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_xeneficope.w_IDFILEBO = w_IDBASE;
          ardt_xeneficope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_xerzistiope.w_IDFILEBO = w_IDBASE;
          ardt_xerzistiope.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          armt_xperazbo_agg.w_IDBASE = w_IDBASE;
          armt_xperazbo_agg.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_xpe_contante.w_IDOPE = w_IDBASE;
          ardt_xpe_contante.Delete();
        }
        CPLib.DeleteMNTs(m_Sql,m_MNTs,this);
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_xperazbo.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_xperazbo,w_IDBASE);
          l_cSql = l_cSql+m_oWrInfo_xperazbo.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"xperazbo")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_xperazbo,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"PPOPER1","i_codazi,w_IDBASE",m_cServer_xperazbo,m_Ctx.GetCompany());
    ...
    m_Sql.NextTableProg(this,"PPOPER2","i_codazi,w_NUMPROG",m_cServer_xperazbo,m_Ctx.GetCompany());
    ...
    op_NUMPROG = w_NUMPROG;
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    m_Sql.NextTableProg(this,"PRGIMPOPE","i_codazi,w_PRGIMPOPE",m_cServer_xperazbo,m_Ctx.GetCompany());
    op_PRGIMPOPE = w_PRGIMPOPE;
  }
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_calcflaglire,arfn_chkdatdoc,arfn_chksogg,arfn_chktotalelire,arfn_chktotalelire_cont,arfn_read_tipoleg,arrt_crea_idereg,arrt_imp_frischio,arrt_li_operazbo,arrt_li_xperazbo,arrt_val_benefic,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_calcflaglire,arfn_chkdatdoc,arfn_chksogg,arfn_chktotalelire,arfn_chktotalelire_cont,arfn_read_tipoleg,arrt_crea_idereg,arrt_imp_frischio,arrt_li_operazbo,arrt_li_xperazbo,arrt_val_benefic,arrt_writelog,";
}
