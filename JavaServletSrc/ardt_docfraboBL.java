...
public class ardt_docfraboBL extends ardt_docfraboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_docfrabo";
  ...
  public CPPhTableWrInfo m_oWrInfo_docfrabo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_docfrabo;
  ...
  public ardt_docfraboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_docfrabo = p_ContextObject.GetPhName("docfrabo",p_ContextObject.GetCompany(),false);
    m_cServer_docfrabo = p_ContextObject.GetServer("docfrabo");
    m_oWrInfo_docfrabo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"docfrabo",p_ContextObject.GetCompany());
    m_cVirtName_docfrabo = CPSql.ManipulateTablePhName("docfrabo",m_cServer_docfrabo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_docfrabo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_docfrabo","docfrabo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_docfrabo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_docfrabo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_docfrabo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_docfrabo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_docfrabo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_docfrabo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "docfrabo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("NUMPROG","C",11,0));
  }
  public String RowPrimaryKey() {
    return "docfrabo"+"\\"+CPLib.ToCPStr(w_CONNESCLI);
  }
