...
if ( ! (m_oFather.SaveContext_armt_cgo_qadv_operazioni_storico())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_qadv_operazioni_storico_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_qadv_operazioni_storico_dataNotSent',{'action':formaction});
}
}
}
}
...
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_cgo_qadv_operazioni_storico();
}
}
