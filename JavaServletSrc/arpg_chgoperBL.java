...
public class arpg_chgoperBL extends arpg_chgoperWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_chgoper";
  ...
  public static final String i_StateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli}";
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2}";
  public static final String i_ItemSequence = "DaDatOpe,ADatOpe,daCodCli,aCodCli";
  ...
  public arpg_chgoperBL (CPContext p_ContextObject) {
  ...
  void Link_UYVYTEMEXX_blank(String p_cType) {
    w_RAGSOC1 = "";
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_chgoper","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
