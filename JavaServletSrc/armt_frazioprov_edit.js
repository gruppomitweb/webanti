...
function DisplayErrorMessage_ardt_xlientifrz() {
if ( ! (ChildToLoad(FrameRef('ardt_xlientifrz'))) && Ne(typeof(FrameRef('ardt_xlientifrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xlientifrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_sogopefrazprov() {
if ( ! (ChildToLoad(FrameRef('ardt_sogopefrazprov'))) && Ne(typeof(FrameRef('ardt_sogopefrazprov').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_sogopefrazprov').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xeneficfrz() {
if ( ! (ChildToLoad(FrameRef('ardt_xeneficfrz'))) && Ne(typeof(FrameRef('ardt_xeneficfrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xeneficfrz').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xerzistifrz() {
if ( ! (ChildToLoad(FrameRef('ardt_xerzistifrz'))) && Ne(typeof(FrameRef('ardt_xerzistifrz').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xerzistifrz').DisplayErrorMessage();
}
}
...
function DisplayErrorMessage_armt_xraziobo_agg() {
if ( ! (ChildToLoad(FrameRef('armt_xraziobo_agg'))) && Ne(typeof(FrameRef('armt_xraziobo_agg').DisplayErrorMessage),'undefined')) {
FrameRef('armt_xraziobo_agg').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xrz_contante() {
if ( ! (ChildToLoad(FrameRef('ardt_xrz_contante'))) && Ne(typeof(FrameRef('ardt_xrz_contante').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xrz_contante').DisplayErrorMessage();
}
}
...
SetObligatory(Ctrl('AWPNTOJIRR'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) || IsObligatoryByStateDriver('C_RAG'));
SetObligatory(Ctrl('YVIKEGPYPM'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) || IsObligatoryByStateDriver('C_STA'));
SetObligatory(Ctrl('OBBUSHLGFO'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) || IsObligatoryByStateDriver('TIPOINT2'));
SetObligatory(Ctrl('TYCTKKPTQQ'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Empty(w_CODINT2) && Eq(w_gVerSim,'N') || IsObligatoryByStateDriver('DESCINTER'));
SetObligatory(Ctrl('MUTRCJYNJT'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) || IsObligatoryByStateDriver('PAESE'));
SetObligatory(Ctrl('CRVLITCYRD'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') || IsObligatoryByStateDriver('CODCAB2'));
SetObligatory(Ctrl('KDONRVZYMP'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') || IsObligatoryByStateDriver('DESC2'));
SetObligatory(Ctrl('HWGWORUQJF'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') || IsObligatoryByStateDriver('PROV2'));
}
...
if ( ! (ChildToLoad(FrameRef('armt_xraziobo_agg'))) && Ne(typeof(FrameRef('armt_xraziobo_agg').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('armt_xraziobo_agg'),['SEGNO'],['SEGNO'],true)
}
...
parent.ZtVWeb.raiseEventToEvalParms('armt_frazioprov_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_frazioprov_dataNotSent',{'action':formaction});
}
}
}
}
CheckChild.child=[{'prg':"ardt_xlientifrz",'BOScId':function(){ return FrameRef('ardt_xlientifrz')},'repeated':0},{'prg':"ardt_sogopefrazprov",'BOScId':function(){ return FrameRef('ardt_sogopefrazprov')},'repeated':0},{'prg':"ardt_xeneficfrz",'BOScId':function(){ return FrameRef('ardt_xeneficfrz')},'repeated':0},{'prg':"ardt_xerzistifrz",'BOScId':function(){ return FrameRef('ardt_xerzistifrz')},'repeated':0},{'prg':"ardt_docfrabo",'BOScId':function(){ return FrameRef('ardt_docfrabo')},'repeated':0},{'prg':"armt_xraziobo_agg",'BOScId':function(){ return FrameRef('armt_xraziobo_agg')},'repeated':0},{'prg':"ardt_xrz_contante",'BOScId':function(){ return FrameRef('ardt_xrz_contante')},'repeated':0}];
function Check() {
var l_bResult = true;
...
function SetChildVariables_armt_xraziobo_agg() {
if ( ! (ChildToLoad(FrameRef('armt_xraziobo_agg'))) && Ne(typeof(FrameRef('armt_xraziobo_agg').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('armt_xraziobo_agg'),['SEGNO'],['SEGNO'],false)
}
}
function CtxLoad_armt_xraziobo_agg() {
if (ChildToLoad(FrameRef('armt_xraziobo_agg'))) {
return [LoadContext(0,'RZOXJTRIYP'),'armt_xraziobo_agg'];
}
}
function SetChildVariables_ardt_xrz_contante() {
}
function CtxLoad_ardt_xrz_contante() {
if (ChildToLoad(FrameRef('ardt_xrz_contante'))) {
return [LoadContext(0,'QMSPZAQYXJ'),'ardt_xrz_contante'];
}
}
