...
public class armt_japotitBL extends armt_japotitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_japotit";
  ...
  public CPPhTableWrInfo m_oWrInfo_japotit;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_japotit;
  ...
  public static String[] m_EntityTables = {"japotit"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDBASE':IDBASE,'STATOREG':STATOREG,'CODDIPE':CODDIPE,'CONNESCLI':CONNESCLI,'DATAOPE':DATAOPE,'TIPOOPRAP':TIPOOPRAP,'TIPOLEG':TIPOLEG,'RAPPORTO':RAPPORTO,'DESCINTER':DESCINTER,'ardt_jntestit':ardt_jntestit"+FoundlingChildrenList("armt_japotit",true)+"}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gDataVaria':gDataVaria,'gStatus':gStatus,'gCodDip':gCodDip,'gSblocco':gSblocco,'gChkDate':gChkDate,'IDBASE':IDBASE,'STATOREG':STATOREG,'sEdit':sEdit,'flgpf':flgpf,'flgpg':flgpg,'CODINTER':CODINTER,'CODDIPE':CODDIPE,'xDescDipe':xDescDipe,'TIPOINTER':TIPOINTER,'TIPOINF':TIPOINF,'IDEREG':IDEREG,'FLAGRAP':FLAGRAP,'OPRAP':OPRAP,'OPERATORE':OPERATORE,'AUTOM':AUTOM,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CODCAB':CODCAB,'xdescrap':xdescrap,'datpaseuro':datpaseuro,'xDesReg':xDesReg,'xRagSoc':xRagSoc,'errmsg':errmsg,'Aggiorna':Aggiorna,'FLAGRAP2':FLAGRAP2,'lancio':lancio,'FLAGLIRE':FLAGLIRE,'VALUTA':VALUTA,'tipreg':tipreg,'tipregn':tipregn,'PRGIMPTIT':PRGIMPTIT,'dataoggi':dataoggi,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'xRagSocCli':xRagSocCli,'filtro':filtro,'CONNESCLI':CONNESCLI,'DATAOPE':DATAOPE,'DATAREG':DATAREG,'CDATOPE':CDATOPE,'TIPOOPRAP':TIPOOPRAP,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'RAPPORTO':RAPPORTO,'NUMPROG':NUMPROG,'DESCINTER':DESCINTER,'ardt_jntestit':ardt_jntestit,'COLLEG':COLLEG,'SESSO':SESSO,'OPERAZMOD':OPERAZMOD,'CDATREG':CDATREG"+FoundlingChildrenList("armt_japotit",true)+"}";
  public static final String i_ItemSequence = "IDBASE,STATOREG,CODDIPE,CONNESCLI,DATAOPE,TIPOOPRAP,TIPOLEG,RAPPORTO,DESCINTER,ardt_jntestit"+FoundlingChildrenList("armt_japotit",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_japotit"),new String[][]{new String[]{"IDBASE","idbase","C","10","0","campo","key1","false","false"},new String[]{"STATOREG","Stato Registrazione","C","1","0","campo","nokey","false","false"},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"CONNESCLI","","C","16","0","campo","key4","false","false"},new String[]{"DATAOPE","Data Operazione","D","8","0","campo","key2","false","true"},new String[]{"TIPOOPRAP","Tipo Informazione","C","2","0","campo","key5","false","true"},new String[]{"TIPOLEG","Tipo Legame Sogg.","C","1","0","campo","nokey","false","false"},new String[]{"RAPPORTO","","C","25","0","campo","nokey","false","true"},new String[]{"DESCINTER","","C","50","0","campo","nokey","false","false"},new String[]{"ardt_jntestit","LinkPC","","","","link_PC","","false",""}});
  ...
  public armt_japotitBL (CPContext p_ContextObject) {
    ...
    m_cPhName_japotit = p_ContextObject.GetPhName("japotit",p_ContextObject.GetCompany(),false);
    m_cServer_japotit = p_ContextObject.GetServer("japotit");
    m_oWrInfo_japotit = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"japotit",p_ContextObject.GetCompany());
    m_cVirtName_japotit = CPSql.ManipulateTablePhName("japotit",m_cServer_japotit);
    ...
    ardt_jntestit = new ardt_jntestitBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_japotit",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_jntestit.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_jntestit);
    return l_bResult;
  }
  ...
  protected boolean Link_FMTBXELZFV(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_RAPPORTO))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_jnarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_jnarapbo+((m_cPhName_jnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"RAPPORTO"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
  ...
  public boolean Calculate() {
    ...
    UpdateAutonumber();
    CopyWorkVar(this,ardt_jntestit,new String[]{"tipoprap"},new String[]{"TIPOOPRAP"},true);
  ...
  void Calculation_OEZVQSLBRM() {
    ...
    l_oRoutine_arrt_writelog.pTabella = "XAPOTIT";
    l_oRoutine_arrt_writelog.pChiave = w_IDBASE;
    l_oRoutine_arrt_writelog.Run();
    arrt_japotit_deleteR l_oRoutine_arrt_japotit_delete;
    l_oRoutine_arrt_japotit_delete = arrt_japotit_deleteR.Make(m_Ctx,this);
    l_oRoutine_arrt_japotit_delete.Run();
  }
  ...
  void Calculation_FMZMADCIPT() {
    ...
    l_oRoutine_arrt_crea_idereg.pTab = "T";
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_japotit","japotit",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_ardt_jntestit = CPLib.GetProperty(p,"m_cWv_ardt_jntestit",m_cWv_ardt_jntestit,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("jntestit");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("jntestit",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODCLI"});
    map.put("rd_var",new String[]{"w_CONNESCLI"});
    map.put("wr_var",new String[]{"w_CONNESCLI"});
    map.put("wr_field",new String[]{"CODCLI"});
    ...
    map.put("rd_var.comment",zeroSplit.split("Tipo Informazione",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("key5",-1));
    ...
    map.put("property.value",zeroSplit.split("jntestit\u0000false\u0000false\u00001\u00000\u0000ardt_jntestit\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    ...
    map.put("rd_var.obj",zeroSplit.split("campo\u0000variabile",-1));
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("jnarapbo\u0000false\u0000false\u00001\u00000\u0000\u0000false\u0000false\u0000Rapporti Continuativi\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
  }
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_japotit",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_japotit",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_jntestit = new ardt_jntestitBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_japotit",m_Ctx);
  ...
  public boolean Check() {
    ...
    if (l_bResult && (( ! (ardt_jntestit.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_jntestit)) || ( ! (ardt_jntestit.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_jntestit)))) {
      ardt_jntestit.SetFromContext(m_cWv_ardt_jntestit);
      m_cWv_ardt_jntestit = "_not_empty_";
    }
    if (l_bResult && (ardt_jntestit.m_bLoaded || ardt_jntestit.m_bUpdated)) {
      l_bResult = l_bResult && ardt_jntestit.Check();
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_japotit","administrators","utenti standard","ruolo 3","utenti confidi","ruolo 5","agenzia","area finanza","help desk","consultazione","utilità"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_japotit\\"+p_cState,"administrators","utenti standard","ruolo 3","utenti confidi","ruolo 5","agenzia","area finanza","help desk","consultazione","utilità"};
    }
    return l_Keys;
  }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"PRGJTIT1"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_japotit);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_NUMPROG = m_Ctx.AskTableProg(w_NUMPROG,11,op_NUMPROG,"PRGJTIT2"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_japotit);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PRGIMPTIT = m_Ctx.AskTableProg(w_PRGIMPTIT,15,op_PRGIMPTIT,"PRGIMPTIT"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_japotit);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (ardt_jntestit.IsUpdated()) {
        m_cWv_ardt_jntestit = ardt_jntestit.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_jntestit",m_cWv_ardt_jntestit,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "japotit"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public boolean ChildExists_ardt_jntestit() {
    if (ardt_jntestit.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_jntestit) || CPLib.IsLoaded(m_cWv_ardt_jntestit))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_jntestit.m_bLoaded)) {
      ardt_jntestit.Blank();
      ardt_jntestit.w_CODCLI = w_CONNESCLI;
      ardt_jntestit.Load();
    }
    return ardt_jntestit.m_bLoaded;
  }
  public void CtxLoad_ardt_jntestit() {
    if ( ! (ardt_jntestit.m_lCtxLoaded)) {
      ardt_jntestit.Blank();
    }
    ardt_jntestit.m_lCtxLoaded = true;
    if ( ! (ardt_jntestit.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_jntestit) || CPLib.IsLoaded(m_cWv_ardt_jntestit)) {
        ardt_jntestit.SetFromContext(m_cWv_ardt_jntestit);
        m_cWv_ardt_jntestit = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_jntestit.m_bLoaded)) {
          ardt_jntestit.Blank();
          ardt_jntestit.w_CODCLI = w_CONNESCLI;
          ardt_jntestit.Load();
          if ( ! (ardt_jntestit.m_bLoaded)) {
            ardt_jntestit.Initialize();
            ardt_jntestit.SetUpdated();
          }
          CopyWorkVar(this,ardt_jntestit,new String[]{"tipoprap"},new String[]{"TIPOOPRAP"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_jntestit,new String[]{"tipoprap"},new String[]{"TIPOOPRAP"},true);
        }
      }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_jntestit")) {
      CtxLoad_ardt_jntestit();
      return ardt_jntestit;
    }
