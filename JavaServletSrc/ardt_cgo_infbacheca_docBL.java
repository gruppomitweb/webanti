...
public class ardt_cgo_infbacheca_docBL extends ardt_cgo_infbacheca_docWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_IDBNOMFILE;
    public String w_IBDDESFILE;
  ...
  public static final String i_EntityName = "ardt_cgo_infbacheca_doc";
  ...
  public String m_cPhName_cgo_infbacheca_doc;
  public String m_cServer_cgo_infbacheca_doc;
  public CPPhTableWrInfo m_oWrInfo_cgo_infbacheca_doc;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_infbacheca_doc;
  ...
  public static String[] m_EntityTables = {"cgo_infbacheca_doc"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IBDCODICE':IBDCODICE,'m_Detail':{'IDBNOMFILE':IDBNOMFILE,'IBDDESFILE':IBDDESFILE,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("ardt_cgo_infbacheca_doc",true,true)+"}"+FoundlingChildrenList("ardt_cgo_infbacheca_doc",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IBDCODICE':IBDCODICE,'gAzienda':gAzienda,'m_Detail':{'IDBNOMFILE':IDBNOMFILE,'IBDDESFILE':IBDDESFILE,'CPROWNUM':CPROWNUM"+FoundlingChildrenList("ardt_cgo_infbacheca_doc",true,true)+"}"+FoundlingChildrenList("ardt_cgo_infbacheca_doc",true,false)+"}";
  public static final String i_ItemSequence = "IBDCODICE,m_Detail[ IDBNOMFILE IBDDESFILE CPROWNUM"+FoundlingChildrenList("ardt_cgo_infbacheca_doc",false,true)+"]"+FoundlingChildrenList("ardt_cgo_infbacheca_doc",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_cgo_infbacheca_doc"),new String[][]{new String[]{"IBDCODICE","Codice Informazione","N","10","0","campo","key1","false","false"},new String[]{"IDBNOMFILE","Nome File","C","80","0","campo","nokey","true","false"},new String[]{"IBDDESFILE","Descrizione File","C","70","0","campo","nokey","true","false"},new String[]{"CPROWNUM","","N","4","0","campo","key1","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_cgo_infbacheca_docBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_infbacheca_doc = p_ContextObject.GetPhName("cgo_infbacheca_doc",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_infbacheca_doc = p_ContextObject.GetServer("cgo_infbacheca_doc");
    m_oWrInfo_cgo_infbacheca_doc = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_infbacheca_doc",p_ContextObject.GetCompany());
    m_cVirtName_cgo_infbacheca_doc = CPSql.ManipulateTablePhName("cgo_infbacheca_doc",m_cServer_cgo_infbacheca_doc);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_cgo_infbacheca_doc",p_ContextObject);
  }
  public void Blank() {
  ...
  public void NotifyEvent(String p_cEvent) {
    if (CPLib.eq(p_cEvent,"Insert end")) {
      Calculation_KEPPPZMESL();
    } else if (CPLib.eq(p_cEvent,"Update end")) {
      Calculation_VNZOHHKEPO();
    }
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_IBDCODICE(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_IBDCODICE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_IDBNOMFILE(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IDBNOMFILE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_IBDDESFILE(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IBDDESFILE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  void Calculation_KEPPPZMESL() {
    arrt_movedoc_infbachecaR l_oRoutine_arrt_movedoc_infbacheca;
    l_oRoutine_arrt_movedoc_infbacheca = arrt_movedoc_infbachecaR.Make(m_Ctx,this);
    l_oRoutine_arrt_movedoc_infbacheca.pObj = this;
    l_oRoutine_arrt_movedoc_infbacheca.pTipo = "I";
    l_oRoutine_arrt_movedoc_infbacheca.Run();
  }
  void Calculation_VNZOHHKEPO() {
    arrt_movedoc_infbachecaR l_oRoutine_arrt_movedoc_infbacheca;
    l_oRoutine_arrt_movedoc_infbacheca = arrt_movedoc_infbachecaR.Make(m_Ctx,this);
    l_oRoutine_arrt_movedoc_infbacheca.pObj = this;
    l_oRoutine_arrt_movedoc_infbacheca.pTipo = "U";
    l_oRoutine_arrt_movedoc_infbacheca.Run();
  }
  ...
  public final static String[] m_KeyColumns = {"IBDCODICE"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_cgo_infbacheca_doc","cgo_infbacheca_doc",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_IDBNOMFILE;
      p_IDBNOMFILE = CPLib.GetProperties(trs_p.getProperty("IDBNOMFILE"),new Properties());
      Properties p_IBDDESFILE;
      p_IBDDESFILE = CPLib.GetProperties(trs_p.getProperty("IBDDESFILE"),new Properties());
      ...
      w_IBDCODICE = CPLib.GetProperty(p,"IBDCODICE",w_IBDCODICE,0);
      ...
      while (CPLib.le(i,rows)) {
        w_IDBNOMFILE = "";
        w_IDBNOMFILE = CPLib.GetProperty(p_IDBNOMFILE,"",w_IDBNOMFILE,i);
        w_IBDDESFILE = "";
        w_IBDDESFILE = CPLib.GetProperty(p_IBDDESFILE,"",w_IBDDESFILE,i);
        w_CPROWNUM = 0;
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"IBDCODICE")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"IDBNOMFILE")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"IBDDESFILE")) {
      SetUpdatedRow();
      return;
    }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_cgo_infbacheca_doc",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_cgo_infbacheca_doc",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_cgo_infbacheca_doc",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_infbacheca_doc",m_Ctx);
  ...
  public boolean Check() {
    ...
    ResetErrorMessage();
    l_bResult = true;
    if ( ! (CPLib.Empty(w_IDBNOMFILE)) &&  ! (CPLib.Empty(w_IBDDESFILE))) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_cgo_infbacheca_doc"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_cgo_infbacheca_doc\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_IDBNOMFILE;
    p_IDBNOMFILE = new Properties();
    Properties p_IBDDESFILE;
    p_IBDDESFILE = new Properties();
    Properties p_CPROWNUM;
    ...
    CPLib.PutProperty(p,"IBDCODICE",w_IBDCODICE,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_IDBNOMFILE,"",w_IDBNOMFILE,trsrow);
      CPLib.PutProperty(p_IBDDESFILE,"",w_IBDDESFILE,trsrow);
    ...
    trs_p.setProperty("IDBNOMFILE",CPLib.ToProperties(p_IDBNOMFILE));
    trs_p.setProperty("IBDDESFILE",CPLib.ToProperties(p_IBDDESFILE));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_infbacheca_doc"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("IBDCODICE","N",10,0));
  }
  public String RowPrimaryKey() {
    return "cgo_infbacheca_doc"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
  ...
  protected void TrsToWork() {
    w_IDBNOMFILE= m_oTrs.get(m_nCurrentRow).w_IDBNOMFILE;
    w_IBDDESFILE= m_oTrs.get(m_nCurrentRow).w_IBDDESFILE;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_IDBNOMFILE=w_IDBNOMFILE;
    m_oTrs.get(m_nCurrentRow).w_IBDDESFILE=w_IBDDESFILE;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_IDBNOMFILE=w_IDBNOMFILE;
    m_oDeletedRows.get(l_nRows).w_IBDDESFILE=w_IBDDESFILE;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_IDBNOMFILE)) &&  ! (CPLib.Empty(w_IBDDESFILE));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_IDBNOMFILE= m_oDeletedRows.get(l_RowNumberToSet).w_IDBNOMFILE;
    w_IBDDESFILE= m_oDeletedRows.get(l_RowNumberToSet).w_IBDDESFILE;
