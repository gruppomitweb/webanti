...
if ( ! (m_oFather.SaveContext_ardt_xocfrabo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xocfrabo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xocfrabo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xocfrabo();
}
}
SaveContext.child=[];
function BlankRow() {
