...
if (false || WindowConfirm(Translate('10322427886'))) {
Variazione()
}
}
function href_MQMNEIMSBN() {
if (false || WindowConfirm(Translate('1811853829'))) {
window.close()
}
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_fam_variazione_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_fam_variazione',m_cSelectedPage);
...
m_bCalculating=true;
if (start && Eq(At(',datavaria,',pseq),0)) {
