...
// * --- Fine Area Manuale
public class arrt_stp_stdtec_newR implements CallerWithObjs {
  ...
  public int _nfiles;
  // * --- Fine Area Manuale
  public arrt_stp_stdtec_newR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_stp_stdtec_new",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
          ...
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              ...
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_stp_stdtec_new: query on anadip returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
      ...
      if (CPLib.gt(mcFileList.RecCount(),0)) {
        ...
        /* gMsgProc := gMsgProc + 'Sono state elaborate '+LRTrim(Str(_conta,10,0))+iif(pTipo='O'," operazioni"," frazionte") + NL */
        gMsgProc = gMsgProc+"Sono state elaborate "+CPLib.LRTrim(CPLib.Str(_conta,10,0))+(CPLib.eqr(pTipo,"O")?" operazioni":" frazionte")+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
  ...
  void Page_2() throws Exception {
    ...
    try {
      ...
      _h00000095.Set("tbname","clientiope");
      _h00000095.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000095,true).GetResultSet(m_Ctx);
      ...
      _h00000097.Set("tbname","sogopebo");
      _h00000097.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000097,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
      ...
      _h00000099.Set("tbname","terzistiope");
      ...
      _h0000009B.Set("tbname","beneficope");
      ...
      _h0000009D.Set("tbname","mlientiope");
      ...
      _h0000009F.Set("tbname","mogopebo");
      ...
      _h000000A1.Set("tbname","merzistiope");
      ...
      _h000000A3.Set("tbname","meneficope");
      ...
      _h000000AA.Set("c_dadata",w_c_dadata);
      _h000000AA.Set("c_adata",w_c_adata);
      _h000000AA.Set("daCodCli",w_daCodCli);
      _h000000AA.Set("aCodCli",w_aCodCli);
      _h000000AA.Set("daCodDip",w_daCodDip);
      _h000000AA.Set("aCodDip",w_aCodDip);
      _h000000AA.Set("dacdatreg",w_dacdatreg);
      _h000000AA.Set("acdatreg",w_acdatreg);
      _h000000AA.Set("DaDatReg",w_DaDatReg);
      _h000000AA.Set("ADatReg",w_ADatReg);
      if (Cursor_qbe_alloperazbo_min_max!=null)
        Cursor_qbe_alloperazbo_min_max.Close();
      Cursor_qbe_alloperazbo_min_max = new VQRHolder("qbe_alloperazbo_min_max",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000AA,true).GetResultSet(m_Ctx);
      ...
      Cursor_qbe_alloperazbo_min_max.Close();
      // * --- End Select
      /* _mono := iif(_tot > 250,0,1) */
      _mono = CPLib.Round((CPLib.gt(_tot,250)?0:1),0);
      /* If _mono = 1 */
      if (CPLib.eqr(_mono,1)) {
        ...
        /* _cicli := iif(Mod(_tot,250) <> 0,Int(_tot/250) + 1,Int(_tot/250)) */
        _cicli = CPLib.Round((CPLib.ne(CPLib.Mod(_tot,250),0)?CPLib.Int(_tot/250)+1:CPLib.Int(_tot/250)),0);
      } // End If
      /* _contacicli := 1 */
      ...
      while (CPLib.le(_contacicli,_cicli)) {
        ...
        if (CPLib.eqr(_mono,1)) {
          ...
          if (CPLib.eqr(_contacicli,1)) {
            ...
            _bottom = CPLib.Round(_top+1,0);
            /* _top := _bottom + 249 */
            _top = CPLib.Round(_bottom+249,0);
          } // End If
        } // End If
        /* If Empty(_oldmsg) */
        ...
        if (CPLib.ge(_top,_min)) {
          ...
          SPBridge.HMCaller _h000000C6;
          _h000000C6 = new SPBridge.HMCaller();
          _h000000C6.Set("m_cVQRList",m_cVQRList);
          _h000000C6.Set("c_dadata",w_c_dadata);
          _h000000C6.Set("c_adata",w_c_adata);
          _h000000C6.Set("daCodCli",w_daCodCli);
          _h000000C6.Set("aCodCli",w_aCodCli);
          _h000000C6.Set("daCodDip",w_daCodDip);
          _h000000C6.Set("aCodDip",w_aCodDip);
          _h000000C6.Set("_bottom",_bottom);
          _h000000C6.Set("_top",_top);
          _h000000C6.Set("dacdatreg",w_dacdatreg);
          _h000000C6.Set("acdatreg",w_acdatreg);
          _h000000C6.Set("DaDatReg",w_DaDatReg);
          _h000000C6.Set("ADatReg",w_ADatReg);
          if (Cursor_qbe_alloperazbo_lim!=null)
            Cursor_qbe_alloperazbo_lim.Close();
          Cursor_qbe_alloperazbo_lim = new VQRHolder("qbe_alloperazbo_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000C6,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_alloperazbo_lim.Eof())) {
            ...
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000000D6")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000000D7")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_qbe_alloperazbo_lim.GetString("CODINT2"))))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on inter2bo into routine arrt_stp_stdtec_new returns two or more records. This item should return only a record.");
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000000E2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_alloperazbo_lim.GetString("CONNESCLI")))) {
                  ...
                  Cursor_personbo.ActionOnClose(new Runnable() {
                    public void run() {
                      if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
                        com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
                        if ( ! (CPLib.IsNull(info))) {
                          info.log("Routine arrt_stp_stdtec_new: query on personbo returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
                        }
                      }
                    }
                    });
                  ...
                  Cursor_wersonbo.ActionOnClose(new Runnable() {
                    public void run() {
                      if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
                        com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
                        if ( ! (CPLib.IsNull(info))) {
                          info.log("Routine arrt_stp_stdtec_new: query on wersonbo returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
                        }
                      }
                    }
                    });
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000000ED")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contacli,0)) {
                ...
                while ( ! (Cursor_clientiope.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_clientiope.GetString("CODSOG"),Cursor_qbe_alloperazbo_lim.GetString("CONNESCLI"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000000FA")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contamli,0)) {
                ...
                while ( ! (Cursor_mlientiope.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_mlientiope.GetString("CODSOG"),Cursor_qbe_alloperazbo_lim.GetString("CONNESCLI"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000107")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_alloperazbo_lim.GetString("CONNESOPER")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000112")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contaopr,0)) {
                ...
                while ( ! (Cursor_sogopebo.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_sogopebo.GetString("CODSOG"),Cursor_qbe_alloperazbo_lim.GetString("CONNESOPER"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000011F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contampr,0)) {
                ...
                while ( ! (Cursor_mogopebo.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_mogopebo.GetString("CODSOG"),Cursor_qbe_alloperazbo_lim.GetString("CONNESOPER"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000012C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_alloperazbo_lim.GetString("CONNALTRO")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000137")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contater,0)) {
                ...
                while ( ! (Cursor_terzistiope.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_terzistiope.GetString("CODSOG"),Cursor_qbe_alloperazbo_lim.GetString("CONNALTRO"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000144")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contamer,0)) {
                ...
                while ( ! (Cursor_merzistiope.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_merzistiope.GetString("CODSOG"),Cursor_qbe_alloperazbo_lim.GetString("CONNALTRO"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000151")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_alloperazbo_lim.GetString("C_RAG")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000156")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.ne(Cursor_qbe_alloperazbo_lim.GetString("STATOREG"),"3")) {
              ...
              if (CPLib.gt(_contaben,0)) {
                ...
                while ( ! (Cursor_beneficope.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000015C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.eqr(Cursor_qbe_alloperazbo_lim.GetString("STATOREG"),"3")) {
              ...
              if (CPLib.gt(_contamen,0)) {
                ...
                while ( ! (Cursor_meneficope.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000162")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_3() throws Exception {
    ...
    try {
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000018D;
      _h0000018D = new SPBridge.HMCaller();
      _h0000018D.Set("m_cVQRList",m_cVQRList);
      _h0000018D.Set("tbname","xlientiope");
      _h0000018D.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000018D,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contacli := qbe_tab_mmc->tot */
        _contacli = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000018F;
      _h0000018F = new SPBridge.HMCaller();
      _h0000018F.Set("m_cVQRList",m_cVQRList);
      _h0000018F.Set("tbname","xogopebo");
      _h0000018F.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000018F,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contaopr := qbe_tab_mmc->tot */
        _contaopr = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      _h00000191.Set("tbname","xerzistiope");
      _h00000191.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000191,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contater := qbe_tab_mmc->tot */
        _contater = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000193;
      _h00000193 = new SPBridge.HMCaller();
      _h00000193.Set("m_cVQRList",m_cVQRList);
      _h00000193.Set("tbname","xeneficope");
      _h00000193.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000193,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contaben := qbe_tab_mmc->tot */
        _contaben = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      _h0000019B.Set("tbname","xperazbo");
      _h0000019B.Set("fldname","PRGIMPOPE");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000019B,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
      ...
      while (CPLib.le(_contacicli,_cicli)) {
        ...
        if (CPLib.ge(_top,_min)) {
          ...
          SPBridge.HMCaller _h000001AE;
          _h000001AE = new SPBridge.HMCaller();
          _h000001AE.Set("m_cVQRList",m_cVQRList);
          _h000001AE.Set("c_dadata",w_c_dadata);
          _h000001AE.Set("c_adata",w_c_adata);
          _h000001AE.Set("daCodCli",w_daCodCli);
          _h000001AE.Set("aCodCli",w_aCodCli);
          _h000001AE.Set("daCodDip",w_daCodDip);
          _h000001AE.Set("aCodDip",w_aCodDip);
          _h000001AE.Set("_bottom",_bottom);
          _h000001AE.Set("_top",_top);
          if (Cursor_qbe_allxperazbo_lim!=null)
            Cursor_qbe_allxperazbo_lim.Close();
          Cursor_qbe_allxperazbo_lim = new VQRHolder("qbe_allxperazbo_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000001AE,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_allxperazbo_lim.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001BE")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001BF")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001CA")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxperazbo_lim.GetString("CONNESCLI")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001D5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000001D5(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxperazbo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("I","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxperazbo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.gt(_contacli,0)) {
              ...
              while ( ! (Cursor_xlientiope.Eof())) {
                ...
                if (CPLib.ne(Cursor_xlientiope.GetString("CODSOG"),Cursor_qbe_allxperazbo_lim.GetString("CONNESCLI"))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001E1")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxperazbo_lim.GetString("CONNESOPER")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001EC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.gt(_contaopr,0)) {
              ...
              while ( ! (Cursor_xogopebo.Eof())) {
                ...
                if (CPLib.ne(CPLib.LRTrim(Cursor_xogopebo.GetString("CODSOG")),CPLib.LRTrim(Cursor_qbe_allxperazbo_lim.GetString("CONNESOPER")))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000001F8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_000001F8(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxperazbo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("O","?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxperazbo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxperazbo_lim.GetString("CONNALTRO")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000203")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.gt(_contater,0)) {
              ...
              while ( ! (Cursor_xerzistiope.Eof())) {
                ...
                if (CPLib.ne(Cursor_xerzistiope.GetString("CODSOG"),Cursor_qbe_allxperazbo_lim.GetString("CONNALTRO"))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000020F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_0000020F(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxperazbo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("T","?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxperazbo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxperazbo_lim.GetString("C_RAG")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000214")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.gt(_contaben,0)) {
              ...
              while ( ! (Cursor_xeneficope.Eof())) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000219")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_4() throws Exception {
    ...
    try {
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000022F;
      _h0000022F = new SPBridge.HMCaller();
      _h0000022F.Set("m_cVQRList",m_cVQRList);
      _h0000022F.Set("tbname","clientifrz");
      _h0000022F.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000022F,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contacli := qbe_tab_mmc->tot */
        _contacli = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000231;
      _h00000231 = new SPBridge.HMCaller();
      _h00000231.Set("m_cVQRList",m_cVQRList);
      _h00000231.Set("tbname","sogopefbo");
      _h00000231.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000231,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contaopr := qbe_tab_mmc->tot */
        _contaopr = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000233;
      _h00000233 = new SPBridge.HMCaller();
      _h00000233.Set("m_cVQRList",m_cVQRList);
      _h00000233.Set("tbname","terzistifrz");
      _h00000233.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000233,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contater := qbe_tab_mmc->tot */
        _contater = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000235;
      _h00000235 = new SPBridge.HMCaller();
      _h00000235.Set("m_cVQRList",m_cVQRList);
      _h00000235.Set("tbname","beneficfrz");
      _h00000235.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000235,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contaben := qbe_tab_mmc->tot */
        _contaben = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000237;
      _h00000237 = new SPBridge.HMCaller();
      _h00000237.Set("m_cVQRList",m_cVQRList);
      _h00000237.Set("tbname","mlientifrz");
      _h00000237.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000237,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contamli := qbe_tab_mmc->tot */
        _contamli = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000239;
      _h00000239 = new SPBridge.HMCaller();
      _h00000239.Set("m_cVQRList",m_cVQRList);
      _h00000239.Set("tbname","mogopefbo");
      _h00000239.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000239,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contampr := qbe_tab_mmc->tot */
        _contampr = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000023B;
      _h0000023B = new SPBridge.HMCaller();
      _h0000023B.Set("m_cVQRList",m_cVQRList);
      _h0000023B.Set("tbname","merzistifrz");
      _h0000023B.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000023B,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contamer := qbe_tab_mmc->tot */
        _contamer = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      _h0000023D.Set("tbname","meneficfrz");
      _h0000023D.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000023D,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contamen := qbe_tab_mmc->tot */
        _contamen = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      _h00000244.Set("tbname","fraziobo");
      _h00000244.Set("fldname","PRGIMPFRZ");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000244,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _min := qbe_tab_mmc->min */
        _min = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("min"),0);
        /* _max := qbe_tab_mmc->max */
      ...
      while (CPLib.le(_contacicli,_cicli)) {
        ...
        if (CPLib.ge(_top,_min)) {
          ...
          _h00000257.Set("c_dadata",w_c_dadata);
          _h00000257.Set("c_adata",w_c_adata);
          _h00000257.Set("daCodCli",w_daCodCli);
          _h00000257.Set("aCodCli",w_aCodCli);
          _h00000257.Set("daCodDip",w_daCodDip);
          _h00000257.Set("aCodDip",w_aCodDip);
          _h00000257.Set("_bottom",_bottom);
          _h00000257.Set("_top",_top);
          if (Cursor_qbe_allfraziobo_lim!=null)
            Cursor_qbe_allfraziobo_lim.Close();
          Cursor_qbe_allfraziobo_lim = new VQRHolder("qbe_allfraziobo_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000257,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_allfraziobo_lim.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000267")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000268")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000273")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo_lim.GetString("CONNESCLI")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000027E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contacli,0)) {
                ...
                while ( ! (Cursor_clientifrz.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_clientifrz.GetString("CODSOG"),Cursor_qbe_allfraziobo_lim.GetString("CONNESCLI"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000028B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contamli,0)) {
                ...
                while ( ! (Cursor_mlientifrz.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_mlientifrz.GetString("CODSOG"),Cursor_qbe_allfraziobo_lim.GetString("CONNESCLI"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000298")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo_lim.GetString("CONNESOPER")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002A3")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000002A3(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("O","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.gt(_contaopr,0)) {
                ...
                while ( ! (Cursor_sogopefbo.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_sogopefbo.GetString("CODSOG"),Cursor_qbe_allfraziobo_lim.GetString("CONNESOPER"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002B0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contampr,0)) {
                ...
                while ( ! (Cursor_mogopefbo.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_mogopefbo.GetString("CODSOG"),Cursor_qbe_allfraziobo_lim.GetString("CONNESOPER"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002BD")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo_lim.GetString("CONNALTRO")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002C8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000002C8(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("T","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.gt(_contater,0)) {
                ...
                while ( ! (Cursor_terzistifrz.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_terzistifrz.GetString("CODSOG"),Cursor_qbe_allfraziobo_lim.GetString("CONNALTRO"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002D5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.gt(_contamer,0)) {
                ...
                while ( ! (Cursor_merzistifrz.Eof())) {
                  ...
                  if (CPLib.ne(Cursor_merzistifrz.GetString("CODSOG"),Cursor_qbe_allfraziobo_lim.GetString("CONNALTRO"))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002E2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo_lim.GetString("C_RAG")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002E7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.ne(Cursor_qbe_allfraziobo_lim.GetString("STATOREG"),"3")) {
              ...
              if (CPLib.gt(_contaben,0)) {
                ...
                while ( ! (Cursor_beneficfrz.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002ED")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.ne(Cursor_qbe_allfraziobo_lim.GetString("STATOREG"),"3")) {
              ...
              if (CPLib.gt(_contamen,0)) {
                ...
                while ( ! (Cursor_meneficfrz.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"000002F3")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_000002F3(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("C","?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
  ...
  void Page_5() throws Exception {
    ...
    try {
      ...
      _h00000309.Set("tbname","xlientifrz");
      _h00000309.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000309,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contacli := qbe_tab_mmc->tot */
        _contacli = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000030B;
      _h0000030B = new SPBridge.HMCaller();
      _h0000030B.Set("m_cVQRList",m_cVQRList);
      _h0000030B.Set("tbname","xogopefbo");
      _h0000030B.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000030B,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contaopr := qbe_tab_mmc->tot */
        _contaopr = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000030D;
      _h0000030D = new SPBridge.HMCaller();
      _h0000030D.Set("m_cVQRList",m_cVQRList);
      _h0000030D.Set("tbname","xerzistifrz");
      _h0000030D.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000030D,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contater := qbe_tab_mmc->tot */
        _contater = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      // * --- End Select
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h0000030F;
      _h0000030F = new SPBridge.HMCaller();
      _h0000030F.Set("m_cVQRList",m_cVQRList);
      _h0000030F.Set("tbname","xeneficfrz");
      _h0000030F.Set("fldname","IDFILEBO");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000030F,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _contaben := qbe_tab_mmc->tot */
        _contaben = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("tot"),0);
        Cursor_qbe_tab_mmc.Next();
      ...
      _mono = CPLib.Round(0,0);
      // * --- Select from qbe_tab_mmc
      SPBridge.HMCaller _h00000317;
      _h00000317 = new SPBridge.HMCaller();
      _h00000317.Set("m_cVQRList",m_cVQRList);
      _h00000317.Set("tbname","xraziobo");
      _h00000317.Set("fldname","PRGIMPFRZ");
      if (Cursor_qbe_tab_mmc!=null)
        Cursor_qbe_tab_mmc.Close();
      Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000317,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_tab_mmc.Eof())) {
        /* _min := qbe_tab_mmc->min */
        _min = CPLib.Round(Cursor_qbe_tab_mmc.GetDouble("min"),0);
        /* _max := qbe_tab_mmc->max */
      ...
      while (CPLib.le(_contacicli,_cicli)) {
        ...
        if (CPLib.ge(_top,_min)) {
          ...
          SPBridge.HMCaller _h0000032A;
          _h0000032A = new SPBridge.HMCaller();
          _h0000032A.Set("m_cVQRList",m_cVQRList);
          _h0000032A.Set("c_dadata",w_c_dadata);
          _h0000032A.Set("c_adata",w_c_adata);
          _h0000032A.Set("daCodCli",w_daCodCli);
          _h0000032A.Set("aCodCli",w_aCodCli);
          _h0000032A.Set("daCodDip",w_daCodDip);
          _h0000032A.Set("aCodDip",w_aCodDip);
          _h0000032A.Set("_bottom",_bottom);
          _h0000032A.Set("_top",_top);
          if (Cursor_qbe_allxraziobo_lim!=null)
            Cursor_qbe_allxraziobo_lim.Close();
          Cursor_qbe_allxraziobo_lim = new VQRHolder("qbe_allxraziobo_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h0000032A,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_allxraziobo_lim.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000033A")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000033B")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter("1=1");
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000346")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000346(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxraziobo_lim.GetString("CONNESCLI")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000351")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000351(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("I","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.gt(_contacli,0)) {
              ...
              while ( ! (Cursor_xlientifrz.Eof())) {
                ...
                if (CPLib.ne(Cursor_xlientifrz.GetString("CODSOG"),Cursor_qbe_allxraziobo_lim.GetString("CONNESCLI"))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000035D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_0000035D(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("I","?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxraziobo_lim.GetString("CONNESOPER")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000368")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000368(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("O","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.gt(_contaopr,0)) {
              ...
              while ( ! (Cursor_xogopefbo.Eof())) {
                ...
                if (CPLib.ne(Cursor_xogopefbo.GetString("CODSOG"),Cursor_qbe_allxraziobo_lim.GetString("CONNESOPER"))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000374")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_00000374(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("O","?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxraziobo_lim.GetString("CONNALTRO")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000037F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_0000037F(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("T","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.gt(_contater,0)) {
              ...
              while ( ! (Cursor_xerzistifrz.Eof())) {
                ...
                if (CPLib.ne(Cursor_xerzistifrz.GetString("CODSOG"),Cursor_qbe_allxraziobo_lim.GetString("CONNALTRO"))) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"0000038B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_0000038B(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL("T","?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_allxraziobo_lim.GetString("C_RAG")))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000390")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if (CPLib.gt(_contaben,0)) {
              ...
              while ( ! (Cursor_xeneficfrz.Eof())) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_soggettioper",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_stp_stdtec_new",306,"00000395")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000395(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL("C","?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allxraziobo_lim.GetString("NUMPROG"),"?",0,0,m_cServer)+", ";
  ...
  public static arrt_stp_stdtec_newR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_stp_stdtec_newR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pTipo = CPLib.Space(1);
    pAUI = CPLib.Space(1);
  ...
  protected static String GetFieldsName_000001D5(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_000001F8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_0000020F(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_000002A3(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_000002C8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_000002F3(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_00000346(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"DATAOPE,";
  ...
  protected static String GetFieldsName_00000351(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_0000035D(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_00000368(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_00000374(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_0000037F(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_0000038B(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
  ...
  protected static String GetFieldsName_00000395(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPOPERS,";
    p_cSql = p_cSql+"NUMPROG,";
