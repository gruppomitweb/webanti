...
if ( ! (m_oFather.SaveContext_ardt_docfrabo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_docfrabo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_docfrabo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_docfrabo();
}
}
SaveContext.child=[];
function BlankRow() {
