...
public class arpg_scaricodati_annoBL extends arpg_scaricodati_annoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_scaricodati_anno";
  ...
  public static final String i_StateStructure = "{'daanno':daanno,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO,'a_anno':a_anno}";
  public static final String i_CompleteStateStructure = "{'daanno':daanno,'gIntemediario':gIntemediario,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO,'gDescAzi':gDescAzi,'a_anno':a_anno}";
  public static final String i_ItemSequence = "daanno,CFINVIO,CAFINVIO,FILEINVIO,DATAINVIO,a_anno";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daanno","","N","4","0","variabile","nokey","false","false"},new String[]{"CFINVIO","Codice Fiscale Organo Invio File","C","16","0","variabile","nokey","false","false"},new String[]{"CAFINVIO","Codice CAF Organo Invio","C","5","0","variabile","nokey","false","false"},new String[]{"FILEINVIO","Tipo Preparazione FIle","C","1","0","variabile","nokey","false","false"},new String[]{"DATAINVIO","Data Impegno Organo Invio","D","8","0","variabile","nokey","false","false"},new String[]{"a_anno","","N","4","0","variabile","nokey","false","false"}});
  ...
  public arpg_scaricodati_annoBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_daanno = CPLib.Year(CPLib.Date());
    Link_AHMXEPADOR();
    w_a_anno = CPLib.Year(CPLib.Date());
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_daanno(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_daanno = p_workVariableValue;
    // 
    l_bResult = CPLib.ge(w_daanno,2008);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
  ...
  public boolean Set_a_anno(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_a_anno = p_workVariableValue;
    // 
    l_bResult = CPLib.ge(w_a_anno,2008);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "L'utilizzo di questa maschera consente date dal 2008 in avanti";
    }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_scaricodati_anno","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_daanno = CPLib.GetProperty(p,"daanno",w_daanno,0);
      ...
      w_a_anno = CPLib.GetProperty(p,"a_anno",w_a_anno,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
