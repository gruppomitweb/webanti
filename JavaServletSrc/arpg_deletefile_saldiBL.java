...
public class arpg_deletefile_saldiBL extends arpg_deletefile_saldiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_deletefile_saldi";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'anno':anno,'idbase':idbase}";
  ...
  public arpg_deletefile_saldiBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_deletefile_saldi","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_nomefile","w_anno","w_idbase"});
