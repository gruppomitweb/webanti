...
public class ardt_ae_delegaboBL extends ardt_ae_delegaboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_ae_delegabo";
  ...
  public CPPhTableWrInfo m_oWrInfo_jelegabo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_jelegabo;
  ...
  public static String[] m_EntityTables = {"jelegabo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE"+FoundlingChildrenList("ardt_ae_delegabo",true,true)+"}"+FoundlingChildrenList("ardt_ae_delegabo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DESCINTER':DESCINTER,'descdele':descdele,'DATAINI':DATAINI,'TIPORAP':TIPORAP,'TIPOPERS':TIPOPERS,'STATOREG':STATOREG,'OPERAZMOD':OPERAZMOD,'DATARETT':DATARETT,'IDEREG':IDEREG,'COLLEGAMEN':COLLEGAMEN,'DATAFINE':DATAFINE,'IDBASE':IDBASE,'UCODE':UCODE,'tiporegr':tiporegr,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'NUMPROG1':NUMPROG1,'NUMPROG2':NUMPROG2,'xRagSoc':xRagSoc,'NOAGE':NOAGE"+FoundlingChildrenList("ardt_ae_delegabo",true,true)+"}"+FoundlingChildrenList("ardt_ae_delegabo",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER DATAINI DATAFINE"+FoundlingChildrenList("ardt_ae_delegabo",false,true)+"]"+FoundlingChildrenList("ardt_ae_delegabo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_ae_delegabo"),new String[][]{new String[]{"RAPPORTO","Rapporto (Copia della testata)","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","","C","16","0","campo","nokey","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","true"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","true"}});
  ...
  public int m_nCPRowNum;
  public ardt_ae_delegaboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_jelegabo = p_ContextObject.GetPhName("jelegabo",p_ContextObject.GetCompany(),false);
    m_cServer_jelegabo = p_ContextObject.GetServer("jelegabo");
    m_oWrInfo_jelegabo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"jelegabo",p_ContextObject.GetCompany());
    m_cVirtName_jelegabo = CPSql.ManipulateTablePhName("jelegabo",m_cServer_jelegabo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_delegabo",p_ContextObject);
  }
  public void Blank() {
    ...
    w_xRagSoc = "";
    w_xRagSoc = ( ! (CPLib.Empty(CPLib.LRTrim(w_descdele)))?w_descdele:( ! (CPLib.Empty(w_CODINTER))?"Soggetto non presente in anagrafica":""));
    w_NOAGE = "N";
    ...
    if ( ! (CPLib.Empty(w_CODINTER))) {
      ...
      try {
        ...
        if (l_bLoaded) {
          ...
          w_descdele = l_rsLink.GetString("RAGSOC");
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_ae_delegabo","jelegabo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_descdele;
      p_descdele = CPLib.GetProperties(trs_p.getProperty("descdele"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_descdele = "";
        w_descdele = CPLib.GetProperty(p_descdele,"",w_descdele,i);
        w_tiporegr = 0;
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_CODINTER","w_descdele","w_DOMICILIO","w_DESCCIT","w_PROVINCIA","w_CAP"});
    ...
    map.put("rd_var.comment",zeroSplit.split("\u0000Ragione Sociale\u0000Indirizzo\u0000Città\u0000Provincia\u0000CAP",-1));
    ...
    map.put("property.value",zeroSplit.split("personbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Soggetti Registrati\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_ae_delegabo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_ae_delegabo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_ae_delegabo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_delegabo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_ae_delegabo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_ae_delegabo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_descdele,"",w_descdele,trsrow);
    ...
    trs_p.setProperty("descdele",CPLib.ToProperties(p_descdele));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "jelegabo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "jelegabo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
  ...
  protected void TrsToWork() {
    ...
    w_descdele= m_oTrs.get(m_nCurrentRow).w_descdele;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_descdele=w_descdele;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_descdele=w_descdele;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_descdele= m_oDeletedRows.get(l_RowNumberToSet).w_descdele;
