...
public class ardt_destemailBL extends ardt_destemailWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_DWNOMINATIVO;
    public String w_DWEMAIL;
    public double w_CPROWNUM;
    public String w_DWFLG380;
    public String w_DWFLGVLT;
    public String w_DWFLGQADV;
  ...
  public static final String i_EntityName = "ardt_destemail";
  ...
  public CPPhTableWrInfo m_oWrInfo_destwarn;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_destwarn;
  ...
  public static String[] m_EntityTables = {"destwarn"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'DWCODINT':DWCODINT,'m_Detail':{'DWNOMINATIVO':DWNOMINATIVO,'DWEMAIL':DWEMAIL,'CPROWNUM':CPROWNUM,'DWFLG380':DWFLG380,'DWFLGVLT':DWFLGVLT,'DWFLGQADV':DWFLGQADV"+FoundlingChildrenList("ardt_destemail",true,true)+"}"+FoundlingChildrenList("ardt_destemail",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'DWCODINT':DWCODINT,'m_Detail':{'DWNOMINATIVO':DWNOMINATIVO,'DWEMAIL':DWEMAIL,'CPROWNUM':CPROWNUM,'DWFLG380':DWFLG380,'DWFLGVLT':DWFLGVLT,'DWFLGQADV':DWFLGQADV"+FoundlingChildrenList("ardt_destemail",true,true)+"}"+FoundlingChildrenList("ardt_destemail",true,false)+"}";
  public static final String i_ItemSequence = "DWCODINT,m_Detail[ DWNOMINATIVO DWEMAIL CPROWNUM DWFLG380 DWFLGVLT DWFLGQADV"+FoundlingChildrenList("ardt_destemail",false,true)+"]"+FoundlingChildrenList("ardt_destemail",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_destemail"),new String[][]{new String[]{"DWCODINT","Codice Intermediario","C","11","0","campo","key1","false","false"},new String[]{"DWNOMINATIVO","Nominativo","C","50","0","campo","nokey","true","false"},new String[]{"DWEMAIL","Email Destinatari","C","50","0","campo","nokey","true","false"},new String[]{"CPROWNUM","","N","3","0","campo","key1","true","false"},new String[]{"DWFLG380","Mail 380","C","1","0","campo","nokey","true","false"},new String[]{"DWFLGVLT","Mail VLT","C","1","0","campo","nokey","true","false"},new String[]{"DWFLGQADV","Mail QADV","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_destemailBL (CPContext p_ContextObject) {
    ...
    m_cPhName_destwarn = p_ContextObject.GetPhName("destwarn",p_ContextObject.GetCompany(),false);
    m_cServer_destwarn = p_ContextObject.GetServer("destwarn");
    m_oWrInfo_destwarn = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"destwarn",p_ContextObject.GetCompany());
    m_cVirtName_destwarn = CPSql.ManipulateTablePhName("destwarn",m_cServer_destwarn);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_destemail",p_ContextObject);
  }
  public void Blank() {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_DWCODINT(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_DWCODINT = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_DWNOMINATIVO(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DWNOMINATIVO = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_DWEMAIL(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DWEMAIL = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_DWFLG380(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DWFLG380 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_DWFLGVLT(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DWFLGVLT = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_DWFLGQADV(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DWFLGQADV = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"DWCODINT"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_destemail","destwarn",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_DWNOMINATIVO;
      p_DWNOMINATIVO = CPLib.GetProperties(trs_p.getProperty("DWNOMINATIVO"),new Properties());
      Properties p_DWEMAIL;
      p_DWEMAIL = CPLib.GetProperties(trs_p.getProperty("DWEMAIL"),new Properties());
      Properties p_CPROWNUM;
      p_CPROWNUM = CPLib.GetProperties(trs_p.getProperty("CPROWNUM"),new Properties());
      Properties p_DWFLG380;
      p_DWFLG380 = CPLib.GetProperties(trs_p.getProperty("DWFLG380"),new Properties());
      Properties p_DWFLGVLT;
      p_DWFLGVLT = CPLib.GetProperties(trs_p.getProperty("DWFLGVLT"),new Properties());
      Properties p_DWFLGQADV;
      p_DWFLGQADV = CPLib.GetProperties(trs_p.getProperty("DWFLGQADV"),new Properties());
      ...
      w_DWCODINT = CPLib.GetProperty(p,"DWCODINT",w_DWCODINT,0);
      ...
      while (CPLib.le(i,rows)) {
        w_DWNOMINATIVO = "";
        w_DWNOMINATIVO = CPLib.GetProperty(p_DWNOMINATIVO,"",w_DWNOMINATIVO,i);
        w_DWEMAIL = "";
        w_DWEMAIL = CPLib.GetProperty(p_DWEMAIL,"",w_DWEMAIL,i);
        w_CPROWNUM = 0;
        w_CPROWNUM = CPLib.GetProperty(p_CPROWNUM,"",w_CPROWNUM,i);
        w_DWFLG380 = "";
        w_DWFLG380 = CPLib.GetProperty(p_DWFLG380,"",w_DWFLG380,i);
        w_DWFLGVLT = "";
        w_DWFLGVLT = CPLib.GetProperty(p_DWFLGVLT,"",w_DWFLGVLT,i);
        w_DWFLGQADV = "";
        w_DWFLGQADV = CPLib.GetProperty(p_DWFLGQADV,"",w_DWFLGQADV,i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"DWCODINT")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"DWNOMINATIVO")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"DWEMAIL")) {
      SetUpdatedRow();
      return;
    }
    ...
    if (CPLib.eq(p_cName,"DWFLG380")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"DWFLGVLT")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"DWFLGQADV")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_destemail",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_destemail",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_destemail",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_destemail",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_destemail"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_destemail\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_DWNOMINATIVO;
    p_DWNOMINATIVO = new Properties();
    Properties p_DWEMAIL;
    p_DWEMAIL = new Properties();
    Properties p_CPROWNUM;
    p_CPROWNUM = new Properties();
    Properties p_DWFLG380;
    p_DWFLG380 = new Properties();
    Properties p_DWFLGVLT;
    p_DWFLGVLT = new Properties();
    Properties p_DWFLGQADV;
    p_DWFLGQADV = new Properties();
    Properties p_m_nCPRowNum;
    ...
    CPLib.PutProperty(p,"DWCODINT",w_DWCODINT,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_DWNOMINATIVO,"",w_DWNOMINATIVO,trsrow);
      CPLib.PutProperty(p_DWEMAIL,"",w_DWEMAIL,trsrow);
      CPLib.PutProperty(p_CPROWNUM,"",w_CPROWNUM,trsrow);
      CPLib.PutProperty(p_DWFLG380,"",w_DWFLG380,trsrow);
      CPLib.PutProperty(p_DWFLGVLT,"",w_DWFLGVLT,trsrow);
      CPLib.PutProperty(p_DWFLGQADV,"",w_DWFLGQADV,trsrow);
    ...
    trs_p.setProperty("DWNOMINATIVO",CPLib.ToProperties(p_DWNOMINATIVO));
    trs_p.setProperty("DWEMAIL",CPLib.ToProperties(p_DWEMAIL));
    trs_p.setProperty("CPROWNUM",CPLib.ToProperties(p_CPROWNUM));
    trs_p.setProperty("DWFLG380",CPLib.ToProperties(p_DWFLG380));
    trs_p.setProperty("DWFLGVLT",CPLib.ToProperties(p_DWFLGVLT));
    trs_p.setProperty("DWFLGQADV",CPLib.ToProperties(p_DWFLGQADV));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "destwarn"+"\\"+CPLib.ToCPStr(p_Caller.GetString("DWCODINT","C",11,0));
  }
  public String RowPrimaryKey() {
    return "destwarn"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
  ...
  protected void TrsToWork() {
    w_DWNOMINATIVO= m_oTrs.get(m_nCurrentRow).w_DWNOMINATIVO;
    w_DWEMAIL= m_oTrs.get(m_nCurrentRow).w_DWEMAIL;
    w_CPROWNUM= m_oTrs.get(m_nCurrentRow).w_CPROWNUM;
    w_DWFLG380= m_oTrs.get(m_nCurrentRow).w_DWFLG380;
    w_DWFLGVLT= m_oTrs.get(m_nCurrentRow).w_DWFLGVLT;
    w_DWFLGQADV= m_oTrs.get(m_nCurrentRow).w_DWFLGQADV;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_DWNOMINATIVO=w_DWNOMINATIVO;
    m_oTrs.get(m_nCurrentRow).w_DWEMAIL=w_DWEMAIL;
    m_oTrs.get(m_nCurrentRow).w_CPROWNUM=w_CPROWNUM;
    m_oTrs.get(m_nCurrentRow).w_DWFLG380=w_DWFLG380;
    m_oTrs.get(m_nCurrentRow).w_DWFLGVLT=w_DWFLGVLT;
    m_oTrs.get(m_nCurrentRow).w_DWFLGQADV=w_DWFLGQADV;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_DWNOMINATIVO=w_DWNOMINATIVO;
    m_oDeletedRows.get(l_nRows).w_DWEMAIL=w_DWEMAIL;
    m_oDeletedRows.get(l_nRows).w_CPROWNUM=w_CPROWNUM;
    m_oDeletedRows.get(l_nRows).w_DWFLG380=w_DWFLG380;
    m_oDeletedRows.get(l_nRows).w_DWFLGVLT=w_DWFLGVLT;
    m_oDeletedRows.get(l_nRows).w_DWFLGQADV=w_DWFLGQADV;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_DWNOMINATIVO));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_DWNOMINATIVO= m_oDeletedRows.get(l_RowNumberToSet).w_DWNOMINATIVO;
    w_DWEMAIL= m_oDeletedRows.get(l_RowNumberToSet).w_DWEMAIL;
    w_CPROWNUM= m_oDeletedRows.get(l_RowNumberToSet).w_CPROWNUM;
    w_DWFLG380= m_oDeletedRows.get(l_RowNumberToSet).w_DWFLG380;
    w_DWFLGVLT= m_oDeletedRows.get(l_RowNumberToSet).w_DWFLGVLT;
    w_DWFLGQADV= m_oDeletedRows.get(l_RowNumberToSet).w_DWFLGQADV;
