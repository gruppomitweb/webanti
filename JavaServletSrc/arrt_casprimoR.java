...
// * --- Fine Area Manuale
public class arrt_casprimoR implements CallerWithObjs {
  ...
  public String m_cPhName_cassandra_aefaminvio;
  public String m_cServer_cassandra_aefaminvio;
  ...
  public MemoryCursor_cassandra_aefaminvio mcFAMINVIO;
  public double _crea;
  ...
  public int _r;
  // * --- Fine Area Manuale
  public arrt_casprimoR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_casprimo",m_Caller);
    ...
    m_cPhName_cassandra_aefaminvio = p_ContextObject.GetPhName("cassandra_aefaminvio");
    if (m_cPhName_cassandra_aefaminvio.endsWith(CPSecurity.FILTER_QUERY_POSTFIX)) {
      m_cPhName_cassandra_aefaminvio = m_cPhName_cassandra_aefaminvio+" "+m_Ctx.GetWritePhName("cassandra_aefaminvio");
    }
    m_cServer_cassandra_aefaminvio = p_ContextObject.GetServer("cassandra_aefaminvio");
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("_cdataini",p_cVarName)) {
      return _cdataini;
    }
    if (CPLib.eqr("_cdatafin",p_cVarName)) {
      return _cdatafin;
    }
  ...
  public CPMemoryCursor GetMemoryCursor(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("mcFAMINVIO",p_cVarName)) {
      return mcFAMINVIO;
    }
  ...
  public void SetMemoryCursor(String p_cVarName,String p_cType,int len,int dec,CPMemoryCursor value) {
    ...
    if (CPLib.eqr("mcFAMINVIO",p_cVarName)) {
      mcFAMINVIO = (MemoryCursor_cassandra_aefaminvio)value;
      return;
    }
    if (CPLib.eqr("_sid",p_cVarName)) {
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* mcFAMINVIO MemoryCursor(cassandra_aefaminvio) */
      /* _crea Numeric(1, 0) */
      /* _dataini Date */
      /* _datafin Date */
      /* _invio Char(10) */
      ...
      double nTry00000043status;
      nTry00000043status = m_Sql.GetTransactionStatus();
      String cTry00000043msg;
      cTry00000043msg = m_Sql.TransactionErrorMessage();
      try {
        /* If w_flgnuovi='N' */
        if (CPLib.eqr(w_flgnuovi,"N")) {
          ...
          if (CPLib.eqr(w_anno,2015) && CPLib.Empty(w_mese)) {
            for (int i = 1; CPLib.ne(i,13); i = i + (1)) {
              ...
              /* _cdataini := DateToChar(_dataini) */
              _cdataini = CPLib.DateToChar(_dataini);
              /* _cdatafin := DateToChar(_datafin) */
              _cdatafin = CPLib.DateToChar(_datafin);
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry00000043status,0)) {
          m_Sql.SetTransactionStatus(nTry00000043status,cTry00000043msg);
        }
      }
  ...
  void Page_2() throws Exception {
    ...
    try {
      ...
      _h00000079.Set("_dadata",_dataini);
      _h00000079.Set("_adata",_datafin);
      _h00000079.Set("_inviato",1);
      if (Cursor_qbe_fam_periodo01_minmax!=null)
        Cursor_qbe_fam_periodo01_minmax.Close();
      Cursor_qbe_fam_periodo01_minmax = new VQRHolder("qbe_fam_periodo01_minmax",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000079,true).GetResultSet(m_Ctx);
      ...
      if (CPLib.gt(_totrecord,0)) {
        ...
        _invio = "2015"+_mese+"_2_1";
        // * --- Delete from cassandra_aefaminvio
        m_Sql.RequireTransaction();
        m_cServer = m_Ctx.GetServer("cassandra_aefaminvio");
        m_cPhName = m_Ctx.GetPhName("cassandra_aefaminvio");
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cassandra_aefaminvio",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000085")+"delete from "+m_oWrInfo.GetTableWriteName();
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"IDIDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_invio,"?",0,0,m_cServer),m_cServer,_invio)+"";
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000086")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"0000008F")+"delete from "+m_oWrInfo.GetTableWriteName();
        m_cSql = m_cSql+" where ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000090")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        mcTemp.Zap();
        SPBridge.HMCaller _h000000AF;
        _h000000AF = new SPBridge.HMCaller();
        _h000000AF.Set("m_cVQRList",m_cVQRList);
        _h000000AF.Set("_dadata",_dataini);
        _h000000AF.Set("_adata",_datafin);
        _h000000AF.Set("_inviato",1);
        if (Cursor_qbe_fam_periodo01!=null)
          Cursor_qbe_fam_periodo01.Close();
        Cursor_qbe_fam_periodo01 = new VQRHolder("qbe_fam_periodo01",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000AF,true).GetResultSet(m_Ctx);
        {
            ...
            public void run() {
              if (CPLib.gt(m_TheCursor.CurrentRow()-1,100000*1.1)) {
                ...
                if ( ! (CPLib.IsNull(info))) {
                  info.log("Routine arrt_casprimo: query on qbe_fam_periodo01 returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 100000");
                }
              }
            }
            });
        ...
        if (CPLib.gt(mcTemp.RecCount(),0)) {
          for (MemoryCursorRow_tmp_stpperiodo rowTemp : mcTemp._iterable_()) {
            ...
            if (CPLib.eqr(w_flgstp,"N")) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000000C3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            // * --- Insert into cassandra_aefaminvio from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("cassandra_aefaminvio");
            m_cPhName = m_Ctx.GetPhName("cassandra_aefaminvio");
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cassandra_aefaminvio",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000000F0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(_invio,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+m_oWrInfo.InsertValues();
            m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"cassandra_aefaminvio",true);
            m_cSql = m_cSql+")";
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            if (CPLib.lt(m_nUpdatedRows,0)) {
              m_Sql.AbortTransaction();
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000000FE")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_000000FE(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        ...
        if (CPLib.gt(_sid.RecCount(),0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000105")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000106")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          ...
          if (CPLib.eqr(w_flgstp,"N")) {
            ...
            for (MemoryCursorRow_sid_invio1 rowSID1 : mcSID1._iterable_()) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio1",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000112")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.eqr(rowSID1.TPRINVIO1,"98")) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000115")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"INVIATO = "+CPLib.ToSQL(1,"N",1,0)+", ";
                m_cSql = m_cSql+"DATAINVIO = "+CPLib.ToSQL(CPLib.Date(),"D",8,0)+", ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"aetesta",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000117")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"UNIQUER = "+CPLib.ToSQL(rowSID1.UNIQUE1,"C",50,0,m_cServer)+", ";
            ...
            for (MemoryCursorRow_sid_invio2 rowSID2 : mcSID2._iterable_()) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio2",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"0000011E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_3() throws Exception {
    ...
    try {
      ...
      mcTemp.Zap();
      SPBridge.HMCaller _h00000129;
      _h00000129 = new SPBridge.HMCaller();
      _h00000129.Set("m_cVQRList",m_cVQRList);
      _h00000129.Set("_dadata",_dataini);
      _h00000129.Set("_adata",_datafin);
      if (Cursor_qbe_fam_modifiche_2015!=null)
        Cursor_qbe_fam_modifiche_2015.Close();
      Cursor_qbe_fam_modifiche_2015 = new VQRHolder("qbe_fam_modifiche_2015",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000129,true).GetResultSet(m_Ctx);
      {
        ...
        Cursor_qbe_fam_modifiche_2015.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_casprimo: query on qbe_fam_modifiche_2015 returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
      ...
      if (CPLib.gt(mcTemp.RecCount(),0)) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"0000013E")+"delete from "+m_oWrInfo.GetTableWriteName();
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"CODINVIO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_invio,"?",0,0,m_cServer),m_cServer,_invio)+"";
        m_cSql = m_cSql+m_oWrInfo.WhereFilter();
        m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"0000013F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_0000013F(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(_invio,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL("2","?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL("2","?",0,0,m_cServer)+", ";
        ...
        for (MemoryCursorRow_tmp_stpperiodo rowTemp : mcTemp._iterable_()) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on aetesta into routine arrt_casprimo returns two or more records. This item should return only a record.");
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cassandra_aefaminvio",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001AD")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000001AD(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cProg,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(rowTemp.TIPO,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("2","?",0,0,m_cServer)+", ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"aesaldi",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001BA")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.gt(_sid.RecCount(),0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001C1")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio2",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001C2")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"CODINVIO2 = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_invio,"?",0,0,m_cServer),m_cServer,_invio)+"";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter();
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio1",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001C3")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"CODINVIO1 = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_invio,"?",0,0,m_cServer),m_cServer,_invio)+"";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter();
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          for (MemoryCursorRow_sid_invio1 rowSID1 : mcSID1._iterable_()) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio1",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001C5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          for (MemoryCursorRow_sid_invio2 rowSID2 : mcSID2._iterable_()) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio2",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001C7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          for (MemoryCursorRow_sid_invio3 rowSID3 : mcSID3._iterable_()) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sid_invio3",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"000001C9")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_4() throws Exception {
    CPResultSet Cursor_qbe_cassandra_opx_min_max=null;
    CPResultSet Cursor_qbe_casperiodo_opx01=null;
    VQRHolder l_VQRHolder = null;
    try {
      /* _max := 0 */
      ...
      // * --- Select from qbe_cassandra_opx_min_max
      SPBridge.HMCaller _h000001D2;
      _h000001D2 = new SPBridge.HMCaller();
      _h000001D2.Set("m_cVQRList",m_cVQRList);
      _h000001D2.Set("_dadata",_cdataini);
      _h000001D2.Set("_adata",_cdatafin);
      _h000001D2.Set("_inviato",1);
      if (Cursor_qbe_cassandra_opx_min_max!=null)
        Cursor_qbe_cassandra_opx_min_max.Close();
      Cursor_qbe_cassandra_opx_min_max = new VQRHolder("qbe_cassandra_opx_min_max",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000001D2,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_cassandra_opx_min_max.Eof())) {
        /* _min := qbe_cassandra_opx_min_max->MINPRG */
        _min = CPLib.Round(Cursor_qbe_cassandra_opx_min_max.GetDouble("MINPRG"),0);
        /* _max := qbe_cassandra_opx_min_max->MAXPRG */
        _max = CPLib.Round(Cursor_qbe_cassandra_opx_min_max.GetDouble("MAXPRG"),0);
        /* _tot := qbe_cassandra_opx_min_max->TOTPRG */
        _tot = CPLib.Round(Cursor_qbe_cassandra_opx_min_max.GetDouble("TOTPRG"),0);
        Cursor_qbe_cassandra_opx_min_max.Next();
      }
      m_cConnectivityError = Cursor_qbe_cassandra_opx_min_max.ErrorMessage();
      Cursor_qbe_cassandra_opx_min_max.Close();
      // * --- End Select
      /* If _tot > 0 */
      if (CPLib.gt(_tot,0)) {
        ...
        while (CPLib.le(_contacicli,_cicli)) {
          ...
          if (CPLib.ge(_top,_min)) {
            ...
            m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
            // * --- Fill memory cursor mcTemp on qbe_casperiodo_opx01
            mcTemp.Zap();
            SPBridge.HMCaller _h000001F7;
            _h000001F7 = new SPBridge.HMCaller();
            _h000001F7.Set("m_cVQRList",m_cVQRList);
            _h000001F7.Set("_dadata",_cdataini);
            _h000001F7.Set("_adata",_cdatafin);
            _h000001F7.Set("_inviato",1);
            _h000001F7.Set("_bottom",_bottom);
            _h000001F7.Set("_top",_top);
            if (Cursor_qbe_casperiodo_opx01!=null)
              Cursor_qbe_casperiodo_opx01.Close();
            Cursor_qbe_casperiodo_opx01 = new VQRHolder("qbe_casperiodo_opx01",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000001F7,true).GetResultSet(m_Ctx);
            {
              final CPResultSet m_TheCursor = Cursor_qbe_casperiodo_opx01;
              Cursor_qbe_casperiodo_opx01.ActionOnClose(new Runnable() {
                public void run() {
                  if (CPLib.gt(m_TheCursor.CurrentRow()-1,5000*1.1)) {
                    com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
                    if ( ! (CPLib.IsNull(info))) {
                      info.log("Routine arrt_casprimo: query on qbe_casperiodo_opx01 returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 5000");
                    }
                  }
                }
                });
            }
            while ( ! (Cursor_qbe_casperiodo_opx01.Eof())) {
              mcTemp.AppendBlank();
              mcTemp.row.RAPPORTO = Cursor_qbe_casperiodo_opx01.GetString("RAPPORTO");
              mcTemp.row.DATAINI = Cursor_qbe_casperiodo_opx01.GetDate("DATAINI");
              mcTemp.row.DATAFINE = Cursor_qbe_casperiodo_opx01.GetDate("DATAFINE");
              mcTemp.row.TIPOAG = Cursor_qbe_casperiodo_opx01.GetString("TIPOAG");
              mcTemp.row.TIPORAP = Cursor_qbe_casperiodo_opx01.GetString("TIPORAP");
              mcTemp.row.DESCRAP = Cursor_qbe_casperiodo_opx01.GetString("DESCRAP");
              mcTemp.row.VALUTA = Cursor_qbe_casperiodo_opx01.GetString("VALUTA");
              mcTemp.row.INVIATO = Cursor_qbe_casperiodo_opx01.GetDouble("INVIATO");
              mcTemp.row.TIPO = Cursor_qbe_casperiodo_opx01.GetString("TIPO");
              mcTemp.row.CAB = Cursor_qbe_casperiodo_opx01.GetString("CAB");
              mcTemp.row.UNIQUECODE = Cursor_qbe_casperiodo_opx01.GetString("UNIQUECODE");
              mcTemp.row.OLDINTER = Cursor_qbe_casperiodo_opx01.GetString("OLDINTER");
              mcTemp.row.IDBASE = Cursor_qbe_casperiodo_opx01.GetString("IDBASE");
              mcTemp.row.DATAMODI = Cursor_qbe_casperiodo_opx01.GetDate("DATAMODI");
              mcTemp.row.IDESITO = Cursor_qbe_casperiodo_opx01.GetString("IDESITO");
              mcTemp.row.ISOAGE = Cursor_qbe_casperiodo_opx01.GetString("ISOAGE");
              Cursor_qbe_casperiodo_opx01.Next();
            }
            m_cConnectivityError = Cursor_qbe_casperiodo_opx01.ErrorMessage();
            Cursor_qbe_casperiodo_opx01.Close();
            mcTemp.GoTop();
            /* If mcTemp.RecCount() > 0 */
            if (CPLib.gt(mcTemp.RecCount(),0)) {
              for (MemoryCursorRow_tmp_stpperiodo rowTemp : mcTemp._iterable_()) {
                ...
                if (CPLib.eqr(w_flgstp,"S")) {
                  // * --- Write into cassandra_opextrbo from values
                  m_Sql.RequireTransaction();
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"0000020A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"INVIATO = "+CPLib.ToSQL(1,"N",1,0)+", ";
                  m_cSql = m_cSql+"DATAINVIO = "+CPLib.ToSQL(CPLib.DateToChar(CPLib.Date()),"C",8,0,m_cServer)+", ";
                  m_cSql = m_cSql+"UNIQUER = "+CPLib.ToSQL(_unique,"C",50,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cassandra_opextrbo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(rowTemp.IDBASE,"?",0,0,m_cServer),m_cServer,rowTemp.IDBASE)+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                  if (CPLib.lt(m_nUpdatedRows,0)) {
                    m_Sql.AbortTransaction();
                ...
                /* cProg := Utilities.GetAutonumber("PRGAGESID\'"+LRTrim(gAzienda)+"'",'',10) */
                cProg = Utilities.Make(m_Ctx,m_Caller).GetAutonumber("PRGAGESID\\'"+CPLib.LRTrim(gAzienda)+"'","",10);
                /* mcFAMINVIO.AppendBlank() */
                mcFAMINVIO.AppendBlank();
                /* mcFAMINVIO.IDBASE := cProg */
                mcFAMINVIO.row.IDBASE = cProg;
                /* mcFAMINVIO.IDIDBASE := _invio */
                mcFAMINVIO.row.IDIDBASE = _invio;
                /* mcFAMINVIO.TIPO := rowTemp.TIPO */
                mcFAMINVIO.row.TIPO = rowTemp.TIPO;
                /* mcFAMINVIO.TIPOINVIO := '2' */
                mcFAMINVIO.row.TIPOINVIO = "2";
                /* mcFAMINVIO.ANNO := '2015' */
                mcFAMINVIO.row.ANNO = "2015";
                /* mcFAMINVIO.MESE := _mese */
                mcFAMINVIO.row.MESE = _mese;
                /* mcFAMINVIO.TIPOCOM := '1' */
                mcFAMINVIO.row.TIPOCOM = "1";
                /* mcFAMINVIO.RAPPORTO := rowTemp.RAPPORTO */
                mcFAMINVIO.row.RAPPORTO = rowTemp.RAPPORTO;
                /* mcFAMINVIO.NOMEFILE := _nomefile */
                mcFAMINVIO.row.NOMEFILE = _nomefile;
                /* mcFAMINVIO.PROG := _conta */
                mcFAMINVIO.row.PROG = _conta;
                /* mcFAMINVIO.SaveRow() */
                mcFAMINVIO.SaveRow();
          ...
          for (MemoryCursorRow_cassandra_aefaminvio rowFAMINVIO : mcFAMINVIO._iterable_()) {
            // * --- Insert into cassandra_aefaminvio from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("cassandra_aefaminvio");
            m_cPhName = m_Ctx.GetPhName("cassandra_aefaminvio");
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cassandra_aefaminvio",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_casprimo",157,"00000249")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000249(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.IDBASE,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.IDIDBASE,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.TIPO,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.TIPOINVIO,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.ANNO,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.MESE,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.TIPOCOM,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.RAPPORTO,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.NOMEFILE,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(rowFAMINVIO.PROG,"?",0,0)+", ";
            m_cSql = m_cSql+m_oWrInfo.InsertValues();
            m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"cassandra_aefaminvio",true);
            m_cSql = m_cSql+")";
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
  ...
  public static arrt_casprimoR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_casprimoR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    mcFAMINVIO = new MemoryCursor_cassandra_aefaminvio();
    _crea = 0;
    ...
    _cdataini = CPLib.Space(8);
    _cdatafin = CPLib.Space(8);
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_fam_periodo01_minmax,qbe_fam_periodo01,qbe_fam_modifiche_2015,qbe_cassandra_opx_min_max,qbe_casperiodo_opx01,
  public static final String m_cVQRList = ",qbe_fam_periodo01_minmax,qbe_fam_periodo01,qbe_fam_modifiche_2015,qbe_cassandra_opx_min_max,qbe_casperiodo_opx01,";
  ...
  protected static String GetFieldsName_000000F0(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    ...
    p_cSql = p_cSql+p_oWrInfo.InsertFields();
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"cassandra_aefaminvio",true);
    return p_cSql;
  }
  protected static String GetFieldsName_000000FE(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NOMEFILE,";
    p_cSql = p_cSql+"ANNO,";
  ...
  protected static String GetFieldsName_0000013F(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CODINVIO,";
    p_cSql = p_cSql+"TIPINVIO,";
    p_cSql = p_cSql+"TPCINVIO,";
  ...
  protected static String GetFieldsName_000001AD(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"TIPO,";
    p_cSql = p_cSql+"TIPOINVIO,";
  ...
  protected static String GetFieldsName_00000249(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"IDIDBASE,";
    p_cSql = p_cSql+"TIPO,";
