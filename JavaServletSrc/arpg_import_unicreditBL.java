...
public class arpg_import_unicreditBL extends arpg_import_unicreditWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_unicredit";
  ...
  public static final String i_StateStructure = "{'nomefile':nomefile,'tipodest':tipodest,'codmage':codmage}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'tipodest':tipodest,'codmage':codmage,'xMADESCRI':xMADESCRI,'xMAFLGRAP':xMAFLGRAP,'destfin':destfin,'xMAFLGBON':xMAFLGBON,'xMADIPSTD':xMADIPSTD}";
  public static final String i_ItemSequence = "nomefile,tipodest,codmage";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"nomefile","","C","100","0","variabile","nokey","false","false"},new String[]{"tipodest","","C","1","0","variabile","nokey","false","false"},new String[]{"codmage","MacroAgente","C","5","0","variabile","nokey","false","false"}});
  ...
  public arpg_import_unicreditBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_XFVQTXPEXL(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_codmage))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_tbmacage,"select MACODICE,MADESCRI,MAFLGRAP,MAFLGOPE,MAFLGBON,MADIPSTD from "+m_cPhName_tbmacage+((m_cPhName_tbmacage).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"MACODICE"+l_cCurrentKey+l_cWhere);
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            ...
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_tbmacage,"select MACODICE,MADESCRI,MAFLGRAP,MAFLGOPE,MAFLGBON,MADIPSTD from "+m_cPhName_tbmacage+((m_cPhName_tbmacage).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"MADESCRI"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_unicredit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_field",new String[]{"MACODICE","MADESCRI","MAFLGRAP","MAFLGOPE","MAFLGBON","MADIPSTD"});
    map.put("rd_var",new String[]{"w_codmage","w_xMADESCRI","w_xMAFLGRAP","w_destfin","w_xMAFLGBON","w_xMADIPSTD"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C\u0000C\u0000C\u0000C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("5\u000060\u00001\u00001\u00001\u00006",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000\u00000\u00000\u00000\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("MacroAgente\u0000Denominazione\u0000Generazione Rapporti da operazioni\u0000Scrivi su Operazioni o Frazionate\u0000Scrive tipo operazione come bonifico\u0000Dipendenza Default",-1));
    ...
    map.put("rd_var.obj",zeroSplit.split("variabile\u0000variabile\u0000variabile\u0000variabile\u0000variabile\u0000variabile",-1));
