...
public class armt_snai_oper_storicoBL extends armt_snai_oper_storicoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_snai_oper_storico";
  ...
  public String m_cVirtName_cgo_operazioni_storico;
  ...
  public static String[] m_EntityTables = {"cgo_operazioni_storico"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'IMPWALLET':IMPWALLET,'CODWALLET':CODWALLET,'CODTRANSZ':CODTRANSZ,'CGOFLGVLT':CGOFLGVLT,'FLGPAGAM':FLGPAGAM,'FILTROMP':FILTROMP,'MEZPAGAM':MEZPAGAM,'CC4CIFRE':CC4CIFRE,'CCMESSCA':CCMESSCA,'CCANNSCA':CCANNSCA,'IBAN':IBAN,'ASSEGNO':ASSEGNO,'CFESTERO':CFESTERO,'PEP':PEP,'CODFISC':CODFISC,'COGNOME':COGNOME,'NOME':NOME,'NASCOMUN':NASCOMUN,'TIPINTER':TIPINTER,'SESSO':SESSO,'NASSTATO':NASSTATO,'DATANASC':DATANASC,'PAESE':PAESE,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'DOMICILIO':DOMICILIO,'NUMTEL':NUMTEL,'SNAINUMOPE':SNAINUMOPE,'FLAGCONT':FLAGCONT,'FLAGWALLET':FLAGWALLET,'CONNESCLI':CONNESCLI,'CODDIPE':CODDIPE,'CAIDBIGLIETTO':CAIDBIGLIETTO,'verifica':verifica,'NUMOPEDL':NUMOPEDL,'FLGDOCALL':FLGDOCALL,'DOC03':DOC03,'DOC04':DOC04,'tipop':tipop,'saveddoc':saveddoc,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'DATAVALI':DATAVALI,'RDCODAUT':RDCODAUT,'RDLOCAUT':RDLOCAUT,'PEPDESCRI':PEPDESCRI,'PAESE2':PAESE2,'DESCCIT2':DESCCIT2,'PROVINCIA2':PROVINCIA2,'CAP2':CAP2,'DOMICILIO2':DOMICILIO2,'FLGDOM':FLGDOM,'ardt_cgo_oper_storico_multi':ardt_cgo_oper_storico_multi,'armt_cgo_qadv_operazioni_storico':armt_cgo_qadv_operazioni_storico"+FoundlingChildrenList("armt_snai_oper_storico",true)+"}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'TIPOGIOCO':TIPOGIOCO,'xSOGTPGIO':xSOGTPGIO,'xDEFTPGIO':xDEFTPGIO,'xEDTTPGIO':xEDTTPGIO,'xEDTSPGIO':xEDTSPGIO,'xDEFSPGIO':xDEFSPGIO,'TIPOPERS':TIPOPERS,'CGOFLGVNP':CGOFLGVNP,'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'IMPWALLET':IMPWALLET,'CODWALLET':CODWALLET,'CODTRANSZ':CODTRANSZ,'CGOFLGVLT':CGOFLGVLT,'FLGPAGAM':FLGPAGAM,'FILTROMP':FILTROMP,'MEZPAGAM':MEZPAGAM,'CC4CIFRE':CC4CIFRE,'CCMESSCA':CCMESSCA,'CCANNSCA':CCANNSCA,'IBAN':IBAN,'ASSEGNO':ASSEGNO,'CFESTERO':CFESTERO,'PEP':PEP,'CODFISC':CODFISC,'COGNOME':COGNOME,'NOME':NOME,'NASCOMUN':NASCOMUN,'TIPINTER':TIPINTER,'SESSO':SESSO,'NASSTATO':NASSTATO,'DATANASC':DATANASC,'PAESE':PAESE,'RAGSOC':RAGSOC,'DESCCIT':DESCCIT,'idcitta':idcitta,'PROVINCIA':PROVINCIA,'CAP':CAP,'CODCAB':CODCAB,'DOMICILIO':DOMICILIO,'NUMTEL':NUMTEL,'xARDESCRI':xARDESCRI,'ATTIV':ATTIV,'SOTGRUP':SOTGRUP,'RAMOGRUP':RAMOGRUP,'SETTSINT':SETTSINT,'dessta':dessta,'tipsot':tipsot,'STATOREG':STATOREG,'IDBASE':IDBASE,'NUMPROG':NUMPROG,'DESCRI':DESCRI,'gSeekAos':gSeekAos,'gDataVaria':gDataVaria,'gFlgDoc':gFlgDoc,'SNAINUMOPE':SNAINUMOPE,'DATAOPE':DATAOPE,'DATAREG':DATAREG,'FLAGCONT':FLAGCONT,'FLAGWALLET':FLAGWALLET,'TIPOOPRAP':TIPOOPRAP,'CODANA':CODANA,'CODVOC':CODVOC,'VALUTA':VALUTA,'CAMBIO':CAMBIO,'CONNESCLI':CONNESCLI,'CONNESBEN':CONNESBEN,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_PRV':C_PRV,'C_CAP':C_CAP,'C_CAB':C_CAB,'C_IND':C_IND,'C_STA':C_STA,'CODINTER':CODINTER,'CODDIPE':CODDIPE,'DESCCITDIP':DESCCITDIP,'FLAGFRAZ':FLAGFRAZ,'COLLEG':COLLEG,'PROVINCIADIP':PROVINCIADIP,'CODCABDIP':CODCABDIP,'xDescDipe':xDescDipe,'datpaseuro':datpaseuro,'xdes1':xdes1,'desccauana':desccauana,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'xdesccausin':xdesccausin,'gChkDate':gChkDate,'CACODICE':CACODICE,'CAIDBIGLIETTO':CAIDBIGLIETTO,'xdesctipatt':xdesctipatt,'gVLT':gVLT,'gVNP':gVNP,'CGOTIPOPE':CGOTIPOPE,'gCodDip':gCodDip,'verifica':verifica,'NUMOPEDL':NUMOPEDL,'gStpDwn':gStpDwn,'MIDBIGLIETTO':MIDBIGLIETTO,'MIDBIGLIETTO1':MIDBIGLIETTO1,'MIDBIGLIETTO2':MIDBIGLIETTO2,'MIDBIGLIETTO3':MIDBIGLIETTO3,'MIDBIGLIETTO4':MIDBIGLIETTO4,'CAFLGOPE':CAFLGOPE,'TELDIP':TELDIP,'CODLOC':CODLOC,'xFLGPLGIO':xFLGPLGIO,'IDDOCALL':IDDOCALL,'FLGDOCALL':FLGDOCALL,'VLTPLAT':VLTPLAT,'xVPFLGATT':xVPFLGATT,'DOC03':DOC03,'DOC04':DOC04,'tipop':tipop,'CCDATSCA':CCDATSCA,'gGesDoc':gGesDoc,'edtdoc':edtdoc,'saveddoc':saveddoc,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'DATAVALI':DATAVALI,'RDCODAUT':RDCODAUT,'RDLOCAUT':RDLOCAUT,'AUTRILASC':AUTRILASC,'PEPDESCRI':PEPDESCRI,'PAESE2':PAESE2,'DESCCIT2':DESCCIT2,'idcitta2':idcitta2,'PROVINCIA2':PROVINCIA2,'CAP2':CAP2,'DOMICILIO2':DOMICILIO2,'FLGDOM':FLGDOM,'dessta2':dessta2,'ardt_cgo_oper_storico_multi':ardt_cgo_oper_storico_multi,'FLGSBLOCCO':FLGSBLOCCO,'SEGNO':SEGNO,'xCGOFLGPROF':xCGOFLGPROF,'PROFESSIONE':PROFESSIONE,'armt_cgo_qadv_operazioni_storico':armt_cgo_qadv_operazioni_storico"+FoundlingChildrenList("armt_snai_oper_storico",true)+"}";
  public static final String i_ItemSequence = "TOTLIRE,TOTCONT,IMPWALLET,CODWALLET,CODTRANSZ,CGOFLGVLT,FLGPAGAM,FILTROMP,MEZPAGAM,CC4CIFRE,CCMESSCA,CCANNSCA,IBAN,ASSEGNO,CFESTERO,PEP,CODFISC,COGNOME,NOME,NASCOMUN,TIPINTER,SESSO,NASSTATO,DATANASC,PAESE,DESCCIT,PROVINCIA,CAP,DOMICILIO,NUMTEL,SNAINUMOPE,FLAGCONT,FLAGWALLET,CONNESCLI,CODDIPE,CAIDBIGLIETTO,verifica,NUMOPEDL,FLGDOCALL,DOC03,DOC04,tipop,saveddoc,TIPODOC,NUMDOCUM,DATARILASC,DATAVALI,RDCODAUT,RDLOCAUT,PEPDESCRI,PAESE2,DESCCIT2,PROVINCIA2,CAP2,DOMICILIO2,FLGDOM,ardt_cgo_oper_storico_multi,armt_cgo_qadv_operazioni_storico"+FoundlingChildrenList("armt_snai_oper_storico",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_snai_oper_storico"),new String[][]{new String[]{"TOTLIRE","Totale Operazione","N","15","2","campo","nokey","false","false"},new String[]{"TOTCONT","di cui contanti","N","15","2","campo","nokey","false","true"},new String[]{"IMPWALLET","IMporto","N","12","2","campo","nokey","false","true"},new String[]{"CODWALLET","WALLET","C","20","0","campo","nokey","false","true"},new String[]{"CODTRANSZ","Transazione ID Wallet","C","50","0","campo","nokey","false","true"},new String[]{"CGOFLGVLT","Pagamento VLT","C","1","0","campo","nokey","false","true"},new String[]{"FLGPAGAM","","C","1","0","variabile","nokey","false","false"},new String[]{"FILTROMP","","C","50","0","variabile","nokey","false","false"},new String[]{"MEZPAGAM","Mezzo Pagamento","C","1","0","campo","nokey","false","true"},new String[]{"CC4CIFRE","Ultime Cifre CC ()","C","4","0","campo","nokey","false","true"},new String[]{"CCMESSCA","Mese Scadenza","N","2","0","campo","nokey","false","true"},new String[]{"CCANNSCA","Carta Di Credito Scadenza","N","4","0","campo","nokey","false","true"},new String[]{"IBAN","IBAN per Bonifici","C","40","0","campo","nokey","false","true"},new String[]{"ASSEGNO","Assegno","C","25","0","campo","nokey","false","true"},new String[]{"CFESTERO","Codice Fiscale Estero","N","1","0","campo","nokey","false","false"},new String[]{"PEP","Persona Politicamente Esposta","C","1","0","campo","nokey","false","true"},new String[]{"CODFISC","Codice Fiscale","C","16","0","campo","nokey","false","true"},new String[]{"COGNOME","Cognome","C","26","0","campo","nokey","false","true"},new String[]{"NOME","Nome","C","25","0","campo","nokey","false","true"},new String[]{"NASCOMUN","Luogo di Nascita","C","30","0","campo","nokey","false","true"},new String[]{"TIPINTER","Prov.","C","2","0","campo","nokey","false","true"},new String[]{"SESSO","Sesso","C","1","0","campo","nokey","false","true"},new String[]{"NASSTATO","Stato di nascita","C","30","0","campo","nokey","false","true"},new String[]{"DATANASC","Data Nascita","D","8","0","campo","nokey","false","true"},new String[]{"PAESE","Stato","C","3","0","campo","nokey","false","true"},new String[]{"DESCCIT","Città","C","40","0","campo","nokey","false","true"},new String[]{"PROVINCIA","Provincia","C","2","0","campo","nokey","false","true"},new String[]{"CAP","CAP","C","9","0","campo","nokey","false","true"},new String[]{"DOMICILIO","Indirizzo","C","35","0","campo","nokey","false","true"},new String[]{"NUMTEL","Numero Telefono","C","20","0","campo","nokey","false","false"},new String[]{"SNAINUMOPE","N° Operazione","C","15","0","campo","key1","false","false"},new String[]{"FLAGCONT","Contanti (S/N)","C","1","0","campo","nokey","false","false"},new String[]{"FLAGWALLET","Flag Wallet","C","1","0","campo","nokey","false","true"},new String[]{"CONNESCLI","Codice Cliente Occasionale","C","16","0","campo","nokey","false","false"},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"CAIDBIGLIETTO","ID BIGLIETTO","C","30","0","campo","nokey","false","false"},new String[]{"verifica","","C","1","0","variabile","nokey","false","false"},new String[]{"NUMOPEDL","Operazione da cancellare","C","15","0","campo","nokey","false","false"},new String[]{"FLGDOCALL","Flag Documentazione Completa","C","1","0","campo","nokey","false","false"},new String[]{"DOC03","","C","80","0","variabile","nokey","false","false"},new String[]{"DOC04","","C","80","0","variabile","nokey","false","false"},new String[]{"tipop","","C","1","0","variabile","nokey","false","false"},new String[]{"saveddoc","","C","1","0","variabile","nokey","false","false"},new String[]{"TIPODOC","Tipo Documento","C","2","0","campo","nokey","false","true"},new String[]{"NUMDOCUM","Numero Doc.","C","15","0","campo","nokey","false","true"},new String[]{"DATARILASC","Rilascio Doc.","D","8","0","campo","nokey","false","true"},new String[]{"DATAVALI","Data Fine Validità","D","8","0","campo","nokey","false","true"},new String[]{"RDCODAUT","Autorità Rilascio","C","2","0","campo","nokey","false","true"},new String[]{"RDLOCAUT","Luogo Autorità Rilascio","C","20","0","campo","nokey","false","true"},new String[]{"PEPDESCRI","Descrizione PEP","C","80","0","campo","nokey","false","true"},new String[]{"PAESE2","Stato Domicilio","C","3","0","campo","nokey","false","true"},new String[]{"DESCCIT2","Città Domicilio","C","40","0","campo","nokey","false","true"},new String[]{"PROVINCIA2","Provincia","C","2","0","campo","nokey","false","true"},new String[]{"CAP2","CAP","C","9","0","campo","nokey","false","true"},new String[]{"DOMICILIO2","Indirizzo Domicilio","C","35","0","campo","nokey","false","true"},new String[]{"FLGDOM","Domicilio diverso da residenza","C","1","0","campo","nokey","false","false"},new String[]{"ardt_cgo_oper_storico_multi","LinkPC","","","","link_PC","","false",""},new String[]{"armt_cgo_qadv_operazioni_storico","LinkPC","","","","link_PC","","false",""}});
  ...
  public armt_snai_oper_storicoBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_operazioni_storico = p_ContextObject.GetPhName("cgo_operazioni_storico",p_ContextObject.GetCompany(),false);
    ...
    m_cVirtName_cgo_operazioni_storico = CPSql.ManipulateTablePhName("cgo_operazioni_storico",m_cServer_cgo_operazioni_storico);
    ...
    armt_cgo_qadv_operazioni_storico = new armt_cgo_qadv_operazioni_storicoBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_snai_oper_storico",p_ContextObject);
  }
  public void Blank() {
    ...
    w_FILTROMP = "";
    w_FILTROMP = (CPLib.ne(w_TOTCONT,w_TOTLIRE)?"'I','E','P','B','C','V'":"'I','E','P','B','C','V','S'");
    w_CFESTERO = 0;
    w_PEP = "N";
    Link_NEUBQNUEOJ();
    Link_HODZKKOSYW();
    ...
    Link_WJQFIEBCQV();
    w_edtdoc = false;
    w_edtdoc = CPLib.Empty(w_IDDOCALL) || CPLib.Empty(w_TIPOGIOCO) || CPLib.le(w_TOTLIRE,0) || (CPLib.eq(w_FLAGCONT,"1") && CPLib.le(w_TOTCONT,0));
    w_saveddoc = "N";
    Link_MBGANUUHRA();
    Link_YDUQCBNYFV();
    w_AUTRILASC = "";
    ...
    m_cWv_armt_cgo_qadv_operazioni_storico = "";
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || armt_cgo_qadv_operazioni_storico.IsUpdated() || CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_storico);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    armt_cgo_qadv_operazioni_storico.SaveDependsOn();
  }
  ...
  protected boolean Link_PSLKLXOQMT() {
    return Link_PSLKLXOQMT("Full");
  }
  protected boolean Link_PSLKLXOQMT(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
  ...
  void Calculation_KGBNFVNJHO() {
    ...
    l_oRoutine_arrt_writelog.pTabella = "CGO_OPERAZIONI_STORICO";
    l_oRoutine_arrt_writelog.pChiave = w_SNAINUMOPE;
    l_oRoutine_arrt_writelog.Run();
    arrt_cgo_update_poR l_oRoutine_arrt_cgo_update_po;
    l_oRoutine_arrt_cgo_update_po = arrt_cgo_update_poR.Make(m_Ctx,this);
    l_oRoutine_arrt_cgo_update_po.w_SNAINUMOPE = w_SNAINUMOPE;
    l_oRoutine_arrt_cgo_update_po.Run();
  }
  ...
  void Calculation_OCENIGMBXJ() {
    w_MEZPAGAM = (CPLib.eq(w_TOTLIRE,w_TOTCONT)?"S":"");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_snai_oper_storico","cgo_operazioni_storico",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_FLGSBLOCCO = CPLib.GetProperty(p,"FLGSBLOCCO",w_FLGSBLOCCO,0);
      ...
      m_cWv_armt_cgo_qadv_operazioni_storico = CPLib.GetProperty(p,"m_cWv_armt_cgo_qadv_operazioni_storico",m_cWv_armt_cgo_qadv_operazioni_storico,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("cgo_qadv_operazioni_storico");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("cgo_qadv_operazioni_storico",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("cgo_qadv_operazioni_storico\u0000false\u0000false\u00001\u00000\u0000armt_cgo_qadv_operazioni_storico\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_snai_oper_storico",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_snai_oper_storico",child);
  ...
  public void Initialize() {
    ...
    armt_cgo_qadv_operazioni_storico = new armt_cgo_qadv_operazioni_storicoBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_snai_oper_storico",m_Ctx);
  ...
  public boolean Check() {
    ...
    } else if ((false) && ( ! (CPLib.gt(w_TOTLIRE,0) && CPLib.ge(w_TOTLIRE,(w_TOTCONT+w_IMPWALLET))))) {
      m_cLastMsgError = m_Ctx.Translate("Totale Operazione")+" : ";
    ...
    } else if ((CPLib.eq(w_FLAGCONT,"1")) && ((CPLib.Empty(w_TOTCONT) && HUDOCMLKKT_isObligatory()) || ( ! (arfn_chktotalelire_contR.Make(m_Ctx,this).Run(w_DATAOPE,w_datpaseuro,w_TOTCONT,w_TOTLIRE))))) {
    ...
    if (l_bResult && (( ! (armt_cgo_qadv_operazioni_storico.m_bLoaded) && CPLib.IsLoaded(m_cWv_armt_cgo_qadv_operazioni_storico)) || ( ! (armt_cgo_qadv_operazioni_storico.m_bUpdated) && CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_storico)))) {
      armt_cgo_qadv_operazioni_storico.SetFromContext(m_cWv_armt_cgo_qadv_operazioni_storico);
      m_cWv_armt_cgo_qadv_operazioni_storico = "_not_empty_";
    }
    if (l_bResult && (armt_cgo_qadv_operazioni_storico.m_bLoaded || armt_cgo_qadv_operazioni_storico.m_bUpdated)) {
      l_bResult = l_bResult && armt_cgo_qadv_operazioni_storico.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = armt_cgo_qadv_operazioni_storico.m_cLastMsgError;
      }
    }
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_snai_oper_storico"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_snai_oper_storico\\"+p_cState};
    }
    return l_Keys;
  }
  public boolean CanView() {
    ...
    l_bResult = true;
    ResetErrorMessage();
    l_bResult = CPLib.eq(w_gCodDip,w_CODDIPE) || Utilities.Make(m_Ctx).IsInGroup(1) || Utilities.Make(m_Ctx).IsInGroup(9) || Utilities.Make(m_Ctx).IsInGroup(11) || Utilities.Make(m_Ctx).IsInGroup(12);
    if ( ! (l_bResult)) {
  ...
  public boolean CanEdit(String p_cState) {
    boolean l_bResult = true;
    ResetErrorMessage();
    l_bResult = CPLib.ne(p_cState,GetCurrentState()) || (CPLib.eq(w_FLGSBLOCCO,"S") && (CPLib.eq(w_gCodDip,w_CODDIPE) || Utilities.Make(m_Ctx).IsInGroup(1) || Utilities.Make(m_Ctx).IsInGroup(9) || Utilities.Make(m_Ctx).IsInGroup(11) || Utilities.Make(m_Ctx).IsInGroup(12)));
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile modificare un'operazione bloccata";
    }
  ...
  public boolean CanDelete() {
    ...
    l_bResult = false;
    if ( ! (l_bResult)) {
      m_cLastMsgError = "Impossibile cancellare un'operazione storicizzata";
    }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"FLGSBLOCCO",w_FLGSBLOCCO,0);
    ...
    if (p_bGetChildren) {
      if (armt_cgo_qadv_operazioni_storico.IsUpdated()) {
        m_cWv_armt_cgo_qadv_operazioni_storico = armt_cgo_qadv_operazioni_storico.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_armt_cgo_qadv_operazioni_storico",m_cWv_armt_cgo_qadv_operazioni_storico,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_operazioni_storico"+"\\"+CPLib.ToCPStr(p_Caller.GetString("SNAINUMOPE","C",15,0));
  }
  ...
  public boolean ChildExists_armt_cgo_qadv_operazioni_storico() {
    if (armt_cgo_qadv_operazioni_storico.IsUpdated() || (CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_storico) || CPLib.IsLoaded(m_cWv_armt_cgo_qadv_operazioni_storico))) {
      return true;
    } else if (m_bLoaded &&  ! (armt_cgo_qadv_operazioni_storico.m_bLoaded)) {
      armt_cgo_qadv_operazioni_storico.Blank();
      armt_cgo_qadv_operazioni_storico.w_SNAINUMOPE = w_SNAINUMOPE;
      armt_cgo_qadv_operazioni_storico.Load();
    }
    return armt_cgo_qadv_operazioni_storico.m_bLoaded;
  }
  public void CtxLoad_armt_cgo_qadv_operazioni_storico() {
    if ( ! (armt_cgo_qadv_operazioni_storico.m_lCtxLoaded)) {
      armt_cgo_qadv_operazioni_storico.Blank();
    }
    armt_cgo_qadv_operazioni_storico.m_lCtxLoaded = true;
    if ( ! (armt_cgo_qadv_operazioni_storico.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_armt_cgo_qadv_operazioni_storico) || CPLib.IsLoaded(m_cWv_armt_cgo_qadv_operazioni_storico)) {
        armt_cgo_qadv_operazioni_storico.SetFromContext(m_cWv_armt_cgo_qadv_operazioni_storico);
        m_cWv_armt_cgo_qadv_operazioni_storico = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (armt_cgo_qadv_operazioni_storico.m_bLoaded)) {
          armt_cgo_qadv_operazioni_storico.Blank();
          armt_cgo_qadv_operazioni_storico.w_SNAINUMOPE = w_SNAINUMOPE;
          armt_cgo_qadv_operazioni_storico.Load();
          if ( ! (armt_cgo_qadv_operazioni_storico.m_bLoaded)) {
            armt_cgo_qadv_operazioni_storico.Initialize();
            armt_cgo_qadv_operazioni_storico.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"armt_cgo_qadv_operazioni_storico")) {
      CtxLoad_armt_cgo_qadv_operazioni_storico();
      return armt_cgo_qadv_operazioni_storico;
    }
