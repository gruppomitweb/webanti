...
public class arpg_chkrap_annoBL extends arpg_chkrap_annoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_chkrap_anno";
  ...
  public arpg_chkrap_annoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_chkrap_anno","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
