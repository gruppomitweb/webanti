...
public class ardt_delegaopBL extends ardt_delegaopWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_delegaop";
  ...
  public CPPhTableWrInfo m_oWrInfo_delegaop;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_delegaop;
  ...
  public static String[] m_EntityTables = {"delegaop"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'COLLEG':COLLEG,'ANNO':ANNO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE"+FoundlingChildrenList("ardt_delegaop",true,true)+"}"+FoundlingChildrenList("ardt_delegaop",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'COLLEG':COLLEG,'ANNO':ANNO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'xRAGSOC':xRAGSOC"+FoundlingChildrenList("ardt_delegaop",true,true)+"}"+FoundlingChildrenList("ardt_delegaop",true,false)+"}";
  public static final String i_ItemSequence = "COLLEG,ANNO,m_Detail[ CODINTER DATAINI DATAFINE"+FoundlingChildrenList("ardt_delegaop",false,true)+"]"+FoundlingChildrenList("ardt_delegaop",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_delegaop"),new String[][]{new String[]{"COLLEG","NDG Soggetto","C","16","0","campo","key1","false","false"},new String[]{"ANNO","Anno Operazione","C","4","0","campo","key1","false","false"},new String[]{"CODINTER","Delegato","C","16","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"}});
  ...
  public ardt_delegaopBL (CPContext p_ContextObject) {
    ...
    m_cPhName_delegaop = p_ContextObject.GetPhName("delegaop",p_ContextObject.GetCompany(),false);
    m_cServer_delegaop = p_ContextObject.GetServer("delegaop");
    m_oWrInfo_delegaop = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"delegaop",p_ContextObject.GetCompany());
    m_cVirtName_delegaop = CPSql.ManipulateTablePhName("delegaop",m_cServer_delegaop);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_delegaop",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_QVNGTSMQDW() {
    return Link_QVNGTSMQDW("Full");
  }
  protected boolean Link_QVNGTSMQDW(String p_cType) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_delegaop","delegaop",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_delegaop",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_delegaop",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_delegaop",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_delegaop",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_delegaop"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_delegaop\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "delegaop"+"\\"+CPLib.ToCPStr(p_Caller.GetString("COLLEG","C",16,0))+"\\"+CPLib.ToCPStr(p_Caller.GetString("ANNO","C",4,0));
  }
  public String RowPrimaryKey() {
    return "delegaop"+"\\"+CPLib.ToCPStr(w_CODINTER);
  }
