...
public class arpg_trasfopeBL extends arpg_trasfopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasfope";
  ...
  public arpg_trasfopeBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasfope","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
