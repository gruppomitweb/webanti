...
if ( ! (m_oFather.SaveContext_armt_xraziobo_agg())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_xraziobo_agg_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_xraziobo_agg_dataNotSent',{'action':formaction});
}
}
}
}
...
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_xraziobo_agg();
}
}
