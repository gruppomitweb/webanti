...
public class arpg_allinea_anagrafiche_reportBL extends arpg_allinea_anagrafiche_reportWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_AATIPERR;
    public String c_AANOMREP;
  ...
  public static final String i_EntityName = "arpg_allinea_anagrafiche_report";
  ...
  public static final String i_CompleteStateStructure = "{'gUrlApp':gUrlApp}";
  ...
  public arpg_allinea_anagrafiche_reportBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_anagrafiche_report","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_AATIPERR=c_AATIPERR;
    m_oTrs.get(m_nCurrentRow).c_AANOMREP=c_AANOMREP;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_AATIPERR= m_oTrs.get(m_nCurrentRow).c_AATIPERR;
    c_AANOMREP= m_oTrs.get(m_nCurrentRow).c_AANOMREP;
