...
var c;
SPBOUILib.SetInputValue('TNOGQPIWSU',function(){return WtH(w_CODICE,'C',5,0,'')},w_CODICE);
SPBOUILib.SetInputValue('BGMMOQKKPH',function(){return WtH(w_DESCRI,'C',200,0,'')},w_DESCRI);
...
function Help() {
windowOpenForeground('../doc/armt_tbplauso_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'tbplauso'+'\\'+CPLib.ToCPStr(w_CODICE);
}
...
p_d.setValue('armt_tbplauso',m_cSelectedPage);
