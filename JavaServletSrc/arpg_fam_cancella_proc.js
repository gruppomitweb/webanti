...
function Help() {
windowOpenForeground('../doc/arpg_fam_cancella_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_fam_cancella',m_cSelectedPage);
