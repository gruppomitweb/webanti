...
public class ardt_xapcollBL extends ardt_xapcollWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xapcoll";
  ...
  public CPPhTableWrInfo m_oWrInfo_xapcoll;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xapcoll;
  ...
  public static String[] m_EntityTables = {"xapcoll"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'RAPPORTO':RAPPORTO"+FoundlingChildrenList("ardt_xapcoll",true,true)+"}"+FoundlingChildrenList("ardt_xapcoll",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'RAPPORTO':RAPPORTO,'IDBASE':IDBASE,'DESCRAP':DESCRAP"+FoundlingChildrenList("ardt_xapcoll",true,true)+"}"+FoundlingChildrenList("ardt_xapcoll",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ RAPPORTO"+FoundlingChildrenList("ardt_xapcoll",false,true)+"]"+FoundlingChildrenList("ardt_xapcoll",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_xapcoll"),new String[][]{new String[]{"IDFILEBO","Operazione","C","10","0","campo","key1","false","false"},new String[]{"RAPPORTO","Rapporto","C","25","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",RAPPORTO";
  ...
  public ardt_xapcollBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xapcoll = p_ContextObject.GetPhName("xapcoll",p_ContextObject.GetCompany(),false);
    m_cServer_xapcoll = p_ContextObject.GetServer("xapcoll");
    m_oWrInfo_xapcoll = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xapcoll",p_ContextObject.GetCompany());
    m_cVirtName_xapcoll = CPSql.ManipulateTablePhName("xapcoll",m_cServer_xapcoll);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xapcoll",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_ADJOKPLCJT() {
    return Link_ADJOKPLCJT("Full");
  }
  protected boolean Link_ADJOKPLCJT(String p_cType) {
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            ...
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_knarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_knarapbo+((m_cPhName_knarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
          ...
          w_DESCRAP = l_rsLink.GetString("DESCRAP");
          l_rsLink.Next();
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xapcoll","xapcoll",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_RAPPORTO;
      p_RAPPORTO = CPLib.GetProperties(trs_p.getProperty("RAPPORTO"),new Properties());
      Properties p_IDBASE;
      p_IDBASE = CPLib.GetProperties(trs_p.getProperty("IDBASE"),new Properties());
      Properties p_DESCRAP;
      p_DESCRAP = CPLib.GetProperties(trs_p.getProperty("DESCRAP"),new Properties());
      Properties p_opk_RAPPORTO;
      p_opk_RAPPORTO = CPLib.GetProperties(trs_p.getProperty("opk_RAPPORTO"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        w_RAPPORTO = "";
        w_RAPPORTO = CPLib.GetProperty(p_RAPPORTO,"",w_RAPPORTO,i);
        w_IDBASE = "";
        w_IDBASE = CPLib.GetProperty(p_IDBASE,"",w_IDBASE,i);
        w_DESCRAP = "";
        w_DESCRAP = CPLib.GetProperty(p_DESCRAP,"",w_DESCRAP,i);
        opk_RAPPORTO = CPLib.GetProperty(p_opk_RAPPORTO,"","",i);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_RAPPORTO","w_DESCRAP"});
    ...
    map.put("rd_var.comment",zeroSplit.split("Rapporto\u0000Descrizione",-1));
    ...
    map.put("property.value",zeroSplit.split("knarapbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Rapporti Continuativi\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xapcoll",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xapcoll",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xapcoll",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xapcoll",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xapcoll"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xapcoll\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_RAPPORTO;
    p_RAPPORTO = new Properties();
    Properties p_IDBASE;
    p_IDBASE = new Properties();
    Properties p_DESCRAP;
    p_DESCRAP = new Properties();
    Properties p_opk_RAPPORTO;
    p_opk_RAPPORTO = new Properties();
    Properties p_m_nRowStatus;
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_RAPPORTO,"",w_RAPPORTO,trsrow);
      CPLib.PutProperty(p_IDBASE,"",w_IDBASE,trsrow);
      CPLib.PutProperty(p_DESCRAP,"",w_DESCRAP,trsrow);
      CPLib.PutProperty(p_opk_RAPPORTO,"",opk_RAPPORTO,trsrow);
    ...
    trs_p.setProperty("RAPPORTO",CPLib.ToProperties(p_RAPPORTO));
    trs_p.setProperty("IDBASE",CPLib.ToProperties(p_IDBASE));
    trs_p.setProperty("DESCRAP",CPLib.ToProperties(p_DESCRAP));
    trs_p.setProperty("opk_RAPPORTO",CPLib.ToProperties(p_opk_RAPPORTO));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xapcoll"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xapcoll"+"\\"+CPLib.ToCPStr(w_RAPPORTO);
  }
  ...
  protected void TrsToWork() {
    w_RAPPORTO= m_oTrs.get(m_nCurrentRow).w_RAPPORTO;
    w_IDBASE= m_oTrs.get(m_nCurrentRow).w_IDBASE;
    w_DESCRAP= m_oTrs.get(m_nCurrentRow).w_DESCRAP;
    opk_RAPPORTO= m_oTrs.get(m_nCurrentRow).opk_RAPPORTO;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_RAPPORTO=w_RAPPORTO;
    m_oTrs.get(m_nCurrentRow).w_IDBASE=w_IDBASE;
    m_oTrs.get(m_nCurrentRow).w_DESCRAP=w_DESCRAP;
    m_oTrs.get(m_nCurrentRow).opk_RAPPORTO=opk_RAPPORTO;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_RAPPORTO=w_RAPPORTO;
    m_oDeletedRows.get(l_nRows).w_IDBASE=w_IDBASE;
    m_oDeletedRows.get(l_nRows).w_DESCRAP=w_DESCRAP;
    m_oDeletedRows.get(l_nRows).opk_RAPPORTO=opk_RAPPORTO;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_RAPPORTO= m_oDeletedRows.get(l_RowNumberToSet).w_RAPPORTO;
    w_IDBASE= m_oDeletedRows.get(l_RowNumberToSet).w_IDBASE;
    w_DESCRAP= m_oDeletedRows.get(l_RowNumberToSet).w_DESCRAP;
    opk_RAPPORTO= m_oDeletedRows.get(l_RowNumberToSet).opk_RAPPORTO;
