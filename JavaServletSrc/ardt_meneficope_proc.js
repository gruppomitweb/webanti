...
HideUI.lblids["C_CAB"]=['CBEMYYLYKG'];
HideUI.lblids["C_CAP"]=['ZELRIRCOIH'];
HideUI.lblids["C_CTA"]=['ADZOIEROPS'];
HideUI.lblids["C_IND"]=['XXIXVHLNAZ'];
HideUI.lblids["C_PRV"]=['FTGWANORAK'];
HideUI.lblids["C_STA"]=['EONEZLZFOS'];
...
m_oFather.i_last_focused_item='child_ardt_meneficope';
...
function Help() {
windowOpenForeground('../doc/ardt_meneficope_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'meneficope'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_meneficope',m_cSelectedPage);
