...
public class armt_cgo_oper_multi_dcBL extends armt_cgo_oper_multi_dcWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_cgo_oper_multi_dc";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_operazioni_dl_multi_dc;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_operazioni_dl_multi_dc;
  ...
  public static String[] m_EntityTables = {"cgo_operazioni_dl_multi_dc"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'SNAINUMOPE':SNAINUMOPE,'VLTPLAT':VLTPLAT,'CAIDBIGLIETTO':CAIDBIGLIETTO,'FLAGCONT':FLAGCONT,'FLAGWALLET':FLAGWALLET,'CAFLGOPE':CAFLGOPE,'SEGNO':SEGNO,'ardt_cgo_oper_multi_dc':ardt_cgo_oper_multi_dc,'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'IMPWALLET':IMPWALLET,'CODWALLET':CODWALLET,'CODTRANSZ':CODTRANSZ,'CGOFLGVLT':CGOFLGVLT,'FLGPAGAM':FLGPAGAM,'FILTROMP':FILTROMP,'CC4CIFRE':CC4CIFRE,'CCMESSCA':CCMESSCA,'CCANNSCA':CCANNSCA,'IBAN':IBAN,'ASSEGNO':ASSEGNO,'CFESTERO':CFESTERO,'PEP':PEP,'CODFISC':CODFISC,'COGNOME':COGNOME,'NOME':NOME,'NASCOMUN':NASCOMUN,'TIPINTER':TIPINTER,'SESSO':SESSO,'NASSTATO':NASSTATO,'DATANASC':DATANASC,'PAESE':PAESE,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'DOMICILIO':DOMICILIO,'NUMTEL':NUMTEL,'FLGDOM':FLGDOM,'PAESE2':PAESE2,'DESCCIT2':DESCCIT2,'PROVINCIA2':PROVINCIA2,'CAP2':CAP2,'DOMICILIO2':DOMICILIO2,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'DATAVALI':DATAVALI,'RDCODAUT':RDCODAUT,'RDLOCAUT':RDLOCAUT,'PEPDESCRI':PEPDESCRI,'CONNESCLI':CONNESCLI,'CODDIPE':CODDIPE,'MIDBIGLIETTO':MIDBIGLIETTO,'MIDBIGLIETTO1':MIDBIGLIETTO1,'MIDBIGLIETTO2':MIDBIGLIETTO2,'MIDBIGLIETTO3':MIDBIGLIETTO3,'MIDBIGLIETTO4':MIDBIGLIETTO4,'FLGDOCALL':FLGDOCALL,'DOC03':DOC03,'DOC04':DOC04,'saveddoc':saveddoc,'verifica':verifica,'PROFESSIONE':PROFESSIONE,'MEZPAGAM':MEZPAGAM,'ANA_FOUND':ANA_FOUND"+FoundlingChildrenList("armt_cgo_oper_multi_dc",true)+"}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'SNAINUMOPE':SNAINUMOPE,'gCodDip':gCodDip,'gStpDwn':gStpDwn,'gVLT':gVLT,'gVNP':gVNP,'gChkDate':gChkDate,'gGesDoc':gGesDoc,'gSeekAos':gSeekAos,'gDataVaria':gDataVaria,'gFlgDoc':gFlgDoc,'gTipMul':gTipMul,'TIPOGIOCO':TIPOGIOCO,'VLTPLAT':VLTPLAT,'xARDESCRI':xARDESCRI,'xSOGTPGIO':xSOGTPGIO,'xDEFTPGIO':xDEFTPGIO,'xEDTTPGIO':xEDTTPGIO,'xEDTSPGIO':xEDTSPGIO,'xDEFSPGIO':xDEFSPGIO,'CGOTIPOPE':CGOTIPOPE,'xFLGPLGIO':xFLGPLGIO,'CAIDBIGLIETTO':CAIDBIGLIETTO,'DATAOPE':DATAOPE,'FLAGCONT':FLAGCONT,'FLAGWALLET':FLAGWALLET,'CACODICE':CACODICE,'CODANA':CODANA,'CODVOC':CODVOC,'CAFLGOPE':CAFLGOPE,'SEGNO':SEGNO,'ardt_cgo_oper_multi_dc':ardt_cgo_oper_multi_dc,'TOTLIRE':TOTLIRE,'TOTCONT':TOTCONT,'IMPWALLET':IMPWALLET,'CODWALLET':CODWALLET,'CODTRANSZ':CODTRANSZ,'CGOFLGVLT':CGOFLGVLT,'FLGPAGAM':FLGPAGAM,'FILTROMP':FILTROMP,'CGOFLGVNP':CGOFLGVNP,'CC4CIFRE':CC4CIFRE,'CCMESSCA':CCMESSCA,'CCANNSCA':CCANNSCA,'IBAN':IBAN,'ASSEGNO':ASSEGNO,'CCDATSCA':CCDATSCA,'CFESTERO':CFESTERO,'PEP':PEP,'CODFISC':CODFISC,'COGNOME':COGNOME,'NOME':NOME,'NASCOMUN':NASCOMUN,'TIPINTER':TIPINTER,'SESSO':SESSO,'NASSTATO':NASSTATO,'DATANASC':DATANASC,'PAESE':PAESE,'DESCCIT':DESCCIT,'idcitta':idcitta,'PROVINCIA':PROVINCIA,'CAP':CAP,'DOMICILIO':DOMICILIO,'NUMTEL':NUMTEL,'FLGDOM':FLGDOM,'PAESE2':PAESE2,'DESCCIT2':DESCCIT2,'idcitta2':idcitta2,'PROVINCIA2':PROVINCIA2,'CAP2':CAP2,'DOMICILIO2':DOMICILIO2,'TIPODOC':TIPODOC,'NUMDOCUM':NUMDOCUM,'DATARILASC':DATARILASC,'DATAVALI':DATAVALI,'RDCODAUT':RDCODAUT,'RDLOCAUT':RDLOCAUT,'PEPDESCRI':PEPDESCRI,'TIPOPERS':TIPOPERS,'RAGSOC':RAGSOC,'SOTGRUP':SOTGRUP,'RAMOGRUP':RAMOGRUP,'SETTSINT':SETTSINT,'dessta':dessta,'tipsot':tipsot,'STATOREG':STATOREG,'IDBASE':IDBASE,'NUMPROG':NUMPROG,'DESCRI':DESCRI,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'VALUTA':VALUTA,'CAMBIO':CAMBIO,'CONNESCLI':CONNESCLI,'CONNESBEN':CONNESBEN,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_PRV':C_PRV,'C_CAP':C_CAP,'C_CAB':C_CAB,'C_IND':C_IND,'C_STA':C_STA,'CODINTER':CODINTER,'CODDIPE':CODDIPE,'DESCCITDIP':DESCCITDIP,'FLAGFRAZ':FLAGFRAZ,'COLLEG':COLLEG,'PROVINCIADIP':PROVINCIADIP,'CODCABDIP':CODCABDIP,'xDescDipe':xDescDipe,'datpaseuro':datpaseuro,'xdes1':xdes1,'desccauana':desccauana,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'xdesccausin':xdesccausin,'xdesctipatt':xdesctipatt,'CODCAB':CODCAB,'MIDBIGLIETTO':MIDBIGLIETTO,'MIDBIGLIETTO1':MIDBIGLIETTO1,'MIDBIGLIETTO2':MIDBIGLIETTO2,'MIDBIGLIETTO3':MIDBIGLIETTO3,'MIDBIGLIETTO4':MIDBIGLIETTO4,'ATTIV':ATTIV,'AUTRILASC':AUTRILASC,'IDDOCALL':IDDOCALL,'FLGDOCALL':FLGDOCALL,'xVPFLGATT':xVPFLGATT,'DOC03':DOC03,'DOC04':DOC04,'edtdoc':edtdoc,'saveddoc':saveddoc,'dessta2':dessta2,'verifica':verifica,'xIMPMINTOT':xIMPMINTOT,'gAzienda':gAzienda,'xCGOFLGPROF':xCGOFLGPROF,'PROFESSIONE':PROFESSIONE,'MEZPAGAM':MEZPAGAM,'ANA_FOUND':ANA_FOUND"+FoundlingChildrenList("armt_cgo_oper_multi_dc",true)+"}";
  public static final String i_ItemSequence = "SNAINUMOPE,VLTPLAT,CAIDBIGLIETTO,FLAGCONT,FLAGWALLET,CAFLGOPE,SEGNO,ardt_cgo_oper_multi_dc,TOTLIRE,TOTCONT,IMPWALLET,CODWALLET,CODTRANSZ,CGOFLGVLT,FLGPAGAM,FILTROMP,CC4CIFRE,CCMESSCA,CCANNSCA,IBAN,ASSEGNO,CFESTERO,PEP,CODFISC,COGNOME,NOME,NASCOMUN,TIPINTER,SESSO,NASSTATO,DATANASC,PAESE,DESCCIT,PROVINCIA,CAP,DOMICILIO,NUMTEL,FLGDOM,PAESE2,DESCCIT2,PROVINCIA2,CAP2,DOMICILIO2,TIPODOC,NUMDOCUM,DATARILASC,DATAVALI,RDCODAUT,RDLOCAUT,PEPDESCRI,CONNESCLI,CODDIPE,MIDBIGLIETTO,MIDBIGLIETTO1,MIDBIGLIETTO2,MIDBIGLIETTO3,MIDBIGLIETTO4,FLGDOCALL,DOC03,DOC04,saveddoc,verifica,PROFESSIONE,MEZPAGAM,ANA_FOUND"+FoundlingChildrenList("armt_cgo_oper_multi_dc",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_cgo_oper_multi_dc"),new String[][]{new String[]{"SNAINUMOPE","N° Operazione","C","15","0","campo","key1","false","false"},new String[]{"VLTPLAT","Piattaforma VLT","C","2","0","campo","nokey","false","true"},new String[]{"CAIDBIGLIETTO","ID BIGLIETTO","C","30","0","campo","nokey","false","false"},new String[]{"FLAGCONT","Contanti (S/N)","C","1","0","campo","nokey","false","true"},new String[]{"FLAGWALLET","Flag Wallet","C","1","0","campo","nokey","false","true"},new String[]{"CAFLGOPE","Tipo Registrazione","C","1","0","campo","nokey","false","false"},new String[]{"SEGNO","Segno","C","1","0","campo","nokey","false","false"},new String[]{"ardt_cgo_oper_multi_dc","LinkPC","","","","link_PC","","false",""},new String[]{"TOTLIRE","Totale Operazione","N","15","2","campo","nokey","false","true"},new String[]{"TOTCONT","di cui contanti","N","15","2","campo","nokey","false","true"},new String[]{"IMPWALLET","IMporto","N","12","2","campo","nokey","false","true"},new String[]{"CODWALLET","WALLET","C","20","0","campo","nokey","false","true"},new String[]{"CODTRANSZ","Transazione ID Wallet","C","50","0","campo","nokey","false","true"},new String[]{"CGOFLGVLT","Pagamento VLT","C","1","0","campo","nokey","false","true"},new String[]{"FLGPAGAM","","C","1","0","variabile","nokey","false","false"},new String[]{"FILTROMP","","C","50","0","variabile","nokey","false","false"},new String[]{"CC4CIFRE","Ultime Cifre CC ()","C","4","0","campo","nokey","false","true"},new String[]{"CCMESSCA","Mese Scadenza","N","2","0","campo","nokey","false","true"},new String[]{"CCANNSCA","Carta Di Credito Scadenza","N","4","0","campo","nokey","false","true"},new String[]{"IBAN","IBAN per Bonifici","C","40","0","campo","nokey","false","true"},new String[]{"ASSEGNO","Assegno","C","25","0","campo","nokey","false","true"},new String[]{"CFESTERO","Codice Fiscale Estero","N","1","0","campo","nokey","false","false"},new String[]{"PEP","Persona Politicamente Esposta","C","1","0","campo","nokey","false","true"},new String[]{"CODFISC","Codice Fiscale","C","16","0","campo","nokey","false","true"},new String[]{"COGNOME","Cognome","C","26","0","campo","nokey","false","true"},new String[]{"NOME","Nome","C","25","0","campo","nokey","false","true"},new String[]{"NASCOMUN","Luogo di Nascita","C","30","0","campo","nokey","false","true"},new String[]{"TIPINTER","Prov.","C","2","0","campo","nokey","false","true"},new String[]{"SESSO","Sesso","C","1","0","campo","nokey","false","true"},new String[]{"NASSTATO","Stato di nascita","C","30","0","campo","nokey","false","true"},new String[]{"DATANASC","Data Nascita","D","8","0","campo","nokey","false","true"},new String[]{"PAESE","Stato","C","3","0","campo","nokey","false","true"},new String[]{"DESCCIT","Città","C","40","0","campo","nokey","false","true"},new String[]{"PROVINCIA","Provincia","C","2","0","campo","nokey","false","true"},new String[]{"CAP","CAP","C","9","0","campo","nokey","false","true"},new String[]{"DOMICILIO","Indirizzo","C","35","0","campo","nokey","false","true"},new String[]{"NUMTEL","Numero Telefono","C","20","0","campo","nokey","false","false"},new String[]{"FLGDOM","Domicilio diverso da residenza","C","1","0","campo","nokey","false","false"},new String[]{"PAESE2","Stato Domicilio","C","3","0","campo","nokey","false","true"},new String[]{"DESCCIT2","Città Domicilio","C","40","0","campo","nokey","false","true"},new String[]{"PROVINCIA2","Provincia","C","2","0","campo","nokey","false","true"},new String[]{"CAP2","CAP","C","9","0","campo","nokey","false","true"},new String[]{"DOMICILIO2","Indirizzo Domicilio","C","35","0","campo","nokey","false","true"},new String[]{"TIPODOC","Tipo Documento","C","2","0","campo","nokey","false","true"},new String[]{"NUMDOCUM","Numero Doc.","C","15","0","campo","nokey","false","true"},new String[]{"DATARILASC","Rilascio Doc.","D","8","0","campo","nokey","false","true"},new String[]{"DATAVALI","Data Fine Validità","D","8","0","campo","nokey","false","true"},new String[]{"RDCODAUT","Autorità Rilascio","C","2","0","campo","nokey","false","true"},new String[]{"RDLOCAUT","Luogo Autorità Rilascio","C","20","0","campo","nokey","false","true"},new String[]{"PEPDESCRI","Descrizione PEP","C","80","0","campo","nokey","false","true"},new String[]{"CONNESCLI","Codice Cliente Occasionale","C","16","0","campo","nokey","false","false"},new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"MIDBIGLIETTO","","M","10","0","variabile","nokey","false","false"},new String[]{"MIDBIGLIETTO1","","M","10","0","variabile","nokey","false","false"},new String[]{"MIDBIGLIETTO2","","M","10","0","variabile","nokey","false","false"},new String[]{"MIDBIGLIETTO3","","M","10","0","variabile","nokey","false","false"},new String[]{"MIDBIGLIETTO4","","M","10","0","variabile","nokey","false","false"},new String[]{"FLGDOCALL","Flag Documentazione Completa","C","1","0","campo","nokey","false","false"},new String[]{"DOC03","","C","80","0","variabile","nokey","false","false"},new String[]{"DOC04","","C","80","0","variabile","nokey","false","false"},new String[]{"saveddoc","","C","1","0","variabile","nokey","false","false"},new String[]{"verifica","","C","1","0","variabile","nokey","false","false"},new String[]{"PROFESSIONE","Professione","C","40","0","campo","nokey","false","true"},new String[]{"MEZPAGAM","Mezzo Pagamento","C","1","0","campo","nokey","false","true"},new String[]{"ANA_FOUND","","C","1","0","variabile","nokey","false","false"}});
  ...
  public armt_cgo_oper_multi_dcBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_operazioni_dl_multi_dc = p_ContextObject.GetPhName("cgo_operazioni_dl_multi_dc",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_operazioni_dl_multi_dc = p_ContextObject.GetServer("cgo_operazioni_dl_multi_dc");
    m_oWrInfo_cgo_operazioni_dl_multi_dc = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_operazioni_dl_multi_dc",p_ContextObject.GetCompany());
    m_cVirtName_cgo_operazioni_dl_multi_dc = CPSql.ManipulateTablePhName("cgo_operazioni_dl_multi_dc",m_cServer_cgo_operazioni_dl_multi_dc);
    ...
    ardt_cgo_oper_multi_dc = new ardt_cgo_oper_multi_dcBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_cgo_oper_multi_dc",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_cgo_oper_multi_dc.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi_dc);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    ardt_cgo_oper_multi_dc.SaveDependsOn();
  }
  public void NotifyEvent(String p_cEvent) {
    if (CPLib.eq(p_cEvent,"Blank")) {
      ...
      Calculation_QMNVPQPHJO();
      Calculation_WKUMXNRIRT();
      Calculation_CVWSCOAOME();
      Calculation_CHYPGHRXCN();
  ...
  protected boolean Link_QZTTRBWAQL(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_TIPOGIOCO))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_cgo_tbtipgio,"select CODTPGIO,SOGTPGIO,DEFTPGIO,EDTTPGIO,EDTSPGIO,DEFSPGIO,FLGPLGIO,FLTIPGIO,IMPMINTOT from "+m_cPhName_cgo_tbtipgio+((m_cPhName_cgo_tbtipgio).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODTPGIO"+l_cCurrentKey+l_cWhere);
      try {
        ...
        if (l_bLoaded) {
          ...
          w_CGOTIPOPE = l_rsLink.GetString("FLTIPGIO");
          w_xIMPMINTOT = l_rsLink.GetDouble("IMPMINTOT");
          l_rsLink.Next();
  ...
  protected boolean Link_LVYFMQXNZH(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_VLTPLAT))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_cgo_vltplat,"select VPCODICE,VPFLGATT from "+m_cPhName_cgo_vltplat+((m_cPhName_cgo_vltplat).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"VPCODICE"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
          ...
          w_xVPFLGATT = l_rsLink.GetString("VPFLGATT");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if (l_bResult) {
            l_bResult = CPLib.eq(w_xVPFLGATT,"S");
            if ( ! (l_bResult)) {
              // Se il check è fallito vengono caricati i valori di blank nelle variabili
              m_nLastError = 3;
              m_cLastMsgError = "Obbligatorio selezionare una piattaforma attiva!";
              if (CPLib.eq(m_cLastMsgError,"")) {
  ...
  public boolean Set_VLTPLAT(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public boolean LVYFMQXNZH_isObligatory() {
    // Condizione di obbligatorietà
    return CPLib.eq(w_xFLGPLGIO,"S");
  }
  ...
  public boolean Set_TOTLIRE(double p_workVariableValue) {
    ...
    // Se il campo è vuoto, demando la segnalazione dell'obbligatorietà alla Check() del business object
    // 
    l_bResult = CPLib.gt(w_TOTLIRE,0) && CPLib.ge(w_TOTLIRE,(w_TOTCONT+w_IMPWALLET));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "E' obbligatorio inserire un importo valido";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_TOTLIRE = 0;
  ...
  public boolean RUNOCZKNEF_isObligatory() {
    // Condizione di obbligatorietà
    return CPLib.eq(w_FLAGWALLET,"1");
  }
  ...
  public boolean Set_MIDBIGLIETTO1(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_MIDBIGLIETTO1 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_MIDBIGLIETTO2(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_MIDBIGLIETTO2 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_MIDBIGLIETTO3(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_MIDBIGLIETTO3 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_MIDBIGLIETTO4(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_MIDBIGLIETTO4 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean NTWMYVQDWZ_isObligatory() {
    // Condizione di obbligatorietà
  ...
  public boolean getWritable_VLTPLAT() {
    return CPLib.eq(w_xFLGPLGIO,"S");
  }
  public boolean getWritable_CAIDBIGLIETTO() {
    return false;
  }
  public boolean getWritable_CAFLGOPE() {
    return false;
  }
  ...
  public boolean getVisible_VLTPLAT() {
    return CPLib.ne(w_xFLGPLGIO,"S");
  }
  ...
  public boolean getVisible_MIDBIGLIETTO1() {
    return true;
  }
  public boolean getVisible_MIDBIGLIETTO2() {
    return true;
  }
  public boolean getVisible_MIDBIGLIETTO3() {
    return true;
  }
  public boolean getVisible_MIDBIGLIETTO4() {
    return true;
  }
  ...
  public boolean Calculate() {
    ...
    if (CPLib.ne(o_TIPOGIOCO,w_TIPOGIOCO) || CPLib.ne(o_TOTLIRE,w_TOTLIRE)) {
      Calculation_QMNVPQPHJO();
    }
    ...
    if (CPLib.ne(o_SNAINUMOPE,w_SNAINUMOPE)) {
      w_CODDIPE = w_gCodDip;
    ...
    UpdateAutonumber();
    CopyWorkVar(this,ardt_cgo_oper_multi_dc,new String[]{"CGOTIPOPE_P","DATOPE_P","SEGNO_P"},new String[]{"CGOTIPOPE","DATAOPE","SEGNO"},true);
  ...
  void Calculation_QMNVPQPHJO() {
    arrt_cgo_setpagatore_m_dcR l_oRoutine_arrt_cgo_setpagatore_m_dc;
    l_oRoutine_arrt_cgo_setpagatore_m_dc = arrt_cgo_setpagatore_m_dcR.Make(m_Ctx,this);
    l_oRoutine_arrt_cgo_setpagatore_m_dc.pObj = this;
    l_oRoutine_arrt_cgo_setpagatore_m_dc.Run();
  }
  ...
  void Calculation_KGBNFVNJHO() {
    ...
    l_oRoutine_arrt_writelog.pChiave = w_SNAINUMOPE;
    l_oRoutine_arrt_writelog.Run();
    arrt_cgo_save_multi_dl_dcR l_oRoutine_arrt_cgo_save_multi_dl_dc;
    l_oRoutine_arrt_cgo_save_multi_dl_dc = arrt_cgo_save_multi_dl_dcR.Make(m_Ctx,this);
    l_oRoutine_arrt_cgo_save_multi_dl_dc.w_SNAINUMOPE = w_SNAINUMOPE;
    l_oRoutine_arrt_cgo_save_multi_dl_dc._gAzienda = w_gAzienda;
    l_oRoutine_arrt_cgo_save_multi_dl_dc.Run();
  }
  ...
  void Calculation_TDZCBUMNXR() {
    w_VLTPLAT = (CPLib.eq(w_xFLGPLGIO,"S")?w_VLTPLAT:"");
  }
  ...
  void Calculation_DJCGAISFTP() {
    w_SEGNO = (CPLib.eq(w_CAFLGOPE,"G")?"A":(CPLib.eq(w_CAFLGOPE,"V")?"D":""));
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_cgo_oper_multi_dc","cgo_operazioni_dl_multi_dc",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_gTipMul = CPLib.GetProperty(p,"gTipMul",w_gTipMul,0);
      ...
      w_xIMPMINTOT = CPLib.GetProperty(p,"xIMPMINTOT",w_xIMPMINTOT,0);
      ...
      m_cWv_ardt_cgo_oper_multi_dc = CPLib.GetProperty(p,"m_cWv_ardt_cgo_oper_multi_dc",m_cWv_ardt_cgo_oper_multi_dc,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("cgo_operazioni_dl_multi_dt_dc");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("cgo_operazioni_dl_multi_dt_dc",items);
    }
    items.add(map);
    ...
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("1\u00008\u00001",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Tipo Gioco\u0000Data Operazione\u0000Segno",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000key2\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("cgo_operazioni_dl_multi_dt_dc\u0000false\u0000false\u00001\u00000\u0000ardt_cgo_oper_multi_dc\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODTPGIO","SOGTPGIO","DEFTPGIO","EDTTPGIO","EDTSPGIO","DEFSPGIO","FLGPLGIO","FLTIPGIO","IMPMINTOT"});
    map.put("rd_var",new String[]{"w_TIPOGIOCO","w_xSOGTPGIO","w_xDEFTPGIO","w_xEDTTPGIO","w_xEDTSPGIO","w_xDEFSPGIO","w_xFLGPLGIO","w_CGOTIPOPE","w_xIMPMINTOT"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000N\u0000C\u0000C\u0000C\u0000C\u0000C\u0000C\u0000N",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("3\u000012\u00001\u00001\u00001\u00001\u00001\u00001\u000012",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00002\u00000\u00000\u00000\u00000\u00000\u00000\u00002",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Tipo gioco\u0000Soglia pagamento Agenzia\u0000Default (A=Agenzia , S=SNAI)\u0000Abilita modifica Scelta\u0000Abilita Modifica Sotto Soglia\u0000Default Sotto Soglia\u0000Abilita Selezione Piattaforma\u0000Tipo Gioco\u0000Importo Minimo Totale Multiple",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE\u0000FALSE\u0000FALSE\u0000FALSE\u0000FALSE\u0000FALSE\u0000FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000",-1));
    map.put("rd_kvar.frm_obbl",new String[]{});
    map.put("rd_var.obj",zeroSplit.split("campo\u0000variabile\u0000variabile\u0000variabile\u0000variabile\u0000variabile\u0000variabile\u0000campo\u0000variabile",-1));
    map.put("rd_kvar.obj",new String[]{});
    ...
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"VPCODICE","VPFLGATT"});
    map.put("rd_var",new String[]{"w_VLTPLAT","w_xVPFLGATT"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("2\u00001",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Piattaforma VLT\u0000Piattaforma Attiva",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",new String[]{});
    map.put("rd_var.frm_obbl",zeroSplit.split("w_xFLGPLGIO='S'\u0000",-1));
    map.put("rd_kvar.frm_obbl",new String[]{});
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_cgo_oper_multi_dc",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_cgo_oper_multi_dc",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_cgo_oper_multi_dc = new ardt_cgo_oper_multi_dcBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_cgo_oper_multi_dc",m_Ctx);
  ...
  public boolean Check() {
    ...
    ResetErrorMessage();
    if ((CPLib.eq(w_xFLGPLGIO,"S")) && ((CPLib.Empty(w_VLTPLAT) && LVYFMQXNZH_isObligatory()) || ( ! (CPLib.Empty(w_VLTPLAT)) &&  ! (CPLib.eq(w_xVPFLGATT,"S"))))) {
      l_bNoObligatory =  ! (CPLib.Empty(w_VLTPLAT));
      String obblMsgError = m_Ctx.Translate("Piattaforma VLT")+" : ";
      if ( ! (l_bNoObligatory)) {
        m_cLastMsgError = obblMsgError+m_Ctx.Translate("Obbligatorio selezionare una piattaforma attiva!");
      } else {
        m_cLastMsgError = m_Ctx.Translate("Obbligatorio selezionare una piattaforma attiva!");
        l_bNoCheck = false;
      }
      l_bResult = false;
      w_VLTPLAT = "";
    ...
    } else if (CPLib.Empty(w_DATAOPE)) {
      l_bNoObligatory =  ! (CPLib.Empty(w_DATAOPE));
      String obblMsgError = m_Ctx.Translate("Data Operazione")+" : ";
      m_cLastMsgError = obblMsgError+m_Ctx.Translate("La data del ticket non può essere maggiore della data odierna!");
      l_bResult = false;
      w_DATAOPE = CPLib.NullDate();
      if (CPLib.eq(m_cLastWorkVarError,"")) {
        m_cLastWorkVarError = "DATAOPE";
      }
    } else if (CPLib.Empty(w_FLAGCONT)) {
    ...
    } else if (CPLib.Empty(w_CACODICE)) {
      l_bNoObligatory =  ! (CPLib.Empty(w_CACODICE));
    ...
    } else if ((false) && ((CPLib.Empty(w_TOTLIRE)) || ( ! (CPLib.gt(w_TOTLIRE,0) && CPLib.ge(w_TOTLIRE,(w_TOTCONT+w_IMPWALLET)))))) {
      ...
      if ( ! (l_bNoObligatory)) {
        ...
        m_cLastMsgError = m_Ctx.Translate("E' obbligatorio inserire un importo valido");
        l_bNoCheck = false;
      }
      l_bResult = false;
      w_TOTLIRE = 0;
    ...
    } else if ((CPLib.eq(w_FLAGWALLET,"1") &&  ! (CPLib.Empty(w_DATAOPE))) && (CPLib.Empty(w_CODWALLET) && RUNOCZKNEF_isObligatory())) {
      ...
      m_cLastMsgError = obblMsgError+m_Ctx.Translate("\"9,999,999,999.99\"");
      l_bResult = false;
      w_DATANASC = CPLib.NullDate();
      if (CPLib.eq(m_cLastWorkVarError,"")) {
    ...
    } else if (CPLib.Empty(w_PROFESSIONE) && NTWMYVQDWZ_isObligatory()) {
    ...
    if (l_bResult && (( ! (ardt_cgo_oper_multi_dc.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_cgo_oper_multi_dc)) || ( ! (ardt_cgo_oper_multi_dc.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi_dc)))) {
      ardt_cgo_oper_multi_dc.SetFromContext(m_cWv_ardt_cgo_oper_multi_dc);
      m_cWv_ardt_cgo_oper_multi_dc = "_not_empty_";
    }
    if (l_bResult && (ardt_cgo_oper_multi_dc.m_bLoaded || ardt_cgo_oper_multi_dc.m_bUpdated)) {
      l_bResult = l_bResult && ardt_cgo_oper_multi_dc.Check();
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_cgo_oper_multi_dc"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_cgo_oper_multi_dc\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  void InitAutonumber() {
    ...
    w_SNAINUMOPE = m_Ctx.AskTableProg(w_SNAINUMOPE,15,op_SNAINUMOPE,"PRGNUMOPE"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_cgo_operazioni_dl_multi_dc);
    op_codazi = m_Ctx.GetCompany();
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"gTipMul",w_gTipMul,0);
    ...
    CPLib.PutProperty(p,"xIMPMINTOT",w_xIMPMINTOT,0);
    ...
    if (p_bGetChildren) {
      if (ardt_cgo_oper_multi_dc.IsUpdated()) {
        m_cWv_ardt_cgo_oper_multi_dc = ardt_cgo_oper_multi_dc.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_cgo_oper_multi_dc",m_cWv_ardt_cgo_oper_multi_dc,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_operazioni_dl_multi_dc"+"\\"+CPLib.ToCPStr(p_Caller.GetString("SNAINUMOPE","C",15,0));
  }
  ...
  public boolean ChildExists_ardt_cgo_oper_multi_dc() {
    if (ardt_cgo_oper_multi_dc.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi_dc) || CPLib.IsLoaded(m_cWv_ardt_cgo_oper_multi_dc))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_cgo_oper_multi_dc.m_bLoaded)) {
      ardt_cgo_oper_multi_dc.Blank();
      ardt_cgo_oper_multi_dc.w_SNAINUMOPE = w_SNAINUMOPE;
      ardt_cgo_oper_multi_dc.Load();
    }
    return ardt_cgo_oper_multi_dc.m_bLoaded;
  }
  public void CtxLoad_ardt_cgo_oper_multi_dc() {
    if ( ! (ardt_cgo_oper_multi_dc.m_lCtxLoaded)) {
      ardt_cgo_oper_multi_dc.Blank();
    }
    ardt_cgo_oper_multi_dc.m_lCtxLoaded = true;
    if ( ! (ardt_cgo_oper_multi_dc.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_cgo_oper_multi_dc) || CPLib.IsLoaded(m_cWv_ardt_cgo_oper_multi_dc)) {
        ardt_cgo_oper_multi_dc.SetFromContext(m_cWv_ardt_cgo_oper_multi_dc);
        m_cWv_ardt_cgo_oper_multi_dc = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_cgo_oper_multi_dc.m_bLoaded)) {
          ardt_cgo_oper_multi_dc.Blank();
          ardt_cgo_oper_multi_dc.w_SNAINUMOPE = w_SNAINUMOPE;
          ardt_cgo_oper_multi_dc.Load();
          if ( ! (ardt_cgo_oper_multi_dc.m_bLoaded)) {
            ardt_cgo_oper_multi_dc.Initialize();
            ardt_cgo_oper_multi_dc.SetUpdated();
          }
          CopyWorkVar(this,ardt_cgo_oper_multi_dc,new String[]{"CGOTIPOPE_P","DATOPE_P","SEGNO_P"},new String[]{"CGOTIPOPE","DATAOPE","SEGNO"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_cgo_oper_multi_dc,new String[]{"CGOTIPOPE_P","DATOPE_P","SEGNO_P"},new String[]{"CGOTIPOPE","DATAOPE","SEGNO"},true);
        }
      }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_cgo_oper_multi_dc")) {
      CtxLoad_ardt_cgo_oper_multi_dc();
      return ardt_cgo_oper_multi_dc;
    }
