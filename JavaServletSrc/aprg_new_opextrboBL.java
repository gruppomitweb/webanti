...
public class aprg_new_opextrboBL extends aprg_new_opextrboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "aprg_new_opextrbo";
  ...
  public static final String i_StateStructure = "{'annorif':annorif,'dataope':dataope,'txtnote':txtnote,'nummov':nummov,'impsaldo':impsaldo,'codval':codval,'CONNES':CONNES}";
  public static final String i_CompleteStateStructure = "{'annorif':annorif,'dataope':dataope,'txtnote':txtnote,'nummov':nummov,'impsaldo':impsaldo,'codval':codval,'CONNES':CONNES,'xdesval':xdesval}";
  public static final String i_ItemSequence = "annorif,dataope,txtnote,nummov,impsaldo,codval,CONNES";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"annorif","Anno Riferimento","C","4","0","variabile","nokey","false","false"},new String[]{"dataope","Data Operazione","D","8","0","variabile","nokey","false","false"},new String[]{"txtnote","Note","C","50","0","variabile","nokey","false","false"},new String[]{"nummov","Numero di Operazioni","N","10","0","variabile","nokey","false","false"},new String[]{"impsaldo","Importo Saldo","N","17","0","variabile","nokey","false","false"},new String[]{"codval","Valuta Prevalente","C","3","0","variabile","nokey","false","false"},new String[]{"CONNES","","C","16","0","variabile","nokey","false","false"}});
  ...
  public aprg_new_opextrboBL (CPContext p_ContextObject) {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_annorif(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    // 
    l_bResult = arfn_verify_opexR.Make(m_Ctx,this).Run(w_CONNES,w_annorif);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "Esiste già un'operazione per l'anno selezionato !";
    }
    if ( ! (l_bResult)) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("aprg_new_opextrbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
