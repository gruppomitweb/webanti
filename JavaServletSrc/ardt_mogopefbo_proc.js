...
m_oFather.i_last_focused_item='child_ardt_mogopefbo';
...
function Help() {
windowOpenForeground('../doc/ardt_mogopefbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'mogopefbo'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_mogopefbo',m_cSelectedPage);
