...
if ( ! (m_oFather.SaveContext_armt_tbspecie_p())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_tbspecie_p_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tbspecie_p_dataNotSent',{'action':formaction});
}
}
}
}
...
l_oWv.setValue('CODSPE',WtA(w_CODSPE,'C'));
...
_FillChildren.n=[];
FillWv.n=["CODSPE","RISCHIO","FLGPERS","oldris"];
function SetModified() {
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_tbspecie_p();
}
}
