...
// * --- Fine Area Manuale
public class armt_decodestatiBO extends armt_decodestatiBL {
  class SqlLoader {
    double m_nColumns = 0;
    CPSql m_Sql;
    String m_cServer;
  ...
  // * --- Fine Area Manuale
  public armt_decodestatiBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_decodestati");
    }
  ...
  public boolean Load(double p_id) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_DecodeStati,m_cPhName_DecodeStati,m_cVirtName_DecodeStati,m_cVirtName_DecodeStati+".id="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_id,"N",10,0),m_cServer_DecodeStati,p_id),"");
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (CPLib.HasTableCPCCCHK(m_Ctx,"DecodeStati")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_DecodeStati);
      l_cSql = "insert into "+m_oWrInfo_DecodeStati.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_DecodeStati.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"DecodeStati")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQLNull(w_CODSTA,"C",3,0)+", ";
      l_cSql = l_cSql+CPLib.ToSQL(w_DESCRI,"C",40,0)+", ";
      ...
      l_cSql = l_cSql+m_oWrInfo_DecodeStati.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"DecodeStati")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_DecodeStati,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_DecodeStati);
      l_cSql = "Update "+m_oWrInfo_DecodeStati.GetTableWriteName()+" set";
      l_cSql = l_cSql+" account = "+CPLib.ToSQL(w_account,"C",100,0);
      l_cSql = l_cSql+", CODSTA = "+CPLib.ToSQLNull(w_CODSTA,"C",3,0);
      l_cSql = l_cSql+", DESCRI = "+CPLib.ToSQL(w_DESCRI,"C",40,0);
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"id="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_id,"N",10,0),m_cServer_DecodeStati,w_id);
      l_cSql = l_cSql+m_oWrInfo_DecodeStati.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"DecodeStati")) {
  ...
  public boolean Delete(double p_id) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_DecodeStati.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"id="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_id,"N",10,0),m_cServer_DecodeStati,w_id);
          l_cSql = l_cSql+m_oWrInfo_DecodeStati.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"DecodeStati")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_DecodeStati,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    ...
    if (CPLib.eq(p_cID,"UGNUAEBJAI")) {
      ...
      result.m_PrgZoom = "";
      result.m_rdField = new String[]{"CODSTA" , "DESCRI" , "SIGLA" , "ISO" , "ISO2" , "IDTBLS" , "IDBASE"};
      result.m_rdTypes = new String[]{"C" , "C" , "C" , "C" , "C" , "C" , "C"};
      result.m_kField = new String[]{};
      result.m_kTypes = new String[]{};
      result.AppendFieldsHash("UGNUAEBJAI",CPLib.GetLinkedFieldProps("CODSTA","CODSTA","C",3,0));
    }
    return result;
  }
