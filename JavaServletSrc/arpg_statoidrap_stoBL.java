...
public class arpg_statoidrap_stoBL extends arpg_statoidrap_stoWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_CODINTER;
    public String c_RAGSOC;
    public java.sql.Date c_DATAINI;
    public java.sql.Date c_DATAFINE;
    public String c_STATORAP;
    public String c_TIPOPERS;
  ...
  public static final String i_EntityName = "arpg_statoidrap_sto";
  ...
  public arpg_statoidrap_stoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_statoidrap_sto","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_CODINTER=c_CODINTER;
    m_oTrs.get(m_nCurrentRow).c_RAGSOC=c_RAGSOC;
    m_oTrs.get(m_nCurrentRow).c_DATAINI=c_DATAINI;
    m_oTrs.get(m_nCurrentRow).c_DATAFINE=c_DATAFINE;
    m_oTrs.get(m_nCurrentRow).c_STATORAP=c_STATORAP;
    m_oTrs.get(m_nCurrentRow).c_TIPOPERS=c_TIPOPERS;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_CODINTER= m_oTrs.get(m_nCurrentRow).c_CODINTER;
    c_RAGSOC= m_oTrs.get(m_nCurrentRow).c_RAGSOC;
    c_DATAINI= m_oTrs.get(m_nCurrentRow).c_DATAINI;
    c_DATAFINE= m_oTrs.get(m_nCurrentRow).c_DATAFINE;
    c_STATORAP= m_oTrs.get(m_nCurrentRow).c_STATORAP;
    c_TIPOPERS= m_oTrs.get(m_nCurrentRow).c_TIPOPERS;
