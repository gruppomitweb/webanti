...
if ( ! (m_oFather.SaveContext_ardt_storsogfraz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_storsogfraz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_storsogfraz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_storsogfraz();
}
}
SaveContext.child=[];
function BlankRow() {
