...
public class arpg_stprappoBL extends arpg_stprappoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stprappo";
  ...
  public static final String i_StateStructure = "{'daRappo':daRappo,'aRappo':aRappo,'DaData':DaData,'AData':AData,'coddip':coddip,'detope':detope,'attiva':attiva,'mod_attiva':mod_attiva,'cancellata':cancellata,'mod_copia':mod_copia,'tipo':tipo,'detana':detana,'flgtit':flgtit,'flgdel':flgdel,'DaSogg':DaSogg,'ASogg':ASogg}";
  public static final String i_CompleteStateStructure = "{'daRappo':daRappo,'aRappo':aRappo,'DaData':DaData,'AData':AData,'coddip':coddip,'desrap1':desrap1,'desrap2':desrap2,'detope':detope,'c_dadata':c_dadata,'c_adata':c_adata,'attiva':attiva,'mod_attiva':mod_attiva,'cancellata':cancellata,'mod_copia':mod_copia,'tipo':tipo,'detana':detana,'flgtit':flgtit,'flgdel':flgdel,'desdip':desdip,'DaSogg':DaSogg,'xDaRag':xDaRag,'ASogg':ASogg,'xARag':xARag}";
  public static final String i_ItemSequence = "daRappo,aRappo,DaData,AData,coddip,detope,attiva,mod_attiva,cancellata,mod_copia,tipo,detana,flgtit,flgdel,DaSogg,ASogg";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daRappo","","C","25","0","variabile","nokey","false","false"},new String[]{"aRappo","","C","25","0","variabile","nokey","false","false"},new String[]{"DaData","","D","8","0","variabile","nokey","false","false"},new String[]{"AData","","D","8","0","variabile","nokey","false","false"},new String[]{"coddip","Dipendenza / Agenzia","C","6","0","variabile","nokey","false","false"},new String[]{"detope","","C","1","0","variabile","nokey","false","false"},new String[]{"attiva","","C","1","0","variabile","nokey","false","false"},new String[]{"mod_attiva","","C","1","0","variabile","nokey","false","false"},new String[]{"cancellata","","C","1","0","variabile","nokey","false","false"},new String[]{"mod_copia","","C","1","0","variabile","nokey","false","false"},new String[]{"tipo","","C","1","0","variabile","nokey","false","false"},new String[]{"detana","","C","1","0","variabile","nokey","false","false"},new String[]{"flgtit","","C","1","0","variabile","nokey","false","false"},new String[]{"flgdel","","C","1","0","variabile","nokey","false","false"},new String[]{"DaSogg","Da Soggetto","C","16","0","variabile","nokey","false","false"},new String[]{"ASogg","Da Soggetto","C","16","0","variabile","nokey","false","false"}});
  ...
  public arpg_stprappoBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_RGLTWKIWPY() {
    return Link_RGLTWKIWPY("Full");
  }
  protected boolean Link_RGLTWKIWPY(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    // Dichiarazione del cursore locale del link
    CPResultSet l_rsLink=null;
    if ( ! (CPLib.Empty(w_DaSogg))) {
      String l_OldValue = w_DaSogg;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_DaSogg,"C",16,0),m_cServer_personbo,w_DaSogg);
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_DaSogg,"C",70,0),m_cServer_personbo,w_DaSogg);
            if (l_rsLink!=null)
              l_rsLink.Close();
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                      relativi campi e/o variabili.
                                    */
          w_DaSogg = l_rsLink.GetString("CONNES");
          w_xDaRag = l_rsLink.GetString("RAGSOC");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
        ...
        if ( ! (l_bResult)) {
          ...
          m_cLastMsgError = "";
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","DaSogg");
          }
          m_cLastWorkVarError = "DaSogg";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  void Link_RGLTWKIWPY_blank() {
    w_DaSogg = "";
    w_xDaRag = "";
  }
  protected boolean Link_USKGWKJFWW() {
    return Link_USKGWKJFWW("Full");
  }
  protected boolean Link_USKGWKJFWW(String p_cType) {
    // Viene eseguita una query per chiave totale.
    boolean l_bResult;
    boolean l_bLoaded;
    String l_cWhere = "";
    ...
    // Dichiarazione del cursore locale del link
    CPResultSet l_rsLink=null;
    if ( ! (CPLib.Empty(w_ASogg))) {
      String l_OldValue = w_ASogg;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_ASogg,"C",16,0),m_cServer_personbo,w_ASogg);
      if (m_Ctx.IsSharedTemp("personbo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_ASogg,"C",70,0),m_cServer_personbo,w_ASogg);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_personbo,"select CONNES,RAGSOC from "+m_cPhName_personbo+((m_cPhName_personbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"RAGSOC"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                      relativi campi e/o variabili.
                                    */
          w_ASogg = l_rsLink.GetString("CONNES");
          w_xARag = l_rsLink.GetString("RAGSOC");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
        ...
        if ( ! (l_bResult)) {
          ...
          m_cLastMsgError = "";
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","ASogg");
          }
          m_cLastWorkVarError = "ASogg";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  public boolean Set_attiva(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_attiva = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_mod_attiva(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_mod_attiva = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_cancellata(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_cancellata = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_mod_copia(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_mod_copia = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_DaSogg(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_DaSogg = p_workVariableValue;
    l_bResult = Link_RGLTWKIWPY();
    // La variabile che indica il tipo di errore viene eventualmente impostata
    // dalla funzione di link: infatti il suo valore di ritorno non e'
    // sufficiente per determinare il tipo di errore che puo' essere di valore
    // non trovato nella tabella collegata o di check non valido.
  ...
  public boolean Set_ASogg(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_ASogg = p_workVariableValue;
    l_bResult = Link_USKGWKJFWW();
    // La variabile che indica il tipo di errore viene eventualmente impostata
    // dalla funzione di link: infatti il suo valore di ritorno non e'
    // sufficiente per determinare il tipo di errore che puo' essere di valore
    // non trovato nella tabella collegata o di check non valido.
  ...
  public String getDefault_ASogg() {
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getVisible_flgtit() {
    return CPLib.eq(w_detana,"N");
  }
  public boolean getVisible_flgdel() {
    return CPLib.eq(w_detana,"N");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stprappo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_attiva = CPLib.GetProperty(p,"attiva",w_attiva,0);
      w_mod_attiva = CPLib.GetProperty(p,"mod_attiva",w_mod_attiva,0);
      w_cancellata = CPLib.GetProperty(p,"cancellata",w_cancellata,0);
      w_mod_copia = CPLib.GetProperty(p,"mod_copia",w_mod_copia,0);
      ...
      w_DaSogg = CPLib.GetProperty(p,"DaSogg",w_DaSogg,0);
      w_xDaRag = CPLib.GetProperty(p,"xDaRag",w_xDaRag,0);
      w_ASogg = CPLib.GetProperty(p,"ASogg",w_ASogg,0);
      w_xARag = CPLib.GetProperty(p,"xARag",w_xARag,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_DaSogg","w_xDaRag"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    ...
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("Da Soggetto\u0000Ragione Sociale",-1));
    map.put("rd_kvar.comment",new String[]{});
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",new String[]{});
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    ...
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CONNES","RAGSOC"});
    map.put("rd_var",new String[]{"w_ASogg","w_xARag"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
