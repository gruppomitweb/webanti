...
_modifyandopen('arrt_stpoper_sto'+'?m_cAction=start&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes,height=500,width=700',null)
}
function href_PTXYMSWBZO() {
var action = (Eq(Left('centrale'+''+'?',17),'arpg_stpoper_sto?')?'query':'start');
...
function Help() {
windowOpenForeground('../doc/arpg_stpoper_sto_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stpoper_sto',m_cSelectedPage);
