...
// * --- Fine Area Manuale
public class arrt_xntestit_iudR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_xntestit_iudR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_xntestit_iud",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(pTipo,"I")) {
      ...
      if (CPLib.eqr(w_TIPOOPRAP,"50") || CPLib.eqr(w_TIPOOPRAP,"52")) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arrt_xntestit_iud",3,"0000000D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_xntestit_iud",3,"0000000E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      if (CPLib.eqr(w_TIPOOPRAP,"50") || CPLib.eqr(w_TIPOOPRAP,"52")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_xntestit_iud",3,"00000010")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_xntestit_iud",3,"00000011")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(w_DATAOPE,"D",8,0)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xntestit",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"CODCLI = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CONNESCLI,"?",0,0,m_cServer),m_cServer,w_CONNESCLI)+"";
      ...
      if (CPLib.eqr(w_TIPOOPRAP,"50") || CPLib.eqr(w_TIPOOPRAP,"52")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_xntestit_iud",3,"00000013")+"delete from "+m_oWrInfo.GetTableWriteName();
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"CODCLI = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CONNESCLI,"?",0,0,m_cServer),m_cServer,w_CONNESCLI)+"";
        m_cSql = m_cSql+" and CODINTER = "+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CONNESOPER,"?",0,0,m_cServer),m_cServer,w_CONNESOPER)+"";
        m_cSql = m_cSql+m_oWrInfo.WhereFilter();
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestit",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_xntestit_iud",3,"00000014")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  public static arrt_xntestit_iudR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_xntestit_iudR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pTipo = CPLib.Space(1);
