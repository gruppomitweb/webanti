...
// * --- Fine Area Manuale
public class arrt_lancia_import_valutransR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_valutransR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_valutrans",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_import_valutrans";
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_import_errori_valutrans */
    Forward f;
    f=new Forward("arpg_import_errori_valutrans",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_import_valutransR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_valutransR(p_Ctx, p_Caller);
  }
  public void Blank() {
