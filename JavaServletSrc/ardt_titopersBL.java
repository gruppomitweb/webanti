...
public class ardt_titopersBL extends ardt_titopersWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_titopers";
  ...
  public CPPhTableWrInfo m_oWrInfo_titopers;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_titopers;
  ...
  public static String[] m_EntityTables = {"titopers"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CONTITO':CONTITO,'m_Detail':{'CONPERS':CONPERS,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'NOTEBREV':NOTEBREV"+FoundlingChildrenList("ardt_titopers",true,true)+"}"+FoundlingChildrenList("ardt_titopers",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'CONTITO':CONTITO,'m_Detail':{'CONPERS':CONPERS,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'NOTEBREV':NOTEBREV,'xragsoc':xragsoc"+FoundlingChildrenList("ardt_titopers",true,true)+"}"+FoundlingChildrenList("ardt_titopers",true,false)+"}";
  public static final String i_ItemSequence = "CONTITO,m_Detail[ CONPERS DATAINI DATAFINE NOTEBREV"+FoundlingChildrenList("ardt_titopers",false,true)+"]"+FoundlingChildrenList("ardt_titopers",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_titopers"),new String[][]{new String[]{"CONTITO","Codice Connessione","C","16","0","campo","key1","false","false"},new String[]{"CONPERS","Codice Titolarità","C","16","0","campo","key2","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"},new String[]{"NOTEBREV","Note Brevi","M","10","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_titopersBL (CPContext p_ContextObject) {
    ...
    m_cPhName_titopers = p_ContextObject.GetPhName("titopers",p_ContextObject.GetCompany(),false);
    m_cServer_titopers = p_ContextObject.GetServer("titopers");
    m_oWrInfo_titopers = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"titopers",p_ContextObject.GetCompany());
    m_cVirtName_titopers = CPSql.ManipulateTablePhName("titopers",m_cServer_titopers);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_titopers",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_AGYYKHSHUA() {
    return Link_AGYYKHSHUA("Full");
  }
  protected boolean Link_AGYYKHSHUA(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_CONPERS))) {
      String l_OldValue = w_CONPERS;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CONPERS,"C",16,0),m_cServer_personbo,w_CONPERS);
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CONPERS,"C",70,0),m_cServer_personbo,w_CONPERS);
            if (l_rsLink!=null)
              l_rsLink.Close();
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                    ...
                                    */
          w_CONPERS = l_rsLink.GetString("CONNES");
          ...
          Link_AGYYKHSHUA_blank();
          if (CPLib.eq(p_cType,"Load")) {
            w_CONPERS = l_OldValue;
          }
        }
        if ( ! (l_bResult)) {
          m_nLastError = 3;
          ...
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","CONPERS");
          }
          m_cLastWorkVarError = "CONPERS";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_CONTITO(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_CONTITO = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_CONPERS(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_CONPERS = p_workVariableValue;
    l_bResult = Link_AGYYKHSHUA();
  ...
  public boolean Set_NOTEBREV(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_NOTEBREV = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"CONTITO"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_titopers","titopers",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_CONPERS;
      p_CONPERS = CPLib.GetProperties(trs_p.getProperty("CONPERS"),new Properties());
      ...
      Properties p_NOTEBREV;
      p_NOTEBREV = CPLib.GetProperties(trs_p.getProperty("NOTEBREV"),new Properties());
      ...
      w_CONTITO = CPLib.GetProperty(p,"CONTITO",w_CONTITO,0);
      ...
      while (CPLib.le(i,rows)) {
        w_CONPERS = "";
        w_CONPERS = CPLib.GetProperty(p_CONPERS,"",w_CONPERS,i);
        w_DATAINI = CPLib.NullDate();
        w_DATAINI = CPLib.GetProperty(p_DATAINI,"",w_DATAINI,i);
        w_DATAFINE = CPLib.NullDate();
        w_DATAFINE = CPLib.GetProperty(p_DATAFINE,"",w_DATAFINE,i);
        w_NOTEBREV = "";
        w_NOTEBREV = CPLib.GetProperty(p_NOTEBREV,"",w_NOTEBREV,i);
        w_xragsoc = "";
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"CONTITO")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"CONPERS")) {
      SetUpdatedRow();
      return;
    }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_CONPERS","w_xragsoc"});
    ...
    map.put("rd_var.comment",zeroSplit.split("Codice Titolarità\u0000Ragione Sociale",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_titopers",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_titopers",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_titopers",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_titopers",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_titopers"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_titopers\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_CONPERS;
    p_CONPERS = new Properties();
    Properties p_DATAINI;
    p_DATAINI = new Properties();
    Properties p_DATAFINE;
    p_DATAFINE = new Properties();
    Properties p_NOTEBREV;
    p_NOTEBREV = new Properties();
    Properties p_xragsoc;
    ...
    CPLib.PutProperty(p,"CONTITO",w_CONTITO,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_CONPERS,"",w_CONPERS,trsrow);
      CPLib.PutProperty(p_DATAINI,"",w_DATAINI,trsrow);
      CPLib.PutProperty(p_DATAFINE,"",w_DATAFINE,trsrow);
      CPLib.PutProperty(p_NOTEBREV,"",w_NOTEBREV,trsrow);
    ...
    trs_p.setProperty("CONPERS",CPLib.ToProperties(p_CONPERS));
    trs_p.setProperty("DATAINI",CPLib.ToProperties(p_DATAINI));
    trs_p.setProperty("DATAFINE",CPLib.ToProperties(p_DATAFINE));
    trs_p.setProperty("NOTEBREV",CPLib.ToProperties(p_NOTEBREV));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "titopers"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CONTITO","C",16,0));
  }
  public String RowPrimaryKey() {
    return "titopers"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
  ...
  protected void TrsToWork() {
    w_CONPERS= m_oTrs.get(m_nCurrentRow).w_CONPERS;
    w_DATAINI= m_oTrs.get(m_nCurrentRow).w_DATAINI;
    w_DATAFINE= m_oTrs.get(m_nCurrentRow).w_DATAFINE;
    w_NOTEBREV= m_oTrs.get(m_nCurrentRow).w_NOTEBREV;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_CONPERS=w_CONPERS;
    m_oTrs.get(m_nCurrentRow).w_DATAINI=w_DATAINI;
    m_oTrs.get(m_nCurrentRow).w_DATAFINE=w_DATAFINE;
    m_oTrs.get(m_nCurrentRow).w_NOTEBREV=w_NOTEBREV;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_CONPERS=w_CONPERS;
    m_oDeletedRows.get(l_nRows).w_DATAINI=w_DATAINI;
    m_oDeletedRows.get(l_nRows).w_DATAFINE=w_DATAFINE;
    m_oDeletedRows.get(l_nRows).w_NOTEBREV=w_NOTEBREV;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_CONPERS= m_oDeletedRows.get(l_RowNumberToSet).w_CONPERS;
    w_DATAINI= m_oDeletedRows.get(l_RowNumberToSet).w_DATAINI;
    w_DATAFINE= m_oDeletedRows.get(l_RowNumberToSet).w_DATAFINE;
    w_NOTEBREV= m_oDeletedRows.get(l_RowNumberToSet).w_NOTEBREV;
