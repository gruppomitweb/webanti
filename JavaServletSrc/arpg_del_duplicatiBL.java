...
public class arpg_del_duplicatiBL extends arpg_del_duplicatiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_del_duplicati";
  ...
  public static final String i_CompleteStateStructure = "{'anno':anno}";
  public static final String i_ItemSequence = "anno";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","","N","4","0","variabile","nokey","false","false"}});
  ...
  public arpg_del_duplicatiBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_del_duplicati","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
