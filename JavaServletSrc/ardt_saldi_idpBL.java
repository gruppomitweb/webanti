...
public class ardt_saldi_idpBL extends ardt_saldi_idpWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_saldi_idp";
  ...
  public CPPhTableWrInfo m_oWrInfo_saldi_idp;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_saldi_idp;
  ...
  public static String[] m_EntityTables = {"saldi_idp"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'ANNO':ANNO,'TRIMESTRE':TRIMESTRE,'IMPORTO':IMPORTO"+FoundlingChildrenList("ardt_saldi_idp",true,true)+"}"+FoundlingChildrenList("ardt_saldi_idp",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'ANNO':ANNO,'TRIMESTRE':TRIMESTRE,'IMPORTO':IMPORTO,'IDBASE':IDBASE"+FoundlingChildrenList("ardt_saldi_idp",true,true)+"}"+FoundlingChildrenList("ardt_saldi_idp",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ ANNO TRIMESTRE IMPORTO"+FoundlingChildrenList("ardt_saldi_idp",false,true)+"]"+FoundlingChildrenList("ardt_saldi_idp",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_saldi_idp"),new String[][]{new String[]{"RAPPORTO","Codice Rapporto","C","25","0","campo","key1","false","false"},new String[]{"ANNO","Anno","C","4","0","campo","key1","true","false"},new String[]{"TRIMESTRE","Trimestre","C","1","0","campo","key1","true","false"},new String[]{"IMPORTO","Importo","N","15","2","campo","nokey","true","false"}});
  public static final String i_TrsKeys = ",ANNO,TRIMESTRE";
  ...
  public ardt_saldi_idpBL (CPContext p_ContextObject) {
    ...
    m_cPhName_saldi_idp = p_ContextObject.GetPhName("saldi_idp",p_ContextObject.GetCompany(),false);
    m_cServer_saldi_idp = p_ContextObject.GetServer("saldi_idp");
    m_oWrInfo_saldi_idp = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"saldi_idp",p_ContextObject.GetCompany());
    m_cVirtName_saldi_idp = CPSql.ManipulateTablePhName("saldi_idp",m_cServer_saldi_idp);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_saldi_idp",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Set_TRIMESTRE(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_TRIMESTRE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_saldi_idp","saldi_idp",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_TRIMESTRE;
      p_TRIMESTRE = CPLib.GetProperties(trs_p.getProperty("TRIMESTRE"),new Properties());
      ...
      Properties p_opk_TRIMESTRE;
      p_opk_TRIMESTRE = CPLib.GetProperties(trs_p.getProperty("opk_TRIMESTRE"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_TRIMESTRE = "";
        w_TRIMESTRE = CPLib.GetProperty(p_TRIMESTRE,"",w_TRIMESTRE,i);
        w_IMPORTO = 0;
        ...
        opk_TRIMESTRE = CPLib.GetProperty(p_opk_TRIMESTRE,"","",i);
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_saldi_idp",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_saldi_idp",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_saldi_idp",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_saldi_idp",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_saldi_idp"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_saldi_idp\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_opk_TRIMESTRE;
    p_opk_TRIMESTRE = new Properties();
    Properties p_m_nRowStatus;
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_TRIMESTRE,"",w_TRIMESTRE,trsrow);
      ...
      CPLib.PutProperty(p_opk_TRIMESTRE,"",opk_TRIMESTRE,trsrow);
    ...
    trs_p.setProperty("TRIMESTRE",CPLib.ToProperties(p_TRIMESTRE));
    ...
    trs_p.setProperty("opk_TRIMESTRE",CPLib.ToProperties(p_opk_TRIMESTRE));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "saldi_idp"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "saldi_idp"+"\\"+CPLib.ToCPStr(w_ANNO)+"\\"+CPLib.ToCPStr(w_TRIMESTRE);
  }
  ...
  protected void TrsToWork() {
    ...
    w_TRIMESTRE= m_oTrs.get(m_nCurrentRow).w_TRIMESTRE;
    ...
    opk_TRIMESTRE= m_oTrs.get(m_nCurrentRow).opk_TRIMESTRE;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_TRIMESTRE=w_TRIMESTRE;
    ...
    m_oTrs.get(m_nCurrentRow).opk_TRIMESTRE=opk_TRIMESTRE;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_TRIMESTRE=w_TRIMESTRE;
    ...
    m_oDeletedRows.get(l_nRows).opk_TRIMESTRE=opk_TRIMESTRE;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_TRIMESTRE= m_oDeletedRows.get(l_RowNumberToSet).w_TRIMESTRE;
    ...
    opk_TRIMESTRE= m_oDeletedRows.get(l_RowNumberToSet).opk_TRIMESTRE;
