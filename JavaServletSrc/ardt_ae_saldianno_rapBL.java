...
public class ardt_ae_saldianno_rapBL extends ardt_ae_saldianno_rapWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public double w_ANNO;
    public String w_IDBASE;
    public double w_IMPORTO1;
    public double w_IMPORTO2;
    public double w_IMPORTO3;
    public double w_IMPORTO4;
    public double w_IMPORTO5;
    public String w_FILEANNO;
    public String w_PROG1;
    public double w_IMPORTO6;
  ...
  public static final String i_EntityName = "ardt_ae_saldianno_rap";
  ...
  public CPPhTableWrInfo m_oWrInfo_aeannora;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_aeannora;
  ...
  public static String[] m_EntityTables = {"aeannora"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'TIPRAP':TIPRAP,'m_Detail':{'ANNO':ANNO,'IMPORTO1':IMPORTO1,'IMPORTO2':IMPORTO2,'IMPORTO3':IMPORTO3,'IMPORTO4':IMPORTO4,'IMPORTO5':IMPORTO5,'IMPORTO6':IMPORTO6,'NATURA':NATURA"+FoundlingChildrenList("ardt_ae_saldianno_rap",true,true)+"}"+FoundlingChildrenList("ardt_ae_saldianno_rap",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'TIPRAP':TIPRAP,'m_Detail':{'ANNO':ANNO,'IDBASE':IDBASE,'IMPORTO1':IMPORTO1,'IMPORTO2':IMPORTO2,'IMPORTO3':IMPORTO3,'IMPORTO4':IMPORTO4,'IMPORTO5':IMPORTO5,'FILEANNO':FILEANNO,'PROG1':PROG1,'IMPORTO6':IMPORTO6,'NATURA':NATURA"+FoundlingChildrenList("ardt_ae_saldianno_rap",true,true)+"}"+FoundlingChildrenList("ardt_ae_saldianno_rap",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,TIPRAP,m_Detail[ ANNO IMPORTO1 IMPORTO2 IMPORTO3 IMPORTO4 IMPORTO5 IMPORTO6 NATURA"+FoundlingChildrenList("ardt_ae_saldianno_rap",false,true)+"]"+FoundlingChildrenList("ardt_ae_saldianno_rap",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_ae_saldianno_rap"),new String[][]{new String[]{"RAPPORTO","Rapporto","C","25","0","campo","key1","false","false"},new String[]{"TIPRAP","Tipo Rapporto","C","2","0","campo","nokey","false","false"},new String[]{"ANNO","Anno Riferimento","N","4","0","campo","key1","true","false"},new String[]{"IMPORTO1","Importo 1","N","17","0","campo","nokey","true","false"},new String[]{"IMPORTO2","Importo 2","N","17","0","campo","nokey","true","false"},new String[]{"IMPORTO3","Importo 3","N","17","0","campo","nokey","true","false"},new String[]{"IMPORTO4","Importo 4","N","17","0","campo","nokey","true","false"},new String[]{"IMPORTO5","Importo 5","N","6","0","campo","nokey","true","false"},new String[]{"IMPORTO6","Giacenza Media","N","17","0","campo","nokey","true","false"},new String[]{"NATURA","Natura Valuta","C","2","0","campo","nokey","true","false"}});
  ...
  public ardt_ae_saldianno_rapBL (CPContext p_ContextObject) {
    ...
    m_cPhName_aeannora = p_ContextObject.GetPhName("aeannora",p_ContextObject.GetCompany(),false);
    m_cServer_aeannora = p_ContextObject.GetServer("aeannora");
    m_oWrInfo_aeannora = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"aeannora",p_ContextObject.GetCompany());
    m_cVirtName_aeannora = CPSql.ManipulateTablePhName("aeannora",m_cServer_aeannora);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_saldianno_rap",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Set_IMPORTO1(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IMPORTO1 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_IMPORTO2(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IMPORTO2 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public boolean Set_IMPORTO6(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IMPORTO6 = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getVisible_TIPRAP() {
    return true;
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_ae_saldianno_rap","aeannora",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_IMPORTO1;
      p_IMPORTO1 = CPLib.GetProperties(trs_p.getProperty("IMPORTO1"),new Properties());
      Properties p_IMPORTO2;
      p_IMPORTO2 = CPLib.GetProperties(trs_p.getProperty("IMPORTO2"),new Properties());
      ...
      Properties p_FILEANNO;
      p_FILEANNO = CPLib.GetProperties(trs_p.getProperty("FILEANNO"),new Properties());
      Properties p_PROG1;
      p_PROG1 = CPLib.GetProperties(trs_p.getProperty("PROG1"),new Properties());
      Properties p_IMPORTO6;
      p_IMPORTO6 = CPLib.GetProperties(trs_p.getProperty("IMPORTO6"),new Properties());
      Properties p_NATURA;
      p_NATURA = CPLib.GetProperties(trs_p.getProperty("NATURA"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_IMPORTO1 = 0;
        w_IMPORTO1 = CPLib.GetProperty(p_IMPORTO1,"",w_IMPORTO1,i);
        w_IMPORTO2 = 0;
        w_IMPORTO2 = CPLib.GetProperty(p_IMPORTO2,"",w_IMPORTO2,i);
        w_IMPORTO3 = 0;
        ...
        w_FILEANNO = "";
        w_FILEANNO = CPLib.GetProperty(p_FILEANNO,"",w_FILEANNO,i);
        w_PROG1 = "";
        w_PROG1 = CPLib.GetProperty(p_PROG1,"",w_PROG1,i);
        w_IMPORTO6 = 0;
        w_IMPORTO6 = CPLib.GetProperty(p_IMPORTO6,"",w_IMPORTO6,i);
        w_NATURA = "";
        w_NATURA = CPLib.GetProperty(p_NATURA,"",w_NATURA,i);
        opk_ANNO = CPLib.GetProperty(p_opk_ANNO,"",0,i);
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"IMPORTO1")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"IMPORTO2")) {
      SetUpdatedRow();
      return;
    }
    ...
    if (CPLib.eq(p_cName,"IMPORTO6")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"NATURA")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_ae_saldianno_rap",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_ae_saldianno_rap",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_ae_saldianno_rap",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_saldianno_rap",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_ae_saldianno_rap"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_ae_saldianno_rap\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_IMPORTO1;
    p_IMPORTO1 = new Properties();
    Properties p_IMPORTO2;
    p_IMPORTO2 = new Properties();
    Properties p_IMPORTO3;
    ...
    Properties p_FILEANNO;
    p_FILEANNO = new Properties();
    Properties p_PROG1;
    p_PROG1 = new Properties();
    Properties p_IMPORTO6;
    p_IMPORTO6 = new Properties();
    Properties p_NATURA;
    p_NATURA = new Properties();
    Properties p_opk_ANNO;
    ...
    CPLib.PutProperty(p,"TIPRAP",w_TIPRAP,0);
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_IMPORTO1,"",w_IMPORTO1,trsrow);
      CPLib.PutProperty(p_IMPORTO2,"",w_IMPORTO2,trsrow);
      ...
      CPLib.PutProperty(p_FILEANNO,"",w_FILEANNO,trsrow);
      CPLib.PutProperty(p_PROG1,"",w_PROG1,trsrow);
      CPLib.PutProperty(p_IMPORTO6,"",w_IMPORTO6,trsrow);
      CPLib.PutProperty(p_NATURA,"",w_NATURA,trsrow);
    ...
    trs_p.setProperty("IMPORTO1",CPLib.ToProperties(p_IMPORTO1));
    trs_p.setProperty("IMPORTO2",CPLib.ToProperties(p_IMPORTO2));
    ...
    trs_p.setProperty("FILEANNO",CPLib.ToProperties(p_FILEANNO));
    trs_p.setProperty("PROG1",CPLib.ToProperties(p_PROG1));
    trs_p.setProperty("IMPORTO6",CPLib.ToProperties(p_IMPORTO6));
    trs_p.setProperty("NATURA",CPLib.ToProperties(p_NATURA));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "aeannora"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "aeannora"+"\\"+CPLib.ToCPStr(w_ANNO);
  }
  ...
  protected void TrsToWork() {
    ...
    w_IMPORTO1= m_oTrs.get(m_nCurrentRow).w_IMPORTO1;
    w_IMPORTO2= m_oTrs.get(m_nCurrentRow).w_IMPORTO2;
    ...
    w_FILEANNO= m_oTrs.get(m_nCurrentRow).w_FILEANNO;
    w_PROG1= m_oTrs.get(m_nCurrentRow).w_PROG1;
    w_IMPORTO6= m_oTrs.get(m_nCurrentRow).w_IMPORTO6;
    w_NATURA= m_oTrs.get(m_nCurrentRow).w_NATURA;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_IMPORTO1=w_IMPORTO1;
    m_oTrs.get(m_nCurrentRow).w_IMPORTO2=w_IMPORTO2;
    ...
    m_oTrs.get(m_nCurrentRow).w_FILEANNO=w_FILEANNO;
    m_oTrs.get(m_nCurrentRow).w_PROG1=w_PROG1;
    m_oTrs.get(m_nCurrentRow).w_IMPORTO6=w_IMPORTO6;
    m_oTrs.get(m_nCurrentRow).w_NATURA=w_NATURA;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_IMPORTO1=w_IMPORTO1;
    m_oDeletedRows.get(l_nRows).w_IMPORTO2=w_IMPORTO2;
    ...
    m_oDeletedRows.get(l_nRows).w_FILEANNO=w_FILEANNO;
    m_oDeletedRows.get(l_nRows).w_PROG1=w_PROG1;
    m_oDeletedRows.get(l_nRows).w_IMPORTO6=w_IMPORTO6;
    m_oDeletedRows.get(l_nRows).w_NATURA=w_NATURA;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_IMPORTO1= m_oDeletedRows.get(l_RowNumberToSet).w_IMPORTO1;
    w_IMPORTO2= m_oDeletedRows.get(l_RowNumberToSet).w_IMPORTO2;
    ...
    w_FILEANNO= m_oDeletedRows.get(l_RowNumberToSet).w_FILEANNO;
    w_PROG1= m_oDeletedRows.get(l_RowNumberToSet).w_PROG1;
    w_IMPORTO6= m_oDeletedRows.get(l_RowNumberToSet).w_IMPORTO6;
    w_NATURA= m_oDeletedRows.get(l_RowNumberToSet).w_NATURA;
