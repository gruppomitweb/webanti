...
public class ardt_mlientiopeBL extends ardt_mlientiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_mlientiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_mlientiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_mlientiope;
  ...
  public static String[] m_EntityTables = {"mlientiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'PROQUOTA':PROQUOTA,'IMPSARA':IMPSARA"+FoundlingChildrenList("ardt_mlientiope",true,true)+"}"+FoundlingChildrenList("ardt_mlientiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PROQUOTA':PROQUOTA,'IMPSARA':IMPSARA"+FoundlingChildrenList("ardt_mlientiope",true,true)+"}"+FoundlingChildrenList("ardt_mlientiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG PROQUOTA IMPSARA"+FoundlingChildrenList("ardt_mlientiope",false,true)+"]"+FoundlingChildrenList("ardt_mlientiope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_mlientiope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"PROQUOTA","Pro Quota","N","3","0","campo","nokey","true","false"},new String[]{"IMPSARA","Importo Sara","N","19","2","campo","nokey","true","false"}});
  ...
  public ardt_mlientiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_mlientiope = p_ContextObject.GetPhName("mlientiope",p_ContextObject.GetCompany(),false);
    m_cServer_mlientiope = p_ContextObject.GetServer("mlientiope");
    m_oWrInfo_mlientiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"mlientiope",p_ContextObject.GetCompany());
    m_cVirtName_mlientiope = CPSql.ManipulateTablePhName("mlientiope",m_cServer_mlientiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mlientiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_mlientiope","mlientiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_mlientiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_mlientiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_mlientiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mlientiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_mlientiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_mlientiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "mlientiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "mlientiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
