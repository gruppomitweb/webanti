...
public class ardt_garantboBL extends ardt_garantboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_garantbo";
  ...
  public CPPhTableWrInfo m_oWrInfo_garantbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_garantbo;
  ...
  public static String[] m_EntityTables = {"garantbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'xRagSoc':xRagSoc,'DATAINI':DATAINI,'DATAFINE':DATAFINE"+FoundlingChildrenList("ardt_garantbo",true,true)+"}"+FoundlingChildrenList("ardt_garantbo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'xRagSoc':xRagSoc,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'IDBASE':IDBASE"+FoundlingChildrenList("ardt_garantbo",true,true)+"}"+FoundlingChildrenList("ardt_garantbo",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER xRagSoc DATAINI DATAFINE"+FoundlingChildrenList("ardt_garantbo",false,true)+"]"+FoundlingChildrenList("ardt_garantbo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_garantbo"),new String[][]{new String[]{"RAPPORTO","Rapporto","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","Garantito","C","16","0","campo","key1","true","false"},new String[]{"xRagSoc","Ragione Sociale","C","70","0","variabile","nokey","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"}});
  ...
  public ardt_garantboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_garantbo = p_ContextObject.GetPhName("garantbo",p_ContextObject.GetCompany(),false);
    m_cServer_garantbo = p_ContextObject.GetServer("garantbo");
    m_oWrInfo_garantbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"garantbo",p_ContextObject.GetCompany());
    m_cVirtName_garantbo = CPSql.ManipulateTablePhName("garantbo",m_cServer_garantbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_garantbo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_garantbo","garantbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_garantbo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_garantbo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_garantbo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_garantbo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_garantbo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_garantbo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "garantbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "garantbo"+"\\"+CPLib.ToCPStr(w_CODINTER);
  }
