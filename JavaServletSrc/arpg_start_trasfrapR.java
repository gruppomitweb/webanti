...
// * --- Fine Area Manuale
public class arpg_start_trasfrapR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arpg_start_trasfrapR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arpg_start_trasfrap",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* Cicla sui rapporti e li inserisce sul temporaneo */
      ...
      while ( ! (Cursor_xnarapbo.Eof())) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arpg_start_trasfrap",2,"00000006")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  public static arpg_start_trasfrapR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arpg_start_trasfrapR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
