...
public class ardt_mogopefboBL extends ardt_mogopefboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_mogopefbo";
  ...
  public CPPhTableWrInfo m_oWrInfo_mogopefbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_mogopefbo;
  ...
  public static String[] m_EntityTables = {"mogopefbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_mogopefbo",true,true)+"}"+FoundlingChildrenList("ardt_mogopefbo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescriz':xdescriz"+FoundlingChildrenList("ardt_mogopefbo",true,true)+"}"+FoundlingChildrenList("ardt_mogopefbo",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_mogopefbo",false,true)+"]"+FoundlingChildrenList("ardt_mogopefbo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_mogopefbo"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_mogopefboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_mogopefbo = p_ContextObject.GetPhName("mogopefbo",p_ContextObject.GetCompany(),false);
    m_cServer_mogopefbo = p_ContextObject.GetServer("mogopefbo");
    m_oWrInfo_mogopefbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"mogopefbo",p_ContextObject.GetCompany());
    m_cVirtName_mogopefbo = CPSql.ManipulateTablePhName("mogopefbo",m_cServer_mogopefbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mogopefbo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_mogopefbo","mogopefbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_mogopefbo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_mogopefbo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_mogopefbo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mogopefbo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_mogopefbo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_mogopefbo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "mogopefbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "mogopefbo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
