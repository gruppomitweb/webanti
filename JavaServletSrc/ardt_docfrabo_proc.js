...
m_oFather.i_last_focused_item='child_ardt_docfrabo';
...
function Help() {
windowOpenForeground('../doc/ardt_docfrabo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'docfrabo'+'\\'+CPLib.ToCPStr(w_NUMPROG);
}
...
p_d.setValue('ardt_docfrabo',m_cSelectedPage);
