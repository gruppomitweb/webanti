...
// * --- Fine Area Manuale
public class arpg_importBO extends arpg_importBL {
  ...
  public arpg_importBO (CPContext p_ContextObject) {
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arrt_import,azzera_messaggi,
  public static final String i_InvokedRoutines = ",arrt_import,azzera_messaggi,";
}
