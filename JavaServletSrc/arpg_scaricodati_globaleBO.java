...
// * --- Fine Area Manuale
public class arpg_scaricodati_globaleBO extends arpg_scaricodati_globaleBL {
  ...
  public arpg_scaricodati_globaleBO (CPContext p_ContextObject) {
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_filesage,
  public static final String i_InvokedRoutines = ",arfn_filesage,";
}
