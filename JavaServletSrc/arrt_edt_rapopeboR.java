...
// * --- Fine Area Manuale
public class arrt_edt_rapopeboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_edt_rapopeboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_edt_rapopebo",m_Caller);
    Blank();
  }
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("gStatus",p_cVarName)) {
      return gStatus;
    }
    return "";
  }
  ...
  void Page_1() throws Exception {
    ...
    /* gStatus Char(4) // Stato Operazione */
    /* lancio e vediamo */
    /* gDataVaria := w_datavaria // Data Variazione */
    gDataVaria = w_datavaria;
    m_Ctx.SetGlobalDate("gDataVaria",gDataVaria);
    /* gStatus := 'edit' // Stato Operazione */
    gStatus = "edit";
    m_Ctx.SetGlobalString("gStatus",gStatus);
    /* Return  */
    Forward f;
    f=new Forward("armt_informazioni",false,this,Forward.EditStatus,false);
    f.SetParameter("IDBASE",w_IDBASE);
  ...
  public static arrt_edt_rapopeboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_edt_rapopeboR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    gStatus=m_Ctx.GetGlobalString("gStatus");
  }
