...
public class arpg_operazrappoprvBL extends arpg_operazrappoprvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_operazrappoprv";
  ...
  public arpg_operazrappoprvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_operazrappoprv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
