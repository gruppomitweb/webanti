...
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_ope_modopen2']));
SendData('start','arrt_ope_modopen2'+'',HParApplet().asString());
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_ope_modopen2_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_ope_modopen2',m_cSelectedPage);
