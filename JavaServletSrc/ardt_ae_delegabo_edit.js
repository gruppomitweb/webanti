...
if (IsDisabledByStateDriver('Progressivi')) {
...
w_xRagSoc=( ! (Empty(LRTrim(w_descdele)))?w_descdele:( ! (Empty(w_CODINTER))?'Soggetto non presente in anagrafica':''));
...
function Calculation_QTTFUVPIQX() {
...
w_descdele=l_Appl.GetStringValue('RAGSOC',70,0);
...
if ( ! (m_oFather.SaveContext_ardt_ae_delegabo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_ae_delegabo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_ae_delegabo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (( ! (_ChkObl('CROCGCIGKF',1))) && FullRow()) {
_SignErr('CROCGCIGKF');
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_ae_delegabo();
}
}
SaveContext.child=[];
function BlankRow() {
...
l_aRepeatedFields.TIPORAP={"dec":0,"fixedpos":true,"id":"ELDZLJSOEH","len":1,"name":"TIPORAP","title":"Tipo Rapporto","type":"C"};
l_aRepeatedFields.TIPOPERS={"dec":0,"fixedpos":true,"id":"MNRSAHBCHQ","len":1,"name":"TIPOPERS","title":"Tipo Persona","type":"C"};
l_aRepeatedFields.STATOREG={"dec":0,"fixedpos":true,"id":"IAQJZGLOAD","len":1,"name":"STATOREG","title":"Stato Registrazione","type":"C"};
l_aRepeatedFields.OPERAZMOD={"dec":0,"fixedpos":true,"id":"DROURUHVGG","len":20,"name":"OPERAZMOD","title":"","type":"C"};
l_aRepeatedFields.DATARETT={"dec":0,"fixedpos":true,"id":"FATTRZDAAG","len":8,"name":"DATARETT","title":"Data Rettifica","type":"D"};
l_aRepeatedFields.IDEREG={"dec":0,"fixedpos":true,"id":"GLDZYZXXYY","len":20,"name":"IDEREG","title":"Identificativo Registrazione","type":"C"};
l_aRepeatedFields.COLLEGAMEN={"dec":0,"fixedpos":true,"id":"XWAEDZCMQI","len":20,"name":"COLLEGAMEN","title":"Collegamento","type":"C"};
l_aRepeatedFields.DATAFINE={"dec":0,"fixedpos":false,"id":"JCFUNSQXBI","len":8,"name":"DATAFINE","title":"Data Fine","type":"D"};
l_aRepeatedFields.IDBASE={"dec":0,"fixedpos":true,"id":"QCJOLDTFZW","len":10,"name":"IDBASE","title":"IDBASE","type":"C"};
l_aRepeatedFields.UCODE={"dec":0,"fixedpos":true,"id":"GHQWSBFMLC","len":7,"name":"UCODE","title":"","type":"C"};
...
l_aRepeatedFields.descdele={"dec":0,"fixedpos":true,"id":"BTOQMIAVXE","len":70,"name":"descdele","title":"Ragione Sociale","type":"C"};
