...
public class aosdt_ano_rilBL extends aosdt_ano_rilWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "aosdt_ano_ril";
  ...
  public CPPhTableWrInfo m_oWrInfo_ano_ril;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_ano_ril;
  ...
  public static String[] m_EntityTables = {"ano_ril"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDMOD':IDMOD,'ROWRIL':ROWRIL,'m_Detail':{'IDIND':IDIND,'IDSUBIND':IDSUBIND,'NOTA':NOTA"+FoundlingChildrenList("aosdt_ano_ril",true,true)+"}"+FoundlingChildrenList("aosdt_ano_ril",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDMOD':IDMOD,'ROWRIL':ROWRIL,'m_Detail':{'IDIND':IDIND,'IDSUBIND':IDSUBIND,'NOTA':NOTA,'PROGIND':PROGIND,'DESCRI_IND':DESCRI_IND,'PROGSUBIND':PROGSUBIND,'DESCRI_SUBIND':DESCRI_SUBIND"+FoundlingChildrenList("aosdt_ano_ril",true,true)+"}"+FoundlingChildrenList("aosdt_ano_ril",true,false)+"}";
  public static final String i_ItemSequence = "IDMOD,ROWRIL,m_Detail[ IDIND IDSUBIND NOTA"+FoundlingChildrenList("aosdt_ano_ril",false,true)+"]"+FoundlingChildrenList("aosdt_ano_ril",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("aosdt_ano_ril"),new String[][]{new String[]{"IDMOD","ID del modello","C","10","0","campo","key1","false","false"},new String[]{"ROWRIL","Progressivo rilevazione","N","4","0","campo","key1","false","false"},new String[]{"IDIND","ID del indicatore","C","10","0","campo","key1","true","false"},new String[]{"IDSUBIND","ID del subindicatore ","C","10","0","campo","key1","true","false"},new String[]{"NOTA","Nota della rilevazione","M","10","0","campo","nokey","true","false"}});
  ...
  public aosdt_ano_rilBL (CPContext p_ContextObject) {
    ...
    m_cPhName_ano_ril = p_ContextObject.GetPhName("ano_ril",p_ContextObject.GetCompany(),false);
    m_cServer_ano_ril = p_ContextObject.GetServer("ano_ril");
    m_oWrInfo_ano_ril = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"ano_ril",p_ContextObject.GetCompany());
    m_cVirtName_ano_ril = CPSql.ManipulateTablePhName("ano_ril",m_cServer_ano_ril);
    ...
    m_MNTs = CPLib.MNTChilds("aosdt_ano_ril",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean getVisible_ROWRIL() {
    return true;
  }
  ...
  public final static String[] m_KeyColumns = {"IDMOD","ROWRIL"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("aosdt_ano_ril","ano_ril",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.value",zeroSplit.split("ind_def\u0000false\u0000false\u00003\u00000\u0000\u0000false\u0000false\u0000Selezione Indicatore\u0000\u0000\u0000false",-1));
    ...
    map.put("property.value",zeroSplit.split("sub_ind_def\u0000false\u0000false\u00003\u00000\u0000\u0000false\u0000false\u0000Selezione Subindicatore\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
  }
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("aosdt_ano_ril",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("aosdt_ano_ril",child);
    ...
    for(String child : CPLib.LoadableMNTs("aosdt_ano_ril",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("aosdt_ano_ril",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"aosdt_ano_ril"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"aosdt_ano_ril\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "ano_ril"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDMOD","C",10,0))+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("ROWRIL","N",4,0));
  }
  public String RowPrimaryKey() {
    return "ano_ril"+"\\"+CPLib.ToCPStr(w_IDIND)+"\\"+CPLib.ToCPStr(w_IDSUBIND);
  }
  ...
  boolean CanSaveConditionallyRow(boolean p_bSaveWork) {
    ...
    if (CPLib.ge(m_nCurrentRow,Rows())) {
      ...
      m_cLastMsgError = m_Ctx.Translate("Indicatore di annomalia non corretto");
      l_bResult = false;
    } else {
