...
if(c=Ctrl('NPNISIVXKK')) ChkboxCheckUncheck(c,'0',w_attiva)
if(c=Ctrl('NPNISIVXKK')) ChkboxValueAssign(c,'0','9','C',1,0,'')
if(c=Ctrl('RFAMRJFBMI')) ChkboxCheckUncheck(c,'1',w_mod_attiva)
if(c=Ctrl('RFAMRJFBMI')) ChkboxValueAssign(c,'1','9','C',1,0,'')
if(c=Ctrl('DMFWCILZEL')) ChkboxCheckUncheck(c,'2',w_cancellata)
if(c=Ctrl('DMFWCILZEL')) ChkboxValueAssign(c,'2','9','C',1,0,'')
if(c=Ctrl('FNXXQDPJEK')) ChkboxCheckUncheck(c,'3',w_mod_copia)
if(c=Ctrl('FNXXQDPJEK')) ChkboxValueAssign(c,'3','9','C',1,0,'')
...
if(c=Ctrl('RGLTWKIWPY')) c.value = WtH(w_DaSogg,'C',16,0,'')
var tmp_DPLASECNGE = ToHTag(AsControlValue(w_xDaRag));
if (Ne(e_DPLASECNGE,tmp_DPLASECNGE)) {
if(c=Ctrl('DPLASECNGE')) c.innerHTML=tmp_DPLASECNGE;
e_DPLASECNGE=tmp_DPLASECNGE;
}
if(c=Ctrl('USKGWKJFWW')) c.value = WtH(w_ASogg,'C',16,0,'')
var tmp_XADEIGCIYD = ToHTag(AsControlValue(w_xARag));
if (Ne(e_XADEIGCIYD,tmp_XADEIGCIYD)) {
if(c=Ctrl('XADEIGCIYD')) c.innerHTML=tmp_XADEIGCIYD;
e_XADEIGCIYD=tmp_XADEIGCIYD;
}
...
var h;
SetDisplay(Ctrl('XURLGQZZMU'),Eq(w_detana,'S'));
SetDisplay('HOUDAUAIJN_3_container',Ne(w_detana,'S'));
SetDisplay('HOUDAUAIJN_4_container',Ne(w_detana,'S'));
SetDisplay(Ctrl('LMSVTJSWTT'),Eq(w_detana,'N'));
SetDisplay('ULDTTBEWIQ_DIV',Eq(w_detana,'N'));
SetDisplay('JVAYGFIMTX_DIV',Eq(w_detana,'N'));
HideUI();
}
HideUI.lblids["AData"]=['WICQRPVOOM'];
HideUI.lblids["ASogg"]=['XWICOJPCNN'];
HideUI.lblids["DaData"]=['NGVOZRVMWR'];
HideUI.lblids["DaSogg"]=['NJZHHGRCUF'];
...
l_oWv.setValue('w_attiva',AsAppletValue(w_attiva));
l_oWv.setValue('w_c_adata',AsAppletValue(w_c_adata));
l_oWv.setValue('w_c_dadata',AsAppletValue(w_c_dadata));
l_oWv.setValue('w_cancellata',AsAppletValue(w_cancellata));
...
l_oWv.setValue('w_mod_attiva',AsAppletValue(w_mod_attiva));
l_oWv.setValue('w_mod_copia',AsAppletValue(w_mod_copia));
l_oWv.setValue('w_tipo',AsAppletValue(w_tipo));
l_oWv.setValue('w_DaSogg',AsAppletValue(w_DaSogg));
l_oWv.setValue('w_ASogg',AsAppletValue(w_ASogg));
l_oWv.setValue('m_cParameterSequence',AsAppletValue('pTipo,w_AData,w_aRappo,w_attiva,w_c_adata,w_c_dadata,w_cancellata,w_DaData,w_daRappo,w_detana,w_detope,w_flgdel,w_flgtit,w_mod_attiva,w_mod_copia,w_tipo,w_DaSogg,w_ASogg'));
SetLocationHref(null,'arrt_stprappo'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
function NPNISIVXKK_Valid(e) {
e=(Ne(e,null)?e:window.event);
return Set_attiva(ChkboxValueAssign(Ctrl('NPNISIVXKK'),'0','9','C',1,0,''),null,e);
}
function NPNISIVXKK_OnFocus(e) {
SetActiveField(Ctrl('NPNISIVXKK'),true);
}
function NPNISIVXKK_OnBlur(e) {
SetActiveField(Ctrl('NPNISIVXKK'),false);
}
function RFAMRJFBMI_Valid(e) {
e=(Ne(e,null)?e:window.event);
return Set_mod_attiva(ChkboxValueAssign(Ctrl('RFAMRJFBMI'),'1','9','C',1,0,''),null,e);
}
function RFAMRJFBMI_OnFocus(e) {
SetActiveField(Ctrl('RFAMRJFBMI'),true);
}
function RFAMRJFBMI_OnBlur(e) {
SetActiveField(Ctrl('RFAMRJFBMI'),false);
}
function DMFWCILZEL_Valid(e) {
e=(Ne(e,null)?e:window.event);
return Set_cancellata(ChkboxValueAssign(Ctrl('DMFWCILZEL'),'2','9','C',1,0,''),null,e);
}
function DMFWCILZEL_OnFocus(e) {
SetActiveField(Ctrl('DMFWCILZEL'),true);
}
function DMFWCILZEL_OnBlur(e) {
SetActiveField(Ctrl('DMFWCILZEL'),false);
}
function FNXXQDPJEK_Valid(e) {
e=(Ne(e,null)?e:window.event);
return Set_mod_copia(ChkboxValueAssign(Ctrl('FNXXQDPJEK'),'3','9','C',1,0,''),null,e);
}
function FNXXQDPJEK_OnFocus(e) {
SetActiveField(Ctrl('FNXXQDPJEK'),true);
}
function FNXXQDPJEK_OnBlur(e) {
SetActiveField(Ctrl('FNXXQDPJEK'),false);
}
...
function RGLTWKIWPY_Valid(e) {
SetActiveField(Ctrl('RGLTWKIWPY'),false);
e=(Ne(e,null)?e:window.event);
return Set_DaSogg(HtW(Ctrl('RGLTWKIWPY').value,'C'),null,e);
}
function RGLTWKIWPY_OnFocus(e) {
if (Ne(m_cFunction,'query') &&  ! (CheckZone('RGLTWKIWPY'))) {
DisplayErrorMessage();
}
SetActiveField(Ctrl('RGLTWKIWPY'),true);
SetLastFocusedOnParent();
SPSelectCtrl(Ctrl('RGLTWKIWPY'),e);
}
function RGLTWKIWPY_ZOOM_Click() {
if (Ne(typeof(link_url),'undefined')) {
layerOpenForeground(link_url(link_index('RGLTWKIWPY')),'linkview_RGLTWKIWPY','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes',null,null,null,null,null,null,'-d-g');
}
}
function USKGWKJFWW_Valid(e) {
SetActiveField(Ctrl('USKGWKJFWW'),false);
e=(Ne(e,null)?e:window.event);
return Set_ASogg(HtW(Ctrl('USKGWKJFWW').value,'C'),null,e);
}
function USKGWKJFWW_OnFocus(e) {
if (Ne(m_cFunction,'query') &&  ! (CheckZone('USKGWKJFWW'))) {
DisplayErrorMessage();
}
if ( ! (GetDisabled('USKGWKJFWW'))) {
if (Eq(w_ASogg,'') && Eq(_tracker.ctrl,null)) {
Ctrl('USKGWKJFWW').value=WtH(w_DaSogg,'C',16,0,'');
} else {
}
}
SetActiveField(Ctrl('USKGWKJFWW'),true);
SetLastFocusedOnParent();
SPSelectCtrl(Ctrl('USKGWKJFWW'),e);
}
function USKGWKJFWW_ZOOM_Click() {
if (Ne(typeof(link_url),'undefined')) {
layerOpenForeground(link_url(link_index('USKGWKJFWW')),'linkview_USKGWKJFWW','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes',null,null,null,null,null,null,'-d-g');
}
}
_ResetTracker();
...
if(c=Ctrl('NPNISIVXKK')) c.onclick=NPNISIVXKK_Valid;
if(c=Ctrl('NPNISIVXKK')) c.onfocus=NPNISIVXKK_OnFocus;
if(c=Ctrl('NPNISIVXKK')) c.onblur=NPNISIVXKK_OnBlur;
if(c=Ctrl('RFAMRJFBMI')) c.onclick=RFAMRJFBMI_Valid;
if(c=Ctrl('RFAMRJFBMI')) c.onfocus=RFAMRJFBMI_OnFocus;
if(c=Ctrl('RFAMRJFBMI')) c.onblur=RFAMRJFBMI_OnBlur;
if(c=Ctrl('DMFWCILZEL')) c.onclick=DMFWCILZEL_Valid;
if(c=Ctrl('DMFWCILZEL')) c.onfocus=DMFWCILZEL_OnFocus;
if(c=Ctrl('DMFWCILZEL')) c.onblur=DMFWCILZEL_OnBlur;
if(c=Ctrl('FNXXQDPJEK')) c.onclick=FNXXQDPJEK_Valid;
if(c=Ctrl('FNXXQDPJEK')) c.onfocus=FNXXQDPJEK_OnFocus;
if(c=Ctrl('FNXXQDPJEK')) c.onblur=FNXXQDPJEK_OnBlur;
c=Ctrl('HOUDAUAIJN');
if ( ! (Empty(c))) {
c[0].onclick=HOUDAUAIJN_Valid;
c[1].onclick=HOUDAUAIJN_Valid;
c[2].onclick=HOUDAUAIJN_Valid;
c[3].onclick=HOUDAUAIJN_Valid;
c[4].onclick=HOUDAUAIJN_Valid;
}
...
if(c=Ctrl('RGLTWKIWPY')) c.onblur=RGLTWKIWPY_Valid;
if(c=Ctrl('RGLTWKIWPY')) c.onfocus=RGLTWKIWPY_OnFocus;
if(c=Ctrl('USKGWKJFWW')) c.onblur=USKGWKJFWW_Valid;
if(c=Ctrl('USKGWKJFWW')) c.onfocus=USKGWKJFWW_OnFocus;
}
}
function NotifyEvent(p_cEvent) {
var old_c;
if (Ne(typeof(w_Messaggi),'undefined')) {
w_Messaggi.raiseEvent('arpg_stprappo_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stprappo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stprappo',m_cSelectedPage);
...
function Set_mod_attiva(ctrlValue,kmode,e) {
if (Ne(w_mod_attiva,ctrlValue)) {
var ctl = _GetCtl(e,'RFAMRJFBMI');
if (_tracker.goon(ctl,ctrlValue)) {
w_mod_attiva=ctrlValue;
SetModified(false);
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('RFAMRJFBMI',0);
DoUpdate(l_bResult);
} else {
ctl.value=WtH('9','C',1,0,'');
_ResetTracker();
return true;
}
}
...
function Set_mod_copia(ctrlValue,kmode,e) {
if (Ne(w_mod_copia,ctrlValue)) {
var ctl = _GetCtl(e,'FNXXQDPJEK');
if (_tracker.goon(ctl,ctrlValue)) {
w_mod_copia=ctrlValue;
SetModified(false);
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('FNXXQDPJEK',0);
DoUpdate(l_bResult);
} else {
ctl.value=WtH('9','C',1,0,'');
_ResetTracker();
...
function Set_attiva(ctrlValue,kmode,e) {
if (Ne(w_attiva,ctrlValue)) {
var ctl = _GetCtl(e,'NPNISIVXKK');
if (_tracker.goon(ctl,ctrlValue)) {
w_attiva=ctrlValue;
SetModified(false);
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('NPNISIVXKK',0);
DoUpdate(l_bResult);
} else {
ctl.value=WtH('9','C',1,0,'');
_ResetTracker();
...
function Set_DaSogg(ctrlValue,kmode,e) {
if (Ne(w_DaSogg,ctrlValue)) {
var ctl = _GetCtl(e,'RGLTWKIWPY');
if (_tracker.goon(ctl,ctrlValue)) {
w_DaSogg=ctrlValue;
SetModified(false);
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('RGLTWKIWPY',0);
if (l_bResult) {
l_bResult=Link_RGLTWKIWPY(kmode);
if ( ! (l_bResult)) {
w_DaSogg=HtW('','C');
}
}
...
function Set_cancellata(ctrlValue,kmode,e) {
if (Ne(w_cancellata,ctrlValue)) {
var ctl = _GetCtl(e,'DMFWCILZEL');
if (_tracker.goon(ctl,ctrlValue)) {
w_cancellata=ctrlValue;
SetModified(false);
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('DMFWCILZEL',0);
DoUpdate(l_bResult);
} else {
ctl.value=WtH('9','C',1,0,'');
_ResetTracker();
...
function Set_ASogg(ctrlValue,kmode,e) {
if (Ne(w_ASogg,ctrlValue)) {
var ctl = _GetCtl(e,'USKGWKJFWW');
if (_tracker.goon(ctl,ctrlValue)) {
w_ASogg=ctrlValue;
SetModified(false);
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('USKGWKJFWW',0);
if (l_bResult) {
l_bResult=Link_USKGWKJFWW(kmode);
if ( ! (l_bResult)) {
w_ASogg=HtW('','C');
}
}
...
function Link_RGLTWKIWPY(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_DaSogg);
var l_Appl = LinkApplet();
l_Appl.SetStringKey('CONNES',w_DaSogg,16,0);
l_Appl.SetFields('CONNES,RAGSOC');
l_Appl.SetTypes('C,C');
l_Appl.LinkTable('personbo');
l_Appl.SetID('RGLTWKIWPY');
l_nRec=l_Appl.DoLink((Eq(kmode,null)?2:kmode));
l_bResult=Ne(l_nRec,0);
if (Eq(l_nRec,1)) {
w_DaSogg=l_Appl.GetStringValue('CONNES',16,0);
w_xDaRag=l_Appl.GetStringValue('RAGSOC',70,0);
} else {
Link_RGLTWKIWPY_Blank();
}
if (Eq(l_nRec,2)) {
var openername = 'linkview_RGLTWKIWPY';
var l_cFieldFilter = l_Appl.GetWhereFieldExprUnencoded();
var l_cFixedFilter = l_Appl.GetWhereFixedExprUnencoded();
var l_cAndOpForField = '';
if ( ! (Empty(l_cFieldFilter))) {
...
function Link_RGLTWKIWPY_Blank() {
w_DaSogg='';
w_xDaRag='';
}
function LOpt_RGLTWKIWPY() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('personbo','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CONNES','C'));
l_oWv.setValue('LinkedField',WtA('CONNES','C'));
l_oWv.setValue('UID',WtA('RGLTWKIWPY','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['RGLTWKIWPY'][1],'C'));
l_oWv.setValue('Caption',WtA(Translate('195812931'),'C'));
return l_oWv;
}
function Link_USKGWKJFWW(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_ASogg);
var l_Appl = LinkApplet();
l_Appl.SetStringKey('CONNES',w_ASogg,16,0);
l_Appl.SetFields('CONNES,RAGSOC');
l_Appl.SetTypes('C,C');
l_Appl.LinkTable('personbo');
l_Appl.SetID('USKGWKJFWW');
l_nRec=l_Appl.DoLink((Eq(kmode,null)?2:kmode));
l_bResult=Ne(l_nRec,0);
if (Eq(l_nRec,1)) {
w_ASogg=l_Appl.GetStringValue('CONNES',16,0);
w_xARag=l_Appl.GetStringValue('RAGSOC',70,0);
} else {
Link_USKGWKJFWW_Blank();
}
if (Eq(l_nRec,2)) {
var openername = 'linkview_USKGWKJFWW';
var l_cFieldFilter = l_Appl.GetWhereFieldExprUnencoded();
var l_cFixedFilter = l_Appl.GetWhereFixedExprUnencoded();
var l_cAndOpForField = '';
if ( ! (Empty(l_cFieldFilter))) {
...
function Link_USKGWKJFWW_Blank() {
w_ASogg='';
w_xARag='';
}
function LOpt_USKGWKJFWW() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('personbo','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CONNES','C'));
l_oWv.setValue('LinkedField',WtA('CONNES','C'));
l_oWv.setValue('UID',WtA('USKGWKJFWW','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['USKGWKJFWW'][1],'C'));
l_oWv.setValue('Caption',WtA(Translate('195812931'),'C'));
return l_oWv;
}
...
if (Eq(varName,'RGLTWKIWPY')) {
last_focused_comp=GetLastFocusedElementOfLink('RGLTWKIWPY');
function SetMethod_RGLTWKIWPY() {
Set_DaSogg(HtW(value,'C'),0);
}
if (IsDeviceMobile()) {
SetMethod_RGLTWKIWPY();
} else {
setTimeout(SetMethod_RGLTWKIWPY,1);
}
bResult=true;
}
if (Eq(varName,'USKGWKJFWW')) {
last_focused_comp=GetLastFocusedElementOfLink('USKGWKJFWW');
function SetMethod_USKGWKJFWW() {
Set_ASogg(HtW(value,'C'),0);
}
if (IsDeviceMobile()) {
SetMethod_USKGWKJFWW();
} else {
setTimeout(SetMethod_USKGWKJFWW,1);
}
bResult=true;
}
return bResult;
...
if (Eq(varName,'RGLTWKIWPY')) {
return [Ctrl('RGLTWKIWPY')];
}
if (Eq(varName,'USKGWKJFWW')) {
return [Ctrl('USKGWKJFWW')];
}
}
...
l_bResult=false;
w_detope='N';
} else if ( ! (_ChkObl('NPNISIVXKK',1))) {
_SignErr('NPNISIVXKK');
m_cLastWorkVarErrorMsg='attiva';
l_bResult=false;
w_attiva='9';
} else if ( ! (_ChkObl('RFAMRJFBMI',1))) {
_SignErr('RFAMRJFBMI');
m_cLastWorkVarErrorMsg='mod_attiva';
l_bResult=false;
w_mod_attiva='9';
} else if ( ! (_ChkObl('DMFWCILZEL',1))) {
_SignErr('DMFWCILZEL');
m_cLastWorkVarErrorMsg='cancellata';
l_bResult=false;
w_cancellata='9';
} else if ( ! (_ChkObl('FNXXQDPJEK',1))) {
_SignErr('FNXXQDPJEK');
m_cLastWorkVarErrorMsg='mod_copia';
l_bResult=false;
w_mod_copia='9';
...
l_bResult=false;
w_flgdel='N';
} else if ( ! (_ChkObl('RGLTWKIWPY',1))) {
_SignErr('RGLTWKIWPY');
m_cLastWorkVarErrorMsg='11109078776';
l_bResult=false;
w_DaSogg=HtW('','C');
} else if ( ! (_ChkObl('USKGWKJFWW',1))) {
_SignErr('USKGWKJFWW');
m_cLastWorkVarErrorMsg='11109078776';
l_bResult=false;
w_ASogg=HtW('','C');
...
if (Eq('RGLTWKIWPY_ZOOM',lc)) {
return 3;
}
if (Eq('RGLTWKIWPY',lc)) {
return 3;
}
if (Eq('USKGWKJFWW_ZOOM',lc)) {
return 4;
}
if (Eq('USKGWKJFWW',lc)) {
return 4;
...
l_oWv.setValue('attiva',WtA(w_attiva,'C'));
l_oWv.setValue('mod_attiva',WtA(w_mod_attiva,'C'));
l_oWv.setValue('cancellata',WtA(w_cancellata,'C'));
l_oWv.setValue('mod_copia',WtA(w_mod_copia,'C'));
...
l_oWv.setValue('DaSogg',WtA(w_DaSogg,'C'));
l_oWv.setValue('xDaRag',WtA(w_xDaRag,'C'));
l_oWv.setValue('ASogg',WtA(w_ASogg,'C'));
l_oWv.setValue('xARag',WtA(w_xARag,'C'));
_FillChildren(l_oWv);
}
_FillChildren.n=[];
FillWv.n=["daRappo","aRappo","DaData","AData","coddip","desrap1","desrap2","detope","c_dadata","c_adata","attiva","mod_attiva","cancellata","mod_copia","tipo","detana","flgtit","flgdel","desdip","DaSogg","xDaRag","ASogg","xARag"];
...
if (Eq(w_attiva,'0') && Ne(opener.w_attiva,null)) {
TransferBetweenWindows(opener,'w_attiva',null,'Set_attiva');
}
if (Eq(w_mod_attiva,'1') && Ne(opener.w_mod_attiva,null)) {
TransferBetweenWindows(opener,'w_mod_attiva',null,'Set_mod_attiva');
}
if (Eq(w_cancellata,'2') && Ne(opener.w_cancellata,null)) {
TransferBetweenWindows(opener,'w_cancellata',null,'Set_cancellata');
}
if (Eq(w_mod_copia,'3') && Ne(opener.w_mod_copia,null)) {
TransferBetweenWindows(opener,'w_mod_copia',null,'Set_mod_copia');
}
...
w_c_dadata=(Empty(w_DaData)?'':DateToChar(w_DaData));
w_c_adata=(Empty(w_AData)?'':DateToChar(w_AData));
if (start && Eq(At(',attiva,',pseq),0)) {
w_attiva='0';
}
if (start && Eq(At(',mod_attiva,',pseq),0)) {
w_mod_attiva='1';
}
if (start && Eq(At(',cancellata,',pseq),0)) {
w_cancellata='2';
}
if (start && Eq(At(',mod_copia,',pseq),0)) {
w_mod_copia='3';
}
...
Link_RGLTWKIWPY(null);
Link_USKGWKJFWW(null);
m_bCalculating=false;
SaveDependsOn();
SetControlsValue();
EnableControlsUnderCondition();
...
_Obli('mod_attiva',0,'RFAMRJFBMI',false)
_Obli('tipo',0,'HOUDAUAIJN',false)
_Obli('detope',0,'KRWIPWBLIZ',false)
_Obli('detana',0,'BGSKTJIZGQ',false)
_Obli('mod_copia',0,'FNXXQDPJEK',false)
_Obli('attiva',0,'NPNISIVXKK',false)
_Obli('DaSogg',0,'RGLTWKIWPY',false,"11109078776")
_Obli('cancellata',0,'DMFWCILZEL',false)
_Obli('ASogg',0,'USKGWKJFWW',false,"11109078776")
