...
m_oFather.DoQueryFromChild('cgo_operazioni_dl_multi',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
function DoQueryFrom_cgo_operazioni_dl_multi_dt(firstAlias) {
...
_chNotF(childAlias,'master','armt_cgo_oper_multi');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('cgo_operazioni_dl_multi',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
