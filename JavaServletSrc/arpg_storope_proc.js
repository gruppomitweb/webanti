...
SetLocationHref(null,'arrt_storoper'+'?m_cAction=start&m_cAtExit=close&m_cMode=hyperlink','elaborazione')
}
...
w_Messaggi.raiseEvent('arpg_storope_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_storope_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_storope_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_storope',m_cSelectedPage);
