...
public class arpg_filesageBL extends arpg_filesageWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public java.sql.Date c_datafile;
    public String c_nomefile;
    public String c_descfile;
    public String c_mese;
    public double c_anno;
  ...
  public static final String i_EntityName = "arpg_filesage";
  ...
  public static final String i_CompleteStateStructure = "{'gUrlApp':gUrlApp,'gAzienda':gAzienda}";
  ...
  public arpg_filesageBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_filesage","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_datafile=c_datafile;
    m_oTrs.get(m_nCurrentRow).c_nomefile=c_nomefile;
    m_oTrs.get(m_nCurrentRow).c_descfile=c_descfile;
    m_oTrs.get(m_nCurrentRow).c_mese=c_mese;
    m_oTrs.get(m_nCurrentRow).c_anno=c_anno;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_datafile= m_oTrs.get(m_nCurrentRow).c_datafile;
    c_nomefile= m_oTrs.get(m_nCurrentRow).c_nomefile;
    c_descfile= m_oTrs.get(m_nCurrentRow).c_descfile;
    c_mese= m_oTrs.get(m_nCurrentRow).c_mese;
    c_anno= m_oTrs.get(m_nCurrentRow).c_anno;
