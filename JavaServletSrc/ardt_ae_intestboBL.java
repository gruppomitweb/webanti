...
public class ardt_ae_intestboBL extends ardt_ae_intestboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_ae_intestbo";
  ...
  public CPPhTableWrInfo m_oWrInfo_jntestbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_jntestbo;
  ...
  public static String[] m_EntityTables = {"jntestbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'TIPORAP':TIPORAP"+FoundlingChildrenList("ardt_ae_intestbo",true,true)+"}"+FoundlingChildrenList("ardt_ae_intestbo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDBASE':IDBASE,'tipreg':tipreg,'appoggio':appoggio,'RAPPORTO':RAPPORTO,'gAzienda':gAzienda,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'TIPOPERS':TIPOPERS,'xragsoci':xragsoci,'tiporegr':tiporegr,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PRGIMPSOG':PRGIMPSOG,'STATOREG':STATOREG,'IDEREG':IDEREG,'TIPORAP':TIPORAP,'NUMPROG2':NUMPROG2,'NUMPROG1':NUMPROG1"+FoundlingChildrenList("ardt_ae_intestbo",true,true)+"}"+FoundlingChildrenList("ardt_ae_intestbo",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER DATAINI DATAFINE TIPORAP"+FoundlingChildrenList("ardt_ae_intestbo",false,true)+"]"+FoundlingChildrenList("ardt_ae_intestbo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_ae_intestbo"),new String[][]{new String[]{"RAPPORTO","Rapporto (Copia della testata)","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","Intestatario (Non Intermediario)","C","16","0","campo","key2","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","true"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","true"},new String[]{"TIPORAP","Tipo Rapporto","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_ae_intestboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_jntestbo = p_ContextObject.GetPhName("jntestbo",p_ContextObject.GetCompany(),false);
    m_cServer_jntestbo = p_ContextObject.GetServer("jntestbo");
    m_oWrInfo_jntestbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"jntestbo",p_ContextObject.GetCompany());
    m_cVirtName_jntestbo = CPSql.ManipulateTablePhName("jntestbo",m_cServer_jntestbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_intestbo",p_ContextObject);
  }
  public void Blank() {
    ...
    w_NUMPROG1 = "";
    w_NUMPROG1 = ( ! (CPLib.Empty(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"))) && CPLib.ne(CPLib.At(Utilities.Make(m_Ctx).GetCallerString("TIPOOPRAP"),"|21|22|23|24|27|33|34|35|43|44|45"),0) && CPLib.Empty(w_NUMPROG1)?Utilities.Make(m_Ctx).GetCallerString("NUMPROG"):w_NUMPROG1);
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_ae_intestbo","jntestbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_ae_intestbo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_ae_intestbo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_ae_intestbo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_intestbo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_ae_intestbo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_ae_intestbo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "jntestbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "jntestbo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
