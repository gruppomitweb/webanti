...
// * --- Fine Area Manuale
public class arrt_seldes_closerapR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_seldes_closerapR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_seldes_closerap",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(pTipo,"S")) {
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_seldes_closerap",4,"00000005")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_rapportipd",m_Ctx.GetCompany());
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_seldes_closerap",4,"00000006")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  public static arrt_seldes_closerapR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_seldes_closerapR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pTipo = CPLib.Space(1);
  }
