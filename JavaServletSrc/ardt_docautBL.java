...
public class ardt_docautBL extends ardt_docautWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_docaut";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_docaut;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_docaut;
  ...
  public static String[] m_EntityTables = {"cgo_docaut"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'DACODICE':DACODICE,'m_Detail':{'DATIPDOC':DATIPDOC"+FoundlingChildrenList("ardt_docaut",true,true)+"}"+FoundlingChildrenList("ardt_docaut",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'DACODICE':DACODICE,'m_Detail':{'DATIPDOC':DATIPDOC,'xDESCRI':xDESCRI"+FoundlingChildrenList("ardt_docaut",true,true)+"}"+FoundlingChildrenList("ardt_docaut",true,false)+"}";
  public static final String i_ItemSequence = "DACODICE,m_Detail[ DATIPDOC"+FoundlingChildrenList("ardt_docaut",false,true)+"]"+FoundlingChildrenList("ardt_docaut",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_docaut"),new String[][]{new String[]{"DACODICE","Autorità","C","2","0","campo","key1","false","false"},new String[]{"DATIPDOC","Tipo Documento","C","2","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",DATIPDOC";
  ...
  public ardt_docautBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_docaut = p_ContextObject.GetPhName("cgo_docaut",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_docaut = p_ContextObject.GetServer("cgo_docaut");
    m_oWrInfo_cgo_docaut = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_docaut",p_ContextObject.GetCompany());
    m_cVirtName_cgo_docaut = CPSql.ManipulateTablePhName("cgo_docaut",m_cServer_cgo_docaut);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_docaut",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_SSYFQFAQAO() {
    return Link_SSYFQFAQAO("Full");
  }
  protected boolean Link_SSYFQFAQAO(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_DATIPDOC))) {
      String l_OldValue = w_DATIPDOC;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_DATIPDOC,"C",2,0),m_cServer_cgo_tipdoc,w_DATIPDOC);
      ...
      try {
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                    ...
                                    */
          w_DATIPDOC = l_rsLink.GetString("TIPDOC");
          ...
          Link_SSYFQFAQAO_blank();
          if (CPLib.eq(p_cType,"Load")) {
            w_DATIPDOC = l_OldValue;
          }
        }
        if ( ! (l_bResult)) {
          m_nLastError = 3;
          ...
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","DATIPDOC");
          }
          m_cLastWorkVarError = "DATIPDOC";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_DACODICE(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_DACODICE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_DATIPDOC(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_DATIPDOC = p_workVariableValue;
    l_bResult = Link_SSYFQFAQAO();
  ...
  public final static String[] m_KeyColumns = {"DACODICE"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_docaut","cgo_docaut",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_DATIPDOC;
      p_DATIPDOC = CPLib.GetProperties(trs_p.getProperty("DATIPDOC"),new Properties());
      Properties p_xDESCRI;
      p_xDESCRI = CPLib.GetProperties(trs_p.getProperty("xDESCRI"),new Properties());
      Properties p_opk_DATIPDOC;
      p_opk_DATIPDOC = CPLib.GetProperties(trs_p.getProperty("opk_DATIPDOC"),new Properties());
      ...
      w_DACODICE = CPLib.GetProperty(p,"DACODICE",w_DACODICE,0);
      ...
      while (CPLib.le(i,rows)) {
        w_DATIPDOC = "";
        w_DATIPDOC = CPLib.GetProperty(p_DATIPDOC,"",w_DATIPDOC,i);
        w_xDESCRI = "";
        w_xDESCRI = CPLib.GetProperty(p_xDESCRI,"",w_xDESCRI,i);
        opk_DATIPDOC = CPLib.GetProperty(p_opk_DATIPDOC,"","",i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"DACODICE")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"DATIPDOC")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_DATIPDOC","w_xDESCRI"});
    ...
    map.put("property.value",zeroSplit.split("cgo_tipdoc\u0000false\u0000false\u00001\u00000\u0000armt_cgo_tipdoc\u0000false\u0000false\u0000Tipo Documento\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_docaut",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_docaut",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_docaut",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_docaut",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_docaut"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_docaut\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_DATIPDOC;
    p_DATIPDOC = new Properties();
    Properties p_xDESCRI;
    p_xDESCRI = new Properties();
    Properties p_opk_DATIPDOC;
    p_opk_DATIPDOC = new Properties();
    Properties p_m_nRowStatus;
    p_m_nRowStatus = new Properties();
    Properties p_m_cOldRowCPCCCHK;
    p_m_cOldRowCPCCCHK = new Properties();
    CPLib.PutProperty(p,"DACODICE",w_DACODICE,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_DATIPDOC,"",w_DATIPDOC,trsrow);
      CPLib.PutProperty(p_xDESCRI,"",w_xDESCRI,trsrow);
      CPLib.PutProperty(p_opk_DATIPDOC,"",opk_DATIPDOC,trsrow);
    ...
    trs_p.setProperty("DATIPDOC",CPLib.ToProperties(p_DATIPDOC));
    trs_p.setProperty("xDESCRI",CPLib.ToProperties(p_xDESCRI));
    trs_p.setProperty("opk_DATIPDOC",CPLib.ToProperties(p_opk_DATIPDOC));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_docaut"+"\\"+CPLib.ToCPStr(p_Caller.GetString("DACODICE","C",2,0));
  }
  public String RowPrimaryKey() {
    return "cgo_docaut"+"\\"+CPLib.ToCPStr(w_DATIPDOC);
  }
  ...
  protected void TrsToWork() {
    w_DATIPDOC= m_oTrs.get(m_nCurrentRow).w_DATIPDOC;
    w_xDESCRI= m_oTrs.get(m_nCurrentRow).w_xDESCRI;
    opk_DATIPDOC= m_oTrs.get(m_nCurrentRow).opk_DATIPDOC;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_DATIPDOC=w_DATIPDOC;
    m_oTrs.get(m_nCurrentRow).w_xDESCRI=w_xDESCRI;
    m_oTrs.get(m_nCurrentRow).opk_DATIPDOC=opk_DATIPDOC;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_DATIPDOC=w_DATIPDOC;
    m_oDeletedRows.get(l_nRows).w_xDESCRI=w_xDESCRI;
    m_oDeletedRows.get(l_nRows).opk_DATIPDOC=opk_DATIPDOC;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_DATIPDOC= m_oDeletedRows.get(l_RowNumberToSet).w_DATIPDOC;
    w_xDESCRI= m_oDeletedRows.get(l_RowNumberToSet).w_xDESCRI;
    opk_DATIPDOC= m_oDeletedRows.get(l_RowNumberToSet).opk_DATIPDOC;
