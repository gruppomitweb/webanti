...
l_oWv.setValue('m_cParameterSequence',AsAppletValue('w_c_dadata,w_c_adata'));
_modifyandopen('Report?ReportName='+'arrp_stp_informa_sa'+'&m_cWv='+URLenc(l_oWv.asString())+'&m_cMode=hyperlink','scrollbars=1,toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes,height=500,width=700',null)
}
...
function Help() {
windowOpenForeground('../doc/arpg_stpinforma_prv_sa_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stpinforma_prv_sa',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["DaDatOpe","ADatOpe","daCodCli","aCodCli","OrderBy","tipstp","RAGSOC1","RAGSOC2","c_dadata","c_adata"];
