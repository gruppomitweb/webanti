...
public class arpg_genera_ocseBL extends arpg_genera_ocseWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_genera_ocse";
  ...
  public arpg_genera_ocseBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_genera_ocse","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
