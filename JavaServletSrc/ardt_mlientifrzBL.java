...
public class ardt_mlientifrzBL extends ardt_mlientifrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_mlientifrz";
  ...
  public CPPhTableWrInfo m_oWrInfo_mlientifrz;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_mlientifrz;
  ...
  public static String[] m_EntityTables = {"mlientifrz"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_mlientifrz",true,true)+"}"+FoundlingChildrenList("ardt_mlientifrz",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_mlientifrz",true,true)+"}"+FoundlingChildrenList("ardt_mlientifrz",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG PROQUOTA"+FoundlingChildrenList("ardt_mlientifrz",false,true)+"]"+FoundlingChildrenList("ardt_mlientifrz",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_mlientifrz"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"PROQUOTA","Pro Quota","N","3","0","campo","nokey","true","false"}});
  ...
  public ardt_mlientifrzBL (CPContext p_ContextObject) {
    ...
    m_cPhName_mlientifrz = p_ContextObject.GetPhName("mlientifrz",p_ContextObject.GetCompany(),false);
    m_cServer_mlientifrz = p_ContextObject.GetServer("mlientifrz");
    m_oWrInfo_mlientifrz = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"mlientifrz",p_ContextObject.GetCompany());
    m_cVirtName_mlientifrz = CPSql.ManipulateTablePhName("mlientifrz",m_cServer_mlientifrz);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mlientifrz",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_mlientifrz","mlientifrz",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_mlientifrz",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_mlientifrz",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_mlientifrz",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mlientifrz",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_mlientifrz"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_mlientifrz\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "mlientifrz"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "mlientifrz"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
