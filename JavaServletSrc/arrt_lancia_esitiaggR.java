...
// * --- Fine Area Manuale
public class arrt_lancia_esitiaggR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_esitiaggR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_esitiagg",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if ( ! (m_Ctx.IsSharedTemp("tmp_impesiti"))) {
      m_cServer = m_Ctx.GetServer("tmp_impesiti");
      m_Sql.SrvQuery(m_cServer,"* ","from "+m_Ctx.PhNameAdapter(m_Sql.ManipulateTablePhName("tmp_impesiti",m_cServer,"proto")),m_cPhName,"tmp_impesiti",m_Ctx,new String[]{"idbase","PROGIMPESITI","esito"});
    }
    m_cPhName_tmp_impesiti = m_cPhName;
    /* Lancia la pagina */
    /* Return  */
    Forward f;
    f=new Forward("arpg_esiti_agg",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_esitiaggR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_esitiaggR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
