...
if ( ! (m_oFather.SaveContext_ardt_merzistifrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_merzistifrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_merzistifrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_merzistifrz();
}
}
SaveContext.child=[];
function BlankRow() {
