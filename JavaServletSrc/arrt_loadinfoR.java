...
// * --- Fine Area Manuale
public class arrt_loadinfoR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_loadinfoR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_loadinfo",m_Caller);
  ...
  public Forward Run(armt_informazioniBO p_pObj) {
    pObj = p_pObj;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_loadinfoR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_loadinfoR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
  }
