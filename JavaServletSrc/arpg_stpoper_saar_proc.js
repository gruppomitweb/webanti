...
_modifyandopen('arrt_stpoper_sara'+'?m_cAction=start&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes,height=500,width=700',null)
}
...
function Help() {
windowOpenForeground('../doc/arpg_stpoper_saar_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stpoper_saar',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["DaDatOpe","ADatOpe","RAGSOC1","RAGSOC2","c_dadata","c_adata","OrderBy","daCodCli","aCodCli"];
