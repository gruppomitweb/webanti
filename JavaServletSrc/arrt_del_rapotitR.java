...
// * --- Fine Area Manuale
public class arrt_del_rapotitR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_del_rapotitR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_del_rapotit",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("armt_rapotit",false,this,Forward.Delete,false);
  ...
  public static arrt_del_rapotitR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_del_rapotitR(p_Ctx, p_Caller);
  }
  public void Blank() {
