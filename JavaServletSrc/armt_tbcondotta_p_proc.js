...
m_oFather.i_last_focused_item='child_armt_tbcondotta_p';
...
function Help() {
windowOpenForeground('../doc/armt_tbcondotta_p_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'tbcondotta_p'+'\\'+CPLib.ToCPStr(w_CODICE);
}
function CheckZone(me) {
if (IsWndAccessible(window['m_oFather'])) {
return m_oFather.CheckZone('child_armt_tbcondotta_p');
}
return true;
}
GetSelectedChildPage.child={}
function GetSelectedPage(p_d) {
p_d.setValue('armt_tbcondotta_p',m_cSelectedPage);
