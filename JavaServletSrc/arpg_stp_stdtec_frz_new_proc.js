...
SetDisplay(Ctrl('HLPOJCMBVW'),true);
HideUI();
}
...
w_Messaggi.raiseEvent('arpg_stp_stdtec_frz_new_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_stp_stdtec_frz_new_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stp_stdtec_frz_new_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_stdtec_frz_new',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["daCodDip","aCodDip","DaDatOpe","ADatOpe","daCodCli","aCodCli","RAGSOC1","RAGSOC2","c_dadata","c_adata","DESCRIZ1","DESCRIZ2","flgrae","tipopdf"];
