...
SetLocationHref(null,'arrt_imp_ariu_m'+'?m_cAction=start&m_cMode=hyperlink','elaborazione')
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_imp_ariu_m_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_imp_ariu_m',m_cSelectedPage);
