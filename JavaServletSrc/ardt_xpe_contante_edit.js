...
if ( ! (m_oFather.SaveContext_ardt_xpe_contante())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_xpe_contante_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_xpe_contante_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_xpe_contante();
}
}
SaveContext.child=[];
function BlankRow() {
