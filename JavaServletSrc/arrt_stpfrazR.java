...
// * --- Fine Area Manuale
public class arrt_stpfrazR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_stpfrazR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_stpfraz",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* _conta Numeric(10, 0) */
      /* _numsto Char(15) */
      /* _nomereport Char(50) // Nome del report */
      /* _ftypes Char(20) */
      /* _rotate Char(20) */
      ...
      try {
        ...
        if (CPLib.eqr(w_Tipop,"T") && CPLib.eqr(w_stato,"T")) {
          ...
          while ( ! (Cursor_qbe_allfraziobo.Eof())) {
            ...
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000028")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_allfraziobo.GetString("CODINT2"),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(w_Tipop,"R")) {
            ...
            Cursor_qbe_allfraziobo = new VQRHolder("qbe_allfraziobo",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
            while ( ! (Cursor_qbe_allfraziobo.Eof())) {
              /* If not(Empty(qbe_allfraziobo->RAPPORTO)) */
              if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo.GetString("RAPPORTO")))) {
                // * --- Insert into tmp_stpoperazioni from values
                m_Sql.RequireTransaction();
                m_cServer = m_Ctx.GetServer("tmp_stpoperazioni");
                m_cPhName = m_Ctx.GetPhName("tmp_stpoperazioni");
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000002C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_qbe_allfraziobo.Eof())) {
              ...
              if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo.GetString("CONNESCLI")))) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000002F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          Cursor_qbe_allfraziobo = new VQRHolder("qbe_allfraziobo",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_allfraziobo.Eof())) {
            /* If At(qbe_allfraziobo->STATOREG,statoreg)>0 */
            if (CPLib.gt(CPLib.At(Cursor_qbe_allfraziobo.GetString("STATOREG"),statoreg),0)) {
              // * --- Insert into tmp_stpoperazioni from values
              m_Sql.RequireTransaction();
              m_cServer = m_Ctx.GetServer("tmp_stpoperazioni");
              m_cPhName = m_Ctx.GetPhName("tmp_stpoperazioni");
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000032")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_qbe_allfraziobo.Eof())) {
              ...
              if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo.GetString("RAPPORTO")))) {
                ...
                if (CPLib.gt(CPLib.At(Cursor_qbe_allfraziobo.GetString("STATOREG"),statoreg),0)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000037")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_qbe_allfraziobo.Eof())) {
              ...
              if ( ! (CPLib.Empty(Cursor_qbe_allfraziobo.GetString("CONNESCLI")))) {
                ...
                if (CPLib.gt(CPLib.At(Cursor_qbe_allfraziobo.GetString("STATOREG"),statoreg),0)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000003B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(w_tipstp,"S")) {
          ...
          if (CPLib.eqr(_conta,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000041")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            /* _rotate := 'PORTRAIT' */
            _rotate = "PORTRAIT";
            /* _nomereport := 'arrp_stpfraz_neg.vrp' */
            _nomereport = "arrp_stpfraz_neg.vrp";
          } else { // Else
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESCLI"))))) {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                  ...
                  while ( ! (Cursor_personbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000004A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  while ( ! (Cursor_wersonbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000004C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESOPER"))))) {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                  ...
                  while ( ! (Cursor_personbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000051")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
                  ...
                  while ( ! (Cursor_wersonbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000053")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESBEN"))))) {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                  ...
                  while ( ! (Cursor_personbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000058")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  while ( ! (Cursor_wersonbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000005A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            /* _reportname := 'Frazionate_AUI_'+DateTimeToChar(DateTime()) // Nome del Report */
            _reportname = "Frazionate_AUI_"+CPLib.DateTimeToChar(CPLib.DateTime());
          } // End If
        } else { // Else
          /* If _conta=0 */
          if (CPLib.eqr(_conta,0)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000061")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESCLI"))))) {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                  ...
                  while ( ! (Cursor_personbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000006A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
                  ...
                  while ( ! (Cursor_wersonbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000006C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_wersonbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESOPER"))))) {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                  ...
                  while ( ! (Cursor_personbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000071")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
                  ...
                  while ( ! (Cursor_wersonbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000073")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"RAGOPE = "+CPLib.ToSQL(Cursor_wersonbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESBEN"))))) {
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                  ...
                  while ( ! (Cursor_personbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"00000078")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                    m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
                  ...
                  while ( ! (Cursor_wersonbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_stpfraz",99,"0000007A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_wersonbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                    m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_wersonbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_wersonbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                    m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_wersonbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
            ...
            /* _rotate := 'PORTRAIT' */
            _rotate = "PORTRAIT";
            /* _reportname := 'Analitica_Frazionate_AUI_'+DateTimeToChar(DateTime()) // Nome del Report */
            _reportname = "Analitica_Frazionate_AUI_"+CPLib.DateTimeToChar(CPLib.DateTime());
            /* _nomereport := 'arrp_stpoperana.vrp' // stampa analitica delle frazionate */
  ...
  public static arrt_stpfrazR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_stpfrazR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_tot_tmp_operazioni,
  public static final String m_cVQRList = ",qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_allfraziobo,qbe_tot_tmp_operazioni,";
