...
SetDisplay('STHOKLKHLK_DIV',Eq(w_SEGNO,'A') || IsHiddenByStateDriver('SOS'));
...
m_oFather.i_last_focused_item='child_armt_operazbo_agg';
...
function Help() {
windowOpenForeground('../doc/armt_operazbo_agg_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'operazbo_agg'+'\\'+CPLib.ToCPStr(w_IDBASE);
}
function CheckZone(me) {
if (IsWndAccessible(window['m_oFather'])) {
return m_oFather.CheckZone('child_armt_operazbo_agg');
}
return true;
}
GetSelectedChildPage.child={}
function GetSelectedPage(p_d) {
p_d.setValue('armt_operazbo_agg',m_cSelectedPage);
...
_Obli('CATEG04',0,'JQLGHMLOKO',false,"157155508")
_Obli('CATEG05',0,'QVBZSFMTVP',false,"157155764")
