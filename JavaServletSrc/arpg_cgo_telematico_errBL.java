...
public class arpg_cgo_telematico_errBL extends arpg_cgo_telematico_errWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    ...
    public java.sql.Timestamp c_CADATAORA;
  ...
  public static final String i_EntityName = "arpg_cgo_telematico_err";
  ...
  public arpg_cgo_telematico_errBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_telematico_err","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).c_CADATAORA=c_CADATAORA;
  ...
  public void TrsToWork() {
    ...
    c_CADATAORA= m_oTrs.get(m_nCurrentRow).c_CADATAORA;
