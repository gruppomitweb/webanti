...
// * --- Fine Area Manuale
public class arrt_frazioboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_frazioboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_fraziobo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(w_tipooper,"S")) {
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_fraziobo",16,"0000000C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("2","C",1,0,m_cServer)+", ";
      m_cSql = m_cSql+"DATARETT = "+CPLib.ToSQL(w_datavaria,"D",8,0)+", ";
      ...
      /* Case w_tipooper = 'M' */
    } else if (CPLib.eqr(w_tipooper,"M")) {
    } // End Case
  }
  void _init_() {
  }
  ...
  public static arrt_frazioboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_frazioboR(p_Ctx, p_Caller);
  }
  public void Blank() {
