...
// * --- Fine Area Manuale
public class arrt_trasfdafra_aoped_multiploR implements CallerWithObjs {
  ...
  public java.sql.Date w_dadataD;
  public java.sql.Date w_adataD;
  ...
  // * --- Fine Area Manuale
  public arrt_trasfdafra_aoped_multiploR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_trasfdafra_aoped_multiplo",m_Caller);
  ...
  public double GetNumber(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("numgio",p_cVarName)) {
      return w_numgio;
    }
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_trasfdafra_aoped_multiplo";
  ...
  public java.sql.Date GetDate(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("dadataD",p_cVarName)) {
      return w_dadataD;
    }
    if (CPLib.eqr("adataD",p_cVarName)) {
      return w_adataD;
    }
  ...
  void Main() throws Exception {
    ...
    try {
      ...
      if (CPLib.le(w_ADatOpe,_limite)) {
        /* Imposta i limiti */
        /* w_dadataD := arfn_dateminus(w_DaDatOpe,(w_numgio-1)) */
        w_dadataD = arfn_dateminusR.Make(m_Ctx,this).Run(w_DaDatOpe,(w_numgio-1));
        /* w_adataD := w_DaDatOpe */
        w_adataD = w_DaDatOpe;
        /* w_dadata := DateToChar(w_dadataD) */
        w_dadata = CPLib.DateToChar(w_dadataD);
        /* w_adata := DateToChar(w_adataD) */
        w_adata = CPLib.DateToChar(w_adataD);
        ...
        /* Case w_dadataD <= CharToDate("20011231") */
        if (CPLib.le(w_dadataD,CPLib.CharToDate("20011231"))) {
          /* w_importo := 20000000 */
          w_importo = CPLib.Round(20000000,0);
          /* Case w_dadataD >= CharToDate("20020101") and w_dadataD <= CharToDate("20021227") */
        } else if (CPLib.ge(w_dadataD,CPLib.CharToDate("20020101")) && CPLib.le(w_dadataD,CPLib.CharToDate("20021227"))) {
          /* w_importo := 1032914 */
          w_importo = CPLib.Round(1032914,0);
          /* Case w_dadataD > CharToDate("20021227") and w_dadataD <= CharToDate("20071229") */
        } else if (CPLib.gt(w_dadataD,CPLib.CharToDate("20021227")) && CPLib.le(w_dadataD,CPLib.CharToDate("20071229"))) {
          /* w_importo := 1250000 */
          w_importo = CPLib.Round(1250000,0);
          /* Case w_dadataD > CharToDate("20071229") */
        } else if (CPLib.gt(w_dadataD,CPLib.CharToDate("20071229"))) {
          /* w_importo := w_impfraz */
        ...
        double nTry0000003Dstatus;
        nTry0000003Dstatus = m_Sql.GetTransactionStatus();
        String cTry0000003Dmsg;
        cTry0000003Dmsg = m_Sql.TransactionErrorMessage();
        try {
          /* _conta := 0 */
          ...
          /* While w_adataD <= w_ADatOpe */
          while (CPLib.le(w_adataD,w_ADatOpe)) {
            ...
            if (CPLib.eqr(w_flgdel,"S")) {
              ...
              Cursor_fraziobo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select IDBASE,CODDIPE  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"DATAOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_dadataD,"?",0,0,m_cServer, m_oParameters),m_cServer,w_dadataD)+"  and  TIPOOPRAP <> 10 "+")"+(m_Ctx.IsSharedTemp("fraziobo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
              while ( ! (Cursor_fraziobo.Eof())) {
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on anadip into routine arrt_trasfdafra_aoped_multiplo returns two or more records. This item should return only a record.");
                ...
                if (CPLib.Empty(CPLib.LRTrim(_coddip)) || ( ! (CPLib.Empty(CPLib.LRTrim(_coddip))) && CPLib.ne(_flgage,"S"))) {
                  ...
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000004B")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000004C")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_fraziobo.GetString("idbase"),"?",0,0,m_cServer),m_cServer,Cursor_fraziobo.GetString("idbase"))+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000004D")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_fraziobo.GetString("idbase"),"?",0,0,m_cServer),m_cServer,Cursor_fraziobo.GetString("idbase"))+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000004E")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_fraziobo.GetString("idbase"),"?",0,0,m_cServer),m_cServer,Cursor_fraziobo.GetString("idbase"))+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000004F")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
            ...
            /* w_adataD := arfn_datesum(w_adataD,1) */
            w_adataD = arfn_datesumR.Make(m_Ctx,this).Run(w_adataD,1);
            /* w_dadataD := arfn_dateminus(w_adataD,(w_numgio-1)) */
            w_dadataD = arfn_dateminusR.Make(m_Ctx,this).Run(w_adataD,(w_numgio-1));
            /* w_dadata := DateToChar(w_dadataD) */
            w_dadata = CPLib.DateToChar(w_dadataD);
            /* w_adata := DateToChar(w_adataD) */
            w_adata = CPLib.DateToChar(w_adataD);
          ...
          if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry0000003Dstatus,0)) {
            m_Sql.SetTransactionStatus(nTry0000003Dstatus,cTry0000003Dmsg);
          }
        }
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* gMsgProc := gMsgProc + 'Ora Inizio Tipo 1: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Inizio Tipo 1: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* w_segno := 'D' */
      w_segno = "D";
      /* w_codcli := '' */
      ...
      while ( ! (Cursor_qbe_trasffraope1.Eof())) {
        ...
        _h00000063.Set("codcli",Cursor_qbe_trasffraope1.GetString("CONNESCLI"));
        _h00000063.Set("segno",w_segno);
        _h00000063.Set("dadata",w_dadata);
        _h00000063.Set("adata",w_adata);
        _h00000063.Set("minfraz",w_minfraz);
        if (Cursor_qbe_trasffraope10a!=null)
          Cursor_qbe_trasffraope10a.Close();
        Cursor_qbe_trasffraope10a = new VQRHolder("qbe_trasffraope10a",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000063,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_trasffraope10a.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000006E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000006F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_sogopefbo.Eof())) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000075")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_clientifrz.Eof())) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000078")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_beneficfrz.Eof())) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000007B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_terzistifrz.Eof())) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000007E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(_sog,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopefbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000082")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
          ...
          if (CPLib.eqr(_cli,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000084")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ben,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficfrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000086")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ter,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000088")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000089")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
      ...
      Cursor_qbe_trasffraope1.Close();
      // * --- End Select
      /* gMsgProc := gMsgProc + 'Ora Fine Tipo 1: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Fine Tipo 1: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
    } finally {
      try {
        if (Cursor_qbe_trasffraope1!=null)
  ...
  void Page_2() throws Exception {
    ...
    try {
      ...
      /* gMsgProc := gMsgProc + 'Ora Inizio Tipo 2: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Inizio Tipo 2: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* w_segno := 'A' */
      w_segno = "A";
      /* w_codcli := '' */
      ...
      while ( ! (Cursor_qbe_trasffraope1.Eof())) {
        ...
        _h00000094.Set("codcli",Cursor_qbe_trasffraope1.GetString("CONNESCLI"));
        _h00000094.Set("segno",w_segno);
        _h00000094.Set("dadata",w_dadata);
        _h00000094.Set("adata",w_adata);
        _h00000094.Set("minfraz",w_minfraz);
        if (Cursor_qbe_trasffraope10a!=null)
          Cursor_qbe_trasffraope10a.Close();
        Cursor_qbe_trasffraope10a = new VQRHolder("qbe_trasffraope10a",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000094,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_trasffraope10a.Eof())) {
          /* _idb2 := LibreriaMit.UniqueId() */
          _idb2 = LibreriaMit.UniqueId();
          /* _conta := _conta + 1 */
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000009F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_trasfope",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000A0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_sogopefbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopebo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000A6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_clientifrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000A9")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_beneficfrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000AC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_terzistifrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistiope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000AF")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(_sog,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopefbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000B3")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_cli,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000B5")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ben,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficfrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000B7")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ter,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000B9")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000BA")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"NUMPROG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10a.GetString("NUMPROG"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10a.GetString("NUMPROG"))+"";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter();
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
      ...
      Cursor_qbe_trasffraope1.Close();
      // * --- End Select
      /* gMsgProc := gMsgProc + 'Ora Fine Tipo 2: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Fine Tipo 2: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
    } finally {
      try {
        if (Cursor_qbe_trasffraope1!=null)
  ...
  void Page_3() throws Exception {
    ...
    try {
      ...
      /* gMsgProc := gMsgProc + 'Ora Inizio Tipo 3: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Inizio Tipo 3: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* w_segno := 'D' */
      w_segno = "D";
      ...
      while ( ! (Cursor_qbe_trasffraope3.Eof())) {
        ...
        _h000000C5.Set("codrap",Cursor_qbe_trasffraope3.GetString("RAPPORTO"));
        _h000000C5.Set("segno",w_segno);
        _h000000C5.Set("dadata",w_dadata);
        _h000000C5.Set("adata",w_adata);
        _h000000C5.Set("minfraz",w_minfraz);
        if (Cursor_qbe_trasffraope10b!=null)
          Cursor_qbe_trasffraope10b.Close();
        Cursor_qbe_trasffraope10b = new VQRHolder("qbe_trasffraope10b",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000C5,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_trasffraope10b.Eof())) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000D0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_trasfope",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000D1")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_sogopefbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopebo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000D7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_clientifrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000DA")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_beneficfrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000DD")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_terzistifrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistiope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000E0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(_sog,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopefbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000E4")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
          ...
          if (CPLib.eqr(_cli,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000E6")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ben,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficfrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000E8")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ter,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000EA")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"000000EB")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
      ...
      Cursor_qbe_trasffraope3.Close();
      // * --- End Select
      /* gMsgProc := gMsgProc + 'Ora Fine Tipo 3: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Fine Tipo 3: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
    } finally {
      try {
        if (Cursor_qbe_trasffraope3!=null)
  ...
  void Page_4() throws Exception {
    ...
    try {
      ...
      /* gMsgProc := gMsgProc + 'Ora Inizio Tipo 4: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Inizio Tipo 4: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* w_segno := 'A' */
      w_segno = "A";
      /* w_codrap := '' // Codice Rapporto */
      ...
      while ( ! (Cursor_qbe_trasffraope3.Eof())) {
        ...
        cValRec = CPLib.Round(0,0);
        // * --- Select from qbe_trasffraope10b
        SPBridge.HMCaller _h000000F6;
        _h000000F6 = new SPBridge.HMCaller();
        _h000000F6.Set("m_cVQRList",m_cVQRList);
        _h000000F6.Set("codrap",Cursor_qbe_trasffraope3.GetString("RAPPORTO"));
        _h000000F6.Set("segno",w_segno);
        _h000000F6.Set("dadata",w_dadata);
        _h000000F6.Set("adata",w_adata);
        _h000000F6.Set("minfraz",w_minfraz);
        if (Cursor_qbe_trasffraope10b!=null)
          Cursor_qbe_trasffraope10b.Close();
        Cursor_qbe_trasffraope10b = new VQRHolder("qbe_trasffraope10b",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000F6,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_trasffraope10b.Eof())) {
          /* _idb2 := LibreriaMit.UniqueId() */
          _idb2 = LibreriaMit.UniqueId();
          /* _conta := _conta + 1 */
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000101")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_trasfope",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000102")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_sogopefbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopebo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000108")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_clientifrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000010B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_beneficfrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000010E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          while ( ! (Cursor_terzistifrz.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistiope",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000111")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(_sog,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sogopefbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000115")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_cli,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000117")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ben,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"beneficfrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"00000119")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          if (CPLib.eqr(_ter,1)) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"terzistifrz",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000011B")+"delete from "+m_oWrInfo.GetTableWriteName();
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDFILEBO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("IDBASE"))+"";
            m_cSql = m_cSql+m_oWrInfo.WhereFilter();
            m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_multiplo",121,"0000011C")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"NUMPROG = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_qbe_trasffraope10b.GetString("NUMPROG"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_trasffraope10b.GetString("NUMPROG"))+"";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter();
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
      ...
      Cursor_qbe_trasffraope3.Close();
      // * --- End Select
      /* gMsgProc := gMsgProc + 'Ora Fine Tipo 4: '+ arfn_fdatetime(DateTime()) +" Periodo: "+arfn_fdate(w_dadataD) + " - " + arfn_fdate(w_adataD) + NL */
      gMsgProc = gMsgProc+"Ora Fine Tipo 4: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" Periodo: "+arfn_fdateR.Make(m_Ctx,this).Run(w_dadataD)+" - "+arfn_fdateR.Make(m_Ctx,this).Run(w_adataD)+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
    } finally {
      try {
        if (Cursor_qbe_trasffraope3!=null)
  ...
  public Forward Run() {
    ...
    try {
      ...
      m_Caller.SetNumber("numgio","N",2,0,w_numgio);
  ...
  public static arrt_trasfdafra_aoped_multiploR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_trasfdafra_aoped_multiploR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    w_numgio = m_Caller.GetNumber("numgio","N",2,0);
    _conta = 0;
    ...
    cValRec = 0;
    w_dadataD = CPLib.NullDate();
    w_adataD = CPLib.NullDate();
  ...
  // ENTITY_BATCHES: ,arfn_dateminus,arfn_datesum,arfn_fdate,arfn_fdatetime,
  public static final String i_InvokedRoutines = ",arfn_dateminus,arfn_datesum,arfn_fdate,arfn_fdatetime,";
