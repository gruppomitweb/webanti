...
if ( ! (m_oFather.SaveContext_ardt_terzistifrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_terzistifrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_terzistifrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_terzistifrz();
}
}
SaveContext.child=[];
function BlankRow() {
