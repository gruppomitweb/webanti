...
public class arpg_inverti_causaliBL extends arpg_inverti_causaliWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_inverti_causali";
  ...
  public arpg_inverti_causaliBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_inverti_causali","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
