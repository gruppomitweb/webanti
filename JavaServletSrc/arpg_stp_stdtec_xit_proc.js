...
SetDisplay(Ctrl('TAGIKJVKTH'),true);
HideUI();
}
...
w_Messaggi.raiseEvent('arpg_stp_stdtec_xit_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_stp_stdtec_xit_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stp_stdtec_xit_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_stdtec_xit',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["daCodDip","aCodDip","DaDatOpe","ADatOpe","daCodCli","aCodCli","RAGSOC1","RAGSOC2","DESCRIZ1","DESCRIZ2","ADatReg","DaDatReg"];
