...
public class arpg_import_valutransBL extends arpg_import_valutransWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_valutrans";
  ...
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gTipInter':gTipInter,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gFlgWU':gFlgWU,'xdesval':xdesval,'xragsoc':xragsoc}";
  ...
  public arpg_import_valutransBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_valutrans","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
