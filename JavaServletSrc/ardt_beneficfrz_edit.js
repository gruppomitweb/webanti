...
if ( ! (m_oFather.SaveContext_ardt_beneficfrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_beneficfrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_beneficfrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_beneficfrz();
}
}
SaveContext.child=[];
function BlankRow() {
