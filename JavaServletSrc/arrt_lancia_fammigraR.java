...
// * --- arrt_lancia_fammigra
import java.io.*;
import java.util.Scanner;
// * --- Fine Area Manuale
public class arrt_lancia_fammigraR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_fammigraR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_fammigra",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    File di = new File(CPLib.LRTrim(gPathApp)+"/SID/MIGRA/ELB/"+CPLib.LRTrim(gAzienda)+"/");
    ...
    /* Stop arpg_fammigra */
    Forward f;
    f=new Forward("arpg_fammigra",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_fammigraR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_fammigraR(p_Ctx, p_Caller);
  }
  public void Blank() {
