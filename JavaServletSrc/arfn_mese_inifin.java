...
public class arfn_mese_inifin extends SPRoutineServlet implements SPInvokable {
  public static String m_cEntityUid = "!*b1da1462*!";
  public class ServletStatus extends SPRoutineServletStatus {
    ...
    public String pMese;
    public String pTipo;
    public java.sql.Date aaa_retval;
  ...
  private void ExecuteRoutine(ServletStatus status) throws IOException {
    arfn_mese_inifinR Rcalled;
    Rcalled = new arfn_mese_inifinR(status.context,status);
  ...
  CallerWithObjs NewRoutine(SPServletStatus status,Caller dataFromClient) {
    return new arfn_mese_inifinR(status.context,dataFromClient);
  }
  protected void BringBackPage(ServletStatus status,arfn_mese_inifinR Rcalled) throws IOException {
    String l_cErrMsg;
    String msg;
    ...
    if ( ! (CPLib.Empty(status.m_cFaultTrace))) {
      status.out.println("Fault:["+SPLib.ToJSValue(status.context.Translate("MSG_ROUTINE_FAULTED","arfn_mese_inifin"),"C",0,0)+","+SPLib.ToJSValue(status.m_cFaultTrace,"C",0,0)+"]");
