...
if(c=Ctrl('NMNMXABGKO')) c.value=WtH('Crea Comunicazione Negativa relativa al Periodo'+"\n"+'sia per i rapporti che per le deleghe/procure'+"\n"+'ed operazioni extraconto','C',0,0);
...
_modifyandopen('arrt_sd_comunega'+'?m_cAction=start&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes',null)
}
}
...
FocusFirstComponent.otherwise={"page_1":["NMNMXABGKO","GTMJENMCMN"]};
function Help() {
windowOpenForeground('../doc/arpg_scaricodati_negaglob_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_scaricodati_negaglob',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["gIntemediario","dadata","a_data","anno","mese","CFINVIO","CAFINVIO","FILEINVIO","DATAINVIO"];
