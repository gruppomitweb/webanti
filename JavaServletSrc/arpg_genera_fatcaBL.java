...
public class arpg_genera_fatcaBL extends arpg_genera_fatcaWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_genera_fatca";
  ...
  public static final String i_StateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'soggetto':soggetto,'codtin':codtin}";
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'cdadata':cdadata,'c_adata':c_adata,'soggetto':soggetto,'codtin':codtin}";
  public static final String i_ItemSequence = "DaDatOpe,ADatOpe,soggetto,codtin";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"soggetto","Soggetto","C","70","0","variabile","nokey","false","false"},new String[]{"codtin","TIN","C","15","0","variabile","nokey","false","false"}});
  ...
  public arpg_genera_fatcaBL (CPContext p_ContextObject) {
  ...
  public boolean Set_soggetto(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_soggetto = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_codtin(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_genera_fatca","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_soggetto = CPLib.GetProperty(p,"soggetto",w_soggetto,0);
      w_codtin = CPLib.GetProperty(p,"codtin",w_codtin,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
