...
function DisplayErrorMessage_ardt_cgo_oper_multi_dc() {
if ( ! (ChildToLoad(FrameRef('ardt_cgo_oper_multi_dc'))) && Ne(typeof(FrameRef('ardt_cgo_oper_multi_dc').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_cgo_oper_multi_dc').DisplayErrorMessage();
}
}
...
SetDisabled('RUNOCZKNEF',l_bEnabled);
...
SetObligatory(Ctrl('RUNOCZKNEF'),Eq(w_FLAGWALLET,'1') || IsObligatoryByStateDriver('CODWALLET'));
...
SetObligatory(Ctrl('NTWMYVQDWZ'),Eq(w_xCGOFLGPROF,'S') || IsObligatoryByStateDriver('PROFESSIONE'));
...
var ctl = _GetCtl(e,'RUNOCZKNEF');
if (_tracker.goon(ctl,ctrlValue)) {
w_CODWALLET=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('RUNOCZKNEF',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','C',20,0,'');
...
var ctl = _GetCtl(e,'NTWMYVQDWZ');
if (_tracker.goon(ctl,ctrlValue)) {
w_PROFESSIONE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('NTWMYVQDWZ',0);
DoUpdate(l_bResult);
return l_bResult;
} else {
ctl.value=WtH('','C',40,0,'');
...
if ( ! (ChildToLoad(FrameRef('ardt_cgo_oper_multi_dc'))) && Ne(typeof(FrameRef('ardt_cgo_oper_multi_dc').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('ardt_cgo_oper_multi_dc'),['CGOTIPOPE_P','DATOPE_P','SEGNO_P'],['CGOTIPOPE','DATAOPE','SEGNO'],true)
}
...
if ((Ne(o_SNAINUMOPE,w_SNAINUMOPE))) {
w_CODDIPE=w_gCodDip;
...
arrt_cgo_setpagatore_m_dc([["pObj",this]])
}
...
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_oper_multi_dc_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_oper_multi_dc_dataNotSent',{'action':formaction});
}
}
}
}
CheckChild.child=[{'prg':"ardt_cgo_oper_multi_dc",'BOScId':function(){ return FrameRef('ardt_cgo_oper_multi_dc')},'repeated':0}];
function Check() {
var l_bResult = true;
...
l_bResult=false;
w_IMPWALLET=HtW('','N');
} else if ((Eq(w_FLAGWALLET,'1') &&  ! (Empty(w_DATAOPE))) && ( ! (_ChkObl('RUNOCZKNEF',1)))) {
_SignErr('RUNOCZKNEF');
...
if (l_bResult) {
  l_bReport=true;
  arrt_cgo_calc_multiid_dc([['pObj',this]]);
}
...
_FillChildren.n=['ardt_cgo_oper_multi_dc'];
FillWv.n=["SNAINUMOPE","TIPOGIOCO","VLTPLAT","CGOTIPOPE","CAIDBIGLIETTO","DATAOPE","FLAGCONT","FLAGWALLET","CACODICE","CODANA","CODVOC","CAFLGOPE","SEGNO","TOTLIRE","TOTCONT","IMPWALLET","CODWALLET","CODTRANSZ","CGOFLGVLT","CGOFLGVNP","CC4CIFRE","CCMESSCA","CCANNSCA","IBAN","ASSEGNO","CCDATSCA","CFESTERO","PEP","CODFISC","COGNOME","NOME","NASCOMUN","TIPINTER","SESSO","NASSTATO","DATANASC","PAESE","DESCCIT","PROVINCIA","CAP","DOMICILIO","NUMTEL","FLGDOM","PAESE2","DESCCIT2","PROVINCIA2","CAP2","DOMICILIO2","TIPODOC","NUMDOCUM","DATARILASC","DATAVALI","RDCODAUT","RDLOCAUT","PEPDESCRI","TIPOPERS","RAGSOC","SOTGRUP","RAMOGRUP","SETTSINT","DATAREG","TIPOOPRAP","VALUTA","CAMBIO","CONNESCLI","CONNESBEN","C_RAG","C_CTA","C_PRV","C_CAP","C_CAB","C_IND","C_STA","CODINTER","CODDIPE","DESCCITDIP","FLAGFRAZ","COLLEG","PROVINCIADIP","CODCABDIP","CODCAB","ATTIV","AUTRILASC","IDDOCALL","FLGDOCALL","PROFESSIONE","MEZPAGAM","gIntemediario","gCodDip","gStpDwn","gVLT","gVNP","gChkDate","gGesDoc","gSeekAos","gDataVaria","gFlgDoc","gTipMul","xARDESCRI","xSOGTPGIO","xDEFTPGIO","xEDTTPGIO","xEDTSPGIO","xDEFSPGIO","xFLGPLGIO","FLGPAGAM","FILTROMP","idcitta","idcitta2","dessta","tipsot","STATOREG","IDBASE","NUMPROG","DESCRI","xDescDipe","datpaseuro","xdes1","desccauana","CITINT","CITDIP","PROVDIP","CABDIP","PROVINT","CABINT","xdesccausin","xdesctipatt","MIDBIGLIETTO","MIDBIGLIETTO1","MIDBIGLIETTO2","MIDBIGLIETTO3","MIDBIGLIETTO4","xVPFLGATT","DOC03","DOC04","edtdoc","saveddoc","dessta2","verifica","xIMPMINTOT","gAzienda","xCGOFLGPROF","ANA_FOUND"];
function SetModified() {
m_bUpdated=true;
}
function SetChildVariables_ardt_cgo_oper_multi_dc() {
if ( ! (ChildToLoad(FrameRef('ardt_cgo_oper_multi_dc'))) && Ne(typeof(FrameRef('ardt_cgo_oper_multi_dc').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('ardt_cgo_oper_multi_dc'),['CGOTIPOPE_P','DATOPE_P','SEGNO_P'],['CGOTIPOPE','DATAOPE','SEGNO'],false)
}
}
function CtxLoad_ardt_cgo_oper_multi_dc() {
if (ChildToLoad(FrameRef('ardt_cgo_oper_multi_dc'))) {
return [LoadContext(0,'AAHJPBZVGL'),'ardt_cgo_oper_multi_dc'];
}
}
