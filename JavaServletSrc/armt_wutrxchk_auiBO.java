...
// * --- Fine Area Manuale
public class armt_wutrxchk_auiBO extends armt_wutrxchk_auiBL {
  class SqlLoader {
    double m_nColumns = 0;
    CPSql m_Sql;
    String m_cServer;
  ...
  // * --- Fine Area Manuale
  public armt_wutrxchk_auiBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_wutrxchk_aui");
    }
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_wu_doctype,arrt_wutrxchk_aua_exit,arrt_wutrxchk_upddata,
  public static final String i_InvokedRoutines = ",arfn_wu_doctype,arrt_wutrxchk_aua_exit,arrt_wutrxchk_upddata,";
}
