...
public class arpg_rapotitBL extends arpg_rapotitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_rapotit";
  ...
  public static final String i_CompleteStateStructure = "{'CODCLI':CODCLI}";
  ...
  public arpg_rapotitBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_rapotit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
