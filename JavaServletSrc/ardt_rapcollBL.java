...
public class ardt_rapcollBL extends ardt_rapcollWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_rapcoll";
  ...
  public CPPhTableWrInfo m_oWrInfo_rapcoll;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_rapcoll;
  ...
  public static String[] m_EntityTables = {"rapcoll"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'RAPPORTO':RAPPORTO"+FoundlingChildrenList("ardt_rapcoll",true,true)+"}"+FoundlingChildrenList("ardt_rapcoll",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'RAPPORTO':RAPPORTO,'IDBASE':IDBASE,'DESCRAP':DESCRAP"+FoundlingChildrenList("ardt_rapcoll",true,true)+"}"+FoundlingChildrenList("ardt_rapcoll",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ RAPPORTO"+FoundlingChildrenList("ardt_rapcoll",false,true)+"]"+FoundlingChildrenList("ardt_rapcoll",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_rapcoll"),new String[][]{new String[]{"IDFILEBO","Operazione","C","10","0","campo","key1","false","false"},new String[]{"RAPPORTO","Rapporto","C","25","0","campo","key1","true","false"}});
  ...
  public ardt_rapcollBL (CPContext p_ContextObject) {
    ...
    m_cPhName_rapcoll = p_ContextObject.GetPhName("rapcoll",p_ContextObject.GetCompany(),false);
    m_cServer_rapcoll = p_ContextObject.GetServer("rapcoll");
    m_oWrInfo_rapcoll = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"rapcoll",p_ContextObject.GetCompany());
    m_cVirtName_rapcoll = CPSql.ManipulateTablePhName("rapcoll",m_cServer_rapcoll);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_rapcoll",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_rapcoll","rapcoll",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.value",zeroSplit.split("anarapbo\u0000false\u0000false\u00002\u00000\u0000armt_anarap\u0000false\u0000false\u0000Rapporti Continuativi\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_rapcoll",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_rapcoll",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_rapcoll",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_rapcoll",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_rapcoll"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_rapcoll\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "rapcoll"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "rapcoll"+"\\"+CPLib.ToCPStr(w_RAPPORTO);
  }
