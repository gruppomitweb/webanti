...
// * --- Fine Area Manuale
public class arrt_stpfraz_stoR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_stpfraz_stoR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_stpfraz_sto",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    if (CPLib.eqr(w_tipstp,"S")) {
      ...
      f.SetParameter("ReportName","arrp_stpfraz_sto");
      ...
      Forward f;
      f=new Forward("Report",false,this,Forward.Start,false);
      f.SetParameter("ReportName","arrp_stpfrazana_sto");
      f.SetParameter("outputFormat","PDF");
      f.SetParameter("cdadata",w_cdadata);
      f.SetParameter("c_adata",w_c_adata);
      f.SetParameter("daCodCli",w_daCodCli);
  ...
  public static arrt_stpfraz_stoR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_stpfraz_stoR(p_Ctx, p_Caller);
  }
  public void Blank() {
