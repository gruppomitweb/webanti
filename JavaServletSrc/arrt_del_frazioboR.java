...
// * --- Fine Area Manuale
public class arrt_del_frazioboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_del_frazioboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_del_fraziobo",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("armt_ofrazionate",false,this,Forward.Delete,false);
  ...
  public static arrt_del_frazioboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_del_frazioboR(p_Ctx, p_Caller);
  }
  public void Blank() {
