...
// * --- Fine Area Manuale
public class arrt_stpoper_prvR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_stpoper_prvR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_stpoper_prv",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(w_Tipop,"T")) {
        ...
        Cursor_qbe_alloperazbo_prv = new VQRHolder("qbe_alloperazbo_prv",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_alloperazbo_prv.Eof())) {
          ...
          m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000024")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(w_Tipop,"R")) {
          ...
          Cursor_qbe_alloperazbo_prv = new VQRHolder("qbe_alloperazbo_prv",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_alloperazbo_prv.Eof())) {
            /* If not(Empty(qbe_alloperazbo_prv->RAPPORTO)) */
            if ( ! (CPLib.Empty(Cursor_qbe_alloperazbo_prv.GetString("RAPPORTO")))) {
              // * --- Insert into tmp_stpoperazioni from values
              m_Sql.RequireTransaction();
              m_cServer = m_Ctx.GetServer("tmp_stpoperazioni");
              m_cPhName = m_Ctx.GetPhName("tmp_stpoperazioni");
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000028")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          Cursor_qbe_alloperazbo_prv = new VQRHolder("qbe_alloperazbo_prv",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_alloperazbo_prv.Eof())) {
            /* If Empty(qbe_alloperazbo_prv->RAPPORTO) */
            if (CPLib.Empty(Cursor_qbe_alloperazbo_prv.GetString("RAPPORTO"))) {
              // * --- Insert into tmp_stpoperazioni from values
              m_Sql.RequireTransaction();
              m_cServer = m_Ctx.GetServer("tmp_stpoperazioni");
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"0000002B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(w_tipstp,"S")) {
        ...
        if (CPLib.eqr(_conta,0)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000030")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESCLI"))))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000038")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                while ( ! (Cursor_wersonbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"0000003A")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESOPER"))))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"0000003F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
                ...
                while ( ! (Cursor_wersonbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000041")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESBEN"))))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000046")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                while ( ! (Cursor_wersonbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000048")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          /* _reportname := 'Operazioni_PROVVISORIO_'+DateTimeToChar(DateTime()) // Nome del Report */
          _reportname = "Operazioni_PROVVISORIO_"+CPLib.DateTimeToChar(CPLib.DateTime());
        } // End If
      } else { // Else
        /* If _conta=0 */
        if (CPLib.eqr(_conta,0)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"0000004F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESCLI"))))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000057")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
                ...
                while ( ! (Cursor_wersonbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000059")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_wersonbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESOPER"))))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"0000005E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"RAGCLI = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
                ...
                while ( ! (Cursor_wersonbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000060")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"RAGOPE = "+CPLib.ToSQL(Cursor_wersonbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"tmp_stpoperazioni",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_stpoperazioni.GetString("IDBASE"),"?",0,0,m_cServer),m_cServer,Cursor_tmp_stpoperazioni.GetString("IDBASE"))+"";
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_stpoperazioni.GetString("CONNESBEN"))))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_numsto))) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000065")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
                ...
                while ( ! (Cursor_wersonbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_stpoperazioni",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arrt_stpoper_prv",104,"00000067")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_wersonbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_wersonbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_wersonbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_wersonbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
          ...
          _nomereport = "arrp_stpoperana.vrp";
          /* _reportname := 'Analitica_Operazioni_PROVVISORIO_'+DateTimeToChar(DateTime()) // Nome del Report */
          _reportname = "Analitica_Operazioni_PROVVISORIO_"+CPLib.DateTimeToChar(CPLib.DateTime());
        } // End If
      } // End If
      /* Stop _nomereport */
      Forward f;
  ...
  public static arrt_stpoper_prvR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_stpoper_prvR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_alloperazbo_prv,qbe_alloperazbo_prv,qbe_alloperazbo_prv,qbe_tot_tmp_operazioni,
  public static final String m_cVQRList = ",qbe_alloperazbo_prv,qbe_alloperazbo_prv,qbe_alloperazbo_prv,qbe_tot_tmp_operazioni,";
