...
public class arpg_stampe_sogBL extends arpg_stampe_sogWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stampe_sog";
  ...
  public static final String i_CompleteStateStructure = "{'CodCli':CodCli,'RAGSOC1':RAGSOC1}";
  ...
  public arpg_stampe_sogBL (CPContext p_ContextObject) {
  ...
  public boolean Calculate() {
    ...
    l_bResult = true;
    m_bCalculating = true;
    if (CPLib.ne(o_CodCli,w_CodCli)) {
      l_bTmpRes = Link_UYVYTEMEXX("Load");
    }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stampe_sog","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_CodCli","w_RAGSOC1"});
