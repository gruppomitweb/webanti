...
public class ardt_mogopeboBL extends ardt_mogopeboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_mogopebo";
  ...
  public CPPhTableWrInfo m_oWrInfo_mogopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_mogopebo;
  ...
  public static String[] m_EntityTables = {"mogopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_mogopebo",true,true)+"}"+FoundlingChildrenList("ardt_mogopebo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescriz':xdescriz"+FoundlingChildrenList("ardt_mogopebo",true,true)+"}"+FoundlingChildrenList("ardt_mogopebo",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_mogopebo",false,true)+"]"+FoundlingChildrenList("ardt_mogopebo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_mogopebo"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_mogopeboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_mogopebo = p_ContextObject.GetPhName("mogopebo",p_ContextObject.GetCompany(),false);
    m_cServer_mogopebo = p_ContextObject.GetServer("mogopebo");
    m_oWrInfo_mogopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"mogopebo",p_ContextObject.GetCompany());
    m_cVirtName_mogopebo = CPSql.ManipulateTablePhName("mogopebo",m_cServer_mogopebo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mogopebo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_mogopebo","mogopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_mogopebo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_mogopebo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_mogopebo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_mogopebo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_mogopebo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_mogopebo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "mogopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "mogopebo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
