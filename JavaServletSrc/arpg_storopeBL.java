...
public class arpg_storopeBL extends arpg_storopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_storope";
  ...
  public arpg_storopeBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_storope","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
