...
public class armt_fraziobo_aggBL extends armt_fraziobo_aggWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_fraziobo_agg";
  ...
  public CPPhTableWrInfo m_oWrInfo_fraziobo_agg;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_fraziobo_agg;
  ...
  public armt_fraziobo_aggBL (CPContext p_ContextObject) {
    ...
    m_cPhName_fraziobo_agg = p_ContextObject.GetPhName("fraziobo_agg",p_ContextObject.GetCompany(),false);
    m_cServer_fraziobo_agg = p_ContextObject.GetServer("fraziobo_agg");
    m_oWrInfo_fraziobo_agg = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"fraziobo_agg",p_ContextObject.GetCompany());
    m_cVirtName_fraziobo_agg = CPSql.ManipulateTablePhName("fraziobo_agg",m_cServer_fraziobo_agg);
    ...
    m_MNTs = CPLib.MNTChilds("armt_fraziobo_agg",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_fraziobo_agg","fraziobo_agg",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_fraziobo_agg",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_fraziobo_agg",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_fraziobo_agg",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_fraziobo_agg"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_fraziobo_agg\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "fraziobo_agg"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
