...
SetDisplay(Ctrl('SWPFAIZGKJ'),true);
HideUI();
}
...
SetLocationHref(null,'arrt_stp_stdtec_tit_new'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
_ResetTracker();
...
w_Messaggi.raiseEvent('arpg_stp_stdtec_tit_new_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_stp_stdtec_tit_new_'+Strtran(p_cEvent,' ','_'));
}
}
...
FocusFirstComponent.otherwise={"page_1":["UQFVYWSNYY","HXBJUMEZIA","DPKVLWHCIG","MTJDZQTEIR","UYVYTEMEXX","CJWUHWULAR","IDBBKLYUJD"]};
function Help() {
windowOpenForeground('../doc/arpg_stp_stdtec_tit_new_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_stdtec_tit_new',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["RAGSOC1","RAGSOC2","DESCRIZ1","DESCRIZ2","daCodDip","aCodDip","DaDatOpe","ADatOpe","daCodCli","aCodCli","tipopdf","ADatReg","DaDatReg"];
