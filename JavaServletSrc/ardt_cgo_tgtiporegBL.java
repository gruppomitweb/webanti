...
public class ardt_cgo_tgtiporegBL extends ardt_cgo_tgtiporegWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_TRTIPREG;
    public String w_TRDESREG;
    public String opk_TRTIPREG;
  ...
  public static final String i_EntityName = "ardt_cgo_tgtiporeg";
  ...
  public String m_cPhName_cgo_tgtiporeg;
  public String m_cServer_cgo_tgtiporeg;
  public CPPhTableWrInfo m_oWrInfo_cgo_tgtiporeg;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_tgtiporeg;
  ...
  public static String[] m_EntityTables = {"cgo_tgtiporeg"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'TRCODGIO':TRCODGIO,'m_Detail':{'TRTIPREG':TRTIPREG,'TRDESREG':TRDESREG"+FoundlingChildrenList("ardt_cgo_tgtiporeg",true,true)+"}"+FoundlingChildrenList("ardt_cgo_tgtiporeg",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'TRCODGIO':TRCODGIO,'m_Detail':{'TRTIPREG':TRTIPREG,'TRDESREG':TRDESREG"+FoundlingChildrenList("ardt_cgo_tgtiporeg",true,true)+"}"+FoundlingChildrenList("ardt_cgo_tgtiporeg",true,false)+"}";
  public static final String i_ItemSequence = "TRCODGIO,m_Detail[ TRTIPREG TRDESREG"+FoundlingChildrenList("ardt_cgo_tgtiporeg",false,true)+"]"+FoundlingChildrenList("ardt_cgo_tgtiporeg",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_cgo_tgtiporeg"),new String[][]{new String[]{"TRCODGIO","Tipo Gioco","C","3","0","campo","key1","false","false"},new String[]{"TRTIPREG","Tipo Registrazione","C","1","0","campo","key1","true","false"},new String[]{"TRDESREG","Descrizione","C","30","0","campo","key2","true","false"}});
  public static final String i_TrsKeys = ",TRTIPREG";
  ...
  public ardt_cgo_tgtiporegBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_tgtiporeg = p_ContextObject.GetPhName("cgo_tgtiporeg",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_tgtiporeg = p_ContextObject.GetServer("cgo_tgtiporeg");
    m_oWrInfo_cgo_tgtiporeg = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_tgtiporeg",p_ContextObject.GetCompany());
    m_cVirtName_cgo_tgtiporeg = CPSql.ManipulateTablePhName("cgo_tgtiporeg",m_cServer_cgo_tgtiporeg);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_cgo_tgtiporeg",p_ContextObject);
  }
  public void Blank() {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_TRCODGIO(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_TRCODGIO = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_TRTIPREG(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_TRTIPREG = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_TRDESREG(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_TRDESREG = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"TRCODGIO"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_cgo_tgtiporeg","cgo_tgtiporeg",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_TRTIPREG;
      p_TRTIPREG = CPLib.GetProperties(trs_p.getProperty("TRTIPREG"),new Properties());
      Properties p_TRDESREG;
      p_TRDESREG = CPLib.GetProperties(trs_p.getProperty("TRDESREG"),new Properties());
      Properties p_opk_TRTIPREG;
      p_opk_TRTIPREG = CPLib.GetProperties(trs_p.getProperty("opk_TRTIPREG"),new Properties());
      ...
      w_TRCODGIO = CPLib.GetProperty(p,"TRCODGIO",w_TRCODGIO,0);
      ...
      while (CPLib.le(i,rows)) {
        w_TRTIPREG = "";
        w_TRTIPREG = CPLib.GetProperty(p_TRTIPREG,"",w_TRTIPREG,i);
        w_TRDESREG = "";
        w_TRDESREG = CPLib.GetProperty(p_TRDESREG,"",w_TRDESREG,i);
        opk_TRTIPREG = CPLib.GetProperty(p_opk_TRTIPREG,"","",i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"TRCODGIO")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"TRTIPREG")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"TRDESREG")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_cgo_tgtiporeg",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_cgo_tgtiporeg",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_cgo_tgtiporeg",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_tgtiporeg",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_cgo_tgtiporeg"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_cgo_tgtiporeg\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_TRTIPREG;
    p_TRTIPREG = new Properties();
    Properties p_TRDESREG;
    p_TRDESREG = new Properties();
    Properties p_opk_TRTIPREG;
    p_opk_TRTIPREG = new Properties();
    Properties p_m_nRowStatus;
    p_m_nRowStatus = new Properties();
    Properties p_m_cOldRowCPCCCHK;
    p_m_cOldRowCPCCCHK = new Properties();
    CPLib.PutProperty(p,"TRCODGIO",w_TRCODGIO,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_TRTIPREG,"",w_TRTIPREG,trsrow);
      CPLib.PutProperty(p_TRDESREG,"",w_TRDESREG,trsrow);
      CPLib.PutProperty(p_opk_TRTIPREG,"",opk_TRTIPREG,trsrow);
    ...
    trs_p.setProperty("TRTIPREG",CPLib.ToProperties(p_TRTIPREG));
    trs_p.setProperty("TRDESREG",CPLib.ToProperties(p_TRDESREG));
    trs_p.setProperty("opk_TRTIPREG",CPLib.ToProperties(p_opk_TRTIPREG));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_tgtiporeg"+"\\"+CPLib.ToCPStr(p_Caller.GetString("TRCODGIO","C",3,0));
  }
  public String RowPrimaryKey() {
    return "cgo_tgtiporeg"+"\\"+CPLib.ToCPStr(w_TRTIPREG);
  }
  ...
  protected void TrsToWork() {
    w_TRTIPREG= m_oTrs.get(m_nCurrentRow).w_TRTIPREG;
    w_TRDESREG= m_oTrs.get(m_nCurrentRow).w_TRDESREG;
    opk_TRTIPREG= m_oTrs.get(m_nCurrentRow).opk_TRTIPREG;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_TRTIPREG=w_TRTIPREG;
    m_oTrs.get(m_nCurrentRow).w_TRDESREG=w_TRDESREG;
    m_oTrs.get(m_nCurrentRow).opk_TRTIPREG=opk_TRTIPREG;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_TRTIPREG=w_TRTIPREG;
    m_oDeletedRows.get(l_nRows).w_TRDESREG=w_TRDESREG;
    m_oDeletedRows.get(l_nRows).opk_TRTIPREG=opk_TRTIPREG;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_TRTIPREG= m_oDeletedRows.get(l_RowNumberToSet).w_TRTIPREG;
    w_TRDESREG= m_oDeletedRows.get(l_RowNumberToSet).w_TRDESREG;
    opk_TRTIPREG= m_oDeletedRows.get(l_RowNumberToSet).opk_TRTIPREG;
