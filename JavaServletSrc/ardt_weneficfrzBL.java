...
public class ardt_weneficfrzBL extends ardt_weneficfrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_weneficfrz";
  ...
  public CPPhTableWrInfo m_oWrInfo_weneficfrz;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_weneficfrz;
  ...
  public static String[] m_EntityTables = {"weneficfrz"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_CAB':C_CAB,'C_PRV':C_PRV,'C_IND':C_IND,'C_STA':C_STA,'C_CAP':C_CAP"+FoundlingChildrenList("ardt_weneficfrz",true,true)+"}"+FoundlingChildrenList("ardt_weneficfrz",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_CAB':C_CAB,'C_PRV':C_PRV,'C_IND':C_IND,'C_STA':C_STA,'xdessta':xdessta,'C_CAP':C_CAP"+FoundlingChildrenList("ardt_weneficfrz",true,true)+"}"+FoundlingChildrenList("ardt_weneficfrz",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG C_RAG C_CTA C_CAB C_PRV C_IND C_STA C_CAP"+FoundlingChildrenList("ardt_weneficfrz",false,true)+"]"+FoundlingChildrenList("ardt_weneficfrz",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_weneficfrz"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"C_RAG","","C","70","0","campo","nokey","true","false"},new String[]{"C_CTA","","C","30","0","campo","nokey","true","false"},new String[]{"C_CAB","","C","6","0","campo","nokey","true","false"},new String[]{"C_PRV","","C","2","0","campo","nokey","true","false"},new String[]{"C_IND","","C","35","0","campo","nokey","true","false"},new String[]{"C_STA","","C","3","0","campo","nokey","true","false"},new String[]{"C_CAP","","C","5","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_weneficfrzBL (CPContext p_ContextObject) {
    ...
    m_cPhName_weneficfrz = p_ContextObject.GetPhName("weneficfrz",p_ContextObject.GetCompany(),false);
    m_cServer_weneficfrz = p_ContextObject.GetServer("weneficfrz");
    m_oWrInfo_weneficfrz = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"weneficfrz",p_ContextObject.GetCompany());
    m_cVirtName_weneficfrz = CPSql.ManipulateTablePhName("weneficfrz",m_cServer_weneficfrz);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_weneficfrz",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_weneficfrz","weneficfrz",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_weneficfrz",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_weneficfrz",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_weneficfrz",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_weneficfrz",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_weneficfrz"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_weneficfrz\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "weneficfrz"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "weneficfrz"+"\\"+CPLib.ToCPStr(w_CODSOG)+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
