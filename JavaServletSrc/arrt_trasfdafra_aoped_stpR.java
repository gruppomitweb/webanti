...
// * --- Fine Area Manuale
public class arrt_trasfdafra_aoped_stpR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_trasfdafra_aoped_stpR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_trasfdafra_aoped_stp",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_trasfdafra_aoped_stp";
  ...
  void Main() throws Exception {
    CPResultSet Cursor_qbe_trasfraz_conta=null;
    ...
    try {
      ...
      /* _conta Numeric(10, 0) */
      // * --- Select from qbe_trasfraz_conta
      if (Cursor_qbe_trasfraz_conta!=null)
        Cursor_qbe_trasfraz_conta.Close();
      Cursor_qbe_trasfraz_conta = new VQRHolder("qbe_trasfraz_conta",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_trasfraz_conta.Eof())) {
        /* _conta := qbe_trasfraz_conta->TOTALE */
        _conta = CPLib.Round(Cursor_qbe_trasfraz_conta.GetDouble("TOTALE"),0);
        Cursor_qbe_trasfraz_conta.Next();
      }
      m_cConnectivityError = Cursor_qbe_trasfraz_conta.ErrorMessage();
      Cursor_qbe_trasfraz_conta.Close();
      // * --- End Select
      /* If _conta = 0 */
      if (CPLib.eqr(_conta,0)) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arrt_trasfdafra_aoped_stp",111,"0000000C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_0000000C(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL("XXXXXXXXXXX","?",0,0,m_cServer)+", ";
        ...
        f.SetParameter("_datafin",w_ADatOpe);
        f.SetParameter("_dataini",w_DaDatOpe);
        f.SetParameter("ReportName","arrp_trasfraz_stp_no.vrp");
        f.SetParameter("m_cParameterSequence","hideCover"+","+"hideLanguage"+","+"hideSettings"+","+"formatTypes"+","+"DescAzi"+","+"_datafin"+","+"_dataini"+","+"ReportName");
        f.SetParameter("m_cMode","hyperlink");
        throw f;
      } else { // Else
        /* Stop arrp_trasfraz_stp.vrp */
        Forward f;
        f=new Forward("Report",false,this,Forward.Start,false);
        f.SetParameter("hideCover",true);
        f.SetParameter("hideLanguage",true);
        ...
        f.SetParameter("_datafin",w_ADatOpe);
        f.SetParameter("_dataini",w_DaDatOpe);
        f.SetParameter("ReportName","arrp_trasfraz_stp.vrp");
        f.SetParameter("m_cParameterSequence","hideCover"+","+"hideLanguage"+","+"hideSettings"+","+"formatTypes"+","+"DescAzi"+","+"_datafin"+","+"_dataini"+","+"ReportName");
        f.SetParameter("m_cMode","hyperlink");
        throw f;
      } // End If
  ...
  public static arrt_trasfdafra_aoped_stpR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_trasfdafra_aoped_stpR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_trasfraz_conta,
  public static final String m_cVQRList = ",qbe_trasfraz_conta,";
  // ENTITY_BATCHES: ,
