...
public class armt_personbo_aggBL extends armt_personbo_aggWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_personbo_agg";
  ...
  public String m_cVirtName_personbo_agg;
  ...
  public armt_personbo_aggBL (CPContext p_ContextObject) {
    ...
    m_cPhName_personbo_agg = p_ContextObject.GetPhName("personbo_agg",p_ContextObject.GetCompany(),false);
    ...
    m_cVirtName_personbo_agg = CPSql.ManipulateTablePhName("personbo_agg",m_cServer_personbo_agg);
    ...
    m_MNTs = CPLib.MNTChilds("armt_personbo_agg",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_personbo_agg","personbo_agg",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_personbo_agg",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_personbo_agg",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_personbo_agg",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_personbo_agg"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_personbo_agg\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "personbo_agg"+"\\"+CPLib.ToCPStr(p_Caller.GetString("CONNES","C",16,0));
  }
