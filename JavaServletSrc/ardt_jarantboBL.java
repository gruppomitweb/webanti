...
public class ardt_jarantboBL extends ardt_jarantboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_jarantbo";
  ...
  public CPPhTableWrInfo m_oWrInfo_jarantbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_jarantbo;
  ...
  public static String[] m_EntityTables = {"jarantbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'xRagSoc':xRagSoc"+FoundlingChildrenList("ardt_jarantbo",true,true)+"}"+FoundlingChildrenList("ardt_jarantbo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'IDBASE':IDBASE,'xRagSoc':xRagSoc"+FoundlingChildrenList("ardt_jarantbo",true,true)+"}"+FoundlingChildrenList("ardt_jarantbo",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER DATAINI DATAFINE xRagSoc"+FoundlingChildrenList("ardt_jarantbo",false,true)+"]"+FoundlingChildrenList("ardt_jarantbo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_jarantbo"),new String[][]{new String[]{"RAPPORTO","Rapporto","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","Garantito","C","16","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"},new String[]{"xRagSoc","Ragione Sociale","C","70","0","variabile","nokey","true","false"}});
  ...
  public ardt_jarantboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_jarantbo = p_ContextObject.GetPhName("jarantbo",p_ContextObject.GetCompany(),false);
    m_cServer_jarantbo = p_ContextObject.GetServer("jarantbo");
    m_oWrInfo_jarantbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"jarantbo",p_ContextObject.GetCompany());
    m_cVirtName_jarantbo = CPSql.ManipulateTablePhName("jarantbo",m_cServer_jarantbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_jarantbo",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_FPBSSVXDQL() {
    return Link_FPBSSVXDQL("Full");
  }
  protected boolean Link_FPBSSVXDQL(String p_cType) {
  ...
  public boolean Set_xRagSoc(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_xRagSoc = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_jarantbo","jarantbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var.comment",zeroSplit.split("Garantito\u0000Ragione Sociale",-1));
    ...
    map.put("property.value",zeroSplit.split("personbo\u0000false\u0000false\u00002\u00000\u0000armt_personbo_age\u0000false\u0000false\u0000Soggetti\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_jarantbo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_jarantbo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_jarantbo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_jarantbo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_jarantbo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_jarantbo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "jarantbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "jarantbo"+"\\"+CPLib.ToCPStr(w_CODINTER);
  }
