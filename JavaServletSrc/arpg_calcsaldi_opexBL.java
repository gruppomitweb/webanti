...
public class arpg_calcsaldi_opexBL extends arpg_calcsaldi_opexWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_calcsaldi_opex";
  ...
  public static final String i_StateStructure = "{'annorif':annorif,'valuta':valuta,'flgmod':flgmod,'flgazz':flgazz,'ndgcli':ndgcli,'flgmopx':flgmopx}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gTipInter':gTipInter,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gFlgWU':gFlgWU,'annorif':annorif,'valuta':valuta,'xdesval':xdesval,'flgmod':flgmod,'flgazz':flgazz,'ndgcli':ndgcli,'xragsoc':xragsoc,'flgmopx':flgmopx}";
  public static final String i_ItemSequence = "annorif,valuta,flgmod,flgazz,ndgcli,flgmopx";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"annorif","Anno di riferimento","N","4","0","variabile","nokey","false","true"},new String[]{"valuta","Valuta Prevalente","C","3","0","variabile","nokey","false","false"},new String[]{"flgmod","","C","1","0","variabile","nokey","false","false"},new String[]{"flgazz","","C","1","0","variabile","nokey","false","false"},new String[]{"ndgcli","Calcola Saldi solo per NDG","C","16","0","variabile","nokey","false","false"},new String[]{"flgmopx","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_calcsaldi_opexBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_calcsaldi_opex","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
