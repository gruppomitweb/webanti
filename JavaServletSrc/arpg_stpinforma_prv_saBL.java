...
public class arpg_stpinforma_prv_saBL extends arpg_stpinforma_prv_saWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpinforma_prv_sa";
  ...
  public static final String i_StateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'OrderBy':OrderBy,'tipstp':tipstp}";
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'OrderBy':OrderBy,'tipstp':tipstp,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'c_dadata':c_dadata,'c_adata':c_adata}";
  public static final String i_ItemSequence = "DaDatOpe,ADatOpe,daCodCli,aCodCli,OrderBy,tipstp";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"OrderBy","","C","7","0","variabile","nokey","false","false"},new String[]{"tipstp","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_stpinforma_prv_saBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpinforma_prv_sa","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
