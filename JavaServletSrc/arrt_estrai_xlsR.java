...
// * --- Fine Area Manuale
public class arrt_estrai_xlsR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_estrai_xlsR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_estrai_xls",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("pLstSta",p_cVarName)) {
      return pLstSta;
    }
    if (CPLib.eqr("pLstPrv",p_cVarName)) {
      return pLstPrv;
    }
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* w_cdadata Char(8) // Data Inizio Char */
      /* w_c_adata Char(8) // Data Fine Char */
      /* w_cDIP Char(6) // Agenzia */
      ...
      /* w_cMTCN Char(10) // MTCN Operazione */
      /* w_cCODFISC Char(16) // Codice Fiscale */
      ...
      /* w_tipofile Char(1) // Tipo Import */
      /* w_flgsto Char(1) // Dati Storici Soggetto */
      /* w_tipoout Char(1) // Tipo Output */
      /* w_opesel Char(1) // Operazioni */
      /* w_frzsel Char(1) // Frazionate */
      /* w_attive Char(1) // Solo movimenti Attivi */
      /* w_destfold Char(128) // Cartella Destinazione */
      /* pAzienda Char(10) // Azienda Riferimento */
      /* pPath Char(80) // Path Applicazione */
      /* pMese Char(1) // Suddividi in un file per mese */
      /* pNCF Char(1) // No CF Fittizi */
      /* pSegno Char(1) // Segno Operazioni */
      /* pLstSta Char(128) // Stati Destinazione */
      /* pLstPrv Char(128) // Provincie Agenzie */
      /* pImporto Numeric(15, 2) // Importo minimo */
      ...
      /* pmcParametri.AppendBlank() // mc Parametri */
      pmcParametri.AppendBlank();
      /* pmcParametri.pTipo := pTipo // mc Parametri */
      pmcParametri.row.pTipo = pTipo;
      /* pmcParametri.w_dadata := w_dadata // mc Parametri */
      pmcParametri.row.w_dadata = w_dadata;
      /* pmcParametri.w_adata := w_adata // mc Parametri */
      pmcParametri.row.w_adata = w_adata;
      /* pmcParametri.w_cdadata := w_cdadata // mc Parametri */
      pmcParametri.row.w_cdadata = w_cdadata;
      /* pmcParametri.w_c_adata := w_c_adata // mc Parametri */
      pmcParametri.row.w_c_adata = w_c_adata;
      /* pmcParametri.w_cDIP := w_cDIP // mc Parametri */
      pmcParametri.row.w_cDIP = w_cDIP;
      /* pmcParametri.w_xdesdip := w_xdesdip // mc Parametri */
      pmcParametri.row.w_xdesdip = w_xdesdip;
      /* pmcParametri.w_ragosc := w_ragosc // mc Parametri */
      pmcParametri.row.w_ragosc = w_ragosc;
      /* pmcParametri.w_citnas := w_citnas // mc Parametri */
      pmcParametri.row.w_citnas = w_citnas;
      /* pmcParametri.w_stanas := w_stanas // mc Parametri */
      pmcParametri.row.w_stanas = w_stanas;
      /* pmcParametri.w_datnas := w_datnas // mc Parametri */
      pmcParametri.row.w_datnas = w_datnas;
      /* pmcParametri.w_cMTCN := w_cMTCN // mc Parametri */
      pmcParametri.row.w_cMTCN = w_cMTCN;
      /* pmcParametri.w_cCODFISC := w_cCODFISC // mc Parametri */
      pmcParametri.row.w_cCODFISC = w_cCODFISC;
      /* pmcParametri.w_ragben := w_ragben // mc Parametri */
      pmcParametri.row.w_ragben = w_ragben;
      /* pmcParametri.w_staben := w_staben // mc Parametri */
      pmcParametri.row.w_staben = w_staben;
      /* pmcParametri.w_codmag := w_codmag // mc Parametri */
      pmcParametri.row.w_codmag = w_codmag;
      /* pmcParametri.w_connes := w_connes // mc Parametri */
      pmcParametri.row.w_connes = w_connes;
      /* pmcParametri.w_nomefile := w_nomefile // mc Parametri */
      pmcParametri.row.w_nomefile = w_nomefile;
      /* pmcParametri.w_tipofile := w_tipofile // mc Parametri */
      pmcParametri.row.w_tipofile = w_tipofile;
      /* pmcParametri.w_flgsto := w_flgsto // mc Parametri */
      pmcParametri.row.w_flgsto = w_flgsto;
      /* pmcParametri.w_tipoout := w_tipoout // mc Parametri */
      pmcParametri.row.w_tipoout = w_tipoout;
      /* pmcParametri.w_opesel := w_opesel // mc Parametri */
      pmcParametri.row.w_opesel = w_opesel;
      /* pmcParametri.w_frzsel := w_frzsel // mc Parametri */
      pmcParametri.row.w_frzsel = w_frzsel;
      /* pmcParametri.w_attive := w_attive // mc Parametri */
      pmcParametri.row.w_attive = w_attive;
      /* pmcParametri.w_destfold := w_destfold // mc Parametri */
      pmcParametri.row.w_destfold = w_destfold;
      /* pmcParametri.w_flgmese := pMese // mc Parametri */
      pmcParametri.row.w_flgmese = pMese;
      /* pmcParametri.w_flgncf := pNCF // mc Parametri */
      pmcParametri.row.w_flgncf = pNCF;
      /* pmcParametri.w_flgsegno := pSegno // mc Parametri */
      pmcParametri.row.w_flgsegno = pSegno;
      /* pmcParametri.w_lststa := pLstSta // mc Parametri */
      pmcParametri.row.w_lststa = pLstSta;
      /* pmcParametri.w_lstprv := pLstPrv // mc Parametri */
      pmcParametri.row.w_lstprv = pLstPrv;
      /* pmcParametri.w_importo := pImporto // mc Parametri */
      pmcParametri.row.w_importo = pImporto;
      /* pmcParametri.SaveRow() // mc Parametri */
      pmcParametri.SaveRow();
          ...
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              ...
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_estrai_xls: query on tbcauana returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
        ...
        Cursor_tbcausin.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_estrai_xls: query on tbcausin returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
        ...
        Cursor_tbstati.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_estrai_xls: query on tbstati returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
        ...
        Cursor_tbtipdoc.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_estrai_xls: query on tbtipdoc returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
        ...
        Cursor_tbtipreg.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arrt_estrai_xls: query on tbtipreg returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
      ...
      if (CPLib.eqr(pmcParametri.row.pTipo,"B")) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"000000E2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(pmcParametri.row.w_frzsel,"S")) {
        ...
        _h000000EA.Set("cdadata",pmcParametri.row.w_cdadata);
        _h000000EA.Set("c_adata",pmcParametri.row.w_c_adata);
        _h000000EA.Set("cDIP",pmcParametri.row.w_cDIP);
        _h000000EA.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
        _h000000EA.Set("cMTCN",pmcParametri.row.w_cMTCN);
        _h000000EA.Set("codmag",pmcParametri.row.w_codmag);
        _h000000EA.Set("_mstato",_mstato);
        _h000000EA.Set("_lststati",pmcParametri.row.w_lststa);
        _h000000EA.Set("_lstprov",pmcParametri.row.w_lstprv);
        _h000000EA.Set("connes",pmcParametri.row.w_connes);
        _h000000EA.Set("_importo",_importo);
        if (Cursor_qbe_estrai_frz_lim!=null)
          Cursor_qbe_estrai_frz_lim.Close();
        Cursor_qbe_estrai_frz_lim = new VQRHolder("qbe_estrai_frz_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000EA,true).GetResultSet(m_Ctx);
      ...
      if (CPLib.eqr(pmcParametri.row.w_opesel,"S")) {
        ...
        SPBridge.HMCaller _h000000ED;
        _h000000ED = new SPBridge.HMCaller();
        _h000000ED.Set("m_cVQRList",m_cVQRList);
        _h000000ED.Set("cdadata",pmcParametri.row.w_cdadata);
        _h000000ED.Set("c_adata",pmcParametri.row.w_c_adata);
        _h000000ED.Set("cDIP",pmcParametri.row.w_cDIP);
        _h000000ED.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
        _h000000ED.Set("cMTCN",pmcParametri.row.w_cMTCN);
        _h000000ED.Set("codmag",pmcParametri.row.w_codmag);
        _h000000ED.Set("_mstato",_mstato);
        _h000000ED.Set("_lststati",pmcParametri.row.w_lststa);
        _h000000ED.Set("_lstprov",pmcParametri.row.w_lstprv);
        _h000000ED.Set("connes",pmcParametri.row.w_connes);
        _h000000ED.Set("_importo",_importo);
        if (Cursor_qbe_estrai_ope_lim!=null)
          Cursor_qbe_estrai_ope_lim.Close();
        Cursor_qbe_estrai_ope_lim = new VQRHolder("qbe_estrai_ope_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000000ED,true).GetResultSet(m_Ctx);
      ...
      // Begin Transaction
      m_Sql.RequireTransaction();
      double nTry000000F6status;
      nTry000000F6status = m_Sql.GetTransactionStatus();
      String cTry000000F6msg;
      cTry000000F6msg = m_Sql.TransactionErrorMessage();
      try {
        ...
        if (CPLib.eqr(pmcParametri.row.pTipo,"B")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"processi",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000115")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        if (CPLib.eqr(pmcParametri.row.pTipo,"B")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"processi",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"0000011B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"PRDOSTOP = "+CPLib.ToSQL(CPLib.DateTime(),"T",14,0)+", ";
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry000000F6status,0)) {
          m_Sql.SetTransactionStatus(nTry000000F6status,cTry000000F6msg);
        }
      }
  ...
  void Page_3() throws Exception {
    ...
    /* fhand := FileLibMit.OpenWrite(_nfile) */
    fhand = FileLibMit.OpenWrite(_nfile);
  ...
  void Page_5() throws Exception {
    ...
    campi[20]="AUTORITA DI RILASCIO";
    campi[21]="STATO DI RESIDENZA";
    campi[22]="CITTA DI RESIDENZA";
    campi[23]="PROVINCIA DI RESIDENZA";
    campi[24]="INDIRIZZO RESIDENZA";
    campi[25]="TIPO OPERAZIONE";
    campi[26]="CAUSALE ANALITICA";
    campi[27]="CAUSALE SINTETICA";
    campi[28]="SEGNO OPERAZIONE";
    campi[29]="DATA OPERAZIONE";
    campi[30]="NOMINATIVO CONTROPARTE";
    campi[31]="STATO CONTROPARTE";
    campi[32]="N. OPERAZIONE";
    campi[33]="STATO REGISTRAZIONE";
    campi[34]="CODICE RAPPORTO";
    campi[35]="DATA REGISTRAZIONE";
    campi[36]="FRAZIONATA/OPERAZIONE";
    /* If gFlgWU='S' */
    if (CPLib.eqr(gFlgWU,"S")) {
      /* If pmcParametri.w_flgncf='N' */
      if (CPLib.eqr(pmcParametri.row.w_flgncf,"N")) {
        // CAmpi WU
        campi[37]="CODICE FISCALE FITTIZIO";
        campi[38]="MTCN";
      ...
      if (CPLib.eqr(pmcParametri.row.w_flgncf,"N")) {
        // CAmpi No WU
        campi[37]="CODICE FISCALE FITTIZIO";
        campi[38]="RIFERIMENTO";
      } else { // Else
        // CAmpi No WU
        campi[37]="RIFERIMENTO";
      } // End If
    } // End If
  ...
  void Page_6() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(pmcParametri.row.w_tipoout,"Z")) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000185")+"delete from "+m_oWrInfo.GetTableWriteName();
        m_cSql = m_cSql+" where ";
        ...
        SPBridge.HMCaller _h00000187;
        _h00000187 = new SPBridge.HMCaller();
        _h00000187.Set("m_cVQRList",m_cVQRList);
        _h00000187.Set("tbname","dw_operazioni");
        _h00000187.Set("fldname","PROGOPE");
        if (Cursor_qbe_tab_mmc!=null)
          Cursor_qbe_tab_mmc.Close();
        Cursor_qbe_tab_mmc = new VQRHolder("qbe_tab_mmc",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000187,true).GetResultSet(m_Ctx);
      ...
      if (CPLib.Empty(CPLib.LRTrim(pmcParametri.row.w_nomefile)) && CPLib.Empty(pmcParametri.row.w_cCODFISC)) {
        ...
        if (CPLib.Empty(pmcParametri.row.w_ragosc) && CPLib.Empty(pmcParametri.row.w_citnas) && CPLib.Empty(pmcParametri.row.w_stanas) && CPLib.Empty(pmcParametri.row.w_datnas) && CPLib.Empty(pmcParametri.row.w_connes)) {
          ...
          if (CPLib.eqr(pmcParametri.row.w_frzsel,"S")) {
            ...
            _h00000191.Set("cdadata",_cfromdate);
            _h00000191.Set("c_adata",_c_todate);
            _h00000191.Set("cDIP",pmcParametri.row.w_cDIP);
            _h00000191.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
            _h00000191.Set("cMTCN",pmcParametri.row.w_cMTCN);
            _h00000191.Set("codmag",pmcParametri.row.w_codmag);
            _h00000191.Set("_mstato",_mstato);
            _h00000191.Set("_lststati",pmcParametri.row.w_lststa);
            _h00000191.Set("_lstprov",pmcParametri.row.w_lstprv);
            _h00000191.Set("_importo",_importo);
            if (Cursor_qbe_estrai_frz_lim!=null)
              Cursor_qbe_estrai_frz_lim.Close();
            Cursor_qbe_estrai_frz_lim = new VQRHolder("qbe_estrai_frz_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000191,true).GetResultSet(m_Ctx);
            while ( ! (Cursor_qbe_estrai_frz_lim.Eof())) {
            ...
            while (CPLib.le(_contacicli,_cicli)) {
              ...
              if (CPLib.ge(_top,_min)) {
                ...
                SPBridge.HMCaller _h000001A5;
                _h000001A5 = new SPBridge.HMCaller();
                _h000001A5.Set("m_cVQRList",m_cVQRList);
                _h000001A5.Set("cdadata",_cfromdate);
                _h000001A5.Set("c_adata",_c_todate);
                _h000001A5.Set("cDIP",pmcParametri.row.w_cDIP);
                _h000001A5.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
                _h000001A5.Set("cMTCN",pmcParametri.row.w_cMTCN);
                _h000001A5.Set("codmag",pmcParametri.row.w_codmag);
                _h000001A5.Set("_bottom",_bottom);
                _h000001A5.Set("_top",_top);
                _h000001A5.Set("_mstato",_mstato);
                _h000001A5.Set("_lststati",pmcParametri.row.w_lststa);
                _h000001A5.Set("_lstprov",pmcParametri.row.w_lstprv);
                _h000001A5.Set("_importo",_importo);
                if (Cursor_qbe_estrai_frz!=null)
                  Cursor_qbe_estrai_frz.Close();
                Cursor_qbe_estrai_frz = new VQRHolder("qbe_estrai_frz",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000001A5,true).GetResultSet(m_Ctx);
                while ( ! (Cursor_qbe_estrai_frz.Eof())) {
                  ...
                  if (CPLib.eqr(pmcParametri.row.w_tipoout,"E")) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"dw_operazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"000001F4")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.eqr(pmcParametri.row.w_opesel,"S")) {
            ...
            _tot = CPLib.Round(0,0);
            // * --- Select from qbe_estrai_ope_lim
            SPBridge.HMCaller _h000001FC;
            _h000001FC = new SPBridge.HMCaller();
            _h000001FC.Set("m_cVQRList",m_cVQRList);
            _h000001FC.Set("cdadata",_cfromdate);
            _h000001FC.Set("c_adata",_c_todate);
            _h000001FC.Set("cDIP",pmcParametri.row.w_cDIP);
            _h000001FC.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
            _h000001FC.Set("cMTCN",pmcParametri.row.w_cMTCN);
            _h000001FC.Set("codmag",pmcParametri.row.w_codmag);
            _h000001FC.Set("_mstato",_mstato);
            _h000001FC.Set("_lststati",pmcParametri.row.w_lststa);
            _h000001FC.Set("_lstprov",pmcParametri.row.w_lstprv);
            _h000001FC.Set("_importo",_importo);
            if (Cursor_qbe_estrai_ope_lim!=null)
              Cursor_qbe_estrai_ope_lim.Close();
            Cursor_qbe_estrai_ope_lim = new VQRHolder("qbe_estrai_ope_lim",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000001FC,true).GetResultSet(m_Ctx);
            while ( ! (Cursor_qbe_estrai_ope_lim.Eof())) {
            ...
            while (CPLib.le(_contacicli,_cicli)) {
              ...
              if (CPLib.ge(_top,_min)) {
                ...
                SPBridge.HMCaller _h00000210;
                _h00000210 = new SPBridge.HMCaller();
                _h00000210.Set("m_cVQRList",m_cVQRList);
                _h00000210.Set("cdadata",_cfromdate);
                _h00000210.Set("c_adata",_c_todate);
                _h00000210.Set("cDIP",pmcParametri.row.w_cDIP);
                _h00000210.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
                _h00000210.Set("cMTCN",pmcParametri.row.w_cMTCN);
                _h00000210.Set("codmag",pmcParametri.row.w_codmag);
                _h00000210.Set("_bottom",_bottom);
                _h00000210.Set("_top",_top);
                _h00000210.Set("_mstato",_mstato);
                _h00000210.Set("_lststati",pmcParametri.row.w_lststa);
                _h00000210.Set("_lstprov",pmcParametri.row.w_lstprv);
                _h00000210.Set("_importo",_importo);
                if (Cursor_qbe_estrai_ope!=null)
                  Cursor_qbe_estrai_ope.Close();
                Cursor_qbe_estrai_ope = new VQRHolder("qbe_estrai_ope",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000210,true).GetResultSet(m_Ctx);
                while ( ! (Cursor_qbe_estrai_ope.Eof())) {
                  ...
                  if (CPLib.eqr(pmcParametri.row.w_tipoout,"E")) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"dw_operazioni",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"0000025F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          if (CPLib.Empty(CPLib.LRTrim(pmcParametri.row.w_connes))) {
            ...
            _h00000265.Set("ragosc",_ragsoc);
            _h00000265.Set("citnas",pmcParametri.row.w_citnas);
            _h00000265.Set("datnas",pmcParametri.row.w_datnas);
            _h00000265.Set("stanas",pmcParametri.row.w_stanas);
            if (Cursor_qbe_sele_sogg!=null)
              Cursor_qbe_sele_sogg.Close();
            Cursor_qbe_sele_sogg = new VQRHolder("qbe_sele_sogg",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000265,true).GetResultSet(m_Ctx);
            while ( ! (Cursor_qbe_sele_sogg.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000266")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_newpers",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000267")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000267(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
        ...
        if ( ! (CPLib.Empty(pmcParametri.row.w_nomefile))) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"0000026B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(pmcParametri.row.w_tipofile,"1")) {
          ...
          while ( ! (Cursor_qbe_sele_sogg2.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_newpers",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000270")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
    ...
    while (CPLib.lt(_i,conta)) {
      ...
      while (rows.hasNext()) {
        ...
        if (( ! (CPLib.Empty(CPLib.LRTrim(_mtcn))) && CPLib.eqr(pmcParametri.row.w_tipofile,"1")) || ( ! (CPLib.Empty(CPLib.LRTrim(codfisc))) && CPLib.eqr(pmcParametri.row.w_tipofile,"2"))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_mtcn_cf",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000284")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  void Page_8() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(pmcParametri.row.w_frzsel,"S")) {
        ...
        _h00000288.Set("cdadata",_cfromdate);
        _h00000288.Set("c_adata",_c_todate);
        _h00000288.Set("cDIP",pmcParametri.row.w_cDIP);
        _h00000288.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
        _h00000288.Set("cMTCN",pmcParametri.row.w_cMTCN);
        _h00000288.Set("codmag",pmcParametri.row.w_codmag);
        _h00000288.Set("_mstato",_mstato);
        _h00000288.Set("_lststati",pmcParametri.row.w_lststa);
        _h00000288.Set("_lstprov",pmcParametri.row.w_lstprv);
        _h00000288.Set("_importo",_importo);
        if (Cursor_qbe_estrai_frz_sog!=null)
          Cursor_qbe_estrai_frz_sog.Close();
        Cursor_qbe_estrai_frz_sog = new VQRHolder("qbe_estrai_frz_sog",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000288,true).GetResultSet(m_Ctx);
        if ( ! (Cursor_qbe_estrai_frz_sog.Eof())) {
          while ( ! (Cursor_qbe_estrai_frz_sog.Eof())) {
            ...
            if (CPLib.eqr(pmcParametri.row.w_tipoout,"E")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"dw_operazioni",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"000002D5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(pmcParametri.row.w_opesel,"S")) {
        ...
        SPBridge.HMCaller _h000002D7;
        _h000002D7 = new SPBridge.HMCaller();
        _h000002D7.Set("m_cVQRList",m_cVQRList);
        _h000002D7.Set("cdadata",_cfromdate);
        _h000002D7.Set("c_adata",_c_todate);
        _h000002D7.Set("cDIP",pmcParametri.row.w_cDIP);
        _h000002D7.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
        _h000002D7.Set("cMTCN",pmcParametri.row.w_cMTCN);
        _h000002D7.Set("codmag",pmcParametri.row.w_codmag);
        _h000002D7.Set("_mstato",_mstato);
        _h000002D7.Set("_lststati",pmcParametri.row.w_lststa);
        _h000002D7.Set("_lstprov",pmcParametri.row.w_lstprv);
        _h000002D7.Set("_importo",_importo);
        if (Cursor_qbe_estrai_ope_sog!=null)
          Cursor_qbe_estrai_ope_sog.Close();
        Cursor_qbe_estrai_ope_sog = new VQRHolder("qbe_estrai_ope_sog",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000002D7,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_estrai_ope_sog.Eof())) {
          ...
          /* _coddip := qbe_estrai_ope_sog->AGACCODE */
          _coddip = Cursor_qbe_estrai_ope_sog.GetString("AGACCODE");
          ...
          if (CPLib.eqr(pmcParametri.row.w_tipoout,"E")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"dw_operazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000324")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000324(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_ctot,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(_sqr,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(_coddip,"?",0,0,m_cServer)+", ";
  ...
  void Page_9() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(pmcParametri.row.w_frzsel,"S")) {
        ...
        SPBridge.HMCaller _h00000326;
        _h00000326 = new SPBridge.HMCaller();
        _h00000326.Set("m_cVQRList",m_cVQRList);
        _h00000326.Set("cdadata",_cfromdate);
        _h00000326.Set("c_adata",_c_todate);
        _h00000326.Set("cDIP",pmcParametri.row.w_cDIP);
        _h00000326.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
        _h00000326.Set("cMTCN",pmcParametri.row.w_cMTCN);
        _h00000326.Set("codmag",pmcParametri.row.w_codmag);
        _h00000326.Set("_mstato",_mstato);
        _h00000326.Set("_lststati",pmcParametri.row.w_lststa);
        _h00000326.Set("_lstprov",pmcParametri.row.w_lstprv);
        _h00000326.Set("_importo",_importo);
        if (Cursor_qbe_estrai_frz_mtcn!=null)
          Cursor_qbe_estrai_frz_mtcn.Close();
        Cursor_qbe_estrai_frz_mtcn = new VQRHolder("qbe_estrai_frz_mtcn",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000326,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_estrai_frz_mtcn.Eof())) {
          ...
          if (CPLib.eqr(pmcParametri.row.w_tipoout,"E")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"dw_operazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"00000373")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000373(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_ctot,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(_sqr,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(_coddip,"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(pmcParametri.row.w_opesel,"S")) {
        ...
        SPBridge.HMCaller _h00000375;
        _h00000375 = new SPBridge.HMCaller();
        _h00000375.Set("m_cVQRList",m_cVQRList);
        _h00000375.Set("cdadata",_cfromdate);
        _h00000375.Set("c_adata",_c_todate);
        _h00000375.Set("cDIP",pmcParametri.row.w_cDIP);
        _h00000375.Set("cCODFISC",pmcParametri.row.w_cCODFISC);
        _h00000375.Set("cMTCN",pmcParametri.row.w_cMTCN);
        _h00000375.Set("codmag",pmcParametri.row.w_codmag);
        _h00000375.Set("_mstato",_mstato);
        _h00000375.Set("_lststati",pmcParametri.row.w_lststa);
        _h00000375.Set("_lstprov",pmcParametri.row.w_lstprv);
        _h00000375.Set("_importo",_importo);
        if (Cursor_qbe_estrai_ope_mtcn!=null)
          Cursor_qbe_estrai_ope_mtcn.Close();
        Cursor_qbe_estrai_ope_mtcn = new VQRHolder("qbe_estrai_ope_mtcn",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h00000375,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_estrai_ope_mtcn.Eof())) {
          ...
          if (CPLib.eqr(pmcParametri.row.w_tipoout,"E")) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"dw_operazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_estrai_xls",366,"000003C2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_000003C2(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_ctot,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(_sqr,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(_coddip,"?",0,0,m_cServer)+", ";
  ...
  void Page_10() throws Exception {
    ...
    if (CPLib.eqr(gFlgWU,"S")) {
      ...
      if (CPLib.eqr(pmcParametri.row.w_flgncf,"N")) {
        ...
        cell.setCellValue(CPLib.LRTrim(_cfestero));
        cell = row.createCell(38);
        cell.setCellValue(CPLib.LRTrim(_rifimp));
        cell = row.createCell(39);
        cell.setCellValue(CPLib.LRTrim(_rifimp2));
      } else { // Else
        // Scrive riferimento per altri
        cell = row.createCell(37);
        cell.setCellValue(CPLib.LRTrim(_rifimp));
  ...
  void Page_11() throws Exception {
    ...
    /* _file := _file + LibreriaMit.SpacePad(indirizzo,36) */
    _file = _file+LibreriaMit.SpacePad(indirizzo,36);
    /* _file := _file + LibreriaMit.SpacePad(stares,16) */
    _file = _file+LibreriaMit.SpacePad(stares,16);
    ...
    if (CPLib.eqr(gFlgWU,"S")) {
      ...
      _file = _file+LibreriaMit.SpacePad(_mtcn,11);
      /* _file := _file + LibreriaMit.SpacePad(_macage,12) */
      _file = _file+LibreriaMit.SpacePad(_macage,12);
      /* _file := _file + LibreriaMit.SpacePad(_coddip,13) */
      _file = _file+LibreriaMit.SpacePad(_coddip,13);
  ...
  void Page_12() throws Exception {
    ...
    campi[19]=f_datdoc;
    campi[20]=_autril;
    campi[21]=_codstar+"-"+stares;
    campi[22]=citres;
    campi[23]=prvres;
    campi[24]=indirizzo;
    campi[25]=tipope+"-"+_dtipoope;
    campi[26]=cauana+"-"+_dcauana;
    campi[27]=causin+"-"+_dcausin;
    campi[28]=segno;
    campi[29]=f_datope;
    campi[30]=nominativo;
  ...
  void Page_13() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(pmcParametri.row.w_flgsto,"N")) {
        ...
        /* _numsto := arfn_chkspers(_ndg,iif(_stator='1',_datarett,_datareg)) */
        _numsto = arfn_chkspersR.Make(m_Ctx,this).Run(_ndg,(CPLib.eqr(_stator,"1")?_datarett:_datareg));
  ...
  public String RunAsync(String p_pTipo,java.sql.Date p_w_dadata,java.sql.Date p_w_adata,String p_w_cdadata,String p_w_c_adata,String p_w_cDIP,String p_w_xdesdip,String p_w_ragosc,String p_w_citnas,String p_w_stanas,java.sql.Date p_w_datnas,String p_w_cMTCN,String p_w_cCODFISC,String p_w_ragben,String p_w_staben,String p_w_codmag,String p_w_connes,String p_w_nomefile,String p_w_tipofile,String p_w_flgsto,String p_w_tipoout,String p_w_opesel,String p_w_frzsel,String p_w_attive,String p_w_destfold,String p_pAzienda,String p_pPath,String p_pMese,String p_pNCF,String p_pSegno,String p_pLstSta,String p_pLstPrv,double p_pImporto) {
    pTipo = p_pTipo;
    w_dadata = p_w_dadata;
    w_adata = p_w_adata;
    w_cdadata = p_w_cdadata;
    w_c_adata = p_w_c_adata;
    w_cDIP = p_w_cDIP;
    w_xdesdip = p_w_xdesdip;
    w_ragosc = p_w_ragosc;
    w_citnas = p_w_citnas;
    w_stanas = p_w_stanas;
    w_datnas = p_w_datnas;
    w_cMTCN = p_w_cMTCN;
    w_cCODFISC = p_w_cCODFISC;
    w_ragben = p_w_ragben;
    w_staben = p_w_staben;
    w_codmag = p_w_codmag;
    w_connes = p_w_connes;
    ...
    w_flgsto = p_w_flgsto;
    w_tipoout = p_w_tipoout;
    w_opesel = p_w_opesel;
    w_frzsel = p_w_frzsel;
    w_attive = p_w_attive;
    w_destfold = p_w_destfold;
    pAzienda = p_pAzienda;
    pPath = p_pPath;
    pMese = p_pMese;
    pNCF = p_pNCF;
  ...
  public Forward Run(String p_pTipo,java.sql.Date p_w_dadata,java.sql.Date p_w_adata,String p_w_cdadata,String p_w_c_adata,String p_w_cDIP,String p_w_xdesdip,String p_w_ragosc,String p_w_citnas,String p_w_stanas,java.sql.Date p_w_datnas,String p_w_cMTCN,String p_w_cCODFISC,String p_w_ragben,String p_w_staben,String p_w_codmag,String p_w_connes,String p_w_nomefile,String p_w_tipofile,String p_w_flgsto,String p_w_tipoout,String p_w_opesel,String p_w_frzsel,String p_w_attive,String p_w_destfold,String p_pAzienda,String p_pPath,String p_pMese,String p_pNCF,String p_pSegno,String p_pLstSta,String p_pLstPrv,double p_pImporto) {
    pTipo = p_pTipo;
    w_dadata = p_w_dadata;
    w_adata = p_w_adata;
    w_cdadata = p_w_cdadata;
  ...
  public static arrt_estrai_xlsR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_estrai_xlsR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pTipo = CPLib.Space(1);
    ...
    w_cDIP = CPLib.Space(6);
    w_xdesdip = CPLib.Space(30);
    w_ragosc = CPLib.Space(60);
    w_citnas = CPLib.Space(40);
    w_stanas = CPLib.Space(40);
    w_datnas = CPLib.NullDate();
    w_cMTCN = CPLib.Space(10);
    w_cCODFISC = CPLib.Space(16);
    w_ragben = CPLib.Space(60);
    w_staben = CPLib.Space(40);
    w_codmag = CPLib.Space(5);
    w_connes = CPLib.Space(16);
    w_nomefile = CPLib.Space(60);
    w_tipofile = CPLib.Space(1);
    w_flgsto = CPLib.Space(1);
    w_tipoout = CPLib.Space(1);
    w_opesel = CPLib.Space(1);
    w_frzsel = CPLib.Space(1);
    w_attive = CPLib.Space(1);
    w_destfold = CPLib.Space(128);
    pAzienda = CPLib.Space(10);
    pPath = CPLib.Space(80);
    pMese = CPLib.Space(1);
    pNCF = CPLib.Space(1);
    pSegno = CPLib.Space(1);
    pLstSta = CPLib.Space(128);
    pLstPrv = CPLib.Space(128);
    pImporto = 0;
  ...
  public static String[] m_cRunParameterNames={"pTipo","w_dadata","w_adata","w_cdadata","w_c_adata","w_cDIP","w_xdesdip","w_ragosc","w_citnas","w_stanas","w_datnas","w_cMTCN","w_cCODFISC","w_ragben","w_staben","w_codmag","w_connes","w_nomefile","w_tipofile","w_flgsto","w_tipoout","w_opesel","w_frzsel","w_attive","w_destfold","pAzienda","pPath","pMese","pNCF","pSegno","pLstSta","pLstPrv","pImporto"};
  ...
  protected static String GetFieldsName_00000267(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+p_oWrInfo.InsertFields();
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"tmp_newpers",true);
  ...
  protected static String GetFieldsName_00000324(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"PROGOPE,";
    p_cSql = p_cSql+"TIPO,";
    p_cSql = p_cSql+"CODDIP,";
  ...
  protected static String GetFieldsName_00000373(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"PROGOPE,";
    p_cSql = p_cSql+"TIPO,";
    p_cSql = p_cSql+"CODDIP,";
  ...
  protected static String GetFieldsName_000003C2(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"PROGOPE,";
    p_cSql = p_cSql+"TIPO,";
    p_cSql = p_cSql+"CODDIP,";
