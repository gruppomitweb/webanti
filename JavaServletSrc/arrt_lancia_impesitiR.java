...
// * --- Fine Area Manuale
public class arrt_lancia_impesitiR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_impesitiR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_impesiti",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Return  */
    Forward f;
    f=new Forward("arpg_esiti",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_impesitiR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_impesitiR(p_Ctx, p_Caller);
  }
  public void Blank() {
  }
