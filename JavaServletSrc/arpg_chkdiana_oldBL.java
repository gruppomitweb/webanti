...
public class arpg_chkdiana_oldBL extends arpg_chkdiana_oldWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_chkdiana_old";
  ...
  public static final String i_StateStructure = "{'codinter':codinter,'tipinter':tipinter,'codage':codage,'codcli':codcli,'ragben':ragben,'DaData':DaData,'AData':AData,'tipoarch':tipoarch,'flgope':flgope,'flgfrz':flgfrz,'flgrap':flgrap,'tiprap':tiprap,'flgint':flgint,'flgdel':flgdel,'flgsto':flgsto}";
  ...
  public static final String i_ItemSequence = "codinter,tipinter,codage,codcli,ragben,DaData,AData,tipoarch,flgope,flgfrz,flgrap,tiprap,flgint,flgdel,flgsto";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"codinter","","C","11","0","variabile","nokey","false","false"},new String[]{"tipinter","","C","2","0","variabile","nokey","false","false"},new String[]{"codage","Agenzia/Dipendenza:","C","6","0","variabile","nokey","false","false"},new String[]{"codcli","Cliente","C","16","0","variabile","nokey","false","false"},new String[]{"ragben","Beneficiario","C","70","0","variabile","nokey","false","false"},new String[]{"DaData","","D","8","0","variabile","nokey","false","false"},new String[]{"AData","","D","8","0","variabile","nokey","false","false"},new String[]{"tipoarch","","C","1","0","variabile","nokey","false","false"},new String[]{"flgope","","C","10","0","variabile","nokey","false","false"},new String[]{"flgfrz","","C","10","0","variabile","nokey","false","false"},new String[]{"flgrap","","C","1","0","variabile","nokey","false","false"},new String[]{"tiprap","","C","1","0","variabile","nokey","false","false"},new String[]{"flgint","","C","1","0","variabile","nokey","false","false"},new String[]{"flgdel","","C","1","0","variabile","nokey","false","false"},new String[]{"flgsto","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_chkdiana_oldBL (CPContext p_ContextObject) {
  ...
  public boolean Set_DaData(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.le(w_DaData,CPLib.CharToDate("20100531"));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di inizio periodo devere essere inferiore al 31/05/2010";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_DaData = CPLib.NullDate();
  ...
  public boolean Set_AData(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.ge(w_AData,w_DaData) && CPLib.le(w_AData,CPLib.CharToDate("20100531"));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di fine periodo deve essere maggiore di quella di inizio e inferiore al 31/05/2010";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_AData = CPLib.NullDate();
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_chkdiana_old","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
