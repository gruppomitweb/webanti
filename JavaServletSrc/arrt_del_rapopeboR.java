...
// * --- Fine Area Manuale
public class arrt_del_rapopeboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_del_rapopeboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_del_rapopebo",m_Caller);
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    /* gStatus := 'dele' // Stato Operazione */
    gStatus = "dele";
    m_Ctx.SetGlobalString("gStatus",gStatus);
    /* Return  */
    Forward f;
    f=new Forward("armt_informazioni",false,this,Forward.Delete,false);
  ...
  public static arrt_del_rapopeboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_del_rapopeboR(p_Ctx, p_Caller);
  }
  public void Blank() {
