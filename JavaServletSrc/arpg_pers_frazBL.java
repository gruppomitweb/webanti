...
public class arpg_pers_frazBL extends arpg_pers_frazWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_pers_fraz";
  ...
  public arpg_pers_frazBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_pers_fraz","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
