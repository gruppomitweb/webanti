...
if ( ! (m_oFather.SaveContext_ardt_merzistiope())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_merzistiope_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_merzistiope_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_merzistiope();
}
}
SaveContext.child=[];
function BlankRow() {
