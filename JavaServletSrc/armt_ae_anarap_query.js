...
m_oFather.DoQueryFromChild('jnarapbo',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
function DoQueryFrom_jelegabo(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPPORTO ";
}
function DoQueryFrom_saldioro(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPPORTO ";
}
function DoQueryFrom_jarantbo(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPPORTO ";
}
...
_chNotF(childAlias,'master','armt_ae_anarap');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('jnarapbo',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
