...
public class ardt_ope_contanteBL extends ardt_ope_contanteWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_ope_contante";
  ...
  public CPPhTableWrInfo m_oWrInfo_ope_contante;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_ope_contante;
  ...
  public static String[] m_EntityTables = {"ope_contante"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDOPE':IDOPE,'TIPATT':TIPATT,'TIPOATTIV':TIPOATTIV,'CODICEGLN':CODICEGLN,'CODCLICON':CODCLICON,'ATECO_CON':ATECO_CON,'CODCOMCON':CODCOMCON,'ABIINTER':ABIINTER,'ABIPROPR':ABIPROPR,'GLNALTROSOG':GLNALTROSOG,'GLNALTRASC':GLNALTRASC,'BILLSRIT':BILLSRIT,'BILLSSOV':BILLSSOV,'m_Detail':{'TAGLIO':TAGLIO,'NBANCONOTE':NBANCONOTE"+FoundlingChildrenList("ardt_ope_contante",true,true)+"}"+FoundlingChildrenList("ardt_ope_contante",true,false)+"}";
  ...
  public ardt_ope_contanteBL (CPContext p_ContextObject) {
    ...
    m_cPhName_ope_contante = p_ContextObject.GetPhName("ope_contante",p_ContextObject.GetCompany(),false);
    m_cServer_ope_contante = p_ContextObject.GetServer("ope_contante");
    m_oWrInfo_ope_contante = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"ope_contante",p_ContextObject.GetCompany());
    m_cVirtName_ope_contante = CPSql.ManipulateTablePhName("ope_contante",m_cServer_ope_contante);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ope_contante",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_ope_contante","ope_contante",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("property.value",zeroSplit.split("tbtipatt\u0000false\u0000false\u00001\u00000\u0000opemt_tbtipatt\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_ope_contante",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_ope_contante",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_ope_contante",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ope_contante",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_ope_contante"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_ope_contante\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "ope_contante"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDOPE","C",10,0));
  }
  public String RowPrimaryKey() {
    return "ope_contante"+"\\"+CPLib.ToCPStr(w_TAGLIO);
  }
