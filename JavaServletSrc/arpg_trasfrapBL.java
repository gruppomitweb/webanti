...
public class arpg_trasfrapBL extends arpg_trasfrapWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasfrap";
  ...
  public arpg_trasfrapBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasfrap","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
