// Definition generated from table rapopebo
public class MemoryCursor_rapopebo extends CPMemoryCursor {
  MemoryCursorRow_rapopebo row;
  MemoryCursorRow_rapopebo empty_row;
  public MemoryCursor_rapopebo() {
    empty_row = new MemoryCursorRow_rapopebo();
    row = empty_row;
  }
  public MemoryCursor_rapopebo(java.util.Properties p,CPContext p_Ctx) {
    AppendData(p,p_Ctx);
  }
  public void AppendData(java.util.Properties p,CPContext p_Ctx) {
    ...
    java.util.Properties p_PRGIMPINF;
    p_PRGIMPINF = new java.util.Properties();
    ...
    java.util.Properties p_FLAGTIT;
    p_FLAGTIT = new java.util.Properties();
    ...
    while (e.hasMoreElements()) {
      ...
      if ("PRGIMPINF".equalsIgnoreCase(key)) {
        p_PRGIMPINF = CPLib.GetProperties(p.getProperty(key));
      }
      ...
      if ("FLAGTIT".equalsIgnoreCase(key)) {
        p_FLAGTIT = CPLib.GetProperties(p.getProperty(key));
      }
    }
    for ( i = 1; CPLib.le(i,Rows); i = i + (1)) {
      ...
      row.PRGIMPINF = CPLib.GetProperty(p_PRGIMPINF,"",0,i);
      ...
      row.FLAGTIT = CPLib.GetProperty(p_FLAGTIT,"",0,i);
    }
  ...
  protected void SetCurrentRow(Object p_Row) {
    row = (MemoryCursorRow_rapopebo)p_Row;
  }
  protected void SaveOnRow(Object p_Row) {
  }
  protected Object NewBlankRow() {
    return new MemoryCursorRow_rapopebo();
  }
  ...
  public MemoryCursorRow_rapopebo _slice_(double p_nRow) {
    return super._slice_(p_nRow);
  }
  @SuppressWarnings("unchecked")
  public MemoryCursorRow_rapopebo _get_(Object p_Key) {
    return super._get_(p_Key);
  }
  @SuppressWarnings("unchecked")
  public Iterable<MemoryCursorRow_rapopebo> _iterable_() {
    return _iterable_(null,null);
  }
  public boolean AppendRow(MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
      l_Row = new MemoryCursorRow_rapopebo();
      l_Row.Copy(p_Row);
    }
    return Append(l_Row);
  }
  public boolean AppendRowWithKey(boolean p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(boolean p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(String p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(String p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(double p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(double p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Date p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Date p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(java.sql.Timestamp p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean AppendRowWithKey(Object p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRowWithKey(Object p_Key,MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean InsertRow(MemoryCursorRow_rapopebo p_Row) {
    MemoryCursorRow_rapopebo l_Row;
    if (CPLib.IsNull(p_Row)) {
      l_Row = null;
    } else {
  ...
  public boolean CopyRow(MemoryCursorRow_rapopebo p_Row) {
    if (CPLib.IsNull(p_Row)) {
      return false;
    } else if (CPLib.IsNull(this.row)) {
      this.row = new MemoryCursorRow_rapopebo();
    }
    this.row.Copy(p_Row);
    return true;
  }
