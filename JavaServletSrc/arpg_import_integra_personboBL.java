...
public class arpg_import_integra_personboBL extends arpg_import_integra_personboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_integra_personbo";
  ...
  public arpg_import_integra_personboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_integra_personbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
