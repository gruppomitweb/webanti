...
// * --- Fine Area Manuale
public class arrt_load_xnarapboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_load_xnarapboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_load_xnarapbo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if ( ! (CPLib.Empty(cRapporto))) {
      /* _comando := 'query RAPPORTO="'+cRapporto+'"'+ NL + "@" + NL + "@SAVE"+ NL +"arrt_load_xnarapbo" + NL +'cRapporto="%RAPPORTO%" '+NL+"@DISCARD"+ NL +"arrt_load_xnarapbo" */
      _comando = "query RAPPORTO=\""+cRapporto+"\""+"\n"+"@"+"\n"+"@SAVE"+"\n"+"arrt_load_xnarapbo"+"\n"+"cRapporto=\"%RAPPORTO%\" "+"\n"+"@DISCARD"+"\n"+"arrt_load_xnarapbo";
      /* _where := "RAPPORTO='"+cRapporto+"'" */
      _where = "RAPPORTO='"+cRapporto+"'";
    } else { // Else
      /* _comando := 'query RAPPORTO=""'+ NL + "@" + NL + "@SAVE"+ NL +"arrt_load_xnarapbo" + NL +'cRapporto="%RAPPORTO%" '+NL+"@DISCARD"+ NL +"arrt_load_xnarapbo" */
    ...
    /* Return  */
    Forward f;
    f=new Forward("armt_provanarap",false,this,Forward.Start,false);
  ...
  public static arrt_load_xnarapboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_load_xnarapboR(p_Ctx, p_Caller);
  }
  public void Blank() {
