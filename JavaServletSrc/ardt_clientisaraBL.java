...
public class ardt_clientisaraBL extends ardt_clientisaraWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_clientisara";
  ...
  public CPPhTableWrInfo m_oWrInfo_clientisara;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_clientisara;
  ...
  public static String[] m_EntityTables = {"clientisara"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_clientisara",true,true)+"}"+FoundlingChildrenList("ardt_clientisara",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP,'PROQUOTA':PROQUOTA"+FoundlingChildrenList("ardt_clientisara",true,true)+"}"+FoundlingChildrenList("ardt_clientisara",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG PROQUOTA"+FoundlingChildrenList("ardt_clientisara",false,true)+"]"+FoundlingChildrenList("ardt_clientisara",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_clientisara"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"PROQUOTA","% Pro Quota","N","3","0","campo","nokey","true","false"}});
  ...
  public ardt_clientisaraBL (CPContext p_ContextObject) {
    ...
    m_cPhName_clientisara = p_ContextObject.GetPhName("clientisara",p_ContextObject.GetCompany(),false);
    m_cServer_clientisara = p_ContextObject.GetServer("clientisara");
    m_oWrInfo_clientisara = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"clientisara",p_ContextObject.GetCompany());
    m_cVirtName_clientisara = CPSql.ManipulateTablePhName("clientisara",m_cServer_clientisara);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_clientisara",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_clientisara","clientisara",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_clientisara",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_clientisara",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_clientisara",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_clientisara",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_clientisara"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_clientisara\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "clientisara"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "clientisara"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
