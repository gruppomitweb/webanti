...
public class arpg_fam_chksaldiBL extends arpg_fam_chksaldiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fam_chksaldi";
  ...
  public static final String i_CompleteStateStructure = "{'anno':anno,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe}";
  ...
  public arpg_fam_chksaldiBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_DaDatOpe = (CPLib.eq(w_anno,0)?CPLib.NullDate():CPLib.CharToDate(CPLib.Str(w_anno,4,0)+"0101"));
    w_ADatOpe = CPLib.NullDate();
    w_ADatOpe = (CPLib.eq(w_anno,0)?CPLib.NullDate():CPLib.CharToDate(CPLib.Str(w_anno,4,0)+"1231"));
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fam_chksaldi","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
