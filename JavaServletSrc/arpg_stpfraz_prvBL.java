...
public class arpg_stpfraz_prvBL extends arpg_stpfraz_prvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpfraz_prv";
  ...
  public static final String i_StateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'Tipop':Tipop,'tipstp':tipstp,'OrderBy':OrderBy}";
  public static final String i_CompleteStateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'Tipop':Tipop,'tipstp':tipstp,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'c_dadata':c_dadata,'c_adata':c_adata,'OrderBy':OrderBy,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2}";
  public static final String i_ItemSequence = "daCodDip,aCodDip,DaDatOpe,ADatOpe,daCodCli,aCodCli,Tipop,tipstp,OrderBy";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"aCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"Tipop","Tipo operazione","C","1","0","variabile","nokey","false","false"},new String[]{"tipstp","","C","1","0","variabile","nokey","false","false"},new String[]{"OrderBy","","C","15","0","variabile","nokey","false","false"}});
  ...
  public arpg_stpfraz_prvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpfraz_prv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
