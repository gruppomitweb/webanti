...
public class arpg_stp_stdtec_frz_newBL extends arpg_stp_stdtec_frz_newWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_frz_new";
  ...
  public static final String i_StateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'tipopdf':tipopdf}";
  public static final String i_CompleteStateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'c_dadata':c_dadata,'c_adata':c_adata,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2,'flgrae':flgrae,'tipopdf':tipopdf}";
  public static final String i_ItemSequence = "daCodDip,aCodDip,DaDatOpe,ADatOpe,daCodCli,aCodCli,tipopdf";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"aCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"tipopdf","Tipologia PDF","C","6","0","variabile","nokey","false","false"}});
  ...
  public arpg_stp_stdtec_frz_newBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_frz_new","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
