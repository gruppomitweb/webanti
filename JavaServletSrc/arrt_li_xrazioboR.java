...
// * --- Fine Area Manuale
public class arrt_li_xrazioboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_li_xrazioboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_li_xraziobo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* pObj Object(armt_frazioprovBL) */
      /* Variabili locali */
      /* conta Numeric(2, 0) */
      /* _tiporap Char(1) */
      /* Carica il contesto del figlio */
      /* pObj.CtxLoad_ardt_xlientifrz() */
      pObj.CtxLoad_ardt_xlientifrz();
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on knarapbo into routine arrt_li_xraziobo returns two or more records. This item should return only a record.");
      ...
      if (CPLib.eqr(_tiporap,"D")) {
        ...
        while ( ! (Cursor_intestbo.Eof())) {
          ...
          if (CPLib.eqr(conta,0)) {
            ...
            /* pObj.ardt_xlientifrz.AddRow() */
            pObj.ardt_xlientifrz.AddRow();
            /* pObj.ardt_xlientifrz.Set_CODSOG(intestbo->CODINTER) */
            pObj.ardt_xlientifrz.Set_CODSOG(Cursor_intestbo.GetString("CODINTER"));
            /* pObj.ardt_xlientifrz.SaveRow() */
            pObj.ardt_xlientifrz.SaveRow();
            /* pObj.ardt_xlientifrz.SetUpdated() */
            pObj.ardt_xlientifrz.SetUpdated();
          } // End If
        ...
        while ( ! (Cursor_xntestbo.Eof())) {
          ...
          if (CPLib.eqr(conta,0)) {
            ...
            /* pObj.ardt_xlientifrz.AddRow() */
            pObj.ardt_xlientifrz.AddRow();
            /* pObj.ardt_xlientifrz.Set_CODSOG(xntestbo->CODINTER) */
            pObj.ardt_xlientifrz.Set_CODSOG(Cursor_xntestbo.GetString("CODINTER"));
            /* pObj.ardt_xlientifrz.SaveRow() */
            pObj.ardt_xlientifrz.SaveRow();
            /* pObj.ardt_xlientifrz.SetUpdated() */
            pObj.ardt_xlientifrz.SetUpdated();
  ...
  public String RunAsync(armt_frazioprovBL p_pObj) {
    pObj = p_pObj;
  ...
  public Forward Run(armt_frazioprovBL p_pObj) {
    pObj = p_pObj;
    return Run();
  }
  public Forward Run() {
  ...
  public static arrt_li_xrazioboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_li_xrazioboR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
    conta = 0;
