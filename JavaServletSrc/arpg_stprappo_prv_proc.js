...
l_oWv.setValue('m_cParameterSequence',AsAppletValue('w_AData,w_aRappo,w_c_adata,w_c_dadata,w_DaData,w_daRappo,w_detope,w_flgdel,w_flgtit'));
SetLocationHref(null,'arrt_stprappo_prv'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
w_Messaggi.raiseEvent('arpg_stprappo_prv_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stprappo_prv_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stprappo_prv',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["daRappo","aRappo","DaData","AData","coddip","desrap1","desrap2","detope","c_dadata","c_adata","flgtit","flgdel","desdip"];
