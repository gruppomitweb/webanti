...
public class armt_modi_aggoperBL extends armt_modi_aggoperWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_modi_aggoper";
  ...
  public armt_modi_aggoperBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_modi_aggoper","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
