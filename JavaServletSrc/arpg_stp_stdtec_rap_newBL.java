...
public class arpg_stp_stdtec_rap_newBL extends arpg_stp_stdtec_rap_newWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_rap_new";
  ...
  public static final String i_StateStructure = "{'tipopdf':tipopdf,'daRapporto':daRapporto,'aRapporto':aRapporto,'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'ADatReg':ADatReg,'DaDatReg':DaDatReg}";
  public static final String i_CompleteStateStructure = "{'tipopdf':tipopdf,'daRapporto':daRapporto,'aRapporto':aRapporto,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2,'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'ADatReg':ADatReg,'DaDatReg':DaDatReg}";
  public static final String i_ItemSequence = "tipopdf,daRapporto,aRapporto,daCodDip,aCodDip,DaDatOpe,ADatOpe,ADatReg,DaDatReg";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"tipopdf","Tipologia PDF","C","6","0","variabile","nokey","false","false"},new String[]{"daRapporto","","C","25","0","variabile","nokey","false","false"},new String[]{"aRapporto","","C","25","0","variabile","nokey","false","false"},new String[]{"daCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"aCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatReg","","D","8","0","variabile","nokey","false","false"},new String[]{"DaDatReg","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_stp_stdtec_rap_newBL (CPContext p_ContextObject) {
  ...
  protected boolean Link_UYVYTEMEXX(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_daRapporto))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daRapporto,"C",25,0),m_cServer_anarapbo,w_daRapporto);
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daRapporto,"C",70,0),m_cServer_anarapbo,w_daRapporto);
            if (l_rsLink!=null)
              l_rsLink.Close();
        ...
        if (l_bLoaded) {
          ...
          w_RAGSOC1 = l_rsLink.GetString("DESCRAP");
          l_rsLink.Next();
  ...
  protected boolean Link_CJWUHWULAR(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_aRapporto))) {
      ...
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aRapporto,"C",25,0),m_cServer_anarapbo,w_aRapporto);
      if (m_Ctx.IsSharedTemp("anarapbo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aRapporto,"C",70,0),m_cServer_anarapbo,w_aRapporto);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_anarapbo,"select RAPPORTO,DESCRAP from "+m_cPhName_anarapbo+((m_cPhName_anarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
        ...
        if (l_bLoaded) {
          ...
          w_RAGSOC2 = l_rsLink.GetString("DESCRAP");
          l_rsLink.Next();
          /*  Se è stato trovato un record il link con chiave piena ha avuto successo.
                                  */
          l_bResult = l_rsLink.Eof();
  ...
  protected boolean Link_UQFVYWSNYY(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_daCodDip))) {
      String l_OldValue = w_daCodDip;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daCodDip,"C",6,0),m_cServer_anadip,w_daCodDip);
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_daCodDip,"C",30,0),m_cServer_anadip,w_daCodDip);
            if (l_rsLink!=null)
              l_rsLink.Close();
  ...
  protected boolean Link_HXBJUMEZIA(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_aCodDip))) {
      String l_OldValue = w_aCodDip;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aCodDip,"C",6,0),m_cServer_anadip,w_aCodDip);
      if (m_Ctx.IsSharedTemp("anadip")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
      ...
      try {
        ...
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_aCodDip,"C",30,0),m_cServer_anadip,w_aCodDip);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_anadip,"select CODDIP,DESCRIZ from "+m_cPhName_anadip+((m_cPhName_anadip).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRIZ"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_tipopdf(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getVisible_daRapporto() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  public boolean getVisible_aRapporto() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  public boolean getVisible_daCodDip() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  public boolean getVisible_aCodDip() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  public boolean getVisible_DaDatOpe() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  public boolean getVisible_ADatOpe() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_rap_new","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_tipopdf = CPLib.GetProperty(p,"tipopdf",w_tipopdf,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_daRapporto","w_RAGSOC1"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("25\u000070",-1));
    ...
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"RAPPORTO","DESCRAP"});
    map.put("rd_var",new String[]{"w_aRapporto","w_RAGSOC2"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    ...
    map.put("rd_var",new String[]{"w_daCodDip","w_DESCRIZ1"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    ...
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODDIP","DESCRIZ"});
    map.put("rd_var",new String[]{"w_aCodDip","w_DESCRIZ2"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
