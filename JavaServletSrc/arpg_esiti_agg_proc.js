...
function Help() {
windowOpenForeground('../doc/arpg_esiti_agg_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_esiti_agg',m_cSelectedPage);
