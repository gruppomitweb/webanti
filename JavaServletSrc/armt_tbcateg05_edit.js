...
function Set_C5CODTAB(ctrlValue,kmode,e) {
if (Ne(w_C5CODTAB,ctrlValue)) {
var ctl = _GetCtl(e,'SEJWRQHUSP');
if (_tracker.goon(ctl,ctrlValue)) {
w_C5CODTAB=ctrlValue;
SetModified();
var l_bResult = true;
...
function Set_C5CODICE(ctrlValue,kmode,e) {
if (Ne(w_C5CODICE,ctrlValue)) {
var ctl = _GetCtl(e,'XREVNLNKCY');
if (_tracker.goon(ctl,ctrlValue)) {
w_C5CODICE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
function Set_C5DESCRI(ctrlValue,kmode,e) {
if (Ne(w_C5DESCRI,ctrlValue)) {
var ctl = _GetCtl(e,'RJDJPGMTCC');
if (_tracker.goon(ctl,ctrlValue)) {
w_C5DESCRI=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
...
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg05_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tbcateg05_dataNotSent',{'action':formaction});
}
}
}
}
...
l_oWv.setValue('C5CODTAB',WtA(w_C5CODTAB,'C'));
l_oWv.setValue('C5CODICE',WtA(w_C5CODICE,'C'));
l_oWv.setValue('C5DESCRI',WtA(w_C5DESCRI,'C'));
...
FillWv.n=["C5CODTAB","C5CODICE","C5DESCRI","IDBASE"];
