...
public class arpg_cancella_opexBL extends arpg_cancella_opexWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_cancella_opex";
  ...
  public static final String i_StateStructure = "{'nomefile':nomefile,'anno':anno,'datarett':datarett}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'anno':anno,'gAzienda':gAzienda,'gDescAzi':gDescAzi,'datarett':datarett}";
  public static final String i_ItemSequence = "nomefile,anno,datarett";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"nomefile","","C","100","0","variabile","nokey","false","false"},new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"datarett","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_cancella_opexBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cancella_opex","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
