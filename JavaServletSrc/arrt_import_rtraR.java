...
import org.apache.poi.xssf.streaming.SXSSFWorkbook;
// * --- Fine Area Manuale
public class arrt_import_rtraR implements CallerWithObjs {
  ...
  public Font f;
  // * --- Fine Area Manuale
  public arrt_import_rtraR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_import_rtra",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      while ( ! (Cursor_intermbo.Eof())) {
        ...
        /* _limite20 := iif(Empty(intermbo->LIMITE20),CharToDate('20200101'),intermbo->LIMITE20) */
        _limite20 = (CPLib.Empty(Cursor_intermbo.GetDate("LIMITE20"))?CPLib.CharToDate("20200101"):Cursor_intermbo.GetDate("LIMITE20"));
        /* _gPathDoc := LRTrim(intermbo->RICEVUTE) // Path Applicazione */
        _gPathDoc = CPLib.LRTrim(Cursor_intermbo.GetString("RICEVUTE"));
      ...
      /* _gPathApp := Left(_gPathApp,Len(LRTrim(_gPathApp))-1) // Path Applicazione */
      _gPathApp = CPLib.Left(_gPathApp,CPLib.Len(CPLib.LRTrim(_gPathApp))-1);
      /* _dirfiles := LRTrim(_gPathApp)+"/appo/"+LRTrim(_gAzienda) */
      _dirfiles = CPLib.LRTrim(_gPathApp)+"/appo/"+CPLib.LRTrim(_gAzienda);
      // Legge la cartella e trova la directory corretta
      File dir = new File(_dirfiles);
      File[] files = dir.listFiles();
      if (files != null) {
        for (File file: files) {
      /* If At('POS',file.getAbsolutePath()) > 0 */
      if (CPLib.gt(CPLib.At("POS",file.getAbsolutePath()),0)) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000118")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000118(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(file.getName(),"?",0,0,m_cServer)+", ";
        ...
        /* ElseIf At('TRX',file.getAbsolutePath()) > 0 */
      } else if (CPLib.gt(CPLib.At("TRX",file.getAbsolutePath()),0)) {
        // * --- Insert into tmp_list_imprich from values
        m_Sql.RequireTransaction();
        m_cServer = m_Ctx.GetServer("tmp_list_imprich");
        m_cPhName = m_Ctx.GetPhName("tmp_list_imprich");
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_list_imprich",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000119")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_list_imprich",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"0000011A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      // Chiude la lettura dei file
         }
      }      
      // Begin Transaction
      m_Sql.RequireTransaction();
      double nTry0000011Estatus;
      nTry0000011Estatus = m_Sql.GetTransactionStatus();
      String cTry0000011Emsg;
      cTry0000011Emsg = m_Sql.TransactionErrorMessage();
      try {
        /* _messaggio := '' */
        _messaggio = "";
        ...
        while ( ! (Cursor_tmp_list_imprich.Eof())) {
          ...
          /* _filename := _gPathApp+"/appo/"+LRTrim(_gAzienda)+"/"+LRTrim(nomefileimport) // Nome file con path */
          _filename = _gPathApp+"/appo/"+CPLib.LRTrim(_gAzienda)+"/"+CPLib.LRTrim(nomefileimport);
          /* If At('POS',Upper(nomefileimport)) <> 0 */
          if (CPLib.ne(CPLib.At("POS",CPLib.Upper(nomefileimport)),0)) {
            /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Agenzie: '+arfn_fdatetime(DateTime()) + NL */
            _messaggio = _messaggio+"Ora Inizio Elaborazione File Agenzie: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            /* If pTipo='O' */
            if (CPLib.eqr(pTipo,"O")) {
              /* gMsgProc := gMsgProc + _messaggio */
              gMsgProc = gMsgProc+_messaggio;
            } // End If
            /* _nerrage := 0 */
            _nerrage = CPLib.Round(0,0);
            ...
            /* _messaggio := _messaggio + 'Ora Fine Elaborazione File Agenzie: '+arfn_fdatetime(DateTime()) + NL */
            _messaggio = _messaggio+"Ora Fine Elaborazione File Agenzie: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            /* If pTipo='O' */
            if (CPLib.eqr(pTipo,"O")) {
              /* gMsgProc := gMsgProc + _messaggio */
              gMsgProc = gMsgProc+_messaggio;
            ...
            if (CPLib.gt(_nerrage,0)) {
              ...
              _filen = "Errori_POS_"+_trxdate+".xlsx";
              /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Scarti Agenzie: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Inizio Elaborazione File Scarti Agenzie: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
              /* If pTipo='O' */
              if (CPLib.eqr(pTipo,"O")) {
                /* gMsgProc := gMsgProc + _messaggio */
                gMsgProc = gMsgProc+_messaggio;
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000139")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL("IMPORT AGENZIE","?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.gt(_nerrage,0)?_filen:""),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.gt(_nerrage,0)?"image:../images/GIF/118.gif":""),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.ne(CPLib.At("TRX",CPLib.Upper(nomefileimport)),0)) {
              /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Transazioni: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Inizio Elaborazione File Transazioni: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            } else { // Else
              /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Transazioni Sospese: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Inizio Elaborazione File Transazioni Sospese: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            } // End If
            /* If pTipo='O' */
            if (CPLib.eqr(pTipo,"O")) {
              /* gMsgProc := gMsgProc + _messaggio */
            ...
            /* If At('TRX',Upper(nomefileimport)) <> 0 */
            if (CPLib.ne(CPLib.At("TRX",CPLib.Upper(nomefileimport)),0)) {
              /* _messaggio := _messaggio + 'Ora Fine Elaborazione File Transazioni: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Fine Elaborazione File Transazioni: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            } else { // Else
              /* _messaggio := _messaggio + 'Ora Fine Elaborazione File Transazioni Sospese: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Fine Elaborazione File Transazioni Sospese: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            } // End If
            /* If pTipo='O' */
            if (CPLib.eqr(pTipo,"O")) {
              /* gMsgProc := gMsgProc + _messaggio */
            ...
            if (CPLib.ne(CPLib.At("TRX",CPLib.Upper(nomefileimport)),0)) {
              ...
              if (CPLib.gt(_nerrori,0)) {
                /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Scarti Transazioni: '+arfn_fdatetime(DateTime()) + NL */
                _messaggio = _messaggio+"Ora Inizio Elaborazione File Scarti Transazioni: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
                /* If pTipo='O' */
                if (CPLib.eqr(pTipo,"O")) {
                  /* gMsgProc := gMsgProc + _messaggio */
                  gMsgProc = gMsgProc+_messaggio;
                ...
                /* _messaggio := _messaggio + 'Ora Fine Elaborazione File Scarti Transazioni: '+arfn_fdatetime(DateTime()) + NL */
                _messaggio = _messaggio+"Ora Fine Elaborazione File Scarti Transazioni: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
                /* If pTipo='O' */
                if (CPLib.eqr(pTipo,"O")) {
                  /* gMsgProc := gMsgProc + _messaggio */
                  gMsgProc = gMsgProc+_messaggio;
              ...
              /* If _nerrori > 0 */
              if (CPLib.gt(_nerrori,0)) {
                /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Scarti Transazioni Sospese: '+arfn_fdatetime(DateTime()) + NL */
                _messaggio = _messaggio+"Ora Inizio Elaborazione File Scarti Transazioni Sospese: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
                /* If pTipo='O' */
                if (CPLib.eqr(pTipo,"O")) {
                  /* gMsgProc := gMsgProc + _messaggio */
                  gMsgProc = gMsgProc+_messaggio;
                ...
                /* _messaggio := _messaggio + 'Ora Fine Elaborazione File Scarti Transazioni Sospese: '+arfn_fdatetime(DateTime()) + NL */
                _messaggio = _messaggio+"Ora Fine Elaborazione File Scarti Transazioni Sospese: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
                /* If pTipo='O' */
                if (CPLib.eqr(pTipo,"O")) {
                  /* gMsgProc := gMsgProc + _messaggio */
                  gMsgProc = gMsgProc+_messaggio;
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"log_app",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"0000015C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(_messaggio,"?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL("Scheduler","?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.ne(CPLib.At("TRX",CPLib.Upper(nomefileimport)),0)?"IMPORT TRX":"IMPORT OTR"),"?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.gt(_nerrori,0)?_filen:""),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.gt(_nerrori,0)?"image:../images/GIF/118.gif":""),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL("S","?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+m_oWrInfo.InsertValues();
            m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"log_app",true);
            m_cSql = m_cSql+")";
            ...
            /* mcErrate.Zap() */
            mcErrate.Zap();
            /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Aggiornamento Soggetti: '+arfn_fdatetime(DateTime()) + NL */
            _messaggio = _messaggio+"Ora Inizio Elaborazione File Aggiornamento Soggetti: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            /* _nerrori := 0 */
            _nerrori = CPLib.Round(0,0);
            /* mcErrAge.Zap() */
            mcErrAge.Zap();
            ...
            /* _messaggio := _messaggio + 'Ora Fine Elaborazione File Aggiornamento Soggetti: '+arfn_fdatetime(DateTime()) + NL */
            _messaggio = _messaggio+"Ora Fine Elaborazione File Aggiornamento Soggetti: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
            /* If pTipo='O' */
            if (CPLib.eqr(pTipo,"O")) {
              /* gMsgProc := gMsgProc + _messaggio */
              gMsgProc = gMsgProc+_messaggio;
            ...
            if (CPLib.gt(_nerrori,0)) {
              ...
              _filen = "Errori_NEW_"+_trxdate+".xlsx";
              /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Scarti Aggiornamenti Soggetti: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Inizio Elaborazione File Scarti Aggiornamenti Soggetti: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
              /* If pTipo='O' */
              if (CPLib.eqr(pTipo,"O")) {
                /* gMsgProc := gMsgProc + _messaggio */
                gMsgProc = gMsgProc+_messaggio;
              ...
              /* _messaggio := _messaggio + 'Ora Inizio Elaborazione File Scarti Aggiornamento Soggetti: '+arfn_fdatetime(DateTime()) + NL */
              _messaggio = _messaggio+"Ora Inizio Elaborazione File Scarti Aggiornamento Soggetti: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+"\n";
              /* If pTipo='O' */
              if (CPLib.eqr(pTipo,"O")) {
                /* gMsgProc := gMsgProc + _messaggio */
                gMsgProc = gMsgProc+_messaggio;
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"log_app",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000170")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(_messaggio,"?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL("Scheduler","?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL("IMPORT AGGIORNAMENTI SOGGETTI","?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.gt(_nerrori,0)?_filen:""),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.gt(_nerrori,0)?"image:../images/GIF/118.gif":""),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL("S","?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+m_oWrInfo.InsertValues();
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_list_imprich",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000171")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry0000011Estatus,0)) {
          m_Sql.SetTransactionStatus(nTry0000011Estatus,cTry0000011Emsg);
        }
      }
    } finally {
      try {
  ...
  void Page_2() throws Exception {
    ...
    try {
      ...
      /* _nerrori := 0 */
      _nerrori = CPLib.Round(0,0);
      /* fhand := FileLibMit.OpenRead('./appo/'+LRTrim(_gAzienda)+"/"+nomefileimport) */
      fhand = FileLibMit.OpenRead("./appo/"+CPLib.LRTrim(_gAzienda)+"/"+nomefileimport);
      ...
      while ( ! (FileLibMit.Eof(fhand))) {
        ...
        riga = FileLibMit.ReadLine(fhand);
        /* mcAgeDuo.AppendWithKey(Left(riga,10)) */
        mcAgeDuo.AppendWithKey(CPLib.Left(riga,10));
        /* mcAgeDuo.colonna01 := Left(riga,10) */
        mcAgeDuo.row.colonna01 = CPLib.Left(riga,10);
        /* mcAgeDuo.colonna02 := LRTrim(Substr(riga,11,30)) */
        mcAgeDuo.row.colonna02 = CPLib.LRTrim(CPLib.Substr(riga,11,30));
        /* mcAgeDuo.colonna03 := LRTrim(Substr(riga,111,40)) */
        mcAgeDuo.row.colonna03 = CPLib.LRTrim(CPLib.Substr(riga,111,40));
        /* mcAgeDuo.colonna04 := LRTrim(Substr(riga,211,30)) */
        mcAgeDuo.row.colonna04 = CPLib.LRTrim(CPLib.Substr(riga,211,30));
        /* mcAgeDuo.colonna05 := LRTrim(Substr(riga,261,3)) */
        mcAgeDuo.row.colonna05 = CPLib.LRTrim(CPLib.Substr(riga,261,3));
        /* mcAgeDuo.colonna06 := LRTrim(Substr(riga,264,2)) */
        mcAgeDuo.row.colonna06 = CPLib.LRTrim(CPLib.Substr(riga,264,2));
        /* mcAgeDuo.colonna07 := LRTrim(Substr(riga,266,2)) */
        mcAgeDuo.row.colonna07 = CPLib.LRTrim(CPLib.Substr(riga,266,2));
        /* mcAgeDuo.colonna08 := LRTrim(Substr(riga,268,10)) */
        mcAgeDuo.row.colonna08 = CPLib.LRTrim(CPLib.Substr(riga,268,10));
        /* mcAgeDuo.colonna09 := LRTrim(Substr(riga,278,10)) */
        mcAgeDuo.row.colonna09 = CPLib.LRTrim(CPLib.Substr(riga,278,10));
        /* mcAgeDuo.colonna10 := LRTrim(Substr(riga,288,10)) */
        mcAgeDuo.row.colonna10 = CPLib.LRTrim(CPLib.Substr(riga,288,10));
        /* mcAgeDuo.colonna11 := LRTrim(Substr(riga,298,2)) */
        mcAgeDuo.row.colonna11 = CPLib.LRTrim(CPLib.Substr(riga,298,2));
        /* mcAgeDuo.colonna12 := LRTrim(Substr(riga,300,1)) */
        mcAgeDuo.row.colonna12 = CPLib.LRTrim(CPLib.Substr(riga,300,1));
        /* mcAgeDuo.colonna13 := LRTrim(Substr(riga,301,5)) */
        mcAgeDuo.row.colonna13 = CPLib.LRTrim(CPLib.Substr(riga,301,5));
        /* mcAgeDuo.SaveRow() */
        mcAgeDuo.SaveRow();
        /* mcAgenzie.AppendWithKey(Left(riga,10)) */
        mcAgenzie.AppendWithKey(CPLib.Left(riga,10));
        /* mcAgenzie.colonna01 := Left(riga,10) */
        mcAgenzie.row.colonna01 = CPLib.Left(riga,10);
        /* mcAgenzie.colonna02 := LRTrim(Substr(riga,11,30)) */
        mcAgenzie.row.colonna02 = CPLib.LRTrim(CPLib.Substr(riga,11,30));
        /* mcAgenzie.colonna03 := LRTrim(Substr(riga,111,40)) */
        mcAgenzie.row.colonna03 = CPLib.LRTrim(CPLib.Substr(riga,111,40));
        /* mcAgenzie.colonna04 := LRTrim(Substr(riga,211,30)) */
        mcAgenzie.row.colonna04 = CPLib.LRTrim(CPLib.Substr(riga,211,30));
        /* mcAgenzie.colonna05 := LRTrim(Substr(riga,261,3)) */
        mcAgenzie.row.colonna05 = CPLib.LRTrim(CPLib.Substr(riga,261,3));
        /* mcAgenzie.colonna06 := LRTrim(Substr(riga,264,2)) */
        mcAgenzie.row.colonna06 = CPLib.LRTrim(CPLib.Substr(riga,264,2));
        /* mcAgenzie.colonna07 := LRTrim(Substr(riga,266,2)) */
        mcAgenzie.row.colonna07 = CPLib.LRTrim(CPLib.Substr(riga,266,2));
        /* mcAgenzie.colonna08 := LRTrim(Substr(riga,268,10)) */
        mcAgenzie.row.colonna08 = CPLib.LRTrim(CPLib.Substr(riga,268,10));
        /* mcAgenzie.colonna09 := LRTrim(Substr(riga,278,10)) */
        mcAgenzie.row.colonna09 = CPLib.LRTrim(CPLib.Substr(riga,278,10));
        /* mcAgenzie.colonna10 := LRTrim(Substr(riga,288,10)) */
        mcAgenzie.row.colonna10 = CPLib.LRTrim(CPLib.Substr(riga,288,10));
        /* mcAgenzie.colonna11 := LRTrim(Substr(riga,298,2)) */
        mcAgenzie.row.colonna11 = CPLib.LRTrim(CPLib.Substr(riga,298,2));
        /* mcAgenzie.colonna12 := LRTrim(Substr(riga,300,1)) */
        mcAgenzie.row.colonna12 = CPLib.LRTrim(CPLib.Substr(riga,300,1));
        /* mcAgenzie.colonna13 := LRTrim(Substr(riga,301,5)) */
        mcAgenzie.row.colonna13 = CPLib.LRTrim(CPLib.Substr(riga,301,5));
        /* mcAgeDuo.SaveRow() */
        mcAgeDuo.SaveRow();
      } // End While
      // Chiude il file e lo cancella
      FileLibMit.Close(fhand);
      FileLibMit.DeleteFile("appo/"+CPLib.LRTrim(_gAzienda)+"/"+nomefileimport);
      // Begin Transaction
      m_Sql.RequireTransaction();
      double nTry000001A1status;
      nTry000001A1status = m_Sql.GetTransactionStatus();
      String cTry000001A1msg;
      cTry000001A1msg = m_Sql.TransactionErrorMessage();
      try {
        for (MemoryCursorRow_mcerratedef_mcrdef rowAgenzie : mcAgenzie._iterable_()) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on anadip into routine arrt_import_rtra returns two or more records. This item should return only a record.");
          ...
          if (CPLib.Empty(_coddip)) {
            ...
            m_cPhName = m_Ctx.GetPhName("anadip");
            m_cSql = "";
            m_cSql = m_cSql+"CODDIP="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Substr(rowAgenzie.colonna01,5,6),"C",6,0,m_cServer),m_cServer,CPLib.Substr(rowAgenzie.colonna01,5,6));
            if (m_Ctx.IsSharedTemp("anadip")) {
              m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
            }
            if (Read_Cursor!=null)
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_import_rtra returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          _colonna13 = rowAgenzie.colonna13;
          /* Exec "Controllo Agenzia" Page 3:Page_3 */
          Page_3();
          if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
            throw new RoutineException();
          }
          ...
          if (CPLib.gt(_errage,0)) {
            ...
            if (CPLib.Empty(_coddip)) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000001EB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000001EB(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(CPLib.Substr(rowAgenzie.colonna01,5,6)),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.eqr(CPLib.Left(CPLib.LRTrim(rowAgenzie.colonna10),1),"S")?"N":"S"),"?",0,0,m_cServer)+", ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000001ED")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"AGENTE = "+CPLib.ToSQL((CPLib.eqr(CPLib.Left(CPLib.LRTrim(rowAgenzie.colonna10),1),"S")?"N":"S"),"C",1,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry000001A1status,0)) {
          m_Sql.SetTransactionStatus(nTry000001A1status,cTry000001A1msg);
        }
      }
      /* _messaggio := _messaggio + 'Informazioni Elaborate: '+LRTrim(Str(conta,10,0)) + ' dal file '+nomefileimport+NL */
      _messaggio = _messaggio+"Informazioni Elaborate: "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" dal file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("_messaggio",_messaggio);
      /* _messaggio := _messaggio + 'Nuove Agenzie '+LRTrim(Str(cNumNew,10,0)) + ' dal file '+nomefileimport+NL */
      _messaggio = _messaggio+"Nuove Agenzie "+CPLib.LRTrim(CPLib.Str(cNumNew,10,0))+" dal file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("_messaggio",_messaggio);
      /* _messaggio := _messaggio + 'Agenzie Aggiornate '+LRTrim(Str(cNumMod,10,0)) + ' dal file '+nomefileimport+NL */
      _messaggio = _messaggio+"Agenzie Aggiornate "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+" dal file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("_messaggio",_messaggio);
      /* If _nerrage > 0 */
      if (CPLib.gt(_nerrage,0)) {
        /* _messaggio := _messaggio + 'Agenzie Scartate '+LRTrim(Str(_nerrage,10,0)) + ' dal file '+nomefileimport+NL */
        _messaggio = _messaggio+"Agenzie Scartate "+CPLib.LRTrim(CPLib.Str(_nerrage,10,0))+" dal file "+nomefileimport+"\n";
        m_Ctx.SetGlobalString("_messaggio",_messaggio);
      } // End If
    } finally {
      try {
  ...
  void Page_3() throws Exception {
    ...
    /* If Empty(_colonna13) or At('x',_colonna13) <> 0 */
    if (CPLib.Empty(_colonna13) || CPLib.ne(CPLib.At("x",_colonna13),0)) {
      /* _errage := _errage + 1 */
      _errage = CPLib.Round(_errage+1,0);
      /* _ageerr13 := 'CAP assente o presenza di caratteri non ammessi' */
      _ageerr13 = "CAP assente o presenza di caratteri non ammessi";
    } // End If
  }
  void Page_4() throws Exception {
    /* Formato Excel */
    /* _nfile := LRTrim(_gPathDoc)+"/export/"+LRTrim(_gAzienda)+"/"+LRTrim(_filen) */
    _nfile = CPLib.LRTrim(_gPathDoc)+"/export/"+CPLib.LRTrim(_gAzienda)+"/"+CPLib.LRTrim(_filen);
    /* Seleziona i record */
    ...
    cell.setCellStyle(cs);
    r++;
    MemoryCursor_mcerratedef_mcrdef cpmc_0000022B;
    cpmc_0000022B = new MemoryCursor_mcerratedef_mcrdef();
    for (MemoryCursorRow_mcerratedef_mcrdef rowErrate : mcErrAge._iterable_()) {
      cpmc_0000022B.Append(rowErrate);
    }
    for (MemoryCursorRow_mcerratedef_mcrdef rowErrate : cpmc_0000022B._iterable_(new CPMemoryCursorRow.Comparator<MemoryCursorRow_mcerratedef_mcrdef>(){  public int compare(MemoryCursorRow_mcerratedef_mcrdef r1,MemoryCursorRow_mcerratedef_mcrdef r2){    if (CPLib.gt(r1.colonna01,r2.colonna01)) return 1;    if (CPLib.lt(r1.colonna01,r2.colonna01)) return -1;    return 0;  }})) {
      // Scrive la riga
      row = sheet.createRow(r);
      cell = row.createCell(0);
  ...
  void Page_5() throws Exception {
    ...
    try {
      ...
      // Begin Transaction
      m_Sql.RequireTransaction();
      double nTry00000239status;
      nTry00000239status = m_Sql.GetTransactionStatus();
      String cTry00000239msg;
      cTry00000239msg = m_Sql.TransactionErrorMessage();
      try {
        /* While not(FileLibMit.Eof(fhand)) */
        while ( ! (FileLibMit.Eof(fhand))) {
          /* riga := FileLibMit.ReadLine(fhand) */
          ...
          if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
            ...
            if (CPLib.eqr(CPLib.Substr(riga,925,1),"D")) {
              ...
              if (CPLib.eqr(_nocf,0)) {
                ...
                if (CPLib.eqr(CPLib.Substr(_codfis,12,1),"Z")) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on tbstati into routine arrt_import_rtra returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                  ...
                  if (CPLib.Empty(_nasstato)) {
                    ...
                    m_cPhName = m_Ctx.GetPhName("tbstati");
                    m_cSql = "";
                    m_cSql = m_cSql+"DESCRI="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(CPLib.Substr(riga,234,50)),40),"C",40,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(CPLib.Substr(riga,234,50)),40));
                    if (m_Ctx.IsSharedTemp("tbstati")) {
                      m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                    }
                    if (Read_Cursor!=null)
                    ...
                    /* If Empty(_nasstato) */
                    if (CPLib.Empty(_nasstato)) {
                      /* _nasstato := LRTrim(Substr(riga,234,50)) */
                      _nasstato = CPLib.LRTrim(CPLib.Substr(riga,234,50));
                  ...
                  if (CPLib.Empty(_nascitta)) {
                    ...
                    m_cPhName = m_Ctx.GetPhName("tbcitta");
                    m_cSql = "";
                    m_cSql = m_cSql+"CITTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(CPLib.Substr(riga,234,50)),40),"C",60,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(CPLib.Substr(riga,234,50)),40));
                    if (m_Ctx.IsSharedTemp("tbcitta")) {
                      m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                    }
                    if (Read_Cursor!=null)
                    ...
                    /* If Empty(_nascitta) */
                    if (CPLib.Empty(_nascitta)) {
                      /* _nascitta := LRTrim(Substr(riga,234,50)) */
                      _nascitta = CPLib.LRTrim(CPLib.Substr(riga,234,50));
                      /* _luonas := LRTrim(Substr(riga,234,50)) */
                      _luonas = CPLib.LRTrim(CPLib.Substr(riga,234,50));
                    } // End If
                  } // End If
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on tbvalute into routine arrt_import_rtra returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              /* rowErrate.colonna01 := LRTrim(Left(riga,16)) */
              rowErrate.colonna01 = CPLib.LRTrim(CPLib.Left(riga,16));
              /* rowErrate.colonna02 := LRTrim(Substr(riga,17,50)) */
              rowErrate.colonna02 = CPLib.LRTrim(CPLib.Substr(riga,17,50));
              /* rowErrate.colonna03 := LRTrim(Substr(riga,67,50)) */
              rowErrate.colonna03 = CPLib.LRTrim(CPLib.Substr(riga,67,50));
              /* rowErrate.colonna04 := LRTrim(Substr(riga,117,100)) */
              rowErrate.colonna04 = CPLib.LRTrim(CPLib.Substr(riga,117,100));
              /* rowErrate.colonna05 := LRTrim(Substr(riga,217,1)) */
              rowErrate.colonna05 = CPLib.LRTrim(CPLib.Substr(riga,217,1));
              /* rowErrate.colonna06 := Substr(riga,218,16) */
              rowErrate.colonna06 = CPLib.Substr(riga,218,16);
              /* rowErrate.colonna07 := Substr(riga,234,50) */
              rowErrate.colonna07 = CPLib.Substr(riga,234,50);
              /* rowErrate.colonna08 := Substr(riga,284,30) */
              rowErrate.colonna08 = CPLib.Substr(riga,284,30);
              /* rowErrate.colonna09 := Substr(riga,314,8) */
              rowErrate.colonna09 = CPLib.Substr(riga,314,8);
              /* rowErrate.colonna10 := Substr(riga,322,8) */
              rowErrate.colonna10 = CPLib.Substr(riga,322,8);
              /* rowErrate.colonna11 := Substr(riga,330,50) */
              rowErrate.colonna11 = CPLib.Substr(riga,330,50);
              /* rowErrate.colonna12 := Substr(riga,380,50) */
              rowErrate.colonna12 = CPLib.Substr(riga,380,50);
              /* rowErrate.colonna13 := Substr(riga,430,50) */
              rowErrate.colonna13 = CPLib.Substr(riga,430,50);
              /* rowErrate.colonna14 := Substr(riga,480,2) */
              rowErrate.colonna14 = CPLib.Substr(riga,480,2);
              /* rowErrate.colonna15 := Substr(riga,482,8) */
              rowErrate.colonna15 = CPLib.Substr(riga,482,8);
              /* rowErrate.colonna16 := Substr(riga,490,1) */
              rowErrate.colonna16 = CPLib.Substr(riga,490,1);
              /* rowErrate.colonna17 := Substr(riga,491,1) */
              rowErrate.colonna17 = CPLib.Substr(riga,491,1);
              /* rowErrate.colonna18 := Substr(riga,492,15) */
              rowErrate.colonna18 = CPLib.Substr(riga,492,15);
              /* rowErrate.colonna19 := Substr(riga,507,15) */
              rowErrate.colonna19 = CPLib.Substr(riga,507,15);
              /* rowErrate.colonna20 := Substr(riga,522,10) */
              rowErrate.colonna20 = CPLib.Substr(riga,522,10);
              /* rowErrate.colonna21 := Substr(riga,532,10) */
              rowErrate.colonna21 = CPLib.Substr(riga,532,10);
              /* rowErrate.colonna22 := Substr(riga,542,100) */
              rowErrate.colonna22 = CPLib.Substr(riga,542,100);
              /* rowErrate.colonna23 := Substr(riga,642,100) */
              rowErrate.colonna23 = CPLib.Substr(riga,642,100);
              /* rowErrate.colonna24 := Substr(riga,742,100) */
              rowErrate.colonna24 = CPLib.Substr(riga,742,100);
              /* rowErrate.colonna25 := Substr(riga,842,30) */
              rowErrate.colonna25 = CPLib.Substr(riga,842,30);
              /* rowErrate.colonna26 := Substr(riga,872,30) */
              rowErrate.colonna26 = CPLib.Substr(riga,872,30);
              /* rowErrate.colonna27 := Substr(riga,902,10) */
              rowErrate.colonna27 = CPLib.Substr(riga,902,10);
              /* rowErrate.colonna28 := Substr(riga,912,8) */
              rowErrate.colonna28 = CPLib.Substr(riga,912,8);
              /* rowErrate.colonna29 := Substr(riga,920,1) */
              rowErrate.colonna29 = CPLib.Substr(riga,920,1);
              /* rowErrate.colonna30 := Substr(riga,921,4) */
              rowErrate.colonna30 = CPLib.Substr(riga,921,4);
              /* rowErrate.colonna31 := Substr(riga,925,1) */
              rowErrate.colonna31 = CPLib.Substr(riga,925,1);
              /* rowErrate.colonna32 := Substr(riga,926,5) */
              rowErrate.colonna32 = CPLib.Substr(riga,926,5);
              /* rowErrate.colonna33 := Substr(riga,931,18) */
              rowErrate.colonna33 = CPLib.Substr(riga,931,18);
              /* rowErrate.colonna34 := Substr(riga,949,2) */
              rowErrate.colonna34 = CPLib.Substr(riga,949,2);
              /* rowErrate.colonna35 := Substr(riga,951,5) */
              rowErrate.colonna35 = CPLib.Substr(riga,951,5);
              /* rowErrate.colonna36 := Substr(riga,956,1) */
              rowErrate.colonna36 = CPLib.Substr(riga,956,1);
              /* rowErrate.colonna37 := Substr(riga,957,2) */
              rowErrate.colonna37 = CPLib.Substr(riga,957,2);
              /* rowErrate.colonna38 := Substr(riga,959,3) */
              rowErrate.colonna38 = CPLib.Substr(riga,959,3);
              /* rowErrate.colonna39 := Substr(riga,962,10) */
              rowErrate.colonna39 = CPLib.Substr(riga,962,10);
              /* rowErrate.colonna40 := Substr(riga,972,2) */
              rowErrate.colonna40 = CPLib.Substr(riga,972,2);
              /* rowErrate.colonna41 := Substr(riga,974,2) */
              rowErrate.colonna41 = CPLib.Substr(riga,974,2);
              /* rowErrate.colonna42 := Space(11) */
              rowErrate.colonna42 = CPLib.Space(11);
              /* rowErrate.colonna43 := Substr(riga,976,50) */
              rowErrate.colonna43 = CPLib.Substr(riga,976,50);
              /* rowErrate.colonna44 := Substr(riga,1026,3) */
              rowErrate.colonna44 = CPLib.Substr(riga,1026,3);
              /* rowErrate.colonna45 := Substr(riga,1029,6) */
              rowErrate.colonna45 = CPLib.Substr(riga,1029,6);
              /* rowErrate.colonna46 := Space(25) */
              rowErrate.colonna46 = CPLib.Space(25);
              /* rowErrate.colonna47 := Substr(riga,1035,10) */
              rowErrate.colonna47 = CPLib.Substr(riga,1035,10);
              /* rowErrate.colonna48 := Substr(riga,1045,10) */
              rowErrate.colonna48 = CPLib.Substr(riga,1045,10);
              /* rowErrate.colonna49 := Substr(riga,1055,1) */
              rowErrate.colonna49 = CPLib.Substr(riga,1055,1);
              /* Exec "Controllo Transazione" Page 6:Page_6 */
              Page_6();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              /* If _esito=1 or At('OTR',Upper(nomefileimport)) <> 0 */
              if (CPLib.eqr(_esito,1) || CPLib.ne(CPLib.At("OTR",CPLib.Upper(nomefileimport)),0)) {
                /* _nerrori := _nerrori + 1 */
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry00000239status,0)) {
          m_Sql.SetTransactionStatus(nTry00000239status,cTry00000239msg);
        }
      }
      /* _messaggio := _messaggio + 'Transazioni Elaborate: '+LRTrim(Str(conta,10,0)) + ' dal file '+nomefileimport+NL */
      _messaggio = _messaggio+"Transazioni Elaborate: "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" dal file "+nomefileimport+"\n";
      /* If cNumMod > 0 */
      if (CPLib.gt(cNumMod,0)) {
        /* _messaggio := _messaggio + 'Sono stati cancellate '+LRTrim(Str(cNumMod,10,0)) + ' transazioni dal file '+nomefileimport+NL */
        _messaggio = _messaggio+"Sono stati cancellate "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+" transazioni dal file "+nomefileimport+"\n";
      } // End If
      /* If _nerrori > 0 */
      if (CPLib.gt(_nerrori,0)) {
        /* _messaggio := _messaggio + 'Sono stati rilevati '+LRTrim(Str(_nerrori,10,0)) + ' errori dal file '+nomefileimport+NL */
        _messaggio = _messaggio+"Sono stati rilevati "+CPLib.LRTrim(CPLib.Str(_nerrori,10,0))+" errori dal file "+nomefileimport+"\n";
        m_Ctx.SetGlobalString("_messaggio",_messaggio);
      } // End If
    } finally {
      try {
  ...
  void Page_6() throws Exception {
    ...
    if (CPLib.Empty(_codcit) && CPLib.eqr(_codstares,"086")) {
      ...
      /* _esito := 1 */
      _esito = CPLib.Round(1,0);
      /* If Empty(LRTrim(_cap)) or At('x',_cap) <> 0 */
      if (CPLib.Empty(CPLib.LRTrim(_cap)) || CPLib.ne(CPLib.At("x",_cap),0)) {
    ...
    if (CPLib.eqr(_nocf,1)) {
      ...
      if ((CPLib.Empty(_nasstato) && CPLib.Empty(_nascitta)) || CPLib.Empty(_nasdata) || CPLib.Empty(_cognome) || CPLib.Empty(_nome) || CPLib.Empty(_sesso)) {
        ...
        w_NOME = _nome;
        /* w_SESSO := iif(_sesso='M','1',iif(_sesso='F' or _sesso='W','2','')) // Sesso */
        w_SESSO = (CPLib.eqr(_sesso,"M")?"1":(CPLib.eqr(_sesso,"F") || CPLib.eqr(_sesso,"W")?"2":""));
  ...
  void Page_8() throws Exception {
    ...
    try {
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on personbo into routine arrt_import_rtra returns two or more records. This item should return only a record.");
          CPStdCounter.Error(l_oErrorFault);
        }
        Read_Cursor.Close();
      } else {
      ...
      if (CPLib.Empty(CPLib.LRTrim(_connes))) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000483")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000483(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        ...
        m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(CPLib.Left(_cognome,26)," "),"?",0,0,m_cServer)+", ";
        ...
        m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(CPLib.Left(_nome,25)," "),"?",0,0,m_cServer)+", ";
        ...
        m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(CPLib.Left(CPLib.LRTrim(_cognome)+" "+CPLib.LRTrim(_nome),70)," "),"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL("","?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.eqr(_sesso,"M")?"1":(CPLib.eqr(_sesso,"F") || CPLib.eqr(_sesso,"W")?"2":"")),"?",0,0,m_cServer)+", ";
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000484")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.Empty(cProgSto)) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"0000048C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(Cursor_personbo.GetString("RAGSOC")," "),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(Cursor_personbo.GetString("NOME")," "),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(Cursor_personbo.GetString("COGNOME")," "),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(Cursor_personbo.GetString("RAGSOCOLD")," "),"?",0,0,m_cServer)+", ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"0000048D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        m_cSql = m_cSql+"COGNOME = "+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(CPLib.Left(_cognome,26)," "),"C",26,0,m_cServer)+", ";
        ...
        m_cSql = m_cSql+"NOME = "+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(CPLib.Left(_nome,25)," "),"C",25,0,m_cServer)+", ";
        ...
        m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(arfn_agecharR.Make(m_Ctx,this).Run(CPLib.Left(CPLib.LRTrim(_cognome)+" "+CPLib.LRTrim(_nome),70)," "),"C",70,0,m_cServer)+", ";
        m_cSql = m_cSql+"RAMOGRUP = "+CPLib.ToSQL("","C",3,0,m_cServer)+", ";
        m_cSql = m_cSql+"SESSO = "+CPLib.ToSQL((CPLib.eqr(_sesso,"M")?"1":(CPLib.eqr(_sesso,"F") || CPLib.eqr(_sesso,"W")?"2":"")),"C",1,0,m_cServer)+", ";
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on personbo_agg into routine arrt_import_rtra returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(_connes)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo_agg",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000490")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_00000490(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(_ndg,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,949,2),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,956,1),"?",0,0,m_cServer)+", ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo_agg",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000491")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
  ...
  void Page_9() throws Exception {
    ...
    try {
      ...
      /* If At(_codana,'|26|48') > 0 */
      if (CPLib.gt(CPLib.At(_codana,"|26|48"),0)) {
        /* If _importo > 100000 */
        if (CPLib.gt(_importo,100000)) {
          /* _scopo := 'BONIFICO IN ENTRATA' */
          _scopo = "BONIFICO IN ENTRATA";
        } else { // Else
          /* _scopo := 'OPERAZIONE TRA SEDI IN ITALIA' */
          _scopo = "OPERAZIONE TRA SEDI IN ITALIA";
        } // End If
      } else { // Else
        /* If _importo > 100000 */
        if (CPLib.gt(_importo,100000)) {
          /* _scopo := "OPERAZIONE VERSO ESTERO" */
          _scopo = "OPERAZIONE VERSO ESTERO";
        } else { // Else
          /* If _segno='D' */
      ...
      if (CPLib.eqr(w_destfin,"O")) {
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004A2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000004A2(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL("TRANSAZIONE FINANZIARIA","?",0,0,m_cServer)+", ";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(_scopo),"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004A5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004AB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004AE")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      if (CPLib.eqr(w_tipodest,"D")) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on opextrbo into routine arrt_import_rtra returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(_idbase)) {
          /* _id := Utilities.GetAutonumber("PROGOPEX\'"+LRTrim(_gAzienda)+"'",0,10) */
          _id = CPLib.Round(Utilities.Make(m_Ctx,m_Caller).GetAutonumber("PROGOPEX\\'"+CPLib.LRTrim(_gAzienda)+"'",0,10),0);
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004B6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
    ...
    try {
      ...
      if (CPLib.Empty(_idbase)) {
        ...
        if ( ! (CPLib.Empty(_idbase))) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004BF")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004C0")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"DATARETT = "+CPLib.ToSQL(CPLib.Date(),"D",8,0)+", ";
        m_cSql = m_cSql+"STATOREG = "+CPLib.ToSQL("2","C",1,0,m_cServer)+", ";
  ...
  void Page_11() throws Exception {
    ...
    try {
      ...
      /* cOpeProg1 := Utilities.GetAutonumber("POPERAGE1\'"+LRTrim(_gAzienda)+"'",'',10) */
      cOpeProg1 = Utilities.Make(m_Ctx,m_Caller).GetAutonumber("POPERAGE1\\'"+CPLib.LRTrim(_gAzienda)+"'","",10);
      ...
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004C4")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      m_cSql = m_cSql+GetFieldsName_000004C4(m_Ctx,m_oWrInfo);
      m_cSql = m_cSql+") values (";
      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Year(_datope),"?",0,0)+", ";
      m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(_cognomecp)+" "+CPLib.LRTrim(_nomecp),70),"?",0,0,m_cServer)+", ";
      m_cSql = m_cSql+""+CPLib.ToSQL(_uifdest,"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.Empty(_idbase)) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"opextrbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000004CB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_000004CB(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(_ndg,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(_anno,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
  ...
  void Page_12() throws Exception {
    ...
    try {
      ...
      // Begin Transaction
      m_Sql.RequireTransaction();
      double nTry000004D6status;
      nTry000004D6status = m_Sql.GetTransactionStatus();
      String cTry000004D6msg;
      cTry000004D6msg = m_Sql.TransactionErrorMessage();
      try {
        /* While not(FileLibMit.Eof(fhand)) */
        while ( ! (FileLibMit.Eof(fhand))) {
          /* riga := FileLibMit.ReadLine(fhand) */
              ...
              if (CPLib.eqr(CPLib.Substr(_codfis,12,1),"Z")) {
                ...
                if (CPLib.Empty(_nasstato)) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on tbstatna into routine arrt_import_rtra returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                ...
                if (CPLib.Empty(_nascitta)) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on tbcittna into routine arrt_import_rtra returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry000004D6status,0)) {
          m_Sql.SetTransactionStatus(nTry000004D6status,cTry000004D6msg);
        }
      }
      /* _messaggio := _messaggio + 'Anagrafiche Elaborate: '+LRTrim(Str(conta,10,0)) + ' dal file '+nomefileimport+NL */
      _messaggio = _messaggio+"Anagrafiche Elaborate: "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" dal file "+nomefileimport+"\n";
      /* If cNumMod > 0 */
      if (CPLib.gt(cNumMod,0)) {
        /* _messaggio := _messaggio + 'Sono stati rettificate '+LRTrim(Str(cNumMod,10,0)) + ' anagrafiche dal file '+nomefileimport+NL */
        _messaggio = _messaggio+"Sono stati rettificate "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+" anagrafiche dal file "+nomefileimport+"\n";
      } // End If
      /* If cNumNew > 0 */
      if (CPLib.gt(cNumNew,0)) {
        /* _messaggio := _messaggio + 'Sono stati inserite '+LRTrim(Str(cNumNew,10,0)) + ' anagrafiche dal file '+nomefileimport+NL */
        _messaggio = _messaggio+"Sono stati inserite "+CPLib.LRTrim(CPLib.Str(cNumNew,10,0))+" anagrafiche dal file "+nomefileimport+"\n";
      } // End If
      /* If _nerrori > 0 */
      if (CPLib.gt(_nerrori,0)) {
        /* _messaggio := _messaggio + 'Sono stati rilevati '+LRTrim(Str(_nerrori,10,0)) + ' errori dal file '+nomefileimport+NL */
  ...
  void Page_14() throws Exception {
    ...
    try {
      ...
      m_cSql = "";
      m_cSql = m_cSql+"tablecode="+CPSql.SQLValueAdapter(CPLib.ToSQL("prog\\PRGIMPOCLI\\'"+CPLib.LRTrim(_gAzienda)+"'","C",100,0,m_cServer),m_cServer,"prog\\PRGIMPOCLI\\'"+CPLib.LRTrim(_gAzienda)+"'");
      m_cSql = m_cSql+" and warncode="+CPSql.SQLValueAdapter(CPLib.ToSQL(_gAzienda,"C",10,0,m_cServer),m_cServer,_gAzienda);
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on cpwarn into routine arrt_import_rtra returns two or more records. This item should return only a record.");
          CPStdCounter.Error(l_oErrorFault);
        }
        Read_Cursor.Close();
      } else {
      ...
      m_cPhName = m_Ctx.GetPhName("cpwarn");
      m_cSql = "";
      m_cSql = m_cSql+"tablecode="+CPSql.SQLValueAdapter(CPLib.ToSQL("prog\\PSTOPERS\\'"+CPLib.LRTrim(_gAzienda)+"'","C",100,0,m_cServer),m_cServer,"prog\\PSTOPERS\\'"+CPLib.LRTrim(_gAzienda)+"'");
      m_cSql = m_cSql+" and warncode="+CPSql.SQLValueAdapter(CPLib.ToSQL(_gAzienda,"C",10,0,m_cServer),m_cServer,_gAzienda);
      if (m_Ctx.IsSharedTemp("cpwarn")) {
        m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      ...
      if (CPLib.Empty(xConnes)) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"00000665")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000665(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(0,"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(0,"?",0,0)+", ";
        ...
        while ( ! (Cursor_personbo.Eof())) {
          ...
          if (CPLib.ne(CPLib.LRTrim(xRiga1),CPLib.LRTrim(xRiga2))) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(cProgSto))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"wersonbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006A8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000006A8(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetDouble("ALLINEATO"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetDouble("ALLINEATONOMECNOME"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_personbo.GetString("AREAGEO"),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.ne(CPLib.LRTrim(xRiga3),CPLib.LRTrim(xRiga4))) {
                ...
                while ( ! (Cursor_operazbo.Eof())) {
                  /* cNewProg := Utilities.GetAutonumber("POPERAZ1\'"+LRTrim(_gAzienda)+"'",Space(10),10) */
                  cNewProg = Utilities.Make(m_Ctx,m_Caller).GetAutonumber("POPERAZ1\\'"+CPLib.LRTrim(_gAzienda)+"'",CPLib.Space(10),10);
                  ...
                  while ( ! (Cursor_operazbo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006B0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000006B0(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006B3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                while ( ! (Cursor_fraziobo.Eof())) {
                  /* cNewProg := Utilities.GetAutonumber("PFRAZIO1\'"+LRTrim(_gAzienda)+"'",Space(10),10) */
                  cNewProg = Utilities.Make(m_Ctx,m_Caller).GetAutonumber("PFRAZIO1\\'"+CPLib.LRTrim(_gAzienda)+"'",CPLib.Space(10),10);
                  ...
                  while ( ! (Cursor_fraziobo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006BA")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000006BA(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006BD")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        if (CPLib.eqr(CPLib.Substr(riga,288,1),"M") || CPLib.eqr(CPLib.Substr(riga,288,1),"F")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006C3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006C6")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"ATTIV = "+CPLib.ToSQL(CPLib.Substr(riga,468,10),"C",10,0,m_cServer)+", ";
          m_cSql = m_cSql+"AUTRILASC = "+CPLib.ToSQL(CPLib.Substr(riga,200,30),"C",30,0,m_cServer)+", ";
          m_cSql = m_cSql+"CAP = "+CPLib.ToSQL(CPLib.Substr(riga,265,9),"C",9,0,m_cServer)+", ";
          m_cSql = m_cSql+"CFESTERO = "+CPLib.ToSQL(_oldest,"N",1,0)+", ";
        ...
        SPBridge.HMCaller _h000006C8;
        _h000006C8 = new SPBridge.HMCaller();
        _h000006C8.Set("m_cVQRList",m_cVQRList);
        _h000006C8.Set("CONNES",xConnes);
        if (Cursor_qbe_aggfam_opextrbo_new!=null)
          Cursor_qbe_aggfam_opextrbo_new.Close();
        Cursor_qbe_aggfam_opextrbo_new = new VQRHolder("qbe_aggfam_opextrbo_new",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000006C8,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_aggfam_opextrbo_new.Eof())) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"opextrbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006C9")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        ...
        SPBridge.HMCaller _h000006CB;
        _h000006CB = new SPBridge.HMCaller();
        _h000006CB.Set("m_cVQRList",m_cVQRList);
        _h000006CB.Set("CONNES",xConnes);
        _h000006CB.Set("pAnno",_anno);
        if (Cursor_qbe_aggfam_opextrbo!=null)
          Cursor_qbe_aggfam_opextrbo.Close();
        Cursor_qbe_aggfam_opextrbo = new VQRHolder("qbe_aggfam_opextrbo",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),_h000006CB,true).GetResultSet(m_Ctx);
        while ( ! (Cursor_qbe_aggfam_opextrbo.Eof())) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"opextrbo",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006CC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          m_cSql = m_cSql+"CFESTERO = "+CPLib.ToSQL((CPLib.eqr(_oldest,1)?"S":"N"),"C",1,0,m_cServer)+", ";
      ...
      if (CPLib.gt(nProgImp,0)) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006CE")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"autonum = "+CPLib.ToSQL(nProgImp+1,"N",10,0)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cpwarn",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"tablecode = "+CPSql.SQLValueAdapter(CPLib.ToSQL("prog\\PRGIMPOCLI\\'"+CPLib.LRTrim(_gAzienda)+"'","?",0,0,m_cServer),m_cServer,"prog\\PRGIMPOCLI\\'"+CPLib.LRTrim(_gAzienda)+"'")+"";
        ...
        if (CPLib.eqr(m_nUpdatedRows,0)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cpwarn",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006D0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000006D0(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL("prog\\PRGIMPOCLI\\'"+CPLib.LRTrim(_gAzienda)+"'","?",0,0,m_cServer)+", ";
      ...
      if (CPLib.gt(nProgSto,0)) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cpwarn",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006D2")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
        m_cSql = m_cSql+"autonum = "+CPLib.ToSQL(nProgSto+1,"N",10,0)+", ";
        m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cpwarn",false,true);
        m_cSql = m_cSql+" where ";
        m_cSql = m_cSql+"tablecode = "+CPSql.SQLValueAdapter(CPLib.ToSQL("prog\\PSTOPERS\\'"+CPLib.LRTrim(_gAzienda)+"'","?",0,0,m_cServer),m_cServer,"prog\\PSTOPERS\\'"+CPLib.LRTrim(_gAzienda)+"'")+"";
        m_cSql = m_cSql+" and warncode = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_gAzienda,"?",0,0,m_cServer),m_cServer,_gAzienda)+"";
        m_cSql = m_cSql+m_oWrInfo.WhereFilter();
        m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        if (CPLib.lt(m_nUpdatedRows,0)) {
        ...
        if (CPLib.eqr(m_nUpdatedRows,0)) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cpwarn",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arrt_import_rtra",1229,"000006D4")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000006D4(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL("prog\\PSTOPERS\\'"+CPLib.LRTrim(_gAzienda)+"'","?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_gAzienda,"?",0,0,m_cServer)+", ";
  ...
  public static arrt_import_rtraR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_import_rtraR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pTipo = CPLib.Space(1);
  ...
  // ENTITY_BATCHES: ,arfn_agechar,arfn_chkcodfis,arfn_conv_stato_uic,arfn_fdatetime,arrt_ae_agg_aetesta_sog,arrt_calccodfis_wu,
  public static final String i_InvokedRoutines = ",arfn_agechar,arfn_chkcodfis,arfn_conv_stato_uic,arfn_fdatetime,arrt_ae_agg_aetesta_sog,arrt_calccodfis_wu,";
  ...
  protected static String GetFieldsName_00000483(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_00000490(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"REGRES,";
    p_cSql = p_cSql+"FLGBL,";
  ...
  protected static String GetFieldsName_000004A2(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000004C4(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"ANNOOPE,";
    p_cSql = p_cSql+"C_RAG,";
    p_cSql = p_cSql+"C_STA,";
  ...
  protected static String GetFieldsName_000004CB(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000665(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"ALLINEATO,";
    p_cSql = p_cSql+"ALLINEATONOMECNOME,";
    p_cSql = p_cSql+"AREAGEO,";
  ...
  protected static String GetFieldsName_000006A8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"ALLINEATO,";
    p_cSql = p_cSql+"ALLINEATONOMECNOME,";
    p_cSql = p_cSql+"AREAGEO,";
  ...
  protected static String GetFieldsName_000006B0(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000006BA(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"AUTOM,";
    p_cSql = p_cSql+"CAMBIO,";
  ...
  protected static String GetFieldsName_000006D0(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000006D4(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"tablecode,";
    p_cSql = p_cSql+"warncode,";
    p_cSql = p_cSql+"autonum,";
