...
// * --- Fine Area Manuale
public class arpg_viewinfoprvBO extends arpg_viewinfoprvBL {
  ...
  public arpg_viewinfoprvBO (CPContext p_ContextObject) {
    ...
    if (m_bQuery) {
      while ( ! (l_bEof) &&  ! (m_bExitRow)) {
        ...
        if ( ! (l_bEof) &&  ! (m_bExitRow)) {
          ...
          c_TIPOOPRAP = rs.GetString("TIPOOPRAP");
          c_DES1 = rs.GetString("DES1");
