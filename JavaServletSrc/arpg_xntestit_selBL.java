...
public class arpg_xntestit_selBL extends arpg_xntestit_selWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_xntestit_sel";
  ...
  public arpg_xntestit_selBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_xntestit_sel","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
