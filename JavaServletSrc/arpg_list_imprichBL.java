...
public class arpg_list_imprichBL extends arpg_list_imprichWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_list_imprich";
  ...
  public arpg_list_imprichBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_list_imprich","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
