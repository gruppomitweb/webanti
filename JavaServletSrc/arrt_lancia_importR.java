...
// * --- Fine Area Manuale
public class arrt_lancia_importR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_importR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Stop ../jsp/pg_import_dati_portlet.jsp */
    Forward f;
    f=new Forward("../jsp/pg_import_dati_portlet.jsp",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_importR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_importR(p_Ctx, p_Caller);
  }
  public void Blank() {
