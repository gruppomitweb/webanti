...
function DisplayErrorMessage_ardt_xlientiope() {
if ( ! (ChildToLoad(FrameRef('ardt_xlientiope'))) && Ne(typeof(FrameRef('ardt_xlientiope').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xlientiope').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xeneficope() {
if ( ! (ChildToLoad(FrameRef('ardt_xeneficope'))) && Ne(typeof(FrameRef('ardt_xeneficope').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xeneficope').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xerzistiope() {
if ( ! (ChildToLoad(FrameRef('ardt_xerzistiope'))) && Ne(typeof(FrameRef('ardt_xerzistiope').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xerzistiope').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xapcoll() {
if ( ! (ChildToLoad(FrameRef('ardt_xapcoll'))) && Ne(typeof(FrameRef('ardt_xapcoll').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xapcoll').DisplayErrorMessage();
}
}
...
function DisplayErrorMessage_armt_xperazbo_agg() {
if ( ! (ChildToLoad(FrameRef('armt_xperazbo_agg'))) && Ne(typeof(FrameRef('armt_xperazbo_agg').DisplayErrorMessage),'undefined')) {
FrameRef('armt_xperazbo_agg').DisplayErrorMessage();
}
}
function DisplayErrorMessage_ardt_xpe_contante() {
if ( ! (ChildToLoad(FrameRef('ardt_xpe_contante'))) && Ne(typeof(FrameRef('ardt_xpe_contante').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_xpe_contante').DisplayErrorMessage();
}
}
...
DisableInputsInContainer(Ctrl('NIKDKIOYYF'),true);
}
...
DisableInputsInContainer(Ctrl('JWDKPZAEZU'),true);
}
...
DisableInputsInContainer(Ctrl('CEBGUGLSVM'),true);
}
...
DisableInputsInContainer(Ctrl('HHLUYHQCAT'),true);
}
if (IsDisabledByStateDriver('Intermediario7')) {
DisableInputsInContainer(Ctrl('QKOTBMZCDT'),true);
}
if (IsDisabledByStateDriver('Contante')) {
DisableInputsInContainer(Ctrl('VTXXRGJSRI'),true);
}
...
SetObligatory(Ctrl('HNMYJPHSQN'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) || IsObligatoryByStateDriver('TIPOINT2'));
SetObligatory(Ctrl('VYDRMHACRY'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Empty(w_CODINT2) && Eq(w_gVerSim,'N') || IsObligatoryByStateDriver('DESCINTER'));
SetObligatory(Ctrl('NYRJHOZOON'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) || IsObligatoryByStateDriver('PAESE'));
SetObligatory(Ctrl('YQINIDXZSL'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') || IsObligatoryByStateDriver('CODCAB2'));
SetObligatory(Ctrl('FFCAGQAZHK'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') || IsObligatoryByStateDriver('DESC2'));
SetObligatory(Ctrl('ACAPFGYRVI'),Ne(At(w_CODVOC,'|1B|2B|3B|4B|5B|6B|3M|4M|5M|6M|1R|2R'),0) && Eq(w_xFLGITAEST,'I') || IsObligatoryByStateDriver('PROV2'));
}
...
if ( ! (ChildToLoad(FrameRef('armt_xperazbo_agg'))) && Ne(typeof(FrameRef('armt_xperazbo_agg').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('armt_xperazbo_agg'),['SEGNO'],['SEGNO'],true)
}
...
parent.ZtVWeb.raiseEventToEvalParms('armt_oprovvisorie_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_oprovvisorie_dataNotSent',{'action':formaction});
}
}
}
}
CheckChild.child=[{'prg':"ardt_sogopeprov",'BOScId':function(){ return FrameRef('ardt_sogopeprov')},'repeated':0},{'prg':"ardt_xlientiope",'BOScId':function(){ return FrameRef('ardt_xlientiope')},'repeated':0},{'prg':"ardt_xeneficope",'BOScId':function(){ return FrameRef('ardt_xeneficope')},'repeated':0},{'prg':"ardt_xerzistiope",'BOScId':function(){ return FrameRef('ardt_xerzistiope')},'repeated':0},{'prg':"ardt_xapcoll",'BOScId':function(){ return FrameRef('ardt_xapcoll')},'repeated':0},{'prg':"ardt_docopebo",'BOScId':function(){ return FrameRef('ardt_docopebo')},'repeated':0},{'prg':"armt_xperazbo_agg",'BOScId':function(){ return FrameRef('armt_xperazbo_agg')},'repeated':0},{'prg':"ardt_xpe_contante",'BOScId':function(){ return FrameRef('ardt_xpe_contante')},'repeated':0}];
function Check() {
var l_bResult = true;
...
function SetChildVariables_ardt_xlientiope() {
}
function CtxLoad_ardt_xlientiope() {
if (ChildToLoad(FrameRef('ardt_xlientiope'))) {
return [LoadContext(0,'BOAFVDQFRN'),'ardt_xlientiope'];
}
}
function SetChildVariables_ardt_xeneficope() {
}
function CtxLoad_ardt_xeneficope() {
if (ChildToLoad(FrameRef('ardt_xeneficope'))) {
return [LoadContext(0,'OCTDIOXFMI'),'ardt_xeneficope'];
}
}
function SetChildVariables_ardt_xerzistiope() {
}
function CtxLoad_ardt_xerzistiope() {
if (ChildToLoad(FrameRef('ardt_xerzistiope'))) {
return [LoadContext(0,'NOKYMTFBFL'),'ardt_xerzistiope'];
}
}
function SetChildVariables_ardt_xapcoll() {
}
function CtxLoad_ardt_xapcoll() {
if (ChildToLoad(FrameRef('ardt_xapcoll'))) {
return [LoadContext(0,'QLURQBXKEV'),'ardt_xapcoll'];
}
}
...
function SetChildVariables_armt_xperazbo_agg() {
if ( ! (ChildToLoad(FrameRef('armt_xperazbo_agg'))) && Ne(typeof(FrameRef('armt_xperazbo_agg').DoUpdate),'undefined')) {
CopyWorkVar(FrameRef('armt_xperazbo_agg'),['SEGNO'],['SEGNO'],false)
}
}
function CtxLoad_armt_xperazbo_agg() {
if (ChildToLoad(FrameRef('armt_xperazbo_agg'))) {
return [LoadContext(0,'RZOXJTRIYP'),'armt_xperazbo_agg'];
}
}
function SetChildVariables_ardt_xpe_contante() {
}
function CtxLoad_ardt_xpe_contante() {
if (ChildToLoad(FrameRef('ardt_xpe_contante'))) {
return [LoadContext(0,'HPXRKUBEED'),'ardt_xpe_contante'];
}
}
