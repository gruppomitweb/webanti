...
if ( ! (m_oFather.SaveContext_armt_cgo_qadv_operazioni_dl())) {
...
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_qadv_operazioni_dl_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_cgo_qadv_operazioni_dl_dataNotSent',{'action':formaction});
}
}
}
}
...
m_bUpdated=true;
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_armt_cgo_qadv_operazioni_dl();
}
}
