...
public class aprg_rapporto_oroBL extends aprg_rapporto_oroWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "aprg_rapporto_oro";
  ...
  public static final String i_StateStructure = "{'dataope':dataope,'FLGCLOSE':FLGCLOSE,'CONNES':CONNES}";
  public static final String i_CompleteStateStructure = "{'dataope':dataope,'FLGCLOSE':FLGCLOSE,'CONNES':CONNES,'risultato':risultato}";
  public static final String i_ItemSequence = "dataope,FLGCLOSE,CONNES";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"dataope","Data Operazione","D","8","0","variabile","nokey","false","false"},new String[]{"FLGCLOSE","","C","1","0","variabile","nokey","false","false"},new String[]{"CONNES","","C","16","0","variabile","nokey","false","false"}});
  ...
  public aprg_rapporto_oroBL (CPContext p_ContextObject) {
  ...
  public boolean Set_FLGCLOSE(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_FLGCLOSE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("aprg_rapporto_oro","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_FLGCLOSE = CPLib.GetProperty(p,"FLGCLOSE",w_FLGCLOSE,0);
      w_CONNES = CPLib.GetProperty(p,"CONNES",w_CONNES,0);
      w_risultato = CPLib.GetProperty(p,"risultato",w_risultato,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
