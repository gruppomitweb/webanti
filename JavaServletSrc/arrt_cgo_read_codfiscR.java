...
// * --- Fine Area Manuale
public class arrt_cgo_read_codfiscR implements CallerWithObjs {
  ...
  public armt_snai_operBO pObj;
  public String pTipo;
  public String _lastope;
  public String cDoc;
  // * --- Area Manuale = BO - Properties
  // * --- Fine Area Manuale
  public arrt_cgo_read_codfiscR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_cgo_read_codfisc",m_Caller);
            ...
            while ( ! (Cursor_cgo_docope.Eof())) {
              ...
              if (CPLib.Empty(Cursor_cgo_docope.GetString("DCDOCUNICO"))) {
                ...
                if (CPLib.eqr(Cursor_cgo_operazioni_storico.GetString("CODFISC"),pObj.w_CODFISC)) {
                  ...
                  /* cDoc := Strtran(cDoc,'appo/','') */
                  cDoc = CPLib.Strtran(cDoc,"appo/","");
                  /* pObj.Set_DOC03(cDoc) */
                  pObj.Set_DOC03(cDoc);
                } // End If
  ...
  public String RunAsync(armt_snai_operBO p_pObj,String p_pTipo) {
    pObj = p_pObj;
    pTipo = p_pTipo;
  ...
  public Forward Run(armt_snai_operBO p_pObj,String p_pTipo) {
    pObj = p_pObj;
    pTipo = p_pTipo;
    return Run();
  }
  ...
  public static arrt_cgo_read_codfiscR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_cgo_read_codfiscR(p_Ctx, p_Caller);
  }
  public void Blank() {
    pObj = null;
    pTipo = CPLib.Space(1);
