...
m_oFather.i_last_focused_item='child_ardt_ope_contante';
...
function Help() {
windowOpenForeground('../doc/ardt_ope_contante_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'ope_contante'+'\\'+CPLib.ToCPStr(w_IDOPE);
}
...
p_d.setValue('ardt_ope_contante',m_cSelectedPage);
