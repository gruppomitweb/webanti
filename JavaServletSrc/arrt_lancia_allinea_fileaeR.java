...
// * --- Fine Area Manuale
public class arrt_lancia_allinea_fileaeR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_allinea_fileaeR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_allinea_fileae",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_allinea_fileae";
  ...
  void Page_1() throws Exception {
    ...
    /* Lancia la pagina */
    /* Stop arpg_allinea_fileae */
    Forward f;
    f=new Forward("arpg_allinea_fileae",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_allinea_fileaeR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_allinea_fileaeR(p_Ctx, p_Caller);
  }
  public void Blank() {
    _tipo = CPLib.Space(1);
  }
