...
m_oFather.DoQueryFromChild('xapopebo',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
function DoQueryFrom_xntestbo(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPPORTO ";
}
function DoQueryFrom_xelegabo(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPPORTO ";
}
function DoQueryFrom_xoginfo(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPCOL ";
}
function DoQueryFrom_xiduciabo(firstAlias) {
return m_cVirtName+".RAPPORTO = "+firstAlias+".RAPCOL ";
}
function DoQueryFrom_xerzistirap(firstAlias) {
...
_chNotF(childAlias,'master','armt_provinformazioni');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('xapopebo',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
