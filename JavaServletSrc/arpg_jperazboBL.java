...
public class arpg_jperazboBL extends arpg_jperazboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_jperazbo";
  ...
  public arpg_jperazboBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_jperazbo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
