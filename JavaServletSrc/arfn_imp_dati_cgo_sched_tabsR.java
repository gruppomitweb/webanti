...
// * --- arfn_imp_dati_cgo_sched_tabs
import java.io.File;
import java.io.FileReader;
import java.io.FileWriter;
import org.apache.commons.lang3.RandomStringUtils;
// * --- Fine Area Manuale
public class arfn_imp_dati_cgo_sched_tabsR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_imp_dati_cgo_sched_tabsR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_imp_dati_cgo_sched_tabs",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arfn_imp_dati_cgo_sched_tabs";
  ...
  void Page_1() throws Exception {
    ...
    try {
          ...
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              ...
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arfn_imp_dati_cgo_sched_tabs: query on tbcitta returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
      ...
      while ( ! (Cursor_tbcitta.Eof())) {
        mcTBCITTA.AppendWithTrimmedKey(Cursor_tbcitta.GetString("CITTA")+Cursor_tbcitta.GetString("PROV"));
        ...
        Cursor_tbstati.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arfn_imp_dati_cgo_sched_tabs: query on tbstati returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
      ...
      while ( ! (Cursor_tbstati.Eof())) {
        mcTBSTATI.AppendWithTrimmedKey(Cursor_tbstati.GetString("DESCRI"));
        ...
        Cursor_cgo_causali.ActionOnClose(new Runnable() {
          public void run() {
            if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
              com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
              if ( ! (CPLib.IsNull(info))) {
                info.log("Routine arfn_imp_dati_cgo_sched_tabs: query on cgo_causali returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
              }
            }
          }
          });
      ...
      while ( ! (Cursor_cgo_causali.Eof())) {
        mcCAUSALI.AppendWithTrimmedKey(Cursor_cgo_causali.GetDouble("CACODICE")+Cursor_cgo_causali.GetString("CATIPOPE"));
      ...
      while ( ! (Cursor_cpazi.Eof())) {
        ...
        double nTry0000010Fstatus;
        nTry0000010Fstatus = m_Sql.GetTransactionStatus();
        String cTry0000010Fmsg;
        cTry0000010Fmsg = m_Sql.TransactionErrorMessage();
        try {
          /* nTotErr := 0 */
          ...
          /* Utilities.SetCompany(LRTrim(cpazi->codazi)) */
          Utilities.Make(m_Ctx,m_Caller).SetCompany(CPLib.LRTrim(Cursor_cpazi.GetString("codazi")));
          /* Exec Routine arrt_writelog('IMPORT DATI','Scheduler','Errors',_gMsgProc) */
          arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","Scheduler","Errors",_gMsgProc);
        } finally {
          if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry0000010Fstatus,0)) {
            m_Sql.SetTransactionStatus(nTry0000010Fstatus,cTry0000010Fmsg);
          }
        }
        Cursor_cpazi.Next();
      }
  ...
  void Page_2() throws Exception {
    ...
    try {
      ...
      if (CPLib.gt(_totale,0)) {
        ...
        while ( ! (Cursor_cgo_anadip.Eof())) {
          ...
          if (CPLib.eqr(_recOK,0)) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xCodCab))) {
              ...
              m_cSql = m_cSql+" and PROV="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_anadip.GetString("PROVINCIA"),"C",2,0,m_cServer),m_cServer,Cursor_cgo_anadip.GetString("PROVINCIA"));
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on tbcitta into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on anadip into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
              ...
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000014F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anadip",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000151")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000154")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_cgo_telematico.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000157")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000159")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000015A")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
        ...
        /* Exec Routine arrt_writelog('IMPORT DATI','ANADIP','Inseriti / Aggiornati '+LRTrim(Str(dNumNew+dNumMod,10,0)),_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","ANADIP","Inseriti / Aggiornati "+CPLib.LRTrim(CPLib.Str(dNumNew+dNumMod,10,0)),_gMsgProc);
        /* If oNumErr > 0 */
        if (CPLib.gt(oNumErr,0)) {
          ...
          /* Exec Routine arrt_writelog('IMPORT DATI','ANADIP','Scartati '+LRTrim(Str(dNumErr,10,0)),_gMsgProc) */
          arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","ANADIP","Scartati "+CPLib.LRTrim(CPLib.Str(dNumErr,10,0)),_gMsgProc);
        } // End If
      } else { // Else
        /* _gMsgProc := "Nessuna Dipendenza Inserita, Aggiornata o Scartata" */
        _gMsgProc = "Nessuna Dipendenza Inserita, Aggiornata o Scartata";
        /* Exec Routine arrt_writelog('IMPORT DATI','ANADIP','NO RECORDS',_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","ANADIP","NO RECORDS",_gMsgProc);
      } // End If
    } finally {
      try {
        if (Cursor_qbe_cgo_anadip_totali!=null)
      ...
      if (CPLib.gt(_totale,0)) {
        ...
        while ( ! (Cursor_cgo_soggetti.Eof())) {
          ...
          if (CPLib.eqr(_recOK,0)) {
            ...
            m_cPhName = m_Ctx.GetPhName("tbstati");
            m_cSql = "";
            m_cSql = m_cSql+"CODSTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_soggetti.GetString("PAESE"),"C",3,0,m_cServer),m_cServer,Cursor_cgo_soggetti.GetString("PAESE"));
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbstati into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xCodCab))) {
              ...
              m_cSql = "";
              m_cSql = m_cSql+"CITTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(xCitta,"C",60,0,m_cServer),m_cServer,xCitta);
              m_cSql = m_cSql+" and PROV="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_soggetti.GetString("PROVINCIA"),"C",2,0,m_cServer),m_cServer,Cursor_cgo_soggetti.GetString("PROVINCIA"));
              if (m_Ctx.IsSharedTemp("tbcitta")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
              if (Read_Cursor!=null)
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("NASPROV"))))) {
              ...
              if (CPLib.eqr(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("NASPROV")),"EE")) {
                ...
                m_cPhName = m_Ctx.GetPhName("tbcitta");
                m_cSql = "";
                m_cSql = m_cSql+"CITTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_soggetti.GetString("NASCOMUN"),"C",60,0,m_cServer),m_cServer,Cursor_cgo_soggetti.GetString("NASCOMUN"));
                m_cSql = m_cSql+" and PROV="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_soggetti.GetString("NASPROV"),"C",2,0,m_cServer),m_cServer,Cursor_cgo_soggetti.GetString("NASPROV"));
                if (m_Ctx.IsSharedTemp("tbcitta")) {
                  m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                }
                if (Read_Cursor!=null)
            ...
            if ( ! (CPLib.Empty(xConnes))) {
              ...
              if (CPLib.ne(CPLib.Upper(CPLib.LRTrim(xRiga1)+CPLib.LRTrim(xRiga3)),CPLib.Upper(CPLib.LRTrim(xRiga2)+CPLib.LRTrim(xRiga4)))) {
                ...
                if (CPLib.eqr(_stoper,1)) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on wersonbo into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_oldmodi))) {
                    /* cProgSto := LibreriaMit.GeneraCodice(15,true,false,"") */
                    cProgSto = LibreriaMit.GeneraCodice(15,true,false,"");
                    // * --- Select from personbo
                    m_cServer = m_Ctx.GetServer("personbo");
                    m_cPhName = m_Ctx.GetPhName("personbo");
                    ...
                    while ( ! (Cursor_personbo.Eof())) {
                      ...
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000001EA")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                if (CPLib.ne(CPLib.Upper(CPLib.LRTrim(xRiga1)),CPLib.Upper(CPLib.LRTrim(xRiga2)))) {
                  ...
                  while ( ! (Cursor_intestbo.Eof())) {
                    ...
                    if (CPLib.Empty(Cursor_intestbo.GetDate("DATAFINE"))) {
                      ...
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000001F5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapopebo",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000001F9")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000001FA")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"personbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000201")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000201(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000207")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_cgo_rapporti.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000020B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              while ( ! (Cursor_cgo_telematico.Eof())) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico_err",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000020E")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000210")+"delete from "+m_oWrInfo.GetTableWriteName();
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"SNAINUMOPE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0,m_cServer),m_cServer,Cursor_cgo_telematico.GetString("SNAINUMOPE"))+"";
                m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000211")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
            ...
            while ( ! (Cursor_intestbo.Eof())) {
              ...
              while ( ! (Cursor_cgo_telematico.Eof())) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico_err",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000214")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000216")+"delete from "+m_oWrInfo.GetTableWriteName();
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"SNAINUMOPE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0,m_cServer),m_cServer,Cursor_cgo_telematico.GetString("SNAINUMOPE"))+"";
                m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            ...
            while ( ! (Cursor_xntestbo.Eof())) {
              ...
              while ( ! (Cursor_cgo_telematico.Eof())) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico_err",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000219")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_00000219(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_cgo_telematico.GetString("ENV"),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_cgo_telematico.GetString("CODDIPE"),"?",0,0,m_cServer)+", ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000021B")+"delete from "+m_oWrInfo.GetTableWriteName();
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"SNAINUMOPE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0,m_cServer),m_cServer,Cursor_cgo_telematico.GetString("SNAINUMOPE"))+"";
                m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000021C")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
        ...
        /* Exec Routine arrt_writelog('IMPORT DATI','PERSONBO','Inseriti / Aggiornati '+LRTrim(Str(sNumNew+sNumMod,10,0)),_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","PERSONBO","Inseriti / Aggiornati "+CPLib.LRTrim(CPLib.Str(sNumNew+sNumMod,10,0)),_gMsgProc);
        /* If sNumErr > 0 */
        if (CPLib.gt(sNumErr,0)) {
          ...
          /* Exec Routine arrt_writelog('IMPORT DATI','PERSONBO','Scartati '+LRTrim(Str(sNumErr,10,0)),_gMsgProc) */
          arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","PERSONBO","Scartati "+CPLib.LRTrim(CPLib.Str(sNumErr,10,0)),_gMsgProc);
        } // End If
      } else { // Else
        /* _gMsgProc := "Nessuna Soggetto Inserito, Aggiornato o Scartato" */
        _gMsgProc = "Nessuna Soggetto Inserito, Aggiornato o Scartato";
        /* Exec Routine arrt_writelog('IMPORT DATI','PERSONBO','NO RECORDS',_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","PERSONBO","NO RECORDS",_gMsgProc);
      } // End If
    } finally {
      try {
        if (Cursor_qbe_cgo_soggetti_totali!=null)
      ...
      if (CPLib.gt(_totale,0)) {
        ...
        while ( ! (Cursor_cgo_rapporti.Eof())) {
          ...
          if (CPLib.eqr(_snaistor,"N")) {
            ...
            if (CPLib.Empty(Cursor_cgo_rapporti.GetString("CODINTEST"))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on personbo into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(Cursor_cgo_rapporti.GetString("TIPOMOV")))) && (CPLib.eqr(Cursor_cgo_rapporti.GetString("TIPOMOV"),"C") || CPLib.eqr(Cursor_cgo_rapporti.GetString("TIPOMOV"),"S"))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on anarapbo into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              if (CPLib.Empty(CPLib.LRTrim(_rapporto))) {
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on xnarapbo into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
          ...
          if (CPLib.eqr(_recOK,0)) {
            ...
            if (CPLib.eqr(Cursor_cgo_rapporti.GetString("TIPOMOV"),"A")) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
                ...
                if (CPLib.eqr(w_tipodest,"P")) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000256")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000025A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000260")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000261")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapopebo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000265")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000026B")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000026C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_0000026C(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_cgo_rapporti.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_cgo_rapporti.GetString("DESCRAP"),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xapopebo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000273")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xntestbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000278")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"rapopebo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000027C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"intestbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000281")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"DATAFINE = "+CPLib.ToSQL(Cursor_cgo_rapporti.GetDate("DATAOPE"),"D",8,0)+", ";
                m_cSql = m_cSql+"NUMPROG2 = "+CPLib.ToSQL(cInfProg2,"C",11,0,m_cServer)+", ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anarapbo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000282")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"anarapbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000284")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CASTATOC = "+CPLib.ToSQL(Cursor_cgo_rapporti.GetDouble("CASTATOC"),"N",3,0)+", ";
              m_cSql = m_cSql+"CASTATOM = "+CPLib.ToSQL(Cursor_cgo_rapporti.GetDouble("CASTATOM"),"N",3,0)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_rapporti_err",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000286")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            while ( ! (Cursor_cgo_telematico.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico_err",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000289")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000028A")+"delete from "+m_oWrInfo.GetTableWriteName();
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"SNAINUMOPE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0,m_cServer),m_cServer,Cursor_cgo_telematico.GetString("SNAINUMOPE"))+"";
              m_cSql = m_cSql+m_oWrInfo.WhereFilter();
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_rapporti",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000028C")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_rapporti.GetString("RAPPORTO"),"?",0,0,m_cServer),m_cServer,Cursor_cgo_rapporti.GetString("RAPPORTO"))+"";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter();
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        ...
        /* Exec Routine arrt_writelog('IMPORT DATI','RAPOPEBO','Inseriti / Aggiornati '+LRTrim(Str((rNumNew+rNumMod),10,0)),_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","RAPOPEBO","Inseriti / Aggiornati "+CPLib.LRTrim(CPLib.Str((rNumNew+rNumMod),10,0)),_gMsgProc);
        /* If rNumErr > 0 */
        if (CPLib.gt(rNumErr,0)) {
          ...
          /* Exec Routine arrt_writelog('IMPORT DATI','RAPOPEBO','Scartati '+LRTrim(Str(rNumErr,10,0)),_gMsgProc) */
          arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","RAPOPEBO","Scartati "+CPLib.LRTrim(CPLib.Str(rNumErr,10,0)),_gMsgProc);
        } // End If
      } else { // Else
        /* _gMsgProc := "Nessun Rapporto Inserito, Aggiornato o Scartato" */
        _gMsgProc = "Nessun Rapporto Inserito, Aggiornato o Scartato";
        /* Exec Routine arrt_writelog('IMPORT DATI','RAPOPEBO','NO RECORDS',_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","RAPOPEBO","NO RECORDS",_gMsgProc);
      } // End If
    } finally {
      try {
        if (Cursor_qbe_cgo_rapporti_totali!=null)
    ...
    try {
      ...
      if (CPLib.gt(_totale,0)) {
        ...
        while ( ! (Cursor_cgo_telematico.Eof())) {
          ...
          if (CPLib.eqr(_snaistor,"N")) {
            ...
            if (CPLib.Empty(Cursor_cgo_telematico.GetDouble("CACODICE"))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on cgo_causali into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          /* If _recOK=0 */
          if (CPLib.eqr(_recOK,0)) {
            /* _numopetele := cgo_telematico->SNAINUMOPE */
            _numopetele = Cursor_cgo_telematico.GetString("SNAINUMOPE");
            /* If _snaistor='S' */
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico_err",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000031A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_telematico",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000031C")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
          m_cSql = m_cSql+"SNAINUMOPE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0,m_cServer),m_cServer,Cursor_cgo_telematico.GetString("SNAINUMOPE"))+"";
          m_cSql = m_cSql+m_oWrInfo.WhereFilter();
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        ...
        /* Exec Routine arrt_writelog('IMPORT DATI','OPERAZIONI','Inseriti / Aggiornati '+LRTrim(Str(oNumero+fNumero,10,0)),_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","OPERAZIONI","Inseriti / Aggiornati "+CPLib.LRTrim(CPLib.Str(oNumero+fNumero,10,0)),_gMsgProc);
        /* If oNumErr > 0 */
        if (CPLib.gt(oNumErr,0)) {
          /* _gMsgProc := 'Movimenti Scartati: '+LRTrim(Str(oNumErr,10,0)) + NL */
          _gMsgProc = "Movimenti Scartati: "+CPLib.LRTrim(CPLib.Str(oNumErr,10,0))+"\n";
          /* Exec Routine arrt_writelog('IMPORT DATI','OPERAZIONI','Scartati '+LRTrim(Str(oNumErr,10,0)),_gMsgProc) */
          arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","OPERAZIONI","Scartati "+CPLib.LRTrim(CPLib.Str(oNumErr,10,0)),_gMsgProc);
        } // End If
      } else { // Else
        /* _gMsgProc := "Nessuna Operazione/Frazionata Inserita" */
        _gMsgProc = "Nessuna Operazione/Frazionata Inserita";
        /* Exec Routine arrt_writelog('IMPORT DATI','OPERAZIONI','NO RECORDS',_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","OPERAZIONI","NO RECORDS",_gMsgProc);
      } // End If
    } finally {
      try {
        if (Cursor_qbe_cgo_telematico_totali!=null)
      ...
      if (CPLib.gt(_totale,0)) {
        ...
        while ( ! (Cursor_cgo_users.Eof())) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on cpusers into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(nUser,0)) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000338")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_00000338(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000339")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000033A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cpusers",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000033C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cpusers_add",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000033D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000033F")+"delete from "+m_oWrInfo.GetTableWriteName();
          m_cSql = m_cSql+" where ";
        ...
        /* Exec Routine arrt_writelog('IMPORT DATI','UTENTI','Inseriti / Aggiornati '+LRTrim(Str(_conta,10,0)),_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","UTENTI","Inseriti / Aggiornati "+CPLib.LRTrim(CPLib.Str(_conta,10,0)),_gMsgProc);
      } else { // Else
        /* _gMsgProc := "Nessun Utente Inserito o Aggiornato" */
        _gMsgProc = "Nessun Utente Inserito o Aggiornato";
        /* Exec Routine arrt_writelog('IMPORT DATI','UTENTI','NO RECORDS',_gMsgProc) */
        arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","UTENTI","NO RECORDS",_gMsgProc);
      } // End If
    } finally {
      try {
        if (Cursor_qbe_cgo_users_totali!=null)
  ...
  void Page_7() throws Exception {
    ...
    try {
      ...
      while ( ! (Cursor_cgo_soggetti.Eof())) {
        ...
        if (CPLib.Empty(Cursor_cgo_soggetti.GetString("NASCOMUN")) && CPLib.Empty(Cursor_cgo_soggetti.GetString("NASSTATO"))) {
          ...
          if (CPLib.Empty(Cursor_cgo_soggetti.GetString("NASPROV"))) {
            ...
            if (CPLib.eqr(CPLib.Upper(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("NASPROV"))),"EE")) {
              ...
              m_cPhName = m_Ctx.GetPhName("tbcitta");
              m_cSql = "";
              m_cSql = m_cSql+"CITTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Upper(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("NASCOMUN"))),"C",60,0,m_cServer),m_cServer,CPLib.Upper(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("NASCOMUN"))));
              m_cSql = m_cSql+" and PROV="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_soggetti.GetString("NASPROV"),"C",2,0,m_cServer),m_cServer,Cursor_cgo_soggetti.GetString("NASPROV"));
              if (m_Ctx.IsSharedTemp("tbcitta")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
        ...
        /* If _flglight='N' or (_flglight='S' and (cgo_soggetti->FLGLIGHT='N' or Empty(cgo_soggetti->FLGLIGHT))) */
        if (CPLib.eqr(_flglight,"N") || (CPLib.eqr(_flglight,"S") && (CPLib.eqr(Cursor_cgo_soggetti.GetString("FLGLIGHT"),"N") || CPLib.Empty(Cursor_cgo_soggetti.GetString("FLGLIGHT"))))) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("TIPODOC")))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbtipdoc into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
        ...
        if (CPLib.Empty(Cursor_cgo_soggetti.GetString("PAESE"))) {
          ...
          if (CPLib.eqr(Cursor_cgo_soggetti.GetString("PAESE"),"086")) {
            ...
            if (CPLib.Empty(Cursor_cgo_soggetti.GetString("DESCCIT"))) {
              ...
              m_cPhName = m_Ctx.GetPhName("tbcitta");
              m_cSql = "";
              m_cSql = m_cSql+"CITTA="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Upper(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("DESCCIT"))),"C",60,0,m_cServer),m_cServer,CPLib.Upper(CPLib.LRTrim(Cursor_cgo_soggetti.GetString("DESCCIT"))));
              m_cSql = m_cSql+" and PROV="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_cgo_soggetti.GetString("PROVINCIA"),"C",2,0,m_cServer),m_cServer,Cursor_cgo_soggetti.GetString("PROVINCIA"));
              if (m_Ctx.IsSharedTemp("tbcitta")) {
                m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
              }
  ...
  void Page_8() throws Exception {
    ...
    try {
      ...
      while ( ! (Cursor_cgo_telematico.Eof())) {
        /* _coddip := cgo_telematico->CODDIPE */
        _coddip = Cursor_cgo_telematico.GetString("CODDIPE");
        /* _ipcol := cgo_telematico->IPCOLLEG */
        _ipcol = Cursor_cgo_telematico.GetString("IPCOLLEG");
        /* _drcol := cgo_telematico->DUCOLLEG */
        _drcol = CPLib.Round(Cursor_cgo_telematico.GetDouble("DUCOLLEG"),0);
        /* _orcol := cgo_telematico->ORACOLLEG */
        _orcol = Cursor_cgo_telematico.GetDateTime("ORACOLLEG");
        /* _idbiglietto := cgo_telematico->CAIDBIGLIETTO */
        _idbiglietto = Cursor_cgo_telematico.GetString("CAIDBIGLIETTO");
        /* _rapporto := cgo_telematico->RAPPORTO */
        _rapporto = Cursor_cgo_telematico.GetString("RAPPORTO");
        /* _env := cgo_telematico->ENV */
        _env = Cursor_cgo_telematico.GetString("ENV");
        /* _importo := cgo_telematico->TOTLIRE */
        _importo = CPLib.Round(Cursor_cgo_telematico.GetDouble("TOTLIRE"),0);
        /* _iban := cgo_telematico->IBAN */
        _iban = Cursor_cgo_telematico.GetString("IBAN");
        /* _vpcodice := cgo_telematico->VPCODICE */
        _vpcodice = Cursor_cgo_telematico.GetString("VPCODICE");
        // * --- Select from anadip
        m_cServer = m_Ctx.GetServer("anadip");
        m_cPhName = m_Ctx.GetPhName("anadip");
        ...
        if (Read_Cursor!=null)
          Read_Cursor.Close();
        Read_Cursor = m_Sql.Query(m_cServer,"select "+CPLib.GetMultilanguageField("CACODANA",m_Ctx,m_cServer)+","+CPLib.GetMultilanguageField("CACODSIN",m_Ctx,m_cServer)+","+CPLib.GetMultilanguageField("CASEGNO",m_Ctx,m_cServer)+","+CPLib.GetMultilanguageField("CAFLGAUI",m_Ctx,m_cServer)+","+CPLib.GetMultilanguageField("CAFLGOPE",m_Ctx,m_cServer)+" from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+m_cSql);
        if ( ! (Read_Cursor.Eof())) {
          _codana = Read_Cursor.GetString("CACODANA");
          _codsin = Read_Cursor.GetString("CACODSIN");
          _segno = Read_Cursor.GetString("CASEGNO");
          _flgaui = Read_Cursor.GetString("CAFLGAUI");
          _flgope = Read_Cursor.GetString("CAFLGOPE");
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on cgo_causali into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
        ...
        /* xCF := '' */
        xCF = "";
        /* _catipgio := cgo_telematico->CATIPGIO */
        _catipgio = CPLib.Round(Cursor_cgo_telematico.GetDouble("CATIPGIO"),0);
        /* _catipcon := cgo_telematico->CATIPCON */
        _catipcon = CPLib.Round(Cursor_cgo_telematico.GetDouble("CATIPCON"),0);
        /* _capv_cod := cgo_telematico->CAPV_COD */
        _capv_cod = CPLib.Round(Cursor_cgo_telematico.GetDouble("CAPV_COD"),0);
        /* _cadataora := cgo_telematico->CADATAORA */
        _cadataora = Cursor_cgo_telematico.GetDateTime("CADATAORA");
        /* If cgo_telematico->ENV='W' */
        if (CPLib.eqr(Cursor_cgo_telematico.GetString("ENV"),"W")) {
          ...
          /* _biglietto := cgo_telematico->CAIDBIGLIETTO */
          _biglietto = Cursor_cgo_telematico.GetString("CAIDBIGLIETTO");
          /* If _flgaui='N' */
          if (CPLib.eqr(_flgaui,"N")) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003C7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_000003C7(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            ...
            if (CPLib.eqr(_locrap,"D")) {
              ...
              while ( ! (Cursor_intestbo.Eof())) {
                ...
                if (CPLib.eqr(nIntest,1)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003CC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003CD")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_000003CD(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              ...
              while ( ! (Cursor_xntestbo.Eof())) {
                ...
                if (CPLib.eqr(nIntest,1)) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003D2")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"slientifrz",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003D3")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  m_cSql = m_cSql+GetFieldsName_000003D3(m_Ctx,m_oWrInfo);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
              ...
              while ( ! (Cursor_personbo.Eof())) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sraziobo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003D7")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            ...
            if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
              ...
              if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                ...
                while ( ! (Cursor_inter2bo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003DC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"sraziobo",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003DE")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"sraziobo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
          ...
          Cursor_cgo_tbtipgio = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+""+CPLib.ToSQL(Cursor_cgo_telematico.GetString("TIPOGIOCO"),"?",0,0)+" "+")"+(m_Ctx.IsSharedTemp("cgo_tbtipgio")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
          while ( ! (Cursor_cgo_tbtipgio.Eof())) {
            /* If cgo_telematico->TOTLIRE < cgo_tbtipgio->SOGTPGIO */
            if (CPLib.lt(Cursor_cgo_telematico.GetDouble("TOTLIRE"),Cursor_cgo_tbtipgio.GetDouble("SOGTPGIO"))) {
              /* _flgvlt := cgo_tbtipgio->DEFTPGIO */
              _flgvlt = Cursor_cgo_tbtipgio.GetString("DEFTPGIO");
            } else { // Else
              /* _flgvlt := cgo_tbtipgio->DEFSPGIO */
              _flgvlt = Cursor_cgo_tbtipgio.GetString("DEFSPGIO");
            } // End If
          ...
          if (CPLib.eqr(Cursor_cgo_telematico.GetString("ENV"),"V")) {
            ...
            Cursor_cgo_operazioni_dl = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select SNAINUMOPE,ASSEGNO  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"DATAOPE= "+CPSql.SQLValueAdapter(CPLib.ToSQL(_datope,"?",0,0,m_cServer, m_oParameters),m_cServer,_datope)+"  and  CODDIPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("CODDIPE"),"?",0,0)+"  and  TOTLIRE="+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"?",0,0)+"  and  TIPOGIOCO='V' "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_dl")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
            ...
            if (CPLib.eqr(_numope,"")) {
              ...
              Cursor_cgo_operazioni_dl_multi = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"CODDIPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("CODDIPE"),"?",0,0)+"  and  TIPOGIOCO='V' "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_dl_multi")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
              while ( ! (Cursor_cgo_operazioni_dl_multi.Eof())) {
                ...
                while ( ! (Cursor_cgo_operazioni_dl_multi_dt.Eof())) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000003F6")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"TOTLIRE = "+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"N",15,2)+", ";
            ...
            /* If not(Empty(LRTrim(_numope))) and cgo_telematico->TOTLIRE > 1000 */
            if ( ! (CPLib.Empty(CPLib.LRTrim(_numope))) && CPLib.gt(Cursor_cgo_telematico.GetDouble("TOTLIRE"),1000)) {
              /* Exec "Scrive i dati per AAMS" Page 9:Page_9 */
              Page_9();
            } // End If
          } else { // Else
            /* _idb := '' */
            ...
            if (CPLib.Empty(CPLib.LRTrim(_numope))) {
              ...
              if (Cursor_cgo_operazioni_dl_multi!=null)
                Cursor_cgo_operazioni_dl_multi.Close();
              Cursor_cgo_operazioni_dl_multi = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"CODDIPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("CODDIPE"),"?",0,0)+"  and  CGOTIPOPE <> 'V' "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_dl_multi")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
              while ( ! (Cursor_cgo_operazioni_dl_multi.Eof())) {
                /* _numass := cgo_operazioni_dl_multi->ASSEGNO */
                _numass = Cursor_cgo_operazioni_dl_multi.GetString("ASSEGNO");
                // * --- Select from cgo_operazioni_dl_multi_dt
                ...
                if (Cursor_cgo_operazioni_dl_multi_dt!=null)
                  Cursor_cgo_operazioni_dl_multi_dt.Close();
                Cursor_cgo_operazioni_dl_multi_dt = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"SNAINUMOPE="+CPLib.ToSQL(Cursor_cgo_operazioni_dl_multi.GetString("SNAINUMOPE"),"?",0,0)+"  and  DATOPE= "+CPSql.SQLValueAdapter(CPLib.ToSQL(_datope,"?",0,0,m_cServer, m_oParameters),m_cServer,_datope)+"  and  TOTLIRE="+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"?",0,0)+"  and  CAIDBIGLIETTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(_seekid,"?",0,0,m_cServer, m_oParameters),m_cServer,_seekid)+" "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_dl_multi_dt")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
                while ( ! (Cursor_cgo_operazioni_dl_multi_dt.Eof())) {
                  /* _numope := cgo_operazioni_dl_multi_dt->SNAINUMOPE */
                  _numope = Cursor_cgo_operazioni_dl_multi_dt.GetString("SNAINUMOPE");
                  /* _omulti := 'S' */
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_operazioni_dl_multi_dt",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000040E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"TOTLIRE = "+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"N",15,2)+", ";
                  m_cSql = m_cSql+"FLGFULL = "+CPLib.ToSQL("S","C",1,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_operazioni_dl_multi_dt",false,true);
                  m_cSql = m_cSql+" where ";
                ...
                if (CPLib.Empty(CPLib.LRTrim(_numope))) {
                  ...
                  while ( ! (Cursor_cgo_operazioni_dl_multi_dt.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_operazioni_dl_multi_dt",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000413")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TOTLIRE = "+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"N",15,2)+", ";
                    m_cSql = m_cSql+"FLGFULL = "+CPLib.ToSQL("S","C",1,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_operazioni_dl_multi_dt",false,true);
                    m_cSql = m_cSql+" where ";
            ...
            /* If not(Empty(LRTrim(_numope))) and (cgo_telematico->TOTLIRE > 1000 and  cgo_telematico->TOTLIRE < 15000) */
            if ( ! (CPLib.Empty(CPLib.LRTrim(_numope))) && (CPLib.gt(Cursor_cgo_telematico.GetDouble("TOTLIRE"),1000) && CPLib.lt(Cursor_cgo_telematico.GetDouble("TOTLIRE"),15000))) {
              /* Exec "Scrive i dati per AAMS" Page 9:Page_9 */
              Page_9();
            } // End If
          } // End If
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(_numope)))) {
            ...
            if (CPLib.eqr(_omulti,"S")) {
              ...
              while ( ! (Cursor_cgo_operazioni_dl.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000041F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_0000041F(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
            ...
            if (CPLib.eqr(_omulti,"N")) {
              ...
              /* If False */
              if (false) {
                /* Exec Routine arrt_writelog('IMPORT DATI','CGO_OPERAZIONI',nProgOpe,'Associazione Operazione con IDBIGLIETTO'+_seekid) */
                arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","CGO_OPERAZIONI",nProgOpe,"Associazione Operazione con IDBIGLIETTO"+_seekid);
              } // End If
            ...
            /* If False */
            if (false) {
              /* Exec Routine arrt_writelog('IMPORT DATI','CGO_OPERAZIONI',nProgOpe,'Inserimento Operazione con IDBIGLIETTO'+_seekid) */
              arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","CGO_OPERAZIONI",nProgOpe,"Inserimento Operazione con IDBIGLIETTO"+_seekid);
            } // End If
            // * --- Insert into cgo_operazioni from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("cgo_operazioni");
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_operazioni",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000430")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          /* ElseIf cgo_telematico->ENV='M' */
        } else if (CPLib.eqr(Cursor_cgo_telematico.GetString("ENV"),"M")) {
          /* _flgvnp := 'A' */
          _flgvnp = "A";
          /* nTotRighe := 0 */
          ...
          Cursor_cgo_telematico_multipla = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *,'N'  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"SNAINUMOPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0)+" "+")"+(m_Ctx.IsSharedTemp("cgo_telematico_multipla")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
          {
            ...
            Cursor_cgo_telematico_multipla.ActionOnClose(new Runnable() {
              public void run() {
                if (CPLib.gt(m_TheCursor.CurrentRow()-1,1000*1.1)) {
                  com.zucchetti.sitepainter.Logger info = com.zucchetti.sitepainter.Logger.getWarningLogger();
                  if ( ! (CPLib.IsNull(info))) {
                    info.log("Routine arfn_imp_dati_cgo_sched_tabs: query on cgo_telematico_multipla returns "+(m_TheCursor.CurrentRow()-1)+" rows larger then the expected 1000");
                  }
                }
              }
              });
          ...
          if (Cursor_cgo_operazioni_dl_multi!=null)
            Cursor_cgo_operazioni_dl_multi.Close();
          Cursor_cgo_operazioni_dl_multi = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"CODDIPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("CODDIPE"),"?",0,0)+" "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_dl_multi")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
          while ( ! (Cursor_cgo_operazioni_dl_multi.Eof())) {
            /* nTotValide := 0 */
                ...
                for (MemoryCursorRow_mctelematicomultiple_mcrdef rwMultipla : mcMultipla._iterable_()) {
                  ...
                  while ( ! (Cursor_cgo_operazioni_dl_multi_dt.Eof())) {
                    ...
                    if (CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetString("CAIDBIGLIETTO"),rwMultipla.CAIDBIGLIETTO) && CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetString("TIPOGIOCO"),rwMultipla.TIPOGIOCO) && CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetDouble("TOTLIRE"),rwMultipla.TOTLIRE) && CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetDate("DATOPE"),arfn_dt_to_dateR.Make(m_Ctx,this).Run(rwMultipla.CADATAORA))) {
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_operazioni_dl_multi_dt",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000454")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                      m_cSql = m_cSql+"FLGFULL = "+CPLib.ToSQL("S","C",1,0,m_cServer)+", ";
                      m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_operazioni_dl_multi_dt",false,true);
                      m_cSql = m_cSql+" where ";
                ...
                for (MemoryCursorRow_mctelematicomultiple_mcrdef rwMultipla : mcMultipla._iterable_()) {
                  ...
                  while ( ! (Cursor_cgo_operazioni_dl_multi_dt.Eof())) {
                    ...
                    if (CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetString("CAIDBIGLIETTO"),rwMultipla.CAIDBIGLIETTO) && CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetString("TIPOGIOCO"),rwMultipla.TIPOGIOCO) && CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetDouble("TOTLIRE"),rwMultipla.TOTLIRE) && CPLib.eqr(Cursor_cgo_operazioni_dl_multi_dt.GetDate("DATOPE"),arfn_dt_to_dateR.Make(m_Ctx,this).Run(rwMultipla.CADATAORA))) {
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_operazioni_dl_multi_dt",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000045C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                      m_cSql = m_cSql+"FLGFULL = "+CPLib.ToSQL("S","C",1,0,m_cServer)+", ";
                      m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_operazioni_dl_multi_dt",false,true);
                      m_cSql = m_cSql+" where ";
                      m_cSql = m_cSql+"CAIDBIGLIETTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(rwMultipla.CAIDBIGLIETTO,"?",0,0,m_cServer),m_cServer,rwMultipla.CAIDBIGLIETTO)+"";
          ...
          if (CPLib.eqr(_match,"N")) {
            ...
            Cursor_cgo_operazioni_storico = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"CODDIPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("CODDIPE"),"?",0,0)+"  and  TIPOGIOCO="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("TIPOGIOCO"),"?",0,0)+"  and  DATAOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(_datope,"?",0,0,m_cServer, m_oParameters),m_cServer,_datope)+" "+")"+(m_Ctx.IsSharedTemp("cgo_operazioni_storico")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
            ...
            if (CPLib.ne(nTotValide,nTotRighe)) {
              ...
              if (Cursor_intermbo!=null)
                Cursor_intermbo.Close();
              Cursor_intermbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select CGOTGDEFMUL  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+(m_Ctx.IsSharedTemp("intermbo")?"context_id='"+m_Ctx.GetTempID()+"'":"1=1"),m_cServer,m_Ctx,true));
              while ( ! (Cursor_intermbo.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000477")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              /* If False */
              if (false) {
                /* Exec Routine arrt_writelog('IMPORT DATI','CGO_OPERAZIONI',nProgOpe,'Inserimento operazione multipla da completare') */
                arrt_writelogR.Make(m_Ctx,this).Run("IMPORT DATI","CGO_OPERAZIONI",nProgOpe,"Inserimento operazione multipla da completare");
              } // End If
              /* _criga := 1 */
              ...
              if (Cursor_cgo_telematico_multipla!=null)
                Cursor_cgo_telematico_multipla.Close();
              Cursor_cgo_telematico_multipla = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"SNAINUMOPE="+CPLib.ToSQL(Cursor_cgo_telematico.GetString("SNAINUMOPE"),"?",0,0)+" "+")"+(m_Ctx.IsSharedTemp("cgo_telematico_multipla")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
              while ( ! (Cursor_cgo_telematico_multipla.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000047C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_0000047C(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(nProgOpe,"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.gt(nTotRighe,nTotValide) && CPLib.gt(nTotValide,0)) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000047F")+"delete from "+m_oWrInfo.GetTableWriteName();
                m_cSql = m_cSql+" where ";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000480")+"delete from "+m_oWrInfo.GetTableWriteName();
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"SNAINUMOPE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(xSNAINUMOPE,"?",0,0,m_cServer),m_cServer,xSNAINUMOPE)+"";
                m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on xperazbo_agg into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
                ...
                if (CPLib.Empty(_idbase)) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on operazbo_agg into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                  ...
                  if ( ! (CPLib.Empty(_idbase))) {
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000486")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000487")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_idbase,"?",0,0,m_cServer),m_cServer,_idbase)+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000488")+"delete from "+m_oWrInfo.GetTableWriteName();
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_idbase,"?",0,0,m_cServer),m_cServer,_idbase)+"";
                  m_cSql = m_cSql+m_oWrInfo.WhereFilter();
                  m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
      ...
      while ( ! (Cursor_cgo_telematico.Eof())) {
        ...
        if (CPLib.eqr(_omulti,"S")) {
          ...
          if (CPLib.gt(Cursor_cgo_telematico.GetDouble("TOTLIRE"),1000)) {
            ...
            while ( ! (Cursor_cgo_operazioni_dl_multi.Eof())) {
              ...
              while ( ! (Cursor_cgo_operazioni_dl_multi_dt.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004A5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                m_cSql = m_cSql+GetFieldsName_000004A5(m_Ctx,m_oWrInfo);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
                ...
                if (CPLib.eqr(Cursor_cgo_operazioni_dl_multi.GetString("MEZPAGAM"),"I") || CPLib.eqr(Cursor_cgo_operazioni_dl_multi.GetString("MEZPAGAM"),"E") || CPLib.eqr(Cursor_cgo_operazioni_dl_multi.GetString("MEZPAGAM"),"P")) {
                  ...
                  if (CPLib.eqr(CPLib.Left(CPLib.Upper(Cursor_cgo_operazioni_dl_multi.GetString("IBAN")),2),"IT")) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004A9")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    ...
                    while ( ! (Cursor_inter2bo.Eof())) {
                      ...
                      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
                      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004AB")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                      m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                      m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                      m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                      m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004AD")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
          ...
          while ( ! (Cursor_cgo_operazioni_dl.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004BD")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_000004BD(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(Cursor_cgo_operazioni_dl.GetString("MEZPAGAM"),"I") || CPLib.eqr(Cursor_cgo_operazioni_dl.GetString("MEZPAGAM"),"E") || CPLib.eqr(Cursor_cgo_operazioni_dl.GetString("MEZPAGAM"),"P")) {
              ...
              if (CPLib.eqr(CPLib.Left(CPLib.Upper(Cursor_cgo_operazioni_dl.GetString("IBAN")),2),"IT")) {
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004C1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL("02","C",2,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_aams_base",false,true);
                m_cSql = m_cSql+" where ";
                ...
                while ( ! (Cursor_inter2bo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004C3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                ...
                m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_aams_base",m_Ctx.GetCompany());
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004C5")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL("12","C",2,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_aams_base",false,true);
                m_cSql = m_cSql+" where ";
        ...
        if (CPLib.eqr(Cursor_cgo_telematico.GetString("ENV"),"W")) {
          ...
          if (CPLib.ge(Cursor_cgo_telematico.GetDouble("TOTLIRE"),_limoper)) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004ED")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000004ED(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_locrap,"D")) {
                ...
                while ( ! (Cursor_intestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004F2")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004F3")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on cgo_totope into routine arfn_imp_dati_cgo_sched_tabs returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004F8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000004F8(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004F9")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                ...
                while ( ! (Cursor_xntestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004FD")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientiope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000004FE")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_000004FE(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000503")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_00000503(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000504")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
                    m_cSql = m_cSql+"TOIMPORT = TOIMPORT+("+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"N",12,2)+"), ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_totope",false,true);
                    m_cSql = m_cSql+" where ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000507")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000050C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000050E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000514")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000514(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.le(CPLib.DateToChar(_datope),"20120531")?"20120601":CPLib.DateToChar(arfn_datesumR.Make(m_Ctx,this).Run(_datope,1))),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_locrap,"D")) {
                ...
                while ( ! (Cursor_intestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000519")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000051A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_0000051A(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000051F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_0000051F(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000520")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
                    m_cSql = m_cSql+"TOIMPORT = TOIMPORT+("+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"N",12,2)+"), ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_totope",false,true);
                    m_cSql = m_cSql+" where ";
                ...
                while ( ! (Cursor_xntestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000524")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000525")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_00000525(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                  ...
                  if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000052A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_0000052A(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000052B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
                    m_cSql = m_cSql+"TOIMPORT = TOIMPORT+("+CPLib.ToSQL(Cursor_cgo_telematico.GetDouble("TOTLIRE"),"N",12,2)+"), ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_totope",false,true);
                    m_cSql = m_cSql+" where ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000052E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000533")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000535")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000053C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_0000053C(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.le(CPLib.DateToChar(_datope),"20120531")?"20120601":CPLib.DateToChar(arfn_datesumR.Make(m_Ctx,this).Run(_datope,1))),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_locrap,"D")) {
                ...
                while ( ! (Cursor_intestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000541")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000542")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_00000542(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                ...
                while ( ! (Cursor_xntestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000547")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientifrz",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000548")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_00000548(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000054C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000551")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000553")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000559")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000559(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.le(CPLib.DateToChar(_datope),"20120531")?"20120601":CPLib.DateToChar(arfn_datesumR.Make(m_Ctx,this).Run(_datope,1))),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_locrap,"D")) {
                ...
                while ( ! (Cursor_intestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000055E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    ...
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000055F")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_0000055F(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                ...
                while ( ! (Cursor_xntestbo.Eof())) {
                  ...
                  if (CPLib.eqr(nIntest,1)) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000564")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
                    m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
                    m_cSql = m_cSql+" where ";
                    m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000565")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
                    m_cSql = m_cSql+GetFieldsName_00000565(m_Ctx,m_oWrInfo);
                    m_cSql = m_cSql+") values (";
                    m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
                    m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000569")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000056E")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000570")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
          ...
          if (CPLib.ge(Cursor_cgo_telematico.GetDouble("TOTLIRE"),_limoper)) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000578")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000057B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000580")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000582")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000588")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000588(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.le(CPLib.DateToChar(_datope),"20120531")?"20120601":CPLib.DateToChar(arfn_datesumR.Make(m_Ctx,this).Run(_datope,1))),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000058B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000590")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000592")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000599")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000599(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.le(CPLib.DateToChar(_datope),"20120531")?"20120601":CPLib.DateToChar(arfn_datesumR.Make(m_Ctx,this).Run(_datope,1))),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000059C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005A1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005A3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005A9")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005A9(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.le(CPLib.DateToChar(_datope),"20120531")?"20120601":CPLib.DateToChar(arfn_datesumR.Make(m_Ctx,this).Run(_datope,1))),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
                ...
                while ( ! (Cursor_personbo.Eof())) {
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005AC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_cgo_telematico.GetString("IBAN")))) {
                ...
                if (CPLib.eqr(CPLib.Left(Cursor_cgo_telematico.GetString("IBAN"),2),"IT")) {
                  ...
                  while ( ! (Cursor_inter2bo.Eof())) {
                    ...
                    m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                    m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                    m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005B1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                    m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
                    m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                    m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
                    m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
                  ...
                  m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005B3")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
                  m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
                  m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
                  m_cSql = m_cSql+" where ";
                  m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
  ...
  void Page_11() throws Exception {
    ...
    if (CPLib.eqr(_flgaui,"N")) {
      ...
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005B8")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      m_cSql = m_cSql+GetFieldsName_000005B8(m_Ctx,m_oWrInfo);
      m_cSql = m_cSql+") values (";
      m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.ge(_tottele,_limoper)) {
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo_agg",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005BB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000005BB(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_codlob,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_tipgio,"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005BC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000005BC(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_codlob,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_tipgio,"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005BE")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000005BE(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_codlob,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_tipgio,"?",0,0,m_cServer)+", ";
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005BF")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          m_cSql = m_cSql+GetFieldsName_000005BF(m_Ctx,m_oWrInfo);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_codlob,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(_tipgio,"?",0,0,m_cServer)+", ";
  ...
  void Page_12() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005C5")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_000005C5(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.DateToChar(CPLib.Date()),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(_locrap,"D")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005CA")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientiope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005CB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005CB(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005D0")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005D0(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005D1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
          ...
          while ( ! (Cursor_xntestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005D5")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientiope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005D6")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005D6(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005DB")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005DC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
              m_cSql = m_cSql+"TOIMPORT = TOIMPORT+("+CPLib.ToSQL(_importo,"N",12,2)+"), ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_totope",false,true);
              m_cSql = m_cSql+" where ";
        ...
        if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005DF")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(_iban))) {
          ...
          if (CPLib.eqr(CPLib.Left(_iban,2),"IT")) {
            ...
            while ( ! (Cursor_inter2bo.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005E4")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
              m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
              m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xperazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005E6")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xperazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005EC")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_000005EC(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.DateToChar(CPLib.Date()),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(_locrap,"D")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005F1")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005F2")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005F2(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005F7")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005F7(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005F8")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
              m_cSql = m_cSql+"TOIMPORT = TOIMPORT+("+CPLib.ToSQL(_importo,"N",12,2)+"), ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_totope",false,true);
              m_cSql = m_cSql+" where ";
          ...
          while ( ! (Cursor_xntestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005FC")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientiope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"000005FD")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_000005FD(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(_codsog))) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000602")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000602(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_datope,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"cgo_totope",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000603")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TONUMOPE = TONUMOPE+("+CPLib.ToSQL(1,"N",10,0)+"), ";
              m_cSql = m_cSql+"TOIMPORT = TOIMPORT+("+CPLib.ToSQL(_importo,"N",12,2)+"), ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"cgo_totope",false,true);
              m_cSql = m_cSql+" where ";
        ...
        if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000606")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(_iban))) {
          ...
          if (CPLib.eqr(CPLib.Left(_iban,2),"IT")) {
            ...
            while ( ! (Cursor_inter2bo.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000060B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
              m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
              m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"operazbo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000060D")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"operazbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
  ...
  void Page_13() throws Exception {
    ...
    try {
      ...
      if (CPLib.eqr(w_tipodest,"P")) {
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000614")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000614(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.DateToChar(CPLib.Date()),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(_locrap,"D")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000619")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientifrz",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000061A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_0000061A(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          while ( ! (Cursor_xntestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000061F")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xlientifrz",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000620")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000620(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000624")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(_iban))) {
          ...
          if (CPLib.eqr(CPLib.Left(_iban,2),"IT")) {
            ...
            while ( ! (Cursor_inter2bo.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000629")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
              m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
              m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xraziobo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000062B")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xraziobo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
        ...
        m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000631")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000631(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(xData,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.DateToChar(CPLib.Date()),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(_locrap,"D")) {
          ...
          while ( ! (Cursor_intestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000636")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000637")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000637(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_intestbo.GetString("CODINTER"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          while ( ! (Cursor_xntestbo.Eof())) {
            ...
            if (CPLib.eqr(nIntest,1)) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000063C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"CONNESCLI = "+CPLib.ToSQL(Cursor_xntestbo.GetString("CODINTER"),"C",16,0,m_cServer)+", ";
              m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
              m_cSql = m_cSql+" where ";
              m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"clientifrz",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"0000063D")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.eqr(_mezpagam,"I") || CPLib.eqr(_mezpagam,"E") || CPLib.eqr(_mezpagam,"P")) {
          ...
          while ( ! (Cursor_personbo.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000641")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"C_RAG = "+CPLib.ToSQL(Cursor_personbo.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_STA = "+CPLib.ToSQL(Cursor_personbo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CTA = "+CPLib.ToSQL(Cursor_personbo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"C_CAB = "+CPLib.ToSQL(Cursor_personbo.GetString("CODCAB"),"C",6,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(_iban))) {
          ...
          if (CPLib.eqr(CPLib.Left(_iban,2),"IT")) {
            ...
            while ( ! (Cursor_inter2bo.Eof())) {
              ...
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000646")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
              m_cSql = m_cSql+"TIPOINT2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("TIPINTER"),"C",2,0,m_cServer)+", ";
              m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
              m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_inter2bo.GetString("PAESE"),"C",3,0,m_cServer)+", ";
              m_cSql = m_cSql+"DESC2 = "+CPLib.ToSQL(Cursor_inter2bo.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"fraziobo",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("arfn_imp_dati_cgo_sched_tabs",908,"00000648")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
            m_cSql = m_cSql+"CODINT2 = "+CPLib.ToSQL(abicab,"C",11,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"fraziobo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"IDBASE = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cOpeProg1,"?",0,0,m_cServer),m_cServer,cOpeProg1)+"";
  ...
  public static arfn_imp_dati_cgo_sched_tabsR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_imp_dati_cgo_sched_tabsR(p_Ctx, p_Caller);
  }
  public static arfn_imp_dati_cgo_sched_tabsR Make(CPContext p_Ctx) {
    return new arfn_imp_dati_cgo_sched_tabsR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
    fhand = CPLib.Space(1);
    riga = "";
  ...
  // ENTITY_BATCHES: ,arfn_datesum,arfn_dt_to_date,arfn_dttod,arfn_fdate,arfn_fdatetime,arfn_imp_dati_cgo_sched_tabs,arrt_cgo_save_multi_dl,arrt_snai_oper_save,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_datesum,arfn_dt_to_date,arfn_dttod,arfn_fdate,arfn_fdatetime,arfn_imp_dati_cgo_sched_tabs,arrt_cgo_save_multi_dl,arrt_snai_oper_save,arrt_writelog,";
  ...
  protected static String GetFieldsName_00000201(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"AUTRILASC,";
    p_cSql = p_cSql+"CAP,";
    p_cSql = p_cSql+"CFESTERO,";
  ...
  protected static String GetFieldsName_00000219(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"SNAINUMOPE,";
    p_cSql = p_cSql+"ENV,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_0000026C(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_00000338(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"code,";
    p_cSql = p_cSql+"name,";
  ...
  protected static String GetFieldsName_000003C7(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000003CD(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000003D3(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0000041F(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0000047C(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"SNAINUMOPE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CAIDBIGLIETTO,";
  ...
  protected static String GetFieldsName_000004A5(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000004BD(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000004ED(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000004F8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_000004FE(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000503(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"TODATOPE,";
    p_cSql = p_cSql+"TOCODSOG,";
    p_cSql = p_cSql+"TONUMOPE,";
  ...
  protected static String GetFieldsName_00000514(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_0000051A(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0000051F(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"TODATOPE,";
    p_cSql = p_cSql+"TOCODSOG,";
    p_cSql = p_cSql+"TONUMOPE,";
  ...
  protected static String GetFieldsName_00000525(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0000052A(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"TODATOPE,";
    p_cSql = p_cSql+"TOCODSOG,";
    p_cSql = p_cSql+"TONUMOPE,";
  ...
  protected static String GetFieldsName_0000053C(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_00000542(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000548(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000559(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_0000055F(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000565(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000588(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_00000599(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000005A9(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000005B8(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CODLOB,";
    p_cSql = p_cSql+"TIPOGIOCO,";
  ...
  protected static String GetFieldsName_000005BB(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CODLOB,";
    p_cSql = p_cSql+"TIPOGIOCO,";
  ...
  protected static String GetFieldsName_000005BC(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CODLOB,";
    p_cSql = p_cSql+"TIPOGIOCO,";
  ...
  protected static String GetFieldsName_000005BE(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CODLOB,";
    p_cSql = p_cSql+"TIPOGIOCO,";
  ...
  protected static String GetFieldsName_000005BF(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CODLOB,";
    p_cSql = p_cSql+"TIPOGIOCO,";
  ...
  protected static String GetFieldsName_000005C5(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000005CB(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000005D0(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"TODATOPE,";
    p_cSql = p_cSql+"TOCODSOG,";
    p_cSql = p_cSql+"TONUMOPE,";
  ...
  protected static String GetFieldsName_000005D6(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000005EC(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_000005F2(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_000005F7(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"TODATOPE,";
    p_cSql = p_cSql+"TOCODSOG,";
    p_cSql = p_cSql+"TONUMOPE,";
  ...
  protected static String GetFieldsName_000005FD(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000602(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"TODATOPE,";
    p_cSql = p_cSql+"TOCODSOG,";
    p_cSql = p_cSql+"TONUMOPE,";
  ...
  protected static String GetFieldsName_00000614(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_0000061A(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000620(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_00000631(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CDATREG,";
  ...
  protected static String GetFieldsName_00000637(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
