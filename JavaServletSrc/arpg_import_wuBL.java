...
public class arpg_import_wuBL extends arpg_import_wuWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_wu";
  ...
  public arpg_import_wuBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_wu","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
