...
function DisplayErrorMessage_ardt_garantbo() {
if ( ! (ChildToLoad(FrameRef('ardt_garantbo'))) && Ne(typeof(FrameRef('ardt_garantbo').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_garantbo').DisplayErrorMessage();
}
}
...
function DisplayErrorMessage_ardt_saldi_idp() {
if ( ! (ChildToLoad(FrameRef('ardt_saldi_idp'))) && Ne(typeof(FrameRef('ardt_saldi_idp').DisplayErrorMessage),'undefined')) {
FrameRef('ardt_saldi_idp').DisplayErrorMessage();
}
}
...
SetDisabled('HBPZQIPSZE',l_bEnabled);
SetDisabled(Ctrl('HBPZQIPSZE_ZOOM'),l_bEnabled);
...
if (IsDisabledByStateDriver('SaldiCanali')) {
DisableInputsInContainer(Ctrl('GURCMCSTQS'),true);
}
if (IsDisabledByStateDriver('AltriDati')) {
DisableInputsInContainer(Ctrl('PHCJDNQLLF'),true);
}
...
l_bResult=l_bResult && _ChkObl('DTDVSGUEWE',0);
if (l_bResult) {
if ( ! (l_bResult)) {
w_TIPO=HtW('','C');
}
...
l_bResult=l_bResult && _ChkObl('VEAKSOSZMJ',0);
if (l_bResult) {
if ( ! (l_bResult)) {
w_DURAT=HtW('','C');
}
...
l_bResult=l_bResult && _ChkObl('FLHYCYAKON',0);
if (l_bResult) {
if ( ! (l_bResult)) {
w_AMMONT=HtW('','C');
}
...
l_bResult=l_bResult && _ChkObl('MDMTUJRAZF',0);
if (l_bResult) {
if ( ! (l_bResult)) {
w_AREAGEO=HtW('','C');
}
...
l_bResult=l_bResult && _ChkObl('ZKJUEEUNAK',0);
if (l_bResult) {
if ( ! (l_bResult)) {
w_MODSVOL=HtW('','C');
}
...
var ctl = _GetCtl(e,'HBPZQIPSZE');
if (_tracker.goon(ctl,ctrlValue)) {
w_CODDIPE=ctrlValue;
SetModified();
var l_bResult = true;
SetErrorField(ctl,false);
l_bResult=_ChkObl('HBPZQIPSZE',0);
if (l_bResult) {
l_bResult=Link_HBPZQIPSZE(kmode);
if ( ! (l_bResult)) {
w_CODDIPE=HtW('','C');
}
}
...
l_bResult=l_bResult && _ChkObl('EAWVSIWQBM',0);
if (l_bResult) {
if ( ! (l_bResult)) {
w_RAGIO=HtW('','C');
}
...
l_bTmpRes=Link_VEAKSOSZMJ(null);
}
if ((Ne(o_AMMONT,w_AMMONT))) {
l_bTmpRes=Link_FLHYCYAKON(null);
}
if ((Ne(o_AREAGEO,w_AREAGEO))) {
l_bTmpRes=Link_MDMTUJRAZF(null);
}
if ((Ne(o_MODSVOL,w_MODSVOL))) {
l_bTmpRes=Link_ZKJUEEUNAK(null);
}
if ((Ne(o_RAGIO,w_RAGIO))) {
l_bTmpRes=Link_EAWVSIWQBM(null);
}
if ((Ne(o_TIPO,w_TIPO))) {
l_bTmpRes=Link_DTDVSGUEWE(null);
}
...
w_titolo=(Eq(w_gTipInter,'14')?'Relazione d\'Affari (AUI)':'Rapporti Continuativi (AUI)')+' - '+LRTrim(w_RAPPORTO)+'-'+LRTrim(w_DESCRAP);
w_mess='Messaggio\\nSecondo\\nTerzo';
...
function Link_VEAKSOSZMJ(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_DURAT);
...
function Link_VEAKSOSZMJ_Blank() {
w_DURAT='';
w_RFREQ=0;
}
function LOpt_VEAKSOSZMJ() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('tbdurata_p','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CODICE','C'));
l_oWv.setValue('LinkedField',WtA('CODICE','C'));
l_oWv.setValue('UID',WtA('VEAKSOSZMJ','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['VEAKSOSZMJ'][1],'C'));
return l_oWv;
}
...
function Link_FLHYCYAKON(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_AMMONT);
...
function Link_FLHYCYAKON_Blank() {
w_AMMONT='';
w_RIMP=0;
}
function LOpt_FLHYCYAKON() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('tbimporto_p','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CODICE','C'));
l_oWv.setValue('LinkedField',WtA('CODICE','C'));
l_oWv.setValue('UID',WtA('FLHYCYAKON','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['FLHYCYAKON'][1],'C'));
return l_oWv;
}
...
function Link_MDMTUJRAZF(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_AREAGEO);
...
function Link_MDMTUJRAZF_Blank() {
w_AREAGEO='';
w_RAREA=0;
}
function LOpt_MDMTUJRAZF() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('tbareegeog_p','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CODICE','C'));
l_oWv.setValue('LinkedField',WtA('CODICE','C'));
l_oWv.setValue('UID',WtA('MDMTUJRAZF','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['MDMTUJRAZF'][1],'C'));
return l_oWv;
}
...
function Link_ZKJUEEUNAK(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_MODSVOL);
...
function Link_ZKJUEEUNAK_Blank() {
w_MODSVOL='';
w_RCOMP=0;
}
function LOpt_ZKJUEEUNAK() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('tbsvolgim_p','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CODICE','C'));
l_oWv.setValue('LinkedField',WtA('CODICE','C'));
l_oWv.setValue('UID',WtA('ZKJUEEUNAK','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['ZKJUEEUNAK'][1],'C'));
return l_oWv;
}
...
function Link_EAWVSIWQBM(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_RAGIO);
...
function Link_EAWVSIWQBM_Blank() {
w_RAGIO='';
w_RRAGIO=0;
}
function LOpt_EAWVSIWQBM() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('tbplauso_p','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CODICE','C'));
l_oWv.setValue('LinkedField',WtA('CODICE','C'));
l_oWv.setValue('UID',WtA('EAWVSIWQBM','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['EAWVSIWQBM'][1],'C'));
return l_oWv;
}
...
function Link_DTDVSGUEWE(kmode) {
var l_bResult = true;
var l_nRec = 0;
var l_cLinkUrl;
var l_bEmp = Empty(w_TIPO);
var l_Appl = LinkApplet();
l_Appl.SetStringKey('CODICE',w_TIPO,2,0);
l_Appl.SetFields('CODICE,RISCHIO');
l_Appl.SetTypes('C,N');
l_Appl.LinkTable('tbtiporisc_p');
l_Appl.SetID('DTDVSGUEWE');
l_nRec=l_Appl.DoLink((Eq(kmode,null)?0:kmode));
l_bResult=Ne(l_nRec,0);
if (Eq(l_nRec,1)) {
w_TIPO=l_Appl.GetStringValue('CODICE',2,0);
...
function Link_DTDVSGUEWE_Blank() {
w_TIPO='';
w_RTIPO=0;
}
function LOpt_DTDVSGUEWE() {
var l_oWv = InitWvApplet();
l_oWv.setValue('Table',WtA('tbtiporisc_p','C'));
l_oWv.setValue('Linkzoom',WtA(true,'L'));
l_oWv.setValue('PKFields',WtA('CODICE','C'));
l_oWv.setValue('LinkedField',WtA('CODICE','C'));
l_oWv.setValue('UID',WtA('DTDVSGUEWE','C'));
l_oWv.setValue('SPZTL',WtA(m_IDS['DTDVSGUEWE'][1],'C'));
return l_oWv;
}
...
if (Eq(l_nRec,2)) {
var openername = 'linkview_HBPZQIPSZE';
var l_cFieldFilter = l_Appl.GetWhereFieldExprUnencoded();
var l_cFixedFilter = l_Appl.GetWhereFixedExprUnencoded();
var l_cAndOpForField = '';
if ( ! (Empty(l_cFieldFilter))) {
...
if (Eq(varName,'HBPZQIPSZE')) {
last_focused_comp=GetLastFocusedElementOfLink('HBPZQIPSZE');
function SetMethod_HBPZQIPSZE() {
Set_CODDIPE(HtW(value,'C'),0);
}
if (IsDeviceMobile()) {
SetMethod_HBPZQIPSZE();
} else {
setTimeout(SetMethod_HBPZQIPSZE,1);
}
bResult=true;
}
...
parent.ZtVWeb.raiseEventToEvalParms('armt_anarap_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_anarap_dataNotSent',{'action':formaction});
}
}
}
}
CheckChild.child=[{'prg':"ardt_garantbo",'BOScId':function(){ return FrameRef('ardt_garantbo')},'repeated':0},{'prg':"ardt_ae_saldianno_rap",'BOScId':function(){ return FrameRef('ardt_ae_saldianno_rap')},'repeated':0},{'prg':"ardt_saldi_idp",'BOScId':function(){ return FrameRef('ardt_saldi_idp')},'repeated':0}];
function Check() {
var l_bResult = true;
...
l_bResult=false;
w_NOCANC=0;
} else if (( ! (Utilities.Make(window).IsInGroup(3))) && ( ! (_ChkObl('HBPZQIPSZE',1)))) {
_SignErr('HBPZQIPSZE');
m_cLastWorkVarErrorMsg='350773234';
l_bResult=false;
w_CODDIPE=HtW('','C');
...
_FillChildren.n=['ardt_garantbo','ardt_ae_saldianno_rap','ardt_saldi_idp'];
FillWv.n=["CODDIP","RAPPORTO","DESCRAP","TIPORAP","TIPOAG","ISOAGE","NOPROT","FLAGLIRE","VALUTA","PRGIMPRAP","IBAN","CODOGG","NATURA","SCOPO","DURAT","RFREQ","AMMONT","RIMP","AREAGEO","RAREA","MODSVOL","RCOMP","RAGIO","RRAGIO","TIPO","RTIPO","CODDIPE","RISGLOB","DATAPROF","DATAREVPROF","MITIG","MITGDOC","CATEG01","CATEG02","CATEG03","CATEG04","CATEG05","CATEGORIA","NOCANC","MACODICE","SPLITCODE","CODICELR","gTipInter","gBrowser","gTelepass","gCodDip","descval","daticoll","xdescmodsvo","xdescareag","xdescplauso","xdesctipor","xdescfreq","xdescammo","xDESDIPE","xMADESCRI","xRAGLEG","mess","xC1DESCRI","xC2DESCRI","xC3DESCRI","xC4DESCRI","xC5DESCRI","titolo"];
function SetModified() {
m_bUpdated=true;
}
function SetChildVariables_ardt_garantbo() {
}
function CtxLoad_ardt_garantbo() {
if (ChildToLoad(FrameRef('ardt_garantbo'))) {
return [LoadContext(0,'ZSYGOPYXSA'),'ardt_garantbo'];
}
}
...
function SetChildVariables_ardt_saldi_idp() {
}
function CtxLoad_ardt_saldi_idp() {
if (ChildToLoad(FrameRef('ardt_saldi_idp'))) {
return [LoadContext(0,'BOCKZFOGBL'),'ardt_saldi_idp'];
}
}
