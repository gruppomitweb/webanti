...
public class armt_storinformazioniBL extends armt_storinformazioniWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_storinformazioni";
  ...
  public CPPhTableWrInfo m_oWrInfo_wapopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wapopebo;
  ...
  public static String[] m_EntityTables = {"wapopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CODDIPE':CODDIPE,'RAPPORTO':RAPPORTO,'DATAOPE':DATAOPE,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'DATARETT':DATARETT,'IDBASE':IDBASE,'STATOREG':STATOREG,'ardt_storinformazioni':ardt_storinformazioni,'ardt_storsoginfo':ardt_storsoginfo"+FoundlingChildrenList("armt_storinformazioni",true)+"}";
  public static final String i_CompleteStateStructure = "{'CODINTER':CODINTER,'gIntemediario':gIntemediario,'CODDIPE':CODDIPE,'RAPPORTO':RAPPORTO,'DATAOPE':DATAOPE,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'DATARETT':DATARETT,'IDBASE':IDBASE,'TIPOINTER':TIPOINTER,'TIPOINF':TIPOINF,'IDEREG':IDEREG,'FLAGRAP':FLAGRAP,'OPRAP':OPRAP,'STATOREG':STATOREG,'OPERAZMOD':OPERAZMOD,'OPERATORE':OPERATORE,'AUTOM':AUTOM,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CODCAB':CODCAB,'NUMPROG':NUMPROG,'xdescrap':xdescrap,'xDescDipe':xDescDipe,'datpaseuro':datpaseuro,'gChkDate':gChkDate,'xDesReg':xDesReg,'xRagSoc':xRagSoc,'sEdit':sEdit,'errmsg':errmsg,'Aggiorna':Aggiorna,'FLAGRAP2':FLAGRAP2,'lancio':lancio,'FLAGLIRE':FLAGLIRE,'VALUTA':VALUTA,'gSblocco':gSblocco,'tipreg':tipreg,'tipregn':tipregn,'PRGIMPINF':PRGIMPINF,'dataoggi':dataoggi,'CDATOPE':CDATOPE,'gStatus':gStatus,'gDataVaria':gDataVaria,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'ardt_storinformazioni':ardt_storinformazioni,'ardt_storsoginfo':ardt_storsoginfo"+FoundlingChildrenList("armt_storinformazioni",true)+"}";
  public static final String i_ItemSequence = "CODDIPE,RAPPORTO,DATAOPE,DATAREG,TIPOOPRAP,CONNESOPER,TIPOLEG,DATARETT,IDBASE,STATOREG,ardt_storinformazioni,ardt_storsoginfo"+FoundlingChildrenList("armt_storinformazioni",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_storinformazioni"),new String[][]{new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"RAPPORTO","","C","25","0","campo","nokey","false","false"},new String[]{"DATAOPE","Data Operazione","D","8","0","campo","key2","false","true"},new String[]{"DATAREG","Data registrazione","D","8","0","campo","nokey","false","true"},new String[]{"TIPOOPRAP","Tipo Informazione","C","2","0","campo","key5","false","true"},new String[]{"CONNESOPER","Soggetto Operante Conto Terzi","C","16","0","campo","key6","false","false"},new String[]{"TIPOLEG","Tipo Legame Sogg.","C","1","0","campo","nokey","false","false"},new String[]{"DATARETT","Data Rettifica","D","8","0","campo","nokey","false","false"},new String[]{"IDBASE","idbase","C","10","0","campo","key1","false","false"},new String[]{"STATOREG","Stato Registrazione","C","1","0","campo","nokey","false","false"},new String[]{"ardt_storinformazioni","Informazioni","","","","link_PC","","false",""},new String[]{"ardt_storsoginfo","Soggetti Agenti per Conto Inform.","","","","link_PC","","false",""}});
  ...
  public armt_storinformazioniBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wapopebo = p_ContextObject.GetPhName("wapopebo",p_ContextObject.GetCompany(),false);
    m_cServer_wapopebo = p_ContextObject.GetServer("wapopebo");
    m_oWrInfo_wapopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wapopebo",p_ContextObject.GetCompany());
    m_cVirtName_wapopebo = CPSql.ManipulateTablePhName("wapopebo",m_cServer_wapopebo);
    ...
    ardt_storinformazioni = new ardt_storinformazioniBO(p_ContextObject);
    ardt_storsoginfo = new ardt_storsoginfoBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_storinformazioni",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_storinformazioni.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_storinformazioni);
    l_bResult = l_bResult || ardt_storsoginfo.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_storsoginfo);
    return l_bResult;
  }
  ...
  public void SaveDependsOn() {
    ...
    o_FLAGRAP = w_FLAGRAP;
    ardt_storinformazioni.SaveDependsOn();
    ardt_storsoginfo.SaveDependsOn();
  }
  ...
  protected boolean Link_UMFEJVRUFZ(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_RAPPORTO))) {
      ...
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_RAPPORTO,"C",25,0),m_cServer_wnarapbo,w_RAPPORTO);
      if (m_Ctx.IsSharedTemp("wnarapbo")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_wnarapbo,"select RAPPORTO,DESCRAP,FLAGLIRE,VALUTA,TIPORAP from "+m_cPhName_wnarapbo+((m_cPhName_wnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"RAPPORTO"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_RAPPORTO,"C",50,0),m_cServer_wnarapbo,w_RAPPORTO);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_wnarapbo,"select RAPPORTO,DESCRAP,FLAGLIRE,VALUTA,TIPORAP from "+m_cPhName_wnarapbo+((m_cPhName_wnarapbo).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRAP"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
  ...
  public boolean getWritable_CONNESOPER() {
    return  ! (CPLib.Empty(w_DATAOPE)) && CPLib.lt(w_DATAOPE,CPLib.CharToDate("01/06/2010"));
  }
  public boolean getWritable_TIPOLEG() {
    return  ! (CPLib.Empty(w_DATAOPE)) && CPLib.lt(w_DATAOPE,CPLib.CharToDate("01/06/2010"));
  }
  public boolean getVisible_CONNESOPER() {
    return CPLib.ge(w_DATAOPE,CPLib.CharToDate("01/06/2010")) && CPLib.Empty(w_CONNESOPER);
  }
  ...
  public boolean Calculate() {
    ...
    UpdateAutonumber();
    CopyWorkVar(this,ardt_storinformazioni,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},true);
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_storinformazioni","wapopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_ardt_storinformazioni = CPLib.GetProperty(p,"m_cWv_ardt_storinformazioni",m_cWv_ardt_storinformazioni,0);
      m_cWv_ardt_storsoginfo = CPLib.GetProperty(p,"m_cWv_ardt_storsoginfo",m_cWv_ardt_storsoginfo,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("wntestbo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("wntestbo",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("wntestbo\u0000false\u0000false\u00001\u00000\u0000ardt_storinformazioni\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("woginfo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("woginfo",items);
    }
    items.add(map);
    map.put("link_PC",new String[]{});
    map.put("rd_kvar",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("woginfo\u0000false\u0000false\u00001\u00000\u0000ardt_storsoginfo\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    ...
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
    items = tables.get("wnarapbo");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("wnarapbo",items);
    }
    items.add(map);
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("wnarapbo\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Rapporti in essere\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
    map = new HashMap<String,String[]>();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_storinformazioni",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_storinformazioni",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_storinformazioni = new ardt_storinformazioniBO(m_Ctx);
    ardt_storsoginfo = new ardt_storsoginfoBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_storinformazioni",m_Ctx);
  ...
  public boolean Check() {
    ...
    } else if ((CPLib.ne(w_gChkDate,"U") &&  ! (CPLib.Empty(w_gChkDate))) && (CPLib.Empty(w_DATAREG))) {
    ...
    if (l_bResult && (( ! (ardt_storinformazioni.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_storinformazioni)) || ( ! (ardt_storinformazioni.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_storinformazioni)))) {
      ardt_storinformazioni.SetFromContext(m_cWv_ardt_storinformazioni);
      m_cWv_ardt_storinformazioni = "_not_empty_";
    }
    if (l_bResult && (ardt_storinformazioni.m_bLoaded || ardt_storinformazioni.m_bUpdated)) {
      l_bResult = l_bResult && ardt_storinformazioni.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_storinformazioni.m_cLastMsgError;
      }
    }
    if (l_bResult && (( ! (ardt_storsoginfo.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_storsoginfo)) || ( ! (ardt_storsoginfo.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_storsoginfo)))) {
      ardt_storsoginfo.SetFromContext(m_cWv_ardt_storsoginfo);
      m_cWv_ardt_storsoginfo = "_not_empty_";
    }
    if (l_bResult && (ardt_storsoginfo.m_bLoaded || ardt_storsoginfo.m_bUpdated)) {
      l_bResult = l_bResult && ardt_storsoginfo.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_storinformazioni"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_storinformazioni\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"PRGINFO1"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wapopebo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_NUMPROG = m_Ctx.AskTableProg(w_NUMPROG,11,op_NUMPROG,"PRGINFO2"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wapopebo);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PRGIMPINF = m_Ctx.AskTableProg(w_PRGIMPINF,15,op_PRGIMPINF,"PRGIMPINF"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_wapopebo);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (ardt_storinformazioni.IsUpdated()) {
        m_cWv_ardt_storinformazioni = ardt_storinformazioni.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_storinformazioni",m_cWv_ardt_storinformazioni,0);
    }
    if (p_bGetChildren) {
      if (ardt_storsoginfo.IsUpdated()) {
        m_cWv_ardt_storsoginfo = ardt_storsoginfo.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_storsoginfo",m_cWv_ardt_storsoginfo,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wapopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public boolean ChildExists_ardt_storinformazioni() {
    if (ardt_storinformazioni.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_storinformazioni) || CPLib.IsLoaded(m_cWv_ardt_storinformazioni))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_storinformazioni.m_bLoaded)) {
      ardt_storinformazioni.Blank();
      ardt_storinformazioni.w_RAPPORTO = w_RAPPORTO;
      ardt_storinformazioni.Load();
    }
    return ardt_storinformazioni.m_bLoaded;
  }
  public void CtxLoad_ardt_storinformazioni() {
    if ( ! (ardt_storinformazioni.m_lCtxLoaded)) {
      ardt_storinformazioni.Blank();
    }
    ardt_storinformazioni.m_lCtxLoaded = true;
    if ( ! (ardt_storinformazioni.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_storinformazioni) || CPLib.IsLoaded(m_cWv_ardt_storinformazioni)) {
        ardt_storinformazioni.SetFromContext(m_cWv_ardt_storinformazioni);
        m_cWv_ardt_storinformazioni = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_storinformazioni.m_bLoaded)) {
          ardt_storinformazioni.Blank();
          ardt_storinformazioni.w_RAPPORTO = w_RAPPORTO;
          ardt_storinformazioni.Load();
          if ( ! (ardt_storinformazioni.m_bLoaded)) {
            ardt_storinformazioni.Initialize();
            ardt_storinformazioni.SetUpdated();
          }
          CopyWorkVar(this,ardt_storinformazioni,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_storinformazioni,new String[]{"TIPORAP"},new String[]{"FLAGRAP"},true);
        }
      }
  ...
  public boolean ChildExists_ardt_storsoginfo() {
    if (ardt_storsoginfo.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_storsoginfo) || CPLib.IsLoaded(m_cWv_ardt_storsoginfo))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_storsoginfo.m_bLoaded)) {
      ardt_storsoginfo.Blank();
      ardt_storsoginfo.w_RAPCOL = w_RAPPORTO;
      ardt_storsoginfo.Load();
    }
    return ardt_storsoginfo.m_bLoaded;
  }
  public void CtxLoad_ardt_storsoginfo() {
    if ( ! (ardt_storsoginfo.m_lCtxLoaded)) {
      ardt_storsoginfo.Blank();
    }
    ardt_storsoginfo.m_lCtxLoaded = true;
    if ( ! (ardt_storsoginfo.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_storsoginfo) || CPLib.IsLoaded(m_cWv_ardt_storsoginfo)) {
        ardt_storsoginfo.SetFromContext(m_cWv_ardt_storsoginfo);
        m_cWv_ardt_storsoginfo = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_storsoginfo.m_bLoaded)) {
          ardt_storsoginfo.Blank();
          ardt_storsoginfo.w_RAPCOL = w_RAPPORTO;
          ardt_storsoginfo.Load();
          if ( ! (ardt_storsoginfo.m_bLoaded)) {
            ardt_storsoginfo.Initialize();
            ardt_storsoginfo.SetUpdated();
          }
        }
      }
    }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_storinformazioni")) {
      CtxLoad_ardt_storinformazioni();
      return ardt_storinformazioni;
    }
    if (CPLib.eq(p_cName,"ardt_storsoginfo")) {
      CtxLoad_ardt_storsoginfo();
      return ardt_storsoginfo;
    }
