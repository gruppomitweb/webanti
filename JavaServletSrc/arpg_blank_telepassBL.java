...
public class arpg_blank_telepassBL extends arpg_blank_telepassWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_blank_telepass";
  ...
  public arpg_blank_telepassBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_blank_telepass","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
