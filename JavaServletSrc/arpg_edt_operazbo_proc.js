...
if (false || WindowConfirm(Translate('938798654'))) {
...
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_edt_operazbo']));
SendData('start','arrt_edt_operazbo'+'',HParApplet().asString());
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_edt_operazbo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_edt_operazbo',m_cSelectedPage);
