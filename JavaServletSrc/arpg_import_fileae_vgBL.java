...
public class arpg_import_fileae_vgBL extends arpg_import_fileae_vgWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_import_fileae_vg";
  ...
  public static final String i_StateStructure = "{'offset':offset,'f_denom':f_denom,'f_ricaui':f_ricaui,'prefrap':prefrap,'codval':codval}";
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'msgproc':msgproc,'errchk':errchk,'offset':offset,'f_denom':f_denom,'f_ricaui':f_ricaui,'prefrap':prefrap,'codval':codval,'xdesval':xdesval,'impzip':impzip}";
  public static final String i_ItemSequence = "offset,f_denom,f_ricaui,prefrap,codval";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"offset","","N","5","0","variabile","nokey","false","false"},new String[]{"f_denom","","C","1","0","variabile","nokey","false","false"},new String[]{"f_ricaui","","C","1","0","variabile","nokey","false","false"},new String[]{"prefrap","","C","5","0","variabile","nokey","false","false"},new String[]{"codval","","C","3","0","variabile","nokey","false","false"}});
  ...
  public arpg_import_fileae_vgBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_xdesval = "";
    w_msgproc = "";
    w_msgproc = arfn_readgmsgprocR.Make(m_Ctx,this).Run();
    w_errchk = 1;
    w_offset = 1800;
    w_f_denom = "N";
    Link_HKGEZJGNAE();
  ...
  protected boolean Link_HKGEZJGNAE() {
    return Link_HKGEZJGNAE("Full");
  }
  protected boolean Link_HKGEZJGNAE(String p_cType) {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_offset(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_offset = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_f_denom(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_f_denom = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_f_ricaui(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_f_ricaui = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_prefrap(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public String getDefault_codval() {
  ...
  /*  Gestione delle funzioni che rispondono lo stato delle variabili di work.
                            ...
                            */
  public boolean getWritable_codval() {
    return CPLib.eq(w_f_ricaui,"A") || CPLib.eq(w_f_ricaui,"G");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_import_fileae_vg","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_msgproc = CPLib.GetProperty(p,"msgproc",w_msgproc,0);
      w_errchk = CPLib.GetProperty(p,"errchk",w_errchk,0);
      w_offset = CPLib.GetProperty(p,"offset",w_offset,0);
      w_f_denom = CPLib.GetProperty(p,"f_denom",w_f_denom,0);
      w_f_ricaui = CPLib.GetProperty(p,"f_ricaui",w_f_ricaui,0);
      w_prefrap = CPLib.GetProperty(p,"prefrap",w_prefrap,0);
