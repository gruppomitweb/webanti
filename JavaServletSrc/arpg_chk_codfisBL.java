...
public class arpg_chk_codfisBL extends arpg_chk_codfisWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_chk_codfis";
  ...
  public arpg_chk_codfisBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_chk_codfis","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
