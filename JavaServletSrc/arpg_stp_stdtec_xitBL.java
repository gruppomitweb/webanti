...
public class arpg_stp_stdtec_xitBL extends arpg_stp_stdtec_xitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_xit";
  ...
  public static final String i_StateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli}";
  public static final String i_CompleteStateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2,'ADatReg':ADatReg,'DaDatReg':DaDatReg}";
  public static final String i_ItemSequence = "daCodDip,aCodDip,DaDatOpe,ADatOpe,daCodCli,aCodCli";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"aCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"}});
  ...
  public arpg_stp_stdtec_xitBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_xit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
