...
public class arpg_allinea_ageBL extends arpg_allinea_ageWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_allinea_age";
  ...
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gTipInter':gTipInter,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gFlgWU':gFlgWU,'xdesval':xdesval,'anno':anno}";
  public static final String i_ItemSequence = "anno";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","Anno di riferimento","C","4","0","variabile","nokey","false","false"}});
  ...
  public arpg_allinea_ageBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_age","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
