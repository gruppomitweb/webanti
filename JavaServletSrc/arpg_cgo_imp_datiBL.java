...
public class arpg_cgo_imp_datiBL extends arpg_cgo_imp_datiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_cgo_imp_dati";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'impzip':impzip}";
  ...
  public arpg_cgo_imp_datiBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_imp_dati","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
