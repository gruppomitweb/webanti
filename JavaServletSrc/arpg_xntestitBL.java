...
public class arpg_xntestitBL extends arpg_xntestitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_xntestit";
  ...
  public arpg_xntestitBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_xntestit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
