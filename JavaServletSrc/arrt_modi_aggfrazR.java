...
// * --- Fine Area Manuale
public class arrt_modi_aggfrazR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_modi_aggfrazR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_modi_aggfraz",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    m_cSql = CPLib.GetSQLPrefixComment("arrt_modi_aggfraz",9,"00000015")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
    ...
    m_cSql = m_cSql+"AMMONT = "+CPLib.ToSQL(w_AMMONT,"C",5,0,m_cServer)+", ";
  ...
  public static arrt_modi_aggfrazR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_modi_aggfrazR(p_Ctx, p_Caller);
  }
  public void Blank() {
