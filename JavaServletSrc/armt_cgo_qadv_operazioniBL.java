...
public class armt_cgo_qadv_operazioniBL extends armt_cgo_qadv_operazioniWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_cgo_qadv_operazioni";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_qadv_operazioni;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_qadv_operazioni;
  ...
  public armt_cgo_qadv_operazioniBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_qadv_operazioni = p_ContextObject.GetPhName("cgo_qadv_operazioni",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_qadv_operazioni = p_ContextObject.GetServer("cgo_qadv_operazioni");
    m_oWrInfo_cgo_qadv_operazioni = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_qadv_operazioni",p_ContextObject.GetCompany());
    m_cVirtName_cgo_qadv_operazioni = CPSql.ManipulateTablePhName("cgo_qadv_operazioni",m_cServer_cgo_qadv_operazioni);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("armt_cgo_qadv_operazioni",p_ContextObject);
  }
  public void Blank() {
  ...
  void Calculation_WOOQKMYMKN() {
    arrt_cgo_punteggio_advR l_oRoutine_arrt_cgo_punteggio_adv;
    l_oRoutine_arrt_cgo_punteggio_adv = arrt_cgo_punteggio_advR.Make(m_Ctx,this);
    l_oRoutine_arrt_cgo_punteggio_adv.pObj = this;
    l_oRoutine_arrt_cgo_punteggio_adv.Run();
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_cgo_qadv_operazioni","cgo_qadv_operazioni",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_cgo_qadv_operazioni",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_cgo_qadv_operazioni",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_cgo_qadv_operazioni",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_cgo_qadv_operazioni"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_cgo_qadv_operazioni\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_qadv_operazioni"+"\\"+CPLib.ToCPStr(p_Caller.GetString("SNAINUMOPE","C",15,0));
  }
