...
public class arpg_fam_chkperiodoBL extends arpg_fam_chkperiodoWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fam_chkperiodo";
  ...
  public static final String i_StateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'flgncf':flgncf}";
  public static final String i_CompleteStateStructure = "{'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'cdadata':cdadata,'c_adata':c_adata,'flgncf':flgncf}";
  public static final String i_ItemSequence = "DaDatOpe,ADatOpe,flgncf";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"flgncf","","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_fam_chkperiodoBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fam_chkperiodo","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
