...
// * --- Fine Area Manuale
public class ardt_sogopeBO extends ardt_sogopeBL {
  ...
  // * --- Fine Area Manuale
  public ardt_sogopeBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"ardt_sogope");
    }
