...
SetLocationHref(null,'arrt_stpoper'+'?m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
function Help() {
windowOpenForeground('../doc/arpg_stpoper_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stpoper',m_cSelectedPage);
