...
if ( ! (m_oFather.SaveContext_ardt_mogopefbo())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_mogopefbo_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_mogopefbo_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_mogopefbo();
}
}
SaveContext.child=[];
function BlankRow() {
