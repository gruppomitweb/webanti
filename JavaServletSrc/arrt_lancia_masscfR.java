...
// * --- Fine Area Manuale
public class arrt_lancia_masscfR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_masscfR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_masscf",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_crea_mass_cf */
    Forward f;
    f=new Forward("arpg_crea_mass_cf",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_masscfR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_masscfR(p_Ctx, p_Caller);
  }
  public void Blank() {
