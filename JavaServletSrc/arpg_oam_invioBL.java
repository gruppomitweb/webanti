...
public class arpg_oam_invioBL extends arpg_oam_invioWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_oam_invio";
  ...
  public static final String i_StateStructure = "{'anno':anno,'mese':mese,'tipofile':tipofile}";
  public static final String i_CompleteStateStructure = "{'anno':anno,'mese':mese,'dadata':dadata,'a_data':a_data,'bloccaedit':bloccaedit,'files':files,'gIntemediario':gIntemediario,'gDescAzi':gDescAzi,'tipofile':tipofile}";
  public static final String i_ItemSequence = "anno,mese,tipofile";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"anno","","N","4","0","variabile","nokey","false","false"},new String[]{"mese","","C","2","0","variabile","nokey","false","true"},new String[]{"tipofile","Tipo Invio","N","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_oam_invioBL (CPContext p_ContextObject) {
  ...
  public boolean Set_tipofile(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_oam_invio","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
