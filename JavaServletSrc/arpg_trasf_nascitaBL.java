...
public class arpg_trasf_nascitaBL extends arpg_trasf_nascitaWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_trasf_nascita";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'impzip':impzip,'errchk':errchk,'gAzienda':gAzienda,'gPathApp':gPathApp,'fscarti':fscarti,'gDescAzi':gDescAzi,'filexls':filexls,'gUrlApp':gUrlApp,'tiporep':tiporep}";
  public static final String i_ItemSequence = "nomefile";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"nomefile","","C","100","0","variabile","nokey","false","false"}});
  ...
  public arpg_trasf_nascitaBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_trasf_nascita","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_filexls = CPLib.GetProperty(p,"filexls",w_filexls,0);
      w_gUrlApp = CPLib.GetProperty(p,"gUrlApp",w_gUrlApp,0);
      w_tiporep = CPLib.GetProperty(p,"tiporep",w_tiporep,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
