...
l_bEnabled= ! (Gt(At(w_TIPOOPRAP,'|25|28|39|40|41|47'),0) &&  ! (Empty(w_TIPOOPRAP))) || IsDisabledByStateDriver('Informazioni');
...
Z.Tabs.Get("tabs_1_DETTAGLIO").SetDisable('HDCVKCQUDV',true);
}
if (IsDisabledByStateDriver('Intermediario')) {
DisableInputsInContainer(Ctrl('BFAOFWJWLC'),true);
}
...
var l_bResult = true;
m_bCalculating=true;
if ( ! (ChildToLoad(FrameRef('ardt_ae_intestbo'))) && Ne(typeof(FrameRef('ardt_ae_intestbo').DoUpdate),'undefined')) {
if (Ne(typeof(FrameRef('ardt_ae_intestbo').m_oTrs),'undefined')) {
FrameRef('ardt_ae_intestbo').EnableEntity(false);
}
CopyWorkVar(FrameRef('ardt_ae_intestbo'),['TIPORAP'],['FLAGRAP'],true)
if (Ne(typeof(FrameRef('ardt_ae_intestbo').m_oTrs),'undefined')) {
l_bEnabled= ! (Eq(At(w_TIPOOPRAP,'|25|28|39|40|41|47'),0) &&  ! (Empty(w_TIPOOPRAP))) || IsDisabledByStateDriver('Informazioni');
if ( ! (ChildToLoad(FrameRef('ardt_ae_intestbo'))) && Ne(typeof(FrameRef('ardt_ae_intestbo').EnableEntity),'undefined')) {
FrameRef('ardt_ae_intestbo').EnableEntity(l_bEnabled);
...
if ( ! (ChildToLoad(FrameRef('ardt_ae_delegabo'))) && Ne(typeof(FrameRef('ardt_ae_delegabo').DoUpdate),'undefined')) {
if (Ne(typeof(FrameRef('ardt_ae_delegabo').m_oTrs),'undefined')) {
FrameRef('ardt_ae_delegabo').EnableEntity(false);
}
CopyWorkVar(FrameRef('ardt_ae_delegabo'),['TIPORAP'],['FLAGRAP'],true)
if (Ne(typeof(FrameRef('ardt_ae_delegabo').m_oTrs),'undefined')) {
l_bEnabled= ! (Gt(At(w_TIPOOPRAP,'|25|28|39|40|41|47'),0) &&  ! (Empty(w_TIPOOPRAP))) || IsDisabledByStateDriver('Informazioni');
if ( ! (ChildToLoad(FrameRef('ardt_ae_delegabo'))) && Ne(typeof(FrameRef('ardt_ae_delegabo').EnableEntity),'undefined')) {
FrameRef('ardt_ae_delegabo').EnableEntity(l_bEnabled);
...
FrameRef('ardt_ae_soginfo').Calculate()
FrameRef('ardt_ae_soginfo').DoUpdate(true)
...
FillWv.n=["CDATOPE","CODINTER","CODDIPE","RAPPORTO","DATAOPE","DATAREG","TIPOOPRAP","CONNESOPER","TIPOLEG","IDBASE","TIPOINTER","TIPOINF","IDEREG","FLAGRAP","OPRAP","OPERATORE","AUTOM","DESCCIT","PROVINCIA","CODCAB","NUMPROG","FLAGRAP2","FLAGLIRE","PRGIMPINF","OPERAZMOD","gIntemediario","gSblocco","gFlgDTP","gChkDate","gStatus","gDataVaria","gCodDip","filtro","dataoggi","tipreg","tipregn","sEdit","xdescrap","xDescDipe","datpaseuro","xDesReg","xRagSoc","errmsg","Aggiorna","lancio","VALUTA","CITINT","CITDIP","PROVDIP","CABDIP","PROVINT","CABINT","inutile","prova"];
...
CopyWorkVar(FrameRef('ardt_ae_intestbo'),['TIPORAP'],['FLAGRAP'],false)
if (Ne(typeof(FrameRef('ardt_ae_intestbo').m_oTrs),'undefined')) {
l_bEnabled= ! (Eq(At(w_TIPOOPRAP,'|25|28|39|40|41|47'),0) &&  ! (Empty(w_TIPOOPRAP))) || IsDisabledByStateDriver('Informazioni');
if ( ! (ChildToLoad(FrameRef('ardt_ae_intestbo'))) && Ne(typeof(FrameRef('ardt_ae_intestbo').EnableEntity),'undefined')) {
FrameRef('ardt_ae_intestbo').EnableEntity(l_bEnabled);
...
return [LoadContext(0,'ZFLICMSKTV'),'ardt_ae_intestbo'];
}
}
...
CopyWorkVar(FrameRef('ardt_ae_delegabo'),['TIPORAP'],['FLAGRAP'],false)
if (Ne(typeof(FrameRef('ardt_ae_delegabo').m_oTrs),'undefined')) {
l_bEnabled= ! (Gt(At(w_TIPOOPRAP,'|25|28|39|40|41|47'),0) &&  ! (Empty(w_TIPOOPRAP))) || IsDisabledByStateDriver('Informazioni');
if ( ! (ChildToLoad(FrameRef('ardt_ae_delegabo'))) && Ne(typeof(FrameRef('ardt_ae_delegabo').EnableEntity),'undefined')) {
FrameRef('ardt_ae_delegabo').EnableEntity(l_bEnabled);
...
return [LoadContext(0,'RSWMQMMVEI'),'ardt_ae_delegabo'];
}
}
