...
public class arpg_extrope_variaBL extends arpg_extrope_variaWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_extrope_varia";
  ...
  public static final String i_StateStructure = "{'annorif':annorif}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gTipInter':gTipInter,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gFlgWU':gFlgWU,'annorif':annorif,'xdesval':xdesval}";
  public static final String i_ItemSequence = "annorif";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"annorif","Anno di riferimento","N","4","0","variabile","nokey","false","true"}});
  ...
  public arpg_extrope_variaBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_extrope_varia","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
