...
SetHypPar('m_cParameterSequence',AsAppletValue('w_datarett,w_oldfile,w_oldidbase,w_oldprog,w_oldrappo'));
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_clsdeleghe']));
SendData('start','arrt_clsdeleghe'+'',HParApplet().asString());
}
_ResetTracker();
...
function Help() {
windowOpenForeground('../doc/arpg_clsdeleghe_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_clsdeleghe',m_cSelectedPage);
...
_FillChildren.n=[];
FillWv.n=["datarett","oldprog","oldidbase","oldrappo","oldfile"];
