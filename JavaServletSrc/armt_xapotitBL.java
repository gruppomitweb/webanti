...
public class armt_xapotitBL extends armt_xapotitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_xapotit";
  ...
  public CPPhTableWrInfo m_oWrInfo_xapotit;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xapotit;
  ...
  public static String[] m_EntityTables = {"xapotit"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'CODDIPE':CODDIPE,'CONNESCLI':CONNESCLI,'DATAOPE':DATAOPE,'TIPOOPRAP':TIPOOPRAP,'TIPOLEG':TIPOLEG,'RAPPORTO':RAPPORTO,'IDBASE':IDBASE,'STATOREG':STATOREG,'DESCINTER':DESCINTER,'ardt_xntestit':ardt_xntestit"+FoundlingChildrenList("armt_xapotit",true)+"}";
  public static final String i_CompleteStateStructure = "{'CODINTER':CODINTER,'flgpg':flgpg,'flgpf':flgpf,'gCodDip':gCodDip,'gIntemediario':gIntemediario,'CODDIPE':CODDIPE,'CONNESCLI':CONNESCLI,'DATAOPE':DATAOPE,'CDATOPE':CDATOPE,'DATAREG':DATAREG,'TIPOOPRAP':TIPOOPRAP,'CONNESOPER':CONNESOPER,'TIPOLEG':TIPOLEG,'RAPPORTO':RAPPORTO,'DATARETT':DATARETT,'IDBASE':IDBASE,'TIPOINTER':TIPOINTER,'TIPOINF':TIPOINF,'IDEREG':IDEREG,'FLAGRAP':FLAGRAP,'OPRAP':OPRAP,'STATOREG':STATOREG,'OPERAZMOD':OPERAZMOD,'OPERATORE':OPERATORE,'AUTOM':AUTOM,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CODCAB':CODCAB,'NUMPROG':NUMPROG,'xdescrap':xdescrap,'xDescDipe':xDescDipe,'datpaseuro':datpaseuro,'gChkDate':gChkDate,'xDesReg':xDesReg,'xRagSoc':xRagSoc,'sEdit':sEdit,'errmsg':errmsg,'Aggiorna':Aggiorna,'FLAGRAP2':FLAGRAP2,'lancio':lancio,'FLAGLIRE':FLAGLIRE,'VALUTA':VALUTA,'gSblocco':gSblocco,'tipreg':tipreg,'tipregn':tipregn,'PRGIMPTIT':PRGIMPTIT,'dataoggi':dataoggi,'gStatus':gStatus,'gDataVaria':gDataVaria,'CITINT':CITINT,'CITDIP':CITDIP,'PROVDIP':PROVDIP,'CABDIP':CABDIP,'PROVINT':PROVINT,'CABINT':CABINT,'xRagSocCli':xRagSocCli,'filtro':filtro,'DESCINTER':DESCINTER,'ardt_xntestit':ardt_xntestit,'SESSO':SESSO,'CDATREG':CDATREG"+FoundlingChildrenList("armt_xapotit",true)+"}";
  public static final String i_ItemSequence = "CODDIPE,CONNESCLI,DATAOPE,TIPOOPRAP,TIPOLEG,RAPPORTO,IDBASE,STATOREG,DESCINTER,ardt_xntestit"+FoundlingChildrenList("armt_xapotit",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_xapotit"),new String[][]{new String[]{"CODDIPE","Codice Dipendenza","C","6","0","campo","nokey","false","false"},new String[]{"CONNESCLI","","C","16","0","campo","key4","false","false"},new String[]{"DATAOPE","Data Operazione","D","8","0","campo","key2","false","true"},new String[]{"TIPOOPRAP","Tipo Informazione","C","2","0","campo","key5","false","true"},new String[]{"TIPOLEG","Tipo Legame Sogg.","C","1","0","campo","nokey","false","false"},new String[]{"RAPPORTO","","C","25","0","campo","nokey","false","true"},new String[]{"IDBASE","idbase","C","10","0","campo","key1","false","false"},new String[]{"STATOREG","Stato Registrazione","C","1","0","campo","nokey","false","false"},new String[]{"DESCINTER","","C","50","0","campo","nokey","false","false"},new String[]{"ardt_xntestit","LinkPC","","","","link_PC","","false",""}});
  ...
  public armt_xapotitBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xapotit = p_ContextObject.GetPhName("xapotit",p_ContextObject.GetCompany(),false);
    m_cServer_xapotit = p_ContextObject.GetServer("xapotit");
    m_oWrInfo_xapotit = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xapotit",p_ContextObject.GetCompany());
    m_cVirtName_xapotit = CPSql.ManipulateTablePhName("xapotit",m_cServer_xapotit);
    ...
    ardt_xntestit = new ardt_xntestitBO(p_ContextObject);
    m_MNTs = CPLib.MNTChilds("armt_xapotit",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean IsUpdated() {
    ...
    l_bResult = l_bResult || ardt_xntestit.IsUpdated() || CPLib.IsUpdated(m_cWv_ardt_xntestit);
    return l_bResult;
  }
  ...
  public boolean Calculate() {
    ...
    UpdateAutonumber();
    CopyWorkVar(this,ardt_xntestit,new String[]{"tipooprap"},new String[]{"TIPOOPRAP"},true);
  ...
  void Calculation_UOLXTHJBNA() {
    w_TIPOLEG = ((CPLib.eq(w_TIPOOPRAP,"52") || CPLib.eq(w_TIPOOPRAP,"53"))?"6":"5");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_xapotit","xapotit",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      m_cWv_ardt_xntestit = CPLib.GetProperty(p,"m_cWv_ardt_xntestit",m_cWv_ardt_xntestit,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("xntestit");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("xntestit",items);
    }
    items.add(map);
    ...
    map.put("property.value",zeroSplit.split("xntestit\u0000false\u0000false\u00001\u00000\u0000ardt_xntestit\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
    ...
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C",-1));
    map.put("rd_kvar.obj_type",zeroSplit.split("?",-1));
    map.put("rd_var.len",zeroSplit.split("25\u000050",-1));
    map.put("rd_kvar.len",zeroSplit.split("?",-1));
    map.put("rd_var.dec",zeroSplit.split("0\u00000",-1));
    map.put("rd_kvar.dec",zeroSplit.split("?",-1));
    map.put("rd_var.comment",zeroSplit.split("\u0000Descrizione",-1));
    map.put("rd_kvar.comment",zeroSplit.split(" is not an item of this entity",-1));
    map.put("rd_var.key_num",zeroSplit.split("nokey\u0000nokey",-1));
    map.put("rd_kvar.key_num",zeroSplit.split("?",-1));
    map.put("rd_var.repeated",zeroSplit.split("FALSE\u0000FALSE",-1));
    map.put("rd_kvar.repeated",zeroSplit.split("?",-1));
    map.put("rd_var.frm_obbl",zeroSplit.split("w_TIPOOPRAP='52' or w_TIPOOPRAP='53'\u0000",-1));
    map.put("rd_kvar.frm_obbl",zeroSplit.split("?",-1));
    map.put("rd_var.obj",zeroSplit.split("campo\u0000variabile",-1));
    map.put("rd_kvar.obj",zeroSplit.split("?",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_xapotit",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_xapotit",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    ardt_xntestit = new ardt_xntestitBO(m_Ctx);
    m_MNTs = CPLib.MNTChilds("armt_xapotit",m_Ctx);
  ...
  public boolean Check() {
    ...
    if (l_bResult && (( ! (ardt_xntestit.m_bLoaded) && CPLib.IsLoaded(m_cWv_ardt_xntestit)) || ( ! (ardt_xntestit.m_bUpdated) && CPLib.IsUpdated(m_cWv_ardt_xntestit)))) {
      ardt_xntestit.SetFromContext(m_cWv_ardt_xntestit);
      m_cWv_ardt_xntestit = "_not_empty_";
    }
    if (l_bResult && (ardt_xntestit.m_bLoaded || ardt_xntestit.m_bUpdated)) {
      l_bResult = l_bResult && ardt_xntestit.Check();
      l_bNoCheck = l_bResult;
      if ( ! (l_bNoCheck)) {
        m_cLastMsgError = ardt_xntestit.m_cLastMsgError;
      }
    }
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_xapotit","Administrators","Utenti standard","Ruolo 3","Utenti Confidi","Ruolo 5","agenzia","Area Finanza","Help desk","Consultazione"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_xapotit\\"+p_cState,"Administrators","Utenti standard","Ruolo 3","Utenti Confidi","Ruolo 5","agenzia","Area Finanza","Help desk","Consultazione"};
    }
    return l_Keys;
  }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"PRGPTIT1"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_xapotit);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_NUMPROG = m_Ctx.AskTableProg(w_NUMPROG,11,op_NUMPROG,"PRGPTIT2"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_xapotit);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PRGIMPTIT = m_Ctx.AskTableProg(w_PRGIMPTIT,15,op_PRGIMPTIT,"PRGIMPTIT"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_xapotit);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    if (p_bGetChildren) {
      if (ardt_xntestit.IsUpdated()) {
        m_cWv_ardt_xntestit = ardt_xntestit.GetContext();
      }
      CPLib.PutProperty(p,"m_cWv_ardt_xntestit",m_cWv_ardt_xntestit,0);
    }
    if (p_bGetChildren) {
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xapotit"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public boolean ChildExists_ardt_xntestit() {
    if (ardt_xntestit.IsUpdated() || (CPLib.IsUpdated(m_cWv_ardt_xntestit) || CPLib.IsLoaded(m_cWv_ardt_xntestit))) {
      return true;
    } else if (m_bLoaded &&  ! (ardt_xntestit.m_bLoaded)) {
      ardt_xntestit.Blank();
      ardt_xntestit.w_CODCLI = w_CONNESCLI;
      ardt_xntestit.Load();
    }
    return ardt_xntestit.m_bLoaded;
  }
  public void CtxLoad_ardt_xntestit() {
    if ( ! (ardt_xntestit.m_lCtxLoaded)) {
      ardt_xntestit.Blank();
    }
    ardt_xntestit.m_lCtxLoaded = true;
    if ( ! (ardt_xntestit.IsUpdated())) {
      if (CPLib.IsUpdated(m_cWv_ardt_xntestit) || CPLib.IsLoaded(m_cWv_ardt_xntestit)) {
        ardt_xntestit.SetFromContext(m_cWv_ardt_xntestit);
        m_cWv_ardt_xntestit = "_not_empty_";
      } else {
        if (m_bLoaded &&  ! (ardt_xntestit.m_bLoaded)) {
          ardt_xntestit.Blank();
          ardt_xntestit.w_CODCLI = w_CONNESCLI;
          ardt_xntestit.Load();
          if ( ! (ardt_xntestit.m_bLoaded)) {
            ardt_xntestit.Initialize();
            ardt_xntestit.SetUpdated();
          }
          CopyWorkVar(this,ardt_xntestit,new String[]{"tipooprap"},new String[]{"TIPOOPRAP"},false);
        } else if ( ! (m_bLoaded)) {
          CopyWorkVar(this,ardt_xntestit,new String[]{"tipooprap"},new String[]{"TIPOOPRAP"},true);
        }
      }
  ...
  CallerBRImpl GetChild(String p_cName) {
    if (CPLib.eq(p_cName,"ardt_xntestit")) {
      CtxLoad_ardt_xntestit();
      return ardt_xntestit;
    }
