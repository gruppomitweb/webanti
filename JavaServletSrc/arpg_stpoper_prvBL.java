...
public class arpg_stpoper_prvBL extends arpg_stpoper_prvWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpoper_prv";
  ...
  public arpg_stpoper_prvBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpoper_prv","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
