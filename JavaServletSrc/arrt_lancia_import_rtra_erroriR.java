...
// * --- Fine Area Manuale
public class arrt_lancia_import_rtra_erroriR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_rtra_erroriR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_rtra_errori",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_import_rtra_errori";
  ...
  void Page_1() throws Exception {
    ...
    /* Stop ../jsp/pg_import_dati_rtra_errori_portlet.jsp */
    Forward f;
    f=new Forward("../jsp/pg_import_dati_rtra_errori_portlet.jsp",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_import_rtra_erroriR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_rtra_erroriR(p_Ctx, p_Caller);
  }
  public void Blank() {
