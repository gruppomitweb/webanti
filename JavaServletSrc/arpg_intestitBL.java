...
public class arpg_intestitBL extends arpg_intestitWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_intestit";
  ...
  public arpg_intestitBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_intestit","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
