...
public class arpg_stp_stdtec_frzBL extends arpg_stp_stdtec_frzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_frz";
  ...
  public static final String i_StateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'flgrae':flgrae}";
  public static final String i_CompleteStateStructure = "{'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'daCodCli':daCodCli,'aCodCli':aCodCli,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'c_dadata':c_dadata,'c_adata':c_adata,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2,'flgrae':flgrae}";
  public static final String i_ItemSequence = "daCodDip,aCodDip,DaDatOpe,ADatOpe,daCodCli,aCodCli,flgrae";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"daCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"aCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"flgrae","Rae/ateco","C","1","0","variabile","nokey","false","false"}});
  ...
  public arpg_stp_stdtec_frzBL (CPContext p_ContextObject) {
  ...
  public boolean Set_DaDatOpe(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.le(w_DaDatOpe,CPLib.CharToDate("20131231"));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di inizio deve essere minore del 31/12/2013";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_DaDatOpe = CPLib.NullDate();
  ...
  public boolean Set_ADatOpe(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.ge(w_ADatOpe,w_DaDatOpe) && CPLib.le(w_ADatOpe,CPLib.CharToDate("20131231"));
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di fine periodo non deve essere minore di quella di inizio periodo e deve essere minore del 31/12/2013";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_ADatOpe = CPLib.NullDate();
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_frz","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
