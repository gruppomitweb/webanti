...
public class armt_snai_oper_vBL extends armt_snai_oper_vWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_snai_oper_v";
  ...
  public armt_snai_oper_vBL (CPContext p_ContextObject) {
    ...
    m_MNTs = CPLib.MNTChilds("armt_snai_oper_v",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_snai_oper_v","cgo_operazioni",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_snai_oper_v",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_snai_oper_v",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_snai_oper_v",m_Ctx);
  ...
  public boolean Check() {
    ...
    } else if ( ! (CPLib.Empty(w_RDCODAUT)) &&  ! (arfn_chk_docautR.Make(m_Ctx,this).Run(w_RDCODAUT,w_TIPODOC))) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_snai_oper_v"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_snai_oper_v\\"+p_cState};
    }
    return l_Keys;
  }
