...
if ( ! (m_oFather.SaveContext_ardt_sogopefraz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_sogopefraz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_sogopefraz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_sogopefraz();
}
}
SaveContext.child=[];
function BlankRow() {
