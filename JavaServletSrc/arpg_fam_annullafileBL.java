...
public class arpg_fam_annullafileBL extends arpg_fam_annullafileWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_fam_annullafile";
  ...
  public CPPhTableWrInfo m_oWrInfo_aeinvio;
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'anno':anno,'idbase':idbase,'CODINVIO':CODINVIO,'mese':mese,'TIPOINVIO':TIPOINVIO,'TIPOCOMU':TIPOCOMU}";
  ...
  public arpg_fam_annullafileBL (CPContext p_ContextObject) {
    ...
    m_oWrInfo_aeinvio = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"aeinvio",p_ContextObject.GetCompany());
  ...
  protected boolean Link_UCCWMDWDFX(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_nomefile))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_aesaldi,"select NOMEFILE,ANNO,IDBASE,MESE,TIPOINVIO,TIPOCOMU,CODINVIO from "+m_cPhName_aesaldi+((m_cPhName_aesaldi).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"NOMEFILE"+l_cCurrentKey+l_cWhere);
      try {
        ...
        if (l_bLoaded) {
          ...
          w_anno = l_rsLink.GetString("ANNO");
          w_idbase = l_rsLink.GetString("IDBASE");
          w_mese = l_rsLink.GetString("MESE");
          w_TIPOINVIO = l_rsLink.GetString("TIPOINVIO");
          w_TIPOCOMU = l_rsLink.GetString("TIPOCOMU");
          w_CODINVIO = l_rsLink.GetString("CODINVIO");
          l_rsLink.Next();
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_fam_annullafile","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_CODINVIO = CPLib.GetProperty(p,"CODINVIO",w_CODINVIO,0);
      w_mese = CPLib.GetProperty(p,"mese",w_mese,0);
      w_TIPOINVIO = CPLib.GetProperty(p,"TIPOINVIO",w_TIPOINVIO,0);
      w_TIPOCOMU = CPLib.GetProperty(p,"TIPOCOMU",w_TIPOCOMU,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_field",new String[]{"NOMEFILE","ANNO","IDBASE","MESE","TIPOINVIO","TIPOCOMU","CODINVIO"});
    map.put("rd_var",new String[]{"w_nomefile","w_anno","w_idbase","w_mese","w_TIPOINVIO","w_TIPOCOMU","w_CODINVIO"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C\u0000C\u0000C\u0000C\u0000C\u0000C",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("20\u00004\u000010\u00002\u00001\u00001\u000012",-1));
    map.put("rd_kvar.len",new String[]{});
    map.put("rd_var.dec",zeroSplit.split("0\u00000\u00000\u00000\u00000\u00000\u00000",-1));
    map.put("rd_kvar.dec",new String[]{});
    map.put("rd_var.comment",zeroSplit.split("\u0000\u0000\u0000Mese di riferimento\u0000Tipo Invio\u0000Tipo Comunicazione\u0000Codice Invio",-1));
