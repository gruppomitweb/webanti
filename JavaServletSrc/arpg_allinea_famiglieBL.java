...
public class arpg_allinea_famiglieBL extends arpg_allinea_famiglieWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_allinea_famiglie";
  ...
  public static final String i_CompleteStateStructure = "{'nomefile':nomefile,'gAzienda':gAzienda}";
  ...
  public arpg_allinea_famiglieBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_famiglie","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
