...
m_oFather.i_last_focused_item='child_ardt_terzistifrz';
...
function Help() {
windowOpenForeground('../doc/ardt_terzistifrz_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'terzistifrz'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_terzistifrz',m_cSelectedPage);
