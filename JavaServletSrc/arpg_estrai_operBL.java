...
public class arpg_estrai_operBL extends arpg_estrai_operWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_estrai_oper";
  ...
  public arpg_estrai_operBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_estrai_oper","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
