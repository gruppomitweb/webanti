...
public class arpg_stp_stdtec_xrzBL extends arpg_stp_stdtec_xrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_xrz";
  ...
  public arpg_stp_stdtec_xrzBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_xrz","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
