...
var tmp_GYQCDWXDPD = ToHTag(AsControlValue(w_RAPPORTO));
if (Ne(e_GYQCDWXDPD,tmp_GYQCDWXDPD)) {
SPBOUILib.SetLabelValue('GYQCDWXDPD','innerHTML',tmp_GYQCDWXDPD);
e_GYQCDWXDPD=tmp_GYQCDWXDPD;
}
var tmp_WCEBTQPADO = ToHTag(AsControlValue(w_DESCRAP));
if (Ne(e_WCEBTQPADO,tmp_WCEBTQPADO)) {
SPBOUILib.SetLabelValue('WCEBTQPADO','innerHTML',tmp_WCEBTQPADO);
e_WCEBTQPADO=tmp_WCEBTQPADO;
}
...
SetDisplay('LOWQUGWHYA_DIV',IsHiddenByStateDriver('AltriDati'));
SetDisplay('LWDMGLAEON_DIV',IsHiddenByStateDriver('Garantiti'));
SetDisplay('TUIMYVJMXF_DIV',IsHiddenByStateDriver('box_TUIMYVJMXF'));
...
linkpc_url.u('ZSYGOPYXSA',function(){return 'ardt_xarantbo?m_bInnerChild=true'+GetLinkPCKeys('ardt_xarantbo')+'&m_bRowsChild='+EnableChild('ardt_xarantbo')})
_ResetTracker();
...
w_Delegati.raiseEvent('armt_provanarap_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Operazioni),'undefined')) {
w_Operazioni.raiseEvent('armt_provanarap_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Frazionate),'undefined')) {
w_Frazionate.raiseEvent('armt_provanarap_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Intestatati),'undefined')) {
w_Intestatati.raiseEvent('armt_provanarap_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Informazioni),'undefined')) {
w_Informazioni.raiseEvent('armt_provanarap_'+Strtran(p_cEvent,' ','_'));
}
}
...
FocusFirstComponent.edit={"page_1":["AQAARAIPOR"],"page_4":["YSBAKLZECK"]};
FocusFirstComponent.query={"page_1":["LXORWVRYJJ"],"page_4":["YSBAKLZECK"]};
FocusFirstComponent.otherwise={"page_1":["LXORWVRYJJ"],"page_4":["YSBAKLZECK"]};
function Help() {
windowOpenForeground('../doc/armt_provanarap_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
function SetModified_ardt_xarantbo() {
SetModified();
}
...
GetLayerID.Layers.push({"id":"LOWQUGWHYA","name":"AltriDati"});
GetLayerID.Layers.push({"id":"LWDMGLAEON","name":"Garantiti"});
GetLayerID.Layers.push({"id":"TUIMYVJMXF","name":"box_TUIMYVJMXF"});
function DeclareWVs() {
var a = arguments;
w_RAPPORTO=a[0];
w_DESCRAP=a[1];
...
return 'xnarapbo'+'\\'+CPLib.ToCPStr(w_RAPPORTO);
}
GetLinkPCKeys.set_o('ardt_xarantbo',false);
GetLinkPCKeys.o['ardt_xarantbo']['RAPPORTO']=function(t){
if (Ne(m_cFunction,'new')) {
return t(w_RAPPORTO,'C');
}
}
resizeChildIframe.children['ardt_xarantbo']=true;
...
LoadContext.f('ZSYGOPYXSA',function(){return FrameRef('ardt_xarantbo')},1,'ardt_xarantbo',0,5)
GetSelectedChildPage.child={'ardt_xarantbo': function(){return FrameRef('ardt_xarantbo')}}
function GetSelectedPage(p_d) {
p_d.setValue('armt_provanarap',m_cSelectedPage);
