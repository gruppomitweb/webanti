...
// * --- arrt_imp_dati_storico
import java.io.File; 
import java.lang.Double;
import jxl.*;
// * --- Fine Area Manuale
public class arrt_imp_dati_storicoR implements CallerWithObjs {
  ...
  public int _conta;
  // * --- Fine Area Manuale
  public arrt_imp_dati_storicoR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_imp_dati_storico",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* Exec "Inserisce priorità sui nomi file" Page 20:Page_20 */
      Page_20();
      // Begin Transaction
      ...
      double nTry071995F0status;
      nTry071995F0status = m_Sql.GetTransactionStatus();
      String cTry071995F0msg;
      cTry071995F0msg = m_Sql.TransactionErrorMessage();
      try {
        ...
        while ( ! (Cursor_tmp_list_imprich.Eof())) {
          ...
          if (CPLib.eqr(_esito,0)) {
            ...
            if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"archpers.txt")) {
              ...
              /* Exec "Altri Intestatari Operazione" Page 19:Page_19 */
              Page_19();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Altre Controparti Operazione" Page 22:Page_22 */
              Page_22();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              ...
              /* Exec "Altre Terze Parti Operazione" Page 23:Page_23 */
              Page_23();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              /* Case Lower(LRTrim(nomefileimport))='saldopex.txt' */
            } else if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"saldopex.txt")) {
              /* Exec "Saldi Operazioni Extraconto" Page 25:Page_25 */
              Page_25();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
              /* Case Lower(LRTrim(nomefileimport))='saldrapp.txt' */
            } else if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"saldrapp.txt")) {
        ...
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        /* gMsgProc := gMsgProc + 'Errore NonSQL: ' + m_cLastMsgError + NL */
        gMsgProc = gMsgProc+"Errore NonSQL: "+m_cLastMsgError+"\n";
        m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry071995F0status,0)) {
          m_Sql.SetTransactionStatus(nTry071995F0status,cTry071995F0msg);
        }
      }
    } finally {
      try {
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xCodCab))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
          ...
          m_cSql = m_cSql+GetFieldsName_074B3D90(m_Ctx);
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,448,2))))) {
            ...
            if (CPLib.eqr(CPLib.LRTrim(CPLib.Substr(riga,448,2)),"EE")) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on tbstati into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if ( ! (CPLib.Empty(xConnes))) {
            ...
            m_cSql = m_cSql+GetFieldsName_07690278(m_Ctx);
            m_cSql = m_cSql+") values (";
            ...
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Upper(cPNAS),"?",0,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xnarapbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
              ...
              m_cSql = m_cSql+GetFieldsName_073E0990(m_Ctx);
              m_cSql = m_cSql+") values (";
              ...
              m_cSql = m_cSql+GetFieldsName_073E0DC8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on anarapbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              m_cSql = m_cSql+GetFieldsName_077B74C8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,76,1),"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"knarapbo")+" (";
              m_cSql = m_cSql+GetFieldsName_074CDCB0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if ( ! (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,115,6))))) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(CPLib.Substr(riga,121,30))+CPLib.LRTrim(CPLib.Substr(riga,153,6))+CPLib.LRTrim(CPLib.Substr(riga,151,2)))) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on anadip into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on personbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,159,10))),0)) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on xapopebo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
            ...
            m_cSql = m_cSql+GetFieldsName_074A9710(m_Ctx);
            m_cSql = m_cSql+") values (";
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              if (CPLib.eqr(CPLib.Substr(riga,44,2),"23")) {
                ...
                m_cSql = m_cSql+GetFieldsName_0742E960(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"xntestbo")+" (";
                m_cSql = m_cSql+GetFieldsName_0756D730(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2)),"?",0,0)+", ";
            ...
            if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,159,10))),0)) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on rapopebo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              m_cSql = m_cSql+GetFieldsName_0742F020(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2)),"?",0,0)+", ";
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,318,10))),0)) {
            ...
            if (CPLib.eqr(CPLib.Left(_ucode,1),"I")) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on operazbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if (CPLib.eqr(_newop,1)) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on tbcauana into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_cSql = m_cSql+GetFieldsName_0765CE98(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Right(CPLib.Left(riga,8),4)),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(_bencap,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencta,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.ne(xRiga1,xRiga2)) {
              ...
              while ( ! (Cursor_operazbo.Eof())) {
                ...
                while ( ! (Cursor_sogopebo.Eof())) {
                  ...
                  m_cSql = m_cSql+GetFieldsName_0779F200(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cNewProg,"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"operazbo")+" (";
              m_cSql = m_cSql+GetFieldsName_077B3E80(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0)) {
          ...
          if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,318,10))),0)) {
            ...
            if (CPLib.eqr(CPLib.Left(_ucode,1),"I")) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on fraziobo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if (CPLib.eqr(_newop,1)) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_cSql = m_cSql+GetFieldsName_07041FD8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_07025508(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.ne(xRiga1,xRiga2)) {
              ...
              while ( ! (Cursor_fraziobo.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"fraziobo")+" (";
                m_cSql = m_cSql+GetFieldsName_0759BE90(m_Ctx);
                m_cSql = m_cSql+") values (";
                ...
                while ( ! (Cursor_sogopefbo.Eof())) {
                  ...
                  m_cSql = m_cSql+GetFieldsName_076E4F58(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cNewProg,"?",0,0,m_cServer)+", ";
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"fraziobo")+" (";
              m_cSql = m_cSql+GetFieldsName_05D05E98(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,454,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_bencab,"?",0,0,m_cServer)+", ";
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on jnarapbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
            ...
            m_cSql = m_cSql+GetFieldsName_07668A78(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,50),"?",0,0,m_cServer)+", ";
  ...
  void Page_8() throws Exception {
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        m_cSql = m_cSql+GetFieldsName_079F8360(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(_intercab,"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(cNumMod,0)) {
          ...
          m_cSql = m_cSql+GetFieldsName_06FB20A0(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2)),"?",0,0)+", ";
  ...
  void Page_9() throws Exception {
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        m_cSql = m_cSql+GetFieldsName_07A0C370(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,10,4),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xDIPx))) {
          ...
          m_cSql = m_cSql+GetFieldsName_07817DC0(m_Ctx);
          m_cSql = m_cSql+") values (";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL(xCodCab,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,85,1),"?",0,0,m_cServer)+", ";
          if (m_Ctx.IsSharedTemp("anadip")) {
            m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
          }
          ...
          m_cSql = m_cSql+"AGENTE = "+CPLib.ToSQL(CPLib.Substr(riga,85,1),"C",1,0,m_cServer)+", ";
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if ( ! (CPLib.Empty(CPLib.Substr(riga,159,10)))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xapotit into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(_unicode)) {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on rapotit into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if (CPLib.eqr(w_tipodest,"P")) {
              ...
              m_cSql = m_cSql+GetFieldsName_06D04068(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_intercab,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,115,6),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_062CE7D0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_intercab,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,115,6),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(_tdest,"P")) {
              ...
              while ( ! (Cursor_xapotit.Eof())) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"xapotit")+" (";
                m_cSql = m_cSql+GetFieldsName_070CC618(m_Ctx);
                m_cSql = m_cSql+") values (";
  ...
  void Page_12() throws Exception {
    ...
    try {
      ...
      /* While not(FileLibrary.Eof(fhand)) */
      while ( ! (FileLibrary.Eof(fhand))) {
        /* gMsgImp := 'Sono state elaborate '+LRTrim(Str(conta,10,0))+' operazioni del file '+nomefileimport // Messaggio Import */
        gMsgImp = "Sono state elaborate "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" operazioni del file "+nomefileimport;
        m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
        /* riga := FileLibrary.ReadLine(fhand) */
        riga = FileLibrary.ReadLine(fhand);
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on opextrbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
          ...
          m_cSql = m_cSql+GetFieldsName_07814E80(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(cCli1,"?",0,0,m_cServer)+", ";
      ...
      /* FileLibrary.DeleteFile('./appo/'+nomefileimport) */
      FileLibrary.DeleteFile("./appo/"+nomefileimport);
      /* gMsgProc := gMsgProc + 'Operazioni ExtraConto Inserite: '+LRTrim(Str(cNumNew,10,0)) + " - Operazioni ExtraConto Aggiornate: "+LRTrim(Str(cNumMod,10,0))+' dal file '+nomefileimport+NL */
      gMsgProc = gMsgProc+"Operazioni ExtraConto Inserite: "+CPLib.LRTrim(CPLib.Str(cNumNew,10,0))+" - Operazioni ExtraConto Aggiornate: "+CPLib.LRTrim(CPLib.Str(cNumMod,10,0))+" dal file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      /* gMsgProc := gMsgProc + 'Ora Fine Processo: '+ arfn_fdatetime(DateTime()) + ' del file ' +nomefileimport + NL */
      gMsgProc = gMsgProc+"Ora Fine Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on xelegabo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(cMaxRow,0)) {
            ...
            m_cSql = m_cSql+GetFieldsName_0765EC68(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on delegabo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(cMaxRow,0)) {
            ...
            m_cSql = m_cSql+GetFieldsName_07746390(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,16),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(w_tipodest,"P")) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on xperazbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
              ...
              if ( ! (Read_Cursor.Eof())) {
                ...
                Read_Cursor.Next();
                if ( ! (Read_Cursor.Eof())) {
                  Error l_oErrorFault = new Error("Read on xraziobo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
                  CPStdCounter.Error(l_oErrorFault);
                }
                Read_Cursor.Close();
              } else {
              ...
              if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
                ...
                m_cSql = m_cSql+GetFieldsName_07654288(m_Ctx);
                m_cSql = m_cSql+") values (";
            ...
            if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
              ...
              m_cSql = m_cSql+GetFieldsName_076062F8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
            ...
            m_cSql = m_cSql+GetFieldsName_07605D58(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"sogopefbo")+" (";
                m_cSql = m_cSql+GetFieldsName_04184998(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"sogopebo")+" (";
              m_cSql = m_cSql+GetFieldsName_06343D50(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
            ...
            m_cSql = m_cSql+GetFieldsName_06DCB060(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQLNull(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (CPLib.Empty(CPLib.LRTrim(riga)))) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            Cursor_xntestbo.Close();
            // * --- End Select
            /* Se non trovo il record inserisco il nuovo intestatario */
            /* If cNumMod = 0 */
            if (CPLib.eqr(cNumMod,0)) {
              // * --- Insert into xntestbo from values
              m_Sql.RequireTransaction();
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"xntestbo")+" (";
              m_cSql = m_cSql+GetFieldsName_06E76738(m_Ctx);
              m_cSql = m_cSql+") values (";
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"intestbo")+" (";
              m_cSql = m_cSql+GetFieldsName_06D8FEB0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(ciidbase,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cidataini,"?",0,0)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on jelegabo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.eqr(cMaxRow,0)) {
          ...
          m_cSql = m_cSql+GetFieldsName_0642EFC0(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,26,16),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on japopebo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on jperazbo into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(_salta,0) && CPLib.eqr(CPLib.Substr(riga,11,10),_unicode)) {
            ...
            m_cSql = m_cSql+GetFieldsName_07C80C80(m_Ctx);
            m_cSql = m_cSql+") values (";
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.eqr(cNumMod,0)) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.InsertIntoStatement(m_Ctx,"jntestbo")+" (";
          m_cSql = m_cSql+GetFieldsName_061FBD08(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(ciidbase,"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cMaxRow+1,"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(cidataini,"?",0,0)+", ";
        ...
        if (CPLib.eqr(CPLib.Substr(riga,48,1),"F")) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_070CC300(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_06D5C988(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_06D14F88(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      while ( ! (Cursor_tmp_list_imprich.Eof())) {
        ...
        if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(Cursor_tmp_list_imprich.GetString("nomefile"))),"archdip.txt")) {
          ...
          /* Case Lower(LRTrim(tmp_list_imprich->nomefile))='saldopex.txt' or Lower(LRTrim(tmp_list_imprich->nomefile))='saldopex.xls' */
        } else if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(Cursor_tmp_list_imprich.GetString("nomefile"))),"saldopex.txt") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(Cursor_tmp_list_imprich.GetString("nomefile"))),"saldopex.xls")) {
          /* _priorita := 22 */
          _priorita = CPLib.Round(22,0);
          /* Case Lower(LRTrim(tmp_list_imprich->nomefile))='saldrapp.txt' or Lower(LRTrim(tmp_list_imprich->nomefile))='saldrapp.xls' */
        } else if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(Cursor_tmp_list_imprich.GetString("nomefile"))),"saldrapp.txt") || CPLib.eqr(CPLib.Lower(CPLib.LRTrim(Cursor_tmp_list_imprich.GetString("nomefile"))),"saldrapp.xls")) {
          /* _priorita := 23 */
          ...
          if (CPLib.eqr(CPLib.Substr(riga,48,1),"F")) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
                ...
                m_cSql = m_cSql+GetFieldsName_06E80038(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_070CA5C0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
              ...
              if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
                ...
                m_cSql = m_cSql+GetFieldsName_062E62A8(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_062EA598(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.Substr(riga,48,1),"F")) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_0646E078(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.Empty(CPLib.LRTrim(_unicode))) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(_unicode)))) {
              ...
              m_cSql = m_cSql+GetFieldsName_05F67238(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_06336790(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(_unicode,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,21,16),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
    ...
    try {
      ...
      if (CPLib.eqr(chkat,1)) {
        ...
        while ( ! (Cursor_aerighe.Eof())) {
          ...
          m_cSql = m_cSql+GetFieldsName_041860A8(m_Ctx);
          m_cSql = m_cSql+") values (";
        ...
        while ( ! (Cursor_aerighe.Eof())) {
          ...
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_newrapp")+" (";
          m_cSql = m_cSql+GetFieldsName_06584C50(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetDouble("CPROWNUM"),"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("S","?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"saldopex.txt")) {
        ...
        while ( ! (FileLibrary.Eof(fhand))) {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"opextrbo")+" (";
            m_cSql = m_cSql+GetFieldsName_06F01770(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(cCli1,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,17,4),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(xIDB,"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.eqr(CPLib.Lower(CPLib.LRTrim(nomefileimport)),"saldrapp.txt")) {
        ...
        while ( ! (FileLibrary.Eof(fhand))) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on aeannora into routine arrt_imp_dati_storico returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
            ...
            m_cSql = m_cSql+GetFieldsName_07059998(m_Ctx);
            m_cSql = m_cSql+") values (";
          ...
          while (CPLib.lt(_y,_righe)) {
            ...
            if ( ! (CPLib.Empty(CPLib.LRTrim(column10)))) {
              ...
              if (CPLib.Empty(CPLib.LRTrim(xIDB))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aeannora")+" (";
                m_cSql = m_cSql+GetFieldsName_06DCA838(m_Ctx);
                m_cSql = m_cSql+") values (";
  ...
  public static arrt_imp_dati_storicoR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_imp_dati_storicoR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  protected static String GetFieldsName_074B3D90(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_07690278(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"RAGSOC,";
  ...
  protected static String GetFieldsName_073E0990(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_073E0DC8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_077B74C8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_074CDCB0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_074A9710(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0742E960(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0756D730(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
  ...
  protected static String GetFieldsName_0742F020(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_0765CE98(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
  ...
  protected static String GetFieldsName_0779F200(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_077B3E80(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_07041FD8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_07025508(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_0759BE90(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"AUTOM,";
  ...
  protected static String GetFieldsName_076E4F58(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_05D05E98(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AMMONT,";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"C_CAB,";
  ...
  protected static String GetFieldsName_07668A78(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
    p_cSql = p_cSql+"TIPORAP,";
  ...
  protected static String GetFieldsName_079F8360(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_06FB20A0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_07A0C370(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
    p_cSql = p_cSql+"CODANA,";
  ...
  protected static String GetFieldsName_07817DC0(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_06D04068(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_062CE7D0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_070CC618(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CDATOPE,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"CODDIPE,";
  ...
  protected static String GetFieldsName_07814E80(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0765EC68(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODINTER,";
  ...
  protected static String GetFieldsName_07746390(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODINTER,";
  ...
  protected static String GetFieldsName_07654288(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_076062F8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_07605D58(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_04184998(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_06343D50(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_06DCB060(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_06E76738(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_06D8FEB0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_0642EFC0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODINTER,";
  ...
  protected static String GetFieldsName_07C80C80(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_061FBD08(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_070CC300(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06D5C988(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06D14F88(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06E80038(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_070CA5C0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_062E62A8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_062EA598(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_0646E078(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_05F67238(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06336790(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CODSOG,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_041860A8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_06584C50(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"NUMRIG,";
    p_cSql = p_cSql+"TIPO,";
  ...
  protected static String GetFieldsName_06F01770(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"COLLEG,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_07059998(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
  ...
  protected static String GetFieldsName_06DCA838(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"ANNO,";
    p_cSql = p_cSql+"IDBASE,";
