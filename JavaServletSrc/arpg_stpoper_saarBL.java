...
public class arpg_stpoper_saarBL extends arpg_stpoper_saarWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stpoper_saar";
  ...
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"OrderBy","","C","22","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"}});
  ...
  public arpg_stpoper_saarBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_OrderBy = "DATAOPE,NUMPROG,IDBASE";
    Link_UYVYTEMEXX();
    Link_CJWUHWULAR();
    SaveDependsOn();
    NotifyEvent("Blank");
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stpoper_saar","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
