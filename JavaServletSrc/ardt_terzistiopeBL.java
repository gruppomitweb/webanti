...
public class ardt_terzistiopeBL extends ardt_terzistiopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_terzistiope";
  ...
  public CPPhTableWrInfo m_oWrInfo_terzistiope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_terzistiope;
  ...
  public static String[] m_EntityTables = {"terzistiope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_terzistiope",true,true)+"}"+FoundlingChildrenList("ardt_terzistiope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_terzistiope",true,true)+"}"+FoundlingChildrenList("ardt_terzistiope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_terzistiope",false,true)+"]"+FoundlingChildrenList("ardt_terzistiope",false,false)+"";
  ...
  public ardt_terzistiopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_terzistiope = p_ContextObject.GetPhName("terzistiope",p_ContextObject.GetCompany(),false);
    m_cServer_terzistiope = p_ContextObject.GetServer("terzistiope");
    m_oWrInfo_terzistiope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"terzistiope",p_ContextObject.GetCompany());
    m_cVirtName_terzistiope = CPSql.ManipulateTablePhName("terzistiope",m_cServer_terzistiope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_terzistiope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_terzistiope","terzistiope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_terzistiope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_terzistiope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_terzistiope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_terzistiope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_terzistiope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_terzistiope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "terzistiope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "terzistiope"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
