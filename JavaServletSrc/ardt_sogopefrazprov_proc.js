...
m_oFather.i_last_focused_item='child_ardt_sogopefrazprov';
...
function Help() {
windowOpenForeground('../doc/ardt_sogopefrazprov_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
w_xragsoc=a[4];
w_xdescriz=a[5];
m_PrimaryKeys=['CPROWNUM','IDFILEBO'];
}
function i_PrimaryKey() {
return 'xogopefbo'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_sogopefrazprov',m_cSelectedPage);
