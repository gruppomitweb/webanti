...
public class ardt_cgo_infbacheca_usrBL extends ardt_cgo_infbacheca_usrWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public double w_IBUCODUSR;
    public String w_nome;
    public double opk_IBUCODUSR;
  ...
  public static final String i_EntityName = "ardt_cgo_infbacheca_usr";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_infbacheca_usr;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_infbacheca_usr;
  ...
  public static String[] m_EntityTables = {"cgo_infbacheca_usr"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IBUCODICE':IBUCODICE,'m_Detail':{'IBUCODUSR':IBUCODUSR"+FoundlingChildrenList("ardt_cgo_infbacheca_usr",true,true)+"}"+FoundlingChildrenList("ardt_cgo_infbacheca_usr",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IBUCODICE':IBUCODICE,'m_Detail':{'IBUCODUSR':IBUCODUSR,'nome':nome"+FoundlingChildrenList("ardt_cgo_infbacheca_usr",true,true)+"}"+FoundlingChildrenList("ardt_cgo_infbacheca_usr",true,false)+"}";
  public static final String i_ItemSequence = "IBUCODICE,m_Detail[ IBUCODUSR"+FoundlingChildrenList("ardt_cgo_infbacheca_usr",false,true)+"]"+FoundlingChildrenList("ardt_cgo_infbacheca_usr",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_cgo_infbacheca_usr"),new String[][]{new String[]{"IBUCODICE","Codice Informazione","N","10","0","campo","key1","false","false"},new String[]{"IBUCODUSR","Codice Utente","N","10","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",IBUCODUSR";
  ...
  public ardt_cgo_infbacheca_usrBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_infbacheca_usr = p_ContextObject.GetPhName("cgo_infbacheca_usr",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_infbacheca_usr = p_ContextObject.GetServer("cgo_infbacheca_usr");
    m_oWrInfo_cgo_infbacheca_usr = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_infbacheca_usr",p_ContextObject.GetCompany());
    m_cVirtName_cgo_infbacheca_usr = CPSql.ManipulateTablePhName("cgo_infbacheca_usr",m_cServer_cgo_infbacheca_usr);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_infbacheca_usr",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_BRCAXXLEPY() {
    return Link_BRCAXXLEPY("Full");
  }
  protected boolean Link_BRCAXXLEPY(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_IBUCODUSR))) {
      double l_OldValue = w_IBUCODUSR;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IBUCODUSR,"N",10,0),m_cServer_cpusers,w_IBUCODUSR);
      ...
      try {
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                    ...
                                    */
          w_IBUCODUSR = l_rsLink.GetDouble("code");
          w_nome = l_rsLink.GetString("name");
          l_rsLink.Next();
          ...
          Link_BRCAXXLEPY_blank();
          if (CPLib.eq(p_cType,"Load")) {
            w_IBUCODUSR = l_OldValue;
          }
        }
        if ( ! (l_bResult)) {
          m_nLastError = 3;
          ...
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","IBUCODUSR");
          }
          m_cLastWorkVarError = "IBUCODUSR";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_IBUCODICE(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_IBUCODICE = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_IBUCODUSR(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_IBUCODUSR = p_workVariableValue;
    l_bResult = Link_BRCAXXLEPY();
  ...
  public final static String[] m_KeyColumns = {"IBUCODICE"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_cgo_infbacheca_usr","cgo_infbacheca_usr",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_IBUCODUSR;
      p_IBUCODUSR = CPLib.GetProperties(trs_p.getProperty("IBUCODUSR"),new Properties());
      Properties p_nome;
      p_nome = CPLib.GetProperties(trs_p.getProperty("nome"),new Properties());
      Properties p_opk_IBUCODUSR;
      p_opk_IBUCODUSR = CPLib.GetProperties(trs_p.getProperty("opk_IBUCODUSR"),new Properties());
      ...
      w_IBUCODICE = CPLib.GetProperty(p,"IBUCODICE",w_IBUCODICE,0);
      ...
      while (CPLib.le(i,rows)) {
        w_IBUCODUSR = 0;
        w_IBUCODUSR = CPLib.GetProperty(p_IBUCODUSR,"",w_IBUCODUSR,i);
        w_nome = "";
        w_nome = CPLib.GetProperty(p_nome,"",w_nome,i);
        opk_IBUCODUSR = CPLib.GetProperty(p_opk_IBUCODUSR,"",0,i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"IBUCODICE")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"IBUCODUSR")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_IBUCODUSR","w_nome"});
    ...
    map.put("rd_var.comment",zeroSplit.split("Codice Utente\u0000",-1));
    ...
    map.put("property.value",zeroSplit.split("cpusers\u0000false\u0000false\u00001\u00000\u0000\u0000false\u0000false\u0000\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_cgo_infbacheca_usr",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_cgo_infbacheca_usr",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_cgo_infbacheca_usr",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_infbacheca_usr",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_cgo_infbacheca_usr"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_cgo_infbacheca_usr\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_IBUCODUSR;
    p_IBUCODUSR = new Properties();
    Properties p_nome;
    p_nome = new Properties();
    Properties p_opk_IBUCODUSR;
    p_opk_IBUCODUSR = new Properties();
    Properties p_m_nRowStatus;
    p_m_nRowStatus = new Properties();
    Properties p_m_cOldRowCPCCCHK;
    p_m_cOldRowCPCCCHK = new Properties();
    CPLib.PutProperty(p,"IBUCODICE",w_IBUCODICE,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_IBUCODUSR,"",w_IBUCODUSR,trsrow);
      CPLib.PutProperty(p_nome,"",w_nome,trsrow);
      CPLib.PutProperty(p_opk_IBUCODUSR,"",opk_IBUCODUSR,trsrow);
    ...
    trs_p.setProperty("IBUCODUSR",CPLib.ToProperties(p_IBUCODUSR));
    trs_p.setProperty("nome",CPLib.ToProperties(p_nome));
    trs_p.setProperty("opk_IBUCODUSR",CPLib.ToProperties(p_opk_IBUCODUSR));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_infbacheca_usr"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("IBUCODICE","N",10,0));
  }
  public String RowPrimaryKey() {
    return "cgo_infbacheca_usr"+"\\"+CPLib.ToCPStr(w_IBUCODUSR);
  }
  ...
  protected void TrsToWork() {
    w_IBUCODUSR= m_oTrs.get(m_nCurrentRow).w_IBUCODUSR;
    w_nome= m_oTrs.get(m_nCurrentRow).w_nome;
    opk_IBUCODUSR= m_oTrs.get(m_nCurrentRow).opk_IBUCODUSR;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_IBUCODUSR=w_IBUCODUSR;
    m_oTrs.get(m_nCurrentRow).w_nome=w_nome;
    m_oTrs.get(m_nCurrentRow).opk_IBUCODUSR=opk_IBUCODUSR;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_IBUCODUSR=w_IBUCODUSR;
    m_oDeletedRows.get(l_nRows).w_nome=w_nome;
    m_oDeletedRows.get(l_nRows).opk_IBUCODUSR=opk_IBUCODUSR;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_IBUCODUSR));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_IBUCODUSR= m_oDeletedRows.get(l_RowNumberToSet).w_IBUCODUSR;
    w_nome= m_oDeletedRows.get(l_RowNumberToSet).w_nome;
    opk_IBUCODUSR= m_oDeletedRows.get(l_RowNumberToSet).opk_IBUCODUSR;
