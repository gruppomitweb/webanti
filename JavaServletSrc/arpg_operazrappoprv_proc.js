...
function Help() {
windowOpenForeground('../doc/arpg_operazrappoprv_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_operazrappoprv',m_cSelectedPage);
...
GroupFooter_BeginHtml(document,1,'1710945683'+l_nIdx+'','A',true,false)
GroupFooter_EndHtml(document,1,'1710945683'+l_nIdx+'','A')
} else {
}
l_nIdx=l_nIdx+1;
m_nCurrentRow=l_nIdx;
...
if (Ge(2,l_nDeep)) {
GroupHeader_BeginHtml(document,1,'1711076755'+l_nIdx+'','A',true,false)
document.writeln(
 "<div id='DIV_09795950"+l_nIdx+"' style='position:relative;height:17px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
GroupHeader_EndHtml(document,1,'1711076755'+l_nIdx+'','A')
} else {
}
Row_BeginHtml(document,l_nEvenOdd,'788985235'+l_nIdx+'','A',true,-1)
document.writeln(
 "<div id='DIV_097FA5B0"+l_nIdx+"' style='position:relative;height:17px'>" +
"")
document.writeln(
...
document.writeln(
 "</div>" +
"")
Row_EndHtml(document,l_nEvenOdd,'788985235'+l_nIdx+'','A')
Parms.Idx=l_nIdx;
Parms.Deep=l_nDeep;
Parms.EvenOdd=l_nEvenOdd;
}
