...
// * --- Fine Area Manuale
public class arrt_start_schedulerR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_start_schedulerR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_start_scheduler",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_start_scheduler";
    } else if (m_bEventRunning && CPLib.eqr("i_EntityType",p_cVarName)) {
      return "routine";
    }
    if (CPLib.eqr("_desazi",p_cVarName)) {
      return _desazi;
    }
    return "";
  }
  ...
  void Page_1() throws Exception {
    ...
    try {
      /* _desazi Char(30) */
      /* Debug Msg 'Query per connessione' */
      if ( ! (CPLib.IsNull(m_Debug))) {
        m_Debug.log(CPLib.FormatMsg(m_Ctx,"Query per connessione"));
      }
      // * --- Select from cpazi
      ...
      while ( ! (Cursor_cpazi.Eof())) {
        /* _desazi := cpazi->desazi */
        _desazi = Cursor_cpazi.GetString("desazi");
        Cursor_cpazi.Next();
      }
  ...
  public static arrt_start_schedulerR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_start_schedulerR(p_Ctx, p_Caller);
  }
  public void Blank() {
    _desazi = CPLib.Space(30);
  }
