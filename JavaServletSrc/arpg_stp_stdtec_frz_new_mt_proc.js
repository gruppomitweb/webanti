...
if (false || WindowConfirm(Translate('11421439687'))) {
Lancio()
}
}
...
SetLocationHref(null,'arrt_stp_stdtec_new_mt'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
_ResetTracker();
...
w_Messaggi.raiseEvent('arpg_stp_stdtec_frz_new_mt_'+Strtran(p_cEvent,' ','_'));
}
if (Ne(typeof(w_Log),'undefined')) {
w_Log.raiseEvent('arpg_stp_stdtec_frz_new_mt_'+Strtran(p_cEvent,' ','_'));
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_stp_stdtec_frz_new_mt_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_stdtec_frz_new_mt',m_cSelectedPage);
