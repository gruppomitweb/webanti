...
// * --- Fine Area Manuale
public class armt_cgo_qadv_operazioni_storicoBO extends armt_cgo_qadv_operazioni_storicoBL {
  class SqlLoader {
    double m_nColumns = 0;
    CPSql m_Sql;
    String m_cServer;
  ...
  // * --- Fine Area Manuale
  public armt_cgo_qadv_operazioni_storicoBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_cgo_qadv_operazioni_storico");
    }
  ...
  public boolean Load(String p_SNAINUMOPE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_cgo_qadv_operazioni_storico,m_cPhName_cgo_qadv_operazioni_storico,m_cVirtName_cgo_qadv_operazioni_storico,m_cVirtName_cgo_qadv_operazioni_storico+".SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_SNAINUMOPE,"C",15,0),m_cServer_cgo_qadv_operazioni_storico,p_SNAINUMOPE),"");
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_qadv_operazioni_storico")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_cgo_qadv_operazioni_storico);
      l_cSql = "insert into "+m_oWrInfo_cgo_qadv_operazioni_storico.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_cgo_qadv_operazioni_storico.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_qadv_operazioni_storico")) {
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_QADV_MOTIVO03,"M",10,0,m_cServer_cgo_qadv_operazioni_storico,m_oParameters)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_QADV_MOTIVO05,"M",10,0,m_cServer_cgo_qadv_operazioni_storico,m_oParameters)+", ";
      ...
      l_cSql = l_cSql+CPLib.ToSQL(w_QADV_MOTIVO04,"M",10,0,m_cServer_cgo_qadv_operazioni_storico,m_oParameters)+", ";
      ...
      l_cSql = l_cSql+m_oWrInfo_cgo_qadv_operazioni_storico.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_qadv_operazioni_storico")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_cgo_qadv_operazioni_storico,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_cgo_qadv_operazioni_storico);
      l_cSql = "Update "+m_oWrInfo_cgo_qadv_operazioni_storico.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+", QADV_MOTIVO03 = "+CPLib.ToSQL(w_QADV_MOTIVO03,"M",10,0,m_cServer_cgo_qadv_operazioni_storico,m_oParameters);
      ...
      l_cSql = l_cSql+", QADV_MOTIVO05 = "+CPLib.ToSQL(w_QADV_MOTIVO05,"M",10,0,m_cServer_cgo_qadv_operazioni_storico,m_oParameters);
      ...
      l_cSql = l_cSql+", QADV_MOTIVO04 = "+CPLib.ToSQL(w_QADV_MOTIVO04,"M",10,0,m_cServer_cgo_qadv_operazioni_storico,m_oParameters);
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_SNAINUMOPE,"C",15,0),m_cServer_cgo_qadv_operazioni_storico,w_SNAINUMOPE);
      l_cSql = l_cSql+m_oWrInfo_cgo_qadv_operazioni_storico.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_qadv_operazioni_storico")) {
  ...
  public boolean Delete(String p_SNAINUMOPE) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_cgo_qadv_operazioni_storico.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"SNAINUMOPE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_SNAINUMOPE,"C",15,0),m_cServer_cgo_qadv_operazioni_storico,w_SNAINUMOPE);
          l_cSql = l_cSql+m_oWrInfo_cgo_qadv_operazioni_storico.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"cgo_qadv_operazioni_storico")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_cgo_qadv_operazioni_storico,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arrt_cgo_punteggio_adv_dl,
  public static final String i_InvokedRoutines = ",arrt_cgo_punteggio_adv_dl,";
}
