...
// * --- Fine Area Manuale
public class arrt_aggstatorapprvR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_aggstatorapprvR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_aggstatorapprv",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    try {
      // * --- Insert into xtatorap from values
      ...
      m_cSql = CPLib.GetSQLPrefixComment("arrt_aggstatorapprv",11,"0000000A")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
      ...
      m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"xtatorap",true);
      m_cSql = m_cSql+")";
      ...
      m_cLastMsgError = "";
      m_bError = false;
      // * --- Write into xtatorap from values
      m_Sql.RequireTransaction();
      m_cServer = m_Ctx.GetServer("xtatorap");
      m_cPhName = m_Ctx.GetPhName("xtatorap");
      m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"xtatorap",m_Ctx.GetCompany());
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
      m_cSql = CPLib.GetSQLPrefixComment("arrt_aggstatorapprv",11,"0000000C")+"Update "+m_oWrInfo.GetTableWriteName()+" set ";
      ...
      m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"xtatorap",false,true);
      m_cSql = m_cSql+" where ";
  ...
  public static arrt_aggstatorapprvR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_aggstatorapprvR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  protected static String GetFieldsName_0000000A(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    ...
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"xtatorap",true);
    return p_cSql;
  }
}
