...
public class arpg_stprappo_prv extends SPDialogServlet implements SPInvokable {
  public static String m_cEntityUid = "!*AWXTUFNHUN*!";
  ...
  public String getEntityTitle() {
    return "Stampa Rapporti Continuativi Provvisori (Pagina)";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "arpg_stprappo_prv";
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,arpg_stprappo_prvBO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"329177385",p_Context.Translate("Stampa Rapporti Continuativi Provvisori (Pagina)")},
    {"338639962",p_Context.Translate("Titolari Effettivi")}};
    return l_translations;
  }
  void WriteStyles(arpg_stprappo_prvBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='SPPrxy/"+m_cEntityUid+"/arpg_stprappo_prv.css'>" +
      "");
    }
  ...
  void WriteMainForm(arpg_stprappo_prvBO BO,ServletStatus status) {
    status.out.println(
  ...
  com.zucchetti.sitepainter.Library.IncludedPortletUtils.Vars GetPortlet_DYMVKIQWCA_Vars(arpg_stprappo_prvBO BO,ServletStatus status) {
  ...
  void WriteControls(arpg_stprappo_prvBO BO,ServletStatus status) {
    WriteControls_p1(BO,status);
    PrintNotifyContent(status,getNotifyItems());
  }
  void WriteControls_p1(arpg_stprappo_prvBO BO,ServletStatus status) {
    status.themeWriter.Header_BeginHtml(576);
    WriteControls_1_h_0(BO,status);
  }
  void WriteControls_1_h_0(arpg_stprappo_prvBO BO,ServletStatus status) {
    status.out.println(
  ...
  static void PrintState(arpg_stprappo_prvBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(arpg_stprappo_prvBL BO,ServletStatus status) {
  }
  static void PrintStateWorkVars(arpg_stprappo_prvBL BO,ServletStatus status) {
  ...
  void WriteMainFormVarScript(arpg_stprappo_prvBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"arpg_stprappo_prv"),"C",0,0)+ ";");
    ...
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"arpg_stprappo_prv","");
  ...
  void WriteMainFormScript(arpg_stprappo_prvBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
  ...
  arpg_stprappo_prvBO getBO(ServletStatus status) {
    arpg_stprappo_prvBO BO = new arpg_stprappo_prvBO(status.context);
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(arpg_stprappo_prvBO BO) {
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,arpg_stprappo_prvBO BO) {
    super.NotifyEvent(p_cEvent,status,BO);
    CPLib.NotifyEvent(p_cEvent,BO,BO.m_Ctx,BO.specificEventsHandlers,BO.allEventsHandlers);
  }
  void Start(ServletStatus status,arpg_stprappo_prvBO BO) {
    BO.SetFromContext(status.m_cWv);
    BO.Calculate();
  }
  void Save(ServletStatus status,arpg_stprappo_prvBO BO) {
    boolean l_bResult;
    BO.SetFromContext(status.m_cWv);
    l_bResult = BO.Save();
    if (l_bResult) {
  ...
  void Discard(ServletStatus status,arpg_stprappo_prvBO BO) {
    status.m_bExit = true;
  }
  void CreatePortlet(ServletStatus status,arpg_stprappo_prvBO BO) {
    ...
    item.put("altInterfaceFor","arpg_stprappo_prv");
    items.put(item);
    String s;
    org.json.JSONObject ctrl = null;
    s = "{\"bg_color\":\"transparent\",\"box_type\":\"\",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"567\",\"name\":\"Box_YPYMOEKGTF\",\"page\":\"1\",\"shrinkable\":\"true\",\"spuid\":\"YPYMOEKGTF\",\"tabindex\":\"1\",\"type\":\"Box\",\"w\":\"784\",\"x\":\"8\",\"y\":\"9\",\"zone\":\"pag1_1\"}";
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"DaData\",\"page\":\"1\",\"spuid\":\"AITVTFTATA\",\"tabindex\":\"4\",\"type\":\"Textbox\",\"w\":\"66\",\"x\":\"152\",\"y\":\"72\",\"zone\":\"YPYMOEKGTF_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"AData\",\"page\":\"1\",\"spuid\":\"KGOPKMFAZV\",\"tabindex\":\"5\",\"type\":\"Textbox\",\"w\":\"66\",\"x\":\"384\",\"y\":\"72\",\"zone\":\"YPYMOEKGTF_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Dipendenza \\/ Agenzia\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"6\",\"name\":\"coddip\",\"page\":\"1\",\"spuid\":\"ZNXWTQHRAY\",\"tabindex\":\"6\",\"type\":\"Textbox\",\"w\":\"56\",\"x\":\"152\",\"y\":\"99\",\"zone\":\"YPYMOEKGTF_4\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"32\",\"href\":\"javascript:href_XURLGQZZMU()\",\"name\":\"images_print_gif\",\"page\":\"1\",\"spuid\":\"XURLGQZZMU\",\"src\":\"images\\/print.gif\",\"tabindex\":\"7\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"680\",\"y\":\"153\",\"zone\":\"YPYMOEKGTF_6\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Da_Rapporto_\",\"page\":\"1\",\"spuid\":\"PCILMATBXL_DIV\",\"tabindex\":\"8\",\"type\":\"Label\",\"value\":\"Da Rapporto:\",\"w\":\"74\",\"x\":\"27\",\"y\":\"22\",\"zone\":\"YPYMOEKGTF_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{}";
    ctrl = new org.json.JSONObject(s);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"A_Rapporto_\",\"page\":\"1\",\"spuid\":\"JGQCNSZOCQ_DIV\",\"tabindex\":\"11\",\"type\":\"Label\",\"value\":\"A Rapporto:\",\"w\":\"67\",\"x\":\"34\",\"y\":\"49\",\"zone\":\"YPYMOEKGTF_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"detope\",\"page\":\"1\",\"spuid\":\"KRWIPWBLIZ\",\"tabindex\":\"14\",\"type\":\"Checkbox\",\"w\":\"272\",\"x\":\"24\",\"y\":\"126\",\"zone\":\"YPYMOEKGTF_5\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"32\",\"href\":\"javascript:href_RPFMUWVENA()\",\"name\":\"images_exit_gif\",\"page\":\"1\",\"spuid\":\"RPFMUWVENA\",\"src\":\"images\\/exit.gif\",\"tabindex\":\"15\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"736\",\"y\":\"153\",\"zone\":\"YPYMOEKGTF_6\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Da_Data_Informazione_\",\"page\":\"1\",\"spuid\":\"NGVOZRVMWR_DIV\",\"tabindex\":\"16\",\"type\":\"Label\",\"value\":\"Da Data Informazione:\",\"w\":\"127\",\"x\":\"22\",\"y\":\"76\",\"zone\":\"YPYMOEKGTF_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"A_Data_Informazione_\",\"page\":\"1\",\"spuid\":\"WICQRPVOOM_DIV\",\"tabindex\":\"17\",\"type\":\"Label\",\"value\":\"A Data Informazione:\",\"w\":\"127\",\"x\":\"254\",\"y\":\"76\",\"zone\":\"YPYMOEKGTF_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{}";
    ctrl = new org.json.JSONObject(s);
    ...
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Inserire_anche_i_dati_di_\",\"page\":\"1\",\"spuid\":\"LMSVTJSWTT_DIV\",\"tabindex\":\"20\",\"type\":\"Label\",\"value\":\"Inserire anche i dati di:\",\"w\":\"110\",\"x\":\"368\",\"y\":\"126\",\"zone\":\"YPYMOEKGTF_5\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgtit\",\"page\":\"1\",\"spuid\":\"ULDTTBEWIQ\",\"tabindex\":\"21\",\"type\":\"Checkbox\",\"w\":\"120\",\"x\":\"488\",\"y\":\"121\",\"zone\":\"YPYMOEKGTF_5\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"21\",\"name\":\"flgdel\",\"page\":\"1\",\"spuid\":\"JVAYGFIMTX\",\"tabindex\":\"22\",\"type\":\"Checkbox\",\"w\":\"120\",\"x\":\"624\",\"y\":\"121\",\"zone\":\"YPYMOEKGTF_5\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"comment\":\"\",\"h\":\"84\",\"name\":\"Portlet_DYMVKIQWCA\",\"page\":\"1\",\"src\":\"\\/jsp\\/showmsg_portlet.jsp?ForcedPortletUID=___com__zucchetti__sitepainter__altinterface__m_cEntityUid____DYMVKIQWCA\",\"type\":\"Portlet\",\"w\":\"768\",\"x\":\"16\",\"y\":\"189\",\"zone\":\"YPYMOEKGTF_7\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Dipendenza___Agenzia_\",\"page\":\"1\",\"spuid\":\"YCCWJHXBSK_DIV\",\"tabindex\":\"24\",\"type\":\"Label\",\"value\":\"Dipendenza \\/ Agenzia:\",\"w\":\"138\",\"x\":\"14\",\"y\":\"103\",\"zone\":\"YPYMOEKGTF_4\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"left\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"18\",\"href\":\" \",\"name\":\"w_desdip\",\"page\":\"1\",\"spuid\":\"UKVSKINWXW_DIV\",\"tabindex\":\"26\",\"type\":\"Label\",\"value\":\"w_desdip\",\"w\":\"472\",\"x\":\"232\",\"y\":\"101\",\"zone\":\"YPYMOEKGTF_4\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"left\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"288\",\"href\":\" \",\"name\":\"__iframe_width__750__height__400__id__elaborazione___name__elaborazione__frameborder__1___border__1__align__TOP__marginwidth__1__marginheight__1____iframe__\",\"page\":\"1\",\"spuid\":\"TYIWXFLLFY_DIV\",\"tabindex\":\"27\",\"type\":\"Label\",\"value\":\"\\\"<iframe width="+"'"+"750"+"'"+" height="+"'"+"400"+"'"+" id="+"'"+"elaborazione"+"'"+"  name="+"'"+"elaborazione"+"'"+" frameborder="+"'"+"1"+"'"+"  border="+"'"+"1"+"'"+" align="+"'"+"TOP"+"'"+" marginwidth="+"'"+"1"+"'"+" marginheight="+"'"+"1"+"'"+"><\\/iframe>\\\"\",\"w\":\"768\",\"x\":\"16\",\"y\":\"279\",\"zone\":\"YPYMOEKGTF_8\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    SPLib.SetMimeType(status.response,"application/json");
    items.write(status.out);
  }
  void Next(ServletStatus status,arpg_stprappo_prvBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow+entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void Previous(ServletStatus status,arpg_stprappo_prvBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow-entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void WriteFormPage(arpg_stprappo_prvBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='arpg_stprappo_prv?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+m_cEntityUid+"/arpg_stprappo_prv_proc.js'>" +
     "</script>" +
    "");
    IncludeJS(status);
  ...
  void RaiseLoadedEntity(arpg_stprappo_prvBO BO,ServletStatus status) {
    RaiseEventLoadedEntity(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cClientMode,"C",0,0)+"})","C",0,0));
  }
  void RaiseSavedEntity(arpg_stprappo_prvBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(arpg_stprappo_prvBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(arpg_stprappo_prvBO BO,ServletStatus status) {
  ...
  void WriteExitPage(arpg_stprappo_prvBO BO,ServletStatus status,Forward f) {
    WriteExitPage(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cMode,"C",0,0)+"})","C",0,0), f);
  }
  void WriteExitPage(arpg_stprappo_prvBO BO,ServletStatus status) {
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      arrt_stprappo_prv.GetCallableNames(callable);
    } else {
  ...
  public String GetCheckVars(ServletStatus status,arpg_stprappo_prvBO BO) {
    return "NO_VALUE";
  }
  public boolean CheckVars(ServletStatus status,arpg_stprappo_prvBO BO) {
    boolean result = true;
    return result;
  }
}
