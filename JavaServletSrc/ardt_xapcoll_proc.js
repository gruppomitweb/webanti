...
m_oFather.i_last_focused_item='child_ardt_xapcoll';
...
function Help() {
windowOpenForeground('../doc/ardt_xapcoll_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'xapcoll'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_xapcoll',m_cSelectedPage);
...
ExtendedMenu({"configName":WtA('','C'),"fldValues":[{"expression":function() { return WtA(w_RAPPORTO,'C'); },"field":"RAPPORTO","type":"C"},{"expression":function() { return WtA(w_DESCRAP,'C'); },"field":"DESCRAP","type":"C"}],"itemRepeated":true,"keyValues":[],"linkedUsings":[],"prgInitFields":[],"tableName":WtA('knarapbo','C'),"uid":"ADJOKPLCJT"});
}
