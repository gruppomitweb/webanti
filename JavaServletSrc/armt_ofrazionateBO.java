...
// * --- Fine Area Manuale
public class armt_ofrazionateBO extends armt_ofrazionateBL {
  class SqlLoader {
    ...
    public boolean m_bLink_1_61 = false;
    public boolean m_bLink_1_62 = false;
    public boolean m_bLink_1_64 = false;
    public boolean m_bLink_1_67 = false;
    public boolean m_bLink_1_68 = false;
    public boolean m_bLink_4_9 = false;
    public boolean m_bLink_5_10 = false;
    ...
    public void AddJoinedLink_5_10(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_5_10.CONNES AS CONNES510";
        m_cSelect = m_cSelect+" ,link_5_10.RAGSOC AS RAGSOC510";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_5_10","CONNESDOC","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_5_10","CONNESDOC","CONNES",true);
    ...
    public void AddJoinedLink_1_27(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_27.CODINTER AS CODINTER127";
        m_cSelect = m_cSelect+" ,link_1_27.DATANASC AS DATANASC127";
        m_cSelect = m_cSelect+" ,link_1_27.CODCAB AS CODCAB127";
        m_cSelect = m_cSelect+" ,link_1_27.PROVINCIA AS PROVINCIA127";
        m_cSelect = m_cSelect+" ,link_1_27.DESCCIT AS DESCCIT127";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_27","CODINTER","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_27","CODINTER","CODINTER",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_49(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_49.CODVOC AS CODVOC149";
        m_cSelect = m_cSelect+" ,link_1_49.DESCRIZ AS DESCRIZ149";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_49","CODVOC","CODVOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_49","CODVOC","CODVOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_52(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_52.CODVAL AS CODVAL152";
        m_cSelect = m_cSelect+" ,link_1_52.DESCRI AS DESCRI152";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_52","VALUTA","CODVAL");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_52","VALUTA","CODVAL",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_61(String rightTable,String rightServer) {
      // questo link aggiunge 3 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_61.RAPPORTO AS RAPPORTO161";
        m_cSelect = m_cSelect+" ,link_1_61.DESCRAP AS DESCRAP161";
        m_cSelect = m_cSelect+" ,link_1_61.TIPORAP AS TIPORAP161";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_61","RAPPORTO","RAPPORTO");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_61","RAPPORTO","RAPPORTO",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_62(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_62.CONNES AS CONNES162";
        m_cSelect = m_cSelect+" ,link_1_62.RAGSOC AS RAGSOC162";
        m_cSelect = m_cSelect+" ,link_1_62.CODFISC AS CODFISC162";
        m_cSelect = m_cSelect+" ,link_1_62.DATAVALI AS DATAVALI162";
        m_cSelect = m_cSelect+" ,link_1_62.DATARILASC AS DATARILASC162";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_62","CONNESCLI","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_62","CONNESCLI","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_64(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_64","CONNESOPER","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_64","CONNESOPER","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_67(String rightTable,String rightServer) {
      // questo link aggiunge 3 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_67.CONNES AS CONNES167";
        m_cSelect = m_cSelect+" ,link_1_67.RAGSOC AS RAGSOC167";
        m_cSelect = m_cSelect+" ,link_1_67.CONTO AS CONTO167";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_67","CONNESBEN","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_67","CONNESBEN","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_68(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_68.CONNES AS CONNES168";
        m_cSelect = m_cSelect+" ,link_1_68.RAGSOC AS RAGSOC168";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_68","CONNALTRO","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_68","CONNALTRO","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_4_9(String rightTable,String rightServer) {
      // questo link aggiunge 2 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_4_9.CODICE AS CODICE409";
        m_cSelect = m_cSelect+" ,link_4_9.DESCRI AS DESCRI409";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_4_9","OPERAG","CODICE");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_4_9","OPERAG","CODICE",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_ofrazionateBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_ofrazionate");
    }
  ...
  public boolean CanSave() {
    ...
    if (l_bResult) {
      l_bResult = CanSaveChild(ardt_clientifrz,m_cWv_ardt_clientifrz,"m_cWv_ardt_clientifrz");
      if (l_bResult) {
        l_bResult = CanSaveChild(ardt_mlientifrz,m_cWv_ardt_mlientifrz,"m_cWv_ardt_mlientifrz");
        if (l_bResult) {
          l_bResult = CanSaveChild(ardt_sogopefraz,m_cWv_ardt_sogopefraz,"m_cWv_ardt_sogopefraz");
          if (l_bResult) {
            l_bResult = CanSaveChild(ardt_mogopefbo,m_cWv_ardt_mogopefbo,"m_cWv_ardt_mogopefbo");
            if (l_bResult) {
              l_bResult = CanSaveChild(ardt_meneficfrz,m_cWv_ardt_meneficfrz,"m_cWv_ardt_meneficfrz");
              if (l_bResult) {
                l_bResult = CanSaveChild(ardt_beneficfrz,m_cWv_ardt_beneficfrz,"m_cWv_ardt_beneficfrz");
                if (l_bResult) {
                  l_bResult = CanSaveChild(ardt_terzistifrz,m_cWv_ardt_terzistifrz,"m_cWv_ardt_terzistifrz");
                  if (l_bResult) {
                    l_bResult = CanSaveChild(ardt_merzistifrz,m_cWv_ardt_merzistifrz,"m_cWv_ardt_merzistifrz");
                    if (l_bResult) {
                      l_bResult = CanSaveChild(ardt_docfrabo,m_cWv_ardt_docfrabo,"m_cWv_ardt_docfrabo");
                      if (l_bResult) {
                        l_bResult = CanSaveChild(armt_fraziobo_agg,m_cWv_armt_fraziobo_agg,"m_cWv_armt_fraziobo_agg");
                        if (l_bResult) {
                          l_bResult = CanSaveChild(ardt_frz_contante,m_cWv_ardt_frz_contante,"m_cWv_ardt_frz_contante");
                          if (l_bResult) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_clientifrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_clientifrz)) {
          ...
          if (ardt_clientifrz.IsUpdated()) {
            ...
            if ( ! (ardt_clientifrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_mlientifrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_mlientifrz)) {
          ...
          if (ardt_mlientifrz.IsUpdated()) {
            ...
            if ( ! (ardt_mlientifrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_sogopefraz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_sogopefraz)) {
          ...
          if (ardt_sogopefraz.IsUpdated()) {
            ...
            if ( ! (ardt_sogopefraz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_mogopefbo.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_mogopefbo)) {
          ...
          if (ardt_mogopefbo.IsUpdated()) {
            ...
            if ( ! (ardt_mogopefbo.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_meneficfrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_meneficfrz)) {
          ...
          if (ardt_meneficfrz.IsUpdated()) {
            ...
            if ( ! (ardt_meneficfrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_beneficfrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_beneficfrz)) {
          ...
          if (ardt_beneficfrz.IsUpdated()) {
            ...
            if ( ! (ardt_beneficfrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_terzistifrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_terzistifrz)) {
          ...
          if (ardt_terzistifrz.IsUpdated()) {
            ...
            if ( ! (ardt_terzistifrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_merzistifrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_merzistifrz)) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (armt_fraziobo_agg.IsUpdated()) && CPLib.IsUpdated(m_cWv_armt_fraziobo_agg)) {
          ...
          if (armt_fraziobo_agg.IsUpdated()) {
            ...
            if ( ! (armt_fraziobo_agg.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_frz_contante.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_frz_contante)) {
          ...
          if (ardt_frz_contante.IsUpdated()) {
            ...
            if ( ! (ardt_frz_contante.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
  ...
  public boolean Load(String p_IDBASE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_fraziobo,m_cPhName_fraziobo,m_cVirtName_fraziobo,m_cVirtName_fraziobo+".IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDBASE,"C",10,0),m_cServer_fraziobo,p_IDBASE),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_5_10(m_cPhName_kersonbo,m_cServer_kersonbo);
    l_oSqlLoader.AddJoinedLink_1_27(m_cPhName_intermbo,m_cServer_intermbo);
    l_oSqlLoader.AddJoinedLink_1_30(m_cPhName_anadip,m_cServer_anadip);
    l_oSqlLoader.AddJoinedLink_1_49(m_cPhName_tbcausin,m_cServer_tbcausin);
    l_oSqlLoader.AddJoinedLink_1_52(m_cPhName_tbvalute,m_cServer_tbvalute);
    l_oSqlLoader.AddJoinedLink_1_61(m_cPhName_anarapbo,m_cServer_anarapbo);
    l_oSqlLoader.AddJoinedLink_1_62(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_64(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_67(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_68(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_4_9(m_cPhName_tbtipope,m_cServer_tbtipope);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_27) {
          w_datpaseuro = l_rsLoad.GetDate("DATANASC127");
          w_CABINT = l_rsLoad.GetString("CODCAB127");
          w_PROVINT = l_rsLoad.GetString("PROVINCIA127");
          w_CITINT = l_rsLoad.GetString("DESCCIT127");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_49) {
          w_xdesccausin = l_rsLoad.GetString("DESCRIZ149");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_52) {
          w_descdiv = l_rsLoad.GetString("DESCRI152");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_61) {
          w_xdescrap = l_rsLoad.GetString("DESCRAP161");
          w_FLAGRAP = l_rsLoad.GetString("TIPORAP161");
        } else {
          Link_RZIQZFKPUE("Load");
        }
        w_CONNESCLI = l_rsLoad.GetString("CONNESCLI");
        if (l_oSqlLoader.m_bLink_1_62) {
          w_xragsocper = l_rsLoad.GetString("RAGSOC162");
          w_xcodfisc = l_rsLoad.GetString("CODFISC162");
          w_DATAVALI = l_rsLoad.GetDate("DATAVALI162");
          w_DATARILASC = l_rsLoad.GetDate("DATARILASC162");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_64) {
          w_xragsocct = l_rsLoad.GetString("RAGSOC164");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_67) {
          w_xragsocben = l_rsLoad.GetString("RAGSOC167");
          w_C_RAPPORTO = l_rsLoad.GetString("CONTO167");
        } else {
          Link_ULVCBLFVEU("Load");
        }
        w_CONNALTRO = l_rsLoad.GetString("CONNALTRO");
        if (l_oSqlLoader.m_bLink_1_68) {
          w_xragsocalt = l_rsLoad.GetString("RAGSOC168");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_4_9) {
          w_xdescopeage = l_rsLoad.GetString("DESCRI409");
        } else {
        ...
        w_CONNESDOC = l_rsLoad.GetString("CONNESDOC");
        if (l_oSqlLoader.m_bLink_5_10) {
          w_xRAGSOCDOC = l_rsLoad.GetString("RAGSOC510");
        } else {
        ...
        ardt_clientifrz.m_lCtxLoaded = false;
        m_cWv_ardt_mlientifrz = "";
        ardt_mlientifrz.m_lCtxLoaded = false;
        m_cWv_ardt_sogopefraz = "";
        ardt_sogopefraz.m_lCtxLoaded = false;
        m_cWv_ardt_mogopefbo = "";
        ardt_mogopefbo.m_lCtxLoaded = false;
        m_cWv_ardt_meneficfrz = "";
        ardt_meneficfrz.m_lCtxLoaded = false;
        m_cWv_ardt_beneficfrz = "";
        ardt_beneficfrz.m_lCtxLoaded = false;
        m_cWv_ardt_terzistifrz = "";
        ardt_terzistifrz.m_lCtxLoaded = false;
        m_cWv_ardt_merzistifrz = "";
        ardt_merzistifrz.m_lCtxLoaded = false;
        m_cWv_ardt_docfrabo = "";
        ardt_docfrabo.m_lCtxLoaded = false;
        m_cWv_armt_fraziobo_agg = "";
        armt_fraziobo_agg.m_lCtxLoaded = false;
        m_cWv_ardt_frz_contante = "";
        ardt_frz_contante.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"fraziobo")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_fraziobo);
      l_cSql = "insert into "+m_oWrInfo_fraziobo.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_fraziobo.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"fraziobo")) {
      ...
      l_cSql = l_cSql+m_oWrInfo_fraziobo.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"fraziobo")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_fraziobo,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_fraziobo);
      l_cSql = "Update "+m_oWrInfo_fraziobo.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_fraziobo,w_IDBASE);
      l_cSql = l_cSql+m_oWrInfo_fraziobo.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"fraziobo")) {
  ...
  public boolean Delete(String p_IDBASE) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio Intestatari Fraz. 
          ardt_clientifrz.w_IDFILEBO = w_IDBASE;
          ardt_clientifrz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio Intestatari Fraz. (Modifiche)
          ardt_mlientifrz.w_IDFILEBO = w_IDBASE;
          ardt_mlientifrz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio + Soggetti Oper. Conto Terzi
          ardt_sogopefraz.w_IDFILEBO = w_IDBASE;
          ardt_sogopefraz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio + Soggetti Oper. Conto Terzi
          ardt_mogopefbo.w_IDFILEBO = w_IDBASE;
          ardt_mogopefbo.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio Beneficiari Fraz. (Modifiche)
          ardt_meneficfrz.w_IDFILEBO = w_IDBASE;
          ardt_meneficfrz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio Beneficiari Frazionate
          ardt_beneficfrz.w_IDFILEBO = w_IDBASE;
          ardt_beneficfrz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio Terzisti Frazionate
          ardt_terzistifrz.w_IDFILEBO = w_IDBASE;
          ardt_terzistifrz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio Copy of Terzisti Oper. (Modifiche)
          ardt_merzistifrz.w_IDFILEBO = w_IDBASE;
          ardt_merzistifrz.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          armt_fraziobo_agg.w_IDBASE = w_IDBASE;
          armt_fraziobo_agg.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_frz_contante.w_IDOPE = w_IDBASE;
          ardt_frz_contante.Delete();
        }
        CPLib.DeleteMNTs(m_Sql,m_MNTs,this);
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_fraziobo.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_fraziobo,w_IDBASE);
          l_cSql = l_cSql+m_oWrInfo_fraziobo.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"fraziobo")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_fraziobo,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"PFRAZIO1","i_codazi,w_IDBASE",m_cServer_fraziobo,m_Ctx.GetCompany());
    ...
    m_Sql.NextTableProg(this,"PFRAZIO2","i_codazi,w_NUMPROG",m_cServer_fraziobo,m_Ctx.GetCompany());
    ...
    op_NUMPROG = w_NUMPROG;
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    m_Sql.NextTableProg(this,"PRGIMPFRZ","i_codazi,w_PRGIMPFRZ",m_cServer_fraziobo,m_Ctx.GetCompany());
    op_PRGIMPFRZ = w_PRGIMPFRZ;
  }
  public static CPLib.SPLinkProperties GetLinkProperties(String p_cID) {
    CPLib.SPLinkProperties result = CPLib.GetSPLinkerProperties();
    if (CPLib.eq(p_cID,"NNOUMHTLXJ")) {
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_calcflaglire,arfn_chkdatdoc,arfn_chkdatreg,arfn_chksogg,arfn_chktotalelire_cont,arfn_chktotalelire_fraz,arfn_read_tipoleg,arrt_copiaoperazionef,arrt_crea_idereg,arrt_deloperazionef,arrt_imp_frischio,arrt_li_fraziobo,arrt_updel_opextrbo,arrt_val_benefic,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_calcflaglire,arfn_chkdatdoc,arfn_chkdatreg,arfn_chksogg,arfn_chktotalelire_cont,arfn_chktotalelire_fraz,arfn_read_tipoleg,arrt_copiaoperazionef,arrt_crea_idereg,arrt_deloperazionef,arrt_imp_frischio,arrt_li_fraziobo,arrt_updel_opextrbo,arrt_val_benefic,arrt_writelog,";
}
