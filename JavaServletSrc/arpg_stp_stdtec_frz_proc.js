...
l_oWv.setValue('pTipo',AsAppletValue('F'));
l_oWv.setValue('pAUI',AsAppletValue('D'));
l_oWv.setValue('m_cParameterSequence',AsAppletValue('pTipo,pAUI'));
_modifyandopen('arrt_stp_stdtec'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','toolbar=0,menubar=0,directories=0,resizable=1,scrollbars=yes,height=500,width=700',null)
}
...
function Help() {
windowOpenForeground('../doc/arpg_stp_stdtec_frz_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stp_stdtec_frz',m_cSelectedPage);
...
_SignErr('QNMKJLGOKW');
m_cLastWorkVarErrorMsg='11666950191';
l_bResult=false;
w_flgrae=HtW('','C');
}
...
_FillChildren.n=[];
FillWv.n=["daCodDip","aCodDip","DaDatOpe","ADatOpe","daCodCli","aCodCli","RAGSOC1","RAGSOC2","c_dadata","c_adata","DESCRIZ1","DESCRIZ2","flgrae"];
...
if (Eq(w_flgrae,'A') && Ne(opener.w_flgrae,null)) {
TransferBetweenWindows(opener,'w_flgrae',null,'Set_flgrae');
}
}
}
m_bCalculating=true;
...
_Obli('flgrae',0,'QNMKJLGOKW',false,"11666950191")
