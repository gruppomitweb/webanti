...
public class ardt_xerzistifrzBL extends ardt_xerzistifrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xerzistifrz";
  ...
  public CPPhTableWrInfo m_oWrInfo_xerzistifrz;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xerzistifrz;
  ...
  public static String[] m_EntityTables = {"xerzistifrz"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_xerzistifrz",true,true)+"}"+FoundlingChildrenList("ardt_xerzistifrz",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'CAP':CAP,'PROVINCIA':PROVINCIA"+FoundlingChildrenList("ardt_xerzistifrz",true,true)+"}"+FoundlingChildrenList("ardt_xerzistifrz",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_xerzistifrz",false,true)+"]"+FoundlingChildrenList("ardt_xerzistifrz",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_xerzistifrz"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_xerzistifrzBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xerzistifrz = p_ContextObject.GetPhName("xerzistifrz",p_ContextObject.GetCompany(),false);
    m_cServer_xerzistifrz = p_ContextObject.GetServer("xerzistifrz");
    m_oWrInfo_xerzistifrz = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xerzistifrz",p_ContextObject.GetCompany());
    m_cVirtName_xerzistifrz = CPSql.ManipulateTablePhName("xerzistifrz",m_cServer_xerzistifrz);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xerzistifrz",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xerzistifrz","xerzistifrz",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xerzistifrz",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xerzistifrz",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xerzistifrz",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xerzistifrz",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xerzistifrz"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xerzistifrz\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xerzistifrz"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xerzistifrz"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
