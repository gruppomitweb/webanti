...
// * --- arrt_sd_scaricodati_globale
import java.util.*;
// * --- Fine Area Manuale
public class arrt_sd_scaricodati_globaleR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_sd_scaricodati_globaleR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_sd_scaricodati_globale",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_sd_scaricodati_globale";
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      Page_2();
      /* Exec "Crea file zip" Page 3:Page_3 */
      Page_3();
  ...
  void Page_2() throws Exception {
    CPResultSet Cursor_qbe_scadat_ape_3_max_min_glob=null;
    ...
    try {
      ...
      /* _estero := 'N' */
      _estero = "N";
      // * --- Select from qbe_scadat_ape_3_max_min_glob
      if (Cursor_qbe_scadat_ape_3_max_min_glob!=null)
        Cursor_qbe_scadat_ape_3_max_min_glob.Close();
      Cursor_qbe_scadat_ape_3_max_min_glob = new VQRHolder("qbe_scadat_ape_3_max_min_glob",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_scadat_ape_3_max_min_glob.Eof())) {
        /* _max := qbe_scadat_ape_3_max_min_glob->MAXPROGAER */
        _max = CPLib.Round(Cursor_qbe_scadat_ape_3_max_min_glob.GetDouble("MAXPROGAER"),0);
        /* _min := qbe_scadat_ape_3_max_min_glob->MINPROGAER */
        _min = CPLib.Round(Cursor_qbe_scadat_ape_3_max_min_glob.GetDouble("MINPROGAER"),0);
        /* _tot := qbe_scadat_ape_3_max_min_glob->TOTPROGAER */
        _tot = CPLib.Round(Cursor_qbe_scadat_ape_3_max_min_glob.GetDouble("TOTPROGAER"),0);
        Cursor_qbe_scadat_ape_3_max_min_glob.Next();
      }
      m_cConnectivityError = Cursor_qbe_scadat_ape_3_max_min_glob.ErrorMessage();
      Cursor_qbe_scadat_ape_3_max_min_glob.Close();
      // * --- End Select
      ...
      while (CPLib.le(_contacilci,_cicli)) {
        ...
        if (CPLib.ge(_top,_min)) {
          ...
          while ( ! (Cursor_qbe_scadat_ape_3.Eof())) {
            /* gMsgImp := 'Elaborazione soggetti con CF italiano. Sto elaborando il rapporto N° ' + LRTrim(Str(_nocodrec+_sicodrec,10,0)) // Messaggio allineamento 1 */
            gMsgImp = "Elaborazione soggetti con CF italiano. Sto elaborando il rapporto N° "+CPLib.LRTrim(CPLib.Str(_nocodrec+_sicodrec,10,0));
            m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
            ...
            if ( ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("COGNOME"))) &&  ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("NOME"))) &&  ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("SESSO")))) {
              ...
              /* _cdata3 := iif(Empty(qbe_scadat_ape_3->CDATA),'',Right(DateToChar(qbe_scadat_ape_3->CDATA),2)+Substr(DateToChar(qbe_scadat_ape_3->CDATA),5,2)+Left(DateToChar(qbe_scadat_ape_3->CDATA),4)) */
              _cdata3 = (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetDate("CDATA"))?"":CPLib.Right(CPLib.DateToChar(Cursor_qbe_scadat_ape_3.GetDate("CDATA")),2)+CPLib.Substr(CPLib.DateToChar(Cursor_qbe_scadat_ape_3.GetDate("CDATA")),5,2)+CPLib.Left(CPLib.DateToChar(Cursor_qbe_scadat_ape_3.GetDate("CDATA")),4));
              ...
              m_cSql = m_cSql+GetFieldsName_0622C928(m_Ctx);
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_apecod")+" (";
              m_cSql = m_cSql+GetFieldsName_07058B88(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL("1","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_scadat_ape_3.GetString("TIPOAG"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_scadat_ape_3.GetString("COINT"),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.Mod(_top,75000),0) || CPLib.gt(_contacilci,_cicli)) {
          ...
          if (CPLib.gt(_sicodrec,0)) {
            ...
            while ( ! (Cursor_tmp_apecod.Eof())) {
              ...
              m_cSql = m_cSql+GetFieldsName_07667A70(m_Ctx);
              m_cSql = m_cSql+") values (";
              ...
              /* If not(Empty(tmp_apecod->DATACHIU)) and CharToDate(tmp_apecod->DATACHIU) <= w_a_data */
              if ( ! (CPLib.Empty(Cursor_tmp_apecod.GetString("DATACHIU"))) && CPLib.le(CPLib.CharToDate(Cursor_tmp_apecod.GetString("DATACHIU")),w_a_data)) {
              ...
              if (CPLib.eqr(_crow,15000)) {
                ...
                m_cSql = m_cSql+GetFieldsName_0643B8F0(m_Ctx);
                m_cSql = m_cSql+") values (";
            ...
            if (CPLib.lt(_crow,15000)) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aefiles_glob")+" (";
              m_cSql = m_cSql+GetFieldsName_07AA90C0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cProg,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Date(),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_nomefile,"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.gt(_fileita,0)) {
        ...
        m_cSql = m_cSql+GetFieldsName_07793D28(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(cProg,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Date(),"?",0,0)+", ";
      ...
      while (CPLib.le(_contacilci,_cicli)) {
        ...
        if (CPLib.ge(_top,_min)) {
          ...
          Cursor_qbe_scadat_ape_3 = new VQRHolder("qbe_scadat_ape_3",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_scadat_ape_3.Eof())) {
            /* gMsgImp := 'Elaborazione soggetti senza CF italiano. Sto elaborando il rapporto N° ' + LRTrim(Str(_nocodrec+_sicodrec,10,0)) // Messaggio allineamento 1 */
            gMsgImp = "Elaborazione soggetti senza CF italiano. Sto elaborando il rapporto N° "+CPLib.LRTrim(CPLib.Str(_nocodrec+_sicodrec,10,0));
            m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
            /* _descit := '' */
            _descit = "";
            /* If not(Empty(qbe_scadat_ape_3->COGNOME)) and not(Empty(qbe_scadat_ape_3->NOME)) and not(Empty(qbe_scadat_ape_3->SESSO)) */
            if ( ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("COGNOME"))) &&  ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("NOME"))) &&  ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("SESSO")))) {
              ...
              m_cSql = m_cSql+GetFieldsName_07991520(m_Ctx);
              m_cSql = m_cSql+") values (";
              ...
              if ( ! (CPLib.Empty(Cursor_qbe_scadat_ape_3.GetString("PAESE")))) {
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on tbstati into routine arrt_sd_scaricodati_globale returns two or more records. This item should return only a record.");
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_apenocod")+" (";
              m_cSql = m_cSql+GetFieldsName_0644FBD0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL("4","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_scadat_ape_3.GetString("TIPOAG"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_scadat_ape_3.GetString("COINT"),"?",0,0,m_cServer)+", ";
        ...
        if (CPLib.eqr(CPLib.Mod(_top,75000),0) || CPLib.gt(_contacilci,_cicli)) {
          ...
          if (CPLib.gt(_nocodrec,0)) {
            ...
            while ( ! (Cursor_tmp_apenocod.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_stpfileage")+" (";
              m_cSql = m_cSql+GetFieldsName_05FA1860(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_nomefile,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("4","?",0,0,m_cServer)+", ";
              ...
              /* If not(Empty(tmp_apenocod->DATACHIU)) and CharToDate(tmp_apenocod->DATACHIU) <= w_a_data */
              if ( ! (CPLib.Empty(Cursor_tmp_apenocod.GetString("DATACHIU"))) && CPLib.le(CPLib.CharToDate(Cursor_tmp_apenocod.GetString("DATACHIU")),w_a_data)) {
              ...
              if (CPLib.eqr(_crow,15000)) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aefiles_glob")+" (";
                m_cSql = m_cSql+GetFieldsName_076F27F0(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cProg,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Date(),"?",0,0)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(_nomefile,"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.lt(_crow,15000)) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aefiles_glob")+" (";
              m_cSql = m_cSql+GetFieldsName_07245DF0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cProg,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Date(),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_nomefile,"?",0,0,m_cServer)+", ";
      ...
      if (CPLib.gt(_fileest,0)) {
        ...
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aefiles")+" (";
        m_cSql = m_cSql+GetFieldsName_06340B88(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(cProg,"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Date(),"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(_czip,"?",0,0,m_cServer)+", ";
  ...
  public static arrt_sd_scaricodati_globaleR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_sd_scaricodati_globaleR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_scadat_ape_3_max_min_glob,qbe_scadat_ape_3,qbe_scadat_ape_3_max_min_glob,qbe_scadat_ape_3,
  public static final String m_cVQRList = ",qbe_scadat_ape_3_max_min_glob,qbe_scadat_ape_3,qbe_scadat_ape_3_max_min_glob,qbe_scadat_ape_3,";
  // ENTITY_BATCHES: ,arfn_agechar,
  public static final String i_InvokedRoutines = ",arfn_agechar,";
  public static String[] m_cRunParameterNames={};
  protected static String GetFieldsName_0622C928(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_07058B88(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"TIPOREC,";
    p_cSql = p_cSql+"TIPORAP,";
    p_cSql = p_cSql+"COINT,";
  ...
  protected static String GetFieldsName_07667A70(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0643B8F0(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_07AA90C0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"idfile,";
    p_cSql = p_cSql+"datafile,";
    p_cSql = p_cSql+"nomefile,";
  ...
  protected static String GetFieldsName_07793D28(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"idfile,";
    p_cSql = p_cSql+"datafile,";
    p_cSql = p_cSql+"nomefile,";
  ...
  protected static String GetFieldsName_07991520(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"TIPOREC,";
    p_cSql = p_cSql+"COGNOME,";
    p_cSql = p_cSql+"NOME,";
  ...
  protected static String GetFieldsName_0644FBD0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"TIPOREC,";
    p_cSql = p_cSql+"TIPORAP,";
    p_cSql = p_cSql+"COINT,";
  ...
  protected static String GetFieldsName_05FA1860(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"nomefile,";
    p_cSql = p_cSql+"tipofile,";
    p_cSql = p_cSql+"rapporto,";
  ...
  protected static String GetFieldsName_076F27F0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"idfile,";
    p_cSql = p_cSql+"datafile,";
    p_cSql = p_cSql+"nomefile,";
  ...
  protected static String GetFieldsName_07245DF0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"idfile,";
    p_cSql = p_cSql+"datafile,";
    p_cSql = p_cSql+"nomefile,";
  ...
  protected static String GetFieldsName_06340B88(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"idfile,";
    p_cSql = p_cSql+"datafile,";
    p_cSql = p_cSql+"nomefile,";
