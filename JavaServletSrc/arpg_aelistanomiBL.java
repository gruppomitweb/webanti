...
public class arpg_aelistanomiBL extends arpg_aelistanomiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_aelistanomi";
  ...
  public static final String i_StateStructure = "{'iniz':iniz,'dadata':dadata,'a_data':a_data}";
  public static final String i_CompleteStateStructure = "{'iniz':iniz,'dadata':dadata,'a_data':a_data,'datpris':datpris,'datseci':datseci,'datsecf':datsecf,'datprif':datprif}";
  public static final String i_ItemSequence = "iniz,dadata,a_data";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"iniz","","C","1","0","variabile","nokey","false","false"},new String[]{"dadata","","D","8","0","variabile","nokey","false","false"},new String[]{"a_data","","D","8","0","variabile","nokey","false","false"}});
  ...
  public arpg_aelistanomiBL (CPContext p_ContextObject) {
  ...
  public void Blank() {
    ...
    w_datpris = CPLib.CharToDate("20061231");
    w_datseci = CPLib.NullDate();
    w_datseci = CPLib.CharToDate("20070101");
    w_datsecf = CPLib.NullDate();
    w_datsecf = CPLib.CharToDate("20070430");
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_aelistanomi","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
