...
public class aprg_new_opextrbo extends SPDialogServlet implements SPInvokable {
  public static String m_cEntityUid = "!*TPMPMLAMJF*!";
  ...
  public String getEntityTitle() {
    return "Nuova Operazione ExtraConto";
  }
  public SPEntityGlobals getEntityGlobals() {
    // Costanti globali dell' entita'
    SPEntityGlobals l_eg = new SPEntityGlobals();
    l_eg.name = "aprg_new_opextrbo";
    ...
    l_eg.items = new SPItem[]{
                   new SPItem("annorif","C",4,0, "edit","Anno Riferimento"),
  ...
  public String GetLayerGroupHeader(String p_cGroupName,String p_cLayerName,String p_cLayerId,aprg_new_opextrboBO BO) {
  ...
  public String[][] JSTranslations(CPContext p_Context) {
    ...
    {"1164410876",p_Context.Translate("Esiste già un'operazione per l'anno selezionato !")},
    {"1347686977",p_Context.Translate("Nuova Operazione ExtraConto")},
  ...
  void WriteStyles(aprg_new_opextrboBO BO,ServletStatus status) {
    if ( ! ( ! (CPLib.Empty(status.m_cAltInterface)))) {
      status.out.println(
       "<link type='text/css' rel='stylesheet' href='SPPrxy/"+m_cEntityUid+"/aprg_new_opextrbo.css'>" +
      "");
    }
  ...
  void WriteMainForm(aprg_new_opextrboBO BO,ServletStatus status) {
    status.out.println(
  ...
  void WriteControls(aprg_new_opextrboBO BO,ServletStatus status) {
    WriteControls_p1(BO,status);
    PrintNotifyContent(status,getNotifyItems());
  }
  void WriteControls_p1(aprg_new_opextrboBO BO,ServletStatus status) {
    status.themeWriter.Header_BeginHtml(171);
    WriteControls_1_h_0(BO,status);
  }
  void WriteControls_1_h_0(aprg_new_opextrboBO BO,ServletStatus status) {
    status.out.println(
    ...
    status.out.println(
     "<input name='annorif' id='MEXFGSWICI' type='text' class='Field' value="+SPLib.ToHTMLValue(BO.w_annorif,"C",4,0,"", status.m_oRegSettings)+" tabindex='"+(CPLib.eq(status.m_cClientMode,"query") || CPLib.eq(status.m_cClientMode,"view")?"-1":""+status.m_nTabIndex+"")+"' curTabIndex='"+status.m_nTabIndex+"' maxlength='4' size='4' fieldtype='C'>" +
    "");
    status.m_nTabIndex = status.m_nTabIndex+(1);
    status.out.println(
    ...
    status.out.println(
     ...
     "<label id='HWULSRGDNM'>" +
     ""+SPLib.ToHTMLRepresentation(status.context.Translate("NUOVA OPERAZIONE EXTRACONTO"))+"" +
     "</label>" +
     "</span>" +
    "");
    status.out.println(
  ...
  static void PrintState(aprg_new_opextrboBL BO,ServletStatus status) {
    PrintStateChildren(BO,status);
    PrintStateWorkVars(BO,status);
  }
  static void PrintStateChildren(aprg_new_opextrboBL BO,ServletStatus status) {
  }
  static void PrintStateWorkVars(aprg_new_opextrboBL BO,ServletStatus status) {
  ...
  void WriteMainFormVarScript(aprg_new_opextrboBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    status.out.println("var m_cSelectedPage = " + SPLib.ToJSValue(SPLib.GetSelectedPage(status.m_cSelectedPage,"aprg_new_opextrbo"),"C",0,0)+ ";");
    ...
    VRTStateImpl l_vrtState = VRTHolder.GetState(status.context,"aprg_new_opextrbo","");
  ...
  void WriteMainFormScript(aprg_new_opextrboBO BO,ServletStatus status) {
    status.out.println(
     "<script>" +
    "");
    ...
    status.out.println("// * --- aprg_new_opextrbo");
    ...
    status.out.println("  SetLocationHref(null,'arrt_new_opextrbo'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')");
  ...
  aprg_new_opextrboBO getBO(ServletStatus status) {
    aprg_new_opextrboBO BO = new aprg_new_opextrboBO(status.context);
    LoadExtensions(BO);
    return BO;
  }
  void LoadExtensions(aprg_new_opextrboBO BO) {
  }
  public void NotifyEvent(String p_cEvent,ServletStatus status,aprg_new_opextrboBO BO) {
    super.NotifyEvent(p_cEvent,status,BO);
    CPLib.NotifyEvent(p_cEvent,BO,BO.m_Ctx,BO.specificEventsHandlers,BO.allEventsHandlers);
  }
  void Start(ServletStatus status,aprg_new_opextrboBO BO) {
    BO.SetFromContext(status.m_cWv);
    BO.Calculate();
  }
  void Save(ServletStatus status,aprg_new_opextrboBO BO) {
    boolean l_bResult;
    BO.SetFromContext(status.m_cWv);
    l_bResult = BO.Save();
    if (l_bResult) {
  ...
  void Discard(ServletStatus status,aprg_new_opextrboBO BO) {
    status.m_bExit = true;
  }
  void CreatePortlet(ServletStatus status,aprg_new_opextrboBO BO) {
    ...
    item.put("altInterfaceFor","aprg_new_opextrbo");
    items.put(item);
    String s;
    ...
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Anno Riferimento\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"4\",\"name\":\"annorif\",\"page\":\"1\",\"spuid\":\"MEXFGSWICI\",\"tabindex\":\"2\",\"type\":\"Textbox\",\"w\":\"48\",\"x\":\"128\",\"y\":\"36\",\"zone\":\"IDIZVJSJFR_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Data Operazione\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"10\",\"name\":\"dataope\",\"page\":\"1\",\"spuid\":\"PYGHSMNTBK\",\"tabindex\":\"3\",\"type\":\"Textbox\",\"w\":\"80\",\"x\":\"280\",\"y\":\"36\",\"zone\":\"IDIZVJSJFR_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Note\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"50\",\"name\":\"txtnote\",\"page\":\"1\",\"spuid\":\"MVMKKHKTPS\",\"tabindex\":\"4\",\"type\":\"Textbox\",\"w\":\"312\",\"x\":\"400\",\"y\":\"36\",\"zone\":\"IDIZVJSJFR_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Numero di Operazioni\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"11\",\"name\":\"nummov\",\"page\":\"1\",\"spuid\":\"SJSORASFDD\",\"tabindex\":\"5\",\"type\":\"Textbox\",\"w\":\"72\",\"x\":\"128\",\"y\":\"72\",\"zone\":\"IDIZVJSJFR_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Importo Saldo\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"25\",\"name\":\"impsaldo\",\"page\":\"1\",\"spuid\":\"XVLXTTNQKE\",\"tabindex\":\"6\",\"type\":\"Textbox\",\"w\":\"114\",\"x\":\"400\",\"y\":\"72\",\"zone\":\"IDIZVJSJFR_2\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Valuta Prevalente\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"3\",\"name\":\"codval\",\"page\":\"1\",\"spuid\":\"LRGJFQVRXS\",\"tabindex\":\"7\",\"type\":\"Textbox\",\"w\":\"40\",\"x\":\"128\",\"y\":\"108\",\"zone\":\"IDIZVJSJFR_3\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"Chiudi la finestra senza salvare i dati\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"29\",\"href\":\"javascript:href_ZQEKBHAOQV()\",\"name\":\"images_exit_gif\",\"page\":\"1\",\"spuid\":\"ZQEKBHAOQV\",\"src\":\"images\\/exit.gif\",\"tabindex\":\"8\",\"type\":\"Image\",\"w\":\"40\",\"x\":\"672\",\"y\":\"135\",\"zone\":\"IDIZVJSJFR_4\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"20\",\"maxlength\":\"16\",\"name\":\"CONNES\",\"page\":\"1\",\"spuid\":\"TJVNAGXDHC\",\"tabindex\":\"9\",\"type\":\"Textbox\",\"w\":\"108\",\"x\":\"608\",\"y\":\"72\",\"zone\":\"\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"center\",\"bg_color\":\"#0000FF\",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"NUOVA_OPERAZIONE_EXTRACONTO\",\"page\":\"1\",\"spuid\":\"HWULSRGDNM_DIV\",\"tabindex\":\"10\",\"type\":\"Label\",\"value\":\"NUOVA OPERAZIONE EXTRACONTO\",\"w\":\"712\",\"x\":\"8\",\"y\":\"9\",\"zone\":\"IDIZVJSJFR_5\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
    s = "{\"align\":\"right\",\"bg_color\":\" \",\"class_Css\":\" \",\"comment\":\"\",\"font\":\" \",\"font_color\":\" \",\"font_size\":\" \",\"font_weight\":\" \",\"h\":\"16\",\"href\":\" \",\"name\":\"Data_Operazione_\",\"page\":\"1\",\"spuid\":\"BAATYILHGP_DIV\",\"tabindex\":\"11\",\"type\":\"Label\",\"value\":\"Data Operazione:\",\"w\":\"93\",\"x\":\"187\",\"y\":\"40\",\"zone\":\"IDIZVJSJFR_1\"}";
    ctrl = new org.json.JSONObject(s);
    items.put(ctrl);
  ...
  void Next(ServletStatus status,aprg_new_opextrboBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow+entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void Previous(ServletStatus status,aprg_new_opextrboBO BO) {
    BO.SetFromContext(status.m_cWv);
    status.m_nStartRow = status.m_nStartRow-entityGlobals.m_nRowsPerPage;
    status.m_cClientMode = "edit";
  }
  void WriteFormPage(aprg_new_opextrboBO BO,ServletStatus status) {
    ...
    status.out.println(
     "<script src='aprg_new_opextrbo?"+SPLib.TranslationParameter()+"="+status.context.GetLanguage()+"'>" +
     "</script>" +
    "");
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+m_cEntityUid+"/aprg_new_opextrbo_proc.js'>" +
     "</script>" +
    "");
    IncludeJS(status);
    ...
    l_cJsUid = SPPrxycizer.proxycizedPath("arrt_new_opextrbo.js");
    status.out.println(
     "<script src='../"+l_cJsUid+"' type='text/javascript'>" +
     "</script>" +
    "");
  ...
  void RaiseLoadedEntity(aprg_new_opextrboBO BO,ServletStatus status) {
    RaiseEventLoadedEntity(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cClientMode,"C",0,0)+"})","C",0,0));
  }
  void RaiseSavedEntity(aprg_new_opextrboBO BO,ServletStatus status) {
  ...
  void RaiseDeletedEntity(aprg_new_opextrboBO BO,ServletStatus status) {
  ...
  void RaiseDiscardedEntity(aprg_new_opextrboBO BO,ServletStatus status) {
  ...
  void WriteExitPage(aprg_new_opextrboBO BO,ServletStatus status,Forward f) {
    WriteExitPage(status,SPLib.ToJSValue("({action:"+SPLib.ToJSValue(status.m_cMode,"C",0,0)+"})","C",0,0), f);
  }
  void WriteExitPage(aprg_new_opextrboBO BO,ServletStatus status) {
  ...
  void IncludeJS(ServletStatus status) {
    ...
    "");
    status.out.println(
     "<script src='SPPrxy/"+arfn_verify_opex.m_cEntityUid+"/arfn_verify_opex.js'>" +
     "</script>" +
    "");
  ...
  public static void GetCallableNames(java.util.Set callable) {
    if (CPLib.IsNull(m_CallableNames)) {
      arfn_verify_opex.GetCallableNames(callable);
      CPLib.AddToSet(callable,"arrt_new_opextrbo");
    } else {
  ...
  public String GetCheckVars(ServletStatus status,aprg_new_opextrboBO BO) {
    return "NO_VALUE";
  }
  public boolean CheckVars(ServletStatus status,aprg_new_opextrboBO BO) {
    boolean result = true;
    return result;
  }
}
