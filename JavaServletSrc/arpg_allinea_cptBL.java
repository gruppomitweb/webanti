...
public class arpg_allinea_cptBL extends arpg_allinea_cptWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_allinea_cpt";
  ...
  public arpg_allinea_cptBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_allinea_cpt","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
