...
public class ardt_fiduciaboBL extends ardt_fiduciaboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_fiduciabo";
  ...
  public CPPhTableWrInfo m_oWrInfo_fiduciabo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_fiduciabo;
  ...
  public static String[] m_EntityTables = {"fiduciabo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPCOL':RAPCOL,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_fiduciabo",true,true)+"}"+FoundlingChildrenList("ardt_fiduciabo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'RAPCOL':RAPCOL,'NUMCOL':NUMCOL,'m_Detail':{'CODSOG':CODSOG,'TIPOFILE':TIPOFILE,'LEGAME':LEGAME,'UCODE':UCODE,'IDBASE':IDBASE,'xragsoc':xragsoc,'PROVINCIA':PROVINCIA,'CAP':CAP,'DESCCIT':DESCCIT,'DOMICILIO':DOMICILIO"+FoundlingChildrenList("ardt_fiduciabo",true,true)+"},'NUMIMP':NUMIMP"+FoundlingChildrenList("ardt_fiduciabo",true,false)+"}";
  public static final String i_ItemSequence = "RAPCOL,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_fiduciabo",false,true)+"]"+FoundlingChildrenList("ardt_fiduciabo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_fiduciabo"),new String[][]{new String[]{"RAPCOL","Codice rapporto Collegato","C","25","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_fiduciaboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_fiduciabo = p_ContextObject.GetPhName("fiduciabo",p_ContextObject.GetCompany(),false);
    m_cServer_fiduciabo = p_ContextObject.GetServer("fiduciabo");
    m_oWrInfo_fiduciabo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"fiduciabo",p_ContextObject.GetCompany());
    m_cVirtName_fiduciabo = CPSql.ManipulateTablePhName("fiduciabo",m_cServer_fiduciabo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_fiduciabo",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_MPDPVTSMAO() {
    return Link_MPDPVTSMAO("Full");
  }
  protected boolean Link_MPDPVTSMAO(String p_cType) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_fiduciabo","fiduciabo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_TIPOFILE;
      p_TIPOFILE = CPLib.GetProperties(trs_p.getProperty("TIPOFILE"),new Properties());
      Properties p_LEGAME;
      ...
      w_NUMCOL = CPLib.GetProperty(p,"NUMCOL",w_NUMCOL,0);
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_TIPOFILE = "";
        w_TIPOFILE = CPLib.GetProperty(p_TIPOFILE,"",w_TIPOFILE,i);
        w_LEGAME = "";
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_fiduciabo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_fiduciabo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_fiduciabo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_fiduciabo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_fiduciabo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_fiduciabo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"NUMCOL",w_NUMCOL,0);
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_TIPOFILE,"",w_TIPOFILE,trsrow);
    ...
    trs_p.setProperty("TIPOFILE",CPLib.ToProperties(p_TIPOFILE));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "fiduciabo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPCOL","C",25,0));
  }
  public String RowPrimaryKey() {
    return "fiduciabo"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
  ...
  protected void TrsToWork() {
    ...
    w_TIPOFILE= m_oTrs.get(m_nCurrentRow).w_TIPOFILE;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_TIPOFILE=w_TIPOFILE;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_TIPOFILE=w_TIPOFILE;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_TIPOFILE= m_oDeletedRows.get(l_RowNumberToSet).w_TIPOFILE;
