...
public class arpg_filesage_doBL extends arpg_filesage_doWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_filesage_do";
  ...
  public arpg_filesage_doBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_filesage_do","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
