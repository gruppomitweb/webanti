...
// * --- Fine Area Manuale
public class arrt_load_jnarapboR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_load_jnarapboR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_load_jnarapbo",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    if ( ! (CPLib.Empty(cRapporto))) {
      /* _comando := 'query RAPPORTO="'+cRapporto+'"'+ NL + "@" + NL + "@SAVE"+ NL +"arrt_load_jnarapbo" + NL +'cRapporto="%RAPPORTO%" '+NL+"@DISCARD"+ NL +"arrt_load_jnarapbo" */
      _comando = "query RAPPORTO=\""+cRapporto+"\""+"\n"+"@"+"\n"+"@SAVE"+"\n"+"arrt_load_jnarapbo"+"\n"+"cRapporto=\"%RAPPORTO%\" "+"\n"+"@DISCARD"+"\n"+"arrt_load_jnarapbo";
      /* _where := "RAPPORTO='"+cRapporto+"'" */
      _where = "RAPPORTO='"+cRapporto+"'";
    } else { // Else
      /* _comando := 'query RAPPORTO=""'+ NL + "@" + NL + "@SAVE"+ NL +"arrt_load_jnarapbo" + NL +'cRapporto="%RAPPORTO%" '+NL+"@DISCARD"+ NL +"arrt_load_jnarapbo" */
    ...
    /* Return  */
    Forward f;
    f=new Forward("armt_ae_anarap",false,this,Forward.Start,false);
  ...
  public static arrt_load_jnarapboR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_load_jnarapboR(p_Ctx, p_Caller);
  }
  public void Blank() {
