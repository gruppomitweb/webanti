...
// * --- Fine Area Manuale
public class arfn_downloadfile_docR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arfn_downloadfile_docR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arfn_downloadfile_doc",m_Caller);
    Blank();
  }
  ...
  public static arfn_downloadfile_docR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arfn_downloadfile_docR(p_Ctx, p_Caller);
  }
  public static arfn_downloadfile_docR Make(CPContext p_Ctx) {
    return new arfn_downloadfile_docR(p_Ctx, CPSecurity.EXECUTE_ALL_ROUTINES);
  }
  public void Blank() {
  ...
  // ENTITY_BATCHES: ,arfn_downloadfile_doc,
  public static final String i_InvokedRoutines = ",arfn_downloadfile_doc,";
