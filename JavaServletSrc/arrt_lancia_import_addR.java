...
// * --- Fine Area Manuale
public class arrt_lancia_import_addR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_addR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_add",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_import_add */
    Forward f;
    f=new Forward("arpg_import_add",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_import_addR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_addR(p_Ctx, p_Caller);
  }
  public void Blank() {
