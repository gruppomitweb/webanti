...
public class arrt_wu_stampa_trx extends SPRoutineServlet implements SPInvokable {
  public static String m_cEntityUid = "!*76d5e8fa*!";
  ...
  private void ExecuteRoutine(ServletStatus status) throws IOException {
    arrt_wu_stampa_trxR Rcalled;
    Rcalled = new arrt_wu_stampa_trxR(status.context,status);
  ...
  CallerWithObjs NewRoutine(SPServletStatus status,Caller dataFromClient) {
    return new arrt_wu_stampa_trxR(status.context,dataFromClient);
  }
  protected void BringBackPage(ServletStatus status,arrt_wu_stampa_trxR Rcalled) throws IOException {
    String l_cErrMsg;
    String msg;
    ...
    if ( ! (CPLib.Empty(status.m_cFaultTrace))) {
      status.out.println("Fault:["+SPLib.ToJSValue(status.context.Translate("MSG_ROUTINE_FAULTED","arrt_wu_stampa_trx"),"C",0,0)+","+SPLib.ToJSValue(status.m_cFaultTrace,"C",0,0)+"]");
