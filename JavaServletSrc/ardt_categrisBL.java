...
public class ardt_categrisBL extends ardt_categrisWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_categris";
  ...
  public CPPhTableWrInfo m_oWrInfo_categris;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_categris;
  ...
  public static String[] m_EntityTables = {"categris"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDCATEG':IDCATEG,'m_Detail':{'CODICE':CODICE,'GIORNI':GIORNI,'xDESCRI':xDESCRI"+FoundlingChildrenList("ardt_categris",true,true)+"}"+FoundlingChildrenList("ardt_categris",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDCATEG':IDCATEG,'m_Detail':{'CODICE':CODICE,'GIORNI':GIORNI,'IDBASE':IDBASE,'xDESCRI':xDESCRI"+FoundlingChildrenList("ardt_categris",true,true)+"}"+FoundlingChildrenList("ardt_categris",true,false)+"}";
  public static final String i_ItemSequence = "IDCATEG,m_Detail[ CODICE GIORNI xDESCRI"+FoundlingChildrenList("ardt_categris",false,true)+"]"+FoundlingChildrenList("ardt_categris",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_categris"),new String[][]{new String[]{"IDCATEG","","C","10","0","campo","key1","false","false"},new String[]{"CODICE","","C","3","0","campo","key1","true","false"},new String[]{"GIORNI","","N","5","0","campo","nokey","true","false"},new String[]{"xDESCRI","Descrizione","C","150","0","variabile","nokey","true","false"}});
  public static final String i_TrsKeys = ",CODICE";
  ...
  public ardt_categrisBL (CPContext p_ContextObject) {
    ...
    m_cPhName_categris = p_ContextObject.GetPhName("categris",p_ContextObject.GetCompany(),false);
    m_cServer_categris = p_ContextObject.GetServer("categris");
    m_oWrInfo_categris = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"categris",p_ContextObject.GetCompany());
    m_cVirtName_categris = CPSql.ManipulateTablePhName("categris",m_cServer_categris);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_categris",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_EQQSGWXFEN() {
    return Link_EQQSGWXFEN("Full");
  }
  protected boolean Link_EQQSGWXFEN(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_CODICE))) {
      ...
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CODICE,"C",3,0),m_cServer_tbrisglob,w_CODICE);
      if (m_Ctx.IsSharedTemp("tbrisglob")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_tbrisglob,"select CODICE,DESCRI,GIORNI from "+m_cPhName_tbrisglob+((m_cPhName_tbrisglob).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"CODICE"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_CODICE,"C",150,0),m_cServer_tbrisglob,w_CODICE);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_tbrisglob,"select CODICE,DESCRI,GIORNI from "+m_cPhName_tbrisglob+((m_cPhName_tbrisglob).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRI"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
          ...
          w_GIORNI = l_rsLink.GetDouble("GIORNI");
          l_rsLink.Next();
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_IDCATEG(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_IDCATEG = p_workVariableValue;
  ...
  public boolean Set_GIORNI(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_GIORNI = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_xDESCRI(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_xDESCRI = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"IDCATEG"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_categris","categris",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_GIORNI;
      p_GIORNI = CPLib.GetProperties(trs_p.getProperty("GIORNI"),new Properties());
      Properties p_IDBASE;
      ...
      Properties p_opk_CODICE;
      p_opk_CODICE = CPLib.GetProperties(trs_p.getProperty("opk_CODICE"),new Properties());
      ...
      w_IDCATEG = CPLib.GetProperty(p,"IDCATEG",w_IDCATEG,0);
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"GIORNI")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"xDESCRI")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    items = tables.get("tbrisglob");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("tbrisglob",items);
    }
    items.add(map);
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    map.put("rd_field",new String[]{"CODICE","DESCRI","GIORNI"});
    map.put("rd_var",new String[]{"w_CODICE","w_xDESCRI","w_GIORNI"});
    map.put("wr_var",new String[]{});
    map.put("wr_field",new String[]{});
    map.put("wr_op",new String[]{});
    map.put("rd_var.obj_type",zeroSplit.split("C\u0000C\u0000N",-1));
    map.put("rd_kvar.obj_type",new String[]{});
    map.put("rd_var.len",zeroSplit.split("3\u0000150\u00005",-1));
    ...
    map.put("property.value",zeroSplit.split("tbrisglob\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Rischio Globale\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_categris",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_categris",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_categris",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_categris",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_categris"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_categris\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_GIORNI,"",w_GIORNI,trsrow);
      CPLib.PutProperty(p_IDBASE,"",w_IDBASE,trsrow);
      CPLib.PutProperty(p_xDESCRI,"",w_xDESCRI,trsrow);
      CPLib.PutProperty(p_opk_CODICE,"",opk_CODICE,trsrow);
    ...
    trs_p.setProperty("GIORNI",CPLib.ToProperties(p_GIORNI));
    trs_p.setProperty("IDBASE",CPLib.ToProperties(p_IDBASE));
    trs_p.setProperty("xDESCRI",CPLib.ToProperties(p_xDESCRI));
    trs_p.setProperty("opk_CODICE",CPLib.ToProperties(p_opk_CODICE));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "categris"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDCATEG","C",10,0));
  }
  public String RowPrimaryKey() {
    return "categris"+"\\"+CPLib.ToCPStr(w_CODICE);
  }
  ...
  protected void TrsToWork() {
    ...
    w_GIORNI= m_oTrs.get(m_nCurrentRow).w_GIORNI;
    w_IDBASE= m_oTrs.get(m_nCurrentRow).w_IDBASE;
    w_xDESCRI= m_oTrs.get(m_nCurrentRow).w_xDESCRI;
    opk_CODICE= m_oTrs.get(m_nCurrentRow).opk_CODICE;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_GIORNI=w_GIORNI;
    m_oTrs.get(m_nCurrentRow).w_IDBASE=w_IDBASE;
    m_oTrs.get(m_nCurrentRow).w_xDESCRI=w_xDESCRI;
    m_oTrs.get(m_nCurrentRow).opk_CODICE=opk_CODICE;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_GIORNI=w_GIORNI;
    m_oDeletedRows.get(l_nRows).w_IDBASE=w_IDBASE;
    m_oDeletedRows.get(l_nRows).w_xDESCRI=w_xDESCRI;
    m_oDeletedRows.get(l_nRows).opk_CODICE=opk_CODICE;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_GIORNI= m_oDeletedRows.get(l_RowNumberToSet).w_GIORNI;
    w_IDBASE= m_oDeletedRows.get(l_RowNumberToSet).w_IDBASE;
    w_xDESCRI= m_oDeletedRows.get(l_RowNumberToSet).w_xDESCRI;
    opk_CODICE= m_oDeletedRows.get(l_RowNumberToSet).opk_CODICE;
