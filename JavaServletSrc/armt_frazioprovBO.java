...
// * --- Fine Area Manuale
public class armt_frazioprovBO extends armt_frazioprovBL {
  class SqlLoader {
    ...
    public boolean m_bLink_1_66 = false;
    ...
    public void AddJoinedLink_1_26(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_26.CODINTER AS CODINTER126";
        m_cSelect = m_cSelect+" ,link_1_26.DATANASC AS DATANASC126";
        m_cSelect = m_cSelect+" ,link_1_26.CODCAB AS CODCAB126";
        m_cSelect = m_cSelect+" ,link_1_26.PROVINCIA AS PROVINCIA126";
        m_cSelect = m_cSelect+" ,link_1_26.DESCCIT AS DESCCIT126";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_26","CODINTER","CODINTER");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_26","CODINTER","CODINTER",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_29(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_29.CODDIP AS CODDIP129";
        m_cSelect = m_cSelect+" ,link_1_29.DESCRIZ AS DESCRIZ129";
        m_cSelect = m_cSelect+" ,link_1_29.DESCCIT AS DESCCIT129";
        m_cSelect = m_cSelect+" ,link_1_29.PROVINCIA AS PROVINCIA129";
        m_cSelect = m_cSelect+" ,link_1_29.CAB AS CAB129";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_29","CODDIPE","CODDIP");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_29","CODDIPE","CODDIP",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_48(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_48.CODVOC AS CODVOC148";
        m_cSelect = m_cSelect+" ,link_1_48.DESCRIZ AS DESCRIZ148";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_48","CODVOC","CODVOC");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_48","CODVOC","CODVOC",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_51(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_51.CODVAL AS CODVAL151";
        m_cSelect = m_cSelect+" ,link_1_51.DESCRI AS DESCRI151";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_51","VALUTA","CODVAL");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_51","VALUTA","CODVAL",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_60(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_60.RAPPORTO AS RAPPORTO160";
        m_cSelect = m_cSelect+" ,link_1_60.DESCRAP AS DESCRAP160";
        m_cSelect = m_cSelect+" ,link_1_60.TIPORAP AS TIPORAP160";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_60","RAPPORTO","RAPPORTO");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_60","RAPPORTO","RAPPORTO",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_61(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+5,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_61.CONNES AS CONNES161";
        m_cSelect = m_cSelect+" ,link_1_61.RAGSOC AS RAGSOC161";
        m_cSelect = m_cSelect+" ,link_1_61.CODFISC AS CODFISC161";
        m_cSelect = m_cSelect+" ,link_1_61.DATAVALI AS DATAVALI161";
        m_cSelect = m_cSelect+" ,link_1_61.DATARILASC AS DATARILASC161";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_61","CONNESCLI","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_61","CONNESCLI","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_63(String rightTable,String rightServer) {
      ...
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_63.CONNES AS CONNES163";
        m_cSelect = m_cSelect+" ,link_1_63.RAGSOC AS RAGSOC163";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_63","CONNESOPER","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_63","CONNESOPER","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_66(String rightTable,String rightServer) {
      // questo link aggiunge 3 campi al cursore risultato
      String m_cLinkedFrom;
      String m_cLinkedWhere;
      String m_cJoinCond = "";
      if (m_Sql.CanOptimizeLink(m_nColumns+3,m_cServer,rightServer)) {
        m_cSelect = m_cSelect+" ,link_1_66.CONNES AS CONNES166";
        m_cSelect = m_cSelect+" ,link_1_66.RAGSOC AS RAGSOC166";
        m_cSelect = m_cSelect+" ,link_1_66.CONTO AS CONTO166";
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_66","CONNESBEN","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_66","CONNESBEN","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
    ...
    public void AddJoinedLink_1_67(String rightTable,String rightServer) {
      ...
      if (m_Sql.CanOptimizeLink(m_nColumns+2,m_cServer,rightServer)) {
        ...
        m_cLinkedFrom = m_Sql.GenerateLinkFrom(m_cServer,m_cMainTable,rightTable,"link_1_67","CONNALTRO","CONNES");
        if (CPLib.ne(m_cLinkedFrom,"")) {
          m_cFrom = m_cFrom+m_cLinkedFrom;
          m_cLinkedWhere = m_Sql.GenerateJoinCondition(m_cServer,m_cMainTable,rightTable,"link_1_67","CONNALTRO","CONNES",true);
          if (CPLib.eq(m_cLinkedWhere,"")) {
            m_cFrom = m_cFrom+m_cJoinCond;
          } else {
            m_cWhere = m_cWhere+m_cLinkedWhere+m_cJoinCond;
  ...
  // * --- Fine Area Manuale
  public armt_frazioprovBO (CPContext p_ContextObject) {
  ...
  public boolean CheckOTPSecurity() {
    ...
    if (requiredOTP) {
      ...
      accessType = SPLib.AccessType((m_bLoaded?"edit":"insert"),"armt_frazioprov");
    }
  ...
  public boolean CanSave() {
    ...
    l_bResult = true;
    if (l_bResult) {
      l_bResult = CanSaveChild(ardt_xlientifrz,m_cWv_ardt_xlientifrz,"m_cWv_ardt_xlientifrz");
      if (l_bResult) {
        l_bResult = CanSaveChild(ardt_sogopefrazprov,m_cWv_ardt_sogopefrazprov,"m_cWv_ardt_sogopefrazprov");
        if (l_bResult) {
          l_bResult = CanSaveChild(ardt_xeneficfrz,m_cWv_ardt_xeneficfrz,"m_cWv_ardt_xeneficfrz");
          if (l_bResult) {
            l_bResult = CanSaveChild(ardt_xerzistifrz,m_cWv_ardt_xerzistifrz,"m_cWv_ardt_xerzistifrz");
            if (l_bResult) {
              l_bResult = CanSaveChild(ardt_docfrabo,m_cWv_ardt_docfrabo,"m_cWv_ardt_docfrabo");
              if (l_bResult) {
                l_bResult = CanSaveChild(armt_xraziobo_agg,m_cWv_armt_xraziobo_agg,"m_cWv_armt_xraziobo_agg");
                if (l_bResult) {
                  l_bResult = CanSaveChild(ardt_xrz_contante,m_cWv_ardt_xrz_contante,"m_cWv_ardt_xrz_contante");
                  if (l_bResult) {
    ...
    if (IsUpdated()) {
      ...
      if (l_bResult) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_xlientifrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xlientifrz)) {
          ...
          if (ardt_xlientifrz.IsUpdated()) {
            ...
            if ( ! (ardt_xlientifrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_sogopefrazprov.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_sogopefrazprov)) {
          ...
          if (ardt_sogopefrazprov.IsUpdated()) {
            ...
            if ( ! (ardt_sogopefrazprov.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_xeneficfrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xeneficfrz)) {
          ...
          if (ardt_xeneficfrz.IsUpdated()) {
            ...
            if ( ! (ardt_xeneficfrz.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_xerzistifrz.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xerzistifrz)) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (armt_xraziobo_agg.IsUpdated()) && CPLib.IsUpdated(m_cWv_armt_xraziobo_agg)) {
          ...
          if (armt_xraziobo_agg.IsUpdated()) {
            ...
            if ( ! (armt_xraziobo_agg.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          if ( ! (ardt_xrz_contante.IsUpdated()) && CPLib.IsUpdated(m_cWv_ardt_xrz_contante)) {
          ...
          if (ardt_xrz_contante.IsUpdated()) {
            ...
            if ( ! (ardt_xrz_contante.Save(true))) {
              m_Sql.AbortTransaction();
            }
          }
        }
  ...
  public boolean Load(String p_IDBASE) {
    ...
    l_oSqlLoader = new SqlLoader(m_Sql,m_cServer_xraziobo,m_cPhName_xraziobo,m_cVirtName_xraziobo,m_cVirtName_xraziobo+".IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(p_IDBASE,"C",10,0),m_cServer_xraziobo,p_IDBASE),"");
    // * --- Area Manuale = BO - Load Record Init
    // * --- Fine Area Manuale
    BlankStatusVariables();
    l_oSqlLoader.AddJoinedLink_5_10(m_cPhName_kersonbo,m_cServer_kersonbo);
    l_oSqlLoader.AddJoinedLink_1_26(m_cPhName_intermbo,m_cServer_intermbo);
    l_oSqlLoader.AddJoinedLink_1_29(m_cPhName_anadip,m_cServer_anadip);
    l_oSqlLoader.AddJoinedLink_1_48(m_cPhName_tbcausin,m_cServer_tbcausin);
    l_oSqlLoader.AddJoinedLink_1_51(m_cPhName_tbvalute,m_cServer_tbvalute);
    l_oSqlLoader.AddJoinedLink_1_60(m_cPhName_knarapbo,m_cServer_knarapbo);
    l_oSqlLoader.AddJoinedLink_1_61(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_63(m_cPhName_personbo,m_cServer_personbo);
    l_oSqlLoader.AddJoinedLink_1_66(m_cPhName_personbo,m_cServer_personbo);
    ...
    try {
      ...
      if (m_bLoaded) {
        ...
        if (l_oSqlLoader.m_bLink_1_26) {
          w_datpaseuro = l_rsLoad.GetDate("DATANASC126");
          w_CABINT = l_rsLoad.GetString("CODCAB126");
          w_PROVINT = l_rsLoad.GetString("PROVINCIA126");
          w_CITINT = l_rsLoad.GetString("DESCCIT126");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_29) {
          w_xDescDipe = l_rsLoad.GetString("DESCRIZ129");
          w_CITDIP = l_rsLoad.GetString("DESCCIT129");
          w_PROVDIP = l_rsLoad.GetString("PROVINCIA129");
          w_CABDIP = l_rsLoad.GetString("CAB129");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_48) {
          w_xdesccausin = l_rsLoad.GetString("DESCRIZ148");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_51) {
          w_descdiv = l_rsLoad.GetString("DESCRI151");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_60) {
          w_xdescrap = l_rsLoad.GetString("DESCRAP160");
          w_FLAGRAP = l_rsLoad.GetString("TIPORAP160");
        } else {
          Link_RZIQZFKPUE("Load");
        }
        w_CONNESCLI = l_rsLoad.GetString("CONNESCLI");
        if (l_oSqlLoader.m_bLink_1_61) {
          w_xragsocper = l_rsLoad.GetString("RAGSOC161");
          w_xcodfisc = l_rsLoad.GetString("CODFISC161");
          w_DATAVALI = l_rsLoad.GetDate("DATAVALI161");
          w_DATARILASC = l_rsLoad.GetDate("DATARILASC161");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_63) {
          w_xragsocct = l_rsLoad.GetString("RAGSOC163");
        } else {
        ...
        if (l_oSqlLoader.m_bLink_1_66) {
          w_xragsocben = l_rsLoad.GetString("RAGSOC166");
          w_C_RAPPORTO = l_rsLoad.GetString("CONTO166");
        } else {
          Link_ULVCBLFVEU("Load");
        }
        w_CONNALTRO = l_rsLoad.GetString("CONNALTRO");
        if (l_oSqlLoader.m_bLink_1_67) {
          w_xragsocalt = l_rsLoad.GetString("RAGSOC167");
        } else {
        ...
        ardt_xlientifrz.m_lCtxLoaded = false;
        m_cWv_ardt_sogopefrazprov = "";
        ardt_sogopefrazprov.m_lCtxLoaded = false;
        m_cWv_ardt_xeneficfrz = "";
        ardt_xeneficfrz.m_lCtxLoaded = false;
        m_cWv_ardt_xerzistifrz = "";
        ardt_xerzistifrz.m_lCtxLoaded = false;
        m_cWv_ardt_docfrabo = "";
        ardt_docfrabo.m_lCtxLoaded = false;
        m_cWv_armt_xraziobo_agg = "";
        armt_xraziobo_agg.m_lCtxLoaded = false;
        m_cWv_ardt_xrz_contante = "";
        ardt_xrz_contante.m_lCtxLoaded = false;
        SPExtenderLib.LoadExtendedFields(l_rsLoad,extendedFields);
        if (CPLib.HasTableCPCCCHK(m_Ctx,"xraziobo")) {
  ...
  void Insert() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xraziobo);
      l_cSql = "insert into "+m_oWrInfo_xraziobo.GetTableWriteName()+" (";
      ...
      l_cSql = l_cSql+m_oWrInfo_xraziobo.InsertFields();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xraziobo")) {
      ...
      l_cSql = l_cSql+m_oWrInfo_xraziobo.InsertValues();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xraziobo")) {
      ...
      l_cSql = l_cSql+")";
      l_nUpdatedRows = m_Sql.Update(m_cServer_xraziobo,l_cSql,m_oParameters);
  ...
  void Update() {
    ...
    if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
      m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer_xraziobo);
      l_cSql = "Update "+m_oWrInfo_xraziobo.GetTableWriteName()+" set";
      ...
      l_cSql = l_cSql+" where ";
      l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_xraziobo,w_IDBASE);
      l_cSql = l_cSql+m_oWrInfo_xraziobo.WhereFilter();
      if (CPLib.HasTableCPCCCHK(m_Ctx,"xraziobo")) {
    ...
    if (m_bLoaded) {
      if (CanDelete()) {
        ...
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          armt_xraziobo_agg.w_IDBASE = w_IDBASE;
          armt_xraziobo_agg.Delete();
        }
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          // Cancella il figlio LinkPC
          ardt_xrz_contante.w_IDOPE = w_IDBASE;
          ardt_xrz_contante.Delete();
        }
        CPLib.DeleteMNTs(m_Sql,m_MNTs,this);
        if (CPLib.eq(m_Sql.GetTransactionStatus(),CPSql.OK)) {
          l_cSql = "Delete from "+m_oWrInfo_xraziobo.GetTableWriteName()+" where ";
          l_cSql = l_cSql+"IDBASE="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_xraziobo,w_IDBASE);
          l_cSql = l_cSql+m_oWrInfo_xraziobo.WhereFilter();
          if (CPLib.HasTableCPCCCHK(m_Ctx,"xraziobo")) {
            l_cSql = l_cSql+" and CPCCCHK="+CPLib.ToSQL(m_cOldCPCCCHK,"C",10,0);
          }
          l_nUpdatedRows = m_Sql.Update(m_cServer_xraziobo,l_cSql);
          if (CPLib.ne(l_nUpdatedRows,1)) {
            // AbortTransaction
            m_Sql.AbortTransaction();
          }
  ...
  void SaveAutonumber() {
    ...
    m_Sql.NextTableProg(this,"PPFRAZ1","i_codazi,w_IDBASE",m_cServer_xraziobo,m_Ctx.GetCompany());
    ...
    m_Sql.NextTableProg(this,"PPFRAZ2","i_codazi,w_NUMPROG",m_cServer_xraziobo,m_Ctx.GetCompany());
    ...
    op_NUMPROG = w_NUMPROG;
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    m_Sql.NextTableProg(this,"PRGIMPFRZ","i_codazi,w_PRGIMPFRZ",m_cServer_xraziobo,m_Ctx.GetCompany());
    op_PRGIMPFRZ = w_PRGIMPFRZ;
  }
  ...
  // * --- Fine Area Manuale
  // ENTITY_BATCHES: ,arfn_calcflaglire,arfn_chkdatdoc,arfn_chksogg,arfn_chktotalelire_cont,arfn_chktotalelire_fraz,arfn_read_tipoleg,arrt_crea_idereg,arrt_imp_frischio,arrt_li_xraziobo,arrt_updel_opextrbo,arrt_val_benefic,arrt_writelog,
  public static final String i_InvokedRoutines = ",arfn_calcflaglire,arfn_chkdatdoc,arfn_chksogg,arfn_chktotalelire_cont,arfn_chktotalelire_fraz,arfn_read_tipoleg,arrt_crea_idereg,arrt_imp_frischio,arrt_li_xraziobo,arrt_updel_opextrbo,arrt_val_benefic,arrt_writelog,";
}
