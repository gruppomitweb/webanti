...
public class ardt_cgo_subnetsBL extends ardt_cgo_subnetsWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String w_SNSUBNET;
    public String opk_SNSUBNET;
  ...
  public static final String i_EntityName = "ardt_cgo_subnets";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_subnet;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_subnet;
  ...
  public static String[] m_EntityTables = {"cgo_subnet"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'SNCODINT':SNCODINT,'m_Detail':{'SNSUBNET':SNSUBNET"+FoundlingChildrenList("ardt_cgo_subnets",true,true)+"}"+FoundlingChildrenList("ardt_cgo_subnets",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'SNCODINT':SNCODINT,'m_Detail':{'SNSUBNET':SNSUBNET"+FoundlingChildrenList("ardt_cgo_subnets",true,true)+"}"+FoundlingChildrenList("ardt_cgo_subnets",true,false)+"}";
  public static final String i_ItemSequence = "SNCODINT,m_Detail[ SNSUBNET"+FoundlingChildrenList("ardt_cgo_subnets",false,true)+"]"+FoundlingChildrenList("ardt_cgo_subnets",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_cgo_subnets"),new String[][]{new String[]{"SNCODINT","Codice Intermediario","C","11","0","campo","key1","false","false"},new String[]{"SNSUBNET","","C","15","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",SNSUBNET";
  ...
  public ardt_cgo_subnetsBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_subnet = p_ContextObject.GetPhName("cgo_subnet",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_subnet = p_ContextObject.GetServer("cgo_subnet");
    m_oWrInfo_cgo_subnet = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_subnet",p_ContextObject.GetCompany());
    m_cVirtName_cgo_subnet = CPSql.ManipulateTablePhName("cgo_subnet",m_cServer_cgo_subnet);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("ardt_cgo_subnets",p_ContextObject);
  }
  public void Blank() {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_SNCODINT(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_SNCODINT = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_SNSUBNET(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_SNSUBNET = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"SNCODINT"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_cgo_subnets","cgo_subnet",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_SNSUBNET;
      p_SNSUBNET = CPLib.GetProperties(trs_p.getProperty("SNSUBNET"),new Properties());
      Properties p_opk_SNSUBNET;
      p_opk_SNSUBNET = CPLib.GetProperties(trs_p.getProperty("opk_SNSUBNET"),new Properties());
      ...
      w_SNCODINT = CPLib.GetProperty(p,"SNCODINT",w_SNCODINT,0);
      ...
      while (CPLib.le(i,rows)) {
        w_SNSUBNET = "";
        w_SNSUBNET = CPLib.GetProperty(p_SNSUBNET,"",w_SNSUBNET,i);
        opk_SNSUBNET = CPLib.GetProperty(p_opk_SNSUBNET,"","",i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"SNCODINT")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"SNSUBNET")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_cgo_subnets",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_cgo_subnets",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_cgo_subnets",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_cgo_subnets",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_cgo_subnets"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_cgo_subnets\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_SNSUBNET;
    p_SNSUBNET = new Properties();
    Properties p_opk_SNSUBNET;
    p_opk_SNSUBNET = new Properties();
    Properties p_m_nRowStatus;
    p_m_nRowStatus = new Properties();
    Properties p_m_cOldRowCPCCCHK;
    p_m_cOldRowCPCCCHK = new Properties();
    CPLib.PutProperty(p,"SNCODINT",w_SNCODINT,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_SNSUBNET,"",w_SNSUBNET,trsrow);
      CPLib.PutProperty(p_opk_SNSUBNET,"",opk_SNSUBNET,trsrow);
    ...
    trs_p.setProperty("SNSUBNET",CPLib.ToProperties(p_SNSUBNET));
    trs_p.setProperty("opk_SNSUBNET",CPLib.ToProperties(p_opk_SNSUBNET));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_subnet"+"\\"+CPLib.ToCPStr(p_Caller.GetString("SNCODINT","C",11,0));
  }
  public String RowPrimaryKey() {
    return "cgo_subnet"+"\\"+CPLib.ToCPStr(w_SNSUBNET);
  }
  ...
  protected void TrsToWork() {
    w_SNSUBNET= m_oTrs.get(m_nCurrentRow).w_SNSUBNET;
    opk_SNSUBNET= m_oTrs.get(m_nCurrentRow).opk_SNSUBNET;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_SNSUBNET=w_SNSUBNET;
    m_oTrs.get(m_nCurrentRow).opk_SNSUBNET=opk_SNSUBNET;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_SNSUBNET=w_SNSUBNET;
    m_oDeletedRows.get(l_nRows).opk_SNSUBNET=opk_SNSUBNET;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_SNSUBNET= m_oDeletedRows.get(l_RowNumberToSet).w_SNSUBNET;
    opk_SNSUBNET= m_oDeletedRows.get(l_RowNumberToSet).opk_SNSUBNET;
