...
public class ardt_xrz_contanteBL extends ardt_xrz_contanteWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xrz_contante";
  ...
  public CPPhTableWrInfo m_oWrInfo_xrz_contante;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xrz_contante;
  ...
  public static String[] m_EntityTables = {"xrz_contante"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDOPE':IDOPE,'TIPATT':TIPATT,'TIPOATTIV':TIPOATTIV,'CODICEGLN':CODICEGLN,'CODCLICON':CODCLICON,'ATECO_CON':ATECO_CON,'CODCOMCON':CODCOMCON,'ABIINTER':ABIINTER,'ABIPROPR':ABIPROPR,'GLNALTROSOG':GLNALTROSOG,'GLNALTRASC':GLNALTRASC,'BILLSRIT':BILLSRIT,'BILLSSOV':BILLSSOV,'m_Detail':{'TAGLIO':TAGLIO,'NBANCONOTE':NBANCONOTE"+FoundlingChildrenList("ardt_xrz_contante",true,true)+"}"+FoundlingChildrenList("ardt_xrz_contante",true,false)+"}";
  ...
  public ardt_xrz_contanteBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xrz_contante = p_ContextObject.GetPhName("xrz_contante",p_ContextObject.GetCompany(),false);
    m_cServer_xrz_contante = p_ContextObject.GetServer("xrz_contante");
    m_oWrInfo_xrz_contante = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xrz_contante",p_ContextObject.GetCompany());
    m_cVirtName_xrz_contante = CPSql.ManipulateTablePhName("xrz_contante",m_cServer_xrz_contante);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xrz_contante",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xrz_contante","xrz_contante",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xrz_contante",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xrz_contante",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xrz_contante",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xrz_contante",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xrz_contante"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xrz_contante\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xrz_contante"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDOPE","C",10,0));
  }
  public String RowPrimaryKey() {
    return "xrz_contante"+"\\"+CPLib.ToCPStr(w_TAGLIO);
  }
