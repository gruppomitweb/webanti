...
public class ardt_tipointerBL extends ardt_tipointerWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_tipointer";
  ...
  public CPPhTableWrInfo m_oWrInfo_cauanainter;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cauanainter;
  ...
  public static String[] m_EntityTables = {"cauanainter"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'codcau':codcau,'m_Detail':{'tipinter':tipinter"+FoundlingChildrenList("ardt_tipointer",true,true)+"}"+FoundlingChildrenList("ardt_tipointer",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'codcau':codcau,'m_Detail':{'tipinter':tipinter,'xdescinter':xdescinter"+FoundlingChildrenList("ardt_tipointer",true,true)+"}"+FoundlingChildrenList("ardt_tipointer",true,false)+"}";
  public static final String i_ItemSequence = "codcau,m_Detail[ tipinter"+FoundlingChildrenList("ardt_tipointer",false,true)+"]"+FoundlingChildrenList("ardt_tipointer",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_tipointer"),new String[][]{new String[]{"codcau","Codice Causale","C","4","0","campo","key1","false","false"},new String[]{"tipinter","Valido per tipo intermediario","C","2","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",tipinter";
  ...
  public ardt_tipointerBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cauanainter = p_ContextObject.GetPhName("cauanainter",p_ContextObject.GetCompany(),false);
    m_cServer_cauanainter = p_ContextObject.GetServer("cauanainter");
    m_oWrInfo_cauanainter = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cauanainter",p_ContextObject.GetCompany());
    m_cVirtName_cauanainter = CPSql.ManipulateTablePhName("cauanainter",m_cServer_cauanainter);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_tipointer",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_GCFQVRXGQC() {
    return Link_GCFQVRXGQC("Full");
  }
  protected boolean Link_GCFQVRXGQC(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_tipinter))) {
      ...
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_tbtipint,"select TIPOINT,DESCRI from "+m_cPhName_tbtipint+((m_cPhName_tbtipint).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"TIPOINT"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (CPLib.ne(p_cType,"Load")) {
          if ( ! (l_bLoaded)) {
            l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_tipinter,"C",80,0),m_cServer_tbtipint,w_tipinter);
            if (l_rsLink!=null)
              l_rsLink.Close();
            l_rsLink = m_Sql.Query(m_cServer_tbtipint,"select TIPOINT,DESCRI from "+m_cPhName_tbtipint+((m_cPhName_tbtipint).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"DESCRI"+l_cCurrentKey+l_cWhere);
            l_bLoaded =  ! (l_rsLink.Eof());
          }
        }
        if (l_bLoaded) {
          ...
          w_xdescinter = l_rsLink.GetString("DESCRI");
          l_rsLink.Next();
  ...
  public final static String[] m_KeyColumns = {"codcau"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_tipointer","cauanainter",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_tipinter;
      p_tipinter = CPLib.GetProperties(trs_p.getProperty("tipinter"),new Properties());
      Properties p_xdescinter;
      p_xdescinter = CPLib.GetProperties(trs_p.getProperty("xdescinter"),new Properties());
      Properties p_opk_tipinter;
      p_opk_tipinter = CPLib.GetProperties(trs_p.getProperty("opk_tipinter"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        w_tipinter = "";
        w_tipinter = CPLib.GetProperty(p_tipinter,"",w_tipinter,i);
        w_xdescinter = "";
        w_xdescinter = CPLib.GetProperty(p_xdescinter,"",w_xdescinter,i);
        opk_tipinter = CPLib.GetProperty(p_opk_tipinter,"","",i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"codcau")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"tipinter")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_field",new String[]{"TIPOINT","DESCRI"});
    map.put("rd_var",new String[]{"w_tipinter","w_xdescinter"});
    ...
    map.put("rd_var.comment",zeroSplit.split("Valido per tipo intermediario\u0000Descrizione",-1));
    ...
    map.put("property.value",zeroSplit.split("tbtipint\u0000false\u0000false\u00002\u00000\u0000\u0000false\u0000false\u0000Tipologie Intermediario\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_tipointer",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_tipointer",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_tipointer",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_tipointer",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_tipointer"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_tipointer\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_tipinter;
    p_tipinter = new Properties();
    Properties p_xdescinter;
    p_xdescinter = new Properties();
    Properties p_opk_tipinter;
    p_opk_tipinter = new Properties();
    Properties p_m_nRowStatus;
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_tipinter,"",w_tipinter,trsrow);
      CPLib.PutProperty(p_xdescinter,"",w_xdescinter,trsrow);
      CPLib.PutProperty(p_opk_tipinter,"",opk_tipinter,trsrow);
    ...
    trs_p.setProperty("tipinter",CPLib.ToProperties(p_tipinter));
    trs_p.setProperty("xdescinter",CPLib.ToProperties(p_xdescinter));
    trs_p.setProperty("opk_tipinter",CPLib.ToProperties(p_opk_tipinter));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cauanainter"+"\\"+CPLib.ToCPStr(p_Caller.GetString("codcau","C",4,0));
  }
  public String RowPrimaryKey() {
    return "cauanainter"+"\\"+CPLib.ToCPStr(w_tipinter);
  }
  ...
  protected void TrsToWork() {
    w_tipinter= m_oTrs.get(m_nCurrentRow).w_tipinter;
    w_xdescinter= m_oTrs.get(m_nCurrentRow).w_xdescinter;
    opk_tipinter= m_oTrs.get(m_nCurrentRow).opk_tipinter;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_tipinter=w_tipinter;
    m_oTrs.get(m_nCurrentRow).w_xdescinter=w_xdescinter;
    m_oTrs.get(m_nCurrentRow).opk_tipinter=opk_tipinter;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_tipinter=w_tipinter;
    m_oDeletedRows.get(l_nRows).w_xdescinter=w_xdescinter;
    m_oDeletedRows.get(l_nRows).opk_tipinter=opk_tipinter;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_tipinter= m_oDeletedRows.get(l_RowNumberToSet).w_tipinter;
    w_xdescinter= m_oDeletedRows.get(l_RowNumberToSet).w_xdescinter;
    opk_tipinter= m_oDeletedRows.get(l_RowNumberToSet).opk_tipinter;
