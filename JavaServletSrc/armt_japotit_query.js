...
m_oFather.DoQueryFromChild('japotit',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
function DoQueryFrom_jntestit(firstAlias) {
return m_cVirtName+".CONNESCLI = "+firstAlias+".CODCLI ";
}
...
_chNotF(childAlias,'master','armt_japotit');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('japotit',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
