...
public class ardt_werzistifrzBL extends ardt_werzistifrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_werzistifrz";
  ...
  public CPPhTableWrInfo m_oWrInfo_werzistifrz;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_werzistifrz;
  ...
  public static String[] m_EntityTables = {"werzistifrz"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_werzistifrz",true,true)+"}"+FoundlingChildrenList("ardt_werzistifrz",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_werzistifrz",true,true)+"}"+FoundlingChildrenList("ardt_werzistifrz",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_werzistifrz",false,true)+"]"+FoundlingChildrenList("ardt_werzistifrz",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_werzistifrz"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_werzistifrzBL (CPContext p_ContextObject) {
    ...
    m_cPhName_werzistifrz = p_ContextObject.GetPhName("werzistifrz",p_ContextObject.GetCompany(),false);
    m_cServer_werzistifrz = p_ContextObject.GetServer("werzistifrz");
    m_oWrInfo_werzistifrz = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"werzistifrz",p_ContextObject.GetCompany());
    m_cVirtName_werzistifrz = CPSql.ManipulateTablePhName("werzistifrz",m_cServer_werzistifrz);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_werzistifrz",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_werzistifrz","werzistifrz",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_werzistifrz",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_werzistifrz",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_werzistifrz",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_werzistifrz",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_werzistifrz"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_werzistifrz\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "werzistifrz"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "werzistifrz"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
