...
public class arpg_scaricodatiBL extends arpg_scaricodatiWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_scaricodati";
  ...
  public static final String i_CompleteStateStructure = "{'iniz':iniz,'seco':seco,'dadata':dadata,'a_data':a_data,'datpri':datpri,'datseci':datseci,'datsecf':datsecf,'darett':darett,'a_rett':a_rett,'files':files,'bloccaedit':bloccaedit}";
  ...
  public arpg_scaricodatiBL (CPContext p_ContextObject) {
  ...
  public boolean Set_a_rett(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = CPLib.gt(w_a_rett,w_darett) && CPLib.eq(w_bloccaedit,"N");
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data fine periodo deve essere superiore a quella di inizo periodo";
    }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_scaricodati","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
