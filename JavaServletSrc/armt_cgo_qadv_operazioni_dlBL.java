...
public class armt_cgo_qadv_operazioni_dlBL extends armt_cgo_qadv_operazioni_dlWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_cgo_qadv_operazioni_dl";
  ...
  public CPPhTableWrInfo m_oWrInfo_cgo_qadv_operazioni_dl;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cgo_qadv_operazioni_dl;
  ...
  public armt_cgo_qadv_operazioni_dlBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cgo_qadv_operazioni_dl = p_ContextObject.GetPhName("cgo_qadv_operazioni_dl",p_ContextObject.GetCompany(),false);
    m_cServer_cgo_qadv_operazioni_dl = p_ContextObject.GetServer("cgo_qadv_operazioni_dl");
    m_oWrInfo_cgo_qadv_operazioni_dl = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cgo_qadv_operazioni_dl",p_ContextObject.GetCompany());
    m_cVirtName_cgo_qadv_operazioni_dl = CPSql.ManipulateTablePhName("cgo_qadv_operazioni_dl",m_cServer_cgo_qadv_operazioni_dl);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("armt_cgo_qadv_operazioni_dl",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Calculate() {
    ...
    l_bResult = true;
    m_bCalculating = true;
    if (CPLib.ne(o_QADV_DOMANDA01,w_QADV_DOMANDA01) || CPLib.ne(o_QADV_DOMANDA02,w_QADV_DOMANDA02) || CPLib.ne(o_QADV_DOMANDA03,w_QADV_DOMANDA03) || CPLib.ne(o_QADV_DOMANDA04,w_QADV_DOMANDA04) || CPLib.ne(o_QADV_DOMANDA05,w_QADV_DOMANDA05) || CPLib.ne(o_QADV_DOMANDA06,w_QADV_DOMANDA06) || CPLib.ne(o_QADV_DOMANDA07,w_QADV_DOMANDA07) || CPLib.ne(o_QADV_DOMANDA08,w_QADV_DOMANDA08) || CPLib.ne(o_QADV_DOMANDA09,w_QADV_DOMANDA09) || CPLib.ne(o_QADV_DOMANDA10,w_QADV_DOMANDA10) || CPLib.ne(o_QADV_DOMANDA11,w_QADV_DOMANDA11) || CPLib.ne(o_QADV_DOMANDA12,w_QADV_DOMANDA12) || CPLib.ne(o_QADV_DOMANDA03_1,w_QADV_DOMANDA03_1) || CPLib.ne(o_QADV_DOMANDA03_2,w_QADV_DOMANDA03_2) || CPLib.ne(o_QADV_DOMANDA03_3,w_QADV_DOMANDA03_3) || CPLib.ne(o_QADV_DOMANDA04_1,w_QADV_DOMANDA04_1) || CPLib.ne(o_QADV_DOMANDA04_2,w_QADV_DOMANDA04_2) || CPLib.ne(o_QADV_DOMANDA04_3,w_QADV_DOMANDA04_3) || CPLib.ne(o_QADV_DOMANDA04_4,w_QADV_DOMANDA04_4)) {
  ...
  void Calculation_WOOQKMYMKN() {
    arrt_cgo_punteggio_adv_dlR l_oRoutine_arrt_cgo_punteggio_adv_dl;
    l_oRoutine_arrt_cgo_punteggio_adv_dl = arrt_cgo_punteggio_adv_dlR.Make(m_Ctx,this);
    l_oRoutine_arrt_cgo_punteggio_adv_dl.pObj = this;
    l_oRoutine_arrt_cgo_punteggio_adv_dl.Run();
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_cgo_qadv_operazioni_dl","cgo_qadv_operazioni_dl",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_cgo_qadv_operazioni_dl",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_cgo_qadv_operazioni_dl",child);
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("armt_cgo_qadv_operazioni_dl",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_cgo_qadv_operazioni_dl"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_cgo_qadv_operazioni_dl\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cgo_qadv_operazioni_dl"+"\\"+CPLib.ToCPStr(p_Caller.GetString("SNAINUMOPE","C",15,0));
  }
