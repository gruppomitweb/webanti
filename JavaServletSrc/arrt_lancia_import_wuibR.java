...
// * --- Fine Area Manuale
public class arrt_lancia_import_wuibR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public arrt_lancia_import_wuibR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_lancia_import_wuib",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "arrt_lancia_import_wuib";
  ...
  void Page_1() throws Exception {
    ...
    /* Stop arpg_import_wuib */
    Forward f;
    f=new Forward("arpg_import_wuib",false,this,Forward.Start,false);
  ...
  public static arrt_lancia_import_wuibR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_lancia_import_wuibR(p_Ctx, p_Caller);
  }
  public void Blank() {
