...
m_oFather.DoQueryFromChild('xperazbo',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
function DoQueryFrom_xogopebo(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xlientiope(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xeneficope(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xerzistiope(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_xapcoll(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDFILEBO ";
}
function DoQueryFrom_docopebo(firstAlias) {
return m_cVirtName+".NUMPROG = "+firstAlias+".NUMPROG ";
}
function DoQueryFrom_xperazbo_agg(firstAlias) {
return m_cVirtName+".IDBASE = "+firstAlias+".IDBASE ";
}
function DoQueryFrom_xpe_contante(firstAlias) {
...
_chNotF(childAlias,'master','armt_oprovvisorie');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('xperazbo',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
