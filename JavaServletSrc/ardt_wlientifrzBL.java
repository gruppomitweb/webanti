...
public class ardt_wlientifrzBL extends ardt_wlientifrzWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_wlientifrz";
  ...
  public CPPhTableWrInfo m_oWrInfo_wlientifrz;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_wlientifrz;
  ...
  public static String[] m_EntityTables = {"wlientifrz"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG"+FoundlingChildrenList("ardt_wlientifrz",true,true)+"}"+FoundlingChildrenList("ardt_wlientifrz",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'xragsoc':xragsoc,'DOMICILIO':DOMICILIO,'DESCCIT':DESCCIT,'PROVINCIA':PROVINCIA,'CAP':CAP"+FoundlingChildrenList("ardt_wlientifrz",true,true)+"}"+FoundlingChildrenList("ardt_wlientifrz",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG"+FoundlingChildrenList("ardt_wlientifrz",false,true)+"]"+FoundlingChildrenList("ardt_wlientifrz",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_wlientifrz"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"}});
  ...
  public ardt_wlientifrzBL (CPContext p_ContextObject) {
    ...
    m_cPhName_wlientifrz = p_ContextObject.GetPhName("wlientifrz",p_ContextObject.GetCompany(),false);
    m_cServer_wlientifrz = p_ContextObject.GetServer("wlientifrz");
    m_oWrInfo_wlientifrz = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"wlientifrz",p_ContextObject.GetCompany());
    m_cVirtName_wlientifrz = CPSql.ManipulateTablePhName("wlientifrz",m_cServer_wlientifrz);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_wlientifrz",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_wlientifrz","wlientifrz",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_wlientifrz",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_wlientifrz",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_wlientifrz",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_wlientifrz",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_wlientifrz"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_wlientifrz\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "wlientifrz"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "wlientifrz"+"\\"+CPLib.ToCPStr(w_CODSOG);
  }
