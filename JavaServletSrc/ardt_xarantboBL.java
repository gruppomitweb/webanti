...
public class ardt_xarantboBL extends ardt_xarantboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_xarantbo";
  ...
  public CPPhTableWrInfo m_oWrInfo_xarantbo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_xarantbo;
  ...
  public static String[] m_EntityTables = {"xarantbo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'xRagSoc':xRagSoc"+FoundlingChildrenList("ardt_xarantbo",true,true)+"}"+FoundlingChildrenList("ardt_xarantbo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'m_Detail':{'CODINTER':CODINTER,'DATAINI':DATAINI,'DATAFINE':DATAFINE,'IDBASE':IDBASE,'xRagSoc':xRagSoc"+FoundlingChildrenList("ardt_xarantbo",true,true)+"}"+FoundlingChildrenList("ardt_xarantbo",true,false)+"}";
  public static final String i_ItemSequence = "RAPPORTO,m_Detail[ CODINTER DATAINI DATAFINE xRagSoc"+FoundlingChildrenList("ardt_xarantbo",false,true)+"]"+FoundlingChildrenList("ardt_xarantbo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_xarantbo"),new String[][]{new String[]{"RAPPORTO","Rapporto","C","25","0","campo","key1","false","false"},new String[]{"CODINTER","Garantito","C","16","0","campo","key1","true","false"},new String[]{"DATAINI","Data Inizio","D","8","0","campo","nokey","true","false"},new String[]{"DATAFINE","Data Fine","D","8","0","campo","nokey","true","false"},new String[]{"xRagSoc","Ragione Sociale","C","70","0","variabile","nokey","true","false"}});
  ...
  public ardt_xarantboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_xarantbo = p_ContextObject.GetPhName("xarantbo",p_ContextObject.GetCompany(),false);
    m_cServer_xarantbo = p_ContextObject.GetServer("xarantbo");
    m_oWrInfo_xarantbo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"xarantbo",p_ContextObject.GetCompany());
    m_cVirtName_xarantbo = CPSql.ManipulateTablePhName("xarantbo",m_cServer_xarantbo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xarantbo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_xarantbo","xarantbo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_xarantbo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_xarantbo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_xarantbo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_xarantbo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_xarantbo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_xarantbo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "xarantbo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("RAPPORTO","C",25,0));
  }
  public String RowPrimaryKey() {
    return "xarantbo"+"\\"+CPLib.ToCPStr(w_CODINTER);
  }
