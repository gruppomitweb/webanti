...
parent.ZtVWeb.raiseEventToEvalParms('armt_tipdoc_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('armt_tipdoc_dataNotSent',{'action':formaction});
}
}
}
}
