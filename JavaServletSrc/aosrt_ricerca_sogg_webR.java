...
// * --- Fine Area Manuale
public class aosrt_ricerca_sogg_webR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public aosrt_ricerca_sogg_webR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("aosrt_ricerca_sogg_web",m_Caller);
  ...
  void Page_1() throws Exception {
    ...
    CPResultSet Cursor_qbe_ric_denom_web=null;
    CPResultSet Cursor_qbe_ric_denom_afon_web=null;
    ...
    try {
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on cptsrvr into routine aosrt_ricerca_sogg_web returns two or more records. This item should return only a record.");
      ...
      if (CPLib.eqr(w_criterio,"D")) {
        ...
        if (CPLib.eqr(w_flgafon,"N")) {
          ...
          Cursor_webaos_soggettiweb = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAGSOC = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_denom,"?",0,0,m_cServer, m_oParameters),m_cServer,_denom)+" "+")"+(m_Ctx.IsSharedTemp("webaos_soggettiweb")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
          while ( ! (Cursor_webaos_soggettiweb.Eof())) {
            ...
            m_cSql = CPLib.GetSQLPrefixComment("aosrt_ricerca_sogg_web",47,"0000002C")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
            m_cSql = m_cSql+GetFieldsName_0000002C(m_Ctx,m_oWrInfo);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("APPOGGIO"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("CARICA"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("CHIAVEREP"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("COSAFARE"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetDouble("CUT"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetDouble("ENTITY_ID"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("FLAG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetDouble("IDORIG"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("LEGAL_B"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("LISTA"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("NOME_COMPL"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("NOTE"),"?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("PDF"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("PROGRAMM"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("RAGSOC"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("RAGSOCBLK"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("RAGSOCBLOK"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("RAGSOCX"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetDate("REG_DATE"),"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("RIFERIM"),"?",0,0,m_cServer, m_oParameters)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("SOUNDMAX"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("SPEC"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_webaos_soggettiweb.GetString("TIPO"),"?",0,0,m_cServer)+", ";
          ...
          while ( ! (Cursor_webaos_soggettiweb.Eof())) {
            ...
            m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_seek_sogg",m_Ctx.GetCompany());
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.GetSQLPrefixComment("aosrt_ricerca_sogg_web",47,"00000030")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        ...
        if (CPLib.gt(_count,0)) {
          ...
          /* If w_flgafon = 'N' */
          if (CPLib.eqr(w_flgafon,"N")) {
            // * --- Select from qbe_ric_denom_web
            if (Cursor_qbe_ric_denom_web!=null)
              Cursor_qbe_ric_denom_web.Close();
            Cursor_qbe_ric_denom_web = new VQRHolder("qbe_ric_denom_web",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
            while ( ! (Cursor_qbe_ric_denom_web.Eof())) {
              // * --- Insert into tmp_seek_sogg from values
              m_Sql.RequireTransaction();
              m_cServer = m_Ctx.GetServer("tmp_seek_sogg");
              m_cPhName = m_Ctx.GetPhName("tmp_seek_sogg");
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_seek_sogg",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("aosrt_ricerca_sogg_web",47,"00000072")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000072(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("NOTE"),"?",0,0,m_cServer, m_oParameters)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("TIPO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("RAGSOCX"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("RAGSOCBLK"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("FLAG"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("APPOGGIO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("SPEC"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("RIFERIM"),"?",0,0,m_cServer, m_oParameters)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("COSAFARE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("SOUNDMAX"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("LISTA"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("CARICA"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("PDF"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetDouble("IDORIG"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("NOME_COMPL"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetDouble("ENTITY_ID"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetDate("REG_DATE"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("PROGRAMM"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("LEGAL_B"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetDouble("CUT"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("RAGSOCBLOK"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("RAGSOC"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_web.GetString("CHIAVEREP"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+m_oWrInfo.InsertValues();
              m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"tmp_seek_sogg",true);
              m_cSql = m_cSql+")";
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
              ...
              /* _conta := _conta + 1 */
              _conta = CPLib.Round(_conta+1,0);
              Cursor_qbe_ric_denom_web.Next();
            }
            m_cConnectivityError = Cursor_qbe_ric_denom_web.ErrorMessage();
            Cursor_qbe_ric_denom_web.Close();
            // * --- End Select
          } else { // Else
            // * --- Select from qbe_ric_denom_afon_web
            if (Cursor_qbe_ric_denom_afon_web!=null)
              Cursor_qbe_ric_denom_afon_web.Close();
            Cursor_qbe_ric_denom_afon_web = new VQRHolder("qbe_ric_denom_afon_web",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
            while ( ! (Cursor_qbe_ric_denom_afon_web.Eof())) {
              // * --- Insert into tmp_seek_sogg from values
              m_Sql.RequireTransaction();
              m_cServer = m_Ctx.GetServer("tmp_seek_sogg");
              m_cPhName = m_Ctx.GetPhName("tmp_seek_sogg");
              m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_seek_sogg",m_Ctx.GetCompany());
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.GetSQLPrefixComment("aosrt_ricerca_sogg_web",47,"00000075")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
              m_cSql = m_cSql+GetFieldsName_00000075(m_Ctx,m_oWrInfo);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("IDBASE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("NOTE"),"?",0,0,m_cServer, m_oParameters)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("TIPO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("RAGSOCX"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("RAGSOCBLK"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("FLAG"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("APPOGGIO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("SPEC"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("RIFERIM"),"?",0,0,m_cServer, m_oParameters)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("COSAFARE"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("SOUNDMAX"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("LISTA"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("CARICA"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("PDF"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetDouble("IDORIG"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("NOME_COMPL"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetDouble("ENTITY_ID"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetDate("REG_DATE"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("PROGRAMM"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("LEGAL_B"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetDouble("CUT"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("RAGSOC"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_ric_denom_afon_web.GetString("CHIAVEREP"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+m_oWrInfo.InsertValues();
              m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"tmp_seek_sogg",true);
              m_cSql = m_cSql+")";
              m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
              ...
              /* _conta := _conta + 1 */
              _conta = CPLib.Round(_conta+1,0);
              Cursor_qbe_ric_denom_afon_web.Next();
            }
            m_cConnectivityError = Cursor_qbe_ric_denom_afon_web.ErrorMessage();
            Cursor_qbe_ric_denom_afon_web.Close();
            // * --- End Select
          } // End If
        } // End If
      ...
      if (CPLib.eqr(_conta,0)) {
        ...
        if (CPLib.eqr(w_flgnega,"S")) {
          ...
          m_oWrInfo = CPPhTableWrInfo.GetCPPhTableWrInfo(m_Ctx,"tmp_seek_sogg",m_Ctx.GetCompany());
          m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
          m_cSql = CPLib.GetSQLPrefixComment("aosrt_ricerca_sogg_web",47,"00000079")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
          ...
          /* w_nomereport := 'aosrp_ricerca_sogg_neg' */
          w_nomereport = "aosrp_ricerca_sogg_neg";
        } // End If
      } else { // Else
        /* w_nomereport := 'aosrp_ricerca_sogg_web' */
        w_nomereport = "aosrp_ricerca_sogg_web";
      } // End If
  ...
  public static aosrt_ricerca_sogg_webR Make(CPContext p_Ctx, Caller p_Caller) {
    return new aosrt_ricerca_sogg_webR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_ric_denom_web,qbe_ric_denom_afon_web,
  public static final String m_cVQRList = ",qbe_ric_denom_web,qbe_ric_denom_afon_web,";
  ...
  protected static String GetFieldsName_0000002C(CPContext p_Ctx,CPPhTableWrInfo p_oWrInfo) {
    ...
    p_cSql = p_cSql+"CARICA,";
    p_cSql = p_cSql+"CHIAVEREP,";
    p_cSql = p_cSql+"COSAFARE,";
    p_cSql = p_cSql+"CUT,";
    p_cSql = p_cSql+"ENTITY_ID,";
    p_cSql = p_cSql+"FLAG,";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"IDORIG,";
    p_cSql = p_cSql+"LEGAL_B,";
    p_cSql = p_cSql+"LISTA,";
    p_cSql = p_cSql+"NOME_COMPL,";
    p_cSql = p_cSql+"NOTE,";
    p_cSql = p_cSql+"PDF,";
    p_cSql = p_cSql+"PROGRAMM,";
    p_cSql = p_cSql+"RAGSOC,";
    p_cSql = p_cSql+"RAGSOCBLK,";
    p_cSql = p_cSql+"RAGSOCBLOK,";
    p_cSql = p_cSql+"RAGSOCX,";
    p_cSql = p_cSql+"REG_DATE,";
    p_cSql = p_cSql+"RIFERIM,";
    p_cSql = p_cSql+"SOUNDMAX,";
    p_cSql = p_cSql+"SPEC,";
    p_cSql = p_cSql+"TIPO,";
