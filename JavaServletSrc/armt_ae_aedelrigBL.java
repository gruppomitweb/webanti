...
public class armt_ae_aedelrigBL extends armt_ae_aedelrigWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "armt_ae_aedelrig";
  ...
  public CPPhTableWrInfo m_oWrInfo_aederig;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_aederig;
  ...
  public CPPhTableWrInfo m_oWrInfo_aedecanc;
  ...
  public static String[] m_EntityTables = {"aederig"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'RAPPORTO':RAPPORTO,'COINT':COINT,'TIPOAG':TIPOAG,'IDBASE':IDBASE,'CONNESINT':CONNESINT,'ADATA':ADATA,'ASPEDITO':ASPEDITO,'AFILE':AFILE,'APROG':APROG,'CSPEDITO':CSPEDITO,'CPROG':CPROG,'CFILE':CFILE,'CDATA':CDATA,'IDESITO':IDESITO,'ADATARET':ADATARET,'RSPEDITO':RSPEDITO,'COLDFILE':COLDFILE,'COLDPROG':COLDPROG,'DATESITO':DATESITO"+FoundlingChildrenList("armt_ae_aedelrig",true)+"}";
  public static final String i_CompleteStateStructure = "{'RAPPORTO':RAPPORTO,'COINT':COINT,'TIPOAG':TIPOAG,'IDBASE':IDBASE,'CONNESINT':CONNESINT,'xcfestero':xcfestero,'ADATA':ADATA,'ASPEDITO':ASPEDITO,'AFILE':AFILE,'APROG':APROG,'AOLDPROG':AOLDPROG,'AOLDFILE':AOLDFILE,'CSPEDITO':CSPEDITO,'CPROG':CPROG,'COLDPROG':COLDPROG,'CFILE':CFILE,'COLDFILE':COLDFILE,'IDRIF':IDRIF,'NOCODFISC':NOCODFISC,'ADTPRE':ADTPRE,'CDTPRE':CDTPRE,'xragsoc':xragsoc,'CDATA':CDATA,'IDESITO':IDESITO,'PROGDLG':PROGDLG,'ADATARET':ADATARET,'RSPEDITO':RSPEDITO,'desctrap':desctrap,'dtcanc':dtcanc,'spcanc':spcanc,'filecanc':filecanc,'idcanc':idcanc,'DATESITO':DATESITO"+FoundlingChildrenList("armt_ae_aedelrig",true)+"}";
  public static final String i_ItemSequence = "RAPPORTO,COINT,TIPOAG,IDBASE,CONNESINT,ADATA,ASPEDITO,AFILE,APROG,CSPEDITO,CPROG,CFILE,CDATA,IDESITO,ADATARET,RSPEDITO,COLDFILE,COLDPROG,DATESITO"+FoundlingChildrenList("armt_ae_aedelrig",false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("armt_ae_aedelrig"),new String[][]{new String[]{"RAPPORTO","Codice Rapporto","C","25","0","campo","key2","false","false"},new String[]{"COINT","Tipo Rapporto","C","1","0","campo","nokey","false","false"},new String[]{"TIPOAG","","C","2","0","campo","nokey","false","false"},new String[]{"IDBASE","","C","10","0","campo","key1","false","false"},new String[]{"CONNESINT","Codice Delegato","C","16","0","campo","key3","false","false"},new String[]{"ADATA","data Inizio","D","8","0","campo","nokey","false","false"},new String[]{"ASPEDITO","Spedito Agenzia Entrate","N","1","0","campo","nokey","false","false"},new String[]{"AFILE","Nome File Spedizione","C","15","0","campo","nokey","false","false"},new String[]{"APROG","Progressivo","C","25","0","campo","nokey","false","false"},new String[]{"CSPEDITO","Spedizione Chiusura","N","1","0","campo","nokey","false","false"},new String[]{"CPROG","Progressivo Atuale","C","25","0","campo","nokey","false","false"},new String[]{"CFILE","Nome file spedizione chiusura","C","15","0","campo","nokey","false","false"},new String[]{"CDATA","data Inizio","D","8","0","campo","nokey","false","false"},new String[]{"IDESITO","Esito AGE","C","8","0","campo","nokey","false","false"},new String[]{"ADATARET","Data Rettifica","D","8","0","campo","nokey","false","false"},new String[]{"RSPEDITO","","N","1","0","campo","nokey","false","false"},new String[]{"COLDFILE","Vecchio file spedizione chiusura","C","15","0","campo","nokey","false","false"},new String[]{"COLDPROG","Vecchio Progressivo","C","25","0","campo","nokey","false","false"},new String[]{"DATESITO","Data Creazione Esito","D","8","0","campo","nokey","false","false"}});
  ...
  public armt_ae_aedelrigBL (CPContext p_ContextObject) {
    ...
    m_cPhName_aederig = p_ContextObject.GetPhName("aederig",p_ContextObject.GetCompany(),false);
    m_cServer_aederig = p_ContextObject.GetServer("aederig");
    m_oWrInfo_aederig = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"aederig",p_ContextObject.GetCompany());
    m_cVirtName_aederig = CPSql.ManipulateTablePhName("aederig",m_cServer_aederig);
    ...
    m_oWrInfo_aedecanc = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"aedecanc",p_ContextObject.GetCompany());
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("armt_ae_aedelrig",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_VQOCGQDTYC(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_IDBASE))) {
      ...
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_IDBASE,"C",10,0),m_cServer_aedecanc,w_IDBASE);
      if (m_Ctx.IsSharedTemp("aedecanc")) {
        l_cWhere = l_cWhere+" and context_id='"+m_Ctx.GetTempID()+"'";
      }
      if (l_rsLink!=null)
        l_rsLink.Close();
      l_rsLink = m_Sql.Query(m_cServer_aedecanc,"select IDBASE,IDFILE,IDPROG,SPEDITO,DATARIF from "+m_cPhName_aedecanc+((m_cPhName_aedecanc).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"IDBASE"+l_cCurrentKey+l_cWhere);
      try {
        l_bLoaded =  ! (l_rsLink.Eof());
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("armt_ae_aedelrig","aederig",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_PROGDLG = CPLib.GetProperty(p,"PROGDLG",w_PROGDLG,0);
      op_PROGDLG = CPLib.GetProperty(p,"op_PROGDLG",0,0);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map = new HashMap<String,String[]>();
    items = tables.get("aedecanc");
    if (CPLib.IsNull(items)) {
      items = new ArrayList<Map<String,String[]>>();
      tables.put("aedecanc",items);
    }
    items.add(map);
    map.put("rd_kvar",new String[]{});
    map.put("rd_kfield",new String[]{});
    ...
    map.put("rd_kvar.obj",new String[]{});
    map.put("property.value",zeroSplit.split("aedecanc\u0000false\u0000true\u00001\u00000\u0000\u0000true\u0000false\u0000\u0000\u0000\u0000false",-1));
    map.put("property.name",zeroSplit.split("arch\u0000fillemptykey\u0000looselylinked\u0000src_key\u0000hst_link_mode\u0000prg_zoom\u0000looselylinked\u0000sendkeystozoomonzoom\u0000zoom_title\u0000prg_link_search\u0000prg_link_defaults\u0000",-1));
  }
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("armt_ae_aedelrig",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("armt_ae_aedelrig",child);
  ...
  public void Initialize() {
    ...
    InitAutonumber();
    op_codazi = m_Ctx.GetCompany();
    m_MNTs = CPLib.MNTChilds("armt_ae_aedelrig",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"armt_ae_aedelrig"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"armt_ae_aedelrig\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  void InitAutonumber() {
    ...
    w_IDBASE = m_Ctx.AskTableProg(w_IDBASE,10,op_IDBASE,"PRGAEDELEG"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_aederig);
    // For each autonumbered field set according to values in table CPWARN 
    // Segna le variabili coinvolte in un progressivo: se al salvataggio hanno
    // lo stesso valore vuol dire che l' utente accetta il progressivo proposto.
    w_PROGDLG = m_Ctx.AskTableProg(w_PROGDLG,15,op_PROGDLG,"PROGAED"+"\\"+CPLib.ToCPWarnStr(m_Ctx.GetCompany(),10),m_cServer_aederig);
    op_codazi = m_Ctx.GetCompany();
    op_IDBASE = w_IDBASE;
    o_IDBASE = w_IDBASE;
    op_PROGDLG = w_PROGDLG;
    o_IDBASE = w_IDBASE;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    CPLib.PutProperty(p,"PROGDLG",w_PROGDLG,0);
    CPLib.PutProperty(p,"op_PROGDLG",op_PROGDLG,0);
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "aederig"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDBASE","C",10,0));
  }
  ...
  public static List<List<String>> StaticAutonumDefinition() {
    ...
    oneAutoNum.add("PRGAEDELEG");
    oneAutoNum.add("");
    autonums.add(oneAutoNum);
    oneAutoNum = new ArrayList<String>();
    oneAutoNum.add("i_codazi,w_PROGDLG");
