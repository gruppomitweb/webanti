...
var tmp_TYIWXFLLFY = ToHTag(AsControlValue('<iframe width=\'100%\' height=\'100%\' id=\'elaborazione\'  name=\'elaborazione\'</iframe>'));
...
l_oWv.setValue('w_ADatFin',AsAppletValue(w_ADatFin));
l_oWv.setValue('w_ADatIni',AsAppletValue(w_ADatIni));
l_oWv.setValue('w_aRappo',AsAppletValue(w_aRappo));
l_oWv.setValue('w_DaDatFin',AsAppletValue(w_DaDatFin));
l_oWv.setValue('w_DaDatIni',AsAppletValue(w_DaDatIni));
l_oWv.setValue('w_daRappo',AsAppletValue(w_daRappo));
l_oWv.setValue('w_tipo',AsAppletValue(w_tipo));
l_oWv.setValue('m_cParameterSequence',AsAppletValue('w_ADatFin,w_ADatIni,w_aRappo,w_DaDatFin,w_DaDatIni,w_daRappo,w_tipo'));
SetLocationHref(null,'arrt_stprappo_elenco'+'?m_cWv='+URLenc(l_oWv.asString())+'&m_cAction=start&m_cMode=hyperlink','elaborazione')
}
...
function Help() {
windowOpenForeground('../doc/arpg_stprappo_sint_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_stprappo_sint',m_cSelectedPage);
