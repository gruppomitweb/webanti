...
public class arpg_stp_stdtec_ope_new_mtBL extends arpg_stp_stdtec_ope_new_mtWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_stp_stdtec_ope_new_mt";
  ...
  public static final String i_StateStructure = "{'tipopdf':tipopdf,'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'DaDatReg':DaDatReg,'ADatReg':ADatReg,'daCodCli':daCodCli,'aCodCli':aCodCli}";
  public static final String i_CompleteStateStructure = "{'tipopdf':tipopdf,'daCodDip':daCodDip,'aCodDip':aCodDip,'DaDatOpe':DaDatOpe,'ADatOpe':ADatOpe,'DaDatReg':DaDatReg,'ADatReg':ADatReg,'daCodCli':daCodCli,'aCodCli':aCodCli,'RAGSOC1':RAGSOC1,'RAGSOC2':RAGSOC2,'DESCRIZ1':DESCRIZ1,'DESCRIZ2':DESCRIZ2,'flgrae':flgrae}";
  public static final String i_ItemSequence = "tipopdf,daCodDip,aCodDip,DaDatOpe,ADatOpe,DaDatReg,ADatReg,daCodCli,aCodCli";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"tipopdf","Tipologia PDF","C","6","0","variabile","nokey","false","false"},new String[]{"daCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"aCodDip","","C","6","0","variabile","nokey","false","false"},new String[]{"DaDatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatOpe","","D","8","0","variabile","nokey","false","false"},new String[]{"DaDatReg","","D","8","0","variabile","nokey","false","false"},new String[]{"ADatReg","","D","8","0","variabile","nokey","false","false"},new String[]{"daCodCli","","C","16","0","variabile","nokey","false","false"},new String[]{"aCodCli","","C","16","0","variabile","nokey","false","false"}});
  ...
  public arpg_stp_stdtec_ope_new_mtBL (CPContext p_ContextObject) {
  ...
  public boolean getVisible_daCodCli() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  public boolean getVisible_aCodCli() {
    return CPLib.eq(w_tipopdf,"PDFA1B");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_stp_stdtec_ope_new_mt","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
