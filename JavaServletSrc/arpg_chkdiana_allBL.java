...
public class arpg_chkdiana_allBL extends arpg_chkdiana_allWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_chkdiana_all";
  ...
  public static final String i_StateStructure = "{'codinter':codinter,'tipinter':tipinter,'codage':codage,'codcli':codcli,'ragben':ragben,'DaData':DaData,'AData':AData,'DaDataReg':DaDataReg,'ADataReg':ADataReg,'tipoarch':tipoarch,'flgrae':flgrae,'flgope':flgope,'flgfrz':flgfrz,'flgrap':flgrap,'tiprap':tiprap,'flgtit':flgtit,'tiptip':tiptip,'flgint':flgint,'flgdel':flgdel,'flgchk':flgchk,'flgsto':flgsto,'destfold':destfold,'stoper':stoper,'flgxls':flgxls}";
  public static final String i_CompleteStateStructure = "{'gIntemediario':gIntemediario,'gTipInter':gTipInter,'codinter':codinter,'xragsoc':xragsoc,'tipinter':tipinter,'codage':codage,'codcli':codcli,'ragben':ragben,'DaData':DaData,'AData':AData,'DaDataReg':DaDataReg,'ADataReg':ADataReg,'tipoarch':tipoarch,'flgrae':flgrae,'flgope':flgope,'flgfrz':flgfrz,'flgrap':flgrap,'tiprap':tiprap,'flgtit':flgtit,'tiptip':tiptip,'flgint':flgint,'flgdel':flgdel,'flgchk':flgchk,'flgsto':flgsto,'destfold':destfold,'xdesage':xdesage,'gUrlApp':gUrlApp,'gAzienda':gAzienda,'gFlgWU':gFlgWU,'xragcli':xragcli,'gWebCHK':gWebCHK,'stoper':stoper,'flgxls':flgxls}";
  public static final String i_ItemSequence = "codinter,tipinter,codage,codcli,ragben,DaData,AData,DaDataReg,ADataReg,tipoarch,flgrae,flgope,flgfrz,flgrap,tiprap,flgtit,tiptip,flgint,flgdel,flgchk,flgsto,destfold,stoper,flgxls";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"codinter","","C","11","0","variabile","nokey","false","false"},new String[]{"tipinter","","C","2","0","variabile","nokey","false","false"},new String[]{"codage","Agenzia/Dipendenza:","C","6","0","variabile","nokey","false","false"},new String[]{"codcli","Cliente","C","16","0","variabile","nokey","false","false"},new String[]{"ragben","Beneficiario","C","70","0","variabile","nokey","false","false"},new String[]{"DaData","","D","8","0","variabile","nokey","false","false"},new String[]{"AData","","D","8","0","variabile","nokey","false","false"},new String[]{"DaDataReg","","D","8","0","variabile","nokey","false","false"},new String[]{"ADataReg","","D","8","0","variabile","nokey","false","false"},new String[]{"tipoarch","","C","1","0","variabile","nokey","false","false"},new String[]{"flgrae","","C","1","0","variabile","nokey","false","false"},new String[]{"flgope","","C","10","0","variabile","nokey","false","false"},new String[]{"flgfrz","","C","10","0","variabile","nokey","false","false"},new String[]{"flgrap","","C","1","0","variabile","nokey","false","false"},new String[]{"tiprap","","C","1","0","variabile","nokey","false","false"},new String[]{"flgtit","","C","1","0","variabile","nokey","false","false"},new String[]{"tiptip","","C","1","0","variabile","nokey","false","false"},new String[]{"flgint","","C","1","0","variabile","nokey","false","false"},new String[]{"flgdel","","C","1","0","variabile","nokey","false","false"},new String[]{"flgchk","","C","10","0","variabile","nokey","false","false"},new String[]{"flgsto","","C","1","0","variabile","nokey","false","false"},new String[]{"destfold","Cartella Destinazione","C","80","0","variabile","nokey","false","false"},new String[]{"stoper","","C","1","0","variabile","nokey","false","false"},new String[]{"flgxls","","C","10","0","variabile","nokey","false","false"}});
  ...
  public arpg_chkdiana_allBL (CPContext p_ContextObject) {
  ...
  public boolean Set_DaData(java.sql.Date p_workVariableValue) {
    ...
    // 
    l_bResult = ( ! (CPLib.Empty(w_AData))?CPLib.le(w_DaData,w_AData):true);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di inizio periodo deve essere uguale o inferiore a quella di fine periodo";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_DaData = CPLib.NullDate();
  ...
  public boolean Set_AData(java.sql.Date p_workVariableValue) {
    ...
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di fine periodo deve essere maggiore di quella di inizio periodo";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_AData = CPLib.NullDate();
  ...
  public boolean Set_DaDataReg(java.sql.Date p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_DaDataReg = p_workVariableValue;
    // 
    l_bResult = ( ! (CPLib.Empty(w_ADataReg))?CPLib.le(w_DaDataReg,w_ADataReg):true);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di inizio registrazione deve essere uguale o inferiore a quella di fine registrazione";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_DaDataReg = CPLib.NullDate();
  ...
  public boolean Set_ADataReg(java.sql.Date p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_ADataReg = p_workVariableValue;
    // 
    l_bResult = CPLib.ge(w_ADataReg,w_DaDataReg);
    if ( ! (l_bResult)) {
      m_nLastError = 2;
      m_cLastMsgError = "La data di fine registrazione deve essere maggiore di quella di inizio registrazione";
    }
    if ( ! (l_bResult)) {
      // Impostazione a blank della variabile di work
      w_ADataReg = CPLib.NullDate();
  ...
  public boolean Set_tiptip(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public boolean Set_stoper(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
    ...
    boolean l_bTmpRes;
    SetUpdated();
    w_stoper = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_flgxls(String p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public boolean getWritable_tiptip() {
    return CPLib.eq(w_flgtit,"S");
  }
  ...
  public boolean getVisible_flgxls() {
    return CPLib.ne(w_gWebCHK,"S");
  }
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_chkdiana_all","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      w_DaDataReg = CPLib.GetProperty(p,"DaDataReg",w_DaDataReg,0);
      w_ADataReg = CPLib.GetProperty(p,"ADataReg",w_ADataReg,0);
      ...
      w_tiptip = CPLib.GetProperty(p,"tiptip",w_tiptip,0);
      ...
      w_stoper = CPLib.GetProperty(p,"stoper",w_stoper,0);
      w_flgxls = CPLib.GetProperty(p,"flgxls",w_flgxls,0);
      SetUpdated();
      if ( ! (l_bFromHyperlink)) {
        SaveDependsOn();
      }
