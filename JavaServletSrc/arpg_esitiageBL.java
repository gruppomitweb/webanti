...
public class arpg_esitiageBL extends arpg_esitiageWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_trueident;
    public String c_rapporto;
    public String c_connes;
    public String c_ragsoc;
    public String c_aprog;
    public String c_afile;
    public String c_cprog;
    public String c_cfile;
  ...
  public static final String i_EntityName = "arpg_esitiage";
  ...
  public arpg_esitiageBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_esitiage","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_trueident=c_trueident;
    ...
    m_oTrs.get(m_nCurrentRow).c_aprog=c_aprog;
    m_oTrs.get(m_nCurrentRow).c_afile=c_afile;
    m_oTrs.get(m_nCurrentRow).c_cprog=c_cprog;
    m_oTrs.get(m_nCurrentRow).c_cfile=c_cfile;
    m_oTrs.get(m_nCurrentRow).m_nRowStatus=m_nRowStatus;
  }
  public void TrsToWork() {
    c_trueident= m_oTrs.get(m_nCurrentRow).c_trueident;
    ...
    c_aprog= m_oTrs.get(m_nCurrentRow).c_aprog;
    c_afile= m_oTrs.get(m_nCurrentRow).c_afile;
    c_cprog= m_oTrs.get(m_nCurrentRow).c_cprog;
    c_cfile= m_oTrs.get(m_nCurrentRow).c_cfile;
