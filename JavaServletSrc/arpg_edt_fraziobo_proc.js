...
if (false || WindowConfirm(Translate('2101536212'))) {
...
SetHypPar('m_cID',AsAppletValue(m_IDS['arrt_edt_fraziobo']));
SendData('start','arrt_edt_fraziobo'+'',HParApplet().asString());
}
}
...
function Help() {
windowOpenForeground('../doc/arpg_edt_fraziobo_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
p_d.setValue('arpg_edt_fraziobo',m_cSelectedPage);
