...
public class arfn_import_correzioni_sv_wu extends SPRoutineServlet implements SPInvokable {
  public static String m_cEntityUid = "!*a2fe6336*!";
  ...
  public SPEntityGlobals getEntityGlobals() {
    ...
    l_eg.name = "arfn_import_correzioni_sv_wu";
  ...
  private void ExecuteRoutine(ServletStatus status) throws IOException {
    arfn_import_correzioni_sv_wuR Rcalled;
    Rcalled = new arfn_import_correzioni_sv_wuR(status.context,status);
  ...
  CallerWithObjs NewRoutine(SPServletStatus status,Caller dataFromClient) {
    return new arfn_import_correzioni_sv_wuR(status.context,dataFromClient);
  }
  protected void BringBackPage(ServletStatus status,arfn_import_correzioni_sv_wuR Rcalled) throws IOException {
    String l_cErrMsg;
    String msg;
    ...
    if ( ! (CPLib.Empty(status.m_cFaultTrace))) {
      status.out.println("Fault:["+SPLib.ToJSValue(status.context.Translate("MSG_ROUTINE_FAULTED","arfn_import_correzioni_sv_wu"),"C",0,0)+","+SPLib.ToJSValue(status.m_cFaultTrace,"C",0,0)+"]");
