...
public class ardt_beneficopeBL extends ardt_beneficopeWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_beneficope";
  ...
  public CPPhTableWrInfo m_oWrInfo_beneficope;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_beneficope;
  ...
  public static String[] m_EntityTables = {"beneficope"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_CAB':C_CAB,'C_PRV':C_PRV,'C_IND':C_IND,'C_STA':C_STA,'C_CAP':C_CAP"+FoundlingChildrenList("ardt_beneficope",true,true)+"}"+FoundlingChildrenList("ardt_beneficope",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'IDBASE':IDBASE,'C_RAG':C_RAG,'C_CTA':C_CTA,'C_CAB':C_CAB,'C_PRV':C_PRV,'C_IND':C_IND,'C_STA':C_STA,'xdessta':xdessta,'C_CAP':C_CAP"+FoundlingChildrenList("ardt_beneficope",true,true)+"}"+FoundlingChildrenList("ardt_beneficope",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG C_RAG C_CTA C_CAB C_PRV C_IND C_STA C_CAP"+FoundlingChildrenList("ardt_beneficope",false,true)+"]"+FoundlingChildrenList("ardt_beneficope",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_beneficope"),new String[][]{new String[]{"IDFILEBO","","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","key1","true","false"},new String[]{"C_RAG","","C","70","0","campo","key3","true","false"},new String[]{"C_CTA","","C","30","0","campo","nokey","true","false"},new String[]{"C_CAB","","C","6","0","campo","nokey","true","false"},new String[]{"C_PRV","","C","2","0","campo","nokey","true","false"},new String[]{"C_IND","","C","35","0","campo","nokey","true","false"},new String[]{"C_STA","","C","3","0","campo","nokey","true","false"},new String[]{"C_CAP","","C","5","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_beneficopeBL (CPContext p_ContextObject) {
    ...
    m_cPhName_beneficope = p_ContextObject.GetPhName("beneficope",p_ContextObject.GetCompany(),false);
    m_cServer_beneficope = p_ContextObject.GetServer("beneficope");
    m_oWrInfo_beneficope = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"beneficope",p_ContextObject.GetCompany());
    m_cVirtName_beneficope = CPSql.ManipulateTablePhName("beneficope",m_cServer_beneficope);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_beneficope",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_beneficope","beneficope",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var.key_num",zeroSplit.split("key1\u0000key3\u0000nokey\u0000nokey\u0000nokey\u0000nokey",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_beneficope",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_beneficope",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_beneficope",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_beneficope",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_beneficope"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_beneficope\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "beneficope"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "beneficope"+"\\"+CPLib.ToCPStr(w_CODSOG)+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
