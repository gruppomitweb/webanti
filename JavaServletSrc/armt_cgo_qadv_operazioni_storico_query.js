...
m_oFather.DoQueryFromChild('cgo_qadv_operazioni_storico',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
_chNotF(childAlias,'master','armt_cgo_qadv_operazioni_storico');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('cgo_qadv_operazioni_storico',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
