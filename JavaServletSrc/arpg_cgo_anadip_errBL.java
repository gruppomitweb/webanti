...
public class arpg_cgo_anadip_errBL extends arpg_cgo_anadip_errWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public String c_PRGDIP;
  ...
  public static final String i_EntityName = "arpg_cgo_anadip_err";
  ...
  public arpg_cgo_anadip_errBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_cgo_anadip_err","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).c_PRGDIP=c_PRGDIP;
  ...
  public void TrsToWork() {
    c_PRGDIP= m_oTrs.get(m_nCurrentRow).c_PRGDIP;
