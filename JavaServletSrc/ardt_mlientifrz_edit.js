...
if ( ! (m_oFather.SaveContext_ardt_mlientifrz())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_mlientifrz_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_mlientifrz_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_mlientifrz();
}
}
SaveContext.child=[];
function BlankRow() {
