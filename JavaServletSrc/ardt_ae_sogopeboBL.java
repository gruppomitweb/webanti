...
public class ardt_ae_sogopeboBL extends ardt_ae_sogopeboWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "ardt_ae_sogopebo";
  ...
  public CPPhTableWrInfo m_oWrInfo_jogopebo;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_jogopebo;
  ...
  public static String[] m_EntityTables = {"jogopebo"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME"+FoundlingChildrenList("ardt_ae_sogopebo",true,true)+"}"+FoundlingChildrenList("ardt_ae_sogopebo",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'IDFILEBO':IDFILEBO,'m_Detail':{'CODSOG':CODSOG,'LEGAME':LEGAME,'xragsoc':xragsoc,'xdescriz':xdescriz"+FoundlingChildrenList("ardt_ae_sogopebo",true,true)+"}"+FoundlingChildrenList("ardt_ae_sogopebo",true,false)+"}";
  public static final String i_ItemSequence = "IDFILEBO,m_Detail[ CODSOG LEGAME"+FoundlingChildrenList("ardt_ae_sogopebo",false,true)+"]"+FoundlingChildrenList("ardt_ae_sogopebo",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("ardt_ae_sogopebo"),new String[][]{new String[]{"IDFILEBO","Idbase di Operazbo","C","10","0","campo","key1","false","false"},new String[]{"CODSOG","Codice Soggetto","C","16","0","campo","nokey","true","false"},new String[]{"LEGAME","Tipo Legame","C","1","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public ardt_ae_sogopeboBL (CPContext p_ContextObject) {
    ...
    m_cPhName_jogopebo = p_ContextObject.GetPhName("jogopebo",p_ContextObject.GetCompany(),false);
    m_cServer_jogopebo = p_ContextObject.GetServer("jogopebo");
    m_oWrInfo_jogopebo = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"jogopebo",p_ContextObject.GetCompany());
    m_cVirtName_jogopebo = CPSql.ManipulateTablePhName("jogopebo",m_cServer_jogopebo);
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_sogopebo",p_ContextObject);
  }
  public void Blank() {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("ardt_ae_sogopebo","jogopebo",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("ardt_ae_sogopebo",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("ardt_ae_sogopebo",child);
    ...
    for(String child : CPLib.LoadableMNTs("ardt_ae_sogopebo",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("ardt_ae_sogopebo",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"ardt_ae_sogopebo"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"ardt_ae_sogopebo\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "jogopebo"+"\\"+CPLib.ToCPStr(p_Caller.GetString("IDFILEBO","C",10,0));
  }
  public String RowPrimaryKey() {
    return "jogopebo"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
