...
m_oFather.i_last_focused_item='child_ardt_terzistirap';
...
function Help() {
windowOpenForeground('../doc/ardt_terzistirap_usr.xml','','toolbar=0,menubar=0,directories=0,width=500,height=450,resizable=1');
}
...
return 'terzistirap'+'\\'+CPLib.ToCPStr(w_IDFILEBO);
}
...
p_d.setValue('ardt_terzistirap',m_cSelectedPage);
