...
if ( ! (m_oFather.SaveContext_ardt_sogopeprov())) {
...
parent.ZtVWeb.raiseEventToEvalParms('ardt_sogopeprov_beforeSubmit',{'action':formaction});
}
Frm.submit();
...
DisplayErrorMessage();
if (Ne(parent,window) && parent.ZtVWeb) {
parent.ZtVWeb.raiseEventToEvalParms('ardt_sogopeprov_dataNotSent',{'action':formaction});
}
}
}
}
...
if (IsWndAccessible(m_oFather)) {
m_oFather.SetModified_ardt_sogopeprov();
}
}
SaveContext.child=[];
function BlankRow() {
