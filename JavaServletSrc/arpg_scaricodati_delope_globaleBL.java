...
public class arpg_scaricodati_delope_globaleBL extends arpg_scaricodati_delope_globaleWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_scaricodati_delope_globale";
  ...
  public static final String i_StateStructure = "{'a_data':a_data,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO,'limite':limite}";
  public static final String i_CompleteStateStructure = "{'dadata':dadata,'a_data':a_data,'gIntemediario':gIntemediario,'CFINVIO':CFINVIO,'CAFINVIO':CAFINVIO,'FILEINVIO':FILEINVIO,'DATAINVIO':DATAINVIO,'limite':limite}";
  public static final String i_ItemSequence = "a_data,CFINVIO,CAFINVIO,FILEINVIO,DATAINVIO,limite";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),"",new String[][]{new String[]{"a_data","","D","8","0","variabile","nokey","false","false"},new String[]{"CFINVIO","Codice Fiscale Organo Invio File","C","16","0","variabile","nokey","false","false"},new String[]{"CAFINVIO","Codice CAF Organo Invio","C","5","0","variabile","nokey","false","false"},new String[]{"FILEINVIO","Tipo Preparazione FIle","C","1","0","variabile","nokey","false","false"},new String[]{"DATAINVIO","Data Impegno Organo Invio","D","8","0","variabile","nokey","false","false"},new String[]{"limite","","N","7","0","variabile","nokey","false","false"}});
  ...
  public arpg_scaricodati_delope_globaleBL (CPContext p_ContextObject) {
  ...
  public boolean Set_limite(double p_workVariableValue) {
    m_nLastError = 0;
    m_cLastMsgError = "";
    boolean l_bResult;
    l_bResult = true;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_scaricodati_delope_globale","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
