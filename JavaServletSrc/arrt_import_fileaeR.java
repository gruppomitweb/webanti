...
// * --- Fine Area Manuale
public class arrt_import_fileaeR implements CallerWithObjs {
  ...
  public String w_faggp;
  public String w_faggr;
  ...
  // * --- Fine Area Manuale
  public arrt_import_fileaeR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_import_fileae",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("faggp",p_cVarName)) {
      return w_faggp;
    }
    if (CPLib.eqr("faggr",p_cVarName)) {
      return w_faggr;
    }
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      double nTry04174C78status;
      nTry04174C78status = m_Sql.GetTransactionStatus();
      String cTry04174C78msg;
      cTry04174C78msg = m_Sql.TransactionErrorMessage();
      try {
        ...
        if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry04174C78status,0)) {
          m_Sql.SetTransactionStatus(nTry04174C78status,cTry04174C78msg);
        }
      }
  ...
  void Page_2() throws Exception {
    ...
    /* If w_tipofile='D' */
    if (CPLib.eqr(w_tipofile,"D")) {
      /* riga := Substr(riga,101) */
      riga = CPLib.Substr(riga,101);
    } // End If
    ...
    if (CPLib.ne(CPLib.Left(riga,8),"0CCB0034")) {
      ...
      /* ElseIf (Empty(w_oldinter) and LRTrim(Substr(riga,9,16)) <> LRTrim(_codint)) or (not(Empty(w_oldinter)) and LRTrim(Substr(riga,9,16)) <> LRTrim(w_oldinter) ) */
    } else if ((CPLib.Empty(w_oldinter) && CPLib.ne(CPLib.LRTrim(CPLib.Substr(riga,9,16)),CPLib.LRTrim(_codint))) || ( ! (CPLib.Empty(w_oldinter)) && CPLib.ne(CPLib.LRTrim(CPLib.Substr(riga,9,16)),CPLib.LRTrim(w_oldinter)))) {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(riga)),0) && CPLib.ne(CPLib.Left(riga,1),"9")) {
          ...
          if (CPLib.eqr(_tipofile,"1")) {
            ...
            while (CPLib.le(cicla,4)) {
              ...
              /* If Len(LRTrim(cRiga)) <> 0 */
              if (CPLib.ne(CPLib.Len(CPLib.LRTrim(cRiga)),0)) {
                ...
                if (CPLib.gt(CPLib.Len(CPLib.LRTrim(cNPROG+cCODFISC)),0)) {
                  ...
                  m_cSql = m_cSql+GetFieldsName_06E7A710(m_Ctx);
            ...
            while (CPLib.le(cicla,4)) {
              ...
              if (CPLib.ne(CPLib.Len(CPLib.LRTrim(cRiga)),0)) {
                ...
                if (CPLib.gt(CPLib.Len(CPLib.LRTrim(cNPROG+cCODFISC)),0)) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_imp_filae")+" (";
                  m_cSql = m_cSql+GetFieldsName_0742DE68(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_periodo,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_tipofile,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_descfile,"?",0,0,m_cServer)+", ";
            ...
            while (CPLib.le(cicla,4)) {
              ...
              if (CPLib.ne(CPLib.Len(CPLib.LRTrim(cRiga)),0)) {
                ...
                if (CPLib.gt(CPLib.Len(CPLib.LRTrim(cNPROG+cCODFISC)),0)) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_imp_filae")+" (";
                  m_cSql = m_cSql+GetFieldsName_05DCEB38(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_periodo,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_tipofile,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_descfile,"?",0,0,m_cServer)+", ";
            ...
            while (CPLib.le(cicla,4)) {
              ...
              if (CPLib.ne(CPLib.Len(CPLib.LRTrim(cRiga)),0)) {
                ...
                if (CPLib.gt(CPLib.Len(CPLib.LRTrim(cNPROG+cCODFISC)),0)) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_imp_filae")+" (";
                  m_cSql = m_cSql+GetFieldsName_061A5738(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_periodo,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_tipofile,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_descfile,"?",0,0,m_cServer)+", ";
            ...
            while (CPLib.le(cicla,4)) {
              ...
              if (CPLib.ne(CPLib.Len(CPLib.LRTrim(cRiga)),0)) {
                ...
                if (CPLib.gt(CPLib.Len(CPLib.LRTrim(cNPROG+cCODFISC)),0)) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_imp_filae")+" (";
                  m_cSql = m_cSql+GetFieldsName_070CC270(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_periodo,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_tipofile,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_descfile,"?",0,0,m_cServer)+", ";
            ...
            while (CPLib.le(cicla,4)) {
              ...
              if (CPLib.ne(CPLib.Len(CPLib.LRTrim(cRiga)),0)) {
                ...
                if (CPLib.gt(CPLib.Len(CPLib.LRTrim(cNPROG+cCODFISC)),0)) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_imp_filae")+" (";
                  m_cSql = m_cSql+GetFieldsName_05C6CE98(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_periodo,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_tipofile,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_descfile,"?",0,0,m_cServer)+", ";
        ...
        /* If w_tipofile='D' and Left(riga,1)='9' */
        if (CPLib.eqr(w_tipofile,"D") && CPLib.eqr(CPLib.Left(riga,1),"9")) {
          /* riga := FileLibrary.ReadLine(fhand) */
          riga = FileLibrary.ReadLine(fhand);
        } // End If
      } // End While
        ...
        if (CPLib.gt(Cursor_tmp_imp_filae.GetString("INVIO"),"3")) {
          ...
          if (CPLib.Empty(Cursor_tmp_imp_filae.GetString("SESSO"))) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on personbo into routine arrt_import_fileae returns two or more records. This item should return only a record.");
            ...
            if (CPLib.eqr(Cursor_tmp_imp_filae.GetString("NAPROV"),"EE")) {
              ...
              m_cSql = m_cSql+" and NASSTATO="+CPSql.SQLValueAdapter(CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("NACITTA")),30),"C",30,0,m_cServer),m_cServer,CPLib.Left(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("NACITTA")),30));
          ...
          if (CPLib.Empty(CPLib.LRTrim(_connes))) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("SESSO")))) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"personbo")+" (";
              m_cSql = m_cSql+GetFieldsName_06D85200(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_connes,"?",0,0,m_cServer)+", ";
              ...
              m_cSql = m_cSql+""+CPLib.ToSQL(_connes,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.eqr(Cursor_tmp_imp_filae.GetString("NAPROV"),"EE")?CPLib.Left(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("NACITTA")),30):"ITALIA"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
              if (m_Ctx.IsSharedTemp("personbo")) {
                m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
              }
            ...
            if (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("SESSO")))) {
              ...
              if (CPLib.eqr(Cursor_tmp_imp_filae.GetString("NAPROV"),"EE")) {
                ...
                m_cSql = m_cSql+"CFESTERO = "+CPLib.ToSQL(1,"N",1,0)+", ";
                m_cSql = m_cSql+"NASSTATO = "+CPLib.ToSQL(CPLib.Left(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("NACITTA")),30),"C",30,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"personbo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"CONNES = "+CPSql.SQLValueAdapter(CPLib.ToSQL(_connes,"?",0,0,m_cServer),m_cServer,_connes)+"";
                if (m_Ctx.IsSharedTemp("personbo")) {
          ...
          if (Read_Cursor!=null)
            Read_Cursor.Close();
          Read_Cursor = m_Sql.Query(m_cServer,"select "+CPLib.GetMultilanguageField("CONNES",m_Ctx,m_cServer)+","+CPLib.GetMultilanguageField("RAGSOC",m_Ctx,m_cServer)+" from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+m_cSql);
          if ( ! (Read_Cursor.Eof())) {
            _connes = Read_Cursor.GetString("CONNES");
          ...
          if (CPLib.Empty(_connes)) {
            ...
            m_cPhName = m_Ctx.GetPhName("personbo");
            m_cSql = "";
            m_cSql = m_cSql+"CONNES="+CPSql.SQLValueAdapter(CPLib.ToSQL(Cursor_tmp_imp_filae.GetString("CF"),"C",16,0,m_cServer),m_cServer,Cursor_tmp_imp_filae.GetString("CF"));
            if (m_Ctx.IsSharedTemp("personbo")) {
              m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
            }
            if (Read_Cursor!=null)
          ...
          if (CPLib.Empty(CPLib.LRTrim(_connes))) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("SESSO")))) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"personbo")+" (";
              m_cSql = m_cSql+GetFieldsName_05D165D8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_tmp_imp_filae.GetString("CF"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("CNOME"))+" "+CPLib.LRTrim(Cursor_tmp_imp_filae.GetString("NOME")),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_tmp_imp_filae.GetDate("NADATA"),"?",0,0)+", ";
        ...
        if (CPLib.eqr(Cursor_tmp_imp_filae.GetString("INVIO"),"1") || CPLib.eqr(Cursor_tmp_imp_filae.GetString("INVIO"),"4")) {
          ...
          if (CPLib.eqr(Cursor_tmp_imp_filae.GetString("COINT"),"3") && CPLib.ne(Cursor_tmp_imp_filae.GetString("TIPO"),"98")) {
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on aederig into routine arrt_import_fileae returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(_rapporto))) {
              ...
              m_cPhName = m_Ctx.GetPhName("aederig");
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aederig")+" (";
              m_cSql = m_cSql+GetFieldsName_062AAE78(m_Ctx);
              m_cSql = m_cSql+") values (";
              ...
              m_cSql = m_cSql+""+CPLib.ToSQL((CPLib.eqr(Cursor_tmp_imp_filae.GetString("INVIO"),"1")?"N":"S"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(w_oldinter,"?",0,0,m_cServer)+", ";
              if (m_Ctx.IsSharedTemp("aederig")) {
                m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
              }
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on aeoprig into routine arrt_import_fileae returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(_prog))) {
              ...
              m_cSql = m_cSql+GetFieldsName_05E37518(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_prog,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_connes,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
              ...
              if (CPLib.eqr(w_faggr,"S")) {
                ...
                m_cSql = m_cSql+"AFILE = "+CPLib.ToSQL(Cursor_tmp_imp_filae.GetString("IDFILE"),"C",15,0,m_cServer)+", ";
                m_cSql = m_cSql+"IDRIF = "+CPLib.ToSQL(LibreriaMit.UniqueId(),"C",10,0,m_cServer)+", ";
                m_cSql = m_cSql+"NOCODFISC = "+CPLib.ToSQL((CPLib.eqr(Cursor_tmp_imp_filae.GetString("INVIO"),"1")?"N":"S"),"C",1,0,m_cServer)+", ";
            ...
            if ( ! (Read_Cursor.Eof())) {
              ...
              Read_Cursor.Next();
              if ( ! (Read_Cursor.Eof())) {
                Error l_oErrorFault = new Error("Read on aerighe into routine arrt_import_fileae returns two or more records. This item should return only a record.");
                CPStdCounter.Error(l_oErrorFault);
              }
              Read_Cursor.Close();
            } else {
            ...
            if (CPLib.Empty(CPLib.LRTrim(_rapporto))) {
              ...
              m_cSql = m_cSql+GetFieldsName_05F3BEE0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rapporto,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_tmp_imp_filae.GetString("TIPO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_tmp_imp_filae.GetString("COINT"),"?",0,0,m_cServer)+", ";
              ...
              m_cPhName = m_Ctx.GetPhName("tmp_rapportipd");
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_rapportipd")+" (";
              m_cSql = m_cSql+GetFieldsName_05D9E760(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rapporto,"?",0,0,m_cServer)+", ";
              if (m_Ctx.IsSharedTemp("tmp_rapportipd")) {
                m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
              ...
              m_cSql = m_cSql+GetFieldsName_0779F320(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rapporto,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(1,"?",0,0)+", ";
          ...
          if (CPLib.eqr(Cursor_tmp_imp_filae.GetString("COINT"),"3") && CPLib.ne(Cursor_tmp_imp_filae.GetString("TIPO"),"98")) {
            ...
            if (CPLib.Empty(CPLib.LRTrim(_prog))) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_rapportipd")+" (";
              m_cSql = m_cSql+GetFieldsName_05B64A48(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rapporto,"?",0,0,m_cServer)+", ";
              if (m_Ctx.IsSharedTemp("tmp_rapportipd")) {
                m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
              ...
              if (CPLib.eqr(_friga,0)) {
                ...
                if (CPLib.ne(_friga,0)) {
                  ...
                  if ( ! (Read_Cursor.Eof())) {
                    ...
                    Read_Cursor.Next();
                    if ( ! (Read_Cursor.Eof())) {
                      Error l_oErrorFault = new Error("Read on aetesta into routine arrt_import_fileae returns two or more records. This item should return only a record.");
                      CPStdCounter.Error(l_oErrorFault);
                    }
                    Read_Cursor.Close();
                  } else {
                  ...
                  m_cSql = m_cSql+GetFieldsName_0421E970(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  ...
                  m_cSql = m_cSql+GetFieldsName_05CA5CD8(m_Ctx);
                  m_cSql = m_cSql+") values (";
                ...
                while ( ! (Cursor_aerighe.Eof())) {
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aestor")+" (";
                  m_cSql = m_cSql+GetFieldsName_06EA3C50(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(_idbase,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetString("CONNESINT"),"?",0,0,m_cServer)+", ";
                  ...
                  m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                  m_cSql = CPLib.InsertIntoStatement(m_Ctx,"aecanc")+" (";
                  m_cSql = m_cSql+GetFieldsName_06E8D520(m_Ctx);
                  m_cSql = m_cSql+") values (";
                  m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
                  m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (Cursor_tmp_rapportipd.Eof())) {
        ...
        while ( ! (Cursor_aetesta.Eof())) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on anarapbo into routine arrt_import_fileae returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(_rapporto)) {
            ...
            m_cSql = m_cSql+GetFieldsName_0750DF18(m_Ctx);
            m_cSql = m_cSql+") values (";
            ...
            while ( ! (Cursor_aerighe.Eof())) {
              ...
              if ( ! (CPLib.Empty(Cursor_aerighe.GetDate("CDATA")))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"rapopebo")+" (";
                m_cSql = m_cSql+GetFieldsName_06434240(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_07497170(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aetesta.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (Cursor_tmp_rapportipd.Eof())) {
        ...
        while ( ! (Cursor_aetesta.Eof())) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on jnarapbo into routine arrt_import_fileae returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.Empty(_rapporto)) {
            ...
            m_cSql = m_cSql+GetFieldsName_07C819B8(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aetesta.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aetesta.GetString("TIPOAG"),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
            ...
            while ( ! (Cursor_aerighe.Eof())) {
              ...
              if ( ! (CPLib.Empty(Cursor_aerighe.GetDate("ADATA")))) {
                ...
                m_cSql = m_cSql+GetFieldsName_06D91530(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
              ...
              if ( ! (CPLib.Empty(Cursor_aerighe.GetDate("CDATA")))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"japopebo")+" (";
                m_cSql = m_cSql+GetFieldsName_0766C9C0(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
              ...
              m_cSql = m_cSql+GetFieldsName_0758FBA8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aetesta.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetString("CONNESINT"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_aerighe.GetDate("ADATA"),"?",0,0)+", ";
            ...
            while ( ! (Cursor_aerighe.Eof())) {
              ...
              if ( ! (CPLib.Empty(Cursor_aerighe.GetDate("CDATA")))) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = CPLib.InsertIntoStatement(m_Ctx,"japopebo")+" (";
                m_cSql = m_cSql+GetFieldsName_06195C10(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg1,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(cInfProg2,"?",0,0,m_cServer)+", ";
                m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp,"?",0,0)+", ";
  ...
  void Page_6() throws Exception {
    ...
    try {
      ...
      while (CPLib.lt(contanome,conteggio)) {
        ...
        m_cSql = m_cSql+GetFieldsName_062E4298(m_Ctx);
        m_cSql = m_cSql+") values (";
  ...
  public Forward Run() {
    ...
    try {
      ...
      m_Caller.SetString("faggp","C",1,0,w_faggp);
      m_Caller.SetString("faggr","C",1,0,w_faggr);
      m_Caller.SetString("oldinter","C",16,0,w_oldinter);
  ...
  public static arrt_import_fileaeR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_import_fileaeR(p_Ctx, p_Caller);
  }
  public void Blank() {
    ...
    w_faggp = m_Caller.GetString("faggp","C",1,0);
    w_faggr = m_Caller.GetString("faggr","C",1,0);
    w_oldinter = m_Caller.GetString("oldinter","C",16,0);
    fhand = CPLib.Space(1);
    riga = "";
  ...
  protected static String GetFieldsName_06E7A710(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0742DE68(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PERIODO,";
    p_cSql = p_cSql+"INVIO,";
    p_cSql = p_cSql+"DESCRI,";
  ...
  protected static String GetFieldsName_05DCEB38(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PERIODO,";
    p_cSql = p_cSql+"INVIO,";
    p_cSql = p_cSql+"DESCRI,";
  ...
  protected static String GetFieldsName_061A5738(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PERIODO,";
    p_cSql = p_cSql+"INVIO,";
    p_cSql = p_cSql+"DESCRI,";
  ...
  protected static String GetFieldsName_070CC270(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PERIODO,";
    p_cSql = p_cSql+"INVIO,";
    p_cSql = p_cSql+"DESCRI,";
  ...
  protected static String GetFieldsName_05C6CE98(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PERIODO,";
    p_cSql = p_cSql+"INVIO,";
    p_cSql = p_cSql+"DESCRI,";
  ...
  protected static String GetFieldsName_06D85200(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"RAGSOC,";
  ...
  protected static String GetFieldsName_05D165D8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"RAGSOC,";
    p_cSql = p_cSql+"DATANASC,";
  ...
  protected static String GetFieldsName_062AAE78(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_05E37518(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CONNESINT,";
    p_cSql = p_cSql+"ASPEDITO,";
  ...
  protected static String GetFieldsName_05F3BEE0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"TIPOAG,";
    p_cSql = p_cSql+"COINT,";
  ...
  protected static String GetFieldsName_05D9E760(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_0779F320(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_05B64A48(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    if (p_Ctx.IsSharedTemp("tmp_rapportipd")) {
      p_cSql = p_cSql+"context_id,";
  ...
  protected static String GetFieldsName_0421E970(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CONNESINT,";
  ...
  protected static String GetFieldsName_05CA5CD8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PROGRES,";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_06EA3C50(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CONNESINT,";
  ...
  protected static String GetFieldsName_06E8D520(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"PROGRES,";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_0750DF18(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"TIPOAG,";
  ...
  protected static String GetFieldsName_06434240(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"PRGIMPINF,";
  ...
  protected static String GetFieldsName_07497170(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_07C819B8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"TIPOAG,";
    p_cSql = p_cSql+"PRGIMPRAP,";
  ...
  protected static String GetFieldsName_06D91530(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"PRGIMPINF,";
  ...
  protected static String GetFieldsName_0766C9C0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"PRGIMPINF,";
  ...
  protected static String GetFieldsName_0758FBA8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"CODINTER,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_06195C10(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"NUMPROG,";
    p_cSql = p_cSql+"PRGIMPINF,";
  ...
  protected static String GetFieldsName_062E4298(CPContext p_Ctx) {
    String p_cSql = "";
