...
public class FileLibMit {

//---Start function: FILELIBMIT_LIBRARY_CODE
...
public static boolean FileCopyPath(String src, String dest) {
  boolean res = false;
...
public static String OpenAppendPath(String filename) {
    String id="file_"+CPLib.NewCPCCCHK();
    try {
      CPLib.PutInto(files,id,new BufferedWriter(new FileWriter(filename,true)));
    } catch(Exception e) {
      CPStdCounter.Error(e);
      return OpenWritePath(filename);
    }
    return id;
  }
public static String OpenAppendPath(String filename, String charSet) {
  String id="file_"+CPLib.NewCPCCCHK();
  try {
    CPLib.PutInto(files,id,new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filename,true),charSet)));
  } catch(Exception e) {
    CPStdCounter.Error(e);
    return OpenWritePath(filename, charSet);
  }
  return id;
}
//---End function
...
//---Start function: OpenReadPath
  public static String OpenReadPath(String filename) {
    String id="file_"+CPLib.NewCPCCCHK();
    try {
      CPLib.PutInto(files,id,new BufferedReader(new FileReader(filename)));
    } catch(Exception e) {
      CPStdCounter.Error(e);
      id="";
    }
  ...
  public static String OpenReadPath(String filename, String charSet) {
    String id="file_"+CPLib.NewCPCCCHK();
    try {
      CPLib.PutInto(files,id,new BufferedReader(new InputStreamReader(new FileInputStream(filename),charSet)));
    } catch(Exception e) {
      CPStdCounter.Error(e);
      id="";
    }
...
//---Start function: OpenWritePath
  public static String OpenWritePath(String filename) {
    String id="file_"+CPLib.NewCPCCCHK();
    try {
      CPLib.PutInto(files,id,new BufferedWriter(new FileWriter(filename)));
    } catch(Exception e) {
      CPStdCounter.Error(e);
      id="";
    }
  ...
  public static String OpenWritePath(String filename,String charSet) {
    String id="file_"+CPLib.NewCPCCCHK();
    try {
      CPLib.PutInto(files,id,new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filename),charSet)));
    } catch(Exception e) {
      CPStdCounter.Error(e);
      id="";
    }
