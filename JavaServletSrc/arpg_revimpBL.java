...
public class arpg_revimpBL extends arpg_revimpWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "arpg_revimp";
  ...
  public arpg_revimpBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("arpg_revimp","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
