...
// * --- Fine Area Manuale
public class arrt_imp_dati_schedR implements CallerWithObjs {
  ...
  public String m_cPhName_imp_archpers;
  public String m_cServer_imp_archpers;
  String m_cServer;
  String m_cPhName;
  String m_cQuery;
  ...
  // * --- Fine Area Manuale
  public arrt_imp_dati_schedR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("arrt_imp_dati_sched",m_Caller);
    ...
    if (m_Ctx.IsTmpAlreadyCreated("tmp_imprappo")) {
    ...
    m_cPhName_imp_archpers = p_ContextObject.GetPhName("imp_archpers");
    m_cServer_imp_archpers = p_ContextObject.GetServer("imp_archpers");
    Blank();
  }
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      /* Exec "Ordina file per importanza" Page 2:Page_2 */
      Page_2();
      // Begin Transaction
      ...
      while ( ! (Cursor_tmp_list_imprich.Eof())) {
        double nTry062F3DA0status;
        nTry062F3DA0status = m_Sql.GetTransactionStatus();
        String cTry062F3DA0msg;
        cTry062F3DA0msg = m_Sql.TransactionErrorMessage();
        try {
          /* If _esito = 0 */
          if (CPLib.eqr(_esito,0)) {
            ...
            if (CPLib.eqr(CPLib.Lower(nomefileimport),"archpers.txt")) {
              ...
              /* Exec "Frazionarie" Page 8:Page_8 */
              Page_8();
              if ( ! (CPLib.Empty(m_Sql.TransactionErrorMessage()))) {
                throw new RoutineException();
              }
          ...
          if (CPLib.eqr(m_Sql.GetTransactionStatus(),0) || CPLib.ne(nTry062F3DA0status,0)) {
            m_Sql.SetTransactionStatus(nTry062F3DA0status,cTry062F3DA0msg);
          }
        }
  ...
  void Page_3() throws Exception {
    CPResultSet Cursor_imp_archpers=null;
    ...
    try {
      ...
      // * --- Select from imp_archpers
      m_cServer = m_Ctx.GetServer("imp_archpers");
      m_cPhName = m_Ctx.GetPhName("imp_archpers");
      if (Cursor_imp_archpers!=null)
        Cursor_imp_archpers.Close();
      Cursor_imp_archpers = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+(m_Ctx.IsSharedTemp("imp_archpers")?"context_id='"+m_Ctx.GetTempID()+"'":"1=1"),m_cServer,m_Ctx,true));
      while ( ! (Cursor_imp_archpers.Eof())) {
        ...
        /* cSetSin := '' */
        cSetSin = "";
        /* xCodCab := imp_archpers->CODCAB */
        xCodCab = Cursor_imp_archpers.GetString("CODCAB");
        /* cCli1 := imp_archpers->CONNES */
        cCli1 = Cursor_imp_archpers.GetString("CONNES");
        /* xCF := imp_archpers->CODFISC */
        xCF = Cursor_imp_archpers.GetString("CODFISC");
        /* xCFE := iif(imp_archpers->CFESTERO='S' or imp_archpers->CFESTERO='1',1,0) */
        xCFE = CPLib.Round((CPLib.eqr(Cursor_imp_archpers.GetString("CFESTERO"),"S") || CPLib.eqr(Cursor_imp_archpers.GetString("CFESTERO"),"1")?1:0),0);
        ...
        if (CPLib.Empty(CPLib.LRTrim(xCodCab))) {
          /* xCitta := imp_archpers->DESCCIT */
          xCitta = Cursor_imp_archpers.GetString("DESCCIT");
          // * --- Read from tbcitta
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on tbcitta into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
        ...
        if (CPLib.eqr(CPLib.Len(CPLib.LRTrim(xCF)),0)) {
          ...
          m_cSql = m_cSql+GetFieldsName_062D4218(m_Ctx);
          ...
          /* If arfn_chkcodfis(xCF,imp_archpers->PAESE,0) */
          if (arfn_chkcodfisR.Make(m_Ctx,this).Run(xCF,Cursor_imp_archpers.GetString("PAESE"),0)) {
            /* If Len(LRTrim(xCF)) = 16 and imp_archpers->CFESTERO<> 'S' */
            if (CPLib.eqr(CPLib.Len(CPLib.LRTrim(xCF)),16) && CPLib.ne(Cursor_imp_archpers.GetString("CFESTERO"),"S")) {
              ...
              /* If Substr(xCF,12,1) = 'Z' */
              if (CPLib.eqr(CPLib.Substr(xCF,12,1),"Z")) {
                /* cSNAS := '' */
                cSNAS = "";
                // * --- Read from tbstati
                ...
                if ( ! (Read_Cursor.Eof())) {
                  ...
                  Read_Cursor.Next();
                  if ( ! (Read_Cursor.Eof())) {
                    Error l_oErrorFault = new Error("Read on tbstati into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
                    CPStdCounter.Error(l_oErrorFault);
                  }
                  Read_Cursor.Close();
                } else {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_errimp")+" (";
            m_cSql = m_cSql+GetFieldsName_079B08A0(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(nomefileimport,"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(numriga,"?",0,0)+", ";
        ...
        /* xRiga1 := LibreriaMit.SpacePad(imp_archpers->CODFISC,16) */
        xRiga1 = LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("CODFISC"),16);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->RAGSOC,70) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("RAGSOC"),70);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->DOMICILIO,35) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("DOMICILIO"),35);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->DESCCIT,30) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("DESCCIT"),30);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->PROVINCIA,2) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("PROVINCIA"),2);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(Left(LRTrim(imp_archpers->CAP),5),5) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(CPLib.Left(CPLib.LRTrim(Cursor_imp_archpers.GetString("CAP")),5),5);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->PAESE,3) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("PAESE"),3);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->SOTGRUP,3) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("SOTGRUP"),3);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->RAMOGRUP,3) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("RAMOGRUP"),3);
        /* xRiga1 := xRiga1 + LibreriaMit.SpacePad(imp_archpers->SETTSINT,3) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("SETTSINT"),3);
        /* xRiga2 := xRiga1 + LibreriaMit.SpacePad(Left(cCNAS,30),30) */
        xRiga2 = xRiga1+LibreriaMit.SpacePad(CPLib.Left(cCNAS,30),30);
        ...
        /* xRiga1 := xRiga1+ LibreriaMit.SpacePad(DateToChar(cDNAS),8) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(CPLib.DateToChar(cDNAS),8);
        /* xRiga1 := xRiga1 +LibreriaMit.SpacePad(imp_archpers->TIPODOC,2) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("TIPODOC"),2);
        /* xRiga1 := xRiga1 +LibreriaMit.SpacePad(imp_archpers->NUMDOCUM,15) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("NUMDOCUM"),15);
        /* xRiga1 := xRiga1 + iif(Empty(imp_archpers->DATARILASC),Space(8),LibreriaMit.SpacePad(Substr(imp_archpers->DATAVALI,5,4)+Substr(imp_archpers->DATAVALI,3,2)+Substr(imp_archpers->DATAVALI,1,2),8)) */
        xRiga1 = xRiga1+(CPLib.Empty(Cursor_imp_archpers.GetString("DATARILASC"))?CPLib.Space(8):LibreriaMit.SpacePad(CPLib.Substr(Cursor_imp_archpers.GetString("DATAVALI"),5,4)+CPLib.Substr(Cursor_imp_archpers.GetString("DATAVALI"),3,2)+CPLib.Substr(Cursor_imp_archpers.GetString("DATAVALI"),1,2),8));
        /* xRiga1 := xRiga1 +LibreriaMit.SpacePad(imp_archpers->AUTRILASC,30) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("AUTRILASC"),30);
        /* xRiga1 := xRiga1 +LibreriaMit.SpacePad(imp_archpers->PARTIVA,14) */
        xRiga1 = xRiga1+LibreriaMit.SpacePad(Cursor_imp_archpers.GetString("PARTIVA"),14);
        ...
        Cursor_personbo.Close();
        // * --- End Select
        /* cSetSin := arfn_calcolasett(imp_archpers->SOTGRUP,imp_archpers->RAMOGRUP,'') */
        cSetSin = arfn_calcolasettR.Make(m_Ctx,this).Run(Cursor_imp_archpers.GetString("SOTGRUP"),Cursor_imp_archpers.GetString("RAMOGRUP"),"");
        /* nProgImp := 0 */
        ...
        if ( ! (CPLib.Empty(xConnes))) {
          ...
          if (CPLib.ne(CPLib.Upper(CPLib.LRTrim(xRiga1)),CPLib.Upper(CPLib.LRTrim(xRiga2)))) {
            ...
            /* xCognome := '' */
            xCognome = "";
            /* If Len(LRTrim(imp_archpers->CODFISC)) = 16 */
            if (CPLib.eqr(CPLib.Len(CPLib.LRTrim(Cursor_imp_archpers.GetString("CODFISC"))),16)) {
              /* xRagSoc := Upper(LRTrim(imp_archpers->RAGSOC)) */
              xRagSoc = CPLib.Upper(CPLib.LRTrim(Cursor_imp_archpers.GetString("RAGSOC")));
              /* If Len(LRTrim(imp_archpers->COGNOME)+LRTrim(imp_archpers->NOME)) = 0 */
              if (CPLib.eqr(CPLib.Len(CPLib.LRTrim(Cursor_imp_archpers.GetString("COGNOME"))+CPLib.LRTrim(Cursor_imp_archpers.GetString("NOME"))),0)) {
                /* Exec "Allinea Cognome Nome" Page 4:Page_4 */
                Page_4();
                /* xNome := Left(xNome,25) */
                ...
                /* xNome := imp_archpers->NOME */
                xNome = Cursor_imp_archpers.GetString("NOME");
                /* xCognome := imp_archpers->COGNOME */
                xCognome = Cursor_imp_archpers.GetString("COGNOME");
                /* _allcn := 1 */
            ...
            while ( ! (Cursor_personbo.Eof())) {
              ...
              m_cSql = m_cSql+GetFieldsName_06444BC0(m_Ctx);
              m_cSql = m_cSql+") values (";
            ...
            m_cSql = m_cSql+"RAGSOC = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
            m_cSql = m_cSql+"DOMICILIO = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("DOMICILIO"),"C",35,0,m_cServer)+", ";
            m_cSql = m_cSql+"CODFISC = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("CODFISC"),"C",16,0,m_cServer)+", ";
            m_cSql = m_cSql+"DATANASC = "+CPLib.ToSQL(cDNAS,"D",8,0)+", ";
            m_cSql = m_cSql+"NASCOMUN = "+CPLib.ToSQL(cCNAS,"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"SOTGRUP = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("SOTGRUP"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"RAMOGRUP = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("RAMOGRUP"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"SETTSINT = "+CPLib.ToSQL(cSetSin,"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"TIPODOC = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("TIPODOC"),"C",2,0,m_cServer)+", ";
            m_cSql = m_cSql+"NUMDOCUM = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("NUMDOCUM"),"C",15,0,m_cServer)+", ";
            m_cSql = m_cSql+"DATARILASC = "+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(Cursor_imp_archpers.GetString("DATARILASC"),5,4)+CPLib.Substr(Cursor_imp_archpers.GetString("DATARILASC"),3,2)+CPLib.Substr(Cursor_imp_archpers.GetString("DATARILASC"),1,2)),"D",8,0)+", ";
            m_cSql = m_cSql+"AUTRILASC = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("AUTRILASC"),"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"DESCCIT = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("DESCCIT"),"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"PROVINCIA = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("PROVINCIA"),"C",2,0,m_cServer)+", ";
            m_cSql = m_cSql+"PAESE = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("PAESE"),"C",3,0,m_cServer)+", ";
            m_cSql = m_cSql+"CAP = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("CAP"),"C",9,0,m_cServer)+", ";
            m_cSql = m_cSql+"PARTIVA = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("PARTIVA"),"C",14,0,m_cServer)+", ";
            m_cSql = m_cSql+"SESSO = "+CPLib.ToSQL(xSesso,"C",1,0,m_cServer)+", ";
            m_cSql = m_cSql+"DATAVALI = "+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(Cursor_imp_archpers.GetString("DATAVALI"),5,4)+CPLib.Substr(Cursor_imp_archpers.GetString("DATAVALI"),3,2)+CPLib.Substr(Cursor_imp_archpers.GetString("DATAVALI"),1,2)),"D",8,0)+", ";
            m_cSql = m_cSql+"COGNOME = "+CPLib.ToSQL(xCognome,"C",26,0,m_cServer)+", ";
            m_cSql = m_cSql+"NOME = "+CPLib.ToSQL(xNome,"C",25,0,m_cServer)+", ";
            m_cSql = m_cSql+"DOCFILE = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("DOCFILE"),"C",100,0,m_cServer)+", ";
            m_cSql = m_cSql+"TIPINTER = "+CPLib.ToSQL(cPNAS,"C",2,0,m_cServer)+", ";
            m_cSql = m_cSql+"CFESTERO = "+CPLib.ToSQL(xCFE,"N",1,0)+", ";
            m_cSql = m_cSql+"PKTBSPECIE = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("SPECIE"),"C",4,0,m_cServer)+", ";
            m_cSql = m_cSql+"COMPORT = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("COMPORT"),"C",5,0,m_cServer)+", ";
            m_cSql = m_cSql+"ATTIV = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("ATTIV"),"C",10,0,m_cServer)+", ";
            m_cSql = m_cSql+"NASSTATO = "+CPLib.ToSQL(cSNAS,"C",30,0,m_cServer)+", ";
            m_cSql = m_cSql+"RAGSOCOLD = "+CPLib.ToSQL(Cursor_imp_archpers.GetString("RAGSOC"),"C",70,0,m_cServer)+", ";
          ...
          m_cSql = m_cSql+GetFieldsName_07766A98(m_Ctx);
          m_cSql = m_cSql+") values (";
        ...
        Cursor_imp_archpers.Next();
      }
      m_cConnectivityError = Cursor_imp_archpers.ErrorMessage();
      Cursor_imp_archpers.Close();
      // * --- End Select
  ...
  void Page_5() throws Exception {
    CPResultSet Cursor_qbe_listimprap=null;
    CPResultSet Read_Cursor=null;
    CPResultSet Cursor_qbe_detimprap=null;
    CPResultSet Cursor_intestbo=null;
    CPResultSet Cursor_rapopebo=null;
    CPResultSet Cursor_=null;
    ...
    try {
      ...
      /* conta := 0 */
      conta = CPLib.Round(0,0);
      // * --- Drop temporary table tmp_imprappo
      if (m_Ctx.IsSharedTemp("tmp_imprappo")) {
        if (m_Ctx.IsTmpAlreadyCreated("tmp_imprappo")) {
          m_cServer = m_Ctx.GetServer("tmp_imprappo");
          m_cPhName = m_Ctx.GetPhName("tmp_imprappo");
          m_cSql = "delete from "+m_cPhName+" where context_id='"+m_Ctx.GetTempID()+"'";
          m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql);
        }
      } else {
        m_Ctx.DropTmp("tmp_imprappo");
      }
      // * --- Create temporary table tmp_imprappo
      if (m_Ctx.IsSharedTemp("tmp_imprappo")) {
        if (m_Ctx.IsTmpAlreadyCreated("tmp_imprappo")) {
          m_cServer = m_Ctx.GetServer("tmp_imprappo");
          m_cPhName = m_Ctx.GetPhName("tmp_imprappo");
      ...
      m_cPhName = m_Ctx.CreateTmpPhName("tmp_imprappo");
      if ( ! (m_Ctx.IsSharedTemp("tmp_imprappo"))) {
        m_cServer = m_Ctx.GetServer("tmp_imprappo");
        m_Sql.SrvQuery(m_cServer,"* ","from "+m_Ctx.PhNameAdapter(m_Sql.ManipulateTablePhName("tmp_imprappo",m_cServer,"proto")),m_cPhName,"tmp_imprappo",m_Ctx);
      }
      m_cPhName_tmp_imprappo = m_cPhName;
      /* gMsgProc := gMsgProc + 'Ora Inizio Processo: '+ arfn_fdatetime(DateTime())  + ' del file ' +nomefileimport + NL */
      gMsgProc = gMsgProc+"Ora Inizio Processo: "+arfn_fdatetimeR.Make(m_Ctx,this).Run(CPLib.DateTime())+" del file "+nomefileimport+"\n";
      m_Ctx.SetGlobalString("gMsgProc",gMsgProc);
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        riga = FileLibrary.ReadLine(fhand);
        // * --- Insert into tmp_imprappo from values
        m_Sql.RequireTransaction();
        m_cServer = m_Ctx.GetServer("tmp_imprappo");
        m_cPhName = m_Ctx.GetPhName("tmp_imprappo");
        m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
        m_cSql = CPLib.InsertIntoStatement(m_Ctx,"tmp_imprappo")+" (";
        m_cSql = m_cSql+GetFieldsName_07D04CC0(m_Ctx);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,25),"?",0,0,m_cServer)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,26,3)),"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,29,8)),"?",0,0)+", ";
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.CharToDate(CPLib.Substr(riga,37,8)),"?",0,0)+", ";
        ...
        m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,56,8),"?",0,0,m_cServer)+", ";
        if (m_Ctx.IsSharedTemp("tmp_imprappo")) {
          m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
        }
        m_cSql = CPLib.AddCPCCCHKValue(m_Ctx,m_cSql,"tmp_imprappo",true);
        m_cSql = m_cSql+")";
        m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
        if (CPLib.lt(m_nUpdatedRows,0)) {
          m_Sql.AbortTransaction();
      ...
      /* conta := 0 */
      conta = CPLib.Round(0,0);
      // * --- Select from qbe_listimprap
      if (Cursor_qbe_listimprap!=null)
        Cursor_qbe_listimprap.Close();
      Cursor_qbe_listimprap = new VQRHolder("qbe_listimprap",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
      while ( ! (Cursor_qbe_listimprap.Eof())) {
        /* conta := conta + 1 */
        conta = CPLib.Round(conta+1,0);
        /* cRapporto := qbe_listimprap->RAPPORTO */
        cRapporto = Cursor_qbe_listimprap.GetString("RAPPORTO");
        /* gMsgImp := 'Sono stati elaborati '+LRTrim(Str(conta,10,0))+' rapporti del file '+nomefileimport // Messaggio Import */
        gMsgImp = "Sono stati elaborati "+CPLib.LRTrim(CPLib.Str(conta,10,0))+" rapporti del file "+nomefileimport;
        m_Ctx.SetGlobalString("gMsgImp",gMsgImp);
        /* xRapporto := '' */
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on anarapbo into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
        ...
        if (CPLib.Empty(CPLib.LRTrim(xRapporto))) {
          ...
          m_cSql = m_cSql+GetFieldsName_06D544C8(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("Rapporto relativo a cliente "+CPLib.LRTrim(Cursor_qbe_detimprap.GetString("CONNESCLI")),"?",0,0,m_cServer)+", ";
          ...
          m_cSql = m_cSql+GetFieldsName_06DEB168(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL("Rapporto relativo a cliente "+CPLib.LRTrim(Cursor_qbe_detimprap.GetString("CONNESCLI")),"?",0,0,m_cServer)+", ";
          ...
          m_cSql = m_cSql+GetFieldsName_07C67268(m_Ctx);
          m_cSql = m_cSql+") values (";
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.DateToChar(Cursor_qbe_detimprap.GetDate("DATAOPE")),"?",0,0,m_cServer)+", ";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetDate("DATAOPE"),"?",0,0)+", ";
          m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetDate("DATAOPE"),"?",0,0)+", ";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Left(riga,8)+cInfApri1+"0","?",0,0,m_cServer)+", ";
          ...
          m_cSql = m_cSql+""+CPLib.ToSQLNull(Cursor_qbe_detimprap.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
          ...
          /* cInfChiu2 := '' */
          cInfChiu2 = "";
          /* If not(Empty(qbe_detimprap->DATACHIU)) */
          if ( ! (CPLib.Empty(Cursor_qbe_detimprap.GetDate("DATACHIU")))) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"rapopebo")+" (";
            m_cSql = m_cSql+GetFieldsName_0730A180(m_Ctx);
            m_cSql = m_cSql+") values (";
            if (m_Ctx.IsSharedTemp("rapopebo")) {
              m_cSql = m_cSql+"'"+m_Ctx.GetTempID()+"', ";
            }
          ...
          // * --- Select from qbe_detimprap
          if (Cursor_qbe_detimprap!=null)
            Cursor_qbe_detimprap.Close();
          Cursor_qbe_detimprap = new VQRHolder("qbe_detimprap",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_detimprap.Eof())) {
            /* If qbe_detimprap->TIPOSOGG='TE' */
            if (CPLib.eqr(Cursor_qbe_detimprap.GetString("TIPOSOGG"),"TE")) {
              /* ElseIf qbe_detimprap->TIPOSOGG='LR' */
            } else if (CPLib.eqr(Cursor_qbe_detimprap.GetString("TIPOSOGG"),"LR")) {
              /* _rigsog := _rigsog+1 */
              ...
              m_cSql = m_cSql+GetFieldsName_07303340(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rigsog,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(Cursor_qbe_detimprap.GetString("CTPSOP"),"?",0,0,m_cServer)+", ";
              ...
              if (CPLib.eqr(_rigint,1)) {
                ...
                m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
                m_cSql = "Update "+m_cPhName+" set ";
                m_cSql = m_cSql+"CONNESOPER = "+CPLib.ToSQLNull(Cursor_qbe_detimprap.GetString("CTPSOP"),"C",16,0,m_cServer)+", ";
                m_cSql = m_cSql+"TIPOLEG = "+CPLib.ToSQLNull("1","C",1,0,m_cServer)+", ";
                m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"rapopebo",false,true);
                m_cSql = m_cSql+" where ";
                m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQLNull(Cursor_qbe_detimprap.GetString("RAPPORTO"),"?",0,0,m_cServer),m_cServer,Cursor_qbe_detimprap.GetString("RAPPORTO"))+"";
                if (m_Ctx.IsSharedTemp("rapopebo")) {
                  m_cSql = m_cSql+" and context_id='"+m_Ctx.GetTempID()+"'";
                }
                m_nUpdatedRows = m_Sql.Update(m_cServer,m_cSql,m_oParameters);
            ...
            Cursor_intestbo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select *  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPLib.ToSQL(Cursor_qbe_detimprap.GetString("RAPPORTO"),"?",0,0)+" "+")"+(m_Ctx.IsSharedTemp("intestbo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1")+" order by "+"CPROWNUM ",m_cServer,m_Ctx,true));
            while ( ! (Cursor_intestbo.Eof())) {
              /* If LRTrim(intestbo->CODINTER)=LRTrim(qbe_detimprap->CONNESCLI) */
              if (CPLib.eqr(CPLib.LRTrim(Cursor_intestbo.GetString("CODINTER")),CPLib.LRTrim(Cursor_qbe_detimprap.GetString("CONNESCLI")))) {
                /* cNumMod := intestbo->CPROWNUM */
                cNumMod = CPLib.Round(Cursor_intestbo.GetDouble("CPROWNUM"),0);
              } // End If
              /* _rigint := intestbo->CPROWNUM */
              _rigint = CPLib.Round(Cursor_intestbo.GetDouble("CPROWNUM"),0);
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              m_cSql = m_cSql+GetFieldsName_0751C3C0(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cInfApri1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rigint+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetDate("DATAOPE"),"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("P","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(Cursor_qbe_detimprap.GetString("CONNESCLI"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(cInfApri2,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetString("RAPPORTO"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("2","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL("0","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.DateToChar(Cursor_qbe_detimprap.GetDate("DATAOPE"))+cInfApri2+"0","?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetString("CONNESCLI"),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(nProgImp2,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetDate("DATACHIU"),"?",0,0)+", ";
            ...
            Cursor_qbe_detimprap.Next();
          }
          m_cConnectivityError = Cursor_qbe_detimprap.ErrorMessage();
          Cursor_qbe_detimprap.Close();
          // * --- End Select
          /* If _rigsog=1 and _rigint=0 */
          if (CPLib.eqr(_rigsog,1) && CPLib.eqr(_rigint,0)) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = "Update "+m_cPhName+" set ";
            m_cSql = m_cSql+"TIPORAP = "+CPLib.ToSQL("0","C",1,0,m_cServer)+", ";
            ...
            /* ElseIf _rigsog=1 and _rigint=1 */
          } else if (CPLib.eqr(_rigsog,1) && CPLib.eqr(_rigint,1)) {
            // * --- Write into anarapbo from values
            m_Sql.RequireTransaction();
            m_cServer = m_Ctx.GetServer("anarapbo");
            m_cPhName = m_Ctx.GetPhName("anarapbo");
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = "Update "+m_cPhName+" set ";
            m_cSql = m_cSql+"TIPORAP = "+CPLib.ToSQL("2","C",1,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cRapporto,"?",0,0,m_cServer),m_cServer,cRapporto)+"";
            if (m_Ctx.IsSharedTemp("intestbo")) {
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = "Update "+m_cPhName+" set ";
            m_cSql = m_cSql+"TIPORAP = "+CPLib.ToSQL("1","C",1,0,m_cServer)+", ";
            m_cSql = CPLib.AddCPCCCHKUpdate(m_Ctx,m_cSql,"intestbo",false,true);
            m_cSql = m_cSql+" where ";
            m_cSql = m_cSql+"RAPPORTO = "+CPSql.SQLValueAdapter(CPLib.ToSQL(cRapporto,"?",0,0,m_cServer),m_cServer,cRapporto)+"";
            if (m_Ctx.IsSharedTemp("intestbo")) {
          ...
          Cursor_qbe_detimprap = new VQRHolder("qbe_detimprap",com.zucchetti.sitepainter.Library.getVQRReaderFactory(m_Ctx.GetInstance()),this,true).GetResultSet(m_Ctx);
          while ( ! (Cursor_qbe_detimprap.Eof())) {
            /* If qbe_detimprap->NRIG=1 */
            if (CPLib.eqr(Cursor_qbe_detimprap.GetDouble("NRIG"),1)) {
              // * --- Select from rapopebo
              m_cServer = m_Ctx.GetServer("rapopebo");
              m_cPhName = m_Ctx.GetPhName("rapopebo");
              if (Cursor_rapopebo!=null)
                Cursor_rapopebo.Close();
              Cursor_rapopebo = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select DATAOPE  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"RAPPORTO="+CPSql.SQLValueAdapter(CPLib.ToSQL(cRapporto,"?",0,0,m_cServer, m_oParameters),m_cServer,cRapporto)+"  and  TIPOOPRAP='23' "+")"+(m_Ctx.IsSharedTemp("rapopebo")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
              while ( ! (Cursor_rapopebo.Eof())) {
                /* If rapopebo->DATAOPE <> qbe_detimprap->DATAOPE */
                if (CPLib.ne(Cursor_rapopebo.GetDate("DATAOPE"),Cursor_qbe_detimprap.GetDate("DATAOPE"))) {
                } // End If
            ...
            if (CPLib.eqr(Cursor_qbe_detimprap.GetString("TIPOSOGG"),"TE")) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"soginfo")+" (";
              m_cSql = m_cSql+GetFieldsName_060DCEA8(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(LibreriaMit.UniqueId(),"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rigsog,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQLNull(Cursor_qbe_detimprap.GetString("CTPSOP"),"?",0,0,m_cServer)+", ";
            ...
            if (CPLib.eqr(cNumMod,0)) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"intestbo")+" (";
              m_cSql = m_cSql+GetFieldsName_074C6918(m_Ctx);
              m_cSql = m_cSql+") values (";
              m_cSql = m_cSql+""+CPLib.ToSQL(cInfApri1,"?",0,0,m_cServer)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(_rigint+1,"?",0,0)+", ";
              m_cSql = m_cSql+""+CPLib.ToSQL(Cursor_qbe_detimprap.GetDate("DATAOPE"),"?",0,0)+", ";
          ...
          m_cPhName = m_Ctx.GetPhName("");
          if (Cursor_!=null)
            Cursor_.Close();
          Cursor_ = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select * from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+(m_Ctx.IsSharedTemp("")?"context_id='"+m_Ctx.GetTempID()+"'":"1=1"),m_cServer,m_Ctx,true));
          while ( ! (Cursor_.Eof())) {
            Cursor_.Next();
          }
          m_cConnectivityError = Cursor_.ErrorMessage();
          Cursor_.Close();
          // * --- End Select
          /* cNumMod := cNumMod + 1 */
          cNumMod = CPLib.Round(cNumMod+1,0);
        } // End If
        Cursor_qbe_listimprap.Next();
      }
      m_cConnectivityError = Cursor_qbe_listimprap.ErrorMessage();
      Cursor_qbe_listimprap.Close();
      // * --- End Select
    ...
    try {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if ( ! (Read_Cursor.Eof())) {
          ...
          Read_Cursor.Next();
          if ( ! (Read_Cursor.Eof())) {
            Error l_oErrorFault = new Error("Read on anadip into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
            CPStdCounter.Error(l_oErrorFault);
          }
          Read_Cursor.Close();
        } else {
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,318,10))),0)) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on operazbo into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
        ...
        if (CPLib.eqr(_newop,1)) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on tbcauana into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_cSql = m_cSql+GetFieldsName_07257268(m_Ctx);
            m_cSql = m_cSql+") values (";
            ...
            m_cSql = m_cSql+GetFieldsName_062A9F48(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.ne(xRiga1,xRiga2)) {
            ...
            while ( ! (Cursor_operazbo.Eof())) {
              ...
              m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
              m_cSql = CPLib.InsertIntoStatement(m_Ctx,"operazbo")+" (";
              m_cSql = m_cSql+GetFieldsName_041896F0(m_Ctx);
              m_cSql = m_cSql+") values (";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"operazbo")+" (";
            m_cSql = m_cSql+GetFieldsName_0797E1B8(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
      ...
      while ( ! (FileLibrary.Eof(fhand))) {
        ...
        if (CPLib.gt(CPLib.Len(CPLib.LRTrim(CPLib.Substr(riga,318,10))),0)) {
          ...
          if ( ! (Read_Cursor.Eof())) {
            ...
            Read_Cursor.Next();
            if ( ! (Read_Cursor.Eof())) {
              Error l_oErrorFault = new Error("Read on fraziobo into routine arrt_imp_dati_sched returns two or more records. This item should return only a record.");
              CPStdCounter.Error(l_oErrorFault);
            }
            Read_Cursor.Close();
          } else {
        ...
        if (CPLib.eqr(_newop,1)) {
          ...
          if (CPLib.eqr(w_tipodest,"P")) {
            ...
            m_cSql = m_cSql+GetFieldsName_06471318(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
            ...
            m_cSql = m_cSql+GetFieldsName_0619E040(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
          ...
          if (CPLib.ne(xRiga1,xRiga2)) {
            ...
            while ( ! (Cursor_fraziobo.Eof())) {
              ...
              while ( ! (Cursor_sogopefbo.Eof())) {
                ...
                m_cSql = m_cSql+GetFieldsName_060FC400(m_Ctx);
                m_cSql = m_cSql+") values (";
                m_cSql = m_cSql+""+CPLib.ToSQL(cNewProg,"?",0,0,m_cServer)+", ";
            ...
            m_oParameters = CPLib.GetParamsForSqlUpdate(m_cServer);
            m_cSql = CPLib.InsertIntoStatement(m_Ctx,"fraziobo")+" (";
            m_cSql = m_cSql+GetFieldsName_07CE0558(m_Ctx);
            m_cSql = m_cSql+") values (";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Substr(riga,419,5),"?",0,0,m_cServer)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Val(CPLib.Substr(riga,222,9))/10000,"?",0,0)+", ";
            m_cSql = m_cSql+""+CPLib.ToSQL(CPLib.Right(CPLib.Left(riga,8),4)+CPLib.Substr(CPLib.Left(riga,8),3,2)+CPLib.Left(CPLib.Left(riga,8),2),"?",0,0,m_cServer)+", ";
  ...
  public static arrt_imp_dati_schedR Make(CPContext p_Ctx, Caller p_Caller) {
    return new arrt_imp_dati_schedR(p_Ctx, p_Caller);
  }
  public void Blank() {
  ...
  // * --- Fine Area Manuale
  // ENTITY_VQR: ,qbe_listimprap,qbe_detimprap,qbe_detimprap,
  public static final String m_cVQRList = ",qbe_listimprap,qbe_detimprap,qbe_detimprap,";
  ...
  protected static String GetFieldsName_062D4218(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_079B08A0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"nomearch,";
    p_cSql = p_cSql+"numriga,";
    p_cSql = p_cSql+"errore,";
  ...
  protected static String GetFieldsName_06444BC0(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_07766A98(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"CONNES,";
    p_cSql = p_cSql+"CODCAB,";
    p_cSql = p_cSql+"RAGSOC,";
  ...
  protected static String GetFieldsName_07D04CC0(CPContext p_Ctx) {
    String p_cSql = "";
    ...
    p_cSql = p_cSql+"TIPOSOGG,";
    p_cSql = p_cSql+"CTPSOP,";
    if (p_Ctx.IsSharedTemp("tmp_imprappo")) {
      p_cSql = p_cSql+"context_id,";
    }
    p_cSql = CPLib.AddCPCCCHKName(p_Ctx,p_cSql,"tmp_imprappo",true);
    return p_cSql;
  }
  protected static String GetFieldsName_06D544C8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
  ...
  protected static String GetFieldsName_06DEB168(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"RAPPORTO,";
    p_cSql = p_cSql+"DESCRAP,";
  ...
  protected static String GetFieldsName_07C67268(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0730A180(CPContext p_Ctx) {
    String p_cSql = "";
    if (p_Ctx.IsSharedTemp("rapopebo")) {
      p_cSql = p_cSql+"context_id,";
    }
  ...
  protected static String GetFieldsName_07303340(CPContext p_Ctx) {
    String p_cSql = "";
  ...
  protected static String GetFieldsName_0751C3C0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
  ...
  protected static String GetFieldsName_060DCEA8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_074C6918(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDBASE,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"DATAINI,";
  ...
  protected static String GetFieldsName_07257268(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
  ...
  protected static String GetFieldsName_062A9F48(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
  ...
  protected static String GetFieldsName_041896F0(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"AUTOM,";
    p_cSql = p_cSql+"CAMBIO,";
  ...
  protected static String GetFieldsName_0797E1B8(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
  ...
  protected static String GetFieldsName_06471318(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
  ...
  protected static String GetFieldsName_0619E040(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
  ...
  protected static String GetFieldsName_060FC400(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"IDFILEBO,";
    p_cSql = p_cSql+"CPROWNUM,";
    p_cSql = p_cSql+"CODSOG,";
  ...
  protected static String GetFieldsName_07CE0558(CPContext p_Ctx) {
    String p_cSql = "";
    p_cSql = p_cSql+"AREAGEO,";
    p_cSql = p_cSql+"CAMBIO,";
    p_cSql = p_cSql+"CDATAOPE,";
