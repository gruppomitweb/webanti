...
public class arfn_imp_dati_cgo_sched_tabs extends SPRoutineServlet implements SPInvokable {
  public static String m_cEntityUid = "!*23850378*!";
  ...
  public SPEntityGlobals getEntityGlobals() {
    ...
    l_eg.name = "arfn_imp_dati_cgo_sched_tabs";
  ...
  private void ExecuteRoutine(ServletStatus status) throws IOException {
    arfn_imp_dati_cgo_sched_tabsR Rcalled;
    Rcalled = new arfn_imp_dati_cgo_sched_tabsR(status.context,status);
  ...
  CallerWithObjs NewRoutine(SPServletStatus status,Caller dataFromClient) {
    return new arfn_imp_dati_cgo_sched_tabsR(status.context,dataFromClient);
  }
  protected void BringBackPage(ServletStatus status,arfn_imp_dati_cgo_sched_tabsR Rcalled) throws IOException {
    String l_cErrMsg;
    String msg;
    ...
    if ( ! (CPLib.Empty(status.m_cFaultTrace))) {
      status.out.println("Fault:["+SPLib.ToJSValue(status.context.Translate("MSG_ROUTINE_FAULTED","arfn_imp_dati_cgo_sched_tabs"),"C",0,0)+","+SPLib.ToJSValue(status.m_cFaultTrace,"C",0,0)+"]");
