...
public class SPAddSecurityUser extends spselectsecurityuser {

  public void init(ServletConfig config) throws ServletException {
    super.init(config);
    entityGlobals.name = "SPAddSecurityUser";
  }
  ...
  public void doProcess(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
    request.getRequestDispatcher("../jsp-system/spselectsecurityuser_portlet.jsp").forward(request, response);
  }
}
