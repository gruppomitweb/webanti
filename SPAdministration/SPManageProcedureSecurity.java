...
public class SPManageProcedureSecurity extends spproceduresecurity {

  public void init(ServletConfig config) throws ServletException {
    super.init(config);
    entityGlobals.name = "SPManageProcedureSecurity";
  }
  ...
  public void doProcess(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
    request.getRequestDispatcher("../jsp-system/spproceduresecurity_portlet.jsp").forward(request, response);
  }
