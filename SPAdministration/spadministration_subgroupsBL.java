...
public class spadministration_subgroupsBL extends spadministration_subgroupsWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public double w_groupbase;
    public String w_group_name;
    public double opk_groupbase;
  ...
  public static final String i_EntityName = "spadministration_subgroups";
  ...
  public CPPhTableWrInfo m_oWrInfo_cpgrpgrp;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cpgrpgrp;
  ...
  public static String[] m_EntityTables = {"cpgrpgrp"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'groupcode':groupcode,'m_Detail':{'groupbase':groupbase"+FoundlingChildrenList("spadministration_subgroups",true,true)+"}"+FoundlingChildrenList("spadministration_subgroups",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'groupcode':groupcode,'m_Detail':{'groupbase':groupbase,'group_name':group_name"+FoundlingChildrenList("spadministration_subgroups",true,true)+"}"+FoundlingChildrenList("spadministration_subgroups",true,false)+"}";
  public static final String i_ItemSequence = "groupcode,m_Detail[ groupbase"+FoundlingChildrenList("spadministration_subgroups",false,true)+"]"+FoundlingChildrenList("spadministration_subgroups",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("spadministration_subgroups"),new String[][]{new String[]{"groupcode","Group code","N","6","0","campo","key1","false","false"},new String[]{"groupbase","Group base","N","6","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",groupbase";
  ...
  public spadministration_subgroupsBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cpgrpgrp = p_ContextObject.GetPhName("cpgrpgrp",p_ContextObject.GetCompany(),false);
    m_cServer_cpgrpgrp = p_ContextObject.GetServer("cpgrpgrp");
    m_oWrInfo_cpgrpgrp = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cpgrpgrp",p_ContextObject.GetCompany());
    m_cVirtName_cpgrpgrp = CPSql.ManipulateTablePhName("cpgrpgrp",m_cServer_cpgrpgrp);
    ...
    m_MNTs = CPLib.MNTChilds("spadministration_subgroups",p_ContextObject);
  }
  public void Blank() {
  ...
  protected boolean Link_MJILVOVIBU() {
    return Link_MJILVOVIBU("Full");
  }
  protected boolean Link_MJILVOVIBU(String p_cType) {
    ...
    if ( ! (CPLib.Empty(w_groupbase))) {
      double l_OldValue = w_groupbase;
      // Costruzione della where per la chiave corrente e per le chiavi fisse
      l_cCurrentKey = "="+CPSql.SQLValueAdapter(CPLib.ToSQL(w_groupbase,"N",6,0),m_cServer_cpgroups,w_groupbase);
      ...
      try {
        ...
        if (l_bLoaded) {
          /*  E' stato trovato almeno un record: i valori del cursore vengono riportati nei
                                    ...
                                    */
          w_groupbase = l_rsLink.GetDouble("code");
          w_group_name = l_rsLink.GetString("name");
          l_rsLink.Next();
          ...
          Link_MJILVOVIBU_blank();
          if (CPLib.eq(p_cType,"Load")) {
            w_groupbase = l_OldValue;
          }
        }
        if ( ! (l_bResult)) {
          m_nLastError = 3;
          ...
          if (CPLib.eq(m_cLastMsgError,"")) {
            m_cLastMsgError = m_Ctx.Translate("MSG_LINK_FAILED","groupbase");
          }
          m_cLastWorkVarError = "groupbase";
        }
      } finally {
        l_rsLink.Close();
      }
  ...
  public boolean Set_groupbase(double p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_groupbase = p_workVariableValue;
    l_bResult = Link_MJILVOVIBU();
  ...
  public final static String[] m_KeyColumns = {"groupcode"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spadministration_subgroups","cpgrpgrp",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_groupbase;
      p_groupbase = CPLib.GetProperties(trs_p.getProperty("groupbase"),new Properties());
      Properties p_group_name;
      p_group_name = CPLib.GetProperties(trs_p.getProperty("group_name"),new Properties());
      Properties p_opk_groupbase;
      p_opk_groupbase = CPLib.GetProperties(trs_p.getProperty("opk_groupbase"),new Properties());
      ...
      w_groupcode = CPLib.GetProperty(p,"groupcode",w_groupcode,0);
      ...
      while (CPLib.le(i,rows)) {
        w_groupbase = 0;
        w_groupbase = CPLib.GetProperty(p_groupbase,"",w_groupbase,i);
        w_group_name = "";
        w_group_name = CPLib.GetProperty(p_group_name,"",w_group_name,i);
        opk_groupbase = CPLib.GetProperty(p_opk_groupbase,"",0,i);
  ...
  static void GetLinkDef0(Map<String,List<Map<String,String[]>>> tables) {
    ...
    map.put("rd_var",new String[]{"w_groupbase","w_group_name"});
    ...
    map.put("rd_var.comment",zeroSplit.split("Group base\u0000ADMIN_NAME",-1));
    ...
    map.put("property.value",zeroSplit.split("cpgroups\u0000false\u0000false\u00001\u00000\u0000spadministration_groups\u0000false\u0000false\u0000ADMIN_SELECT_GROUP\u0000\u0000\u0000false",-1));
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("spadministration_subgroups",false)) {
      map = new HashMap<String,String[]>();
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("spadministration_subgroups",child);
    ...
    for(String child : CPLib.LoadableMNTs("spadministration_subgroups",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("spadministration_subgroups",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"spadministration_subgroups"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"spadministration_subgroups\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_groupbase;
    p_groupbase = new Properties();
    Properties p_group_name;
    p_group_name = new Properties();
    Properties p_opk_groupbase;
    p_opk_groupbase = new Properties();
    Properties p_m_nRowStatus;
    p_m_nRowStatus = new Properties();
    Properties p_m_cOldRowCPCCCHK;
    p_m_cOldRowCPCCCHK = new Properties();
    CPLib.PutProperty(p,"groupcode",w_groupcode,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_groupbase,"",w_groupbase,trsrow);
      CPLib.PutProperty(p_group_name,"",w_group_name,trsrow);
      CPLib.PutProperty(p_opk_groupbase,"",opk_groupbase,trsrow);
    ...
    trs_p.setProperty("groupbase",CPLib.ToProperties(p_groupbase));
    trs_p.setProperty("group_name",CPLib.ToProperties(p_group_name));
    trs_p.setProperty("opk_groupbase",CPLib.ToProperties(p_opk_groupbase));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cpgrpgrp"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("groupcode","N",6,0));
  }
  public String RowPrimaryKey() {
    return "cpgrpgrp"+"\\"+CPLib.ToCPStr(w_groupbase);
  }
  ...
  protected void TrsToWork() {
    w_groupbase= m_oTrs.get(m_nCurrentRow).w_groupbase;
    w_group_name= m_oTrs.get(m_nCurrentRow).w_group_name;
    opk_groupbase= m_oTrs.get(m_nCurrentRow).opk_groupbase;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_groupbase=w_groupbase;
    m_oTrs.get(m_nCurrentRow).w_group_name=w_group_name;
    m_oTrs.get(m_nCurrentRow).opk_groupbase=opk_groupbase;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_groupbase=w_groupbase;
    m_oDeletedRows.get(l_nRows).w_group_name=w_group_name;
    m_oDeletedRows.get(l_nRows).opk_groupbase=opk_groupbase;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_groupbase));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_groupbase= m_oDeletedRows.get(l_RowNumberToSet).w_groupbase;
    w_group_name= m_oDeletedRows.get(l_RowNumberToSet).w_group_name;
    opk_groupbase= m_oDeletedRows.get(l_RowNumberToSet).opk_groupbase;
