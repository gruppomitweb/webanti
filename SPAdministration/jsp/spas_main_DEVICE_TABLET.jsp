...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=PageId%>','spas_main_DEVICE_TABLET','planObj','<%=SPParentObjId%>');
/*JS_MARKER_END*/
</script>
<%
...
ZtVWeb.PageCtrl(this,'<%=PageId%>', '<%=forcePageletId%>', 'spas_main_DEVICE_TABLET');
...
ZtVWeb.addPage('<%=PageId%>', <%=PageId%>, 'spas_main_DEVICE_TABLET','<%=includerPageletId%>' );
