...
<script>
/*JS_MARKER_START*/
  ZtVWeb.POM.addObj('<%=PageId%>','spas_main_DEVICE_SMARTPHONE','planObj','<%=SPParentObjId%>');
/*JS_MARKER_END*/
</script>
<%
...
ZtVWeb.PageCtrl(this,'<%=PageId%>', '<%=forcePageletId%>', 'spas_main_DEVICE_SMARTPHONE');
...
ZtVWeb.addPage('<%=PageId%>', <%=PageId%>, 'spas_main_DEVICE_SMARTPHONE','<%=includerPageletId%>' );
