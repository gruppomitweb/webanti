...
public class spproceduresecurityBL extends spproceduresecurityWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spproceduresecurity";
  ...
  public spproceduresecurityBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spproceduresecurity","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
