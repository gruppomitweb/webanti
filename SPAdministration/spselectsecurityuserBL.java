...
public class spselectsecurityuserBL extends spselectsecurityuserWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spselectsecurityuser";
  ...
  public spselectsecurityuserBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spselectsecurityuser","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
