...
// * --- Fine Area Manuale
public class spadministration_insertgrpgrpR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public spadministration_insertgrpgrpR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("spadministration_insertgrpgrp",m_Caller);
  ...
  public double GetNumber(String p_cVarName,String p_cType,int len,int dec) {
    ...
    if (CPLib.eqr("father",p_cVarName)) {
      return father;
    }
    return 0;
  }
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "spadministration_insertgrpgrp";
  ...
  void Page_1() throws Exception {
    ...
    if (UserAdmin.Make(m_Ctx).HasAdminRights()) {
      ...
      if (CPLib.ne(father,0)) {
        ...
        m_cSql = CPLib.GetSQLPrefixComment("spadministration_insertgrpgrp",7,"00000005")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
        m_cSql = m_cSql+GetFieldsName_00000005(m_Ctx,m_oWrInfo);
        m_cSql = m_cSql+") values (";
        m_cSql = m_cSql+""+CPLib.ToSQL(father,"?",0,0)+", ";
  ...
  public String RunAsync(double p_code,double p_father) {
    code = p_code;
    father = p_father;
  ...
  public Forward Run(double p_code,double p_father) {
    code = p_code;
    father = p_father;
    return Run();
  }
  ...
  public static spadministration_insertgrpgrpR Make(CPContext p_Ctx, Caller p_Caller) {
    return new spadministration_insertgrpgrpR(p_Ctx, p_Caller);
  }
  public void Blank() {
    code = 0;
    father = 0;
  ...
  public static String[] m_cRunParameterNames={"code","father"};
