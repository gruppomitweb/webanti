...
public class spadministration_historypwdBL extends spadministration_historypwdWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spadministration_historypwd";
  ...
  public CPPhTableWrInfo m_oWrInfo_cphistorypwd;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cphistorypwd;
  ...
  public static String[] m_EntityTables = {"cphistorypwd"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'code':code,'m_Detail':{'pwpassword':pwpassword"+FoundlingChildrenList("spadministration_historypwd",true,true)+"}"+FoundlingChildrenList("spadministration_historypwd",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'code':code,'m_Detail':{'pwpassword':pwpassword,'pwdatcreate':pwdatcreate,'pwdtrevoke':pwdtrevoke,'pwactive':pwactive"+FoundlingChildrenList("spadministration_historypwd",true,true)+"}"+FoundlingChildrenList("spadministration_historypwd",true,false)+"}";
  public static final String i_ItemSequence = "code,m_Detail[ pwpassword"+FoundlingChildrenList("spadministration_historypwd",false,true)+"]"+FoundlingChildrenList("spadministration_historypwd",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("spadministration_historypwd"),new String[][]{new String[]{"code","Codice Utente","N","9","0","campo","key1","false","false"},new String[]{"pwpassword","Password","C","20","0","campo","key1","true","false"}});
  public static final String i_TrsKeys = ",pwpassword";
  ...
  public spadministration_historypwdBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cphistorypwd = p_ContextObject.GetPhName("cphistorypwd",p_ContextObject.GetCompany(),false);
    m_cServer_cphistorypwd = p_ContextObject.GetServer("cphistorypwd");
    m_oWrInfo_cphistorypwd = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cphistorypwd",p_ContextObject.GetCompany());
    m_cVirtName_cphistorypwd = CPSql.ManipulateTablePhName("cphistorypwd",m_cServer_cphistorypwd);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("spadministration_historypwd",p_ContextObject);
  }
  public void Blank() {
    ...
    w_code = 0;
    w_pwpassword = "";
    w_pwdatcreate = CPLib.NullDateTime();
    w_pwdtrevoke = CPLib.NullDate();
    w_pwactive = "";
  ...
  public boolean Set_pwpassword(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_pwpassword = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spadministration_historypwd","cphistorypwd",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_pwpassword;
      p_pwpassword = CPLib.GetProperties(trs_p.getProperty("pwpassword"),new Properties());
      Properties p_pwdatcreate;
      p_pwdatcreate = CPLib.GetProperties(trs_p.getProperty("pwdatcreate"),new Properties());
      Properties p_pwdtrevoke;
      p_pwdtrevoke = CPLib.GetProperties(trs_p.getProperty("pwdtrevoke"),new Properties());
      Properties p_pwactive;
      p_pwactive = CPLib.GetProperties(trs_p.getProperty("pwactive"),new Properties());
      Properties p_opk_pwpassword;
      p_opk_pwpassword = CPLib.GetProperties(trs_p.getProperty("opk_pwpassword"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        w_pwpassword = "";
        w_pwpassword = CPLib.GetProperty(p_pwpassword,"",w_pwpassword,i);
        w_pwdatcreate = CPLib.NullDateTime();
        w_pwdatcreate = CPLib.GetProperty(p_pwdatcreate,"",w_pwdatcreate,i);
        w_pwdtrevoke = CPLib.NullDate();
        w_pwdtrevoke = CPLib.GetProperty(p_pwdtrevoke,"",w_pwdtrevoke,i);
        w_pwactive = "";
        w_pwactive = CPLib.GetProperty(p_pwactive,"",w_pwactive,i);
        opk_pwpassword = CPLib.GetProperty(p_opk_pwpassword,"","",i);
  ...
  void SetUpdated(String p_cName) {
    if (CPLib.eq(p_cName,"code")) {
      SetUpdated();
      return;
    }
    if (CPLib.eq(p_cName,"pwpassword")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("spadministration_historypwd",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("spadministration_historypwd",child);
    ...
    for(String child : CPLib.LoadableMNTs("spadministration_historypwd",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("spadministration_historypwd",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"spadministration_historypwd"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"spadministration_historypwd\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_pwpassword;
    p_pwpassword = new Properties();
    Properties p_pwdatcreate;
    p_pwdatcreate = new Properties();
    Properties p_pwdtrevoke;
    p_pwdtrevoke = new Properties();
    Properties p_pwactive;
    p_pwactive = new Properties();
    Properties p_opk_pwpassword;
    p_opk_pwpassword = new Properties();
    Properties p_m_nRowStatus;
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_pwpassword,"",w_pwpassword,trsrow);
      CPLib.PutProperty(p_pwdatcreate,"",w_pwdatcreate,trsrow);
      CPLib.PutProperty(p_pwdtrevoke,"",w_pwdtrevoke,trsrow);
      CPLib.PutProperty(p_pwactive,"",w_pwactive,trsrow);
      CPLib.PutProperty(p_opk_pwpassword,"",opk_pwpassword,trsrow);
    ...
    trs_p.setProperty("pwpassword",CPLib.ToProperties(p_pwpassword));
    trs_p.setProperty("pwdatcreate",CPLib.ToProperties(p_pwdatcreate));
    trs_p.setProperty("pwdtrevoke",CPLib.ToProperties(p_pwdtrevoke));
    trs_p.setProperty("pwactive",CPLib.ToProperties(p_pwactive));
    trs_p.setProperty("opk_pwpassword",CPLib.ToProperties(p_opk_pwpassword));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cphistorypwd"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("code","N",9,0));
  }
  public String RowPrimaryKey() {
    return "cphistorypwd"+"\\"+CPLib.ToCPStr(w_pwpassword);
  }
  ...
  protected void TrsToWork() {
    w_pwpassword= m_oTrs.get(m_nCurrentRow).w_pwpassword;
    w_pwdatcreate= m_oTrs.get(m_nCurrentRow).w_pwdatcreate;
    w_pwdtrevoke= m_oTrs.get(m_nCurrentRow).w_pwdtrevoke;
    w_pwactive= m_oTrs.get(m_nCurrentRow).w_pwactive;
    opk_pwpassword= m_oTrs.get(m_nCurrentRow).opk_pwpassword;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_pwpassword=w_pwpassword;
    m_oTrs.get(m_nCurrentRow).w_pwdatcreate=w_pwdatcreate;
    m_oTrs.get(m_nCurrentRow).w_pwdtrevoke=w_pwdtrevoke;
    m_oTrs.get(m_nCurrentRow).w_pwactive=w_pwactive;
    m_oTrs.get(m_nCurrentRow).opk_pwpassword=opk_pwpassword;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_pwpassword=w_pwpassword;
    m_oDeletedRows.get(l_nRows).w_pwdatcreate=w_pwdatcreate;
    m_oDeletedRows.get(l_nRows).w_pwdtrevoke=w_pwdtrevoke;
    m_oDeletedRows.get(l_nRows).w_pwactive=w_pwactive;
    m_oDeletedRows.get(l_nRows).opk_pwpassword=opk_pwpassword;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_pwpassword));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_pwpassword= m_oDeletedRows.get(l_RowNumberToSet).w_pwpassword;
    w_pwdatcreate= m_oDeletedRows.get(l_RowNumberToSet).w_pwdatcreate;
    w_pwdtrevoke= m_oDeletedRows.get(l_RowNumberToSet).w_pwdtrevoke;
    w_pwactive= m_oDeletedRows.get(l_RowNumberToSet).w_pwactive;
    opk_pwpassword= m_oDeletedRows.get(l_RowNumberToSet).opk_pwpassword;
