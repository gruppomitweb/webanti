...
public class SPManageGroups extends spadministration_groups {

  public void init(ServletConfig config) throws ServletException {
    super.init(config);
    entityGlobals.name = "SPManageGroups";
  }
  public boolean CheckAccess(SPServletStatus status,HttpServletResponse response) throws IOException {
    ...
    status.context.CanEventuallyZoomOn("SPManageGroups",entityGlobals.zoomableTables);
    return true;
  }
}
