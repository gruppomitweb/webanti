...
public class spquerysecurityBL extends spquerysecurityWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spquerysecurity";
  ...
  public spquerysecurityBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spquerysecurity","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
