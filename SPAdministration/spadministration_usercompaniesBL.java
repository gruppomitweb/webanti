...
public class spadministration_usercompaniesBL extends spadministration_usercompaniesWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spadministration_usercompanies";
  ...
  public String m_cPhName_cpusrazi;
  public String m_cServer_cpusrazi;
  public CPPhTableWrInfo m_oWrInfo_cpusrazi;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cpusrazi;
  ...
  public static String[] m_EntityTables = {"cpusrazi"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'usercode':usercode,'m_Detail':{'company':company,'datestart':datestart,'datestop':datestop"+FoundlingChildrenList("spadministration_usercompanies",true,true)+"}"+FoundlingChildrenList("spadministration_usercompanies",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'usercode':usercode,'m_Detail':{'company':company,'datestart':datestart,'datestop':datestop"+FoundlingChildrenList("spadministration_usercompanies",true,true)+"}"+FoundlingChildrenList("spadministration_usercompanies",true,false)+"}";
  public static final String i_ItemSequence = "usercode,m_Detail[ company datestart datestop"+FoundlingChildrenList("spadministration_usercompanies",false,true)+"]"+FoundlingChildrenList("spadministration_usercompanies",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("spadministration_usercompanies"),new String[][]{new String[]{"usercode","ADMIN_CODE","N","9","0","campo","key1","false","false"},new String[]{"company","ADMIN_COMPANY","C","10","0","campo","nokey","true","false"},new String[]{"datestart","ADMIN_VALIDITY_START","D","8","0","campo","nokey","true","false"},new String[]{"datestop","ADMIN_VALIDITY_END","D","8","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public spadministration_usercompaniesBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cpusrazi = p_ContextObject.GetPhName("cpusrazi",p_ContextObject.GetCompany(),false);
    m_cServer_cpusrazi = p_ContextObject.GetServer("cpusrazi");
    m_oWrInfo_cpusrazi = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cpusrazi",p_ContextObject.GetCompany());
    m_cVirtName_cpusrazi = CPSql.ManipulateTablePhName("cpusrazi",m_cServer_cpusrazi);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("spadministration_usercompanies",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Set_company(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_company = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spadministration_usercompanies","cpusrazi",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_company;
      p_company = CPLib.GetProperties(trs_p.getProperty("company"),new Properties());
      ...
      while (CPLib.le(i,rows)) {
        w_company = "";
        w_company = CPLib.GetProperty(p_company,"",w_company,i);
        w_datestart = CPLib.NullDate();
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("spadministration_usercompanies",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("spadministration_usercompanies",child);
    ...
    for(String child : CPLib.LoadableMNTs("spadministration_usercompanies",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("spadministration_usercompanies",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"spadministration_usercompanies"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"spadministration_usercompanies\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_company,"",w_company,trsrow);
    ...
    trs_p.setProperty("company",CPLib.ToProperties(p_company));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cpusrazi"+"\\"+CPLib.ToCPStr(p_Caller.GetNumber("usercode","N",9,0));
  }
  public String RowPrimaryKey() {
    return "cpusrazi"+"\\"+CPLib.ToCPStr(m_nCPRowNum);
  }
  ...
  protected void TrsToWork() {
    w_company= m_oTrs.get(m_nCurrentRow).w_company;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_company=w_company;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_company=w_company;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_company= m_oDeletedRows.get(l_RowNumberToSet).w_company;
