...
public class SPManageQuerySecurity extends spquerysecurity {

  public void init(ServletConfig config) throws ServletException {
    super.init(config);
    entityGlobals.name = "SPManageQuerySecurity";
  }
  ...
  public void doProcess(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
    request.getRequestDispatcher("../jsp-system/spquerysecurity_portlet.jsp").forward(request, response);
  }
}
