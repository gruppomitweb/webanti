...
public class spadministration_dmobapp_qkmBL extends spadministration_dmobapp_qkmWV implements CPLib.QueryFilterFromApplication {
  static public class TrsRow {
    public double w_CPROWNUM;
    public String w_QA_LABEL;
    public String w_QA_URL;
    public String w_QA_ICON;
  ...
  public static final String i_EntityName = "spadministration_dmobapp_qkm";
  ...
  public String m_cPhName_cpqkmappstore;
  public String m_cServer_cpqkmappstore;
  public CPPhTableWrInfo m_oWrInfo_cpqkmappstore;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_cpqkmappstore;
  ...
  public static String[] m_EntityTables = {"cpqkmappstore"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'QA_CODE':QA_CODE,'m_Detail':{'CPROWNUM':CPROWNUM,'QA_LABEL':QA_LABEL,'QA_URL':QA_URL,'QA_ICON':QA_ICON"+FoundlingChildrenList("spadministration_dmobapp_qkm",true,true)+"}"+FoundlingChildrenList("spadministration_dmobapp_qkm",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'QA_CODE':QA_CODE,'m_Detail':{'CPROWNUM':CPROWNUM,'QA_LABEL':QA_LABEL,'QA_URL':QA_URL,'QA_ICON':QA_ICON"+FoundlingChildrenList("spadministration_dmobapp_qkm",true,true)+"}"+FoundlingChildrenList("spadministration_dmobapp_qkm",true,false)+"}";
  public static final String i_ItemSequence = "QA_CODE,m_Detail[ CPROWNUM QA_LABEL QA_URL QA_ICON"+FoundlingChildrenList("spadministration_dmobapp_qkm",false,true)+"]"+FoundlingChildrenList("spadministration_dmobapp_qkm",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("spadministration_dmobapp_qkm"),new String[][]{new String[]{"QA_CODE","Codice ","C","10","0","campo","key1","false","false"},new String[]{"CPROWNUM","","N","6","0","campo","key1","true","false"},new String[]{"QA_LABEL","MSG_DQKM_APP_OFF_DESC","C","30","0","campo","nokey","true","false"},new String[]{"QA_URL","URL","C","255","0","campo","nokey","true","false"},new String[]{"QA_ICON","MSG_DQKM_APP_OFF_ICONA","C","255","0","campo","nokey","true","false"}});
  ...
  public int m_nCPRowNum;
  public spadministration_dmobapp_qkmBL (CPContext p_ContextObject) {
    ...
    m_cPhName_cpqkmappstore = p_ContextObject.GetPhName("cpqkmappstore",p_ContextObject.GetCompany(),false);
    m_cServer_cpqkmappstore = p_ContextObject.GetServer("cpqkmappstore");
    m_oWrInfo_cpqkmappstore = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"cpqkmappstore",p_ContextObject.GetCompany());
    m_cVirtName_cpqkmappstore = CPSql.ManipulateTablePhName("cpqkmappstore",m_cServer_cpqkmappstore);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("spadministration_dmobapp_qkm",p_ContextObject);
  }
  public void Blank() {
  ...
  /*  Gestione dei metodi per l'impostazione delle variabili di work.
                            ...
                            */
  public boolean Set_QA_CODE(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdated();
    w_QA_CODE = p_workVariableValue;
  ...
  public boolean Set_QA_LABEL(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_QA_LABEL = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_QA_URL(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_QA_URL = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_QA_ICON(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_QA_ICON = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"QA_CODE"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spadministration_dmobapp_qkm","cpqkmappstore",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_QA_LABEL;
      p_QA_LABEL = CPLib.GetProperties(trs_p.getProperty("QA_LABEL"),new Properties());
      Properties p_QA_URL;
      p_QA_URL = CPLib.GetProperties(trs_p.getProperty("QA_URL"),new Properties());
      Properties p_QA_ICON;
      p_QA_ICON = CPLib.GetProperties(trs_p.getProperty("QA_ICON"),new Properties());
      ...
      w_QA_CODE = CPLib.GetProperty(p,"QA_CODE",w_QA_CODE,0);
      ...
      while (CPLib.le(i,rows)) {
        ...
        w_QA_LABEL = "";
        w_QA_LABEL = CPLib.GetProperty(p_QA_LABEL,"",w_QA_LABEL,i);
        w_QA_URL = "";
        w_QA_URL = CPLib.GetProperty(p_QA_URL,"",w_QA_URL,i);
        w_QA_ICON = "";
        w_QA_ICON = CPLib.GetProperty(p_QA_ICON,"",w_QA_ICON,i);
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"QA_LABEL")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"QA_URL")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"QA_ICON")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("spadministration_dmobapp_qkm",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("spadministration_dmobapp_qkm",child);
    ...
    for(String child : CPLib.LoadableMNTs("spadministration_dmobapp_qkm",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("spadministration_dmobapp_qkm",m_Ctx);
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"spadministration_dmobapp_qkm"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"spadministration_dmobapp_qkm\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_QA_LABEL;
    p_QA_LABEL = new Properties();
    Properties p_QA_URL;
    p_QA_URL = new Properties();
    Properties p_QA_ICON;
    p_QA_ICON = new Properties();
    Properties p_m_nCPRowNum;
    ...
    CPLib.PutProperty(p,"QA_CODE",w_QA_CODE,0);
    ...
    while (CPLib.lt(i,Rows())) {
      ...
      CPLib.PutProperty(p_QA_LABEL,"",w_QA_LABEL,trsrow);
      CPLib.PutProperty(p_QA_URL,"",w_QA_URL,trsrow);
      CPLib.PutProperty(p_QA_ICON,"",w_QA_ICON,trsrow);
    ...
    trs_p.setProperty("QA_LABEL",CPLib.ToProperties(p_QA_LABEL));
    trs_p.setProperty("QA_URL",CPLib.ToProperties(p_QA_URL));
    trs_p.setProperty("QA_ICON",CPLib.ToProperties(p_QA_ICON));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "cpqkmappstore"+"\\"+CPLib.ToCPStr(p_Caller.GetString("QA_CODE","C",10,0));
  }
  public String RowPrimaryKey() {
    return "cpqkmappstore"+"\\"+CPLib.ToCPStr(w_CPROWNUM);
  }
  ...
  protected void TrsToWork() {
    ...
    w_QA_LABEL= m_oTrs.get(m_nCurrentRow).w_QA_LABEL;
    w_QA_URL= m_oTrs.get(m_nCurrentRow).w_QA_URL;
    w_QA_ICON= m_oTrs.get(m_nCurrentRow).w_QA_ICON;
  ...
  void WorkToTrs() {
    ...
    m_oTrs.get(m_nCurrentRow).w_QA_LABEL=w_QA_LABEL;
    m_oTrs.get(m_nCurrentRow).w_QA_URL=w_QA_URL;
    m_oTrs.get(m_nCurrentRow).w_QA_ICON=w_QA_ICON;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_QA_LABEL=w_QA_LABEL;
    m_oDeletedRows.get(l_nRows).w_QA_URL=w_QA_URL;
    m_oDeletedRows.get(l_nRows).w_QA_ICON=w_QA_ICON;
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_QA_LABEL= m_oDeletedRows.get(l_RowNumberToSet).w_QA_LABEL;
    w_QA_URL= m_oDeletedRows.get(l_RowNumberToSet).w_QA_URL;
    w_QA_ICON= m_oDeletedRows.get(l_RowNumberToSet).w_QA_ICON;
