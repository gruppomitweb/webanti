...
public class spsecurityBL extends spsecurityWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spsecurity";
  ...
  public spsecurityBL (CPContext p_ContextObject) {
  ...
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spsecurity","",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
