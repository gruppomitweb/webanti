...
public class SPManageTables extends spadministration_tables {

  static public class ServletStatus extends spadministration_tables.ServletStatus {
  }
  public void init(ServletConfig config) throws ServletException {
    super.init(config);
    entityGlobals.name = "SPManageTables";
  }
