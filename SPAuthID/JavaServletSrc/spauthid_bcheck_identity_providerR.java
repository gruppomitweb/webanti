...
// * --- Fine Area Manuale
public class spauthid_bcheck_identity_providerR implements CallerWithObjs {
  ...
  // * --- Fine Area Manuale
  public spauthid_bcheck_identity_providerR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("spauthid_bcheck_identity_provider",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "spauthid_bcheck_identity_provider";
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      Cursor_spauthid_identity_provider = m_Sql.Query(m_cServer,QueryLoader.SetSqlFunctions("select code,autologin  from "+m_cPhName+((m_cPhName).endsWith(CPSecurity.FILTER_QUERY_POSTFIX)?CPLib.NewCPCCCHK():"")+" where "+"("+"autologin = 'S'  and   code <> "+CPSql.SQLValueAdapter(CPLib.ToSQL(idpCode,"?",0,0,m_cServer, m_oParameters),m_cServer,idpCode)+" "+")"+(m_Ctx.IsSharedTemp("spauthid_identity_provider")?" and context_id='"+m_Ctx.GetTempID()+"'":" and 1=1"),m_cServer,m_Ctx,true));
      ...
      if (found) {
        // Transaction Error
        m_Sql.AbortTransactionMarkExplicit(CPLib.FormatMsg(m_Ctx,"Esiste già un Identity provider di default"));
      } // End If
    } finally {
      try {
        if (Cursor_spauthid_identity_provider!=null)
  ...
  public String RunAsync(String p_idpCode) {
    idpCode = p_idpCode;
  ...
  public Forward Run(String p_idpCode) {
    idpCode = p_idpCode;
    return Run();
  }
  public Forward Run() {
  ...
  public static spauthid_bcheck_identity_providerR Make(CPContext p_Ctx, Caller p_Caller) {
    return new spauthid_bcheck_identity_providerR(p_Ctx, p_Caller);
  }
  public void Blank() {
    idpCode = CPLib.Space(10);
    found = false;
  }
  ...
  public static String[] m_cRunParameterNames={"idpCode"};
}
