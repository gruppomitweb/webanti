...
public class spauthid_scope_mapperBL extends spauthid_scope_mapperWV implements CPLib.QueryFilterFromApplication {
  ...
  public static final String i_EntityName = "spauthid_scope_mapper";
  ...
  public CPPhTableWrInfo m_oWrInfo_spauthid_scope_mapper;
  // Variabile che contiene il nome virtuale della tabella
  public String m_cVirtName_spauthid_scope_mapper;
  ...
  public static String[] m_EntityTables = {"spauthid_scope_mapper"};
  // codice secondo sintassi delle business rules per produrre i dati da usare in un ideale documento che li rappresenti
  public static final String i_StateStructure = "{'scope_name':scope_name,'m_Detail':{'property_key':property_key,'property_value':property_value"+FoundlingChildrenList("spauthid_scope_mapper",true,true)+"}"+FoundlingChildrenList("spauthid_scope_mapper",true,false)+"}";
  public static final String i_CompleteStateStructure = "{'scope_name':scope_name,'m_Detail':{'property_key':property_key,'property_value':property_value"+FoundlingChildrenList("spauthid_scope_mapper",true,true)+"}"+FoundlingChildrenList("spauthid_scope_mapper",true,false)+"}";
  public static final String i_ItemSequence = "scope_name,m_Detail[ property_key property_value"+FoundlingChildrenList("spauthid_scope_mapper",false,true)+"]"+FoundlingChildrenList("spauthid_scope_mapper",false,false)+"";
  public static final com.zucchetti.sitepainter.EntityItem[] i_EditableEntityItems = com.zucchetti.sitepainter.EntityItem.buildEditableItemsForEntity(GetLinkDef(),FoundlingChildrenList("spauthid_scope_mapper"),new String[][]{new String[]{"scope_name","","C","50","0","campo","key1","false","false"},new String[]{"property_key","","C","20","0","campo","nokey","true","false"},new String[]{"property_value","","M","10","0","campo","nokey","true","false"}});
  ...
  public spauthid_scope_mapperBL (CPContext p_ContextObject) {
    ...
    m_cPhName_spauthid_scope_mapper = p_ContextObject.GetPhName("spauthid_scope_mapper",p_ContextObject.GetCompany(),false);
    m_cServer_spauthid_scope_mapper = p_ContextObject.GetServer("spauthid_scope_mapper");
    m_oWrInfo_spauthid_scope_mapper = CPPhTableWrInfo.GetCPPhTableWrInfo(p_ContextObject,"spauthid_scope_mapper",p_ContextObject.GetCompany());
    m_cVirtName_spauthid_scope_mapper = CPSql.ManipulateTablePhName("spauthid_scope_mapper",m_cServer_spauthid_scope_mapper);
    // Assegnazione della variabile di collegamento con il database
    m_Sql = p_ContextObject.GetSql();
    m_Ctx = p_ContextObject;
    // Istanziazione dei business object dei figli
    m_MNTs = CPLib.MNTChilds("spauthid_scope_mapper",p_ContextObject);
  }
  public void Blank() {
  ...
  public boolean Set_property_key(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_property_key = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  }
  public boolean Set_property_value(String p_workVariableValue) {
    boolean l_bResult;
    l_bResult = true;
    // Variabile temporanea che conterrà il risultato della funzione di link se l'item corrente è parte di una chiave composta
    boolean l_bTmpRes;
    SetUpdatedRow();
    w_property_value = p_workVariableValue;
    // Esecuzione dei calcoli
    Calculate();
    SaveDependsOn();
    return l_bResult;
  ...
  public final static String[] m_KeyColumns = {"scope_name"};
  public static String QueryFilter(CPContext m_Ctx) {
    String l_cFilter;
    l_cFilter = CPLib.ApplicationQueryFilter("spauthid_scope_mapper","spauthid_scope_mapper",m_KeyColumns,m_Ctx);
    return l_cFilter;
  }
  ...
  public void SetFromContext(String s,java.util.Properties p) {
    ...
    if ( ! (CPLib.Empty(s))) {
      ...
      Properties p_property_key;
      p_property_key = CPLib.GetProperties(trs_p.getProperty("property_key"),new Properties());
      Properties p_property_value;
      p_property_value = CPLib.GetProperties(trs_p.getProperty("property_value"),new Properties());
      ...
      w_scope_name = CPLib.GetProperty(p,"scope_name",w_scope_name,0);
      ...
      while (CPLib.le(i,rows)) {
        w_property_key = "";
        w_property_key = CPLib.GetProperty(p_property_key,"",w_property_key,i);
        w_property_value = "";
        w_property_value = CPLib.GetProperty(p_property_value,"",w_property_value,i);
  ...
  void SetUpdated(String p_cName) {
    ...
    if (CPLib.eq(p_cName,"property_key")) {
      SetUpdatedRow();
      return;
    }
    if (CPLib.eq(p_cName,"property_value")) {
      SetUpdatedRow();
      return;
    }
  }
  ...
  public static Map<String,List<Map<String,String[]>>> GetLinkDef() {
    ...
    List<Map<String,String[]>> items;
    GetLinkDef0(tables);
    for(String child : CPLib.LoadableMNTs("spauthid_scope_mapper",false)) {
      ...
      String[][] definitions = CPMNTChild.GetM_Fkd("spauthid_scope_mapper",child);
    ...
    for(String child : CPLib.LoadableMNTs("spauthid_scope_mapper",true)) {
      map = new HashMap<String,String[]>();
      items = tables.get(com.zucchetti.sitepainter.Library.getEntityTables(child)[0]);
      if (CPLib.IsNull(items)) {
        items = new ArrayList<Map<String,String[]>>();
  ...
  public void Initialize() {
    ...
    m_MNTs = CPLib.MNTChilds("spauthid_scope_mapper",m_Ctx);
  ...
  public boolean Check() {
    ...
    ResetErrorMessage();
    l_bResult = true;
    if ( ! (CPLib.Empty(w_property_key)) &&  ! (CPLib.Empty(w_property_value))) {
  ...
  public String[] GetStateSecurityKeyRoles(String p_cState) {
    ...
    if (CPLib.eq(p_cState,CPSecurity.UNKNOWN_STATE)) {
      l_Keys = new String[]{"spauthid_scope_mapper"};
    }
    if (CPLib.eq(l_Keys.length,0)) {
      l_Keys = new String[]{"spauthid_scope_mapper\\"+p_cState};
    }
    return l_Keys;
  }
  ...
  public void GetContext(boolean p_bGetChildren,java.util.Properties p) {
    ...
    Properties p_property_key;
    p_property_key = new Properties();
    Properties p_property_value;
    p_property_value = new Properties();
    Properties p_m_nRowStatus;
    p_m_nRowStatus = new Properties();
    Properties p_m_cOldRowCPCCCHK;
    p_m_cOldRowCPCCCHK = new Properties();
    CPLib.PutProperty(p,"scope_name",w_scope_name,0);
    ...
    while (CPLib.lt(i,Rows())) {
      SetRow(i);
      trsrow = trsrow+1;
      CPLib.PutProperty(p_property_key,"",w_property_key,trsrow);
      CPLib.PutProperty(p_property_value,"",w_property_value,trsrow);
    ...
    trs_p.setProperty("property_key",CPLib.ToProperties(p_property_key));
    trs_p.setProperty("property_value",CPLib.ToProperties(p_property_value));
  ...
  public static String PrimaryKey(Caller p_Caller) {
    return "spauthid_scope_mapper"+"\\"+CPLib.ToCPStr(p_Caller.GetString("scope_name","C",50,0));
  }
  ...
  protected void TrsToWork() {
    w_property_key= m_oTrs.get(m_nCurrentRow).w_property_key;
    w_property_value= m_oTrs.get(m_nCurrentRow).w_property_value;
  ...
  void WorkToTrs() {
    m_oTrs.get(m_nCurrentRow).w_property_key=w_property_key;
    m_oTrs.get(m_nCurrentRow).w_property_value=w_property_value;
  ...
  public void AddTrsDeletedRow() {
    ...
    m_oDeletedRows.get(l_nRows).w_property_key=w_property_key;
    m_oDeletedRows.get(l_nRows).w_property_value=w_property_value;
  ...
  boolean FullRow() {
    return  ! (CPLib.Empty(w_property_key)) &&  ! (CPLib.Empty(w_property_value));
  }
  void SetModified() {
  ...
  void SetDeletedRow(double p_nRowNumberToSet) {
    ...
    w_property_key= m_oDeletedRows.get(l_RowNumberToSet).w_property_key;
    w_property_value= m_oDeletedRows.get(l_RowNumberToSet).w_property_value;
