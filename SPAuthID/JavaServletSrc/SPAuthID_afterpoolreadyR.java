...
// * --- Fine Area Manuale
public class SPAuthID_afterpoolreadyR implements CallerWithObjs {
  ...
  public String defaultProtocolCode;
  // * --- Area Manuale = BO - Properties
  // * --- Fine Area Manuale
  public SPAuthID_afterpoolreadyR (CPContext p_ContextObject, Caller caller) {
    if (caller == null)
    ...
    CPSecurity.RoutineCallableByProgram("SPAuthID_afterpoolready",m_Caller);
  ...
  public String GetString(String p_cVarName,String p_cType,int len,int dec) {
    if (CPLib.eqr("m_cVQRList",p_cVarName)) {
      ...
      return "SPAuthID_afterpoolready";
    } else if (m_bEventRunning && CPLib.eqr("i_EntityType",p_cVarName)) {
      return "routine";
    }
    if (CPLib.eqr("defaultProtocolCode",p_cVarName)) {
      return defaultProtocolCode;
    }
    return "";
  }
  ...
  void Page_1() throws Exception {
    ...
    try {
      ...
      m_cSql = "";
      m_cSql = m_cSql+"PRCODE="+CPSql.SQLValueAdapter(CPLib.ToSQL("oidc","C",10,0,m_cServer),m_cServer,"oidc");
      ...
      if ( ! (Read_Cursor.Eof())) {
        ...
        Read_Cursor.Next();
        if ( ! (Read_Cursor.Eof())) {
          Error l_oErrorFault = new Error("Read on spauthid_protocol into routine SPAuthID_afterpoolready returns two or more records. This item should return only a record.");
        ...
        m_cSql = CPLib.GetSQLPrefixComment("SPAuthID_afterpoolready",6,"00000008")+CPLib.InsertIntoStatement(m_Ctx,m_oWrInfo)+" (";
  ...
  public static SPAuthID_afterpoolreadyR Make(CPContext p_Ctx, Caller p_Caller) {
    return new SPAuthID_afterpoolreadyR(p_Ctx, p_Caller);
  }
  public void Blank() {
    defaultProtocolCode = "oidc";
  }
