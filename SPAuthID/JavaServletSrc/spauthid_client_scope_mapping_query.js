...
m_oFather.DoQueryFromChild('spauthid_client_scope_mapping',_flt_(m_cVirtName+'.'+name,ctrlValue,type),m_cVirtName);
}
} else {
var Frm = document.FSender;
if (m_bIsMq) {
...
_chNotF(childAlias,'detail','spauthid_client_scope_mapping');
return;
}
}
if (IsWndAccessible(window['m_oFather'])) {
m_oFather.DoQueryFromChild('spauthid_client_scope_mapping',keyWhere+' and '+childWhere,m_cVirtName+'|'+allAliases);
} else {
var Frm = document.FSender;
